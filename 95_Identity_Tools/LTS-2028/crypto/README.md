...
As of 1.3.7, `attempt_store.py` closes the previously open item of actually
wiring `AttemptLimiter` into a real unlock path; see
`docs/BSR2_INTEGRATION.md`'s Attempt limiting section for specifics.
