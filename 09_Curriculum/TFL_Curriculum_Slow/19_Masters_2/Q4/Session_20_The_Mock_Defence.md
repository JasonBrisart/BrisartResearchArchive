...
| | |
|---|---|
| **Central question** | The Mock Defence: students rehearse against four adversarial roles? |
| **Core concept** | A mock defence produces a list of unanswered questions. |
| **Student outcome** | Students rehearse against four adversarial roles. |
| **Previous session** | Session 19 — Gate Checking |
| **Next session** | Session 21 — Revising After The Mock |
| **Materials** | Specimen manuscripts supplied by the instructor; review protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_20_Printout.md` |
| **Homework** | `Homework/Session_20_Homework.md` |

## Why this lesson exists

**The conceptual step.** A mock defence produces a list of unanswered questions. Restating the design rather than engaging the challenge wastes the rehearsal.
...
**What depends on it.** Session 21 — Revising After The Mock — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A mock defence produces a list of unanswered questions. Restating the design rather than engaging the challenge wastes the rehearsal.
...
1. A defence answering the scope referee specifically.
2. A recorded list of four unanswered questions.

### One non-example

A defence restating the design when challenged.
...
That unanswered questions are identifiable in rehearsal.
...
| Statement | Status |
|---|---|
| A mock defence produces a list of unanswered questions. | Framework-derived, appropriate at this grade |
| That unanswered questions are identifiable in rehearsal. | What this specific activity can show |
| Whether the defence will succeed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 19 — Gate Checking — specifically: students check their design against both gates before defence.

**How it was taught.** Through the activity: peer gate check on both items, with failures returned for repair

**Quick check.** Ask for the closing sentence of Session 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 19: peer gate check on both items, with failures returned for repair, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence answering the scope referee specifically. |
| **Non-example** | A defence restating the design when challenged. |
...
**Student materials.** One copy of `Printouts/Session_20_Printout.md` per student.

**Prior student data required.** Work produced in Session 19, kept in the student's folder.
...
**File.** `Printouts/Session_20_Printout.md`
...
**Exact wording.** "Assign four challengers: three rivals and the scope referee."
...
**Target observation.** That unanswered questions are identifiable in rehearsal.
...
> "A mock defence produces a list of unanswered questions. You just saw that when assign four challengers: three rivals and the scope referee.
...
**The example.** A defence answering the scope referee specifically.
...
**Completed answer.** A defence answering the scope referee specifically. — which demonstrates that unanswered questions are identifiable in rehearsal.
...
**Teacher prompt.** "Now one that does not work. A defence restating the design when challenged. Why is this not an
example?"
...
**Exact student instructions.** Full rehearsal with every unanswered question recorded.
...
- *Licensed conclusion.* That unanswered questions are identifiable in rehearsal.
...
- *Expected response.* That unanswered questions are identifiable in rehearsal.
...
1. Any wording carrying the idea in `A mock defence produces a list of unanswered questions`.
...
**Why this sentence matters.** It is the opening question of Session 21, which assumes students arrive holding it.
...
**File.** `Homework/Session_20_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 19 — Gate Checking |
| **Leads to** | Session 21 — Revising After The Mock |

**Transition in.** Session 19 established students check their design against both gates before defence. This session uses that as the starting point.

**Transition out.** This session establishes students rehearse against four adversarial roles. Session 21 assumes it and builds students revise against mock-defence feedback.
