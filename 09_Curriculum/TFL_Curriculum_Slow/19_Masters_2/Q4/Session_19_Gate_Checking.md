...
| | |
|---|---|
| **Central question** | Gate Checking: students check their design against both gates before defence? |
| **Core concept** | The two gates are executability and adjudication. |
| **Student outcome** | Students check their design against both gates before defence. |
| **Previous session** | Session 18 — The Final Design |
| **Next session** | Session 20 — The Mock Defence |
...
**The conceptual step.** The two gates are executability and adjudication. Both are checked before any other assessment, and a peer check before submission is the safeguard.
...
**What depends on it.** Session 20 — The Mock Defence — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The two gates are executability and adjudication. Both are checked before any other assessment, and a peer check before submission is the safeguard.
...
1. A design passing a peer gate check on both items.
2. A design returned after failing the adjudication gate.

### One non-example

A design submitted with the gates assumed to pass.
...
That gate checking precedes all other assessment.

### What this activity does not establish

Whether the design is otherwise good.
...
| Statement | Status |
|---|---|
| The two gates are executability and adjudication. | Framework-derived, appropriate at this grade |
| That gate checking precedes all other assessment. | What this specific activity can show |
| Whether the design is otherwise good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 18 — The Final Design — specifically: students produce the design they will defend.

**How it was taught.** Through the activity: assemble the final design with all eight components

**Quick check.** Ask for the closing sentence of Session 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 18: assemble the final design with all eight components, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A design passing a peer gate check on both items. |
| **Non-example** | A design submitted with the gates assumed to pass. |
...
**Exact wording.** "Say: executability and adjudication. Both checked before anything else is read."
...
**Target observation.** That gate checking precedes all other assessment.
...
> "The two gates are executability and adjudication. You just saw that when say: executability and adjudication.
> Last time we said: This is what you defend. This is the next part of that.
...
**What students must not infer.** Whether the design is otherwise good.

### 4. Worked example

**The example.** A design passing a peer gate check on both items.
...
**Completed answer.** A design passing a peer gate check on both items. — which demonstrates that gate checking precedes all other assessment.
...
**Conclusions not licensed.** Whether the design is otherwise good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A design returned after failing the adjudication gate. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A design submitted with the gates assumed to pass. Why is this not an
example?"
...
**Exact student instructions.** Peer gate check on both items, with failures returned for repair.
...
- *Licensed conclusion.* That gate checking precedes all other assessment.
- *Not licensed.* Whether the design is otherwise good.
...
- *Expected response.* That gate checking precedes all other assessment.
...
1. Any wording carrying the idea in `The two gates are executability and adjudication`.
...
Say: "The gate check is the same one I will run."
...
| | |
|---|---|
| **Follows** | Session 18 — The Final Design |
| **Leads to** | Session 20 — The Mock Defence |

**Transition in.** Session 18 established students produce the design they will defend. This session uses that as the starting point.

**Transition out.** This session establishes students check their design against both gates before defence. Session 20 assumes it and builds students rehearse against four adversarial roles.
