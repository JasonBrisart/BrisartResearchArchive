# Session 23 — The Calibration Analysis

**Master's Year 2** · Design Review and Defence · **Quarter 4** · **100 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Calibration Analysis: students account for their reviewing divergence across the year? |
| **Core concept** | Reviewing divergence is classified as a disagreement about fact or about standard. |
| **Student outcome** | Students account for their reviewing divergence across the year. |
| **Previous session** | Session 22 — The Design Defence |
| **Next session** | Session 24 — The Year In Reviews |
| **Materials** | Specimen manuscripts supplied by the instructor; review protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_23_Printout.md` |
| **Homework** | `Homework/Session_23_Homework.md` |

## Why this lesson exists

**The conceptual step.** Reviewing divergence is classified as a disagreement about fact or about standard. Taste is not a category, and divergence traceable to the framework's status is a reviewer error.
...
**What depends on it.** Session 24 — The Year In Reviews — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Reviewing divergence is classified as a disagreement about fact or about standard. Taste is not a category, and divergence traceable to the framework's status is a reviewer error.
...
1. A divergence classified as a standards difference and justified.
2. A divergence traced to a factual error in the reviewer's reading.

### One non-example

A divergence attributed to differing reviewer preferences.
...
That divergence classification is possible and useful.

### What this activity does not establish

Which reviewer was right.
...
| Statement | Status |
|---|---|
| Reviewing divergence is classified as a disagreement about fact or about standard. | Framework-derived, appropriate at this grade |
| That divergence classification is possible and useful. | What this specific activity can show |
| Which reviewer was right. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 22 — The Design Defence — specifically: students defend a design capable of adjudicating.

**How it was taught.** Through the activity: full defence with both gates checked first

**Quick check.** Ask for the closing sentence of Session 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 22: full defence with both gates checked first, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A divergence classified as a standards difference and justified. |
| **Non-example** | A divergence attributed to differing reviewer preferences. |
...
**Student materials.** One copy of `Printouts/Session_23_Printout.md` per student.

**Prior student data required.** Work produced in Session 22, kept in the student's folder.
...
**File.** `Printouts/Session_23_Printout.md`
...
> "Next year the target becomes what the framework has not said."
...
**Exact wording.** "Say: your six reviews against everybody else's. Where did you diverge, and why?"
...
**Target observation.** That divergence classification is possible and useful.
...
> "Reviewing divergence is classified as a disagreement about fact or about standard. You just saw that when say: your six reviews against everybody else's.
> Last time we said: Next year the target becomes what the framework has not said. This is the next part of that.
...
**What students must not infer.** Which reviewer was right.

### 4. Worked example

**The example.** A divergence classified as a standards difference and justified.
...
**Completed answer.** A divergence classified as a standards difference and justified. — which demonstrates that divergence classification is possible and useful.
...
**Conclusions not licensed.** Which reviewer was right.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A divergence traced to a factual error in the reviewer's reading. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A divergence attributed to differing reviewer preferences. Why is this not an
example?"
...
**Exact student instructions.** A written calibration analysis classifying every divergence.
...
- *Licensed conclusion.* That divergence classification is possible and useful.
- *Not licensed.* Which reviewer was right.
...
- *Expected response.* That divergence classification is possible and useful.
...
1. Any wording carrying the idea in `Reviewing divergence is classified as a disagreement about fact or about standard`.
...
Say: "Editors can see the difference between a standard and a reputation."

**Why this sentence matters.** It is the opening question of Session 24, which assumes students arrive holding it.
...
**File.** `Homework/Session_23_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 22 — The Design Defence |
| **Leads to** | Session 24 — The Year In Reviews |

**Transition in.** Session 22 established students defend a design capable of adjudicating. This session uses that as the starting point.

**Transition out.** This session establishes students account for their reviewing divergence across the year. Session 24 assumes it and builds students review the year through their own reviews.
