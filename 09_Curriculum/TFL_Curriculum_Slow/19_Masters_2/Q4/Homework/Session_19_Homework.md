# Session 19 Homework — Gate Checking

**Master's Year 2** · Design Review and Defence · **Quarter 4**
**Follows:** Session 19 — Gate Checking · **Points:** 5 · **Optional:** yes
...
Peer gate check on both items, with failures returned for repair.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every design passes a peer gate check on both items
