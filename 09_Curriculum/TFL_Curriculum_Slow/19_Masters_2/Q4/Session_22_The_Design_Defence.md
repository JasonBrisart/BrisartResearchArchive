...
| | |
|---|---|
| **Central question** | The Design Defence: students defend a design capable of adjudicating? |
| **Core concept** | The design defence requires both gates satisfied, all four challenger roles answered, and the blind spots stated without prompting. |
| **Student outcome** | Students defend a design capable of adjudicating. |
| **Previous session** | Session 21 — Revising After The Mock |
| **Next session** | Session 23 — The Calibration Analysis |
| **Materials** | Specimen manuscripts supplied by the instructor; review protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_22_Printout.md` |
| **Homework** | `Homework/Session_22_Homework.md` |

## Why this lesson exists

**The conceptual step.** The design defence requires both gates satisfied, all four challenger roles answered, and the blind spots stated without prompting.
...
**What depends on it.** Session 23 — The Calibration Analysis — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The design defence requires both gates satisfied, all four challenger roles answered, and the blind spots stated without prompting.
...
1. A defence stating blind spots unprompted.
2. A defence answering all four challengers specifically.

### One non-example

A defence omitting the blind-spot element until asked.
...
Whether the design can be defended.
...
| Statement | Status |
|---|---|
| The design defence requires both gates satisfied, all four challenger roles answered, and the blind spots stated without prompting. | Framework-derived, appropriate at this grade |
| Whether the design can be defended. | What this specific activity can show |
| Whether the design is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 21 — Revising After The Mock — specifically: students revise against mock-defence feedback.

**How it was taught.** Through the activity: revise and mark what changed for each

**Quick check.** Ask for the closing sentence of Session 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 21: revise and mark what changed for each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence stating blind spots unprompted. |
| **Non-example** | A defence omitting the blind-spot element until asked. |
...
**Student materials.** One copy of `Printouts/Session_22_Printout.md` per student.

**Prior student data required.** Work produced in Session 21, kept in the student's folder.
...
**File.** `Printouts/Session_22_Printout.md`
...
**Exact wording.** "Say: six minutes presenting, four defending. Four roles."
...
**Target observation.** Whether the design can be defended.
...
> "The design defence requires both gates satisfied, all four challenger roles answered, and the blind spots stated without prompting. You just saw that when say: six minutes presenting, four defending.
...
**What students must not infer.** Whether the design is correct.

### 4. Worked example

**The example.** A defence stating blind spots unprompted.
...
**Completed answer.** A defence stating blind spots unprompted. — which demonstrates whether the design can be defended.
...
**Conclusions not licensed.** Whether the design is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A defence answering all four challengers specifically. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence omitting the blind-spot element until asked. Why is this not an
example?"
...
**Exact student instructions.** Full defence with both gates checked first.
...
- *Licensed conclusion.* Whether the design can be defended.
- *Not licensed.* Whether the design is correct.
...
- *Expected response.* Whether the design can be defended.
...
1. Any wording carrying the idea in `The design defence requires both gates satisfied, all four challenger roles answered, and the blind spots stated without prompting`.
...
Say: "Next year the target becomes what the framework has not said."

**Why this sentence matters.** It is the opening question of Session 23, which assumes students arrive holding it.
...
**File.** `Homework/Session_22_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 21 — Revising After The Mock |
| **Leads to** | Session 23 — The Calibration Analysis |

**Transition in.** Session 21 established students revise against mock-defence feedback. This session uses that as the starting point.

**Transition out.** This session establishes students defend a design capable of adjudicating. Session 23 assumes it and builds students account for their reviewing divergence across the year.
