...
| | |
|---|---|
| **Central question** | The Final Design: students produce the design they will defend? |
| **Core concept** | The final design assembles two years of methodological training into eight components. |
| **Student outcome** | Students produce the design they will defend. |
| **Previous session** | Session 17 — Rebuilding After Review |
| **Next session** | Session 19 — Gate Checking |
...
**The conceptual step.** The final design assembles two years of methodological training into eight components. The analysis plan is the most frequently omitted.
...
**What depends on it.** Session 19 — Gate Checking — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The final design assembles two years of methodological training into eight components. The analysis plan is the most frequently omitted.
...
1. A design with all eight components present.
2. A design whose analysis plan fixes all ten decisions.

### One non-example

A design with seven components and no analysis plan.
...
That the final design has stateable completeness.
...
| Statement | Status |
|---|---|
| The final design assembles two years of methodological training into eight components. | Framework-derived, appropriate at this grade |
| That the final design has stateable completeness. | What this specific activity can show |
| Whether the design is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 17 — Rebuilding After Review — specifically: students rebuild a design that received a negative verdict.

**How it was taught.** Through the activity: rebuild and re-submit for a second triage verdict

**Quick check.** Ask for the closing sentence of Session 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 17: rebuild and re-submit for a second triage verdict, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A design with all eight components present. |
| **Non-example** | A design with seven components and no analysis plan. |
...
> "The verdict distribution should shift. That is the point."
...
**Exact wording.** "Say: everything from two years. One design."
...
**Target observation.** That the final design has stateable completeness.
...
> "The final design assembles two years of methodological training into eight components. You just saw that when say: everything from two years.
> Last time we said: The verdict distribution should shift. That is the point. This is the next part of that.
...
**The example.** A design with all eight components present.
...
**Completed answer.** A design with all eight components present. — which demonstrates that the final design has stateable completeness.
...
**Teacher prompt.** "Here is a second case. A design whose analysis plan fixes all ten decisions. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A design with seven components and no analysis plan. Why is this not an
example?"
...
**Exact student instructions.** Assemble the final design with all eight components.
...
- *Licensed conclusion.* That the final design has stateable completeness.
...
- *Expected response.* That the final design has stateable completeness.
...
1. Any wording carrying the idea in `The final design assembles two years of methodological training into eight components`.
...
| | |
|---|---|
| **Follows** | Session 17 — Rebuilding After Review |
| **Leads to** | Session 19 — Gate Checking |

**Transition in.** Session 17 established students rebuild a design that received a negative verdict. This session uses that as the starting point.

**Transition out.** This session establishes students produce the design they will defend. Session 19 assumes it and builds students check their design against both gates before defence.
