# Session 14 — Reviewing Your Own Design
...
| | |
|---|---|
| **Central question** | Reviewing Your Own Design: students apply the full protocol to their own work? |
| **Core concept** | Self-review to the same standard is difficult because the author knows their intentions. |
| **Student outcome** | Students apply the full protocol to their own work. |
| **Previous session** | Session 13 — The Review Portfolio |
| **Next session** | Session 15 — Human Subjects And Institutional Duty |
| **Materials** | Specimen manuscripts supplied by the instructor; review protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_14_Printout.md` |
| **Homework** | `Homework/Session_14_Homework.md` |

## Why this lesson exists

**The conceptual step.** Self-review to the same standard is difficult because the author knows their intentions. Requiring a minimum count of serious findings forces genuine application.
...
**What depends on it.** Session 15 — Human Subjects And Institutional Duty — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Self-review to the same standard is difficult because the author knows their intentions. Requiring a minimum count of serious findings forces genuine application.
...
1. A self-review naming three serious findings.
2. A finding the author had not previously noticed.

### One non-example

A self-review concluding the design is sound.
...
That the protocol applies to one's own work.

### What this activity does not establish

Whether the design is salvageable.
...
| Statement | Status |
|---|---|
| Self-review to the same standard is difficult because the author knows their intentions. | Framework-derived, appropriate at this grade |
| That the protocol applies to one's own work. | What this specific activity can show |
| Whether the design is salvageable. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 13 — The Review Portfolio — specifically: students produce six reviews to protocol.

**How it was taught.** Through the activity: six complete six-section reviews submitted together

**Quick check.** Ask for the closing sentence of Session 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 13: six complete six-section reviews submitted together, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A self-review naming three serious findings. |
| **Non-example** | A self-review concluding the design is sound. |
...
**Student materials.** One copy of `Printouts/Session_14_Printout.md` per student.

**Prior student data required.** Work produced in Session 13, kept in the student's folder.
...
**File.** `Printouts/Session_14_Printout.md`
...
**Exact wording.** "Say: six sections, on yours. Harder than it sounds."
...
**Target observation.** That the protocol applies to one's own work.
...
> "Self-review to the same standard is difficult because the author knows their intentions. You just saw that when say: six sections, on yours.
> Last time we said: That is a body of review work. This is the next part of that.
...
**What students must not infer.** Whether the design is salvageable.

### 4. Worked example

**The example.** A self-review naming three serious findings.
...
**Completed answer.** A self-review naming three serious findings. — which demonstrates that the protocol applies to one's own work.
...
**Conclusions not licensed.** Whether the design is salvageable.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A finding the author had not previously noticed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A self-review concluding the design is sound. Why is this not an
example?"
...
**Exact student instructions.** A full self-review with at least three fatal-or-serious findings.
...
- *Licensed conclusion.* That the protocol applies to one's own work.
- *Not licensed.* Whether the design is salvageable.
...
- *Expected response.* That the protocol applies to one's own work.
...
1. Any wording carrying the idea in `Self-review to the same standard is difficult because the author knows their intentions`.
...
Say: "Finding them yourself is cheaper than a reviewer finding them."

**Why this sentence matters.** It is the opening question of Session 15, which assumes students arrive holding it.
...
**File.** `Homework/Session_14_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 13 — The Review Portfolio |
| **Leads to** | Session 15 — Human Subjects And Institutional Duty |

**Transition in.** Session 13 established students produce six reviews to protocol. This session uses that as the starting point.

**Transition out.** This session establishes students apply the full protocol to their own work. Session 15 assumes it and builds students state the obligations attached to running studies on people.
