# Session 13 — The Review Portfolio
...
| | |
|---|---|
| **Central question** | The Review Portfolio: students produce six reviews to protocol? |
| **Core concept** | A review portfolio demonstrates consistent application of the protocol across six designs. |
| **Student outcome** | Students produce six reviews to protocol. |
| **Previous session** | Session 12 — The Midterm Review |
| **Next session** | Session 14 — Reviewing Your Own Design |
| **Materials** | Specimen manuscripts supplied by the instructor; review protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_13_Printout.md` |
| **Homework** | `Homework/Session_13_Homework.md` |

## Why this lesson exists

**The conceptual step.** A review portfolio demonstrates consistent application of the protocol across six designs. A section carrying only a verdict is returned.
...
**What depends on it.** Session 14 — Reviewing Your Own Design — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A review portfolio demonstrates consistent application of the protocol across six designs. A section carrying only a verdict is returned.
...
1. Six reviews with located findings throughout.
2. A review returned for a verdict-only measurement section.

### One non-example

A review whose scope section reads: scope appears appropriate.
...
That review quality is consistent and auditable.

### What this activity does not establish

Whether the reviewed designs are good.
...
| Statement | Status |
|---|---|
| A review portfolio demonstrates consistent application of the protocol across six designs. | Framework-derived, appropriate at this grade |
| That review quality is consistent and auditable. | What this specific activity can show |
| Whether the reviewed designs are good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 12 — The Midterm Review — specifically: students consolidate the first half.

**How it was taught.** Through the activity: review covering the protocol, all six sections, and calibration

**Quick check.** Ask for the closing sentence of Session 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 12: review covering the protocol, all six sections, and calibration, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Six reviews with located findings throughout. |
| **Non-example** | A review whose scope section reads: scope appears appropriate. |
...
**Student materials.** One copy of `Printouts/Session_13_Printout.md` per student.

**Prior student data required.** Work produced in Session 12, kept in the student's folder.
...
**File.** `Printouts/Session_13_Printout.md`
...
> "The review portfolio covers everything up to here."
...
**Exact wording.** "Say: six designs, six full reviews. Specific findings only."
...
**Target observation.** That review quality is consistent and auditable.
...
> "A review portfolio demonstrates consistent application of the protocol across six designs. You just saw that when say: six designs, six full reviews.
> Last time we said: The review portfolio covers everything up to here. This is the next part of that.
...
**What students must not infer.** Whether the reviewed designs are good.

### 4. Worked example

**The example.** Six reviews with located findings throughout.
...
**Completed answer.** Six reviews with located findings throughout. — which demonstrates that review quality is consistent and auditable.
...
**Conclusions not licensed.** Whether the reviewed designs are good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A review returned for a verdict-only measurement section. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A review whose scope section reads: scope appears appropriate. Why is this not an
example?"
...
**Exact student instructions.** Six complete six-section reviews submitted together.
...
- *Licensed conclusion.* That review quality is consistent and auditable.
- *Not licensed.* Whether the reviewed designs are good.
...
- *Expected response.* That review quality is consistent and auditable.
...
1. Any wording carrying the idea in `A review portfolio demonstrates consistent application of the protocol across six designs`.
...
Say: "That is a body of review work."

**Why this sentence matters.** It is the opening question of Session 14, which assumes students arrive holding it.
...
**File.** `Homework/Session_13_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 12 — The Midterm Review |
| **Leads to** | Session 14 — Reviewing Your Own Design |

**Transition in.** Session 12 established students consolidate the first half. This session uses that as the starting point.

**Transition out.** This session establishes students produce six reviews to protocol. Session 14 assumes it and builds students apply the full protocol to their own work.
