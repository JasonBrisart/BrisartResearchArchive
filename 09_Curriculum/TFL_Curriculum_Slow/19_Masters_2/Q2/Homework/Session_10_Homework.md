# Session 10 Homework — The Revised Design

**Master's Year 2** · Design Review and Defence · **Quarter 2**
**Follows:** Session 10 — The Revised Design · **Points:** 5 · **Optional:** yes
...
Second executability run with both question counts reported.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** both counts are reported and the second is lower
...
Session 11 is **Recognising Fatal Flaws**, which assumes you arrive holding it. Write one thing you expect it to be about:
