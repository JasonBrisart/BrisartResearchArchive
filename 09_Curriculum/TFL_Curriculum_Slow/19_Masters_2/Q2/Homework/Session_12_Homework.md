...
Review covering the protocol, all six sections, and calibration.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the cohort identifies its own weakest section
...
Session 13 is **The Review Portfolio**, which assumes you arrive holding it. Write one thing you expect it to be about:
