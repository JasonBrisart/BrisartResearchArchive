...
| | |
|---|---|
| **Central question** | The Midterm Review: students consolidate the first half? |
| **Core concept** | A midterm review samples every section of the protocol rather than the recently practised ones. |
| **Student outcome** | Students consolidate the first half. |
| **Previous session** | Session 11 — Recognising Fatal Flaws |
| **Next session** | Session 13 — The Review Portfolio |
...
**The conceptual step.** A midterm review samples every section of the protocol rather than the recently practised ones.
...
**What depends on it.** Session 13 — The Review Portfolio — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A midterm review samples every section of the protocol rather than the recently practised ones.
...
1. A review touching the executability and scope sections equally.
2. A cohort identifying adjudication auditing as its weakest section.

### One non-example

A review covering only calibration.
...
Where the cohort is weakest.

### What this activity does not establish

What the portfolio will require.
...
| Statement | Status |
|---|---|
| A midterm review samples every section of the protocol rather than the recently practised ones. | Framework-derived, appropriate at this grade |
| Where the cohort is weakest. | What this specific activity can show |
| What the portfolio will require. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 11 — Recognising Fatal Flaws — specifically: students distinguish a fatal flaw from a weakness.

**How it was taught.** Through the activity: classify twelve defects as fatal or weakening with reasons

**Quick check.** Ask for the closing sentence of Session 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 11: classify twelve defects as fatal or weakening with reasons, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A review touching the executability and scope sections equally. |
| **Non-example** | A review covering only calibration. |
...
> "Fatal means no result from this design can be interpreted."
...
**Exact wording.** "Ask what is still unclear about everything so far."
...
**Target observation.** Where the cohort is weakest.
...
> "A midterm review samples every section of the protocol rather than the recently practised ones. You just saw that when ask what is still unclear about everything so far.
> Last time we said: Fatal means no result from this design can be interpreted. This is the next part of that.
...
**What students must not infer.** What the portfolio will require.

### 4. Worked example

**The example.** A review touching the executability and scope sections equally.
...
**Completed answer.** A review touching the executability and scope sections equally. — which demonstrates where the cohort is weakest.
...
**Conclusions not licensed.** What the portfolio will require.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A cohort identifying adjudication auditing as its weakest section. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A review covering only calibration. Why is this not an
example?"
...
**Exact student instructions.** Review covering the protocol, all six sections, and calibration.
...
- *Licensed conclusion.* Where the cohort is weakest.
- *Not licensed.* What the portfolio will require.
...
- *Expected response.* Where the cohort is weakest.
...
1. Any wording carrying the idea in `A midterm review samples every section of the protocol rather than the recently practised ones`.
...
Say: "The review portfolio covers everything up to here."
...
| | |
|---|---|
| **Follows** | Session 11 — Recognising Fatal Flaws |
| **Leads to** | Session 13 — The Review Portfolio |

**Transition in.** Session 11 established students distinguish a fatal flaw from a weakness. This session uses that as the starting point.

**Transition out.** This session establishes students consolidate the first half. Session 13 assumes it and builds students produce six reviews to protocol.
