...
| | |
|---|---|
| **Central question** | Receiving Review: students revise against reviews they disagree with? |
| **Core concept** | Every review point receives either a revision or a reasoned refusal. |
| **Student outcome** | Students revise against reviews they disagree with. |
| **Previous session** | Session 8 — Reviewing The Inference, Not The Framework |
| **Next session** | Session 10 — The Revised Design |
...
**The conceptual step.** Every review point receives either a revision or a reasoned refusal. Silence on a point is not a response, even when the point is wrong.
...
**What depends on it.** Session 10 — The Revised Design — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every review point receives either a revision or a reasoned refusal. Silence on a point is not a response, even when the point is wrong.
...
1. A response letter with a reasoned refusal on one point.
2. A revision made in response to a point the author disputes.

### One non-example

A response letter omitting two review points.
...
That review responses require complete coverage.
...
| Statement | Status |
|---|---|
| Every review point receives either a revision or a reasoned refusal. | Framework-derived, appropriate at this grade |
| That review responses require complete coverage. | What this specific activity can show |
| Whether the reviewer was right. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 8 — Reviewing The Inference, Not The Framework — specifically: students avoid the two standard reviewer failures.

**How it was taught.** Through the activity: audit their own past reviews for both failure directions

**Quick check.** Ask for the closing sentence of Session 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 8: audit their own past reviews for both failure directions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A response letter with a reasoned refusal on one point. |
| **Non-example** | A response letter omitting two review points. |
...
> "Rigour substituting for relevance is this cohort's failure."
...
**Exact wording.** "Say: at least one of your three reviews is wrong. Revise against all three anyway."
...
**Target observation.** That review responses require complete coverage.
...
> "Every review point receives either a revision or a reasoned refusal. You just saw that when say: at least one of your three reviews is wrong.
> Last time we said: Rigour substituting for relevance is this cohort's failure. This is the next part of that.
...
**What students must not infer.** Whether the reviewer was right.

### 4. Worked example

**The example.** A response letter with a reasoned refusal on one point.
...
**Completed answer.** A response letter with a reasoned refusal on one point. — which demonstrates that review responses require complete coverage.
...
**Conclusions not licensed.** Whether the reviewer was right.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A revision made in response to a point the author disputes. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A response letter omitting two review points. Why is this not an
example?"
...
**Exact student instructions.** Write a full response letter addressing every point.
...
- *Licensed conclusion.* That review responses require complete coverage.
- *Not licensed.* Whether the reviewer was right.
...
- *Expected response.* That review responses require complete coverage.
...
1. Any wording carrying the idea in `Every review point receives either a revision or a reasoned refusal`.
...
Say: "A reasoned refusal is legitimate. Silence is not."
...
| | |
|---|---|
| **Follows** | Session 8 — Reviewing The Inference, Not The Framework |
| **Leads to** | Session 10 — The Revised Design |

**Transition in.** Session 8 established students avoid the two standard reviewer failures. This session uses that as the starting point.

**Transition out.** This session establishes students revise against reviews they disagree with. Session 10 assumes it and builds students demonstrate improvement against measured criteria.
