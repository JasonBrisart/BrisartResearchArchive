# Session 4 — The Adjudication Section
...
| | |
|---|---|
| **Central question** | The Adjudication Section: students audit whether rivals are fairly stated and separated? |
| **Core concept** | Auditing adjudication means naming which rival best explains the anticipated result. |
| **Student outcome** | Students audit whether rivals are fairly stated and separated. |
| **Previous session** | Session 3 — The Measurement Section |
| **Next session** | Session 5 — The Falsifiability Section |
| **Materials** | Specimen manuscripts supplied by the instructor; review protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_04_Printout.md` |
| **Homework** | `Homework/Session_04_Homework.md` |

## Why this lesson exists

**The conceptual step.** Auditing adjudication means naming which rival best explains the anticipated result. Asserting that a design adjudicates without naming the competitor is not an audit.
...
**What depends on it.** Session 5 — The Falsifiability Section — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Auditing adjudication means naming which rival best explains the anticipated result. Asserting that a design adjudicates without naming the competitor is not an audit.
...
1. An audit naming the arousal account as the best rival explanation.
2. An audit finding the rival was weakened in operationalisation.

### One non-example

An audit asserting the design adjudicates adequately.
...
That adjudication audits name specific rivals.
...
| Statement | Status |
|---|---|
| Auditing adjudication means naming which rival best explains the anticipated result. | Framework-derived, appropriate at this grade |
| That adjudication audits name specific rivals. | What this specific activity can show |
| Which account is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 3 — The Measurement Section — specifically: students audit construct validity and prespecification.

**How it was taught.** Through the activity: audit two designs against the four measurement checks with specific findings

**Quick check.** Ask for the closing sentence of Session 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 3: audit two designs against the four measurement checks with specific findings, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit naming the arousal account as the best rival explanation. |
| **Non-example** | An audit asserting the design adjudicates adequately. |
...
**Student materials.** One copy of `Printouts/Session_04_Printout.md` per student.

**Prior student data required.** Work produced in Session 3, kept in the student's folder.
...
**File.** `Printouts/Session_04_Printout.md`
...
> "Construct validity is the check reviewers skip."
...
**Exact wording.** "Say: the check most reviewers omit is whether the rival's proponents would accept it."
...
**Target observation.** That adjudication audits name specific rivals.
...
> "Auditing adjudication means naming which rival best explains the anticipated result. You just saw that when say: the check most reviewers omit is whether the rival's proponents would accept it.
> Last time we said: Construct validity is the check reviewers skip. This is the next part of that.
...
**What students must not infer.** Which account is correct.

### 4. Worked example

**The example.** An audit naming the arousal account as the best rival explanation.
...
**Completed answer.** An audit naming the arousal account as the best rival explanation. — which demonstrates that adjudication audits name specific rivals.
...
**Conclusions not licensed.** Which account is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An audit finding the rival was weakened in operationalisation. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit asserting the design adjudicates adequately. Why is this not an
example?"
...
**Exact student instructions.** Audit two designs and name which rival best explains the anticipated result.
...
- *Licensed conclusion.* That adjudication audits name specific rivals.
- *Not licensed.* Which account is correct.
...
- *Expected response.* That adjudication audits name specific rivals.
...
1. Any wording carrying the idea in `Auditing adjudication means naming which rival best explains the anticipated result`.
...
Say: "If you cannot name it, you have not audited adjudication."

**Why this sentence matters.** It is the opening question of Session 5, which assumes students arrive holding it.
...
**File.** `Homework/Session_04_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 3 — The Measurement Section |
| **Leads to** | Session 5 — The Falsifiability Section |

**Transition in.** Session 3 established students audit construct validity and prespecification. This session uses that as the starting point.

**Transition out.** This session establishes students audit whether rivals are fairly stated and separated. Session 5 assumes it and builds students audit whether the condition could fire.
