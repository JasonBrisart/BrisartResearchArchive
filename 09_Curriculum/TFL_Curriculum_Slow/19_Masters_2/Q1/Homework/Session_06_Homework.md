# Session 6 Homework — Scope And Recommendation

**Master's Year 2** · Design Review and Defence · **Quarter 1**
**Follows:** Session 6 — Scope And Recommendation · **Points:** 5 · **Optional:** yes
...
Two full six-section reviews with verdicts and ranked revisions.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every negative verdict names a specific blocking element
...
Session 7 is **Calibration**, which assumes you arrive holding it. Write one thing you expect it to be about:
