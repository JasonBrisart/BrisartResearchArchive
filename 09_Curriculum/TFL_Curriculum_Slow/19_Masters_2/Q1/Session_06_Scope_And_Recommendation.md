# Session 6 — Scope And Recommendation
...
| | |
|---|---|
| **Central question** | Scope And Recommendation: students complete a review with a defensible verdict? |
| **Core concept** | A review verdict names the specific blocking element, and revisions are ranked so the author knows what to fix first. |
| **Student outcome** | Students complete a review with a defensible verdict. |
| **Previous session** | Session 5 — The Falsifiability Section |
| **Next session** | Session 7 — Calibration |
...
**The conceptual step.** A review verdict names the specific blocking element, and revisions are ranked so the author knows what to fix first. Unranked lists are not actionable.
...
**What depends on it.** Session 7 — Calibration — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A review verdict names the specific blocking element, and revisions are ranked so the author knows what to fix first. Unranked lists are not actionable.
...
1. A negative verdict naming the unfalsifiable condition as blocking.
2. Three revisions ranked by consequence.

### One non-example

A list of six revisions in no particular order.
...
That reviews produce actionable ranked output.

### What this activity does not establish

Whether the design should proceed.
...
| Statement | Status |
|---|---|
| A review verdict names the specific blocking element, and revisions are ranked so the author knows what to fix first. | Framework-derived, appropriate at this grade |
| That reviews produce actionable ranked output. | What this specific activity can show |
| Whether the design should proceed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 5 — The Falsifiability Section — specifically: students audit whether the condition could fire.

**How it was taught.** Through the activity: audit two designs, tracing each firing pathway personally

**Quick check.** Ask for the closing sentence of Session 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 5: audit two designs, tracing each firing pathway personally, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A negative verdict naming the unfalsifiable condition as blocking. |
| **Non-example** | A list of six revisions in no particular order. |
...
> "The author asserting it fires is not evidence."
...
**Exact wording.** "Say: two scope checks, then three ranked revisions."
...
**Target observation.** That reviews produce actionable ranked output.
...
> "A review verdict names the specific blocking element, and revisions are ranked so the author knows what to fix first. You just saw that when say: two scope checks, then three ranked revisions.
> Last time we said: The author asserting it fires is not evidence. This is the next part of that.
...
**What students must not infer.** Whether the design should proceed.

### 4. Worked example

**The example.** A negative verdict naming the unfalsifiable condition as blocking.
...
**Completed answer.** A negative verdict naming the unfalsifiable condition as blocking. — which demonstrates that reviews produce actionable ranked output.
...
**Conclusions not licensed.** Whether the design should proceed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Three revisions ranked by consequence. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A list of six revisions in no particular order. Why is this not an
example?"
...
**Exact student instructions.** Two full six-section reviews with verdicts and ranked revisions.
...
- *Licensed conclusion.* That reviews produce actionable ranked output.
- *Not licensed.* Whether the design should proceed.
...
- *Expected response.* That reviews produce actionable ranked output.
...
1. Any wording carrying the idea in `A review verdict names the specific blocking element, and revisions are ranked so the author knows what to fix first`.
...
Say: "Unranked revisions tell the author nothing about what to fix first."
...
| | |
|---|---|
| **Follows** | Session 5 — The Falsifiability Section |
| **Leads to** | Session 7 — Calibration |

**Transition in.** Session 5 established students audit whether the condition could fire. This session uses that as the starting point.

**Transition out.** This session establishes students complete a review with a defensible verdict. Session 7 assumes it and builds students compare their review against others of the same work.
