# Session 3 — The Measurement Section
...
| | |
|---|---|
| **Central question** | The Measurement Section: students audit construct validity and prespecification? |
| **Core concept** | A measurement audit produces findings rather than verdicts. |
| **Student outcome** | Students audit construct validity and prespecification. |
| **Previous session** | Session 2 — The Executability Section |
| **Next session** | Session 4 — The Adjudication Section |
...
**The conceptual step.** A measurement audit produces findings rather than verdicts. Construct validity is the check most reviewers skip because it requires proposing alternative constructs.
...
**What depends on it.** Session 4 — The Adjudication Section — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A measurement audit produces findings rather than verdicts. Construct validity is the check most reviewers skip because it requires proposing alternative constructs.
...
1. A finding naming an alternative construct the instrument may capture.
2. A finding that prespecification was asserted but not evidenced.

### One non-example

A section reading: measurement appears adequate.
...
That audits produce located findings.
...
| Statement | Status |
|---|---|
| A measurement audit produces findings rather than verdicts. | Framework-derived, appropriate at this grade |
| That audits produce located findings. | What this specific activity can show |
| Whether the instrument is valid. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 2 — The Executability Section — specifically: students audit whether a design can be run at all.

**How it was taught.** Through the activity: executability audits on two designs with complete clarification lists

**Quick check.** Ask for the closing sentence of Session 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 2: executability audits on two designs with complete clarification lists, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A finding naming an alternative construct the instrument may capture. |
| **Non-example** | A section reading: measurement appears adequate. |
...
> "An empty list must be stated explicitly."
...
**Exact wording.** "Put a technically sound instrument up and ask what it is measuring."
...
**Target observation.** That audits produce located findings.
...
> "A measurement audit produces findings rather than verdicts. You just saw that when put a technically sound instrument up and ask what it is measuring.
> Last time we said: An empty list must be stated explicitly. This is the next part of that.
...
**The example.** A finding naming an alternative construct the instrument may capture.
...
**Completed answer.** A finding naming an alternative construct the instrument may capture. — which demonstrates that audits produce located findings.
...
**Teacher prompt.** "Here is a second case. A finding that prespecification was asserted but not evidenced. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A section reading: measurement appears adequate. Why is this not an
example?"
...
**Exact student instructions.** Audit two designs against the four measurement checks with specific findings.
...
- *Licensed conclusion.* That audits produce located findings.
...
- *Expected response.* That audits produce located findings.
...
1. Any wording carrying the idea in `A measurement audit produces findings rather than verdicts`.
...
Say: "Construct validity is the check reviewers skip."
...
| | |
|---|---|
| **Follows** | Session 2 — The Executability Section |
| **Leads to** | Session 4 — The Adjudication Section |

**Transition in.** Session 2 established students audit whether a design can be run at all. This session uses that as the starting point.

**Transition out.** This session establishes students audit construct validity and prespecification. Session 4 assumes it and builds students audit whether rivals are fairly stated and separated.
