...
| **Core concept** | The four exit outcomes together constitute readiness for Grade 4, which asks what happens to a moment once the next one begins. |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 4, which asks what happens to a moment once the next one begins.
...
The four exit outcomes together constitute readiness for Grade 4, which asks what happens to a moment once the next one begins.
...
2. A student completes the decomposition fully and the rest adequately.

### One non-example

A student who writes at length on reconstruction and omits decomposition.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 4, which asks what happens to a moment once the next one begins. | Framework-derived, appropriate at this grade |
...
| **Non-example** | A student who writes at length on reconstruction and omits decomposition. |
...
> "The four exit outcomes together constitute readiness for Grade 4, which asks what happens to a moment once the next one begins. You just saw that when say: everything you know, on your own.
...
**Teacher prompt.** "Here is a second case. A student completes the decomposition fully and the rest adequately. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student who writes at length on reconstruction and omits decomposition. Why is this not an
example?"
...
**Exact student instructions.** The final: a full supported reconstruction, a decomposition checked forwards, two viewpoints.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 4, which asks what happens to a moment once the next one begins`.
...
Say: "Next year: nothing starts from zero."
