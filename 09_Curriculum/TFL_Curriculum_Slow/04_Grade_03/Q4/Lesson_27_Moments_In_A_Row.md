...
| | |
|---|---|
| **Central question** | Moments In A Row: students reconstruct two consecutive moments? |
| **Core concept** | Two adjacent moments can both be reconstructed. |
| **Student outcome** | Students reconstruct two consecutive moments. |
| **Previous lesson** | Lesson 26 — One Part Changes Everything |
| **Next lesson** | Lesson 28 — What Happens To The Moment |
...
**The conceptual step.** Two adjacent moments can both be reconstructed. The question of what connects them is deliberately left open until Grade 4.
...
**What depends on it.** Lesson 28 — What Happens To The Moment — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Two adjacent moments can both be reconstructed. The question of what connects them is deliberately left open until Grade 4.
...
1. Two reconstructions from the same minute, in order.
2. A student noticing the second contains something from the first.

### One non-example

Two reconstructions from different parts of the day.
...
That adjacent moments can both be captured.

### What this activity does not establish

What connects them, which is next year.
...
| Statement | Status |
|---|---|
| Two adjacent moments can both be reconstructed. | Framework-derived, appropriate at this grade |
| That adjacent moments can both be captured. | What this specific activity can show |
| What connects them, which is next year. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — One Part Changes Everything — specifically: students test what happens when each part is varied.

**How it was taught.** Through the activity: three thought experiments, one per part, each with the resulting moment

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: three thought experiments, one per part, each with the resulting moment, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two reconstructions from the same minute, in order. |
| **Non-example** | Two reconstructions from different parts of the day. |
...
**Exact wording.** "Ask them to reconstruct this moment, then the one right after it."
...
**Target observation.** That adjacent moments can both be captured.
...
> "Two adjacent moments can both be reconstructed. You just saw that when ask them to reconstruct this moment, then the one right after it.
> Last time we said: The parts are not independent of each other. This is the next part of that.
...
**What students must not infer.** What connects them, which is next year.

### 4. Worked example

**The example.** Two reconstructions from the same minute, in order.
...
**Completed answer.** Two reconstructions from the same minute, in order. — which demonstrates that adjacent moments can both be captured.
...
**Conclusions not licensed.** What connects them, which is next year.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student noticing the second contains something from the first. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two reconstructions from different parts of the day. Why is this not an
example?"
...
**Exact student instructions.** Two consecutive reconstructions from the same minute.
...
- *Licensed conclusion.* That adjacent moments can both be captured.
- *Not licensed.* What connects them, which is next year.
...
- *Expected response.* That adjacent moments can both be captured.
...
1. Any wording carrying the idea in `Two adjacent moments can both be reconstructed`.
...
Say: "They happened one after the other. Something connects them."
...
| | |
|---|---|
| **Follows** | Lesson 26 — One Part Changes Everything |
| **Leads to** | Lesson 28 — What Happens To The Moment |

**Transition in.** Lesson 26 established students test what happens when each part is varied. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students reconstruct two consecutive moments. Lesson 28 assumes it and builds students confront the open question of what happens next.
