# Lesson 27 Homework — Moments In A Row

**Grade 3** · Right Now · **Quarter 4**
**Follows:** Lesson 27 — Moments In A Row · **Points:** 5 · **Optional:** yes
...
Two consecutive reconstructions from the same minute.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has two reconstructions from consecutive moments
...
Lesson 28 is **What Happens To The Moment**, which assumes you arrive holding it. Write one thing you expect it to be about:
