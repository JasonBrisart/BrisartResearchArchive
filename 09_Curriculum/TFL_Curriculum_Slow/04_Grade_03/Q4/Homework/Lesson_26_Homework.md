# Lesson 26 Homework — One Part Changes Everything

**Grade 3** · Right Now · **Quarter 4**
**Follows:** Lesson 26 — One Part Changes Everything · **Points:** 5 · **Optional:** yes
...
Three thought experiments, one per part, each with the resulting moment.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces three varied moments
...
Lesson 27 is **Moments In A Row**, which assumes you arrive holding it. Write one thing you expect it to be about:
