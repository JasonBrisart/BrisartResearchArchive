...
| **Core concept** | The practice final is a diagnostic. |
| **Student outcome** | Students rehearse the final under conditions. |
| **Previous lesson** | Lesson 30 — The Year In Reconstructions |
...
**The conceptual step.** The practice final is a diagnostic. Self-marking against the key is what turns a score into a list of things to review.
...
The practice final is a diagnostic. Self-marking against the key is what turns a score into a list of things to review.
...
1. A student identifying the forward check as their weak point.
2. A student finding their final lines are still lists.
...
| Statement | Status |
|---|---|
| The practice final is a diagnostic. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 30 — The Year In Reconstructions — specifically: students review the year using their own work.

**How it was taught.** Through the activity: order their own work by term and compare an early one with a late one

**Quick check.** Ask for the closing sentence of Lesson 30. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 30: order their own work by term and compare an early one with a late one, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student identifying the forward check as their weak point. |
...
> "The practice final is a diagnostic. You just saw that when say: same as the real one.
...
**The example.** A student identifying the forward check as their weak point.
...
**Completed answer.** A student identifying the forward check as their weak point. — which demonstrates where each student is weakest.
...
**Teacher prompt.** "Here is a second case. A student finding their final lines are still lists. Work it through with me."
...
1. Any wording carrying the idea in `The practice final is a diagnostic`.
...
| | |
|---|---|
| **Follows** | Lesson 30 — The Year In Reconstructions |
| **Leads to** | Lesson 32 — Final Assessment |

**Transition in.** Lesson 30 established students review the year using their own work. This lesson uses that as the starting point.
