# Lesson 29 — Explaining Right Now
...
| | |
|---|---|
| **Central question** | Explaining Right Now: students explain the combined moment to somebody else? |
| **Core concept** | Explaining the combined moment tests whether the student holds the combination or only the three-part list. |
| **Student outcome** | Students explain the combined moment to somebody else. |
| **Previous lesson** | Lesson 28 — What Happens To The Moment |
| **Next lesson** | Lesson 30 — The Year In Reconstructions |
...
**The conceptual step.** Explaining the combined moment tests whether the student holds the combination or only the three-part list. The listener's question locates the gap.
...
**What depends on it.** Lesson 30 — The Year In Reconstructions — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Explaining the combined moment tests whether the student holds the combination or only the three-part list. The listener's question locates the gap.
...
1. A listener asks whether everyone has the same right now.
2. A listener asks what happens when you are asleep.

### One non-example

Reporting that the listener understood it immediately.
...
Where the student's understanding runs out.
...
| Statement | Status |
|---|---|
| Explaining the combined moment tests whether the student holds the combination or only the three-part list. | Framework-derived, appropriate at this grade |
| Where the student's understanding runs out. | What this specific activity can show |
| Whether the explanation was accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — What Happens To The Moment — specifically: students confront the open question of what happens next.

**How it was taught.** Through the activity: each student writes and seals an answer, dated, for Grade 4 Lesson 1

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: each student writes and seals an answer, dated, for Grade 4 Lesson 1, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A listener asks whether everyone has the same right now. |
| **Non-example** | Reporting that the listener understood it immediately. |
...
> "Next year you find out. I am not telling you today."
...
**Target observation.** Where the student's understanding runs out.
...
> "Explaining the combined moment tests whether the student holds the combination or only the three-part list. You just saw that when say: today you teach it.
> Last time we said: Next year you find out. I am not telling you today. This is the next part of that.
...
**What students must not infer.** Whether the explanation was accurate.

### 4. Worked example

**The example.** A listener asks whether everyone has the same right now.
...
**Completed answer.** A listener asks whether everyone has the same right now. — which demonstrates where the student's understanding runs out.
...
**Conclusions not licensed.** Whether the explanation was accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A listener asks what happens when you are asleep. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reporting that the listener understood it immediately. Why is this not an
example?"
...
**Exact student instructions.** Each student explains right now to a buddy and records one question asked.
...
- *Licensed conclusion.* Where the student's understanding runs out.
- *Not licensed.* Whether the explanation was accurate.
...
- *Expected response.* Where the student's understanding runs out.
...
1. Any wording carrying the idea in `Explaining the combined moment tests whether the student holds the combination or only the three-part list`.
...
| | |
|---|---|
| **Follows** | Lesson 28 — What Happens To The Moment |
| **Leads to** | Lesson 30 — The Year In Reconstructions |

**Transition in.** Lesson 28 established students confront the open question of what happens next. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain the combined moment to somebody else. Lesson 30 assumes it and builds students review the year using their own work.
