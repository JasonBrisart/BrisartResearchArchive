# Lesson 25 — When The Moment Was Wrong
...
| | |
|---|---|
| **Central question** | When The Moment Was Wrong: students reconstruct a moment whose expectation failed? |
| **Core concept** | Between two adjacent moments, usually only one part changes. |
| **Student outcome** | Students reconstruct a moment whose expectation failed. |
| **Previous lesson** | Lesson 24 — The Evidence Review |
| **Next lesson** | Lesson 26 — One Part Changes Everything |
...
**The conceptual step.** Between two adjacent moments, usually only one part changes. Identifying which one shows that the moment is built rather than replaced wholesale.
...
**What depends on it.** Lesson 26 — One Part Changes Everything — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Between two adjacent moments, usually only one part changes. Identifying which one shows that the moment is built rather than replaced wholesale.
...
1. The noticing changed; the remembering did not.
2. A student notices their memory could not have changed that fast.

### One non-example

A claim that all three parts changed in half a second.
...
That a single changed part alters the whole moment.

### What this activity does not establish

Why that part changed.
...
| Statement | Status |
|---|---|
| Between two adjacent moments, usually only one part changes. | Framework-derived, appropriate at this grade |
| That a single changed part alters the whole moment. | What this specific activity can show |
| Why that part changed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 24 — The Evidence Review — specifically: students consolidate evidence for reconstructions.

**How it was taught.** Through the activity: review with six reconstructions audited for evidence

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: review with six reconstructions audited for evidence, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The noticing changed; the remembering did not. |
| **Non-example** | A claim that all three parts changed in half a second. |
...
> "Next time: what happens to a moment when the next one starts."
...
**Exact wording.** "Run a sound break with no warning, then ask them to reconstruct the half-second before and after."
...
**Target observation.** That a single changed part alters the whole moment.
...
> "Between two adjacent moments, usually only one part changes. You just saw that when run a sound break with no warning, then ask them to reconstruct the half-second before and after.
> Last time we said: Next time: what happens to a moment when the next one starts. This is the next part of that.
...
**What students must not infer.** Why that part changed.

### 4. Worked example

**The example.** The noticing changed; the remembering did not.
...
**Completed answer.** The noticing changed; the remembering did not. — which demonstrates that a single changed part alters the whole moment.
...
**Conclusions not licensed.** Why that part changed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student notices their memory could not have changed that fast. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that all three parts changed in half a second. Why is this not an
example?"
...
**Exact student instructions.** Both moments reconstructed in full; identify which part changed.
...
- *Licensed conclusion.* That a single changed part alters the whole moment.
- *Not licensed.* Why that part changed.
...
- *Expected response.* That a single changed part alters the whole moment.
...
1. Any wording carrying the idea in `Between two adjacent moments, usually only one part changes`.
...
Say: "One part changed and the whole moment changed with it."
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Evidence Review |
| **Leads to** | Lesson 26 — One Part Changes Everything |

**Transition in.** Lesson 24 established students consolidate evidence for reconstructions. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students reconstruct a moment whose expectation failed. Lesson 26 assumes it and builds students test what happens when each part is varied.
