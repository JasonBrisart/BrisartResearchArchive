# Lesson 19 Homework — Evidence From Somebody Else

**Grade 3** · Right Now · **Quarter 3**
**Follows:** Lesson 19 — Evidence From Somebody Else · **Points:** 5 · **Optional:** yes
...
Strengthen two weak lines using a second person's account.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student strengthens at least one line with external evidence
...
Lesson 20 is **When Accounts Disagree**, which assumes you arrive holding it. Write one thing you expect it to be about:
