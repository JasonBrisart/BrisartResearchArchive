# Lesson 22 — Repairing A Reconstruction
...
| | |
|---|---|
| **Central question** | Repairing A Reconstruction: students repair a reconstruction after audit? |
| **Core concept** | A marked line is repaired either by supplying evidence or by adding the question mark. |
| **Student outcome** | Students repair a reconstruction after audit. |
| **Previous lesson** | Lesson 21 — The Question Mark Audit |
| **Next lesson** | Lesson 23 — The Full Reconstruction |
...
**The conceptual step.** A marked line is repaired either by supplying evidence or by adding the question mark. Both are legitimate; defending without changing anything is not.
...
**What depends on it.** Lesson 23 — The Full Reconstruction — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A marked line is repaired either by supplying evidence or by adding the question mark. Both are legitimate; defending without changing anything is not.
...
1. A line repaired by adding pointable evidence.
2. A line repaired by adding a question mark.

### One non-example

A line defended on the grounds that the student remembers it clearly.
...
That repair takes two legitimate forms.

### What this activity does not establish

That the repaired reconstruction is accurate.
...
| Statement | Status |
|---|---|
| A marked line is repaired either by supplying evidence or by adding the question mark. | Framework-derived, appropriate at this grade |
| That repair takes two legitimate forms. | What this specific activity can show |
| That the repaired reconstruction is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 21 — The Question Mark Audit — specifically: students audit a partner's reconstruction for unmarked gaps.

**How it was taught.** Through the activity: audit a partner's two reconstructions for unmarked unsupported lines

**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: audit a partner's two reconstructions for unmarked unsupported lines, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A line repaired by adding pointable evidence. |
| **Non-example** | A line defended on the grounds that the student remembers it clearly. |
...
> "The unmarked ones are the ones to watch."
...
**Exact wording.** "Say: yours came back marked. Fix it, do not argue."
...
**Target observation.** That repair takes two legitimate forms.
...
> "A marked line is repaired either by supplying evidence or by adding the question mark. You just saw that when say: yours came back marked.
> Last time we said: The unmarked ones are the ones to watch. This is the next part of that.
...
**What students must not infer.** That the repaired reconstruction is accurate.

### 4. Worked example

**The example.** A line repaired by adding pointable evidence.
...
**Completed answer.** A line repaired by adding pointable evidence. — which demonstrates that repair takes two legitimate forms.
...
**Conclusions not licensed.** That the repaired reconstruction is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A line repaired by adding a question mark. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A line defended on the grounds that the student remembers it clearly. Why is this not an
example?"
...
**Exact student instructions.** Repair every marked line, either with evidence or a question mark.
...
- *Licensed conclusion.* That repair takes two legitimate forms.
- *Not licensed.* That the repaired reconstruction is accurate.
...
- *Expected response.* That repair takes two legitimate forms.
...
1. Any wording carrying the idea in `A marked line is repaired either by supplying evidence or by adding the question mark`.
...
Say: "A question mark is a legitimate repair."
...
| | |
|---|---|
| **Follows** | Lesson 21 — The Question Mark Audit |
| **Leads to** | Lesson 23 — The Full Reconstruction |

**Transition in.** Lesson 21 established students audit a partner's reconstruction for unmarked gaps. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students repair a reconstruction after audit. Lesson 23 assumes it and builds students produce a supported reconstruction unaided.
