# Lesson 18 — Strong And Weak Lines

**Grade 3** · Right Now · **Quarter 3** · **35 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Strong And Weak Lines: students rank the lines of a reconstruction by evidential strength? |
| **Core concept** | Lines within one reconstruction differ in how well they are supported. |
| **Student outcome** | Students rank the lines of a reconstruction by evidential strength. |
| **Previous lesson** | Lesson 17 — Evidence For A Moment |
| **Next lesson** | Lesson 19 — Evidence From Somebody Else |
...
**The conceptual step.** Lines within one reconstruction differ in how well they are supported. Ranking them makes the weakest link visible, which is where the reconstruction would fail.
...
**What depends on it.** Lesson 19 — Evidence From Somebody Else — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Lines within one reconstruction differ in how well they are supported. Ranking them makes the weakest link visible, which is where the reconstruction would fail.
...
1. The noticing line ranked strongest because others saw it.
2. The remembering line ranked weakest because only the student has it.

### One non-example

Ranking by how confident the student feels about each line.
...
That support varies within a single reconstruction.

### What this activity does not establish

Whether the strongest line is true.
...
| Statement | Status |
|---|---|
| Lines within one reconstruction differ in how well they are supported. | Framework-derived, appropriate at this grade |
| That support varies within a single reconstruction. | What this specific activity can show |
| Whether the strongest line is true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Evidence For A Moment — specifically: students support a reconstruction with pointable evidence.

**How it was taught.** Through the activity: add evidence to every line of two reconstructions; unsupported lines get a question mark

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: add evidence to every line of two reconstructions; unsupported lines get a question mark, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The noticing line ranked strongest because others saw it. |
| **Non-example** | Ranking by how confident the student feels about each line. |
...
> "A line you cannot support gets a question mark, not a deletion."
...
**Exact wording.** "Put up one reconstruction with lines of obviously varying support."
...
**Target observation.** That support varies within a single reconstruction.
...
> "Lines within one reconstruction differ in how well they are supported. You just saw that when put up one reconstruction with lines of obviously varying support.
> Last time we said: A line you cannot support gets a question mark, not a deletion. This is the next part of that.
...
**What students must not infer.** Whether the strongest line is true.

### 4. Worked example

**The example.** The noticing line ranked strongest because others saw it.
...
**Completed answer.** The noticing line ranked strongest because others saw it. — which demonstrates that support varies within a single reconstruction.
...
**Conclusions not licensed.** Whether the strongest line is true.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The remembering line ranked weakest because only the student has it. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Ranking by how confident the student feels about each line. Why is this not an
example?"
...
**Exact student instructions.** Rank the five lines of their own reconstruction from strongest to weakest.
...
- *Licensed conclusion.* That support varies within a single reconstruction.
- *Not licensed.* Whether the strongest line is true.
...
- *Expected response.* That support varies within a single reconstruction.
...
1. Any wording carrying the idea in `Lines within one reconstruction differ in how well they are supported`.
...
Say: "Some lines are better supported than others."
...
| | |
|---|---|
| **Follows** | Lesson 17 — Evidence For A Moment |
| **Leads to** | Lesson 19 — Evidence From Somebody Else |

**Transition in.** Lesson 17 established students support a reconstruction with pointable evidence. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students rank the lines of a reconstruction by evidential strength. Lesson 19 assumes it and builds students use a second person's account as evidence.
