# Lesson 20 — When Accounts Disagree
...
| | |
|---|---|
| **Central question** | When Accounts Disagree: students handle two accounts that conflict? |
| **Core concept** | When two accounts conflict, both are recorded and the resolving observation is named. |
| **Student outcome** | Students handle two accounts that conflict. |
| **Previous lesson** | Lesson 19 — Evidence From Somebody Else |
| **Next lesson** | Lesson 21 — The Question Mark Audit |
...
**The conceptual step.** When two accounts conflict, both are recorded and the resolving observation is named. Discarding the inconvenient one is the error this lesson prevents.
...
**What depends on it.** Lesson 21 — The Question Mark Audit — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

When two accounts conflict, both are recorded and the resolving observation is named. Discarding the inconvenient one is the error this lesson prevents.
...
1. Both accounts written, with a named observation that would settle it.
2. A conflict left unresolved with the resolver named.

### One non-example

Keeping the account that matches the student's own.
...
| Statement | Status |
|---|---|
| When two accounts conflict, both are recorded and the resolving observation is named. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 19 — Evidence From Somebody Else — specifically: students use a second person's account as evidence.

**How it was taught.** Through the activity: strengthen two weak lines using a second person's account

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: strengthen two weak lines using a second person's account, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Both accounts written, with a named observation that would settle it. |
| **Non-example** | Keeping the account that matches the student's own. |
...
> "Another person's account is evidence you did not have."
...
**Exact wording.** "Present two conflicting accounts of one staged event."
...
> "When two accounts conflict, both are recorded and the resolving observation is named. You just saw that when present two conflicting accounts of one staged event.
> Last time we said: Another person's account is evidence you did not have. This is the next part of that.
...
**The example.** Both accounts written, with a named observation that would settle it.
...
**Completed answer.** Both accounts written, with a named observation that would settle it. — which demonstrates that conflicts are recorded rather than resolved by preference.
...
**Teacher prompt.** "Here is a second case. A conflict left unresolved with the resolver named. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Keeping the account that matches the student's own. Why is this not an
example?"
...
**Exact student instructions.** Reconcile the conflict: state both, explain it, and name what would resolve it.
...
1. Any wording carrying the idea in `When two accounts conflict, both are recorded and the resolving observation is named`.
...
| | |
|---|---|
| **Follows** | Lesson 19 — Evidence From Somebody Else |
| **Leads to** | Lesson 21 — The Question Mark Audit |

**Transition in.** Lesson 19 established students use a second person's account as evidence. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students handle two accounts that conflict. Lesson 21 assumes it and builds students audit a partner's reconstruction for unmarked gaps.
