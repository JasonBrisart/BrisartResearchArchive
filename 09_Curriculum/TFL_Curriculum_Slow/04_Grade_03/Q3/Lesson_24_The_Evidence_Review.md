...
| | |
|---|---|
| **Central question** | The Evidence Review: students consolidate evidence for reconstructions? |
| **Core concept** | The question-mark convention is what keeps a reconstruction honest. |
| **Student outcome** | Students consolidate evidence for reconstructions. |
| **Previous lesson** | Lesson 23 — The Full Reconstruction |
| **Next lesson** | Lesson 25 — When The Moment Was Wrong |
...
**The conceptual step.** The question-mark convention is what keeps a reconstruction honest. The review checks it is applied rather than quietly dropped.
...
**What depends on it.** Lesson 25 — When The Moment Was Wrong — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The question-mark convention is what keeps a reconstruction honest. The review checks it is applied rather than quietly dropped.
...
1. A reconstruction audited with two question marks added.
2. A student applying the pointing test unprompted.

### One non-example

An audit that adds no question marks to any reconstruction.
...
Whether the evidence convention is habitual.

### What this activity does not establish

Whether any reconstruction is true.
...
| Statement | Status |
|---|---|
| The question-mark convention is what keeps a reconstruction honest. | Framework-derived, appropriate at this grade |
| Whether the evidence convention is habitual. | What this specific activity can show |
| Whether any reconstruction is true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — The Full Reconstruction — specifically: students produce a supported reconstruction unaided.

**How it was taught.** Through the activity: two complete supported reconstructions, swapped for a forward check

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: two complete supported reconstructions, swapped for a forward check, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A reconstruction audited with two question marks added. |
| **Non-example** | An audit that adds no question marks to any reconstruction. |
...
> "You can take any moment apart and show your working."
...
**Exact wording.** "Ask what every line needs."
...
**Target observation.** Whether the evidence convention is habitual.
...
> "The question-mark convention is what keeps a reconstruction honest. You just saw that when ask what every line needs.
> Last time we said: You can take any moment apart and show your working. This is the next part of that.
...
**What students must not infer.** Whether any reconstruction is true.

### 4. Worked example

**The example.** A reconstruction audited with two question marks added.
...
**Completed answer.** A reconstruction audited with two question marks added. — which demonstrates whether the evidence convention is habitual.
...
**Conclusions not licensed.** Whether any reconstruction is true.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student applying the pointing test unprompted. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit that adds no question marks to any reconstruction. Why is this not an
example?"
...
**Exact student instructions.** Review with six reconstructions audited for evidence.
...
- *Licensed conclusion.* Whether the evidence convention is habitual.
- *Not licensed.* Whether any reconstruction is true.
...
- *Expected response.* Whether the evidence convention is habitual.
...
1. Any wording carrying the idea in `The question-mark convention is what keeps a reconstruction honest`.
...
Say: "Next time: what happens to a moment when the next one starts."
...
| | |
|---|---|
| **Follows** | Lesson 23 — The Full Reconstruction |
| **Leads to** | Lesson 25 — When The Moment Was Wrong |

**Transition in.** Lesson 23 established students produce a supported reconstruction unaided. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate evidence for reconstructions. Lesson 25 assumes it and builds students reconstruct a moment whose expectation failed.
