# Lesson 17 — Evidence For A Moment
...
| | |
|---|---|
| **Central question** | Evidence For A Moment: students support a reconstruction with pointable evidence? |
| **Core concept** | Every line of a reconstruction is a claim requiring support. |
| **Student outcome** | Students support a reconstruction with pointable evidence. |
| **Previous lesson** | Lesson 16 — The Decomposition Review |
| **Next lesson** | Lesson 18 — Strong And Weak Lines |
...
**The conceptual step.** Every line of a reconstruction is a claim requiring support. A line that cannot be supported is marked rather than removed, which preserves the honest record.
...
**What depends on it.** Lesson 18 — Strong And Weak Lines — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every line of a reconstruction is a claim requiring support. A line that cannot be supported is marked rather than removed, which preserves the honest record.
...
1. A noticing line supported by something others also saw.
2. A remembering line marked with a question mark.

### One non-example

A remembering line supported by an invented detail.
...
That reconstruction lines are claims requiring support.

### What this activity does not establish

That the supported lines are true.
...
| Statement | Status |
|---|---|
| Every line of a reconstruction is a claim requiring support. | Framework-derived, appropriate at this grade |
| That reconstruction lines are claims requiring support. | What this specific activity can show |
| That the supported lines are true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Decomposition Review — specifically: students consolidate decomposition.

**How it was taught.** Through the activity: review with eight decompositions to check forwards

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with eight decompositions to check forwards, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A noticing line supported by something others also saw. |
| **Non-example** | A remembering line supported by an invented detail. |
...
> "Next time: how do we know any of this is true?"
...
**Exact wording.** "Put an unsupported reconstruction on the board and ask how we know any of it."
...
**Target observation.** That reconstruction lines are claims requiring support.
...
> "Every line of a reconstruction is a claim requiring support. You just saw that when put an unsupported reconstruction on the board and ask how we know any of it.
> Last time we said: Next time: how do we know any of this is true? This is the next part of that.
...
**What students must not infer.** That the supported lines are true.

### 4. Worked example

**The example.** A noticing line supported by something others also saw.
...
**Completed answer.** A noticing line supported by something others also saw. — which demonstrates that reconstruction lines are claims requiring support.
...
**Conclusions not licensed.** That the supported lines are true.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A remembering line marked with a question mark. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A remembering line supported by an invented detail. Why is this not an
example?"
...
**Exact student instructions.** Add evidence to every line of two reconstructions; unsupported lines get a question mark.
...
- *Licensed conclusion.* That reconstruction lines are claims requiring support.
- *Not licensed.* That the supported lines are true.
...
- *Expected response.* That reconstruction lines are claims requiring support.
...
1. Any wording carrying the idea in `Every line of a reconstruction is a claim requiring support`.
...
Say: "A line you cannot support gets a question mark, not a deletion."
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Decomposition Review |
| **Leads to** | Lesson 18 — Strong And Weak Lines |

**Transition in.** Lesson 16 established students consolidate decomposition. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students support a reconstruction with pointable evidence. Lesson 18 assumes it and builds students rank the lines of a reconstruction by evidential strength.
