# Lesson 19 — Evidence From Somebody Else
...
| | |
|---|---|
| **Central question** | Evidence From Somebody Else: students use a second person's account as evidence? |
| **Core concept** | A second person's account is external evidence. |
| **Student outcome** | Students use a second person's account as evidence. |
| **Previous lesson** | Lesson 18 — Strong And Weak Lines |
| **Next lesson** | Lesson 20 — When Accounts Disagree |
...
**The conceptual step.** A second person's account is external evidence. It must be obtained and recorded rather than assumed, because the assumption is usually that it agrees.
...
**What depends on it.** Lesson 20 — When Accounts Disagree — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A second person's account is external evidence. It must be obtained and recorded rather than assumed, because the assumption is usually that it agrees.
...
1. A partner's recorded words confirming the noticing line.
2. A partner's account that does not confirm it, recorded anyway.

### One non-example

Assuming a partner would agree without asking.
...
That external accounts function as evidence.

### What this activity does not establish

Whether the external account is accurate.
...
| Statement | Status |
|---|---|
| A second person's account is external evidence. | Framework-derived, appropriate at this grade |
| That external accounts function as evidence. | What this specific activity can show |
| Whether the external account is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — Strong And Weak Lines — specifically: students rank the lines of a reconstruction by evidential strength.

**How it was taught.** Through the activity: rank the five lines of their own reconstruction from strongest to weakest

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: rank the five lines of their own reconstruction from strongest to weakest, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A partner's recorded words confirming the noticing line. |
| **Non-example** | Assuming a partner would agree without asking. |
...
> "Some lines are better supported than others."
...
**Exact wording.** "Ask who else was there and what they say."
...
**Target observation.** That external accounts function as evidence.
...
> "A second person's account is external evidence. You just saw that when ask who else was there and what they say.
> Last time we said: Some lines are better supported than others. This is the next part of that.
...
**What students must not infer.** Whether the external account is accurate.

### 4. Worked example

**The example.** A partner's recorded words confirming the noticing line.
...
**Completed answer.** A partner's recorded words confirming the noticing line. — which demonstrates that external accounts function as evidence.
...
**Conclusions not licensed.** Whether the external account is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A partner's account that does not confirm it, recorded anyway. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Assuming a partner would agree without asking. Why is this not an
example?"
...
**Exact student instructions.** Strengthen two weak lines using a second person's account.
...
- *Licensed conclusion.* That external accounts function as evidence.
- *Not licensed.* Whether the external account is accurate.
...
- *Expected response.* That external accounts function as evidence.
...
1. Any wording carrying the idea in `A second person's account is external evidence`.
...
Say: "Another person's account is evidence you did not have."
...
| | |
|---|---|
| **Follows** | Lesson 18 — Strong And Weak Lines |
| **Leads to** | Lesson 20 — When Accounts Disagree |

**Transition in.** Lesson 18 established students rank the lines of a reconstruction by evidential strength. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students use a second person's account as evidence. Lesson 20 assumes it and builds students handle two accounts that conflict.
