# Lesson 21 — The Question Mark Audit
...
| | |
|---|---|
| **Central question** | The Question Mark Audit: students audit a partner's reconstruction for unmarked gaps? |
| **Core concept** | Unmarked unsupported lines are more dangerous than marked ones, because they look like supported claims. |
| **Student outcome** | Students audit a partner's reconstruction for unmarked gaps. |
| **Previous lesson** | Lesson 20 — When Accounts Disagree |
| **Next lesson** | Lesson 22 — Repairing A Reconstruction |
...
**The conceptual step.** Unmarked unsupported lines are more dangerous than marked ones, because they look like supported claims. Auditing finds them.
...
**What depends on it.** Lesson 22 — Repairing A Reconstruction — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Unmarked unsupported lines are more dangerous than marked ones, because they look like supported claims. Auditing finds them.
...
1. An audit naming line three as unsupported and unmarked.
2. An audit naming a line whose evidence cannot be pointed at.

### One non-example

An audit returning the reconstruction as fully supported.
...
That unmarked gaps are findable by another reader.

### What this activity does not establish

Whether the audited reconstruction is otherwise good.
...
| Statement | Status |
|---|---|
| Unmarked unsupported lines are more dangerous than marked ones, because they look like supported claims. | Framework-derived, appropriate at this grade |
| That unmarked gaps are findable by another reader. | What this specific activity can show |
| Whether the audited reconstruction is otherwise good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — When Accounts Disagree — specifically: students handle two accounts that conflict.

**How it was taught.** Through the activity: reconcile the conflict: state both, explain it, and name what would resolve it

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: reconcile the conflict: state both, explain it, and name what would resolve it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit naming line three as unsupported and unmarked. |
| **Non-example** | An audit returning the reconstruction as fully supported. |
...
> "You do not pick the one you like."
...
**Exact wording.** "Say: find the lines they should have question-marked and did not."
...
**Target observation.** That unmarked gaps are findable by another reader.
...
> "Unmarked unsupported lines are more dangerous than marked ones, because they look like supported claims. You just saw that when say: find the lines they should have question-marked and did not.
> Last time we said: You do not pick the one you like. This is the next part of that.
...
**What students must not infer.** Whether the audited reconstruction is otherwise good.

### 4. Worked example

**The example.** An audit naming line three as unsupported and unmarked.
...
**Completed answer.** An audit naming line three as unsupported and unmarked. — which demonstrates that unmarked gaps are findable by another reader.
...
**Conclusions not licensed.** Whether the audited reconstruction is otherwise good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An audit naming a line whose evidence cannot be pointed at. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit returning the reconstruction as fully supported. Why is this not an
example?"
...
**Exact student instructions.** Audit a partner's two reconstructions for unmarked unsupported lines.
...
- *Licensed conclusion.* That unmarked gaps are findable by another reader.
- *Not licensed.* Whether the audited reconstruction is otherwise good.
...
- *Expected response.* That unmarked gaps are findable by another reader.
...
1. Any wording carrying the idea in `Unmarked unsupported lines are more dangerous than marked ones, because they look like supported claims`.
...
Say: "The unmarked ones are the ones to watch."
...
| | |
|---|---|
| **Follows** | Lesson 20 — When Accounts Disagree |
| **Leads to** | Lesson 22 — Repairing A Reconstruction |

**Transition in.** Lesson 20 established students handle two accounts that conflict. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit a partner's reconstruction for unmarked gaps. Lesson 22 assumes it and builds students repair a reconstruction after audit.
