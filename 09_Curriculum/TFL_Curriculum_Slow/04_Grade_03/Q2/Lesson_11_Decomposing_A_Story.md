...
| | |
|---|---|
| **Central question** | Decomposing A Story: students decompose a character's moment from a text? |
| **Core concept** | The method applies to described people as well as to the student. |
| **Student outcome** | Students decompose a character's moment from a text. |
| **Previous lesson** | Lesson 10 — Checking Forwards |
| **Next lesson** | Lesson 12 — Decomposing A Photograph |
...
**The conceptual step.** The method applies to described people as well as to the student. A character's reaction can be decomposed from what the text supplies.
...
**What depends on it.** Lesson 12 — Decomposing A Photograph — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The method applies to described people as well as to the student. A character's reaction can be decomposed from what the text supplies.
...
1. The character noticed the open door, remembered the warning, expected trouble.
2. A decomposition supported by lines from the passage.

### One non-example

A plot summary presented as a decomposition.
...
That the method works on described people.
...
| Statement | Status |
|---|---|
| The method applies to described people as well as to the student. | Framework-derived, appropriate at this grade |
| That the method works on described people. | What this specific activity can show |
| What the author intended. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 10 — Checking Forwards — specifically: students verify a decomposition by running it forwards.

**How it was taught.** Through the activity: check a partner's six decompositions forwards and mark those that fail

**Quick check.** Ask for the closing sentence of Lesson 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 10: check a partner's six decompositions forwards and mark those that fail, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The character noticed the open door, remembered the warning, expected trouble. |
| **Non-example** | A plot summary presented as a decomposition. |
...
> "Backwards to find them, forwards to check them."
...
**Exact wording.** "Read a short passage where a character reacts to something."
...
**Target observation.** That the method works on described people.
...
> "The method applies to described people as well as to the student. You just saw that when read a short passage where a character reacts to something.
> Last time we said: Backwards to find them, forwards to check them. This is the next part of that.
...
**The example.** The character noticed the open door, remembered the warning, expected trouble.
...
**Completed answer.** The character noticed the open door, remembered the warning, expected trouble. — which demonstrates that the method works on described people.
...
**Teacher prompt.** "Here is a second case. A decomposition supported by lines from the passage. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A plot summary presented as a decomposition. Why is this not an
example?"
...
**Exact student instructions.** Decompose three character moments from the passage.
...
- *Licensed conclusion.* That the method works on described people.
...
- *Expected response.* That the method works on described people.
...
1. Any wording carrying the idea in `The method applies to described people as well as to the student`.
...
Say: "It works on people in books too."
...
| | |
|---|---|
| **Follows** | Lesson 10 — Checking Forwards |
| **Leads to** | Lesson 12 — Decomposing A Photograph |

**Transition in.** Lesson 10 established students verify a decomposition by running it forwards. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students decompose a character's moment from a text. Lesson 12 assumes it and builds students decompose a moment from a still image.
