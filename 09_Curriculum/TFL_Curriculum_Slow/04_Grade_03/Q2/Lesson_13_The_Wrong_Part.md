...
| | |
|---|---|
| **Central question** | The Wrong Part: students find the single incorrect part in a decomposition? |
| **Core concept** | Locating which part is wrong is more useful than declaring the whole thing wrong. |
| **Student outcome** | Students find the single incorrect part in a decomposition. |
| **Previous lesson** | Lesson 12 — Decomposing A Photograph |
| **Next lesson** | Lesson 14 — Decomposing Your Own |
...
**The conceptual step.** Locating which part is wrong is more useful than declaring the whole thing wrong. Precision in the diagnosis is what makes repair possible.
...
**What depends on it.** Lesson 14 — Decomposing Your Own — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Locating which part is wrong is more useful than declaring the whole thing wrong. Precision in the diagnosis is what makes repair possible.
...
1. Naming the remembering line as the wrong one.
2. Correcting one part and leaving the other two.

### One non-example

Marking the whole decomposition as incorrect.
...
That errors can be located to a specific part.

### What this activity does not establish

Whether the corrected version is now right.
...
| Statement | Status |
|---|---|
| Locating which part is wrong is more useful than declaring the whole thing wrong. | Framework-derived, appropriate at this grade |
| That errors can be located to a specific part. | What this specific activity can show |
| Whether the corrected version is now right. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — Decomposing A Photograph — specifically: students decompose a moment from a still image.

**How it was taught.** Through the activity: three decompositions from three images, each checked forwards

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: three decompositions from three images, each checked forwards, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Naming the remembering line as the wrong one. |
| **Non-example** | Marking the whole decomposition as incorrect. |
...
> "You can do it with no words at all to go on."
...
**Exact wording.** "Put up a decomposition with exactly one wrong part and ask them to find it."
...
**Target observation.** That errors can be located to a specific part.
...
> "Locating which part is wrong is more useful than declaring the whole thing wrong. You just saw that when put up a decomposition with exactly one wrong part and ask them to find it.
> Last time we said: You can do it with no words at all to go on. This is the next part of that.
...
**What students must not infer.** Whether the corrected version is now right.

### 4. Worked example

**The example.** Naming the remembering line as the wrong one.
...
**Completed answer.** Naming the remembering line as the wrong one. — which demonstrates that errors can be located to a specific part.
...
**Conclusions not licensed.** Whether the corrected version is now right.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Correcting one part and leaving the other two. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Marking the whole decomposition as incorrect. Why is this not an
example?"
...
**Exact student instructions.** Six decompositions, each with one planted error, located and corrected.
...
- *Licensed conclusion.* That errors can be located to a specific part.
- *Not licensed.* Whether the corrected version is now right.
...
- *Expected response.* That errors can be located to a specific part.
...
1. Any wording carrying the idea in `Locating which part is wrong is more useful than declaring the whole thing wrong`.
...
Say: "One wrong part breaks the whole thing."
...
| | |
|---|---|
| **Follows** | Lesson 12 — Decomposing A Photograph |
| **Leads to** | Lesson 14 — Decomposing Your Own |

**Transition in.** Lesson 12 established students decompose a moment from a still image. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find the single incorrect part in a decomposition. Lesson 14 assumes it and builds students decompose a moment they had themselves.
