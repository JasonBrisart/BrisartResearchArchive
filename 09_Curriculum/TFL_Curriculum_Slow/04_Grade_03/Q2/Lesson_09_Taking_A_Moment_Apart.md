# Lesson 9 — Taking A Moment Apart
...
| | |
|---|---|
| **Central question** | Taking A Moment Apart: students decompose a described moment into three parts? |
| **Core concept** | Decomposition runs the reconstruction backwards. |
| **Student outcome** | Students decompose a described moment into three parts. |
| **Previous lesson** | Lesson 8 — The Right Now Review |
| **Next lesson** | Lesson 10 — Checking Forwards |
...
**The conceptual step.** Decomposition runs the reconstruction backwards. The test of a decomposition is whether the parts would actually produce the described moment.
...
**What depends on it.** Lesson 10 — Checking Forwards — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Decomposition runs the reconstruction backwards. The test of a decomposition is whether the parts would actually produce the described moment.
...
1. Parts that plausibly produce the stopping and looking up.
2. Two different decompositions that both work.

### One non-example

Parts that would have produced a completely different behaviour.
...
That moments can be analysed backwards into parts.

### What this activity does not establish

That the recovered parts are the real ones.
...
| Statement | Status |
|---|---|
| Decomposition runs the reconstruction backwards. | Framework-derived, appropriate at this grade |
| That moments can be analysed backwards into parts. | What this specific activity can show |
| That the recovered parts are the real ones. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Right Now Review — specifically: students consolidate the quarter's reconstruction work.

**How it was taught.** Through the activity: review with six reconstructions marked for list-versus-combination

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: review with six reconstructions marked for list-versus-combination, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Parts that plausibly produce the stopping and looking up. |
| **Non-example** | Parts that would have produced a completely different behaviour. |
...
> "Next time: taking a moment apart on purpose."
...
**Exact wording.** "Say: she walked in, stopped, and looked at the ceiling. Ask what the three parts were."
...
**Target observation.** That moments can be analysed backwards into parts.
...
> "Decomposition runs the reconstruction backwards. You just saw that when say: she walked in, stopped, and looked at the ceiling.
> Last time we said: Next time: taking a moment apart on purpose. This is the next part of that.
...
**What students must not infer.** That the recovered parts are the real ones.

### 4. Worked example

**The example.** Parts that plausibly produce the stopping and looking up.
...
**Completed answer.** Parts that plausibly produce the stopping and looking up. — which demonstrates that moments can be analysed backwards into parts.
...
**Conclusions not licensed.** That the recovered parts are the real ones.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Two different decompositions that both work. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Parts that would have produced a completely different behaviour. Why is this not an
example?"
...
**Exact student instructions.** Decompose six described moments; several answers are plausible for each.
...
- *Licensed conclusion.* That moments can be analysed backwards into parts.
- *Not licensed.* That the recovered parts are the real ones.
...
- *Expected response.* That moments can be analysed backwards into parts.
...
1. Any wording carrying the idea in `Decomposition runs the reconstruction backwards`.
...
Say: "You can work backwards to the three things that built it."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Right Now Review |
| **Leads to** | Lesson 10 — Checking Forwards |

**Transition in.** Lesson 8 established students consolidate the quarter's reconstruction work. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students decompose a described moment into three parts. Lesson 10 assumes it and builds students verify a decomposition by running it forwards.
