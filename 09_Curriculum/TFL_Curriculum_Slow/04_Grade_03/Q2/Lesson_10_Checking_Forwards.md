# Lesson 10 — Checking Forwards

**Grade 3** · Right Now · **Quarter 2** · **35 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Checking Forwards: students verify a decomposition by running it forwards? |
| **Core concept** | A decomposition is checked by running it forwards: if the parts would not produce the moment, the decomposition is wrong regardless of how plausible it sounded. |
| **Student outcome** | Students verify a decomposition by running it forwards. |
| **Previous lesson** | Lesson 9 — Taking A Moment Apart |
| **Next lesson** | Lesson 11 — Decomposing A Story |
...
**The conceptual step.** A decomposition is checked by running it forwards: if the parts would not produce the moment, the decomposition is wrong regardless of how plausible it sounded.
...
**What depends on it.** Lesson 11 — Decomposing A Story — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A decomposition is checked by running it forwards: if the parts would not produce the moment, the decomposition is wrong regardless of how plausible it sounded.
...
1. A decomposition that produces the described moment when run forwards.
2. A decomposition marked because it would produce something else.

### One non-example

Accepting a decomposition because it sounds reasonable.
...
That decompositions can be verified rather than merely proposed.

### What this activity does not establish

Which decomposition is the true one.
...
| Statement | Status |
|---|---|
| A decomposition is checked by running it forwards: if the parts would not produce the moment, the decomposition is wrong regardless of how plausible it sounded. | Framework-derived, appropriate at this grade |
| That decompositions can be verified rather than merely proposed. | What this specific activity can show |
| Which decomposition is the true one. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 9 — Taking A Moment Apart — specifically: students decompose a described moment into three parts.

**How it was taught.** Through the activity: decompose six described moments; several answers are plausible for each

**Quick check.** Ask for the closing sentence of Lesson 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 9: decompose six described moments; several answers are plausible for each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A decomposition that produces the described moment when run forwards. |
| **Non-example** | Accepting a decomposition because it sounds reasonable. |
...
> "You can work backwards to the three things that built it."
...
**Exact wording.** "Put a wrong decomposition on the board and ask whether it works."
...
**Target observation.** That decompositions can be verified rather than merely proposed.
...
> "A decomposition is checked by running it forwards: if the parts would not produce the moment, the decomposition is wrong regardless of how plausible it sounded. You just saw that when put a wrong decomposition on the board and ask whether it works.
> Last time we said: You can work backwards to the three things that built it. This is the next part of that.
...
**What students must not infer.** Which decomposition is the true one.

### 4. Worked example

**The example.** A decomposition that produces the described moment when run forwards.
...
**Completed answer.** A decomposition that produces the described moment when run forwards. — which demonstrates that decompositions can be verified rather than merely proposed.
...
**Conclusions not licensed.** Which decomposition is the true one.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A decomposition marked because it would produce something else. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Accepting a decomposition because it sounds reasonable. Why is this not an
example?"
...
**Exact student instructions.** Check a partner's six decompositions forwards and mark those that fail.
...
- *Licensed conclusion.* That decompositions can be verified rather than merely proposed.
- *Not licensed.* Which decomposition is the true one.
...
- *Expected response.* That decompositions can be verified rather than merely proposed.
...
1. Any wording carrying the idea in `A decomposition is checked by running it forwards: if the parts would not produce the moment, the decomposition is wrong regardless of how plausible it sounded`.
...
Say: "Backwards to find them, forwards to check them."
...
| | |
|---|---|
| **Follows** | Lesson 9 — Taking A Moment Apart |
| **Leads to** | Lesson 11 — Decomposing A Story |

**Transition in.** Lesson 9 established students decompose a described moment into three parts. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students verify a decomposition by running it forwards. Lesson 11 assumes it and builds students decompose a character's moment from a text.
