# Lesson 12 Homework — Decomposing A Photograph

**Grade 3** · Right Now · **Quarter 2**
**Follows:** Lesson 12 — Decomposing A Photograph · **Points:** 5 · **Optional:** yes
...
Three decompositions from three images, each checked forwards.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces three forward-checking decompositions
...
Lesson 13 is **The Wrong Part**, which assumes you arrive holding it. Write one thing you expect it to be about:
