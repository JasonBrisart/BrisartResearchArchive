# Lesson 10 Homework — Checking Forwards

**Grade 3** · Right Now · **Quarter 2**
**Follows:** Lesson 10 — Checking Forwards · **Points:** 5 · **Optional:** yes
...
Check a partner's six decompositions forwards and mark those that fail.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student receives a forward-checked set with at least one marked
...
Lesson 11 is **Decomposing A Story**, which assumes you arrive holding it. Write one thing you expect it to be about:
