# Lesson 9 Homework — Taking A Moment Apart

**Grade 3** · Right Now · **Quarter 2**
**Follows:** Lesson 9 — Taking A Moment Apart · **Points:** 5 · **Optional:** yes
...
Decompose six described moments; several answers are plausible for each.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student decomposes at least four into connected parts
...
Lesson 10 is **Checking Forwards**, which assumes you arrive holding it. Write one thing you expect it to be about:
