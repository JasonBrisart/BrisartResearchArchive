# Lesson 15 — When You Cannot Decompose
...
| | |
|---|---|
| **Central question** | When You Cannot Decompose: students mark a moment they cannot take apart? |
| **Core concept** | Some moments resist decomposition. |
| **Student outcome** | Students mark a moment they cannot take apart. |
| **Previous lesson** | Lesson 14 — Decomposing Your Own |
| **Next lesson** | Lesson 16 — The Decomposition Review |
...
**The conceptual step.** Some moments resist decomposition. Marking one honestly is better work than forcing three parts onto it, and it maps where the method stops.
...
**What depends on it.** Lesson 16 — The Decomposition Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Some moments resist decomposition. Marking one honestly is better work than forcing three parts onto it, and it maps where the method stops.
...
1. A moment marked resistant because the remembering cannot be named.
2. A moment marked because nothing specific was expected.

### One non-example

A moment forced into three invented parts.
...
That the method has limits the student can identify.

### What this activity does not establish

Why those moments resist.
...
| Statement | Status |
|---|---|
| Some moments resist decomposition. | Framework-derived, appropriate at this grade |
| That the method has limits the student can identify. | What this specific activity can show |
| Why those moments resist. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Decomposing Your Own — specifically: students decompose a moment they had themselves.

**How it was taught.** Through the activity: three self-decompositions, each checked forwards by a partner

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: three self-decompositions, each checked forwards by a partner, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A moment marked resistant because the remembering cannot be named. |
| **Non-example** | A moment forced into three invented parts. |
...
> "Your own moments are harder because you were in them."
...
**Exact wording.** "Say: some will not come apart. That is a real answer."
...
**Target observation.** That the method has limits the student can identify.
...
> "Some moments resist decomposition. You just saw that when say: some will not come apart.
> Last time we said: Your own moments are harder because you were in them. This is the next part of that.
...
**What students must not infer.** Why those moments resist.

### 4. Worked example

**The example.** A moment marked resistant because the remembering cannot be named.
...
**Completed answer.** A moment marked resistant because the remembering cannot be named. — which demonstrates that the method has limits the student can identify.
...
**Conclusions not licensed.** Why those moments resist.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A moment marked because nothing specific was expected. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A moment forced into three invented parts. Why is this not an
example?"
...
**Exact student instructions.** Attempt five decompositions and mark any that resist, with why.
...
- *Licensed conclusion.* That the method has limits the student can identify.
- *Not licensed.* Why those moments resist.
...
- *Expected response.* That the method has limits the student can identify.
...
1. Any wording carrying the idea in `Some moments resist decomposition`.
...
Say: "Marking one is honest. Inventing parts is not."
...
| | |
|---|---|
| **Follows** | Lesson 14 — Decomposing Your Own |
| **Leads to** | Lesson 16 — The Decomposition Review |

**Transition in.** Lesson 14 established students decompose a moment they had themselves. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students mark a moment they cannot take apart. Lesson 16 assumes it and builds students consolidate decomposition.
