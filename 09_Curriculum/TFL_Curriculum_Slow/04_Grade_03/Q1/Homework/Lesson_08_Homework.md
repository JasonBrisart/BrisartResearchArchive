# Lesson 8 Homework — The Right Now Review

**Grade 3** · Right Now · **Quarter 1**
**Follows:** Lesson 8 — The Right Now Review · **Points:** 5 · **Optional:** yes
...
Review with six reconstructions marked for list-versus-combination.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class identifies at least four lists correctly
...
Lesson 9 is **Taking A Moment Apart**, which assumes you arrive holding it. Write one thing you expect it to be about:
