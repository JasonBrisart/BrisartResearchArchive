# Lesson 5 Homework — Right Now, Just Now

**Grade 3** · Right Now · **Quarter 1**
**Follows:** Lesson 5 — Right Now, Just Now · **Points:** 5 · **Optional:** yes
...
Three rapid reconstructions of moments from within the lesson.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student completes three same-session reconstructions
...
Lesson 6 is **Two People, One Event**, which assumes you arrive holding it. Write one thing you expect it to be about:
