# Lesson 1 Homework — One Moment, Not Three Things

**Grade 3** · Right Now · **Quarter 1**
**Follows:** Lesson 1 — One Moment, Not Three Things · **Points:** 5 · **Optional:** yes
...
Rewrite one Grade 2 comparison row as a single sentence describing the whole moment.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces one sentence that is not a list
...
Lesson 2 is **Building Right Now**, which assumes you arrive holding it. Write one thing you expect it to be about:
