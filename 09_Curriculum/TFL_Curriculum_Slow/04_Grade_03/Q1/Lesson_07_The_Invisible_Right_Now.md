# Lesson 7 — The Invisible Right Now
...
| | |
|---|---|
| **Central question** | The Invisible Right Now: students reconstruct a moment in which nothing surprising happened? |
| **Core concept** | Routine moments have the same structure as remarkable ones. |
| **Student outcome** | Students reconstruct a moment in which nothing surprising happened. |
| **Previous lesson** | Lesson 6 — Two People, One Event |
| **Next lesson** | Lesson 8 — The Right Now Review |
...
**The conceptual step.** Routine moments have the same structure as remarkable ones. They are harder to reconstruct only because nothing drew attention to them.
...
**What depends on it.** Lesson 8 — The Right Now Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Routine moments have the same structure as remarkable ones. They are harder to reconstruct only because nothing drew attention to them.
...
1. A reconstruction of sitting down, with a real final line.
2. A reconstruction of the teacher walking to the board.

### One non-example

A claim that nothing happened and therefore nothing can be written.
...
That routine moments have the same three-part structure.

### What this activity does not establish

That routine moments are less important.
...
| Statement | Status |
|---|---|
| Routine moments have the same structure as remarkable ones. | Framework-derived, appropriate at this grade |
| That routine moments have the same three-part structure. | What this specific activity can show |
| That routine moments are less important. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — Two People, One Event — specifically: students reconstruct the same event from two positions.

**How it was taught.** Through the activity: both reconstruct; compare side by side and name the differing line

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: both reconstruct; compare side by side and name the differing line, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A reconstruction of sitting down, with a real final line. |
| **Non-example** | A claim that nothing happened and therefore nothing can be written. |
...
> "One event produces a different moment for everyone in it."
...
**Exact wording.** "Walk to the board, pick up a pen, write the date, then ask what their right now was."
...
**Target observation.** That routine moments have the same three-part structure.
...
> "Routine moments have the same structure as remarkable ones. You just saw that when walk to the board, pick up a pen, write the date, then ask what their right now was.
> Last time we said: One event produces a different moment for everyone in it. This is the next part of that.
...
**What students must not infer.** That routine moments are less important.

### 4. Worked example

**The example.** A reconstruction of sitting down, with a real final line.
...
**Completed answer.** A reconstruction of sitting down, with a real final line. — which demonstrates that routine moments have the same three-part structure.
...
**Conclusions not licensed.** That routine moments are less important.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A reconstruction of the teacher walking to the board. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that nothing happened and therefore nothing can be written. Why is this not an
example?"
...
**Exact student instructions.** Three reconstructions of entirely routine moments.
...
- *Licensed conclusion.* That routine moments have the same three-part structure.
- *Not licensed.* That routine moments are less important.
...
- *Expected response.* That routine moments have the same three-part structure.
...
1. Any wording carrying the idea in `Routine moments have the same structure as remarkable ones`.
...
Say: "Even the boring moments are built out of three things."
...
| | |
|---|---|
| **Follows** | Lesson 6 — Two People, One Event |
| **Leads to** | Lesson 8 — The Right Now Review |

**Transition in.** Lesson 6 established students reconstruct the same event from two positions. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students reconstruct a moment in which nothing surprising happened. Lesson 8 assumes it and builds students consolidate the quarter's reconstruction work.
