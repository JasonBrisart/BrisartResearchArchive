# Lesson 4 — Right Now Somewhere Else
...
| | |
|---|---|
| **Central question** | Right Now Somewhere Else: students build a reconstruction outside the classroom? |
| **Core concept** | The reconstruction method is portable. |
| **Student outcome** | Students build a reconstruction outside the classroom. |
| **Previous lesson** | Lesson 3 — Same Input, Different Moment |
| **Next lesson** | Lesson 5 — Right Now, Just Now |
...
**The conceptual step.** The reconstruction method is portable. Building one on the spot in a new place shows it is a tool rather than a classroom routine.
...
**What depends on it.** Lesson 5 — Right Now, Just Now — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The reconstruction method is portable. Building one on the spot in a new place shows it is a tool rather than a classroom routine.
...
1. A five-line reconstruction of arriving in the hall.
2. A reconstruction of the first ten seconds outdoors.

### One non-example

A reconstruction of this morning's classroom moment, written in the hall.
...
That the method works in any setting.

### What this activity does not establish

Whether new settings produce richer moments.
...
| Statement | Status |
|---|---|
| The reconstruction method is portable. | Framework-derived, appropriate at this grade |
| That the method works in any setting. | What this specific activity can show |
| Whether new settings produce richer moments. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — Same Input, Different Moment — specifically: students explain why identical input yields different moments.

**How it was taught.** Through the activity: two students' templates side by side; the class identifies the differing line

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: two students' templates side by side; the class identifies the differing line, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A five-line reconstruction of arriving in the hall. |
| **Non-example** | A reconstruction of this morning's classroom moment, written in the hall. |
...
> "The event was shared. The moment was not."
...
**Exact wording.** "Move the group to a corridor, hall, or outdoor space."
...
**Target observation.** That the method works in any setting.
...
> "The reconstruction method is portable. You just saw that when move the group to a corridor, hall, or outdoor space.
> Last time we said: The event was shared. The moment was not. This is the next part of that.
...
**What students must not infer.** Whether new settings produce richer moments.

### 4. Worked example

**The example.** A five-line reconstruction of arriving in the hall.
...
**Completed answer.** A five-line reconstruction of arriving in the hall. — which demonstrates that the method works in any setting.
...
**Conclusions not licensed.** Whether new settings produce richer moments.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A reconstruction of the first ten seconds outdoors. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A reconstruction of this morning's classroom moment, written in the hall. Why is this not an
example?"
...
**Exact student instructions.** A five-line reconstruction built in the new space, on the spot.
...
- *Licensed conclusion.* That the method works in any setting.
- *Not licensed.* Whether new settings produce richer moments.
...
- *Expected response.* That the method works in any setting.
...
1. Any wording carrying the idea in `The reconstruction method is portable`.
...
Say: "It works anywhere, not only at your desk."
...
| | |
|---|---|
| **Follows** | Lesson 3 — Same Input, Different Moment |
| **Leads to** | Lesson 5 — Right Now, Just Now |

**Transition in.** Lesson 3 established students explain why identical input yields different moments. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students build a reconstruction outside the classroom. Lesson 5 assumes it and builds students reconstruct a moment seconds after it happens.
