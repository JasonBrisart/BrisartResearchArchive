...
| | |
|---|---|
| **Central question** | Building Right Now: students name the three inputs that fed one moment? |
| **Core concept** | The five-line template separates the three inputs and then requires them to be recombined into one statement. |
| **Student outcome** | Students name the three inputs that fed one moment. |
| **Previous lesson** | Lesson 1 — One Moment, Not Three Things |
| **Next lesson** | Lesson 3 — Same Input, Different Moment |
...
**The conceptual step.** The five-line template separates the three inputs and then requires them to be recombined into one statement. The final line is the moment, not a summary of the lines above it.
...
**What depends on it.** Lesson 3 — Same Input, Different Moment — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The five-line template separates the three inputs and then requires them to be recombined into one statement. The final line is the moment, not a summary of the lines above it.
...
1. Lines one to three list inputs; line five says the corridor felt too quiet.
2. Lines one to three list inputs; line five says I was already braced for a change.

### One non-example

A final line reading I noticed, remembered, and expected these things.
...
That a moment can be reconstructed from its inputs.

### What this activity does not establish

Whether the reconstruction is accurate.
...
| Statement | Status |
|---|---|
| The five-line template separates the three inputs and then requires them to be recombined into one statement. | Framework-derived, appropriate at this grade |
| That a moment can be reconstructed from its inputs. | What this specific activity can show |
| Whether the reconstruction is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 1 — One Moment, Not Three Things — specifically: students recognise that experience arrives combined.

**How it was taught.** Through the activity: rewrite one Grade 2 comparison row as a single sentence describing the whole moment

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: rewrite one Grade 2 comparison row as a single sentence describing the whole moment, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Lines one to three list inputs; line five says the corridor felt too quiet. |
| **Non-example** | A final line reading I noticed, remembered, and expected these things. |
...
> "You have one moment. We take it apart afterwards."
...
**Exact wording.** "Show something mostly covered. Everyone writes what it is; read several aloud."
...
**Target observation.** That a moment can be reconstructed from its inputs.
...
> "The five-line template separates the three inputs and then requires them to be recombined into one statement. You just saw that when show something mostly covered.
> Last time we said: You have one moment. We take it apart afterwards. This is the next part of that.
...
**What students must not infer.** Whether the reconstruction is accurate.

### 4. Worked example

**The example.** Lines one to three list inputs; line five says the corridor felt too quiet.
...
**Completed answer.** Lines one to three list inputs; line five says the corridor felt too quiet. — which demonstrates that a moment can be reconstructed from its inputs.
...
**Conclusions not licensed.** Whether the reconstruction is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Lines one to three list inputs; line five says I was already braced for a change. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A final line reading I noticed, remembered, and expected these things. Why is this not an
example?"
...
**Exact student instructions.** Reconstruct one moment from today using the five-line template.
...
- *Licensed conclusion.* That a moment can be reconstructed from its inputs.
- *Not licensed.* Whether the reconstruction is accurate.
...
- *Expected response.* That a moment can be reconstructed from its inputs.
...
1. Any wording carrying the idea in `The five-line template separates the three inputs and then requires them to be recombined into one statement`.
...
Say: "Right now is built from three things and arrives as one."
...
| | |
|---|---|
| **Follows** | Lesson 1 — One Moment, Not Three Things |
| **Leads to** | Lesson 3 — Same Input, Different Moment |

**Transition in.** Lesson 1 established students recognise that experience arrives combined. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students name the three inputs that fed one moment. Lesson 3 assumes it and builds students explain why identical input yields different moments.
