...
| | |
|---|---|
| **Central question** | Right Now, Just Now: students reconstruct a moment seconds after it happens? |
| **Core concept** | Reconstruction is more complete the sooner it is done. |
| **Student outcome** | Students reconstruct a moment seconds after it happens. |
| **Previous lesson** | Lesson 4 — Right Now Somewhere Else |
| **Next lesson** | Lesson 6 — Two People, One Event |
...
**The conceptual step.** Reconstruction is more complete the sooner it is done. Distance from the moment costs detail, which is why timing matters.
...
**What depends on it.** Lesson 6 — Two People, One Event — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Reconstruction is more complete the sooner it is done. Distance from the moment costs detail, which is why timing matters.
...
1. A reconstruction written eight seconds after the event.
2. A student notices they recovered more than in yesterday's attempt.

### One non-example

A reconstruction of something from this morning, written now.
...
That recency improves recovery.

### What this activity does not establish

How much is lost over any given interval.
...
| Statement | Status |
|---|---|
| Reconstruction is more complete the sooner it is done. | Framework-derived, appropriate at this grade |
| That recency improves recovery. | What this specific activity can show |
| How much is lost over any given interval. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — Right Now Somewhere Else — specifically: students build a reconstruction outside the classroom.

**How it was taught.** Through the activity: a five-line reconstruction built in the new space, on the spot

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: a five-line reconstruction built in the new space, on the spot, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A reconstruction written eight seconds after the event. |
| **Non-example** | A reconstruction of something from this morning, written now. |
...
> "It works anywhere, not only at your desk."
...
**Exact wording.** "Do something small and unremarkable, then ask them to reconstruct the last five seconds."
...
**Target observation.** That recency improves recovery.
...
> "Reconstruction is more complete the sooner it is done. You just saw that when do something small and unremarkable, then ask them to reconstruct the last five seconds.
> Last time we said: It works anywhere, not only at your desk. This is the next part of that.
...
**What students must not infer.** How much is lost over any given interval.

### 4. Worked example

**The example.** A reconstruction written eight seconds after the event.
...
**Completed answer.** A reconstruction written eight seconds after the event. — which demonstrates that recency improves recovery.
...
**Conclusions not licensed.** How much is lost over any given interval.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student notices they recovered more than in yesterday's attempt. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A reconstruction of something from this morning, written now. Why is this not an
example?"
...
**Exact student instructions.** Three rapid reconstructions of moments from within the lesson.
...
- *Licensed conclusion.* That recency improves recovery.
- *Not licensed.* How much is lost over any given interval.
...
- *Expected response.* That recency improves recovery.
...
1. Any wording carrying the idea in `Reconstruction is more complete the sooner it is done`.
...
Say: "The closer to the moment, the more you can recover."
...
| | |
|---|---|
| **Follows** | Lesson 4 — Right Now Somewhere Else |
| **Leads to** | Lesson 6 — Two People, One Event |

**Transition in.** Lesson 4 established students build a reconstruction outside the classroom. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students reconstruct a moment seconds after it happens. Lesson 6 assumes it and builds students reconstruct the same event from two positions.
