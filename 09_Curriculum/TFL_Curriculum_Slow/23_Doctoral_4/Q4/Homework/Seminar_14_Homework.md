# Seminar 14 Homework — Revising After The Mock

**Doctoral Year 4** · Dissertation and Defence · **Quarter 4**
**Follows:** Seminar 14 — Revising After The Mock · **Points:** 5 · **Optional:** yes
...
Revise and log each change against its question.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every unanswered question produces a logged revision
...
Seminar 15 is **The Defence**, which assumes you arrive holding it. Write one thing you expect it to be about:
