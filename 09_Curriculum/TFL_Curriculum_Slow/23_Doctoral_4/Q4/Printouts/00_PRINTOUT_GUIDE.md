...
|---|---|---|---|---|---|---|
| `Seminar_13_Printout.md` | Seminar 13 — The Mock Defence | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Seminar_14_Printout.md` | Seminar 14 — Revising After The Mock | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 13 work |
| `Seminar_15_Printout.md` | Seminar 15 — The Defence | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 14 work |
| `Seminar_16_Printout.md` | Seminar 16 — What Comes Next | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 15 work |
...
**Seminar 15 — The Defence.** If you only have time to print one
