...
| | |
|---|---|
| **Central question** | Both Discussions: participants write the discussion for each possible outcome? |
| **Core concept** | Writing both discussions before seeing the result produces an honest version of whichever is used. |
| **Student outcome** | Participants write the discussion for each possible outcome. |
| **Previous seminar** | Seminar 4 — Prespecified Versus Exploratory |
| **Next seminar** | Seminar 6 — Availability And Reproducibility |
| **Materials** | The participant's own proposal and data; dissertation structure templates |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_05_Printout.md` |
| **Homework** | `Homework/Seminar_05_Homework.md` |

## Why this lesson exists

**The conceptual step.** Writing both discussions before seeing the result produces an honest version of whichever is used. Writing afterwards produces one written from inside the result.
...
**What depends on it.** Seminar 6 — Availability And Reproducibility — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Writing both discussions before seeing the result produces an honest version of whichever is used. Writing afterwards produces one written from inside the result.
...
1. Both discussions written and checked against the ceiling.
2. A null discussion written before the data were examined.

### One non-example

Only the positive discussion drafted in advance.
...
That honest discussions are written in advance.

### What this activity does not establish

Which discussion will be used.
...
| Statement | Status |
|---|---|
| Writing both discussions before seeing the result produces an honest version of whichever is used. | Framework-derived, appropriate at this grade |
| That honest discussions are written in advance. | What this specific activity can show |
| Which discussion will be used. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 4 — Prespecified Versus Exploratory — specifically: participants label every analysis honestly.

**How it was taught.** Through the activity: label every analysis and check against the original plan document

**Quick check.** Ask for the closing sentence of Seminar 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 4: label every analysis and check against the original plan document, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Both discussions written and checked against the ceiling. |
| **Non-example** | Only the positive discussion drafted in advance. |
...
**Student materials.** One copy of `Printouts/Seminar_05_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 4, kept in the student's folder.
...
**File.** `Printouts/Seminar_05_Printout.md`
...
> "Exploration is legitimate and must be labelled."
...
**Exact wording.** "Say: write both now, before you look. The one you use will be honest."
...
**Target observation.** That honest discussions are written in advance.
...
> "Writing both discussions before seeing the result produces an honest version of whichever is used. You just saw that when say: write both now, before you look.
> Last time we said: Exploration is legitimate and must be labelled. This is the next part of that.
...
**What students must not infer.** Which discussion will be used.

### 4. Worked example

**The example.** Both discussions written and checked against the ceiling.
...
**Completed answer.** Both discussions written and checked against the ceiling. — which demonstrates that honest discussions are written in advance.
...
**Conclusions not licensed.** Which discussion will be used.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A null discussion written before the data were examined. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Only the positive discussion drafted in advance. Why is this not an
example?"
...
**Exact student instructions.** Write both discussions, each checked against the declared ceiling.
...
- *Licensed conclusion.* That honest discussions are written in advance.
- *Not licensed.* Which discussion will be used.
...
- *Expected response.* That honest discussions are written in advance.
...
1. Any wording carrying the idea in `Writing both discussions before seeing the result produces an honest version of whichever is used`.
...
Say: "This prevents the commonest failure of the writing year."

**Why this sentence matters.** It is the opening question of Seminar 6, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_05_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 4 — Prespecified Versus Exploratory |
| **Leads to** | Seminar 6 — Availability And Reproducibility |

**Transition in.** Seminar 4 established participants label every analysis honestly. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants write the discussion for each possible outcome. Seminar 6 assumes it and builds participants state what others can obtain.
