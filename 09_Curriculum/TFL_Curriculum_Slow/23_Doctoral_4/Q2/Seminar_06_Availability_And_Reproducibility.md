# Seminar 6 — Availability And Reproducibility

**Doctoral Year 4** · Dissertation and Defence · **Quarter 2** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Availability And Reproducibility: participants state what others can obtain? |
| **Core concept** | An availability statement names what can be obtained and what cannot, with reasons. |
| **Student outcome** | Participants state what others can obtain. |
| **Previous seminar** | Seminar 5 — Both Discussions |
| **Next seminar** | Seminar 7 — Chapter Review By Strangers |
| **Materials** | The participant's own proposal and data; dissertation structure templates |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_06_Printout.md` |
| **Homework** | `Homework/Seminar_06_Homework.md` |

## Why this lesson exists

**The conceptual step.** An availability statement names what can be obtained and what cannot, with reasons. Unstated restrictions discovered later damage credibility more than stated ones.
...
**What depends on it.** Seminar 7 — Chapter Review By Strangers — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An availability statement names what can be obtained and what cannot, with reasons. Unstated restrictions discovered later damage credibility more than stated ones.
...
1. A statement naming a consent restriction on raw data.
2. A statement checked against the institutional data policy.

### One non-example

A statement claiming all materials are freely available.
...
That availability requires verification before assertion.

### What this activity does not establish

Whether reproduction would succeed.
...
| Statement | Status |
|---|---|
| An availability statement names what can be obtained and what cannot, with reasons. | Framework-derived, appropriate at this grade |
| That availability requires verification before assertion. | What this specific activity can show |
| Whether reproduction would succeed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 5 — Both Discussions — specifically: participants write the discussion for each possible outcome.

**How it was taught.** Through the activity: write both discussions, each checked against the declared ceiling

**Quick check.** Ask for the closing sentence of Seminar 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 5: write both discussions, each checked against the declared ceiling, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A statement naming a consent restriction on raw data. |
| **Non-example** | A statement claiming all materials are freely available. |
...
**Student materials.** One copy of `Printouts/Seminar_06_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 5, kept in the student's folder.
...
**File.** `Printouts/Seminar_06_Printout.md`
...
> "This prevents the commonest failure of the writing year."
...
**Exact wording.** "Ask what somebody wanting to reproduce the analysis next year could get."
...
**Target observation.** That availability requires verification before assertion.
...
> "An availability statement names what can be obtained and what cannot, with reasons. You just saw that when ask what somebody wanting to reproduce the analysis next year could get.
> Last time we said: This prevents the commonest failure of the writing year. This is the next part of that.
...
**What students must not infer.** Whether reproduction would succeed.

### 4. Worked example

**The example.** A statement naming a consent restriction on raw data.
...
**Completed answer.** A statement naming a consent restriction on raw data. — which demonstrates that availability requires verification before assertion.
...
**Conclusions not licensed.** Whether reproduction would succeed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A statement checked against the institutional data policy. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A statement claiming all materials are freely available. Why is this not an
example?"
...
**Exact student instructions.** Draft the availability statement naming what cannot be shared and why.
...
- *Licensed conclusion.* That availability requires verification before assertion.
- *Not licensed.* Whether reproduction would succeed.
...
- *Expected response.* That availability requires verification before assertion.
...
1. Any wording carrying the idea in `An availability statement names what can be obtained and what cannot, with reasons`.
...
Say: "An honest restriction stated beats an unstated one discovered."

**Why this sentence matters.** It is the opening question of Seminar 7, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_06_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 5 — Both Discussions |
| **Leads to** | Seminar 7 — Chapter Review By Strangers |

**Transition in.** Seminar 5 established participants write the discussion for each possible outcome. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants state what others can obtain. Seminar 7 assumes it and builds participants have chapters read by people new to the project.
