# Seminar 8 — Revising Against Strangers
...
| | |
|---|---|
| **Central question** | Revising Against Strangers: participants revise chapters against stranger feedback? |
| **Core concept** | Revision success is measured by comparing question counts across two stranger reads. |
| **Student outcome** | Participants revise chapters against stranger feedback. |
| **Previous seminar** | Seminar 7 — Chapter Review By Strangers |
| **Next seminar** | Seminar 9 — The Limitations Section |
| **Materials** | The participant's own proposal and data; dissertation structure templates |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_08_Printout.md` |
| **Homework** | `Homework/Seminar_08_Homework.md` |

## Why this lesson exists

**The conceptual step.** Revision success is measured by comparing question counts across two stranger reads. A second count matching the first indicates the revision missed.
...
**What depends on it.** Seminar 9 — The Limitations Section — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Revision success is measured by comparing question counts across two stranger reads. A second count matching the first indicates the revision missed.
...
1. Both counts reported with the second lower.
2. A revision dropping the count from eight to three.

### One non-example

A defence that the original chapter was clear.
...
That revision is measurable by re-reading.

### What this activity does not establish

Whether the chapter is now adequate.
...
| Statement | Status |
|---|---|
| Revision success is measured by comparing question counts across two stranger reads. | Framework-derived, appropriate at this grade |
| That revision is measurable by re-reading. | What this specific activity can show |
| Whether the chapter is now adequate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 7 — Chapter Review By Strangers — specifically: participants have chapters read by people new to the project.

**How it was taught.** Through the activity: cross-project reading with every question recorded as a revision

**Quick check.** Ask for the closing sentence of Seminar 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 7: cross-project reading with every question recorded as a revision, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Both counts reported with the second lower. |
| **Non-example** | A defence that the original chapter was clear. |
...
**Student materials.** One copy of `Printouts/Seminar_08_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 7, kept in the student's folder.
...
**File.** `Printouts/Seminar_08_Printout.md`
...
> "The stranger reader is the honest simulation of your examiner."
...
**Exact wording.** "Say: every question becomes a revision. Then a second stranger reads it."
...
**Target observation.** That revision is measurable by re-reading.
...
> "Revision success is measured by comparing question counts across two stranger reads. You just saw that when say: every question becomes a revision.
> Last time we said: The stranger reader is the honest simulation of your examiner. This is the next part of that.
...
**What students must not infer.** Whether the chapter is now adequate.

### 4. Worked example

**The example.** Both counts reported with the second lower.
...
**Completed answer.** Both counts reported with the second lower. — which demonstrates that revision is measurable by re-reading.
...
**Conclusions not licensed.** Whether the chapter is now adequate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A revision dropping the count from eight to three. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence that the original chapter was clear. Why is this not an
example?"
...
**Exact student instructions.** Revise and run a second stranger read with both counts reported.
...
- *Licensed conclusion.* That revision is measurable by re-reading.
- *Not licensed.* Whether the chapter is now adequate.
...
- *Expected response.* That revision is measurable by re-reading.
...
1. Any wording carrying the idea in `Revision success is measured by comparing question counts across two stranger reads`.
...
Say: "If the second matches the first, the revision missed."

**Why this sentence matters.** It is the opening question of Seminar 9, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_08_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 7 — Chapter Review By Strangers |
| **Leads to** | Seminar 9 — The Limitations Section |

**Transition in.** Seminar 7 established participants have chapters read by people new to the project. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants revise chapters against stranger feedback. Seminar 9 assumes it and builds participants state limits specifically rather than generically.
