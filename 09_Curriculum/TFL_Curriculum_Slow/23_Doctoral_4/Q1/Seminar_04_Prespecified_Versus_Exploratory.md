# Seminar 4 — Prespecified Versus Exploratory
...
| | |
|---|---|
| **Central question** | Prespecified Versus Exploratory: participants label every analysis honestly? |
| **Core concept** | Analyses are labelled by checking against the registered plan rather than against memory. |
| **Student outcome** | Participants label every analysis honestly. |
| **Previous seminar** | Seminar 3 — Reporting What Happened |
| **Next seminar** | Seminar 5 — Both Discussions |
...
**The conceptual step.** Analyses are labelled by checking against the registered plan rather than against memory. Memory reliably reclassifies exploration as confirmation.
...
**What depends on it.** Seminar 5 — Both Discussions — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Analyses are labelled by checking against the registered plan rather than against memory. Memory reliably reclassifies exploration as confirmation.
...
1. An analysis verified as confirmatory against the plan document.
2. An analysis reclassified as exploratory after checking.

### One non-example

An analysis labelled confirmatory from the author's recollection.
...
That labelling requires documentary verification.

### What this activity does not establish

Whether the analyses are informative.
...
| Statement | Status |
|---|---|
| Analyses are labelled by checking against the registered plan rather than against memory. | Framework-derived, appropriate at this grade |
| That labelling requires documentary verification. | What this specific activity can show |
| Whether the analyses are informative. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 3 — Reporting What Happened — specifically: participants write results without interpretation.

**How it was taught.** Through the activity: write a results section with no interpretive language, peer-marked

**Quick check.** Ask for the closing sentence of Seminar 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 3: write a results section with no interpretive language, peer-marked, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An analysis verified as confirmatory against the plan document. |
| **Non-example** | An analysis labelled confirmatory from the author's recollection. |
...
> "A reader must be able to reach a different conclusion from your results."
...
**Exact wording.** "Ask which analyses were in the plan and which occurred afterwards."
...
**Target observation.** That labelling requires documentary verification.
...
> "Analyses are labelled by checking against the registered plan rather than against memory. You just saw that when ask which analyses were in the plan and which occurred afterwards.
> Last time we said: A reader must be able to reach a different conclusion from your results. This is the next part of that.
...
**What students must not infer.** Whether the analyses are informative.

### 4. Worked example

**The example.** An analysis verified as confirmatory against the plan document.
...
**Completed answer.** An analysis verified as confirmatory against the plan document. — which demonstrates that labelling requires documentary verification.
...
**Conclusions not licensed.** Whether the analyses are informative.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An analysis reclassified as exploratory after checking. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An analysis labelled confirmatory from the author's recollection. Why is this not an
example?"
...
**Exact student instructions.** Label every analysis and check against the original plan document.
...
- *Licensed conclusion.* That labelling requires documentary verification.
- *Not licensed.* Whether the analyses are informative.
...
- *Expected response.* That labelling requires documentary verification.
...
1. Any wording carrying the idea in `Analyses are labelled by checking against the registered plan rather than against memory`.
...
Say: "Exploration is legitimate and must be labelled."
...
| | |
|---|---|
| **Follows** | Seminar 3 — Reporting What Happened |
| **Leads to** | Seminar 5 — Both Discussions |

**Transition in.** Seminar 3 established participants write results without interpretation. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants label every analysis honestly. Seminar 5 assumes it and builds participants write the discussion for each possible outcome.
