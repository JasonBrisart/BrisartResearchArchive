# Seminar 1 — The Hedged Dissertation
...
| | |
|---|---|
| **Central question** | The Hedged Dissertation: participants confirm their work produces value under either outcome? |
| **Core concept** | A hedged design produces a contribution under either outcome. |
| **Student outcome** | Participants confirm their work produces value under either outcome. |
| **Previous seminar** | None. First seminar of the year. |
| **Next seminar** | Seminar 2 — The Change Log |
| **Materials** | The participant's own proposal and data; dissertation structure templates |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_01_Printout.md` |
| **Homework** | `Homework/Seminar_01_Homework.md` |

## Why this lesson exists

**The conceptual step.** A hedged design produces a contribution under either outcome. A design whose value depends on one result is a structural failure, not bad luck.
...
**What depends on it.** Seminar 2 — The Change Log — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A hedged design produces a contribution under either outcome. A design whose value depends on one result is a structural failure, not bad luck.
...
1. A contribution under a null stated as a measurement finding.
2. A design repaired after the null contribution was found empty.

### One non-example

A null treated as a disappointment to be managed later.
...
That hedging is a structural design property.
...
| Statement | Status |
|---|---|
| A hedged design produces a contribution under either outcome. | Framework-derived, appropriate at this grade |
| That hedging is a structural design property. | What this specific activity can show |
| Which outcome will occur. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The participant produces referee-quality review and states ceilings both ways.
...
| **Correct example** | A contribution under a null stated as a measurement finding. |
| **Non-example** | A null treated as a disappointment to be managed later. |
...
**Student materials.** One copy of `Printouts/Seminar_01_Printout.md` per student.
...
**File.** `Printouts/Seminar_01_Printout.md`
...
This is the first seminar of the year, so there is nothing to retrieve. Instead ask: "What do you think this course is about?" Take three answers and write them where they can be revisited at the end of the year. Do not correct them.

### 2. Hook

**Exact wording.** "Ask: if your result comes back null, what do you have? Take every answer."
...
**Target observation.** That hedging is a structural design property.
...
> "A hedged design produces a contribution under either outcome. You just saw that when ask: if your result comes back null, what do you have? Take every answer.
...
**What students must not infer.** Which outcome will occur.

### 4. Worked example

**The example.** A contribution under a null stated as a measurement finding.
...
**Completed answer.** A contribution under a null stated as a measurement finding. — which demonstrates that hedging is a structural design property.
...
**Conclusions not licensed.** Which outcome will occur.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A design repaired after the null contribution was found empty. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A null treated as a disappointment to be managed later. Why is this not an
example?"
...
**Exact student instructions.** State the contribution under each outcome and repair the design if either is empty.
...
- *Licensed conclusion.* That hedging is a structural design property.
- *Not licensed.* Which outcome will occur.
...
- *Expected response.* That hedging is a structural design property.
...
1. Any wording carrying the idea in `A hedged design produces a contribution under either outcome`.
...
Say: "If your degree depends on the framework being true, the design failed first."

**Why this sentence matters.** It is the opening question of Seminar 2, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_01_Homework.md`
...
| | |
|---|---|
| **Follows** | Nothing. First seminar of the year. |
| **Leads to** | Seminar 2 — The Change Log |

**Transition in.** This seminar opens the year.

**Transition out.** This seminar establishes participants confirm their work produces value under either outcome. Seminar 2 assumes it and builds participants document every modification and its cost.
