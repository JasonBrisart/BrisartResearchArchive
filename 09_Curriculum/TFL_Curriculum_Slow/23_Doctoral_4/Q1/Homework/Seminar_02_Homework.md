# Seminar 2 Homework — The Change Log

**Doctoral Year 4** · Dissertation and Defence · **Quarter 1**
**Follows:** Seminar 2 — The Change Log · **Points:** 5 · **Optional:** yes
...
Reconstruct a change log for work done so far.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every log includes at least one modification with its prompting result
...
Seminar 3 is **Reporting What Happened**, which assumes you arrive holding it. Write one thing you expect it to be about:
