# Seminar 4 Homework — Prespecified Versus Exploratory

**Doctoral Year 4** · Dissertation and Defence · **Quarter 1**
**Follows:** Seminar 4 — Prespecified Versus Exploratory · **Points:** 5 · **Optional:** yes
...
Label every analysis and check against the original plan document.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every analysis is checked against the plan, not against memory
...
Seminar 5 is **Both Discussions**, which assumes you arrive holding it. Write one thing you expect it to be about:
