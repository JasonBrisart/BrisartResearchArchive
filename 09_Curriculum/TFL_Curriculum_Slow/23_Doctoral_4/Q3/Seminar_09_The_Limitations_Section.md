# Seminar 9 — The Limitations Section
...
| | |
|---|---|
| **Central question** | The Limitations Section: participants state limits specifically rather than generically? |
| **Core concept** | A limitation names the conclusion it excludes. |
| **Student outcome** | Participants state limits specifically rather than generically. |
| **Previous seminar** | Seminar 8 — Revising Against Strangers |
| **Next seminar** | Seminar 10 — The Inference Audit |
| **Materials** | The participant's own proposal and data; dissertation structure templates |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_09_Printout.md` |
| **Homework** | `Homework/Seminar_09_Homework.md` |

## Why this lesson exists

**The conceptual step.** A limitation names the conclusion it excludes. Generic statements about sample size and generalisability exclude nothing and inform nobody.
...
**What depends on it.** Seminar 10 — The Inference Audit — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A limitation names the conclusion it excludes. Generic statements about sample size and generalisability exclude nothing and inform nobody.
...
1. A limitation naming a specific excluded conclusion.
2. A limitation naming a phenomenon the design could not detect.

### One non-example

A limitation stating that generalisability may be limited.
...
That limitations can be made specific and informative.

### What this activity does not establish

Whether the limitations are exhaustive.
...
| Statement | Status |
|---|---|
| A limitation names the conclusion it excludes. | Framework-derived, appropriate at this grade |
| That limitations can be made specific and informative. | What this specific activity can show |
| Whether the limitations are exhaustive. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 8 — Revising Against Strangers — specifically: participants revise chapters against stranger feedback.

**How it was taught.** Through the activity: revise and run a second stranger read with both counts reported

**Quick check.** Ask for the closing sentence of Seminar 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 8: revise and run a second stranger read with both counts reported, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A limitation naming a specific excluded conclusion. |
| **Non-example** | A limitation stating that generalisability may be limited. |
...
**Student materials.** One copy of `Printouts/Seminar_09_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 8, kept in the student's folder.
...
**File.** `Printouts/Seminar_09_Printout.md`
...
> "If the second matches the first, the revision missed."
...
**Exact wording.** "Put up a generic limitations section and ask what a reader learns from it."
...
**Target observation.** That limitations can be made specific and informative.
...
> "A limitation names the conclusion it excludes. You just saw that when put up a generic limitations section and ask what a reader learns from it.
> Last time we said: If the second matches the first, the revision missed. This is the next part of that.
...
**What students must not infer.** Whether the limitations are exhaustive.

### 4. Worked example

**The example.** A limitation naming a specific excluded conclusion.
...
**Completed answer.** A limitation naming a specific excluded conclusion. — which demonstrates that limitations can be made specific and informative.
...
**Conclusions not licensed.** Whether the limitations are exhaustive.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A limitation naming a phenomenon the design could not detect. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A limitation stating that generalisability may be limited. Why is this not an
example?"
...
**Exact student instructions.** Rewrite limitations so each names an excluded conclusion.
...
- *Licensed conclusion.* That limitations can be made specific and informative.
- *Not licensed.* Whether the limitations are exhaustive.
...
- *Expected response.* That limitations can be made specific and informative.
...
1. Any wording carrying the idea in `A limitation names the conclusion it excludes`.
...
Say: "A limitation without an excluded conclusion is decoration."

**Why this sentence matters.** It is the opening question of Seminar 10, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_09_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 8 — Revising Against Strangers |
| **Leads to** | Seminar 10 — The Inference Audit |

**Transition in.** Seminar 8 established participants revise chapters against stranger feedback. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants state limits specifically rather than generically. Seminar 10 assumes it and builds participants audit their own dissertation for ceiling breaches.
