...
| | |
|---|---|
| **Central question** | The Honest Result: students write a result with its limits stated? |
| **Core concept** | A result is incomplete without its limits. |
| **Student outcome** | Students write a result with its limits stated. |
| **Previous lesson** | Lesson 26 — What We Cannot Yet Say |
| **Next lesson** | Lesson 28 — Reading Somebody Else's Result |
...
**The conceptual step.** A result is incomplete without its limits. Generic limitations are not limits; the limit must name what the method could not have detected.
...
**What depends on it.** Lesson 28 — Reading Somebody Else's Result — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A result is incomplete without its limits. Generic limitations are not limits; the limit must name what the method could not have detected.
...
1. A limit stating the trial could not detect changes under one minute.
2. A limit stating only one partner was tested.

### One non-example

A limit stating more research is needed.
...
That results include stated limits.

### What this activity does not establish

Whether the limits are exhaustive.
...
| Statement | Status |
|---|---|
| A result is incomplete without its limits. | Framework-derived, appropriate at this grade |
| That results include stated limits. | What this specific activity can show |
| Whether the limits are exhaustive. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — What We Cannot Yet Say — specifically: students list the year's unanswered questions.

**How it was taught.** Through the activity: each student writes and seals a list of open questions for Grade 6

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: each student writes and seals a list of open questions for Grade 6, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A limit stating the trial could not detect changes under one minute. |
| **Non-example** | A limit stating more research is needed. |
...
> "Next year you get the proper names. Not all answers."
...
**Exact wording.** "Say: a result with no limits stated is not finished."
...
**Target observation.** That results include stated limits.
...
> "A result is incomplete without its limits. You just saw that when say: a result with no limits stated is not finished.
> Last time we said: Next year you get the proper names. Not all answers. This is the next part of that.
...
**What students must not infer.** Whether the limits are exhaustive.

### 4. Worked example

**The example.** A limit stating the trial could not detect changes under one minute.
...
**Completed answer.** A limit stating the trial could not detect changes under one minute. — which demonstrates that results include stated limits.
...
**Conclusions not licensed.** Whether the limits are exhaustive.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A limit stating only one partner was tested. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A limit stating more research is needed. Why is this not an
example?"
...
**Exact student instructions.** Rewrite three of their results with the limits explicitly named.
...
- *Licensed conclusion.* That results include stated limits.
- *Not licensed.* Whether the limits are exhaustive.
...
- *Expected response.* That results include stated limits.
...
1. Any wording carrying the idea in `A result is incomplete without its limits`.
...
Say: "Saying what you cannot conclude is part of the result."
...
| | |
|---|---|
| **Follows** | Lesson 26 — What We Cannot Yet Say |
| **Leads to** | Lesson 28 — Reading Somebody Else's Result |

**Transition in.** Lesson 26 established students list the year's unanswered questions. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students write a result with its limits stated. Lesson 28 assumes it and builds students audit a partner's result for overreach.
