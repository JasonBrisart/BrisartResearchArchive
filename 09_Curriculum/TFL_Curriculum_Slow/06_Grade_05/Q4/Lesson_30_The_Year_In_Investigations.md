# Lesson 30 — The Year In Investigations
...
| | |
|---|---|
| **Central question** | The Year In Investigations: students review the year using their own investigations? |
| **Core concept** | Comparing an early trial with a late full investigation gives direct evidence of the year's progress in method rather than content. |
| **Student outcome** | Students review the year using their own investigations. |
| **Previous lesson** | Lesson 29 — Explaining The Invisible |
...
**The conceptual step.** Comparing an early trial with a late full investigation gives direct evidence of the year's progress in method rather than content.
...
Comparing an early trial with a late full investigation gives direct evidence of the year's progress in method rather than content.
...
1. A Lesson 9 tally beside a Lesson 23 investigation.
2. A student noticing their early trials had no alternative.

### One non-example

Reviewing only the most recent work.
...
That the student's own method improved measurably.
...
| Statement | Status |
|---|---|
| Comparing an early trial with a late full investigation gives direct evidence of the year's progress in method rather than content. | Framework-derived, appropriate at this grade |
| That the student's own method improved measurably. | What this specific activity can show |
| Any external quality standard. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 29 — Explaining The Invisible — specifically: students explain invisibility and the break test to somebody else.

**How it was taught.** Through the activity: explain to a buddy; record the hardest question

**Quick check.** Ask for the closing sentence of Lesson 29. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 29: explain to a buddy; record the hardest question, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Lesson 9 tally beside a Lesson 23 investigation. |
| **Non-example** | Reviewing only the most recent work. |
...
**Exact wording.** "Lay out every investigation and trial from the year."
...
**Target observation.** That the student's own method improved measurably.
...
> "Comparing an early trial with a late full investigation gives direct evidence of the year's progress in method rather than content. You just saw that when lay out every investigation and trial from the year.
...
**The example.** A Lesson 9 tally beside a Lesson 23 investigation.
...
**Completed answer.** A Lesson 9 tally beside a Lesson 23 investigation. — which demonstrates that the student's own method improved measurably.
...
**Teacher prompt.** "Here is a second case. A student noticing their early trials had no alternative. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reviewing only the most recent work. Why is this not an
example?"
...
**Exact student instructions.** Order their own work and compare an early trial with a late one.
...
- *Licensed conclusion.* That the student's own method improved measurably.
...
- *Expected response.* That the student's own method improved measurably.
...
1. Any wording carrying the idea in `Comparing an early trial with a late full investigation gives direct evidence of the year's progress in method rather than content`.
...
Say: "Next year: everything gets a proper name."
...
| | |
|---|---|
| **Follows** | Lesson 29 — Explaining The Invisible |
| **Leads to** | Lesson 31 — Practice Final |

**Transition in.** Lesson 29 established students explain invisibility and the break test to somebody else. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students review the year using their own investigations. Lesson 31 assumes it and builds students rehearse the final under conditions.
