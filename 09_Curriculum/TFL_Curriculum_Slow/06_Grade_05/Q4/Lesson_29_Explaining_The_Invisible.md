# Lesson 29 — Explaining The Invisible

**Grade 5** · Invisible and Broken · **Quarter 4** · **40 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Explaining The Invisible: students explain invisibility and the break test to somebody else? |
| **Core concept** | Explaining invisibility is hard because the claim is about something with no direct evidence. |
| **Student outcome** | Students explain invisibility and the break test to somebody else. |
| **Previous lesson** | Lesson 28 — Reading Somebody Else's Result |
| **Next lesson** | Lesson 30 — The Year In Investigations |
...
**The conceptual step.** Explaining invisibility is hard because the claim is about something with no direct evidence. The break test is the argument, and the listener will probe it.
...
**What depends on it.** Lesson 30 — The Year In Investigations — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Explaining invisibility is hard because the claim is about something with no direct evidence. The break test is the argument, and the listener will probe it.
...
1. A listener asking how you can know about something you never noticed.
2. A listener asking whether the test could be wrong.

### One non-example

Reporting that the listener accepted it immediately.
...
Where the student's grasp of the argument runs out.
...
| Statement | Status |
|---|---|
| Explaining invisibility is hard because the claim is about something with no direct evidence. | Framework-derived, appropriate at this grade |
| Where the student's grasp of the argument runs out. | What this specific activity can show |
| Whether the explanation convinced anybody. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — Reading Somebody Else's Result — specifically: students audit a partner's result for overreach.

**How it was taught.** Through the activity: audit a partner's three results for overreach and mark each

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: audit a partner's three results for overreach and mark each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A listener asking how you can know about something you never noticed. |
| **Non-example** | Reporting that the listener accepted it immediately. |
...
> "Overreach is the commonest mistake, and it is easy to spot in others."
...
**Exact wording.** "Say: today you teach it."
...
**Target observation.** Where the student's grasp of the argument runs out.
...
> "Explaining invisibility is hard because the claim is about something with no direct evidence. You just saw that when say: today you teach it.
> Last time we said: Overreach is the commonest mistake, and it is easy to spot in others. This is the next part of that.
...
**The example.** A listener asking how you can know about something you never noticed.
...
**Completed answer.** A listener asking how you can know about something you never noticed. — which demonstrates where the student's grasp of the argument runs out.
...
**Teacher prompt.** "Here is a second case. A listener asking whether the test could be wrong. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reporting that the listener accepted it immediately. Why is this not an
example?"
...
**Exact student instructions.** Explain to a buddy; record the hardest question.
...
- *Licensed conclusion.* Where the student's grasp of the argument runs out.
...
- *Expected response.* Where the student's grasp of the argument runs out.
...
1. Any wording carrying the idea in `Explaining invisibility is hard because the claim is about something with no direct evidence`.
...
Say: "The question is the useful output."
...
| | |
|---|---|
| **Follows** | Lesson 28 — Reading Somebody Else's Result |
| **Leads to** | Lesson 30 — The Year In Investigations |

**Transition in.** Lesson 28 established students audit a partner's result for overreach. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain invisibility and the break test to somebody else. Lesson 30 assumes it and builds students review the year using their own investigations.
