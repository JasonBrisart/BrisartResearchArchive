# Lesson 27 Homework — The Honest Result

**Grade 5** · Invisible and Broken · **Quarter 4**
**Follows:** Lesson 27 — The Honest Result · **Points:** 5 · **Optional:** yes
...
Rewrite three of their results with the limits explicitly named.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student states limits on three results
...
Lesson 28 is **Reading Somebody Else's Result**, which assumes you arrive holding it. Write one thing you expect it to be about:
