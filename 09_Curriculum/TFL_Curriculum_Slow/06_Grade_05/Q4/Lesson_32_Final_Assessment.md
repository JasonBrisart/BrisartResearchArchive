...
| **Core concept** | The four exit outcomes together constitute readiness for Grade 6, where the parts receive their formal names. |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 6, where the parts receive their formal names.
...
The four exit outcomes together constitute readiness for Grade 6, where the parts receive their formal names.
...
2. A student produces a genuine alternative with a separator.

### One non-example

A student who writes at length on the break test and omits the alternative.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 6, where the parts receive their formal names. | Framework-derived, appropriate at this grade |
...
| **Non-example** | A student who writes at length on the break test and omits the alternative. |
...
> "The four exit outcomes together constitute readiness for Grade 6, where the parts receive their formal names. You just saw that when say: everything you know, on your own.
...
**Teacher prompt.** "Here is a second case. A student produces a genuine alternative with a separator. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student who writes at length on the break test and omits the alternative. Why is this not an
example?"
...
**Exact student instructions.** The final: the break test, contradiction outcomes, a designed break, an alternative with a separator.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 6, where the parts receive their formal names`.
...
Say: "Next year: the parts get their proper names."
