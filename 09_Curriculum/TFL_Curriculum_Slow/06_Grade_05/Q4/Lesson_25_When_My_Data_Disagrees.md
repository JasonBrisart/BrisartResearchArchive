# Lesson 25 — When My Data Disagrees
...
| **Core concept** | A result that does not fit is reported as it stands. |
| **Student outcome** | Students report honestly a result that does not fit. |
| **Previous lesson** | Lesson 24 — The Investigation Review |
| **Next lesson** | Lesson 26 — What We Cannot Yet Say |
...
**The conceptual step.** A result that does not fit is reported as it stands. Inventing a reason to exclude it is the error, and it is a tempting one.
...
**What depends on it.** Lesson 26 — What We Cannot Yet Say — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A result that does not fit is reported as it stands. Inventing a reason to exclude it is the error, and it is a tempting one.
...
1. A poorly fitting case described precisely.
2. A case reported with no attempt to explain it away.

### One non-example

A case dismissed because the partner was not concentrating.
...
That awkward results are reported rather than excluded.

### What this activity does not establish

Why the case does not fit.
...
| Statement | Status |
|---|---|
| A result that does not fit is reported as it stands. | Framework-derived, appropriate at this grade |
| That awkward results are reported rather than excluded. | What this specific activity can show |
| Why the case does not fit. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 24 — The Investigation Review — specifically: students consolidate investigation design.

**How it was taught.** Through the activity: review with six investigations audited for missing parts

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: review with six investigations audited for missing parts, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A poorly fitting case described precisely. |
| **Non-example** | A case dismissed because the partner was not concentrating. |
...
> "Next time: what we still cannot explain."
...
**Exact wording.** "Ask who has a result that does not fit and to read it out."
...
**Target observation.** That awkward results are reported rather than excluded.
...
> "A result that does not fit is reported as it stands. You just saw that when ask who has a result that does not fit and to read it out.
> Last time we said: Next time: what we still cannot explain. This is the next part of that.
...
**What students must not infer.** Why the case does not fit.

### 4. Worked example

**The example.** A poorly fitting case described precisely.
...
**Completed answer.** A poorly fitting case described precisely. — which demonstrates that awkward results are reported rather than excluded.
...
**Conclusions not licensed.** Why the case does not fit.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A case reported with no attempt to explain it away. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A case dismissed because the partner was not concentrating. Why is this not an
example?"
...
**Exact student instructions.** Describe one poorly fitting case precisely, without explaining it away.
...
- *Licensed conclusion.* That awkward results are reported rather than excluded.
- *Not licensed.* Why the case does not fit.
...
- *Expected response.* That awkward results are reported rather than excluded.
...
1. Any wording carrying the idea in `A result that does not fit is reported as it stands`.
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Investigation Review |
| **Leads to** | Lesson 26 — What We Cannot Yet Say |

**Transition in.** Lesson 24 established students consolidate investigation design. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students report honestly a result that does not fit. Lesson 26 assumes it and builds students list the year's unanswered questions.
