# Lesson 4 — The Invisible Everywhere
...
| | |
|---|---|
| **Central question** | The Invisible Everywhere: students find unnoticed expectations outside school? |
| **Core concept** | Invisible expectations are not a classroom phenomenon. |
| **Student outcome** | Students find unnoticed expectations outside school. |
| **Previous lesson** | Lesson 3 — Ranking By Surprise |
| **Next lesson** | Lesson 5 — Why Invisible |
...
**The conceptual step.** Invisible expectations are not a classroom phenomenon. Requiring a location for each prevents students from producing a generic list.
...
**What depends on it.** Lesson 5 — Why Invisible — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Invisible expectations are not a classroom phenomenon. Requiring a location for each prevents students from producing a generic list.
...
1. An expectation about the bus door, tested by imagining it stuck.
2. An expectation about the kitchen tap.

### One non-example

A school expectation relabelled with a home location.
...
That invisible expectations occur everywhere.

### What this activity does not establish

How many occur in any given period.
...
| Statement | Status |
|---|---|
| Invisible expectations are not a classroom phenomenon. | Framework-derived, appropriate at this grade |
| That invisible expectations occur everywhere. | What this specific activity can show |
| How many occur in any given period. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — Ranking By Surprise — specifically: students rank expectations by how strongly breaking them would surprise.

**How it was taught.** Through the activity: rank ten expectations by predicted surprise and justify the top three

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: rank ten expectations by predicted surprise and justify the top three, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An expectation about the bus door, tested by imagining it stuck. |
| **Non-example** | A school expectation relabelled with a home location. |
...
> "Stronger expectations produce bigger surprises when broken."
...
**Exact wording.** "Ask for ten from their journey here, none of which they noticed."
...
**Target observation.** That invisible expectations occur everywhere.
...
> "Invisible expectations are not a classroom phenomenon. You just saw that when ask for ten from their journey here, none of which they noticed.
> Last time we said: Stronger expectations produce bigger surprises when broken. This is the next part of that.
...
**What students must not infer.** How many occur in any given period.

### 4. Worked example

**The example.** An expectation about the bus door, tested by imagining it stuck.
...
**Completed answer.** An expectation about the bus door, tested by imagining it stuck. — which demonstrates that invisible expectations occur everywhere.
...
**Conclusions not licensed.** How many occur in any given period.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An expectation about the kitchen tap. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A school expectation relabelled with a home location. Why is this not an
example?"
...
**Exact student instructions.** Ten home or journey expectations with break tests applied.
...
- *Licensed conclusion.* That invisible expectations occur everywhere.
- *Not licensed.* How many occur in any given period.
...
- *Expected response.* That invisible expectations occur everywhere.
...
1. Any wording carrying the idea in `Invisible expectations are not a classroom phenomenon`.
...
Say: "It runs everywhere, and you notice none of it."
...
| | |
|---|---|
| **Follows** | Lesson 3 — Ranking By Surprise |
| **Leads to** | Lesson 5 — Why Invisible |

**Transition in.** Lesson 3 established students rank expectations by how strongly breaking them would surprise. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find unnoticed expectations outside school. Lesson 5 assumes it and builds students explain why correct expectations leave no trace.
