# Lesson 5 Homework — Why Invisible

**Grade 5** · Invisible and Broken · **Quarter 1**
**Follows:** Lesson 5 — Why Invisible · **Points:** 5 · **Optional:** yes
...
Write an explanation, then test it against three cases.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student's explanation survives three cases
...
Lesson 6 is **The Chair Argument**, which assumes you arrive holding it. Write one thing you expect it to be about:
