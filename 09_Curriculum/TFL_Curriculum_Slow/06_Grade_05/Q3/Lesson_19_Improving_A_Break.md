...
| | |
|---|---|
| **Central question** | Improving A Break: students revise a break design after it failed? |
| **Core concept** | Changing one thing at a time is what makes a revision diagnostic. |
| **Student outcome** | Students revise a break design after it failed. |
| **Previous lesson** | Lesson 18 — The Failed Break |
| **Next lesson** | Lesson 20 — Stating The Alternative |
...
**The conceptual step.** Changing one thing at a time is what makes a revision diagnostic. Changing everything means the improvement cannot be attributed.
...
**What depends on it.** Lesson 20 — Stating The Alternative — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Changing one thing at a time is what makes a revision diagnostic. Changing everything means the improvement cannot be attributed.
...
1. A re-run with one named change that worked.
2. A re-run with one named change that did not work.

### One non-example

A re-run with three changes and a better result.
...
That single-change revision is diagnostic.

### What this activity does not establish

Which change would work in general.
...
| Statement | Status |
|---|---|
| Changing one thing at a time is what makes a revision diagnostic. | Framework-derived, appropriate at this grade |
| That single-change revision is diagnostic. | What this specific activity can show |
| Which change would work in general. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — The Failed Break — specifically: students analyse a break that produced no surprise.

**How it was taught.** Through the activity: analyse one failed break against two explanations

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: analyse one failed break against two explanations, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A re-run with one named change that worked. |
| **Non-example** | A re-run with three changes and a better result. |
...
> "A break that did nothing is a result."
...
**Exact wording.** "Say: you know why it failed. Fix it and run it again."
...
**Target observation.** That single-change revision is diagnostic.
...
> "Changing one thing at a time is what makes a revision diagnostic. You just saw that when say: you know why it failed.
> Last time we said: A break that did nothing is a result. This is the next part of that.
...
**What students must not infer.** Which change would work in general.

### 4. Worked example

**The example.** A re-run with one named change that worked.
...
**Completed answer.** A re-run with one named change that worked. — which demonstrates that single-change revision is diagnostic.
...
**Conclusions not licensed.** Which change would work in general.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A re-run with one named change that did not work. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A re-run with three changes and a better result. Why is this not an
example?"
...
**Exact student instructions.** Revise and re-run the failed break, comparing both results.
...
- *Licensed conclusion.* That single-change revision is diagnostic.
- *Not licensed.* Which change would work in general.
...
- *Expected response.* That single-change revision is diagnostic.
...
1. Any wording carrying the idea in `Changing one thing at a time is what makes a revision diagnostic`.
...
Say: "The second run should work better. If not, the fix missed."
...
| | |
|---|---|
| **Follows** | Lesson 18 — The Failed Break |
| **Leads to** | Lesson 20 — Stating The Alternative |

**Transition in.** Lesson 18 established students analyse a break that produced no surprise. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students revise a break design after it failed. Lesson 20 assumes it and builds students name a different explanation for their own result.
