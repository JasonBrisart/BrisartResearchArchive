# Lesson 23 — The Full Investigation
...
| | |
|---|---|
| **Central question** | The Full Investigation: students run a complete investigation unaided? |
| **Core concept** | A complete investigation has six parts, and the separator is the hardest. |
| **Student outcome** | Students run a complete investigation unaided. |
| **Previous lesson** | Lesson 22 — Alternatives In Other Subjects |
| **Next lesson** | Lesson 24 — The Investigation Review |
...
**The conceptual step.** A complete investigation has six parts, and the separator is the hardest. A weak separator is still work; a blank is not.
...
**What depends on it.** Lesson 24 — The Investigation Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A complete investigation has six parts, and the separator is the hardest. A weak separator is still work; a blank is not.
...
1. A six-part write-up with all parts present.
2. A write-up whose separator is weak but genuine.

### One non-example

A five-part write-up with the separator omitted.
...
Whether the student can run a complete investigation.

### What this activity does not establish

Whether the investigation's conclusion is correct.
...
| Statement | Status |
|---|---|
| A complete investigation has six parts, and the separator is the hardest. | Framework-derived, appropriate at this grade |
| Whether the student can run a complete investigation. | What this specific activity can show |
| Whether the investigation's conclusion is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — Alternatives In Other Subjects — specifically: students apply alternatives to a claim from another subject.

**How it was taught.** Through the activity: three cross-subject claims, each with an alternative and a separator

**Quick check.** Ask for the closing sentence of Lesson 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: three cross-subject claims, each with an alternative and a separator, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A six-part write-up with all parts present. |
| **Non-example** | A five-part write-up with the separator omitted. |
...
> "It works on any claim, anywhere."
...
**Exact wording.** "Say: design, run, record, explain, alternative, separator. All of it."
...
**Target observation.** Whether the student can run a complete investigation.
...
> "A complete investigation has six parts, and the separator is the hardest. You just saw that when say: design, run, record, explain, alternative, separator.
> Last time we said: It works on any claim, anywhere. This is the next part of that.
...
**What students must not infer.** Whether the investigation's conclusion is correct.

### 4. Worked example

**The example.** A six-part write-up with all parts present.
...
**Completed answer.** A six-part write-up with all parts present. — which demonstrates whether the student can run a complete investigation.
...
**Conclusions not licensed.** Whether the investigation's conclusion is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A write-up whose separator is weak but genuine. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A five-part write-up with the separator omitted. Why is this not an
example?"
...
**Exact student instructions.** A six-part investigation on a partner, written up.
...
- *Licensed conclusion.* Whether the student can run a complete investigation.
- *Not licensed.* Whether the investigation's conclusion is correct.
...
- *Expected response.* Whether the student can run a complete investigation.
...
1. Any wording carrying the idea in `A complete investigation has six parts, and the separator is the hardest`.
...
| | |
|---|---|
| **Follows** | Lesson 22 — Alternatives In Other Subjects |
| **Leads to** | Lesson 24 — The Investigation Review |

**Transition in.** Lesson 22 established students apply alternatives to a claim from another subject. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students run a complete investigation unaided. Lesson 24 assumes it and builds students consolidate investigation design.
