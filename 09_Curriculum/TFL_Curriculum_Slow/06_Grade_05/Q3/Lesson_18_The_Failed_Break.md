# Lesson 18 — The Failed Break

**Grade 5** · Invisible and Broken · **Quarter 3** · **40 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Failed Break: students analyse a break that produced no surprise? |
| **Core concept** | A break producing no surprise is a result with two usual causes: the pattern was not established, or the partner anticipated the design. |
| **Student outcome** | Students analyse a break that produced no surprise. |
| **Previous lesson** | Lesson 17 — Designing A Break |
| **Next lesson** | Lesson 19 — Improving A Break |
...
**The conceptual step.** A break producing no surprise is a result with two usual causes: the pattern was not established, or the partner anticipated the design.
...
**What depends on it.** Lesson 19 — Improving A Break — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A break producing no surprise is a result with two usual causes: the pattern was not established, or the partner anticipated the design.
...
1. A failed break traced to only two establishing repetitions.
2. A failed break traced to the partner guessing the design.

### One non-example

A failed break hidden and a successful one reported instead.
...
That failed breaks are informative.

### What this activity does not establish

Which cause applies without further evidence.
...
| Statement | Status |
|---|---|
| A break producing no surprise is a result with two usual causes: the pattern was not established, or the partner anticipated the design. | Framework-derived, appropriate at this grade |
| That failed breaks are informative. | What this specific activity can show |
| Which cause applies without further evidence. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Designing A Break — specifically: students design an engineered mismatch of their own.

**How it was taught.** Through the activity: design and run a break on a partner, recording before, during, and after

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: design and run a break on a partner, recording before, during, and after, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A failed break traced to only two establishing repetitions. |
| **Non-example** | A failed break hidden and a successful one reported instead. |
...
> "Designing it is harder than being surprised by it."
...
**Exact wording.** "Ask whose break did nothing and what exactly they did."
...
**Target observation.** That failed breaks are informative.
...
> "A break producing no surprise is a result with two usual causes: the pattern was not established, or the partner anticipated the design. You just saw that when ask whose break did nothing and what exactly they did.
> Last time we said: Designing it is harder than being surprised by it. This is the next part of that.
...
**What students must not infer.** Which cause applies without further evidence.

### 4. Worked example

**The example.** A failed break traced to only two establishing repetitions.
...
**Completed answer.** A failed break traced to only two establishing repetitions. — which demonstrates that failed breaks are informative.
...
**Conclusions not licensed.** Which cause applies without further evidence.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A failed break traced to the partner guessing the design. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A failed break hidden and a successful one reported instead. Why is this not an
example?"
...
**Exact student instructions.** Analyse one failed break against two explanations.
...
- *Licensed conclusion.* That failed breaks are informative.
- *Not licensed.* Which cause applies without further evidence.
...
- *Expected response.* That failed breaks are informative.
...
1. Any wording carrying the idea in `A break producing no surprise is a result with two usual causes: the pattern was not established, or the partner anticipated the design`.
...
Say: "A break that did nothing is a result."
...
| | |
|---|---|
| **Follows** | Lesson 17 — Designing A Break |
| **Leads to** | Lesson 19 — Improving A Break |

**Transition in.** Lesson 17 established students design an engineered mismatch of their own. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students analyse a break that produced no surprise. Lesson 19 assumes it and builds students revise a break design after it failed.
