# Lesson 24 — The Investigation Review
...
| | |
|---|---|
| **Central question** | The Investigation Review: students consolidate investigation design? |
| **Core concept** | The alternative is the part most often omitted. |
| **Student outcome** | Students consolidate investigation design. |
| **Previous lesson** | Lesson 23 — The Full Investigation |
| **Next lesson** | Lesson 25 — When My Data Disagrees |
...
**The conceptual step.** The alternative is the part most often omitted. Returning investigations without it, unmarked, is what makes the requirement real.
...
**What depends on it.** Lesson 25 — When My Data Disagrees — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The alternative is the part most often omitted. Returning investigations without it, unmarked, is what makes the requirement real.
...
1. An investigation audited and the missing alternative identified.
2. An investigation with all six parts confirmed.

### One non-example

An investigation accepted with five parts.
...
Whether all six parts are habitual.

### What this activity does not establish

Whether the investigations are well designed.
...
| Statement | Status |
|---|---|
| The alternative is the part most often omitted. | Framework-derived, appropriate at this grade |
| Whether all six parts are habitual. | What this specific activity can show |
| Whether the investigations are well designed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — The Full Investigation — specifically: students run a complete investigation unaided.

**How it was taught.** Through the activity: a six-part investigation on a partner, written up

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: a six-part investigation on a partner, written up, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An investigation audited and the missing alternative identified. |
| **Non-example** | An investigation accepted with five parts. |
...
**Exact wording.** "Ask which of the six parts people skip."
...
**Target observation.** Whether all six parts are habitual.
...
> "The alternative is the part most often omitted. You just saw that when ask which of the six parts people skip.
> Last time we said: That is an investigation. This is the next part of that.
...
**What students must not infer.** Whether the investigations are well designed.

### 4. Worked example

**The example.** An investigation audited and the missing alternative identified.
...
**Completed answer.** An investigation audited and the missing alternative identified. — which demonstrates whether all six parts are habitual.
...
**Conclusions not licensed.** Whether the investigations are well designed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An investigation with all six parts confirmed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An investigation accepted with five parts. Why is this not an
example?"
...
**Exact student instructions.** Review with six investigations audited for missing parts.
...
- *Licensed conclusion.* Whether all six parts are habitual.
- *Not licensed.* Whether the investigations are well designed.
...
- *Expected response.* Whether all six parts are habitual.
...
1. Any wording carrying the idea in `The alternative is the part most often omitted`.
...
Say: "Next time: what we still cannot explain."
...
| | |
|---|---|
| **Follows** | Lesson 23 — The Full Investigation |
| **Leads to** | Lesson 25 — When My Data Disagrees |

**Transition in.** Lesson 23 established students run a complete investigation unaided. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate investigation design. Lesson 25 assumes it and builds students report honestly a result that does not fit.
