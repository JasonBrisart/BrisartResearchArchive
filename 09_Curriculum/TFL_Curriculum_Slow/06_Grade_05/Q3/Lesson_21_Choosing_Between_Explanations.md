# Lesson 21 — Choosing Between Explanations
...
| | |
|---|---|
| **Central question** | Choosing Between Explanations: students identify evidence that separates two explanations? |
| **Core concept** | Two explanations are separated by finding an observation they disagree about. |
| **Student outcome** | Students identify evidence that separates two explanations. |
| **Previous lesson** | Lesson 20 — Stating The Alternative |
| **Next lesson** | Lesson 22 — Alternatives In Other Subjects |
...
**The conceptual step.** Two explanations are separated by finding an observation they disagree about. An observation both predict cannot separate them.
...
**What depends on it.** Lesson 22 — Alternatives In Other Subjects — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Two explanations are separated by finding an observation they disagree about. An observation both predict cannot separate them.
...
1. An observation that one explanation predicts and the other does not.
2. A student testing a proposed separator and rejecting it.

### One non-example

An observation both explanations would predict.
...
That competing explanations can be separated by evidence.
...
| Statement | Status |
|---|---|
| Two explanations are separated by finding an observation they disagree about. | Framework-derived, appropriate at this grade |
| That competing explanations can be separated by evidence. | What this specific activity can show |
| Which explanation the evidence favours. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — Stating The Alternative — specifically: students name a different explanation for their own result.

**How it was taught.** Through the activity: three of their own results, each with a genuine alternative

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: three of their own results, each with a genuine alternative, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An observation that one explanation predicts and the other does not. |
| **Non-example** | An observation both explanations would predict. |
...
> "Your result is not finished without one."
...
**Exact wording.** "Put two explanations of one result up and ask what you would have to see."
...
**Target observation.** That competing explanations can be separated by evidence.
...
> "Two explanations are separated by finding an observation they disagree about. You just saw that when put two explanations of one result up and ask what you would have to see.
> Last time we said: Your result is not finished without one. This is the next part of that.
...
**What students must not infer.** Which explanation the evidence favours.

### 4. Worked example

**The example.** An observation that one explanation predicts and the other does not.
...
**Completed answer.** An observation that one explanation predicts and the other does not. — which demonstrates that competing explanations can be separated by evidence.
...
**Conclusions not licensed.** Which explanation the evidence favours.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student testing a proposed separator and rejecting it. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An observation both explanations would predict. Why is this not an
example?"
...
**Exact student instructions.** For each alternative, name one separating observation.
...
- *Licensed conclusion.* That competing explanations can be separated by evidence.
- *Not licensed.* Which explanation the evidence favours.
...
- *Expected response.* That competing explanations can be separated by evidence.
...
1. Any wording carrying the idea in `Two explanations are separated by finding an observation they disagree about`.
...
Say: "You choose by finding what they disagree about."
...
| | |
|---|---|
| **Follows** | Lesson 20 — Stating The Alternative |
| **Leads to** | Lesson 22 — Alternatives In Other Subjects |

**Transition in.** Lesson 20 established students name a different explanation for their own result. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify evidence that separates two explanations. Lesson 22 assumes it and builds students apply alternatives to a claim from another subject.
