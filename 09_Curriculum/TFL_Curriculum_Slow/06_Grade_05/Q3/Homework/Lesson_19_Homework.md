# Lesson 19 Homework — Improving A Break

**Grade 5** · Invisible and Broken · **Quarter 3**
**Follows:** Lesson 19 — Improving A Break · **Points:** 5 · **Optional:** yes
...
Revise and re-run the failed break, comparing both results.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student re-runs and compares
...
Lesson 20 is **Stating The Alternative**, which assumes you arrive holding it. Write one thing you expect it to be about:
