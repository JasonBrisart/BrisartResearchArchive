...
|---|---|---|---|---|---|---|
| `Lesson_17_Printout.md` | Lesson 17 — Designing A Break | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_18_Printout.md` | Lesson 18 — The Failed Break | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 17 work |
| `Lesson_19_Printout.md` | Lesson 19 — Improving A Break | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 18 work |
| `Lesson_20_Printout.md` | Lesson 20 — Stating The Alternative | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 19 work |
| `Lesson_21_Printout.md` | Lesson 21 — Choosing Between Explanations | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 20 work |
| `Lesson_22_Printout.md` | Lesson 22 — Alternatives In Other Subjects | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 21 work |
| `Lesson_23_Printout.md` | Lesson 23 — The Full Investigation | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 22 work |
| `Lesson_24_Printout.md` | Lesson 24 — The Investigation Review | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 23 work |
...
**Lesson 21 — Choosing Between Explanations.** If you only have time to print one
