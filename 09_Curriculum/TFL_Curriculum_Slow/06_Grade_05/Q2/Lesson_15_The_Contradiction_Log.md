# Lesson 15 — The Contradiction Log
...
| | |
|---|---|
| **Central question** | The Contradiction Log: students begin a running log of contradictions? |
| **Core concept** | A running log produces evidence that a recalled impression cannot. |
| **Student outcome** | Students begin a running log of contradictions. |
| **Previous lesson** | Lesson 14 — Contradiction Elsewhere |
| **Next lesson** | Lesson 16 — The Contradiction Review |
...
**The conceptual step.** A running log produces evidence that a recalled impression cannot. Date-stamping in class is what prevents backfilling.
...
**What depends on it.** Lesson 16 — The Contradiction Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A running log produces evidence that a recalled impression cannot. Date-stamping in class is what prevents backfilling.
...
1. Three dated entries with outcomes classified.
2. A log checked and stamped in class each week.

### One non-example

A log filled in at the end of the term from memory.
...
That a running log produces usable evidence.
...
| Statement | Status |
|---|---|
| A running log produces evidence that a recalled impression cannot. | Framework-derived, appropriate at this grade |
| That a running log produces usable evidence. | What this specific activity can show |
| What the log will show. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Contradiction Elsewhere — specifically: students find contradiction outside the classroom.

**How it was taught.** Through the activity: three real contradictions classified into the three outcomes

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: three real contradictions classified into the three outcomes, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Three dated entries with outcomes classified. |
| **Non-example** | A log filled in at the end of the term from memory. |
...
> "It happens constantly. Now you can name what it did."
...
**Exact wording.** "Say: every contradiction, logged, for the rest of the term."
...
**Target observation.** That a running log produces usable evidence.
...
> "A running log produces evidence that a recalled impression cannot. You just saw that when say: every contradiction, logged, for the rest of the term.
> Last time we said: It happens constantly. Now you can name what it did. This is the next part of that.
...
**What students must not infer.** What the log will show.

### 4. Worked example

**The example.** Three dated entries with outcomes classified.
...
**Completed answer.** Three dated entries with outcomes classified. — which demonstrates that a running log produces usable evidence.
...
**Conclusions not licensed.** What the log will show.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A log checked and stamped in class each week. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A log filled in at the end of the term from memory. Why is this not an
example?"
...
**Exact student instructions.** Start the log with three entries, each with the outcome classified.
...
- *Licensed conclusion.* That a running log produces usable evidence.
- *Not licensed.* What the log will show.
...
- *Expected response.* That a running log produces usable evidence.
...
1. Any wording carrying the idea in `A running log produces evidence that a recalled impression cannot`.
...
Say: "The log is the evidence. Keep it running."
...
| | |
|---|---|
| **Follows** | Lesson 14 — Contradiction Elsewhere |
| **Leads to** | Lesson 16 — The Contradiction Review |

**Transition in.** Lesson 14 established students find contradiction outside the classroom. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students begin a running log of contradictions. Lesson 16 assumes it and builds students consolidate contradiction.
