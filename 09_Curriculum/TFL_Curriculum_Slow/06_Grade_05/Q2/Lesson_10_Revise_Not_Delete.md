# Lesson 10 — Revise, Not Delete

**Grade 5** · Invisible and Broken · **Quarter 2** · **40 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Revise, Not Delete: students name the three things a contradiction can do? |
| **Core concept** | Contradiction produces revision, replacement, or suppression. |
| **Student outcome** | Students name the three things a contradiction can do. |
| **Previous lesson** | Lesson 9 — The Pattern Trial |
| **Next lesson** | Lesson 11 — How Many Breaks |
...
**The conceptual step.** Contradiction produces revision, replacement, or suppression. Deletion is not among the observed outcomes, and asking for a deletion case makes the absence visible.
...
**What depends on it.** Lesson 11 — How Many Breaks — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Contradiction produces revision, replacement, or suppression. Deletion is not among the observed outcomes, and asking for a deletion case makes the absence visible.
...
1. A case classified as revision because the expectation narrowed.
2. A case classified as suppression because it returned later.

### One non-example

A case classified as deletion, which cannot be evidenced.
...
That contradiction has several outcomes, none of them deletion.
...
| Statement | Status |
|---|---|
| Contradiction produces revision, replacement, or suppression. | Framework-derived, appropriate at this grade |
| That contradiction has several outcomes, none of them deletion. | What this specific activity can show |
| Which outcome is most common. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 9 — The Pattern Trial — specifically: students record class expectations across a broken pattern.

**How it was taught.** Through the activity: a nine-card tally with the drop and recovery plotted

**Quick check.** Ask for the closing sentence of Lesson 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 9: a nine-card tally with the drop and recovery plotted, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A case classified as revision because the expectation narrowed. |
| **Non-example** | A case classified as deletion, which cannot be evidenced. |
...
> "It was proved wrong one second ago and most went straight back."
...
**Exact wording.** "Ask whether the proved-wrong expectation got deleted."
...
**Target observation.** That contradiction has several outcomes, none of them deletion.
...
> "Contradiction produces revision, replacement, or suppression. You just saw that when ask whether the proved-wrong expectation got deleted.
> Last time we said: It was proved wrong one second ago and most went straight back. This is the next part of that.
...
**What students must not infer.** Which outcome is most common.

### 4. Worked example

**The example.** A case classified as revision because the expectation narrowed.
...
**Completed answer.** A case classified as revision because the expectation narrowed. — which demonstrates that contradiction has several outcomes, none of them deletion.
...
**Conclusions not licensed.** Which outcome is most common.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A case classified as suppression because it returned later. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A case classified as deletion, which cannot be evidenced. Why is this not an
example?"
...
**Exact student instructions.** Classify eight described cases into the three outcomes.
...
- *Licensed conclusion.* That contradiction has several outcomes, none of them deletion.
- *Not licensed.* Which outcome is most common.
...
- *Expected response.* That contradiction has several outcomes, none of them deletion.
...
1. Any wording carrying the idea in `Contradiction produces revision, replacement, or suppression`.
...
Say: "Contradiction revises or pushes aside. It does not erase."
...
| | |
|---|---|
| **Follows** | Lesson 9 — The Pattern Trial |
| **Leads to** | Lesson 11 — How Many Breaks |

**Transition in.** Lesson 9 established students record class expectations across a broken pattern. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students name the three things a contradiction can do. Lesson 11 assumes it and builds students count contradictions needed for durable change.
