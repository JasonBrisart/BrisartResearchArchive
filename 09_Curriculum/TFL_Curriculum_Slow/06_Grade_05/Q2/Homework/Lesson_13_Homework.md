# Lesson 13 Homework — Stronger Contradictions

**Grade 5** · Invisible and Broken · **Quarter 2**
**Follows:** Lesson 13 — Stronger Contradictions · **Points:** 5 · **Optional:** yes
...
Compare a mild and a strong break on the same expectation.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student records both counts
...
Lesson 14 is **Contradiction Elsewhere**, which assumes you arrive holding it. Write one thing you expect it to be about:
