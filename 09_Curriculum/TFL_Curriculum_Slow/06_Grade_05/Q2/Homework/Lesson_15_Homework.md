# Lesson 15 Homework — The Contradiction Log

**Grade 5** · Invisible and Broken · **Quarter 2**
**Follows:** Lesson 15 — The Contradiction Log · **Points:** 5 · **Optional:** yes
...
Start the log with three entries, each with the outcome classified.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has three logged entries with outcomes
...
Lesson 16 is **The Contradiction Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
