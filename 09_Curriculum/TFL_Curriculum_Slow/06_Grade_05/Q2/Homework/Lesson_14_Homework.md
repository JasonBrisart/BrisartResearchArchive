# Lesson 14 Homework — Contradiction Elsewhere

**Grade 5** · Invisible and Broken · **Quarter 2**
**Follows:** Lesson 14 — Contradiction Elsewhere · **Points:** 5 · **Optional:** yes
...
Three real contradictions classified into the three outcomes.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student classifies three real cases
...
Lesson 15 is **The Contradiction Log**, which assumes you arrive holding it. Write one thing you expect it to be about:
