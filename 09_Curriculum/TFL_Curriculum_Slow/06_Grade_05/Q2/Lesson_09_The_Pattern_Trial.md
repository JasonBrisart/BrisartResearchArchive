...
| | |
|---|---|
| **Central question** | The Pattern Trial: students record class expectations across a broken pattern? |
| **Core concept** | A single contradiction produces a drop that recovers within one or two trials. |
| **Student outcome** | Students record class expectations across a broken pattern. |
| **Previous lesson** | Lesson 8 — The Invisible Review |
| **Next lesson** | Lesson 10 — Revise, Not Delete |
...
**The conceptual step.** A single contradiction produces a drop that recovers within one or two trials. The plotted tally is what makes the recovery undeniable.
...
**What depends on it.** Lesson 10 — Revise, Not Delete — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A single contradiction produces a drop that recovers within one or two trials. The plotted tally is what makes the recovery undeniable.
...
1. A tally showing a drop at card six and recovery by seven.
2. A student noting their own expectation returned immediately.

### One non-example

A tally completed after all nine cards were seen.
...
That expectations recover quickly after one contradiction.
...
| Statement | Status |
|---|---|
| A single contradiction produces a drop that recovers within one or two trials. | Framework-derived, appropriate at this grade |
| That expectations recover quickly after one contradiction. | What this specific activity can show |
| Why they recover. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Invisible Review — specifically: students consolidate the quarter's work on invisibility.

**How it was taught.** Through the activity: review with six claimed expectations tested by the break test

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: review with six claimed expectations tested by the break test, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A tally showing a drop at card six and recovery by seven. |
| **Non-example** | A tally completed after all nine cards were seen. |
...
> "Next time: what breaking one actually does."
...
**Exact wording.** "Five circles, then a square. Written expectations before each card."
...
**Target observation.** That expectations recover quickly after one contradiction.
...
> "A single contradiction produces a drop that recovers within one or two trials. You just saw that when five circles, then a square.
> Last time we said: Next time: what breaking one actually does. This is the next part of that.
...
**What students must not infer.** Why they recover.

### 4. Worked example

**The example.** A tally showing a drop at card six and recovery by seven.
...
**Completed answer.** A tally showing a drop at card six and recovery by seven. — which demonstrates that expectations recover quickly after one contradiction.
...
**Conclusions not licensed.** Why they recover.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student noting their own expectation returned immediately. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A tally completed after all nine cards were seen. Why is this not an
example?"
...
**Exact student instructions.** A nine-card tally with the drop and recovery plotted.
...
- *Licensed conclusion.* That expectations recover quickly after one contradiction.
- *Not licensed.* Why they recover.
...
- *Expected response.* That expectations recover quickly after one contradiction.
...
1. Any wording carrying the idea in `A single contradiction produces a drop that recovers within one or two trials`.
...
Say: "It was proved wrong one second ago and most went straight back."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Invisible Review |
| **Leads to** | Lesson 10 — Revise, Not Delete |

**Transition in.** Lesson 8 established students consolidate the quarter's work on invisibility. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students record class expectations across a broken pattern. Lesson 10 assumes it and builds students name the three things a contradiction can do.
