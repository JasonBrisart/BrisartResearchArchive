# Lesson 16 — The Contradiction Review
...
| | |
|---|---|
| **Central question** | The Contradiction Review: students consolidate contradiction? |
| **Core concept** | The deleted category keeps returning because it is intuitive. |
| **Student outcome** | Students consolidate contradiction. |
| **Previous lesson** | Lesson 15 — The Contradiction Log |
| **Next lesson** | Lesson 17 — Designing A Break |
...
**The conceptual step.** The deleted category keeps returning because it is intuitive. The recovery data is the standing answer, and the review makes using it habitual.
...
**What depends on it.** Lesson 17 — Designing A Break — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The deleted category keeps returning because it is intuitive. The recovery data is the standing answer, and the review makes using it habitual.
...
1. A student rejecting deletion by citing the recovery tally.
2. Eight cases classified into the three legitimate outcomes.

### One non-example

Reintroducing deletion as a fourth category.
...
Whether the three-outcome classification is secure.
...
| Statement | Status |
|---|---|
| The deleted category keeps returning because it is intuitive. | Framework-derived, appropriate at this grade |
| Whether the three-outcome classification is secure. | What this specific activity can show |
| Which outcome is most common. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — The Contradiction Log — specifically: students begin a running log of contradictions.

**How it was taught.** Through the activity: start the log with three entries, each with the outcome classified

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: start the log with three entries, each with the outcome classified, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student rejecting deletion by citing the recovery tally. |
| **Non-example** | Reintroducing deletion as a fourth category. |
...
> "The log is the evidence. Keep it running."
...
**Exact wording.** "Ask what the three outcomes are and what is not one."
...
**Target observation.** Whether the three-outcome classification is secure.
...
> "The deleted category keeps returning because it is intuitive. You just saw that when ask what the three outcomes are and what is not one.
> Last time we said: The log is the evidence. Keep it running. This is the next part of that.
...
**The example.** A student rejecting deletion by citing the recovery tally.
...
**Completed answer.** A student rejecting deletion by citing the recovery tally. — which demonstrates whether the three-outcome classification is secure.
...
**Teacher prompt.** "Here is a second case. Eight cases classified into the three legitimate outcomes. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reintroducing deletion as a fourth category. Why is this not an
example?"
...
**Exact student instructions.** Review with eight cases classified and the deleted category defended against.
...
- *Licensed conclusion.* Whether the three-outcome classification is secure.
...
- *Expected response.* Whether the three-outcome classification is secure.
...
1. Any wording carrying the idea in `The deleted category keeps returning because it is intuitive`.
...
Say: "Next time: designing the break yourself."
...
| | |
|---|---|
| **Follows** | Lesson 15 — The Contradiction Log |
| **Leads to** | Lesson 17 — Designing A Break |

**Transition in.** Lesson 15 established students begin a running log of contradictions. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate contradiction. Lesson 17 assumes it and builds students design an engineered mismatch of their own.
