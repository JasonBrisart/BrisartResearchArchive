# Lesson 13 — Stronger Contradictions
...
| | |
|---|---|
| **Central question** | Stronger Contradictions: students test whether a stronger break changes the count? |
| **Core concept** | Comparing two conditions requires both to be run. |
| **Student outcome** | Students test whether a stronger break changes the count. |
| **Previous lesson** | Lesson 12 — The Return |
| **Next lesson** | Lesson 14 — Contradiction Elsewhere |
...
**The conceptual step.** Comparing two conditions requires both to be run. A single condition produces a number with nothing to compare it against.
...
**What depends on it.** Lesson 14 — Contradiction Elsewhere — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Comparing two conditions requires both to be run. A single condition produces a number with nothing to compare it against.
...
1. Two counts recorded from mild and strong breaks.
2. A student noting the two counts differ.

### One non-example

One condition run with the other estimated.
...
That two conditions can be compared directly.

### What this activity does not establish

Whether the difference generalises.
...
| Statement | Status |
|---|---|
| Comparing two conditions requires both to be run. | Framework-derived, appropriate at this grade |
| That two conditions can be compared directly. | What this specific activity can show |
| Whether the difference generalises. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — The Return — specifically: students observe a broken expectation reappearing.

**How it was taught.** Through the activity: record the sequence and write both explanations, admitting the question is open

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: record the sequence and write both explanations, admitting the question is open, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two counts recorded from mild and strong breaks. |
| **Non-example** | One condition run with the other estimated. |
...
> "We cannot tell which. That is an honest result."
...
**Exact wording.** "Ask whether a bigger surprise changes it faster."
...
**Target observation.** That two conditions can be compared directly.
...
> "Comparing two conditions requires both to be run. You just saw that when ask whether a bigger surprise changes it faster.
> Last time we said: We cannot tell which. That is an honest result. This is the next part of that.
...
**What students must not infer.** Whether the difference generalises.

### 4. Worked example

**The example.** Two counts recorded from mild and strong breaks.
...
**Completed answer.** Two counts recorded from mild and strong breaks. — which demonstrates that two conditions can be compared directly.
...
**Conclusions not licensed.** Whether the difference generalises.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student noting the two counts differ. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. One condition run with the other estimated. Why is this not an
example?"
...
**Exact student instructions.** Compare a mild and a strong break on the same expectation.
...
- *Licensed conclusion.* That two conditions can be compared directly.
- *Not licensed.* Whether the difference generalises.
...
- *Expected response.* That two conditions can be compared directly.
...
1. Any wording carrying the idea in `Comparing two conditions requires both to be run`.
...
Say: "Now you have two numbers to compare."
...
| | |
|---|---|
| **Follows** | Lesson 12 — The Return |
| **Leads to** | Lesson 14 — Contradiction Elsewhere |

**Transition in.** Lesson 12 established students observe a broken expectation reappearing. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students test whether a stronger break changes the count. Lesson 14 assumes it and builds students find contradiction outside the classroom.
