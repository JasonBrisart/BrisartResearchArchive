...
| | |
|---|---|
| **Central question** | The Peer Run: students run somebody else's method and report where it failed? |
| **Core concept** | Every point where the runner had to guess is a gap in the method. |
| **Student outcome** | Students run somebody else's method and report where it failed. |
| **Previous lesson** | Lesson 17 — Designing An Investigation |
| **Next lesson** | Lesson 19 — Repairing A Method |
...
**The conceptual step.** Every point where the runner had to guess is a gap in the method. Recording guesses as questions is what makes the list complete.
...
**What depends on it.** Lesson 19 — Repairing A Method — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every point where the runner had to guess is a gap in the method. Recording guesses as questions is what makes the list complete.
...
1. A clarification list with five recorded questions.
2. A guess recorded as a question rather than resolved silently.

### One non-example

A run completed by filling gaps with common sense.
...
That method gaps are detectable by handover.

### What this activity does not establish

Whether the method is otherwise sound.
...
| Statement | Status |
|---|---|
| Every point where the runner had to guess is a gap in the method. | Framework-derived, appropriate at this grade |
| That method gaps are detectable by handover. | What this specific activity can show |
| Whether the method is otherwise sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Designing An Investigation — specifically: students design an investigation with a reproducible method.

**How it was taught.** Through the activity: design an investigation of one guarantee and complete the six-item checklist

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: design an investigation of one guarantee and complete the six-item checklist, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A clarification list with five recorded questions. |
| **Non-example** | A run completed by filling gaps with common sense. |
...
> "Reproducible means runnable by somebody else."
...
**Exact wording.** "Say: swap designs. Run theirs. Every question you have to ask, write it down."
...
**Target observation.** That method gaps are detectable by handover.
...
> "Every point where the runner had to guess is a gap in the method. You just saw that when say: swap designs.
> Last time we said: Reproducible means runnable by somebody else. This is the next part of that.
...
**What students must not infer.** Whether the method is otherwise sound.

### 4. Worked example

**The example.** A clarification list with five recorded questions.
...
**Completed answer.** A clarification list with five recorded questions. — which demonstrates that method gaps are detectable by handover.
...
**Conclusions not licensed.** Whether the method is otherwise sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A guess recorded as a question rather than resolved silently. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A run completed by filling gaps with common sense. Why is this not an
example?"
...
**Exact student instructions.** Run a partner's investigation and return a full clarification list.
...
- *Licensed conclusion.* That method gaps are detectable by handover.
- *Not licensed.* Whether the method is otherwise sound.
...
- *Expected response.* That method gaps are detectable by handover.
...
1. Any wording carrying the idea in `Every point where the runner had to guess is a gap in the method`.
...
Say: "The questions they had to ask are the gaps in your method."
...
| | |
|---|---|
| **Follows** | Lesson 17 — Designing An Investigation |
| **Leads to** | Lesson 19 — Repairing A Method |

**Transition in.** Lesson 17 established students design an investigation with a reproducible method. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students run somebody else's method and report where it failed. Lesson 19 assumes it and builds students revise a design against reproducibility feedback.
