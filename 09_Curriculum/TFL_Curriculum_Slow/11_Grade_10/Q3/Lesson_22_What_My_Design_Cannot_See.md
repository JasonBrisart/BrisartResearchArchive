# Lesson 22 — What My Design Cannot See
...
| | |
|---|---|
| **Central question** | What My Design Cannot See: students state the limits of their own investigation? |
| **Core concept** | A blind spot names a specific phenomenon the design could not detect. |
| **Student outcome** | Students state the limits of their own investigation. |
| **Previous lesson** | Lesson 21 — Reporting The Result |
| **Next lesson** | Lesson 23 — The Defended Investigation |
...
**The conceptual step.** A blind spot names a specific phenomenon the design could not detect. Generic limitations are not blind spots.
...
**What depends on it.** Lesson 23 — The Defended Investigation — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A blind spot names a specific phenomenon the design could not detect. Generic limitations are not blind spots.
...
1. A blind spot naming sub-minute changes as undetectable.
2. A conclusion the design does not license, named specifically.

### One non-example

A limitation stating the sample was small.
...
**Prerequisite.** The content of Lesson 21 — Reporting The Result — specifically: students report a result without interpreting it.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: write a results section with no interpretive language, peer-marked, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A blind spot naming sub-minute changes as undetectable. |
| **Non-example** | A limitation stating the sample was small. |
...
> "A reader must be able to disagree with your conclusion from your results."
...
**Exact wording.** "Ask what their design could not detect even if it ran perfectly."
...
> "A blind spot names a specific phenomenon the design could not detect. You just saw that when ask what their design could not detect even if it ran perfectly.
> Last time we said: A reader must be able to disagree with your conclusion from your results. This is the next part of that.
...
**The example.** A blind spot naming sub-minute changes as undetectable.
...
**Completed answer.** A blind spot naming sub-minute changes as undetectable. — which demonstrates that blind spots can be named specifically.
...
**Teacher prompt.** "Now one that does not work. A limitation stating the sample was small. Why is this not an
example?"
...
**Exact student instructions.** List three blind spots and one conclusion they are not entitled to draw.
...
Say: "Naming what you cannot see makes what you can see interpretable."
...
| | |
|---|---|
| **Follows** | Lesson 21 — Reporting The Result |
| **Leads to** | Lesson 23 — The Defended Investigation |

**Transition in.** Lesson 21 established students report a result without interpreting it. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state the limits of their own investigation. Lesson 23 assumes it and builds students present an investigation and defend its method.
