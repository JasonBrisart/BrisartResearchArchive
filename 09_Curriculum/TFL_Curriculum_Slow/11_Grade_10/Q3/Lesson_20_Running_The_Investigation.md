# Lesson 20 — Running The Investigation
...
| | |
|---|---|
| **Central question** | Running The Investigation: students execute their repaired design and collect data? |
| **Core concept** | A contemporaneous record is made during the work. |
| **Student outcome** | Students execute their repaired design and collect data. |
| **Previous lesson** | Lesson 19 — Repairing A Method |
| **Next lesson** | Lesson 21 — Reporting The Result |
...
**The conceptual step.** A contemporaneous record is made during the work. A record reconstructed afterwards is a memory of the work and is weaker evidence.
...
**What depends on it.** Lesson 21 — Reporting The Result — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A contemporaneous record is made during the work. A record reconstructed afterwards is a memory of the work and is weaker evidence.
...
1. A dated record with entries made during the run.
2. A record whose timestamps span the session.

### One non-example

A record written up from memory that evening.
...
That contemporaneous recording is distinguishable.
...
| Statement | Status |
|---|---|
| A contemporaneous record is made during the work. | Framework-derived, appropriate at this grade |
| That contemporaneous recording is distinguishable. | What this specific activity can show |
| Whether the data supports the hypothesis. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — Repairing A Method — specifically: students revise a design against reproducibility feedback.

**How it was taught.** Through the activity: repair the design and have a second classmate attempt it

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: repair the design and have a second classmate attempt it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A dated record with entries made during the run. |
| **Non-example** | A record written up from memory that evening. |
...
> "The second run should produce fewer questions. If not, the repair missed."
...
**Exact wording.** "Say: run it properly. Record as you go, not afterwards."
...
**Target observation.** That contemporaneous recording is distinguishable.
...
> "A contemporaneous record is made during the work. You just saw that when say: run it properly.
> Last time we said: The second run should produce fewer questions. If not, the repair missed. This is the next part of that.
...
**What students must not infer.** Whether the data supports the hypothesis.

### 4. Worked example

**The example.** A dated record with entries made during the run.
...
**Completed answer.** A dated record with entries made during the run. — which demonstrates that contemporaneous recording is distinguishable.
...
**Conclusions not licensed.** Whether the data supports the hypothesis.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A record whose timestamps span the session. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A record written up from memory that evening. Why is this not an
example?"
...
**Exact student instructions.** Execute the investigation and produce a contemporaneous record.
...
- *Licensed conclusion.* That contemporaneous recording is distinguishable.
- *Not licensed.* Whether the data supports the hypothesis.
...
- *Expected response.* That contemporaneous recording is distinguishable.
...
1. Any wording carrying the idea in `A contemporaneous record is made during the work`.
...
Say: "Recorded as you go is the only kind that counts."
...
| | |
|---|---|
| **Follows** | Lesson 19 — Repairing A Method |
| **Leads to** | Lesson 21 — Reporting The Result |

**Transition in.** Lesson 19 established students revise a design against reproducibility feedback. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students execute their repaired design and collect data. Lesson 21 assumes it and builds students report a result without interpreting it.
