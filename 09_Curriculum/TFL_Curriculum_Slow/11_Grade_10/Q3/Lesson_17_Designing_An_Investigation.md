# Lesson 17 — Designing An Investigation

**Grade 10** · The Gate and the Guarantees · **Quarter 3** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Designing An Investigation: students design an investigation with a reproducible method? |
| **Core concept** | A reproducible method can be run by somebody else without clarification. |
| **Student outcome** | Students design an investigation with a reproducible method. |
| **Previous lesson** | Lesson 16 — The Guarantee Review |
| **Next lesson** | Lesson 18 — The Peer Run |
...
**The conceptual step.** A reproducible method can be run by somebody else without clarification. Handing it over and counting the questions is the only real test.
...
**What depends on it.** Lesson 18 — The Peer Run — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A reproducible method can be run by somebody else without clarification. Handing it over and counting the questions is the only real test.
...
1. A method run by a classmate with no questions asked.
2. A method revised after three clarification questions.

### One non-example

A method the author considers clear without testing it.
...
That reproducibility is testable by handover.

### What this activity does not establish

Whether the investigation would produce a result.
...
| Statement | Status |
|---|---|
| A reproducible method can be run by somebody else without clarification. | Framework-derived, appropriate at this grade |
| That reproducibility is testable by handover. | What this specific activity can show |
| Whether the investigation would produce a result. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Guarantee Review — specifically: students consolidate the guarantee set.

**How it was taught.** Through the activity: review with the full set recalled and four violations produced

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with the full set recalled and four violations produced, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A method run by a classmate with no questions asked. |
| **Non-example** | A method the author considers clear without testing it. |
...
> "Next time: designing something somebody else could run."
...
**Exact wording.** "Ask whether a classmate could run their method without asking a single question."
...
**Target observation.** That reproducibility is testable by handover.
...
> "A reproducible method can be run by somebody else without clarification. You just saw that when ask whether a classmate could run their method without asking a single question.
> Last time we said: Next time: designing something somebody else could run. This is the next part of that.
...
**What students must not infer.** Whether the investigation would produce a result.

### 4. Worked example

**The example.** A method run by a classmate with no questions asked.
...
**Completed answer.** A method run by a classmate with no questions asked. — which demonstrates that reproducibility is testable by handover.
...
**Conclusions not licensed.** Whether the investigation would produce a result.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A method revised after three clarification questions. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A method the author considers clear without testing it. Why is this not an
example?"
...
**Exact student instructions.** Design an investigation of one guarantee and complete the six-item checklist.
...
- *Licensed conclusion.* That reproducibility is testable by handover.
- *Not licensed.* Whether the investigation would produce a result.
...
- *Expected response.* That reproducibility is testable by handover.
...
1. Any wording carrying the idea in `A reproducible method can be run by somebody else without clarification`.
...
Say: "Reproducible means runnable by somebody else."
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Guarantee Review |
| **Leads to** | Lesson 18 — The Peer Run |

**Transition in.** Lesson 16 established students consolidate the guarantee set. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students design an investigation with a reproducible method. Lesson 18 assumes it and builds students run somebody else's method and report where it failed.
