# Lesson 21 Homework — Reporting The Result

**Grade 10** · The Gate and the Guarantees · **Quarter 3**
**Follows:** Lesson 21 — Reporting The Result · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 21 ended on, from memory:
...
Write a results section with no interpretive language, peer-marked.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every results section is marked and cleaned
...
Lesson 22 is **What My Design Cannot See**, which assumes you arrive holding it. Write one thing you expect it to be about:
