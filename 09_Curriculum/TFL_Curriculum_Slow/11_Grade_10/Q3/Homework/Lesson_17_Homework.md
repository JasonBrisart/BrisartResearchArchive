# Lesson 17 Homework — Designing An Investigation

**Grade 10** · The Gate and the Guarantees · **Quarter 3**
**Follows:** Lesson 17 — Designing An Investigation · **Points:** 5 · **Optional:** yes
...
Design an investigation of one guarantee and complete the six-item checklist.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has a checklist with no item requiring clarification
...
Lesson 18 is **The Peer Run**, which assumes you arrive holding it. Write one thing you expect it to be about:
