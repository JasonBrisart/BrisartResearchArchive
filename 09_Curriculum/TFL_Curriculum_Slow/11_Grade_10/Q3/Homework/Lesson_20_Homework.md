# Lesson 20 Homework — Running The Investigation

**Grade 10** · The Gate and the Guarantees · **Quarter 3**
**Follows:** Lesson 20 — Running The Investigation · **Points:** 5 · **Optional:** yes
...
Execute the investigation and produce a contemporaneous record.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has a dated, contemporaneous record
...
Lesson 21 is **Reporting The Result**, which assumes you arrive holding it. Write one thing you expect it to be about:
