# Lesson 24 Homework — The Design Review

**Grade 10** · The Gate and the Guarantees · **Quarter 3**
**Follows:** Lesson 24 — The Design Review · **Points:** 5 · **Optional:** yes
...
Review with six designs audited for the missing element.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class identifies the missing element in at least four
...
Lesson 25 is **Somebody Else Explains It**, which assumes you arrive holding it. Write one thing you expect it to be about:
