# Lesson 23 — The Defended Investigation
...
| | |
|---|---|
| **Central question** | The Defended Investigation: students present an investigation and defend its method? |
| **Core concept** | A defended investigation states the guarantee tested, the violating observation sought, the method, the result, and the blind spots. |
| **Student outcome** | Students present an investigation and defend its method. |
| **Previous lesson** | Lesson 22 — What My Design Cannot See |
| **Next lesson** | Lesson 24 — The Design Review |
...
**The conceptual step.** A defended investigation states the guarantee tested, the violating observation sought, the method, the result, and the blind spots. The blind spots are usually omitted.
...
**What depends on it.** Lesson 24 — The Design Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A defended investigation states the guarantee tested, the violating observation sought, the method, the result, and the blind spots. The blind spots are usually omitted.
...
1. A presentation including the blind spots unprompted.
2. A reproducibility question answered with the peer-run evidence.

### One non-example

A presentation of method and result only.
...
Whether the investigation can be defended.
...
| Statement | Status |
|---|---|
| A defended investigation states the guarantee tested, the violating observation sought, the method, the result, and the blind spots. | Framework-derived, appropriate at this grade |
| Whether the investigation can be defended. | What this specific activity can show |
| Whether the result is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — What My Design Cannot See — specifically: students state the limits of their own investigation.

**How it was taught.** Through the activity: list three blind spots and one conclusion they are not entitled to draw

**Quick check.** Ask for the closing sentence of Lesson 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: list three blind spots and one conclusion they are not entitled to draw, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A presentation including the blind spots unprompted. |
| **Non-example** | A presentation of method and result only. |
...
> "Naming what you cannot see makes what you can see interpretable."
...
**Exact wording.** "Say: the guarantee, the violation, the method, and what it could not see."
...
**Target observation.** Whether the investigation can be defended.
...
> "A defended investigation states the guarantee tested, the violating observation sought, the method, the result, and the blind spots. You just saw that when say: the guarantee, the violation, the method, and what it could not see.
> Last time we said: Naming what you cannot see makes what you can see interpretable. This is the next part of that.
...
**The example.** A presentation including the blind spots unprompted.
...
**Completed answer.** A presentation including the blind spots unprompted. — which demonstrates whether the investigation can be defended.
...
**Teacher prompt.** "Here is a second case. A reproducibility question answered with the peer-run evidence. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A presentation of method and result only. Why is this not an
example?"
...
**Exact student instructions.** A five-minute presentation with three questions taken, one on reproducibility.
...
- *Licensed conclusion.* Whether the investigation can be defended.
...
- *Expected response.* Whether the investigation can be defended.
...
1. Any wording carrying the idea in `A defended investigation states the guarantee tested, the violating observation sought, the method, the result, and the blind spots`.
...
Say: "Next year: how you would measure any of this properly."
...
| | |
|---|---|
| **Follows** | Lesson 22 — What My Design Cannot See |
| **Leads to** | Lesson 24 — The Design Review |

**Transition in.** Lesson 22 established students state the limits of their own investigation. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students present an investigation and defend its method. Lesson 24 assumes it and builds students consolidate reproducible design.
