...
| | |
|---|---|
| **Central question** | Repairing A Method: students revise a design against reproducibility feedback? |
| **Core concept** | Repair converts each recorded question into an explicit line. |
| **Student outcome** | Students revise a design against reproducibility feedback. |
| **Previous lesson** | Lesson 18 — The Peer Run |
| **Next lesson** | Lesson 20 — Running The Investigation |
...
**The conceptual step.** Repair converts each recorded question into an explicit line. A second run with fewer questions is the evidence that the repair worked.
...
**What depends on it.** Lesson 20 — Running The Investigation — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Repair converts each recorded question into an explicit line. A second run with fewer questions is the evidence that the repair worked.
...
1. A second run producing two questions rather than five.
2. A repair adding explicit timing instructions.

### One non-example

A defence that the original wording was clear enough.
...
Whether the method is now complete.
...
| Whether the method is now complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — The Peer Run — specifically: students run somebody else's method and report where it failed.

**How it was taught.** Through the activity: run a partner's investigation and return a full clarification list

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: run a partner's investigation and return a full clarification list, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A second run producing two questions rather than five. |
| **Non-example** | A defence that the original wording was clear enough. |
...
> "The questions they had to ask are the gaps in your method."
...
**Exact wording.** "Say: every question becomes a line in the method."
...
> "Repair converts each recorded question into an explicit line. You just saw that when say: every question becomes a line in the method.
> Last time we said: The questions they had to ask are the gaps in your method. This is the next part of that.
...
**What students must not infer.** Whether the method is now complete.

### 4. Worked example

**The example.** A second run producing two questions rather than five.
...
**Completed answer.** A second run producing two questions rather than five. — which demonstrates that repair is measurable by re-running.
...
**Conclusions not licensed.** Whether the method is now complete.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A repair adding explicit timing instructions. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence that the original wording was clear enough. Why is this not an
example?"
...
**Exact student instructions.** Repair the design and have a second classmate attempt it.
...
- *Not licensed.* Whether the method is now complete.
...
Say: "The second run should produce fewer questions. If not, the repair missed."
...
| | |
|---|---|
| **Follows** | Lesson 18 — The Peer Run |
| **Leads to** | Lesson 20 — Running The Investigation |

**Transition in.** Lesson 18 established students run somebody else's method and report where it failed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students revise a design against reproducibility feedback. Lesson 20 assumes it and builds students execute their repaired design and collect data.
