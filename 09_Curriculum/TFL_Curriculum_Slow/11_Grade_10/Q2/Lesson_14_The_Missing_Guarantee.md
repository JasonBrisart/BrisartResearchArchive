# Lesson 14 — The Missing Guarantee
...
| | |
|---|---|
| **Central question** | The Missing Guarantee: students identify guarantees a reader might expect but not find? |
| **Core concept** | Absent guarantees are informative. |
| **Student outcome** | Students identify guarantees a reader might expect but not find. |
| **Previous lesson** | Lesson 13 — Guarantees Versus Predictions |
| **Next lesson** | Lesson 15 — Guarantees Under Challenge |
...
**The conceptual step.** Absent guarantees are informative. The framework does not promise universal resolution, accuracy tracking, or neural correspondence, and each absence is deliberate.
...
**What depends on it.** Lesson 15 — Guarantees Under Challenge — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Absent guarantees are informative. The framework does not promise universal resolution, accuracy tracking, or neural correspondence, and each absence is deliberate.
...
1. Universal resolution listed as deliberately absent.
2. Accuracy tracking listed as absent, with the reason.

### One non-example

A present guarantee listed as absent.
...
That absences are identifiable and deliberate.

### What this activity does not establish

Whether the absences are appropriate.
...
| Statement | Status |
|---|---|
| Absent guarantees are informative. | Framework-derived, appropriate at this grade |
| That absences are identifiable and deliberate. | What this specific activity can show |
| Whether the absences are appropriate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 13 — Guarantees Versus Predictions — specifically: students distinguish an architectural guarantee from an empirical prediction.

**How it was taught.** Through the activity: sort eight statements into guarantees and empirical predictions

**Quick check.** Ask for the closing sentence of Lesson 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 13: sort eight statements into guarantees and empirical predictions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Universal resolution listed as deliberately absent. |
| **Non-example** | A present guarantee listed as absent. |
...
> "Different kinds of claim, tested in different ways."
...
**Exact wording.** "Ask what they would expect a model like this to promise that it does not."
...
**Target observation.** That absences are identifiable and deliberate.
...
> "Absent guarantees are informative. You just saw that when ask what they would expect a model like this to promise that it does not.
> Last time we said: Different kinds of claim, tested in different ways. This is the next part of that.
...
**What students must not infer.** Whether the absences are appropriate.

### 4. Worked example

**The example.** Universal resolution listed as deliberately absent.
...
**Completed answer.** Universal resolution listed as deliberately absent. — which demonstrates that absences are identifiable and deliberate.
...
**Conclusions not licensed.** Whether the absences are appropriate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Accuracy tracking listed as absent, with the reason. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A present guarantee listed as absent. Why is this not an
example?"
...
**Exact student instructions.** List three absent guarantees and say why each is absent.
...
- *Licensed conclusion.* That absences are identifiable and deliberate.
- *Not licensed.* Whether the absences are appropriate.
...
- *Expected response.* That absences are identifiable and deliberate.
...
1. Any wording carrying the idea in `Absent guarantees are informative`.
...
Say: "The absences are as informative as the promises."
...
| | |
|---|---|
| **Follows** | Lesson 13 — Guarantees Versus Predictions |
| **Leads to** | Lesson 15 — Guarantees Under Challenge |

**Transition in.** Lesson 13 established students distinguish an architectural guarantee from an empirical prediction. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify guarantees a reader might expect but not find. Lesson 15 assumes it and builds students defend a guarantee against a challenge.
