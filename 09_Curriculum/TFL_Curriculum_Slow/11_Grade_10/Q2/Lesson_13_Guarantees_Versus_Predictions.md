# Lesson 13 — Guarantees Versus Predictions

**Grade 10** · The Gate and the Guarantees · **Quarter 2** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Guarantees Versus Predictions: students distinguish an architectural guarantee from an empirical prediction? |
| **Core concept** | An architectural guarantee is a property of the model; an empirical prediction is a claim about what will be observed. |
| **Student outcome** | Students distinguish an architectural guarantee from an empirical prediction. |
| **Previous lesson** | Lesson 12 — Ranking The Guarantees |
| **Next lesson** | Lesson 14 — The Missing Guarantee |
...
**The conceptual step.** An architectural guarantee is a property of the model; an empirical prediction is a claim about what will be observed. They are tested differently.
...
**What depends on it.** Lesson 14 — The Missing Guarantee — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An architectural guarantee is a property of the model; an empirical prediction is a claim about what will be observed. They are tested differently.
...
1. Conditional determinism sorted as an architectural guarantee.
2. A persistence claim sorted as an empirical prediction.

### One non-example

A guarantee treated as a prediction about human behaviour.
...
That the two claim types are distinguishable.

### What this activity does not establish

Whether either type holds.
...
| Statement | Status |
|---|---|
| An architectural guarantee is a property of the model; an empirical prediction is a claim about what will be observed. | Framework-derived, appropriate at this grade |
| That the two claim types are distinguishable. | What this specific activity can show |
| Whether either type holds. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — Ranking The Guarantees — specifically: students rank guarantees by how exposed they are.

**How it was taught.** Through the activity: rank all guarantees by exposure and justify the top two

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: rank all guarantees by exposure and justify the top two, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Conditional determinism sorted as an architectural guarantee. |
| **Non-example** | A guarantee treated as a prediction about human behaviour. |
...
> "The most exposed one is where the framework fails first, if it fails."
...
**Exact wording.** "Ask whether conditional determinism is a prediction about people or a property of the model."
...
**Target observation.** That the two claim types are distinguishable.
...
> "An architectural guarantee is a property of the model; an empirical prediction is a claim about what will be observed. You just saw that when ask whether conditional determinism is a prediction about people or a property of the model.
> Last time we said: The most exposed one is where the framework fails first, if it fails. This is the next part of that.
...
**What students must not infer.** Whether either type holds.

### 4. Worked example

**The example.** Conditional determinism sorted as an architectural guarantee.
...
**Completed answer.** Conditional determinism sorted as an architectural guarantee. — which demonstrates that the two claim types are distinguishable.
...
**Conclusions not licensed.** Whether either type holds.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A persistence claim sorted as an empirical prediction. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A guarantee treated as a prediction about human behaviour. Why is this not an
example?"
...
**Exact student instructions.** Sort eight statements into guarantees and empirical predictions.
...
- *Licensed conclusion.* That the two claim types are distinguishable.
- *Not licensed.* Whether either type holds.
...
- *Expected response.* That the two claim types are distinguishable.
...
1. Any wording carrying the idea in `An architectural guarantee is a property of the model; an empirical prediction is a claim about what will be observed`.
...
Say: "Different kinds of claim, tested in different ways."
...
| | |
|---|---|
| **Follows** | Lesson 12 — Ranking The Guarantees |
| **Leads to** | Lesson 14 — The Missing Guarantee |

**Transition in.** Lesson 12 established students rank guarantees by how exposed they are. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students distinguish an architectural guarantee from an empirical prediction. Lesson 14 assumes it and builds students identify guarantees a reader might expect but not find.
