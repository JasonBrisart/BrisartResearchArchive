# Lesson 10 — Convergence Is Not Guaranteed
...
| | |
|---|---|
| **Central question** | Convergence Is Not Guaranteed: students state the three conditions under which resolution occurs? |
| **Core concept** | Resolution occurs under sufficient congruence, contradiction-driven update, or decay below threshold. |
| **Student outcome** | Students state the three conditions under which resolution occurs. |
| **Previous lesson** | Lesson 9 — The Guarantee Set |
| **Next lesson** | Lesson 11 — Violating A Guarantee |
...
**The conceptual step.** Resolution occurs under sufficient congruence, contradiction-driven update, or decay below threshold. Refusing to guarantee universal resolution is a falsifiability strength.
...
**What depends on it.** Lesson 11 — Violating A Guarantee — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Resolution occurs under sufficient congruence, contradiction-driven update, or decay below threshold. Refusing to guarantee universal resolution is a falsifiability strength.
...
1. Resolution via contradiction-driven revision.
2. Resolution via decay below the threshold.

### One non-example

A claim that the loop always resolves given enough time.
...
That convergence is conditional and the conditions are stateable.

### What this activity does not establish

Whether the conditions are exhaustive.
...
| Statement | Status |
|---|---|
| Resolution occurs under sufficient congruence, contradiction-driven update, or decay below threshold. | Framework-derived, appropriate at this grade |
| That convergence is conditional and the conditions are stateable. | What this specific activity can show |
| Whether the conditions are exhaustive. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 9 — The Guarantee Set — specifically: students state what the architecture commits to.

**How it was taught.** Through the activity: list the guarantees from the chart, then close it and list from memory

**Quick check.** Ask for the closing sentence of Lesson 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 9: list the guarantees from the chart, then close it and list from memory, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Resolution via contradiction-driven revision. |
| **Non-example** | A claim that the loop always resolves given enough time. |
...
> "Note what is missing. The framework does not promise resolution."
...
**Exact wording.** "Ask whether the loop always resolves eventually. Most say yes."
...
**Target observation.** That convergence is conditional and the conditions are stateable.
...
> "Resolution occurs under sufficient congruence, contradiction-driven update, or decay below threshold. You just saw that when ask whether the loop always resolves eventually.
> Last time we said: Note what is missing. The framework does not promise resolution. This is the next part of that.
...
**What students must not infer.** Whether the conditions are exhaustive.

### 4. Worked example

**The example.** Resolution via contradiction-driven revision.
...
**Completed answer.** Resolution via contradiction-driven revision. — which demonstrates that convergence is conditional and the conditions are stateable.
...
**Conclusions not licensed.** Whether the conditions are exhaustive.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Resolution via decay below the threshold. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that the loop always resolves given enough time. Why is this not an
example?"
...
**Exact student instructions.** Write the three conditions and explain why refusing the guarantee is a strength.
...
- *Licensed conclusion.* That convergence is conditional and the conditions are stateable.
- *Not licensed.* Whether the conditions are exhaustive.
...
- *Expected response.* That convergence is conditional and the conditions are stateable.
...
1. Any wording carrying the idea in `Resolution occurs under sufficient congruence, contradiction-driven update, or decay below threshold`.
...
Say: "A model guaranteeing universal resolution claims more and defends less."
...
| | |
|---|---|
| **Follows** | Lesson 9 — The Guarantee Set |
| **Leads to** | Lesson 11 — Violating A Guarantee |

**Transition in.** Lesson 9 established students state what the architecture commits to. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state the three conditions under which resolution occurs. Lesson 11 assumes it and builds students convert each guarantee into a violating observation.
