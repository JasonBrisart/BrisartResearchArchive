# Lesson 15 Homework — Guarantees Under Challenge

**Grade 10** · The Gate and the Guarantees · **Quarter 2**
**Follows:** Lesson 15 — Guarantees Under Challenge · **Points:** 5 · **Optional:** yes
...
Defend two guarantees against written challenges.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student defends two specifically
...
Lesson 16 is **The Guarantee Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
