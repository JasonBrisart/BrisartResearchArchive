# Lesson 9 Homework — The Guarantee Set

**Grade 10** · The Gate and the Guarantees · **Quarter 2**
**Follows:** Lesson 9 — The Guarantee Set · **Points:** 5 · **Optional:** yes
...
List the guarantees from the chart, then close it and list from memory.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student recalls at least six
...
Lesson 10 is **Convergence Is Not Guaranteed**, which assumes you arrive holding it. Write one thing you expect it to be about:
