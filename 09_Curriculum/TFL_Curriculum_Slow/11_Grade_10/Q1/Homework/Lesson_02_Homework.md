# Lesson 2 Homework — Exclusive Gating

**Grade 10** · The Gate and the Guarantees · **Quarter 1**
**Follows:** Lesson 2 — Exclusive Gating · **Points:** 5 · **Optional:** yes
...
Write the three-part exclusivity claim and give one example of each denial.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student states all three denials
...
Lesson 3 is **Bounded Persistence**, which assumes you arrive holding it. Write one thing you expect it to be about:
