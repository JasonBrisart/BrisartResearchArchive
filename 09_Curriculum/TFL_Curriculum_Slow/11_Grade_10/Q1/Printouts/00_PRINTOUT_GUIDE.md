...
|---|---|---|---|---|---|---|
| `Lesson_01_Printout.md` | Lesson 1 — Where E(t) Lives | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_02_Printout.md` | Lesson 2 — Exclusive Gating | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 1 work |
| `Lesson_03_Printout.md` | Lesson 3 — Bounded Persistence | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 2 work |
| `Lesson_04_Printout.md` | Lesson 4 — The Gate Under Pressure | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 3 work |
| `Lesson_05_Printout.md` | Lesson 5 — The Mediation Defence | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 4 work |
| `Lesson_06_Printout.md` | Lesson 6 — Designing The Deciding Test | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 5 work |
| `Lesson_07_Printout.md` | Lesson 7 — Gating In Other Accounts | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 6 work |
| `Lesson_08_Printout.md` | Lesson 8 — The Gating Review | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 7 work |
...
**Lesson 5 — The Mediation Defence.** If you only have time to print one
