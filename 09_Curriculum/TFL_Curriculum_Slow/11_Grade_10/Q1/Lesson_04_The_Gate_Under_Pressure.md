# Lesson 4 — The Gate Under Pressure
...
| | |
|---|---|
| **Central question** | The Gate Under Pressure: students argue three positions on the exclusive gating claim? |
| **Core concept** | The exclusive gating claim is genuinely contestable. |
| **Student outcome** | Students argue three positions on the exclusive gating claim. |
| **Previous lesson** | Lesson 3 — Bounded Persistence |
| **Next lesson** | Lesson 5 — The Mediation Defence |
...
**The conceptual step.** The exclusive gating claim is genuinely contestable. The deciding observation is what would separate the positions, and the room may not be able to specify it.
...
**What depends on it.** Lesson 5 — The Mediation Defence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The exclusive gating claim is genuinely contestable. The deciding observation is what would separate the positions, and the room may not be able to specify it.
...
1. A deciding observation involving within-window measurement.
2. An honest report that the room could not specify one.

### One non-example

A resolution declaring the framework's position correct.
...
| Statement | Status |
|---|---|
| The exclusive gating claim is genuinely contestable. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 3 — Bounded Persistence — specifically: students explain why E(t) must be bounded.

**How it was taught.** Through the activity: write why unbounded E(t) would be a problem and name a violating observation

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: write why unbounded E(t) would be a problem and name a violating observation, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A deciding observation involving within-window measurement. |
| **Non-example** | A resolution declaring the framework's position correct. |
...
> "Boundedness stops the gate from explaining everything."
...
**Exact wording.** "Assign three positions: implausible, the-narrowness-is-the-point, and unfalsifiable-rescue."
...
> "The exclusive gating claim is genuinely contestable. You just saw that when assign three positions: implausible, the-narrowness-is-the-point, and unfalsifiable-rescue.
> Last time we said: Boundedness stops the gate from explaining everything. This is the next part of that.
...
**The example.** A deciding observation involving within-window measurement.
...
**Completed answer.** A deciding observation involving within-window measurement. — which demonstrates that the claim is contestable and the contest is specifiable.
...
**Teacher prompt.** "Here is a second case. An honest report that the room could not specify one. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A resolution declaring the framework's position correct. Why is this not an
example?"
...
**Exact student instructions.** Write the deciding observation after all three have presented.
...
1. Any wording carrying the idea in `The exclusive gating claim is genuinely contestable`.
...
Say: "Write that observation down. It returns in Grade 12 and in college."
...
| | |
|---|---|
| **Follows** | Lesson 3 — Bounded Persistence |
| **Leads to** | Lesson 5 — The Mediation Defence |

**Transition in.** Lesson 3 established students explain why E(t) must be bounded. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students argue three positions on the exclusive gating claim. Lesson 5 assumes it and builds students evaluate whether the mediation defence is principled.
