# Lesson 5 — The Mediation Defence

**Grade 10** · The Gate and the Guarantees · **Quarter 1** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Mediation Defence: students evaluate whether the mediation defence is principled? |
| **Core concept** | The mediation defence attributes apparent affect-on-interpretation effects to carried-forward content. |
| **Student outcome** | Students evaluate whether the mediation defence is principled. |
| **Previous lesson** | Lesson 4 — The Gate Under Pressure |
| **Next lesson** | Lesson 6 — Designing The Deciding Test |
...
**The conceptual step.** The mediation defence attributes apparent affect-on-interpretation effects to carried-forward content. Whether this is principled depends on whether within-window and propagated effects can be distinguished.

**Why students need it now.** This grade owns one idea: exclusive gating, the guarantee set, and reproducible investigation design.
...
that e(t) colours everything. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Investigation design. A method must be reproducible by a peer without asking the author a question.

**What depends on it.** Lesson 6 — Designing The Deciding Test — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The mediation defence attributes apparent affect-on-interpretation effects to carried-forward content. Whether this is principled depends on whether within-window and propagated effects can be distinguished.

### How this is stated at this grade

Investigation design. A method must be reproducible by a peer without asking the author a question.

Use only the vocabulary released at or before this grade. Terms not yet available:
The three rival accounts by name, operationalisation as a formal requirement.

### Why the concept matters

The whole grade rests on exclusive gating, the guarantee set, and reproducible investigation design. If a student leaves this
...
1. A statement of what within-window evidence would settle it.
2. An honest conclusion that the defence is currently unfalsifiable.

### One non-example

Accepting the defence because the framework offers it.
...
That the defence's status is testable.
...
| Statement | Status |
|---|---|
| The mediation defence attributes apparent affect-on-interpretation effects to carried-forward content. | Framework-derived, appropriate at this grade |
| That the defence's status is testable. | What this specific activity can show |
| Whether the defence is principled. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — The Gate Under Pressure — specifically: students argue three positions on the exclusive gating claim.

**How it was taught.** Through the activity: write the deciding observation after all three have presented

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: write the deciding observation after all three have presented, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | E(t) governs persistence only and contributes to nothing else. |
| **Student wording** | E(t) governs persistence only and contributes to nothing else. |
| **Correct example** | A statement of what within-window evidence would settle it. |
| **Non-example** | Accepting the defence because the framework offers it. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for e(t) governs persistence only and contributes to nothing else." |

### bounded persistence

| | |
|---|---|
| **Teacher definition** | E(t) is bounded and cannot escalate without limit. |
| **Student wording** | E(t) is bounded and cannot escalate without limit. |
| **Correct example** | A statement of what within-window evidence would settle it. |
| **Non-example** | Accepting the defence because the framework offers it. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for e(t) is bounded and cannot escalate without limit." |

### guarantee

| | |
|---|---|
| **Teacher definition** | something the architecture commits to. |
| **Student wording** | Something the architecture commits to. |
| **Correct example** | A statement of what within-window evidence would settle it. |
| **Non-example** | Accepting the defence because the framework offers it. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for something the architecture commits to." |


Do not introduce terminology from later grades. The three rival accounts by name, operationalisation as a formal requirement.

## Materials and preparation

**Teacher materials.** Lab books; Whiteboard access; Printed guarantee sheets; A timer.
...
> "Write that observation down. It returns in Grade 12 and in college."
...
**Exact wording.** "Say: affect changed interpretation. The framework says that was carried-forward content. Is that a defence or a dodge?"
...
**Target observation.** That the defence's status is testable.
...
> "The mediation defence attributes apparent affect-on-interpretation effects to carried-forward content. You just saw that when say: affect changed interpretation.
> Last time we said: Write that observation down. It returns in Grade 12 and in college. This is the next part of that.
> It matters because e(t) is a gate, not an ingredient — and the architecture does not promise everything resolves"
...
**Terminology to introduce here.** exclusive gating, bounded persistence, guarantee.

**What students must not infer.** Whether the defence is principled.

### 4. Worked example

**The example.** A statement of what within-window evidence would settle it.
...
**Completed answer.** A statement of what within-window evidence would settle it. — which demonstrates that the defence's status is testable.
...
**Teacher prompt.** "Here is a second case. An honest conclusion that the defence is currently unfalsifiable. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Accepting the defence because the framework offers it. Why is this not an
example?"
...
**Exact student instructions.** Assess the defence against the unfalsifiability charge and state what would settle it.
...
- *Licensed conclusion.* That the defence's status is testable.
...
- *Expected response.* That the defence's status is testable.
...
3. **Misconception check.** Somebody says: "E(t) colours everything" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `The mediation defence attributes apparent affect-on-interpretation effects to carried-forward content`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: The narrowness is what makes it testable.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "Either principled or a rescue. Specifying the evidence decides which."
...
### 1. "E(t) colours everything"

**What the student says or does.** E(t) colours everything — usually while otherwise engaging well.

**Why it is understandable.** Most intuitive accounts of emotion say exactly that.
...
**Exact correction.** State the exclusive claim, then require the refuting observation.

**Say this.** "The narrowness is what makes it testable."
...
### 2. "The architecture promises everything resolves"

**What the student says or does.** The architecture promises everything resolves — usually while otherwise engaging well.

**Why it is understandable.** Models are assumed to be tidy.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Show that convergence is conditional with three stated conditions.

**Say this.** "A universal guarantee would be far less defensible."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "A guarantee is a strength claim"

**What the student says or does.** A guarantee is a strength claim — usually while otherwise engaging well.

**Why it is understandable.** Students read guarantees as advertising.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Require the violating observation for every guarantee.

**Say this.** "A guarantee you cannot violate on paper is a slogan."
...
**Visual or physical support.** Provide the guarantee set with the first violating observation worked.
...
Ask them to argue the mediation defence is an unfalsifiable rescue.
...
Specifically, do not introduce: The three rival accounts by name, operationalisation as a formal requirement.
...
| | |
|---|---|
| **Follows** | Lesson 4 — The Gate Under Pressure |
| **Leads to** | Lesson 6 — Designing The Deciding Test |

**Transition in.** Lesson 4 established students argue three positions on the exclusive gating claim. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students evaluate whether the mediation defence is principled. Lesson 6 assumes it and builds students sketch the design that would settle the gating question.
