# Lesson 32 Homework — Final Assessment

**Grade 10** · The Gate and the Guarantees · **Quarter 4**
**Follows:** Lesson 32 — Final Assessment · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 32 ended on, from memory:
...
The final: both relations, exclusive gating with three denials, a violating observation, a reproducible method.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** all four outcomes are demonstrated
...
This is the last lesson of the year, so this prepares you for the final rather than for a new lesson.
