# Lesson 28 — Redesigning To Separate
...
| | |
|---|---|
| **Central question** | Redesigning To Separate: students revise a design so it can distinguish explanations? |
| **Core concept** | A redesign produces separating evidence when each added measurement would embarrass at least one explanation. |
| **Student outcome** | Students revise a design so it can distinguish explanations. |
| **Previous lesson** | Lesson 27 — Separating Explanations |
| **Next lesson** | Lesson 29 — Explaining The Guarantees |
...
**The conceptual step.** A redesign produces separating evidence when each added measurement would embarrass at least one explanation. Adding measurements that embarrass none does not help.
...
**What depends on it.** Lesson 29 — Explaining The Guarantees — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A redesign produces separating evidence when each added measurement would embarrass at least one explanation. Adding measurements that embarrass none does not help.
...
1. A redesign adding a condition that only one explanation predicts.
2. A measurement justified by naming which explanation it threatens.

### One non-example

A redesign adding three measurements with no separation gained.
...
That designs can be revised to separate explanations.

### What this activity does not establish

Which explanation would survive.
...
| Statement | Status |
|---|---|
| A redesign produces separating evidence when each added measurement would embarrass at least one explanation. | Framework-derived, appropriate at this grade |
| That designs can be revised to separate explanations. | What this specific activity can show |
| Which explanation would survive. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — Separating Explanations — specifically: students name an observation that separates two explanations.

**How it was taught.** Through the activity: for three results, name a separating observation and say which it favours

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: for three results, name a separating observation and say which it favours, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A redesign adding a condition that only one explanation predicts. |
| **Non-example** | A redesign adding three measurements with no separation gained. |
...
> "You separate them by finding what they disagree about."
...
**Exact wording.** "Say: your design could not separate them. Fix it."
...
**Target observation.** That designs can be revised to separate explanations.
...
> "A redesign produces separating evidence when each added measurement would embarrass at least one explanation. You just saw that when say: your design could not separate them.
> Last time we said: You separate them by finding what they disagree about. This is the next part of that.
...
**What students must not infer.** Which explanation would survive.

### 4. Worked example

**The example.** A redesign adding a condition that only one explanation predicts.
...
**Completed answer.** A redesign adding a condition that only one explanation predicts. — which demonstrates that designs can be revised to separate explanations.
...
**Conclusions not licensed.** Which explanation would survive.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A measurement justified by naming which explanation it threatens. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A redesign adding three measurements with no separation gained. Why is this not an
example?"
...
**Exact student instructions.** Redesign one investigation so it produces separating evidence.
...
- *Licensed conclusion.* That designs can be revised to separate explanations.
- *Not licensed.* Which explanation would survive.
...
- *Expected response.* That designs can be revised to separate explanations.
...
1. Any wording carrying the idea in `A redesign produces separating evidence when each added measurement would embarrass at least one explanation`.
...
Say: "Now it would tell you something either way."
...
| | |
|---|---|
| **Follows** | Lesson 27 — Separating Explanations |
| **Leads to** | Lesson 29 — Explaining The Guarantees |

**Transition in.** Lesson 27 established students name an observation that separates two explanations. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students revise a design so it can distinguish explanations. Lesson 29 assumes it and builds students explain guarantees and their limits to somebody else.
