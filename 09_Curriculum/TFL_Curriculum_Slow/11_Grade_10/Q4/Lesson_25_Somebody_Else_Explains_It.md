# Lesson 25 — Somebody Else Explains It
...
| | |
|---|---|
| **Central question** | Somebody Else Explains It: students find an explanation of their result that does not use TFL? |
| **Core concept** | A result consistent with the framework is usually consistent with other explanations too. |
| **Student outcome** | Students find an explanation of their result that does not use TFL. |
| **Previous lesson** | Lesson 24 — The Design Review |
| **Next lesson** | Lesson 26 — Consistency Is Not Evidence |
...
**The conceptual step.** A result consistent with the framework is usually consistent with other explanations too. Producing genuine alternatives is the first step toward adjudication.
...
**What depends on it.** Lesson 26 — Consistency Is Not Evidence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A result consistent with the framework is usually consistent with other explanations too. Producing genuine alternatives is the first step toward adjudication.
...
1. An alternative explaining the result by repetition.
2. An alternative explaining it by general arousal.

### One non-example

An alternative nobody could believe.
...
That results admit non-framework explanations.
...
| Statement | Status |
|---|---|
| A result consistent with the framework is usually consistent with other explanations too. | Framework-derived, appropriate at this grade |
| That results admit non-framework explanations. | What this specific activity can show |
| Which explanation is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 24 — The Design Review — specifically: students consolidate reproducible design.

**How it was taught.** Through the activity: review with six designs audited for the missing element

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: review with six designs audited for the missing element, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An alternative explaining the result by repetition. |
| **Non-example** | An alternative nobody could believe. |
...
> "Next time: what else explains your result."
...
**Exact wording.** "Say: explain your own result without using this framework at all."
...
**Target observation.** That results admit non-framework explanations.
...
> "A result consistent with the framework is usually consistent with other explanations too. You just saw that when say: explain your own result without using this framework at all.
> Last time we said: Next time: what else explains your result. This is the next part of that.
...
**What students must not infer.** Which explanation is correct.

### 4. Worked example

**The example.** An alternative explaining the result by repetition.
...
**Completed answer.** An alternative explaining the result by repetition. — which demonstrates that results admit non-framework explanations.
...
**Conclusions not licensed.** Which explanation is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An alternative explaining it by general arousal. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An alternative nobody could believe. Why is this not an
example?"
...
**Exact student instructions.** Produce two non-TFL explanations of their own investigation result.
...
- *Licensed conclusion.* That results admit non-framework explanations.
- *Not licensed.* Which explanation is correct.
...
- *Expected response.* That results admit non-framework explanations.
...
1. Any wording carrying the idea in `A result consistent with the framework is usually consistent with other explanations too`.
...
Say: "Your result is consistent with things other than the framework."
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Design Review |
| **Leads to** | Lesson 26 — Consistency Is Not Evidence |

**Transition in.** Lesson 24 established students consolidate reproducible design. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find an explanation of their result that does not use TFL. Lesson 26 assumes it and builds students discover their result fits alternatives equally well.
