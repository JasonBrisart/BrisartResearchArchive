# Lesson 26 — Consistency Is Not Evidence
...
| | |
|---|---|
| **Central question** | Consistency Is Not Evidence: students discover their result fits alternatives equally well? |
| **Core concept** | A result that every explanation predicts discriminates between none of them. |
| **Student outcome** | Students discover their result fits alternatives equally well. |
| **Previous lesson** | Lesson 25 — Somebody Else Explains It |
| **Next lesson** | Lesson 27 — Separating Explanations |
...
**The conceptual step.** A result that every explanation predicts discriminates between none of them. Consistency with the framework is not evidence for it.
...
**What depends on it.** Lesson 27 — Separating Explanations — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A result that every explanation predicts discriminates between none of them. Consistency with the framework is not evidence for it.
...
1. A result equally predicted by two alternatives.
2. A student concluding their result discriminates nothing.

### One non-example

An argument that the alternatives are less likely.
...
| Statement | Status |
|---|---|
| A result that every explanation predicts discriminates between none of them. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 25 — Somebody Else Explains It — specifically: students find an explanation of their result that does not use TFL.

**How it was taught.** Through the activity: produce two non-TFL explanations of their own investigation result

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: produce two non-TFL explanations of their own investigation result, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A result equally predicted by two alternatives. |
| **Non-example** | An argument that the alternatives are less likely. |
...
> "Your result is consistent with things other than the framework."
...
**Exact wording.** "Apply each alternative to the same result in turn."
...
> "A result that every explanation predicts discriminates between none of them. You just saw that when apply each alternative to the same result in turn.
> Last time we said: Your result is consistent with things other than the framework. This is the next part of that.
...
**The example.** A result equally predicted by two alternatives.
...
**Completed answer.** A result equally predicted by two alternatives. — which demonstrates that consistency does not constitute support.
...
**Teacher prompt.** "Now one that does not work. An argument that the alternatives are less likely. Why is this not an
example?"
...
**Exact student instructions.** Show how each alternative explains three of their own results equally well.
...
1. Any wording carrying the idea in `A result that every explanation predicts discriminates between none of them`.
...
| | |
|---|---|
| **Follows** | Lesson 25 — Somebody Else Explains It |
| **Leads to** | Lesson 27 — Separating Explanations |

**Transition in.** Lesson 25 established students find an explanation of their result that does not use TFL. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students discover their result fits alternatives equally well. Lesson 27 assumes it and builds students name an observation that separates two explanations.
