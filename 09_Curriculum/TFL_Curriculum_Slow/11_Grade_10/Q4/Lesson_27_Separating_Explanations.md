# Lesson 27 — Separating Explanations

**Grade 10** · The Gate and the Guarantees · **Quarter 4** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Separating Explanations: students name an observation that separates two explanations? |
| **Core concept** | Two explanations are separated by an observation they disagree about. |
| **Student outcome** | Students name an observation that separates two explanations. |
| **Previous lesson** | Lesson 26 — Consistency Is Not Evidence |
| **Next lesson** | Lesson 28 — Redesigning To Separate |
...
**The conceptual step.** Two explanations are separated by an observation they disagree about. An observation both predict cannot separate them, however striking it is.
...
**What depends on it.** Lesson 28 — Redesigning To Separate — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Two explanations are separated by an observation they disagree about. An observation both predict cannot separate them, however striking it is.
...
1. An observation one explanation predicts and the other forbids.
2. A separator tested aloud and confirmed.
...
That explanations can be separated by specific observations.
...
| Statement | Status |
|---|---|
| Two explanations are separated by an observation they disagree about. | Framework-derived, appropriate at this grade |
| That explanations can be separated by specific observations. | What this specific activity can show |
| Which explanation the evidence favours. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — Consistency Is Not Evidence — specifically: students discover their result fits alternatives equally well.

**How it was taught.** Through the activity: show how each alternative explains three of their own results equally well

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: show how each alternative explains three of their own results equally well, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An observation one explanation predicts and the other forbids. |
...
**Exact wording.** "Ask what they would have to see to know which is right."
...
**Target observation.** That explanations can be separated by specific observations.
...
> "Two explanations are separated by an observation they disagree about. You just saw that when ask what they would have to see to know which is right.
> Last time we said: Fitting is not supporting. This is the next part of that.
...
**The example.** An observation one explanation predicts and the other forbids.
...
**Completed answer.** An observation one explanation predicts and the other forbids. — which demonstrates that explanations can be separated by specific observations.
...
**Teacher prompt.** "Here is a second case. A separator tested aloud and confirmed. Work it through with me."
...
**Exact student instructions.** For three results, name a separating observation and say which it favours.
...
- *Licensed conclusion.* That explanations can be separated by specific observations.
...
- *Expected response.* That explanations can be separated by specific observations.
...
1. Any wording carrying the idea in `Two explanations are separated by an observation they disagree about`.
...
Say: "You separate them by finding what they disagree about."
...
| | |
|---|---|
| **Follows** | Lesson 26 — Consistency Is Not Evidence |
| **Leads to** | Lesson 28 — Redesigning To Separate |

**Transition in.** Lesson 26 established students discover their result fits alternatives equally well. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students name an observation that separates two explanations. Lesson 28 assumes it and builds students revise a design so it can distinguish explanations.
