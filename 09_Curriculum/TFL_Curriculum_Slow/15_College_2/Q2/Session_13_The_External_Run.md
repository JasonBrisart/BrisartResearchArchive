...
| | |
|---|---|
| **Central question** | The External Run: students test protocols by handing them to somebody else? |
| **Core concept** | Every inference the runner makes is a gap in the protocol. |
| **Student outcome** | Students test protocols by handing them to somebody else. |
| **Previous session** | Session 12 — The Measurement Map |
...
**The conceptual step.** Every inference the runner makes is a gap in the protocol. Recording inferences as questions is what makes the list complete.
...
Every inference the runner makes is a gap in the protocol. Recording inferences as questions is what makes the list complete.
...
1. A question list with six recorded items.
2. An inference recorded as a question rather than resolved silently.

### One non-example

A run completed by filling gaps with reasonable assumptions.
...
That protocol gaps are detectable by handover.

### What this activity does not establish

Whether the protocol is otherwise sound.
...
| Statement | Status |
|---|---|
| Every inference the runner makes is a gap in the protocol. | Framework-derived, appropriate at this grade |
| That protocol gaps are detectable by handover. | What this specific activity can show |
| Whether the protocol is otherwise sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 12 — The Measurement Map — specifically: students assemble all instruments into a seven-line map.

**How it was taught.** Through the activity: build the map and have two classmates mark unrunnable lines independently

**Quick check.** Ask for the closing sentence of Session 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 12: build the map and have two classmates mark unrunnable lines independently, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A question list with six recorded items. |
| **Non-example** | A run completed by filling gaps with reasonable assumptions. |
...
**Exact wording.** "Say: run theirs. Every question you must ask, write it down."
...
**Target observation.** That protocol gaps are detectable by handover.
...
> "Every inference the runner makes is a gap in the protocol. You just saw that when say: run theirs.
...
**What students must not infer.** Whether the protocol is otherwise sound.

### 4. Worked example

**The example.** A question list with six recorded items.
...
**Completed answer.** A question list with six recorded items. — which demonstrates that protocol gaps are detectable by handover.
...
**Conclusions not licensed.** Whether the protocol is otherwise sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An inference recorded as a question rather than resolved silently. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A run completed by filling gaps with reasonable assumptions. Why is this not an
example?"
...
**Exact student instructions.** Run a partner's protocol and return a full question list.
...
- *Licensed conclusion.* That protocol gaps are detectable by handover.
- *Not licensed.* Whether the protocol is otherwise sound.
...
- *Expected response.* That protocol gaps are detectable by handover.
...
1. Any wording carrying the idea in `Every inference the runner makes is a gap in the protocol`.
...
Say: "You are not the test. The person who runs it is."
...
| | |
|---|---|
| **Follows** | Session 12 — The Measurement Map |
| **Leads to** | Session 14 — The Midterm Review |

**Transition in.** Session 12 established students assemble all instruments into a seven-line map. This session uses that as the starting point.

**Transition out.** This session establishes students test protocols by handing them to somebody else. Session 14 assumes it and builds students consolidate the first half.
