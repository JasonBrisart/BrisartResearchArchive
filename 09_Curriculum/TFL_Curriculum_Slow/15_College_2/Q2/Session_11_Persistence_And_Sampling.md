# Session 11 — Persistence And Sampling
...
| | |
|---|---|
| **Central question** | Persistence And Sampling: students prespecify a criterion and justify an interval? |
| **Core concept** | A persistence criterion fixed after seeing data is a chosen result. |
| **Student outcome** | Students prespecify a criterion and justify an interval. |
| **Previous session** | Session 10 — Construct Validity |
| **Next session** | Session 12 — The Measurement Map |
...
**The conceptual step.** A persistence criterion fixed after seeing data is a chosen result. Identifying how one's own criterion could be gamed is what prevents gaming it.
...
**What depends on it.** Session 12 — The Measurement Map — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A persistence criterion fixed after seeing data is a chosen result. Identifying how one's own criterion could be gamed is what prevents gaming it.
...
2. A named vulnerability in the student's own criterion.

### One non-example

A criterion with borderline cases left unspecified.
...
That criteria can be audited for flexibility.
...
| Statement | Status |
|---|---|
| A persistence criterion fixed after seeing data is a chosen result. | Framework-derived, appropriate at this grade |
| That criteria can be audited for flexibility. | What this specific activity can show |
| Whether the criterion is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 10 — Construct Validity — specifically: students ask what their instrument actually measures.

**How it was taught.** Through the activity: name three plausible alternative constructs per instrument and how to distinguish them

**Quick check.** Ask for the closing sentence of Session 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 10: name three plausible alternative constructs per instrument and how to distinguish them, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A criterion with borderline cases left unspecified. |
...
> "An instrument that runs perfectly can still measure the wrong thing."
...
**Exact wording.** "Ask: persisting for how long, and decided when?"
...
**Target observation.** That criteria can be audited for flexibility.
...
> "A persistence criterion fixed after seeing data is a chosen result. You just saw that when ask: persisting for how long, and decided when?.
> Last time we said: An instrument that runs perfectly can still measure the wrong thing. This is the next part of that.
...
**Completed answer.** A criterion with an explicit partial-match rule. — which demonstrates that criteria can be audited for flexibility.
...
**Teacher prompt.** "Here is a second case. A named vulnerability in the student's own criterion. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A criterion with borderline cases left unspecified. Why is this not an
example?"
...
**Exact student instructions.** Complete both specifications and identify a post-hoc vulnerability.
...
- *Licensed conclusion.* That criteria can be audited for flexibility.
...
- *Expected response.* That criteria can be audited for flexibility.
...
1. Any wording carrying the idea in `A persistence criterion fixed after seeing data is a chosen result`.
...
Say: "Naming how it could be gamed is what stops you gaming it."
...
| | |
|---|---|
| **Follows** | Session 10 — Construct Validity |
| **Leads to** | Session 12 — The Measurement Map |

**Transition in.** Session 10 established students ask what their instrument actually measures. This session uses that as the starting point.

**Transition out.** This session establishes students prespecify a criterion and justify an interval. Session 12 assumes it and builds students assemble all instruments into a seven-line map.
