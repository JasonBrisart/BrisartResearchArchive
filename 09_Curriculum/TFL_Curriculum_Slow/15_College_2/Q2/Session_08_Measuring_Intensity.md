# Session 8 — Measuring Intensity

**College Year 2** · Operationalisation and First Critique · **Quarter 2** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Measuring Intensity: students build an E(t) instrument that avoids circularity? |
| **Core concept** | Rating intensity and persistence in a single judgement guarantees correlation by construction. |
| **Student outcome** | Students build an E(t) instrument that avoids circularity. |
| **Previous session** | Session 7 — Is Self-Report Adequate At All |
| **Next session** | Session 9 — Arousal As A Rival In Disguise |
...
**The conceptual step.** Rating intensity and persistence in a single judgement guarantees correlation by construction. The self-audit requires naming an alternative explanation for any correlation found.
...
**What depends on it.** Session 9 — Arousal As A Rival In Disguise — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Rating intensity and persistence in a single judgement guarantees correlation by construction. The self-audit requires naming an alternative explanation for any correlation found.
...
1. An instrument rating intensity before the outcome is known.
2. An alternative explanation citing shared method variance.

### One non-example

An instrument asserted clean without the audit being run.
...
That circularity can be built in without noticing.
...
| Statement | Status |
|---|---|
| Rating intensity and persistence in a single judgement guarantees correlation by construction. | Framework-derived, appropriate at this grade |
| That circularity can be built in without noticing. | What this specific activity can show |
| Whether the instrument is valid. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 7 — Is Self-Report Adequate At All — specifically: students assess the limits of report-based measurement.

**How it was taught.** Through the activity: identify which of their hypotheses report can and cannot carry, and propose one complement

**Quick check.** Ask for the closing sentence of Session 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 7: identify which of their hypotheses report can and cannot carry, and propose one complement, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An instrument rating intensity before the outcome is known. |
| **Non-example** | An instrument asserted clean without the audit being run. |
...
> "Report of content is not report of mechanism. But report is slow."
...
**Exact wording.** "Ask why finding a correlation between intensity and persistence rated in one survey is worthless."
...
**Target observation.** That circularity can be built in without noticing.
...
> "Rating intensity and persistence in a single judgement guarantees correlation by construction. You just saw that when ask why finding a correlation between intensity and persistence rated in one survey is worthless.
> Last time we said: Report of content is not report of mechanism. But report is slow. This is the next part of that.
...
**The example.** An instrument rating intensity before the outcome is known.
...
**Completed answer.** An instrument rating intensity before the outcome is known. — which demonstrates that circularity can be built in without noticing.
...
**Teacher prompt.** "Now one that does not work. An instrument asserted clean without the audit being run. Why is this not an
example?"
...
- *Licensed conclusion.* That circularity can be built in without noticing.
...
- *Expected response.* That circularity can be built in without noticing.
...
1. Any wording carrying the idea in `Rating intensity and persistence in a single judgement guarantees correlation by construction`.
...
| | |
|---|---|
| **Follows** | Session 7 — Is Self-Report Adequate At All |
| **Leads to** | Session 9 — Arousal As A Rival In Disguise |

**Transition in.** Session 7 established students assess the limits of report-based measurement. This session uses that as the starting point.

**Transition out.** This session establishes students build an E(t) instrument that avoids circularity. Session 9 assumes it and builds students separate intensity from general activation.
