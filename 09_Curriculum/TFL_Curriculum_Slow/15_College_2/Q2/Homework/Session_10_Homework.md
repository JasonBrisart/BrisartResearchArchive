# Session 10 Homework — Construct Validity

**College Year 2** · Operationalisation and First Critique · **Quarter 2**
**Follows:** Session 10 — Construct Validity · **Points:** 5 · **Optional:** yes
...
Name three plausible alternative constructs per instrument and how to distinguish them.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names three plausible alternatives per instrument
...
Session 11 is **Persistence And Sampling**, which assumes you arrive holding it. Write one thing you expect it to be about:
