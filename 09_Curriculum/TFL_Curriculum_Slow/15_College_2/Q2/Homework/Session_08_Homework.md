# Session 8 Homework — Measuring Intensity

**College Year 2** · Operationalisation and First Critique · **Quarter 2**
**Follows:** Session 8 — Measuring Intensity · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 8 ended on, from memory:
...
Build the instrument and run the three-question self-audit.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces a genuine alternative explanation for a correlation
...
Session 9 is **Arousal As A Rival In Disguise**, which assumes you arrive holding it. Write one thing you expect it to be about:
