...
| **Core concept** | The practice final locates gaps while there is time to close them. |
| **Student outcome** | Students rehearse the final under conditions. |
| **Previous session** | Session 25 — The Year In Protocols |
...
**The conceptual step.** The practice final locates gaps while there is time to close them. Self-marking converts the score into a review list.
...
The practice final locates gaps while there is time to close them. Self-marking converts the score into a review list.
...
1. A student identifying construct validity as their weak point.
2. A student finding their protocols still describe rather than specify.

### One non-example

Treating the practice score as the grade.
...
| Statement | Status |
|---|---|
| The practice final locates gaps while there is time to close them. | Framework-derived, appropriate at this grade |
| Where each student is weakest. | What this specific activity can show |
| The final grade. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 25 — The Year In Protocols — specifically: students review the year through their own protocols.

**How it was taught.** Through the activity: compare the first draft with the final and write what changed

**Quick check.** Ask for the closing sentence of Session 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 25: compare the first draft with the final and write what changed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student identifying construct validity as their weak point. |
| **Non-example** | Treating the practice score as the grade. |
...
> "Next year: three accounts that explain your data as well as this one."
...
**Exact wording.** "Say: same as the real one."
...
**Target observation.** Where each student is weakest.
...
> "The practice final locates gaps while there is time to close them. You just saw that when say: same as the real one.
> Last time we said: Next year: three accounts that explain your data as well as this one. This is the next part of that.
...
**The example.** A student identifying construct validity as their weak point.
...
**Completed answer.** A student identifying construct validity as their weak point. — which demonstrates where each student is weakest.
...
**Teacher prompt.** "Here is a second case. A student finding their protocols still describe rather than specify. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Treating the practice score as the grade. Why is this not an
example?"
...
**Exact student instructions.** A full practice final, self-marked.
...
- *Licensed conclusion.* Where each student is weakest.
...
- *Expected response.* Where each student is weakest.
...
1. Any wording carrying the idea in `The practice final locates gaps while there is time to close them`.
...
| | |
|---|---|
| **Follows** | Session 25 — The Year In Protocols |
| **Leads to** | Session 27 — Final Preparation |

**Transition in.** Session 25 established students review the year through their own protocols. This session uses that as the starting point.

**Transition out.** This session establishes students rehearse the final under conditions. Session 27 assumes it and builds students address the weaknesses the practice final revealed.
