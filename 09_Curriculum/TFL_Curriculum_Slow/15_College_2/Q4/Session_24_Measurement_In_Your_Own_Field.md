# Session 24 — Measurement In Your Own Field
...
| | |
|---|---|
| **Central question** | Measurement In Your Own Field: students compare measurement standards with their own discipline? |
| **Core concept** | Every discipline has constructs that resist direct observation. |
| **Student outcome** | Students compare measurement standards with their own discipline. |
| **Previous session** | Session 23 — What I Could Not Measure |
| **Next session** | Session 25 — The Year In Protocols |
...
**The conceptual step.** Every discipline has constructs that resist direct observation. Comparing how one's own field handles them makes the methodological content transferable.
...
**What depends on it.** Session 25 — The Year In Protocols — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every discipline has constructs that resist direct observation. Comparing how one's own field handles them makes the methodological content transferable.
...
1. A construct from the student's field with a contested measure.
2. A comparison on blinding, prespecification, and reliability.

### One non-example

An assumption that the student's field has solved the problem.
...
That the measurement problem is general.

### What this activity does not establish

Which field handles it best.
...
| Statement | Status |
|---|---|
| Every discipline has constructs that resist direct observation. | Framework-derived, appropriate at this grade |
| That the measurement problem is general. | What this specific activity can show |
| Which field handles it best. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 23 — What I Could Not Measure — specifically: students catalogue what resisted measurement this year.

**How it was taught.** Through the activity: list four things that resisted measurement and what each would require

**Quick check.** Ask for the closing sentence of Session 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 23: list four things that resisted measurement and what each would require, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A construct from the student's field with a contested measure. |
| **Non-example** | An assumption that the student's field has solved the problem. |
...
> "Naming what resisted is part of the result."
...
**Exact wording.** "Ask how their field handles a construct nobody can observe directly."
...
**Target observation.** That the measurement problem is general.
...
> "Every discipline has constructs that resist direct observation. You just saw that when ask how their field handles a construct nobody can observe directly.
> Last time we said: Naming what resisted is part of the result. This is the next part of that.
...
**What students must not infer.** Which field handles it best.

### 4. Worked example

**The example.** A construct from the student's field with a contested measure.
...
**Completed answer.** A construct from the student's field with a contested measure. — which demonstrates that the measurement problem is general.
...
**Conclusions not licensed.** Which field handles it best.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A comparison on blinding, prespecification, and reliability. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An assumption that the student's field has solved the problem. Why is this not an
example?"
...
**Exact student instructions.** Compare three measurement practices from their own field against this course's standard.
...
- *Licensed conclusion.* That the measurement problem is general.
- *Not licensed.* Which field handles it best.
...
- *Expected response.* That the measurement problem is general.
...
1. Any wording carrying the idea in `Every discipline has constructs that resist direct observation`.
...
Say: "Every field has this problem. Some handle it better."
...
| | |
|---|---|
| **Follows** | Session 23 — What I Could Not Measure |
| **Leads to** | Session 25 — The Year In Protocols |

**Transition in.** Session 23 established students catalogue what resisted measurement this year. This session uses that as the starting point.

**Transition out.** This session establishes students compare measurement standards with their own discipline. Session 25 assumes it and builds students review the year through their own protocols.
