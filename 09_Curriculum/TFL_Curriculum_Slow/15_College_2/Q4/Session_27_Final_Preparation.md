...
| | |
|---|---|
| **Central question** | Final Preparation: students address the weaknesses the practice final revealed? |
| **Core concept** | Targeted review of identified weaknesses is more useful than general revision. |
| **Student outcome** | Students address the weaknesses the practice final revealed. |
...
**The conceptual step.** Targeted review of identified weaknesses is more useful than general revision. The practice paper supplies the targets.
...
Targeted review of identified weaknesses is more useful than general revision. The practice paper supplies the targets.
...
1. A student working specifically on their two weakest areas.
2. A student who revised construct validity after failing it in practice.

### One non-example

A student re-reading material they already scored well on.
...
That review can be targeted by diagnostic evidence.
...
| Statement | Status |
|---|---|
| Targeted review of identified weaknesses is more useful than general revision. | Framework-derived, appropriate at this grade |
| That review can be targeted by diagnostic evidence. | What this specific activity can show |
| The final grade. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 26 — Practice Final — specifically: students rehearse the final under conditions.

**How it was taught.** Through the activity: a full practice final, self-marked

**Quick check.** Ask for the closing sentence of Session 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 26: a full practice final, self-marked, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student working specifically on their two weakest areas. |
| **Non-example** | A student re-reading material they already scored well on. |
...
**Exact wording.** "Say: your practice paper told you something. Act on it."
...
**Target observation.** That review can be targeted by diagnostic evidence.
...
> "Targeted review of identified weaknesses is more useful than general revision. You just saw that when say: your practice paper told you something.
> Last time we said: Now you know what to review. This is the next part of that.
...
**The example.** A student working specifically on their two weakest areas.
...
**Completed answer.** A student working specifically on their two weakest areas. — which demonstrates that review can be targeted by diagnostic evidence.
...
**Teacher prompt.** "Here is a second case. A student who revised construct validity after failing it in practice. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student re-reading material they already scored well on. Why is this not an
example?"
...
**Exact student instructions.** Targeted review of each student's two weakest areas.
...
- *Licensed conclusion.* That review can be targeted by diagnostic evidence.
...
- *Expected response.* That review can be targeted by diagnostic evidence.
...
1. Any wording carrying the idea in `Targeted review of identified weaknesses is more useful than general revision`.
...
**Transition in.** Session 26 established students rehearse the final under conditions. This session uses that as the starting point.

**Transition out.** This session establishes students address the weaknesses the practice final revealed. Session 28 assumes it and builds students demonstrate integrated command of measurement.
