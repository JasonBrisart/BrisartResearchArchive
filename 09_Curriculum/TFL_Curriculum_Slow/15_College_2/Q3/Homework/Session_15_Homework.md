# Session 15 Homework — Repairing A Protocol

**College Year 2** · Operationalisation and First Critique · **Quarter 3**
**Follows:** Session 15 — Repairing A Protocol · **Points:** 5 · **Optional:** yes
...
Repair the protocol and run a second external test.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the second run produces fewer questions
...
Session 16 is **The Measurement Critique**, which assumes you arrive holding it. Write one thing you expect it to be about:
