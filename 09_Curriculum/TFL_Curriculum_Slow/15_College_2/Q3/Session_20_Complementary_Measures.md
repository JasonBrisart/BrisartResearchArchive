# Session 20 — Complementary Measures
...
| | |
|---|---|
| **Central question** | Complementary Measures: students propose a non-report measure and its assumptions? |
| **Core concept** | Every complementary measure imports assumptions. |
| **Student outcome** | Students propose a non-report measure and its assumptions. |
| **Previous session** | Session 19 — Resolution And Claim Scale |
| **Next session** | Session 21 — The Complete Protocol |
...
**The conceptual step.** Every complementary measure imports assumptions. Reaction time assumes a mapping from latency to processing; autonomic measures assume a mapping from arousal to intensity.
...
**What depends on it.** Session 21 — The Complete Protocol — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every complementary measure imports assumptions. Reaction time assumes a mapping from latency to processing; autonomic measures assume a mapping from arousal to intensity.
...
1. A reaction-time measure with its mapping assumption stated.
2. An autonomic measure with its arousal assumption stated.

### One non-example

A measure proposed as objective with no assumptions named.
...
That complementary measures carry their own assumptions.
...
| Statement | Status |
|---|---|
| Every complementary measure imports assumptions. | Framework-derived, appropriate at this grade |
| That complementary measures carry their own assumptions. | What this specific activity can show |
| Whether the measures are valid. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 19 — Resolution And Claim Scale — specifically: students match claim scale to observation scale.

**How it was taught.** Through the activity: write a resolution declaration naming conclusions not licensed

**Quick check.** Ask for the closing sentence of Session 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 19: write a resolution declaration naming conclusions not licensed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A reaction-time measure with its mapping assumption stated. |
| **Non-example** | A measure proposed as objective with no assumptions named. |
...
> "It is not modesty. It is what makes your result interpretable."
...
**Exact wording.** "Say: report cannot carry timing. What could?"
...
**Target observation.** That complementary measures carry their own assumptions.
...
> "Every complementary measure imports assumptions. You just saw that when say: report cannot carry timing.
> Last time we said: It is not modesty. It is what makes your result interpretable. This is the next part of that.
...
**What students must not infer.** Whether the measures are valid.

### 4. Worked example

**The example.** A reaction-time measure with its mapping assumption stated.
...
**Completed answer.** A reaction-time measure with its mapping assumption stated. — which demonstrates that complementary measures carry their own assumptions.
...
**Conclusions not licensed.** Whether the measures are valid.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An autonomic measure with its arousal assumption stated. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A measure proposed as objective with no assumptions named. Why is this not an
example?"
...
**Exact student instructions.** Propose two complementary measures and state the assumptions each brings.
...
- *Licensed conclusion.* That complementary measures carry their own assumptions.
- *Not licensed.* Whether the measures are valid.
...
- *Expected response.* That complementary measures carry their own assumptions.
...
1. Any wording carrying the idea in `Every complementary measure imports assumptions`.
...
Say: "Any measure you add brings its own assumptions."
...
| | |
|---|---|
| **Follows** | Session 19 — Resolution And Claim Scale |
| **Leads to** | Session 21 — The Complete Protocol |

**Transition in.** Session 19 established students match claim scale to observation scale. This session uses that as the starting point.

**Transition out.** This session establishes students propose a non-report measure and its assumptions. Session 21 assumes it and builds students assemble a full measurement package.
