# Session 17 — What The Study Could Legitimately Claim
...
| | |
|---|---|
| **Central question** | What The Study Could Legitimately Claim: students state the weaker claim a flawed design supports? |
| **Core concept** | A flawed study usually licenses some weaker claim. |
| **Student outcome** | Students state the weaker claim a flawed design supports. |
| **Previous session** | Session 16 — The Measurement Critique |
| **Next session** | Session 18 — Critiquing Your Own Protocol |
...
**The conceptual step.** A flawed study usually licenses some weaker claim. Concluding that it says nothing is as much an error as accepting the original claim.
...
**What depends on it.** Session 18 — Critiquing Your Own Protocol — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A flawed study usually licenses some weaker claim. Concluding that it says nothing is as much an error as accepting the original claim.
...
1. A flawed study licensing a claim about this sample only.
2. A weaker claim stated for a design with no blinding.

### One non-example

A conclusion that the flawed study is uninformative.
...
That flawed designs license weaker claims.

### What this activity does not establish

Whether the weaker claim is true.
...
| Statement | Status |
|---|---|
| A flawed study usually licenses some weaker claim. | Framework-derived, appropriate at this grade |
| That flawed designs license weaker claims. | What this specific activity can show |
| Whether the weaker claim is true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 16 — The Measurement Critique — specifically: students critique a measurement claim in writing.

**How it was taught.** Through the activity: produce a written critique naming at least six specific measurement failures

**Quick check.** Ask for the closing sentence of Session 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 16: produce a written critique naming at least six specific measurement failures, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A flawed study licensing a claim about this sample only. |
| **Non-example** | A conclusion that the flawed study is uninformative. |
...
> "Critique the measurement, not the framework. Different jobs."
...
**Exact wording.** "Say: it is flawed. What can it still legitimately say?"
...
**Target observation.** That flawed designs license weaker claims.
...
> "A flawed study usually licenses some weaker claim. You just saw that when say: it is flawed.
> Last time we said: Critique the measurement, not the framework. Different jobs. This is the next part of that.
...
**What students must not infer.** Whether the weaker claim is true.

### 4. Worked example

**The example.** A flawed study licensing a claim about this sample only.
...
**Completed answer.** A flawed study licensing a claim about this sample only. — which demonstrates that flawed designs license weaker claims.
...
**Conclusions not licensed.** Whether the weaker claim is true.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A weaker claim stated for a design with no blinding. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A conclusion that the flawed study is uninformative. Why is this not an
example?"
...
**Exact student instructions.** State the legitimate claim for three flawed designs.
...
- *Licensed conclusion.* That flawed designs license weaker claims.
- *Not licensed.* Whether the weaker claim is true.
...
- *Expected response.* That flawed designs license weaker claims.
...
1. Any wording carrying the idea in `A flawed study usually licenses some weaker claim`.
...
Say: "The legitimate claim is usually much weaker than the one made."
...
| | |
|---|---|
| **Follows** | Session 16 — The Measurement Critique |
| **Leads to** | Session 18 — Critiquing Your Own Protocol |

**Transition in.** Session 16 established students critique a measurement claim in writing. This session uses that as the starting point.

**Transition out.** This session establishes students state the weaker claim a flawed design supports. Session 18 assumes it and builds students apply the critique standard to their own work.
