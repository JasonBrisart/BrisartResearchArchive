# Session 18 — Critiquing Your Own Protocol

**College Year 2** · Operationalisation and First Critique · **Quarter 3** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Critiquing Your Own Protocol: students apply the critique standard to their own work? |
| **Core concept** | Self-critique to the same standard applied to others is difficult because the author knows their own intentions. |
| **Student outcome** | Students apply the critique standard to their own work. |
| **Previous session** | Session 17 — What The Study Could Legitimately Claim |
| **Next session** | Session 19 — Resolution And Claim Scale |
...
**The conceptual step.** Self-critique to the same standard applied to others is difficult because the author knows their own intentions. Requiring a minimum count forces the exercise.
...
**What depends on it.** Session 19 — Resolution And Claim Scale — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Self-critique to the same standard applied to others is difficult because the author knows their own intentions. Requiring a minimum count forces the exercise.
...
1. A self-critique naming four genuine failures.
2. A failure the student had not previously noticed.

### One non-example

A self-critique concluding the protocol is sound.
...
That the critique standard applies to one's own work.

### What this activity does not establish

Whether the protocol is salvageable.
...
| Statement | Status |
|---|---|
| Self-critique to the same standard applied to others is difficult because the author knows their own intentions. | Framework-derived, appropriate at this grade |
| That the critique standard applies to one's own work. | What this specific activity can show |
| Whether the protocol is salvageable. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 17 — What The Study Could Legitimately Claim — specifically: students state the weaker claim a flawed design supports.

**How it was taught.** Through the activity: state the legitimate claim for three flawed designs

**Quick check.** Ask for the closing sentence of Session 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 17: state the legitimate claim for three flawed designs, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A self-critique naming four genuine failures. |
| **Non-example** | A self-critique concluding the protocol is sound. |
...
> "The legitimate claim is usually much weaker than the one made."
...
**Exact wording.** "Say: six failures. Find them in your own protocol."
...
**Target observation.** That the critique standard applies to one's own work.
...
> "Self-critique to the same standard applied to others is difficult because the author knows their own intentions. You just saw that when say: six failures.
> Last time we said: The legitimate claim is usually much weaker than the one made. This is the next part of that.
...
**What students must not infer.** Whether the protocol is salvageable.

### 4. Worked example

**The example.** A self-critique naming four genuine failures.
...
**Completed answer.** A self-critique naming four genuine failures. — which demonstrates that the critique standard applies to one's own work.
...
**Conclusions not licensed.** Whether the protocol is salvageable.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A failure the student had not previously noticed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A self-critique concluding the protocol is sound. Why is this not an
example?"
...
**Exact student instructions.** Self-critique naming at least four failures in their own protocol.
...
- *Licensed conclusion.* That the critique standard applies to one's own work.
- *Not licensed.* Whether the protocol is salvageable.
...
- *Expected response.* That the critique standard applies to one's own work.
...
1. Any wording carrying the idea in `Self-critique to the same standard applied to others is difficult because the author knows their own intentions`.
...
| | |
|---|---|
| **Follows** | Session 17 — What The Study Could Legitimately Claim |
| **Leads to** | Session 19 — Resolution And Claim Scale |

**Transition in.** Session 17 established students state the weaker claim a flawed design supports. This session uses that as the starting point.

**Transition out.** This session establishes students apply the critique standard to their own work. Session 19 assumes it and builds students match claim scale to observation scale.
