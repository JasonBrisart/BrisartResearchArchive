# Session 6 — Blind Coding And Reliability
...
| | |
|---|---|
| **Central question** | Blind Coding And Reliability: students specify who scores and what they know? |
| **Core concept** | Blind coding requires that the scorer does not know the condition or the hypothesis. |
| **Student outcome** | Students specify who scores and what they know. |
| **Previous session** | Session 5 — Capturing Sim(t) |
| **Next session** | Session 7 — Is Self-Report Adequate At All |
...
**The conceptual step.** Blind coding requires that the scorer does not know the condition or the hypothesis. Inter-rater reliability must be reported as a number rather than asserted.
...
**What depends on it.** Session 7 — Is Self-Report Adequate At All — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Blind coding requires that the scorer does not know the condition or the hypothesis. Inter-rater reliability must be reported as a number rather than asserted.
...
1. A protocol naming two blind coders and the agreement statistic.
2. A coding scheme with an explicit uncodable category.

### One non-example

A protocol where the experimenter scores their own elicitation.
...
That blindness and reliability are specifiable.

### What this activity does not establish

Whether the coding is valid.
...
| Statement | Status |
|---|---|
| Blind coding requires that the scorer does not know the condition or the hypothesis. | Framework-derived, appropriate at this grade |
| That blindness and reliability are specifiable. | What this specific activity can show |
| Whether the coding is valid. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 5 — Capturing Sim(t) — specifically: students build a contamination-resistant elicitation protocol.

**How it was taught.** Through the activity: write the full protocol with verbatim prompt, timing, scoring, and three worked examples

**Quick check.** Ask for the closing sentence of Session 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 5: write the full protocol with verbatim prompt, timing, scoring, and three worked examples, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A protocol naming two blind coders and the agreement statistic. |
| **Non-example** | A protocol where the experimenter scores their own elicitation. |
...
**Exact wording.** "Ask what is wrong with scoring your own elicitation."
...
**Target observation.** That blindness and reliability are specifiable.
...
> "Blind coding requires that the scorer does not know the condition or the hypothesis. You just saw that when ask what is wrong with scoring your own elicitation.
...
**What students must not infer.** Whether the coding is valid.

### 4. Worked example

**The example.** A protocol naming two blind coders and the agreement statistic.
...
**Completed answer.** A protocol naming two blind coders and the agreement statistic. — which demonstrates that blindness and reliability are specifiable.
...
**Conclusions not licensed.** Whether the coding is valid.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A coding scheme with an explicit uncodable category. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A protocol where the experimenter scores their own elicitation. Why is this not an
example?"
...
**Exact student instructions.** Specify the coding scheme, the scorer's knowledge, and how reliability is reported.
...
- *Licensed conclusion.* That blindness and reliability are specifiable.
- *Not licensed.* Whether the coding is valid.
...
- *Expected response.* That blindness and reliability are specifiable.
...
1. Any wording carrying the idea in `Blind coding requires that the scorer does not know the condition or the hypothesis`.
...
Say: "A scorer who knows the hypothesis is not a scorer."
...
| | |
|---|---|
| **Follows** | Session 5 — Capturing Sim(t) |
| **Leads to** | Session 7 — Is Self-Report Adequate At All |

**Transition in.** Session 5 established students build a contamination-resistant elicitation protocol. This session uses that as the starting point.

**Transition out.** This session establishes students specify who scores and what they know. Session 7 assumes it and builds students assess the limits of report-based measurement.
