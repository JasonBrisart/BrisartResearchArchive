# Session 6 Homework — Blind Coding And Reliability

**College Year 2** · Operationalisation and First Critique · **Quarter 1**
**Follows:** Session 6 — Blind Coding And Reliability · **Points:** 5 · **Optional:** yes
...
Specify the coding scheme, the scorer's knowledge, and how reliability is reported.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every protocol names who scores and what they know
...
Session 7 is **Is Self-Report Adequate At All**, which assumes you arrive holding it. Write one thing you expect it to be about:
