# Session 7 Homework — Is Self-Report Adequate At All

**College Year 2** · Operationalisation and First Critique · **Quarter 1**
**Follows:** Session 7 — Is Self-Report Adequate At All · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 7 ended on, from memory:
...
Identify which of their hypotheses report can and cannot carry, and propose one complement.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student identifies a hypothesis report cannot carry
...
Session 8 is **Measuring Intensity**, which assumes you arrive holding it. Write one thing you expect it to be about:
