# Session 2 — Is The Constraint Too Demanding
...
| | |
|---|---|
| **Central question** | Is The Constraint Too Demanding: students argue whether in-principle falsifiability is enough? |
| **Core concept** | Whether a framework falsifiable in principle but not in practice is scientifically useful is genuinely open. |
| **Student outcome** | Students argue whether in-principle falsifiability is enough. |
| **Previous session** | Session 1 — The Constraint At Research Standard |
| **Next session** | Session 3 — The Confabulation Objection |
...
**The conceptual step.** Whether a framework falsifiable in principle but not in practice is scientifically useful is genuinely open. The year settles it by attempting the measurement.
...
**What depends on it.** Session 3 — The Confabulation Objection — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Whether a framework falsifiable in principle but not in practice is scientifically useful is genuinely open. The year settles it by attempting the measurement.
...
1. A position that in-principle falsifiability is insufficient.
2. Named evidence that would change the student's position.

### One non-example

A position adopted without naming what would change it.
...
That the question is open and will be tested by attempt.
...
| Statement | Status |
|---|---|
| Whether a framework falsifiable in principle but not in practice is scientifically useful is genuinely open. | Framework-derived, appropriate at this grade |
| That the question is open and will be tested by attempt. | What this specific activity can show |
| Which position is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 1 — The Constraint At Research Standard — specifically: students apply the testability constraint to their own intentions.

**How it was taught.** Through the activity: apply the constraint to their own proposal and list the unmeasured variables

**Quick check.** Ask for the closing sentence of Session 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 1: apply the constraint to their own proposal and list the unmeasured variables, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A position that in-principle falsifiability is insufficient. |
| **Non-example** | A position adopted without naming what would change it. |
...
> "Most of you just discovered your first study idea is not a study of this framework."
...
**Exact wording.** "Assign two positions on whether the constraint is achievable in practice."
...
**Target observation.** That the question is open and will be tested by attempt.
...
> "Whether a framework falsifiable in principle but not in practice is scientifically useful is genuinely open. You just saw that when assign two positions on whether the constraint is achievable in practice.
> Last time we said: Most of you just discovered your first study idea is not a study of this framework. This is the next part of that.
...
**What students must not infer.** Which position is correct.

### 4. Worked example

**The example.** A position that in-principle falsifiability is insufficient.
...
**Completed answer.** A position that in-principle falsifiability is insufficient. — which demonstrates that the question is open and will be tested by attempt.
...
**Conclusions not licensed.** Which position is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Named evidence that would change the student's position. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A position adopted without naming what would change it. Why is this not an
example?"
...
**Exact student instructions.** Write their current position and what evidence over the year would change it.
...
- *Licensed conclusion.* That the question is open and will be tested by attempt.
- *Not licensed.* Which position is correct.
...
- *Expected response.* That the question is open and will be tested by attempt.
...
1. Any wording carrying the idea in `Whether a framework falsifiable in principle but not in practice is scientifically useful is genuinely open`.
...
Say: "You are going to settle this for yourselves by attempting it."
...
| | |
|---|---|
| **Follows** | Session 1 — The Constraint At Research Standard |
| **Leads to** | Session 3 — The Confabulation Objection |

**Transition in.** Session 1 established students apply the testability constraint to their own intentions. This session uses that as the starting point.

**Transition out.** This session establishes students argue whether in-principle falsifiability is enough. Session 3 assumes it and builds students state the objection that threatens all self-report.
