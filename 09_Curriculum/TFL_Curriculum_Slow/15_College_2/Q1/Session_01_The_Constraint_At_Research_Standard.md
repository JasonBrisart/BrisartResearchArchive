# Session 1 — The Constraint At Research Standard
...
| | |
|---|---|
| **Central question** | The Constraint At Research Standard: students apply the testability constraint to their own intentions? |
| **Core concept** | The testability constraint invalidates most casual applications, including the student's own first idea. |
| **Student outcome** | Students apply the testability constraint to their own intentions. |
| **Previous session** | None. First session of the year. |
| **Next session** | Session 2 — Is The Constraint Too Demanding |
| **Materials** | Printed protocol templates; audio source and shape cards |
| **Preparation** | thirty minutes |
| **Student printout** | `Printouts/Session_01_Printout.md` |
| **Homework** | `Homework/Session_01_Homework.md` |

## Why this lesson exists

**The conceptual step.** The testability constraint invalidates most casual applications, including the student's own first idea. Whether the constraint is achievable in practice is a separate and open question.
...
**What depends on it.** Session 2 — Is The Constraint Too Demanding — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The testability constraint invalidates most casual applications, including the student's own first idea. Whether the constraint is achievable in practice is a separate and open question.
...
1. A proposal invalidated because Sim(t) was unmeasured.
2. A proposal invalidated because E(t) was inferred from persistence.

### One non-example

A conclusion that the constraint makes all testing impossible.
...
That the constraint applies to the student's own intentions.
...
| Statement | Status |
|---|---|
| The testability constraint invalidates most casual applications, including the student's own first idea. | Framework-derived, appropriate at this grade |
| That the constraint applies to the student's own intentions. | What this specific activity can show |
| Whether the constraint can be satisfied. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The student states status accurately and renders a claim fairly.
...
| **Correct example** | A proposal invalidated because Sim(t) was unmeasured. |
| **Non-example** | A conclusion that the constraint makes all testing impossible. |
...
**Student materials.** One copy of `Printouts/Session_01_Printout.md` per student.
...
**File.** `Printouts/Session_01_Printout.md`
...
This is the first session of the year, so there is nothing to retrieve. Instead ask: "What do you think this course is about?" Take three answers and write them where they can be revisited at the end of the year. Do not correct them.

### 2. Hook

**Exact wording.** "Ask them to write the study they would most like to run. Read three aloud and apply the constraint."
...
**Target observation.** That the constraint applies to the student's own intentions.
...
> "The testability constraint invalidates most casual applications, including the student's own first idea. You just saw that when ask them to write the study they would most like to run.
...
**What students must not infer.** Whether the constraint can be satisfied.

### 4. Worked example

**The example.** A proposal invalidated because Sim(t) was unmeasured.
...
**Completed answer.** A proposal invalidated because Sim(t) was unmeasured. — which demonstrates that the constraint applies to the student's own intentions.
...
**Conclusions not licensed.** Whether the constraint can be satisfied.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A proposal invalidated because E(t) was inferred from persistence. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A conclusion that the constraint makes all testing impossible. Why is this not an
example?"
...
**Exact student instructions.** Apply the constraint to their own proposal and list the unmeasured variables.
...
- *Licensed conclusion.* That the constraint applies to the student's own intentions.
- *Not licensed.* Whether the constraint can be satisfied.
...
- *Expected response.* That the constraint applies to the student's own intentions.
...
1. Any wording carrying the idea in `The testability constraint invalidates most casual applications, including the student's own first idea`.
...
Say: "Most of you just discovered your first study idea is not a study of this framework."

**Why this sentence matters.** It is the opening question of Session 2, which assumes students arrive holding it.
...
**File.** `Homework/Session_01_Homework.md`
...
| | |
|---|---|
| **Follows** | Nothing. First session of the year. |
| **Leads to** | Session 2 — Is The Constraint Too Demanding |

**Transition in.** This session opens the year.

**Transition out.** This session establishes students apply the testability constraint to their own intentions. Session 2 assumes it and builds students argue whether in-principle falsifiability is enough.
