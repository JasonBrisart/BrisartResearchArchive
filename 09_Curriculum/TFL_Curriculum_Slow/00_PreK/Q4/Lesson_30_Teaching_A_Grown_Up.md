# Lesson 30 — Teaching A Grown-Up

**Pre-Kindergarten** · Guessing Games · **Quarter 4** · **15 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Teaching A Grown-Up: children explain the whole cycle to an adult? |
| **Core concept** | Teaching the whole cycle unsupported is the terminal check for this grade. |
| **Student outcome** | Children explain the whole cycle to an adult. |
| **Previous lesson** | Lesson 29 — The Circle At Home |
| **Next lesson** | Lesson 31 — The Year In Pictures |
...
**The conceptual step.** Teaching the whole cycle unsupported is the terminal check for this grade. The adult's question reveals what is missing.
...
**What depends on it.** Lesson 31 — The Year In Pictures — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Teaching the whole cycle unsupported is the terminal check for this grade. The adult's question reveals what is missing.
...
1. A child names all four words and draws the circle.
2. A child answers the adult's follow-up question.

### One non-example

A child who lists the words with no connection between them.
...
Whether the child can produce the whole idea unsupported.
...
| Statement | Status |
|---|---|
| Teaching the whole cycle unsupported is the terminal check for this grade. | Framework-derived, appropriate at this grade |
| Whether the child can produce the whole idea unsupported. | What this specific activity can show |
| Precision of the explanation. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 29 — The Circle At Home — specifically: children find the cycle outside school.

**How it was taught.** Through the activity: each child names one home example of guess, find out, guess again

**Quick check.** Ask for the closing sentence of Lesson 29. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 29: each child names one home example of guess, find out, guess again, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child names all four words and draws the circle. |
| **Non-example** | A child who lists the words with no connection between them. |
...
> "It is running at home too. It does not stop when you leave."
...
**Exact wording.** "Tell them that today they teach it and you will not explain anything."
...
**Target observation.** Whether the child can produce the whole idea unsupported.
...
> "Teaching the whole cycle unsupported is the terminal check for this grade. You just saw that when tell them that today they teach it and you will not explain anything.
> Last time we said: It is running at home too. It does not stop when you leave. This is the next part of that.
...
**What students must not infer.** Precision of the explanation.

### 4. Worked example

**The example.** A child names all four words and draws the circle.
...
**Completed answer.** A child names all four words and draws the circle. — which demonstrates whether the child can produce the whole idea unsupported.
...
**Conclusions not licensed.** Precision of the explanation.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child answers the adult's follow-up question. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who lists the words with no connection between them. Why is this not an
example?"
...
**Exact student instructions.** Each child explains the four words and the circle to a visiting adult.
...
- *Licensed conclusion.* Whether the child can produce the whole idea unsupported.
- *Not licensed.* Precision of the explanation.
...
- *Expected response.* Whether the child can produce the whole idea unsupported.
...
1. Any wording carrying the idea in `Teaching the whole cycle unsupported is the terminal check for this grade`.
...
| | |
|---|---|
| **Follows** | Lesson 29 — The Circle At Home |
| **Leads to** | Lesson 31 — The Year In Pictures |

**Transition in.** Lesson 29 established children find the cycle outside school. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children explain the whole cycle to an adult. Lesson 31 assumes it and builds children review the whole year using their own work.
