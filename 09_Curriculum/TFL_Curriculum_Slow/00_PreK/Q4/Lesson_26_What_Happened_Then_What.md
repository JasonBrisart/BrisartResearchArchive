# Lesson 26 — What Happened, Then What
...
| | |
|---|---|
| **Central question** | What Happened, Then What: children connect an outcome to the next guess? |
| **Core concept** | The outcome feeds the next guess. |
| **Student outcome** | Children connect an outcome to the next guess. |
| **Previous lesson** | Lesson 25 — Guess Again |
| **Next lesson** | Lesson 27 — Walking The Circle |
...
**The conceptual step.** The outcome feeds the next guess. This is the seed of carry-forward, four years before it is named.
...
**What depends on it.** Lesson 27 — Walking The Circle — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The outcome feeds the next guess. This is the seed of carry-forward, four years before it is named.
...
1. A child guesses rain, sees sun, then guesses outdoor play.
2. A child guesses the door opens, it does, then guesses who enters.

### One non-example

A second guess about something entirely unconnected.
...
That outcomes influence the next guess.
...
| Statement | Status |
|---|---|
| The outcome feeds the next guess. | Framework-derived, appropriate at this grade |
| That outcomes influence the next guess. | What this specific activity can show |
| The full inheritance idea, which is Grade 4. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — Guess Again — specifically: children guess repeatedly in a chain.

**How it was taught.** Through the activity: two rounds. In the second, each child repeats the previous guess before adding theirs

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: two rounds. In the second, each child repeats the previous guess before adding theirs, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child guesses rain, sees sun, then guesses outdoor play. |
| **Non-example** | A second guess about something entirely unconnected. |
...
> "The guessing does not stop. It keeps going round."
...
**Exact wording.** "Ask, after they find out, what they guess next."
...
**Target observation.** That outcomes influence the next guess.
...
> "The outcome feeds the next guess. You just saw that when ask, after they find out, what they guess next.
> Last time we said: The guessing does not stop. It keeps going round. This is the next part of that.
...
**The example.** A child guesses rain, sees sun, then guesses outdoor play.
...
**Completed answer.** A child guesses rain, sees sun, then guesses outdoor play. — which demonstrates that outcomes influence the next guess.
...
**Teacher prompt.** "Here is a second case. A child guesses the door opens, it does, then guesses who enters. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A second guess about something entirely unconnected. Why is this not an
example?"
...
**Exact student instructions.** Three-step chains: guess, find out, guess again. Done aloud in pairs.
...
- *Licensed conclusion.* That outcomes influence the next guess.
...
- *Expected response.* That outcomes influence the next guess.
...
1. Any wording carrying the idea in `The outcome feeds the next guess`.
...
Say: "What happened gives you the next guess."
...
| | |
|---|---|
| **Follows** | Lesson 25 — Guess Again |
| **Leads to** | Lesson 27 — Walking The Circle |

**Transition in.** Lesson 25 established children guess repeatedly in a chain. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children connect an outcome to the next guess. Lesson 27 assumes it and builds children physically walk the cycle.
