...
| | |
|---|---|
| **Central question** | Walking The Circle: children physically walk the cycle? |
| **Core concept** | Walking the loop makes its shape physical. |
| **Student outcome** | Children physically walk the cycle. |
| **Previous lesson** | Lesson 26 — What Happened, Then What |
| **Next lesson** | Lesson 28 — Drawing The Circle |
...
**The conceptual step.** Walking the loop makes its shape physical. The second lap is the whole point, because it shows the return rather than an ending.
...
**What depends on it.** Lesson 28 — Drawing The Circle — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Walking the loop makes its shape physical. The second lap is the whole point, because it shows the return rather than an ending.
...
1. A group walks the triangle and starts again.
2. A group states a real guess at each corner.

### One non-example

A group that walks it once and sits down.
...
That the process returns to its start.

### What this activity does not establish

Any formal cycle structure.
...
| Statement | Status |
|---|---|
| Walking the loop makes its shape physical. | Framework-derived, appropriate at this grade |
| That the process returns to its start. | What this specific activity can show |
| Any formal cycle structure. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — What Happened, Then What — specifically: children connect an outcome to the next guess.

**How it was taught.** Through the activity: three-step chains: guess, find out, guess again. Done aloud in pairs

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: three-step chains: guess, find out, guess again. Done aloud in pairs, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A group walks the triangle and starts again. |
| **Non-example** | A group that walks it once and sits down. |
...
> "What happened gives you the next guess."
...
**Exact wording.** "Three floor spots in a triangle: GUESS, FIND OUT, GUESS AGAIN."
...
**Target observation.** That the process returns to its start.
...
> "Walking the loop makes its shape physical. You just saw that when three floor spots in a triangle: GUESS, FIND OUT, GUESS AGAIN.
> Last time we said: What happened gives you the next guess. This is the next part of that.
...
**What students must not infer.** Any formal cycle structure.

### 4. Worked example

**The example.** A group walks the triangle and starts again.
...
**Completed answer.** A group walks the triangle and starts again. — which demonstrates that the process returns to its start.
...
**Conclusions not licensed.** Any formal cycle structure.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A group states a real guess at each corner. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A group that walks it once and sits down. Why is this not an
example?"
...
**Exact student instructions.** Small groups walk the triangle twice, saying a real thing at each spot.
...
- *Licensed conclusion.* That the process returns to its start.
- *Not licensed.* Any formal cycle structure.
...
- *Expected response.* That the process returns to its start.
...
1. Any wording carrying the idea in `Walking the loop makes its shape physical`.
...
Say: "You came back to the start. It goes round."
...
| | |
|---|---|
| **Follows** | Lesson 26 — What Happened, Then What |
| **Leads to** | Lesson 28 — Drawing The Circle |

**Transition in.** Lesson 26 established children connect an outcome to the next guess. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children physically walk the cycle. Lesson 28 assumes it and builds children draw the cycle with arrows.
