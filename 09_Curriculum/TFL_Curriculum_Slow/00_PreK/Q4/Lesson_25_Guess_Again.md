...
| | |
|---|---|
| **Central question** | Guess Again: children guess repeatedly in a chain? |
| **Core concept** | Guessing is not a single event. |
| **Student outcome** | Children guess repeatedly in a chain. |
| **Previous lesson** | Lesson 24 — The Sticking Review |
| **Next lesson** | Lesson 26 — What Happened, Then What |
...
**The conceptual step.** Guessing is not a single event. It happens again, and again, and the second round makes the repetition physically obvious.
...
**What depends on it.** Lesson 26 — What Happened, Then What — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Guessing is not a single event. It happens again, and again, and the second round makes the repetition physically obvious.
...
1. The object goes round and every child guesses.
2. A child repeats the previous guess and adds their own.

### One non-example

One child guessing once and the activity ending.
...
That guessing recurs continuously.

### What this activity does not establish

That each guess causes the next one.
...
| Statement | Status |
|---|---|
| Guessing is not a single event. | Framework-derived, appropriate at this grade |
| That guessing recurs continuously. | What this specific activity can show |
| That each guess causes the next one. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 24 — The Sticking Review — specifically: children consolidate the quarter's sticking work.

**How it was taught.** Through the activity: whole-group build: place each term's example under the right word

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: whole-group build: place each term's example under the right word, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The object goes round and every child guesses. |
| **Non-example** | One child guessing once and the activity ending. |
...
> "Next time we put all of it into a circle."
...
**Exact wording.** "Circle with one object. Whoever holds it says one thing that happens next."
...
**Target observation.** That guessing recurs continuously.
...
> "Guessing is not a single event. You just saw that when circle with one object.
> Last time we said: Next time we put all of it into a circle. This is the next part of that.
...
**What students must not infer.** That each guess causes the next one.

### 4. Worked example

**The example.** The object goes round and every child guesses.
...
**Completed answer.** The object goes round and every child guesses. — which demonstrates that guessing recurs continuously.
...
**Conclusions not licensed.** That each guess causes the next one.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child repeats the previous guess and adds their own. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. One child guessing once and the activity ending. Why is this not an
example?"
...
**Exact student instructions.** Two rounds. In the second, each child repeats the previous guess before adding theirs.
...
- *Licensed conclusion.* That guessing recurs continuously.
- *Not licensed.* That each guess causes the next one.
...
- *Expected response.* That guessing recurs continuously.
...
1. Any wording carrying the idea in `Guessing is not a single event`.
...
Say: "The guessing does not stop. It keeps going round."
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Sticking Review |
| **Leads to** | Lesson 26 — What Happened, Then What |

**Transition in.** Lesson 24 established children consolidate the quarter's sticking work. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children guess repeatedly in a chain. Lesson 26 assumes it and builds children connect an outcome to the next guess.
