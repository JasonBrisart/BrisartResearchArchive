...
| | |
|---|---|
| **Central question** | Guessing By Touch: children guess using one sense when another is removed? |
| **Core concept** | Guessing does not require sight. |
| **Student outcome** | Children guess using one sense when another is removed. |
| **Previous lesson** | Lesson 5 — The Snack Guess |
| **Next lesson** | Lesson 7 — Two Guesses |
...
**The conceptual step.** Guessing does not require sight. Whatever evidence is available gets used, and a guess is produced from it.
...
**What depends on it.** Lesson 7 — Two Guesses — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Guessing does not require sight. Whatever evidence is available gets used, and a guess is produced from it.
...
1. A child feels something round and says ball.
2. A child feels something with bristles and says brush.

### One non-example

A child who looks and then names the object has not guessed.
...
That guessing runs on whatever evidence is present.

### What this activity does not establish

That touch is more reliable than sight.
...
| Statement | Status |
|---|---|
| Guessing does not require sight. | Framework-derived, appropriate at this grade |
| That guessing runs on whatever evidence is present. | What this specific activity can show |
| That touch is more reliable than sight. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — The Snack Guess — specifically: children guess about a routine event and check it later in the day.

**How it was taught.** Through the activity: each child draws their guess about the next part of the day. Drawings are kept and checked later

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: each child draws their guess about the next part of the day. Drawings are kept and checked later, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child feels something round and says ball. |
| **Non-example** | A child who looks and then names the object has not guessed. |
...
> "We will find out if you were right. Being wrong is fine."
...
**Exact wording.** "Reach into a covered box and feel an object without looking."
...
**Target observation.** That guessing runs on whatever evidence is present.
...
> "Guessing does not require sight. You just saw that when reach into a covered box and feel an object without looking.
> Last time we said: We will find out if you were right. Being wrong is fine. This is the next part of that.
...
**What students must not infer.** That touch is more reliable than sight.

### 4. Worked example

**The example.** A child feels something round and says ball.
...
**Completed answer.** A child feels something round and says ball. — which demonstrates that guessing runs on whatever evidence is present.
...
**Conclusions not licensed.** That touch is more reliable than sight.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child feels something with bristles and says brush. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who looks and then names the object has not guessed. Why is this not an
example?"
...
**Exact student instructions.** Four objects, each felt and guessed before being revealed.
...
- *Licensed conclusion.* That guessing runs on whatever evidence is present.
- *Not licensed.* That touch is more reliable than sight.
...
- *Expected response.* That guessing runs on whatever evidence is present.
...
1. Any wording carrying the idea in `Guessing does not require sight`.
...
Say: "Even with your eyes closed, your brain still guesses."
...
| | |
|---|---|
| **Follows** | Lesson 5 — The Snack Guess |
| **Leads to** | Lesson 7 — Two Guesses |

**Transition in.** Lesson 5 established children guess about a routine event and check it later in the day. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children guess using one sense when another is removed. Lesson 7 assumes it and builds children hear that two people can guess differently about the same thing.
