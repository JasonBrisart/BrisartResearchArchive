...
| | |
|---|---|
| **Central question** | Guessing the Weather: children make a guess about something they can check immediately? |
| **Core concept** | Guessing and checking are two separate steps in that order. |
| **Student outcome** | Children make a guess about something they can check immediately. |
| **Previous lesson** | Lesson 3 — Finish It |
| **Next lesson** | Lesson 5 — The Snack Guess |
...
**The conceptual step.** Guessing and checking are two separate steps in that order. Children naturally collapse them; this lesson pulls them apart.
...
**What depends on it.** Lesson 5 — The Snack Guess — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Guessing and checking are two separate steps in that order. Children naturally collapse them; this lesson pulls them apart.
...
1. A child says cloudy, then the blind opens and it is cloudy.
2. A child says sunny, then the blind opens and it is raining.

### One non-example

Looking first and then announcing the weather — no guess occurred.
...
That the guess comes first and the check comes second.

### What this activity does not establish

That guessing correctly is the goal.
...
| Statement | Status |
|---|---|
| Guessing and checking are two separate steps in that order. | Framework-derived, appropriate at this grade |
| That the guess comes first and the check comes second. | What this specific activity can show |
| That guessing correctly is the goal. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — Finish It — specifically: children complete familiar phrases, showing guesses come from before.

**How it was taught.** Through the activity: circle game: each child offers a phrase the others finish. Coach the stuck ones

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: circle game: each child offers a phrase the others finish. Coach the stuck ones, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child says cloudy, then the blind opens and it is cloudy. |
| **Non-example** | Looking first and then announcing the weather — no guess occurred. |
...
> "Your guesses come from things that already happened to you."
...
**Exact wording.** "Ask, without looking out the window, whether it is sunny or cloudy."
...
**Target observation.** That the guess comes first and the check comes second.
...
> "Guessing and checking are two separate steps in that order. You just saw that when ask, without looking out the window, whether it is sunny or cloudy.
> Last time we said: Your guesses come from things that already happened to you. This is the next part of that.
...
**What students must not infer.** That guessing correctly is the goal.

### 4. Worked example

**The example.** A child says cloudy, then the blind opens and it is cloudy.
...
**Completed answer.** A child says cloudy, then the blind opens and it is cloudy. — which demonstrates that the guess comes first and the check comes second.
...
**Conclusions not licensed.** That guessing correctly is the goal.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child says sunny, then the blind opens and it is raining. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Looking first and then announcing the weather — no guess occurred. Why is this not an
example?"
...
**Exact student instructions.** Three window guesses across the session, each checked immediately.
...
- *Licensed conclusion.* That the guess comes first and the check comes second.
- *Not licensed.* That guessing correctly is the goal.
...
- *Expected response.* That the guess comes first and the check comes second.
...
1. Any wording carrying the idea in `Guessing and checking are two separate steps in that order`.
...
Say: "Guessing first and checking after is how we play."
...
| | |
|---|---|
| **Follows** | Lesson 3 — Finish It |
| **Leads to** | Lesson 5 — The Snack Guess |

**Transition in.** Lesson 3 established children complete familiar phrases, showing guesses come from before. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children make a guess about something they can check immediately. Lesson 5 assumes it and builds children guess about a routine event and check it later in the day.
