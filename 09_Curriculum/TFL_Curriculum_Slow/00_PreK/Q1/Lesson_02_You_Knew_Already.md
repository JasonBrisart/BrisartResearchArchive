# Lesson 2 — You Knew Already

**Pre-Kindergarten** · Guessing Games · **Quarter 1** · **15 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | You Knew Already: children discover they had a guess without being asked for one? |
| **Core concept** | Guesses are running before anybody requests one. |
| **Student outcome** | Children discover they had a guess without being asked for one. |
| **Previous lesson** | Lesson 1 — What Is In The Bag |
| **Next lesson** | Lesson 3 — Finish It |
...
**The conceptual step.** Guesses are running before anybody requests one. The child did not decide to guess about the hallway; the answer was simply available when asked for.
...
**What depends on it.** Lesson 3 — Finish It — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Guesses are running before anybody requests one. The child did not decide to guess about the hallway; the answer was simply available when asked for.
...
1. A child says the door is blue without looking at it.
2. A child knows the hallway is quiet right now without checking.

### One non-example

A child who turns around first and then reports — the evidence arrived before the answer.
...
That answers exist before they are requested.

### What this activity does not establish

That the child is remembering deliberately or trying hard.
...
| Statement | Status |
|---|---|
| Guesses are running before anybody requests one. | Framework-derived, appropriate at this grade |
| That answers exist before they are requested. | What this specific activity can show |
| That the child is remembering deliberately or trying hard. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 1 — What Is In The Bag — specifically: children say a guess out loud before an object is revealed.

**How it was taught.** Through the activity: run the bag five times with different familiar objects. Every child says a guess before each reveal

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: run the bag five times with different familiar objects. Every child says a guess before each reveal, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child says the door is blue without looking at it. |
| **Non-example** | A child who turns around first and then reports — the evidence arrived before the answer. |
...
> "Next time I will hide something else and you will guess again."
...
**Exact wording.** "Freeze the group mid-activity. Ask what is behind them without letting them turn around. Take three answers."
...
**Target observation.** That answers exist before they are requested.
...
> "Guesses are running before anybody requests one. You just saw that when freeze the group mid-activity.
> Last time we said: Next time I will hide something else and you will guess again. This is the next part of that.
...
**What students must not infer.** That the child is remembering deliberately or trying hard.

### 4. Worked example

**The example.** A child says the door is blue without looking at it.
...
**Completed answer.** A child says the door is blue without looking at it. — which demonstrates that answers exist before they are requested.
...
**Conclusions not licensed.** That the child is remembering deliberately or trying hard.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child knows the hallway is quiet right now without checking. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who turns around first and then reports — the evidence arrived before the answer. Why is this not an
example?"
...
**Exact student instructions.** Play it four times with different targets: the window, the hallway, the door colour, the ceiling.
...
- *Licensed conclusion.* That answers exist before they are requested.
- *Not licensed.* That the child is remembering deliberately or trying hard.
...
- *Expected response.* That answers exist before they are requested.
...
1. Any wording carrying the idea in `Guesses are running before anybody requests one`.
...
Say: "Your guesses are already in there, even when nobody asks."
...
| | |
|---|---|
| **Follows** | Lesson 1 — What Is In The Bag |
| **Leads to** | Lesson 3 — Finish It |

**Transition in.** Lesson 1 established children say a guess out loud before an object is revealed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children discover they had a guess without being asked for one. Lesson 3 assumes it and builds children complete familiar phrases, showing guesses come from before.
