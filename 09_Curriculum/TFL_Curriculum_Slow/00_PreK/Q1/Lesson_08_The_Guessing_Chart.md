...
| | |
|---|---|
| **Central question** | The Guessing Chart: children review the quarter and see that guessing happened every session? |
| **Core concept** | Guessing was not a special activity for one day. |
| **Student outcome** | Children review the quarter and see that guessing happened every session. |
| **Previous lesson** | Lesson 7 — Two Guesses |
| **Next lesson** | Lesson 9 — The Story Stop |
...
**The conceptual step.** Guessing was not a special activity for one day. It happened in every session, which is the first evidence that it is continuous.
...
**What depends on it.** Lesson 9 — The Story Stop — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Guessing was not a special activity for one day. It happened in every session, which is the first evidence that it is continuous.
...
1. The tally shows eight sessions with guesses in all eight.
2. A child finds their own drawing from session one.

### One non-example

A session where nobody guessed — there was not one.
...
That guessing recurred across the whole quarter.

### What this activity does not establish

That guessing is continuous outside the classroom, which comes later.
...
| Statement | Status |
|---|---|
| Guessing was not a special activity for one day. | Framework-derived, appropriate at this grade |
| That guessing recurred across the whole quarter. | What this specific activity can show |
| That guessing is continuous outside the classroom, which comes later. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — Two Guesses — specifically: children hear that two people can guess differently about the same thing.

**How it was taught.** Through the activity: partner guessing: pairs guess about the same hidden object and compare

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: partner guessing: pairs guess about the same hidden object and compare, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The tally shows eight sessions with guesses in all eight. |
| **Non-example** | A session where nobody guessed — there was not one. |
...
> "Two people can guess different things. Nobody is in trouble."
...
**Exact wording.** "Point at the GUESS chart and ask how many times they have guessed."
...
**Target observation.** That guessing recurred across the whole quarter.
...
> "Guessing was not a special activity for one day. You just saw that when point at the GUESS chart and ask how many times they have guessed.
> Last time we said: Two people can guess different things. Nobody is in trouble. This is the next part of that.
...
**What students must not infer.** That guessing is continuous outside the classroom, which comes later.

### 4. Worked example

**The example.** The tally shows eight sessions with guesses in all eight.
...
**Completed answer.** The tally shows eight sessions with guesses in all eight. — which demonstrates that guessing recurred across the whole quarter.
...
**Conclusions not licensed.** That guessing is continuous outside the classroom, which comes later.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child finds their own drawing from session one. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A session where nobody guessed — there was not one. Why is this not an
example?"
...
**Exact student instructions.** Build a class tally of every guess made this quarter, using the kept drawings.
...
- *Licensed conclusion.* That guessing recurred across the whole quarter.
- *Not licensed.* That guessing is continuous outside the classroom, which comes later.
...
- *Expected response.* That guessing recurred across the whole quarter.
...
1. Any wording carrying the idea in `Guessing was not a special activity for one day`.
...
Say: "We guessed every single time we met. Next time: what happens when a guess goes wrong."
...
| | |
|---|---|
| **Follows** | Lesson 7 — Two Guesses |
| **Leads to** | Lesson 9 — The Story Stop |

**Transition in.** Lesson 7 established children hear that two people can guess differently about the same thing. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children review the quarter and see that guessing happened every session. Lesson 9 assumes it and builds children predict what comes next in a familiar story.
