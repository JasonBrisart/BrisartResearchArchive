...
| | |
|---|---|
| **Central question** | What Is In The Bag: children say a guess out loud before an object is revealed? |
| **Core concept** | A guess is a thing a person produces before they find out. |
| **Student outcome** | Children say a guess out loud before an object is revealed. |
| **Previous lesson** | None. First lesson of the year. |
| **Next lesson** | Lesson 2 — You Knew Already |
...
**The conceptual step.** A guess is a thing a person produces before they find out. Children this age make guesses constantly but have never been told that the thing they are doing has a name. This lesson gives it one.
...
**What depends on it.** Lesson 2 — You Knew Already — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A guess is a thing a person produces before they find out. Children this age make guesses constantly but have never been told that the thing they are doing has a name. This lesson gives it one.
...
1. A child shakes the bag and says "a ball" before it is opened.
2. A child hears keys jingle and says "keys" without seeing them.

### One non-example

A child opens the bag, looks, and then says "it is a ball" — that is knowing, not guessing.
...
That children produce answers before evidence arrives.

### What this activity does not establish

That guesses are usually correct, or that guessing is a skill being trained.
...
| Statement | Status |
|---|---|
| A guess is a thing a person produces before they find out. | Framework-derived, appropriate at this grade |
| That children produce answers before evidence arrives. | What this specific activity can show |
| That guesses are usually correct, or that guessing is a skill being trained. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** Nothing. A child needs only to answer a spoken question.
...
| **Correct example** | A child shakes the bag and says "a ball" before it is opened. |
| **Non-example** | A child opens the bag, looks, and then says "it is a ball" — that is knowing, not guessing. |
...
**Exact wording.** "Shake a closed bag with something familiar inside. Ask what is in here. Take every answer without judging any of them."
...
**Target observation.** That children produce answers before evidence arrives.
...
> "A guess is a thing a person produces before they find out. You just saw that when shake a closed bag with something familiar inside.
...
**What students must not infer.** That guesses are usually correct, or that guessing is a skill being trained.

### 4. Worked example

**The example.** A child shakes the bag and says "a ball" before it is opened.
...
**Completed answer.** A child shakes the bag and says "a ball" before it is opened. — which demonstrates that children produce answers before evidence arrives.
...
**Conclusions not licensed.** That guesses are usually correct, or that guessing is a skill being trained.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child hears keys jingle and says "keys" without seeing them. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child opens the bag, looks, and then says "it is a ball" — that is knowing, not guessing. Why is this not an
example?"
...
**Exact student instructions.** Run the bag five times with different familiar objects. Every child says a guess before each reveal.
...
- *Licensed conclusion.* That children produce answers before evidence arrives.
- *Not licensed.* That guesses are usually correct, or that guessing is a skill being trained.
...
- *Expected response.* That children produce answers before evidence arrives.
...
1. Any wording carrying the idea in `A guess is a thing a person produces before they find out`.
...
Say: "Next time I will hide something else and you will guess again."
...
| **Leads to** | Lesson 2 — You Knew Already |

**Transition in.** This lesson opens the year.

**Transition out.** This lesson establishes children say a guess out loud before an object is revealed. Lesson 2 assumes it and builds children discover they had a guess without being asked for one.
