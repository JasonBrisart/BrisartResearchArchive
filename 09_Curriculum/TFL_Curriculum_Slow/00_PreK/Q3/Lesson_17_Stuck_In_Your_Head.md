...
| | |
|---|---|
| **Central question** | Stuck In Your Head: children notice some things stay with them and some do not? |
| **Core concept** | Not everything survives. |
| **Student outcome** | Children notice some things stay with them and some do not. |
| **Previous lesson** | Lesson 16 — The Surprise Chart |
| **Next lesson** | Lesson 18 — The Song You Cannot Stop |
...
**The conceptual step.** Not everything survives. Some content stays available and some does not, and the child can observe this difference in themselves.
...
**What depends on it.** Lesson 18 — The Song You Cannot Stop — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Not everything survives. Some content stays available and some does not, and the child can observe this difference in themselves.
...
1. A child still hums the broken song.
2. A child cannot recall the counting skip at all.

### One non-example

A child who says they remember everything from every session.
...
That some content persists and some fades.

### What this activity does not establish

What decides which, which is next session.
...
| Statement | Status |
|---|---|
| Not everything survives. | Framework-derived, appropriate at this grade |
| That some content persists and some fades. | What this specific activity can show |
| What decides which, which is next session. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Surprise Chart — specifically: children review the quarter's surprises and see the pattern.

**How it was taught.** Through the activity: build the class surprise tally. For each, the group says what was expected instead

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: build the class surprise tally. For each, the group says what was expected instead, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child still hums the broken song. |
| **Non-example** | A child who says they remember everything from every session. |
...
> "Every surprise means a guess was there first."
...
**Exact wording.** "Ask, without reminding them, what they still remember from last time."
...
**Target observation.** That some content persists and some fades.
...
> "Not everything survives. You just saw that when ask, without reminding them, what they still remember from last time.
> Last time we said: Every surprise means a guess was there first. This is the next part of that.
...
**What students must not infer.** What decides which, which is next session.

### 4. Worked example

**The example.** A child still hums the broken song.
...
**Completed answer.** A child still hums the broken song. — which demonstrates that some content persists and some fades.
...
**Conclusions not licensed.** What decides which, which is next session.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child cannot recall the counting skip at all. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who says they remember everything from every session. Why is this not an
example?"
...
**Exact student instructions.** Fold paper in half. Draw one stuck thing and one forgotten thing.
...
- *Licensed conclusion.* That some content persists and some fades.
- *Not licensed.* What decides which, which is next session.
...
- *Expected response.* That some content persists and some fades.
...
1. Any wording carrying the idea in `Not everything survives`.
...
Say: "Some things stick and some go. Both happened to you."
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Surprise Chart |
| **Leads to** | Lesson 18 — The Song You Cannot Stop |

**Transition in.** Lesson 16 established children review the quarter's surprises and see the pattern. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children notice some things stay with them and some do not. Lesson 18 assumes it and builds children recognise persistence in a familiar everyday form.
