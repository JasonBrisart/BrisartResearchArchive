...
| | |
|---|---|
| **Central question** | The Sticking Sort: children sort guesses by whether they stuck? |
| **Core concept** | Sorting makes the pattern visible as a physical distribution rather than a claim. |
| **Student outcome** | Children sort guesses by whether they stuck. |
| **Previous lesson** | Lesson 21 — Wrong But Stuck |
| **Next lesson** | Lesson 23 — Telling Somebody |
...
**The conceptual step.** Sorting makes the pattern visible as a physical distribution rather than a claim. The children can see both hoops filling.
...
**What depends on it.** Lesson 23 — Telling Somebody — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Sorting makes the pattern visible as a physical distribution rather than a claim. The children can see both hoops filling.
...
1. A child puts the broken song in STUCK.
2. A child puts a correct door guess in GONE.

### One non-example

A child who sorts by which drawing they like best.
...
That both categories fill with real examples.

### What this activity does not establish

Proportions or rates, which are far beyond this grade.
...
| Statement | Status |
|---|---|
| Sorting makes the pattern visible as a physical distribution rather than a claim. | Framework-derived, appropriate at this grade |
| That both categories fill with real examples. | What this specific activity can show |
| Proportions or rates, which are far beyond this grade. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 21 — Wrong But Stuck — specifically: children find a wrong guess that stayed with them.

**How it was taught.** Through the activity: hunt for wrong-and-stuck examples from the term's surprises

**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: hunt for wrong-and-stuck examples from the term's surprises, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child puts the broken song in STUCK. |
| **Non-example** | A child who sorts by which drawing they like best. |
...
> "Wrong and stuck. That happens a lot."
...
**Exact wording.** "Two hoops on the floor labelled STUCK and GONE."
...
**Target observation.** That both categories fill with real examples.
...
> "Sorting makes the pattern visible as a physical distribution rather than a claim. You just saw that when two hoops on the floor labelled STUCK and GONE.
> Last time we said: Wrong and stuck. That happens a lot. This is the next part of that.
...
**What students must not infer.** Proportions or rates, which are far beyond this grade.

### 4. Worked example

**The example.** A child puts the broken song in STUCK.
...
**Completed answer.** A child puts the broken song in STUCK. — which demonstrates that both categories fill with real examples.
...
**Conclusions not licensed.** Proportions or rates, which are far beyond this grade.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child puts a correct door guess in GONE. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who sorts by which drawing they like best. Why is this not an
example?"
...
**Exact student instructions.** Children physically place drawings of their guesses into the two hoops.
...
- *Licensed conclusion.* That both categories fill with real examples.
- *Not licensed.* Proportions or rates, which are far beyond this grade.
...
- *Expected response.* That both categories fill with real examples.
...
1. Any wording carrying the idea in `Sorting makes the pattern visible as a physical distribution rather than a claim`.
...
Say: "Look how many are in each. It is not about being right."
...
| | |
|---|---|
| **Follows** | Lesson 21 — Wrong But Stuck |
| **Leads to** | Lesson 23 — Telling Somebody |

**Transition in.** Lesson 21 established children find a wrong guess that stayed with them. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children sort guesses by whether they stuck. Lesson 23 assumes it and builds children explain sticking to another person.
