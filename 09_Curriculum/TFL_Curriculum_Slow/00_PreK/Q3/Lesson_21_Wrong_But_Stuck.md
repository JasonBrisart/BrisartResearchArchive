...
| | |
|---|---|
| **Central question** | Wrong But Stuck: children find a wrong guess that stayed with them? |
| **Core concept** | Wrong guesses often persist. |
| **Student outcome** | Children find a wrong guess that stayed with them. |
| **Previous lesson** | Lesson 20 — Right But Forgotten |
| **Next lesson** | Lesson 22 — The Sticking Sort |
...
**The conceptual step.** Wrong guesses often persist. Together with the previous session, this shows that being right and sticking are not the same thing.
...
**What depends on it.** Lesson 22 — The Sticking Sort — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Wrong guesses often persist. Together with the previous session, this shows that being right and sticking are not the same thing.
...
1. The broken song, which was wrong and is still remembered.
2. The wrong story ending, still discussed a week later.

### One non-example

A wrong guess nobody can recall — those exist too.
...
That incorrectness does not prevent sticking.

### What this activity does not establish

Why intensity matters, which is much later.
...
| Statement | Status |
|---|---|
| Wrong guesses often persist. | Framework-derived, appropriate at this grade |
| That incorrectness does not prevent sticking. | What this specific activity can show |
| Why intensity matters, which is much later. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — Right But Forgotten — specifically: children find a correct guess they forgot immediately.

**How it was taught.** Through the activity: hunt for right-and-forgotten examples: doors, chairs, the bell

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: hunt for right-and-forgotten examples: doors, chairs, the bell, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The broken song, which was wrong and is still remembered. |
| **Non-example** | A wrong guess nobody can recall — those exist too. |
...
> "Being right did not make it stick."
...
**Exact wording.** "Ask for a guess they got wrong that they are still thinking about."
...
**Target observation.** That incorrectness does not prevent sticking.
...
> "Wrong guesses often persist. You just saw that when ask for a guess they got wrong that they are still thinking about.
> Last time we said: Being right did not make it stick. This is the next part of that.
...
**What students must not infer.** Why intensity matters, which is much later.

### 4. Worked example

**The example.** The broken song, which was wrong and is still remembered.
...
**Completed answer.** The broken song, which was wrong and is still remembered. — which demonstrates that incorrectness does not prevent sticking.
...
**Conclusions not licensed.** Why intensity matters, which is much later.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The wrong story ending, still discussed a week later. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A wrong guess nobody can recall — those exist too. Why is this not an
example?"
...
**Exact student instructions.** Hunt for wrong-and-stuck examples from the term's surprises.
...
- *Licensed conclusion.* That incorrectness does not prevent sticking.
- *Not licensed.* Why intensity matters, which is much later.
...
- *Expected response.* That incorrectness does not prevent sticking.
...
1. Any wording carrying the idea in `Wrong guesses often persist`.
...
Say: "Wrong and stuck. That happens a lot."
...
| | |
|---|---|
| **Follows** | Lesson 20 — Right But Forgotten |
| **Leads to** | Lesson 22 — The Sticking Sort |

**Transition in.** Lesson 20 established children find a correct guess they forgot immediately. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children find a wrong guess that stayed with them. Lesson 22 assumes it and builds children sort guesses by whether they stuck.
