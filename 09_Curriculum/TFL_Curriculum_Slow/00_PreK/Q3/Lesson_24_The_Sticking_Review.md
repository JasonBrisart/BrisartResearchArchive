...
| | |
|---|---|
| **Central question** | The Sticking Review: children consolidate the quarter's sticking work? |
| **Core concept** | Surprise and sticking are different things. |
| **Student outcome** | Children consolidate the quarter's sticking work. |
| **Previous lesson** | Lesson 23 — Telling Somebody |
| **Next lesson** | Lesson 25 — Guess Again |
...
**The conceptual step.** Surprise and sticking are different things. One is an immediate reaction; the other is what happens afterwards.
...
**What depends on it.** Lesson 25 — Guess Again — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Surprise and sticking are different things. One is an immediate reaction; the other is what happens afterwards.
...
1. The song stop was a surprise and it also stuck.
2. The counting skip was a surprise and it did not stick.

### One non-example

Treating every surprise as automatically sticky.
...
That surprise and sticking are separable.

### What this activity does not establish

Any rate or reliability claim.
...
| Statement | Status |
|---|---|
| Surprise and sticking are different things. | Framework-derived, appropriate at this grade |
| That surprise and sticking are separable. | What this specific activity can show |
| Any rate or reliability claim. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — Telling Somebody — specifically: children explain sticking to another person.

**How it was taught.** Through the activity: pair with an older buddy class or a visiting adult. Each child explains stuck versus gone

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: pair with an older buddy class or a visiting adult. Each child explains stuck versus gone, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The song stop was a surprise and it also stuck. |
| **Non-example** | Treating every surprise as automatically sticky. |
...
> "If you can say it to somebody else, you know it."
...
**Exact wording.** "Both charts up. Ask how guesses, surprises, and sticking fit together."
...
**Target observation.** That surprise and sticking are separable.
...
> "Surprise and sticking are different things. You just saw that when both charts up.
> Last time we said: If you can say it to somebody else, you know it. This is the next part of that.
...
**What students must not infer.** Any rate or reliability claim.

### 4. Worked example

**The example.** The song stop was a surprise and it also stuck.
...
**Completed answer.** The song stop was a surprise and it also stuck. — which demonstrates that surprise and sticking are separable.
...
**Conclusions not licensed.** Any rate or reliability claim.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The counting skip was a surprise and it did not stick. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Treating every surprise as automatically sticky. Why is this not an
example?"
...
**Exact student instructions.** Whole-group build: place each term's example under the right word.
...
- *Licensed conclusion.* That surprise and sticking are separable.
- *Not licensed.* Any rate or reliability claim.
...
- *Expected response.* That surprise and sticking are separable.
...
1. Any wording carrying the idea in `Surprise and sticking are different things`.
...
Say: "Next time we put all of it into a circle."
...
| | |
|---|---|
| **Follows** | Lesson 23 — Telling Somebody |
| **Leads to** | Lesson 25 — Guess Again |

**Transition in.** Lesson 23 established children explain sticking to another person. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children consolidate the quarter's sticking work. Lesson 25 assumes it and builds children guess repeatedly in a chain.
