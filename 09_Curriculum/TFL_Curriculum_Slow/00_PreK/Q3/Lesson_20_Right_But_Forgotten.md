...
| | |
|---|---|
| **Central question** | Right But Forgotten: children find a correct guess they forgot immediately? |
| **Core concept** | Correct guesses are usually forgotten instantly. |
| **Student outcome** | Children find a correct guess they forgot immediately. |
| **Previous lesson** | Lesson 19 — Why Did That Stick |
| **Next lesson** | Lesson 21 — Wrong But Stuck |
...
**The conceptual step.** Correct guesses are usually forgotten instantly. This is the first half of the persistence-accuracy separation, in the plainest possible form.
...
**What depends on it.** Lesson 21 — Wrong But Stuck — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Correct guesses are usually forgotten instantly. This is the first half of the persistence-accuracy separation, in the plainest possible form.
...
1. A child guessed the door would open and it did, and forgot immediately.
2. A child guessed the chair would hold them and never thought about it again.

### One non-example

A child who says they remember every correct guess.
...
That correctness does not produce sticking.

### What this activity does not establish

The full independence claim, which is Grade 7.
...
| Statement | Status |
|---|---|
| Correct guesses are usually forgotten instantly. | Framework-derived, appropriate at this grade |
| That correctness does not produce sticking. | What this specific activity can show |
| The full independence claim, which is Grade 7. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — Why Did That Stick — specifically: children begin to say why something stayed with them.

**How it was taught.** Through the activity: each child gives a reason for their own stuck item. Accept any reason

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: each child gives a reason for their own stuck item. Accept any reason, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child guessed the door would open and it did, and forgot immediately. |
| **Non-example** | A child who says they remember every correct guess. |
...
> "It stuck because it mattered to you."
...
**Exact wording.** "Ask for a guess they got right and whether they kept thinking about it."
...
**Target observation.** That correctness does not produce sticking.
...
> "Correct guesses are usually forgotten instantly. You just saw that when ask for a guess they got right and whether they kept thinking about it.
> Last time we said: It stuck because it mattered to you. This is the next part of that.
...
**What students must not infer.** The full independence claim, which is Grade 7.

### 4. Worked example

**The example.** A child guessed the door would open and it did, and forgot immediately.
...
**Completed answer.** A child guessed the door would open and it did, and forgot immediately. — which demonstrates that correctness does not produce sticking.
...
**Conclusions not licensed.** The full independence claim, which is Grade 7.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child guessed the chair would hold them and never thought about it again. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who says they remember every correct guess. Why is this not an
example?"
...
**Exact student instructions.** Hunt for right-and-forgotten examples: doors, chairs, the bell.
...
- *Licensed conclusion.* That correctness does not produce sticking.
- *Not licensed.* The full independence claim, which is Grade 7.
...
- *Expected response.* That correctness does not produce sticking.
...
1. Any wording carrying the idea in `Correct guesses are usually forgotten instantly`.
...
Say: "Being right did not make it stick."
...
| | |
|---|---|
| **Follows** | Lesson 19 — Why Did That Stick |
| **Leads to** | Lesson 21 — Wrong But Stuck |

**Transition in.** Lesson 19 established children begin to say why something stayed with them. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children find a correct guess they forgot immediately. Lesson 21 assumes it and builds children find a wrong guess that stayed with them.
