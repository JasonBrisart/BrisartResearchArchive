...
| | |
|---|---|
| **Central question** | The Wrong Ending: children experience a deliberately broken guess? |
| **Core concept** | Breaking a guess on purpose makes the guess visible. |
| **Student outcome** | Children experience a deliberately broken guess. |
| **Previous lesson** | Lesson 9 — The Story Stop |
| **Next lesson** | Lesson 11 — The Sound That Stops |
...
**The conceptual step.** Breaking a guess on purpose makes the guess visible. The reaction the children produce is evidence that something was already there.
...
**What depends on it.** Lesson 11 — The Sound That Stops — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Breaking a guess on purpose makes the guess visible. The reaction the children produce is evidence that something was already there.
...
1. The three pigs go swimming and the room objects.
2. Counting goes one, two, three, five and children react.

### One non-example

An ending children have never heard — nothing to break, so no reaction.
...
That a mismatch produces a visible reaction.

### What this activity does not establish

What the reaction is made of, or why it happens.
...
| Statement | Status |
|---|---|
| Breaking a guess on purpose makes the guess visible. | Framework-derived, appropriate at this grade |
| That a mismatch produces a visible reaction. | What this specific activity can show |
| What the reaction is made of, or why it happens. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 9 — The Story Stop — specifically: children predict what comes next in a familiar story.

**How it was taught.** Through the activity: read with five stops. At each, one child says the guess aloud before the page turns

**Quick check.** Ask for the closing sentence of Lesson 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 9: read with five stops. At each, one child says the guess aloud before the page turns, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The three pigs go swimming and the room objects. |
| **Non-example** | An ending children have never heard — nothing to break, so no reaction. |
...
> "Next time I am going to tell it wrong on purpose."
...
**Exact wording.** "Tell a two-line version of a known story and end it wrong."
...
**Target observation.** That a mismatch produces a visible reaction.
...
> "Breaking a guess on purpose makes the guess visible. You just saw that when tell a two-line version of a known story and end it wrong.
> Last time we said: Next time I am going to tell it wrong on purpose. This is the next part of that.
...
**What students must not infer.** What the reaction is made of, or why it happens.

### 4. Worked example

**The example.** The three pigs go swimming and the room objects.
...
**Completed answer.** The three pigs go swimming and the room objects. — which demonstrates that a mismatch produces a visible reaction.
...
**Conclusions not licensed.** What the reaction is made of, or why it happens.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Counting goes one, two, three, five and children react. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An ending children have never heard — nothing to break, so no reaction. Why is this not an
example?"
...
**Exact student instructions.** Three more wrong endings: a song that stops, a counting skip, a phrase ending wrong.
...
- *Licensed conclusion.* That a mismatch produces a visible reaction.
- *Not licensed.* What the reaction is made of, or why it happens.
...
- *Expected response.* That a mismatch produces a visible reaction.
...
1. Any wording carrying the idea in `Breaking a guess on purpose makes the guess visible`.
...
Say: "Surprise is how we catch a guess."
...
| | |
|---|---|
| **Follows** | Lesson 9 — The Story Stop |
| **Leads to** | Lesson 11 — The Sound That Stops |

**Transition in.** Lesson 9 established children predict what comes next in a familiar story. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children experience a deliberately broken guess. Lesson 11 assumes it and builds children report the guess an audio break revealed.
