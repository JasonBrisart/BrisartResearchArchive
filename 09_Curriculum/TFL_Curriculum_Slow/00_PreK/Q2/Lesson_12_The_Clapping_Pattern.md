# Lesson 12 — The Clapping Pattern
...
| | |
|---|---|
| **Central question** | The Clapping Pattern: children predict a rhythm and notice when it changes? |
| **Core concept** | Guesses show up in the body, not only in words. |
| **Student outcome** | Children predict a rhythm and notice when it changes. |
| **Previous lesson** | Lesson 11 — The Sound That Stops |
| **Next lesson** | Lesson 13 — The Counting Skip |
...
**The conceptual step.** Guesses show up in the body, not only in words. Hands that continue the old pattern are displaying the guess directly.
...
**What depends on it.** Lesson 13 — The Counting Skip — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Guesses show up in the body, not only in words. Hands that continue the old pattern are displaying the guess directly.
...
1. Children clap the fourth beat that does not come.
2. Children stop abruptly when the rhythm changes.

### One non-example

Children who watch without joining in produce no visible guess.
...
That guesses can appear as physical action.

### What this activity does not establish

That the body is a separate system from guessing.
...
| Statement | Status |
|---|---|
| Guesses show up in the body, not only in words. | Framework-derived, appropriate at this grade |
| That guesses can appear as physical action. | What this specific activity can show |
| That the body is a separate system from guessing. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 11 — The Sound That Stops — specifically: children report the guess an audio break revealed.

**How it was taught.** Through the activity: three more breaks. After each, every child completes: I was surprised because I guessed

**Quick check.** Ask for the closing sentence of Lesson 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 11: three more breaks. After each, every child completes: I was surprised because I guessed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Children clap the fourth beat that does not come. |
| **Non-example** | Children who watch without joining in produce no visible guess. |
...
> "When your guess is right you never notice it."
...
**Exact wording.** "Clap a simple pattern three times, then change the fourth."
...
**Target observation.** That guesses can appear as physical action.
...
> "Guesses show up in the body, not only in words. You just saw that when clap a simple pattern three times, then change the fourth.
> Last time we said: When your guess is right you never notice it. This is the next part of that.
...
**What students must not infer.** That the body is a separate system from guessing.

### 4. Worked example

**The example.** Children clap the fourth beat that does not come.
...
**Completed answer.** Children clap the fourth beat that does not come. — which demonstrates that guesses can appear as physical action.
...
**Conclusions not licensed.** That the body is a separate system from guessing.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Children stop abruptly when the rhythm changes. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Children who watch without joining in produce no visible guess. Why is this not an
example?"
...
**Exact student instructions.** Four pattern breaks, children joining in and stopping when it changes.
...
- *Licensed conclusion.* That guesses can appear as physical action.
- *Not licensed.* That the body is a separate system from guessing.
...
- *Expected response.* That guesses can appear as physical action.
...
1. Any wording carrying the idea in `Guesses show up in the body, not only in words`.
...
Say: "Your hands knew what was coming. That was a guess too."
...
| | |
|---|---|
| **Follows** | Lesson 11 — The Sound That Stops |
| **Leads to** | Lesson 13 — The Counting Skip |

**Transition in.** Lesson 11 established children report the guess an audio break revealed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children predict a rhythm and notice when it changes. Lesson 13 assumes it and builds children notice a break in a number sequence.
