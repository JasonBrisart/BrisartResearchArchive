...
| | |
|---|---|
| **Central question** | The Counting Skip: children notice a break in a number sequence? |
| **Core concept** | Number sequences are strongly learned, so the guess is strong and the break is easy to feel. |
| **Student outcome** | Children notice a break in a number sequence. |
| **Previous lesson** | Lesson 12 — The Clapping Pattern |
| **Next lesson** | Lesson 14 — Surprised Faces |
...
**The conceptual step.** Number sequences are strongly learned, so the guess is strong and the break is easy to feel. Strength of the guess is why the reaction is large.
...
**What depends on it.** Lesson 14 — Surprised Faces — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Number sequences are strongly learned, so the guess is strong and the break is easy to feel. Strength of the guess is why the reaction is large.
...
1. Children object when four is skipped.
2. Children say no when ten follows eight.

### One non-example

A random string of numbers with no pattern — no guess to break.
...
That well-learned sequences produce strong guesses.

### What this activity does not establish

That number knowledge is being assessed.
...
| Statement | Status |
|---|---|
| Number sequences are strongly learned, so the guess is strong and the break is easy to feel. | Framework-derived, appropriate at this grade |
| That well-learned sequences produce strong guesses. | What this specific activity can show |
| That number knowledge is being assessed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — The Clapping Pattern — specifically: children predict a rhythm and notice when it changes.

**How it was taught.** Through the activity: four pattern breaks, children joining in and stopping when it changes

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: four pattern breaks, children joining in and stopping when it changes, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Children object when four is skipped. |
| **Non-example** | A random string of numbers with no pattern — no guess to break. |
...
> "Your hands knew what was coming. That was a guess too."
...
**Exact wording.** "Count aloud together: one, two, three, five."
...
**Target observation.** That well-learned sequences produce strong guesses.
...
> "Number sequences are strongly learned, so the guess is strong and the break is easy to feel. You just saw that when count aloud together: one, two, three, five.
> Last time we said: Your hands knew what was coming. That was a guess too. This is the next part of that.
...
**What students must not infer.** That number knowledge is being assessed.

### 4. Worked example

**The example.** Children object when four is skipped.
...
**Completed answer.** Children object when four is skipped. — which demonstrates that well-learned sequences produce strong guesses.
...
**Conclusions not licensed.** That number knowledge is being assessed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Children say no when ten follows eight. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A random string of numbers with no pattern — no guess to break. Why is this not an
example?"
...
**Exact student instructions.** Four counting skips of increasing subtlety.
...
- *Licensed conclusion.* That well-learned sequences produce strong guesses.
- *Not licensed.* That number knowledge is being assessed.
...
- *Expected response.* That well-learned sequences produce strong guesses.
...
1. Any wording carrying the idea in `Number sequences are strongly learned, so the guess is strong and the break is easy to feel`.
...
Say: "You knew what number was coming before I said it."
...
| | |
|---|---|
| **Follows** | Lesson 12 — The Clapping Pattern |
| **Leads to** | Lesson 14 — Surprised Faces |

**Transition in.** Lesson 12 established children predict a rhythm and notice when it changes. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children notice a break in a number sequence. Lesson 14 assumes it and builds children recognise surprise as a feeling they can name.
