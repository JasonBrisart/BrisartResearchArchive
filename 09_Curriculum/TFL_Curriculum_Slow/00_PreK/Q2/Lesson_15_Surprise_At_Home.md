...
| | |
|---|---|
| **Central question** | Surprise At Home: children report a surprise from outside the classroom? |
| **Core concept** | Guessing is not a classroom activity. |
| **Student outcome** | Children report a surprise from outside the classroom. |
| **Previous lesson** | Lesson 14 — Surprised Faces |
| **Next lesson** | Lesson 16 — The Surprise Chart |
...
**The conceptual step.** Guessing is not a classroom activity. It runs everywhere, and home surprises are evidence of that.
...
**What depends on it.** Lesson 16 — The Surprise Chart — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Guessing is not a classroom activity. It runs everywhere, and home surprises are evidence of that.
...
1. A child expected a parent home and somebody else arrived.
2. A child expected pasta and got soup.

### One non-example

A child describing a fun day with no mismatch in it.
...
That guessing and surprise occur outside school.

### What this activity does not establish

That home events should be analysed in any depth.
...
| Statement | Status |
|---|---|
| Guessing is not a classroom activity. | Framework-derived, appropriate at this grade |
| That guessing and surprise occur outside school. | What this specific activity can show |
| That home events should be analysed in any depth. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Surprised Faces — specifically: children recognise surprise as a feeling they can name.

**How it was taught.** Through the activity: children draw their own surprised face, then draw what surprised them

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: children draw their own surprised face, then draw what surprised them, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child expected a parent home and somebody else arrived. |
| **Non-example** | A child describing a fun day with no mismatch in it. |
...
> "Your face does that when something different happened than you guessed."
...
**Exact wording.** "Ask about a time something surprised them at home."
...
**Target observation.** That guessing and surprise occur outside school.
...
> "Guessing is not a classroom activity. You just saw that when ask about a time something surprised them at home.
> Last time we said: Your face does that when something different happened than you guessed. This is the next part of that.
...
**What students must not infer.** That home events should be analysed in any depth.

### 4. Worked example

**The example.** A child expected a parent home and somebody else arrived.
...
**Completed answer.** A child expected a parent home and somebody else arrived. — which demonstrates that guessing and surprise occur outside school.
...
**Conclusions not licensed.** That home events should be analysed in any depth.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child expected pasta and got soup. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child describing a fun day with no mismatch in it. Why is this not an
example?"
...
**Exact student instructions.** Each child shares one home surprise and says what they expected instead.
...
- *Licensed conclusion.* That guessing and surprise occur outside school.
- *Not licensed.* That home events should be analysed in any depth.
...
- *Expected response.* That guessing and surprise occur outside school.
...
1. Any wording carrying the idea in `Guessing is not a classroom activity`.
...
Say: "Surprises happen everywhere, not only here."
...
| | |
|---|---|
| **Follows** | Lesson 14 — Surprised Faces |
| **Leads to** | Lesson 16 — The Surprise Chart |

**Transition in.** Lesson 14 established children recognise surprise as a feeling they can name. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children report a surprise from outside the classroom. Lesson 16 assumes it and builds children review the quarter's surprises and see the pattern.
