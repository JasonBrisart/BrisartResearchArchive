...
| | |
|---|---|
| **Central question** | The Chain Review: students consolidate the quarter's chain work? |
| **Core concept** | The wrong-versus-broken distinction is the quarter's core diagnostic. |
| **Student outcome** | Students consolidate the quarter's chain work. |
| **Previous lesson** | Lesson 23 — The Audited Chain |
| **Next lesson** | Lesson 25 — The Loop Closes |
...
**The conceptual step.** The wrong-versus-broken distinction is the quarter's core diagnostic. The review tests whether it survives under speed.
...
**What depends on it.** Lesson 25 — The Loop Closes — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The wrong-versus-broken distinction is the quarter's core diagnostic. The review tests whether it survives under speed.
...
1. A break correctly classified as missing inheritance.
2. A row with a wrong expectation correctly left unmarked.

### One non-example

Marking a row broken because its content was incorrect.
...
Whether the two-way classification is secure.

### What this activity does not establish

Whether the traces are accurate.
...
| Statement | Status |
|---|---|
| The wrong-versus-broken distinction is the quarter's core diagnostic. | Framework-derived, appropriate at this grade |
| Whether the two-way classification is secure. | What this specific activity can show |
| Whether the traces are accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — The Audited Chain — specifically: students produce, audit, and repair a chain in one session.

**How it was taught.** Through the activity: full cycle: produce, swap, audit, repair

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: full cycle: produce, swap, audit, repair, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A break correctly classified as missing inheritance. |
| **Non-example** | Marking a row broken because its content was incorrect. |
...
> "You can follow a chain as far as it honestly goes."
...
**Exact wording.** "Ask how you check one and what the two kinds of break are."
...
**Target observation.** Whether the two-way classification is secure.
...
> "The wrong-versus-broken distinction is the quarter's core diagnostic. You just saw that when ask how you check one and what the two kinds of break are.
> Last time we said: You can follow a chain as far as it honestly goes. This is the next part of that.
...
**What students must not infer.** Whether the traces are accurate.

### 4. Worked example

**The example.** A break correctly classified as missing inheritance.
...
**Completed answer.** A break correctly classified as missing inheritance. — which demonstrates whether the two-way classification is secure.
...
**Conclusions not licensed.** Whether the traces are accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A row with a wrong expectation correctly left unmarked. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Marking a row broken because its content was incorrect. Why is this not an
example?"
...
**Exact student instructions.** Review with eight traces audited and classified.
...
- *Licensed conclusion.* Whether the two-way classification is secure.
- *Not licensed.* Whether the traces are accurate.
...
- *Expected response.* Whether the two-way classification is secure.
...
1. Any wording carrying the idea in `The wrong-versus-broken distinction is the quarter's core diagnostic`.
...
Say: "Next time: the shape this has really been all along."
...
| | |
|---|---|
| **Follows** | Lesson 23 — The Audited Chain |
| **Leads to** | Lesson 25 — The Loop Closes |

**Transition in.** Lesson 23 established students produce, audit, and repair a chain in one session. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the quarter's chain work. Lesson 25 assumes it and builds students show the chain as a cycle rather than a line.
