# Lesson 19 Homework — Repairing Eight Rows

**Grade 4** · Carry Forward · **Quarter 3**
**Follows:** Lesson 19 — Repairing Eight Rows · **Points:** 5 · **Optional:** yes
...
Repair the audited trace and record each repair type.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student repairs from the first break downward
...
Lesson 20 is **Chains In Other Subjects**, which assumes you arrive holding it. Write one thing you expect it to be about:
