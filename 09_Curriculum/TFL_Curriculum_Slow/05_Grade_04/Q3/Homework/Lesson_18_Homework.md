# Lesson 18 Homework — Auditing Eight Rows

**Grade 4** · Carry Forward · **Quarter 3**
**Follows:** Lesson 18 — Auditing Eight Rows · **Points:** 5 · **Optional:** yes
...
Audit a partner's eight-row trace, marking the first break.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student receives an audited eight-row trace
...
Lesson 19 is **Repairing Eight Rows**, which assumes you arrive holding it. Write one thing you expect it to be about:
