...
| | |
|---|---|
| **Central question** | The Eight Row Trace: students produce an eight-row chain? |
| **Core concept** | Reaching eight rows honestly requires eight genuine moments, not four moments subdivided. |
| **Student outcome** | Students produce an eight-row chain. |
| **Previous lesson** | Lesson 16 — The Long Chain Review |
| **Next lesson** | Lesson 18 — Auditing Eight Rows |
...
**The conceptual step.** Reaching eight rows honestly requires eight genuine moments, not four moments subdivided. Checking for duplicated content catches the shortcut.
...
**What depends on it.** Lesson 18 — Auditing Eight Rows — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Reaching eight rows honestly requires eight genuine moments, not four moments subdivided. Checking for duplicated content catches the shortcut.
...
1. Eight distinct moments with distinct inheritance.
2. A trace where rows seven and eight are marked faint.

### One non-example

Eight rows where rows three and four describe the same moment.
...
Whether the student can sustain a long honest chain.

### What this activity does not establish

Whether eight is a meaningful limit.
...
| Statement | Status |
|---|---|
| Reaching eight rows honestly requires eight genuine moments, not four moments subdivided. | Framework-derived, appropriate at this grade |
| Whether the student can sustain a long honest chain. | What this specific activity can show |
| Whether eight is a meaningful limit. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Long Chain Review — specifically: students consolidate long-chain work.

**How it was taught.** Through the activity: review with the term's longest traces compared for honest fading

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with the term's longest traces compared for honest fading, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Eight distinct moments with distinct inheritance. |
| **Non-example** | Eight rows where rows three and four describe the same moment. |
...
> "Next time: two chains that touch, and what that does."
...
**Exact wording.** "Say: eight rows. The inheritance has to hold all the way down."
...
**Target observation.** Whether the student can sustain a long honest chain.
...
> "Reaching eight rows honestly requires eight genuine moments, not four moments subdivided. You just saw that when say: eight rows.
> Last time we said: Next time: two chains that touch, and what that does. This is the next part of that.
...
**What students must not infer.** Whether eight is a meaningful limit.

### 4. Worked example

**The example.** Eight distinct moments with distinct inheritance.
...
**Completed answer.** Eight distinct moments with distinct inheritance. — which demonstrates whether the student can sustain a long honest chain.
...
**Conclusions not licensed.** Whether eight is a meaningful limit.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A trace where rows seven and eight are marked faint. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Eight rows where rows three and four describe the same moment. Why is this not an
example?"
...
**Exact student instructions.** An eight-row trace on one real episode.
...
- *Licensed conclusion.* Whether the student can sustain a long honest chain.
- *Not licensed.* Whether eight is a meaningful limit.
...
- *Expected response.* Whether the student can sustain a long honest chain.
...
1. Any wording carrying the idea in `Reaching eight rows honestly requires eight genuine moments, not four moments subdivided`.
...
Say: "Eight rows is a long way to carry something honestly."
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Long Chain Review |
| **Leads to** | Lesson 18 — Auditing Eight Rows |

**Transition in.** Lesson 16 established students consolidate long-chain work. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students produce an eight-row chain. Lesson 18 assumes it and builds students audit a long chain.
