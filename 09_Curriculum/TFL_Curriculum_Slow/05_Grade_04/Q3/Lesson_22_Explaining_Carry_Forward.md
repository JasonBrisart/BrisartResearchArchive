# Lesson 22 — Explaining Carry Forward

**Grade 4** · Carry Forward · **Quarter 3** · **40 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Explaining Carry Forward: students explain inheritance to somebody who was not there? |
| **Core concept** | Explaining carry-forward is harder than explaining the three parts, because the idea is about connection rather than content. |
| **Student outcome** | Students explain inheritance to somebody who was not there. |
| **Previous lesson** | Lesson 21 — The Chain With A Gap |
| **Next lesson** | Lesson 23 — The Audited Chain |
...
**The conceptual step.** Explaining carry-forward is harder than explaining the three parts, because the idea is about connection rather than content. The listener's question locates the gap.
...
**What depends on it.** Lesson 23 — The Audited Chain — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Explaining carry-forward is harder than explaining the three parts, because the idea is about connection rather than content. The listener's question locates the gap.
...
1. A listener asks where the very first moment came from.
2. A listener asks what happens during sleep.

### One non-example

Reporting that the listener understood immediately.
...
Where the student's grasp of inheritance runs out.
...
| Statement | Status |
|---|---|
| Explaining carry-forward is harder than explaining the three parts, because the idea is about connection rather than content. | Framework-derived, appropriate at this grade |
| Where the student's grasp of inheritance runs out. | What this specific activity can show |
| Whether the explanation was complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 21 — The Chain With A Gap — specifically: students handle a chain interrupted by sleep or absence.

**How it was taught.** Through the activity: a trace spanning an overnight gap, with the gap explicitly handled

**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: a trace spanning an overnight gap, with the gap explicitly handled, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A listener asks where the very first moment came from. |
| **Non-example** | Reporting that the listener understood immediately. |
...
> "A gap is not a break. Something still carried across it."
...
**Target observation.** Where the student's grasp of inheritance runs out.
...
> "Explaining carry-forward is harder than explaining the three parts, because the idea is about connection rather than content. You just saw that when say: today you teach it.
> Last time we said: A gap is not a break. Something still carried across it. This is the next part of that.
...
**What students must not infer.** Whether the explanation was complete.

### 4. Worked example

**The example.** A listener asks where the very first moment came from.
...
**Completed answer.** A listener asks where the very first moment came from. — which demonstrates where the student's grasp of inheritance runs out.
...
**Conclusions not licensed.** Whether the explanation was complete.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A listener asks what happens during sleep. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reporting that the listener understood immediately. Why is this not an
example?"
...
**Exact student instructions.** Explain carry-forward to a buddy; record one question they could not answer.
...
- *Licensed conclusion.* Where the student's grasp of inheritance runs out.
- *Not licensed.* Whether the explanation was complete.
...
- *Expected response.* Where the student's grasp of inheritance runs out.
...
1. Any wording carrying the idea in `Explaining carry-forward is harder than explaining the three parts, because the idea is about connection rather than content`.
...
| | |
|---|---|
| **Follows** | Lesson 21 — The Chain With A Gap |
| **Leads to** | Lesson 23 — The Audited Chain |

**Transition in.** Lesson 21 established students handle a chain interrupted by sleep or absence. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain inheritance to somebody who was not there. Lesson 23 assumes it and builds students produce, audit, and repair a chain in one session.
