...
| | |
|---|---|
| **Central question** | The Audited Chain: students produce, audit, and repair a chain in one session? |
| **Core concept** | The full cycle of produce, audit, and repair is the year's terminal skill. |
| **Student outcome** | Students produce, audit, and repair a chain in one session. |
| **Previous lesson** | Lesson 22 — Explaining Carry Forward |
| **Next lesson** | Lesson 24 — The Chain Review |
...
**The conceptual step.** The full cycle of produce, audit, and repair is the year's terminal skill. The repair step is the assessed one, so the earlier steps must be time-boxed.
...
**What depends on it.** Lesson 24 — The Chain Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The full cycle of produce, audit, and repair is the year's terminal skill. The repair step is the assessed one, so the earlier steps must be time-boxed.
...
1. A trace produced, audited, and repaired within one session.
2. A repair that cascades and resolves later rows.

### One non-example

A trace produced at length with no time left to repair.
...
Whether the final trace is accurate.
...
| Statement | Status |
|---|---|
| The full cycle of produce, audit, and repair is the year's terminal skill. | Framework-derived, appropriate at this grade |
| Whether the student can run the whole cycle. | What this specific activity can show |
| Whether the final trace is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — Explaining Carry Forward — specifically: students explain inheritance to somebody who was not there.

**How it was taught.** Through the activity: explain carry-forward to a buddy; record one question they could not answer

**Quick check.** Ask for the closing sentence of Lesson 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: explain carry-forward to a buddy; record one question they could not answer, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A trace produced, audited, and repaired within one session. |
| **Non-example** | A trace produced at length with no time left to repair. |
...
**Exact wording.** "Say: eight rows, audited by a partner, repaired by you. Today."
...
> "The full cycle of produce, audit, and repair is the year's terminal skill. You just saw that when say: eight rows, audited by a partner, repaired by you.
...
**What students must not infer.** Whether the final trace is accurate.

### 4. Worked example

**The example.** A trace produced, audited, and repaired within one session.
...
**Completed answer.** A trace produced, audited, and repaired within one session. — which demonstrates whether the student can run the whole cycle.
...
**Conclusions not licensed.** Whether the final trace is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A repair that cascades and resolves later rows. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A trace produced at length with no time left to repair. Why is this not an
example?"
...
**Exact student instructions.** Full cycle: produce, swap, audit, repair.
...
- *Not licensed.* Whether the final trace is accurate.
...
1. Any wording carrying the idea in `The full cycle of produce, audit, and repair is the year's terminal skill`.
...
Say: "You can follow a chain as far as it honestly goes."
...
| | |
|---|---|
| **Follows** | Lesson 22 — Explaining Carry Forward |
| **Leads to** | Lesson 24 — The Chain Review |

**Transition in.** Lesson 22 established students explain inheritance to somebody who was not there. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students produce, audit, and repair a chain in one session. Lesson 24 assumes it and builds students consolidate the quarter's chain work.
