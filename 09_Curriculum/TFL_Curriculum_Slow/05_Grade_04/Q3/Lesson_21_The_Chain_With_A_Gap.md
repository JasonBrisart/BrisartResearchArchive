# Lesson 21 — The Chain With A Gap
...
| | |
|---|---|
| **Central question** | The Chain With A Gap: students handle a chain interrupted by sleep or absence? |
| **Core concept** | An overnight gap is not a reset. |
| **Student outcome** | Students handle a chain interrupted by sleep or absence. |
| **Previous lesson** | Lesson 20 — Chains In Other Subjects |
| **Next lesson** | Lesson 22 — Explaining Carry Forward |
...
**The conceptual step.** An overnight gap is not a reset. Something carries across it, which is why the first thought of the day is rarely arbitrary.
...
**What depends on it.** Lesson 22 — Explaining Carry Forward — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An overnight gap is not a reset. Something carries across it, which is why the first thought of the day is rarely arbitrary.
...
1. A trace where the morning row inherits from the night before.
2. A student reporting what they woke up already holding.

### One non-example

A trace that restarts from nothing after the overnight gap.
...
That gaps do not reset the chain.

### What this activity does not establish

How much survives a gap.
...
| Statement | Status |
|---|---|
| An overnight gap is not a reset. | Framework-derived, appropriate at this grade |
| That gaps do not reset the chain. | What this specific activity can show |
| How much survives a gap. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — Chains In Other Subjects — specifically: students find carry-forward in non-TFL material.

**How it was taught.** Through the activity: a six-row inheritance trace on material from another subject

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: a six-row inheritance trace on material from another subject, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A trace where the morning row inherits from the night before. |
| **Non-example** | A trace that restarts from nothing after the overnight gap. |
...
> "The tool works on anything that happens in order."
...
**Exact wording.** "Ask what happens to the chain overnight."
...
**Target observation.** That gaps do not reset the chain.
...
> "An overnight gap is not a reset. You just saw that when ask what happens to the chain overnight.
> Last time we said: The tool works on anything that happens in order. This is the next part of that.
...
**What students must not infer.** How much survives a gap.

### 4. Worked example

**The example.** A trace where the morning row inherits from the night before.
...
**Completed answer.** A trace where the morning row inherits from the night before. — which demonstrates that gaps do not reset the chain.
...
**Conclusions not licensed.** How much survives a gap.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student reporting what they woke up already holding. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A trace that restarts from nothing after the overnight gap. Why is this not an
example?"
...
**Exact student instructions.** A trace spanning an overnight gap, with the gap explicitly handled.
...
- *Licensed conclusion.* That gaps do not reset the chain.
- *Not licensed.* How much survives a gap.
...
- *Expected response.* That gaps do not reset the chain.
...
1. Any wording carrying the idea in `An overnight gap is not a reset`.
...
Say: "A gap is not a break. Something still carried across it."
...
| | |
|---|---|
| **Follows** | Lesson 20 — Chains In Other Subjects |
| **Leads to** | Lesson 22 — Explaining Carry Forward |

**Transition in.** Lesson 20 established students find carry-forward in non-TFL material. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students handle a chain interrupted by sleep or absence. Lesson 22 assumes it and builds students explain inheritance to somebody who was not there.
