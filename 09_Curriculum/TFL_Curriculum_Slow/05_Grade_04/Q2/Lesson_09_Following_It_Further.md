...
| | |
|---|---|
| **Central question** | Following It Further: students extend a trace to six moments? |
| **Core concept** | Inheritance becomes harder to name as a chain lengthens. |
| **Student outcome** | Students extend a trace to six moments. |
| **Previous lesson** | Lesson 8 — The Carry Forward Review |
| **Next lesson** | Lesson 10 — Where The Chain Came From |
...
**The conceptual step.** Inheritance becomes harder to name as a chain lengthens. Marking a faint row is honest work; inventing content to fill it is not.
...
**What depends on it.** Lesson 10 — Where The Chain Came From — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Inheritance becomes harder to name as a chain lengthens. Marking a faint row is honest work; inventing content to fill it is not.
...
2. A student reporting the exact row where it became hard.

### One non-example

A six-row trace with invented inheritance in the later rows.
...
That long chains fade and the fading can be marked.

### What this activity does not establish

Where the fading begins for anybody else.
...
| Statement | Status |
|---|---|
| Inheritance becomes harder to name as a chain lengthens. | Framework-derived, appropriate at this grade |
| That long chains fade and the fading can be marked. | What this specific activity can show |
| Where the fading begins for anybody else. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Carry Forward Review — specifically: students consolidate the quarter's inheritance work.

**How it was taught.** Through the activity: review with six traces audited for inheritance only

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: review with six traces audited for inheritance only, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A six-row trace with invented inheritance in the later rows. |
...
> "Next time: following it further than four rows."
...
**Exact wording.** "Say: four was the warm-up, today six."
...
**Target observation.** That long chains fade and the fading can be marked.
...
> "Inheritance becomes harder to name as a chain lengthens. You just saw that when say: four was the warm-up, today six.
> Last time we said: Next time: following it further than four rows. This is the next part of that.
...
**What students must not infer.** Where the fading begins for anybody else.
...
**Completed answer.** A six-row trace with rows five and six marked faint. — which demonstrates that long chains fade and the fading can be marked.
...
**Conclusions not licensed.** Where the fading begins for anybody else.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student reporting the exact row where it became hard. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A six-row trace with invented inheritance in the later rows. Why is this not an
example?"
...
**Exact student instructions.** A six-row trace with any faint inheritance honestly marked.
...
- *Licensed conclusion.* That long chains fade and the fading can be marked.
- *Not licensed.* Where the fading begins for anybody else.
...
- *Expected response.* That long chains fade and the fading can be marked.
...
1. Any wording carrying the idea in `Inheritance becomes harder to name as a chain lengthens`.
...
Say: "Long chains get faint. Mark it rather than inventing it."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Carry Forward Review |
| **Leads to** | Lesson 10 — Where The Chain Came From |

**Transition in.** Lesson 8 established students consolidate the quarter's inheritance work. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students extend a trace to six moments. Lesson 10 assumes it and builds students extend a trace backwards past their first row.
