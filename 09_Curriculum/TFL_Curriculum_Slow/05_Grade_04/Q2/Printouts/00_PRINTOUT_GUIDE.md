...
|---|---|---|---|---|---|---|
| `Lesson_09_Printout.md` | Lesson 9 — Following It Further | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_10_Printout.md` | Lesson 10 — Where The Chain Came From | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 9 work |
| `Lesson_11_Printout.md` | Lesson 11 — Two Chains At Once | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 10 work |
| `Lesson_12_Printout.md` | Lesson 12 — Chains Across A Week | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 11 work |
| `Lesson_13_Printout.md` | Lesson 13 — Checking A Chain | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 12 work |
| `Lesson_14_Printout.md` | Lesson 14 — Repairing A Chain | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 13 work |
| `Lesson_15_Printout.md` | Lesson 15 — The Missing Moment | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 14 work |
| `Lesson_16_Printout.md` | Lesson 16 — The Long Chain Review | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 15 work |
...
**Lesson 13 — Checking A Chain.** If you only have time to print one
