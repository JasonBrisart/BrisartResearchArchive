# Lesson 12 — Chains Across A Week
...
| | |
|---|---|
| **Central question** | Chains Across A Week: students trace inheritance across a longer interval? |
| **Core concept** | Inheritance across a week is fainter but not absent. |
| **Student outcome** | Students trace inheritance across a longer interval. |
| **Previous lesson** | Lesson 11 — Two Chains At Once |
| **Next lesson** | Lesson 13 — Checking A Chain |
...
**The conceptual step.** Inheritance across a week is fainter but not absent. Anchoring on a salient event makes the longer chain traceable.
...
**What depends on it.** Lesson 13 — Checking A Chain — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Inheritance across a week is fainter but not absent. Anchoring on a salient event makes the longer chain traceable.
...
1. A Monday result still shaping Friday's expectation.
2. A change of routine carried across the whole week.

### One non-example

A claim that each day is entirely separate.
...
That inheritance operates across longer intervals.

### What this activity does not establish

How much survives over a week.
...
| Statement | Status |
|---|---|
| Inheritance across a week is fainter but not absent. | Framework-derived, appropriate at this grade |
| That inheritance operates across longer intervals. | What this specific activity can show |
| How much survives over a week. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 11 — Two Chains At Once — specifically: students trace two parallel episodes and find where they touch.

**How it was taught.** Through the activity: two parallel four-row traces with one interaction point marked

**Quick check.** Ask for the closing sentence of Lesson 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 11: two parallel four-row traces with one interaction point marked, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Monday result still shaping Friday's expectation. |
| **Non-example** | A claim that each day is entirely separate. |
...
> "Chains do not run in separate boxes."
...
**Exact wording.** "Ask whether anything from Monday still affects Friday."
...
**Target observation.** That inheritance operates across longer intervals.
...
> "Inheritance across a week is fainter but not absent. You just saw that when ask whether anything from Monday still affects Friday.
> Last time we said: Chains do not run in separate boxes. This is the next part of that.
...
**What students must not infer.** How much survives over a week.

### 4. Worked example

**The example.** A Monday result still shaping Friday's expectation.
...
**Completed answer.** A Monday result still shaping Friday's expectation. — which demonstrates that inheritance operates across longer intervals.
...
**Conclusions not licensed.** How much survives over a week.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A change of routine carried across the whole week. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that each day is entirely separate. Why is this not an
example?"
...
**Exact student instructions.** A five-point trace across one week with inheritance named at each point.
...
- *Licensed conclusion.* That inheritance operates across longer intervals.
- *Not licensed.* How much survives over a week.
...
- *Expected response.* That inheritance operates across longer intervals.
...
1. Any wording carrying the idea in `Inheritance across a week is fainter but not absent`.
...
Say: "It gets fainter over a week. It does not vanish."
...
| | |
|---|---|
| **Follows** | Lesson 11 — Two Chains At Once |
| **Leads to** | Lesson 13 — Checking A Chain |

**Transition in.** Lesson 11 established students trace two parallel episodes and find where they touch. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students trace inheritance across a longer interval. Lesson 13 assumes it and builds students audit somebody else's chain.
