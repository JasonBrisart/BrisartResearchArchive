# Lesson 16 — The Long Chain Review
...
| | |
|---|---|
| **Central question** | The Long Chain Review: students consolidate long-chain work? |
| **Core concept** | Honest marking must be scored as highly as long chains, or students will invent content to reach length. |
| **Student outcome** | Students consolidate long-chain work. |
| **Previous lesson** | Lesson 15 — The Missing Moment |
| **Next lesson** | Lesson 17 — The Eight Row Trace |
...
**The conceptual step.** Honest marking must be scored as highly as long chains, or students will invent content to reach length. The review makes the scoring visible.
...
**What depends on it.** Lesson 17 — The Eight Row Trace — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Honest marking must be scored as highly as long chains, or students will invent content to reach length. The review makes the scoring visible.
...
1. A short honest trace scored as highly as a long one.
2. A long trace with invented rows correctly identified.

### One non-example

Praising the longest trace without checking its later rows.
...
Whether honesty is valued over length.

### What this activity does not establish

How long a chain can honestly get.
...
| Statement | Status |
|---|---|
| Honest marking must be scored as highly as long chains, or students will invent content to reach length. | Framework-derived, appropriate at this grade |
| Whether honesty is valued over length. | What this specific activity can show |
| How long a chain can honestly get. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — The Missing Moment — specifically: students find breaks caused by a skipped moment.

**How it was taught.** Through the activity: six traces, each classified as missing inheritance or missing moment

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: six traces, each classified as missing inheritance or missing moment, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A short honest trace scored as highly as a long one. |
| **Non-example** | Praising the longest trace without checking its later rows. |
...
> "Sometimes nothing is wrong. Something is absent."
...
**Exact wording.** "Ask how far they can honestly follow one."
...
**Target observation.** Whether honesty is valued over length.
...
> "Honest marking must be scored as highly as long chains, or students will invent content to reach length. You just saw that when ask how far they can honestly follow one.
> Last time we said: Sometimes nothing is wrong. Something is absent. This is the next part of that.
...
**What students must not infer.** How long a chain can honestly get.

### 4. Worked example

**The example.** A short honest trace scored as highly as a long one.
...
**Completed answer.** A short honest trace scored as highly as a long one. — which demonstrates whether honesty is valued over length.
...
**Conclusions not licensed.** How long a chain can honestly get.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A long trace with invented rows correctly identified. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Praising the longest trace without checking its later rows. Why is this not an
example?"
...
**Exact student instructions.** Review with the term's longest traces compared for honest fading.
...
- *Licensed conclusion.* Whether honesty is valued over length.
- *Not licensed.* How long a chain can honestly get.
...
- *Expected response.* Whether honesty is valued over length.
...
1. Any wording carrying the idea in `Honest marking must be scored as highly as long chains, or students will invent content to reach length`.
...
Say: "Next time: two chains that touch, and what that does."
...
| | |
|---|---|
| **Follows** | Lesson 15 — The Missing Moment |
| **Leads to** | Lesson 17 — The Eight Row Trace |

**Transition in.** Lesson 15 established students find breaks caused by a skipped moment. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate long-chain work. Lesson 17 assumes it and builds students produce an eight-row chain.
