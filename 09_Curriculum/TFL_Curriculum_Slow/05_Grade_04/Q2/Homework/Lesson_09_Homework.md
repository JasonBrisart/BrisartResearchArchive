# Lesson 9 Homework — Following It Further

**Grade 4** · Carry Forward · **Quarter 2**
**Follows:** Lesson 9 — Following It Further · **Points:** 5 · **Optional:** yes
...
A six-row trace with any faint inheritance honestly marked.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has six rows with honest marking
...
Lesson 10 is **Where The Chain Came From**, which assumes you arrive holding it. Write one thing you expect it to be about:
