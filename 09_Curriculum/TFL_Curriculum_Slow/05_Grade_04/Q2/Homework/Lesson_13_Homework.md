# Lesson 13 Homework — Checking A Chain

**Grade 4** · Carry Forward · **Quarter 2**
**Follows:** Lesson 13 — Checking A Chain · **Points:** 5 · **Optional:** yes
...
Swap traces; mark the first broken row and what should have been there.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student receives an audited trace with a specific first break
...
Lesson 14 is **Repairing A Chain**, which assumes you arrive holding it. Write one thing you expect it to be about:
