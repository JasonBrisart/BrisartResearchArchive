# Lesson 10 Homework — Where The Chain Came From

**Grade 4** · Carry Forward · **Quarter 2**
**Follows:** Lesson 10 — Where The Chain Came From · **Points:** 5 · **Optional:** yes
...
Add two rows above the original first row, working backwards.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student extends a trace backwards by two rows
...
Lesson 11 is **Two Chains At Once**, which assumes you arrive holding it. Write one thing you expect it to be about:
