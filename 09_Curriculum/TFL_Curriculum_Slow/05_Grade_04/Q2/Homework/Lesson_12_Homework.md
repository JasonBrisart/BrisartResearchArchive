# Lesson 12 Homework — Chains Across A Week

**Grade 4** · Carry Forward · **Quarter 2**
**Follows:** Lesson 12 — Chains Across A Week · **Points:** 5 · **Optional:** yes
...
A five-point trace across one week with inheritance named at each point.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names inheritance across at least three points
...
Lesson 13 is **Checking A Chain**, which assumes you arrive holding it. Write one thing you expect it to be about:
