...
| **Core concept** | The four exit outcomes together constitute readiness for Grade 5, which asks why a working loop cannot be seen. |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 5, which asks why a working loop cannot be seen.
...
The four exit outcomes together constitute readiness for Grade 5, which asks why a working loop cannot be seen.
...
2. A student produces an eight-row trace with honest fading marked.

### One non-example

Eight well-written rows with no inheritance between them.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 5, which asks why a working loop cannot be seen. | Framework-derived, appropriate at this grade |
...
| **Non-example** | Eight well-written rows with no inheritance between them. |
...
> "The four exit outcomes together constitute readiness for Grade 5, which asks why a working loop cannot be seen. You just saw that when say: everything you know, on your own.
...
**Teacher prompt.** "Here is a second case. A student produces an eight-row trace with honest fading marked. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Eight well-written rows with no inheritance between them. Why is this not an
example?"
...
**Exact student instructions.** The final: an eight-row trace, honest fading, a backward extension, the loop redraw.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 5, which asks why a working loop cannot be seen`.
...
Say: "Next year: why a correct expectation is invisible."
