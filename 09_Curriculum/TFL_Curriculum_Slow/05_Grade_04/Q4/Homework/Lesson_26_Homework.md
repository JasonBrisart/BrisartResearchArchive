# Lesson 26 Homework — Joining And Leaving

**Grade 4** · Carry Forward · **Quarter 4**
**Follows:** Lesson 26 — Joining And Leaving · **Points:** 5 · **Optional:** yes
...
Estimate the true length of the chain their eight rows sampled.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student states that their trace sampled a longer chain
...
Lesson 27 is **Nothing Starts From Zero**, which assumes you arrive holding it. Write one thing you expect it to be about:
