# Lesson 25 Homework — The Loop Closes

**Grade 4** · Carry Forward · **Quarter 4**
**Follows:** Lesson 25 — The Loop Closes · **Points:** 5 · **Optional:** yes
...
Redraw their own trace as a loop with a written justification.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student redraws as a loop with a justification
...
Lesson 26 is **Joining And Leaving**, which assumes you arrive holding it. Write one thing you expect it to be about:
