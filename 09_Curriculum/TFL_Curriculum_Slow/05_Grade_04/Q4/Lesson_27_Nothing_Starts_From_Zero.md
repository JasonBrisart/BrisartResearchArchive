# Lesson 27 — Nothing Starts From Zero

**Grade 4** · Carry Forward · **Quarter 4** · **40 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Nothing Starts From Zero: students apply the principle to a case that feels like a fresh start? |
| **Core concept** | Events that feel like fresh starts are not. |
| **Student outcome** | Students apply the principle to a case that feels like a fresh start. |
| **Previous lesson** | Lesson 26 — Joining And Leaving |
| **Next lesson** | Lesson 28 — The Loop In One Sentence |
...
**The conceptual step.** Events that feel like fresh starts are not. Tracing backwards from the apparent start always finds something that was already being carried.
...
**What depends on it.** Lesson 28 — The Loop In One Sentence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Events that feel like fresh starts are not. Tracing backwards from the apparent start always finds something that was already being carried.
...
1. The first day of school, traced back to expectations formed beforehand.
2. A new school year, traced back to the previous summer.

### One non-example

Accepting that a birthday starts a genuinely fresh chain.
...
That apparent fresh starts have traceable antecedents.

### What this activity does not establish

Whether any true fresh start exists.
...
| Statement | Status |
|---|---|
| Events that feel like fresh starts are not. | Framework-derived, appropriate at this grade |
| That apparent fresh starts have traceable antecedents. | What this specific activity can show |
| Whether any true fresh start exists. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — Joining And Leaving — specifically: students recognise that a trace samples a continuing process.

**How it was taught.** Through the activity: estimate the true length of the chain their eight rows sampled

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: estimate the true length of the chain their eight rows sampled, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The first day of school, traced back to expectations formed beforehand. |
| **Non-example** | Accepting that a birthday starts a genuinely fresh chain. |
...
> "You sampled it. You did not capture it."
...
**Exact wording.** "Ask about the first day of school, which surely starts fresh."
...
**Target observation.** That apparent fresh starts have traceable antecedents.
...
> "Events that feel like fresh starts are not. You just saw that when ask about the first day of school, which surely starts fresh.
> Last time we said: You sampled it. You did not capture it. This is the next part of that.
...
**What students must not infer.** Whether any true fresh start exists.

### 4. Worked example

**The example.** The first day of school, traced back to expectations formed beforehand.
...
**Completed answer.** The first day of school, traced back to expectations formed beforehand. — which demonstrates that apparent fresh starts have traceable antecedents.
...
**Conclusions not licensed.** Whether any true fresh start exists.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A new school year, traced back to the previous summer. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Accepting that a birthday starts a genuinely fresh chain. Why is this not an
example?"
...
**Exact student instructions.** Three apparent fresh starts, each traced backwards to show inheritance.
...
- *Licensed conclusion.* That apparent fresh starts have traceable antecedents.
- *Not licensed.* Whether any true fresh start exists.
...
- *Expected response.* That apparent fresh starts have traceable antecedents.
...
1. Any wording carrying the idea in `Events that feel like fresh starts are not`.
...
Say: "Even the things that feel like starting over do not."
...
| | |
|---|---|
| **Follows** | Lesson 26 — Joining And Leaving |
| **Leads to** | Lesson 28 — The Loop In One Sentence |

**Transition in.** Lesson 26 established students recognise that a trace samples a continuing process. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students apply the principle to a case that feels like a fresh start. Lesson 28 assumes it and builds students state the year's idea in a single sentence.
