...
| | |
|---|---|
| **Central question** | The Loop Closes: students show the chain as a cycle rather than a line? |
| **Core concept** | A chain drawn as a line implies a beginning and an end. |
| **Student outcome** | Students show the chain as a cycle rather than a line. |
| **Previous lesson** | Lesson 24 — The Chain Review |
| **Next lesson** | Lesson 26 — Joining And Leaving |
...
**The conceptual step.** A chain drawn as a line implies a beginning and an end. Drawn as a loop, it shows that the student joined an ongoing process.
...
**What depends on it.** Lesson 26 — Joining And Leaving — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A chain drawn as a line implies a beginning and an end. Drawn as a loop, it shows that the student joined an ongoing process.
...
1. A loop drawn with the entry point marked as arbitrary.
2. A justification stating that row one also inherited something.

### One non-example

A loop drawn with a labelled starting point.
...
That the chain's shape is a loop, not a line.

### What this activity does not establish

Whether the loop ever began.
...
| Statement | Status |
|---|---|
| A chain drawn as a line implies a beginning and an end. | Framework-derived, appropriate at this grade |
| That the chain's shape is a loop, not a line. | What this specific activity can show |
| Whether the loop ever began. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 24 — The Chain Review — specifically: students consolidate the quarter's chain work.

**How it was taught.** Through the activity: review with eight traces audited and classified

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: review with eight traces audited and classified, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A loop drawn with the entry point marked as arbitrary. |
| **Non-example** | A loop drawn with a labelled starting point. |
...
> "Next time: the shape this has really been all along."
...
**Exact wording.** "Draw an eight-row trace as a straight line and ask whether that is the right shape."
...
**Target observation.** That the chain's shape is a loop, not a line.
...
> "A chain drawn as a line implies a beginning and an end. You just saw that when draw an eight-row trace as a straight line and ask whether that is the right shape.
> Last time we said: Next time: the shape this has really been all along. This is the next part of that.
...
**What students must not infer.** Whether the loop ever began.

### 4. Worked example

**The example.** A loop drawn with the entry point marked as arbitrary.
...
**Completed answer.** A loop drawn with the entry point marked as arbitrary. — which demonstrates that the chain's shape is a loop, not a line.
...
**Conclusions not licensed.** Whether the loop ever began.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A justification stating that row one also inherited something. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A loop drawn with a labelled starting point. Why is this not an
example?"
...
**Exact student instructions.** Redraw their own trace as a loop with a written justification.
...
- *Licensed conclusion.* That the chain's shape is a loop, not a line.
- *Not licensed.* Whether the loop ever began.
...
- *Expected response.* That the chain's shape is a loop, not a line.
...
1. Any wording carrying the idea in `A chain drawn as a line implies a beginning and an end`.
...
Say: "It is a loop you joined partway through."
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Chain Review |
| **Leads to** | Lesson 26 — Joining And Leaving |

**Transition in.** Lesson 24 established students consolidate the quarter's chain work. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students show the chain as a cycle rather than a line. Lesson 26 assumes it and builds students recognise that a trace samples a continuing process.
