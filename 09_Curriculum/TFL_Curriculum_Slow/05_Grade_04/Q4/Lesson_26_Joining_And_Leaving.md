...
| | |
|---|---|
| **Central question** | Joining And Leaving: students recognise that a trace samples a continuing process? |
| **Core concept** | A trace is a sample of a continuing process, not a complete record of it. |
| **Student outcome** | Students recognise that a trace samples a continuing process. |
| **Previous lesson** | Lesson 25 — The Loop Closes |
| **Next lesson** | Lesson 27 — Nothing Starts From Zero |
...
**The conceptual step.** A trace is a sample of a continuing process, not a complete record of it. Asking what happened between two rows makes the sampling visible.
...
**What depends on it.** Lesson 27 — Nothing Starts From Zero — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A trace is a sample of a continuing process, not a complete record of it. Asking what happened between two rows makes the sampling visible.
...
1. A student estimating hundreds of moments between their eight rows.
2. A student naming something that happened between two rows.

### One non-example

A claim that the eight rows captured the whole episode.
...
That traces sample rather than capture.

### What this activity does not establish

How many moments actually occurred.
...
| Statement | Status |
|---|---|
| A trace is a sample of a continuing process, not a complete record of it. | Framework-derived, appropriate at this grade |
| That traces sample rather than capture. | What this specific activity can show |
| How many moments actually occurred. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — The Loop Closes — specifically: students show the chain as a cycle rather than a line.

**How it was taught.** Through the activity: redraw their own trace as a loop with a written justification

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: redraw their own trace as a loop with a written justification, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student estimating hundreds of moments between their eight rows. |
| **Non-example** | A claim that the eight rows captured the whole episode. |
...
> "It is a loop you joined partway through."
...
**Exact wording.** "Ask how many moments the day had, given their trace has eight rows."
...
**Target observation.** That traces sample rather than capture.
...
> "A trace is a sample of a continuing process, not a complete record of it. You just saw that when ask how many moments the day had, given their trace has eight rows.
> Last time we said: It is a loop you joined partway through. This is the next part of that.
...
**What students must not infer.** How many moments actually occurred.

### 4. Worked example

**The example.** A student estimating hundreds of moments between their eight rows.
...
**Completed answer.** A student estimating hundreds of moments between their eight rows. — which demonstrates that traces sample rather than capture.
...
**Conclusions not licensed.** How many moments actually occurred.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student naming something that happened between two rows. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that the eight rows captured the whole episode. Why is this not an
example?"
...
**Exact student instructions.** Estimate the true length of the chain their eight rows sampled.
...
- *Licensed conclusion.* That traces sample rather than capture.
- *Not licensed.* How many moments actually occurred.
...
- *Expected response.* That traces sample rather than capture.
...
1. Any wording carrying the idea in `A trace is a sample of a continuing process, not a complete record of it`.
...
Say: "You sampled it. You did not capture it."
...
| | |
|---|---|
| **Follows** | Lesson 25 — The Loop Closes |
| **Leads to** | Lesson 27 — Nothing Starts From Zero |

**Transition in.** Lesson 25 established students show the chain as a cycle rather than a line. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students recognise that a trace samples a continuing process. Lesson 27 assumes it and builds students apply the principle to a case that feels like a fresh start.
