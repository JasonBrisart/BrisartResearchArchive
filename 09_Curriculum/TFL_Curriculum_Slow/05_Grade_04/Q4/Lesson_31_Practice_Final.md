...
| **Previous lesson** | Lesson 30 — The Year In Chains |
...
**The conceptual step.** The practice final locates gaps while there is time to close them. Self-marking turns the score into a review list.
...
The practice final locates gaps while there is time to close them. Self-marking turns the score into a review list.
...
1. A student identifying the backward extension as their weak point.
2. A student finding their inheritance entries are still generic.
...
**Prerequisite.** The content of Lesson 30 — The Year In Chains — specifically: students review the year using their own traces.

**How it was taught.** Through the activity: compare a Lesson 3 trace with a Lesson 23 trace and write what changed

**Quick check.** Ask for the closing sentence of Lesson 30. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 30: compare a Lesson 3 trace with a Lesson 23 trace and write what changed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student identifying the backward extension as their weak point. |
...
> "Next year: why you cannot see the loop when it is working."
...
> Last time we said: Next year: why you cannot see the loop when it is working. This is the next part of that.
...
**The example.** A student identifying the backward extension as their weak point.
...
**Completed answer.** A student identifying the backward extension as their weak point. — which demonstrates where each student is weakest.
...
**Teacher prompt.** "Here is a second case. A student finding their inheritance entries are still generic. Work it through with me."
...
| | |
|---|---|
| **Follows** | Lesson 30 — The Year In Chains |
| **Leads to** | Lesson 32 — Final Assessment |

**Transition in.** Lesson 30 established students review the year using their own traces. This lesson uses that as the starting point.
