# Lesson 28 — The Loop In One Sentence
...
| | |
|---|---|
| **Central question** | The Loop In One Sentence: students state the year's idea in a single sentence? |
| **Core concept** | Compressing the year into one sentence tests whether the student holds the idea or a set of procedures. |
| **Student outcome** | Students state the year's idea in a single sentence. |
| **Previous lesson** | Lesson 27 — Nothing Starts From Zero |
| **Next lesson** | Lesson 29 — Explaining The Loop |
...
**The conceptual step.** Compressing the year into one sentence tests whether the student holds the idea or a set of procedures. Lists joined by conjunctions fail the test.
...
**What depends on it.** Lesson 29 — Explaining The Loop — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Compressing the year into one sentence tests whether the student holds the idea or a set of procedures. Lists joined by conjunctions fail the test.
...
1. Each moment starts from what the one before handed it.
2. Nothing begins from nothing, so every moment inherits.

### One non-example

You notice, remember, expect, and then it happens again and again.
...
Whether the idea can be compressed to one statement.

### What this activity does not establish

Whether the statement is elegant.
...
| Statement | Status |
|---|---|
| Compressing the year into one sentence tests whether the student holds the idea or a set of procedures. | Framework-derived, appropriate at this grade |
| Whether the idea can be compressed to one statement. | What this specific activity can show |
| Whether the statement is elegant. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — Nothing Starts From Zero — specifically: students apply the principle to a case that feels like a fresh start.

**How it was taught.** Through the activity: three apparent fresh starts, each traced backwards to show inheritance

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: three apparent fresh starts, each traced backwards to show inheritance, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Each moment starts from what the one before handed it. |
| **Non-example** | You notice, remember, expect, and then it happens again and again. |
...
> "Even the things that feel like starting over do not."
...
**Exact wording.** "Say: one sentence. No lists."
...
**Target observation.** Whether the idea can be compressed to one statement.
...
> "Compressing the year into one sentence tests whether the student holds the idea or a set of procedures. You just saw that when say: one sentence.
> Last time we said: Even the things that feel like starting over do not. This is the next part of that.
...
**What students must not infer.** Whether the statement is elegant.

### 4. Worked example

**The example.** Each moment starts from what the one before handed it.
...
**Completed answer.** Each moment starts from what the one before handed it. — which demonstrates whether the idea can be compressed to one statement.
...
**Conclusions not licensed.** Whether the statement is elegant.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Nothing begins from nothing, so every moment inherits. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. You notice, remember, expect, and then it happens again and again. Why is this not an
example?"
...
**Exact student instructions.** Write, refine, and peer-check a one-sentence statement of carry-forward.
...
- *Licensed conclusion.* Whether the idea can be compressed to one statement.
- *Not licensed.* Whether the statement is elegant.
...
- *Expected response.* Whether the idea can be compressed to one statement.
...
1. Any wording carrying the idea in `Compressing the year into one sentence tests whether the student holds the idea or a set of procedures`.
...
Say: "If you can say it in one sentence, you have it."
...
| | |
|---|---|
| **Follows** | Lesson 27 — Nothing Starts From Zero |
| **Leads to** | Lesson 29 — Explaining The Loop |

**Transition in.** Lesson 27 established students apply the principle to a case that feels like a fresh start. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state the year's idea in a single sentence. Lesson 29 assumes it and builds students explain the closed loop to an adult.
