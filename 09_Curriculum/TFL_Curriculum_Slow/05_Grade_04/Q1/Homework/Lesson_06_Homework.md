# Lesson 6 Homework — Inheritance In A Day

**Grade 4** · Carry Forward · **Quarter 1**
**Follows:** Lesson 6 — Inheritance In A Day · **Points:** 5 · **Optional:** yes
...
A four-row trace across one school day with inheritance named at each step.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names specific inheritance at three steps
...
Lesson 7 is **The Broken Chain**, which assumes you arrive holding it. Write one thing you expect it to be about:
