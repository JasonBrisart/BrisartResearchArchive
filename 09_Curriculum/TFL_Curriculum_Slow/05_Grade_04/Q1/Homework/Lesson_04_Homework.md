# Lesson 4 Homework — The Chain

**Grade 4** · Carry Forward · **Quarter 1**
**Follows:** Lesson 4 — The Chain · **Points:** 5 · **Optional:** yes
...
Two rounds; the second with a student instructed to add something unrelated.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class can say even a wrong expectation came from somewhere
...
Lesson 5 is **Inheritance In A Story**, which assumes you arrive holding it. Write one thing you expect it to be about:
