# Lesson 8 — The Carry Forward Review
...
| | |
|---|---|
| **Central question** | The Carry Forward Review: students consolidate the quarter's inheritance work? |
| **Core concept** | Specific inheritance is the requirement. |
| **Student outcome** | Students consolidate the quarter's inheritance work. |
| **Previous lesson** | Lesson 7 — The Broken Chain |
| **Next lesson** | Lesson 9 — Following It Further |
...
**The conceptual step.** Specific inheritance is the requirement. The review tests whether generic entries are still being accepted when working quickly.
...
**What depends on it.** Lesson 9 — Following It Further — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Specific inheritance is the requirement. The review tests whether generic entries are still being accepted when working quickly.
...
1. A generic entry correctly rejected.
2. A specific entry correctly accepted.

### One non-example

Accepting the previous moment as an inheritance entry.
...
Whether the specificity requirement is secure.
...
| Statement | Status |
|---|---|
| Specific inheritance is the requirement. | Framework-derived, appropriate at this grade |
| Whether the specificity requirement is secure. | What this specific activity can show |
| Whether the traces are accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — The Broken Chain — specifically: students identify the impossible row in a defective trace.

**How it was taught.** Through the activity: check four supplied traces and mark the broken row in each

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: check four supplied traces and mark the broken row in each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A generic entry correctly rejected. |
| **Non-example** | Accepting the previous moment as an inheritance entry. |
...
> "A chain that starts from nothing is impossible, not just badly written."
...
**Exact wording.** "Ask what the inheritance column has to contain."
...
**Target observation.** Whether the specificity requirement is secure.
...
> "Specific inheritance is the requirement. You just saw that when ask what the inheritance column has to contain.
> Last time we said: A chain that starts from nothing is impossible, not just badly written. This is the next part of that.
...
**The example.** A generic entry correctly rejected.
...
**Completed answer.** A generic entry correctly rejected. — which demonstrates whether the specificity requirement is secure.
...
**Teacher prompt.** "Here is a second case. A specific entry correctly accepted. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Accepting the previous moment as an inheritance entry. Why is this not an
example?"
...
**Exact student instructions.** Review with six traces audited for inheritance only.
...
- *Licensed conclusion.* Whether the specificity requirement is secure.
...
- *Expected response.* Whether the specificity requirement is secure.
...
1. Any wording carrying the idea in `Specific inheritance is the requirement`.
...
Say: "Next time: following it further than four rows."
...
| | |
|---|---|
| **Follows** | Lesson 7 — The Broken Chain |
| **Leads to** | Lesson 9 — Following It Further |

**Transition in.** Lesson 7 established students identify the impossible row in a defective trace. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the quarter's inheritance work. Lesson 9 assumes it and builds students extend a trace to six moments.
