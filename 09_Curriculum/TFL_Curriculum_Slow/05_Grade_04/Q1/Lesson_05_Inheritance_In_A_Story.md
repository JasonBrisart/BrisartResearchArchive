# Lesson 5 — Inheritance In A Story
...
| | |
|---|---|
| **Central question** | Inheritance In A Story: students find carry-forward in a narrative text? |
| **Core concept** | Narrative depends on carry-forward, which is why a character's state in one scene constrains the next. |
| **Student outcome** | Students find carry-forward in a narrative text. |
| **Previous lesson** | Lesson 4 — The Chain |
| **Next lesson** | Lesson 6 — Inheritance In A Day |
...
**The conceptual step.** Narrative depends on carry-forward, which is why a character's state in one scene constrains the next. The method makes a familiar effect analysable.
...
**What depends on it.** Lesson 6 — Inheritance In A Day — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Narrative depends on carry-forward, which is why a character's state in one scene constrains the next. The method makes a familiar effect analysable.
...
1. A character's fear from scene one constraining scene two.
2. An unresolved question carried across a chapter break.

### One non-example

A plot summary offered instead of an inheritance trace.
...
That carry-forward is visible in written narrative.
...
| Statement | Status |
|---|---|
| Narrative depends on carry-forward, which is why a character's state in one scene constrains the next. | Framework-derived, appropriate at this grade |
| That carry-forward is visible in written narrative. | What this specific activity can show |
| What the author intended. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — The Chain — specifically: students physically demonstrate inheritance and feel its cost.

**How it was taught.** Through the activity: two rounds; the second with a student instructed to add something unrelated

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: two rounds; the second with a student instructed to add something unrelated, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A character's fear from scene one constraining scene two. |
| **Non-example** | A plot summary offered instead of an inheritance trace. |
...
> "Carrying forward is automatic. You noticed it because you did it on purpose."
...
**Exact wording.** "Read a passage where a character's state clearly carries between scenes."
...
**Target observation.** That carry-forward is visible in written narrative.
...
> "Narrative depends on carry-forward, which is why a character's state in one scene constrains the next. You just saw that when read a passage where a character's state clearly carries between scenes.
> Last time we said: Carrying forward is automatic. You noticed it because you did it on purpose. This is the next part of that.
...
**What students must not infer.** What the author intended.

### 4. Worked example

**The example.** A character's fear from scene one constraining scene two.
...
**Completed answer.** A character's fear from scene one constraining scene two. — which demonstrates that carry-forward is visible in written narrative.
...
**Conclusions not licensed.** What the author intended.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An unresolved question carried across a chapter break. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A plot summary offered instead of an inheritance trace. Why is this not an
example?"
...
**Exact student instructions.** Trace one character across four moments using the inheritance column.
...
- *Licensed conclusion.* That carry-forward is visible in written narrative.
- *Not licensed.* What the author intended.
...
- *Expected response.* That carry-forward is visible in written narrative.
...
1. Any wording carrying the idea in `Narrative depends on carry-forward, which is why a character's state in one scene constrains the next`.
...
Say: "Writers do this on purpose. Now you can see it."
...
| | |
|---|---|
| **Follows** | Lesson 4 — The Chain |
| **Leads to** | Lesson 6 — Inheritance In A Day |

**Transition in.** Lesson 4 established students physically demonstrate inheritance and feel its cost. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find carry-forward in a narrative text. Lesson 6 assumes it and builds students trace carry-forward across their own day.
