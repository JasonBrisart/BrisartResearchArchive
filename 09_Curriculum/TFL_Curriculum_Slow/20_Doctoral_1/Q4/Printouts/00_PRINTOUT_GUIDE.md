...
|---|---|---|---|---|---|---|
| `Seminar_13_Printout.md` | Seminar 13 — Rehearsing The Defence | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Seminar_14_Printout.md` | Seminar 14 — Revising The Audit | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 13 work |
| `Seminar_15_Printout.md` | Seminar 15 — Audit Review | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 14 work |
| `Seminar_16_Printout.md` | Seminar 16 — The Year In Findings | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 15 work |
...
**Seminar 15 — Audit Review.** If you only have time to print one
