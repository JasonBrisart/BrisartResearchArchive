# Seminar 14 — Revising The Audit

**Doctoral Year 1** · Specification Audit · **Quarter 4** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Revising The Audit: participants revise the audit against rehearsal feedback? |
| **Core concept** | A change log names the source of each revision, distinguishing a revision from a rewrite and allowing the reasoning to be audited. |
| **Student outcome** | Participants revise the audit against rehearsal feedback. |
| **Previous seminar** | Seminar 13 — Rehearsing The Defence |
| **Next seminar** | Seminar 15 — Audit Review |
...
**The conceptual step.** A change log names the source of each revision, distinguishing a revision from a rewrite and allowing the reasoning to be audited.
...
**What depends on it.** Seminar 15 — Audit Review — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A change log names the source of each revision, distinguishing a revision from a rewrite and allowing the reasoning to be audited.
...
1. A log entry naming the ranking challenger as the source.
2. A revision traced to a specific unanswered question.

### One non-example

A revised document with no record of what prompted the changes.
...
That audit revisions are sourceable.

### What this activity does not establish

Whether the revised audit is correct.
...
| Statement | Status |
|---|---|
| A change log names the source of each revision, distinguishing a revision from a rewrite and allowing the reasoning to be audited. | Framework-derived, appropriate at this grade |
| That audit revisions are sourceable. | What this specific activity can show |
| Whether the revised audit is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 13 — Rehearsing The Defence — specifically: participants rehearse the audit defence.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 13: full rehearsal with unanswered questions recorded, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A log entry naming the ranking challenger as the source. |
| **Non-example** | A revised document with no record of what prompted the changes. |
...
**Target observation.** That audit revisions are sourceable.
...
> "A change log names the source of each revision, distinguishing a revision from a rewrite and allowing the reasoning to be audited. You just saw that when say: every unanswered question becomes a revision.
...
**What students must not infer.** Whether the revised audit is correct.

### 4. Worked example

**The example.** A log entry naming the ranking challenger as the source.
...
**Completed answer.** A log entry naming the ranking challenger as the source. — which demonstrates that audit revisions are sourceable.
...
**Conclusions not licensed.** Whether the revised audit is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A revision traced to a specific unanswered question. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A revised document with no record of what prompted the changes. Why is this not an
example?"
...
**Exact student instructions.** Revise the document and log every change with its source.
...
- *Licensed conclusion.* That audit revisions are sourceable.
- *Not licensed.* Whether the revised audit is correct.
...
- *Expected response.* That audit revisions are sourceable.
...
1. Any wording carrying the idea in `A change log names the source of each revision, distinguishing a revision from a rewrite and allowing the reasoning to be audited`.
...
| | |
|---|---|
| **Follows** | Seminar 13 — Rehearsing The Defence |
| **Leads to** | Seminar 15 — Audit Review |

**Transition in.** Seminar 13 established participants rehearse the audit defence. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants revise the audit against rehearsal feedback. Seminar 15 assumes it and builds participants defend the audit and their field placement.
