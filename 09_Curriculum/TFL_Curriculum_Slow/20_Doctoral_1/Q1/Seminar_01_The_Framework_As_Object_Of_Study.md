# Seminar 1 — The Framework As Object Of Study
...
| | |
|---|---|
| **Central question** | The Framework As Object Of Study: participants establish the seminar's stance and its limits? |
| **Core concept** | The seminar treats the framework as an object of study rather than a doctrine to be learned or refuted. |
| **Student outcome** | Participants establish the seminar's stance and its limits. |
| **Previous seminar** | None. First seminar of the year. |
| **Next seminar** | Seminar 2 — Reading For Silence |
...
**The conceptual step.** The seminar treats the framework as an object of study rather than a doctrine to be learned or refuted. The defending role is assigned and rotated so nobody becomes its advocate by default.
...
**What depends on it.** Seminar 2 — Reading For Silence — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The seminar treats the framework as an object of study rather than a doctrine to be learned or refuted. The defending role is assigned and rotated so nobody becomes its advocate by default.
...
1. An objection that the threshold is unspecified in a load-bearing way.
2. An objection that the gating claim is unseparable from arousal.

### One non-example

An objection that the framework has not been validated.
...
That the seminar's stance is analytical rather than partisan.
...
| Statement | Status |
|---|---|
| The seminar treats the framework as an object of study rather than a doctrine to be learned or refuted. | Framework-derived, appropriate at this grade |
| That the seminar's stance is analytical rather than partisan. | What this specific activity can show |
| Whether the framework is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The participant reviews to journal structure and calibrates against others.
...
| **Correct example** | An objection that the threshold is unspecified in a load-bearing way. |
| **Non-example** | An objection that the framework has not been validated. |
...
**Exact wording.** "Deliver the disclosure unhedged, then state that the defending role is assigned and rotated."
...
**Target observation.** That the seminar's stance is analytical rather than partisan.
...
> "The seminar treats the framework as an object of study rather than a doctrine to be learned or refuted. You just saw that when deliver the disclosure unhedged, then state that the defending role is assigned and rotated.
...
**The example.** An objection that the threshold is unspecified in a load-bearing way.
...
**Completed answer.** An objection that the threshold is unspecified in a load-bearing way. — which demonstrates that the seminar's stance is analytical rather than partisan.
...
**Teacher prompt.** "Here is a second case. An objection that the gating claim is unseparable from arousal. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An objection that the framework has not been validated. Why is this not an
example?"
...
**Exact student instructions.** Each participant writes their strongest objection, specific enough to be addressed.
...
- *Licensed conclusion.* That the seminar's stance is analytical rather than partisan.
...
- *Expected response.* That the seminar's stance is analytical rather than partisan.
...
1. Any wording carrying the idea in `The seminar treats the framework as an object of study rather than a doctrine to be learned or refuted`.
...
Say: "Saying it is unvalidated is a status, not an objection."
...
| **Leads to** | Seminar 2 — Reading For Silence |

**Transition in.** This seminar opens the year.

**Transition out.** This seminar establishes participants establish the seminar's stance and its limits. Seminar 2 assumes it and builds participants locate claims the specification does not support.
