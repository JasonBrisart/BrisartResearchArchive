# Seminar 3 — Sorting The Gaps

**Doctoral Year 1** · Specification Audit · **Quarter 1** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Sorting The Gaps: participants classify absences into three categories? |
| **Core concept** | Absences sort into deliberate exclusions, acknowledged open questions, and undocumented gaps. |
| **Student outcome** | Participants classify absences into three categories. |
| **Previous seminar** | Seminar 2 — Reading For Silence |
| **Next seminar** | Seminar 4 — Ranking By What Rests On Them |
...
**The conceptual step.** Absences sort into deliberate exclusions, acknowledged open questions, and undocumented gaps. Only the third category constitutes an audit finding.
...
**What depends on it.** Seminar 4 — Ranking By What Rests On Them — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Absences sort into deliberate exclusions, acknowledged open questions, and undocumented gaps. Only the third category constitutes an audit finding.
...
1. An undocumented gap with its textual location recorded.
2. A scoped exclusion correctly classified after reading the text.

### One non-example

A deliberate exclusion recorded as an undocumented gap.
...
That absences are classifiable by textual evidence.

### What this activity does not establish

Whether the gaps are consequential.
...
| Statement | Status |
|---|---|
| Absences sort into deliberate exclusions, acknowledged open questions, and undocumented gaps. | Framework-derived, appropriate at this grade |
| That absences are classifiable by textual evidence. | What this specific activity can show |
| Whether the gaps are consequential. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 2 — Reading For Silence — specifically: participants locate claims the specification does not support.

**How it was taught.** Through the activity: pool the second list and consolidate it on the board

**Quick check.** Ask for the closing sentence of Seminar 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 2: pool the second list and consolidate it on the board, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An undocumented gap with its textual location recorded. |
| **Non-example** | A deliberate exclusion recorded as an undocumented gap. |
...
> "We are writing the audit document that does not yet exist."
...
**Exact wording.** "Put the three categories up, then sort the pooled list live."
...
**Target observation.** That absences are classifiable by textual evidence.
...
> "Absences sort into deliberate exclusions, acknowledged open questions, and undocumented gaps. You just saw that when put the three categories up, then sort the pooled list live.
> Last time we said: We are writing the audit document that does not yet exist. This is the next part of that.
...
**What students must not infer.** Whether the gaps are consequential.

### 4. Worked example

**The example.** An undocumented gap with its textual location recorded.
...
**Completed answer.** An undocumented gap with its textual location recorded. — which demonstrates that absences are classifiable by textual evidence.
...
**Conclusions not licensed.** Whether the gaps are consequential.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A scoped exclusion correctly classified after reading the text. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A deliberate exclusion recorded as an undocumented gap. Why is this not an
example?"
...
**Exact student instructions.** Draft formal audit entries for undocumented gaps with textual locations.
...
- *Licensed conclusion.* That absences are classifiable by textual evidence.
- *Not licensed.* Whether the gaps are consequential.
...
- *Expected response.* That absences are classifiable by textual evidence.
...
1. Any wording carrying the idea in `Absences sort into deliberate exclusions, acknowledged open questions, and undocumented gaps`.
...
Say: "Five undocumented gaps in one session is a substantial finding."
...
| | |
|---|---|
| **Follows** | Seminar 2 — Reading For Silence |
| **Leads to** | Seminar 4 — Ranking By What Rests On Them |

**Transition in.** Seminar 2 established participants locate claims the specification does not support. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants classify absences into three categories. Seminar 4 assumes it and builds participants determine which gaps are load-bearing.
