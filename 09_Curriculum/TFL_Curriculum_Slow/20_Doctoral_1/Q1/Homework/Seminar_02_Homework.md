# Seminar 2 Homework — Reading For Silence

**Doctoral Year 1** · Specification Audit · **Quarter 1**
**Follows:** Seminar 2 — Reading For Silence · **Points:** 5 · **Optional:** yes
...
Pool the second list and consolidate it on the board.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the pooled list contains at least five candidate gaps
...
Seminar 3 is **Sorting The Gaps**, which assumes you arrive holding it. Write one thing you expect it to be about:
