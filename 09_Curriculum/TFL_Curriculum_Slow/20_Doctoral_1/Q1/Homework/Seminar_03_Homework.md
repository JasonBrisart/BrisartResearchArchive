# Seminar 3 Homework — Sorting The Gaps

**Doctoral Year 1** · Specification Audit · **Quarter 1**
**Follows:** Seminar 3 — Sorting The Gaps · **Points:** 5 · **Optional:** yes
...
Draft formal audit entries for undocumented gaps with textual locations.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every entry carries a textual location
...
Seminar 4 is **Ranking By What Rests On Them**, which assumes you arrive holding it. Write one thing you expect it to be about:
