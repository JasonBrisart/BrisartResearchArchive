# Seminar 4 — Ranking By What Rests On Them
...
| | |
|---|---|
| **Central question** | Ranking By What Rests On Them: participants determine which gaps are load-bearing? |
| **Core concept** | Gaps are ranked by what depends on them, not by how interesting they are. |
| **Student outcome** | Participants determine which gaps are load-bearing. |
| **Previous seminar** | Seminar 3 — Sorting The Gaps |
| **Next seminar** | Seminar 5 — The Audit Document |
...
**The conceptual step.** Gaps are ranked by what depends on them, not by how interesting they are. A load-bearing gap blocks multiple downstream claims.
...
**What depends on it.** Seminar 5 — The Audit Document — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Gaps are ranked by what depends on them, not by how interesting they are. A load-bearing gap blocks multiple downstream claims.
...
1. A threshold gap ranked highest with three dependent claims named.
2. A peripheral gap ranked low with its limited dependency stated.

### One non-example

A gap ranked highly because it is unusual.
...
That gaps can be ranked by dependency.
...
| Statement | Status |
|---|---|
| Gaps are ranked by what depends on them, not by how interesting they are. | Framework-derived, appropriate at this grade |
| That gaps can be ranked by dependency. | What this specific activity can show |
| Whether the ranking is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 3 — Sorting The Gaps — specifically: participants classify absences into three categories.

**How it was taught.** Through the activity: draft formal audit entries for undocumented gaps with textual locations

**Quick check.** Ask for the closing sentence of Seminar 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 3: draft formal audit entries for undocumented gaps with textual locations, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A threshold gap ranked highest with three dependent claims named. |
| **Non-example** | A gap ranked highly because it is unusual. |
...
> "Five undocumented gaps in one session is a substantial finding."
...
**Exact wording.** "Assign two positions on whether the gaps are ordinary or asymmetric."
...
**Target observation.** That gaps can be ranked by dependency.
...
> "Gaps are ranked by what depends on them, not by how interesting they are. You just saw that when assign two positions on whether the gaps are ordinary or asymmetric.
> Last time we said: Five undocumented gaps in one session is a substantial finding. This is the next part of that.
...
**What students must not infer.** Whether the ranking is correct.

### 4. Worked example

**The example.** A threshold gap ranked highest with three dependent claims named.
...
**Completed answer.** A threshold gap ranked highest with three dependent claims named. — which demonstrates that gaps can be ranked by dependency.
...
**Conclusions not licensed.** Whether the ranking is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A peripheral gap ranked low with its limited dependency stated. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A gap ranked highly because it is unusual. Why is this not an
example?"
...
**Exact student instructions.** Rank the gaps by dependency and justify the top-ranked one.
...
- *Licensed conclusion.* That gaps can be ranked by dependency.
- *Not licensed.* Whether the ranking is correct.
...
- *Expected response.* That gaps can be ranked by dependency.
...
1. Any wording carrying the idea in `Gaps are ranked by what depends on them, not by how interesting they are`.
...
Say: "A gap in the load-bearing parameter differs from a peripheral one."
...
| | |
|---|---|
| **Follows** | Seminar 3 — Sorting The Gaps |
| **Leads to** | Seminar 5 — The Audit Document |

**Transition in.** Seminar 3 established participants classify absences into three categories. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants determine which gaps are load-bearing. Seminar 5 assumes it and builds participants produce a document another researcher could use.
