...
| | |
|---|---|
| **Central question** | Reading For Silence: participants locate claims the specification does not support? |
| **Core concept** | A specification audit begins by locating silences. |
| **Student outcome** | Participants locate claims the specification does not support. |
| **Previous seminar** | Seminar 1 — The Framework As Object Of Study |
| **Next seminar** | Seminar 3 — Sorting The Gaps |
...
**The conceptual step.** A specification audit begins by locating silences. The test for a candidate gap is whether the silence prevents somebody from testing a claim.
...
**What depends on it.** Seminar 3 — Sorting The Gaps — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A specification audit begins by locating silences. The test for a candidate gap is whether the silence prevents somebody from testing a claim.
...
1. A silence about how the threshold is set, which prevents testing.
2. A silence about parameter estimation procedures.

### One non-example

A complaint that the notation is inconsistent in places.
...
That silences can be located and triaged.

### What this activity does not establish

Whether the gaps are fatal.
...
| Statement | Status |
|---|---|
| A specification audit begins by locating silences. | Framework-derived, appropriate at this grade |
| That silences can be located and triaged. | What this specific activity can show |
| Whether the gaps are fatal. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 1 — The Framework As Object Of Study — specifically: participants establish the seminar's stance and its limits.

**How it was taught.** Through the activity: each participant writes their strongest objection, specific enough to be addressed

**Quick check.** Ask for the closing sentence of Seminar 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 1: each participant writes their strongest objection, specific enough to be addressed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A silence about how the threshold is set, which prevents testing. |
| **Non-example** | A complaint that the notation is inconsistent in places. |
...
> "Saying it is unvalidated is a status, not an objection."
...
**Exact wording.** "Work through the specification as a text, marking checkable and unchecked claims."
...
**Target observation.** That silences can be located and triaged.
...
> "A specification audit begins by locating silences. You just saw that when work through the specification as a text, marking checkable and unchecked claims.
> Last time we said: Saying it is unvalidated is a status, not an objection. This is the next part of that.
...
**What students must not infer.** Whether the gaps are fatal.

### 4. Worked example

**The example.** A silence about how the threshold is set, which prevents testing.
...
**Completed answer.** A silence about how the threshold is set, which prevents testing. — which demonstrates that silences can be located and triaged.
...
**Conclusions not licensed.** Whether the gaps are fatal.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A silence about parameter estimation procedures. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A complaint that the notation is inconsistent in places. Why is this not an
example?"
...
**Exact student instructions.** Pool the second list and consolidate it on the board.
...
- *Licensed conclusion.* That silences can be located and triaged.
- *Not licensed.* Whether the gaps are fatal.
...
- *Expected response.* That silences can be located and triaged.
...
1. Any wording carrying the idea in `A specification audit begins by locating silences`.
...
Say: "We are writing the audit document that does not yet exist."
...
| | |
|---|---|
| **Follows** | Seminar 1 — The Framework As Object Of Study |
| **Leads to** | Seminar 3 — Sorting The Gaps |

**Transition in.** Seminar 1 established participants establish the seminar's stance and its limits. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants locate claims the specification does not support. Seminar 3 assumes it and builds participants classify absences into three categories.
