# Seminar 12 Homework — The Gaps That Matter

**Doctoral Year 1** · Specification Audit · **Quarter 3**
**Follows:** Seminar 12 — The Gaps That Matter · **Points:** 5 · **Optional:** yes
...
Select and justify one gap, with a preliminary closure path.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every selection carries a preliminary closure path
...
Seminar 13 is **Rehearsing The Defence**, which assumes you arrive holding it. Write one thing you expect it to be about:
