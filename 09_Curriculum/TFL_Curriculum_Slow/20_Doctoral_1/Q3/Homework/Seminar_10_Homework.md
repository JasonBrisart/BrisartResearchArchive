# Seminar 10 Homework — Situating The Work

**Doctoral Year 1** · Specification Audit · **Quarter 3**
**Follows:** Seminar 10 — Situating The Work · **Points:** 5 · **Optional:** yes
...
Write the sentence Seminar 10 ended on, from memory:
...
A 1000-word situating statement with evidence for the placement.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every placement is supported by a divergence or coverage argument
...
Seminar 11 is **Defending The Placement**, which assumes you arrive holding it. Write one thing you expect it to be about:
