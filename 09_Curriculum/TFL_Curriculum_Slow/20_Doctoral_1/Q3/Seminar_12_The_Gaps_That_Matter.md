# Seminar 12 — The Gaps That Matter
...
| | |
|---|---|
| **Central question** | The Gaps That Matter: participants select the gap they will develop next year? |
| **Core concept** | A gap worth a year's work must have a preliminary closure path. |
| **Student outcome** | Participants select the gap they will develop next year. |
| **Previous seminar** | Seminar 11 — Defending The Placement |
| **Next seminar** | Seminar 13 — Rehearsing The Defence |
...
**The conceptual step.** A gap worth a year's work must have a preliminary closure path. A gap with no conceivable resolution is a complaint rather than a research target.
...
**What depends on it.** Seminar 13 — Rehearsing The Defence — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A gap worth a year's work must have a preliminary closure path. A gap with no conceivable resolution is a complaint rather than a research target.
...
1. A gap selected with a theoretical closure path.
2. A gap selected with an empirical closure path named.

### One non-example

A gap selected because it is the most damaging.
...
That selection requires a closure path.

### What this activity does not establish

Whether the gap can be closed.
...
| Statement | Status |
|---|---|
| A gap worth a year's work must have a preliminary closure path. | Framework-derived, appropriate at this grade |
| That selection requires a closure path. | What this specific activity can show |
| Whether the gap can be closed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 11 — Defending The Placement — specifically: participants defend a placement claim under challenge.

**How it was taught.** Through the activity: defend the placement against two written challenges

**Quick check.** Ask for the closing sentence of Seminar 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 11: defend the placement against two written challenges, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A gap selected with a theoretical closure path. |
| **Non-example** | A gap selected because it is the most damaging. |
...
> "A placement you cannot defend is a preference."
...
**Exact wording.** "Say: one gap. The one you would spend a year on."
...
**Target observation.** That selection requires a closure path.
...
> "A gap worth a year's work must have a preliminary closure path. You just saw that when say: one gap.
> Last time we said: A placement you cannot defend is a preference. This is the next part of that.
...
**What students must not infer.** Whether the gap can be closed.

### 4. Worked example

**The example.** A gap selected with a theoretical closure path.
...
**Completed answer.** A gap selected with a theoretical closure path. — which demonstrates that selection requires a closure path.
...
**Conclusions not licensed.** Whether the gap can be closed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A gap selected with an empirical closure path named. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A gap selected because it is the most damaging. Why is this not an
example?"
...
**Exact student instructions.** Select and justify one gap, with a preliminary closure path.
...
- *Licensed conclusion.* That selection requires a closure path.
- *Not licensed.* Whether the gap can be closed.
...
- *Expected response.* That selection requires a closure path.
...
1. Any wording carrying the idea in `A gap worth a year's work must have a preliminary closure path`.
...
Say: "That is next year's critique paper."
...
| | |
|---|---|
| **Follows** | Seminar 11 — Defending The Placement |
| **Leads to** | Seminar 13 — Rehearsing The Defence |

**Transition in.** Seminar 11 established participants defend a placement claim under challenge. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants select the gap they will develop next year. Seminar 13 assumes it and builds participants rehearse the audit defence.
