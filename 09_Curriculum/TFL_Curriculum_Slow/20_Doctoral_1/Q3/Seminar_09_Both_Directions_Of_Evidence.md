# Seminar 9 — Both Directions Of Evidence

**Doctoral Year 1** · Specification Audit · **Quarter 3** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Both Directions Of Evidence: participants state what would favour the rival? |
| **Core concept** | A differential table that can only produce framework-favouring evidence is advocacy. |
| **Student outcome** | Participants state what would favour the rival. |
| **Previous seminar** | Seminar 8 — The Redundancy Charge |
| **Next seminar** | Seminar 10 — Situating The Work |
...
**The conceptual step.** A differential table that can only produce framework-favouring evidence is advocacy. Every account requires a favouring observation.
...
**What depends on it.** Seminar 10 — Situating The Work — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A differential table that can only produce framework-favouring evidence is advocacy. Every account requires a favouring observation.
...
1. An observation stated that would favour the field rival.
2. A table with favouring observations in both directions.

### One non-example

A table specifying only framework-favouring outcomes.
...
That genuine adjudication runs in both directions.

### What this activity does not establish

Which account the evidence favours.
...
| Statement | Status |
|---|---|
| A differential table that can only produce framework-favouring evidence is advocacy. | Framework-derived, appropriate at this grade |
| That genuine adjudication runs in both directions. | What this specific activity can show |
| Which account the evidence favours. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 8 — The Redundancy Charge — specifically: participants assess whether the framework adds anything.

**How it was taught.** Through the activity: produce one differential prediction against a field-standard account

**Quick check.** Ask for the closing sentence of Seminar 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 8: produce one differential prediction against a field-standard account, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An observation stated that would favour the field rival. |
| **Non-example** | A table specifying only framework-favouring outcomes. |
...
**Target observation.** That genuine adjudication runs in both directions.
...
> "A differential table that can only produce framework-favouring evidence is advocacy. You just saw that when say: you said what would favour the framework.
...
**What students must not infer.** Which account the evidence favours.

### 4. Worked example

**The example.** An observation stated that would favour the field rival.
...
**Completed answer.** An observation stated that would favour the field rival. — which demonstrates that genuine adjudication runs in both directions.
...
**Conclusions not licensed.** Which account the evidence favours.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A table with favouring observations in both directions. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A table specifying only framework-favouring outcomes. Why is this not an
example?"
...
**Exact student instructions.** State one observation favouring each account over the others.
...
- *Licensed conclusion.* That genuine adjudication runs in both directions.
- *Not licensed.* Which account the evidence favours.
...
- *Expected response.* That genuine adjudication runs in both directions.
...
1. Any wording carrying the idea in `A differential table that can only produce framework-favouring evidence is advocacy`.
...
Say: "A table that can only favour one is advocacy with extra steps."
...
| | |
|---|---|
| **Follows** | Seminar 8 — The Redundancy Charge |
| **Leads to** | Seminar 10 — Situating The Work |

**Transition in.** Seminar 8 established participants assess whether the framework adds anything. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants state what would favour the rival. Seminar 10 assumes it and builds participants place the framework within their field's literature.
