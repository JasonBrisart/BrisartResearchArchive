# Seminar 8 Homework — The Redundancy Charge

**Doctoral Year 1** · Specification Audit · **Quarter 2**
**Follows:** Seminar 8 — The Redundancy Charge · **Points:** 5 · **Optional:** yes
...
Produce one differential prediction against a field-standard account.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every participant has a genuine differential prediction
...
Seminar 9 is **Both Directions Of Evidence**, which assumes you arrive holding it. Write one thing you expect it to be about:
