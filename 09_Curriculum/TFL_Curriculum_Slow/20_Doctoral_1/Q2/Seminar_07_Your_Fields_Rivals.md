...
| | |
|---|---|
| **Central question** | Your Field's Rivals: participants identify the real competing accounts in their literature? |
| **Core concept** | Real competition comes from the participant's own literature. |
| **Student outcome** | Participants identify the real competing accounts in their literature. |
| **Previous seminar** | Seminar 6 — Auditing The Audit |
| **Next seminar** | Seminar 8 — The Redundancy Charge |
...
**The conceptual step.** Real competition comes from the participant's own literature. Non-divergence means the accounts are identical, one is a special case, or one is underspecified.
...
**What depends on it.** Seminar 8 — The Redundancy Charge — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Real competition comes from the participant's own literature. Non-divergence means the accounts are identical, one is a special case, or one is underspecified.
...
1. A field rival with a divergence line that held under pressure.
2. A field account found to be a special case of the framework.
...
That the real competition is field-specific.
...
| Statement | Status |
|---|---|
| Real competition comes from the participant's own literature. | Framework-derived, appropriate at this grade |
| That the real competition is field-specific. | What this specific activity can show |
| Which account is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 6 — Auditing The Audit — specifically: participants check another audit for unsupported findings.

**How it was taught.** Through the activity: audit a colleague's document and mark every unsupported entry

**Quick check.** Ask for the closing sentence of Seminar 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 6: audit a colleague's document and mark every unsupported entry, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A field rival with a divergence line that held under pressure. |
...
> "An audit that survives this room is worth circulating."
...
**Target observation.** That the real competition is field-specific.
...
> "Real competition comes from the participant's own literature. You just saw that when say: the three are teaching rivals.
> Last time we said: An audit that survives this room is worth circulating. This is the next part of that.
...
**The example.** A field rival with a divergence line that held under pressure.
...
**Completed answer.** A field rival with a divergence line that held under pressure. — which demonstrates that the real competition is field-specific.
...
**Teacher prompt.** "Here is a second case. A field account found to be a special case of the framework. Work it through with me."
...
**Exact student instructions.** Present two field rivals with readings and divergence lines.
...
- *Licensed conclusion.* That the real competition is field-specific.
...
- *Expected response.* That the real competition is field-specific.
...
1. Any wording carrying the idea in `Real competition comes from the participant's own literature`.
...
| | |
|---|---|
| **Follows** | Seminar 6 — Auditing The Audit |
| **Leads to** | Seminar 8 — The Redundancy Charge |

**Transition in.** Seminar 6 established participants check another audit for unsupported findings. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants identify the real competing accounts in their literature. Seminar 8 assumes it and builds participants assess whether the framework adds anything.
