# Seminar 5 — The Audit Document

**Doctoral Year 1** · Specification Audit · **Quarter 2** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Audit Document: participants produce a document another researcher could use? |
| **Core concept** | An audit document is usable by another researcher only if every entry carries a checkable textual location. |
| **Student outcome** | Participants produce a document another researcher could use. |
| **Previous seminar** | Seminar 4 — Ranking By What Rests On Them |
| **Next seminar** | Seminar 6 — Auditing The Audit |
| **Materials** | The full specification, printed; two readings per meeting |
...
**The conceptual step.** An audit document is usable by another researcher only if every entry carries a checkable textual location. Paraphrased locations cannot be verified.

**Why students need it now.** This grade owns one idea: the audit document, and situating the framework in a real literature.
...
that every gap is fatal. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Every gap claim requires a textual location. An impression without a reference is not an audit finding.

**What depends on it.** Seminar 6 — Auditing The Audit — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An audit document is usable by another researcher only if every entry carries a checkable textual location. Paraphrased locations cannot be verified.

### How this is stated at this grade

Every gap claim requires a textual location. An impression without a reference is not an audit finding.

Use only the vocabulary released at or before this grade. Terms not yet available:
Referee reports on manuscripts, governance instruments.

### Why the concept matters

The whole grade rests on the audit document, and situating the framework in a real literature. If a student leaves this
...
1. An entry citing a specific section and sentence.
2. An entry peer-audited and confirmed against the text.

### One non-example

An entry citing the general area of the specification.
...
That audit documents can be made externally checkable.

### What this activity does not establish

Whether the findings are correct.
...
| Statement | Status |
|---|---|
| An audit document is usable by another researcher only if every entry carries a checkable textual location. | Framework-derived, appropriate at this grade |
| That audit documents can be made externally checkable. | What this specific activity can show |
| Whether the findings are correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 4 — Ranking By What Rests On Them — specifically: participants determine which gaps are load-bearing.

**How it was taught.** Through the activity: rank the gaps by dependency and justify the top-ranked one

**Quick check.** Ask for the closing sentence of Seminar 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 4: rank the gaps by dependency and justify the top-ranked one, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | a documented catalogue of what has not been said. |
| **Student wording** | A documented catalogue of what has not been said. |
| **Correct example** | An entry citing a specific section and sentence. |
| **Non-example** | An entry citing the general area of the specification. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a documented catalogue of what has not been said." |

### deliberate exclusion

| | |
|---|---|
| **Teacher definition** | a scoped absence the specification states. |
| **Student wording** | A scoped absence the specification states. |
| **Correct example** | An entry citing a specific section and sentence. |
| **Non-example** | An entry citing the general area of the specification. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a scoped absence the specification states." |

### acknowledged open

| | |
|---|---|
| **Teacher definition** | something the specification flags as undetermined. |
| **Student wording** | Something the specification flags as undetermined. |
| **Correct example** | An entry citing a specific section and sentence. |
| **Non-example** | An entry citing the general area of the specification. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for something the specification flags as undetermined." |


Do not introduce terminology from later grades. Referee reports on manuscripts, governance instruments.

## Materials and preparation

**Teacher materials.** The full specification, printed; Two readings per meeting; Index cards for the standing objection; Whiteboard.
...
> "A gap in the load-bearing parameter differs from a peripheral one."
...
**Exact wording.** "Say: the most transferable artifact in this year. Several of you will extend it."
...
**Target observation.** That audit documents can be made externally checkable.
...
> "An audit document is usable by another researcher only if every entry carries a checkable textual location. You just saw that when say: the most transferable artifact in this year.
> Last time we said: A gap in the load-bearing parameter differs from a peripheral one. This is the next part of that.
> It matters because a specification is judged as much by what it declines to say as by what it asserts"
...
**Terminology to introduce here.** specification audit, deliberate exclusion, acknowledged open.

**What students must not infer.** Whether the findings are correct.

### 4. Worked example

**The example.** An entry citing a specific section and sentence.
...
**Completed answer.** An entry citing a specific section and sentence. — which demonstrates that audit documents can be made externally checkable.
...
**Conclusions not licensed.** Whether the findings are correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An entry peer-audited and confirmed against the text. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An entry citing the general area of the specification. Why is this not an
example?"
...
**Exact student instructions.** Complete the document and peer-audit every entry for textual evidence.
...
- *Licensed conclusion.* That audit documents can be made externally checkable.
- *Not licensed.* Whether the findings are correct.
...
- *Expected response.* That audit documents can be made externally checkable.
...
3. **Misconception check.** Somebody says: "Every gap is fatal" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `An audit document is usable by another researcher only if every entry carries a checkable textual location`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Most of what you found is scoped exclusion.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "Without a location, a finding cannot be checked by anybody but you."
...
### 1. "Every gap is fatal"

**What the student says or does.** Every gap is fatal — usually while otherwise engaging well.

**Why it is understandable.** Finding an absence feels like finding an error.
...
**Exact correction.** Sort into three categories.

**Say this.** "Most of what you found is scoped exclusion."
...
### 2. "An impression counts as an audit finding"

**What the student says or does.** An impression counts as an audit finding — usually while otherwise engaging well.

**Why it is understandable.** The gap is real, so the reference feels unnecessary.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Require the textual location for every claim.

**Say this.** "Without it the finding cannot be checked by anybody else."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "My field has no account in this territory"

**What the student says or does.** My field has no account in this territory — usually while otherwise engaging well.

**Why it is understandable.** The student's literature uses different vocabulary.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Require two readings.

**Say this.** "If your field genuinely has nothing, that is itself a finding."
...
**Visual or physical support.** Provide one worked audit entry with its textual location.
...
Ask whether closing their strongest gap needs theory, data, or both.
...
Specifically, do not introduce: Referee reports on manuscripts, governance instruments.
...
| | |
|---|---|
| **Follows** | Seminar 4 — Ranking By What Rests On Them |
| **Leads to** | Seminar 6 — Auditing The Audit |

**Transition in.** Seminar 4 established participants determine which gaps are load-bearing. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants produce a document another researcher could use. Seminar 6 assumes it and builds participants check another audit for unsupported findings.
