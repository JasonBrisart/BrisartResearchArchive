# Lesson 29 — Explaining The Distinction
...
| | |
|---|---|
| **Central question** | Explaining The Distinction: students explain persistence versus accuracy to somebody else? |
| **Core concept** | Explaining the distinction requires both halves: intensity governs persistence, and persistence says nothing about accuracy. |
| **Student outcome** | Students explain persistence versus accuracy to somebody else. |
| **Previous lesson** | Lesson 28 — The Threshold Question |
| **Next lesson** | Lesson 30 — The Year In Data |
...
**The conceptual step.** Explaining the distinction requires both halves: intensity governs persistence, and persistence says nothing about accuracy. Dropping the second half is the usual failure.
...
**What depends on it.** Lesson 30 — The Year In Data — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Explaining the distinction requires both halves: intensity governs persistence, and persistence says nothing about accuracy. Dropping the second half is the usual failure.
...
1. An explanation stating both halves clearly.
2. A listener asking whether that means feelings are unreliable.

### One non-example

An explanation reducing to emotions make things memorable.
...
Whether both halves of the distinction are held.

### What this activity does not establish

Whether the explanation convinced anybody.
...
| Statement | Status |
|---|---|
| Explaining the distinction requires both halves: intensity governs persistence, and persistence says nothing about accuracy. | Framework-derived, appropriate at this grade |
| Whether both halves of the distinction are held. | What this specific activity can show |
| Whether the explanation convinced anybody. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — The Threshold Question — specifically: students confront what sets the threshold.

**How it was taught.** Through the activity: write what would have to be measured to answer it, and why nobody has

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: write what would have to be measured to answer it, and why nobody has, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An explanation stating both halves clearly. |
| **Non-example** | An explanation reducing to emotions make things memorable. |
...
> "That one is still open. You are allowed to know that."
...
**Exact wording.** "Say: today you teach the hardest idea in this course."
...
**Target observation.** Whether both halves of the distinction are held.
...
> "Explaining the distinction requires both halves: intensity governs persistence, and persistence says nothing about accuracy. You just saw that when say: today you teach the hardest idea in this course.
> Last time we said: That one is still open. You are allowed to know that. This is the next part of that.
...
**What students must not infer.** Whether the explanation convinced anybody.

### 4. Worked example

**The example.** An explanation stating both halves clearly.
...
**Completed answer.** An explanation stating both halves clearly. — which demonstrates whether both halves of the distinction are held.
...
**Conclusions not licensed.** Whether the explanation convinced anybody.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A listener asking whether that means feelings are unreliable. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An explanation reducing to emotions make things memorable. Why is this not an
example?"
...
- *Licensed conclusion.* Whether both halves of the distinction are held.
- *Not licensed.* Whether the explanation convinced anybody.
...
- *Expected response.* Whether both halves of the distinction are held.
...
1. Any wording carrying the idea in `Explaining the distinction requires both halves: intensity governs persistence, and persistence says nothing about accuracy`.
...
Say: "If they got it, you have it."
...
| | |
|---|---|
| **Follows** | Lesson 28 — The Threshold Question |
| **Leads to** | Lesson 30 — The Year In Data |

**Transition in.** Lesson 28 established students confront what sets the threshold. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain persistence versus accuracy to somebody else. Lesson 30 assumes it and builds students review the year through their own dataset.
