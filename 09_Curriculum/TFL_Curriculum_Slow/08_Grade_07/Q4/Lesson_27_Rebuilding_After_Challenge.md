# Lesson 27 — Rebuilding After Challenge
...
| | |
|---|---|
| **Central question** | Rebuilding After Challenge: students revise an argument after it was challenged? |
| **Core concept** | Revising after a good challenge is correct practice. |
| **Student outcome** | Students revise an argument after it was challenged. |
| **Previous lesson** | Lesson 26 — Defending The Argument |
| **Next lesson** | Lesson 28 — The Threshold Question |
...
**The conceptual step.** Revising after a good challenge is correct practice. Refusing to change anything usually means the challenges were not read rather than that they failed.
...
**What depends on it.** Lesson 28 — The Threshold Question — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Revising after a good challenge is correct practice. Refusing to change anything usually means the challenges were not read rather than that they failed.
...
1. A revision narrowing the claim after a sample-size challenge.
2. A revision adding the awkward case back in.

### One non-example

An argument returned unchanged with all challenges dismissed.
...
That arguments improve through challenge.

### What this activity does not establish

Whether the revised argument is correct.
...
| Statement | Status |
|---|---|
| Revising after a good challenge is correct practice. | Framework-derived, appropriate at this grade |
| That arguments improve through challenge. | What this specific activity can show |
| Whether the revised argument is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — Defending The Argument — specifically: students defend their argument against a classmate's challenge.

**How it was taught.** Through the activity: each student receives and answers three written challenges

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: each student receives and answers three written challenges, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A revision narrowing the claim after a sample-size challenge. |
| **Non-example** | An argument returned unchanged with all challenges dismissed. |
...
> "If it cannot survive this room, it will not survive anywhere."
...
**Exact wording.** "Ask which challenge landed and to rebuild that part."
...
**Target observation.** That arguments improve through challenge.
...
> "Revising after a good challenge is correct practice. You just saw that when ask which challenge landed and to rebuild that part.
> Last time we said: If it cannot survive this room, it will not survive anywhere. This is the next part of that.
...
**What students must not infer.** Whether the revised argument is correct.

### 4. Worked example

**The example.** A revision narrowing the claim after a sample-size challenge.
...
**Completed answer.** A revision narrowing the claim after a sample-size challenge. — which demonstrates that arguments improve through challenge.
...
**Conclusions not licensed.** Whether the revised argument is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A revision adding the awkward case back in. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An argument returned unchanged with all challenges dismissed. Why is this not an
example?"
...
**Exact student instructions.** Revise the argument and mark what changed and why.
...
- *Licensed conclusion.* That arguments improve through challenge.
- *Not licensed.* Whether the revised argument is correct.
...
- *Expected response.* That arguments improve through challenge.
...
1. Any wording carrying the idea in `Revising after a good challenge is correct practice`.
...
Say: "Changing it because somebody made a good point is correct."
...
| | |
|---|---|
| **Follows** | Lesson 26 — Defending The Argument |
| **Leads to** | Lesson 28 — The Threshold Question |

**Transition in.** Lesson 26 established students defend their argument against a classmate's challenge. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students revise an argument after it was challenged. Lesson 28 assumes it and builds students confront what sets the threshold.
