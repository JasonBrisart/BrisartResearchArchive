...
| **Core concept** | The practice final locates gaps while the log is still available for review. |
| **Student outcome** | Students rehearse the final under conditions. |
| **Previous lesson** | Lesson 30 — The Year In Data |
...
**The conceptual step.** The practice final locates gaps while the log is still available for review. Self-marking converts the score into a review list.
...
The practice final locates gaps while the log is still available for review. Self-marking converts the score into a review list.
...
1. A student identifying threshold direction as their weak point.
2. A student finding they cannot produce the four-box demonstration.
...
| Statement | Status |
|---|---|
| The practice final locates gaps while the log is still available for review. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 30 — The Year In Data — specifically: students review the year through their own dataset.

**How it was taught.** Through the activity: write a summary of the year's dataset including one surprise in it

**Quick check.** Ask for the closing sentence of Lesson 30. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 30: write a summary of the year's dataset including one surprise in it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student identifying threshold direction as their weak point. |
...
> "You collected that. Nobody handed it to you."
...
> "The practice final locates gaps while the log is still available for review. You just saw that when say: same as the real one.
> Last time we said: You collected that. Nobody handed it to you. This is the next part of that.
...
**The example.** A student identifying threshold direction as their weak point.
...
**Completed answer.** A student identifying threshold direction as their weak point. — which demonstrates where each student is weakest.
...
**Teacher prompt.** "Here is a second case. A student finding they cannot produce the four-box demonstration. Work it through with me."
...
1. Any wording carrying the idea in `The practice final locates gaps while the log is still available for review`.
...
| | |
|---|---|
| **Follows** | Lesson 30 — The Year In Data |
| **Leads to** | Lesson 32 — Final Assessment |

**Transition in.** Lesson 30 established students review the year through their own dataset. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students rehearse the final under conditions. Lesson 32 assumes it and builds students demonstrate the year's outcomes.
