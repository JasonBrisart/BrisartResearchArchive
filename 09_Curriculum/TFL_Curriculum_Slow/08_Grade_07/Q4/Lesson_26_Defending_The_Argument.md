# Lesson 26 — Defending The Argument
...
| | |
|---|---|
| **Central question** | Defending The Argument: students defend their argument against a classmate's challenge? |
| **Core concept** | A defence engages with the specific challenge rather than restating the original claim. |
| **Student outcome** | Students defend their argument against a classmate's challenge. |
| **Previous lesson** | Lesson 25 — The Whole Distinction |
| **Next lesson** | Lesson 27 — Rebuilding After Challenge |
...
**The conceptual step.** A defence engages with the specific challenge rather than restating the original claim. Restatement is the commonest evasion.
...
**What depends on it.** Lesson 27 — Rebuilding After Challenge — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A defence engages with the specific challenge rather than restating the original claim. Restatement is the commonest evasion.
...
1. A defence answering the challenge about sample size.
2. A defence conceding a point and narrowing the claim.

### One non-example

A defence that repeats the original argument more firmly.
...
Whether the student can engage with specific challenges.
...
| Statement | Status |
|---|---|
| A defence engages with the specific challenge rather than restating the original claim. | Framework-derived, appropriate at this grade |
| Whether the student can engage with specific challenges. | What this specific activity can show |
| Whether the argument survives. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — The Whole Distinction — specifically: students present a data-backed argument for the central claim.

**How it was taught.** Through the activity: a five-part written argument with one part read aloud

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: a five-part written argument with one part read aloud, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence answering the challenge about sample size. |
| **Non-example** | A defence that repeats the original argument more firmly. |
...
> "Next year: what contradiction actually does, and why the framework refuses to explain everything."
...
**Exact wording.** "Say: swap arguments. Find the weakest part and attack it."
...
**Target observation.** Whether the student can engage with specific challenges.
...
> "A defence engages with the specific challenge rather than restating the original claim. You just saw that when say: swap arguments.
> Last time we said: Next year: what contradiction actually does, and why the framework refuses to explain everything. This is the next part of that.
...
**What students must not infer.** Whether the argument survives.

### 4. Worked example

**The example.** A defence answering the challenge about sample size.
...
**Completed answer.** A defence answering the challenge about sample size. — which demonstrates whether the student can engage with specific challenges.
...
**Conclusions not licensed.** Whether the argument survives.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A defence conceding a point and narrowing the claim. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence that repeats the original argument more firmly. Why is this not an
example?"
...
**Exact student instructions.** Each student receives and answers three written challenges.
...
- *Licensed conclusion.* Whether the student can engage with specific challenges.
- *Not licensed.* Whether the argument survives.
...
- *Expected response.* Whether the student can engage with specific challenges.
...
1. Any wording carrying the idea in `A defence engages with the specific challenge rather than restating the original claim`.
...
Say: "If it cannot survive this room, it will not survive anywhere."
...
| | |
|---|---|
| **Follows** | Lesson 25 — The Whole Distinction |
| **Leads to** | Lesson 27 — Rebuilding After Challenge |

**Transition in.** Lesson 25 established students present a data-backed argument for the central claim. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students defend their argument against a classmate's challenge. Lesson 27 assumes it and builds students revise an argument after it was challenged.
