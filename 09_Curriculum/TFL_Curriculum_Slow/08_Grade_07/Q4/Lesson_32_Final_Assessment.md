...
| **Core concept** | The four exit outcomes together constitute readiness for Grade 8. |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 8. The four-box demonstration requires the log, which is why it is required equipment.
...
The four exit outcomes together constitute readiness for Grade 8. The four-box demonstration requires the log, which is why it is required equipment.
...
1. A student completes all four items with the log present.
2. A student demonstrating the distinction from their own data.

### One non-example

A student without the log, unable to complete the demonstration.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 8. | Framework-derived, appropriate at this grade |
...
| **Correct example** | A student completes all four items with the log present. |
| **Non-example** | A student without the log, unable to complete the demonstration. |
...
**Exact wording.** "Say: everything you know, on your own. Bring your log."
...
> "The four exit outcomes together constitute readiness for Grade 8. You just saw that when say: everything you know, on your own.
...
**The example.** A student completes all four items with the log present.
...
**Completed answer.** A student completes all four items with the log present. — which demonstrates whether all four exit outcomes are present.
...
**Teacher prompt.** "Here is a second case. A student demonstrating the distinction from their own data. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student without the log, unable to complete the demonstration. Why is this not an
example?"
...
**Exact student instructions.** The final: the persistence condition, threshold direction, the four-box demonstration, a disconfirmer.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 8`.
...
Say: "Next year: recurrence, belief, and the limits of your own measurements."
