# Lesson 28 — The Threshold Question
...
| | |
|---|---|
| **Central question** | The Threshold Question: students confront what sets the threshold? |
| **Core concept** | What sets the persistence threshold is genuinely unknown. |
| **Student outcome** | Students confront what sets the threshold. |
| **Previous lesson** | Lesson 27 — Rebuilding After Challenge |
| **Next lesson** | Lesson 29 — Explaining The Distinction |
...
**The conceptual step.** What sets the persistence threshold is genuinely unknown. Naming an open question as open is more valuable than supplying a confident invented answer.
...
**What depends on it.** Lesson 29 — Explaining The Distinction — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

What sets the persistence threshold is genuinely unknown. Naming an open question as open is more valuable than supplying a confident invented answer.
...
1. A statement of what would have to be measured to find out.
2. A student recognising the question as open rather than difficult.

### One non-example

A confident invented answer about how the threshold is set.
...
That some framework questions are genuinely open.
...
| Statement | Status |
|---|---|
| What sets the persistence threshold is genuinely unknown. | Framework-derived, appropriate at this grade |
| That some framework questions are genuinely open. | What this specific activity can show |
| The answer. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — Rebuilding After Challenge — specifically: students revise an argument after it was challenged.

**How it was taught.** Through the activity: revise the argument and mark what changed and why

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: revise the argument and mark what changed and why, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A statement of what would have to be measured to find out. |
| **Non-example** | A confident invented answer about how the threshold is set. |
...
> "Changing it because somebody made a good point is correct."
...
**Exact wording.** "Ask what decides where theta sits and who has an answer."
...
**Target observation.** That some framework questions are genuinely open.
...
> "What sets the persistence threshold is genuinely unknown. You just saw that when ask what decides where theta sits and who has an answer.
> Last time we said: Changing it because somebody made a good point is correct. This is the next part of that.
...
**What students must not infer.** The answer.

### 4. Worked example

**The example.** A statement of what would have to be measured to find out.
...
**Completed answer.** A statement of what would have to be measured to find out. — which demonstrates that some framework questions are genuinely open.
...
**Conclusions not licensed.** The answer.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student recognising the question as open rather than difficult. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A confident invented answer about how the threshold is set. Why is this not an
example?"
...
**Exact student instructions.** Write what would have to be measured to answer it, and why nobody has.
...
- *Licensed conclusion.* That some framework questions are genuinely open.
- *Not licensed.* The answer.
...
- *Expected response.* That some framework questions are genuinely open.
...
1. Any wording carrying the idea in `What sets the persistence threshold is genuinely unknown`.
...
Say: "That one is still open. You are allowed to know that."
...
| | |
|---|---|
| **Follows** | Lesson 27 — Rebuilding After Challenge |
| **Leads to** | Lesson 29 — Explaining The Distinction |

**Transition in.** Lesson 27 established students revise an argument after it was challenged. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students confront what sets the threshold. Lesson 29 assumes it and builds students explain persistence versus accuracy to somebody else.
