# Lesson 18 Homework — Counting The Breaks

**Grade 7** · Persistence Is Not Accuracy · **Quarter 3**
**Follows:** Lesson 18 — Counting The Breaks · **Points:** 5 · **Optional:** yes
...
A three-break trial in pairs with class numbers pooled and compared to predictions.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student compares the pooled number with their prediction
...
Lesson 19 is **When My Data Disagrees**, which assumes you arrive holding it. Write one thing you expect it to be about:
