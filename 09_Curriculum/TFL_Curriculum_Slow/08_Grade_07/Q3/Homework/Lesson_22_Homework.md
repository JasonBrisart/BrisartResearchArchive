# Lesson 22 Homework — Presenting Your Data

**Grade 7** · Persistence Is Not Accuracy · **Quarter 3**
**Follows:** Lesson 22 — Presenting Your Data · **Points:** 5 · **Optional:** yes
...
A three-minute presentation with the matrix, the finding, and the disconfirmer.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student presents all three elements
...
Lesson 23 is **Is That What This Is For**, which assumes you arrive holding it. Write one thing you expect it to be about:
