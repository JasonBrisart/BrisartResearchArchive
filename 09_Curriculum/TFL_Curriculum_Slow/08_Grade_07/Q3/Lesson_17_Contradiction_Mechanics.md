# Lesson 17 — Contradiction Mechanics
...
| | |
|---|---|
| **Central question** | Contradiction Mechanics: students record the drop and recovery across a broken pattern? |
| **Core concept** | The drop and recovery is a mechanical pattern, not a character trait. |
| **Student outcome** | Students record the drop and recovery across a broken pattern. |
| **Previous lesson** | Lesson 16 — The Distinction Review |
| **Next lesson** | Lesson 18 — Counting The Breaks |
...
**The conceptual step.** The drop and recovery is a mechanical pattern, not a character trait. Describing it as stubbornness imports agency the framework does not claim.
...
**What depends on it.** Lesson 18 — Counting The Breaks — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The drop and recovery is a mechanical pattern, not a character trait. Describing it as stubbornness imports agency the framework does not claim.
...
1. A plot showing the drop at card six and recovery by seven.
2. A description in terms of suppression and re-entry.

### One non-example

A description of the class as stubborn or slow to learn.
...
That contradiction produces a measurable drop and recovery.

### What this activity does not establish

Why the recovery occurs.
...
| Statement | Status |
|---|---|
| The drop and recovery is a mechanical pattern, not a character trait. | Framework-derived, appropriate at this grade |
| That contradiction produces a measurable drop and recovery. | What this specific activity can show |
| Why the recovery occurs. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Distinction Review — specifically: students consolidate the central distinction.

**How it was taught.** Through the activity: review with eight claims marked as confusing or respecting the distinction

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with eight claims marked as confusing or respecting the distinction, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A plot showing the drop at card six and recovery by seven. |
| **Non-example** | A description of the class as stubborn or slow to learn. |
...
> "Next time: what contradiction does to a simulation."
...
**Exact wording.** "Run a nine-card trial with written expectations before each card, percentages recorded."
...
**Target observation.** That contradiction produces a measurable drop and recovery.
...
> "The drop and recovery is a mechanical pattern, not a character trait. You just saw that when run a nine-card trial with written expectations before each card, percentages recorded.
> Last time we said: Next time: what contradiction does to a simulation. This is the next part of that.
...
**What students must not infer.** Why the recovery occurs.

### 4. Worked example

**The example.** A plot showing the drop at card six and recovery by seven.
...
**Completed answer.** A plot showing the drop at card six and recovery by seven. — which demonstrates that contradiction produces a measurable drop and recovery.
...
**Conclusions not licensed.** Why the recovery occurs.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A description in terms of suppression and re-entry. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A description of the class as stubborn or slow to learn. Why is this not an
example?"
...
**Exact student instructions.** Plot the class percentages and write what the recovery shows.
...
- *Licensed conclusion.* That contradiction produces a measurable drop and recovery.
- *Not licensed.* Why the recovery occurs.
...
- *Expected response.* That contradiction produces a measurable drop and recovery.
...
1. Any wording carrying the idea in `The drop and recovery is a mechanical pattern, not a character trait`.
...
Say: "Revision. Suppression. Not deletion."
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Distinction Review |
| **Leads to** | Lesson 18 — Counting The Breaks |

**Transition in.** Lesson 16 established students consolidate the central distinction. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students record the drop and recovery across a broken pattern. Lesson 18 assumes it and builds students measure how many contradictions produce durable change.
