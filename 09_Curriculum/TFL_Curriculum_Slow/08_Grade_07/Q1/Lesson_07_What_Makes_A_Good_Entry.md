# Lesson 7 — What Makes A Good Entry
...
| | |
|---|---|
| **Central question** | What Makes A Good Entry: students distinguish strong from weak log entries? |
| **Core concept** | Entry quality is about checkability and timing, not about how interesting the prediction is. |
| **Student outcome** | Students distinguish strong from weak log entries. |
| **Previous lesson** | Lesson 6 — Intensity At The Time |
| **Next lesson** | Lesson 8 — The Log Review |
...
**The conceptual step.** Entry quality is about checkability and timing, not about how interesting the prediction is. Ranking forces the criterion to be applied repeatedly.
...
**What depends on it.** Lesson 8 — The Log Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Entry quality is about checkability and timing, not about how interesting the prediction is. Ranking forces the criterion to be applied repeatedly.
...
1. A checkable timestamped entry ranked highest.
2. An unfalsifiable entry ranked lowest.

### One non-example

An entry ranked highly because the prediction was dramatic.
...
That entry quality has stateable criteria.

### What this activity does not establish

Whether the top-ranked prediction is accurate.
...
| Statement | Status |
|---|---|
| Entry quality is about checkability and timing, not about how interesting the prediction is. | Framework-derived, appropriate at this grade |
| That entry quality has stateable criteria. | What this specific activity can show |
| Whether the top-ranked prediction is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — Intensity At The Time — specifically: students rate intensity at the moment of prediction, not after.

**How it was taught.** Through the activity: add four entries with intensity rated at writing and timestamped

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: add four entries with intensity rated at writing and timestamped, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A checkable timestamped entry ranked highest. |
| **Non-example** | An entry ranked highly because the prediction was dramatic. |
...
> "Rated afterwards, it is contaminated by knowing the outcome."
...
**Exact wording.** "Put two entries on the board, one checkable and one not."
...
**Target observation.** That entry quality has stateable criteria.
...
> "Entry quality is about checkability and timing, not about how interesting the prediction is. You just saw that when put two entries on the board, one checkable and one not.
> Last time we said: Rated afterwards, it is contaminated by knowing the outcome. This is the next part of that.
...
**What students must not infer.** Whether the top-ranked prediction is accurate.

### 4. Worked example

**The example.** A checkable timestamped entry ranked highest.
...
**Completed answer.** A checkable timestamped entry ranked highest. — which demonstrates that entry quality has stateable criteria.
...
**Conclusions not licensed.** Whether the top-ranked prediction is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An unfalsifiable entry ranked lowest. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An entry ranked highly because the prediction was dramatic. Why is this not an
example?"
...
**Exact student instructions.** Rank eight entries by quality and justify the top and bottom.
...
- *Licensed conclusion.* That entry quality has stateable criteria.
- *Not licensed.* Whether the top-ranked prediction is accurate.
...
- *Expected response.* That entry quality has stateable criteria.
...
1. Any wording carrying the idea in `Entry quality is about checkability and timing, not about how interesting the prediction is`.
...
Say: "Now you know what you are aiming for."
...
| | |
|---|---|
| **Follows** | Lesson 6 — Intensity At The Time |
| **Leads to** | Lesson 8 — The Log Review |

**Transition in.** Lesson 6 established students rate intensity at the moment of prediction, not after. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students distinguish strong from weak log entries. Lesson 8 assumes it and builds students consolidate logging practice.
