# Lesson 5 — Logging Properly

**Grade 7** · Persistence Is Not Accuracy · **Quarter 1** · **45 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Logging Properly: students improve their log entries against the four rules? |
| **Core concept** | A usable log entry names a specific outcome, is written before that outcome, carries an intensity rating made at the time, and is checkable by somebody else. |
| **Student outcome** | Students improve their log entries against the four rules. |
| **Previous lesson** | Lesson 4 — Below The Threshold |
| **Next lesson** | Lesson 6 — Intensity At The Time |
...
**The conceptual step.** A usable log entry names a specific outcome, is written before that outcome, carries an intensity rating made at the time, and is checkable by somebody else.
...
**What depends on it.** Lesson 6 — Intensity At The Time — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A usable log entry names a specific outcome, is written before that outcome, carries an intensity rating made at the time, and is checkable by somebody else.
...
1. An entry naming a specific checkable outcome.
2. An entry rewritten after failing the third-party test.

### One non-example

An entry predicting that things will go fine.
...
That log quality can be audited against stated rules.
...
| Statement | Status |
|---|---|
| A usable log entry names a specific outcome, is written before that outcome, carries an intensity rating made at the time, and is checkable by somebody else. | Framework-derived, appropriate at this grade |
| That log quality can be audited against stated rules. | What this specific activity can show |
| Whether the predictions are accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — Below The Threshold — specifically: students name the three outcomes when intensity fails to clear the bar.

**How it was taught.** Through the activity: classify eight described cases into the three outcomes with justifications

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: classify eight described cases into the three outcomes with justifications, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An entry naming a specific checkable outcome. |
| **Non-example** | An entry predicting that things will go fine. |
...
> "Three things happen, and vanishing is not one."
...
**Exact wording.** "Ask them to read their first two entries and say whether somebody else could check them."
...
**Target observation.** That log quality can be audited against stated rules.
...
> "A usable log entry names a specific outcome, is written before that outcome, carries an intensity rating made at the time, and is checkable by somebody else. You just saw that when ask them to read their first two entries and say whether somebody else could check them.
> Last time we said: Three things happen, and vanishing is not one. This is the next part of that.
...
**What students must not infer.** Whether the predictions are accurate.

### 4. Worked example

**The example.** An entry naming a specific checkable outcome.
...
**Completed answer.** An entry naming a specific checkable outcome. — which demonstrates that log quality can be audited against stated rules.
...
**Conclusions not licensed.** Whether the predictions are accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An entry rewritten after failing the third-party test. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An entry predicting that things will go fine. Why is this not an
example?"
...
**Exact student instructions.** Audit and rewrite the first entries; add four more that pass all four rules.
...
- *Licensed conclusion.* That log quality can be audited against stated rules.
- *Not licensed.* Whether the predictions are accurate.
...
- *Expected response.* That log quality can be audited against stated rules.
...
1. Any wording carrying the idea in `A usable log entry names a specific outcome, is written before that outcome, carries an intensity rating made at the time, and is checkable by somebody else`.
...
Say: "A log nobody can check is not data."
...
| | |
|---|---|
| **Follows** | Lesson 4 — Below The Threshold |
| **Leads to** | Lesson 6 — Intensity At The Time |

**Transition in.** Lesson 4 established students name the three outcomes when intensity fails to clear the bar. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students improve their log entries against the four rules. Lesson 6 assumes it and builds students rate intensity at the moment of prediction, not after.
