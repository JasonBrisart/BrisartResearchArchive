# Lesson 3 Homework — Which Way The Threshold Goes

**Grade 7** · Persistence Is Not Accuracy · **Quarter 1**
**Follows:** Lesson 3 — Which Way The Threshold Goes · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 3 ended on, from memory:
...
Complete a six-row parameter table predicting the effect of each change.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has the direction correct in both threshold rows
...
Lesson 4 is **Below The Threshold**, which assumes you arrive holding it. Write one thing you expect it to be about:
