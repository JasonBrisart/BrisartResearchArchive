# Lesson 8 Homework — The Log Review

**Grade 7** · Persistence Is Not Accuracy · **Quarter 1**
**Follows:** Lesson 8 — The Log Review · **Points:** 5 · **Optional:** yes
...
Full log audit with every failing entry marked and rewritten.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student's log has at least ten surviving entries
...
Lesson 9 is **Two Separate Properties**, which assumes you arrive holding it. Write one thing you expect it to be about:
