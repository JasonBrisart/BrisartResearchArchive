# Lesson 2 Homework — The Persistence Condition

**Grade 7** · Persistence Is Not Accuracy · **Quarter 1**
**Follows:** Lesson 2 — The Persistence Condition · **Points:** 5 · **Optional:** yes
...
Write the relation from memory five times and translate it twice.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student can read the relation aloud as a sentence
...
Lesson 3 is **Which Way The Threshold Goes**, which assumes you arrive holding it. Write one thing you expect it to be about:
