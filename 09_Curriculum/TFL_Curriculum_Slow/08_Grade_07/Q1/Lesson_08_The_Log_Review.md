...
| | |
|---|---|
| **Central question** | The Log Review: students consolidate logging practice? |
| **Core concept** | A log with too few surviving entries cannot support the year's central demonstration. |
| **Student outcome** | Students consolidate logging practice. |
| **Previous lesson** | Lesson 7 — What Makes A Good Entry |
| **Next lesson** | Lesson 9 — Two Separate Properties |
...
**The conceptual step.** A log with too few surviving entries cannot support the year's central demonstration. The audit catches this while there is still time to build the log.
...
**What depends on it.** Lesson 9 — Two Separate Properties — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A log with too few surviving entries cannot support the year's central demonstration. The audit catches this while there is still time to build the log.
...
1. A log with fourteen entries, ten surviving audit.
2. An entry marked failing and rewritten.

### One non-example

A log with four entries, audited and passed.
...
Whether the log will support the four-box study.
...
| Statement | Status |
|---|---|
| A log with too few surviving entries cannot support the year's central demonstration. | Framework-derived, appropriate at this grade |
| Whether the log will support the four-box study. | What this specific activity can show |
| Whether the predictions are accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — What Makes A Good Entry — specifically: students distinguish strong from weak log entries.

**How it was taught.** Through the activity: rank eight entries by quality and justify the top and bottom

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: rank eight entries by quality and justify the top and bottom, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A log with fourteen entries, ten surviving audit. |
| **Non-example** | A log with four entries, audited and passed. |
...
**Exact wording.** "Ask how many entries they have and how many would survive an audit."
...
**Target observation.** Whether the log will support the four-box study.
...
> "A log with too few surviving entries cannot support the year's central demonstration. You just saw that when ask how many entries they have and how many would survive an audit.
> Last time we said: Now you know what you are aiming for. This is the next part of that.
...
**The example.** A log with fourteen entries, ten surviving audit.
...
**Completed answer.** A log with fourteen entries, ten surviving audit. — which demonstrates whether the log will support the four-box study.
...
**Teacher prompt.** "Here is a second case. An entry marked failing and rewritten. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A log with four entries, audited and passed. Why is this not an
example?"
...
**Exact student instructions.** Full log audit with every failing entry marked and rewritten.
...
- *Licensed conclusion.* Whether the log will support the four-box study.
...
- *Expected response.* Whether the log will support the four-box study.
...
1. Any wording carrying the idea in `A log with too few surviving entries cannot support the year's central demonstration`.
...
Say: "Next time: what accuracy and persistence actually are."
...
| | |
|---|---|
| **Follows** | Lesson 7 — What Makes A Good Entry |
| **Leads to** | Lesson 9 — Two Separate Properties |

**Transition in.** Lesson 7 established students distinguish strong from weak log entries. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate logging practice. Lesson 9 assumes it and builds students define accuracy and persistence as independent.
