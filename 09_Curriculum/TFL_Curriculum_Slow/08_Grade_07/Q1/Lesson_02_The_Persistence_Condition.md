# Lesson 2 — The Persistence Condition
...
| | |
|---|---|
| **Central question** | The Persistence Condition: students read and decode the persistence relation? |
| **Core concept** | The persistence condition states that a simulation carries into the next window if its affective intensity exceeds a threshold. |
| **Student outcome** | Students read and decode the persistence relation. |
| **Previous lesson** | Lesson 1 — Starting The Log |
| **Next lesson** | Lesson 3 — Which Way The Threshold Goes |
...
**The conceptual step.** The persistence condition states that a simulation carries into the next window if its affective intensity exceeds a threshold. Every symbol has a plain-language translation.
...
**What depends on it.** Lesson 3 — Which Way The Threshold Goes — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The persistence condition states that a simulation carries into the next window if its affective intensity exceeds a threshold. Every symbol has a plain-language translation.
...
1. Sim(t+1) equals Sim(t) if E(t) exceeds theta.
2. A translation reading: it carries over if it mattered enough.

### One non-example

Reading the relation aloud without decoding theta.
...
That the relation can be read and translated.

### What this activity does not establish

What value theta takes.
...
| Statement | Status |
|---|---|
| The persistence condition states that a simulation carries into the next window if its affective intensity exceeds a threshold. | Framework-derived, appropriate at this grade |
| That the relation can be read and translated. | What this specific activity can show |
| What value theta takes. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 1 — Starting The Log — specifically: students begin a prospective prediction log.

**How it was taught.** Through the activity: start the log with two entries about the next twenty-four hours, written in class

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: start the log with two entries about the next twenty-four hours, written in class, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Sim(t+1) equals Sim(t) if E(t) exceeds theta. |
| **Non-example** | Reading the relation aloud without decoding theta. |
...
> "Writing it afterwards costs you the whole data point."
...
**Exact wording.** "Ask, without notes, what they remember predicting last week. Some survive; most do not."
...
**Target observation.** That the relation can be read and translated.
...
> "The persistence condition states that a simulation carries into the next window if its affective intensity exceeds a threshold. You just saw that when ask, without notes, what they remember predicting last week.
> Last time we said: Writing it afterwards costs you the whole data point. This is the next part of that.
...
**What students must not infer.** What value theta takes.

### 4. Worked example

**The example.** Sim(t+1) equals Sim(t) if E(t) exceeds theta.
...
**Completed answer.** Sim(t+1) equals Sim(t) if E(t) exceeds theta. — which demonstrates that the relation can be read and translated.
...
**Conclusions not licensed.** What value theta takes.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A translation reading: it carries over if it mattered enough. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reading the relation aloud without decoding theta. Why is this not an
example?"
...
**Exact student instructions.** Write the relation from memory five times and translate it twice.
...
- *Licensed conclusion.* That the relation can be read and translated.
- *Not licensed.* What value theta takes.
...
- *Expected response.* That the relation can be read and translated.
...
1. Any wording carrying the idea in `The persistence condition states that a simulation carries into the next window if its affective intensity exceeds a threshold`.
...
Say: "If it mattered enough, it carries over."
...
| | |
|---|---|
| **Follows** | Lesson 1 — Starting The Log |
| **Leads to** | Lesson 3 — Which Way The Threshold Goes |

**Transition in.** Lesson 1 established students begin a prospective prediction log. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students read and decode the persistence relation. Lesson 3 assumes it and builds students reason correctly about threshold direction.
