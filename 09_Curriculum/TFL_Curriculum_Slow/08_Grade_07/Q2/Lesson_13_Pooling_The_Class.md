...
| | |
|---|---|
| **Central question** | Pooling The Class: students combine individual matrices into one class dataset? |
| **Core concept** | Pooling increases the sample and usually changes the proportions. |
| **Student outcome** | Students combine individual matrices into one class dataset. |
| **Previous lesson** | Lesson 12 — The Other Diagonal |
| **Next lesson** | Lesson 14 — What Would Have Changed My Mind |
...
**The conceptual step.** Pooling increases the sample and usually changes the proportions. Comparing an individual matrix with the pooled one shows how unreliable a small sample is.
...
**What depends on it.** Lesson 14 — What Would Have Changed My Mind — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Pooling increases the sample and usually changes the proportions. Comparing an individual matrix with the pooled one shows how unreliable a small sample is.
...
1. A pooled matrix of two hundred entries.
2. A student whose individual proportions differ from the pooled ones.

### One non-example

Assuming the pooled data will look like one's own.
...
That pooling changes the picture.

### What this activity does not establish

Whether the pooled proportions generalise.
...
| Statement | Status |
|---|---|
| Pooling increases the sample and usually changes the proportions. | Framework-derived, appropriate at this grade |
| That pooling changes the picture. | What this specific activity can show |
| Whether the pooled proportions generalise. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — The Other Diagonal — specifically: students examine the accurate-and-faded cell.

**How it was taught.** Through the activity: analyse their accurate-faded entries and compare E(t) ratings across both diagonals

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: analyse their accurate-faded entries and compare E(t) ratings across both diagonals, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A pooled matrix of two hundred entries. |
| **Non-example** | Assuming the pooled data will look like one's own. |
...
> "Both diagonals say the same thing. Accuracy does not decide it."
...
**Exact wording.** "Say: your eight entries is a story. Two hundred is evidence."
...
**Target observation.** That pooling changes the picture.
...
> "Pooling increases the sample and usually changes the proportions. You just saw that when say: your eight entries is a story.
> Last time we said: Both diagonals say the same thing. Accuracy does not decide it. This is the next part of that.
...
**What students must not infer.** Whether the pooled proportions generalise.

### 4. Worked example

**The example.** A pooled matrix of two hundred entries.
...
**Completed answer.** A pooled matrix of two hundred entries. — which demonstrates that pooling changes the picture.
...
**Conclusions not licensed.** Whether the pooled proportions generalise.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student whose individual proportions differ from the pooled ones. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Assuming the pooled data will look like one's own. Why is this not an
example?"
...
**Exact student instructions.** Build the pooled class matrix and compute the proportion in each cell.
...
- *Licensed conclusion.* That pooling changes the picture.
- *Not licensed.* Whether the pooled proportions generalise.
...
- *Expected response.* That pooling changes the picture.
...
1. Any wording carrying the idea in `Pooling increases the sample and usually changes the proportions`.
...
Say: "The pooled numbers are harder to argue with than yours alone."
...
| | |
|---|---|
| **Follows** | Lesson 12 — The Other Diagonal |
| **Leads to** | Lesson 14 — What Would Have Changed My Mind |

**Transition in.** Lesson 12 established students examine the accurate-and-faded cell. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students combine individual matrices into one class dataset. Lesson 14 assumes it and builds students state in advance what result would count against the claim.
