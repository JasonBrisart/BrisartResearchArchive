...
| | |
|---|---|
| **Central question** | The Four Box Study: students test the independence claim on their own prospective data? |
| **Core concept** | The four-box matrix crosses accuracy with persistence. |
| **Student outcome** | Students test the independence claim on their own prospective data. |
| **Previous lesson** | Lesson 9 — Two Separate Properties |
| **Next lesson** | Lesson 11 — The Strongest Cell |
...
**The conceptual step.** The four-box matrix crosses accuracy with persistence. All four cells filling is evidence that the properties vary independently in this sample.
...
**What depends on it.** Lesson 11 — The Strongest Cell — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The four-box matrix crosses accuracy with persistence. All four cells filling is evidence that the properties vary independently in this sample.
...
1. Eight entries sorted with all four cells occupied.
2. A student sorting from the log rather than from memory.

### One non-example

Entries sorted from recollection with the log left in the bag.
...
That all four combinations occur in the student's own data.

### What this activity does not establish

That the properties are independent in general.
...
| Statement | Status |
|---|---|
| The four-box matrix crosses accuracy with persistence. | Framework-derived, appropriate at this grade |
| That all four combinations occur in the student's own data. | What this specific activity can show |
| That the properties are independent in general. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 9 — Two Separate Properties — specifically: students define accuracy and persistence as independent.

**How it was taught.** Through the activity: define both in their own words and find one example of each of four combinations

**Quick check.** Ask for the closing sentence of Lesson 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 9: define both in their own words and find one example of each of four combinations, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Eight entries sorted with all four cells occupied. |
| **Non-example** | Entries sorted from recollection with the log left in the bag. |
...
> "Tomorrow you test this on your own data."
...
**Exact wording.** "Say: ten weeks ago you started recording predictions before outcomes. Today it does work."
...
**Target observation.** That all four combinations occur in the student's own data.
...
> "The four-box matrix crosses accuracy with persistence. You just saw that when say: ten weeks ago you started recording predictions before outcomes.
> Last time we said: Tomorrow you test this on your own data. This is the next part of that.
...
**What students must not infer.** That the properties are independent in general.

### 4. Worked example

**The example.** Eight entries sorted with all four cells occupied.
...
**Completed answer.** Eight entries sorted with all four cells occupied. — which demonstrates that all four combinations occur in the student's own data.
...
**Conclusions not licensed.** That the properties are independent in general.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student sorting from the log rather than from memory. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Entries sorted from recollection with the log left in the bag. Why is this not an
example?"
...
**Exact student instructions.** Sort at least eight logged predictions into the matrix and answer three questions.
...
- *Licensed conclusion.* That all four combinations occur in the student's own data.
- *Not licensed.* That the properties are independent in general.
...
- *Expected response.* That all four combinations occur in the student's own data.
...
1. Any wording carrying the idea in `The four-box matrix crosses accuracy with persistence`.
...
Say: "Being right does not make it stick. Mattering does."
...
| | |
|---|---|
| **Follows** | Lesson 9 — Two Separate Properties |
| **Leads to** | Lesson 11 — The Strongest Cell |

**Transition in.** Lesson 9 established students define accuracy and persistence as independent. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students test the independence claim on their own prospective data. Lesson 11 assumes it and builds students examine the inaccurate-and-persisted cell.
