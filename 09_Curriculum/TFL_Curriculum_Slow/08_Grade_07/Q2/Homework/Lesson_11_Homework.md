# Lesson 11 Homework — The Strongest Cell

**Grade 7** · Persistence Is Not Accuracy · **Quarter 2**
**Follows:** Lesson 11 — The Strongest Cell · **Points:** 5 · **Optional:** yes
...
Write a paragraph on their own inaccurate-persisted entries with the E(t) rating of each.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student writes about at least two entries from that cell
...
Lesson 12 is **The Other Diagonal**, which assumes you arrive holding it. Write one thing you expect it to be about:
