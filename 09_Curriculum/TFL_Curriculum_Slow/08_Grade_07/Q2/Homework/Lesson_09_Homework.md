# Lesson 9 Homework — Two Separate Properties

**Grade 7** · Persistence Is Not Accuracy · **Quarter 2**
**Follows:** Lesson 9 — Two Separate Properties · **Points:** 5 · **Optional:** yes
...
Define both in their own words and find one example of each of four combinations.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student finds at least three of the four combinations
...
Lesson 10 is **The Four Box Study**, which assumes you arrive holding it. Write one thing you expect it to be about:
