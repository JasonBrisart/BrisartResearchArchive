# Lesson 15 Homework — Intensity Is Not Confidence

**Grade 7** · Persistence Is Not Accuracy · **Quarter 2**
**Follows:** Lesson 15 — Intensity Is Not Confidence · **Points:** 5 · **Optional:** yes
...
Re-rate ten log entries on both scales and compare the two columns.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has ten entries rated on both scales
...
Lesson 16 is **The Distinction Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
