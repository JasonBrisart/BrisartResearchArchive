...
| | |
|---|---|
| **Central question** | Sorting What Stuck: students separate expectations that stayed from those that faded? |
| **Core concept** | Sorting by stuck and faded, with each item also marked right or wrong, shows that correctness does not predict the column. |
| **Student outcome** | Students separate expectations that stayed from those that faded. |
| **Previous lesson** | Lesson 22 — When The Interrupt Is Wrong |
| **Next lesson** | Lesson 24 — The Wrong Is Useful Review |
...
**The conceptual step.** Sorting by stuck and faded, with each item also marked right or wrong, shows that correctness does not predict the column.
...
**What depends on it.** Lesson 24 — The Wrong Is Useful Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Sorting by stuck and faded, with each item also marked right or wrong, shows that correctness does not predict the column.
...
1. A wrong expectation in the stuck column.
2. A right expectation in the faded column.

### One non-example

A sort where every item is both right and stuck.
...
That correctness does not track sticking.

### What this activity does not establish

The strength of that relationship, which is Grade 7.
...
| Statement | Status |
|---|---|
| Sorting by stuck and faded, with each item also marked right or wrong, shows that correctness does not predict the column. | Framework-derived, appropriate at this grade |
| That correctness does not track sticking. | What this specific activity can show |
| The strength of that relationship, which is Grade 7. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — When The Interrupt Is Wrong — specifically: students analyse an interrupt whose expectation failed.

**How it was taught.** Through the activity: each wrong interrupt traced backwards and written up

**Quick check.** Ask for the closing sentence of Lesson 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: each wrong interrupt traced backwards and written up, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A wrong expectation in the stuck column. |
| **Non-example** | A sort where every item is both right and stuck. |
...
> "The wrong ones are the ones we can see."
...
**Exact wording.** "Ask cold what they still remember expecting this week."
...
**Target observation.** That correctness does not track sticking.
...
> "Sorting by stuck and faded, with each item also marked right or wrong, shows that correctness does not predict the column. You just saw that when ask cold what they still remember expecting this week.
> Last time we said: The wrong ones are the ones we can see. This is the next part of that.
...
**What students must not infer.** The strength of that relationship, which is Grade 7.

### 4. Worked example

**The example.** A wrong expectation in the stuck column.
...
**Completed answer.** A wrong expectation in the stuck column. — which demonstrates that correctness does not track sticking.
...
**Conclusions not licensed.** The strength of that relationship, which is Grade 7.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A right expectation in the faded column. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A sort where every item is both right and stuck. Why is this not an
example?"
...
**Exact student instructions.** Two-column sort of six real expectations, each marked R or W.
...
- *Licensed conclusion.* That correctness does not track sticking.
- *Not licensed.* The strength of that relationship, which is Grade 7.
...
- *Expected response.* That correctness does not track sticking.
...
1. Any wording carrying the idea in `Sorting by stuck and faded, with each item also marked right or wrong, shows that correctness does not predict the column`.
...
Say: "It stuck because it mattered."
...
| | |
|---|---|
| **Follows** | Lesson 22 — When The Interrupt Is Wrong |
| **Leads to** | Lesson 24 — The Wrong Is Useful Review |

**Transition in.** Lesson 22 established students analyse an interrupt whose expectation failed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students separate expectations that stayed from those that faded. Lesson 24 assumes it and builds students consolidate the quarter's work on broken expectations.
