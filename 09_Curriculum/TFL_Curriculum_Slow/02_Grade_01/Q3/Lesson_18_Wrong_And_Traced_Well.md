# Lesson 18 — Wrong And Traced Well
...
| | |
|---|---|
| **Central question** | Wrong And Traced Well: students see that a wrong expectation can be well traced? |
| **Core concept** | The trace is the graded work, not the outcome. |
| **Student outcome** | Students see that a wrong expectation can be well traced. |
| **Previous lesson** | Lesson 17 — Break It On Purpose |
| **Next lesson** | Lesson 19 — The Pattern Break |
...
**The conceptual step.** The trace is the graded work, not the outcome. A wrong expectation with a strong source is better work than a correct one with none.
...
**What depends on it.** Lesson 19 — The Pattern Break — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The trace is the graded work, not the outcome. A wrong expectation with a strong source is better work than a correct one with none.
...
1. Expected the song to continue because it always does, and it stopped.
2. Expected four after three because counting works that way, and five came.

### One non-example

A correct expectation with no because attached.
...
That reasoning, not accuracy, is what is assessed.

### What this activity does not establish

That wrong expectations are preferable.
...
| Statement | Status |
|---|---|
| The trace is the graded work, not the outcome. | Framework-derived, appropriate at this grade |
| That reasoning, not accuracy, is what is assessed. | What this specific activity can show |
| That wrong expectations are preferable. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Break It On Purpose — specifically: students report the expectation an engineered break revealed.

**How it was taught.** Through the activity: three more breaks. Each written up as: I was surprised because I expected ___

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: three more breaks. Each written up as: I was surprised because I expected ___, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Expected the song to continue because it always does, and it stopped. |
| **Non-example** | A correct expectation with no because attached. |
...
**Exact wording.** "Two traces on the board: one right with no because, one wrong with a strong because."
...
**Target observation.** That reasoning, not accuracy, is what is assessed.
...
> "The trace is the graded work, not the outcome. You just saw that when two traces on the board: one right with no because, one wrong with a strong because.
> Last time we said: The surprise is our tool. This is the next part of that.
...
**What students must not infer.** That wrong expectations are preferable.

### 4. Worked example

**The example.** Expected the song to continue because it always does, and it stopped.
...
**Completed answer.** Expected the song to continue because it always does, and it stopped. — which demonstrates that reasoning, not accuracy, is what is assessed.
...
**Conclusions not licensed.** That wrong expectations are preferable.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Expected four after three because counting works that way, and five came. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A correct expectation with no because attached. Why is this not an
example?"
...
**Exact student instructions.** Add a because to each of the three surprise frames from last lesson.
...
- *Licensed conclusion.* That reasoning, not accuracy, is what is assessed.
- *Not licensed.* That wrong expectations are preferable.
...
- *Expected response.* That reasoning, not accuracy, is what is assessed.
...
1. Any wording carrying the idea in `The trace is the graded work, not the outcome`.
...
Say: "Being wrong costs you nothing."
...
| | |
|---|---|
| **Follows** | Lesson 17 — Break It On Purpose |
| **Leads to** | Lesson 19 — The Pattern Break |

**Transition in.** Lesson 17 established students report the expectation an engineered break revealed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students see that a wrong expectation can be well traced. Lesson 19 assumes it and builds students record how a class expectation survives a break.
