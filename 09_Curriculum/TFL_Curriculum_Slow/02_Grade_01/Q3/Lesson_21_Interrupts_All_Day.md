...
| | |
|---|---|
| **Central question** | Interrupts All Day: students run interrupts outside the lesson? |
| **Core concept** | Timestamping is what separates a captured expectation from a remembered one. |
| **Student outcome** | Students run interrupts outside the lesson. |
| **Previous lesson** | Lesson 20 — The Prediction Interrupt |
| **Next lesson** | Lesson 22 — When The Interrupt Is Wrong |
...
**The conceptual step.** Timestamping is what separates a captured expectation from a remembered one. Without a time, the record cannot be trusted.
...
**What depends on it.** Lesson 22 — When The Interrupt Is Wrong — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Timestamping is what separates a captured expectation from a remembered one. Without a time, the record cannot be trusted.
...
1. An interrupt written at 11:15 before entering the hall.
2. An interrupt written before the bus arrived.

### One non-example

Three interrupts all written at the end of the day.
...
That capture works outside the lesson when timed.

### What this activity does not establish

How accurate any of them were.
...
| Statement | Status |
|---|---|
| Timestamping is what separates a captured expectation from a remembered one. | Framework-derived, appropriate at this grade |
| That capture works outside the lesson when timed. | What this specific activity can show |
| How accurate any of them were. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — The Prediction Interrupt — specifically: students catch an expectation while it is running.

**How it was taught.** Through the activity: five interrupts across the session, each written before the action

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: five interrupts across the session, each written before the action, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An interrupt written at 11:15 before entering the hall. |
| **Non-example** | Three interrupts all written at the end of the day. |
...
> "You can catch one while it is still running."
...
**Exact wording.** "Ask for three today, outside this room, written before acting."
...
**Target observation.** That capture works outside the lesson when timed.
...
> "Timestamping is what separates a captured expectation from a remembered one. You just saw that when ask for three today, outside this room, written before acting.
> Last time we said: You can catch one while it is still running. This is the next part of that.
...
**What students must not infer.** How accurate any of them were.

### 4. Worked example

**The example.** An interrupt written at 11:15 before entering the hall.
...
**Completed answer.** An interrupt written at 11:15 before entering the hall. — which demonstrates that capture works outside the lesson when timed.
...
**Conclusions not licensed.** How accurate any of them were.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An interrupt written before the bus arrived. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Three interrupts all written at the end of the day. Why is this not an
example?"
...
**Exact student instructions.** Three interrupts collected from the rest of the school day.
...
- *Licensed conclusion.* That capture works outside the lesson when timed.
- *Not licensed.* How accurate any of them were.
...
- *Expected response.* That capture works outside the lesson when timed.
...
1. Any wording carrying the idea in `Timestamping is what separates a captured expectation from a remembered one`.
...
| | |
|---|---|
| **Follows** | Lesson 20 — The Prediction Interrupt |
| **Leads to** | Lesson 22 — When The Interrupt Is Wrong |

**Transition in.** Lesson 20 established students catch an expectation while it is running. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students run interrupts outside the lesson. Lesson 22 assumes it and builds students analyse an interrupt whose expectation failed.
