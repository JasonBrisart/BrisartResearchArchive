...
**Grade 1** · Where Guesses Come From
...
|---|---|---|---|---|---|---|
| `Lesson_17_Printout.md` | Lesson 17 — Break It On Purpose | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_18_Printout.md` | Lesson 18 — Wrong And Traced Well | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 17 work |
| `Lesson_19_Printout.md` | Lesson 19 — The Pattern Break | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 18 work |
| `Lesson_20_Printout.md` | Lesson 20 — The Prediction Interrupt | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 19 work |
| `Lesson_21_Printout.md` | Lesson 21 — Interrupts All Day | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 20 work |
| `Lesson_22_Printout.md` | Lesson 22 — When The Interrupt Is Wrong | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 21 work |
| `Lesson_23_Printout.md` | Lesson 23 — Sorting What Stuck | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 22 work |
| `Lesson_24_Printout.md` | Lesson 24 — The Wrong Is Useful Review | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 23 work |
...
**Lesson 21 — Interrupts All Day.** If you only have time to print one
