# Lesson 19 Homework — The Pattern Break

**Grade 1** · Where Guesses Come From · **Quarter 3**
**Follows:** Lesson 19 — The Pattern Break · **Points:** 5 · **Optional:** yes
...
Tally the class expectation across nine cards on a printed sheet.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has a completed nine-card tally
...
Lesson 20 is **The Prediction Interrupt**, which assumes you arrive holding it. Write one thing you expect it to be about:
