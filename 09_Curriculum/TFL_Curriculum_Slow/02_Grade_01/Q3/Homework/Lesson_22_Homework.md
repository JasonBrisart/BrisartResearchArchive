# Lesson 22 Homework — When The Interrupt Is Wrong

**Grade 1** · Where Guesses Come From · **Quarter 3**
**Follows:** Lesson 22 — When The Interrupt Is Wrong · **Points:** 5 · **Optional:** yes
...
Each wrong interrupt traced backwards and written up.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student analyses at least one wrong interrupt
...
Lesson 23 is **Sorting What Stuck**, which assumes you arrive holding it. Write one thing you expect it to be about:
