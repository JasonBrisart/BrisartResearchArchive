# Lesson 24 Homework — The Wrong Is Useful Review

**Grade 1** · Where Guesses Come From · **Quarter 3**
**Follows:** Lesson 24 — The Wrong Is Useful Review · **Points:** 5 · **Optional:** yes
...
Review using the term's tallies, sorted by what each break revealed.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class can state why breaks are engineered
...
Lesson 25 is **Putting It Together**, which assumes you arrive holding it. Write one thing you expect it to be about:
