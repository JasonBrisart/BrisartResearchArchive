# Lesson 18 Homework — Wrong And Traced Well

**Grade 1** · Where Guesses Come From · **Quarter 3**
**Follows:** Lesson 18 — Wrong And Traced Well · **Points:** 5 · **Optional:** yes
...
Add a because to each of the three surprise frames from last lesson.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** students can state the trace is what is graded
...
Lesson 19 is **The Pattern Break**, which assumes you arrive holding it. Write one thing you expect it to be about:
