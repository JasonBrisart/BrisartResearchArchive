# Lesson 17 — Break It On Purpose

**Grade 1** · Where Guesses Come From · **Quarter 3** · **25 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Break It On Purpose: students report the expectation an engineered break revealed? |
| **Core concept** | Breaking an expectation on purpose is the standard method for making an unspoken one reportable. |
| **Student outcome** | Students report the expectation an engineered break revealed. |
| **Previous lesson** | Lesson 16 — The Because Review |
| **Next lesson** | Lesson 18 — Wrong And Traced Well |
...
**The conceptual step.** Breaking an expectation on purpose is the standard method for making an unspoken one reportable. The surprise names its own cause.
...
**What depends on it.** Lesson 18 — Wrong And Traced Well — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Breaking an expectation on purpose is the standard method for making an unspoken one reportable. The surprise names its own cause.
...
1. The song stops and the student names the missing line.
2. The pattern breaks and the student names the expected shape.

### One non-example

Reporting that it was loud, which describes the stimulus.
...
That engineered breaks recover unspoken expectations.

### What this activity does not establish

Any claim about how the recovery works.
...
| Statement | Status |
|---|---|
| Breaking an expectation on purpose is the standard method for making an unspoken one reportable. | Framework-derived, appropriate at this grade |
| That engineered breaks recover unspoken expectations. | What this specific activity can show |
| Any claim about how the recovery works. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Because Review — specifically: students consolidate tracing.

**How it was taught.** Through the activity: review with three deliberately unsourced expectations to catch and fix

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with three deliberately unsourced expectations to catch and fix, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The song stops and the student names the missing line. |
| **Non-example** | Reporting that it was loud, which describes the stimulus. |
...
> "Next time: what happens when an expectation is wrong."
...
**Exact wording.** "Play something familiar for fifteen seconds, then stop mid-phrase."
...
**Target observation.** That engineered breaks recover unspoken expectations.
...
> "Breaking an expectation on purpose is the standard method for making an unspoken one reportable. You just saw that when play something familiar for fifteen seconds, then stop mid-phrase.
> Last time we said: Next time: what happens when an expectation is wrong. This is the next part of that.
...
**What students must not infer.** Any claim about how the recovery works.

### 4. Worked example

**The example.** The song stops and the student names the missing line.
...
**Completed answer.** The song stops and the student names the missing line. — which demonstrates that engineered breaks recover unspoken expectations.
...
**Conclusions not licensed.** Any claim about how the recovery works.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The pattern breaks and the student names the expected shape. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reporting that it was loud, which describes the stimulus. Why is this not an
example?"
...
**Exact student instructions.** Three more breaks. Each written up as: I was surprised because I expected ___.
...
- *Licensed conclusion.* That engineered breaks recover unspoken expectations.
- *Not licensed.* Any claim about how the recovery works.
...
- *Expected response.* That engineered breaks recover unspoken expectations.
...
1. Any wording carrying the idea in `Breaking an expectation on purpose is the standard method for making an unspoken one reportable`.
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Because Review |
| **Leads to** | Lesson 18 — Wrong And Traced Well |

**Transition in.** Lesson 16 established students consolidate tracing. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students report the expectation an engineered break revealed. Lesson 18 assumes it and builds students see that a wrong expectation can be well traced.
