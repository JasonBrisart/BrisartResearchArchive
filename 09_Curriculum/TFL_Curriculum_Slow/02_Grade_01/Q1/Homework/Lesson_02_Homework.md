# Lesson 2 Homework — Three Parts In A Row

**Grade 1** · Where Guesses Come From · **Quarter 1**
**Follows:** Lesson 2 — Three Parts In A Row · **Points:** 5 · **Optional:** yes
...
Three-column page, four rows about this room, each connecting across.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** most students have two rows connecting across all three columns
...
Lesson 3 is **Expecting The Ordinary**, which assumes you arrive holding it. Write one thing you expect it to be about:
