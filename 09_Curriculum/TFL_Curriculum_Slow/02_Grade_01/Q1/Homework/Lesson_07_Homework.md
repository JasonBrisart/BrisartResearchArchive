# Lesson 7 Homework — Comparing Expectations

**Grade 1** · Where Guesses Come From · **Quarter 1**
**Follows:** Lesson 7 — Comparing Expectations · **Points:** 5 · **Optional:** yes
...
Pairs compare four rows and mark one where noticing matched but expecting did not.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** each pair identifies one such row
...
Lesson 8 is **The Expect Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
