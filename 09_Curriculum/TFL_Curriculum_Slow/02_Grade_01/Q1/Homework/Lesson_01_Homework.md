# Lesson 1 Homework — The Proper Word

**Grade 1** · Where Guesses Come From · **Quarter 1**
**Follows:** Lesson 1 — The Proper Word · **Points:** 5 · **Optional:** yes
...
Rewrite four Kindergarten frames using EXPECT, in notebooks.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student writes EXPECT in at least two sentences
...
Lesson 2 is **Three Parts In A Row**, which assumes you arrive holding it. Write one thing you expect it to be about:
