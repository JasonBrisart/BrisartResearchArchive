...
| | |
|---|---|
| **Central question** | The Expect Review: students consolidate the quarter's work on expectation? |
| **Core concept** | The three columns must stay distinct under speed. |
| **Student outcome** | Students consolidate the quarter's work on expectation. |
| **Previous lesson** | Lesson 7 — Comparing Expectations |
| **Next lesson** | Lesson 9 — The Word Because |
...
**The conceptual step.** The three columns must stay distinct under speed. The relay tests whether the distinction survives pressure.
...
**What depends on it.** Lesson 9 — The Word Because — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The three columns must stay distinct under speed. The relay tests whether the distinction survives pressure.
...
1. Twelve items sorted with nine correct.
2. A student self-corrects using the timing test.

### One non-example

Sorting by which column has fewer cards.
...
Whether the three-way distinction survives quick sorting.
...
| Statement | Status |
|---|---|
| The three columns must stay distinct under speed. | Framework-derived, appropriate at this grade |
| Whether the three-way distinction survives quick sorting. | What this specific activity can show |
| Perfect accuracy. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — Comparing Expectations — specifically: students notice that classmates expect different things.

**How it was taught.** Through the activity: pairs compare four rows and mark one where noticing matched but expecting did not

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: pairs compare four rows and mark one where noticing matched but expecting did not, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Twelve items sorted with nine correct. |
| **Non-example** | Sorting by which column has fewer cards. |
...
> "The remembering is what makes the expecting different."
...
**Exact wording.** "Ask for the proper word and the three parts."
...
**Target observation.** Whether the three-way distinction survives quick sorting.
...
> "The three columns must stay distinct under speed. You just saw that when ask for the proper word and the three parts.
> Last time we said: The remembering is what makes the expecting different. This is the next part of that.
...
**What students must not infer.** Perfect accuracy.

### 4. Worked example

**The example.** Twelve items sorted with nine correct.
...
**Completed answer.** Twelve items sorted with nine correct. — which demonstrates whether the three-way distinction survives quick sorting.
...
**Conclusions not licensed.** Perfect accuracy.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student self-corrects using the timing test. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Sorting by which column has fewer cards. Why is this not an
example?"
...
**Exact student instructions.** Review relay with twelve items sorted into the three columns.
...
- *Licensed conclusion.* Whether the three-way distinction survives quick sorting.
- *Not licensed.* Perfect accuracy.
...
- *Expected response.* Whether the three-way distinction survives quick sorting.
...
1. Any wording carrying the idea in `The three columns must stay distinct under speed`.
...
Say: "Next time: the word that finishes an expectation."
...
| | |
|---|---|
| **Follows** | Lesson 7 — Comparing Expectations |
| **Leads to** | Lesson 9 — The Word Because |

**Transition in.** Lesson 7 established students notice that classmates expect different things. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the quarter's work on expectation. Lesson 9 assumes it and builds students join an expectation to its source.
