# Lesson 7 — Comparing Expectations
...
| | |
|---|---|
| **Central question** | Comparing Expectations: students notice that classmates expect different things? |
| **Core concept** | Same noticing with different expecting points at the middle column. |
| **Student outcome** | Students notice that classmates expect different things. |
| **Previous lesson** | Lesson 6 — Expectations You Never Made |
| **Next lesson** | Lesson 8 — The Expect Review |
...
**The conceptual step.** Same noticing with different expecting points at the middle column. The difference has a locatable source.
...
**What depends on it.** Lesson 8 — The Expect Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Same noticing with different expecting points at the middle column. The difference has a locatable source.
...
1. Two students hear the same bell and expect different lessons.
2. Two students see the same coats and expect different activities.

### One non-example

Two students who expect the same thing — nothing to locate.
...
That the difference traces to the remembering column.

### What this activity does not establish

That either expectation is correct.
...
| Statement | Status |
|---|---|
| Same noticing with different expecting points at the middle column. | Framework-derived, appropriate at this grade |
| That the difference traces to the remembering column. | What this specific activity can show |
| That either expectation is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — Expectations You Never Made — specifically: students recognise expectations they did not deliberately form.

**How it was taught.** Through the activity: hunt three unnoticed expectations, each with how they know it was there

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: hunt three unnoticed expectations, each with how they know it was there, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two students hear the same bell and expect different lessons. |
| **Non-example** | Two students who expect the same thing — nothing to locate. |
...
> "When your expectation is right, you do not notice it."
...
**Exact wording.** "Put three students' rows on the board with no comment."
...
**Target observation.** That the difference traces to the remembering column.
...
> "Same noticing with different expecting points at the middle column. You just saw that when put three students' rows on the board with no comment.
> Last time we said: When your expectation is right, you do not notice it. This is the next part of that.
...
**What students must not infer.** That either expectation is correct.

### 4. Worked example

**The example.** Two students hear the same bell and expect different lessons.
...
**Completed answer.** Two students hear the same bell and expect different lessons. — which demonstrates that the difference traces to the remembering column.
...
**Conclusions not licensed.** That either expectation is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Two students see the same coats and expect different activities. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two students who expect the same thing — nothing to locate. Why is this not an
example?"
...
**Exact student instructions.** Pairs compare four rows and mark one where noticing matched but expecting did not.
...
- *Licensed conclusion.* That the difference traces to the remembering column.
- *Not licensed.* That either expectation is correct.
...
- *Expected response.* That the difference traces to the remembering column.
...
1. Any wording carrying the idea in `Same noticing with different expecting points at the middle column`.
...
Say: "The remembering is what makes the expecting different."
...
| | |
|---|---|
| **Follows** | Lesson 6 — Expectations You Never Made |
| **Leads to** | Lesson 8 — The Expect Review |

**Transition in.** Lesson 6 established students recognise expectations they did not deliberately form. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students notice that classmates expect different things. Lesson 8 assumes it and builds students consolidate the quarter's work on expectation.
