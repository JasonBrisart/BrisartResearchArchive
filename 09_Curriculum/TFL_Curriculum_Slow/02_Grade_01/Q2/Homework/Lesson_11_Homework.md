# Lesson 11 Homework — Finding The Source

**Grade 1** · Where Guesses Come From · **Quarter 2**
**Follows:** Lesson 11 — Finding The Source · **Points:** 5 · **Optional:** yes
...
Six sourceless expectations, each given a plausible memory.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** each student sources at least four of six
...
Lesson 12 is **Tracing Backwards**, which assumes you arrive holding it. Write one thing you expect it to be about:
