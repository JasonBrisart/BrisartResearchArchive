# Lesson 14 Homework — Somebody Else's Trace

**Grade 1** · Where Guesses Come From · **Quarter 2**
**Follows:** Lesson 14 — Somebody Else's Trace · **Points:** 5 · **Optional:** yes
...
Each student checks a partner's five traces and marks the weakest.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student receives a marked trace
...
Lesson 15 is **Fixing A Trace**, which assumes you arrive holding it. Write one thing you expect it to be about:
