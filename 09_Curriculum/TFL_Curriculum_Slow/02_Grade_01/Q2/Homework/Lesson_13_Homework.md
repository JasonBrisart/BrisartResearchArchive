# Lesson 13 Homework — Two Sources

**Grade 1** · Where Guesses Come From · **Quarter 2**
**Follows:** Lesson 13 — Two Sources · **Points:** 5 · **Optional:** yes
...
Three expectations, each traced to two contributing memories.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces three two-source traces
...
Lesson 14 is **Somebody Else's Trace**, which assumes you arrive holding it. Write one thing you expect it to be about:
