...
| | |
|---|---|
| **Central question** | Because Everywhere: students apply because to expectations from other lessons? |
| **Core concept** | The because rule is general. |
| **Student outcome** | Students apply because to expectations from other lessons. |
| **Previous lesson** | Lesson 9 — The Word Because |
| **Next lesson** | Lesson 11 — Finding The Source |
...
**The conceptual step.** The because rule is general. Applying it outside this lesson prevents it being filed as a classroom ritual.
...
**What depends on it.** Lesson 11 — Finding The Source — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The because rule is general. Applying it outside this lesson prevents it being filed as a classroom ritual.
...
1. In maths I expect the answer to be even because both numbers were.
2. In reading I expect the character to go back because she forgot something.

### One non-example

An expectation from this lesson reused in a different notebook.
...
That the rule transfers to other subjects.
...
| Statement | Status |
|---|---|
| The because rule is general. | Framework-derived, appropriate at this grade |
| That the rule transfers to other subjects. | What this specific activity can show |
| Anything about those subjects. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 9 — The Word Because — specifically: students join an expectation to its source.

**How it was taught.** Through the activity: five of their own expectations, each completed with because

**Quick check.** Ask for the closing sentence of Lesson 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 9: five of their own expectations, each completed with because, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | In maths I expect the answer to be even because both numbers were. |
| **Non-example** | An expectation from this lesson reused in a different notebook. |
...
> "An expectation is not finished until you say because."
...
**Exact wording.** "Take a maths or reading expectation and finish it with because."
...
**Target observation.** That the rule transfers to other subjects.
...
> "The because rule is general. You just saw that when take a maths or reading expectation and finish it with because.
> Last time we said: An expectation is not finished until you say because. This is the next part of that.
...
**The example.** In maths I expect the answer to be even because both numbers were.
...
**Completed answer.** In maths I expect the answer to be even because both numbers were. — which demonstrates that the rule transfers to other subjects.
...
**Teacher prompt.** "Here is a second case. In reading I expect the character to go back because she forgot something. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An expectation from this lesson reused in a different notebook. Why is this not an
example?"
...
**Exact student instructions.** Four cross-subject expectations completed with because.
...
- *Licensed conclusion.* That the rule transfers to other subjects.
...
- *Expected response.* That the rule transfers to other subjects.
...
1. Any wording carrying the idea in `The because rule is general`.
...
Say: "It works in every lesson, not only this one."
...
| | |
|---|---|
| **Follows** | Lesson 9 — The Word Because |
| **Leads to** | Lesson 11 — Finding The Source |

**Transition in.** Lesson 9 established students join an expectation to its source. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students apply because to expectations from other lessons. Lesson 11 assumes it and builds students identify what a stated expectation came from.
