...
| | |
|---|---|
| **Central question** | The Word Because: students join an expectation to its source? |
| **Core concept** | Because links the expectation to what produced it. |
| **Student outcome** | Students join an expectation to its source. |
| **Previous lesson** | Lesson 8 — The Expect Review |
| **Next lesson** | Lesson 10 — Because Everywhere |
...
**The conceptual step.** Because links the expectation to what produced it. Without it, the expectation is reported but not explained.
...
**What depends on it.** Lesson 10 — Because Everywhere — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Because links the expectation to what produced it. Without it, the expectation is reported but not explained.
...
1. I expect rain because I remember the forecast.
2. I expect the hall to be loud because it always is at lunch.

### One non-example

I expect rain because I just know — no source named.
...
That expectations can be linked to a stated source.

### What this activity does not establish

Whether the stated source is the real one.
...
| Statement | Status |
|---|---|
| Because links the expectation to what produced it. | Framework-derived, appropriate at this grade |
| That expectations can be linked to a stated source. | What this specific activity can show |
| Whether the stated source is the real one. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Expect Review — specifically: students consolidate the quarter's work on expectation.

**How it was taught.** Through the activity: review relay with twelve items sorted into the three columns

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: review relay with twelve items sorted into the three columns, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | I expect rain because I remember the forecast. |
| **Non-example** | I expect rain because I just know — no source named. |
...
> "Next time: the word that finishes an expectation."
...
**Exact wording.** "Write an unfinished expectation and ask whether it is finished."
...
**Target observation.** That expectations can be linked to a stated source.
...
> "Because links the expectation to what produced it. You just saw that when write an unfinished expectation and ask whether it is finished.
> Last time we said: Next time: the word that finishes an expectation. This is the next part of that.
...
**What students must not infer.** Whether the stated source is the real one.

### 4. Worked example

**The example.** I expect rain because I remember the forecast.
...
**Completed answer.** I expect rain because I remember the forecast. — which demonstrates that expectations can be linked to a stated source.
...
**Conclusions not licensed.** Whether the stated source is the real one.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. I expect the hall to be loud because it always is at lunch. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. I expect rain because I just know — no source named. Why is this not an
example?"
...
**Exact student instructions.** Five of their own expectations, each completed with because.
...
- *Licensed conclusion.* That expectations can be linked to a stated source.
- *Not licensed.* Whether the stated source is the real one.
...
- *Expected response.* That expectations can be linked to a stated source.
...
1. Any wording carrying the idea in `Because links the expectation to what produced it`.
...
Say: "An expectation is not finished until you say because."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Expect Review |
| **Leads to** | Lesson 10 — Because Everywhere |

**Transition in.** Lesson 8 established students consolidate the quarter's work on expectation. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students join an expectation to its source. Lesson 10 assumes it and builds students apply because to expectations from other lessons.
