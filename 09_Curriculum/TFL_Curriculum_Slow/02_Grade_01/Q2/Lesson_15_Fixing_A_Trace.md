...
| | |
|---|---|
| **Central question** | Fixing A Trace: students repair a trace that was marked? |
| **Core concept** | Repair is a normal step, not a punishment. |
| **Student outcome** | Students repair a trace that was marked. |
| **Previous lesson** | Lesson 14 — Somebody Else's Trace |
| **Next lesson** | Lesson 16 — The Because Review |
...
**The conceptual step.** Repair is a normal step, not a punishment. A marked trace with a stated fix is stronger evidence of learning than an unmarked one.
...
**What depends on it.** Lesson 16 — The Because Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Repair is a normal step, not a punishment. A marked trace with a stated fix is stronger evidence of learning than an unmarked one.
...
1. Adding the missing memory to the because half.
2. Replacing a wish with a genuine expectation.

### One non-example

Arguing that the marker misread it, without changing anything.
...
That work improves through marked repair.

### What this activity does not establish

That the original was worthless.
...
| Statement | Status |
|---|---|
| Repair is a normal step, not a punishment. | Framework-derived, appropriate at this grade |
| That work improves through marked repair. | What this specific activity can show |
| That the original was worthless. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Somebody Else's Trace — specifically: students check a partner's trace.

**How it was taught.** Through the activity: each student checks a partner's five traces and marks the weakest

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: each student checks a partner's five traces and marks the weakest, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Adding the missing memory to the because half. |
| **Non-example** | Arguing that the marker misread it, without changing anything. |
...
> "Checking somebody else is how you learn to check yourself."
...
**Exact wording.** "Say: your trace came back marked. Today you fix it, not argue."
...
**Target observation.** That work improves through marked repair.
...
> "Repair is a normal step, not a punishment. You just saw that when say: your trace came back marked.
> Last time we said: Checking somebody else is how you learn to check yourself. This is the next part of that.
...
**What students must not infer.** That the original was worthless.

### 4. Worked example

**The example.** Adding the missing memory to the because half.
...
**Completed answer.** Adding the missing memory to the because half. — which demonstrates that work improves through marked repair.
...
**Conclusions not licensed.** That the original was worthless.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Replacing a wish with a genuine expectation. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Arguing that the marker misread it, without changing anything. Why is this not an
example?"
...
**Exact student instructions.** Each student repairs every marked trace and says what changed.
...
- *Licensed conclusion.* That work improves through marked repair.
- *Not licensed.* That the original was worthless.
...
- *Expected response.* That work improves through marked repair.
...
1. Any wording carrying the idea in `Repair is a normal step, not a punishment`.
...
Say: "Fixing is part of the work."
...
| | |
|---|---|
| **Follows** | Lesson 14 — Somebody Else's Trace |
| **Leads to** | Lesson 16 — The Because Review |

**Transition in.** Lesson 14 established students check a partner's trace. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students repair a trace that was marked. Lesson 16 assumes it and builds students consolidate tracing.
