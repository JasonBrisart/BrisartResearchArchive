...
| **Core concept** | A practice final is a diagnostic, not a verdict. |
| **Student outcome** | Students rehearse the final under conditions. |
| **Previous lesson** | Lesson 30 — The Year In Traces |
...
**The conceptual step.** A practice final is a diagnostic, not a verdict. Its purpose is to locate what needs review while there is still time to review it.
...
A practice final is a diagnostic, not a verdict. Its purpose is to locate what needs review while there is still time to review it.
...
1. A student identifies the because half as their weak point.
2. A student finds they cannot produce a second cycle.

### One non-example

Treating the practice score as the final grade.
...
Where each student's preparation is weakest.
...
| Statement | Status |
|---|---|
| A practice final is a diagnostic, not a verdict. | Framework-derived, appropriate at this grade |
| Where each student's preparation is weakest. | What this specific activity can show |
| What the final score will be. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 30 — The Year In Traces — specifically: students review the year using their own traces.

**How it was taught.** Through the activity: students order their own traces by term and mark how they changed

**Quick check.** Ask for the closing sentence of Lesson 30. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 30: students order their own traces by term and mark how they changed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student identifies the because half as their weak point. |
| **Non-example** | Treating the practice score as the final grade. |
...
> "Look at the difference between the first and the last."
...
**Exact wording.** "Say: same as the real one. Find out now what you need."
...
**Target observation.** Where each student's preparation is weakest.
...
> "A practice final is a diagnostic, not a verdict. You just saw that when say: same as the real one.
> Last time we said: Look at the difference between the first and the last. This is the next part of that.
...
**What students must not infer.** What the final score will be.

### 4. Worked example

**The example.** A student identifies the because half as their weak point.
...
**Completed answer.** A student identifies the because half as their weak point. — which demonstrates where each student's preparation is weakest.
...
**Conclusions not licensed.** What the final score will be.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student finds they cannot produce a second cycle. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Treating the practice score as the final grade. Why is this not an
example?"
...
- *Licensed conclusion.* Where each student's preparation is weakest.
- *Not licensed.* What the final score will be.
...
- *Expected response.* Where each student's preparation is weakest.
...
1. Any wording carrying the idea in `A practice final is a diagnostic, not a verdict`.
...
Say: "Now you know what to look at before next time."
...
| | |
|---|---|
| **Follows** | Lesson 30 — The Year In Traces |
