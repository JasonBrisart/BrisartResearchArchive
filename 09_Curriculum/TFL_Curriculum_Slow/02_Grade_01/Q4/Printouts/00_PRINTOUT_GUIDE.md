...
|---|---|---|---|---|---|---|
| `Lesson_25_Printout.md` | Lesson 25 — Putting It Together | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_26_Printout.md` | Lesson 26 — Checking Your Own | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 25 work |
| `Lesson_27_Printout.md` | Lesson 27 — It Goes Around | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 26 work |
| `Lesson_28_Printout.md` | Lesson 28 — Three Cycles | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 27 work |
| `Lesson_29_Printout.md` | Lesson 29 — Explaining The Loop | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 28 work |
| `Lesson_30_Printout.md` | Lesson 30 — The Year In Traces | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 29 work |
