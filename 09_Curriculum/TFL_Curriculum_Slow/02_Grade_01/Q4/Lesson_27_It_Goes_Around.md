...
| | |
|---|---|
| **Central question** | It Goes Around: students show the three parts repeating as a cycle? |
| **Core concept** | The second cycle must begin from the first cycle's outcome. |
| **Student outcome** | Students show the three parts repeating as a cycle. |
| **Previous lesson** | Lesson 26 — Checking Your Own |
| **Next lesson** | Lesson 28 — Three Cycles |
...
**The conceptual step.** The second cycle must begin from the first cycle's outcome. That join is what makes it a cycle rather than two separate traces.
...
**What depends on it.** Lesson 28 — Three Cycles — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The second cycle must begin from the first cycle's outcome. That join is what makes it a cycle rather than two separate traces.
...
1. Cycle two begins from what actually happened in cycle one.
2. A student points at the join without being asked.

### One non-example

Two complete traces about unrelated events.
...
That the outcome of one cycle starts the next.

### What this activity does not establish

The full inheritance idea, which is Grade 4.
...
| Statement | Status |
|---|---|
| The second cycle must begin from the first cycle's outcome. | Framework-derived, appropriate at this grade |
| That the outcome of one cycle starts the next. | What this specific activity can show |
| The full inheritance idea, which is Grade 4. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — Checking Your Own — specifically: students audit their own complete trace.

**How it was taught.** Through the activity: self-audit against a four-point checklist, with one repair made

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: self-audit against a four-point checklist, with one repair made, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Cycle two begins from what actually happened in cycle one. |
| **Non-example** | Two complete traces about unrelated events. |
...
> "You can check your own work now."
...
**Exact wording.** "Notebooks closed. Build the diagram from student contributions only."
...
**Target observation.** That the outcome of one cycle starts the next.
...
> "The second cycle must begin from the first cycle's outcome. You just saw that when notebooks closed.
> Last time we said: You can check your own work now. This is the next part of that.
...
**What students must not infer.** The full inheritance idea, which is Grade 4.

### 4. Worked example

**The example.** Cycle two begins from what actually happened in cycle one.
...
**Completed answer.** Cycle two begins from what actually happened in cycle one. — which demonstrates that the outcome of one cycle starts the next.
...
**Conclusions not licensed.** The full inheritance idea, which is Grade 4.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student points at the join without being asked. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two complete traces about unrelated events. Why is this not an
example?"
...
**Exact student instructions.** Add a second cycle under their Lesson 25 trace, starting from what happened.
...
- *Licensed conclusion.* That the outcome of one cycle starts the next.
- *Not licensed.* The full inheritance idea, which is Grade 4.
...
- *Expected response.* That the outcome of one cycle starts the next.
...
1. Any wording carrying the idea in `The second cycle must begin from the first cycle's outcome`.
...
| | |
|---|---|
| **Follows** | Lesson 26 — Checking Your Own |
| **Leads to** | Lesson 28 — Three Cycles |

**Transition in.** Lesson 26 established students audit their own complete trace. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students show the three parts repeating as a cycle. Lesson 28 assumes it and builds students extend the chain to three cycles.
