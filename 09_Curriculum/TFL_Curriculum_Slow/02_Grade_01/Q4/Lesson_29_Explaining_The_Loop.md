...
| | |
|---|---|
| **Central question** | Explaining The Loop: students explain the cycle to somebody who was not there? |
| **Core concept** | The listener's unanswerable question locates the gap the student cannot yet see. |
| **Student outcome** | Students explain the cycle to somebody who was not there. |
| **Previous lesson** | Lesson 28 — Three Cycles |
| **Next lesson** | Lesson 30 — The Year In Traces |
...
**The conceptual step.** The listener's unanswerable question locates the gap the student cannot yet see. That question is the output, not the explanation.
...
**What depends on it.** Lesson 30 — The Year In Traces — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The listener's unanswerable question locates the gap the student cannot yet see. That question is the output, not the explanation.
...
1. A listener asks where the first cycle started.
2. A listener asks what happens if you are asleep.

### One non-example

Reporting that the listener understood perfectly.
...
| Statement | Status |
|---|---|
| The listener's unanswerable question locates the gap the student cannot yet see. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 28 — Three Cycles — specifically: students extend the chain to three cycles.

**How it was taught.** Through the activity: a three-cycle trace on one real episode, each cycle inheriting

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: a three-cycle trace on one real episode, each cycle inheriting, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A listener asks where the first cycle started. |
| **Non-example** | Reporting that the listener understood perfectly. |
...
> "The further you go, the harder it gets. That is real."
...
> "The listener's unanswerable question locates the gap the student cannot yet see. You just saw that when say: today you teach it.
> Last time we said: The further you go, the harder it gets. That is real. This is the next part of that.
...
**The example.** A listener asks where the first cycle started.
...
**Completed answer.** A listener asks where the first cycle started. — which demonstrates where the student's understanding runs out.
...
**Teacher prompt.** "Here is a second case. A listener asks what happens if you are asleep. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reporting that the listener understood perfectly. Why is this not an
example?"
...
**Exact student instructions.** Each student explains the loop to a buddy or adult and records one question asked.
...
1. Any wording carrying the idea in `The listener's unanswerable question locates the gap the student cannot yet see`.
...
Say: "The question you could not answer is the useful bit."
...
| | |
|---|---|
| **Follows** | Lesson 28 — Three Cycles |
| **Leads to** | Lesson 30 — The Year In Traces |

**Transition in.** Lesson 28 established students extend the chain to three cycles. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain the cycle to somebody who was not there. Lesson 30 assumes it and builds students review the year using their own traces.
