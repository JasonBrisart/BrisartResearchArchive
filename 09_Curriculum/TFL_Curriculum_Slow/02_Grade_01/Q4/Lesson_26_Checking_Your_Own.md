...
| | |
|---|---|
| **Central question** | Checking Your Own: students audit their own complete trace? |
| **Core concept** | Self-auditing is harder than checking a partner because the writer knows what they meant. |
| **Student outcome** | Students audit their own complete trace. |
| **Previous lesson** | Lesson 25 — Putting It Together |
| **Next lesson** | Lesson 27 — It Goes Around |
...
**The conceptual step.** Self-auditing is harder than checking a partner because the writer knows what they meant. The checklist supplies the outside view.
...
**What depends on it.** Lesson 27 — It Goes Around — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Self-auditing is harder than checking a partner because the writer knows what they meant. The checklist supplies the outside view.
...
1. Finding a missing because in your own trace.
2. Finding a step that reasons from the outcome.

### One non-example

Reading it through and declaring it fine.
...
That self-checking is possible with a checklist.

### What this activity does not establish

That the repaired trace is now correct.
...
| Statement | Status |
|---|---|
| Self-auditing is harder than checking a partner because the writer knows what they meant. | Framework-derived, appropriate at this grade |
| That self-checking is possible with a checklist. | What this specific activity can show |
| That the repaired trace is now correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — Putting It Together — specifically: students produce a complete traced expectation unaided.

**How it was taught.** Through the activity: two complete traces about real events, unaided

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: two complete traces about real events, unaided, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Finding a missing because in your own trace. |
| **Non-example** | Reading it through and declaring it fine. |
...
> "You can do the whole thing now."
...
**Exact wording.** "Ask them to read theirs as if somebody else wrote it and find what is missing."
...
**Target observation.** That self-checking is possible with a checklist.
...
> "Self-auditing is harder than checking a partner because the writer knows what they meant. You just saw that when ask them to read theirs as if somebody else wrote it and find what is missing.
> Last time we said: You can do the whole thing now. This is the next part of that.
...
**What students must not infer.** That the repaired trace is now correct.

### 4. Worked example

**The example.** Finding a missing because in your own trace.
...
**Completed answer.** Finding a missing because in your own trace. — which demonstrates that self-checking is possible with a checklist.
...
**Conclusions not licensed.** That the repaired trace is now correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Finding a step that reasons from the outcome. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reading it through and declaring it fine. Why is this not an
example?"
...
**Exact student instructions.** Self-audit against a four-point checklist, with one repair made.
...
- *Licensed conclusion.* That self-checking is possible with a checklist.
- *Not licensed.* That the repaired trace is now correct.
...
- *Expected response.* That self-checking is possible with a checklist.
...
1. Any wording carrying the idea in `Self-auditing is harder than checking a partner because the writer knows what they meant`.
...
Say: "You can check your own work now."
...
| | |
|---|---|
| **Follows** | Lesson 25 — Putting It Together |
| **Leads to** | Lesson 27 — It Goes Around |

**Transition in.** Lesson 25 established students produce a complete traced expectation unaided. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit their own complete trace. Lesson 27 assumes it and builds students show the three parts repeating as a cycle.
