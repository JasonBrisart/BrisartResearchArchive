...
**Doctoral Year 2** · Original Critique · **Quarter 4** · **3 hours**
...
| **Core concept** | Originality is defended by demonstrating that the specification does not address the point, not by asserting that the critique is novel. |
| **Student outcome** | Participants rehearse against four challengers. |
| **Previous seminar** | Seminar 13 — External Reading |
| **Next seminar** | Seminar 15 — Critique Defence |
...
**The conceptual step.** Originality is defended by demonstrating that the specification does not address the point, not by asserting that the critique is novel.
...
**What depends on it.** Seminar 15 — Critique Defence — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Originality is defended by demonstrating that the specification does not address the point, not by asserting that the critique is novel.
...
1. A demonstration that the specification is silent on the point.
2. A recorded list of three unanswered questions.

### One non-example

An assertion that the critique is original.
...
That originality claims require demonstration.

### What this activity does not establish

Whether the critique is original.
...
| Statement | Status |
|---|---|
| Originality is defended by demonstrating that the specification does not address the point, not by asserting that the critique is novel. | Framework-derived, appropriate at this grade |
| That originality claims require demonstration. | What this specific activity can show |
| Whether the critique is original. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 13 — External Reading — specifically: participants have the paper read by somebody outside the seminar.

**How it was taught.** Through the activity: external read with every question recorded and addressed

**Quick check.** Ask for the closing sentence of Seminar 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 13: external read with every question recorded and addressed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A demonstration that the specification is silent on the point. |
| **Non-example** | An assertion that the critique is original. |
...
> "The outside reader finds what the room has stopped seeing."
...
**Exact wording.** "Assign four roles: the framework's advocate, evidence, originality, and proportion."
...
**Target observation.** That originality claims require demonstration.
...
> "Originality is defended by demonstrating that the specification does not address the point, not by asserting that the critique is novel. You just saw that when assign four roles: the framework's advocate, evidence, originality, and proportion.
> Last time we said: The outside reader finds what the room has stopped seeing. This is the next part of that.
...
**What students must not infer.** Whether the critique is original.

### 4. Worked example

**The example.** A demonstration that the specification is silent on the point.
...
**Completed answer.** A demonstration that the specification is silent on the point. — which demonstrates that originality claims require demonstration.
...
**Conclusions not licensed.** Whether the critique is original.
...
**Teacher prompt.** "Now one that does not work. An assertion that the critique is original. Why is this not an
example?"
...
- *Licensed conclusion.* That originality claims require demonstration.
- *Not licensed.* Whether the critique is original.
...
- *Expected response.* That originality claims require demonstration.
...
1. Any wording carrying the idea in `Originality is defended by demonstrating that the specification does not address the point, not by asserting that the critique is novel`.
...
| | |
|---|---|
| **Follows** | Seminar 13 — External Reading |
| **Leads to** | Seminar 15 — Critique Defence |

**Transition in.** Seminar 13 established participants have the paper read by somebody outside the seminar. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants rehearse against four challengers. Seminar 15 assumes it and builds participants defend the critique against the framework's advocate.
