# Seminar 13 Homework — External Reading

**Doctoral Year 2** · Original Critique · **Quarter 4**
**Follows:** Seminar 13 — External Reading · **Points:** 5 · **Optional:** yes
...
External read with every question recorded and addressed.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every paper is read by somebody outside the seminar
...
Seminar 14 is **Rehearsing The Defence**, which assumes you arrive holding it. Write one thing you expect it to be about:
