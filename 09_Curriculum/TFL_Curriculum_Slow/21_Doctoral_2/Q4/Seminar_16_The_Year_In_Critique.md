# Seminar 16 — The Year In Critique
...
| | |
|---|---|
| **Central question** | The Year In Critique: participants review the year's collective critique work? |
| **Core concept** | A cohort critique register is a genuine contribution rather than a course artifact, and circulation should be considered explicitly. |
| **Student outcome** | Participants review the year's collective critique work. |
| **Previous seminar** | Seminar 15 — Critique Defence |
...
**The conceptual step.** A cohort critique register is a genuine contribution rather than a course artifact, and circulation should be considered explicitly.
...
A cohort critique register is a genuine contribution rather than a course artifact, and circulation should be considered explicitly.
...
1. A register classifying each paper by form and target.
2. A discussion of which papers are submittable.

### One non-example

A register filed as coursework with no circulation discussed.
...
That cohort critique constitutes a contribution.

### What this activity does not establish

Whether the critiques are correct.
...
| Statement | Status |
|---|---|
| A cohort critique register is a genuine contribution rather than a course artifact, and circulation should be considered explicitly. | Framework-derived, appropriate at this grade |
| That cohort critique constitutes a contribution. | What this specific activity can show |
| Whether the critiques are correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 15 — Critique Defence — specifically: participants defend the critique against the framework's advocate.

**How it was taught.** Through the activity: ten minutes presenting, ten defending, against four challengers

**Quick check.** Ask for the closing sentence of Seminar 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 15: ten minutes presenting, ten defending, against four challengers, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A register classifying each paper by form and target. |
| **Non-example** | A register filed as coursework with no circulation discussed. |
...
> "Next year you referee other people's work and the failure mode reverses."
...
**Exact wording.** "Put every critique from the cohort on one board, summarised."
...
**Target observation.** That cohort critique constitutes a contribution.
...
> "A cohort critique register is a genuine contribution rather than a course artifact, and circulation should be considered explicitly. You just saw that when put every critique from the cohort on one board, summarised.
> Last time we said: Next year you referee other people's work and the failure mode reverses. This is the next part of that.
...
**What students must not infer.** Whether the critiques are correct.

### 4. Worked example

**The example.** A register classifying each paper by form and target.
...
**Completed answer.** A register classifying each paper by form and target. — which demonstrates that cohort critique constitutes a contribution.
...
**Conclusions not licensed.** Whether the critiques are correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A discussion of which papers are submittable. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A register filed as coursework with no circulation discussed. Why is this not an
example?"
...
**Exact student instructions.** Build the cohort's critique register with each paper's primary form and target.
...
- *Licensed conclusion.* That cohort critique constitutes a contribution.
- *Not licensed.* Whether the critiques are correct.
...
- *Expected response.* That cohort critique constitutes a contribution.
...
1. Any wording carrying the idea in `A cohort critique register is a genuine contribution rather than a course artifact, and circulation should be considered explicitly`.
...
Say: "Next year: judging whether other people's work supports what it claims."
...
| | |
|---|---|
| **Follows** | Seminar 15 — Critique Defence |
| **Leads to** | The final examination. |

**Transition in.** Seminar 15 established participants defend the critique against the framework's advocate. This seminar uses that as the starting point.
