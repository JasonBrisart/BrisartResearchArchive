...
| | |
|---|---|
| **Central question** | Critique Defence: participants defend the critique against the framework's advocate? |
| **Core concept** | The critique defence requires originality and proportion to be defended specifically against assigned challengers. |
| **Student outcome** | Participants defend the critique against the framework's advocate. |
| **Previous seminar** | Seminar 14 — Rehearsing The Defence |
| **Next seminar** | Seminar 16 — The Year In Critique |
...
**The conceptual step.** The critique defence requires originality and proportion to be defended specifically against assigned challengers.
...
**What depends on it.** Seminar 16 — The Year In Critique — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The critique defence requires originality and proportion to be defended specifically against assigned challengers.
...
1. A defence demonstrating originality against the specification.
2. A defence conceding proportion and revising the assessment.

### One non-example

A defence asserting originality without demonstration.
...
Whether the critique can be defended.
...
| Statement | Status |
|---|---|
| The critique defence requires originality and proportion to be defended specifically against assigned challengers. | Framework-derived, appropriate at this grade |
| Whether the critique can be defended. | What this specific activity can show |
...
| **Correct example** | A defence demonstrating originality against the specification. |
| **Non-example** | A defence asserting originality without demonstration. |
...
**Exact wording.** "Say: target, critique, evidence, defence, response, closure, assessment. Then questions."
...
**Target observation.** Whether the critique can be defended.
...
> "The critique defence requires originality and proportion to be defended specifically against assigned challengers. You just saw that when say: target, critique, evidence, defence, response, closure, assessment.
...
**The example.** A defence demonstrating originality against the specification.
...
**Completed answer.** A defence demonstrating originality against the specification. — which demonstrates whether the critique can be defended.
...
**Teacher prompt.** "Here is a second case. A defence conceding proportion and revising the assessment. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence asserting originality without demonstration. Why is this not an
example?"
...
**Exact student instructions.** Ten minutes presenting, ten defending, against four challengers.
...
- *Licensed conclusion.* Whether the critique can be defended.
...
- *Expected response.* Whether the critique can be defended.
...
1. Any wording carrying the idea in `The critique defence requires originality and proportion to be defended specifically against assigned challengers`.
...
Say: "Next year you referee other people's work and the failure mode reverses."
...
| **Leads to** | Seminar 16 — The Year In Critique |
...
**Transition out.** This seminar establishes participants defend the critique against the framework's advocate. Seminar 16 assumes it and builds participants review the year's collective critique work.
