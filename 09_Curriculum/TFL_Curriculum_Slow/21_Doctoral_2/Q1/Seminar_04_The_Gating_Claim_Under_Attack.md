# Seminar 4 — The Gating Claim Under Attack

**Doctoral Year 2** · Original Critique · **Quarter 1** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Gating Claim Under Attack: participants subject the most exposed claim to structured attack? |
| **Core concept** | The gating claim is the framework's most exposed commitment. |
| **Student outcome** | Participants subject the most exposed claim to structured attack. |
| **Previous seminar** | Seminar 3 — Evidence For A Critique |
| **Next seminar** | Seminar 5 — Measurement At Publication Standard |
...
**The conceptual step.** The gating claim is the framework's most exposed commitment. Whether the mediation defence is principled or an unfalsifiable rescue turns on whether within-window and propagated effects can be distinguished.
...
**What depends on it.** Seminar 5 — Measurement At Publication Standard — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The gating claim is the framework's most exposed commitment. Whether the mediation defence is principled or an unfalsifiable rescue turns on whether within-window and propagated effects can be distinguished.
...
1. A sketch attempting the within-window distinction.
2. A recorded finding that the room could not specify the evidence.
...
That the charge is live and its resolution specifiable.
...
| Statement | Status |
|---|---|
| The gating claim is the framework's most exposed commitment. | Framework-derived, appropriate at this grade |
| That the charge is live and its resolution specifiable. | What this specific activity can show |
| Whether the defence is principled. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 3 — Evidence For A Critique — specifically: participants support every claim with a location or citation.

**How it was taught.** Through the activity: audit their draft for unsupported claims and supply evidence or delete

**Quick check.** Ask for the closing sentence of Seminar 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 3: audit their draft for unsupported claims and supply evidence or delete, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A sketch attempting the within-window distinction. |
...
**Exact wording.** "Assign three groups: empirical case, mediation defence, unfalsifiability charge."
...
**Target observation.** That the charge is live and its resolution specifiable.
...
> "The gating claim is the framework's most exposed commitment. You just saw that when assign three groups: empirical case, mediation defence, unfalsifiability charge.
...
**The example.** A sketch attempting the within-window distinction.
...
**Completed answer.** A sketch attempting the within-window distinction. — which demonstrates that the charge is live and its resolution specifiable.
...
**Teacher prompt.** "Here is a second case. A recorded finding that the room could not specify the evidence. Work it through with me."
...
**Exact student instructions.** Write the deciding design sketch with the distinguishing line.
...
- *Licensed conclusion.* That the charge is live and its resolution specifiable.
...
- *Expected response.* That the charge is live and its resolution specifiable.
...
1. Any wording carrying the idea in `The gating claim is the framework's most exposed commitment`.
...
Say: "If the room cannot specify the evidence, report that as the finding."
...
| | |
|---|---|
| **Follows** | Seminar 3 — Evidence For A Critique |
| **Leads to** | Seminar 5 — Measurement At Publication Standard |

**Transition in.** Seminar 3 established participants support every claim with a location or citation. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants subject the most exposed claim to structured attack. Seminar 5 assumes it and builds participants apply reviewer-level objections to their own work.
