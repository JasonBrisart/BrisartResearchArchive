...
**Doctoral Year 2** · Original Critique

Every seminar in this quarter has one matching student printout. Distribute
it **before the hook** so students can record their initial thinking before any
explanation is given.

## What is here

| Printout | Matching seminar | Pages | Distribute | Student action | After | Prior data |
|---|---|---|---|---|---|---|
| `Seminar_01_Printout.md` | Seminar 1 — What Makes A Critique Original | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Seminar_02_Printout.md` | Seminar 2 — Stating The Target Fairly | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 1 work |
| `Seminar_03_Printout.md` | Seminar 3 — Evidence For A Critique | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 2 work |
| `Seminar_04_Printout.md` | Seminar 4 — The Gating Claim Under Attack | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 3 work |

## When to distribute

Always before the hook. The *What I think before the seminar* section is only
...
| What I think before the seminar | Before any explanation |
...
## The pivot seminar of this quarter

**Seminar 3 — Evidence For A Critique.** If you only have time to print one
