# Seminar 2 Homework — Stating The Target Fairly

**Doctoral Year 2** · Original Critique · **Quarter 1**
**Follows:** Seminar 2 — Stating The Target Fairly · **Points:** 5 · **Optional:** yes
...
Write the sentence Seminar 2 ended on, from memory:
...
Target statements checked by the participant assigned to defend the framework.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every target passes an external fairness check
...
Seminar 3 is **Evidence For A Critique**, which assumes you arrive holding it. Write one thing you expect it to be about:
