# Seminar 3 — Evidence For A Critique
...
| | |
|---|---|
| **Central question** | Evidence For A Critique: participants support every claim with a location or citation? |
| **Core concept** | Every claim in a critique requires a location or citation. |
| **Student outcome** | Participants support every claim with a location or citation. |
| **Previous seminar** | Seminar 2 — Stating The Target Fairly |
| **Next seminar** | Seminar 4 — The Gating Claim Under Attack |
...
**The conceptual step.** Every claim in a critique requires a location or citation. Background claims are claims, and deleting an unsupportable one strengthens the critique.
...
**What depends on it.** Seminar 4 — The Gating Claim Under Attack — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every claim in a critique requires a location or citation. Background claims are claims, and deleting an unsupportable one strengthens the critique.
...
An unsupported claim retained as contextual framing.
...
**Prerequisite.** The content of Seminar 2 — Stating The Target Fairly — specifically: participants render the framework's position in its strongest form.

**How it was taught.** Through the activity: target statements checked by the participant assigned to defend the framework

**Quick check.** Ask for the closing sentence of Seminar 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 2: target statements checked by the participant assigned to defend the framework, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | An unsupported claim retained as contextual framing. |
...
> "The defender's acceptance is the test, not your intent."
...
> Last time we said: The defender's acceptance is the test, not your intent. This is the next part of that.
...
**Teacher prompt.** "Now one that does not work. An unsupported claim retained as contextual framing. Why is this not an
example?"
...
**Exact student instructions.** Audit their draft for unsupported claims and supply evidence or delete.
...
| | |
|---|---|
| **Follows** | Seminar 2 — Stating The Target Fairly |
| **Leads to** | Seminar 4 — The Gating Claim Under Attack |

**Transition in.** Seminar 2 established participants render the framework's position in its strongest form. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants support every claim with a location or citation. Seminar 4 assumes it and builds participants subject the most exposed claim to structured attack.
