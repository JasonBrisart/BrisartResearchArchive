# Seminar 9 Homework — Revising After Workshop

**Doctoral Year 2** · Original Critique · **Quarter 3**
**Follows:** Seminar 9 — Revising After Workshop · **Points:** 5 · **Optional:** yes
...
Revise the paper and log every change against a reader comment.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every change is logged against a comment
...
Seminar 10 is **The Closure Path**, which assumes you arrive holding it. Write one thing you expect it to be about:
