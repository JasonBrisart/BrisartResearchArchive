# Seminar 10 — The Closure Path

**Doctoral Year 2** · Original Critique · **Quarter 3** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Closure Path: participants specify what would resolve the issue raised? |
| **Core concept** | A closure path names actionable work, distinguishes theoretical from empirical requirements, and states what would be known afterwards. |
| **Student outcome** | Participants specify what would resolve the issue raised. |
| **Previous seminar** | Seminar 9 — Revising After Workshop |
| **Next seminar** | Seminar 11 — Proportionate Assessment |
| **Materials** | Discipline readings; specimen manuscripts |
...
**The conceptual step.** A closure path names actionable work, distinguishes theoretical from empirical requirements, and states what would be known afterwards.

**Why students need it now.** This grade owns one idea: original critique to publishable standard, with a fairly stated defence.
...
that a critique is a list of things I dislike. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Critique must be publishable in form, not merely correct. The anticipated defence must be checked by somebody sympathetic to the framework.

**What depends on it.** Seminar 11 — Proportionate Assessment — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A closure path names actionable work, distinguishes theoretical from empirical requirements, and states what would be known afterwards.

### How this is stated at this grade

Critique must be publishable in form, not merely correct. The anticipated defence must be checked by somebody sympathetic to the framework.

Use only the vocabulary released at or before this grade. Terms not yet available:
Referee reports on manuscripts, adjudication proposals, governance.

### Why the concept matters

The whole grade rests on original critique to publishable standard, with a fairly stated defence. If a student leaves this
...
1. A path requiring theoretical specification, with the specification named.
2. A path requiring an empirical study with a named design.

### One non-example

A path stating that further investigation is warranted.
...
| Statement | Status |
|---|---|
| A closure path names actionable work, distinguishes theoretical from empirical requirements, and states what would be known afterwards. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Seminar 9 — Revising After Workshop — specifically: participants revise against workshop findings.

**How it was taught.** Through the activity: revise the paper and log every change against a reader comment

**Quick check.** Ask for the closing sentence of Seminar 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 9: revise the paper and log every change against a reader comment, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | a gap that prevents testing, documented. |
| **Student wording** | A gap that prevents testing, documented. |
| **Correct example** | A path requiring theoretical specification, with the specification named. |
| **Non-example** | A path stating that further investigation is warranted. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a gap that prevents testing, documented." |

### structural critique

| | |
|---|---|
| **Teacher definition** | an internal tension between two commitments. |
| **Student wording** | An internal tension between two commitments. |
| **Correct example** | A path requiring theoretical specification, with the specification named. |
| **Non-example** | A path stating that further investigation is warranted. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for an internal tension between two commitments." |

### adjudication critique

| | |
|---|---|
| **Teacher definition** | a rival the framework cannot be separated from. |
| **Student wording** | A rival the framework cannot be separated from. |
| **Correct example** | A path requiring theoretical specification, with the specification named. |
| **Non-example** | A path stating that further investigation is warranted. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a rival the framework cannot be separated from." |


Do not introduce terminology from later grades. Referee reports on manuscripts, adjudication proposals, governance.

## Materials and preparation

**Teacher materials.** Discipline readings; Specimen manuscripts; The audit documents from Year 1; Whiteboard.
...
> "The gap is the finding, not the readers' failure."
...
**Exact wording.** "Say: a critique that identifies a problem without a resolution is a complaint with citations."
...
> "A closure path names actionable work, distinguishes theoretical from empirical requirements, and states what would be known afterwards. You just saw that when say: a critique that identifies a problem without a resolution is a complaint with citations.
> Last time we said: The gap is the finding, not the readers' failure. This is the next part of that.
> It matters because restating that the framework is unvalidated is not a critique"
...
**Terminology to introduce here.** specification critique, structural critique, adjudication critique.

**What students must not infer.** Whether the path would succeed.

### 4. Worked example

**The example.** A path requiring theoretical specification, with the specification named.
...
**Completed answer.** A path requiring theoretical specification, with the specification named. — which demonstrates that critiques can specify their own resolution.
...
**Teacher prompt.** "Now one that does not work. A path stating that further investigation is warranted. Why is this not an
example?"
...
3. **Misconception check.** Somebody says: "A critique is a list of things I dislike" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `A closure path names actionable work, distinguishes theoretical from empirical requirements, and states what would be known afterwards`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: What does this stop somebody from testing?

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "The closure path is what makes it research."
...
### 1. "A critique is a list of things I dislike"

**What the student says or does.** A critique is a list of things I dislike — usually while otherwise engaging well.

**Why it is understandable.** Criticism is the everyday meaning of the word.
...
**Exact correction.** Apply the originality test.

**Say this.** "What does this stop somebody from testing?"
...
### 2. "The anticipated defence should be easy to beat"

**What the student says or does.** The anticipated defence should be easy to beat — usually while otherwise engaging well.

**Why it is understandable.** Authors construct the defence they can answer.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Require external checking by somebody sympathetic.

**Say this.** "Constructing a weak defence is the commonest failure in critique writing."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "Conceding means I failed"

**What the student says or does.** Conceding means I failed — usually while otherwise engaging well.

**Why it is understandable.** Concession reads as losing.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Score it identically to rebuttal and say so publicly.

**Say this.** "A narrowed surviving critique beats an overreaching one."
...
**Visual or physical support.** Provide a worked critique in each of the three forms from another framework.
...
Ask them to submit the critique for comment outside the seminar.
...
Specifically, do not introduce: Referee reports on manuscripts, adjudication proposals, governance.
...
| | |
|---|---|
| **Follows** | Seminar 9 — Revising After Workshop |
| **Leads to** | Seminar 11 — Proportionate Assessment |

**Transition in.** Seminar 9 established participants revise against workshop findings. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants specify what would resolve the issue raised. Seminar 11 assumes it and builds participants match the verdict to the critique's scope.
