...
|---|---|---|---|---|---|---|
| `Seminar_05_Printout.md` | Seminar 5 — Measurement At Publication Standard | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Seminar_06_Printout.md` | Seminar 6 — The Anticipated Defence | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 5 work |
| `Seminar_07_Printout.md` | Seminar 7 — Responding Or Conceding | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 6 work |
| `Seminar_08_Printout.md` | Seminar 8 — The Critique Workshop | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 7 work |
...
**Seminar 7 — Responding Or Conceding.** If you only have time to print one
