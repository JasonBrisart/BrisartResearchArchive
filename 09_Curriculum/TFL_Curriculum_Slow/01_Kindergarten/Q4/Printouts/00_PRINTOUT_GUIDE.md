...
|---|---|---|---|---|---|---|
| `Lesson_25_Printout.md` | Lesson 25 — The Sound That Stops | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_26_Printout.md` | Lesson 26 — What Stuck | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 25 work |
| `Lesson_27_Printout.md` | Lesson 27 — Notice, Remember, Guess | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 26 work |
| `Lesson_28_Printout.md` | Lesson 28 — Around Again | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 27 work |
| `Lesson_29_Printout.md` | Lesson 29 — The Guess Jar Opens | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 28 work |
| `Lesson_30_Printout.md` | Lesson 30 — Teaching Somebody Else | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 29 work |
| `Lesson_31_Printout.md` | Lesson 31 — The Year Review | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 30 work |
| `Lesson_32_Printout.md` | Lesson 32 — Show What You Know | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 31 work |
...
**Lesson 29 — The Guess Jar Opens.** If you only have time to print one
