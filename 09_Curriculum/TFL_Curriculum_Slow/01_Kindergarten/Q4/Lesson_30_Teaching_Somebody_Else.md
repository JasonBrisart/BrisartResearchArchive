# Lesson 30 — Teaching Somebody Else
...
| | |
|---|---|
| **Central question** | Teaching Somebody Else: children explain the three parts to another person? |
| **Core concept** | Explaining unsupported is the terminal check. |
| **Student outcome** | Children explain the three parts to another person. |
| **Previous lesson** | Lesson 29 — The Guess Jar Opens |
| **Next lesson** | Lesson 31 — The Year Review |
...
**The conceptual step.** Explaining unsupported is the terminal check. The listener's question reveals the gap the child cannot yet fill.
...
**What depends on it.** Lesson 31 — The Year Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Explaining unsupported is the terminal check. The listener's question reveals the gap the child cannot yet fill.
...
1. A child explains all three with examples.
2. A child answers the listener's follow-up.

### One non-example

A child who names the three words with no examples.
...
Whether the child can produce all three unsupported.
...
| Statement | Status |
|---|---|
| Explaining unsupported is the terminal check. | Framework-derived, appropriate at this grade |
| Whether the child can produce all three unsupported. | What this specific activity can show |
| Fluency of delivery. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 29 — The Guess Jar Opens — specifically: children check the long-interval guess from Lesson 19.

**How it was taught.** Through the activity: count the buttons. Compare every recorded guess

**Quick check.** Ask for the closing sentence of Lesson 29. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 29: count the buttons. Compare every recorded guess, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child explains all three with examples. |
| **Non-example** | A child who names the three words with no examples. |
...
> "You made that guess ten weeks ago and it was still waiting."
...
**Exact wording.** "Tell them today they teach it."
...
**Target observation.** Whether the child can produce all three unsupported.
...
> "Explaining unsupported is the terminal check. You just saw that when tell them today they teach it.
> Last time we said: You made that guess ten weeks ago and it was still waiting. This is the next part of that.
...
**What students must not infer.** Fluency of delivery.

### 4. Worked example

**The example.** A child explains all three with examples.
...
**Completed answer.** A child explains all three with examples. — which demonstrates whether the child can produce all three unsupported.
...
**Conclusions not licensed.** Fluency of delivery.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child answers the listener's follow-up. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who names the three words with no examples. Why is this not an
example?"
...
**Exact student instructions.** Each child explains notice, remember, guess to a buddy or visiting adult.
...
- *Licensed conclusion.* Whether the child can produce all three unsupported.
- *Not licensed.* Fluency of delivery.
...
- *Expected response.* Whether the child can produce all three unsupported.
...
1. Any wording carrying the idea in `Explaining unsupported is the terminal check`.
...
Say: "If you can say it to somebody else, you have it."
...
| | |
|---|---|
| **Follows** | Lesson 29 — The Guess Jar Opens |
| **Leads to** | Lesson 31 — The Year Review |

**Transition in.** Lesson 29 established children check the long-interval guess from Lesson 19. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children explain the three parts to another person. Lesson 31 assumes it and builds children review the whole year with their own work.
