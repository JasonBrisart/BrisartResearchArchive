# Lesson 28 Homework — Around Again

**Kindergarten** · Noticing and Remembering · **Quarter 4**
**Follows:** Lesson 28 — Around Again · **Points:** 5 · **Optional:** yes
...
Floor triangle walked twice, second lap starting from the guess just made.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every group walks the second lap and can say why
...
Lesson 29 is **The Guess Jar Opens**, which assumes you arrive holding it. Write one thing you expect it to be about:
