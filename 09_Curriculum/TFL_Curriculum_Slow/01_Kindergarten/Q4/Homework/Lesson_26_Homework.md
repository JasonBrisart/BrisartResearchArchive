# Lesson 26 Homework — What Stuck

**Kindergarten** · Noticing and Remembering · **Quarter 4**
**Follows:** Lesson 26 — What Stuck · **Points:** 5 · **Optional:** yes
...
Two-column drawing: STUCK and GONE, with a reason for the stuck one.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** each child names a stuck and a gone thing
...
Lesson 27 is **Notice, Remember, Guess**, which assumes you arrive holding it. Write one thing you expect it to be about:
