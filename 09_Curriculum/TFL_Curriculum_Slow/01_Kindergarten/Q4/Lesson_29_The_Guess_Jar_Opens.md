...
| | |
|---|---|
| **Central question** | The Guess Jar Opens: children check the long-interval guess from Lesson 19? |
| **Core concept** | A ten-week-old guess can still be checked because it was recorded. |
| **Student outcome** | Children check the long-interval guess from Lesson 19. |
| **Previous lesson** | Lesson 28 — Around Again |
| **Next lesson** | Lesson 30 — Teaching Somebody Else |
...
**The conceptual step.** A ten-week-old guess can still be checked because it was recorded. The record, not the child's memory, preserves it.
...
**What depends on it.** Lesson 30 — Teaching Somebody Else — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A ten-week-old guess can still be checked because it was recorded. The record, not the child's memory, preserves it.
...
1. A child compares their fifty against the real forty-two.
2. A child is surprised by how far off they were.

### One non-example

Asking children to recall their guess without the record.
...
That recorded guesses survive long intervals.
...
| Statement | Status |
|---|---|
| A ten-week-old guess can still be checked because it was recorded. | Framework-derived, appropriate at this grade |
| That recorded guesses survive long intervals. | What this specific activity can show |
| Estimation skill. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — Around Again — specifically: children show the three parts repeating.

**How it was taught.** Through the activity: floor triangle walked twice, second lap starting from the guess just made

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: floor triangle walked twice, second lap starting from the guess just made, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child compares their fifty against the real forty-two. |
| **Non-example** | Asking children to recall their guess without the record. |
...
> "It does not stop when you leave."
...
**Exact wording.** "Bring out the jar and count the buttons together."
...
**Target observation.** That recorded guesses survive long intervals.
...
> "A ten-week-old guess can still be checked because it was recorded. You just saw that when bring out the jar and count the buttons together.
> Last time we said: It does not stop when you leave. This is the next part of that.
...
**What students must not infer.** Estimation skill.

### 4. Worked example

**The example.** A child compares their fifty against the real forty-two.
...
**Completed answer.** A child compares their fifty against the real forty-two. — which demonstrates that recorded guesses survive long intervals.
...
**Conclusions not licensed.** Estimation skill.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child is surprised by how far off they were. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Asking children to recall their guess without the record. Why is this not an
example?"
...
**Exact student instructions.** Count the buttons. Compare every recorded guess.
...
- *Licensed conclusion.* That recorded guesses survive long intervals.
- *Not licensed.* Estimation skill.
...
- *Expected response.* That recorded guesses survive long intervals.
...
1. Any wording carrying the idea in `A ten-week-old guess can still be checked because it was recorded`.
...
Say: "You made that guess ten weeks ago and it was still waiting."
...
| | |
|---|---|
| **Follows** | Lesson 28 — Around Again |
| **Leads to** | Lesson 30 — Teaching Somebody Else |

**Transition in.** Lesson 28 established children show the three parts repeating. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children check the long-interval guess from Lesson 19. Lesson 30 assumes it and builds children explain the three parts to another person.
