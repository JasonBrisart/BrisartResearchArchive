# Lesson 27 — Notice, Remember, Guess
...
| | |
|---|---|
| **Central question** | Notice, Remember, Guess: children use all three parts on one real event? |
| **Core concept** | The three parts occur together in every real moment. |
| **Student outcome** | Children use all three parts on one real event. |
| **Previous lesson** | Lesson 26 — What Stuck |
| **Next lesson** | Lesson 28 — Around Again |
...
**The conceptual step.** The three parts occur together in every real moment. Connection between the boxes is what distinguishes a trace from a list.
...
**What depends on it.** Lesson 28 — Around Again — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The three parts occur together in every real moment. Connection between the boxes is what distinguishes a trace from a list.
...
1. Saw the coats, remembered outdoor play, guessed we go outside.
2. Heard the bell, remembered lunch, guessed we line up.

### One non-example

Three pictures with nothing linking them.
...
That the three parts co-occur and connect.

### What this activity does not establish

Any ordering claim about which comes first.
...
| Statement | Status |
|---|---|
| The three parts occur together in every real moment. | Framework-derived, appropriate at this grade |
| That the three parts co-occur and connect. | What this specific activity can show |
| Any ordering claim about which comes first. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — What Stuck — specifically: children separate what stayed from what faded.

**How it was taught.** Through the activity: two-column drawing: STUCK and GONE, with a reason for the stuck one

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: two-column drawing: STUCK and GONE, with a reason for the stuck one, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Saw the coats, remembered outdoor play, guessed we go outside. |
| **Non-example** | Three pictures with nothing linking them. |
...
> "It stuck because it mattered, not because you were right."
...
**Exact wording.** "Model it on a real moment from this morning, saying each part aloud."
...
**Target observation.** That the three parts co-occur and connect.
...
> "The three parts occur together in every real moment. You just saw that when model it on a real moment from this morning, saying each part aloud.
> Last time we said: It stuck because it mattered, not because you were right. This is the next part of that.
...
**What students must not infer.** Any ordering claim about which comes first.

### 4. Worked example

**The example.** Saw the coats, remembered outdoor play, guessed we go outside.
...
**Completed answer.** Saw the coats, remembered outdoor play, guessed we go outside. — which demonstrates that the three parts co-occur and connect.
...
**Conclusions not licensed.** Any ordering claim about which comes first.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Heard the bell, remembered lunch, guessed we line up. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Three pictures with nothing linking them. Why is this not an
example?"
...
**Exact student instructions.** Every child builds a three-box trace of their own morning, with arrows.
...
- *Licensed conclusion.* That the three parts co-occur and connect.
- *Not licensed.* Any ordering claim about which comes first.
...
- *Expected response.* That the three parts co-occur and connect.
...
1. Any wording carrying the idea in `The three parts occur together in every real moment`.
...
Say: "Three things happen every time."
...
| | |
|---|---|
| **Follows** | Lesson 26 — What Stuck |
| **Leads to** | Lesson 28 — Around Again |

**Transition in.** Lesson 26 established children separate what stayed from what faded. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children use all three parts on one real event. Lesson 28 assumes it and builds children show the three parts repeating.
