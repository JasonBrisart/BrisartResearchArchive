# Lesson 11 — Remembering Yesterday
...
| | |
|---|---|
| **Central question** | Remembering Yesterday: children retrieve something from a longer interval? |
| **Core concept** | Remembering spans longer intervals than a single session. |
| **Student outcome** | Children retrieve something from a longer interval. |
| **Previous lesson** | Lesson 10 — Two Different Jobs |
| **Next lesson** | Lesson 12 — Remembering A Song |
...
**The conceptual step.** Remembering spans longer intervals than a single session. Content from a week ago still returns unprompted.
...
**What depends on it.** Lesson 12 — Remembering A Song — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Remembering spans longer intervals than a single session. Content from a week ago still returns unprompted.
...
1. Three items recalled before the chart is uncovered.
2. A child recalls the card sort unprompted.

### One non-example

Reading the chart and then reporting — that is not recall.
...
That unprompted return happens across a week.
...
| Statement | Status |
|---|---|
| Remembering spans longer intervals than a single session. | Framework-derived, appropriate at this grade |
| That unprompted return happens across a week. | What this specific activity can show |
| Reliability of recall. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 10 — Two Different Jobs — specifically: children sort examples into noticing and remembering.

**How it was taught.** Through the activity: card sort in pairs: eight picture cards under NOTICE or REMEMBER

**Quick check.** Ask for the closing sentence of Lesson 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 10: card sort in pairs: eight picture cards under NOTICE or REMEMBER, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Three items recalled before the chart is uncovered. |
| **Non-example** | Reading the chart and then reporting — that is not recall. |
...
**Exact wording.** "Ask what they did last time without letting anybody look at the chart."
...
**Target observation.** That unprompted return happens across a week.
...
> "Remembering spans longer intervals than a single session. You just saw that when ask what they did last time without letting anybody look at the chart.
> Last time we said: Two jobs, both running at once. This is the next part of that.
...
**What students must not infer.** Reliability of recall.

### 4. Worked example

**The example.** Three items recalled before the chart is uncovered.
...
**Completed answer.** Three items recalled before the chart is uncovered. — which demonstrates that unprompted return happens across a week.
...
**Conclusions not licensed.** Reliability of recall.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child recalls the card sort unprompted. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reading the chart and then reporting — that is not recall. Why is this not an
example?"
...
**Exact student instructions.** Cold recall of the previous session, tallied, then checked against the chart.
...
- *Licensed conclusion.* That unprompted return happens across a week.
- *Not licensed.* Reliability of recall.
...
- *Expected response.* That unprompted return happens across a week.
...
1. Any wording carrying the idea in `Remembering spans longer intervals than a single session`.
...
Say: "Some things came back on their own, from a whole week ago."
...
| | |
|---|---|
| **Follows** | Lesson 10 — Two Different Jobs |
| **Leads to** | Lesson 12 — Remembering A Song |

**Transition in.** Lesson 10 established children sort examples into noticing and remembering. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children retrieve something from a longer interval. Lesson 12 assumes it and builds children notice that remembering can be automatic and complete.
