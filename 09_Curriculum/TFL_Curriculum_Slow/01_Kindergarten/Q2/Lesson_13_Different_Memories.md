...
| | |
|---|---|
| **Central question** | Different Memories: children discover people remember different things about the same event? |
| **Core concept** | Shared events produce different memories. |
| **Student outcome** | Children discover people remember different things about the same event. |
| **Previous lesson** | Lesson 12 — Remembering A Song |
| **Next lesson** | Lesson 14 — Where The Guess Comes From |
...
**The conceptual step.** Shared events produce different memories. This is the mechanism behind different guesses, which arrives next session.
...
**What depends on it.** Lesson 14 — Where The Guess Comes From — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Shared events produce different memories. This is the mechanism behind different guesses, which arrives next session.
...
1. One child recalls the story, the other the snack.
2. One child recalls being nervous, the other recalls the door.

### One non-example

Two children producing identical accounts.
...
That memories of one event differ between people.

### What this activity does not establish

Whether either memory is accurate.
...
| Statement | Status |
|---|---|
| Shared events produce different memories. | Framework-derived, appropriate at this grade |
| That memories of one event differ between people. | What this specific activity can show |
| Whether either memory is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — Remembering A Song — specifically: children notice that remembering can be automatic and complete.

**How it was taught.** Through the activity: four song fragments, each completed by the group without instruction

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: four song fragments, each completed by the group without instruction, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | One child recalls the story, the other the snack. |
| **Non-example** | Two children producing identical accounts. |
...
> "You did not decide to remember that. It arrived."
...
**Exact wording.** "Ask what they remember about the first day here."
...
**Target observation.** That memories of one event differ between people.
...
> "Shared events produce different memories. You just saw that when ask what they remember about the first day here.
> Last time we said: You did not decide to remember that. It arrived. This is the next part of that.
...
**What students must not infer.** Whether either memory is accurate.

### 4. Worked example

**The example.** One child recalls the story, the other the snack.
...
**Completed answer.** One child recalls the story, the other the snack. — which demonstrates that memories of one event differ between people.
...
**Conclusions not licensed.** Whether either memory is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. One child recalls being nervous, the other recalls the door. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two children producing identical accounts. Why is this not an
example?"
...
**Exact student instructions.** Compare recollections of one shared event in pairs. Mark one difference.
...
- *Licensed conclusion.* That memories of one event differ between people.
- *Not licensed.* Whether either memory is accurate.
...
- *Expected response.* That memories of one event differ between people.
...
1. Any wording carrying the idea in `Shared events produce different memories`.
...
Say: "Same day. Different memories."
...
| | |
|---|---|
| **Follows** | Lesson 12 — Remembering A Song |
| **Leads to** | Lesson 14 — Where The Guess Comes From |

**Transition in.** Lesson 12 established children notice that remembering can be automatic and complete. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children discover people remember different things about the same event. Lesson 14 assumes it and builds children connect a remembered thing to the guess it produces.
