# Lesson 14 — Where The Guess Comes From

**Kindergarten** · Noticing and Remembering · **Quarter 2** · **20 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Where The Guess Comes From: children connect a remembered thing to the guess it produces? |
| **Core concept** | The frame makes the link explicit: the remembered thing on the left produces the guess on the right. |
| **Student outcome** | Children connect a remembered thing to the guess it produces. |
| **Previous lesson** | Lesson 13 — Different Memories |
| **Next lesson** | Lesson 15 — Same Room, Different Guesses |
...
**The conceptual step.** The frame makes the link explicit: the remembered thing on the left produces the guess on the right. The two halves must connect.
...
**What depends on it.** Lesson 15 — Same Room, Different Guesses — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The frame makes the link explicit: the remembered thing on the left produces the guess on the right. The two halves must connect.
...
1. I remember music is next, so I guess we go to the hall.
2. I remember the bell rings, so I guess we pack up.

### One non-example

I remember lunch, so I guess we get ice cream — a wish, not a guess.
...
That remembered content generates expectations.
...
| Statement | Status |
|---|---|
| The frame makes the link explicit: the remembered thing on the left produces the guess on the right. | Framework-derived, appropriate at this grade |
| That remembered content generates expectations. | What this specific activity can show |
| How the generation works. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 13 — Different Memories — specifically: children discover people remember different things about the same event.

**How it was taught.** Through the activity: compare recollections of one shared event in pairs. Mark one difference

**Quick check.** Ask for the closing sentence of Lesson 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 13: compare recollections of one shared event in pairs. Mark one difference, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | I remember music is next, so I guess we go to the hall. |
| **Non-example** | I remember lunch, so I guess we get ice cream — a wish, not a guess. |
...
**Exact wording.** "Say: I remember we line up after this, so I guess the door opens soon."
...
**Target observation.** That remembered content generates expectations.
...
> "The frame makes the link explicit: the remembered thing on the left produces the guess on the right. You just saw that when say: I remember we line up after this, so I guess the door opens soon.
> Last time we said: Same day. Different memories. This is the next part of that.
...
**What students must not infer.** How the generation works.

### 4. Worked example

**The example.** I remember music is next, so I guess we go to the hall.
...
**Completed answer.** I remember music is next, so I guess we go to the hall. — which demonstrates that remembered content generates expectations.
...
**Conclusions not licensed.** How the generation works.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. I remember the bell rings, so I guess we pack up. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. I remember lunch, so I guess we get ice cream — a wish, not a guess. Why is this not an
example?"
...
**Exact student instructions.** Every child completes the frame aloud about the school day.
...
- *Licensed conclusion.* That remembered content generates expectations.
- *Not licensed.* How the generation works.
...
- *Expected response.* That remembered content generates expectations.
...
1. Any wording carrying the idea in `The frame makes the link explicit: the remembered thing on the left produces the guess on the right`.
...
Say: "Guesses come out of remembering."
...
| | |
|---|---|
| **Follows** | Lesson 13 — Different Memories |
| **Leads to** | Lesson 15 — Same Room, Different Guesses |

**Transition in.** Lesson 13 established children discover people remember different things about the same event. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children connect a remembered thing to the guess it produces. Lesson 15 assumes it and builds children explain why the same input gives different guesses.
