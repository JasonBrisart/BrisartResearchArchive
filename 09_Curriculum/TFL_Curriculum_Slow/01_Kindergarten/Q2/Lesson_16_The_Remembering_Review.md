# Lesson 16 — The Remembering Review
...
| | |
|---|---|
| **Central question** | The Remembering Review: children consolidate noticing and remembering together? |
| **Core concept** | Both categories must remain distinct under speed. |
| **Student outcome** | Children consolidate noticing and remembering together. |
| **Previous lesson** | Lesson 15 — Same Room, Different Guesses |
| **Next lesson** | Lesson 17 — Saying It Before |
...
**The conceptual step.** Both categories must remain distinct under speed. The relay format tests whether the distinction survives pressure.
...
**What depends on it.** Lesson 17 — Saying It Before — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Both categories must remain distinct under speed. The relay format tests whether the distinction survives pressure.
...
1. Twelve cards sorted with nine or more correct.
2. A child self-corrects using the timing test.

### One non-example

A child who sorts by which word sounds better.
...
Whether the distinction survives quick sorting.
...
| Statement | Status |
|---|---|
| Both categories must remain distinct under speed. | Framework-derived, appropriate at this grade |
| Whether the distinction survives quick sorting. | What this specific activity can show |
| Perfect accuracy. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — Same Room, Different Guesses — specifically: children explain why the same input gives different guesses.

**How it was taught.** Through the activity: pairs compare their frames and find one differing pair

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: pairs compare their frames and find one differing pair, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Twelve cards sorted with nine or more correct. |
| **Non-example** | A child who sorts by which word sounds better. |
...
> "Your noticing was the same. Your remembering was different."
...
**Exact wording.** "Both charts up. Ask what the two jobs are."
...
**Target observation.** Whether the distinction survives quick sorting.
...
> "Both categories must remain distinct under speed. You just saw that when both charts up.
> Last time we said: Your noticing was the same. Your remembering was different. This is the next part of that.
...
**The example.** Twelve cards sorted with nine or more correct.
...
**Completed answer.** Twelve cards sorted with nine or more correct. — which demonstrates whether the distinction survives quick sorting.
...
**Teacher prompt.** "Here is a second case. A child self-corrects using the timing test. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who sorts by which word sounds better. Why is this not an
example?"
...
**Exact student instructions.** Sorting relay: the group sorts twelve items under the two words.
...
- *Licensed conclusion.* Whether the distinction survives quick sorting.
...
- *Expected response.* Whether the distinction survives quick sorting.
...
1. Any wording carrying the idea in `Both categories must remain distinct under speed`.
...
Say: "Next time we say the guess out loud before we find out."
...
| | |
|---|---|
| **Follows** | Lesson 15 — Same Room, Different Guesses |
| **Leads to** | Lesson 17 — Saying It Before |

**Transition in.** Lesson 15 established children explain why the same input gives different guesses. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children consolidate noticing and remembering together. Lesson 17 assumes it and builds children commit to a guess aloud before an outcome.
