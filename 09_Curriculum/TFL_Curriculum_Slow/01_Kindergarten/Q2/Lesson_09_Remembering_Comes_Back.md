# Lesson 9 — Remembering Comes Back
...
| | |
|---|---|
| **Central question** | Remembering Comes Back: children identify things that come back without effort? |
| **Core concept** | Remembering here means content that arrives on its own. |
| **Student outcome** | Children identify things that come back without effort. |
| **Previous lesson** | Lesson 8 — The Noticing Review |
| **Next lesson** | Lesson 10 — Two Different Jobs |
...
**The conceptual step.** Remembering here means content that arrives on its own. Effortful recall is a different thing and is not what is being named.
...
**What depends on it.** Lesson 10 — Two Different Jobs — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Remembering here means content that arrives on its own. Effortful recall is a different thing and is not what is being named.
...
1. GO arrives without any effort.
2. A familiar tune completes itself.

### One non-example

Straining to recall a name — that is effortful and not the target.
...
That content returns without deliberate effort.

### What this activity does not establish

Any memory-system distinction.
...
| Statement | Status |
|---|---|
| Remembering here means content that arrives on its own. | Framework-derived, appropriate at this grade |
| That content returns without deliberate effort. | What this specific activity can show |
| Any memory-system distinction. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Noticing Review — specifically: children consolidate the quarter's noticing work.

**How it was taught.** Through the activity: whole-group review with the term's drawings sorted by sense

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: whole-group review with the term's drawings sorted by sense, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | GO arrives without any effort. |
| **Non-example** | Straining to recall a name — that is effortful and not the target. |
...
> "Next time: what comes back from before."
...
**Exact wording.** "Say "ready, set" and stop, then ask how they knew."
...
**Target observation.** That content returns without deliberate effort.
...
> "Remembering here means content that arrives on its own. You just saw that when say "ready, set" and stop, then ask how they knew.
> Last time we said: Next time: what comes back from before. This is the next part of that.
...
**What students must not infer.** Any memory-system distinction.

### 4. Worked example

**The example.** GO arrives without any effort.
...
**Completed answer.** GO arrives without any effort. — which demonstrates that content returns without deliberate effort.
...
**Conclusions not licensed.** Any memory-system distinction.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A familiar tune completes itself. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Straining to recall a name — that is effortful and not the target. Why is this not an
example?"
...
**Exact student instructions.** Four unfinished phrases, then one remembered thing from this morning each.
...
- *Licensed conclusion.* That content returns without deliberate effort.
- *Not licensed.* Any memory-system distinction.
...
- *Expected response.* That content returns without deliberate effort.
...
1. Any wording carrying the idea in `Remembering here means content that arrives on its own`.
...
Say: "Remembering is what comes back from before, by itself."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Noticing Review |
| **Leads to** | Lesson 10 — Two Different Jobs |

**Transition in.** Lesson 8 established children consolidate the quarter's noticing work. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children identify things that come back without effort. Lesson 10 assumes it and builds children sort examples into noticing and remembering.
