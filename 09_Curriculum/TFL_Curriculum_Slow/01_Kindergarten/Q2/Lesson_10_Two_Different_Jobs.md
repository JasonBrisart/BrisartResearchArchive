...
| | |
|---|---|
| **Central question** | Two Different Jobs: children sort examples into noticing and remembering? |
| **Core concept** | Noticing and remembering are separable by a single test. |
| **Student outcome** | Children sort examples into noticing and remembering. |
| **Previous lesson** | Lesson 9 — Remembering Comes Back |
| **Next lesson** | Lesson 11 — Remembering Yesterday |
...
**The conceptual step.** Noticing and remembering are separable by a single test. Sorting forces the test to be applied repeatedly.
...
**What depends on it.** Lesson 11 — Remembering Yesterday — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Noticing and remembering are separable by a single test. Sorting forces the test to be applied repeatedly.
...
1. The fan humming goes under NOTICE.
2. Music lesson yesterday goes under REMEMBER.

### One non-example

A card sorted because the child likes the picture.
...
That the two categories are reliably separable.

### What this activity does not establish

How the two interact, which is later.
...
| Statement | Status |
|---|---|
| Noticing and remembering are separable by a single test. | Framework-derived, appropriate at this grade |
| That the two categories are reliably separable. | What this specific activity can show |
| How the two interact, which is later. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 9 — Remembering Comes Back — specifically: children identify things that come back without effort.

**How it was taught.** Through the activity: four unfinished phrases, then one remembered thing from this morning each

**Quick check.** Ask for the closing sentence of Lesson 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 9: four unfinished phrases, then one remembered thing from this morning each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The fan humming goes under NOTICE. |
| **Non-example** | A card sorted because the child likes the picture. |
...
> "Remembering is what comes back from before, by itself."
...
**Exact wording.** "Hold up two cards and say six things; the class points at the right one."
...
**Target observation.** That the two categories are reliably separable.
...
> "Noticing and remembering are separable by a single test. You just saw that when hold up two cards and say six things; the class points at the right one.
> Last time we said: Remembering is what comes back from before, by itself. This is the next part of that.
...
**What students must not infer.** How the two interact, which is later.

### 4. Worked example

**The example.** The fan humming goes under NOTICE.
...
**Completed answer.** The fan humming goes under NOTICE. — which demonstrates that the two categories are reliably separable.
...
**Conclusions not licensed.** How the two interact, which is later.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Music lesson yesterday goes under REMEMBER. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A card sorted because the child likes the picture. Why is this not an
example?"
...
**Exact student instructions.** Card sort in pairs: eight picture cards under NOTICE or REMEMBER.
...
- *Licensed conclusion.* That the two categories are reliably separable.
- *Not licensed.* How the two interact, which is later.
...
- *Expected response.* That the two categories are reliably separable.
...
1. Any wording carrying the idea in `Noticing and remembering are separable by a single test`.
...
Say: "Two jobs, both running at once."
...
| | |
|---|---|
| **Follows** | Lesson 9 — Remembering Comes Back |
| **Leads to** | Lesson 11 — Remembering Yesterday |

**Transition in.** Lesson 9 established children identify things that come back without effort. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children sort examples into noticing and remembering. Lesson 11 assumes it and builds children retrieve something from a longer interval.
