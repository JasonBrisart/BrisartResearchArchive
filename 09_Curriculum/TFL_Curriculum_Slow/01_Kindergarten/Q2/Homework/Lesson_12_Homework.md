# Lesson 12 Homework — Remembering A Song

**Kindergarten** · Noticing and Remembering · **Quarter 2**
**Follows:** Lesson 12 — Remembering A Song · **Points:** 5 · **Optional:** yes
...
Four song fragments, each completed by the group without instruction.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the group completes at least three fragments
...
Lesson 13 is **Different Memories**, which assumes you arrive holding it. Write one thing you expect it to be about:
