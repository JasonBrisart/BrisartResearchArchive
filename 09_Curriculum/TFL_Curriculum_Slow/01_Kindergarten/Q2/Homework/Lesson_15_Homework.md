# Lesson 15 Homework — Same Room, Different Guesses

**Kindergarten** · Noticing and Remembering · **Quarter 2**
**Follows:** Lesson 15 — Same Room, Different Guesses · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 15 ended on, from memory:
...
Pairs compare their frames and find one differing pair.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class can say different memories give different guesses
...
Lesson 16 is **The Remembering Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
