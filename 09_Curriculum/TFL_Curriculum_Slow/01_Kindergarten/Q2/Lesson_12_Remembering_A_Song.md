...
| | |
|---|---|
| **Central question** | Remembering A Song: children notice that remembering can be automatic and complete? |
| **Core concept** | Some remembered content arrives complete and without any decision. |
| **Student outcome** | Children notice that remembering can be automatic and complete. |
| **Previous lesson** | Lesson 11 — Remembering Yesterday |
| **Next lesson** | Lesson 13 — Different Memories |
...
**The conceptual step.** Some remembered content arrives complete and without any decision. The child did not choose to retrieve it.
...
**What depends on it.** Lesson 13 — Different Memories — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Some remembered content arrives complete and without any decision. The child did not choose to retrieve it.
...
1. Two notes produce the whole chorus.
2. Children sing on before being asked.

### One non-example

A song nobody knows, which produces nothing.
...
That retrieval can be automatic and complete.

### What this activity does not establish

Why some content is more available than other content.
...
| Statement | Status |
|---|---|
| Some remembered content arrives complete and without any decision. | Framework-derived, appropriate at this grade |
| That retrieval can be automatic and complete. | What this specific activity can show |
| Why some content is more available than other content. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 11 — Remembering Yesterday — specifically: children retrieve something from a longer interval.

**How it was taught.** Through the activity: cold recall of the previous session, tallied, then checked against the chart

**Quick check.** Ask for the closing sentence of Lesson 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 11: cold recall of the previous session, tallied, then checked against the chart, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two notes produce the whole chorus. |
| **Non-example** | A song nobody knows, which produces nothing. |
...
> "Some things came back on their own, from a whole week ago."
...
**Exact wording.** "Hum two notes of a very familiar song."
...
**Target observation.** That retrieval can be automatic and complete.
...
> "Some remembered content arrives complete and without any decision. You just saw that when hum two notes of a very familiar song.
> Last time we said: Some things came back on their own, from a whole week ago. This is the next part of that.
...
**What students must not infer.** Why some content is more available than other content.

### 4. Worked example

**The example.** Two notes produce the whole chorus.
...
**Completed answer.** Two notes produce the whole chorus. — which demonstrates that retrieval can be automatic and complete.
...
**Conclusions not licensed.** Why some content is more available than other content.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Children sing on before being asked. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A song nobody knows, which produces nothing. Why is this not an
example?"
...
**Exact student instructions.** Four song fragments, each completed by the group without instruction.
...
- *Licensed conclusion.* That retrieval can be automatic and complete.
- *Not licensed.* Why some content is more available than other content.
...
- *Expected response.* That retrieval can be automatic and complete.
...
1. Any wording carrying the idea in `Some remembered content arrives complete and without any decision`.
...
Say: "You did not decide to remember that. It arrived."
...
| | |
|---|---|
| **Follows** | Lesson 11 — Remembering Yesterday |
| **Leads to** | Lesson 13 — Different Memories |

**Transition in.** Lesson 11 established children retrieve something from a longer interval. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children notice that remembering can be automatic and complete. Lesson 13 assumes it and builds children discover people remember different things about the same event.
