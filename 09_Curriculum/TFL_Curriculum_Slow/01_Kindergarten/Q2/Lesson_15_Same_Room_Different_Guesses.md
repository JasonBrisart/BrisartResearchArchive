# Lesson 15 — Same Room, Different Guesses
...
| | |
|---|---|
| **Central question** | Same Room, Different Guesses: children explain why the same input gives different guesses? |
| **Core concept** | Same noticing plus different remembering equals different guessing. |
| **Student outcome** | Children explain why the same input gives different guesses. |
| **Previous lesson** | Lesson 14 — Where The Guess Comes From |
| **Next lesson** | Lesson 16 — The Remembering Review |
...
**The conceptual step.** Same noticing plus different remembering equals different guessing. This is the first causal account the children get.
...
**What depends on it.** Lesson 16 — The Remembering Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Same noticing plus different remembering equals different guessing. This is the first causal account the children get.
...
1. Two children see the same shape and guess differently.
2. The difference traces to different remembered objects.

### One non-example

Two children guessing differently for no traceable reason.
...
That differing memory explains differing guesses.

### What this activity does not establish

That memory is the only source of difference.
...
| Statement | Status |
|---|---|
| Same noticing plus different remembering equals different guessing. | Framework-derived, appropriate at this grade |
| That differing memory explains differing guesses. | What this specific activity can show |
| That memory is the only source of difference. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Where The Guess Comes From — specifically: children connect a remembered thing to the guess it produces.

**How it was taught.** Through the activity: every child completes the frame aloud about the school day

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: every child completes the frame aloud about the school day, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two children see the same shape and guess differently. |
| **Non-example** | Two children guessing differently for no traceable reason. |
...
> "Guesses come out of remembering."
...
**Exact wording.** "Show something partly hidden and collect four different answers."
...
**Target observation.** That differing memory explains differing guesses.
...
> "Same noticing plus different remembering equals different guessing. You just saw that when show something partly hidden and collect four different answers.
> Last time we said: Guesses come out of remembering. This is the next part of that.
...
**What students must not infer.** That memory is the only source of difference.

### 4. Worked example

**The example.** Two children see the same shape and guess differently.
...
**Completed answer.** Two children see the same shape and guess differently. — which demonstrates that differing memory explains differing guesses.
...
**Conclusions not licensed.** That memory is the only source of difference.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The difference traces to different remembered objects. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two children guessing differently for no traceable reason. Why is this not an
example?"
...
**Exact student instructions.** Pairs compare their frames and find one differing pair.
...
- *Licensed conclusion.* That differing memory explains differing guesses.
- *Not licensed.* That memory is the only source of difference.
...
- *Expected response.* That differing memory explains differing guesses.
...
1. Any wording carrying the idea in `Same noticing plus different remembering equals different guessing`.
...
Say: "Your noticing was the same. Your remembering was different."
...
| | |
|---|---|
| **Follows** | Lesson 14 — Where The Guess Comes From |
| **Leads to** | Lesson 16 — The Remembering Review |

**Transition in.** Lesson 14 established children connect a remembered thing to the guess it produces. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children explain why the same input gives different guesses. Lesson 16 assumes it and builds children consolidate noticing and remembering together.
