...
| | |
|---|---|
| **Central question** | Drawing It Before: children record a guess before finding out? |
| **Core concept** | A recorded guess cannot be revised after the fact. |
| **Student outcome** | Children record a guess before finding out. |
| **Previous lesson** | Lesson 17 — Saying It Before |
| **Next lesson** | Lesson 19 — The Guess Jar |
...
**The conceptual step.** A recorded guess cannot be revised after the fact. The record is what makes the guess checkable later.
...
**What depends on it.** Lesson 19 — The Guess Jar — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A recorded guess cannot be revised after the fact. The record is what makes the guess checkable later.
...
1. A child draws a ball and the box contains a cup.
2. Drawings collected before the box is opened.

### One non-example

A child who adjusts their drawing once the box is open.
...
That recording fixes the guess.

### What this activity does not establish

That the guesses should be correct.
...
| Statement | Status |
|---|---|
| A recorded guess cannot be revised after the fact. | Framework-derived, appropriate at this grade |
| That recording fixes the guess. | What this specific activity can show |
| That the guesses should be correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Saying It Before — specifically: children commit to a guess aloud before an outcome.

**How it was taught.** Through the activity: five story stops. Three children guess aloud before each page turn

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: five story stops. Three children guess aloud before each page turn, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child draws a ball and the box contains a cup. |
| **Non-example** | A child who adjusts their drawing once the box is open. |
...
> "A guess only counts if you say it before."
...
**Exact wording.** "Ask them to draw what they think is in the box without telling anybody."
...
**Target observation.** That recording fixes the guess.
...
> "A recorded guess cannot be revised after the fact. You just saw that when ask them to draw what they think is in the box without telling anybody.
> Last time we said: A guess only counts if you say it before. This is the next part of that.
...
**What students must not infer.** That the guesses should be correct.

### 4. Worked example

**The example.** A child draws a ball and the box contains a cup.
...
**Completed answer.** A child draws a ball and the box contains a cup. — which demonstrates that recording fixes the guess.
...
**Conclusions not licensed.** That the guesses should be correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Drawings collected before the box is opened. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who adjusts their drawing once the box is open. Why is this not an
example?"
...
**Exact student instructions.** Four hidden-object rounds, each guess drawn before the reveal.
...
- *Licensed conclusion.* That recording fixes the guess.
- *Not licensed.* That the guesses should be correct.
...
- *Expected response.* That recording fixes the guess.
...
1. Any wording carrying the idea in `A recorded guess cannot be revised after the fact`.
...
Say: "Drawing it first means nobody can change it after."
...
| | |
|---|---|
| **Follows** | Lesson 17 — Saying It Before |
| **Leads to** | Lesson 19 — The Guess Jar |

**Transition in.** Lesson 17 established children commit to a guess aloud before an outcome. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children record a guess before finding out. Lesson 19 assumes it and builds children make a guess checked much later.
