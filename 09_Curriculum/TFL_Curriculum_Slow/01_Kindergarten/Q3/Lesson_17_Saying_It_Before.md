...
| | |
|---|---|
| **Central question** | Saying It Before: children commit to a guess aloud before an outcome? |
| **Core concept** | Timing is what makes something a guess. |
| **Student outcome** | Children commit to a guess aloud before an outcome. |
| **Previous lesson** | Lesson 16 — The Remembering Review |
| **Next lesson** | Lesson 18 — Drawing It Before |
...
**The conceptual step.** Timing is what makes something a guess. Said afterwards, the same words are a report of what happened.
...
**What depends on it.** Lesson 18 — Drawing It Before — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Timing is what makes something a guess. Said afterwards, the same words are a report of what happened.
...
1. A child says the wolf appears before the page turns.
2. Three hands go up before the reveal.

### One non-example

A child who says I knew that after seeing the page.
...
That guesses are defined by preceding the outcome.
...
| Statement | Status |
|---|---|
| Timing is what makes something a guess. | Framework-derived, appropriate at this grade |
| That guesses are defined by preceding the outcome. | What this specific activity can show |
| Whether the guess was correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Remembering Review — specifically: children consolidate noticing and remembering together.

**How it was taught.** Through the activity: sorting relay: the group sorts twelve items under the two words

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: sorting relay: the group sorts twelve items under the two words, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child says the wolf appears before the page turns. |
| **Non-example** | A child who says I knew that after seeing the page. |
...
> "Next time we say the guess out loud before we find out."
...
**Exact wording.** "Hold up a familiar book and state the rule: you say it before."
...
**Target observation.** That guesses are defined by preceding the outcome.
...
> "Timing is what makes something a guess. You just saw that when hold up a familiar book and state the rule: you say it before.
> Last time we said: Next time we say the guess out loud before we find out. This is the next part of that.
...
**What students must not infer.** Whether the guess was correct.

### 4. Worked example

**The example.** A child says the wolf appears before the page turns.
...
**Completed answer.** A child says the wolf appears before the page turns. — which demonstrates that guesses are defined by preceding the outcome.
...
**Conclusions not licensed.** Whether the guess was correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Three hands go up before the reveal. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who says I knew that after seeing the page. Why is this not an
example?"
...
**Exact student instructions.** Five story stops. Three children guess aloud before each page turn.
...
- *Licensed conclusion.* That guesses are defined by preceding the outcome.
- *Not licensed.* Whether the guess was correct.
...
- *Expected response.* That guesses are defined by preceding the outcome.
...
1. Any wording carrying the idea in `Timing is what makes something a guess`.
...
Say: "A guess only counts if you say it before."
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Remembering Review |
| **Leads to** | Lesson 18 — Drawing It Before |

**Transition in.** Lesson 16 established children consolidate noticing and remembering together. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children commit to a guess aloud before an outcome. Lesson 18 assumes it and builds children record a guess before finding out.
