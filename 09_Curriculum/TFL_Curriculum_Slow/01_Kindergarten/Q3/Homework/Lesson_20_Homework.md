# Lesson 20 Homework — Checking A Guess

**Kindergarten** · Noticing and Remembering · **Quarter 3**
**Follows:** Lesson 20 — Checking A Guess · **Points:** 5 · **Optional:** yes
...
Reveal each hidden object. Children mark their own drawing right or wrong.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every child checks their own and marks it
...
Lesson 21 is **Guessing About Tomorrow**, which assumes you arrive holding it. Write one thing you expect it to be about:
