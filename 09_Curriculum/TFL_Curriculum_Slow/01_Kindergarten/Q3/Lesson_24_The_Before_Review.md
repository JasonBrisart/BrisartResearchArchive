...
| | |
|---|---|
| **Central question** | The Before Review: children consolidate the before rule? |
| **Core concept** | Catching after-the-fact claims is the active form of the before rule. |
| **Student outcome** | Children consolidate the before rule. |
| **Previous lesson** | Lesson 23 — The Before Chart |
| **Next lesson** | Lesson 25 — The Sound That Stops |
...
**The conceptual step.** Catching after-the-fact claims is the active form of the before rule. Children who can catch it in others hold the rule.
...
**What depends on it.** Lesson 25 — The Sound That Stops — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Catching after-the-fact claims is the active form of the before rule. Children who can catch it in others hold the rule.
...
1. A child objects to I knew that all along.
2. A child asks when the guess was said.

### One non-example

A child who accepts any claim of foreknowledge.
...
Whether the before rule can be applied to others' claims.
...
| Statement | Status |
|---|---|
| Catching after-the-fact claims is the active form of the before rule. | Framework-derived, appropriate at this grade |
| Whether the before rule can be applied to others' claims. | What this specific activity can show |
| Politeness of the challenge. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — The Before Chart — specifically: children see the record of before-guesses across the quarter.

**How it was taught.** Through the activity: tally how many before-guesses were made, and how many were checked

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: tally how many before-guesses were made, and how many were checked, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child objects to I knew that all along. |
| **Non-example** | A child who accepts any claim of foreknowledge. |
...
> "Every one of those was said before. That is what makes it a guess."
...
**Exact wording.** "Ask why we say it before."
...
**Target observation.** Whether the before rule can be applied to others' claims.
...
> "Catching after-the-fact claims is the active form of the before rule. You just saw that when ask why we say it before.
> Last time we said: Every one of those was said before. That is what makes it a guess. This is the next part of that.
...
**The example.** A child objects to I knew that all along.
...
**Completed answer.** A child objects to I knew that all along. — which demonstrates whether the before rule can be applied to others' claims.
...
**Teacher prompt.** "Here is a second case. A child asks when the guess was said. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who accepts any claim of foreknowledge. Why is this not an
example?"
...
**Exact student instructions.** Whole-group review with three deliberate after-the-fact claims to catch.
...
- *Licensed conclusion.* Whether the before rule can be applied to others' claims.
...
- *Expected response.* Whether the before rule can be applied to others' claims.
...
1. Any wording carrying the idea in `Catching after-the-fact claims is the active form of the before rule`.
...
Say: "Next time we break one on purpose."
...
| | |
|---|---|
| **Follows** | Lesson 23 — The Before Chart |
| **Leads to** | Lesson 25 — The Sound That Stops |

**Transition in.** Lesson 23 established children see the record of before-guesses across the quarter. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children consolidate the before rule. Lesson 25 assumes it and builds children report the guess an engineered break revealed.
