# Lesson 22 — Guessing About Each Other
...
| | |
|---|---|
| **Central question** | Guessing About Each Other: children guess about a partner's choice and check it? |
| **Core concept** | Guesses about people work the same way as guesses about objects, and are checked the same way. |
| **Student outcome** | Children guess about a partner's choice and check it. |
| **Previous lesson** | Lesson 21 — Guessing About Tomorrow |
| **Next lesson** | Lesson 23 — The Before Chart |
...
**The conceptual step.** Guesses about people work the same way as guesses about objects, and are checked the same way.
...
**What depends on it.** Lesson 23 — The Before Chart — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Guesses about people work the same way as guesses about objects, and are checked the same way.
...
1. A child guesses blue and their partner picks blue.
2. A child guesses red and their partner picks green.

### One non-example

A child who asks and then reports the answer.
...
That the same procedure applies to social guesses.

### What this activity does not establish

Anything about reading other people.
...
| Statement | Status |
|---|---|
| Guesses about people work the same way as guesses about objects, and are checked the same way. | Framework-derived, appropriate at this grade |
| That the same procedure applies to social guesses. | What this specific activity can show |
| Anything about reading other people. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 21 — Guessing About Tomorrow — specifically: children guess about an event further ahead.

**How it was taught.** Through the activity: each child draws one tomorrow guess, kept for checking next session

**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: each child draws one tomorrow guess, kept for checking next session, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child guesses blue and their partner picks blue. |
| **Non-example** | A child who asks and then reports the answer. |
...
> "We will check tomorrow. Do not change it."
...
**Exact wording.** "Ask them to guess which colour their partner will pick without asking."
...
**Target observation.** That the same procedure applies to social guesses.
...
> "Guesses about people work the same way as guesses about objects, and are checked the same way. You just saw that when ask them to guess which colour their partner will pick without asking.
> Last time we said: We will check tomorrow. Do not change it. This is the next part of that.
...
**What students must not infer.** Anything about reading other people.

### 4. Worked example

**The example.** A child guesses blue and their partner picks blue.
...
**Completed answer.** A child guesses blue and their partner picks blue. — which demonstrates that the same procedure applies to social guesses.
...
**Conclusions not licensed.** Anything about reading other people.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child guesses red and their partner picks green. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who asks and then reports the answer. Why is this not an
example?"
...
**Exact student instructions.** Four rounds of partner-choice guessing, each checked immediately.
...
- *Licensed conclusion.* That the same procedure applies to social guesses.
- *Not licensed.* Anything about reading other people.
...
- *Expected response.* That the same procedure applies to social guesses.
...
1. Any wording carrying the idea in `Guesses about people work the same way as guesses about objects, and are checked the same way`.
...
Say: "You guessed about a person. Sometimes right, sometimes not."
...
| | |
|---|---|
| **Follows** | Lesson 21 — Guessing About Tomorrow |
| **Leads to** | Lesson 23 — The Before Chart |

**Transition in.** Lesson 21 established children guess about an event further ahead. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children guess about a partner's choice and check it. Lesson 23 assumes it and builds children see the record of before-guesses across the quarter.
