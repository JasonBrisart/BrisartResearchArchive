# Lesson 20 — Checking A Guess

**Kindergarten** · Noticing and Remembering · **Quarter 3** · **20 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Checking A Guess: children check a guess made in a previous session? |
| **Core concept** | Checking is a separate step from guessing, and both outcomes are equally valid data. |
| **Student outcome** | Children check a guess made in a previous session. |
| **Previous lesson** | Lesson 19 — The Guess Jar |
| **Next lesson** | Lesson 21 — Guessing About Tomorrow |
...
**The conceptual step.** Checking is a separate step from guessing, and both outcomes are equally valid data. Marking your own is the honest form.
...
**What depends on it.** Lesson 21 — Guessing About Tomorrow — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Checking is a separate step from guessing, and both outcomes are equally valid data. Marking your own is the honest form.
...
1. A child marks their ball guess wrong and is unbothered.
2. A child marks two right and two wrong.

### One non-example

A child who changes the drawing rather than marking it.
...
That checking is routine and both outcomes are acceptable.

### What this activity does not establish

That accuracy is being assessed.
...
| Statement | Status |
|---|---|
| Checking is a separate step from guessing, and both outcomes are equally valid data. | Framework-derived, appropriate at this grade |
| That checking is routine and both outcomes are acceptable. | What this specific activity can show |
| That accuracy is being assessed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — The Guess Jar — specifically: children make a guess checked much later.

**How it was taught.** Through the activity: guesses recorded and sealed. Revisited in Lesson 29

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: guesses recorded and sealed. Revisited in Lesson 29, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child marks their ball guess wrong and is unbothered. |
| **Non-example** | A child who changes the drawing rather than marking it. |
...
> "We will find out much later. Your guess is safe in there."
...
**Exact wording.** "Bring back the drawings from the hidden-box rounds and check them."
...
**Target observation.** That checking is routine and both outcomes are acceptable.
...
> "Checking is a separate step from guessing, and both outcomes are equally valid data. You just saw that when bring back the drawings from the hidden-box rounds and check them.
> Last time we said: We will find out much later. Your guess is safe in there. This is the next part of that.
...
**What students must not infer.** That accuracy is being assessed.

### 4. Worked example

**The example.** A child marks their ball guess wrong and is unbothered.
...
**Completed answer.** A child marks their ball guess wrong and is unbothered. — which demonstrates that checking is routine and both outcomes are acceptable.
...
**Conclusions not licensed.** That accuracy is being assessed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child marks two right and two wrong. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who changes the drawing rather than marking it. Why is this not an
example?"
...
**Exact student instructions.** Reveal each hidden object. Children mark their own drawing right or wrong.
...
- *Licensed conclusion.* That checking is routine and both outcomes are acceptable.
- *Not licensed.* That accuracy is being assessed.
...
- *Expected response.* That checking is routine and both outcomes are acceptable.
...
1. Any wording carrying the idea in `Checking is a separate step from guessing, and both outcomes are equally valid data`.
...
Say: "Some were right and some were wrong. Both were real guesses."
...
| | |
|---|---|
| **Follows** | Lesson 19 — The Guess Jar |
| **Leads to** | Lesson 21 — Guessing About Tomorrow |

**Transition in.** Lesson 19 established children make a guess checked much later. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children check a guess made in a previous session. Lesson 21 assumes it and builds children guess about an event further ahead.
