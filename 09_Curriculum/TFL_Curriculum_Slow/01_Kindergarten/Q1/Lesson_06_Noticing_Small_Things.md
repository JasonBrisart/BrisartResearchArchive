# Lesson 6 — Noticing Small Things
...
| | |
|---|---|
| **Central question** | Noticing Small Things: children notice something they usually overlook? |
| **Core concept** | Being present is not the same as being noticed. |
| **Student outcome** | Children notice something they usually overlook. |
| **Previous lesson** | Lesson 5 — Noticing Together |
| **Next lesson** | Lesson 7 — Noticing All Day |
...
**The conceptual step.** Being present is not the same as being noticed. Things can be available for months without ever being picked up.
...
**What depends on it.** Lesson 7 — Noticing All Day — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Being present is not the same as being noticed. Things can be available for months without ever being picked up.
...
1. A child finds a mark on the skirting board.
2. A child finds a screw in the table leg.

### One non-example

A child who selects the door, which everybody notices daily.
...
That availability and noticing come apart.

### What this activity does not establish

Any account of attention.
...
| Statement | Status |
|---|---|
| Being present is not the same as being noticed. | Framework-derived, appropriate at this grade |
| That availability and noticing come apart. | What this specific activity can show |
| Any account of attention. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — Noticing Together — specifically: children compare what they noticed with a partner.

**How it was taught.** Through the activity: pairs share their hunt lists and mark one thing only one of them noticed

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: pairs share their hunt lists and mark one thing only one of them noticed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child finds a mark on the skirting board. |
| **Non-example** | A child who selects the door, which everybody notices daily. |
...
> "Two people in the same room notice different things."
...
**Exact wording.** "Ask them to find something in the room they have never noticed before."
...
**Target observation.** That availability and noticing come apart.
...
> "Being present is not the same as being noticed. You just saw that when ask them to find something in the room they have never noticed before.
> Last time we said: Two people in the same room notice different things. This is the next part of that.
...
**What students must not infer.** Any account of attention.

### 4. Worked example

**The example.** A child finds a mark on the skirting board.
...
**Completed answer.** A child finds a mark on the skirting board. — which demonstrates that availability and noticing come apart.
...
**Conclusions not licensed.** Any account of attention.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child finds a screw in the table leg. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who selects the door, which everybody notices daily. Why is this not an
example?"
...
**Exact student instructions.** The overlooked hunt. Each child finds and draws one never-noticed thing.
...
- *Licensed conclusion.* That availability and noticing come apart.
- *Not licensed.* Any account of attention.
...
- *Expected response.* That availability and noticing come apart.
...
1. Any wording carrying the idea in `Being present is not the same as being noticed`.
...
Say: "It was always there. You just were not noticing it."
...
| | |
|---|---|
| **Follows** | Lesson 5 — Noticing Together |
| **Leads to** | Lesson 7 — Noticing All Day |

**Transition in.** Lesson 5 established children compare what they noticed with a partner. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children notice something they usually overlook. Lesson 7 assumes it and builds children recognise noticing as continuous.
