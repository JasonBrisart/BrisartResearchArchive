...
| | |
|---|---|
| **Central question** | The Noticing Review: children consolidate the quarter's noticing work? |
| **Core concept** | Noticing is defined by its timing. |
| **Student outcome** | Children consolidate the quarter's noticing work. |
| **Previous lesson** | Lesson 7 — Noticing All Day |
| **Next lesson** | Lesson 9 — Remembering Comes Back |
...
**The conceptual step.** Noticing is defined by its timing. The review makes the test explicit so it can be applied in the next quarter.
...
**What depends on it.** Lesson 9 — Remembering Comes Back — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Noticing is defined by its timing. The review makes the test explicit so it can be applied in the next quarter.
...
1. A child says noticing is what is happening now.
2. A child correctly rejects a breakfast example.

### One non-example

A child who defines noticing as thinking about something.
...
Whether the timing test is available to the child.

### What this activity does not establish

Any comparison with remembering, which starts next quarter.
...
| Statement | Status |
|---|---|
| Noticing is defined by its timing. | Framework-derived, appropriate at this grade |
| Whether the timing test is available to the child. | What this specific activity can show |
| Any comparison with remembering, which starts next quarter. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — Noticing All Day — specifically: children recognise noticing as continuous.

**How it was taught.** Through the activity: tally noticing moments across one short activity, counted by the group

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: tally noticing moments across one short activity, counted by the group, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child says noticing is what is happening now. |
| **Non-example** | A child who defines noticing as thinking about something. |
...
> "You are noticing constantly, not sometimes."
...
**Exact wording.** "Point at the NOTICE chart and ask what noticing is."
...
**Target observation.** Whether the timing test is available to the child.
...
> "Noticing is defined by its timing. You just saw that when point at the NOTICE chart and ask what noticing is.
> Last time we said: You are noticing constantly, not sometimes. This is the next part of that.
...
**What students must not infer.** Any comparison with remembering, which starts next quarter.

### 4. Worked example

**The example.** A child says noticing is what is happening now.
...
**Completed answer.** A child says noticing is what is happening now. — which demonstrates whether the timing test is available to the child.
...
**Conclusions not licensed.** Any comparison with remembering, which starts next quarter.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child correctly rejects a breakfast example. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who defines noticing as thinking about something. Why is this not an
example?"
...
**Exact student instructions.** Whole-group review with the term's drawings sorted by sense.
...
- *Licensed conclusion.* Whether the timing test is available to the child.
- *Not licensed.* Any comparison with remembering, which starts next quarter.
...
- *Expected response.* Whether the timing test is available to the child.
...
1. Any wording carrying the idea in `Noticing is defined by its timing`.
...
Say: "Next time: what comes back from before."
...
| | |
|---|---|
| **Follows** | Lesson 7 — Noticing All Day |
| **Leads to** | Lesson 9 — Remembering Comes Back |

**Transition in.** Lesson 7 established children recognise noticing as continuous. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children consolidate the quarter's noticing work. Lesson 9 assumes it and builds children identify things that come back without effort.
