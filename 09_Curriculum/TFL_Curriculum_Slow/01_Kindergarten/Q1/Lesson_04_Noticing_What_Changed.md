# Lesson 4 — Noticing What Changed
...
| | |
|---|---|
| **Central question** | Noticing What Changed: children detect a change in a familiar scene? |
| **Core concept** | Detecting a change requires something to compare against. |
| **Student outcome** | Children detect a change in a familiar scene. |
| **Previous lesson** | Lesson 3 — Noticing Outside |
| **Next lesson** | Lesson 5 — Noticing Together |
...
**The conceptual step.** Detecting a change requires something to compare against. Noticing the difference proves the earlier version was held.
...
**What depends on it.** Lesson 5 — Noticing Together — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Detecting a change requires something to compare against. Noticing the difference proves the earlier version was held.
...
1. A child spots the moved chair.
2. A child notices the changed poster.

### One non-example

A child who guesses at random without reference to how it was.
...
That change detection implies a stored prior version.
...
| Statement | Status |
|---|---|
| Detecting a change requires something to compare against. | Framework-derived, appropriate at this grade |
| That change detection implies a stored prior version. | What this specific activity can show |
| Any memory mechanism. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — Noticing Outside — specifically: children notice in a different environment.

**How it was taught.** Through the activity: same hunt in the new place. Compare what is noticeable here versus there

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: same hunt in the new place. Compare what is noticeable here versus there, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child spots the moved chair. |
| **Non-example** | A child who guesses at random without reference to how it was. |
...
> "Different places give you different things to notice."
...
**Exact wording.** "Change three things in the room while their eyes are closed."
...
**Target observation.** That change detection implies a stored prior version.
...
> "Detecting a change requires something to compare against. You just saw that when change three things in the room while their eyes are closed.
> Last time we said: Different places give you different things to notice. This is the next part of that.
...
**What students must not infer.** Any memory mechanism.

### 4. Worked example

**The example.** A child spots the moved chair.
...
**Completed answer.** A child spots the moved chair. — which demonstrates that change detection implies a stored prior version.
...
**Conclusions not licensed.** Any memory mechanism.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child notices the changed poster. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who guesses at random without reference to how it was. Why is this not an
example?"
...
**Exact student instructions.** Three rounds of spot-the-change, increasing subtlety.
...
- *Licensed conclusion.* That change detection implies a stored prior version.
- *Not licensed.* Any memory mechanism.
...
- *Expected response.* That change detection implies a stored prior version.
...
1. Any wording carrying the idea in `Detecting a change requires something to compare against`.
...
Say: "You knew it was different because you knew how it was before."
...
| | |
|---|---|
| **Follows** | Lesson 3 — Noticing Outside |
| **Leads to** | Lesson 5 — Noticing Together |

**Transition in.** Lesson 3 established children notice in a different environment. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children detect a change in a familiar scene. Lesson 5 assumes it and builds children compare what they noticed with a partner.
