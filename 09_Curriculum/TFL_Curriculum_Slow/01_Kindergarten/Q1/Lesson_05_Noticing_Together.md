# Lesson 5 — Noticing Together

**Kindergarten** · Noticing and Remembering · **Quarter 1** · **20 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Noticing Together: children compare what they noticed with a partner? |
| **Core concept** | Two children in the same room do not notice the same things. |
| **Student outcome** | Children compare what they noticed with a partner. |
| **Previous lesson** | Lesson 4 — Noticing What Changed |
| **Next lesson** | Lesson 6 — Noticing Small Things |
...
**The conceptual step.** Two children in the same room do not notice the same things. Input availability and what gets noticed are not identical.
...
**What depends on it.** Lesson 6 — Noticing Small Things — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Two children in the same room do not notice the same things. Input availability and what gets noticed are not identical.
...
1. One child noticed the clock, the other did not.
2. One child heard the corridor, the other heard the fan.

### One non-example

Two children producing identical lists.
...
That noticing differs between people in one place.

### What this activity does not establish

Why it differs, which is not settled here.
...
| Statement | Status |
|---|---|
| Two children in the same room do not notice the same things. | Framework-derived, appropriate at this grade |
| That noticing differs between people in one place. | What this specific activity can show |
| Why it differs, which is not settled here. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — Noticing What Changed — specifically: children detect a change in a familiar scene.

**How it was taught.** Through the activity: three rounds of spot-the-change, increasing subtlety

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: three rounds of spot-the-change, increasing subtlety, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | One child noticed the clock, the other did not. |
| **Non-example** | Two children producing identical lists. |
...
> "You knew it was different because you knew how it was before."
...
**Exact wording.** "Ask whether their partner noticed the same thing as them."
...
**Target observation.** That noticing differs between people in one place.
...
> "Two children in the same room do not notice the same things. You just saw that when ask whether their partner noticed the same thing as them.
> Last time we said: You knew it was different because you knew how it was before. This is the next part of that.
...
**What students must not infer.** Why it differs, which is not settled here.

### 4. Worked example

**The example.** One child noticed the clock, the other did not.
...
**Completed answer.** One child noticed the clock, the other did not. — which demonstrates that noticing differs between people in one place.
...
**Conclusions not licensed.** Why it differs, which is not settled here.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. One child heard the corridor, the other heard the fan. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two children producing identical lists. Why is this not an
example?"
...
**Exact student instructions.** Pairs share their hunt lists and mark one thing only one of them noticed.
...
- *Licensed conclusion.* That noticing differs between people in one place.
- *Not licensed.* Why it differs, which is not settled here.
...
- *Expected response.* That noticing differs between people in one place.
...
1. Any wording carrying the idea in `Two children in the same room do not notice the same things`.
...
Say: "Two people in the same room notice different things."
...
| | |
|---|---|
| **Follows** | Lesson 4 — Noticing What Changed |
| **Leads to** | Lesson 6 — Noticing Small Things |

**Transition in.** Lesson 4 established children detect a change in a familiar scene. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children compare what they noticed with a partner. Lesson 6 assumes it and builds children notice something they usually overlook.
