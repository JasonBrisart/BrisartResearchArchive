...
| | |
|---|---|
| **Central question** | Three Senses: children notice using three different senses deliberately? |
| **Core concept** | Noticing runs through several channels at once. |
| **Student outcome** | Children notice using three different senses deliberately. |
| **Previous lesson** | Lesson 1 — Noticing Right Now |
| **Next lesson** | Lesson 3 — Noticing Outside |
...
**The conceptual step.** Noticing runs through several channels at once. Deliberately separating them shows the child how much is arriving simultaneously.
...
**What depends on it.** Lesson 3 — Noticing Outside — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Noticing runs through several channels at once. Deliberately separating them shows the child how much is arriving simultaneously.
...
1. A child lists lamp, fan, chair-back.
2. A child closes their eyes and reports three sounds.

### One non-example

A child who lists three things they can see and calls them three senses.
...
That several channels supply information at once.

### What this activity does not establish

Which channel dominates, or any ranking.
...
| Statement | Status |
|---|---|
| Noticing runs through several channels at once. | Framework-derived, appropriate at this grade |
| That several channels supply information at once. | What this specific activity can show |
| Which channel dominates, or any ranking. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 1 — Noticing Right Now — specifically: children name things they can sense at this moment.

**How it was taught.** Through the activity: round robin: each child names one thing noticed. Prompt the stuck by sense

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: round robin: each child names one thing noticed. Prompt the stuck by sense, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child lists lamp, fan, chair-back. |
| **Non-example** | A child who lists three things they can see and calls them three senses. |
...
> "Noticing is what is happening right now."
...
**Exact wording.** "Ask for one thing they can see, one they can hear, one they can feel."
...
**Target observation.** That several channels supply information at once.
...
> "Noticing runs through several channels at once. You just saw that when ask for one thing they can see, one they can hear, one they can feel.
> Last time we said: Noticing is what is happening right now. This is the next part of that.
...
**What students must not infer.** Which channel dominates, or any ranking.

### 4. Worked example

**The example.** A child lists lamp, fan, chair-back.
...
**Completed answer.** A child lists lamp, fan, chair-back. — which demonstrates that several channels supply information at once.
...
**Conclusions not licensed.** Which channel dominates, or any ranking.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child closes their eyes and reports three sounds. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who lists three things they can see and calls them three senses. Why is this not an
example?"
...
**Exact student instructions.** The Noticing Hunt across the room, one item per sense, drawn.
...
- *Licensed conclusion.* That several channels supply information at once.
- *Not licensed.* Which channel dominates, or any ranking.
...
- *Expected response.* That several channels supply information at once.
...
1. Any wording carrying the idea in `Noticing runs through several channels at once`.
...
Say: "You have more than one way to notice."
...
| | |
|---|---|
| **Follows** | Lesson 1 — Noticing Right Now |
| **Leads to** | Lesson 3 — Noticing Outside |

**Transition in.** Lesson 1 established children name things they can sense at this moment. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children notice using three different senses deliberately. Lesson 3 assumes it and builds children notice in a different environment.
