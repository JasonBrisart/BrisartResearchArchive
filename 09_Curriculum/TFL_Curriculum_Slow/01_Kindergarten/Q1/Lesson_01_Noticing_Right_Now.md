...
| | |
|---|---|
| **Central question** | Noticing Right Now: children name things they can sense at this moment? |
| **Core concept** | Noticing is present-tense and sensory. |
| **Student outcome** | Children name things they can sense at this moment. |
| **Previous lesson** | None. First lesson of the year. |
| **Next lesson** | Lesson 2 — Three Senses |
...
**The conceptual step.** Noticing is present-tense and sensory. The boundary that matters is time: it is happening now, not before.
...
**What depends on it.** Lesson 2 — Three Senses — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Noticing is present-tense and sensory. The boundary that matters is time: it is happening now, not before.
...
1. A child hears the fan and says so.
2. A child feels the carpet under their feet.

### One non-example

A child who reports their breakfast — that happened before.
...
That present-moment sensing can be reported on demand.

### What this activity does not establish

Any distinction between the senses.
...
| Statement | Status |
|---|---|
| Noticing is present-tense and sensory. | Framework-derived, appropriate at this grade |
| That present-moment sensing can be reported on demand. | What this specific activity can show |
| Any distinction between the senses. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The child guesses freely without fear of being wrong.
...
| **Correct example** | A child hears the fan and says so. |
| **Non-example** | A child who reports their breakfast — that happened before. |
...
**Exact wording.** "Freeze the group and ask what they hear right now."
...
**Target observation.** That present-moment sensing can be reported on demand.
...
> "Noticing is present-tense and sensory. You just saw that when freeze the group and ask what they hear right now.
...
**What students must not infer.** Any distinction between the senses.

### 4. Worked example

**The example.** A child hears the fan and says so.
...
**Completed answer.** A child hears the fan and says so. — which demonstrates that present-moment sensing can be reported on demand.
...
**Conclusions not licensed.** Any distinction between the senses.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child feels the carpet under their feet. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who reports their breakfast — that happened before. Why is this not an
example?"
...
**Exact student instructions.** Round robin: each child names one thing noticed. Prompt the stuck by sense.
...
- *Licensed conclusion.* That present-moment sensing can be reported on demand.
- *Not licensed.* Any distinction between the senses.
...
- *Expected response.* That present-moment sensing can be reported on demand.
...
1. Any wording carrying the idea in `Noticing is present-tense and sensory`.
...
Say: "Noticing is what is happening right now."
...
| **Leads to** | Lesson 2 — Three Senses |

**Transition in.** This lesson opens the year.

**Transition out.** This lesson establishes children name things they can sense at this moment. Lesson 2 assumes it and builds children notice using three different senses deliberately.
