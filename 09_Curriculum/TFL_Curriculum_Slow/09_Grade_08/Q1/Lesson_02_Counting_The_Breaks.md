...
| **Core concept** | A prediction recorded before measurement can be compared with the result. |
| **Student outcome** | Students measure how many contradictions produce durable change. |
| **Previous lesson** | Lesson 1 — What Contradiction Does |
| **Next lesson** | Lesson 3 — Persistence Or Recurrence |
...
**The conceptual step.** A prediction recorded before measurement can be compared with the result. Without the record, the comparison is unavailable.
...
**What depends on it.** Lesson 3 — Persistence Or Recurrence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A prediction recorded before measurement can be compared with the result. Without the record, the comparison is unavailable.
...
1. A pooled figure compared against a written prediction.
2. A student whose prediction was substantially off.
...
| Statement | Status |
|---|---|
| A prediction recorded before measurement can be compared with the result. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 1 — What Contradiction Does — specifically: students record the drop and recovery across a broken pattern.

**How it was taught.** Through the activity: plot the percentages and write one paragraph on what the recovery shows

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: plot the percentages and write one paragraph on what the recovery shows, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A pooled figure compared against a written prediction. |
...
> "Revision. Suppression. Not deletion. Your own numbers showed it."
...
**Exact wording.** "Collect a written prediction of the number before any trial runs."
...
> "A prediction recorded before measurement can be compared with the result. You just saw that when collect a written prediction of the number before any trial runs.
> Last time we said: Revision. Suppression. Not deletion. Your own numbers showed it. This is the next part of that.
...
**The example.** A pooled figure compared against a written prediction.
...
**Completed answer.** A pooled figure compared against a written prediction. — which demonstrates that predictions can be tested against measurements.
...
**Teacher prompt.** "Here is a second case. A student whose prediction was substantially off. Work it through with me."
...
**Exact student instructions.** A three-break trial in pairs, pooled, compared against predictions.
...
1. Any wording carrying the idea in `A prediction recorded before measurement can be compared with the result`.
...
| | |
|---|---|
| **Follows** | Lesson 1 — What Contradiction Does |
| **Leads to** | Lesson 3 — Persistence Or Recurrence |

**Transition in.** Lesson 1 established students record the drop and recovery across a broken pattern. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students measure how many contradictions produce durable change. Lesson 3 assumes it and builds students define recurrence and distinguish it from persistence.
