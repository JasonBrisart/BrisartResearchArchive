...
| | |
|---|---|
| **Central question** | The Sampling Problem: students discover that sampling rate sets what can be seen? |
| **Core concept** | A claim of recurrence requires observing the absence. |
| **Student outcome** | Students discover that sampling rate sets what can be seen. |
| **Previous lesson** | Lesson 3 — Persistence Or Recurrence |
| **Next lesson** | Lesson 5 — Running The Sampling |
...
**The conceptual step.** A claim of recurrence requires observing the absence. The sampling interval sets a floor on the shortest gap that could be detected.
...
**What depends on it.** Lesson 5 — Running The Sampling — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A claim of recurrence requires observing the absence. The sampling interval sets a floor on the shortest gap that could be detected.
...
1. An hourly schedule with a stated one-hour floor.
2. A student calculating that shorter gaps are invisible to their schedule.

### One non-example

A claim that an hourly schedule could detect any absence.
...
That sampling rate limits detectable phenomena.

### What this activity does not establish

What the true gap durations are.
...
| Statement | Status |
|---|---|
| A claim of recurrence requires observing the absence. | Framework-derived, appropriate at this grade |
| That sampling rate limits detectable phenomena. | What this specific activity can show |
| What the true gap durations are. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — Persistence Or Recurrence — specifically: students define recurrence and distinguish it from persistence.

**How it was taught.** Through the activity: classify five described cases as persistent, recurrent, resolved, or unclassifiable

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: classify five described cases as persistent, recurrent, resolved, or unclassifiable, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An hourly schedule with a stated one-hour floor. |
| **Non-example** | A claim that an hourly schedule could detect any absence. |
...
> "Marking one unclassifiable is the correct answer."
...
**Exact wording.** "Ask what you must have observed to say something came back. Its absence."
...
**Target observation.** That sampling rate limits detectable phenomena.
...
> "A claim of recurrence requires observing the absence. You just saw that when ask what you must have observed to say something came back.
> Last time we said: Marking one unclassifiable is the correct answer. This is the next part of that.
...
**What students must not infer.** What the true gap durations are.

### 4. Worked example

**The example.** An hourly schedule with a stated one-hour floor.
...
**Completed answer.** An hourly schedule with a stated one-hour floor. — which demonstrates that sampling rate limits detectable phenomena.
...
**Conclusions not licensed.** What the true gap durations are.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student calculating that shorter gaps are invisible to their schedule. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that an hourly schedule could detect any absence. Why is this not an
example?"
...
**Exact student instructions.** Design a sampling schedule and state the shortest gap it could detect.
...
- *Licensed conclusion.* That sampling rate limits detectable phenomena.
- *Not licensed.* What the true gap durations are.
...
- *Expected response.* That sampling rate limits detectable phenomena.
...
1. Any wording carrying the idea in `A claim of recurrence requires observing the absence`.
...
Say: "Your sampling rate sets a floor on what you can find."
...
| | |
|---|---|
| **Follows** | Lesson 3 — Persistence Or Recurrence |
| **Leads to** | Lesson 5 — Running The Sampling |

**Transition in.** Lesson 3 established students define recurrence and distinguish it from persistence. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students discover that sampling rate sets what can be seen. Lesson 5 assumes it and builds students collect sampled data on one of their own expectations.
