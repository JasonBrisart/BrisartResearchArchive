# Lesson 7 — Improving The Sampling
...
| | |
|---|---|
| **Central question** | Improving The Sampling: students design a schedule that could detect a shorter gap? |
| **Core concept** | Higher sampling resolution costs effort, attention, and interference with the thing being measured. |
| **Student outcome** | Students design a schedule that could detect a shorter gap. |
| **Previous lesson** | Lesson 6 — Reading Your Own Sampling |
| **Next lesson** | Lesson 8 — The Sampling Review |
...
**The conceptual step.** Higher sampling resolution costs effort, attention, and interference with the thing being measured. Stating the cost is part of the design.
...
**What depends on it.** Lesson 8 — The Sampling Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Higher sampling resolution costs effort, attention, and interference with the thing being measured. Stating the cost is part of the design.
...
1. A ten-minute schedule with the daily checkpoint count stated.
2. A student noting the schedule would interfere with lessons.

### One non-example

A one-minute schedule proposed with no cost considered.
...
That resolution and cost trade against each other.

### What this activity does not establish

What rate would be sufficient.
...
| Statement | Status |
|---|---|
| Higher sampling resolution costs effort, attention, and interference with the thing being measured. | Framework-derived, appropriate at this grade |
| That resolution and cost trade against each other. | What this specific activity can show |
| What rate would be sufficient. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — Reading Your Own Sampling — specifically: students interpret a sampling log within its limits.

**How it was taught.** Through the activity: write up their own log with the classification and its explicit limit

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: write up their own log with the classification and its explicit limit, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A ten-minute schedule with the daily checkpoint count stated. |
| **Non-example** | A one-minute schedule proposed with no cost considered. |
...
> "A result without its rate is not interpretable."
...
**Exact wording.** "Ask what it costs to catch a ten-minute absence."
...
**Target observation.** That resolution and cost trade against each other.
...
> "Higher sampling resolution costs effort, attention, and interference with the thing being measured. You just saw that when ask what it costs to catch a ten-minute absence.
> Last time we said: A result without its rate is not interpretable. This is the next part of that.
...
**What students must not infer.** What rate would be sufficient.

### 4. Worked example

**The example.** A ten-minute schedule with the daily checkpoint count stated.
...
**Completed answer.** A ten-minute schedule with the daily checkpoint count stated. — which demonstrates that resolution and cost trade against each other.
...
**Conclusions not licensed.** What rate would be sufficient.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student noting the schedule would interfere with lessons. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A one-minute schedule proposed with no cost considered. Why is this not an
example?"
...
**Exact student instructions.** Design a higher-rate schedule and state what it would cost to run.
...
- *Licensed conclusion.* That resolution and cost trade against each other.
- *Not licensed.* What rate would be sufficient.
...
- *Expected response.* That resolution and cost trade against each other.
...
1. Any wording carrying the idea in `Higher sampling resolution costs effort, attention, and interference with the thing being measured`.
...
Say: "Better resolution costs something. Always."
...
| | |
|---|---|
| **Follows** | Lesson 6 — Reading Your Own Sampling |
| **Leads to** | Lesson 8 — The Sampling Review |

**Transition in.** Lesson 6 established students interpret a sampling log within its limits. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students design a schedule that could detect a shorter gap. Lesson 8 assumes it and builds students consolidate sampling.
