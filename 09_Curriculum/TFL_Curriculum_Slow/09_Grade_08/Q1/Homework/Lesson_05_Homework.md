# Lesson 5 Homework — Running The Sampling

**Grade 8** · Contradiction and Limits · **Quarter 1**
**Follows:** Lesson 5 — Running The Sampling · **Points:** 5 · **Optional:** yes
...
A five-checkpoint sampling log run across a full day.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has a completed five-checkpoint log
...
Lesson 6 is **Reading Your Own Sampling**, which assumes you arrive holding it. Write one thing you expect it to be about:
