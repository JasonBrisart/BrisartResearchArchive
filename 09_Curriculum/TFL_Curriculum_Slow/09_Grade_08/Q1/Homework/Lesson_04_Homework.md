# Lesson 4 Homework — The Sampling Problem

**Grade 8** · Contradiction and Limits · **Quarter 1**
**Follows:** Lesson 4 — The Sampling Problem · **Points:** 5 · **Optional:** yes
...
Design a sampling schedule and state the shortest gap it could detect.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student states a minimum detectable gap
...
Lesson 5 is **Running The Sampling**, which assumes you arrive holding it. Write one thing you expect it to be about:
