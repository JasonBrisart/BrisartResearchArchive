# Lesson 19 — Auditing Assumptions
...
| | |
|---|---|
| **Central question** | Auditing Assumptions: students audit somebody else's claim for unstated assumptions? |
| **Core concept** | Every claim rests on unstated assumptions. |
| **Student outcome** | Students audit somebody else's claim for unstated assumptions. |
| **Previous lesson** | Lesson 18 — Ranking Assumptions |
| **Next lesson** | Lesson 20 — The Assumption Behind The Method |
...
**The conceptual step.** Every claim rests on unstated assumptions. An audit that finds none has not been performed, which is why a minimum is required.
...
**What depends on it.** Lesson 20 — The Assumption Behind The Method — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every claim rests on unstated assumptions. An audit that finds none has not been performed, which is why a minimum is required.
...
1. An audit naming an unstated assumption about the sample.
2. An audit naming an unstated assumption about the method.

### One non-example

An audit returning all four claims as fully stated.
...
That unstated assumptions are externally detectable.
...
| Statement | Status |
|---|---|
| Every claim rests on unstated assumptions. | Framework-derived, appropriate at this grade |
| That unstated assumptions are externally detectable. | What this specific activity can show |
| Whether the claims are true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — Ranking Assumptions — specifically: students identify which assumption is weakest.

**How it was taught.** Through the activity: rank the assumptions under three claims and justify the weakest

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: rank the assumptions under three claims and justify the weakest, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit naming an unstated assumption about the sample. |
| **Non-example** | An audit returning all four claims as fully stated. |
...
> "The weakest one is where the claim breaks first."
...
**Exact wording.** "Put up a claim with three hidden assumptions and ask what it is leaning on."
...
**Target observation.** That unstated assumptions are externally detectable.
...
> "Every claim rests on unstated assumptions. You just saw that when put up a claim with three hidden assumptions and ask what it is leaning on.
> Last time we said: The weakest one is where the claim breaks first. This is the next part of that.
...
**The example.** An audit naming an unstated assumption about the sample.
...
**Completed answer.** An audit naming an unstated assumption about the sample. — which demonstrates that unstated assumptions are externally detectable.
...
**Teacher prompt.** "Here is a second case. An audit naming an unstated assumption about the method. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit returning all four claims as fully stated. Why is this not an
example?"
...
**Exact student instructions.** Audit a partner's four claims and return the unstated assumptions.
...
- *Licensed conclusion.* That unstated assumptions are externally detectable.
...
- *Expected response.* That unstated assumptions are externally detectable.
...
1. Any wording carrying the idea in `Every claim rests on unstated assumptions`.
...
Say: "The unstated ones are the ones that break claims."
...
| | |
|---|---|
| **Follows** | Lesson 18 — Ranking Assumptions |
| **Leads to** | Lesson 20 — The Assumption Behind The Method |

**Transition in.** Lesson 18 established students identify which assumption is weakest. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit somebody else's claim for unstated assumptions. Lesson 20 assumes it and builds students connect assumptions to their own measurement choices.
