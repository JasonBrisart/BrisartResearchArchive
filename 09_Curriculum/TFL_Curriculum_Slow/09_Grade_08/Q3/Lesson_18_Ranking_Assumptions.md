...
| | |
|---|---|
| **Central question** | Ranking Assumptions: students identify which assumption is weakest? |
| **Core concept** | Assumptions differ in how much weight they carry. |
| **Student outcome** | Students identify which assumption is weakest. |
| **Previous lesson** | Lesson 17 — Stating An Assumption |
| **Next lesson** | Lesson 19 — Auditing Assumptions |
...
**The conceptual step.** Assumptions differ in how much weight they carry. The weakest is the one whose failure would do most damage, which is not the same as the least obvious.
...
**What depends on it.** Lesson 19 — Auditing Assumptions — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Assumptions differ in how much weight they carry. The weakest is the one whose failure would do most damage, which is not the same as the least obvious.
...
1. A sampling-rate assumption ranked weakest with a reason.
2. A ranking justified by what fails if each assumption fails.

### One non-example

A ranking by how unusual each assumption sounds.
...
That assumptions can be ranked by consequence.

### What this activity does not establish

Whether the weakest assumption is false.
...
| Statement | Status |
|---|---|
| Assumptions differ in how much weight they carry. | Framework-derived, appropriate at this grade |
| That assumptions can be ranked by consequence. | What this specific activity can show |
| Whether the weakest assumption is false. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Stating An Assumption — specifically: students write the assumptions underneath their own claims.

**How it was taught.** Through the activity: take four of their own claims and list at least two assumptions under each

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: take four of their own claims and list at least two assumptions under each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A sampling-rate assumption ranked weakest with a reason. |
| **Non-example** | A ranking by how unusual each assumption sounds. |
...
> "A claim without its assumptions is unfinished work."
...
**Exact wording.** "Say: one of these is doing more work than the others. Which?"
...
**Target observation.** That assumptions can be ranked by consequence.
...
> "Assumptions differ in how much weight they carry. You just saw that when say: one of these is doing more work than the others.
> Last time we said: A claim without its assumptions is unfinished work. This is the next part of that.
...
**What students must not infer.** Whether the weakest assumption is false.

### 4. Worked example

**The example.** A sampling-rate assumption ranked weakest with a reason.
...
**Completed answer.** A sampling-rate assumption ranked weakest with a reason. — which demonstrates that assumptions can be ranked by consequence.
...
**Conclusions not licensed.** Whether the weakest assumption is false.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A ranking justified by what fails if each assumption fails. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A ranking by how unusual each assumption sounds. Why is this not an
example?"
...
**Exact student instructions.** Rank the assumptions under three claims and justify the weakest.
...
- *Licensed conclusion.* That assumptions can be ranked by consequence.
- *Not licensed.* Whether the weakest assumption is false.
...
- *Expected response.* That assumptions can be ranked by consequence.
...
1. Any wording carrying the idea in `Assumptions differ in how much weight they carry`.
...
Say: "The weakest one is where the claim breaks first."
...
| | |
|---|---|
| **Follows** | Lesson 17 — Stating An Assumption |
| **Leads to** | Lesson 19 — Auditing Assumptions |

**Transition in.** Lesson 17 established students write the assumptions underneath their own claims. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify which assumption is weakest. Lesson 19 assumes it and builds students audit somebody else's claim for unstated assumptions.
