...
**Grade 8** · Contradiction and Limits
...
|---|---|---|---|---|---|---|
| `Lesson_17_Printout.md` | Lesson 17 — Stating An Assumption | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_18_Printout.md` | Lesson 18 — Ranking Assumptions | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 17 work |
| `Lesson_19_Printout.md` | Lesson 19 — Auditing Assumptions | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 18 work |
| `Lesson_20_Printout.md` | Lesson 20 — The Assumption Behind The Method | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 19 work |
| `Lesson_21_Printout.md` | Lesson 21 — Assumptions In Other Subjects | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 20 work |
| `Lesson_22_Printout.md` | Lesson 22 — When An Assumption Fails | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 21 work |
| `Lesson_23_Printout.md` | Lesson 23 — The Audited Claim | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 22 work |
| `Lesson_24_Printout.md` | Lesson 24 — The Assumption Review | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 23 work |
...
**Lesson 21 — Assumptions In Other Subjects.** If you only have time to print one
