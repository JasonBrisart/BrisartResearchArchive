...
| | |
|---|---|
| **Central question** | The Audited Claim: students produce a claim with evidence, assumptions, and limits? |
| **Core concept** | A complete claim has five parts: the claim, its evidence, its assumptions, its limits, and a scope note. |
| **Student outcome** | Students produce a claim with evidence, assumptions, and limits. |
| **Previous lesson** | Lesson 22 — When An Assumption Fails |
| **Next lesson** | Lesson 24 — The Assumption Review |
...
**The conceptual step.** A complete claim has five parts: the claim, its evidence, its assumptions, its limits, and a scope note. Producing and repairing one is the year's terminal skill.
...
**What depends on it.** Lesson 24 — The Assumption Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A complete claim has five parts: the claim, its evidence, its assumptions, its limits, and a scope note. Producing and repairing one is the year's terminal skill.
...
1. A five-part claim audited and repaired.
2. A claim whose limits name what the method could not detect.

### One non-example

A four-part claim with the limits omitted.
...
Whether the student can produce a complete audited claim.
...
| Statement | Status |
|---|---|
| A complete claim has five parts: the claim, its evidence, its assumptions, its limits, and a scope note. | Framework-derived, appropriate at this grade |
| Whether the student can produce a complete audited claim. | What this specific activity can show |
| Whether the claim is true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — When An Assumption Fails — specifically: students trace what happens when an assumption turns out false.

**How it was taught.** Through the activity: for three claims, state what survives if the weakest assumption fails

**Quick check.** Ask for the closing sentence of Lesson 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: for three claims, state what survives if the weakest assumption fails, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A five-part claim audited and repaired. |
| **Non-example** | A four-part claim with the limits omitted. |
...
> "Some claims survive. Some collapse entirely."
...
**Exact wording.** "Say: a claim, the evidence, the assumptions, the limits, and one thing outside the model."
...
**Target observation.** Whether the student can produce a complete audited claim.
...
> "A complete claim has five parts: the claim, its evidence, its assumptions, its limits, and a scope note. You just saw that when say: a claim, the evidence, the assumptions, the limits, and one thing outside the model.
> Last time we said: Some claims survive. Some collapse entirely. This is the next part of that.
...
**The example.** A five-part claim audited and repaired.
...
**Completed answer.** A five-part claim audited and repaired. — which demonstrates whether the student can produce a complete audited claim.
...
**Teacher prompt.** "Here is a second case. A claim whose limits name what the method could not detect. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A four-part claim with the limits omitted. Why is this not an
example?"
...
**Exact student instructions.** A five-part audited claim, swapped for audit and repaired.
...
- *Licensed conclusion.* Whether the student can produce a complete audited claim.
...
- *Expected response.* Whether the student can produce a complete audited claim.
...
1. Any wording carrying the idea in `A complete claim has five parts: the claim, its evidence, its assumptions, its limits, and a scope note`.
...
Say: "Next year the equations arrive and all of this gets written down precisely."
...
| | |
|---|---|
| **Follows** | Lesson 22 — When An Assumption Fails |
| **Leads to** | Lesson 24 — The Assumption Review |

**Transition in.** Lesson 22 established students trace what happens when an assumption turns out false. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students produce a claim with evidence, assumptions, and limits. Lesson 24 assumes it and builds students consolidate assumption auditing.
