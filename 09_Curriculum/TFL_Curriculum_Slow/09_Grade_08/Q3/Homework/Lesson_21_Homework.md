# Lesson 21 Homework — Assumptions In Other Subjects

**Grade 8** · Contradiction and Limits · **Quarter 3**
**Follows:** Lesson 21 — Assumptions In Other Subjects · **Points:** 5 · **Optional:** yes
...
Audit three outside claims for assumptions and rank each set.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student audits three outside claims
...
Lesson 22 is **When An Assumption Fails**, which assumes you arrive holding it. Write one thing you expect it to be about:
