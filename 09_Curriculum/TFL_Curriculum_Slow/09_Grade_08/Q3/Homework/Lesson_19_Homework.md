# Lesson 19 Homework — Auditing Assumptions

**Grade 8** · Contradiction and Limits · **Quarter 3**
**Follows:** Lesson 19 — Auditing Assumptions · **Points:** 5 · **Optional:** yes
...
Audit a partner's four claims and return the unstated assumptions.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student receives an audit naming at least one per claim
...
Lesson 20 is **The Assumption Behind The Method**, which assumes you arrive holding it. Write one thing you expect it to be about:
