# Lesson 22 Homework — When An Assumption Fails

**Grade 8** · Contradiction and Limits · **Quarter 3**
**Follows:** Lesson 22 — When An Assumption Fails · **Points:** 5 · **Optional:** yes
...
For three claims, state what survives if the weakest assumption fails.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student states what survives for three claims
...
Lesson 23 is **The Audited Claim**, which assumes you arrive holding it. Write one thing you expect it to be about:
