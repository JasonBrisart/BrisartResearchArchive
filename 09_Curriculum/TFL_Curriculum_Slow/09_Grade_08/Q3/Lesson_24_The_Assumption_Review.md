# Lesson 24 — The Assumption Review
...
| | |
|---|---|
| **Central question** | The Assumption Review: students consolidate assumption auditing? |
| **Core concept** | The falsity test separates assumptions from restatements. |
| **Student outcome** | Students consolidate assumption auditing. |
| **Previous lesson** | Lesson 23 — The Audited Claim |
| **Next lesson** | Lesson 25 — What The Model Refuses |
...
**The conceptual step.** The falsity test separates assumptions from restatements. The review checks whether it is applied when working quickly.
...
**What depends on it.** Lesson 25 — What The Model Refuses — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The falsity test separates assumptions from restatements. The review checks whether it is applied when working quickly.
...
1. An assumption confirmed by the falsity test.
2. A restatement correctly rejected.

### One non-example

A restatement accepted as an assumption.
...
Whether the falsity test is habitual.
...
| Statement | Status |
|---|---|
| The falsity test separates assumptions from restatements. | Framework-derived, appropriate at this grade |
| Whether the falsity test is habitual. | What this specific activity can show |
| Whether the assumptions hold. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — The Audited Claim — specifically: students produce a claim with evidence, assumptions, and limits.

**How it was taught.** Through the activity: a five-part audited claim, swapped for audit and repaired

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: a five-part audited claim, swapped for audit and repaired, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An assumption confirmed by the falsity test. |
| **Non-example** | A restatement accepted as an assumption. |
...
> "Next year the equations arrive and all of this gets written down precisely."
...
**Exact wording.** "Ask what an assumption is and how you find the hidden ones."
...
**Target observation.** Whether the falsity test is habitual.
...
> "The falsity test separates assumptions from restatements. You just saw that when ask what an assumption is and how you find the hidden ones.
> Last time we said: Next year the equations arrive and all of this gets written down precisely. This is the next part of that.
...
**The example.** An assumption confirmed by the falsity test.
...
**Completed answer.** An assumption confirmed by the falsity test. — which demonstrates whether the falsity test is habitual.
...
**Teacher prompt.** "Here is a second case. A restatement correctly rejected. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A restatement accepted as an assumption. Why is this not an
example?"
...
**Exact student instructions.** Review with six claims audited for hidden assumptions.
...
- *Licensed conclusion.* Whether the falsity test is habitual.
...
- *Expected response.* Whether the falsity test is habitual.
...
1. Any wording carrying the idea in `The falsity test separates assumptions from restatements`.
...
Say: "Next time: what this model refuses to explain."
...
| | |
|---|---|
| **Follows** | Lesson 23 — The Audited Claim |
| **Leads to** | Lesson 25 — What The Model Refuses |

**Transition in.** Lesson 23 established students produce a claim with evidence, assumptions, and limits. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate assumption auditing. Lesson 25 assumes it and builds students state the exclusions and why they exist.
