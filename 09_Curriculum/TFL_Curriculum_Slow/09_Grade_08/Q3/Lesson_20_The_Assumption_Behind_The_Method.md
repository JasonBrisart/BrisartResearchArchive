# Lesson 20 — The Assumption Behind The Method
...
| | |
|---|---|
| **Central question** | The Assumption Behind The Method: students connect assumptions to their own measurement choices? |
| **Core concept** | A measurement choice embeds an assumption about what needs to be detected. |
| **Student outcome** | Students connect assumptions to their own measurement choices. |
| **Previous lesson** | Lesson 19 — Auditing Assumptions |
| **Next lesson** | Lesson 21 — Assumptions In Other Subjects |
...
**The conceptual step.** A measurement choice embeds an assumption about what needs to be detected. Choosing an hourly interval assumes gaps are longer than an hour.
...
**What depends on it.** Lesson 21 — Assumptions In Other Subjects — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A measurement choice embeds an assumption about what needs to be detected. Choosing an hourly interval assumes gaps are longer than an hour.
...
1. An hourly interval assuming gaps exceed an hour.
2. A five-point schedule assuming the day is representative.

### One non-example

A method choice described as simply practical.
...
That method choices carry assumptions.
...
| Statement | Status |
|---|---|
| A measurement choice embeds an assumption about what needs to be detected. | Framework-derived, appropriate at this grade |
| That method choices carry assumptions. | What this specific activity can show |
| Whether the assumptions hold. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — Auditing Assumptions — specifically: students audit somebody else's claim for unstated assumptions.

**How it was taught.** Through the activity: audit a partner's four claims and return the unstated assumptions

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: audit a partner's four claims and return the unstated assumptions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An hourly interval assuming gaps exceed an hour. |
| **Non-example** | A method choice described as simply practical. |
...
> "The unstated ones are the ones that break claims."
...
**Exact wording.** "Say: your sampling schedule assumed something. What?"
...
**Target observation.** That method choices carry assumptions.
...
> "A measurement choice embeds an assumption about what needs to be detected. You just saw that when say: your sampling schedule assumed something.
> Last time we said: The unstated ones are the ones that break claims. This is the next part of that.
...
**What students must not infer.** Whether the assumptions hold.

### 4. Worked example

**The example.** An hourly interval assuming gaps exceed an hour.
...
**Completed answer.** An hourly interval assuming gaps exceed an hour. — which demonstrates that method choices carry assumptions.
...
**Conclusions not licensed.** Whether the assumptions hold.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A five-point schedule assuming the day is representative. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A method choice described as simply practical. Why is this not an
example?"
...
**Exact student instructions.** List the assumptions behind three of their own measurement choices.
...
- *Licensed conclusion.* That method choices carry assumptions.
- *Not licensed.* Whether the assumptions hold.
...
- *Expected response.* That method choices carry assumptions.
...
1. Any wording carrying the idea in `A measurement choice embeds an assumption about what needs to be detected`.
...
Say: "Every measurement choice is an assumption in disguise."
...
| | |
|---|---|
| **Follows** | Lesson 19 — Auditing Assumptions |
| **Leads to** | Lesson 21 — Assumptions In Other Subjects |

**Transition in.** Lesson 19 established students audit somebody else's claim for unstated assumptions. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students connect assumptions to their own measurement choices. Lesson 21 assumes it and builds students audit a claim from another subject.
