# Lesson 22 — When An Assumption Fails

**Grade 8** · Contradiction and Limits · **Quarter 3** · **45 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | When An Assumption Fails: students trace what happens when an assumption turns out false? |
| **Core concept** | When an assumption fails, some claims collapse and others narrow. |
| **Student outcome** | Students trace what happens when an assumption turns out false. |
| **Previous lesson** | Lesson 21 — Assumptions In Other Subjects |
| **Next lesson** | Lesson 23 — The Audited Claim |
...
**The conceptual step.** When an assumption fails, some claims collapse and others narrow. Tracing which happens is more informative than assuming total collapse.
...
**What depends on it.** Lesson 23 — The Audited Claim — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

When an assumption fails, some claims collapse and others narrow. Tracing which happens is more informative than assuming total collapse.
...
1. A claim that narrows to a smaller population when the assumption fails.
2. A claim that collapses entirely.

### One non-example

An assumption failure treated as automatically fatal.
...
That assumption failure has graded consequences.

### What this activity does not establish

Whether the assumption is actually false.
...
| Statement | Status |
|---|---|
| When an assumption fails, some claims collapse and others narrow. | Framework-derived, appropriate at this grade |
| That assumption failure has graded consequences. | What this specific activity can show |
| Whether the assumption is actually false. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 21 — Assumptions In Other Subjects — specifically: students audit a claim from another subject.

**How it was taught.** Through the activity: audit three outside claims for assumptions and rank each set

**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: audit three outside claims for assumptions and rank each set, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A claim that narrows to a smaller population when the assumption fails. |
| **Non-example** | An assumption failure treated as automatically fatal. |
...
> "Every claim anywhere is standing on something."
...
**Exact wording.** "Say: your weakest assumption is false. What survives?"
...
**Target observation.** That assumption failure has graded consequences.
...
> "When an assumption fails, some claims collapse and others narrow. You just saw that when say: your weakest assumption is false.
> Last time we said: Every claim anywhere is standing on something. This is the next part of that.
...
**What students must not infer.** Whether the assumption is actually false.

### 4. Worked example

**The example.** A claim that narrows to a smaller population when the assumption fails.
...
**Completed answer.** A claim that narrows to a smaller population when the assumption fails. — which demonstrates that assumption failure has graded consequences.
...
**Conclusions not licensed.** Whether the assumption is actually false.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A claim that collapses entirely. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An assumption failure treated as automatically fatal. Why is this not an
example?"
...
**Exact student instructions.** For three claims, state what survives if the weakest assumption fails.
...
- *Licensed conclusion.* That assumption failure has graded consequences.
- *Not licensed.* Whether the assumption is actually false.
...
- *Expected response.* That assumption failure has graded consequences.
...
1. Any wording carrying the idea in `When an assumption fails, some claims collapse and others narrow`.
...
Say: "Some claims survive. Some collapse entirely."
...
| | |
|---|---|
| **Follows** | Lesson 21 — Assumptions In Other Subjects |
| **Leads to** | Lesson 23 — The Audited Claim |

**Transition in.** Lesson 21 established students audit a claim from another subject. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students trace what happens when an assumption turns out false. Lesson 23 assumes it and builds students produce a claim with evidence, assumptions, and limits.
