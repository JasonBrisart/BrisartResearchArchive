...
| **Previous lesson** | Lesson 30 — The Year In Limits |
...
1. A student identifying the assumption audit as their weak point.
2. A student finding they list restatements rather than assumptions.
...
**Prerequisite.** The content of Lesson 30 — The Year In Limits — specifically: students review the year through what they learned they could not do.

**How it was taught.** Through the activity: write the year's honest limitations list with an example for each

**Quick check.** Ask for the closing sentence of Lesson 30. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 30: write the year's honest limitations list with an example for each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student identifying the assumption audit as their weak point. |
...
> "Next year: the equations, and why one variable is missing from them."
...
> Last time we said: Next year: the equations, and why one variable is missing from them. This is the next part of that.
...
**The example.** A student identifying the assumption audit as their weak point.
...
**Completed answer.** A student identifying the assumption audit as their weak point. — which demonstrates where each student is weakest.
...
**Teacher prompt.** "Here is a second case. A student finding they list restatements rather than assumptions. Work it through with me."
...
| | |
|---|---|
| **Follows** | Lesson 30 — The Year In Limits |
| **Leads to** | Lesson 32 — Final Assessment |

**Transition in.** Lesson 30 established students review the year through what they learned they could not do. This lesson uses that as the starting point.
