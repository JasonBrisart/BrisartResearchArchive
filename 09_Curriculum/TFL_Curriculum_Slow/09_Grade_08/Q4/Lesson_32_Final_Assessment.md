...
| **Core concept** | The four exit outcomes together constitute readiness for Grade 9, where the formal relations are introduced. |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 9, where the formal relations are introduced.
...
The four exit outcomes together constitute readiness for Grade 9, where the formal relations are introduced.
...
2. A student produces a genuine assumption audit with ranking.

### One non-example

A student whose assumptions are restatements of the claim.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 9, where the formal relations are introduced. | Framework-derived, appropriate at this grade |
...
| **Non-example** | A student whose assumptions are restatements of the claim. |
...
> "The four exit outcomes together constitute readiness for Grade 9, where the formal relations are introduced. You just saw that when say: everything you know, on your own.
...
**Teacher prompt.** "Here is a second case. A student produces a genuine assumption audit with ranking. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student whose assumptions are restatements of the claim. Why is this not an
example?"
...
**Exact student instructions.** The final: contradiction effects, persistence versus recurrence with the measurement, an assumption audit, a scope rejection.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 9, where the formal relations are introduced`.
...
Say: "Next year: the two relations, written down properly."
