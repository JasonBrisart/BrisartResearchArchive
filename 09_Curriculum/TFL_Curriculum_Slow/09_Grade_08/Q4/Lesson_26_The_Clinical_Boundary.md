# Lesson 26 — The Clinical Boundary

**Grade 8** · Contradiction and Limits · **Quarter 4** · **45 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Clinical Boundary: students learn why the clinical application is a misuse, not a stretch? |
| **Core concept** | The framework supplies no diagnostic criteria and no therapeutic mechanism. |
| **Student outcome** | Students learn why the clinical application is a misuse, not a stretch. |
| **Previous lesson** | Lesson 25 — What The Model Refuses |
| **Next lesson** | Lesson 27 — Borderline Cases |
...
**The conceptual step.** The framework supplies no diagnostic criteria and no therapeutic mechanism. Clinical application is a misuse rather than an extension, and a verbatim refusal prevents the improvised version from softening.
...
**What depends on it.** Lesson 27 — Borderline Cases — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The framework supplies no diagnostic criteria and no therapeutic mechanism. Clinical application is a misuse rather than an extension, and a verbatim refusal prevents the improvised version from softening.
...
2. A refusal that redirects to the appropriate level of analysis.

### One non-example

A clinical application proposed as a promising direction.
...
That clinical use is a category error.

### What this activity does not establish

Whether clinical questions are important.
...
| That clinical use is a category error. | What this specific activity can show |
| Whether clinical questions are important. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — What The Model Refuses — specifically: students state the exclusions and why they exist.

**How it was taught.** Through the activity: write formal rejections for three invalid proposals with the boundary named

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: write formal rejections for three invalid proposals with the boundary named, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A clinical application proposed as a promising direction. |
...
> "Saying what it is not for is understanding it better, not less."
...
**Exact wording.** "Say: the commonest suggestion adults make is the clinical one. It is always wrong."
...
**Target observation.** That clinical use is a category error.
...
> "The framework supplies no diagnostic criteria and no therapeutic mechanism. You just saw that when say: the commonest suggestion adults make is the clinical one.
> Last time we said: Saying what it is not for is understanding it better, not less. This is the next part of that.
...
**What students must not infer.** Whether clinical questions are important.
...
**Completed answer.** A verbatim refusal naming the absence of diagnostic content. — which demonstrates that clinical use is a category error.
...
**Conclusions not licensed.** Whether clinical questions are important.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A refusal that redirects to the appropriate level of analysis. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A clinical application proposed as a promising direction. Why is this not an
example?"
...
**Exact student instructions.** Write the standing refusal for a clinical proposal, verbatim.
...
- *Licensed conclusion.* That clinical use is a category error.
- *Not licensed.* Whether clinical questions are important.
...
- *Expected response.* That clinical use is a category error.
...
Say: "Not an extension. A misuse. Different category."
...
| | |
|---|---|
| **Follows** | Lesson 25 — What The Model Refuses |
| **Leads to** | Lesson 27 — Borderline Cases |

**Transition in.** Lesson 25 established students state the exclusions and why they exist. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students learn why the clinical application is a misuse, not a stretch. Lesson 27 assumes it and builds students resolve genuinely ambiguous scope questions.
