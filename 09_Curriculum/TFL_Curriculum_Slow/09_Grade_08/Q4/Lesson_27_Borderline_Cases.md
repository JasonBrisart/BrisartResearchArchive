...
| **Core concept** | Borderline scope cases are decided by whether a specific Sim(t) can be stated, not by how long the interval is. |
| **Student outcome** | Students resolve genuinely ambiguous scope questions. |
| **Previous lesson** | Lesson 26 — The Clinical Boundary |
| **Next lesson** | Lesson 28 — Defending A Rejection |
...
**The conceptual step.** Borderline scope cases are decided by whether a specific Sim(t) can be stated, not by how long the interval is. Duration alone is the wrong criterion.
...
**What depends on it.** Lesson 28 — Defending A Rejection — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Borderline scope cases are decided by whether a specific Sim(t) can be stated, not by how long the interval is. Duration alone is the wrong criterion.
...
1. A long-interval case with stateable content, resolved inside.
2. A short-interval case with no stateable content, resolved outside.

### One non-example

A case decided solely because it lasted all day.
...
That identifiability is the deciding criterion.
...
| Statement | Status |
|---|---|
| Borderline scope cases are decided by whether a specific Sim(t) can be stated, not by how long the interval is. | Framework-derived, appropriate at this grade |
| That identifiability is the deciding criterion. | What this specific activity can show |
| Whether the resolution is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — The Clinical Boundary — specifically: students learn why the clinical application is a misuse, not a stretch.

**How it was taught.** Through the activity: write the standing refusal for a clinical proposal, verbatim

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: write the standing refusal for a clinical proposal, verbatim, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A long-interval case with stateable content, resolved inside. |
| **Non-example** | A case decided solely because it lasted all day. |
...
> "Not an extension. A misuse. Different category."
...
**Target observation.** That identifiability is the deciding criterion.
...
> "Borderline scope cases are decided by whether a specific Sim(t) can be stated, not by how long the interval is. You just saw that when present a hard case: expectations about a single school day, tracked across it.
> Last time we said: Not an extension. A misuse. Different category. This is the next part of that.
...
**The example.** A long-interval case with stateable content, resolved inside.
...
**Completed answer.** A long-interval case with stateable content, resolved inside. — which demonstrates that identifiability is the deciding criterion.
...
**Teacher prompt.** "Here is a second case. A short-interval case with no stateable content, resolved outside. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A case decided solely because it lasted all day. Why is this not an
example?"
...
- *Licensed conclusion.* That identifiability is the deciding criterion.
...
- *Expected response.* That identifiability is the deciding criterion.
...
1. Any wording carrying the idea in `Borderline scope cases are decided by whether a specific Sim(t) can be stated, not by how long the interval is`.
...
| | |
|---|---|
| **Follows** | Lesson 26 — The Clinical Boundary |
| **Leads to** | Lesson 28 — Defending A Rejection |

**Transition in.** Lesson 26 established students learn why the clinical application is a misuse, not a stretch. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students resolve genuinely ambiguous scope questions. Lesson 28 assumes it and builds students defend a scope rejection against a challenge.
