# Lesson 29 — Explaining The Limits
...
| | |
|---|---|
| **Central question** | Explaining The Limits: students explain the model's boundaries to somebody else? |
| **Core concept** | The exclusions are content, not apologies. |
| **Student outcome** | Students explain the model's boundaries to somebody else. |
| **Previous lesson** | Lesson 28 — Defending A Rejection |
| **Next lesson** | Lesson 30 — The Year In Limits |
...
**The conceptual step.** The exclusions are content, not apologies. Presenting them as caveats misrepresents the framework, which gains its testability from being narrow.
...
**What depends on it.** Lesson 30 — The Year In Limits — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The exclusions are content, not apologies. Presenting them as caveats misrepresents the framework, which gains its testability from being narrow.
...
1. An explanation presenting the limits as part of the design.
2. A listener asking why the framework does not cover more.

### One non-example

An explanation apologising for what the framework cannot do.
...
Whether the limits are held as content.

### What this activity does not establish

Whether the limits are correctly drawn.
...
| Statement | Status |
|---|---|
| The exclusions are content, not apologies. | Framework-derived, appropriate at this grade |
| Whether the limits are held as content. | What this specific activity can show |
| Whether the limits are correctly drawn. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — Defending A Rejection — specifically: students defend a scope rejection against a challenge.

**How it was taught.** Through the activity: each student defends one rejection against two written challenges

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: each student defends one rejection against two written challenges, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An explanation presenting the limits as part of the design. |
| **Non-example** | An explanation apologising for what the framework cannot do. |
...
> "A rejection you cannot defend is just an opinion."
...
**Exact wording.** "Say: today you teach what it is not for."
...
**Target observation.** Whether the limits are held as content.
...
> "The exclusions are content, not apologies. You just saw that when say: today you teach what it is not for.
> Last time we said: A rejection you cannot defend is just an opinion. This is the next part of that.
...
**What students must not infer.** Whether the limits are correctly drawn.

### 4. Worked example

**The example.** An explanation presenting the limits as part of the design.
...
**Completed answer.** An explanation presenting the limits as part of the design. — which demonstrates whether the limits are held as content.
...
**Conclusions not licensed.** Whether the limits are correctly drawn.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A listener asking why the framework does not cover more. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An explanation apologising for what the framework cannot do. Why is this not an
example?"
...
**Exact student instructions.** Explain the exclusions to a buddy; record the hardest question.
...
- *Licensed conclusion.* Whether the limits are held as content.
- *Not licensed.* Whether the limits are correctly drawn.
...
- *Expected response.* Whether the limits are held as content.
...
1. Any wording carrying the idea in `The exclusions are content, not apologies`.
...
Say: "Most people find the limits more surprising than the content."
...
| | |
|---|---|
| **Follows** | Lesson 28 — Defending A Rejection |
| **Leads to** | Lesson 30 — The Year In Limits |

**Transition in.** Lesson 28 established students defend a scope rejection against a challenge. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain the model's boundaries to somebody else. Lesson 30 assumes it and builds students review the year through what they learned they could not do.
