# Lesson 25 — What The Model Refuses
...
| | |
|---|---|
| **Central question** | What The Model Refuses: students state the exclusions and why they exist? |
| **Core concept** | A rejection names the specific boundary violated: timescale, level of analysis, implementation, or clinical. |
| **Student outcome** | Students state the exclusions and why they exist. |
| **Previous lesson** | Lesson 24 — The Assumption Review |
| **Next lesson** | Lesson 26 — The Clinical Boundary |
...
**The conceptual step.** A rejection names the specific boundary violated: timescale, level of analysis, implementation, or clinical. A rejection without a named boundary is an opinion.
...
**What depends on it.** Lesson 26 — The Clinical Boundary — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A rejection names the specific boundary violated: timescale, level of analysis, implementation, or clinical. A rejection without a named boundary is an opinion.
...
1. A rejection naming the timescale boundary.
2. A rejection naming the level-of-analysis boundary.

### One non-example

A rejection stating only that it feels outside.
...
That rejections require a named boundary.

### What this activity does not establish

Whether the boundaries are correctly drawn.
...
| Statement | Status |
|---|---|
| A rejection names the specific boundary violated: timescale, level of analysis, implementation, or clinical. | Framework-derived, appropriate at this grade |
| That rejections require a named boundary. | What this specific activity can show |
| Whether the boundaries are correctly drawn. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 24 — The Assumption Review — specifically: students consolidate assumption auditing.

**How it was taught.** Through the activity: review with six claims audited for hidden assumptions

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: review with six claims audited for hidden assumptions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A rejection naming the timescale boundary. |
| **Non-example** | A rejection stating only that it feels outside. |
...
> "Next time: what this model refuses to explain."
...
**Exact wording.** "Read six proposals; students vote. Four are outside."
...
**Target observation.** That rejections require a named boundary.
...
> "A rejection names the specific boundary violated: timescale, level of analysis, implementation, or clinical. You just saw that when read six proposals; students vote.
> Last time we said: Next time: what this model refuses to explain. This is the next part of that.
...
**What students must not infer.** Whether the boundaries are correctly drawn.

### 4. Worked example

**The example.** A rejection naming the timescale boundary.
...
**Completed answer.** A rejection naming the timescale boundary. — which demonstrates that rejections require a named boundary.
...
**Conclusions not licensed.** Whether the boundaries are correctly drawn.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A rejection naming the level-of-analysis boundary. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rejection stating only that it feels outside. Why is this not an
example?"
...
**Exact student instructions.** Write formal rejections for three invalid proposals with the boundary named.
...
- *Licensed conclusion.* That rejections require a named boundary.
- *Not licensed.* Whether the boundaries are correctly drawn.
...
- *Expected response.* That rejections require a named boundary.
...
1. Any wording carrying the idea in `A rejection names the specific boundary violated: timescale, level of analysis, implementation, or clinical`.
...
Say: "Saying what it is not for is understanding it better, not less."
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Assumption Review |
| **Leads to** | Lesson 26 — The Clinical Boundary |

**Transition in.** Lesson 24 established students consolidate assumption auditing. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state the exclusions and why they exist. Lesson 26 assumes it and builds students learn why the clinical application is a misuse, not a stretch.
