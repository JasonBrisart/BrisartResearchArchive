...
|---|---|---|---|---|---|---|
| `Lesson_09_Printout.md` | Lesson 9 — Belief As A Prior | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_10_Printout.md` | Lesson 10 — Where Belief Comes From | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 9 work |
| `Lesson_11_Printout.md` | Lesson 11 — Belief Versus Expectation | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 10 work |
| `Lesson_12_Printout.md` | Lesson 12 — Three Dynamics | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 11 work |
| `Lesson_13_Printout.md` | Lesson 13 — Dynamics In Data | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 12 work |
| `Lesson_14_Printout.md` | Lesson 14 — Escalation Is Not A Diagnosis | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 13 work |
| `Lesson_15_Printout.md` | Lesson 15 — Dynamics Elsewhere | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 14 work |
| `Lesson_16_Printout.md` | Lesson 16 — The Dynamics Review | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 15 work |
...
**Lesson 13 — Dynamics In Data.** If you only have time to print one
