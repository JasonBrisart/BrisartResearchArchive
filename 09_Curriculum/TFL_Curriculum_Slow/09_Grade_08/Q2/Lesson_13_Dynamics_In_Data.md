...
| | |
|---|---|
| **Central question** | Dynamics In Data: students find the three dynamics in their own sampling data? |
| **Core concept** | Real sampled data sometimes cannot be classified at the available rate. |
| **Student outcome** | Students find the three dynamics in their own sampling data. |
| **Previous lesson** | Lesson 12 — Three Dynamics |
| **Next lesson** | Lesson 14 — Escalation Is Not A Diagnosis |
...
**The conceptual step.** Real sampled data sometimes cannot be classified at the available rate. Cannot tell is a full-credit answer when the rate does not support a classification.
...
**What depends on it.** Lesson 14 — Escalation Is Not A Diagnosis — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Real sampled data sometimes cannot be classified at the available rate. Cannot tell is a full-credit answer when the rate does not support a classification.
...
1. A log clearly showing sustained recurrence.
2. A log marked unclassifiable at the available rate.

### One non-example

An ambiguous log forced into the escalation category.
...
That real data sometimes resists classification.

### What this activity does not establish

Which dynamic is most common.
...
| Statement | Status |
|---|---|
| Real sampled data sometimes cannot be classified at the available rate. | Framework-derived, appropriate at this grade |
| That real data sometimes resists classification. | What this specific activity can show |
| Which dynamic is most common. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — Three Dynamics — specifically: students classify system behaviour into the three dynamics.

**How it was taught.** Through the activity: classify eight scenarios and state the driving condition for each

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: classify eight scenarios and state the driving condition for each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A log clearly showing sustained recurrence. |
| **Non-example** | An ambiguous log forced into the escalation category. |
...
> "Same loop, different conditions. Not three different systems."
...
**Exact wording.** "Ask which shape their five-checkpoint log shows."
...
**Target observation.** That real data sometimes resists classification.
...
> "Real sampled data sometimes cannot be classified at the available rate. You just saw that when ask which shape their five-checkpoint log shows.
> Last time we said: Same loop, different conditions. Not three different systems. This is the next part of that.
...
**What students must not infer.** Which dynamic is most common.

### 4. Worked example

**The example.** A log clearly showing sustained recurrence.
...
**Completed answer.** A log clearly showing sustained recurrence. — which demonstrates that real data sometimes resists classification.
...
**Conclusions not licensed.** Which dynamic is most common.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A log marked unclassifiable at the available rate. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An ambiguous log forced into the escalation category. Why is this not an
example?"
...
**Exact student instructions.** Classify their own log and two classmates' logs into the three dynamics.
...
- *Licensed conclusion.* That real data sometimes resists classification.
- *Not licensed.* Which dynamic is most common.
...
- *Expected response.* That real data sometimes resists classification.
...
1. Any wording carrying the idea in `Real sampled data sometimes cannot be classified at the available rate`.
...
Say: "You can see the shapes in real data, not just in descriptions."
...
| | |
|---|---|
| **Follows** | Lesson 12 — Three Dynamics |
| **Leads to** | Lesson 14 — Escalation Is Not A Diagnosis |

**Transition in.** Lesson 12 established students classify system behaviour into the three dynamics. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find the three dynamics in their own sampling data. Lesson 14 assumes it and builds students state the boundary around the escalation dynamic.
