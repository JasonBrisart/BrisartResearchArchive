...
| | |
|---|---|
| **Central question** | Belief As A Prior: students identify Belief(t) constraining retrieval under ambiguity? |
| **Core concept** | Belief(t) is a stabilised prior that constrains which memories are retrieved and which simulations are generated under ambiguity. |
| **Student outcome** | Students identify Belief(t) constraining retrieval under ambiguity. |
| **Previous lesson** | Lesson 8 — The Sampling Review |
| **Next lesson** | Lesson 10 — Where Belief Comes From |
...
**The conceptual step.** Belief(t) is a stabilised prior that constrains which memories are retrieved and which simulations are generated under ambiguity. It biases; it does not override unambiguous input.
...
**What depends on it.** Lesson 10 — Where Belief Comes From — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Belief(t) is a stabilised prior that constrains which memories are retrieved and which simulations are generated under ambiguity. It biases; it does not override unambiguous input.
...
1. An ambiguous image producing different simulations from different priors.
2. A student stating what somebody with the opposite belief would expect.

### One non-example

A claim that belief determines what you see regardless of input.
...
That priors bias retrieval and simulation under ambiguity.

### What this activity does not establish

How strongly priors bias.
...
| Statement | Status |
|---|---|
| Belief(t) is a stabilised prior that constrains which memories are retrieved and which simulations are generated under ambiguity. | Framework-derived, appropriate at this grade |
| That priors bias retrieval and simulation under ambiguity. | What this specific activity can show |
| How strongly priors bias. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Sampling Review — specifically: students consolidate sampling.

**How it was taught.** Through the activity: review with six results judged against their stated rates

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: review with six results judged against their stated rates, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An ambiguous image producing different simulations from different priors. |
| **Non-example** | A claim that belief determines what you see regardless of input. |
...
> "Next time: what shapes which memories come back at all."
...
**Exact wording.** "Present something genuinely ambiguous. Collect and read the spread of answers."
...
**Target observation.** That priors bias retrieval and simulation under ambiguity.
...
> "Belief(t) is a stabilised prior that constrains which memories are retrieved and which simulations are generated under ambiguity. You just saw that when present something genuinely ambiguous.
> Last time we said: Next time: what shapes which memories come back at all. This is the next part of that.
...
**What students must not infer.** How strongly priors bias.

### 4. Worked example

**The example.** An ambiguous image producing different simulations from different priors.
...
**Completed answer.** An ambiguous image producing different simulations from different priors. — which demonstrates that priors bias retrieval and simulation under ambiguity.
...
**Conclusions not licensed.** How strongly priors bias.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student stating what somebody with the opposite belief would expect. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that belief determines what you see regardless of input. Why is this not an
example?"
...
**Exact student instructions.** Trace one ambiguous situation and state what a differently-believing person would expect.
...
- *Licensed conclusion.* That priors bias retrieval and simulation under ambiguity.
- *Not licensed.* How strongly priors bias.
...
- *Expected response.* That priors bias retrieval and simulation under ambiguity.
...
1. Any wording carrying the idea in `Belief(t) is a stabilised prior that constrains which memories are retrieved and which simulations are generated under ambiguity`.
...
Say: "Same input, different prior, different simulation."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Sampling Review |
| **Leads to** | Lesson 10 — Where Belief Comes From |

**Transition in.** Lesson 8 established students consolidate sampling. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify Belief(t) constraining retrieval under ambiguity. Lesson 10 assumes it and builds students trace a belief to its source.
