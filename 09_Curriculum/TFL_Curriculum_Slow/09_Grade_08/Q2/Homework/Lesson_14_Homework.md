# Lesson 14 Homework — Escalation Is Not A Diagnosis

**Grade 8** · Contradiction and Limits · **Quarter 2**
**Follows:** Lesson 14 — Escalation Is Not A Diagnosis · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 14 ended on, from memory:
...
Rewrite four escalation descriptions so none describes a person.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every description is of system behaviour, not a person
...
Lesson 15 is **Dynamics Elsewhere**, which assumes you arrive holding it. Write one thing you expect it to be about:
