# Lesson 11 Homework — Belief Versus Expectation

**Grade 8** · Contradiction and Limits · **Quarter 2**
**Follows:** Lesson 11 — Belief Versus Expectation · **Points:** 5 · **Optional:** yes
...
Sort twelve statements into beliefs and expectations with the deciding criterion named.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student sorts at least nine correctly and names the criterion
...
Lesson 12 is **Three Dynamics**, which assumes you arrive holding it. Write one thing you expect it to be about:
