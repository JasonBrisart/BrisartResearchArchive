# Lesson 15 Homework — Dynamics Elsewhere

**Grade 8** · Contradiction and Limits · **Quarter 2**
**Follows:** Lesson 15 — Dynamics Elsewhere · **Points:** 5 · **Optional:** yes
...
Three non-personal examples, one per dynamic, with conditions named.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces three non-personal examples
...
Lesson 16 is **The Dynamics Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
