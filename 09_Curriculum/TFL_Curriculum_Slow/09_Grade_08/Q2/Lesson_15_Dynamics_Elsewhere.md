...
| | |
|---|---|
| **Central question** | Dynamics Elsewhere: students find the dynamics in non-personal systems? |
| **Core concept** | The three dynamics describe conditions rather than agents, which is why they appear in weather, traffic, and queues as readily as anywhere else. |
| **Student outcome** | Students find the dynamics in non-personal systems. |
| **Previous lesson** | Lesson 14 — Escalation Is Not A Diagnosis |
| **Next lesson** | Lesson 16 — The Dynamics Review |
...
**The conceptual step.** The three dynamics describe conditions rather than agents, which is why they appear in weather, traffic, and queues as readily as anywhere else.
...
**What depends on it.** Lesson 16 — The Dynamics Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The three dynamics describe conditions rather than agents, which is why they appear in weather, traffic, and queues as readily as anywhere else.
...
1. A traffic queue showing sustained recurrence.
2. A game state showing rapid resolution.

### One non-example

A classmate offered as an example of escalation.
...
That the dynamics are condition-driven and general.

### What this activity does not establish

Whether those systems work the same way.
...
| Statement | Status |
|---|---|
| The three dynamics describe conditions rather than agents, which is why they appear in weather, traffic, and queues as readily as anywhere else. | Framework-derived, appropriate at this grade |
| That the dynamics are condition-driven and general. | What this specific activity can show |
| Whether those systems work the same way. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Escalation Is Not A Diagnosis — specifically: students state the boundary around the escalation dynamic.

**How it was taught.** Through the activity: rewrite four escalation descriptions so none describes a person

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: rewrite four escalation descriptions so none describes a person, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A traffic queue showing sustained recurrence. |
| **Non-example** | A classmate offered as an example of escalation. |
...
> "It describes a loop under conditions. Nothing else."
...
**Exact wording.** "Ask where else they see these three shapes, not in people."
...
**Target observation.** That the dynamics are condition-driven and general.
...
> "The three dynamics describe conditions rather than agents, which is why they appear in weather, traffic, and queues as readily as anywhere else. You just saw that when ask where else they see these three shapes, not in people.
> Last time we said: It describes a loop under conditions. Nothing else. This is the next part of that.
...
**What students must not infer.** Whether those systems work the same way.

### 4. Worked example

**The example.** A traffic queue showing sustained recurrence.
...
**Completed answer.** A traffic queue showing sustained recurrence. — which demonstrates that the dynamics are condition-driven and general.
...
**Conclusions not licensed.** Whether those systems work the same way.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A game state showing rapid resolution. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A classmate offered as an example of escalation. Why is this not an
example?"
...
**Exact student instructions.** Three non-personal examples, one per dynamic, with conditions named.
...
- *Licensed conclusion.* That the dynamics are condition-driven and general.
- *Not licensed.* Whether those systems work the same way.
...
- *Expected response.* That the dynamics are condition-driven and general.
...
1. Any wording carrying the idea in `The three dynamics describe conditions rather than agents, which is why they appear in weather, traffic, and queues as readily as anywhere else`.
...
Say: "The shapes are about conditions, not about who."
...
| | |
|---|---|
| **Follows** | Lesson 14 — Escalation Is Not A Diagnosis |
| **Leads to** | Lesson 16 — The Dynamics Review |

**Transition in.** Lesson 14 established students state the boundary around the escalation dynamic. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find the dynamics in non-personal systems. Lesson 16 assumes it and builds students consolidate belief and dynamics.
