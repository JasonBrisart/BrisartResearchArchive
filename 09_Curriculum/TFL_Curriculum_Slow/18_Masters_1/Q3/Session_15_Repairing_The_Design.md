# Session 15 — Repairing The Design
...
| | |
|---|---|
| **Central question** | Repairing The Design: students revise the design against every source of feedback? |
| **Core concept** | A change log names the source of each revision, which distinguishes a revision from a rewrite and allows the reasoning to be audited later. |
| **Student outcome** | Students revise the design against every source of feedback. |
| **Previous session** | Session 14 — Reading The Examination |
| **Next session** | Session 16 — The Executability Test |
...
**The conceptual step.** A change log names the source of each revision, which distinguishes a revision from a rewrite and allows the reasoning to be audited later.
...
**What depends on it.** Session 16 — The Executability Test — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A change log names the source of each revision, which distinguishes a revision from a rewrite and allows the reasoning to be audited later.
...
1. A change log naming the peer attack as a change source.
2. A change traced to a specific examination weakness.

### One non-example

A revised design with no record of what prompted each change.
...
That revisions can be sourced and audited.

### What this activity does not establish

Whether the revised design is sound.
...
| Statement | Status |
|---|---|
| A change log names the source of each revision, which distinguishes a revision from a rewrite and allows the reasoning to be audited later. | Framework-derived, appropriate at this grade |
| That revisions can be sourced and audited. | What this specific activity can show |
| Whether the revised design is sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 14 — Reading The Examination — specifically: students diagnose their own examination performance.

**How it was taught.** Through the activity: convert examination weaknesses into two specific design revisions

**Quick check.** Ask for the closing sentence of Session 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 14: convert examination weaknesses into two specific design revisions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A change log naming the peer attack as a change source. |
| **Non-example** | A revised design with no record of what prompted each change. |
...
> "The examination was a diagnostic, not a verdict."
...
**Exact wording.** "Say: peer attack, the audit, and the examination. All of it into one revision."
...
**Target observation.** That revisions can be sourced and audited.
...
> "A change log names the source of each revision, which distinguishes a revision from a rewrite and allows the reasoning to be audited later. You just saw that when say: peer attack, the audit, and the examination.
> Last time we said: The examination was a diagnostic, not a verdict. This is the next part of that.
...
**What students must not infer.** Whether the revised design is sound.

### 4. Worked example

**The example.** A change log naming the peer attack as a change source.
...
**Completed answer.** A change log naming the peer attack as a change source. — which demonstrates that revisions can be sourced and audited.
...
**Conclusions not licensed.** Whether the revised design is sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A change traced to a specific examination weakness. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A revised design with no record of what prompted each change. Why is this not an
example?"
...
**Exact student instructions.** A revised design with a change log naming the source of each change.
...
- *Licensed conclusion.* That revisions can be sourced and audited.
- *Not licensed.* Whether the revised design is sound.
...
- *Expected response.* That revisions can be sourced and audited.
...
1. Any wording carrying the idea in `A change log names the source of each revision, which distinguishes a revision from a rewrite and allows the reasoning to be audited later`.
...
Say: "A revision without a log is a rewrite."
...
| | |
|---|---|
| **Follows** | Session 14 — Reading The Examination |
| **Leads to** | Session 16 — The Executability Test |

**Transition in.** Session 14 established students diagnose their own examination performance. This session uses that as the starting point.

**Transition out.** This session establishes students revise the design against every source of feedback. Session 16 assumes it and builds students test the whole design by external execution.
