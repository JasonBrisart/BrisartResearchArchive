# Session 15 Homework — Repairing The Design

**Master's Year 1** · Executable Measurement · **Quarter 3**
**Follows:** Session 15 — Repairing The Design · **Points:** 5 · **Optional:** yes
...
A revised design with a change log naming the source of each change.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every change names its source
...
Session 16 is **The Executability Test**, which assumes you arrive holding it. Write one thing you expect it to be about:
