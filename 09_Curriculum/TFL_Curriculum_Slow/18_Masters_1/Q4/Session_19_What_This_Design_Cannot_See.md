# Session 19 — What This Design Cannot See
...
| | |
|---|---|
| **Central question** | What This Design Cannot See: students state specific blind spots? |
| **Core concept** | A blind spot names a specific phenomenon the design could not detect. |
| **Student outcome** | Students state specific blind spots. |
| **Previous session** | Session 18 — Human Subjects And Institutional Duty |
| **Next session** | Session 20 — The Design Portfolio |
...
**The conceptual step.** A blind spot names a specific phenomenon the design could not detect. Generic limitations are not blind spots and do not make results interpretable.
...
**What depends on it.** Session 20 — The Design Portfolio — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A blind spot names a specific phenomenon the design could not detect. Generic limitations are not blind spots and do not make results interpretable.
...
1. A blind spot naming sub-second transitions as undetectable.
2. A conclusion the design does not license, named specifically.

### One non-example

A limitation stating the sample was modest.
...
That blind spots can be named specifically.

### What this activity does not establish

Whether the blind spots matter.
...
| Statement | Status |
|---|---|
| A blind spot names a specific phenomenon the design could not detect. | Framework-derived, appropriate at this grade |
| That blind spots can be named specifically. | What this specific activity can show |
| Whether the blind spots matter. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 18 — Human Subjects And Institutional Duty — specifically: students state the obligations attached to running studies on people.

**How it was taught.** Through the activity: complete the compliance checklist and state whether the design is hypothetical

**Quick check.** Ask for the closing sentence of Session 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 18: complete the compliance checklist and state whether the design is hypothetical, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A blind spot naming sub-second transitions as undetectable. |
| **Non-example** | A limitation stating the sample was modest. |
...
> "This is the difference between a design and a study."
...
**Exact wording.** "Ask what it could not detect even if it ran perfectly."
...
**Target observation.** That blind spots can be named specifically.
...
> "A blind spot names a specific phenomenon the design could not detect. You just saw that when ask what it could not detect even if it ran perfectly.
> Last time we said: This is the difference between a design and a study. This is the next part of that.
...
**What students must not infer.** Whether the blind spots matter.

### 4. Worked example

**The example.** A blind spot naming sub-second transitions as undetectable.
...
**Completed answer.** A blind spot naming sub-second transitions as undetectable. — which demonstrates that blind spots can be named specifically.
...
**Conclusions not licensed.** Whether the blind spots matter.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A conclusion the design does not license, named specifically. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A limitation stating the sample was modest. Why is this not an
example?"
...
**Exact student instructions.** List three blind spots and one conclusion not licensed.
...
- *Licensed conclusion.* That blind spots can be named specifically.
- *Not licensed.* Whether the blind spots matter.
...
- *Expected response.* That blind spots can be named specifically.
...
1. Any wording carrying the idea in `A blind spot names a specific phenomenon the design could not detect`.
...
Say: "Naming what you cannot see makes the rest interpretable."
...
| | |
|---|---|
| **Follows** | Session 18 — Human Subjects And Institutional Duty |
| **Leads to** | Session 20 — The Design Portfolio |

**Transition in.** Session 18 established students state the obligations attached to running studies on people. This session uses that as the starting point.

**Transition out.** This session establishes students state specific blind spots. Session 20 assumes it and builds students assemble the complete design package.
