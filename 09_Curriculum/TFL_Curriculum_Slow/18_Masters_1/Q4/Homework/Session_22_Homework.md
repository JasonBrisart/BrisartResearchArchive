# Session 22 Homework — Final Revision

**Master's Year 1** · Executable Measurement · **Quarter 4**
**Follows:** Session 22 — Final Revision · **Points:** 5 · **Optional:** yes
...
Final revision with a complete change log.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every unanswered question from rehearsal is addressed
...
Session 23 is **Portfolio Submission**, which assumes you arrive holding it. Write one thing you expect it to be about:
