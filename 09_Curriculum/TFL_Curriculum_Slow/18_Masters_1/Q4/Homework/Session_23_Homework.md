# Session 23 Homework — Portfolio Submission

**Master's Year 1** · Executable Measurement · **Quarter 4**
**Follows:** Session 23 — Portfolio Submission · **Points:** 5 · **Optional:** yes
...
Presentation and submission, with the gate checked by external execution first.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the executability gate is passed by external execution
...
Session 24 is **The Year In Designs**, which assumes you arrive holding it. Write one thing you expect it to be about:
