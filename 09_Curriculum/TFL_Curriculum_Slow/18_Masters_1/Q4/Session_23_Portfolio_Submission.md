# Session 23 — Portfolio Submission
...
| | |
|---|---|
| **Central question** | Portfolio Submission: students submit and present the portfolio? |
| **Core concept** | The executability gate is checked by external execution before any presentation. |
| **Student outcome** | Students submit and present the portfolio. |
| **Previous session** | Session 22 — Final Revision |
| **Next session** | Session 24 — The Year In Designs |
...
**The conceptual step.** The executability gate is checked by external execution before any presentation. A design that requires its author present has failed regardless of how well it is presented.
...
**What depends on it.** Session 24 — The Year In Designs — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The executability gate is checked by external execution before any presentation. A design that requires its author present has failed regardless of how well it is presented.
...
1. A portfolio passing blind execution before presentation.
2. A six-minute presentation covering all nine components.

### One non-example

A portfolio presented before executability was tested.
...
Whether the portfolio is executable.
...
| Statement | Status |
|---|---|
| The executability gate is checked by external execution before any presentation. | Framework-derived, appropriate at this grade |
| Whether the portfolio is executable. | What this specific activity can show |
| Whether the design is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 22 — Final Revision — specifically: students make the last revision before submission.

**How it was taught.** Through the activity: final revision with a complete change log

**Quick check.** Ask for the closing sentence of Session 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 22: final revision with a complete change log, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A portfolio passing blind execution before presentation. |
| **Non-example** | A portfolio presented before executability was tested. |
...
**Exact wording.** "Say: present the nine components. Six minutes."
...
**Target observation.** Whether the portfolio is executable.
...
> "The executability gate is checked by external execution before any presentation. You just saw that when say: present the nine components.
> Last time we said: That is the portfolio. This is the next part of that.
...
**The example.** A portfolio passing blind execution before presentation.
...
**Completed answer.** A portfolio passing blind execution before presentation. — which demonstrates whether the portfolio is executable.
...
**Teacher prompt.** "Here is a second case. A six-minute presentation covering all nine components. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A portfolio presented before executability was tested. Why is this not an
example?"
...
**Exact student instructions.** Presentation and submission, with the gate checked by external execution first.
...
- *Licensed conclusion.* Whether the portfolio is executable.
...
- *Expected response.* Whether the portfolio is executable.
...
1. Any wording carrying the idea in `The executability gate is checked by external execution before any presentation`.
...
Say: "Next year you review each other to journal standard."
...
| | |
|---|---|
| **Follows** | Session 22 — Final Revision |
| **Leads to** | Session 24 — The Year In Designs |

**Transition in.** Session 22 established students make the last revision before submission. This session uses that as the starting point.

**Transition out.** This session establishes students submit and present the portfolio. Session 24 assumes it and builds students review the year through their own drafts.
