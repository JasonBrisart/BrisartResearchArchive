# Session 21 — Rehearsing The Defence

**Master's Year 1** · Executable Measurement · **Quarter 4** · **100 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Rehearsing The Defence: students rehearse against measurement, inference, and scope challengers? |
| **Core concept** | An instrument is defended by addressing what else it might capture. |
| **Student outcome** | Students rehearse against measurement, inference, and scope challengers. |
| **Previous session** | Session 20 — The Design Portfolio |
| **Next session** | Session 22 — Final Revision |
...
**The conceptual step.** An instrument is defended by addressing what else it might capture. Restating the design intention is the commonest evasion and is not a defence.
...
**What depends on it.** Session 22 — Final Revision — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An instrument is defended by addressing what else it might capture. Restating the design intention is the commonest evasion and is not a defence.
...
A defence restating what the instrument was meant to measure.
...
That unanswered questions can be identified in rehearsal.
...
| Statement | Status |
|---|---|
| An instrument is defended by addressing what else it might capture. | Framework-derived, appropriate at this grade |
| That unanswered questions can be identified in rehearsal. | What this specific activity can show |
| Whether the defence will succeed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 20 — The Design Portfolio — specifically: students assemble the complete design package.

**How it was taught.** Through the activity: assemble all nine components and self-audit against the gate

**Quick check.** Ask for the closing sentence of Session 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 20: assemble all nine components and self-audit against the gate, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A defence restating what the instrument was meant to measure. |
...
> "The gate is executability. Everything else is points."
...
**Exact wording.** "Assign three roles. Six minutes presenting, four defending."
...
**Target observation.** That unanswered questions can be identified in rehearsal.
...
> "An instrument is defended by addressing what else it might capture. You just saw that when assign three roles.
> Last time we said: The gate is executability. Everything else is points. This is the next part of that.
...
**Completed answer.** A defence naming and excluding an alternative construct. — which demonstrates that unanswered questions can be identified in rehearsal.
...
**Teacher prompt.** "Now one that does not work. A defence restating what the instrument was meant to measure. Why is this not an
example?"
...
**Exact student instructions.** A full rehearsal with every unanswered question recorded.
...
- *Licensed conclusion.* That unanswered questions can be identified in rehearsal.
...
- *Expected response.* That unanswered questions can be identified in rehearsal.
...
1. Any wording carrying the idea in `An instrument is defended by addressing what else it might capture`.
...
| | |
|---|---|
| **Follows** | Session 20 — The Design Portfolio |
| **Leads to** | Session 22 — Final Revision |

**Transition in.** Session 20 established students assemble the complete design package. This session uses that as the starting point.

**Transition out.** This session establishes students rehearse against measurement, inference, and scope challengers. Session 22 assumes it and builds students make the last revision before submission.
