...
| | |
|---|---|
| **Central question** | Final Revision: students make the last revision before submission? |
| **Core concept** | Every unanswered question from rehearsal produces a change log entry. |
| **Student outcome** | Students make the last revision before submission. |
| **Previous session** | Session 21 — Rehearsing The Defence |
| **Next session** | Session 23 — Portfolio Submission |
...
**The conceptual step.** Every unanswered question from rehearsal produces a change log entry. Leaving them unaddressed means the rehearsal produced nothing.
...
**What depends on it.** Session 23 — Portfolio Submission — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every unanswered question from rehearsal produces a change log entry. Leaving them unaddressed means the rehearsal produced nothing.
...
1. A change log with one entry per unanswered question.
2. A revision addressing the scope challenger's question.

### One non-example

A portfolio submitted with rehearsal questions unaddressed.
...
That rehearsal feedback is convertible into revisions.

### What this activity does not establish

Whether the portfolio is sound.
...
| Statement | Status |
|---|---|
| Every unanswered question from rehearsal produces a change log entry. | Framework-derived, appropriate at this grade |
| That rehearsal feedback is convertible into revisions. | What this specific activity can show |
| Whether the portfolio is sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 21 — Rehearsing The Defence — specifically: students rehearse against measurement, inference, and scope challengers.

**How it was taught.** Through the activity: a full rehearsal with every unanswered question recorded

**Quick check.** Ask for the closing sentence of Session 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 21: a full rehearsal with every unanswered question recorded, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A change log with one entry per unanswered question. |
| **Non-example** | A portfolio submitted with rehearsal questions unaddressed. |
...
**Exact wording.** "Say: everything you have been told. One last pass."
...
**Target observation.** That rehearsal feedback is convertible into revisions.
...
> "Every unanswered question from rehearsal produces a change log entry. You just saw that when say: everything you have been told.
...
**What students must not infer.** Whether the portfolio is sound.

### 4. Worked example

**The example.** A change log with one entry per unanswered question.
...
**Completed answer.** A change log with one entry per unanswered question. — which demonstrates that rehearsal feedback is convertible into revisions.
...
**Conclusions not licensed.** Whether the portfolio is sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A revision addressing the scope challenger's question. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A portfolio submitted with rehearsal questions unaddressed. Why is this not an
example?"
...
**Exact student instructions.** Final revision with a complete change log.
...
- *Licensed conclusion.* That rehearsal feedback is convertible into revisions.
- *Not licensed.* Whether the portfolio is sound.
...
- *Expected response.* That rehearsal feedback is convertible into revisions.
...
1. Any wording carrying the idea in `Every unanswered question from rehearsal produces a change log entry`.
...
| | |
|---|---|
| **Follows** | Session 21 — Rehearsing The Defence |
| **Leads to** | Session 23 — Portfolio Submission |

**Transition in.** Session 21 established students rehearse against measurement, inference, and scope challengers. This session uses that as the starting point.

**Transition out.** This session establishes students make the last revision before submission. Session 23 assumes it and builds students submit and present the portfolio.
