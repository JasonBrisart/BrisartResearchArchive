# Session 6 Homework — Can You Estimate The Weights

**Master's Year 1** · Executable Measurement · **Quarter 1**
**Follows:** Session 6 — Can You Estimate The Weights · **Points:** 5 · **Optional:** yes
...
Write the feasibility statement listing which claims survive without the weights.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student states honestly whether estimation is feasible
...
Session 7 is **The Map Assembled**, which assumes you arrive holding it. Write one thing you expect it to be about:
