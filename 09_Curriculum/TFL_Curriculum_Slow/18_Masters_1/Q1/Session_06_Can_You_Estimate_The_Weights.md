# Session 6 — Can You Estimate The Weights
...
| | |
|---|---|
| **Central question** | Can You Estimate The Weights: students determine honestly whether their design can recover parameters? |
| **Core concept** | Retrieved memory and generated simulation covary by construction in most tasks, making the integration weights unidentifiable. |
| **Student outcome** | Students determine honestly whether their design can recover parameters. |
| **Previous session** | Session 5 — Matching Claim Scale To Resolution |
| **Next session** | Session 7 — The Map Assembled |
| **Materials** | Lab books; printed map and protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_06_Printout.md` |
| **Homework** | `Homework/Session_06_Homework.md` |

## Why this lesson exists

**The conceptual step.** Retrieved memory and generated simulation covary by construction in most tasks, making the integration weights unidentifiable. Declaring estimation infeasible is the correct answer for most designs.
...
**What depends on it.** Session 7 — The Map Assembled — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Retrieved memory and generated simulation covary by construction in most tasks, making the integration weights unidentifiable. Declaring estimation infeasible is the correct answer for most designs.
...
1. A feasibility statement declaring estimation infeasible with the reason.
2. A list of claims that survive without weight estimates.

### One non-example

A proposal to estimate weights by regression on collinear predictors.
...
That estimation feasibility can be assessed before collection.
...
| Statement | Status |
|---|---|
| Retrieved memory and generated simulation covary by construction in most tasks, making the integration weights unidentifiable. | Framework-derived, appropriate at this grade |
| That estimation feasibility can be assessed before collection. | What this specific activity can show |
| What the weights are. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 5 — Matching Claim Scale To Resolution — specifically: students declare the scale their design can observe.

**How it was taught.** Through the activity: write the resolution declaration ending with conclusions not licensed

**Quick check.** Ask for the closing sentence of Session 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 5: write the resolution declaration ending with conclusions not licensed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A feasibility statement declaring estimation infeasible with the reason. |
| **Non-example** | A proposal to estimate weights by regression on collinear predictors. |
...
**Student materials.** One copy of `Printouts/Session_06_Printout.md` per student.

**Prior student data required.** Work produced in Session 5, kept in the student's folder.
...
**File.** `Printouts/Session_06_Printout.md`
...
> "Put it at the top of your protocol. Reviewers check whether your conclusions stay in it."
...
**Exact wording.** "Ask what it would take to estimate the weights, and whether they can."
...
**Target observation.** That estimation feasibility can be assessed before collection.
...
> "Retrieved memory and generated simulation covary by construction in most tasks, making the integration weights unidentifiable. You just saw that when ask what it would take to estimate the weights, and whether they can.
> Last time we said: Put it at the top of your protocol. Reviewers check whether your conclusions stay in it. This is the next part of that.
...
**What students must not infer.** What the weights are.

### 4. Worked example

**The example.** A feasibility statement declaring estimation infeasible with the reason.
...
**Completed answer.** A feasibility statement declaring estimation infeasible with the reason. — which demonstrates that estimation feasibility can be assessed before collection.
...
**Conclusions not licensed.** What the weights are.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A list of claims that survive without weight estimates. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A proposal to estimate weights by regression on collinear predictors. Why is this not an
example?"
...
**Exact student instructions.** Write the feasibility statement listing which claims survive without the weights.
...
- *Licensed conclusion.* That estimation feasibility can be assessed before collection.
- *Not licensed.* What the weights are.
...
- *Expected response.* That estimation feasibility can be assessed before collection.
...
1. Any wording carrying the idea in `Retrieved memory and generated simulation covary by construction in most tasks, making the integration weights unidentifiable`.
...
Say: "Most course designs cannot. Declaring it is the correct answer."

**Why this sentence matters.** It is the opening question of Session 7, which assumes students arrive holding it.
...
**File.** `Homework/Session_06_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 5 — Matching Claim Scale To Resolution |
| **Leads to** | Session 7 — The Map Assembled |

**Transition in.** Session 5 established students declare the scale their design can observe. This session uses that as the starting point.

**Transition out.** This session establishes students determine honestly whether their design can recover parameters. Session 7 assumes it and builds students assemble all instruments into one executable map.
