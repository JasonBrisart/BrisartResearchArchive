# Session 5 — Matching Claim Scale To Resolution
...
| | |
|---|---|
| **Central question** | Matching Claim Scale To Resolution: students declare the scale their design can observe? |
| **Core concept** | A resolution declaration states the observation scale and names the conclusions the design does not license. |
| **Student outcome** | Students declare the scale their design can observe. |
| **Previous session** | Session 4 — Persistence Criterion And Sampling |
| **Next session** | Session 6 — Can You Estimate The Weights |
...
**The conceptual step.** A resolution declaration states the observation scale and names the conclusions the design does not license. Reviewers check the discussion against it.
...
**What depends on it.** Session 6 — Can You Estimate The Weights — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A resolution declaration states the observation scale and names the conclusions the design does not license. Reviewers check the discussion against it.
...
1. A declaration excluding within-window mechanistic conclusions.
2. A named conclusion about window-level integration the design cannot support.

### One non-example

A final line stating that the study has resolution limitations.
...
That claim scale must be declared in advance.

### What this activity does not establish

Whether the design is otherwise sound.
...
| Statement | Status |
|---|---|
| A resolution declaration states the observation scale and names the conclusions the design does not license. | Framework-derived, appropriate at this grade |
| That claim scale must be declared in advance. | What this specific activity can show |
| Whether the design is otherwise sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 4 — Persistence Criterion And Sampling — specifically: students fix the criterion and interval before data exist.

**How it was taught.** Through the activity: complete both specifications and name one way the criterion could be adjusted post hoc

**Quick check.** Ask for the closing sentence of Session 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 4: complete both specifications and name one way the criterion could be adjusted post hoc, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A declaration excluding within-window mechanistic conclusions. |
| **Non-example** | A final line stating that the study has resolution limitations. |
...
> "Your sampling interval sets a floor on what you can see."
...
**Exact wording.** "Say: the framework specifies milliseconds. Almost none of you can observe there."
...
**Target observation.** That claim scale must be declared in advance.
...
> "A resolution declaration states the observation scale and names the conclusions the design does not license. You just saw that when say: the framework specifies milliseconds.
> Last time we said: Your sampling interval sets a floor on what you can see. This is the next part of that.
...
**What students must not infer.** Whether the design is otherwise sound.

### 4. Worked example

**The example.** A declaration excluding within-window mechanistic conclusions.
...
**Completed answer.** A declaration excluding within-window mechanistic conclusions. — which demonstrates that claim scale must be declared in advance.
...
**Conclusions not licensed.** Whether the design is otherwise sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A named conclusion about window-level integration the design cannot support. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A final line stating that the study has resolution limitations. Why is this not an
example?"
...
**Exact student instructions.** Write the resolution declaration ending with conclusions not licensed.
...
- *Licensed conclusion.* That claim scale must be declared in advance.
- *Not licensed.* Whether the design is otherwise sound.
...
- *Expected response.* That claim scale must be declared in advance.
...
1. Any wording carrying the idea in `A resolution declaration states the observation scale and names the conclusions the design does not license`.
...
Say: "Put it at the top of your protocol. Reviewers check whether your conclusions stay in it."
...
| | |
|---|---|
| **Follows** | Session 4 — Persistence Criterion And Sampling |
| **Leads to** | Session 6 — Can You Estimate The Weights |

**Transition in.** Session 4 established students fix the criterion and interval before data exist. This session uses that as the starting point.

**Transition out.** This session establishes students declare the scale their design can observe. Session 6 assumes it and builds students determine honestly whether their design can recover parameters.
