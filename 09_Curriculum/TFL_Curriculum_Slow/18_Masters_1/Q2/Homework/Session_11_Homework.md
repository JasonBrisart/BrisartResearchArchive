# Session 11 Homework — Scope Enforcement In Design

**Master's Year 1** · Executable Measurement · **Quarter 2**
**Follows:** Session 11 — Scope Enforcement In Design · **Points:** 5 · **Optional:** yes
...
Write a formal rejection of an invalid variant of their own design.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names why the invalid version was tempting
...
Session 12 is **The Midterm Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
