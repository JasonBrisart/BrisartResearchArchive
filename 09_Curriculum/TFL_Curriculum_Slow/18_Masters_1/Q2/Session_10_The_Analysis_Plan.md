...
| | |
|---|---|
| **Central question** | The Analysis Plan: students fix every consequential decision before data exist? |
| **Core concept** | An analysis plan fixes ten decisions before data exist. |
| **Student outcome** | Students fix every consequential decision before data exist. |
| **Previous session** | Session 9 — Confounds And Controls |
| **Next session** | Session 11 — Scope Enforcement In Design |
...
**The conceptual step.** An analysis plan fixes ten decisions before data exist. The unscoreable-response rule is the most frequently omitted and the one that most affects the result.
...
**What depends on it.** Session 11 — Scope Enforcement In Design — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An analysis plan fixes ten decisions before data exist. The unscoreable-response rule is the most frequently omitted and the one that most affects the result.
...
1. A plan with an explicit rule for unscoreable responses.
2. A peer audit confirming the falsification condition could fire.

### One non-example

A plan with nine items and no unscoreable rule.
...
That analysis plans can be audited for completeness.

### What this activity does not establish

Whether the analysis will be informative.
...
| Statement | Status |
|---|---|
| An analysis plan fixes ten decisions before data exist. | Framework-derived, appropriate at this grade |
| That analysis plans can be audited for completeness. | What this specific activity can show |
| Whether the analysis will be informative. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 9 — Confounds And Controls — specifically: students identify and control what would invalidate their result.

**How it was taught.** Through the activity: structured peer attack in three rounds, then the seven-row confound table

**Quick check.** Ask for the closing sentence of Session 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 9: structured peer attack in three rounds, then the seven-row confound table, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A plan with an explicit rule for unscoreable responses. |
| **Non-example** | A plan with nine items and no unscoreable rule. |
...
> "The seventh one ruined your undergraduate logs and nobody noticed."
...
**Exact wording.** "Say: every undecided detail is a place where the result can be chosen."
...
**Target observation.** That analysis plans can be audited for completeness.
...
> "An analysis plan fixes ten decisions before data exist. You just saw that when say: every undecided detail is a place where the result can be chosen.
> Last time we said: The seventh one ruined your undergraduate logs and nobody noticed. This is the next part of that.
...
**What students must not infer.** Whether the analysis will be informative.

### 4. Worked example

**The example.** A plan with an explicit rule for unscoreable responses.
...
**Completed answer.** A plan with an explicit rule for unscoreable responses. — which demonstrates that analysis plans can be audited for completeness.
...
**Conclusions not licensed.** Whether the analysis will be informative.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A peer audit confirming the falsification condition could fire. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A plan with nine items and no unscoreable rule. Why is this not an
example?"
...
**Exact student instructions.** Complete the ten-item plan and peer-audit whether the condition could fire.
...
- *Licensed conclusion.* That analysis plans can be audited for completeness.
- *Not licensed.* Whether the analysis will be informative.
...
- *Expected response.* That analysis plans can be audited for completeness.
...
1. Any wording carrying the idea in `An analysis plan fixes ten decisions before data exist`.
...
Say: "A falsification condition that cannot fire is decorative."
...
| | |
|---|---|
| **Follows** | Session 9 — Confounds And Controls |
| **Leads to** | Session 11 — Scope Enforcement In Design |

**Transition in.** Session 9 established students identify and control what would invalidate their result. This session uses that as the starting point.

**Transition out.** This session establishes students fix every consequential decision before data exist. Session 11 assumes it and builds students reject an invalid variant of their own study.
