# Session 8 — Designing To Adjudicate

**Master's Year 1** · Executable Measurement · **Quarter 2** · **100 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Designing To Adjudicate: students build a design entering the discriminating condition? |
| **Core concept** | A design adjudicates only if it enters the discriminating condition and produces distinct predictions for each account. |
| **Student outcome** | Students build a design entering the discriminating condition. |
| **Previous session** | Session 7 — The Map Assembled |
| **Next session** | Session 9 — Confounds And Controls |
...
**The conceptual step.** A design adjudicates only if it enters the discriminating condition and produces distinct predictions for each account. Honest reporting of non-entry is preferable to a false claim.
...
**What depends on it.** Session 9 — Confounds And Controls — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A design adjudicates only if it enters the discriminating condition and produces distinct predictions for each account. Honest reporting of non-entry is preferable to a false claim.
...
1. A design meeting all four entry criteria with distinct predictions.
2. An honest verdict that the design does not enter the cell.

### One non-example

A claim of entry satisfying three of the four criteria.
...
That adjudication requires verifiable cell entry.

### What this activity does not establish

Which account the design would favour.
...
| Statement | Status |
|---|---|
| A design adjudicates only if it enters the discriminating condition and produces distinct predictions for each account. | Framework-derived, appropriate at this grade |
| That adjudication requires verifiable cell entry. | What this specific activity can show |
| Which account the design would favour. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 7 — The Map Assembled — specifically: students assemble all instruments into one executable map.

**How it was taught.** Through the activity: rebuild the map and have two people mark it independently

**Quick check.** Ask for the closing sentence of Session 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 7: rebuild the map and have two people mark it independently, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A design meeting all four entry criteria with distinct predictions. |
| **Non-example** | A claim of entry satisfying three of the four criteria. |
...
**Exact wording.** "Say: a result consistent with everything discriminates nothing."
...
**Target observation.** That adjudication requires verifiable cell entry.
...
> "A design adjudicates only if it enters the discriminating condition and produces distinct predictions for each account. You just saw that when say: a result consistent with everything discriminates nothing.
> Last time we said: That is what executable means. This is the next part of that.
...
**What students must not infer.** Which account the design would favour.

### 4. Worked example

**The example.** A design meeting all four entry criteria with distinct predictions.
...
**Completed answer.** A design meeting all four entry criteria with distinct predictions. — which demonstrates that adjudication requires verifiable cell entry.
...
**Conclusions not licensed.** Which account the design would favour.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An honest verdict that the design does not enter the cell. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim of entry satisfying three of the four criteria. Why is this not an
example?"
...
**Exact student instructions.** Draft the design with predictions for every account, marked for cell entry.
...
- *Licensed conclusion.* That adjudication requires verifiable cell entry.
- *Not licensed.* Which account the design would favour.
...
- *Expected response.* That adjudication requires verifiable cell entry.
...
1. Any wording carrying the idea in `A design adjudicates only if it enters the discriminating condition and produces distinct predictions for each account`.
...
| | |
|---|---|
| **Follows** | Session 7 — The Map Assembled |
| **Leads to** | Session 9 — Confounds And Controls |

**Transition in.** Session 7 established students assemble all instruments into one executable map. This session uses that as the starting point.

**Transition out.** This session establishes students build a design entering the discriminating condition. Session 9 assumes it and builds students identify and control what would invalidate their result.
