# Session 11 — Scope Enforcement In Design
...
| | |
|---|---|
| **Central question** | Scope Enforcement In Design: students reject an invalid variant of their own study? |
| **Core concept** | Methodological rigour does not rescue an out-of-scope design. |
| **Student outcome** | Students reject an invalid variant of their own study. |
| **Previous session** | Session 10 — The Analysis Plan |
...
**The conceptual step.** Methodological rigour does not rescue an out-of-scope design. Naming why the invalid version was tempting is what prevents building it later.
...
Methodological rigour does not rescue an out-of-scope design. Naming why the invalid version was tempting is what prevents building it later.
...
1. A rejection of the student's own clinical variant with the boundary named.
2. A stated reason the invalid version appealed.

### One non-example

A rejection of a colleague's design instead of one's own.
...
| Statement | Status |
|---|---|
| Methodological rigour does not rescue an out-of-scope design. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Session 10 — The Analysis Plan — specifically: students fix every consequential decision before data exist.

**How it was taught.** Through the activity: complete the ten-item plan and peer-audit whether the condition could fire

**Quick check.** Ask for the closing sentence of Session 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 10: complete the ten-item plan and peer-audit whether the condition could fire, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A rejection of the student's own clinical variant with the boundary named. |
| **Non-example** | A rejection of a colleague's design instead of one's own. |
...
> "A falsification condition that cannot fire is decorative."
...
**Exact wording.** "Say: an invalid study can be methodologically excellent. Rigour does not rescue it."
...
> "Methodological rigour does not rescue an out-of-scope design. You just saw that when say: an invalid study can be methodologically excellent.
> Last time we said: A falsification condition that cannot fire is decorative. This is the next part of that.
...
**The example.** A rejection of the student's own clinical variant with the boundary named.
...
**Completed answer.** A rejection of the student's own clinical variant with the boundary named. — which demonstrates that self-directed scope rejection is achievable.
...
**Teacher prompt.** "Now one that does not work. A rejection of a colleague's design instead of one's own. Why is this not an
example?"
...
**Exact student instructions.** Write a formal rejection of an invalid variant of their own design.
...
1. Any wording carrying the idea in `Methodological rigour does not rescue an out-of-scope design`.
...
| | |
|---|---|
| **Follows** | Session 10 — The Analysis Plan |
| **Leads to** | Session 12 — The Midterm Review |

**Transition in.** Session 10 established students fix every consequential decision before data exist. This session uses that as the starting point.

**Transition out.** This session establishes students reject an invalid variant of their own study. Session 12 assumes it and builds students consolidate the first half.
