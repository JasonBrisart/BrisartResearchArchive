...
| | |
|---|---|
| **Central question** | Breaking A Trace: students identify architectural violations in a trace? |
| **Core concept** | An architectural violation is cited by naming the rule broken, not by noting that something is absent. |
| **Student outcome** | Students identify architectural violations in a trace. |
| **Previous lesson** | Lesson 13 — Tracing With The Relation |
| **Next lesson** | Lesson 15 — Repairing A Trace |
...
**The conceptual step.** An architectural violation is cited by naming the rule broken, not by noting that something is absent. Citation makes the audit checkable.
...
**What depends on it.** Lesson 15 — Repairing A Trace — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An architectural violation is cited by naming the rule broken, not by noting that something is absent. Citation makes the audit checkable.
...
1. An audit citing the propagation requirement.
2. An audit citing the closure constraint.

### One non-example

An audit noting only that row four looks incomplete.
...
That violations are cited by rule.

### What this activity does not establish

Whether the trace is otherwise sound.
...
| Statement | Status |
|---|---|
| An architectural violation is cited by naming the rule broken, not by noting that something is absent. | Framework-derived, appropriate at this grade |
| That violations are cited by rule. | What this specific activity can show |
| Whether the trace is otherwise sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 13 — Tracing With The Relation — specifically: students hand-trace F(t) across multiple cycles.

**How it was taught.** Through the activity: a five-cycle trace with carried-in content named in every cycle after the first

**Quick check.** Ask for the closing sentence of Lesson 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 13: a five-cycle trace with carried-in content named in every cycle after the first, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit citing the propagation requirement. |
| **Non-example** | An audit noting only that row four looks incomplete. |
...
> "Propagation is explicit. Nothing arrives from outside the cycle."
...
**Exact wording.** "Put up a trace where cycle four inherits nothing and ask where it violates the architecture."
...
**Target observation.** That violations are cited by rule.
...
> "An architectural violation is cited by naming the rule broken, not by noting that something is absent. You just saw that when put up a trace where cycle four inherits nothing and ask where it violates the architecture.
> Last time we said: Propagation is explicit. Nothing arrives from outside the cycle. This is the next part of that.
...
**What students must not infer.** Whether the trace is otherwise sound.

### 4. Worked example

**The example.** An audit citing the propagation requirement.
...
**Completed answer.** An audit citing the propagation requirement. — which demonstrates that violations are cited by rule.
...
**Conclusions not licensed.** Whether the trace is otherwise sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An audit citing the closure constraint. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit noting only that row four looks incomplete. Why is this not an
example?"
...
**Exact student instructions.** Audit four traces, citing the specific rule each violation breaks.
...
- *Licensed conclusion.* That violations are cited by rule.
- *Not licensed.* Whether the trace is otherwise sound.
...
- *Expected response.* That violations are cited by rule.
...
1. Any wording carrying the idea in `An architectural violation is cited by naming the rule broken, not by noting that something is absent`.
...
| | |
|---|---|
| **Follows** | Lesson 13 — Tracing With The Relation |
| **Leads to** | Lesson 15 — Repairing A Trace |

**Transition in.** Lesson 13 established students hand-trace F(t) across multiple cycles. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify architectural violations in a trace. Lesson 15 assumes it and builds students repair an architecturally broken trace.
