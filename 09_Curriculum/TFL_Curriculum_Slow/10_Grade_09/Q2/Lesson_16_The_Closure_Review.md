...
| | |
|---|---|
| **Central question** | The Closure Review: students consolidate closure and propagation? |
| **Core concept** | Closure stated without its cost is half the idea. |
| **Student outcome** | Students consolidate closure and propagation. |
| **Previous lesson** | Lesson 15 — Repairing A Trace |
| **Next lesson** | Lesson 17 — Opening The Prediction |
...
**The conceptual step.** Closure stated without its cost is half the idea. The review enforces the cost as a required part of the statement.
...
**What depends on it.** Lesson 17 — Opening The Prediction — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Closure stated without its cost is half the idea. The review enforces the cost as a required part of the statement.
...
1. Closure stated with its falsifiability cost.
2. A proposal costed with a specific absorbed result.

### One non-example

Closure stated as a rule with no cost mentioned.
...
Whether the cost requirement is habitual.

### What this activity does not establish

Whether closure is correct.
...
| Statement | Status |
|---|---|
| Closure stated without its cost is half the idea. | Framework-derived, appropriate at this grade |
| Whether the cost requirement is habitual. | What this specific activity can show |
| Whether closure is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — Repairing A Trace — specifically: students repair an architecturally broken trace.

**How it was taught.** Through the activity: repair four audited traces and classify each repair type

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: repair four audited traces and classify each repair type, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Closure stated with its falsifiability cost. |
| **Non-example** | Closure stated as a rule with no cost mentioned. |
...
> "A break is sometimes a missing cycle, not an error."
...
**Exact wording.** "Ask what closure costs and what propagation forbids."
...
**Target observation.** Whether the cost requirement is habitual.
...
> "Closure stated without its cost is half the idea. You just saw that when ask what closure costs and what propagation forbids.
> Last time we said: A break is sometimes a missing cycle, not an error. This is the next part of that.
...
**What students must not infer.** Whether closure is correct.

### 4. Worked example

**The example.** Closure stated with its falsifiability cost.
...
**Completed answer.** Closure stated with its falsifiability cost. — which demonstrates whether the cost requirement is habitual.
...
**Conclusions not licensed.** Whether closure is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A proposal costed with a specific absorbed result. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Closure stated as a rule with no cost mentioned. Why is this not an
example?"
...
**Exact student instructions.** Review with six traces audited and four proposals costed.
...
- *Licensed conclusion.* Whether the cost requirement is habitual.
- *Not licensed.* Whether closure is correct.
...
- *Expected response.* Whether the cost requirement is habitual.
...
1. Any wording carrying the idea in `Closure stated without its cost is half the idea`.
...
Say: "Next time: the sealed prediction comes back."
...
| | |
|---|---|
| **Follows** | Lesson 15 — Repairing A Trace |
| **Leads to** | Lesson 17 — Opening The Prediction |

**Transition in.** Lesson 15 established students repair an architecturally broken trace. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate closure and propagation. Lesson 17 assumes it and builds students check their Lesson 1 sealed prediction about E(t)'s absence.
