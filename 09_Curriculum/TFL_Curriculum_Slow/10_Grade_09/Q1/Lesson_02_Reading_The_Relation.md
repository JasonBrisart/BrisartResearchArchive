...
| | |
|---|---|
| **Central question** | Reading The Relation: students decode the integration function term by term? |
| **Core concept** | Reading a formal relation means decoding every symbol including subscripts. |
| **Student outcome** | Students decode the integration function term by term. |
| **Previous lesson** | Lesson 1 — What Is Missing |
| **Next lesson** | Lesson 3 — Weights And Behaviour |
...
**The conceptual step.** Reading a formal relation means decoding every symbol including subscripts. The relation states that the integrated state is a weighted combination of three inputs.
...
**What depends on it.** Lesson 3 — Weights And Behaviour — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Reading a formal relation means decoding every symbol including subscripts. The relation states that the integrated state is a weighted combination of three inputs.
...
1. A translation reading: the moment is a weighted mix of three things.
2. A translation naming each weight and what it scales.

### One non-example

A reading that skips the subscripts on the weights.
...
That formal relations can be read and translated.

### What this activity does not establish

Whether the relation is empirically correct.
...
| Statement | Status |
|---|---|
| Reading a formal relation means decoding every symbol including subscripts. | Framework-derived, appropriate at this grade |
| That formal relations can be read and translated. | What this specific activity can show |
| Whether the relation is empirically correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 1 — What Is Missing — specifically: students identify E(t)'s absence from the integration relation.

**How it was taught.** Through the activity: write and seal a prediction of what the absence means, opened at Lesson 17

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: write and seal a prediction of what the absence means, opened at Lesson 17, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A translation reading: the moment is a weighted mix of three things. |
| **Non-example** | A reading that skips the subscripts on the weights. |
...
> "One variable is missing from that relation. That absence is this year's spine."
...
**Exact wording.** "Say: nobody translates a relation all at once. One symbol at a time, out loud."
...
**Target observation.** That formal relations can be read and translated.
...
> "Reading a formal relation means decoding every symbol including subscripts. You just saw that when say: nobody translates a relation all at once.
> Last time we said: One variable is missing from that relation. That absence is this year's spine. This is the next part of that.
...
**What students must not infer.** Whether the relation is empirically correct.

### 4. Worked example

**The example.** A translation reading: the moment is a weighted mix of three things.
...
**Completed answer.** A translation reading: the moment is a weighted mix of three things. — which demonstrates that formal relations can be read and translated.
...
**Conclusions not licensed.** Whether the relation is empirically correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A translation naming each weight and what it scales. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A reading that skips the subscripts on the weights. Why is this not an
example?"
...
**Exact student instructions.** Write the relation from memory and produce three translations of increasing precision.
...
- *Licensed conclusion.* That formal relations can be read and translated.
- *Not licensed.* Whether the relation is empirically correct.
...
- *Expected response.* That formal relations can be read and translated.
...
1. Any wording carrying the idea in `Reading a formal relation means decoding every symbol including subscripts`.
...
Say: "The integrated state is the weighted combination of input, memory, and simulation."
...
| | |
|---|---|
| **Follows** | Lesson 1 — What Is Missing |
| **Leads to** | Lesson 3 — Weights And Behaviour |

**Transition in.** Lesson 1 established students identify E(t)'s absence from the integration relation. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students decode the integration function term by term. Lesson 3 assumes it and builds students predict system behaviour from weight configurations.
