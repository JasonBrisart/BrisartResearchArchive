# Lesson 7 — Determinism Objections

**Grade 9** · The Formal System · **Quarter 1** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Determinism Objections: students evaluate objections to conditional determinism? |
| **Core concept** | Most objections to determinism target a claim about human freedom rather than the narrow architectural claim, which is about fixed inputs and parameters. |
| **Student outcome** | Students evaluate objections to conditional determinism. |
| **Previous lesson** | Lesson 6 — Where Variability Comes From |
| **Next lesson** | Lesson 8 — The Relation Review |
| **Materials** | Lab books; whiteboard access |
| **Preparation** | fifteen to twenty minutes |
| **Student printout** | `Printouts/Lesson_07_Printout.md` |
| **Homework** | `Homework/Lesson_07_Homework.md` |

## Why this lesson exists

**The conceptual step.** Most objections to determinism target a claim about human freedom rather than the narrow architectural claim, which is about fixed inputs and parameters.

**Why students need it now.** This grade owns one idea: the integration function, variable closure, and conditional determinism.
...
that the weights are real numbers in my head. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Formal argument with sources. A student states the claim, the structure it rests on, and the cost of any modification proposed.

**What depends on it.** Lesson 8 — The Relation Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Most objections to determinism target a claim about human freedom rather than the narrow architectural claim, which is about fixed inputs and parameters.

### How this is stated at this grade

Formal argument with sources. A student states the claim, the structure it rests on, and the cost of any modification proposed.

Use only the vocabulary released at or before this grade. Terms not yet available:
Operationalisation as a formal requirement, the three rival accounts.

### Why the concept matters

The whole grade rests on the integration function, variable closure, and conditional determinism. If a student leaves this
...
1. An objection about free will, which misses the stated claim.
2. An objection about measurement, which does land.

### One non-example

Accepting a free-will objection as refuting the architecture.
...
That objections must be matched against the actual claim.

### What this activity does not establish

Whether determinism is true of people.
...
| Statement | Status |
|---|---|
| Most objections to determinism target a claim about human freedom rather than the narrow architectural claim, which is about fixed inputs and parameters. | Framework-derived, appropriate at this grade |
| That objections must be matched against the actual claim. | What this specific activity can show |
| Whether determinism is true of people. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — Where Variability Comes From — specifically: students locate the sources of variation across implementations.

**How it was taught.** Through the activity: list the three sources of variability and give an example of each

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: list the three sources of variability and give an example of each, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | F(t) = w1 Input(t) + w2 Minfo(t) + w3 Sim(t). |
| **Student wording** | F(t) = w1 input(t) + w2 minfo(t) + w3 sim(t). |
| **Correct example** | An objection about free will, which misses the stated claim. |
| **Non-example** | Accepting a free-will objection as refuting the architecture. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for f(t) = w1 Input(t) + w2 Minfo(t) + w3 Sim(t)." |

### integration weights

| | |
|---|---|
| **Teacher definition** | w1, w2, w3; relative contribution of the three inputs. |
| **Student wording** | W1, w2, w3; relative contribution of the three inputs. |
| **Correct example** | An objection about free will, which misses the stated claim. |
| **Non-example** | Accepting a free-will objection as refuting the architecture. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for w1, w2, w3; relative contribution of the three inputs." |

### conditional determinism

| | |
|---|---|
| **Teacher definition** | fixed inputs and parameters yield a unique F(t). |
| **Student wording** | Fixed inputs and parameters yield a unique f(t). |
| **Correct example** | An objection about free will, which misses the stated claim. |
| **Non-example** | Accepting a free-will objection as refuting the architecture. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for fixed inputs and parameters yield a unique F(t)." |


Do not introduce terminology from later grades. Operationalisation as a formal requirement, the three rival accounts.

## Materials and preparation

**Teacher materials.** Lab books; Whiteboard access; Printed weight-case tables; A timer.
...
> "Variability comes from parameters, measurement, or inputs. Not from randomness."
...
**Exact wording.** "Say: somebody says people are not deterministic. Are they attacking this claim?"
...
**Target observation.** That objections must be matched against the actual claim.
...
> "Most objections to determinism target a claim about human freedom rather than the narrow architectural claim, which is about fixed inputs and parameters. You just saw that when say: somebody says people are not deterministic.
> Last time we said: Variability comes from parameters, measurement, or inputs. Not from randomness. This is the next part of that.
> It matters because f(t) = w1 Input(t) + w2 Minfo(t) + w3 Sim(t) — and one variable is missing from it"
...
**Terminology to introduce here.** integration function, integration weights, conditional determinism.

**What students must not infer.** Whether determinism is true of people.

### 4. Worked example

**The example.** An objection about free will, which misses the stated claim.
...
**Completed answer.** An objection about free will, which misses the stated claim. — which demonstrates that objections must be matched against the actual claim.
...
**Conclusions not licensed.** Whether determinism is true of people.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An objection about measurement, which does land. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Accepting a free-will objection as refuting the architecture. Why is this not an
example?"
...
**Exact student instructions.** Assess three objections for whether they actually target the stated claim.
...
- *Licensed conclusion.* That objections must be matched against the actual claim.
- *Not licensed.* Whether determinism is true of people.
...
- *Expected response.* That objections must be matched against the actual claim.
...
3. **Misconception check.** Somebody says: "The weights are real numbers in my head" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `Most objections to determinism target a claim about human freedom rather than the narrow architectural claim, which is about fixed inputs and parameters`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Nobody possesses a w2. Using them requires measurement.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "Most objections to determinism are not objections to this one."
...
### 1. "The weights are real numbers in my head"

**What the student says or does.** The weights are real numbers in my head — usually while otherwise engaging well.

**Why it is understandable.** Students take the notation literally.
...
**Exact correction.** They are model parameters requiring empirical estimation.

**Say this.** "Nobody possesses a w2. Using them requires measurement."
...
### 2. "A high-w3 description is a description of a person"

**What the student says or does.** A high-w3 description is a description of a person — usually while otherwise engaging well.

**Why it is understandable.** Weight cases read like personality types.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** State the framing every single time weight cases appear.

**Say this.** "That is a structural description, not a person and not a diagnosis."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "Closure is arbitrary strictness"

**What the student says or does.** Closure is arbitrary strictness — usually while otherwise engaging well.

**Why it is understandable.** Refusing obviously relevant variables looks stubborn.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Run the cost argument.

**Say this.** "A framework that explains any result explains nothing."
...
**Visual or physical support.** Provide the relation on a desk card with each term labelled.
...
Ask them to propose a sixth variable and name what becomes unfalsifiable.
...
Specifically, do not introduce: Operationalisation as a formal requirement, the three rival accounts.
...
| | |
|---|---|
| **Follows** | Lesson 6 — Where Variability Comes From |
| **Leads to** | Lesson 8 — The Relation Review |

**Transition in.** Lesson 6 established students locate the sources of variation across implementations. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students evaluate objections to conditional determinism. Lesson 8 assumes it and builds students consolidate the integration function.
