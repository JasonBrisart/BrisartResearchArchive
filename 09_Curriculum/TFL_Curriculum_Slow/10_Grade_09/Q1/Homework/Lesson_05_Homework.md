# Lesson 5 Homework — Conditional Determinism

**Grade 9** · The Formal System · **Quarter 1**
**Follows:** Lesson 5 — Conditional Determinism · **Points:** 5 · **Optional:** yes
...
**Your teacher is looking for:** every student states that the condition is fixed parameters
...
Lesson 6 is **Where Variability Comes From**, which assumes you arrive holding it. Write one thing you expect it to be about:
