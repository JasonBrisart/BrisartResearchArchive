# Lesson 2 Homework — Reading The Relation

**Grade 9** · The Formal System · **Quarter 1**
**Follows:** Lesson 2 — Reading The Relation · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 2 ended on, from memory:
...
Write the relation from memory and produce three translations of increasing precision.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student reads it aloud as a sentence without the board
...
Lesson 3 is **Weights And Behaviour**, which assumes you arrive holding it. Write one thing you expect it to be about:
