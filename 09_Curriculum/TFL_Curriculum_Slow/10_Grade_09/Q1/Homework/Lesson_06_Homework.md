# Lesson 6 Homework — Where Variability Comes From

**Grade 9** · The Formal System · **Quarter 1**
**Follows:** Lesson 6 — Where Variability Comes From · **Points:** 5 · **Optional:** yes
...
List the three sources of variability and give an example of each.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student lists all three sources with examples
...
Lesson 7 is **Determinism Objections**, which assumes you arrive holding it. Write one thing you expect it to be about:
