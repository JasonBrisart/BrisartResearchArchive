# Lesson 3 Homework — Weights And Behaviour

**Grade 9** · The Formal System · **Quarter 1**
**Follows:** Lesson 3 — Weights And Behaviour · **Points:** 5 · **Optional:** yes
...
Complete a six-case table with the dominant term and expected behaviour.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has the dominant term correct in all six
...
Lesson 4 is **Weight Cases In Depth**, which assumes you arrive holding it. Write one thing you expect it to be about:
