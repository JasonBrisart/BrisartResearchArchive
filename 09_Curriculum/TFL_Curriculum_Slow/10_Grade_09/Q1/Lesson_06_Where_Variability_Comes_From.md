# Lesson 6 — Where Variability Comes From
...
| | |
|---|---|
| **Central question** | Where Variability Comes From: students locate the sources of variation across implementations? |
| **Core concept** | Variability arises from differing parameters, differing measurement, or differing inputs. |
| **Student outcome** | Students locate the sources of variation across implementations. |
| **Previous lesson** | Lesson 5 — Conditional Determinism |
| **Next lesson** | Lesson 7 — Determinism Objections |
...
**The conceptual step.** Variability arises from differing parameters, differing measurement, or differing inputs. The architecture itself contains no random term.
...
**What depends on it.** Lesson 7 — Determinism Objections — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Variability arises from differing parameters, differing measurement, or differing inputs. The architecture itself contains no random term.
...
1. Two people differing because their inputs differed.
2. Two implementations differing because of measurement noise.

### One non-example

Variability attributed to randomness inside the architecture.
...
That variability has three stated sources.

### What this activity does not establish

Which source dominates in practice.
...
| Statement | Status |
|---|---|
| Variability arises from differing parameters, differing measurement, or differing inputs. | Framework-derived, appropriate at this grade |
| That variability has three stated sources. | What this specific activity can show |
| Which source dominates in practice. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — Conditional Determinism — specifically: students state what the framework guarantees about repeatability.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: explain what conditionally is doing and name a violating observation, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two people differing because their inputs differed. |
| **Non-example** | Variability attributed to randomness inside the architecture. |
...
**Exact wording.** "Ask why two people differ if it is deterministic."
...
**Target observation.** That variability has three stated sources.
...
> "Variability arises from differing parameters, differing measurement, or differing inputs. You just saw that when ask why two people differ if it is deterministic.
...
**What students must not infer.** Which source dominates in practice.

### 4. Worked example

**The example.** Two people differing because their inputs differed.
...
**Completed answer.** Two people differing because their inputs differed. — which demonstrates that variability has three stated sources.
...
**Conclusions not licensed.** Which source dominates in practice.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Two implementations differing because of measurement noise. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Variability attributed to randomness inside the architecture. Why is this not an
example?"
...
**Exact student instructions.** List the three sources of variability and give an example of each.
...
- *Licensed conclusion.* That variability has three stated sources.
- *Not licensed.* Which source dominates in practice.
...
- *Expected response.* That variability has three stated sources.
...
1. Any wording carrying the idea in `Variability arises from differing parameters, differing measurement, or differing inputs`.
...
Say: "Variability comes from parameters, measurement, or inputs. Not from randomness."
...
| | |
|---|---|
| **Follows** | Lesson 5 — Conditional Determinism |
| **Leads to** | Lesson 7 — Determinism Objections |

**Transition in.** Lesson 5 established students state what the framework guarantees about repeatability. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students locate the sources of variation across implementations. Lesson 7 assumes it and builds students evaluate objections to conditional determinism.
