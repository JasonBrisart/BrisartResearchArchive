...
| | |
|---|---|
| **Central question** | The Relation Review: students consolidate the integration function? |
| **Core concept** | The relation must be reproducible from memory with correct subscripts. |
| **Student outcome** | Students consolidate the integration function. |
| **Previous lesson** | Lesson 7 — Determinism Objections |
| **Next lesson** | Lesson 9 — Variable Closure |
...
**The conceptual step.** The relation must be reproducible from memory with correct subscripts. Silence about accuracy and persistence is as important as what it states.
...
**What depends on it.** Lesson 9 — Variable Closure — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The relation must be reproducible from memory with correct subscripts. Silence about accuracy and persistence is as important as what it states.
...
1. A statement correctly marked as consistent with the relation.
2. A statement correctly marked as inconsistent.

### One non-example

A relation written with the subscripts transposed.
...
Whether the relation is securely held.

### What this activity does not establish

Whether the relation is correct.
...
| Statement | Status |
|---|---|
| The relation must be reproducible from memory with correct subscripts. | Framework-derived, appropriate at this grade |
| Whether the relation is securely held. | What this specific activity can show |
| Whether the relation is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — Determinism Objections — specifically: students evaluate objections to conditional determinism.

**How it was taught.** Through the activity: assess three objections for whether they actually target the stated claim

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: assess three objections for whether they actually target the stated claim, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A statement correctly marked as consistent with the relation. |
| **Non-example** | A relation written with the subscripts transposed. |
...
> "Most objections to determinism are not objections to this one."
...
**Exact wording.** "Ask them to write it, define every term, and state what it is silent about."
...
**Target observation.** Whether the relation is securely held.
...
> "The relation must be reproducible from memory with correct subscripts. You just saw that when ask them to write it, define every term, and state what it is silent about.
> Last time we said: Most objections to determinism are not objections to this one. This is the next part of that.
...
**What students must not infer.** Whether the relation is correct.

### 4. Worked example

**The example.** A statement correctly marked as consistent with the relation.
...
**Completed answer.** A statement correctly marked as consistent with the relation. — which demonstrates whether the relation is securely held.
...
**Conclusions not licensed.** Whether the relation is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A statement correctly marked as inconsistent. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A relation written with the subscripts transposed. Why is this not an
example?"
...
**Exact student instructions.** Review with eight statements marked correct or incorrect about the relation.
...
- *Licensed conclusion.* Whether the relation is securely held.
- *Not licensed.* Whether the relation is correct.
...
- *Expected response.* Whether the relation is securely held.
...
1. Any wording carrying the idea in `The relation must be reproducible from memory with correct subscripts`.
...
Say: "Next time: why the framework refuses to add variables."
...
| | |
|---|---|
| **Follows** | Lesson 7 — Determinism Objections |
| **Leads to** | Lesson 9 — Variable Closure |

**Transition in.** Lesson 7 established students evaluate objections to conditional determinism. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the integration function. Lesson 9 assumes it and builds students state the closure constraint and its cost.
