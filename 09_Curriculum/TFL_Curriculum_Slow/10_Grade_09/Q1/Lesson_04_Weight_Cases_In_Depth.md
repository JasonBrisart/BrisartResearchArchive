# Lesson 4 — Weight Cases In Depth
...
| | |
|---|---|
| **Central question** | Weight Cases In Depth: students reason about extreme and balanced weight configurations? |
| **Core concept** | Extreme weight values are thought experiments that reveal what each term contributes. |
| **Student outcome** | Students reason about extreme and balanced weight configurations. |
| **Previous lesson** | Lesson 3 — Weights And Behaviour |
| **Next lesson** | Lesson 5 — Conditional Determinism |
...
**The conceptual step.** Extreme weight values are thought experiments that reveal what each term contributes. A zero-w1 system would be unresponsive to incoming evidence.
...
**What depends on it.** Lesson 5 — Conditional Determinism — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Extreme weight values are thought experiments that reveal what each term contributes. A zero-w1 system would be unresponsive to incoming evidence.
...
1. A zero-w1 system failing to update on new input.
2. A zero-w3 system failing to anticipate anything.

### One non-example

Dismissing a zero-weight case as unrealistic and not analysing it.
...
That extreme cases reveal each term's contribution.

### What this activity does not establish

That extreme configurations occur.
...
| Statement | Status |
|---|---|
| Extreme weight values are thought experiments that reveal what each term contributes. | Framework-derived, appropriate at this grade |
| That extreme cases reveal each term's contribution. | What this specific activity can show |
| That extreme configurations occur. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — Weights And Behaviour — specifically: students predict system behaviour from weight configurations.

**How it was taught.** Through the activity: complete a six-case table with the dominant term and expected behaviour

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: complete a six-case table with the dominant term and expected behaviour, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A zero-w1 system failing to update on new input. |
| **Non-example** | Dismissing a zero-weight case as unrealistic and not analysing it. |
...
> "These are parameters of a model, not quantities anybody has."
...
**Exact wording.** "Ask what would happen if w1 were zero, and what that system would be like."
...
**Target observation.** That extreme cases reveal each term's contribution.
...
> "Extreme weight values are thought experiments that reveal what each term contributes. You just saw that when ask what would happen if w1 were zero, and what that system would be like.
> Last time we said: These are parameters of a model, not quantities anybody has. This is the next part of that.
...
**What students must not infer.** That extreme configurations occur.

### 4. Worked example

**The example.** A zero-w1 system failing to update on new input.
...
**Completed answer.** A zero-w1 system failing to update on new input. — which demonstrates that extreme cases reveal each term's contribution.
...
**Conclusions not licensed.** That extreme configurations occur.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A zero-w3 system failing to anticipate anything. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Dismissing a zero-weight case as unrealistic and not analysing it. Why is this not an
example?"
...
**Exact student instructions.** Four extreme cases analysed, with what each would fail at.
...
- *Licensed conclusion.* That extreme cases reveal each term's contribution.
- *Not licensed.* That extreme configurations occur.
...
- *Expected response.* That extreme cases reveal each term's contribution.
...
1. Any wording carrying the idea in `Extreme weight values are thought experiments that reveal what each term contributes`.
...
Say: "Extremes tell you what each term is doing."
...
| | |
|---|---|
| **Follows** | Lesson 3 — Weights And Behaviour |
| **Leads to** | Lesson 5 — Conditional Determinism |

**Transition in.** Lesson 3 established students predict system behaviour from weight configurations. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students reason about extreme and balanced weight configurations. Lesson 5 assumes it and builds students state what the framework guarantees about repeatability.
