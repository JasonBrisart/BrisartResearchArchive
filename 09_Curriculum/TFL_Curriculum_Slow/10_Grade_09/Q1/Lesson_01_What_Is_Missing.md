...
| | |
|---|---|
| **Central question** | What Is Missing: students identify E(t)'s absence from the integration relation? |
| **Core concept** | The integration relation contains three of the five declared variables. |
| **Student outcome** | Students identify E(t)'s absence from the integration relation. |
| **Previous lesson** | None. First lesson of the year. |
| **Next lesson** | Lesson 2 — Reading The Relation |
...
**The conceptual step.** The integration relation contains three of the five declared variables. E(t) is absent, and the absence is a deliberate structural commitment rather than an omission.
...
**What depends on it.** Lesson 2 — Reading The Relation — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The integration relation contains three of the five declared variables. E(t) is absent, and the absence is a deliberate structural commitment rather than an omission.
...
1. A sealed prediction that E(t) was simply forgotten.
2. A sealed prediction that its absence is the framework's main claim.

### One non-example

Treating the absence as a notational shortcut.
...
| Statement | Status |
|---|---|
| The integration relation contains three of the five declared variables. | Framework-derived, appropriate at this grade |
| That the absence is deliberate and checkable. | What this specific activity can show |
| Why the absence is defensible. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The student states assumptions under a claim and reports within sampling limits.
...
| **Correct example** | A sealed prediction that E(t) was simply forgotten. |
| **Non-example** | Treating the absence as a notational shortcut. |
...
**Exact wording.** "Write the integration function with no explanation. Say: five variables. Count how many are here."
...
**Target observation.** That the absence is deliberate and checkable.
...
> "The integration relation contains three of the five declared variables. You just saw that when write the integration function with no explanation.
...
**What students must not infer.** Why the absence is defensible.

### 4. Worked example

**The example.** A sealed prediction that E(t) was simply forgotten.
...
**Completed answer.** A sealed prediction that E(t) was simply forgotten. — which demonstrates that the absence is deliberate and checkable.
...
**Conclusions not licensed.** Why the absence is defensible.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A sealed prediction that its absence is the framework's main claim. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Treating the absence as a notational shortcut. Why is this not an
example?"
...
**Exact student instructions.** Write and seal a prediction of what the absence means, opened at Lesson 17.
...
- *Licensed conclusion.* That the absence is deliberate and checkable.
- *Not licensed.* Why the absence is defensible.
...
- *Expected response.* That the absence is deliberate and checkable.
...
1. Any wording carrying the idea in `The integration relation contains three of the five declared variables`.
...
Say: "One variable is missing from that relation. That absence is this year's spine."
...
| **Leads to** | Lesson 2 — Reading The Relation |

**Transition in.** This lesson opens the year.

**Transition out.** This lesson establishes students identify E(t)'s absence from the integration relation. Lesson 2 assumes it and builds students decode the integration function term by term.
