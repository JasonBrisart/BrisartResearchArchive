# Lesson 21 — Silence Is Not Denial
...
| | |
|---|---|
| **Central question** | Silence Is Not Denial: students distinguish what a model denies from what it does not address? |
| **Core concept** | A model that does not address something has not denied it. |
| **Student outcome** | Students distinguish what a model denies from what it does not address. |
| **Previous lesson** | Lesson 20 — What The Relation Does Not Say |
| **Next lesson** | Lesson 22 — Parameters In Other Models |
...
**The conceptual step.** A model that does not address something has not denied it. Conflating silence with denial produces false claims about what the framework asserts.
...
**What depends on it.** Lesson 22 — Parameters In Other Models — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A model that does not address something has not denied it. Conflating silence with denial produces false claims about what the framework asserts.
...
1. Accuracy sorted as unaddressed rather than denied.
2. Neural implementation sorted as unaddressed.

### One non-example

Accuracy treated as denied because the relation omits it.
...
That silence and denial are distinguishable.

### What this activity does not establish

Whether the silences are appropriate.
...
| Statement | Status |
|---|---|
| A model that does not address something has not denied it. | Framework-derived, appropriate at this grade |
| That silence and denial are distinguishable. | What this specific activity can show |
| Whether the silences are appropriate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — What The Relation Does Not Say — specifically: students state the limits of the integration function.

**How it was taught.** Through the activity: list five questions the relation cannot answer and route each correctly

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: list five questions the relation cannot answer and route each correctly, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Accuracy sorted as unaddressed rather than denied. |
| **Non-example** | Accuracy treated as denied because the relation omits it. |
...
> "Knowing what a relation is silent about is half of knowing what it says."
...
**Exact wording.** "Ask: the relation says nothing about accuracy. Does it say accuracy does not exist?"
...
**Target observation.** That silence and denial are distinguishable.
...
> "A model that does not address something has not denied it. You just saw that when ask: the relation says nothing about accuracy.
> Last time we said: Knowing what a relation is silent about is half of knowing what it says. This is the next part of that.
...
**What students must not infer.** Whether the silences are appropriate.

### 4. Worked example

**The example.** Accuracy sorted as unaddressed rather than denied.
...
**Completed answer.** Accuracy sorted as unaddressed rather than denied. — which demonstrates that silence and denial are distinguishable.
...
**Conclusions not licensed.** Whether the silences are appropriate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Neural implementation sorted as unaddressed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Accuracy treated as denied because the relation omits it. Why is this not an
example?"
...
**Exact student instructions.** Sort eight statements into denied, unaddressed, and asserted.
...
- *Licensed conclusion.* That silence and denial are distinguishable.
- *Not licensed.* Whether the silences are appropriate.
...
- *Expected response.* That silence and denial are distinguishable.
...
1. Any wording carrying the idea in `A model that does not address something has not denied it`.
...
Say: "Silence is not denial. Different thing entirely."
...
| | |
|---|---|
| **Follows** | Lesson 20 — What The Relation Does Not Say |
| **Leads to** | Lesson 22 — Parameters In Other Models |

**Transition in.** Lesson 20 established students state the limits of the integration function. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students distinguish what a model denies from what it does not address. Lesson 22 assumes it and builds students compare parameter practice with another subject.
