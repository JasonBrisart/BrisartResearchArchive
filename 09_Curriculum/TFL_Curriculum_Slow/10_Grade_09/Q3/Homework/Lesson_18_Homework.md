# Lesson 18 Homework — Parameters Need Observables

**Grade 9** · The Formal System · **Quarter 3**
**Follows:** Lesson 18 — Parameters Need Observables · **Points:** 5 · **Optional:** yes
...
For each of four parameters, name one thing that would have to be measurable.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names a candidate observable for at least three
...
Lesson 19 is **Measurable Or Not**, which assumes you arrive holding it. Write one thing you expect it to be about:
