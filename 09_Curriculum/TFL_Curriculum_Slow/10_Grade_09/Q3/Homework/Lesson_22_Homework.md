# Lesson 22 Homework — Parameters In Other Models

**Grade 9** · The Formal System · **Quarter 3**
**Follows:** Lesson 22 — Parameters In Other Models · **Points:** 5 · **Optional:** yes
...
Compare three outside parameters against the observable requirement.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student compares three outside parameters
...
Lesson 23 is **The Parameter Audit**, which assumes you arrive holding it. Write one thing you expect it to be about:
