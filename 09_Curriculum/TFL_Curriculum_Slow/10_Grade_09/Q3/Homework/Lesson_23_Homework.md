# Lesson 23 Homework — The Parameter Audit

**Grade 9** · The Formal System · **Quarter 3**
**Follows:** Lesson 23 — The Parameter Audit · **Points:** 5 · **Optional:** yes
...
Rank all four parameters by observational support with justification.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student ranks all four with justification
...
Lesson 24 is **The Parameter Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
