# Lesson 20 — What The Relation Does Not Say
...
| | |
|---|---|
| **Central question** | What The Relation Does Not Say: students state the limits of the integration function? |
| **Core concept** | The integration relation says nothing about accuracy, persistence, or how long anything lasts. |
| **Student outcome** | Students state the limits of the integration function. |
| **Previous lesson** | Lesson 19 — Measurable Or Not |
| **Next lesson** | Lesson 21 — Silence Is Not Denial |
...
**The conceptual step.** The integration relation says nothing about accuracy, persistence, or how long anything lasts. Routing questions to the right relation is a core skill.
...
**What depends on it.** Lesson 21 — Silence Is Not Denial — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The integration relation says nothing about accuracy, persistence, or how long anything lasts. Routing questions to the right relation is a core skill.
...
1. A persistence question routed to the other relation.
2. An accuracy question routed outside both relations.

### One non-example

A persistence effect attributed to an integration weight.
...
That the relation has stateable silences.

### What this activity does not establish

Whether the relation is complete.
...
| Statement | Status |
|---|---|
| The integration relation says nothing about accuracy, persistence, or how long anything lasts. | Framework-derived, appropriate at this grade |
| That the relation has stateable silences. | What this specific activity can show |
| Whether the relation is complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — Measurable Or Not — specifically: students judge whether proposed observables are actually obtainable.

**How it was taught.** Through the activity: judge eight proposed observables and justify four rejections

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: judge eight proposed observables and justify four rejections, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A persistence question routed to the other relation. |
| **Non-example** | A persistence effect attributed to an integration weight. |
...
> "Obtainable means somebody could actually do it."
...
**Exact wording.** "Ask what this relation tells you about whether a prediction was correct. Nothing."
...
**Target observation.** That the relation has stateable silences.
...
> "The integration relation says nothing about accuracy, persistence, or how long anything lasts. You just saw that when ask what this relation tells you about whether a prediction was correct.
> Last time we said: Obtainable means somebody could actually do it. This is the next part of that.
...
**What students must not infer.** Whether the relation is complete.

### 4. Worked example

**The example.** A persistence question routed to the other relation.
...
**Completed answer.** A persistence question routed to the other relation. — which demonstrates that the relation has stateable silences.
...
**Conclusions not licensed.** Whether the relation is complete.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An accuracy question routed outside both relations. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A persistence effect attributed to an integration weight. Why is this not an
example?"
...
**Exact student instructions.** List five questions the relation cannot answer and route each correctly.
...
- *Licensed conclusion.* That the relation has stateable silences.
- *Not licensed.* Whether the relation is complete.
...
- *Expected response.* That the relation has stateable silences.
...
1. Any wording carrying the idea in `The integration relation says nothing about accuracy, persistence, or how long anything lasts`.
...
Say: "Knowing what a relation is silent about is half of knowing what it says."
...
| | |
|---|---|
| **Follows** | Lesson 19 — Measurable Or Not |
| **Leads to** | Lesson 21 — Silence Is Not Denial |

**Transition in.** Lesson 19 established students judge whether proposed observables are actually obtainable. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state the limits of the integration function. Lesson 21 assumes it and builds students distinguish what a model denies from what it does not address.
