# Lesson 17 — Opening The Prediction

**Grade 9** · The Formal System · **Quarter 3** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Opening The Prediction: students check their Lesson 1 sealed prediction about E(t)'s absence? |
| **Core concept** | A prediction made in ignorance and checked later is the method the whole curriculum teaches. |
| **Student outcome** | Students check their Lesson 1 sealed prediction about E(t)'s absence. |
| **Previous lesson** | Lesson 16 — The Closure Review |
| **Next lesson** | Lesson 18 — Parameters Need Observables |
...
**The conceptual step.** A prediction made in ignorance and checked later is the method the whole curriculum teaches. A wrong sealed prediction that was honestly checked is a success.
...
**What depends on it.** Lesson 18 — Parameters Need Observables — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A prediction made in ignorance and checked later is the method the whole curriculum teaches. A wrong sealed prediction that was honestly checked is a success.
...
1. A sealed prediction that the absence was an oversight, now corrected.
2. A sealed prediction that came close, with the reasoning identified.

### One non-example

Dismissing one's earlier self as having been foolish.
...
That sealed predictions can be checked honestly.
...
| Statement | Status |
|---|---|
| A prediction made in ignorance and checked later is the method the whole curriculum teaches. | Framework-derived, appropriate at this grade |
| That sealed predictions can be checked honestly. | What this specific activity can show |
| Whether the prediction was correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Closure Review — specifically: students consolidate closure and propagation.

**How it was taught.** Through the activity: review with six traces audited and four proposals costed

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with six traces audited and four proposals costed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A sealed prediction that the absence was an oversight, now corrected. |
| **Non-example** | Dismissing one's earlier self as having been foolish. |
...
> "Next time: the sealed prediction comes back."
...
**Exact wording.** "Hand back the sealed predictions. Say: read what you wrote before you knew anything."
...
**Target observation.** That sealed predictions can be checked honestly.
...
> "A prediction made in ignorance and checked later is the method the whole curriculum teaches. You just saw that when hand back the sealed predictions.
> Last time we said: Next time: the sealed prediction comes back. This is the next part of that.
...
**What students must not infer.** Whether the prediction was correct.

### 4. Worked example

**The example.** A sealed prediction that the absence was an oversight, now corrected.
...
**Completed answer.** A sealed prediction that the absence was an oversight, now corrected. — which demonstrates that sealed predictions can be checked honestly.
...
**Conclusions not licensed.** Whether the prediction was correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A sealed prediction that came close, with the reasoning identified. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Dismissing one's earlier self as having been foolish. Why is this not an
example?"
...
**Exact student instructions.** Compare the sealed prediction with what they now know and write what would have pointed them right.
...
- *Licensed conclusion.* That sealed predictions can be checked honestly.
- *Not licensed.* Whether the prediction was correct.
...
- *Expected response.* That sealed predictions can be checked honestly.
...
1. Any wording carrying the idea in `A prediction made in ignorance and checked later is the method the whole curriculum teaches`.
...
Say: "You made a real prediction and checked it. That is the method."
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Closure Review |
| **Leads to** | Lesson 18 — Parameters Need Observables |

**Transition in.** Lesson 16 established students consolidate closure and propagation. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students check their Lesson 1 sealed prediction about E(t)'s absence. Lesson 18 assumes it and builds students state that a parameter must connect to something measurable.
