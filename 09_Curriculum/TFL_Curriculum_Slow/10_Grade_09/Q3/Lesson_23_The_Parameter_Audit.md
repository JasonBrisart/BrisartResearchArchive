...
| | |
|---|---|
| **Central question** | The Parameter Audit: students audit the framework's full parameter set? |
| **Core concept** | Parameters differ in how well supported they are. |
| **Student outcome** | Students audit the framework's full parameter set. |
| **Previous lesson** | Lesson 22 — Parameters In Other Models |
| **Next lesson** | Lesson 24 — The Parameter Review |
...
**The conceptual step.** Parameters differ in how well supported they are. Ranking by support rather than importance produces an honest audit, and the window usually ranks weakest.
...
**What depends on it.** Lesson 24 — The Parameter Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Parameters differ in how well supported they are. Ranking by support rather than importance produces an honest audit, and the window usually ranks weakest.
...
1. The window ranked weakest with a stated reason.
2. The persistence threshold ranked by available evidence.

### One non-example

A ranking by how central each parameter seems.
...
That parameters can be ranked by support.

### What this activity does not establish

Whether any parameter is well established.
...
| Statement | Status |
|---|---|
| Parameters differ in how well supported they are. | Framework-derived, appropriate at this grade |
| That parameters can be ranked by support. | What this specific activity can show |
| Whether any parameter is well established. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — Parameters In Other Models — specifically: students compare parameter practice with another subject.

**How it was taught.** Through the activity: compare three outside parameters against the observable requirement

**Quick check.** Ask for the closing sentence of Lesson 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: compare three outside parameters against the observable requirement, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The window ranked weakest with a stated reason. |
| **Non-example** | A ranking by how central each parameter seems. |
...
> "Every serious model has this problem. Some solve it better."
...
**Exact wording.** "Ask which of the four parameters is best supported and which worst."
...
**Target observation.** That parameters can be ranked by support.
...
> "Parameters differ in how well supported they are. You just saw that when ask which of the four parameters is best supported and which worst.
> Last time we said: Every serious model has this problem. Some solve it better. This is the next part of that.
...
**What students must not infer.** Whether any parameter is well established.

### 4. Worked example

**The example.** The window ranked weakest with a stated reason.
...
**Completed answer.** The window ranked weakest with a stated reason. — which demonstrates that parameters can be ranked by support.
...
**Conclusions not licensed.** Whether any parameter is well established.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The persistence threshold ranked by available evidence. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A ranking by how central each parameter seems. Why is this not an
example?"
...
**Exact student instructions.** Rank all four parameters by observational support with justification.
...
- *Licensed conclusion.* That parameters can be ranked by support.
- *Not licensed.* Whether any parameter is well established.
...
- *Expected response.* That parameters can be ranked by support.
...
1. Any wording carrying the idea in `Parameters differ in how well supported they are`.
...
Say: "The window is the weakest. Say so if that is what you find."
...
| | |
|---|---|
| **Follows** | Lesson 22 — Parameters In Other Models |
| **Leads to** | Lesson 24 — The Parameter Review |

**Transition in.** Lesson 22 established students compare parameter practice with another subject. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit the framework's full parameter set. Lesson 24 assumes it and builds students consolidate parameter work.
