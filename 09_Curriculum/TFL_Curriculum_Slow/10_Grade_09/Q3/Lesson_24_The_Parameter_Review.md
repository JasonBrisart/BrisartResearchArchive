# Lesson 24 — The Parameter Review
...
| | |
|---|---|
| **Central question** | The Parameter Review: students consolidate parameter work? |
| **Core concept** | Every parameter requires a measurement pathway. |
| **Student outcome** | Students consolidate parameter work. |
| **Previous lesson** | Lesson 23 — The Parameter Audit |
| **Next lesson** | Lesson 25 — The Structural Argument |
...
**The conceptual step.** Every parameter requires a measurement pathway. The review tests whether the practical question is applied consistently.
...
**What depends on it.** Lesson 25 — The Structural Argument — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every parameter requires a measurement pathway. The review tests whether the practical question is applied consistently.
...
1. A parameter judged supported with its pathway named.
2. A parameter judged unsupported with the gap named.

### One non-example

A parameter accepted because it appears in the relation.
...
Whether the measurement requirement is habitual.
...
| Statement | Status |
|---|---|
| Every parameter requires a measurement pathway. | Framework-derived, appropriate at this grade |
| Whether the measurement requirement is habitual. | What this specific activity can show |
| Whether the parameters are correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — The Parameter Audit — specifically: students audit the framework's full parameter set.

**How it was taught.** Through the activity: rank all four parameters by observational support with justification

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: rank all four parameters by observational support with justification, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A parameter judged supported with its pathway named. |
| **Non-example** | A parameter accepted because it appears in the relation. |
...
> "The window is the weakest. Say so if that is what you find."
...
**Exact wording.** "Ask what every parameter needs and what happens without it."
...
**Target observation.** Whether the measurement requirement is habitual.
...
> "Every parameter requires a measurement pathway. You just saw that when ask what every parameter needs and what happens without it.
> Last time we said: The window is the weakest. Say so if that is what you find. This is the next part of that.
...
**What students must not infer.** Whether the parameters are correct.

### 4. Worked example

**The example.** A parameter judged supported with its pathway named.
...
**Completed answer.** A parameter judged supported with its pathway named. — which demonstrates whether the measurement requirement is habitual.
...
**Conclusions not licensed.** Whether the parameters are correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A parameter judged unsupported with the gap named. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A parameter accepted because it appears in the relation. Why is this not an
example?"
...
**Exact student instructions.** Review with six parameters judged for observational support.
...
- *Licensed conclusion.* Whether the measurement requirement is habitual.
- *Not licensed.* Whether the parameters are correct.
...
- *Expected response.* Whether the measurement requirement is habitual.
...
1. Any wording carrying the idea in `Every parameter requires a measurement pathway`.
...
Say: "Next time: arguing about the structure itself."
...
| | |
|---|---|
| **Follows** | Lesson 23 — The Parameter Audit |
| **Leads to** | Lesson 25 — The Structural Argument |

**Transition in.** Lesson 23 established students audit the framework's full parameter set. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate parameter work. Lesson 25 assumes it and builds students argue formally about a proposed modification.
