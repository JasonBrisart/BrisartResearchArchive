# Lesson 18 — Parameters Need Observables
...
| | |
|---|---|
| **Central question** | Parameters Need Observables: students state that a parameter must connect to something measurable? |
| **Core concept** | A parameter is only meaningful if it connects to something measurable. |
| **Student outcome** | Students state that a parameter must connect to something measurable. |
| **Previous lesson** | Lesson 17 — Opening The Prediction |
| **Next lesson** | Lesson 19 — Measurable Or Not |
...
**The conceptual step.** A parameter is only meaningful if it connects to something measurable. Proposing an unobtainable observable does not satisfy the requirement.
...
**What depends on it.** Lesson 19 — Measurable Or Not — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A parameter is only meaningful if it connects to something measurable. Proposing an unobtainable observable does not satisfy the requirement.
...
1. A persistence threshold linked to recurrence rates.
2. An integration weight linked to response bias under varied input.

### One non-example

An observable requiring equipment nobody has.
...
That parameters require candidate observables.

### What this activity does not establish

Whether any parameter has been measured.
...
| Statement | Status |
|---|---|
| A parameter is only meaningful if it connects to something measurable. | Framework-derived, appropriate at this grade |
| That parameters require candidate observables. | What this specific activity can show |
| Whether any parameter has been measured. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Opening The Prediction — specifically: students check their Lesson 1 sealed prediction about E(t)'s absence.

**How it was taught.** Through the activity: compare the sealed prediction with what they now know and write what would have pointed them right

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: compare the sealed prediction with what they now know and write what would have pointed them right, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A persistence threshold linked to recurrence rates. |
| **Non-example** | An observable requiring equipment nobody has. |
...
> "You made a real prediction and checked it. That is the method."
...
**Exact wording.** "Ask what w2 is worth. Nobody knows. Ask what use it is then."
...
**Target observation.** That parameters require candidate observables.
...
> "A parameter is only meaningful if it connects to something measurable. You just saw that when ask what w2 is worth.
> Last time we said: You made a real prediction and checked it. That is the method. This is the next part of that.
...
**What students must not infer.** Whether any parameter has been measured.

### 4. Worked example

**The example.** A persistence threshold linked to recurrence rates.
...
**Completed answer.** A persistence threshold linked to recurrence rates. — which demonstrates that parameters require candidate observables.
...
**Conclusions not licensed.** Whether any parameter has been measured.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An integration weight linked to response bias under varied input. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An observable requiring equipment nobody has. Why is this not an
example?"
...
**Exact student instructions.** For each of four parameters, name one thing that would have to be measurable.
...
- *Licensed conclusion.* That parameters require candidate observables.
- *Not licensed.* Whether any parameter has been measured.
...
- *Expected response.* That parameters require candidate observables.
...
1. Any wording carrying the idea in `A parameter is only meaningful if it connects to something measurable`.
...
Say: "A parameter with no observable behind it is decoration."
...
| | |
|---|---|
| **Follows** | Lesson 17 — Opening The Prediction |
| **Leads to** | Lesson 19 — Measurable Or Not |

**Transition in.** Lesson 17 established students check their Lesson 1 sealed prediction about E(t)'s absence. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state that a parameter must connect to something measurable. Lesson 19 assumes it and builds students judge whether proposed observables are actually obtainable.
