# Lesson 22 — Parameters In Other Models
...
| | |
|---|---|
| **Central question** | Parameters In Other Models: students compare parameter practice with another subject? |
| **Core concept** | Free parameters are common in scientific models. |
| **Student outcome** | Students compare parameter practice with another subject. |
| **Previous lesson** | Lesson 21 — Silence Is Not Denial |
| **Next lesson** | Lesson 23 — The Parameter Audit |
...
**The conceptual step.** Free parameters are common in scientific models. Comparing how other fields handle them shows this is a general problem with known approaches.
...
**What depends on it.** Lesson 23 — The Parameter Audit — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Free parameters are common in scientific models. Comparing how other fields handle them shows this is a general problem with known approaches.
...
1. A physics parameter with a well-established measurement route.
2. A parameter in another model that is currently unmeasured.

### One non-example

An assumption that established models have no free parameters.
...
That the parameter problem is general.

### What this activity does not establish

Whether other models solve it well.
...
| Statement | Status |
|---|---|
| Free parameters are common in scientific models. | Framework-derived, appropriate at this grade |
| That the parameter problem is general. | What this specific activity can show |
| Whether other models solve it well. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 21 — Silence Is Not Denial — specifically: students distinguish what a model denies from what it does not address.

**How it was taught.** Through the activity: sort eight statements into denied, unaddressed, and asserted

**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: sort eight statements into denied, unaddressed, and asserted, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A physics parameter with a well-established measurement route. |
| **Non-example** | An assumption that established models have no free parameters. |
...
> "Silence is not denial. Different thing entirely."
...
**Exact wording.** "Take a parameter from a physics or chemistry model."
...
**Target observation.** That the parameter problem is general.
...
> "Free parameters are common in scientific models. You just saw that when take a parameter from a physics or chemistry model.
> Last time we said: Silence is not denial. Different thing entirely. This is the next part of that.
...
**What students must not infer.** Whether other models solve it well.

### 4. Worked example

**The example.** A physics parameter with a well-established measurement route.
...
**Completed answer.** A physics parameter with a well-established measurement route. — which demonstrates that the parameter problem is general.
...
**Conclusions not licensed.** Whether other models solve it well.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A parameter in another model that is currently unmeasured. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An assumption that established models have no free parameters. Why is this not an
example?"
...
**Exact student instructions.** Compare three outside parameters against the observable requirement.
...
- *Licensed conclusion.* That the parameter problem is general.
- *Not licensed.* Whether other models solve it well.
...
- *Expected response.* That the parameter problem is general.
...
1. Any wording carrying the idea in `Free parameters are common in scientific models`.
...
Say: "Every serious model has this problem. Some solve it better."
...
| | |
|---|---|
| **Follows** | Lesson 21 — Silence Is Not Denial |
| **Leads to** | Lesson 23 — The Parameter Audit |

**Transition in.** Lesson 21 established students distinguish what a model denies from what it does not address. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students compare parameter practice with another subject. Lesson 23 assumes it and builds students audit the framework's full parameter set.
