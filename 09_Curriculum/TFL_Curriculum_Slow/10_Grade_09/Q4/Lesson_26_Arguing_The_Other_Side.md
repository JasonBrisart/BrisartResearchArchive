# Lesson 26 — Arguing The Other Side
...
| | |
|---|---|
| **Central question** | Arguing The Other Side: students argue for the modification they argued against? |
| **Core concept** | Arguing both sides tests whether the student understands the structure or merely holds a position. |
| **Student outcome** | Students argue for the modification they argued against. |
| **Previous lesson** | Lesson 25 — The Structural Argument |
| **Next lesson** | Lesson 27 — Judging Arguments |
...
**The conceptual step.** Arguing both sides tests whether the student understands the structure or merely holds a position. A deliberately weak opposing case fails the test.
...
**What depends on it.** Lesson 27 — Judging Arguments — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Arguing both sides tests whether the student understands the structure or merely holds a position. A deliberately weak opposing case fails the test.
...
1. A genuine best case for the modification.
2. An opposing argument a partner judges strong.

### One non-example

An opposing argument written to be easily defeated.
...
Whether both sides can be argued genuinely.
...
| Statement | Status |
|---|---|
| Arguing both sides tests whether the student understands the structure or merely holds a position. | Framework-derived, appropriate at this grade |
| Whether both sides can be argued genuinely. | What this specific activity can show |
| Which side is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — The Structural Argument — specifically: students argue formally about a proposed modification.

**How it was taught.** Through the activity: a 250-word structured argument on what changes, what it costs, what would justify it

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: a 250-word structured argument on what changes, what it costs, what would justify it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A genuine best case for the modification. |
| **Non-example** | An opposing argument written to be easily defeated. |
...
> "The strongest answers notice the modification absorbs contradicting results."
...
**Exact wording.** "Say: now defend the modification. Best case for it."
...
**Target observation.** Whether both sides can be argued genuinely.
...
> "Arguing both sides tests whether the student understands the structure or merely holds a position. You just saw that when say: now defend the modification.
> Last time we said: The strongest answers notice the modification absorbs contradicting results. This is the next part of that.
...
**What students must not infer.** Which side is correct.

### 4. Worked example

**The example.** A genuine best case for the modification.
...
**Completed answer.** A genuine best case for the modification. — which demonstrates whether both sides can be argued genuinely.
...
**Conclusions not licensed.** Which side is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An opposing argument a partner judges strong. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An opposing argument written to be easily defeated. Why is this not an
example?"
...
**Exact student instructions.** A 250-word argument for the opposite position.
...
- *Licensed conclusion.* Whether both sides can be argued genuinely.
- *Not licensed.* Which side is correct.
...
- *Expected response.* Whether both sides can be argued genuinely.
...
1. Any wording carrying the idea in `Arguing both sides tests whether the student understands the structure or merely holds a position`.
...
Say: "You should be able to argue both. That is the test."
...
| | |
|---|---|
| **Follows** | Lesson 25 — The Structural Argument |
| **Leads to** | Lesson 27 — Judging Arguments |

**Transition in.** Lesson 25 established students argue formally about a proposed modification. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students argue for the modification they argued against. Lesson 27 assumes it and builds students evaluate structural arguments by criteria.
