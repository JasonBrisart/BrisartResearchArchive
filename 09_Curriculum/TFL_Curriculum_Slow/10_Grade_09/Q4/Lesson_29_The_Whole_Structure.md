...
| | |
|---|---|
| **Central question** | The Whole Structure: students present the formal system and defend one claim? |
| **Core concept** | Writing the full structure unaided and defending one part of it is the year's terminal skill. |
| **Student outcome** | Students present the formal system and defend one claim. |
| **Previous lesson** | Lesson 28 — Defending Under Challenge |
| **Next lesson** | Lesson 30 — The Year In Arguments |
...
**The conceptual step.** Writing the full structure unaided and defending one part of it is the year's terminal skill. The defence must engage rather than restate.
...
**What depends on it.** Lesson 30 — The Year In Arguments — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Writing the full structure unaided and defending one part of it is the year's terminal skill. The defence must engage rather than restate.
...
1. The relation, the weights, and closure written from memory.
2. A claim defended against two specific questions.

### One non-example

A structure written with the board still visible.
...
Whether the formal system is securely held.
...
| Statement | Status |
|---|---|
| Writing the full structure unaided and defending one part of it is the year's terminal skill. | Framework-derived, appropriate at this grade |
| Whether the formal system is securely held. | What this specific activity can show |
| Whether the system is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — Defending Under Challenge — specifically: students defend a structural argument against classmates.

**How it was taught.** Through the activity: each student answers three written challenges to their argument

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: each student answers three written challenges to their argument, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The relation, the weights, and closure written from memory. |
| **Non-example** | A structure written with the board still visible. |
...
**Exact wording.** "Say: write the system from memory, then defend one part against the room."
...
**Target observation.** Whether the formal system is securely held.
...
> "Writing the full structure unaided and defending one part of it is the year's terminal skill. You just saw that when say: write the system from memory, then defend one part against the room.
...
**What students must not infer.** Whether the system is correct.

### 4. Worked example

**The example.** The relation, the weights, and closure written from memory.
...
**Completed answer.** The relation, the weights, and closure written from memory. — which demonstrates whether the formal system is securely held.
...
**Conclusions not licensed.** Whether the system is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A claim defended against two specific questions. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A structure written with the board still visible. Why is this not an
example?"
...
**Exact student instructions.** The full structure written unaided, with one claim defended against two questions.
...
- *Licensed conclusion.* Whether the formal system is securely held.
- *Not licensed.* Whether the system is correct.
...
- *Expected response.* Whether the formal system is securely held.
...
1. Any wording carrying the idea in `Writing the full structure unaided and defending one part of it is the year's terminal skill`.
...
Say: "Next year: why E(t) lives where it lives."
...
| | |
|---|---|
| **Follows** | Lesson 28 — Defending Under Challenge |
| **Leads to** | Lesson 30 — The Year In Arguments |

**Transition in.** Lesson 28 established students defend a structural argument against classmates. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students present the formal system and defend one claim. Lesson 30 assumes it and builds students review the year through their own arguments.
