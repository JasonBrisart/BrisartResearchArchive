# Lesson 30 — The Year In Arguments
...
| | |
|---|---|
| **Central question** | The Year In Arguments: students review the year through their own arguments? |
| **Core concept** | Comparing an early structural argument with a late one gives direct evidence of the year's progress in formal reasoning. |
| **Student outcome** | Students review the year through their own arguments. |
| **Previous lesson** | Lesson 29 — The Whole Structure |
...
**The conceptual step.** Comparing an early structural argument with a late one gives direct evidence of the year's progress in formal reasoning.
...
Comparing an early structural argument with a late one gives direct evidence of the year's progress in formal reasoning.
...
1. A Lesson 9 argument beside a Lesson 28 one.
2. A student noticing their early arguments did not state costs.

### One non-example

Reviewing only the most recent arguments.
...
That the student's formal reasoning improved measurably.
...
| Statement | Status |
|---|---|
| Comparing an early structural argument with a late one gives direct evidence of the year's progress in formal reasoning. | Framework-derived, appropriate at this grade |
| That the student's formal reasoning improved measurably. | What this specific activity can show |
| Any external quality standard. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 29 — The Whole Structure — specifically: students present the formal system and defend one claim.

**How it was taught.** Through the activity: the full structure written unaided, with one claim defended against two questions

**Quick check.** Ask for the closing sentence of Lesson 29. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 29: the full structure written unaided, with one claim defended against two questions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Lesson 9 argument beside a Lesson 28 one. |
| **Non-example** | Reviewing only the most recent arguments. |
...
> "Next year: why E(t) lives where it lives."
...
**Exact wording.** "Lay out every structural argument written this year."
...
**Target observation.** That the student's formal reasoning improved measurably.
...
> "Comparing an early structural argument with a late one gives direct evidence of the year's progress in formal reasoning. You just saw that when lay out every structural argument written this year.
> Last time we said: Next year: why E(t) lives where it lives. This is the next part of that.
...
**The example.** A Lesson 9 argument beside a Lesson 28 one.
...
**Completed answer.** A Lesson 9 argument beside a Lesson 28 one. — which demonstrates that the student's formal reasoning improved measurably.
...
**Teacher prompt.** "Here is a second case. A student noticing their early arguments did not state costs. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reviewing only the most recent arguments. Why is this not an
example?"
...
**Exact student instructions.** Compare an early and a late argument and write what improved.
...
- *Licensed conclusion.* That the student's formal reasoning improved measurably.
...
- *Expected response.* That the student's formal reasoning improved measurably.
...
1. Any wording carrying the idea in `Comparing an early structural argument with a late one gives direct evidence of the year's progress in formal reasoning`.
...
Say: "Next year: the guarantees, and what they refuse to promise."
...
| | |
|---|---|
| **Follows** | Lesson 29 — The Whole Structure |
| **Leads to** | Lesson 31 — Practice Final |

**Transition in.** Lesson 29 established students present the formal system and defend one claim. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students review the year through their own arguments. Lesson 31 assumes it and builds students rehearse the final under conditions.
