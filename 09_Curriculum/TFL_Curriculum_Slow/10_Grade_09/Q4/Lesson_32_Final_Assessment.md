...
| **Core concept** | The four exit outcomes together constitute readiness for Grade 10, which formalises the persistence relation and the guarantee set. |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 10, which formalises the persistence relation and the guarantee set.
...
The four exit outcomes together constitute readiness for Grade 10, which formalises the persistence relation and the guarantee set.
...
2. A student produces a structural argument with costs named.

### One non-example

A student who states closure without its cost.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 10, which formalises the persistence relation and the guarantee set. | Framework-derived, appropriate at this grade |
...
| **Non-example** | A student who states closure without its cost. |
...
> "The four exit outcomes together constitute readiness for Grade 10, which formalises the persistence relation and the guarantee set. You just saw that when say: everything you know, on your own.
...
**Teacher prompt.** "Here is a second case. A student produces a structural argument with costs named. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student who states closure without its cost. Why is this not an
example?"
...
**Exact student instructions.** The final: the relation, closure with its cost, conditional determinism, a structural argument.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 10, which formalises the persistence relation and the guarantee set`.
...
Say: "Next year: the guarantees, and the claim the framework is most likely to be wrong about."
