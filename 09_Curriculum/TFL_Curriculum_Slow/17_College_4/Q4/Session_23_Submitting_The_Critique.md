# Session 23 — Submitting The Critique
...
| | |
|---|---|
| **Central question** | Submitting The Critique: students finalise and submit the independent critique? |
| **Core concept** | A critique without an anticipated defence is returned unmarked, because it has not engaged with the strongest available response. |
| **Student outcome** | Students finalise and submit the independent critique. |
| **Previous session** | Session 22 — The Capstone Defence |
| **Next session** | Session 24 — What I Would Do Next |
...
**The conceptual step.** A critique without an anticipated defence is returned unmarked, because it has not engaged with the strongest available response.
...
**What depends on it.** Session 24 — What I Would Do Next — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A critique without an anticipated defence is returned unmarked, because it has not engaged with the strongest available response.
...
1. A critique with all six sections present.
2. A critique returned and resubmitted with the defence added.

### One non-example

A critique with the anticipated defence omitted.
...
That critique completeness is enforced.
...
| Statement | Status |
|---|---|
| A critique without an anticipated defence is returned unmarked, because it has not engaged with the strongest available response. | Framework-derived, appropriate at this grade |
| That critique completeness is enforced. | What this specific activity can show |
| Whether the critique succeeds. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 22 — The Capstone Defence — specifically: students defend the capstone against four roles.

**How it was taught.** Through the activity: eight minutes presenting, eight defending, against four challengers

**Quick check.** Ask for the closing sentence of Session 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 22: eight minutes presenting, eight defending, against four challengers, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A critique with all six sections present. |
| **Non-example** | A critique with the anticipated defence omitted. |
...
> "You are leaving undergraduate study able to say what your result does not license."
...
**Exact wording.** "Say: six sections. The target, the critique, evidence, defence, response, closure, assessment."
...
**Target observation.** That critique completeness is enforced.
...
> "A critique without an anticipated defence is returned unmarked, because it has not engaged with the strongest available response. You just saw that when say: six sections.
> Last time we said: You are leaving undergraduate study able to say what your result does not license. This is the next part of that.
...
**The example.** A critique with all six sections present.
...
**Completed answer.** A critique with all six sections present. — which demonstrates that critique completeness is enforced.
...
**Teacher prompt.** "Here is a second case. A critique returned and resubmitted with the defence added. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A critique with the anticipated defence omitted. Why is this not an
example?"
...
**Exact student instructions.** Final revision and submission of the critique paper.
...
- *Licensed conclusion.* That critique completeness is enforced.
...
- *Expected response.* That critique completeness is enforced.
...
1. Any wording carrying the idea in `A critique without an anticipated defence is returned unmarked, because it has not engaged with the strongest available response`.
...
Say: "That is a piece of independent work."
...
| | |
|---|---|
| **Follows** | Session 22 — The Capstone Defence |
| **Leads to** | Session 24 — What I Would Do Next |

**Transition in.** Session 22 established students defend the capstone against four roles. This session uses that as the starting point.

**Transition out.** This session establishes students finalise and submit the independent critique. Session 24 assumes it and builds students state what they would do with another year.
