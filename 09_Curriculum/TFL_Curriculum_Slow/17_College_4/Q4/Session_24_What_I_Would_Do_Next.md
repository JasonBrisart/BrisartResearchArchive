# Session 24 — What I Would Do Next
...
| | |
|---|---|
| **Central question** | What I Would Do Next: students state what they would do with another year? |
| **Core concept** | A continuation plan names an actionable first step doable within a month. |
| **Student outcome** | Students state what they would do with another year. |
| **Previous session** | Session 23 — Submitting The Critique |
| **Next session** | Session 25 — The Degree In Review |
...
**The conceptual step.** A continuation plan names an actionable first step doable within a month. Without it the plan is a wish list.
...
**What depends on it.** Session 25 — The Degree In Review — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A continuation plan names an actionable first step doable within a month. Without it the plan is a wish list.
...
1. A plan whose first step is a pilot study with a named sample.
2. A first step doable within a month.

### One non-example

A plan proposing to establish a research programme.
...
That continuation plans can be made actionable.

### What this activity does not establish

Whether the plan would succeed.
...
| Statement | Status |
|---|---|
| A continuation plan names an actionable first step doable within a month. | Framework-derived, appropriate at this grade |
| That continuation plans can be made actionable. | What this specific activity can show |
| Whether the plan would succeed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 23 — Submitting The Critique — specifically: students finalise and submit the independent critique.

**How it was taught.** Through the activity: final revision and submission of the critique paper

**Quick check.** Ask for the closing sentence of Session 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 23: final revision and submission of the critique paper, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A plan whose first step is a pilot study with a named sample. |
| **Non-example** | A plan proposing to establish a research programme. |
...
> "That is a piece of independent work."
...
**Exact wording.** "Ask what they would do with another year and a budget."
...
**Target observation.** That continuation plans can be made actionable.
...
> "A continuation plan names an actionable first step doable within a month. You just saw that when ask what they would do with another year and a budget.
> Last time we said: That is a piece of independent work. This is the next part of that.
...
**What students must not infer.** Whether the plan would succeed.

### 4. Worked example

**The example.** A plan whose first step is a pilot study with a named sample.
...
**Completed answer.** A plan whose first step is a pilot study with a named sample. — which demonstrates that continuation plans can be made actionable.
...
**Conclusions not licensed.** Whether the plan would succeed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A first step doable within a month. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A plan proposing to establish a research programme. Why is this not an
example?"
...
**Exact student instructions.** Write a one-page continuation plan with a stated first step.
...
- *Licensed conclusion.* That continuation plans can be made actionable.
- *Not licensed.* Whether the plan would succeed.
...
- *Expected response.* That continuation plans can be made actionable.
...
1. Any wording carrying the idea in `A continuation plan names an actionable first step doable within a month`.
...
Say: "That is what a research programme starts as."
...
| | |
|---|---|
| **Follows** | Session 23 — Submitting The Critique |
| **Leads to** | Session 25 — The Degree In Review |

**Transition in.** Session 23 established students finalise and submit the independent critique. This session uses that as the starting point.

**Transition out.** This session establishes students state what they would do with another year. Session 25 assumes it and builds students review four years of their own work.
