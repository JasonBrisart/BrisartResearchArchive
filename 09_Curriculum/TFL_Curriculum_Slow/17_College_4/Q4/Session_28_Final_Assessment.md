...
| | |
|---|---|
| **Central question** | Final Assessment: students demonstrate integrated command on a gated paper? |
| **Core concept** | The gated final requires both gate items regardless of total score. |
| **Student outcome** | Students demonstrate integrated command on a gated paper. |
...
**The conceptual step.** The gated final requires both gate items regardless of total score. Answering them first is the only reliable strategy.
...
The gated final requires both gate items regardless of total score. Answering them first is the only reliable strategy.
...
1. A paper with both gates satisfied.
2. A Gate B answer naming a genuinely invalid application and its boundary.

### One non-example

A paper with high total score and one gate unattempted.
...
Whether both gates are satisfied.

### What this activity does not establish

Quality of the non-gate items.
...
| Statement | Status |
|---|---|
| The gated final requires both gate items regardless of total score. | Framework-derived, appropriate at this grade |
| Whether both gates are satisfied. | What this specific activity can show |
| Quality of the non-gate items. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 27 — Final Preparation — specifically: students address weaknesses the practice revealed.

**How it was taught.** Through the activity: targeted review of two weakest areas, gates prioritised

**Quick check.** Ask for the closing sentence of Session 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 27: targeted review of two weakest areas, gates prioritised, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A paper with both gates satisfied. |
| **Non-example** | A paper with high total score and one gate unattempted. |
...
**Exact wording.** "Say: both gates first. Everything else after."
...
**Target observation.** Whether both gates are satisfied.
...
> "The gated final requires both gate items regardless of total score. You just saw that when say: both gates first.
...
**What students must not infer.** Quality of the non-gate items.

### 4. Worked example

**The example.** A paper with both gates satisfied.
...
**Completed answer.** A paper with both gates satisfied. — which demonstrates whether both gates are satisfied.
...
**Conclusions not licensed.** Quality of the non-gate items.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A Gate B answer naming a genuinely invalid application and its boundary. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A paper with high total score and one gate unattempted. Why is this not an
example?"
...
**Exact student instructions.** The gated final: falsification, scope, the ladder both ways, adjudication, and status.
...
- *Licensed conclusion.* Whether both gates are satisfied.
- *Not licensed.* Quality of the non-gate items.
...
- *Expected response.* Whether both gates are satisfied.
...
1. Any wording carrying the idea in `The gated final requires both gate items regardless of total score`.
...
Say: "Next: measurement that a stranger could execute."
...
**Transition in.** Session 27 established students address weaknesses the practice revealed. This session uses that as the starting point.
