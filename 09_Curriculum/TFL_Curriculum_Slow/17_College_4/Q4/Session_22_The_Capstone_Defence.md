# Session 22 — The Capstone Defence

**College Year 4** · Independent Critique and Capstone · **Quarter 4** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Capstone Defence: students defend the capstone against four roles? |
| **Core concept** | The capstone defence requires the falsification condition before advocacy, all four challenger roles answered, and both gates satisfied. |
| **Student outcome** | Students defend the capstone against four roles. |
| **Previous session** | Session 21 — Revising After The Mock |
| **Next session** | Session 23 — Submitting The Critique |
...
**The conceptual step.** The capstone defence requires the falsification condition before advocacy, all four challenger roles answered, and both gates satisfied.
...
**What depends on it.** Session 23 — Submitting The Critique — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The capstone defence requires the falsification condition before advocacy, all four challenger roles answered, and both gates satisfied.
...
1. A defence opening with the falsification condition.
2. A defence answering all four challengers specifically.

### One non-example

A defence opening with the case for the claim.
...
Whether the capstone can be defended.
...
| Statement | Status |
|---|---|
| The capstone defence requires the falsification condition before advocacy, all four challenger roles answered, and both gates satisfied. | Framework-derived, appropriate at this grade |
| Whether the capstone can be defended. | What this specific activity can show |
| Whether the claim is true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 21 — Revising After The Mock — specifically: students revise the capstone against mock feedback.

**How it was taught.** Through the activity: revise and mark what changed for each unanswered question

**Quick check.** Ask for the closing sentence of Session 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 21: revise and mark what changed for each unanswered question, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence opening with the falsification condition. |
| **Non-example** | A defence opening with the case for the claim. |
...
**Exact wording.** "Say: the claim, the condition first, the design, the ceiling, and one rejection."
...
**Target observation.** Whether the capstone can be defended.
...
> "The capstone defence requires the falsification condition before advocacy, all four challenger roles answered, and both gates satisfied. You just saw that when say: the claim, the condition first, the design, the ceiling, and one rejection.
...
**What students must not infer.** Whether the claim is true.

### 4. Worked example

**The example.** A defence opening with the falsification condition.
...
**Completed answer.** A defence opening with the falsification condition. — which demonstrates whether the capstone can be defended.
...
**Conclusions not licensed.** Whether the claim is true.
...
**Teacher prompt.** "Now one that does not work. A defence opening with the case for the claim. Why is this not an
example?"
...
**Exact student instructions.** Eight minutes presenting, eight defending, against four challengers.
...
- *Licensed conclusion.* Whether the capstone can be defended.
- *Not licensed.* Whether the claim is true.
...
- *Expected response.* Whether the capstone can be defended.
...
1. Any wording carrying the idea in `The capstone defence requires the falsification condition before advocacy, all four challenger roles answered, and both gates satisfied`.
...
Say: "You are leaving undergraduate study able to say what your result does not license."
...
| **Leads to** | Session 23 — Submitting The Critique |

**Transition in.** Session 21 established students revise the capstone against mock feedback. This session uses that as the starting point.

**Transition out.** This session establishes students defend the capstone against four roles. Session 23 assumes it and builds students finalise and submit the independent critique.
