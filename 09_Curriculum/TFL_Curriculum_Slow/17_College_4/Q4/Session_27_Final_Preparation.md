...
| | |
|---|---|
| **Central question** | Final Preparation: students address weaknesses the practice revealed? |
| **Core concept** | A failed gate takes priority over every other weakness, because it determines whether the paper passes at all. |
| **Student outcome** | Students address weaknesses the practice revealed. |
| **Previous session** | Session 26 — Practice Final |
| **Next session** | Session 28 — Final Assessment |
| **Materials** | Capstone templates; printed inference ladders |
| **Preparation** | thirty minutes |
| **Student printout** | `Printouts/Session_27_Printout.md` |
| **Homework** | `Homework/Session_27_Homework.md` |

## Why this lesson exists

**The conceptual step.** A failed gate takes priority over every other weakness, because it determines whether the paper passes at all.
...
**What depends on it.** Session 28 — Final Assessment — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A failed gate takes priority over every other weakness, because it determines whether the paper passes at all.
...
1. A student prioritising a failed Gate A above all else.
2. A student working on their two weakest non-gate areas.

### One non-example

A student revising material they already scored well on.
...
That review can be prioritised by consequence.
...
| Statement | Status |
|---|---|
| A failed gate takes priority over every other weakness, because it determines whether the paper passes at all. | Framework-derived, appropriate at this grade |
| That review can be prioritised by consequence. | What this specific activity can show |
| The final grade. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 26 — Practice Final — specifically: students rehearse the gated final under conditions.

**How it was taught.** Through the activity: a full practice final, gates checked first

**Quick check.** Ask for the closing sentence of Session 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 26: a full practice final, gates checked first, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student prioritising a failed Gate A above all else. |
| **Non-example** | A student revising material they already scored well on. |
...
**Student materials.** One copy of `Printouts/Session_27_Printout.md` per student.

**Prior student data required.** Work produced in Session 26, kept in the student's folder.
...
**File.** `Printouts/Session_27_Printout.md`
...
> "Now you know whether the gates would pass."
...
**Exact wording.** "Say: your practice paper told you something."
...
**Target observation.** That review can be prioritised by consequence.
...
> "A failed gate takes priority over every other weakness, because it determines whether the paper passes at all. You just saw that when say: your practice paper told you something.
> Last time we said: Now you know whether the gates would pass. This is the next part of that.
...
**What students must not infer.** The final grade.

### 4. Worked example

**The example.** A student prioritising a failed Gate A above all else.
...
**Completed answer.** A student prioritising a failed Gate A above all else. — which demonstrates that review can be prioritised by consequence.
...
**Conclusions not licensed.** The final grade.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student working on their two weakest non-gate areas. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student revising material they already scored well on. Why is this not an
example?"
...
**Exact student instructions.** Targeted review of two weakest areas, gates prioritised.
...
- *Licensed conclusion.* That review can be prioritised by consequence.
- *Not licensed.* The final grade.
...
- *Expected response.* That review can be prioritised by consequence.
...
1. Any wording carrying the idea in `A failed gate takes priority over every other weakness, because it determines whether the paper passes at all`.
...
Say: "That is the last useful thing before the final."

**Why this sentence matters.** It is the opening question of Session 28, which assumes students arrive holding it.
...
**File.** `Homework/Session_27_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 26 — Practice Final |
| **Leads to** | Session 28 — Final Assessment |

**Transition in.** Session 26 established students rehearse the gated final under conditions. This session uses that as the starting point.

**Transition out.** This session establishes students address weaknesses the practice revealed. Session 28 assumes it and builds students demonstrate integrated command on a gated paper.
