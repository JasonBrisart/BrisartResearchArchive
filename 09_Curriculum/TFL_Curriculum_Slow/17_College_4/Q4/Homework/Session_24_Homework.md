# Session 24 Homework — What I Would Do Next

**College Year 4** · Independent Critique and Capstone · **Quarter 4**
**Follows:** Session 24 — What I Would Do Next · **Points:** 5 · **Optional:** yes
...
Write a one-page continuation plan with a stated first step.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every plan names an actionable first step
...
Session 25 is **The Degree In Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
