# Session 27 Homework — Final Preparation

**College Year 4** · Independent Critique and Capstone · **Quarter 4**
**Follows:** Session 27 — Final Preparation · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 27 ended on, from memory:
...
Targeted review of two weakest areas, gates prioritised.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has worked on the gates if they failed them
...
Session 28 is **Final Assessment**, which assumes you arrive holding it. Write one thing you expect it to be about:
