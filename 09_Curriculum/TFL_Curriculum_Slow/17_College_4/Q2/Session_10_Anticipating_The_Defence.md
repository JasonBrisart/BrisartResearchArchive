# Session 10 — Anticipating The Defence
...
| | |
|---|---|
| **Central question** | Anticipating The Defence: students state the framework's best available response? |
| **Core concept** | Authors construct the defence they can answer. |
| **Student outcome** | Students state the framework's best available response. |
| **Previous session** | Session 9 — Evidence For A Critique |
| **Next session** | Session 11 — Responding Or Conceding |
...
**The conceptual step.** Authors construct the defence they can answer. External checking by somebody sympathetic to the framework is the only reliable safeguard against a strawman defence.
...
**What depends on it.** Session 11 — Responding Or Conceding — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Authors construct the defence they can answer. External checking by somebody sympathetic to the framework is the only reliable safeguard against a strawman defence.
...
1. A defence a sympathetic checker accepted as the strongest available.
2. A defence revised after the checker objected.

### One non-example

A defence constructed to be easily rebutted.
...
That anticipated defences require external checking.

### What this activity does not establish

Whether the defence succeeds.
...
| Statement | Status |
|---|---|
| Authors construct the defence they can answer. | Framework-derived, appropriate at this grade |
| That anticipated defences require external checking. | What this specific activity can show |
| Whether the defence succeeds. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 9 — Evidence For A Critique — specifically: students support every critique claim with a location or citation.

**How it was taught.** Through the activity: audit their own draft and supply evidence or delete

**Quick check.** Ask for the closing sentence of Session 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 9: audit their own draft and supply evidence or delete, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence a sympathetic checker accepted as the strongest available. |
| **Non-example** | A defence constructed to be easily rebutted. |
...
> "Deleting an unsupportable claim is a repair, not a loss."
...
**Exact wording.** "Put up a critique with a weak anticipated defence and ask whether that is the best it can do."
...
**Target observation.** That anticipated defences require external checking.
...
> "Authors construct the defence they can answer. You just saw that when put up a critique with a weak anticipated defence and ask whether that is the best it can do.
> Last time we said: Deleting an unsupportable claim is a repair, not a loss. This is the next part of that.
...
**What students must not infer.** Whether the defence succeeds.

### 4. Worked example

**The example.** A defence a sympathetic checker accepted as the strongest available.
...
**Completed answer.** A defence a sympathetic checker accepted as the strongest available. — which demonstrates that anticipated defences require external checking.
...
**Conclusions not licensed.** Whether the defence succeeds.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A defence revised after the checker objected. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence constructed to be easily rebutted. Why is this not an
example?"
...
**Exact student instructions.** Write the defence and have it checked by somebody sympathetic to the framework.
...
- *Licensed conclusion.* That anticipated defences require external checking.
- *Not licensed.* Whether the defence succeeds.
...
- *Expected response.* That anticipated defences require external checking.
...
1. Any wording carrying the idea in `Authors construct the defence they can answer`.
...
Say: "Concession is scored identically to successful rebuttal."
...
| | |
|---|---|
| **Follows** | Session 9 — Evidence For A Critique |
| **Leads to** | Session 11 — Responding Or Conceding |

**Transition in.** Session 9 established students support every critique claim with a location or citation. This session uses that as the starting point.

**Transition out.** This session establishes students state the framework's best available response. Session 11 assumes it and builds students answer the defence or narrow the critique.
