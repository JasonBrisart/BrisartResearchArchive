# Session 11 — Responding Or Conceding
...
| | |
|---|---|
| **Central question** | Responding Or Conceding: students answer the defence or narrow the critique? |
| **Core concept** | Conceding in the face of a good defence and narrowing the critique produces stronger work than refusing to concede. |
| **Student outcome** | Students answer the defence or narrow the critique. |
| **Previous session** | Session 10 — Anticipating The Defence |
| **Next session** | Session 12 — The Closure Path |
...
**The conceptual step.** Conceding in the face of a good defence and narrowing the critique produces stronger work than refusing to concede. Both outcomes score identically.
...
**What depends on it.** Session 12 — The Closure Path — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Conceding in the face of a good defence and narrowing the critique produces stronger work than refusing to concede. Both outcomes score identically.
...
1. A response answering the defence directly.
2. A concession narrowing the critique to a defensible core.

### One non-example

A refusal to concede despite an unanswerable defence.
...
That concession is a legitimate and scored outcome.

### What this activity does not establish

Whether the critique survives.
...
| Statement | Status |
|---|---|
| Conceding in the face of a good defence and narrowing the critique produces stronger work than refusing to concede. | Framework-derived, appropriate at this grade |
| That concession is a legitimate and scored outcome. | What this specific activity can show |
| Whether the critique survives. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 10 — Anticipating The Defence — specifically: students state the framework's best available response.

**How it was taught.** Through the activity: write the defence and have it checked by somebody sympathetic to the framework

**Quick check.** Ask for the closing sentence of Session 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 10: write the defence and have it checked by somebody sympathetic to the framework, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A response answering the defence directly. |
| **Non-example** | A refusal to concede despite an unanswerable defence. |
...
> "Concession is scored identically to successful rebuttal."
...
**Exact wording.** "Say: either answer it or concede. Both are legitimate."
...
**Target observation.** That concession is a legitimate and scored outcome.
...
> "Conceding in the face of a good defence and narrowing the critique produces stronger work than refusing to concede. You just saw that when say: either answer it or concede.
> Last time we said: Concession is scored identically to successful rebuttal. This is the next part of that.
...
**What students must not infer.** Whether the critique survives.

### 4. Worked example

**The example.** A response answering the defence directly.
...
**Completed answer.** A response answering the defence directly. — which demonstrates that concession is a legitimate and scored outcome.
...
**Conclusions not licensed.** Whether the critique survives.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A concession narrowing the critique to a defensible core. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A refusal to concede despite an unanswerable defence. Why is this not an
example?"
...
**Exact student instructions.** Write the response or a reasoned concession that narrows the critique.
...
- *Licensed conclusion.* That concession is a legitimate and scored outcome.
- *Not licensed.* Whether the critique survives.
...
- *Expected response.* That concession is a legitimate and scored outcome.
...
1. Any wording carrying the idea in `Conceding in the face of a good defence and narrowing the critique produces stronger work than refusing to concede`.
...
Say: "A narrowed surviving critique is worth more than an overreaching one."
...
| | |
|---|---|
| **Follows** | Session 10 — Anticipating The Defence |
| **Leads to** | Session 12 — The Closure Path |

**Transition in.** Session 10 established students state the framework's best available response. This session uses that as the starting point.

**Transition out.** This session establishes students answer the defence or narrow the critique. Session 12 assumes it and builds students specify what would resolve the issue raised.
