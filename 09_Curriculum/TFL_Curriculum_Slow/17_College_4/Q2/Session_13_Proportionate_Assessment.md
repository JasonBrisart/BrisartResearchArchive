# Session 13 — Proportionate Assessment
...
| | |
|---|---|
| **Central question** | Proportionate Assessment: students match the verdict to the critique's scope? |
| **Core concept** | Proportionate assessment matches the verdict to what the critique establishes. |
| **Student outcome** | Students match the verdict to the critique's scope. |
| **Previous session** | Session 12 — The Closure Path |
...
**The conceptual step.** Proportionate assessment matches the verdict to what the critique establishes. Both inflation and minimisation are errors, and the test is what rests on the gap.
...
Proportionate assessment matches the verdict to what the critique establishes. Both inflation and minimisation are errors, and the test is what rests on the gap.
...
1. A local gap assessed as local.
2. A load-bearing gap assessed as consequential.

### One non-example

A parameter gap converted into a global verdict.
...
That assessments can be checked for proportion.
...
| Statement | Status |
|---|---|
| Proportionate assessment matches the verdict to what the critique establishes. | Framework-derived, appropriate at this grade |
| That assessments can be checked for proportion. | What this specific activity can show |
| Whether the assessment is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 12 — The Closure Path — specifically: students specify what would resolve the issue raised.

**How it was taught.** Through the activity: write the closure path, distinguishing theoretical from empirical work

**Quick check.** Ask for the closing sentence of Session 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 12: write the closure path, distinguishing theoretical from empirical work, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A local gap assessed as local. |
| **Non-example** | A parameter gap converted into a global verdict. |
...
> "Naming the closure path turns a complaint into a contribution."
...
**Exact wording.** "Put up two assessments, one proportionate and one converting a local gap into a verdict."
...
**Target observation.** That assessments can be checked for proportion.
...
> "Proportionate assessment matches the verdict to what the critique establishes. You just saw that when put up two assessments, one proportionate and one converting a local gap into a verdict.
> Last time we said: Naming the closure path turns a complaint into a contribution. This is the next part of that.
...
**What students must not infer.** Whether the assessment is correct.

### 4. Worked example

**The example.** A local gap assessed as local.
...
**Completed answer.** A local gap assessed as local. — which demonstrates that assessments can be checked for proportion.
...
**Conclusions not licensed.** Whether the assessment is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A load-bearing gap assessed as consequential. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A parameter gap converted into a global verdict. Why is this not an
example?"
...
**Exact student instructions.** Write the assessment, checked by a classmate for proportion in both directions.
...
- *Licensed conclusion.* That assessments can be checked for proportion.
- *Not licensed.* Whether the assessment is correct.
...
- *Expected response.* That assessments can be checked for proportion.
...
1. Any wording carrying the idea in `Proportionate assessment matches the verdict to what the critique establishes`.
...
Say: "Do not convert a local gap into a global verdict, or minimise a load-bearing one."
...
| | |
|---|---|
| **Follows** | Session 12 — The Closure Path |
| **Leads to** | Session 14 — The Midterm Review |

**Transition in.** Session 12 established students specify what would resolve the issue raised. This session uses that as the starting point.

**Transition out.** This session establishes students match the verdict to the critique's scope. Session 14 assumes it and builds students consolidate the first half.
