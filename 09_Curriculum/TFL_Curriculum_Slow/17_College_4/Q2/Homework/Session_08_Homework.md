# Session 8 Homework — The Independent Critique

**College Year 4** · Independent Critique and Capstone · **Quarter 2**
**Follows:** Session 8 — The Independent Critique · **Points:** 5 · **Optional:** yes
...
Select a form and draft the target statement, fairly rendered.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the target statement passes the reader test
...
Session 9 is **Evidence For A Critique**, which assumes you arrive holding it. Write one thing you expect it to be about:
