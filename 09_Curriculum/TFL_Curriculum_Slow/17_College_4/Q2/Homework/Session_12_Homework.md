# Session 12 Homework — The Closure Path

**College Year 4** · Independent Critique and Capstone · **Quarter 2**
**Follows:** Session 12 — The Closure Path · **Points:** 5 · **Optional:** yes
...
Write the closure path, distinguishing theoretical from empirical work.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every path distinguishes the two kinds of work
...
Session 13 is **Proportionate Assessment**, which assumes you arrive holding it. Write one thing you expect it to be about:
