# Session 9 — Evidence For A Critique
...
| | |
|---|---|
| **Central question** | Evidence For A Critique: students support every critique claim with a location or citation? |
| **Core concept** | Every claim in a critique requires a location or citation. |
| **Student outcome** | Students support every critique claim with a location or citation. |
| **Previous session** | Session 8 — The Independent Critique |
| **Next session** | Session 10 — Anticipating The Defence |
...
**The conceptual step.** Every claim in a critique requires a location or citation. Deleting an unsupportable claim strengthens the critique by removing a target.
...
**What depends on it.** Session 10 — Anticipating The Defence — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every claim in a critique requires a location or citation. Deleting an unsupportable claim strengthens the critique by removing a target.
...
1. A claim supported by a specific textual location.
2. An unsupportable claim deleted rather than softened.

### One non-example

An unsupported claim retained as contextual background.
...
That critique claims require checkable support.
...
| Statement | Status |
|---|---|
| Every claim in a critique requires a location or citation. | Framework-derived, appropriate at this grade |
| That critique claims require checkable support. | What this specific activity can show |
| Whether the claims are true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 8 — The Independent Critique — specifically: students select a critique form and target.

**How it was taught.** Through the activity: select a form and draft the target statement, fairly rendered

**Quick check.** Ask for the closing sentence of Session 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 8: select a form and draft the target statement, fairly rendered, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A claim supported by a specific textual location. |
| **Non-example** | An unsupported claim retained as contextual background. |
...
> "If a reader can tell which side you take, rewrite it."
...
**Exact wording.** "Put up a critique with three unsupported assertions and ask which a reader could check."
...
**Target observation.** That critique claims require checkable support.
...
> "Every claim in a critique requires a location or citation. You just saw that when put up a critique with three unsupported assertions and ask which a reader could check.
> Last time we said: If a reader can tell which side you take, rewrite it. This is the next part of that.
...
**What students must not infer.** Whether the claims are true.

### 4. Worked example

**The example.** A claim supported by a specific textual location.
...
**Completed answer.** A claim supported by a specific textual location. — which demonstrates that critique claims require checkable support.
...
**Conclusions not licensed.** Whether the claims are true.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An unsupportable claim deleted rather than softened. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An unsupported claim retained as contextual background. Why is this not an
example?"
...
**Exact student instructions.** Audit their own draft and supply evidence or delete.
...
- *Licensed conclusion.* That critique claims require checkable support.
- *Not licensed.* Whether the claims are true.
...
- *Expected response.* That critique claims require checkable support.
...
1. Any wording carrying the idea in `Every claim in a critique requires a location or citation`.
...
Say: "Deleting an unsupportable claim is a repair, not a loss."
...
| | |
|---|---|
| **Follows** | Session 8 — The Independent Critique |
| **Leads to** | Session 10 — Anticipating The Defence |

**Transition in.** Session 8 established students select a critique form and target. This session uses that as the starting point.

**Transition out.** This session establishes students support every critique claim with a location or citation. Session 10 assumes it and builds students state the framework's best available response.
