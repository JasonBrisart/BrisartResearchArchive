# Session 4 Homework — Designing The Capstone

**College Year 4** · Independent Critique and Capstone · **Quarter 1**
**Follows:** Session 4 — Designing The Capstone · **Points:** 5 · **Optional:** yes
...
Draft all seven sections and swap for an executability check.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student receives an executability check with marked lines
...
Session 5 is **The Inference Ladder**, which assumes you arrive holding it. Write one thing you expect it to be about:
