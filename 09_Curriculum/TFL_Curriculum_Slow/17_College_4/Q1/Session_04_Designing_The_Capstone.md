# Session 4 — Designing The Capstone
...
| | |
|---|---|
| **Central question** | Designing The Capstone: students build the design around the condition? |
| **Core concept** | The capstone is built around the falsification condition rather than the reverse. |
| **Student outcome** | Students build the design around the condition. |
| **Previous session** | Session 3 — The Capstone Falsification Condition |
| **Next session** | Session 5 — The Inference Ladder |
...
**The conceptual step.** The capstone is built around the falsification condition rather than the reverse. Executability is established by handover, not by the author's judgement.
...
**What depends on it.** Session 5 — The Inference Ladder — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The capstone is built around the falsification condition rather than the reverse. Executability is established by handover, not by the author's judgement.
...
1. A design surviving the executability check with no questions.
2. A design revised after five unrunnable lines were marked.

### One non-example

A design the author considers clear without handover.
...
That capstone designs are auditable for executability.

### What this activity does not establish

Whether the design produces a result.
...
| Statement | Status |
|---|---|
| The capstone is built around the falsification condition rather than the reverse. | Framework-derived, appropriate at this grade |
| That capstone designs are auditable for executability. | What this specific activity can show |
| Whether the design produces a result. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 3 — The Capstone Falsification Condition — specifically: students write the condition their capstone could trigger.

**How it was taught.** Through the activity: write the condition and demonstrate a producible result that triggers it

**Quick check.** Ask for the closing sentence of Session 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 3: write the condition and demonstrate a producible result that triggers it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A design surviving the executability check with no questions. |
| **Non-example** | A design the author considers clear without handover. |
...
> "A condition that cannot fire under your own analysis is decorative."
...
**Exact wording.** "Say: you have the condition. Now build the design that could produce it."
...
**Target observation.** That capstone designs are auditable for executability.
...
> "The capstone is built around the falsification condition rather than the reverse. You just saw that when say: you have the condition.
> Last time we said: A condition that cannot fire under your own analysis is decorative. This is the next part of that.
...
**What students must not infer.** Whether the design produces a result.

### 4. Worked example

**The example.** A design surviving the executability check with no questions.
...
**Completed answer.** A design surviving the executability check with no questions. — which demonstrates that capstone designs are auditable for executability.
...
**Conclusions not licensed.** Whether the design produces a result.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A design revised after five unrunnable lines were marked. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A design the author considers clear without handover. Why is this not an
example?"
...
**Exact student instructions.** Draft all seven sections and swap for an executability check.
...
- *Licensed conclusion.* That capstone designs are auditable for executability.
- *Not licensed.* Whether the design produces a result.
...
- *Expected response.* That capstone designs are auditable for executability.
...
1. Any wording carrying the idea in `The capstone is built around the falsification condition rather than the reverse`.
...
| | |
|---|---|
| **Follows** | Session 3 — The Capstone Falsification Condition |
| **Leads to** | Session 5 — The Inference Ladder |

**Transition in.** Session 3 established students write the condition their capstone could trigger. This session uses that as the starting point.

**Transition out.** This session establishes students build the design around the condition. Session 5 assumes it and builds students state the highest rung their design licenses.
