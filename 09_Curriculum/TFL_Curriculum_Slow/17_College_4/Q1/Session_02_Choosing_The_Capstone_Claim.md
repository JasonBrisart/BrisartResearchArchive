# Session 2 — Choosing The Capstone Claim
...
| | |
|---|---|
| **Central question** | Choosing The Capstone Claim: students select one claim narrow enough to be settled? |
| **Core concept** | A capstone targets one claim and the rival it is least separable from. |
| **Student outcome** | Students select one claim narrow enough to be settled. |
| **Previous session** | Session 1 — The Order Rule |
| **Next session** | Session 3 — The Capstone Falsification Condition |
...
**The conceptual step.** A capstone targets one claim and the rival it is least separable from. Targeting the framework as a whole produces a project that cannot conclude.
...
**What depends on it.** Session 3 — The Capstone Falsification Condition — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A capstone targets one claim and the rival it is least separable from. Targeting the framework as a whole produces a project that cannot conclude.
...
1. A persistence claim paired with the arousal account.
2. A recurrence claim paired with the habit account.

### One non-example

The framework as a whole selected as the target.
...
That capstone targets can be appropriately narrowed.
...
| Statement | Status |
|---|---|
| A capstone targets one claim and the rival it is least separable from. | Framework-derived, appropriate at this grade |
| That capstone targets can be appropriately narrowed. | What this specific activity can show |
| Whether the claim is true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 1 — The Order Rule — specifically: students place falsification before advocacy in their own work.

**How it was taught.** Through the activity: reorder three Year 3 arguments so the condition precedes the case

**Quick check.** Ask for the closing sentence of Session 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 1: reorder three Year 3 arguments so the condition precedes the case, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A persistence claim paired with the arousal account. |
| **Non-example** | The framework as a whole selected as the target. |
...
> "State what would kill it before you say why you believe it."
...
**Exact wording.** "Say: frameworks are not tested as wholes. Pick one claim and its least-separable rival."
...
**Target observation.** That capstone targets can be appropriately narrowed.
...
> "A capstone targets one claim and the rival it is least separable from. You just saw that when say: frameworks are not tested as wholes.
> Last time we said: State what would kill it before you say why you believe it. This is the next part of that.
...
**The example.** A persistence claim paired with the arousal account.
...
**Completed answer.** A persistence claim paired with the arousal account. — which demonstrates that capstone targets can be appropriately narrowed.
...
**Teacher prompt.** "Here is a second case. A recurrence claim paired with the habit account. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. The framework as a whole selected as the target. Why is this not an
example?"
...
**Exact student instructions.** Select a claim, name the rival, and justify the pairing in 300 words.
...
- *Licensed conclusion.* That capstone targets can be appropriately narrowed.
...
- *Expected response.* That capstone targets can be appropriately narrowed.
...
1. Any wording carrying the idea in `A capstone targets one claim and the rival it is least separable from`.
...
Say: "Not testing the framework. One claim and the rival it is hardest to separate from."
...
| | |
|---|---|
| **Follows** | Session 1 — The Order Rule |
| **Leads to** | Session 3 — The Capstone Falsification Condition |

**Transition in.** Session 1 established students place falsification before advocacy in their own work. This session uses that as the starting point.

**Transition out.** This session establishes students select one claim narrow enough to be settled. Session 3 assumes it and builds students write the condition their capstone could trigger.
