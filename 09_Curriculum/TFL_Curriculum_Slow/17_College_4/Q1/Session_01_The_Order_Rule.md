...
| | |
|---|---|
| **Central question** | The Order Rule: students place falsification before advocacy in their own work? |
| **Core concept** | Placing the falsification condition before the advocacy converts a position into a testable commitment. |
| **Student outcome** | Students place falsification before advocacy in their own work. |
| **Previous session** | None. First session of the year. |
| **Next session** | Session 2 — Choosing The Capstone Claim |
...
**The conceptual step.** Placing the falsification condition before the advocacy converts a position into a testable commitment. Placed last it functions as a disclaimer.
...
**What depends on it.** Session 2 — Choosing The Capstone Claim — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Placing the falsification condition before the advocacy converts a position into a testable commitment. Placed last it functions as a disclaimer.
...
1. An argument opening with its falsification condition.
2. An argument reordered after being returned unmarked.

### One non-example

An argument closing with the condition as a limitation.
...
| Statement | Status |
|---|---|
| Placing the falsification condition before the advocacy converts a position into a testable commitment. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The student adjudicates against field-specific rivals.
...
| **Correct example** | An argument opening with its falsification condition. |
| **Non-example** | An argument closing with the condition as a limitation. |
...
**Exact wording.** "Put up a strong case for the framework with no falsification condition and say it is returned unmarked."
...
> "Placing the falsification condition before the advocacy converts a position into a testable commitment. You just saw that when put up a strong case for the framework with no falsification condition and say it is returned unmarked.
...
**The example.** An argument opening with its falsification condition.
...
**Completed answer.** An argument opening with its falsification condition. — which demonstrates that argument order carries epistemic weight.
...
**Teacher prompt.** "Here is a second case. An argument reordered after being returned unmarked. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An argument closing with the condition as a limitation. Why is this not an
example?"
...
**Exact student instructions.** Reorder three Year 3 arguments so the condition precedes the case.
...
1. Any wording carrying the idea in `Placing the falsification condition before the advocacy converts a position into a testable commitment`.
...
| **Leads to** | Session 2 — Choosing The Capstone Claim |

**Transition in.** This session opens the year.

**Transition out.** This session establishes students place falsification before advocacy in their own work. Session 2 assumes it and builds students select one claim narrow enough to be settled.
