# Session 16 — Capstone Adjudication
...
| | |
|---|---|
| **Central question** | Capstone Adjudication: students state predictions for every account in their capstone? |
| **Core concept** | A capstone adjudicates only if its five predictions differ. |
| **Student outcome** | Students state predictions for every account in their capstone. |
| **Previous session** | Session 15 — Capstone Measurement |
| **Next session** | Session 17 — Capstone Confounds |
...
**The conceptual step.** A capstone adjudicates only if its five predictions differ. Coinciding rows require a redesign rather than a note.
...
**What depends on it.** Session 17 — Capstone Confounds — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A capstone adjudicates only if its five predictions differ. Coinciding rows require a redesign rather than a note.
...
1. A five-row table with all predictions distinct.
2. A coinciding row identified and the design revised.

### One non-example

The same prediction entered under two accounts.
...
That capstone adjudication is verifiable.

### What this activity does not establish

Which account the capstone would favour.
...
| Statement | Status |
|---|---|
| A capstone adjudicates only if its five predictions differ. | Framework-derived, appropriate at this grade |
| That capstone adjudication is verifiable. | What this specific activity can show |
| Which account the capstone would favour. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 15 — Capstone Measurement — specifically: students build the measurement map for their capstone.

**How it was taught.** Through the activity: build the map and have it externally run by two classmates

**Quick check.** Ask for the closing sentence of Session 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 15: build the map and have it externally run by two classmates, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A five-row table with all predictions distinct. |
| **Non-example** | The same prediction entered under two accounts. |
...
> "Executable means runnable by a stranger."
...
**Exact wording.** "Say: your claim, your rival, and the three. Five predictions, all different."
...
**Target observation.** That capstone adjudication is verifiable.
...
> "A capstone adjudicates only if its five predictions differ. You just saw that when say: your claim, your rival, and the three.
> Last time we said: Executable means runnable by a stranger. This is the next part of that.
...
**What students must not infer.** Which account the capstone would favour.

### 4. Worked example

**The example.** A five-row table with all predictions distinct.
...
**Completed answer.** A five-row table with all predictions distinct. — which demonstrates that capstone adjudication is verifiable.
...
**Conclusions not licensed.** Which account the capstone would favour.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A coinciding row identified and the design revised. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. The same prediction entered under two accounts. Why is this not an
example?"
...
**Exact student instructions.** Complete the five-row prediction table with all rows distinct.
...
- *Licensed conclusion.* That capstone adjudication is verifiable.
- *Not licensed.* Which account the capstone would favour.
...
- *Expected response.* That capstone adjudication is verifiable.
...
1. Any wording carrying the idea in `A capstone adjudicates only if its five predictions differ`.
...
Say: "Identical predictions mean the capstone does not adjudicate."
...
| | |
|---|---|
| **Follows** | Session 15 — Capstone Measurement |
| **Leads to** | Session 17 — Capstone Confounds |

**Transition in.** Session 15 established students build the measurement map for their capstone. This session uses that as the starting point.

**Transition out.** This session establishes students state predictions for every account in their capstone. Session 17 assumes it and builds students complete the confound table for the capstone.
