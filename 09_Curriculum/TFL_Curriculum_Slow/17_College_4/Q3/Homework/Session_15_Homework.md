# Session 15 Homework — Capstone Measurement

**College Year 4** · Independent Critique and Capstone · **Quarter 3**
**Follows:** Session 15 — Capstone Measurement · **Points:** 5 · **Optional:** yes
...
Build the map and have it externally run by two classmates.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** at least one external run returns zero questions
...
Session 16 is **Capstone Adjudication**, which assumes you arrive holding it. Write one thing you expect it to be about:
