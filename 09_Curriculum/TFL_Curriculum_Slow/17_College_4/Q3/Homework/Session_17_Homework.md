# Session 17 Homework — Capstone Confounds

**College Year 4** · Independent Critique and Capstone · **Quarter 3**
**Follows:** Session 17 — Capstone Confounds · **Points:** 5 · **Optional:** yes
...
Complete the table and have it adversarially audited.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every row has a control and an acknowledged residual risk
...
Session 18 is **Capstone Scope Rejection**, which assumes you arrive holding it. Write one thing you expect it to be about:
