# Session 19 Homework — Assembling The Capstone

**College Year 4** · Independent Critique and Capstone · **Quarter 3**
**Follows:** Session 19 — Assembling The Capstone · **Points:** 5 · **Optional:** yes
...
Assemble and swap for a peer gate check.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student passes a peer gate check on both items
...
Session 20 is **The Mock Defence**, which assumes you arrive holding it. Write one thing you expect it to be about:
