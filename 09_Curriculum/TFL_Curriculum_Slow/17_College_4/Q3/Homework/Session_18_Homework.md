# Session 18 Homework — Capstone Scope Rejection

**College Year 4** · Independent Critique and Capstone · **Quarter 3**
**Follows:** Session 18 — Capstone Scope Rejection · **Points:** 5 · **Optional:** yes
...
Write a formal rejection of an invalid variant, including why it was tempting.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names why the invalid version appealed
...
Session 19 is **Assembling The Capstone**, which assumes you arrive holding it. Write one thing you expect it to be about:
