# Session 16 Homework — Capstone Adjudication

**College Year 4** · Independent Critique and Capstone · **Quarter 3**
**Follows:** Session 16 — Capstone Adjudication · **Points:** 5 · **Optional:** yes
...
Complete the five-row prediction table with all rows distinct.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** all five prediction rows differ
...
Session 17 is **Capstone Confounds**, which assumes you arrive holding it. Write one thing you expect it to be about:
