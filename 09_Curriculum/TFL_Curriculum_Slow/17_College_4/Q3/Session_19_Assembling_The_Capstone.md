# Session 19 — Assembling The Capstone
...
| | |
|---|---|
| **Central question** | Assembling The Capstone: students produce the complete capstone package? |
| **Core concept** | The capstone has eight parts, two of which are gates checked before anything else. |
| **Student outcome** | Students produce the complete capstone package. |
| **Previous session** | Session 18 — Capstone Scope Rejection |
...
**The conceptual step.** The capstone has eight parts, two of which are gates checked before anything else. A peer gate check before submission is the safeguard.
...
The capstone has eight parts, two of which are gates checked before anything else. A peer gate check before submission is the safeguard.
...
1. A capstone passing a peer gate check on both gates.
2. A capstone revised after a peer gate check failed.

### One non-example

A capstone submitted with one gate incomplete.
...
Whether the capstone is complete.
...
| Statement | Status |
|---|---|
| The capstone has eight parts, two of which are gates checked before anything else. | Framework-derived, appropriate at this grade |
| Whether the capstone is complete. | What this specific activity can show |
| Whether it would succeed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 18 — Capstone Scope Rejection — specifically: students reject an invalid variant of their own capstone.

**How it was taught.** Through the activity: write a formal rejection of an invalid variant, including why it was tempting

**Quick check.** Ask for the closing sentence of Session 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 18: write a formal rejection of an invalid variant, including why it was tempting, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A capstone passing a peer gate check on both gates. |
| **Non-example** | A capstone submitted with one gate incomplete. |
...
> "Students who cannot say why will build it again."
...
**Exact wording.** "Say: eight parts, two of which are gates."
...
**Target observation.** Whether the capstone is complete.
...
> "The capstone has eight parts, two of which are gates checked before anything else. You just saw that when say: eight parts, two of which are gates.
> Last time we said: Students who cannot say why will build it again. This is the next part of that.
...
**What students must not infer.** Whether it would succeed.

### 4. Worked example

**The example.** A capstone passing a peer gate check on both gates.
...
**Completed answer.** A capstone passing a peer gate check on both gates. — which demonstrates whether the capstone is complete.
...
**Conclusions not licensed.** Whether it would succeed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A capstone revised after a peer gate check failed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A capstone submitted with one gate incomplete. Why is this not an
example?"
...
**Exact student instructions.** Assemble and swap for a peer gate check.
...
- *Licensed conclusion.* Whether the capstone is complete.
- *Not licensed.* Whether it would succeed.
...
- *Expected response.* Whether the capstone is complete.
...
1. Any wording carrying the idea in `The capstone has eight parts, two of which are gates checked before anything else`.
...
| | |
|---|---|
| **Follows** | Session 18 — Capstone Scope Rejection |
| **Leads to** | Session 20 — The Mock Defence |

**Transition in.** Session 18 established students reject an invalid variant of their own capstone. This session uses that as the starting point.

**Transition out.** This session establishes students produce the complete capstone package. Session 20 assumes it and builds students rehearse against four adversarial roles.
