...
| **Previous session** | Session 19 — Assembling The Capstone |
...
**The conceptual step.** A mock defence produces a list of unanswered questions. Restating the design rather than answering wastes the rehearsal.
...
A mock defence produces a list of unanswered questions. Restating the design rather than answering wastes the rehearsal.
...
1. A defence answering the inference challenger directly.
...
**Prerequisite.** The content of Session 19 — Assembling The Capstone — specifically: students produce the complete capstone package.

**How it was taught.** Through the activity: assemble and swap for a peer gate check

**Quick check.** Ask for the closing sentence of Session 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 19: assemble and swap for a peer gate check, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence answering the inference challenger directly. |
...
**Exact wording.** "Assign four challengers: rival, measurement, inference, scope."
...
> "A mock defence produces a list of unanswered questions. You just saw that when assign four challengers: rival, measurement, inference, scope.
...
**The example.** A defence answering the inference challenger directly.
...
**Completed answer.** A defence answering the inference challenger directly. — which demonstrates that unanswered questions can be identified in rehearsal.
...
**Exact student instructions.** Present for eight minutes, defend for eight, record unanswered questions.
...
| | |
|---|---|
| **Follows** | Session 19 — Assembling The Capstone |
| **Leads to** | Session 21 — Revising After The Mock |

**Transition in.** Session 19 established students produce the complete capstone package. This session uses that as the starting point.

**Transition out.** This session establishes students rehearse against four adversarial roles. Session 21 assumes it and builds students revise the capstone against mock feedback.
