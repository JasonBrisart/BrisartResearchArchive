# Module 3 — Supervising Students On Unvalidated Work
...
| | |
|---|---|
| **Central question** | Supervising Students On Unvalidated Work: participants build a supervision plan protecting the student? |
| **Core concept** | A supervision plan protects the student from the framework's outcome. |
| **Student outcome** | Participants build a supervision plan protecting the student. |
| **Previous module** | Module 2 — Testing The Disclosure |
| **Next module** | Module 4 — Scope Enforcement As Procedure |
| **Materials** | Institutional standards documentation; licensing terms |
| **Preparation** | ninety minutes |
| **Student printout** | `Printouts/Module_03_Printout.md` |
| **Homework** | `Homework/Module_03_Homework.md` |

## Why this lesson exists

**The conceptual step.** A supervision plan protects the student from the framework's outcome. The exit path must preserve accumulated work rather than discarding it if the student redirects.
...
**What depends on it.** Module 4 — Scope Enforcement As Procedure — opens by assuming this module's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A supervision plan protects the student from the framework's outcome. The exit path must preserve accumulated work rather than discarding it if the student redirects.
...
1. An exit path preserving measurement competences and data.
2. Verbatim informed-entry wording stated in the plan.

### One non-example

An exit path requiring the student to restart from nothing.
...
That supervision plans can protect against outcome risk.

### What this activity does not establish

Whether the framework survives.
...
| Statement | Status |
|---|---|
| A supervision plan protects the student from the framework's outcome. | Framework-derived, appropriate at this grade |
| That supervision plans can protect against outcome risk. | What this specific activity can show |
| Whether the framework survives. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Module 2 — Testing The Disclosure — specifically: participants test the protocol by blind delivery.

**How it was taught.** Through the activity: blind delivery test with every failure point recorded

**Quick check.** Ask for the closing sentence of Module 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Module 2: blind delivery test with every failure point recorded, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An exit path preserving measurement competences and data. |
| **Non-example** | An exit path requiring the student to restart from nothing. |
...
**Student materials.** One copy of `Printouts/Module_03_Printout.md` per student.

**Prior student data required.** Work produced in Module 2, kept in the student's folder.
...
**File.** `Printouts/Module_03_Printout.md`
...
> "The failures you just heard are the protocol's grade."
...
**Exact wording.** "Say: you have a position that survives this being wrong. A doctoral student may not."
...
**Target observation.** That supervision plans can protect against outcome risk.
...
> "A supervision plan protects the student from the framework's outcome. You just saw that when say: you have a position that survives this being wrong.
> Last time we said: The failures you just heard are the protocol's grade. This is the next part of that.
...
**What students must not infer.** Whether the framework survives.

### 4. Worked example

**The example.** An exit path preserving measurement competences and data.
...
**Completed answer.** An exit path preserving measurement competences and data. — which demonstrates that supervision plans can protect against outcome risk.
...
**Conclusions not licensed.** Whether the framework survives.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Verbatim informed-entry wording stated in the plan. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An exit path requiring the student to restart from nothing. Why is this not an
example?"
...
**Exact student instructions.** Draft the plan with verbatim informed-entry wording and an exit decision point.
...
- *Licensed conclusion.* That supervision plans can protect against outcome risk.
- *Not licensed.* Whether the framework survives.
...
- *Expected response.* That supervision plans can protect against outcome risk.
...
1. Any wording carrying the idea in `A supervision plan protects the student from the framework's outcome`.
...
Say: "Hedged design does the most protective work."

**Why this sentence matters.** It is the opening question of Module 4, which assumes students arrive holding it.
...
**File.** `Homework/Module_03_Homework.md`
...
| | |
|---|---|
| **Follows** | Module 2 — Testing The Disclosure |
| **Leads to** | Module 4 — Scope Enforcement As Procedure |

**Transition in.** Module 2 established participants test the protocol by blind delivery. This module uses that as the starting point.

**Transition out.** This module establishes participants build a supervision plan protecting the student. Module 4 assumes it and builds participants produce a three-tier enforcement procedure.
