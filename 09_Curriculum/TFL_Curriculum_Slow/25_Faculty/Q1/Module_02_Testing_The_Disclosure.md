# Module 2 — Testing The Disclosure

**Faculty** · Institutional Stewardship · **Quarter 1** · **3-4 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Testing The Disclosure: participants test the protocol by blind delivery? |
| **Core concept** | A disclosure protocol is graded by blind delivery. |
| **Student outcome** | Participants test the protocol by blind delivery. |
| **Previous module** | Module 1 — Institutional Position And Disclosure |
| **Next module** | Module 3 — Supervising Students On Unvalidated Work |
| **Materials** | Institutional standards documentation; licensing terms |
| **Preparation** | ninety minutes |
| **Student printout** | `Printouts/Module_02_Printout.md` |
| **Homework** | `Homework/Module_02_Homework.md` |

## Why this lesson exists

**The conceptual step.** A disclosure protocol is graded by blind delivery. Every point where the deliverer hesitated or improvised is a defect in the protocol rather than in the deliverer.
...
**What depends on it.** Module 3 — Supervising Students On Unvalidated Work — opens by assuming this module's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A disclosure protocol is graded by blind delivery. Every point where the deliverer hesitated or improvised is a defect in the protocol rather than in the deliverer.
...
1. A protocol delivered verbatim with three hesitation points recorded.
2. A protocol revised after the blind delivery failed twice.

### One non-example

A protocol delivered with the author prompting from the side.
...
That protocols are graded by blind performance.

### What this activity does not establish

Whether the protocol is otherwise good.
...
| Statement | Status |
|---|---|
| A disclosure protocol is graded by blind delivery. | Framework-derived, appropriate at this grade |
| That protocols are graded by blind performance. | What this specific activity can show |
| Whether the protocol is otherwise good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Module 1 — Institutional Position And Disclosure — specifically: participants produce an executable disclosure protocol.

**How it was taught.** Through the activity: draft the protocol with verbatim wording, contexts, responsibility, and review interval

**Quick check.** Ask for the closing sentence of Module 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Module 1: draft the protocol with verbatim wording, contexts, responsibility, and review interval, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A protocol delivered verbatim with three hesitation points recorded. |
| **Non-example** | A protocol delivered with the author prompting from the side. |
...
**Student materials.** One copy of `Printouts/Module_02_Printout.md` per student.

**Prior student data required.** Work produced in Module 1, kept in the student's folder.
...
**File.** `Printouts/Module_02_Printout.md`
...
> "A protocol that says disclose appropriately has not been written."
...
**Exact wording.** "Say: a colleague delivers yours, verbatim, without asking you anything."
...
**Target observation.** That protocols are graded by blind performance.
...
> "A disclosure protocol is graded by blind delivery. You just saw that when say: a colleague delivers yours, verbatim, without asking you anything.
> Last time we said: A protocol that says disclose appropriately has not been written. This is the next part of that.
...
**What students must not infer.** Whether the protocol is otherwise good.

### 4. Worked example

**The example.** A protocol delivered verbatim with three hesitation points recorded.
...
**Completed answer.** A protocol delivered verbatim with three hesitation points recorded. — which demonstrates that protocols are graded by blind performance.
...
**Conclusions not licensed.** Whether the protocol is otherwise good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A protocol revised after the blind delivery failed twice. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A protocol delivered with the author prompting from the side. Why is this not an
example?"
...
**Exact student instructions.** Blind delivery test with every failure point recorded.
...
- *Licensed conclusion.* That protocols are graded by blind performance.
- *Not licensed.* Whether the protocol is otherwise good.
...
- *Expected response.* That protocols are graded by blind performance.
...
1. Any wording carrying the idea in `A disclosure protocol is graded by blind delivery`.
...
Say: "The failures you just heard are the protocol's grade."

**Why this sentence matters.** It is the opening question of Module 3, which assumes students arrive holding it.
...
**File.** `Homework/Module_02_Homework.md`
...
| | |
|---|---|
| **Follows** | Module 1 — Institutional Position And Disclosure |
| **Leads to** | Module 3 — Supervising Students On Unvalidated Work |

**Transition in.** Module 1 established participants produce an executable disclosure protocol. This module uses that as the starting point.

**Transition out.** This module establishes participants test the protocol by blind delivery. Module 3 assumes it and builds participants build a supervision plan protecting the student.
