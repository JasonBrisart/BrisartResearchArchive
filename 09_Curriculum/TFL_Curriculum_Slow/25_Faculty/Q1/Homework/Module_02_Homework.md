# Module 2 Homework — Testing The Disclosure

**Faculty** · Institutional Stewardship · **Quarter 1**
**Follows:** Module 2 — Testing The Disclosure · **Points:** 5 · **Optional:** yes
...
Write the sentence Module 2 ended on, from memory:
...
Blind delivery test with every failure point recorded.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every protocol is delivered by somebody who did not write it
...
Module 3 is **Supervising Students On Unvalidated Work**, which assumes you arrive holding it. Write one thing you expect it to be about:
