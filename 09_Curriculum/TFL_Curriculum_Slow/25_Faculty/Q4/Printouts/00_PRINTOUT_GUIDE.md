...
**Faculty** · Institutional Stewardship

Every module in this quarter has one matching student printout. Distribute
it **before the hook** so students can record their initial thinking before any
explanation is given.

## What is here

| Printout | Matching module | Pages | Distribute | Student action | After | Prior data |
|---|---|---|---|---|---|---|
| `Module_10_Printout.md` | Module 10 — Assembling The Portfolio | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Module_11_Printout.md` | Module 11 — Blind Execution | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | Module 10 work |
| `Module_12_Printout.md` | Module 12 — Portfolio Review | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | Module 11 work |

## When to distribute

Always before the hook. The *What I think before the module* section is only
...
| What I think before the module | Before any explanation |
...
## The pivot module of this quarter

**Module 11 — Blind Execution.** If you only have time to print one
