# Module 11 Homework — Blind Execution

**Faculty** · Institutional Stewardship · **Quarter 4**
**Follows:** Module 11 — Blind Execution · **Points:** 5 · **Optional:** yes
...
Write the sentence Module 11 ended on, from memory:
...
Four artifacts performed blind, with every failure reported back.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** both gates are passed by blind execution
...
Module 12 is **Portfolio Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
