# Module 10 — Assembling The Portfolio

**Faculty** · Institutional Stewardship · **Quarter 4** · **3-4 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Assembling The Portfolio: participants assemble all stewardship artifacts? |
| **Core concept** | Institutional capacity means artifacts that work without their author. |
| **Student outcome** | Participants assemble all stewardship artifacts. |
| **Previous module** | Module 9 — Licensing And Derivative Work |
| **Next module** | Module 11 — Blind Execution |
| **Materials** | Institutional standards documentation; licensing terms |
| **Preparation** | ninety minutes |
| **Student printout** | `Printouts/Module_10_Printout.md` |
| **Homework** | `Homework/Module_10_Homework.md` |

## Why this lesson exists

**The conceptual step.** Institutional capacity means artifacts that work without their author. A portfolio requiring the author's presence is that person rather than an institution.
...
**What depends on it.** Module 11 — Blind Execution — opens by assuming this module's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Institutional capacity means artifacts that work without their author. A portfolio requiring the author's presence is that person rather than an institution.
...
1. A portfolio with all seven artifacts present.
2. An artifact self-audited against the executability gate.

### One non-example

An artifact requiring the author to interpret it.
...
That institutional capacity is artifact-based.

### What this activity does not establish

Whether the artifacts are optimal.
...
| Statement | Status |
|---|---|
| Institutional capacity means artifacts that work without their author. | Framework-derived, appropriate at this grade |
| That institutional capacity is artifact-based. | What this specific activity can show |
| Whether the artifacts are optimal. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Module 9 — Licensing And Derivative Work — specifically: participants produce a compliance checklist.

**How it was taught.** Through the activity: complete the checklist including collaborator status and renewal responsibility by role

**Quick check.** Ask for the closing sentence of Module 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Module 9: complete the checklist including collaborator status and renewal responsibility by role, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A portfolio with all seven artifacts present. |
| **Non-example** | An artifact requiring the author to interpret it. |
...
**Student materials.** One copy of `Printouts/Module_10_Printout.md` per student.

**Prior student data required.** Work produced in Module 9, kept in the student's folder.
...
**File.** `Printouts/Module_10_Printout.md`
...
> "Rights that end on lapse are a continuity risk for any multi-year programme."
...
**Exact wording.** "Say: seven artifacts. Every one executable by somebody who did not write it."
...
**Target observation.** That institutional capacity is artifact-based.
...
> "Institutional capacity means artifacts that work without their author. You just saw that when say: seven artifacts.
> Last time we said: Rights that end on lapse are a continuity risk for any multi-year programme. This is the next part of that.
...
**What students must not infer.** Whether the artifacts are optimal.

### 4. Worked example

**The example.** A portfolio with all seven artifacts present.
...
**Completed answer.** A portfolio with all seven artifacts present. — which demonstrates that institutional capacity is artifact-based.
...
**Conclusions not licensed.** Whether the artifacts are optimal.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An artifact self-audited against the executability gate. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An artifact requiring the author to interpret it. Why is this not an
example?"
...
**Exact student instructions.** Assemble the portfolio and self-audit against the executability gate.
...
- *Licensed conclusion.* That institutional capacity is artifact-based.
- *Not licensed.* Whether the artifacts are optimal.
...
- *Expected response.* That institutional capacity is artifact-based.
...
1. Any wording carrying the idea in `Institutional capacity means artifacts that work without their author`.
...
Say: "Institutional capacity that depends on one person's judgment is just that person."

**Why this sentence matters.** It is the opening question of Module 11, which assumes students arrive holding it.
...
**File.** `Homework/Module_10_Homework.md`
...
| | |
|---|---|
| **Follows** | Module 9 — Licensing And Derivative Work |
| **Leads to** | Module 11 — Blind Execution |

**Transition in.** Module 9 established participants produce a compliance checklist. This module uses that as the starting point.

**Transition out.** This module establishes participants assemble all stewardship artifacts. Module 11 assumes it and builds participants test every artifact by having somebody else perform it.
