# Module 8 — Programmes At Institutional Scale
...
| | |
|---|---|
| **Central question** | Programmes At Institutional Scale: participants produce a programme memo with institutional consequences? |
| **Core concept** | At institutional scale the five programme failure modes bind people who did not choose the programme. |
| **Student outcome** | Participants produce a programme memo with institutional consequences. |
| **Previous module** | Module 7 — Building A Review Process |
| **Next module** | Module 9 — Licensing And Derivative Work |
| **Materials** | Institutional standards documentation; licensing terms |
| **Preparation** | ninety minutes |
| **Student printout** | `Printouts/Module_08_Printout.md` |
| **Homework** | `Homework/Module_08_Homework.md` |

## Why this lesson exists

**The conceptual step.** At institutional scale the five programme failure modes bind people who did not choose the programme. Stop conditions naming observations are what make continuation a decision.
...
**What depends on it.** Module 9 — Licensing And Derivative Work — opens by assuming this module's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

At institutional scale the five programme failure modes bind people who did not choose the programme. Stop conditions naming observations are what make continuation a decision.
...
1. A stop condition naming a specific adjudication outcome.
2. A memo recommending against institutional commitment.

### One non-example

A stop condition naming loss of departmental funding.
...
That institutional programmes require stated endings.

### What this activity does not establish

Whether the programme is warranted.
...
| Statement | Status |
|---|---|
| At institutional scale the five programme failure modes bind people who did not choose the programme. | Framework-derived, appropriate at this grade |
| That institutional programmes require stated endings. | What this specific activity can show |
| Whether the programme is warranted. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Module 7 — Building A Review Process — specifically: participants produce a review protocol and reviewer brief.

**How it was taught.** Through the activity: write both documents and blind-test them on a specimen

**Quick check.** Ask for the closing sentence of Module 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Module 7: write both documents and blind-test them on a specimen, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A stop condition naming a specific adjudication outcome. |
| **Non-example** | A stop condition naming loss of departmental funding. |
...
**Student materials.** One copy of `Printouts/Module_08_Printout.md` per student.

**Prior student data required.** Work produced in Module 7, kept in the student's folder.
...
**File.** `Printouts/Module_08_Printout.md`
...
> "The brief matters more than the structure."
...
**Exact wording.** "Present the five failure modes at institutional rather than personal scale."
...
**Target observation.** That institutional programmes require stated endings.
...
> "At institutional scale the five programme failure modes bind people who did not choose the programme. You just saw that when present the five failure modes at institutional rather than personal scale.
> Last time we said: The brief matters more than the structure. This is the next part of that.
...
**What students must not infer.** Whether the programme is warranted.

### 4. Worked example

**The example.** A stop condition naming a specific adjudication outcome.
...
**Completed answer.** A stop condition naming a specific adjudication outcome. — which demonstrates that institutional programmes require stated endings.
...
**Conclusions not licensed.** Whether the programme is warranted.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A memo recommending against institutional commitment. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A stop condition naming loss of departmental funding. Why is this not an
example?"
...
**Exact student instructions.** Write the memo with stop conditions naming observations.
...
- *Licensed conclusion.* That institutional programmes require stated endings.
- *Not licensed.* Whether the programme is warranted.
...
- *Expected response.* That institutional programmes require stated endings.
...
1. Any wording carrying the idea in `At institutional scale the five programme failure modes bind people who did not choose the programme`.
...
Say: "A memo recommending against a programme is a passing artifact."

**Why this sentence matters.** It is the opening question of Module 9, which assumes students arrive holding it.
...
**File.** `Homework/Module_08_Homework.md`
...
| | |
|---|---|
| **Follows** | Module 7 — Building A Review Process |
| **Leads to** | Module 9 — Licensing And Derivative Work |

**Transition in.** Module 7 established participants produce a review protocol and reviewer brief. This module uses that as the starting point.

**Transition out.** This module establishes participants produce a programme memo with institutional consequences. Module 9 assumes it and builds participants produce a compliance checklist.
