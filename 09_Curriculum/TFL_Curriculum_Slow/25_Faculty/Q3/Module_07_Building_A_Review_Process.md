# Module 7 — Building A Review Process

**Faculty** · Institutional Stewardship · **Quarter 3** · **3-4 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Building A Review Process: participants produce a review protocol and reviewer brief? |
| **Core concept** | A review process for work on an unvalidated framework requires a reviewer brief addressing both failure directions and a conflict declaration, since qualified reviewers are often connected to the work. |
| **Student outcome** | Participants produce a review protocol and reviewer brief. |
| **Previous module** | Module 6 — Designing The Course |
| **Next module** | Module 8 — Programmes At Institutional Scale |
| **Materials** | Institutional standards documentation; licensing terms |
| **Preparation** | ninety minutes |
| **Student printout** | `Printouts/Module_07_Printout.md` |
| **Homework** | `Homework/Module_07_Homework.md` |

## Why this lesson exists

**The conceptual step.** A review process for work on an unvalidated framework requires a reviewer brief addressing both failure directions and a conflict declaration, since qualified reviewers are often connected to the work.

**Why students need it now.** This grade owns one idea: artifacts that work when you are not in the room, tested by blind execution.
This module supplies one component of it. Without this component the student can
...
that underclaiming is the safe direction. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Every artifact must be executable by a colleague who did not write it. This is tested by blind execution, not by reading.

**What depends on it.** Module 8 — Programmes At Institutional Scale — opens by assuming this module's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A review process for work on an unvalidated framework requires a reviewer brief addressing both failure directions and a conflict declaration, since qualified reviewers are often connected to the work.

### How this is stated at this grade

Every artifact must be executable by a colleague who did not write it. This is tested by blind execution, not by reading.

Use only the vocabulary released at or before this grade. Terms not yet available:
Version authority, replication consortia, registries, retirement policy.

### Why the concept matters

The whole grade rests on artifacts that work when you are not in the room, tested by blind execution. If a student leaves this
module without the component taught here, the remaining modules in the quarter
will feel arbitrary, because each one assumes it.

### Two concrete examples

1. A brief instructing reviewers to review the inference, not the framework.
2. A conflict declaration addressing the small qualified pool.

### One non-example

A protocol with no conflict declaration section.
...
That review processes require briefs and conflict handling.

### What this activity does not establish

Whether the process produces good reviews.
...
| Statement | Status |
|---|---|
| A review process for work on an unvalidated framework requires a reviewer brief addressing both failure directions and a conflict declaration, since qualified reviewers are often connected to the work. | Framework-derived, appropriate at this grade |
| That review processes require briefs and conflict handling. | What this specific activity can show |
| Whether the process produces good reviews. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Module 6 — Designing The Course — specifically: participants produce a defensible syllabus.

**How it was taught.** Through the activity: draft the syllabus and present to a partner playing curriculum committee

**Quick check.** Ask for the closing sentence of Module 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Module 6: draft the syllabus and present to a partner playing curriculum committee, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | where and how status is stated, and by whom. |
| **Student wording** | Where and how status is stated, and by whom. |
| **Correct example** | A brief instructing reviewers to review the inference, not the framework. |
| **Non-example** | A protocol with no conflict declaration section. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for where and how status is stated, and by whom." |

### hedged supervision

| | |
|---|---|
| **Teacher definition** | structuring a student's work to survive refutation. |
| **Student wording** | Structuring a student's work to survive refutation. |
| **Correct example** | A brief instructing reviewers to review the inference, not the framework. |
| **Non-example** | A protocol with no conflict declaration section. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for structuring a student's work to survive refutation." |

### tiered enforcement

| | |
|---|---|
| **Teacher definition** | structural prevention, interception, correction. |
| **Student wording** | Structural prevention, interception, correction. |
| **Correct example** | A brief instructing reviewers to review the inference, not the framework. |
| **Non-example** | A protocol with no conflict declaration section. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for structural prevention, interception, correction." |


Do not introduce terminology from later grades. Version authority, replication consortia, registries, retirement policy.

## Materials and preparation

**Teacher materials.** Institutional standards documentation; Licensing terms; Artifact templates; Specimen proposals.

**Student materials.** One copy of `Printouts/Module_07_Printout.md` per student.

**Prior student data required.** Work produced in Module 6, kept in the student's folder.
...
**File.** `Printouts/Module_07_Printout.md`

**Distribute.** Before the hook. Students complete the *What I think before the
module* section before any explanation is given.
...
> "The mid-term refutation question is the one nobody prepares for."
...
**Decision rule.** If fewer than half the group can produce any version of it, spend five minutes on the recovery activity below before starting this module.

### 2. Hook

**Exact wording.** "Say: your protocol must prevent both failures in reviewers you did not train."
...
**Target observation.** That review processes require briefs and conflict handling.
...
> "A review process for work on an unvalidated framework requires a reviewer brief addressing both failure directions and a conflict declaration, since qualified reviewers are often connected to the work. You just saw that when say: your protocol must prevent both failures in reviewers you did not train.
> Last time we said: The mid-term refutation question is the one nobody prepares for. This is the next part of that.
> It matters because a student who overclaims made an error. A supervisor who permitted it made a larger one"
...
**Terminology to introduce here.** disclosure protocol, hedged supervision, tiered enforcement.

**What students must not infer.** Whether the process produces good reviews.

### 4. Worked example

**The example.** A brief instructing reviewers to review the inference, not the framework.
...
**Completed answer.** A brief instructing reviewers to review the inference, not the framework. — which demonstrates that review processes require briefs and conflict handling.
...
**Conclusions not licensed.** Whether the process produces good reviews.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A conflict declaration addressing the small qualified pool. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A protocol with no conflict declaration section. Why is this not an
example?"
...
**Exact student instructions.** Write both documents and blind-test them on a specimen.
...
- *Licensed conclusion.* That review processes require briefs and conflict handling.
- *Not licensed.* Whether the process produces good reviews.
...
- *Expected response.* That review processes require briefs and conflict handling.
...
**Decision rule.** Continue to the next module only if most students pass oral
...
3. **Misconception check.** Somebody says: "Underclaiming is the safe direction" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `A review process for work on an unvalidated framework requires a reviewer brief addressing both failure directions and a conflict declaration, since qualified reviewers are often connected to the work`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: This is the direction this room will get wrong.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "The brief matters more than the structure."

**Why this sentence matters.** It is the opening question of Module 8, which assumes students arrive holding it.

**Open the next module with.** "What did we say at the end last time?"
...
### 1. "Underclaiming is the safe direction"

**What the student says or does.** Underclaiming is the safe direction — usually while otherwise engaging well.

**Why it is understandable.** Academic hedging defaults to dismissal.
...
**Exact correction.** Calling it a private model is as inaccurate as calling it established.

**Say this.** "This is the direction this room will get wrong."
...
### 2. "Explaining the clinical boundary is enough"

**What the student says or does.** Explaining the clinical boundary is enough — usually while otherwise engaging well.

**Why it is understandable.** It works in the room, so it feels sufficient.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Explaining does not scale and softens under pressure.

**Say this.** "You will hear it proposed again next week. Write the procedure."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "Learning outcomes should state framework knowledge"

**What the student says or does.** Learning outcomes should state framework knowledge — usually while otherwise engaging well.

**Why it is understandable.** The course is about the framework.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Phrase outcomes as competences that survive refutation.

**Say this.** "Then it is a methods course using a live example."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 4. "This module proves the framework is right"
...
**Visual or physical support.** Provide each template with one section fully worked, and pair every test.
...
Ask them to run blind execution on a colleague outside the cohort.
...
Specifically, do not introduce: Version authority, replication consortia, registries, retirement policy.
...
- Whether the participant endorses the framework

## Gate reminder

This grade is gated. The final examination does not pass unless both gate items
are satisfied, regardless of total score:

- **Gate A** — a falsification condition naming an observation that could occur.
- **Gate B** — a correctly identified invalid application with its boundary named.

Both were announced in the first session and are never applied retroactively.
Mention them whenever the content of this module touches either.

## Homework connection

**File.** `Homework/Module_07_Homework.md`
...
**How to set it.** Optional. Set it if this is the pivot module of the quarter,
...
7. What must be retaught before the next module?
8. Is the next module still appropriate, or does it need a bridging activity?

## Sequence

| | |
|---|---|
| **Follows** | Module 6 — Designing The Course |
| **Leads to** | Module 8 — Programmes At Institutional Scale |

**Transition in.** Module 6 established participants produce a defensible syllabus. This module uses that as the starting point.

**Transition out.** This module establishes participants produce a review protocol and reviewer brief. Module 8 assumes it and builds participants produce a programme memo with institutional consequences.
