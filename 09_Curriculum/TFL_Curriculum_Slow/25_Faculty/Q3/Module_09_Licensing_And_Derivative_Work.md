# Module 9 — Licensing And Derivative Work
...
| | |
|---|---|
| **Central question** | Licensing And Derivative Work: participants produce a compliance checklist? |
| **Core concept** | Rights that lapse create continuity risk for multi-year programmes. |
| **Student outcome** | Participants produce a compliance checklist. |
| **Previous module** | Module 8 — Programmes At Institutional Scale |
| **Next module** | Module 10 — Assembling The Portfolio |
| **Materials** | Institutional standards documentation; licensing terms |
| **Preparation** | ninety minutes |
| **Student printout** | `Printouts/Module_09_Printout.md` |
| **Homework** | `Homework/Module_09_Homework.md` |

## Why this lesson exists

**The conceptual step.** Rights that lapse create continuity risk for multi-year programmes. The checklist must name a renewal responsibility by role rather than by individual.
...
**What depends on it.** Module 10 — Assembling The Portfolio — opens by assuming this module's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Rights that lapse create continuity risk for multi-year programmes. The checklist must name a renewal responsibility by role rather than by individual.
...
1. A checklist naming the role responsible for renewal.
2. A checklist distinguishing reading rights from derivative work rights.

### One non-example

An assumption that reading rights cover a validation study.
...
That rights management is a continuity requirement.
...
| Statement | Status |
|---|---|
| Rights that lapse create continuity risk for multi-year programmes. | Framework-derived, appropriate at this grade |
| That rights management is a continuity requirement. | What this specific activity can show |
| Whether the terms are reasonable. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Module 8 — Programmes At Institutional Scale — specifically: participants produce a programme memo with institutional consequences.

**How it was taught.** Through the activity: write the memo with stop conditions naming observations

**Quick check.** Ask for the closing sentence of Module 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Module 8: write the memo with stop conditions naming observations, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A checklist naming the role responsible for renewal. |
| **Non-example** | An assumption that reading rights cover a validation study. |
...
**Student materials.** One copy of `Printouts/Module_09_Printout.md` per student.

**Prior student data required.** Work produced in Module 8, kept in the student's folder.
...
**File.** `Printouts/Module_09_Printout.md`
...
> "A memo recommending against a programme is a passing artifact."
...
**Exact wording.** "Say: most of you have reasoned about this for weeks without checking what you may do with it."
...
**Target observation.** That rights management is a continuity requirement.
...
> "Rights that lapse create continuity risk for multi-year programmes. You just saw that when say: most of you have reasoned about this for weeks without checking what you may do with it.
> Last time we said: A memo recommending against a programme is a passing artifact. This is the next part of that.
...
**What students must not infer.** Whether the terms are reasonable.

### 4. Worked example

**The example.** A checklist naming the role responsible for renewal.
...
**Completed answer.** A checklist naming the role responsible for renewal. — which demonstrates that rights management is a continuity requirement.
...
**Conclusions not licensed.** Whether the terms are reasonable.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A checklist distinguishing reading rights from derivative work rights. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An assumption that reading rights cover a validation study. Why is this not an
example?"
...
**Exact student instructions.** Complete the checklist including collaborator status and renewal responsibility by role.
...
- *Licensed conclusion.* That rights management is a continuity requirement.
- *Not licensed.* Whether the terms are reasonable.
...
- *Expected response.* That rights management is a continuity requirement.
...
1. Any wording carrying the idea in `Rights that lapse create continuity risk for multi-year programmes`.
...
Say: "Rights that end on lapse are a continuity risk for any multi-year programme."

**Why this sentence matters.** It is the opening question of Module 10, which assumes students arrive holding it.
...
**File.** `Homework/Module_09_Homework.md`
...
| | |
|---|---|
| **Follows** | Module 8 — Programmes At Institutional Scale |
| **Leads to** | Module 10 — Assembling The Portfolio |

**Transition in.** Module 8 established participants produce a programme memo with institutional consequences. This module uses that as the starting point.

**Transition out.** This module establishes participants produce a compliance checklist. Module 10 assumes it and builds participants assemble all stewardship artifacts.
