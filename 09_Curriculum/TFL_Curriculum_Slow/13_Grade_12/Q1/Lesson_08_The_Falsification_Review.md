# Lesson 8 — The Falsification Review
...
| | |
|---|---|
| **Central question** | The Falsification Review: students consolidate falsification? |
| **Core concept** | The requirement most often skipped is that the condition must name an observation rather than an absence. |
| **Student outcome** | Students consolidate falsification. |
| **Previous lesson** | Lesson 7 — Auditing Conditions |
| **Next lesson** | Lesson 9 — The Exclusion Set |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_08_Printout.md` |
| **Homework** | `Homework/Lesson_08_Homework.md` |

## Why this lesson exists

**The conceptual step.** The requirement most often skipped is that the condition must name an observation rather than an absence. The review enforces it under time pressure.
...
**What depends on it.** Lesson 9 — The Exclusion Set — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The requirement most often skipped is that the condition must name an observation rather than an absence. The review enforces it under time pressure.
...
1. A condition correctly rejected for naming an absence.
2. A condition correctly accepted on all four requirements.

### One non-example

A condition accepted despite naming an absence.
...
Whether the four requirements are habitual.

### What this activity does not establish

Whether the conditions would fire.
...
| Statement | Status |
|---|---|
| The requirement most often skipped is that the condition must name an observation rather than an absence. | Framework-derived, appropriate at this grade |
| Whether the four requirements are habitual. | What this specific activity can show |
| Whether the conditions would fire. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — Auditing Conditions — specifically: students audit a partner's falsification conditions.

**How it was taught.** Through the activity: audit a partner's four conditions and trace each pathway

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: audit a partner's four conditions and trace each pathway, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A condition correctly rejected for naming an absence. |
| **Non-example** | A condition accepted despite naming an absence. |
...
**Student materials.** One copy of `Printouts/Lesson_08_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 7, kept in the student's folder.
...
**File.** `Printouts/Lesson_08_Printout.md`
...
> "The author saying it fires is not evidence that it does."
...
**Exact wording.** "Ask which of the four requirements people skip."
...
**Target observation.** Whether the four requirements are habitual.
...
> "The requirement most often skipped is that the condition must name an observation rather than an absence. You just saw that when ask which of the four requirements people skip.
> Last time we said: The author saying it fires is not evidence that it does. This is the next part of that.
...
**What students must not infer.** Whether the conditions would fire.

### 4. Worked example

**The example.** A condition correctly rejected for naming an absence.
...
**Completed answer.** A condition correctly rejected for naming an absence. — which demonstrates whether the four requirements are habitual.
...
**Conclusions not licensed.** Whether the conditions would fire.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A condition correctly accepted on all four requirements. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A condition accepted despite naming an absence. Why is this not an
example?"
...
**Exact student instructions.** Review with eight conditions judged against the four requirements.
...
- *Licensed conclusion.* Whether the four requirements are habitual.
- *Not licensed.* Whether the conditions would fire.
...
- *Expected response.* Whether the four requirements are habitual.
...
1. Any wording carrying the idea in `The requirement most often skipped is that the condition must name an observation rather than an absence`.
...
Say: "Next time: where the framework does not apply at all."

**Why this sentence matters.** It is the opening question of Lesson 9, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_08_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 7 — Auditing Conditions |
| **Leads to** | Lesson 9 — The Exclusion Set |

**Transition in.** Lesson 7 established students audit a partner's falsification conditions. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate falsification. Lesson 9 assumes it and builds students state everything the framework is not defined to model.
