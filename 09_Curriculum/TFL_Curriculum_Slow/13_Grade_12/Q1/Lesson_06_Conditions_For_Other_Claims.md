# Lesson 6 — Conditions For Other Claims
...
| | |
|---|---|
| **Central question** | Conditions For Other Claims: students write falsification conditions for non-TFL claims? |
| **Core concept** | Writing falsification conditions for outside claims reveals that many public claims have no possible disconfirming result, which is a property of the claim rather than of the evidence. |
| **Student outcome** | Students write falsification conditions for non-TFL claims. |
| **Previous lesson** | Lesson 5 — Making A Condition Fire |
| **Next lesson** | Lesson 7 — Auditing Conditions |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_06_Printout.md` |
| **Homework** | `Homework/Lesson_06_Homework.md` |

## Why this lesson exists

**The conceptual step.** Writing falsification conditions for outside claims reveals that many public claims have no possible disconfirming result, which is a property of the claim rather than of the evidence.
...
**What depends on it.** Lesson 7 — Auditing Conditions — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Writing falsification conditions for outside claims reveals that many public claims have no possible disconfirming result, which is a property of the claim rather than of the evidence.
...
1. A scientific claim with a clear falsification condition.
2. A public claim found to have no possible disconfirmer.

### One non-example

An assumption that every claim can be falsified.
...
That the requirement exposes unfalsifiable public claims.
...
| Statement | Status |
|---|---|
| Writing falsification conditions for outside claims reveals that many public claims have no possible disconfirming result, which is a property of the claim rather than of the evidence. | Framework-derived, appropriate at this grade |
| That the requirement exposes unfalsifiable public claims. | What this specific activity can show |
| Whether those claims are true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — Making A Condition Fire — specifically: students check that a condition could actually be triggered.

**How it was taught.** Through the activity: demonstrate a firing pathway for each of their four conditions

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: demonstrate a firing pathway for each of their four conditions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A scientific claim with a clear falsification condition. |
| **Non-example** | An assumption that every claim can be falsified. |
...
**Student materials.** One copy of `Printouts/Lesson_06_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 5, kept in the student's folder.
...
**File.** `Printouts/Lesson_06_Printout.md`
...
> "A condition that cannot fire is decoration."
...
**Exact wording.** "Take a claim from science or from the news."
...
**Target observation.** That the requirement exposes unfalsifiable public claims.
...
> "Writing falsification conditions for outside claims reveals that many public claims have no possible disconfirming result, which is a property of the claim rather than of the evidence. You just saw that when take a claim from science or from the news.
> Last time we said: A condition that cannot fire is decoration. This is the next part of that.
...
**What students must not infer.** Whether those claims are true.

### 4. Worked example

**The example.** A scientific claim with a clear falsification condition.
...
**Completed answer.** A scientific claim with a clear falsification condition. — which demonstrates that the requirement exposes unfalsifiable public claims.
...
**Conclusions not licensed.** Whether those claims are true.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A public claim found to have no possible disconfirmer. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An assumption that every claim can be falsified. Why is this not an
example?"
...
**Exact student instructions.** Write falsification conditions for three outside claims.
...
- *Licensed conclusion.* That the requirement exposes unfalsifiable public claims.
- *Not licensed.* Whether those claims are true.
...
- *Expected response.* That the requirement exposes unfalsifiable public claims.
...
1. Any wording carrying the idea in `Writing falsification conditions for outside claims reveals that many public claims have no possible disconfirming result, which is a property of the claim rather than of the evidence`.
...
Say: "Some public claims have no possible disconfirming result. Now you can see that."

**Why this sentence matters.** It is the opening question of Lesson 7, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_06_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 5 — Making A Condition Fire |
| **Leads to** | Lesson 7 — Auditing Conditions |

**Transition in.** Lesson 5 established students check that a condition could actually be triggered. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students write falsification conditions for non-TFL claims. Lesson 7 assumes it and builds students audit a partner's falsification conditions.
