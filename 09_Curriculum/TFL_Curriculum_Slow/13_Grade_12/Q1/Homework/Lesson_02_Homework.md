# Lesson 2 Homework — What Falsification Requires

**Grade 12** · Falsification and Scope · **Quarter 1**
**Follows:** Lesson 2 — What Falsification Requires · **Points:** 5 · **Optional:** yes
...
Write four falsification conditions, one per framework claim.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every condition names an observation rather than an absence
...
Lesson 3 is **The Circularity Trap**, which assumes you arrive holding it. Write one thing you expect it to be about:
