...
| | |
|---|---|
| **Central question** | The Clinical Case: students understand why the clinical application is a misuse? |
| **Core concept** | The framework supplies no diagnostic criteria and no therapeutic mechanism. |
| **Student outcome** | Students understand why the clinical application is a misuse. |
| **Previous lesson** | Lesson 11 — Formal Rejection |
| **Next lesson** | Lesson 13 — Borderline Cases |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_12_Printout.md` |
| **Homework** | `Homework/Lesson_12_Homework.md` |

## Why this lesson exists

**The conceptual step.** The framework supplies no diagnostic criteria and no therapeutic mechanism. Clinical use is a category error, and a verbatim refusal prevents the improvised version from softening under pressure.
...
**What depends on it.** Lesson 13 — Borderline Cases — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The framework supplies no diagnostic criteria and no therapeutic mechanism. Clinical use is a category error, and a verbatim refusal prevents the improvised version from softening under pressure.
...
1. A verbatim refusal naming the absence of diagnostic content.
2. A refusal defended against a sympathetic challenge.

### One non-example

A refusal that concedes the application might work with care.
...
That clinical use is categorically excluded.

### What this activity does not establish

Whether clinical questions matter.
...
| Statement | Status |
|---|---|
| The framework supplies no diagnostic criteria and no therapeutic mechanism. | Framework-derived, appropriate at this grade |
| That clinical use is categorically excluded. | What this specific activity can show |
| Whether clinical questions matter. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 11 — Formal Rejection — specifically: students reject an invalid application in the required form.

**How it was taught.** Through the activity: write formal rejections for three invalid proposals with boundary and alternative level

**Quick check.** Ask for the closing sentence of Lesson 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 11: write formal rejections for three invalid proposals with boundary and alternative level, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A verbatim refusal naming the absence of diagnostic content. |
| **Non-example** | A refusal that concedes the application might work with care. |
...
**Student materials.** One copy of `Printouts/Lesson_12_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 11, kept in the student's folder.
...
**File.** `Printouts/Lesson_12_Printout.md`
...
> "Exclusion is not dismissal. It points at a different level of analysis."
...
**Exact wording.** "Say: this is the application people propose most confidently and it is always wrong."
...
**Target observation.** That clinical use is categorically excluded.
...
> "The framework supplies no diagnostic criteria and no therapeutic mechanism. You just saw that when say: this is the application people propose most confidently and it is always wrong.
> Last time we said: Exclusion is not dismissal. It points at a different level of analysis. This is the next part of that.
...
**What students must not infer.** Whether clinical questions matter.

### 4. Worked example

**The example.** A verbatim refusal naming the absence of diagnostic content.
...
**Completed answer.** A verbatim refusal naming the absence of diagnostic content. — which demonstrates that clinical use is categorically excluded.
...
**Conclusions not licensed.** Whether clinical questions matter.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A refusal defended against a sympathetic challenge. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A refusal that concedes the application might work with care. Why is this not an
example?"
...
**Exact student instructions.** Write the standing refusal verbatim and defend it against two challenges.
...
- *Licensed conclusion.* That clinical use is categorically excluded.
- *Not licensed.* Whether clinical questions matter.
...
- *Expected response.* That clinical use is categorically excluded.
...
1. Any wording carrying the idea in `The framework supplies no diagnostic criteria and no therapeutic mechanism`.
...
Say: "Not a stretch. A misuse. Different category."

**Why this sentence matters.** It is the opening question of Lesson 13, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_12_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 11 — Formal Rejection |
| **Leads to** | Lesson 13 — Borderline Cases |

**Transition in.** Lesson 11 established students reject an invalid application in the required form. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students understand why the clinical application is a misuse. Lesson 13 assumes it and builds students resolve genuinely ambiguous scope questions.
