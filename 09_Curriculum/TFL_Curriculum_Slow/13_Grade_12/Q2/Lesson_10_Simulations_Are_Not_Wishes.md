# Lesson 10 — Simulations Are Not Wishes
...
| | |
|---|---|
| **Central question** | Simulations Are Not Wishes: students state what a simulation is treated as? |
| **Core concept** | A simulation is a computational hypothesis, not an intention. |
| **Student outcome** | Students state what a simulation is treated as. |
| **Previous lesson** | Lesson 9 — The Exclusion Set |
| **Next lesson** | Lesson 11 — Formal Rejection |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_10_Printout.md` |
| **Homework** | `Homework/Lesson_10_Homework.md` |

## Why this lesson exists

**The conceptual step.** A simulation is a computational hypothesis, not an intention. Agency language misrepresents the framework and is the default register for anything that predicts.
...
**What depends on it.** Lesson 11 — Formal Rejection — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A simulation is a computational hypothesis, not an intention. Agency language misrepresents the framework and is the default register for anything that predicts.
...
1. A statement rewritten without any agency term.
2. A rewrite replacing wants with generates.

### One non-example

A rewrite replacing wants with hopes.
...
That agency language can be systematically removed.

### What this activity does not establish

Whether the system has any agency.
...
| Statement | Status |
|---|---|
| A simulation is a computational hypothesis, not an intention. | Framework-derived, appropriate at this grade |
| That agency language can be systematically removed. | What this specific activity can show |
| Whether the system has any agency. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 9 — The Exclusion Set — specifically: students state everything the framework is not defined to model.

**How it was taught.** Through the activity: write the exclusion set from memory and group eight proposals within it

**Quick check.** Ask for the closing sentence of Lesson 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 9: write the exclusion set from memory and group eight proposals within it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A statement rewritten without any agency term. |
| **Non-example** | A rewrite replacing wants with hopes. |
...
**Student materials.** One copy of `Printouts/Lesson_10_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 9, kept in the student's folder.
...
**File.** `Printouts/Lesson_10_Printout.md`
...
> "These are not disclaimers. They are part of the framework."
...
**Exact wording.** "Put up a passage describing a prediction as something the system wants, and ask what is wrong."
...
**Target observation.** That agency language can be systematically removed.
...
> "A simulation is a computational hypothesis, not an intention. You just saw that when put up a passage describing a prediction as something the system wants, and ask what is wrong.
> Last time we said: These are not disclaimers. They are part of the framework. This is the next part of that.
...
**What students must not infer.** Whether the system has any agency.

### 4. Worked example

**The example.** A statement rewritten without any agency term.
...
**Completed answer.** A statement rewritten without any agency term. — which demonstrates that agency language can be systematically removed.
...
**Conclusions not licensed.** Whether the system has any agency.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A rewrite replacing wants with generates. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rewrite replacing wants with hopes. Why is this not an
example?"
...
**Exact student instructions.** Rewrite six agency-laden statements in non-agentive terms.
...
- *Licensed conclusion.* That agency language can be systematically removed.
- *Not licensed.* Whether the system has any agency.
...
- *Expected response.* That agency language can be systematically removed.
...
1. Any wording carrying the idea in `A simulation is a computational hypothesis, not an intention`.
...
Say: "The moment somebody says the system wants something, it has been misread."

**Why this sentence matters.** It is the opening question of Lesson 11, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_10_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 9 — The Exclusion Set |
| **Leads to** | Lesson 11 — Formal Rejection |

**Transition in.** Lesson 9 established students state everything the framework is not defined to model. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state what a simulation is treated as. Lesson 11 assumes it and builds students reject an invalid application in the required form.
