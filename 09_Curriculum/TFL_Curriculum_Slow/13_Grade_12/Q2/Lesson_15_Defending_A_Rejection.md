# Lesson 15 — Defending A Rejection
...
| | |
|---|---|
| **Central question** | Defending A Rejection: students defend a scope rejection under challenge? |
| **Core concept** | A rejection must survive challenge. |
| **Student outcome** | Students defend a scope rejection under challenge. |
| **Previous lesson** | Lesson 14 — Scope In Other Frameworks |
| **Next lesson** | Lesson 16 — The Scope Review |
...
**The conceptual step.** A rejection must survive challenge. Restating it more firmly is not a defence, and rejections are challenged frequently in practice.
...
**What depends on it.** Lesson 16 — The Scope Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A rejection must survive challenge. Restating it more firmly is not a defence, and rejections are challenged frequently in practice.
...
1. A defence engaging the specific boundary challenged.
2. A defence conceding a case is genuinely borderline.

### One non-example

A defence repeating the original rejection.
...
Whether rejections can be defended.

### What this activity does not establish

Whether the rejection is correct.
...
| Statement | Status |
|---|---|
| A rejection must survive challenge. | Framework-derived, appropriate at this grade |
| Whether rejections can be defended. | What this specific activity can show |
| Whether the rejection is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Scope In Other Frameworks — specifically: students examine how other models state their limits.

**How it was taught.** Through the activity: compare three outside models' stated limits against TFL's

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: compare three outside models' stated limits against TFL's, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence engaging the specific boundary challenged. |
| **Non-example** | A defence repeating the original rejection. |
...
> "Some models state their limits. Many do not. Notice which."
...
**Exact wording.** "Say: somebody thinks your rejection was wrong. Answer them."
...
**Target observation.** Whether rejections can be defended.
...
> "A rejection must survive challenge. You just saw that when say: somebody thinks your rejection was wrong.
> Last time we said: Some models state their limits. Many do not. Notice which. This is the next part of that.
...
**What students must not infer.** Whether the rejection is correct.

### 4. Worked example

**The example.** A defence engaging the specific boundary challenged.
...
**Completed answer.** A defence engaging the specific boundary challenged. — which demonstrates whether rejections can be defended.
...
**Conclusions not licensed.** Whether the rejection is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A defence conceding a case is genuinely borderline. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence repeating the original rejection. Why is this not an
example?"
...
**Exact student instructions.** Defend two rejections against written challenges.
...
- *Licensed conclusion.* Whether rejections can be defended.
- *Not licensed.* Whether the rejection is correct.
...
- *Expected response.* Whether rejections can be defended.
...
1. Any wording carrying the idea in `A rejection must survive challenge`.
...
Say: "A rejection you cannot defend is an opinion."
...
| | |
|---|---|
| **Follows** | Lesson 14 — Scope In Other Frameworks |
| **Leads to** | Lesson 16 — The Scope Review |

**Transition in.** Lesson 14 established students examine how other models state their limits. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students defend a scope rejection under challenge. Lesson 16 assumes it and builds students consolidate scope.
