...
|---|---|---|---|---|---|---|
| `Lesson_09_Printout.md` | Lesson 9 — The Exclusion Set | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_10_Printout.md` | Lesson 10 — Simulations Are Not Wishes | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 9 work |
| `Lesson_11_Printout.md` | Lesson 11 — Formal Rejection | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 10 work |
| `Lesson_12_Printout.md` | Lesson 12 — The Clinical Case | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 11 work |
| `Lesson_13_Printout.md` | Lesson 13 — Borderline Cases | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 12 work |
| `Lesson_14_Printout.md` | Lesson 14 — Scope In Other Frameworks | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 13 work |
| `Lesson_15_Printout.md` | Lesson 15 — Defending A Rejection | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 14 work |
| `Lesson_16_Printout.md` | Lesson 16 — The Scope Review | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 15 work |
...
**Lesson 13 — Borderline Cases.** If you only have time to print one
