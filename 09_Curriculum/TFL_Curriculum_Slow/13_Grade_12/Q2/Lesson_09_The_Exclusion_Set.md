...
| | |
|---|---|
| **Central question** | The Exclusion Set: students state everything the framework is not defined to model? |
| **Core concept** | The exclusion set names five categories the framework does not model: consolidation, identity, narrative, development, and group dynamics. |
| **Student outcome** | Students state everything the framework is not defined to model. |
| **Previous lesson** | Lesson 8 — The Falsification Review |
| **Next lesson** | Lesson 10 — Simulations Are Not Wishes |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_09_Printout.md` |
| **Homework** | `Homework/Lesson_09_Homework.md` |

## Why this lesson exists

**The conceptual step.** The exclusion set names five categories the framework does not model: consolidation, identity, narrative, development, and group dynamics. The exclusions are content, not disclaimers.
...
**What depends on it.** Lesson 10 — Simulations Are Not Wishes — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The exclusion set names five categories the framework does not model: consolidation, identity, narrative, development, and group dynamics. The exclusions are content, not disclaimers.
...
1. A proposal about identity grouped under the identity exclusion.
2. A proposal about group behaviour grouped correctly.

### One non-example

The exclusions described as legal protection for the author.
...
That the exclusions are stateable and constitutive.

### What this activity does not establish

Whether the exclusions are correctly drawn.
...
| Statement | Status |
|---|---|
| The exclusion set names five categories the framework does not model: consolidation, identity, narrative, development, and group dynamics. | Framework-derived, appropriate at this grade |
| That the exclusions are stateable and constitutive. | What this specific activity can show |
| Whether the exclusions are correctly drawn. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Falsification Review — specifically: students consolidate falsification.

**How it was taught.** Through the activity: review with eight conditions judged against the four requirements

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: review with eight conditions judged against the four requirements, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A proposal about identity grouped under the identity exclusion. |
| **Non-example** | The exclusions described as legal protection for the author. |
...
**Student materials.** One copy of `Printouts/Lesson_09_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 8, kept in the student's folder.
...
**File.** `Printouts/Lesson_09_Printout.md`
...
> "Next time: where the framework does not apply at all."
...
**Exact wording.** "Read six proposals and take votes. Four are invalid."
...
**Target observation.** That the exclusions are stateable and constitutive.
...
> "The exclusion set names five categories the framework does not model: consolidation, identity, narrative, development, and group dynamics. You just saw that when read six proposals and take votes.
> Last time we said: Next time: where the framework does not apply at all. This is the next part of that.
...
**What students must not infer.** Whether the exclusions are correctly drawn.

### 4. Worked example

**The example.** A proposal about identity grouped under the identity exclusion.
...
**Completed answer.** A proposal about identity grouped under the identity exclusion. — which demonstrates that the exclusions are stateable and constitutive.
...
**Conclusions not licensed.** Whether the exclusions are correctly drawn.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A proposal about group behaviour grouped correctly. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. The exclusions described as legal protection for the author. Why is this not an
example?"
...
**Exact student instructions.** Write the exclusion set from memory and group eight proposals within it.
...
- *Licensed conclusion.* That the exclusions are stateable and constitutive.
- *Not licensed.* Whether the exclusions are correctly drawn.
...
- *Expected response.* That the exclusions are stateable and constitutive.
...
1. Any wording carrying the idea in `The exclusion set names five categories the framework does not model: consolidation, identity, narrative, development, and group dynamics`.
...
Say: "These are not disclaimers. They are part of the framework."

**Why this sentence matters.** It is the opening question of Lesson 10, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_09_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Falsification Review |
| **Leads to** | Lesson 10 — Simulations Are Not Wishes |

**Transition in.** Lesson 8 established students consolidate falsification. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state everything the framework is not defined to model. Lesson 10 assumes it and builds students state what a simulation is treated as.
