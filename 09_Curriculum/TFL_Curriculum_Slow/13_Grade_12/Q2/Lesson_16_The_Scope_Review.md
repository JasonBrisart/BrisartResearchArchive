...
| | |
|---|---|
| **Central question** | The Scope Review: students consolidate scope? |
| **Core concept** | Every rejection requires a named boundary. |
| **Student outcome** | Students consolidate scope. |
| **Previous lesson** | Lesson 15 — Defending A Rejection |
| **Next lesson** | Lesson 17 — Falsification Before Advocacy |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_16_Printout.md` |
| **Homework** | `Homework/Lesson_16_Homework.md` |

## Why this lesson exists

**The conceptual step.** Every rejection requires a named boundary. The review tests whether the requirement survives under time pressure, which matters because Gate B depends on it.
...
**What depends on it.** Lesson 17 — Falsification Before Advocacy — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every rejection requires a named boundary. The review tests whether the requirement survives under time pressure, which matters because Gate B depends on it.
...
1. A proposal rejected with its boundary named.
2. A proposal correctly judged valid.

### One non-example

A proposal rejected with no boundary named.
...
Whether the boundary requirement is habitual.

### What this activity does not establish

Whether the boundaries are correct.
...
| Statement | Status |
|---|---|
| Every rejection requires a named boundary. | Framework-derived, appropriate at this grade |
| Whether the boundary requirement is habitual. | What this specific activity can show |
| Whether the boundaries are correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — Defending A Rejection — specifically: students defend a scope rejection under challenge.

**How it was taught.** Through the activity: defend two rejections against written challenges

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: defend two rejections against written challenges, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A proposal rejected with its boundary named. |
| **Non-example** | A proposal rejected with no boundary named. |
...
**Student materials.** One copy of `Printouts/Lesson_16_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 15, kept in the student's folder.
...
**File.** `Printouts/Lesson_16_Printout.md`
...
> "A rejection you cannot defend is an opinion."
...
**Exact wording.** "Ask for the five groups and the boundary word for each."
...
**Target observation.** Whether the boundary requirement is habitual.
...
> "Every rejection requires a named boundary. You just saw that when ask for the five groups and the boundary word for each.
> Last time we said: A rejection you cannot defend is an opinion. This is the next part of that.
...
**What students must not infer.** Whether the boundaries are correct.

### 4. Worked example

**The example.** A proposal rejected with its boundary named.
...
**Completed answer.** A proposal rejected with its boundary named. — which demonstrates whether the boundary requirement is habitual.
...
**Conclusions not licensed.** Whether the boundaries are correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A proposal correctly judged valid. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A proposal rejected with no boundary named. Why is this not an
example?"
...
**Exact student instructions.** Review with ten proposals judged and boundaries named.
...
- *Licensed conclusion.* Whether the boundary requirement is habitual.
- *Not licensed.* Whether the boundaries are correct.
...
- *Expected response.* Whether the boundary requirement is habitual.
...
1. Any wording carrying the idea in `Every rejection requires a named boundary`.
...
Say: "Next time: falsification comes before advocacy. Always."

**Why this sentence matters.** It is the opening question of Lesson 17, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_16_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 15 — Defending A Rejection |
| **Leads to** | Lesson 17 — Falsification Before Advocacy |

**Transition in.** Lesson 15 established students defend a scope rejection under challenge. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate scope. Lesson 17 assumes it and builds students order their own argument correctly.
