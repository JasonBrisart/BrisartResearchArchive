...
| **Core concept** | The practice final must be marked gate-first, exactly as the real paper will be. |
| **Student outcome** | Students rehearse the gated final under conditions. |
| **Previous lesson** | Lesson 30 — The Capstone Defence |
| **Next lesson** | Lesson 32 — Final Assessment |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_31_Printout.md` |
| **Homework** | `Homework/Lesson_31_Homework.md` |

## Why this lesson exists

**The conceptual step.** The practice final must be marked gate-first, exactly as the real paper will be. Knowing whether the gates would pass is the practice's purpose.
...
**What depends on it.** Lesson 32 — Final Assessment — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The practice final must be marked gate-first, exactly as the real paper will be. Knowing whether the gates would pass is the practice's purpose.
...
2. A student discovering Gate B would currently fail.
...
| Statement | Status |
|---|---|
| The practice final must be marked gate-first, exactly as the real paper will be. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 30 — The Capstone Defence — specifically: students defend the capstone against four assigned roles.

**How it was taught.** Through the activity: eight minutes presenting, eight defending, against four challengers

**Quick check.** Ask for the closing sentence of Lesson 30. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 30: eight minutes presenting, eight defending, against four challengers, in miniature, using one example only. Then ask for the sentence again.
...
**Student materials.** One copy of `Printouts/Lesson_31_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 30, kept in the student's folder.
...
**File.** `Printouts/Lesson_31_Printout.md`
...
> "You are leaving school able to specify a claim, measure it, and say what would refute it."
...
> "The practice final must be marked gate-first, exactly as the real paper will be. You just saw that when say: same as the real one, including both gates.
> Last time we said: You are leaving school able to specify a claim, measure it, and say what would refute it. This is the next part of that.
...
**Teacher prompt.** "Here is a second case. A student discovering Gate B would currently fail. Work it through with me."
...
**Exact student instructions.** A full practice final, self-marked, with both gates checked first.
...
1. Any wording carrying the idea in `The practice final must be marked gate-first, exactly as the real paper will be`.
...
**Why this sentence matters.** It is the opening question of Lesson 32, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_31_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 30 — The Capstone Defence |
| **Leads to** | Lesson 32 — Final Assessment |

**Transition in.** Lesson 30 established students defend the capstone against four assigned roles. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students rehearse the gated final under conditions. Lesson 32 assumes it and builds students demonstrate the year's outcomes on a gated paper.
