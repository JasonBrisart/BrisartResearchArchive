...
| | |
|---|---|
| **Central question** | The Mock Defence: students rehearse the defence against four roles? |
| **Core concept** | A mock defence produces a list of unanswered questions, which is its purpose. |
| **Student outcome** | Students rehearse the defence against four roles. |
| **Previous lesson** | Lesson 25 — Assembling The Capstone |
| **Next lesson** | Lesson 27 — Revising After The Mock |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_26_Printout.md` |
| **Homework** | `Homework/Lesson_26_Homework.md` |

## Why this lesson exists

**The conceptual step.** A mock defence produces a list of unanswered questions, which is its purpose. Restating the design rather than answering wastes the rehearsal.
...
**What depends on it.** Lesson 27 — Revising After The Mock — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A mock defence produces a list of unanswered questions, which is its purpose. Restating the design rather than answering wastes the rehearsal.
...
1. A defence answering the scope referee's challenge directly.
...
| Statement | Status |
|---|---|
| A mock defence produces a list of unanswered questions, which is its purpose. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 25 — Assembling The Capstone — specifically: students produce the complete capstone package.

**How it was taught.** Through the activity: assemble the capstone and swap for a peer gate check

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: assemble the capstone and swap for a peer gate check, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence answering the scope referee's challenge directly. |
...
**Student materials.** One copy of `Printouts/Lesson_26_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 25, kept in the student's folder.
...
**File.** `Printouts/Lesson_26_Printout.md`
...
**Exact wording.** "Assign four challengers: three rival advocates and the scope referee."
...
> "A mock defence produces a list of unanswered questions, which is its purpose. You just saw that when assign four challengers: three rival advocates and the scope referee.
...
**The example.** A defence answering the scope referee's challenge directly.
...
**Completed answer.** A defence answering the scope referee's challenge directly. — which demonstrates that unanswered questions can be identified in rehearsal.
...
**Exact student instructions.** Present for eight minutes and defend for eight; record every unanswered question.
...
1. Any wording carrying the idea in `A mock defence produces a list of unanswered questions, which is its purpose`.
...
**Why this sentence matters.** It is the opening question of Lesson 27, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_26_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 25 — Assembling The Capstone |
| **Leads to** | Lesson 27 — Revising After The Mock |

**Transition in.** Lesson 25 established students produce the complete capstone package. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students rehearse the defence against four roles. Lesson 27 assumes it and builds students revise the capstone against mock-defence feedback.
