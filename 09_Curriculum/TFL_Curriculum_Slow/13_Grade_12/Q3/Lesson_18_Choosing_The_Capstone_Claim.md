# Lesson 18 — Choosing The Capstone Claim
...
| **Previous lesson** | Lesson 17 — Falsification Before Advocacy |
| **Next lesson** | Lesson 19 — The Capstone Falsification Condition |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_18_Printout.md` |
| **Homework** | `Homework/Lesson_18_Homework.md` |
...
**What depends on it.** Lesson 19 — The Capstone Falsification Condition — opens by assuming this lesson's closing sentence is already held.
...
1. A claim about persistence paired with the arousal account.
2. A claim narrow enough to be settled by one design.
...
That capstone targets can be narrowed appropriately.
...
| That capstone targets can be narrowed appropriately. | What this specific activity can show |
| Whether the claim is true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Falsification Before Advocacy — specifically: students order their own argument correctly.

**How it was taught.** Through the activity: reorder three of their own arguments so the condition precedes the advocacy

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: reorder three of their own arguments so the condition precedes the advocacy, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A claim about persistence paired with the arousal account. |
...
**Student materials.** One copy of `Printouts/Lesson_18_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 17, kept in the student's folder.
...
**File.** `Printouts/Lesson_18_Printout.md`
...
**Exact wording.** "Say: frameworks are not tested as wholes. Pick one claim."
...
**Target observation.** That capstone targets can be narrowed appropriately.
...
**The example.** A claim about persistence paired with the arousal account.
...
**Completed answer.** A claim about persistence paired with the arousal account. — which demonstrates that capstone targets can be narrowed appropriately.
...
**Teacher prompt.** "Here is a second case. A claim narrow enough to be settled by one design. Work it through with me."
...
**Exact student instructions.** Select a claim, name its least-separable rival, and justify the pairing.
...
- *Licensed conclusion.* That capstone targets can be narrowed appropriately.
...
- *Expected response.* That capstone targets can be narrowed appropriately.
...
**Why this sentence matters.** It is the opening question of Lesson 19, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_18_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 17 — Falsification Before Advocacy |
| **Leads to** | Lesson 19 — The Capstone Falsification Condition |

**Transition in.** Lesson 17 established students order their own argument correctly. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students select one claim narrow enough to be settled. Lesson 19 assumes it and builds students write the condition their capstone could trigger.
