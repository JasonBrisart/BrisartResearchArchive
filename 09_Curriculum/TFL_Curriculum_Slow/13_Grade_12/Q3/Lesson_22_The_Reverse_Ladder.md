...
| **Previous lesson** | Lesson 21 — The Inference Ceiling |
| **Next lesson** | Lesson 23 — Confirmatory And Exploratory |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_22_Printout.md` |
| **Homework** | `Homework/Lesson_22_Homework.md` |

## Why this lesson exists

**The conceptual step.** The reverse ladder states what a null licenses. A null fires the falsification condition only if the condition was prespecified and the controls held.
...
**What depends on it.** Lesson 23 — Confirmatory And Exploratory — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The reverse ladder states what a null licenses. A null fires the falsification condition only if the condition was prespecified and the controls held.
...
2. A reverse ladder stating it would, with the controls verified.
...
**Prerequisite.** The content of Lesson 21 — The Inference Ceiling — specifically: students state the highest claim their design licenses.
...
**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: ladder their own anticipated result and name the rung they will be tempted to claim, in miniature, using one example only. Then ask for the sentence again.
...
**Student materials.** One copy of `Printouts/Lesson_22_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 21, kept in the student's folder.
...
**File.** `Printouts/Lesson_22_Printout.md`
...
**Teacher prompt.** "Here is a second case. A reverse ladder stating it would, with the controls verified. Work it through with me."
...
**Why this sentence matters.** It is the opening question of Lesson 23, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_22_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 21 — The Inference Ceiling |
| **Leads to** | Lesson 23 — Confirmatory And Exploratory |

**Transition in.** Lesson 21 established students state the highest claim their design licenses. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state what a null result licenses. Lesson 23 assumes it and builds students separate prespecified tests from exploration.
