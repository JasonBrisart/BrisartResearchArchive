...
| | |
|---|---|
| **Central question** | Final Assessment: students demonstrate integrated command of the framework and its status? |
| **Core concept** | The course ends without a verdict because no verdict is available. |
| **Student outcome** | Students demonstrate integrated command of the framework and its status. |
| **Previous session** | Session 27 — Practice Final |
...
**The conceptual step.** The course ends without a verdict because no verdict is available. Being able to evaluate the framework rather than believe or dismiss it is the outcome.
...
The course ends without a verdict because no verdict is available. Being able to evaluate the framework rather than believe or dismiss it is the outcome.
...
1. A paper satisfying both gates.
2. A status statement accurate in both directions.

### One non-example

A paper concluding the framework is established.
...
| Statement | Status |
|---|---|
| The course ends without a verdict because no verdict is available. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Session 27 — Practice Final — specifically: students rehearse the final under conditions.

**How it was taught.** Through the activity: a full practice final, self-marked, gates checked first

**Quick check.** Ask for the closing sentence of Session 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 27: a full practice final, self-marked, gates checked first, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A paper satisfying both gates. |
| **Non-example** | A paper concluding the framework is established. |
...
**Exact wording.** "Restate the disclosure one final time."
...
> "The course ends without a verdict because no verdict is available. You just saw that when restate the disclosure one final time.
...
**The example.** A paper satisfying both gates.
...
**Completed answer.** A paper satisfying both gates. — which demonstrates whether the outcomes are demonstrated.
...
**Teacher prompt.** "Here is a second case. A status statement accurate in both directions. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A paper concluding the framework is established. Why is this not an
example?"
...
**Exact student instructions.** The gated final: both relations, closure, a trace, falsification, scope, the rivals, status.
...
1. Any wording carrying the idea in `The course ends without a verdict because no verdict is available`.
...
Say: "You are leaving without knowing whether it is true. That is the actual state of the question."
...
| | |
|---|---|
| **Follows** | Session 27 — Practice Final |
| **Leads to** | The final examination. |

**Transition in.** Session 27 established students rehearse the final under conditions. This session uses that as the starting point.
