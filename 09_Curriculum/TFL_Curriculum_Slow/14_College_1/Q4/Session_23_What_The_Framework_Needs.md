# Session 23 — What The Framework Needs

**College Year 1** · The Framework and Its Status · **Quarter 4** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | What The Framework Needs: students state what would move the question forward? |
| **Core concept** | Naming what would move the question forward is a more useful output than a verdict. |
| **Student outcome** | Students state what would move the question forward. |
| **Previous session** | Session 22 — Falsification Conditions |
| **Next session** | Session 24 — Comparing With Your Own Field |
...
**The conceptual step.** Naming what would move the question forward is a more useful output than a verdict. Ranking by feasibility distinguishes wishes from plans.
...
**What depends on it.** Session 24 — Comparing With Your Own Field — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Naming what would move the question forward is a more useful output than a verdict. Ranking by feasibility distinguishes wishes from plans.
...
1. A requirement for independent replication, ranked feasible.
2. A requirement for within-window measurement, ranked infeasible now.

### One non-example

A verdict that the framework is probably correct.
...
That progress requirements can be named and ranked.

### What this activity does not establish

Whether the framework is correct.
...
| Statement | Status |
|---|---|
| Naming what would move the question forward is a more useful output than a verdict. | Framework-derived, appropriate at this grade |
| That progress requirements can be named and ranked. | What this specific activity can show |
| Whether the framework is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 22 — Falsification Conditions — specifically: students write conditions meeting all four requirements.

**How it was taught.** Through the activity: write four conditions, one per claim, peer-audited against the requirements

**Quick check.** Ask for the closing sentence of Session 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 22: write four conditions, one per claim, peer-audited against the requirements, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A requirement for independent replication, ranked feasible. |
| **Non-example** | A verdict that the framework is probably correct. |
...
> "Absence of support is not falsification."
...
**Exact wording.** "Ask what would have to happen for anybody to know whether this is right."
...
**Target observation.** That progress requirements can be named and ranked.
...
> "Naming what would move the question forward is a more useful output than a verdict. You just saw that when ask what would have to happen for anybody to know whether this is right.
> Last time we said: Absence of support is not falsification. This is the next part of that.
...
**What students must not infer.** Whether the framework is correct.

### 4. Worked example

**The example.** A requirement for independent replication, ranked feasible.
...
**Completed answer.** A requirement for independent replication, ranked feasible. — which demonstrates that progress requirements can be named and ranked.
...
**Conclusions not licensed.** Whether the framework is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A requirement for within-window measurement, ranked infeasible now. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A verdict that the framework is probably correct. Why is this not an
example?"
...
**Exact student instructions.** Write three requirements for progress, ranked by feasibility.
...
- *Licensed conclusion.* That progress requirements can be named and ranked.
- *Not licensed.* Whether the framework is correct.
...
- *Expected response.* That progress requirements can be named and ranked.
...
1. Any wording carrying the idea in `Naming what would move the question forward is a more useful output than a verdict`.
...
Say: "Naming what is needed is more useful than deciding whether you believe it."
...
| | |
|---|---|
| **Follows** | Session 22 — Falsification Conditions |
| **Leads to** | Session 24 — Comparing With Your Own Field |

**Transition in.** Session 22 established students write conditions meeting all four requirements. This session uses that as the starting point.

**Transition out.** This session establishes students state what would move the question forward. Session 24 assumes it and builds students situate TFL against a framework from their own discipline.
