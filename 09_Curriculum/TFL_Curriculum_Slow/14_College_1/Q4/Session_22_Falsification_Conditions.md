# Session 22 — Falsification Conditions
...
| | |
|---|---|
| **Central question** | Falsification Conditions: students write conditions meeting all four requirements? |
| **Core concept** | A falsification condition names an observation that could occur, with controls, stated in advance. |
| **Student outcome** | Students write conditions meeting all four requirements. |
| **Previous session** | Session 21 — Scope And Invalid Application |
| **Next session** | Session 23 — What The Framework Needs |
...
**The conceptual step.** A falsification condition names an observation that could occur, with controls, stated in advance. Absence of support fails all four requirements.
...
**What depends on it.** Session 23 — What The Framework Needs — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A falsification condition names an observation that could occur, with controls, stated in advance. Absence of support fails all four requirements.
...
1. A condition naming a specific observation with its controls.
2. A condition peer-audited and confirmed.

### One non-example

A condition reading: if the effect is not found.
...
That the four requirements are enforceable.
...
| Statement | Status |
|---|---|
| A falsification condition names an observation that could occur, with controls, stated in advance. | Framework-derived, appropriate at this grade |
| That the four requirements are enforceable. | What this specific activity can show |
| Whether any condition would fire. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 21 — Scope And Invalid Application — specifically: students reject invalid applications formally.

**How it was taught.** Through the activity: write three formal rejections with boundary and alternative level

**Quick check.** Ask for the closing sentence of Session 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 21: write three formal rejections with boundary and alternative level, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A condition naming a specific observation with its controls. |
| **Non-example** | A condition reading: if the effect is not found. |
...
> "Capable students over-apply more than struggling ones."
...
**Exact wording.** "Put up the circular claim and ask what result would contradict it."
...
**Target observation.** That the four requirements are enforceable.
...
> "A falsification condition names an observation that could occur, with controls, stated in advance. You just saw that when put up the circular claim and ask what result would contradict it.
> Last time we said: Capable students over-apply more than struggling ones. This is the next part of that.
...
**The example.** A condition naming a specific observation with its controls.
...
**Completed answer.** A condition naming a specific observation with its controls. — which demonstrates that the four requirements are enforceable.
...
**Teacher prompt.** "Here is a second case. A condition peer-audited and confirmed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A condition reading: if the effect is not found. Why is this not an
example?"
...
**Exact student instructions.** Write four conditions, one per claim, peer-audited against the requirements.
...
- *Licensed conclusion.* That the four requirements are enforceable.
...
- *Expected response.* That the four requirements are enforceable.
...
1. Any wording carrying the idea in `A falsification condition names an observation that could occur, with controls, stated in advance`.
...
Say: "Absence of support is not falsification."
...
| | |
|---|---|
| **Follows** | Session 21 — Scope And Invalid Application |
| **Leads to** | Session 23 — What The Framework Needs |

**Transition in.** Session 21 established students reject invalid applications formally. This session uses that as the starting point.

**Transition out.** This session establishes students write conditions meeting all four requirements. Session 23 assumes it and builds students state what would move the question forward.
