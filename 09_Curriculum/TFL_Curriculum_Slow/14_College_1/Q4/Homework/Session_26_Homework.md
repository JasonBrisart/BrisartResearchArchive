# Session 26 Homework — The Year In Objections

**College Year 1** · The Framework and Its Status · **Quarter 4**
**Follows:** Session 26 — The Year In Objections · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 26 ended on, from memory:
...
Sort the class's objections into answered, sharpened, abandoned, and standing.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class produces a sorted objection ledger
...
Session 27 is **Practice Final**, which assumes you arrive holding it. Write one thing you expect it to be about:
