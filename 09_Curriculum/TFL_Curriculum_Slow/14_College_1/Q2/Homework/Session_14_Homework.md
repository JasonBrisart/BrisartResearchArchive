# Session 14 Homework — The Midterm Review

**College Year 1** · The Framework and Its Status · **Quarter 2**
**Follows:** Session 14 — The Midterm Review · **Points:** 5 · **Optional:** yes
...
Review covering status, the five variables, the window, gating, and closure.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class identifies its own weakest area
...
Session 15 is **Three Rivals At Adult Scale**, which assumes you arrive holding it. Write one thing you expect it to be about:
