# Session 11 Homework — Closure And Its Cost

**College Year 1** · The Framework and Its Status · **Quarter 2**
**Follows:** Session 11 — Closure And Its Cost · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 11 ended on, from memory:
...
Test whether the excluded variables are the threatening ones.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student tests the challenge against specific excluded variables
...
Session 12 is **Conditional Determinism**, which assumes you arrive holding it. Write one thing you expect it to be about:
