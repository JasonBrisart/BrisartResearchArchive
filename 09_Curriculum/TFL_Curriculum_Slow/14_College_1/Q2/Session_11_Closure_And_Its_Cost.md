# Session 11 — Closure And Its Cost

**College Year 1** · The Framework and Its Status · **Quarter 2** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Closure And Its Cost: students evaluate whether variable closure is principled or convenient? |
| **Core concept** | Closure is convenient if the excluded variables are exactly those that would threaten the framework's claims. |
| **Student outcome** | Students evaluate whether variable closure is principled or convenient. |
| **Previous session** | Session 10 — Testing It On Your Own Data |
| **Next session** | Session 12 — Conditional Determinism |
| **Materials** | Index cards for standing objections; the full specification, printed |
| **Preparation** | thirty minutes |
| **Student printout** | `Printouts/Session_11_Printout.md` |
| **Homework** | `Homework/Session_11_Homework.md` |

## Why this lesson exists

**The conceptual step.** Closure is convenient if the excluded variables are exactly those that would threaten the framework's claims. The charge is testable by naming one.

**Why students need it now.** This grade owns one idea: epistemic status as content, and stating a claim in its strongest form before attacking it.
...
that unvalidated means unserious. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** University reading load. A claim is stated as its author would state it before it is criticised. The student's own position is never graded.

**What depends on it.** Session 12 — Conditional Determinism — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Closure is convenient if the excluded variables are exactly those that would threaten the framework's claims. The charge is testable by naming one.

### How this is stated at this grade

University reading load. A claim is stated as its author would state it before it is criticised. The student's own position is never graded.

Use only the vocabulary released at or before this grade. Terms not yet available:
Publication-standard measurement critique, referee-quality review.

### Why the concept matters

The whole grade rests on epistemic status as content, and stating a claim in its strongest form before attacking it. If a student leaves this
...
1. An excluded variable that would not threaten any claim.
2. An excluded variable that would, supporting the convenience charge.

### One non-example

Accepting that closure is principled without naming any excluded variable.
...
That the convenience charge is testable.

### What this activity does not establish

Whether closure is principled.
...
| Statement | Status |
|---|---|
| Closure is convenient if the excluded variables are exactly those that would threaten the framework's claims. | Framework-derived, appropriate at this grade |
| That the convenience charge is testable. | What this specific activity can show |
| Whether closure is principled. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 10 — Testing It On Your Own Data — specifically: students run the four-box study on prospectively collected data.

**How it was taught.** Through the activity: sort eight logged predictions and answer four questions, the fourth being three reasons the data might mislead

**Quick check.** Ask for the closing sentence of Session 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 10: sort eight logged predictions and answer four questions, the fourth being three reasons the data might mislead, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | what is currently known about whether a framework is correct. |
| **Student wording** | What is currently known about whether a framework is correct. |
| **Correct example** | An excluded variable that would not threaten any claim. |
| **Non-example** | Accepting that closure is principled without naming any excluded variable. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for what is currently known about whether a framework is correct." |

### independent validation

| | |
|---|---|
| **Teacher definition** | confirmation by researchers unconnected to the author. |
| **Student wording** | Confirmation by researchers unconnected to the author. |
| **Correct example** | An excluded variable that would not threaten any claim. |
| **Non-example** | Accepting that closure is principled without naming any excluded variable. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for confirmation by researchers unconnected to the author." |

### overclaim

| | |
|---|---|
| **Teacher definition** | presenting a framework as more established than it is. |
| **Student wording** | Presenting a framework as more established than it is. |
| **Correct example** | An excluded variable that would not threaten any claim. |
| **Non-example** | Accepting that closure is principled without naming any excluded variable. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for presenting a framework as more established than it is." |


Do not introduce terminology from later grades. Publication-standard measurement critique, referee-quality review.

## Materials and preparation

**Teacher materials.** Index cards for standing objections; The full specification, printed; Whiteboard; Printed status-statement templates.

**Student materials.** One copy of `Printouts/Session_11_Printout.md` per student.

**Prior student data required.** Work produced in Session 10, kept in the student's folder.
...
**File.** `Printouts/Session_11_Printout.md`
...
> "Your data is consistent with the framework and with two rivals."
...
**Exact wording.** "Put their own proposed sixth variables back on the board."
...
**Target observation.** That the convenience charge is testable.
...
> "Closure is convenient if the excluded variables are exactly those that would threaten the framework's claims. You just saw that when put their own proposed sixth variables back on the board.
> Last time we said: Your data is consistent with the framework and with two rivals. This is the next part of that.
> It matters because this framework has not been independently validated, and that is why it is worth studying here"
...
**Terminology to introduce here.** epistemic status, independent validation, overclaim.

**What students must not infer.** Whether closure is principled.

### 4. Worked example

**The example.** An excluded variable that would not threaten any claim.
...
**Completed answer.** An excluded variable that would not threaten any claim. — which demonstrates that the convenience charge is testable.
...
**Conclusions not licensed.** Whether closure is principled.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An excluded variable that would, supporting the convenience charge. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Accepting that closure is principled without naming any excluded variable. Why is this not an
example?"
...
**Exact student instructions.** Test whether the excluded variables are the threatening ones.
...
- *Licensed conclusion.* That the convenience charge is testable.
- *Not licensed.* Whether closure is principled.
...
- *Expected response.* That the convenience charge is testable.
...
3. **Misconception check.** Somebody says: "Unvalidated means unserious" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `Closure is convenient if the excluded variables are exactly those that would threaten the framework's claims`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Dismissal is as inaccurate as endorsement. Both are assessed.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "If closure were convenient, the excluded ones would be the threatening ones."

**Why this sentence matters.** It is the opening question of Session 12, which assumes students arrive holding it.
...
### 1. "Unvalidated means unserious"

**What the student says or does.** Unvalidated means unserious — usually while otherwise engaging well.

**Why it is understandable.** Academic hedging defaults to dismissal and students imitate it.
...
**Exact correction.** Show the specification is falsifiable in principle and internally consistent.

**Say this.** "Dismissal is as inaccurate as endorsement. Both are assessed."
...
### 2. "If the author defines the terms, it cannot be wrong"

**What the student says or does.** If the author defines the terms, it cannot be wrong — usually while otherwise engaging well.

**Why it is understandable.** Author-defined terms feel unfalsifiable by construction.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Point at variable closure and the testability constraint.

**Say this.** "It supplies the rule that invalidates its own popular applications."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "I should decide now whether I believe it"

**What the student says or does.** I should decide now whether I believe it — usually while otherwise engaging well.

**Why it is understandable.** Students want a verdict to organise their study around.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** State that a verdict is not the outcome.

**Say this.** "You are being asked to be able to evaluate it, not to believe it."
...
**Visual or physical support.** Provide the status statement as a three-sentence template.
...
Ask them to state the status of a framework in their own discipline.
...
Specifically, do not introduce: Publication-standard measurement critique, referee-quality review.
...
**File.** `Homework/Session_11_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 10 — Testing It On Your Own Data |
| **Leads to** | Session 12 — Conditional Determinism |

**Transition in.** Session 10 established students run the four-box study on prospectively collected data. This session uses that as the starting point.

**Transition out.** This session establishes students evaluate whether variable closure is principled or convenient. Session 12 assumes it and builds students state what the framework guarantees about repeatability.
