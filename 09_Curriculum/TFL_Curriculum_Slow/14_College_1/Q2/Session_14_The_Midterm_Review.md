...
| | |
|---|---|
| **Central question** | The Midterm Review: students consolidate the first half of the course? |
| **Core concept** | A midterm review must sample the whole term. |
| **Student outcome** | Students consolidate the first half of the course. |
| **Previous session** | Session 13 — The Guarantee Set |
| **Next session** | Session 15 — Three Rivals At Adult Scale |
...
**The conceptual step.** A midterm review must sample the whole term. Reviewing only recent material produces a false sense of readiness.
...
**What depends on it.** Session 15 — Three Rivals At Adult Scale — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A midterm review must sample the whole term. Reviewing only recent material produces a false sense of readiness.
...
1. A review touching Session 2 and Session 13 equally.
2. A cohort identifying the window argument as its weakest area.
...
| Statement | Status |
|---|---|
| A midterm review must sample the whole term. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Session 13 — The Guarantee Set — specifically: students state the architectural commitments and their limits.

**How it was taught.** Through the activity: list the guarantees and convert two into violating observations

**Quick check.** Ask for the closing sentence of Session 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 13: list the guarantees and convert two into violating observations, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A review touching Session 2 and Session 13 equally. |
...
> "A guarantee you cannot violate on paper is a slogan."
...
> "A midterm review must sample the whole term. You just saw that when ask what is still unclear about everything so far.
> Last time we said: A guarantee you cannot violate on paper is a slogan. This is the next part of that.
...
**The example.** A review touching Session 2 and Session 13 equally.
...
**Completed answer.** A review touching Session 2 and Session 13 equally. — which demonstrates where the cohort is weakest.
...
**Teacher prompt.** "Here is a second case. A cohort identifying the window argument as its weakest area. Work it through with me."
...
**Exact student instructions.** Review covering status, the five variables, the window, gating, and closure.
...
1. Any wording carrying the idea in `A midterm review must sample the whole term`.
...
| | |
|---|---|
| **Follows** | Session 13 — The Guarantee Set |
| **Leads to** | Session 15 — Three Rivals At Adult Scale |

**Transition in.** Session 13 established students state the architectural commitments and their limits. This session uses that as the starting point.

**Transition out.** This session establishes students consolidate the first half of the course. Session 15 assumes it and builds students state the rivals in forms their proponents would accept.
