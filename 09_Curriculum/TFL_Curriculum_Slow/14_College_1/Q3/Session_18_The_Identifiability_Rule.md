# Session 18 — The Identifiability Rule

**College Year 1** · The Framework and Its Status · **Quarter 3** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Identifiability Rule: students apply the rule at research standard? |
| **Core concept** | The identifiability rule excludes most of mental life, which is simultaneously a serious limitation and the source of the framework's testability. |
| **Student outcome** | Students apply the rule at research standard. |
| **Previous session** | Session 17 — The Discriminating Condition |
| **Next session** | Session 19 — The Critique Memo, Drafted |
| **Materials** | Index cards for standing objections; the full specification, printed |
| **Preparation** | thirty minutes |
| **Student printout** | `Printouts/Session_18_Printout.md` |
| **Homework** | `Homework/Session_18_Homework.md` |

## Why this lesson exists

**The conceptual step.** The identifiability rule excludes most of mental life, which is simultaneously a serious limitation and the source of the framework's testability. Both readings are correct.
...
**What depends on it.** Session 19 — The Critique Memo, Drafted — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The identifiability rule excludes most of mental life, which is simultaneously a serious limitation and the source of the framework's testability. Both readings are correct.
...
1. A vague statement sharpened into a checkable prediction.
2. A statement marked unsharpenable and the reason recorded.

### One non-example

A vague statement forced into a specific unrelated claim.
...
That the rule involves a stateable trade.
...
| Statement | Status |
|---|---|
| The identifiability rule excludes most of mental life, which is simultaneously a serious limitation and the source of the framework's testability. | Framework-derived, appropriate at this grade |
| That the rule involves a stateable trade. | What this specific activity can show |
| Whether the trade is worth making. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 17 — The Discriminating Condition — specifically: students locate where the four accounts come apart.

**How it was taught.** Through the activity: identify the condition and state whether their design enters it

**Quick check.** Ask for the closing sentence of Session 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 17: identify the condition and state whether their design enters it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A vague statement sharpened into a checkable prediction. |
| **Non-example** | A vague statement forced into a specific unrelated claim. |
...
**Student materials.** One copy of `Printouts/Session_18_Printout.md` per student.

**Prior student data required.** Work produced in Session 17, kept in the student's folder.
...
**File.** `Printouts/Session_18_Printout.md`
...
> "A design that never enters that cell is not adjudicating."
...
**Exact wording.** "Put up two statements, one checkable and one not, and ask which is a Sim(t)."
...
**Target observation.** That the rule involves a stateable trade.
...
> "The identifiability rule excludes most of mental life, which is simultaneously a serious limitation and the source of the framework's testability. You just saw that when put up two statements, one checkable and one not, and ask which is a Sim(t).
> Last time we said: A design that never enters that cell is not adjudicating. This is the next part of that.
...
**What students must not infer.** Whether the trade is worth making.

### 4. Worked example

**The example.** A vague statement sharpened into a checkable prediction.
...
**Completed answer.** A vague statement sharpened into a checkable prediction. — which demonstrates that the rule involves a stateable trade.
...
**Conclusions not licensed.** Whether the trade is worth making.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A statement marked unsharpenable and the reason recorded. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A vague statement forced into a specific unrelated claim. Why is this not an
example?"
...
**Exact student instructions.** Sharpen five vague statements and mark the unsharpenable honestly.
...
- *Licensed conclusion.* That the rule involves a stateable trade.
- *Not licensed.* Whether the trade is worth making.
...
- *Expected response.* That the rule involves a stateable trade.
...
1. Any wording carrying the idea in `The identifiability rule excludes most of mental life, which is simultaneously a serious limitation and the source of the framework's testability`.
...
Say: "The rule trades reach for testability. Name the trade."

**Why this sentence matters.** It is the opening question of Session 19, which assumes students arrive holding it.
...
**File.** `Homework/Session_18_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 17 — The Discriminating Condition |
| **Leads to** | Session 19 — The Critique Memo, Drafted |

**Transition in.** Session 17 established students locate where the four accounts come apart. This session uses that as the starting point.

**Transition out.** This session establishes students apply the rule at research standard. Session 19 assumes it and builds students evaluate one specific claim in writing.
