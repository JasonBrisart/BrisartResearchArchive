# Session 17 — The Discriminating Condition
...
| | |
|---|---|
| **Central question** | The Discriminating Condition: students locate where the four accounts come apart? |
| **Core concept** | The discriminating condition requires identifiable content, high intensity, resolved uncertainty, and novelty simultaneously. |
| **Student outcome** | Students locate where the four accounts come apart. |
| **Previous session** | Session 16 — Consistency Is Not Evidence |
| **Next session** | Session 18 — The Identifiability Rule |
| **Materials** | Index cards for standing objections; the full specification, printed |
| **Preparation** | thirty minutes |
| **Student printout** | `Printouts/Session_17_Printout.md` |
| **Homework** | `Homework/Session_17_Homework.md` |

## Why this lesson exists

**The conceptual step.** The discriminating condition requires identifiable content, high intensity, resolved uncertainty, and novelty simultaneously. Few designs enter it and most students discover theirs does not.
...
**What depends on it.** Session 18 — The Identifiability Rule — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The discriminating condition requires identifiable content, high intensity, resolved uncertainty, and novelty simultaneously. Few designs enter it and most students discover theirs does not.
...
1. A condition meeting all four criteria.
2. An honest statement that the student's design does not enter it.

### One non-example

A claim of entry meeting three of the four criteria.
...
That the condition is specifiable and rarely entered.
...
| Statement | Status |
|---|---|
| The discriminating condition requires identifiable content, high intensity, resolved uncertainty, and novelty simultaneously. | Framework-derived, appropriate at this grade |
| That the condition is specifiable and rarely entered. | What this specific activity can show |
| How often it occurs naturally. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 16 — Consistency Is Not Evidence — specifically: students find their own results fit the rivals equally well.

**How it was taught.** Through the activity: apply all three rivals to three of their own results

**Quick check.** Ask for the closing sentence of Session 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 16: apply all three rivals to three of their own results, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A condition meeting all four criteria. |
| **Non-example** | A claim of entry meeting three of the four criteria. |
...
**Student materials.** One copy of `Printouts/Session_17_Printout.md` per student.

**Prior student data required.** Work produced in Session 16, kept in the student's folder.
...
**File.** `Printouts/Session_17_Printout.md`
...
> "This is the most useful disappointment of the course."
...
**Exact wording.** "Ask under what conditions the framework predicts differently from all three."
...
**Target observation.** That the condition is specifiable and rarely entered.
...
> "The discriminating condition requires identifiable content, high intensity, resolved uncertainty, and novelty simultaneously. You just saw that when ask under what conditions the framework predicts differently from all three.
> Last time we said: This is the most useful disappointment of the course. This is the next part of that.
...
**What students must not infer.** How often it occurs naturally.

### 4. Worked example

**The example.** A condition meeting all four criteria.
...
**Completed answer.** A condition meeting all four criteria. — which demonstrates that the condition is specifiable and rarely entered.
...
**Conclusions not licensed.** How often it occurs naturally.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An honest statement that the student's design does not enter it. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim of entry meeting three of the four criteria. Why is this not an
example?"
...
**Exact student instructions.** Identify the condition and state whether their design enters it.
...
- *Licensed conclusion.* That the condition is specifiable and rarely entered.
- *Not licensed.* How often it occurs naturally.
...
- *Expected response.* That the condition is specifiable and rarely entered.
...
1. Any wording carrying the idea in `The discriminating condition requires identifiable content, high intensity, resolved uncertainty, and novelty simultaneously`.
...
Say: "A design that never enters that cell is not adjudicating."

**Why this sentence matters.** It is the opening question of Session 18, which assumes students arrive holding it.
...
**File.** `Homework/Session_17_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 16 — Consistency Is Not Evidence |
| **Leads to** | Session 18 — The Identifiability Rule |

**Transition in.** Session 16 established students find their own results fit the rivals equally well. This session uses that as the starting point.

**Transition out.** This session establishes students locate where the four accounts come apart. Session 18 assumes it and builds students apply the rule at research standard.
