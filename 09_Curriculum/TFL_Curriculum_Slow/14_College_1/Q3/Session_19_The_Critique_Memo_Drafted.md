# Session 19 — The Critique Memo, Drafted
...
| | |
|---|---|
| **Central question** | The Critique Memo, Drafted: students evaluate one specific claim in writing? |
| **Core concept** | A critique memo states its target fairly before criticising it. |
| **Student outcome** | Students evaluate one specific claim in writing. |
| **Previous session** | Session 18 — The Identifiability Rule |
| **Next session** | Session 20 — The Critique Memo, Finished |
...
**The conceptual step.** A critique memo states its target fairly before criticising it. A reader should not be able to infer the author's position from the claim statement.
...
**What depends on it.** Session 20 — The Critique Memo, Finished — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A critique memo states its target fairly before criticising it. A reader should not be able to infer the author's position from the claim statement.
...
1. A claim statement a reader could not attribute to either side.
2. A statement revised after a reader detected the author's position.

### One non-example

A claim statement using dismissive qualifiers.
...
That fair statement is testable by a reader.
...
| Statement | Status |
|---|---|
| A critique memo states its target fairly before criticising it. | Framework-derived, appropriate at this grade |
| That fair statement is testable by a reader. | What this specific activity can show |
| Whether the claim is true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 18 — The Identifiability Rule — specifically: students apply the rule at research standard.

**How it was taught.** Through the activity: sharpen five vague statements and mark the unsharpenable honestly

**Quick check.** Ask for the closing sentence of Session 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 18: sharpen five vague statements and mark the unsharpenable honestly, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A claim statement a reader could not attribute to either side. |
| **Non-example** | A claim statement using dismissive qualifiers. |
...
> "The rule trades reach for testability. Name the trade."
...
**Exact wording.** "Say: one claim, not the framework. State it as its author would."
...
**Target observation.** That fair statement is testable by a reader.
...
> "A critique memo states its target fairly before criticising it. You just saw that when say: one claim, not the framework.
> Last time we said: The rule trades reach for testability. Name the trade. This is the next part of that.
...
**The example.** A claim statement a reader could not attribute to either side.
...
**Completed answer.** A claim statement a reader could not attribute to either side. — which demonstrates that fair statement is testable by a reader.
...
**Teacher prompt.** "Here is a second case. A statement revised after a reader detected the author's position. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim statement using dismissive qualifiers. Why is this not an
example?"
...
**Exact student instructions.** Draft sections one and two, with peer feedback on whether the claim statement is fair.
...
- *Licensed conclusion.* That fair statement is testable by a reader.
...
- *Expected response.* That fair statement is testable by a reader.
...
1. Any wording carrying the idea in `A critique memo states its target fairly before criticising it`.
...
Say: "If a reader can tell from section one which side you take, rewrite it."
...
| | |
|---|---|
| **Follows** | Session 18 — The Identifiability Rule |
| **Leads to** | Session 20 — The Critique Memo, Finished |

**Transition in.** Session 18 established students apply the rule at research standard. This session uses that as the starting point.

**Transition out.** This session establishes students evaluate one specific claim in writing. Session 20 assumes it and builds students complete a five-section critique memo.
