# Session 21 — Scope And Invalid Application
...
| | |
|---|---|
| **Central question** | Scope And Invalid Application: students reject invalid applications formally? |
| **Core concept** | Over-application is the failure mode of capable students specifically, because they see connections everywhere. |
| **Student outcome** | Students reject invalid applications formally. |
| **Previous session** | Session 20 — The Critique Memo, Finished |
| **Next session** | Session 22 — Falsification Conditions |
| **Materials** | Index cards for standing objections; the full specification, printed |
| **Preparation** | thirty minutes |
| **Student printout** | `Printouts/Session_21_Printout.md` |
| **Homework** | `Homework/Session_21_Homework.md` |

## Why this lesson exists

**The conceptual step.** Over-application is the failure mode of capable students specifically, because they see connections everywhere. A formal rejection names the boundary and redirects.
...
**What depends on it.** Session 22 — Falsification Conditions — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Over-application is the failure mode of capable students specifically, because they see connections everywhere. A formal rejection names the boundary and redirects.
...
1. A rejection naming the clinical exclusion and redirecting.
2. A rejection naming the timescale boundary.

### One non-example

A rejection that dismisses without redirecting.
...
That rejection is redirection rather than dismissal.

### What this activity does not establish

Whether the redirected question is tractable.
...
| Statement | Status |
|---|---|
| Over-application is the failure mode of capable students specifically, because they see connections everywhere. | Framework-derived, appropriate at this grade |
| That rejection is redirection rather than dismissal. | What this specific activity can show |
| Whether the redirected question is tractable. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 20 — The Critique Memo, Finished — specifically: students complete a five-section critique memo.

**How it was taught.** Through the activity: complete all five sections and submit

**Quick check.** Ask for the closing sentence of Session 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 20: complete all five sections and submit, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A rejection naming the clinical exclusion and redirecting. |
| **Non-example** | A rejection that dismisses without redirecting. |
...
**Student materials.** One copy of `Printouts/Session_21_Printout.md` per student.

**Prior student data required.** Work produced in Session 20, kept in the student's folder.
...
**File.** `Printouts/Session_21_Printout.md`
...
> "A memo that advocates without a falsification condition cannot pass."
...
**Exact wording.** "Put six proposals up, voted before discussion. Four are traps."
...
**Target observation.** That rejection is redirection rather than dismissal.
...
> "Over-application is the failure mode of capable students specifically, because they see connections everywhere. You just saw that when put six proposals up, voted before discussion.
> Last time we said: A memo that advocates without a falsification condition cannot pass. This is the next part of that.
...
**What students must not infer.** Whether the redirected question is tractable.

### 4. Worked example

**The example.** A rejection naming the clinical exclusion and redirecting.
...
**Completed answer.** A rejection naming the clinical exclusion and redirecting. — which demonstrates that rejection is redirection rather than dismissal.
...
**Conclusions not licensed.** Whether the redirected question is tractable.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A rejection naming the timescale boundary. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rejection that dismisses without redirecting. Why is this not an
example?"
...
**Exact student instructions.** Write three formal rejections with boundary and alternative level.
...
- *Licensed conclusion.* That rejection is redirection rather than dismissal.
- *Not licensed.* Whether the redirected question is tractable.
...
- *Expected response.* That rejection is redirection rather than dismissal.
...
1. Any wording carrying the idea in `Over-application is the failure mode of capable students specifically, because they see connections everywhere`.
...
Say: "Capable students over-apply more than struggling ones."

**Why this sentence matters.** It is the opening question of Session 22, which assumes students arrive holding it.
...
**File.** `Homework/Session_21_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 20 — The Critique Memo, Finished |
| **Leads to** | Session 22 — Falsification Conditions |

**Transition in.** Session 20 established students complete a five-section critique memo. This session uses that as the starting point.

**Transition out.** This session establishes students reject invalid applications formally. Session 22 assumes it and builds students write conditions meeting all four requirements.
