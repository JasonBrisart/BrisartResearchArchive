# Session 20 Homework — The Critique Memo, Finished

**College Year 1** · The Framework and Its Status · **Quarter 3**
**Follows:** Session 20 — The Critique Memo, Finished · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 20 ended on, from memory:
...
Complete all five sections and submit.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** section four precedes any advocacy in section five
...
Session 21 is **Scope And Invalid Application**, which assumes you arrive holding it. Write one thing you expect it to be about:
