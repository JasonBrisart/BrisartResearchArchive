# Session 4 — Is This Worth Studying
...
| | |
|---|---|
| **Central question** | Is This Worth Studying: students argue both sides of whether pre-validation study is a misallocation? |
| **Core concept** | Whether to study an unvalidated framework is a genuine methodological question with arguments on both sides. |
| **Student outcome** | Students argue both sides of whether pre-validation study is a misallocation. |
| **Previous session** | Session 3 — Reading The Specification Closely |
| **Next session** | Session 5 — The Five Variables At Adult Scale |
...
**The conceptual step.** Whether to study an unvalidated framework is a genuine methodological question with arguments on both sides. The instructor withholding a position is what makes the argument real.
...
**What depends on it.** Session 5 — The Five Variables At Adult Scale — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Whether to study an unvalidated framework is a genuine methodological question with arguments on both sides. The instructor withholding a position is what makes the argument real.
...
1. An argument that pre-validation study builds transferable method skills.
2. An argument that attention is better spent on established work.

### One non-example

A position adopted because the instructor seemed to favour it.
...
| Statement | Status |
|---|---|
| Whether to study an unvalidated framework is a genuine methodological question with arguments on both sides. | Framework-derived, appropriate at this grade |
| That the question is genuinely open. | What this specific activity can show |
| Which position is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 3 — Reading The Specification Closely — specifically: students separate checkable claims from unchecked ones.

**How it was taught.** Through the activity: produce the two lists and pool the second on the board

**Quick check.** Ask for the closing sentence of Session 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 3: produce the two lists and pool the second on the board, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An argument that pre-validation study builds transferable method skills. |
| **Non-example** | A position adopted because the instructor seemed to favour it. |
...
> "That second list is this year's raw material."
...
**Exact wording.** "Assign two positions, have them presented, then open the floor. Take no side."
...
**Target observation.** That the question is genuinely open.
...
> "Whether to study an unvalidated framework is a genuine methodological question with arguments on both sides. You just saw that when assign two positions, have them presented, then open the floor.
> Last time we said: That second list is this year's raw material. This is the next part of that.
...
**The example.** An argument that pre-validation study builds transferable method skills.
...
**Completed answer.** An argument that pre-validation study builds transferable method skills. — which demonstrates that the question is genuinely open.
...
**Teacher prompt.** "Here is a second case. An argument that attention is better spent on established work. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A position adopted because the instructor seemed to favour it. Why is this not an
example?"
...
**Exact student instructions.** Write their own position with reasons and the strongest reason against it.
...
- *Licensed conclusion.* That the question is genuinely open.
...
- *Expected response.* That the question is genuinely open.
...
1. Any wording carrying the idea in `Whether to study an unvalidated framework is a genuine methodological question with arguments on both sides`.
...
Say: "If the first position convinces you, say so in your memo. That is harder to write."
...
| | |
|---|---|
| **Follows** | Session 3 — Reading The Specification Closely |
| **Leads to** | Session 5 — The Five Variables At Adult Scale |

**Transition in.** Session 3 established students separate checkable claims from unchecked ones. This session uses that as the starting point.

**Transition out.** This session establishes students argue both sides of whether pre-validation study is a misallocation. Session 5 assumes it and builds students map the declared set with research-grade specificity.
