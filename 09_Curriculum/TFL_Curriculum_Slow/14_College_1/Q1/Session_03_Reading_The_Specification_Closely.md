# Session 3 — Reading The Specification Closely
...
| | |
|---|---|
| **Central question** | Reading The Specification Closely: students separate checkable claims from unchecked ones? |
| **Core concept** | A specification contains claims that are checkable against observations and claims that are not. |
| **Student outcome** | Students separate checkable claims from unchecked ones. |
| **Previous session** | Session 2 — Stating Status Accurately |
| **Next session** | Session 4 — Is This Worth Studying |
...
**The conceptual step.** A specification contains claims that are checkable against observations and claims that are not. Separating them is the first analytical act rather than a judgement of quality.
...
**What depends on it.** Session 4 — Is This Worth Studying — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A specification contains claims that are checkable against observations and claims that are not. Separating them is the first analytical act rather than a judgement of quality.
...
1. A checkable claim about recurrence after contradiction.
2. An unchecked claim about the persistence threshold's value.

### One non-example

Marking every claim as unchecked because none has been tested.
...
That claims differ in checkability independent of their truth.
...
| Statement | Status |
|---|---|
| A specification contains claims that are checkable against observations and claims that are not. | Framework-derived, appropriate at this grade |
| That claims differ in checkability independent of their truth. | What this specific activity can show |
| Which claims are true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 2 — Stating Status Accurately — specifically: students state the status without overclaiming or underclaiming.

**How it was taught.** Through the activity: write the three-sentence statement, then rewrite for a supervisor, a journal, and a general reader

**Quick check.** Ask for the closing sentence of Session 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 2: write the three-sentence statement, then rewrite for a supervisor, a journal, and a general reader, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A checkable claim about recurrence after contradiction. |
| **Non-example** | Marking every claim as unchecked because none has been tested. |
...
> "Underclaiming is the one this room will get wrong."
...
**Exact wording.** "Say: you read it. Today we treat it as a text, not as content to absorb."
...
**Target observation.** That claims differ in checkability independent of their truth.
...
> "A specification contains claims that are checkable against observations and claims that are not. You just saw that when say: you read it.
> Last time we said: Underclaiming is the one this room will get wrong. This is the next part of that.
...
**What students must not infer.** Which claims are true.

### 4. Worked example

**The example.** A checkable claim about recurrence after contradiction.
...
**Completed answer.** A checkable claim about recurrence after contradiction. — which demonstrates that claims differ in checkability independent of their truth.
...
**Conclusions not licensed.** Which claims are true.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An unchecked claim about the persistence threshold's value. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Marking every claim as unchecked because none has been tested. Why is this not an
example?"
...
**Exact student instructions.** Produce the two lists and pool the second on the board.
...
- *Licensed conclusion.* That claims differ in checkability independent of their truth.
- *Not licensed.* Which claims are true.
...
- *Expected response.* That claims differ in checkability independent of their truth.
...
1. Any wording carrying the idea in `A specification contains claims that are checkable against observations and claims that are not`.
...
Say: "That second list is this year's raw material."
...
| | |
|---|---|
| **Follows** | Session 2 — Stating Status Accurately |
| **Leads to** | Session 4 — Is This Worth Studying |

**Transition in.** Session 2 established students state the status without overclaiming or underclaiming. This session uses that as the starting point.

**Transition out.** This session establishes students separate checkable claims from unchecked ones. Session 4 assumes it and builds students argue both sides of whether pre-validation study is a misallocation.
