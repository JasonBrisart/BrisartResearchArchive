# Session 2 — Stating Status Accurately
...
| | |
|---|---|
| **Central question** | Stating Status Accurately: students state the status without overclaiming or underclaiming? |
| **Core concept** | Overclaiming and underclaiming are both errors. |
| **Student outcome** | Students state the status without overclaiming or underclaiming. |
| **Previous session** | Session 1 — The Uncomfortable Opening |
| **Next session** | Session 3 — Reading The Specification Closely |
...
**The conceptual step.** Overclaiming and underclaiming are both errors. Academic training pushes students toward dismissal, which is why underclaiming is the more common failure in this room.
...
**What depends on it.** Session 3 — Reading The Specification Closely — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Overclaiming and underclaiming are both errors. Academic training pushes students toward dismissal, which is why underclaiming is the more common failure in this room.
...
1. A statement calling it formally specified and unvalidated.
2. A journal version stating both properties without hedging.

### One non-example

A statement calling it one person's private speculation.
...
That accuracy has two failure directions.

### What this activity does not establish

Whether the framework deserves attention.
...
| Statement | Status |
|---|---|
| Overclaiming and underclaiming are both errors. | Framework-derived, appropriate at this grade |
| That accuracy has two failure directions. | What this specific activity can show |
| Whether the framework deserves attention. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 1 — The Uncomfortable Opening — specifically: students receive and record the framework's epistemic status.

**How it was taught.** Through the activity: each student writes their single strongest objection on a named card, returned at Session 25

**Quick check.** Ask for the closing sentence of Session 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 1: each student writes their single strongest objection on a named card, returned at Session 25, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A statement calling it formally specified and unvalidated. |
| **Non-example** | A statement calling it one person's private speculation. |
...
> "You have never been shown a framework at this stage before it was decided."
...
**Exact wording.** "Put three status statements on the board and ask which is correct. Most pick the underclaiming one."
...
**Target observation.** That accuracy has two failure directions.
...
> "Overclaiming and underclaiming are both errors. You just saw that when put three status statements on the board and ask which is correct.
> Last time we said: You have never been shown a framework at this stage before it was decided. This is the next part of that.
...
**What students must not infer.** Whether the framework deserves attention.

### 4. Worked example

**The example.** A statement calling it formally specified and unvalidated.
...
**Completed answer.** A statement calling it formally specified and unvalidated. — which demonstrates that accuracy has two failure directions.
...
**Conclusions not licensed.** Whether the framework deserves attention.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A journal version stating both properties without hedging. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A statement calling it one person's private speculation. Why is this not an
example?"
...
**Exact student instructions.** Write the three-sentence statement, then rewrite for a supervisor, a journal, and a general reader.
...
- *Licensed conclusion.* That accuracy has two failure directions.
- *Not licensed.* Whether the framework deserves attention.
...
- *Expected response.* That accuracy has two failure directions.
...
1. Any wording carrying the idea in `Overclaiming and underclaiming are both errors`.
...
Say: "Underclaiming is the one this room will get wrong."
...
| | |
|---|---|
| **Follows** | Session 1 — The Uncomfortable Opening |
| **Leads to** | Session 3 — Reading The Specification Closely |

**Transition in.** Session 1 established students receive and record the framework's epistemic status. This session uses that as the starting point.

**Transition out.** This session establishes students state the status without overclaiming or underclaiming. Session 3 assumes it and builds students separate checkable claims from unchecked ones.
