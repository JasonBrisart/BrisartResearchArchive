# Session 3 Homework — Reading The Specification Closely

**College Year 1** · The Framework and Its Status · **Quarter 1**
**Follows:** Session 3 — Reading The Specification Closely · **Points:** 5 · **Optional:** yes
...
Produce the two lists and pool the second on the board.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the pooled list contains at least four genuinely unchecked claims
...
Session 4 is **Is This Worth Studying**, which assumes you arrive holding it. Write one thing you expect it to be about:
