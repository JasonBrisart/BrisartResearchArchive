# Session 5 — The Five Variables At Adult Scale

**College Year 1** · The Framework and Its Status · **Quarter 1** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Five Variables At Adult Scale: students map the declared set with research-grade specificity? |
| **Core concept** | At research standard a Sim(t) must be checkable by a third party who was not present. |
| **Student outcome** | Students map the declared set with research-grade specificity. |
| **Previous session** | Session 4 — Is This Worth Studying |
| **Next session** | Session 6 — Belief At Adult Scale |
...
**The conceptual step.** At research standard a Sim(t) must be checkable by a third party who was not present. Most everyday mental content fails this, and marking the failures maps the boundary.
...
**What depends on it.** Session 6 — Belief At Adult Scale — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

At research standard a Sim(t) must be checkable by a third party who was not present. Most everyday mental content fails this, and marking the failures maps the boundary.
...
1. A Sim(t) a third party could verify against the outcome.
2. A moment marked unmappable because only a mood was present.

### One non-example

A mood recorded as a simulation because it felt predictive.
...
That research standard is higher than classroom standard.

### What this activity does not establish

Whether the unmappable moments matter.
...
| Statement | Status |
|---|---|
| At research standard a Sim(t) must be checkable by a third party who was not present. | Framework-derived, appropriate at this grade |
| That research standard is higher than classroom standard. | What this specific activity can show |
| Whether the unmappable moments matter. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 4 — Is This Worth Studying — specifically: students argue both sides of whether pre-validation study is a misallocation.

**How it was taught.** Through the activity: write their own position with reasons and the strongest reason against it

**Quick check.** Ask for the closing sentence of Session 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 4: write their own position with reasons and the strongest reason against it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Sim(t) a third party could verify against the outcome. |
| **Non-example** | A mood recorded as a simulation because it felt predictive. |
...
> "If the first position convinces you, say so in your memo. That is harder to write."
...
**Exact wording.** "Say: you have known these names since Grade 6. The standard changes today."
...
**Target observation.** That research standard is higher than classroom standard.
...
> "At research standard a Sim(t) must be checkable by a third party who was not present. You just saw that when say: you have known these names since Grade 6.
> Last time we said: If the first position convinces you, say so in your memo. That is harder to write. This is the next part of that.
...
**What students must not infer.** Whether the unmappable moments matter.

### 4. Worked example

**The example.** A Sim(t) a third party could verify against the outcome.
...
**Completed answer.** A Sim(t) a third party could verify against the outcome. — which demonstrates that research standard is higher than classroom standard.
...
**Conclusions not licensed.** Whether the unmappable moments matter.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A moment marked unmappable because only a mood was present. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A mood recorded as a simulation because it felt predictive. Why is this not an
example?"
...
**Exact student instructions.** Map three moments with third-party-checkable Sim(t) and mark any that fail.
...
- *Licensed conclusion.* That research standard is higher than classroom standard.
- *Not licensed.* Whether the unmappable moments matter.
...
- *Expected response.* That research standard is higher than classroom standard.
...
1. Any wording carrying the idea in `At research standard a Sim(t) must be checkable by a third party who was not present`.
...
Say: "Marking one unmappable is the useful result."
...
| | |
|---|---|
| **Follows** | Session 4 — Is This Worth Studying |
| **Leads to** | Session 6 — Belief At Adult Scale |

**Transition in.** Session 4 established students argue both sides of whether pre-validation study is a misallocation. This session uses that as the starting point.

**Transition out.** This session establishes students map the declared set with research-grade specificity. Session 6 assumes it and builds students state Belief(t)'s different status from the five signals.
