# Session 20 Homework — The Redundancy Verdict

**College Year 3** · Adjudication · **Quarter 3**
**Follows:** Session 20 — The Redundancy Verdict · **Points:** 5 · **Optional:** yes
...
Write a verdict on the redundancy charge, supported by their own prediction.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every verdict is supported by a specific differential prediction
...
Session 21 is **Adjudication In Your Own Field**, which assumes you arrive holding it. Write one thing you expect it to be about:
