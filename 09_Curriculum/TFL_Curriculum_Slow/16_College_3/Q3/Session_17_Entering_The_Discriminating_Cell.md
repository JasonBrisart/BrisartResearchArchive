# Session 17 — Entering The Discriminating Cell
...
| | |
|---|---|
| **Central question** | Entering The Discriminating Cell: students redesign to enter the discriminating condition? |
| **Core concept** | Entering the discriminating cell costs naturalness, sample availability, or effort. |
| **Student outcome** | Students redesign to enter the discriminating condition. |
| **Previous session** | Session 16 — Repairing The Rival |
| **Next session** | Session 18 — Predictions For Every Account |
...
**The conceptual step.** Entering the discriminating cell costs naturalness, sample availability, or effort. The cost must be stated as part of the redesign.
...
**What depends on it.** Session 18 — Predictions For Every Account — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Entering the discriminating cell costs naturalness, sample availability, or effort. The cost must be stated as part of the redesign.
...
1. A redesign meeting all four criteria with the cost stated.
2. A cost stated as substantially reduced ecological validity.

### One non-example

A redesign claiming entry on three of four criteria.
...
That entry is achievable at a stateable cost.
...
| Statement | Status |
|---|---|
| Entering the discriminating cell costs naturalness, sample availability, or effort. | Framework-derived, appropriate at this grade |
| That entry is achievable at a stateable cost. | What this specific activity can show |
| Whether the cost is worth paying. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 16 — Repairing The Rival — specifically: students strengthen a rival they had weakened.

**How it was taught.** Through the activity: restate the weakened rival and re-derive its prediction

**Quick check.** Ask for the closing sentence of Session 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 16: restate the weakened rival and re-derive its prediction, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A redesign meeting all four criteria with the cost stated. |
| **Non-example** | A redesign claiming entry on three of four criteria. |
...
> "A fair rival often predicts something different from the weak one."
...
**Exact wording.** "Say: your design does not enter the cell. Fix it and state the cost."
...
**Target observation.** That entry is achievable at a stateable cost.
...
> "Entering the discriminating cell costs naturalness, sample availability, or effort. You just saw that when say: your design does not enter the cell.
> Last time we said: A fair rival often predicts something different from the weak one. This is the next part of that.
...
**What students must not infer.** Whether the cost is worth paying.

### 4. Worked example

**The example.** A redesign meeting all four criteria with the cost stated.
...
**Completed answer.** A redesign meeting all four criteria with the cost stated. — which demonstrates that entry is achievable at a stateable cost.
...
**Conclusions not licensed.** Whether the cost is worth paying.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A cost stated as substantially reduced ecological validity. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A redesign claiming entry on three of four criteria. Why is this not an
example?"
...
**Exact student instructions.** Redesign to enter the cell and state what entry costs.
...
- *Licensed conclusion.* That entry is achievable at a stateable cost.
- *Not licensed.* Whether the cost is worth paying.
...
- *Expected response.* That entry is achievable at a stateable cost.
...
1. Any wording carrying the idea in `Entering the discriminating cell costs naturalness, sample availability, or effort`.
...
Say: "Entering the cell costs something. Say what."
...
| | |
|---|---|
| **Follows** | Session 16 — Repairing The Rival |
| **Leads to** | Session 18 — Predictions For Every Account |

**Transition in.** Session 16 established students strengthen a rival they had weakened. This session uses that as the starting point.

**Transition out.** This session establishes students redesign to enter the discriminating condition. Session 18 assumes it and builds students derive predictions for five accounts including field rivals.
