# Session 16 — Repairing The Rival
...
| | |
|---|---|
| **Central question** | Repairing The Rival: students strengthen a rival they had weakened? |
| **Core concept** | Strengthening a rival usually changes its predictions. |
| **Student outcome** | Students strengthen a rival they had weakened. |
| **Previous session** | Session 15 — The Fairness Audit |
| **Next session** | Session 17 — Entering The Discriminating Cell |
...
**The conceptual step.** Strengthening a rival usually changes its predictions. Restating without re-deriving leaves the original weak prediction in place.
...
**What depends on it.** Session 17 — Entering The Discriminating Cell — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Strengthening a rival usually changes its predictions. Restating without re-deriving leaves the original weak prediction in place.
...
1. A strengthened rival whose prediction now differs.
2. A prediction recalculated after the restatement.

### One non-example

A rival restated with the original prediction retained.
...
That strengthening changes predictions.
...
| Statement | Status |
|---|---|
| Strengthening a rival usually changes its predictions. | Framework-derived, appropriate at this grade |
| That strengthening changes predictions. | What this specific activity can show |
| Which prediction is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 15 — The Fairness Audit — specifically: students audit whether a rival was given a fair test.

**How it was taught.** Through the activity: audit three designs for fair operationalisation and mark every weakening

**Quick check.** Ask for the closing sentence of Session 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 15: audit three designs for fair operationalisation and mark every weakening, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A strengthened rival whose prediction now differs. |
| **Non-example** | A rival restated with the original prediction retained. |
...
> "Operationalising the rival to lose is the commonest integrity failure."
...
**Exact wording.** "Say: your rival was weakened. Restate it at full strength."
...
**Target observation.** That strengthening changes predictions.
...
> "Strengthening a rival usually changes its predictions. You just saw that when say: your rival was weakened.
> Last time we said: Operationalising the rival to lose is the commonest integrity failure. This is the next part of that.
...
**The example.** A strengthened rival whose prediction now differs.
...
**Completed answer.** A strengthened rival whose prediction now differs. — which demonstrates that strengthening changes predictions.
...
**Teacher prompt.** "Here is a second case. A prediction recalculated after the restatement. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rival restated with the original prediction retained. Why is this not an
example?"
...
**Exact student instructions.** Restate the weakened rival and re-derive its prediction.
...
- *Licensed conclusion.* That strengthening changes predictions.
...
- *Expected response.* That strengthening changes predictions.
...
1. Any wording carrying the idea in `Strengthening a rival usually changes its predictions`.
...
Say: "A fair rival often predicts something different from the weak one."
...
| | |
|---|---|
| **Follows** | Session 15 — The Fairness Audit |
| **Leads to** | Session 17 — Entering The Discriminating Cell |

**Transition in.** Session 15 established students audit whether a rival was given a fair test. This session uses that as the starting point.

**Transition out.** This session establishes students strengthen a rival they had weakened. Session 17 assumes it and builds students redesign to enter the discriminating condition.
