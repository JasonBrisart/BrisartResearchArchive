# Session 21 — Adjudication In Your Own Field
...
| | |
|---|---|
| **Central question** | Adjudication In Your Own Field: students find an adjudication contest in their own discipline? |
| **Core concept** | Real adjudication attempts exist in every discipline. |
| **Student outcome** | Students find an adjudication contest in their own discipline. |
| **Previous session** | Session 20 — The Redundancy Verdict |
| **Next session** | Session 22 — When Adjudication Fails |
...
**The conceptual step.** Real adjudication attempts exist in every discipline. Analysing one shows how the methodological content applies outside this framework.
...
**What depends on it.** Session 22 — When Adjudication Fails — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Real adjudication attempts exist in every discipline. Analysing one shows how the methodological content applies outside this framework.
...
1. A contested adjudication from the student's literature.
2. An analysis of what the study did and did not settle.

### One non-example

A settled contest chosen because the outcome is known.
...
That adjudication is a general disciplinary practice.
...
| Statement | Status |
|---|---|
| Real adjudication attempts exist in every discipline. | Framework-derived, appropriate at this grade |
| That adjudication is a general disciplinary practice. | What this specific activity can show |
| Which account won. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 20 — The Redundancy Verdict — specifically: students deliver a verdict on whether the framework adds anything.

**How it was taught.** Through the activity: write a verdict on the redundancy charge, supported by their own prediction

**Quick check.** Ask for the closing sentence of Session 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 20: write a verdict on the redundancy charge, supported by their own prediction, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A contested adjudication from the student's literature. |
| **Non-example** | A settled contest chosen because the outcome is known. |
...
> "Either answer is fine. Assertion is not."
...
**Exact wording.** "Ask them to find two accounts in their field that somebody tried to separate."
...
**Target observation.** That adjudication is a general disciplinary practice.
...
> "Real adjudication attempts exist in every discipline. You just saw that when ask them to find two accounts in their field that somebody tried to separate.
> Last time we said: Either answer is fine. Assertion is not. This is the next part of that.
...
**What students must not infer.** Which account won.

### 4. Worked example

**The example.** A contested adjudication from the student's literature.
...
**Completed answer.** A contested adjudication from the student's literature. — which demonstrates that adjudication is a general disciplinary practice.
...
**Conclusions not licensed.** Which account won.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An analysis of what the study did and did not settle. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A settled contest chosen because the outcome is known. Why is this not an
example?"
...
**Exact student instructions.** Analyse one real adjudication attempt from their own literature.
...
- *Licensed conclusion.* That adjudication is a general disciplinary practice.
- *Not licensed.* Which account won.
...
- *Expected response.* That adjudication is a general disciplinary practice.
...
1. Any wording carrying the idea in `Real adjudication attempts exist in every discipline`.
...
Say: "This is what your field does when two accounts compete."
...
| | |
|---|---|
| **Follows** | Session 20 — The Redundancy Verdict |
| **Leads to** | Session 22 — When Adjudication Fails |

**Transition in.** Session 20 established students deliver a verdict on whether the framework adds anything. This session uses that as the starting point.

**Transition out.** This session establishes students find an adjudication contest in their own discipline. Session 22 assumes it and builds students analyse designs that could not separate accounts.
