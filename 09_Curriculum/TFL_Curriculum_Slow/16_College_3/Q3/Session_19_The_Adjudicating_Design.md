# Session 19 — The Adjudicating Design

**College Year 3** · Adjudication · **Quarter 3** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Adjudicating Design: students present a design distinguishing all accounts? |
| **Core concept** | Fair operationalisation is defended by naming who checked it and what they said, not by citing the author's intention to be fair. |
| **Student outcome** | Students present a design distinguishing all accounts. |
| **Previous session** | Session 18 — Predictions For Every Account |
| **Next session** | Session 20 — The Redundancy Verdict |
| **Materials** | Discipline readings selected by the instructor; printed differential tables |
| **Preparation** | thirty minutes |
| **Student printout** | `Printouts/Session_19_Printout.md` |
| **Homework** | `Homework/Session_19_Homework.md` |

## Why this lesson exists

**The conceptual step.** Fair operationalisation is defended by naming who checked it and what they said, not by citing the author's intention to be fair.
...
**What depends on it.** Session 20 — The Redundancy Verdict — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Fair operationalisation is defended by naming who checked it and what they said, not by citing the author's intention to be fair.
...
1. A defence naming the assigned defender and their verdict.
2. A presentation answering each rival advocate specifically.

### One non-example

A defence asserting the author tried to be fair.
...
Whether the design adjudicates and can be defended.

### What this activity does not establish

Which account it would favour.
...
| Statement | Status |
|---|---|
| Fair operationalisation is defended by naming who checked it and what they said, not by citing the author's intention to be fair. | Framework-derived, appropriate at this grade |
| Whether the design adjudicates and can be defended. | What this specific activity can show |
| Which account it would favour. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 18 — Predictions For Every Account — specifically: students derive predictions for five accounts including field rivals.

**How it was taught.** Through the activity: complete a five-row prediction table with all rows distinct

**Quick check.** Ask for the closing sentence of Session 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 18: complete a five-row prediction table with all rows distinct, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence naming the assigned defender and their verdict. |
| **Non-example** | A defence asserting the author tried to be fair. |
...
**Student materials.** One copy of `Printouts/Session_19_Printout.md` per student.

**Prior student data required.** Work produced in Session 18, kept in the student's folder.
...
**File.** `Printouts/Session_19_Printout.md`
...
> "Five accounts is a real adjudication."
...
**Exact wording.** "Say: the claim, the rivals, the condition, both directions, and the blind spots."
...
**Target observation.** Whether the design adjudicates and can be defended.
...
> "Fair operationalisation is defended by naming who checked it and what they said, not by citing the author's intention to be fair. You just saw that when say: the claim, the rivals, the condition, both directions, and the blind spots.
> Last time we said: Five accounts is a real adjudication. This is the next part of that.
...
**What students must not infer.** Which account it would favour.

### 4. Worked example

**The example.** A defence naming the assigned defender and their verdict.
...
**Completed answer.** A defence naming the assigned defender and their verdict. — which demonstrates whether the design adjudicates and can be defended.
...
**Conclusions not licensed.** Which account it would favour.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A presentation answering each rival advocate specifically. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence asserting the author tried to be fair. Why is this not an
example?"
...
**Exact student instructions.** An eight-minute presentation facing one question per rival advocate.
...
- *Licensed conclusion.* Whether the design adjudicates and can be defended.
- *Not licensed.* Which account it would favour.
...
- *Expected response.* Whether the design adjudicates and can be defended.
...
1. Any wording carrying the idea in `Fair operationalisation is defended by naming who checked it and what they said, not by citing the author's intention to be fair`.
...
Say: "Next year: what would make you abandon this."

**Why this sentence matters.** It is the opening question of Session 20, which assumes students arrive holding it.
...
**File.** `Homework/Session_19_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 18 — Predictions For Every Account |
| **Leads to** | Session 20 — The Redundancy Verdict |

**Transition in.** Session 18 established students derive predictions for five accounts including field rivals. This session uses that as the starting point.

**Transition out.** This session establishes students present a design distinguishing all accounts. Session 20 assumes it and builds students deliver a verdict on whether the framework adds anything.
