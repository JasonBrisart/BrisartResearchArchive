# Session 25 — The Year In Comparisons
...
| | |
|---|---|
| **Central question** | The Year In Comparisons: students review the year through their own comparisons? |
| **Core concept** | Comparing the first differential table with the latest gives direct evidence of the year's progress in adjudication. |
| **Student outcome** | Students review the year through their own comparisons. |
| **Previous session** | Session 24 — What Would Settle It |
...
**The conceptual step.** Comparing the first differential table with the latest gives direct evidence of the year's progress in adjudication.
...
Comparing the first differential table with the latest gives direct evidence of the year's progress in adjudication.
...
1. A Session 3 table beside a Session 18 one.
2. A student noticing their early rivals were weakened.

### One non-example

Reviewing only the most recent table.
...
That adjudication work improved measurably.
...
| Statement | Status |
|---|---|
| Comparing the first differential table with the latest gives direct evidence of the year's progress in adjudication. | Framework-derived, appropriate at this grade |
| That adjudication work improved measurably. | What this specific activity can show |
| Any external quality standard. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 24 — What Would Settle It — specifically: students state what would resolve the contest.

**How it was taught.** Through the activity: write three requirements for settling the contest, ranked by feasibility

**Quick check.** Ask for the closing sentence of Session 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 24: write three requirements for settling the contest, ranked by feasibility, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Session 3 table beside a Session 18 one. |
| **Non-example** | Reviewing only the most recent table. |
...
> "Naming what would settle it is the contribution."
...
**Exact wording.** "Lay out every differential table from the year."
...
**Target observation.** That adjudication work improved measurably.
...
> "Comparing the first differential table with the latest gives direct evidence of the year's progress in adjudication. You just saw that when lay out every differential table from the year.
> Last time we said: Naming what would settle it is the contribution. This is the next part of that.
...
**The example.** A Session 3 table beside a Session 18 one.
...
**Completed answer.** A Session 3 table beside a Session 18 one. — which demonstrates that adjudication work improved measurably.
...
**Teacher prompt.** "Here is a second case. A student noticing their early rivals were weakened. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reviewing only the most recent table. Why is this not an
example?"
...
**Exact student instructions.** Compare the first table with the latest and write what improved.
...
- *Licensed conclusion.* That adjudication work improved measurably.
...
- *Expected response.* That adjudication work improved measurably.
...
1. Any wording carrying the idea in `Comparing the first differential table with the latest gives direct evidence of the year's progress in adjudication`.
...
Say: "Next year: a capstone that could fail."
...
| | |
|---|---|
| **Follows** | Session 24 — What Would Settle It |
| **Leads to** | Session 26 — Practice Final |

**Transition in.** Session 24 established students state what would resolve the contest. This session uses that as the starting point.

**Transition out.** This session establishes students review the year through their own comparisons. Session 26 assumes it and builds students rehearse the final under conditions.
