# Session 23 Homework — The Honest Comparison

**College Year 3** · Adjudication · **Quarter 4**
**Follows:** Session 23 — The Honest Comparison · **Points:** 5 · **Optional:** yes
...
A comparison document passing the reader test.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** a reader cannot infer the author's preference
...
Session 24 is **What Would Settle It**, which assumes you arrive holding it. Write one thing you expect it to be about:
