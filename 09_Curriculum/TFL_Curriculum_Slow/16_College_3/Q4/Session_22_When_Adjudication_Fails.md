# Session 22 — When Adjudication Fails

**College Year 3** · Adjudication · **Quarter 4** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | When Adjudication Fails: students analyse designs that could not separate accounts? |
| **Core concept** | A design can be meticulously executed and still change nobody's mind if it never entered the discriminating condition. |
| **Student outcome** | Students analyse designs that could not separate accounts. |
| **Previous session** | Session 21 — Adjudication In Your Own Field |
| **Next session** | Session 23 — The Honest Comparison |
...
**The conceptual step.** A design can be meticulously executed and still change nobody's mind if it never entered the discriminating condition. Careful and irrelevant is a real category.
...
**What depends on it.** Session 23 — The Honest Comparison — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A design can be meticulously executed and still change nobody's mind if it never entered the discriminating condition. Careful and irrelevant is a real category.
...
1. A failed adjudication diagnosed as never entering the cell.
2. A failure diagnosed as weakened rival operationalisation.

### One non-example

A failure diagnosed as poor execution.
...
That adjudication failure has diagnosable causes.

### What this activity does not establish

Which account those studies favoured.
...
| Statement | Status |
|---|---|
| A design can be meticulously executed and still change nobody's mind if it never entered the discriminating condition. | Framework-derived, appropriate at this grade |
| That adjudication failure has diagnosable causes. | What this specific activity can show |
| Which account those studies favoured. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 21 — Adjudication In Your Own Field — specifically: students find an adjudication contest in their own discipline.

**How it was taught.** Through the activity: analyse one real adjudication attempt from their own literature

**Quick check.** Ask for the closing sentence of Session 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 21: analyse one real adjudication attempt from their own literature, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A failed adjudication diagnosed as never entering the cell. |
| **Non-example** | A failure diagnosed as poor execution. |
...
> "This is what your field does when two accounts compete."
...
**Exact wording.** "Say: perfectly executed. Changed nobody's mind. Why?"
...
**Target observation.** That adjudication failure has diagnosable causes.
...
> "A design can be meticulously executed and still change nobody's mind if it never entered the discriminating condition. You just saw that when say: perfectly executed.
> Last time we said: This is what your field does when two accounts compete. This is the next part of that.
...
**What students must not infer.** Which account those studies favoured.

### 4. Worked example

**The example.** A failed adjudication diagnosed as never entering the cell.
...
**Completed answer.** A failed adjudication diagnosed as never entering the cell. — which demonstrates that adjudication failure has diagnosable causes.
...
**Conclusions not licensed.** Which account those studies favoured.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A failure diagnosed as weakened rival operationalisation. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A failure diagnosed as poor execution. Why is this not an
example?"
...
**Exact student instructions.** Diagnose three failed adjudications and name the failing requirement.
...
- *Licensed conclusion.* That adjudication failure has diagnosable causes.
- *Not licensed.* Which account those studies favoured.
...
- *Expected response.* That adjudication failure has diagnosable causes.
...
1. Any wording carrying the idea in `A design can be meticulously executed and still change nobody's mind if it never entered the discriminating condition`.
...
Say: "Careful and irrelevant is a real category."
...
| | |
|---|---|
| **Follows** | Session 21 — Adjudication In Your Own Field |
| **Leads to** | Session 23 — The Honest Comparison |

**Transition in.** Session 21 established students find an adjudication contest in their own discipline. This session uses that as the starting point.

**Transition out.** This session establishes students analyse designs that could not separate accounts. Session 23 assumes it and builds students write a comparison that could favour any account.
