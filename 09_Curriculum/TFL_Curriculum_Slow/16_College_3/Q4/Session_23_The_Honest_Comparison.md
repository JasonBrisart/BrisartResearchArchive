# Session 23 — The Honest Comparison
...
| | |
|---|---|
| **Central question** | The Honest Comparison: students write a comparison that could favour any account? |
| **Core concept** | A comparison document should not reveal the author's preference. |
| **Student outcome** | Students write a comparison that could favour any account. |
| **Previous session** | Session 22 — When Adjudication Fails |
| **Next session** | Session 24 — What Would Settle It |
...
**The conceptual step.** A comparison document should not reveal the author's preference. The reader test is the only reliable check, since authors cannot detect their own signalling.
...
**What depends on it.** Session 24 — What Would Settle It — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A comparison document should not reveal the author's preference. The reader test is the only reliable check, since authors cannot detect their own signalling.
...
1. A comparison a reader could not attribute.
2. A document revised after a reader detected the preference.

### One non-example

A comparison using warmer language for one account.
...
That preference-signalling is externally detectable.
...
| Statement | Status |
|---|---|
| A comparison document should not reveal the author's preference. | Framework-derived, appropriate at this grade |
| That preference-signalling is externally detectable. | What this specific activity can show |
| Which account is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 22 — When Adjudication Fails — specifically: students analyse designs that could not separate accounts.

**How it was taught.** Through the activity: diagnose three failed adjudications and name the failing requirement

**Quick check.** Ask for the closing sentence of Session 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 22: diagnose three failed adjudications and name the failing requirement, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A comparison a reader could not attribute. |
| **Non-example** | A comparison using warmer language for one account. |
...
> "Careful and irrelevant is a real category."
...
**Exact wording.** "Say: write it so a reader cannot tell which account you prefer."
...
**Target observation.** That preference-signalling is externally detectable.
...
> "A comparison document should not reveal the author's preference. You just saw that when say: write it so a reader cannot tell which account you prefer.
> Last time we said: Careful and irrelevant is a real category. This is the next part of that.
...
**The example.** A comparison a reader could not attribute.
...
**Completed answer.** A comparison a reader could not attribute. — which demonstrates that preference-signalling is externally detectable.
...
**Teacher prompt.** "Here is a second case. A document revised after a reader detected the preference. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A comparison using warmer language for one account. Why is this not an
example?"
...
**Exact student instructions.** A comparison document passing the reader test.
...
- *Licensed conclusion.* That preference-signalling is externally detectable.
...
- *Expected response.* That preference-signalling is externally detectable.
...
1. Any wording carrying the idea in `A comparison document should not reveal the author's preference`.
...
Say: "If they can tell, rewrite it."
...
| | |
|---|---|
| **Follows** | Session 22 — When Adjudication Fails |
| **Leads to** | Session 24 — What Would Settle It |

**Transition in.** Session 22 established students analyse designs that could not separate accounts. This session uses that as the starting point.

**Transition out.** This session establishes students write a comparison that could favour any account. Session 24 assumes it and builds students state what would resolve the contest.
