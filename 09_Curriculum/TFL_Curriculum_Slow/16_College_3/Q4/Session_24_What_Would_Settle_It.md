# Session 24 — What Would Settle It
...
| | |
|---|---|
| **Central question** | What Would Settle It: students state what would resolve the contest? |
| **Core concept** | Naming what would settle a contest is a more useful contribution than a verdict. |
| **Student outcome** | Students state what would resolve the contest. |
| **Previous session** | Session 23 — The Honest Comparison |
| **Next session** | Session 25 — The Year In Comparisons |
...
**The conceptual step.** Naming what would settle a contest is a more useful contribution than a verdict. Ranking by feasibility separates plans from wishes.
...
**What depends on it.** Session 25 — The Year In Comparisons — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Naming what would settle a contest is a more useful contribution than a verdict. Ranking by feasibility separates plans from wishes.
...
1. A requirement for within-window measurement, ranked infeasible.
2. A requirement for independent replication, ranked feasible.

### One non-example

A verdict that the framework will probably be vindicated.
...
That settling conditions can be named and ranked.

### What this activity does not establish

Which account will win.
...
| Statement | Status |
|---|---|
| Naming what would settle a contest is a more useful contribution than a verdict. | Framework-derived, appropriate at this grade |
| That settling conditions can be named and ranked. | What this specific activity can show |
| Which account will win. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 23 — The Honest Comparison — specifically: students write a comparison that could favour any account.

**How it was taught.** Through the activity: a comparison document passing the reader test

**Quick check.** Ask for the closing sentence of Session 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 23: a comparison document passing the reader test, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A requirement for within-window measurement, ranked infeasible. |
| **Non-example** | A verdict that the framework will probably be vindicated. |
...
**Exact wording.** "Say: not what you believe. What would settle it."
...
**Target observation.** That settling conditions can be named and ranked.
...
> "Naming what would settle a contest is a more useful contribution than a verdict. You just saw that when say: not what you believe.
> Last time we said: If they can tell, rewrite it. This is the next part of that.
...
**What students must not infer.** Which account will win.

### 4. Worked example

**The example.** A requirement for within-window measurement, ranked infeasible.
...
**Completed answer.** A requirement for within-window measurement, ranked infeasible. — which demonstrates that settling conditions can be named and ranked.
...
**Conclusions not licensed.** Which account will win.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A requirement for independent replication, ranked feasible. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A verdict that the framework will probably be vindicated. Why is this not an
example?"
...
**Exact student instructions.** Write three requirements for settling the contest, ranked by feasibility.
...
- *Licensed conclusion.* That settling conditions can be named and ranked.
- *Not licensed.* Which account will win.
...
- *Expected response.* That settling conditions can be named and ranked.
...
1. Any wording carrying the idea in `Naming what would settle a contest is a more useful contribution than a verdict`.
...
Say: "Naming what would settle it is the contribution."
...
| | |
|---|---|
| **Follows** | Session 23 — The Honest Comparison |
| **Leads to** | Session 25 — The Year In Comparisons |

**Transition in.** Session 23 established students write a comparison that could favour any account. This session uses that as the starting point.

**Transition out.** This session establishes students state what would resolve the contest. Session 25 assumes it and builds students review the year through their own comparisons.
