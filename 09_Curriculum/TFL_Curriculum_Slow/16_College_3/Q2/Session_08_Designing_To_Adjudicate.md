...
| | |
|---|---|
| **Central question** | Designing To Adjudicate: students build a design that separates all accounts? |
| **Core concept** | An adjudicating design requires ambiguity manipulated independently of intensity. |
| **Student outcome** | Students build a design that separates all accounts. |
| **Previous session** | Session 7 — The Redundancy Charge |
...
**The conceptual step.** An adjudicating design requires ambiguity manipulated independently of intensity. In natural settings they covary, which is why most designs fail this requirement.
...
An adjudicating design requires ambiguity manipulated independently of intensity. In natural settings they covary, which is why most designs fail this requirement.
...
1. A design varying intensity at fixed ambiguity.
2. Four prediction lines that genuinely differ.

### One non-example

A design where both variables rise together.
...
That adjudication has stateable design requirements.
...
| Statement | Status |
|---|---|
| An adjudicating design requires ambiguity manipulated independently of intensity. | Framework-derived, appropriate at this grade |
| That adjudication has stateable design requirements. | What this specific activity can show |
| Which account the design would favour. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 7 — The Redundancy Charge — specifically: students argue whether the framework adds anything.

**How it was taught.** Through the activity: produce one differential prediction between TFL and a field-standard account

**Quick check.** Ask for the closing sentence of Session 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 7: produce one differential prediction between TFL and a field-standard account, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A design varying intensity at fixed ambiguity. |
| **Non-example** | A design where both variables rise together. |
...
> "This charge is the one most likely to end the framework."
...
**Exact wording.** "State the six requirements, emphasising the third: ambiguity manipulated independently."
...
**Target observation.** That adjudication has stateable design requirements.
...
> "An adjudicating design requires ambiguity manipulated independently of intensity. You just saw that when state the six requirements, emphasising the third: ambiguity manipulated independently.
> Last time we said: This charge is the one most likely to end the framework. This is the next part of that.
...
**The example.** A design varying intensity at fixed ambiguity.
...
**Completed answer.** A design varying intensity at fixed ambiguity. — which demonstrates that adjudication has stateable design requirements.
...
**Teacher prompt.** "Here is a second case. Four prediction lines that genuinely differ. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A design where both variables rise together. Why is this not an
example?"
...
**Exact student instructions.** Draft a full design with predictions stated for every account.
...
- *Licensed conclusion.* That adjudication has stateable design requirements.
...
- *Expected response.* That adjudication has stateable design requirements.
...
1. Any wording carrying the idea in `An adjudicating design requires ambiguity manipulated independently of intensity`.
...
Say: "Identical predictions mean the design does not adjudicate."
...
| | |
|---|---|
| **Follows** | Session 7 — The Redundancy Charge |
| **Leads to** | Session 9 — Confounds And Controls |

**Transition in.** Session 7 established students argue whether the framework adds anything. This session uses that as the starting point.

**Transition out.** This session establishes students build a design that separates all accounts. Session 9 assumes it and builds students identify what would invalidate their result.
