# Session 11 Homework — Answering The Adversarial Round

**College Year 3** · Adjudication · **Quarter 2**
**Follows:** Session 11 — Answering The Adversarial Round · **Points:** 5 · **Optional:** yes
...
Revise the design and state what changed for each landing attack.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student revises against at least two attacks
...
Session 12 is **Both Directions Of Evidence**, which assumes you arrive holding it. Write one thing you expect it to be about:
