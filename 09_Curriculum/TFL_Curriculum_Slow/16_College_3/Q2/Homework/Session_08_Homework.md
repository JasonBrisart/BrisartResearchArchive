# Session 8 Homework — Designing To Adjudicate

**College Year 3** · Adjudication · **Quarter 2**
**Follows:** Session 8 — Designing To Adjudicate · **Points:** 5 · **Optional:** yes
...
Draft a full design with predictions stated for every account.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the prediction lines differ from one another
...
Session 9 is **Confounds And Controls**, which assumes you arrive holding it. Write one thing you expect it to be about:
