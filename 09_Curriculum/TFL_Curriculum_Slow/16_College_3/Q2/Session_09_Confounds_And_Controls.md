...
| | |
|---|---|
| **Central question** | Confounds And Controls: students identify what would invalidate their result? |
| **Core concept** | Acknowledging residual risk is better work than dismissing a confound. |
| **Student outcome** | Students identify what would invalidate their result. |
| **Previous session** | Session 8 — Designing To Adjudicate |
| **Next session** | Session 10 — The Adversarial Round |
...
**The conceptual step.** Acknowledging residual risk is better work than dismissing a confound. Every dismissal requires a written reason.
...
**What depends on it.** Session 10 — The Adversarial Round — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Acknowledging residual risk is better work than dismissing a confound. Every dismissal requires a written reason.
...
1. A confound controlled with the residual risk named.
2. A confound dismissed with an adequate written reason.

### One non-example

Five confounds marked not applicable without reasons.
...
That confounds require reasoned treatment.
...
| Statement | Status |
|---|---|
| Acknowledging residual risk is better work than dismissing a confound. | Framework-derived, appropriate at this grade |
| That confounds require reasoned treatment. | What this specific activity can show |
| Whether the controls suffice. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 8 — Designing To Adjudicate — specifically: students build a design that separates all accounts.

**How it was taught.** Through the activity: draft a full design with predictions stated for every account

**Quick check.** Ask for the closing sentence of Session 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 8: draft a full design with predictions stated for every account, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A confound controlled with the residual risk named. |
| **Non-example** | Five confounds marked not applicable without reasons. |
...
> "Identical predictions mean the design does not adjudicate."
...
**Target observation.** That confounds require reasoned treatment.
...
> "Acknowledging residual risk is better work than dismissing a confound. You just saw that when say: your design is the defendant.
> Last time we said: Identical predictions mean the design does not adjudicate. This is the next part of that.
...
**The example.** A confound controlled with the residual risk named.
...
**Completed answer.** A confound controlled with the residual risk named. — which demonstrates that confounds require reasoned treatment.
...
**Teacher prompt.** "Now one that does not work. Five confounds marked not applicable without reasons. Why is this not an
example?"
...
**Exact student instructions.** Complete the seven-row confound table with controls and residual risks.
...
- *Licensed conclusion.* That confounds require reasoned treatment.
...
- *Expected response.* That confounds require reasoned treatment.
...
1. Any wording carrying the idea in `Acknowledging residual risk is better work than dismissing a confound`.
...
Say: "Residual risk acknowledged is better work than residual risk dismissed."
...
| **Leads to** | Session 10 — The Adversarial Round |

**Transition in.** Session 8 established students build a design that separates all accounts. This session uses that as the starting point.

**Transition out.** This session establishes students identify what would invalidate their result. Session 10 assumes it and builds students attack a design using an assigned rival.
