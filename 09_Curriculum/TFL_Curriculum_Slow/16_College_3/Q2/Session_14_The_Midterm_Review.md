...
| **Previous session** | Session 13 — Reconciling Conflicting Evidence |
| **Next session** | Session 15 — The Fairness Audit |
...
**The conceptual step.** A midterm review must sample the whole term. Reviewing only recent sessions produces a false sense of readiness.
...
**What depends on it.** Session 15 — The Fairness Audit — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A midterm review must sample the whole term. Reviewing only recent sessions produces a false sense of readiness.
...
1. A review touching Session 2 and Session 12 equally.
2. A cohort identifying fair operationalisation as its weakest area.

### One non-example

A review covering only the adversarial rounds.
...
**Prerequisite.** The content of Session 13 — Reconciling Conflicting Evidence — specifically: students handle results pointing in different directions.

**How it was taught.** Through the activity: reconcile two conflicting results and name a resolving observation

**Quick check.** Ask for the closing sentence of Session 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 13: reconcile two conflicting results and name a resolving observation, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A review touching Session 2 and Session 12 equally. |
| **Non-example** | A review covering only the adversarial rounds. |
...
> "You do not choose the one you prefer."
...
> Last time we said: You do not choose the one you prefer. This is the next part of that.
...
**The example.** A review touching Session 2 and Session 12 equally.
...
**Completed answer.** A review touching Session 2 and Session 12 equally. — which demonstrates where the cohort is weakest.
...
**Teacher prompt.** "Here is a second case. A cohort identifying fair operationalisation as its weakest area. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A review covering only the adversarial rounds. Why is this not an
example?"
...
**Exact student instructions.** Review covering rivals, fair operationalisation, the table, the condition, and confounds.
...
| | |
|---|---|
| **Follows** | Session 13 — Reconciling Conflicting Evidence |
| **Leads to** | Session 15 — The Fairness Audit |

**Transition in.** Session 13 established students handle results pointing in different directions. This session uses that as the starting point.

**Transition out.** This session establishes students consolidate the first half. Session 15 assumes it and builds students audit whether a rival was given a fair test.
