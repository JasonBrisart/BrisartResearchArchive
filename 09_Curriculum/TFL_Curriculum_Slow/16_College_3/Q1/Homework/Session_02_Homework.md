# Session 2 Homework — Stating A Rival Fairly

**College Year 3** · Adjudication · **Quarter 1**
**Follows:** Session 2 — Stating A Rival Fairly · **Points:** 5 · **Optional:** yes
...
Write each rival, checked by a classmate assigned to defend it.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every rival carries a recorded objection from its assigned defender
...
Session 3 is **The Differential Table**, which assumes you arrive holding it. Write one thing you expect it to be about:
