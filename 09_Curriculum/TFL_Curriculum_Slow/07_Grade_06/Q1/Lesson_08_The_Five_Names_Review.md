# Lesson 8 — The Five Names Review
...
| | |
|---|---|
| **Central question** | The Five Names Review: students consolidate the five variables? |
| **Core concept** | Minfo(t) and Sim(t) are the pair most often confused, because both are internal. |
| **Student outcome** | Students consolidate the five variables. |
| **Previous lesson** | Lesson 7 — Comparing Maps |
| **Next lesson** | Lesson 9 — How Fast |
...
**The conceptual step.** Minfo(t) and Sim(t) are the pair most often confused, because both are internal. The timing test separates them: one is retrieved, one is about what comes next.
...
**What depends on it.** Lesson 9 — How Fast — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Minfo(t) and Sim(t) are the pair most often confused, because both are internal. The timing test separates them: one is retrieved, one is about what comes next.
...
1. An item correctly sorted as Minfo(t) because it came back.
2. An item correctly sorted as Sim(t) because it concerns the next moment.

### One non-example

An item sorted by which name sounds more impressive.
...
Whether the five-way distinction is secure.

### What this activity does not establish

Whether the mappings are accurate.
...
| Statement | Status |
|---|---|
| Minfo(t) and Sim(t) are the pair most often confused, because both are internal. | Framework-derived, appropriate at this grade |
| Whether the five-way distinction is secure. | What this specific activity can show |
| Whether the mappings are accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — Comparing Maps — specifically: students compare two maps of the same event.

**How it was taught.** Through the activity: compare two maps of a shared event and name every differing line

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: compare two maps of a shared event and name every differing line, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An item correctly sorted as Minfo(t) because it came back. |
| **Non-example** | An item sorted by which name sounds more impressive. |
...
> "Same event, different maps, and the difference is traceable."
...
**Exact wording.** "Ask them to name all five and say what each one is."
...
**Target observation.** Whether the five-way distinction is secure.
...
> "Minfo(t) and Sim(t) are the pair most often confused, because both are internal. You just saw that when ask them to name all five and say what each one is.
> Last time we said: Same event, different maps, and the difference is traceable. This is the next part of that.
...
**What students must not infer.** Whether the mappings are accurate.

### 4. Worked example

**The example.** An item correctly sorted as Minfo(t) because it came back.
...
**Completed answer.** An item correctly sorted as Minfo(t) because it came back. — which demonstrates whether the five-way distinction is secure.
...
**Conclusions not licensed.** Whether the mappings are accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An item correctly sorted as Sim(t) because it concerns the next moment. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An item sorted by which name sounds more impressive. Why is this not an
example?"
...
**Exact student instructions.** Review with twelve items sorted into the five variables.
...
- *Licensed conclusion.* Whether the five-way distinction is secure.
- *Not licensed.* Whether the mappings are accurate.
...
- *Expected response.* Whether the five-way distinction is secure.
...
1. Any wording carrying the idea in `Minfo(t) and Sim(t) are the pair most often confused, because both are internal`.
...
Say: "Next time: how fast this runs."
...
| | |
|---|---|
| **Follows** | Lesson 7 — Comparing Maps |
| **Leads to** | Lesson 9 — How Fast |

**Transition in.** Lesson 7 established students compare two maps of the same event. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the five variables. Lesson 9 assumes it and builds students learn the length of the temporal window.
