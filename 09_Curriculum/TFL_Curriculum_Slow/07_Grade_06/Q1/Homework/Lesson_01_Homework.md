# Lesson 1 Homework — Opening The Questions

**Grade 6** · Naming The System · **Quarter 1**
**Follows:** Lesson 1 — Opening The Questions · **Points:** 5 · **Optional:** yes
...
Annotate the sealed list against the syllabus and write one sentence on the open one.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has marked their list against the syllabus
...
Lesson 2 is **The Five Names**, which assumes you arrive holding it. Write one thing you expect it to be about:
