# Lesson 5 Homework — Mapping Across A Lesson

**Grade 6** · Naming The System · **Quarter 1**
**Follows:** Lesson 5 — Mapping Across A Lesson · **Points:** 5 · **Optional:** yes
...
Four mapped moments from within the session, in order.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student maps four consecutive moments
...
Lesson 6 is **When Sim(t) Is Unclear**, which assumes you arrive holding it. Write one thing you expect it to be about:
