# Lesson 3 Homework — What E(t) Does Not Do

**Grade 6** · Naming The System · **Quarter 1**
**Follows:** Lesson 3 — What E(t) Does Not Do · **Points:** 5 · **Optional:** yes
...
Write the constraint in their own words and find a supporting example.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has written the constraint with an example
...
Lesson 4 is **Mapping Other People's Moments**, which assumes you arrive holding it. Write one thing you expect it to be about:
