# Lesson 2 Homework — The Five Names

**Grade 6** · Naming The System · **Quarter 1**
**Follows:** Lesson 2 — The Five Names · **Points:** 5 · **Optional:** yes
...
Map three real moments to all five variables using the printed template.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has three moments with a specific Sim(t) in each
...
Lesson 3 is **What E(t) Does Not Do**, which assumes you arrive holding it. Write one thing you expect it to be about:
