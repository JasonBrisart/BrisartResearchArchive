# Lesson 2 — The Five Names

**Grade 6** · Naming The System · **Quarter 1** · **45 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Five Names: students map plain-language parts onto the five declared variables? |
| **Core concept** | The five names attach to things the students have worked with for five years. |
| **Student outcome** | Students map plain-language parts onto the five declared variables. |
| **Previous lesson** | Lesson 1 — Opening The Questions |
| **Next lesson** | Lesson 3 — What E(t) Does Not Do |
...
**The conceptual step.** The five names attach to things the students have worked with for five years. Input(t) is what is arriving, Minfo(t) is what came back, Sim(t) is the specific expected outcome, E(t) is how strongly it mattered, and F(t) is the whole moment.

**Why students need it now.** This grade owns one idea: the five declared variables and the temporal window.
...
that 100 to 300 ms is how long a thought lasts. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Formal vocabulary required. Claims stated with the correct term. A student may no longer say 'the expecting part' once notation is released.

**What depends on it.** Lesson 3 — What E(t) Does Not Do — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The five names attach to things the students have worked with for five years. Input(t) is what is arriving, Minfo(t) is what came back, Sim(t) is the specific expected outcome, E(t) is how strongly it mattered, and F(t) is the whole moment.

### How this is stated at this grade

Formal vocabulary required. Claims stated with the correct term. A student may no longer say 'the expecting part' once notation is released.

Use only the vocabulary released at or before this grade. Terms not yet available:
The integration function, the persistence threshold, w1/w2/w3, theta.

### Why the concept matters

The whole grade rests on the five declared variables and the temporal window. If a student leaves this
...
1. A Sim(t) line reading I expected the door to be locked.
2. A Sim(t) line reading I expected question four to be fractions.

### One non-example

A Sim(t) line reading I felt uneasy, which names no outcome.
...
That plain-language parts map onto formal names.

### What this activity does not establish

That the names add content beyond the mapping.
...
| Statement | Status |
|---|---|
| The five names attach to things the students have worked with for five years. | Framework-derived, appropriate at this grade |
| That plain-language parts map onto formal names. | What this specific activity can show |
| That the names add content beyond the mapping. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 1 — Opening The Questions — specifically: students revisit their sealed Grade 5 questions against this year's syllabus.

**How it was taught.** Through the activity: annotate the sealed list against the syllabus and write one sentence on the open one

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: annotate the sealed list against the syllabus and write one sentence on the open one, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | sensory evidence available in the current window. |
| **Student wording** | Sensory evidence available in the current window. |
| **Correct example** | A Sim(t) line reading I expected the door to be locked. |
| **Non-example** | A Sim(t) line reading I felt uneasy, which names no outcome. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for sensory evidence available in the current window." |

### Minfo(t)

| | |
|---|---|
| **Teacher definition** | retrieved memory content active in the window. |
| **Student wording** | Retrieved memory content active in the window. |
| **Correct example** | A Sim(t) line reading I expected the door to be locked. |
| **Non-example** | A Sim(t) line reading I felt uneasy, which names no outcome. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for retrieved memory content active in the window." |

### Sim(t)

| | |
|---|---|
| **Teacher definition** | the predictive simulation; the specific expected outcome. |
| **Student wording** | The predictive simulation; the specific expected outcome. |
| **Correct example** | A Sim(t) line reading I expected the door to be locked. |
| **Non-example** | A Sim(t) line reading I felt uneasy, which names no outcome. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for the predictive simulation; the specific expected outcome." |


Do not introduce terminology from later grades. The integration function, the persistence threshold, w1/w2/w3, theta.

## Materials and preparation

**Teacher materials.** Notebooks; Chart paper; A timer with a second hand; Printed five-column templates; Index cards.
...
> "Some get answered this year. One is still open for everybody."
...
**Exact wording.** "Ask them to describe the last ten seconds without using the word think."
...
**Target observation.** That plain-language parts map onto formal names.
...
> "The five names attach to things the students have worked with for five years. You just saw that when ask them to describe the last ten seconds without using the word think.
> Last time we said: Some get answered this year. One is still open for everybody. This is the next part of that.
> It matters because the parts have proper names, and the system updates several times a second"
...
**Terminology to introduce here.** Input(t), Minfo(t), Sim(t).

**What students must not infer.** That the names add content beyond the mapping.

### 4. Worked example

**The example.** A Sim(t) line reading I expected the door to be locked.
...
**Completed answer.** A Sim(t) line reading I expected the door to be locked. — which demonstrates that plain-language parts map onto formal names.
...
**Conclusions not licensed.** That the names add content beyond the mapping.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A Sim(t) line reading I expected question four to be fractions. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A Sim(t) line reading I felt uneasy, which names no outcome. Why is this not an
example?"
...
**Exact student instructions.** Map three real moments to all five variables using the printed template.
...
- *Licensed conclusion.* That plain-language parts map onto formal names.
- *Not licensed.* That the names add content beyond the mapping.
...
- *Expected response.* That plain-language parts map onto formal names.
...
3. **Misconception check.** Somebody says: "100 to 300 ms is how long a thought lasts" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `The five names attach to things the students have worked with for five years`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: That is how often the system updates, not how long an idea lasts.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "Five names. Next time, the rule that surprises everybody."
...
### 1. "100 to 300 ms is how long a thought lasts"

**What the student says or does.** 100 to 300 ms is how long a thought lasts — usually while otherwise engaging well.

**Why it is understandable.** Conflating the update cycle with the duration of content.
...
**Exact correction.** Compare with frame rate. A film updates many times a second.

**Say this.** "That is how often the system updates, not how long an idea lasts."
...
### 2. "Emotion makes the prediction"

**What the student says or does.** Emotion makes the prediction — usually while otherwise engaging well.

**Why it is understandable.** Students assume the strongest-feeling element is the driver.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** State the constraint early and repeat it every session.

**Say this.** "It decides whether the prediction survives, not what it is."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "A feeling counts as a simulation"

**What the student says or does.** A feeling counts as a simulation — usually while otherwise engaging well.

**Why it is understandable.** 'I had a bad feeling' sounds like a prediction.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Apply the identifiability test.

**Say this.** "If you cannot say what you expected, this model does not cover it."
...
**Visual or physical support.** Provide a desk card with the five variables and their plain equivalents.
...
Ask them to estimate how many windows a lesson contains.
...
Specifically, do not introduce: The integration function, the persistence threshold, w1/w2/w3, theta.
...
| | |
|---|---|
| **Follows** | Lesson 1 — Opening The Questions |
| **Leads to** | Lesson 3 — What E(t) Does Not Do |

**Transition in.** Lesson 1 established students revisit their sealed Grade 5 questions against this year's syllabus. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students map plain-language parts onto the five declared variables. Lesson 3 assumes it and builds students state the gating constraint.
