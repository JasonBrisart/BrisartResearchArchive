# Lesson 4 — Mapping Other People's Moments
...
| | |
|---|---|
| **Central question** | Mapping Other People's Moments: students map a described moment they did not experience? |
| **Core concept** | A described moment can be mapped from what the account supplies. |
| **Student outcome** | Students map a described moment they did not experience. |
| **Previous lesson** | Lesson 3 — What E(t) Does Not Do |
| **Next lesson** | Lesson 5 — Mapping Across A Lesson |
...
**The conceptual step.** A described moment can be mapped from what the account supplies. Every variable must be supported by something in the text rather than imagined.
...
**What depends on it.** Lesson 5 — Mapping Across A Lesson — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A described moment can be mapped from what the account supplies. Every variable must be supported by something in the text rather than imagined.
...
1. A Sim(t) supported by a line in the account.
2. An E(t) supported by a described reaction.

### One non-example

A Minfo(t) invented because the account does not mention memory.
...
That mapping works on described moments.

### What this activity does not establish

What the described person actually experienced.
...
| Statement | Status |
|---|---|
| A described moment can be mapped from what the account supplies. | Framework-derived, appropriate at this grade |
| That mapping works on described moments. | What this specific activity can show |
| What the described person actually experienced. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — What E(t) Does Not Do — specifically: students state the gating constraint.

**How it was taught.** Through the activity: write the constraint in their own words and find a supporting example

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: write the constraint in their own words and find a supporting example, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Sim(t) supported by a line in the account. |
| **Non-example** | A Minfo(t) invented because the account does not mention memory. |
...
> "E(t) decides survival, not content. Most important sentence this year."
...
**Exact wording.** "Read a short account of somebody reacting to something."
...
**Target observation.** That mapping works on described moments.
...
> "A described moment can be mapped from what the account supplies. You just saw that when read a short account of somebody reacting to something.
> Last time we said: E(t) decides survival, not content. Most important sentence this year. This is the next part of that.
...
**What students must not infer.** What the described person actually experienced.

### 4. Worked example

**The example.** A Sim(t) supported by a line in the account.
...
**Completed answer.** A Sim(t) supported by a line in the account. — which demonstrates that mapping works on described moments.
...
**Conclusions not licensed.** What the described person actually experienced.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An E(t) supported by a described reaction. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A Minfo(t) invented because the account does not mention memory. Why is this not an
example?"
...
**Exact student instructions.** Map four described moments to all five variables.
...
- *Licensed conclusion.* That mapping works on described moments.
- *Not licensed.* What the described person actually experienced.
...
- *Expected response.* That mapping works on described moments.
...
1. Any wording carrying the idea in `A described moment can be mapped from what the account supplies`.
...
Say: "You can do it for other people, from what they tell you."
...
| | |
|---|---|
| **Follows** | Lesson 3 — What E(t) Does Not Do |
| **Leads to** | Lesson 5 — Mapping Across A Lesson |

**Transition in.** Lesson 3 established students state the gating constraint. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students map a described moment they did not experience. Lesson 5 assumes it and builds students map several moments from one continuous period.
