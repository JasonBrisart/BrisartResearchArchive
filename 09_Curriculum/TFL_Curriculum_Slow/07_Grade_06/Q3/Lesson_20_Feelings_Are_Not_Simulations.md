# Lesson 20 — Feelings Are Not Simulations
...
| | |
|---|---|
| **Central question** | Feelings Are Not Simulations: students separate affective states from predicted content? |
| **Core concept** | A feeling is E(t) and a predicted outcome is Sim(t). |
| **Student outcome** | Students separate affective states from predicted content. |
| **Previous lesson** | Lesson 19 — Sharpening Practice |
| **Next lesson** | Lesson 21 — Identifiability Elsewhere |
...
**The conceptual step.** A feeling is E(t) and a predicted outcome is Sim(t). A strong feeling does not establish that a simulation was present, because it names no outcome.
...
**What depends on it.** Lesson 21 — Identifiability Elsewhere — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A feeling is E(t) and a predicted outcome is Sim(t). A strong feeling does not establish that a simulation was present, because it names no outcome.
...
1. I felt nervous, sorted as E(t).
2. I expected to be called on, sorted as Sim(t).

### One non-example

A strong feeling treated as evidence that a prediction existed.
...
That feelings and predictions are separately sortable.

### What this activity does not establish

Whether feelings accompany simulations.
...
| Statement | Status |
|---|---|
| A feeling is E(t) and a predicted outcome is Sim(t). | Framework-derived, appropriate at this grade |
| That feelings and predictions are separately sortable. | What this specific activity can show |
| Whether feelings accompany simulations. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — Sharpening Practice — specifically: students sharpen vague statements systematically.

**How it was taught.** Through the activity: sharpen eight vague statements, showing the intermediate step for each

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: sharpen eight vague statements, showing the intermediate step for each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | I felt nervous, sorted as E(t). |
| **Non-example** | A strong feeling treated as evidence that a prediction existed. |
...
> "Sharpening has steps. It is not one leap."
...
**Exact wording.** "Put up I felt nervous and I expected to be called on, and ask which is which."
...
**Target observation.** That feelings and predictions are separately sortable.
...
> "A feeling is E(t) and a predicted outcome is Sim(t). You just saw that when put up I felt nervous and I expected to be called on, and ask which is which.
> Last time we said: Sharpening has steps. It is not one leap. This is the next part of that.
...
**What students must not infer.** Whether feelings accompany simulations.

### 4. Worked example

**The example.** I felt nervous, sorted as E(t).
...
**Completed answer.** I felt nervous, sorted as E(t). — which demonstrates that feelings and predictions are separately sortable.
...
**Conclusions not licensed.** Whether feelings accompany simulations.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. I expected to be called on, sorted as Sim(t). Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A strong feeling treated as evidence that a prediction existed. Why is this not an
example?"
...
**Exact student instructions.** Sort twelve statements into feelings, simulations, and both.
...
- *Licensed conclusion.* That feelings and predictions are separately sortable.
- *Not licensed.* Whether feelings accompany simulations.
...
- *Expected response.* That feelings and predictions are separately sortable.
...
1. Any wording carrying the idea in `A feeling is E(t) and a predicted outcome is Sim(t)`.
...
Say: "A feeling is E(t). A prediction is Sim(t). Different lines."
...
| | |
|---|---|
| **Follows** | Lesson 19 — Sharpening Practice |
| **Leads to** | Lesson 21 — Identifiability Elsewhere |

**Transition in.** Lesson 19 established students sharpen vague statements systematically. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students separate affective states from predicted content. Lesson 21 assumes it and builds students apply the rule to claims from outside school.
