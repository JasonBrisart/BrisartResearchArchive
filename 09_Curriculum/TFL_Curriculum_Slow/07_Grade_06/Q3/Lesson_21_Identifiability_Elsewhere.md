# Lesson 21 — Identifiability Elsewhere
...
| | |
|---|---|
| **Central question** | Identifiability Elsewhere: students apply the rule to claims from outside school? |
| **Core concept** | Most public predictions fail the identifiability test because nothing specific would count as their coming true. |
| **Student outcome** | Students apply the rule to claims from outside school. |
| **Previous lesson** | Lesson 20 — Feelings Are Not Simulations |
| **Next lesson** | Lesson 22 — The Boundary List |
...
**The conceptual step.** Most public predictions fail the identifiability test because nothing specific would count as their coming true. Applying the test outside school makes this visible.
...
**What depends on it.** Lesson 22 — The Boundary List — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Most public predictions fail the identifiability test because nothing specific would count as their coming true. Applying the test outside school makes this visible.
...
1. A weather prediction with a checkable threshold.
2. A sports prediction naming a specific outcome.

### One non-example

A prediction that things will improve, which nothing could check.
...
That the rule exposes vagueness in public claims.

### What this activity does not establish

Whether those predictions are accurate.
...
| Statement | Status |
|---|---|
| Most public predictions fail the identifiability test because nothing specific would count as their coming true. | Framework-derived, appropriate at this grade |
| That the rule exposes vagueness in public claims. | What this specific activity can show |
| Whether those predictions are accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — Feelings Are Not Simulations — specifically: students separate affective states from predicted content.

**How it was taught.** Through the activity: sort twelve statements into feelings, simulations, and both

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: sort twelve statements into feelings, simulations, and both, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A weather prediction with a checkable threshold. |
| **Non-example** | A prediction that things will improve, which nothing could check. |
...
> "A feeling is E(t). A prediction is Sim(t). Different lines."
...
**Exact wording.** "Take a prediction from news, sport, or weather."
...
**Target observation.** That the rule exposes vagueness in public claims.
...
> "Most public predictions fail the identifiability test because nothing specific would count as their coming true. You just saw that when take a prediction from news, sport, or weather.
> Last time we said: A feeling is E(t). A prediction is Sim(t). Different lines. This is the next part of that.
...
**What students must not infer.** Whether those predictions are accurate.

### 4. Worked example

**The example.** A weather prediction with a checkable threshold.
...
**Completed answer.** A weather prediction with a checkable threshold. — which demonstrates that the rule exposes vagueness in public claims.
...
**Conclusions not licensed.** Whether those predictions are accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A sports prediction naming a specific outcome. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A prediction that things will improve, which nothing could check. Why is this not an
example?"
...
**Exact student instructions.** Five outside predictions tested for identifiability.
...
- *Licensed conclusion.* That the rule exposes vagueness in public claims.
- *Not licensed.* Whether those predictions are accurate.
...
- *Expected response.* That the rule exposes vagueness in public claims.
...
1. Any wording carrying the idea in `Most public predictions fail the identifiability test because nothing specific would count as their coming true`.
...
Say: "Most public predictions fail this test."
...
| | |
|---|---|
| **Follows** | Lesson 20 — Feelings Are Not Simulations |
| **Leads to** | Lesson 22 — The Boundary List |

**Transition in.** Lesson 20 established students separate affective states from predicted content. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students apply the rule to claims from outside school. Lesson 22 assumes it and builds students catalogue what the rule excludes.
