# Lesson 24 — The Identifiability Review
...
| | |
|---|---|
| **Central question** | The Identifiability Review: students consolidate identifiability? |
| **Core concept** | The third-party test is the operational form of the identifiability rule. |
| **Student outcome** | Students consolidate identifiability. |
| **Previous lesson** | Lesson 23 — Auditing For Identifiability |
| **Next lesson** | Lesson 25 — Persistence Named |
...
**The conceptual step.** The third-party test is the operational form of the identifiability rule. The review checks whether it is applied under time pressure.
...
**What depends on it.** Lesson 25 — Persistence Named — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The third-party test is the operational form of the identifiability rule. The review checks whether it is applied under time pressure.
...
1. A statement correctly marked invalid.
2. A statement correctly marked valid.

### One non-example

Marking by whether the statement sounds confident.
...
Whether the identifiability test is habitual.

### What this activity does not establish

Whether valid statements are accurate.
...
| Statement | Status |
|---|---|
| The third-party test is the operational form of the identifiability rule. | Framework-derived, appropriate at this grade |
| Whether the identifiability test is habitual. | What this specific activity can show |
| Whether valid statements are accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — Auditing For Identifiability — specifically: students audit a partner's maps for unidentifiable simulations.

**How it was taught.** Through the activity: audit a partner's five maps and mark every failing Sim(t)

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: audit a partner's five maps and mark every failing Sim(t), in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A statement correctly marked invalid. |
| **Non-example** | Marking by whether the statement sounds confident. |
...
> "The failing ones are easy to spot in somebody else's work."
...
**Exact wording.** "Ask what the rule is and what the test is."
...
**Target observation.** Whether the identifiability test is habitual.
...
> "The third-party test is the operational form of the identifiability rule. You just saw that when ask what the rule is and what the test is.
> Last time we said: The failing ones are easy to spot in somebody else's work. This is the next part of that.
...
**What students must not infer.** Whether valid statements are accurate.

### 4. Worked example

**The example.** A statement correctly marked invalid.
...
**Completed answer.** A statement correctly marked invalid. — which demonstrates whether the identifiability test is habitual.
...
**Conclusions not licensed.** Whether valid statements are accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A statement correctly marked valid. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Marking by whether the statement sounds confident. Why is this not an
example?"
...
**Exact student instructions.** Review with ten statements marked valid or invalid Sim(t).
...
- *Licensed conclusion.* Whether the identifiability test is habitual.
- *Not licensed.* Whether valid statements are accurate.
...
- *Expected response.* Whether the identifiability test is habitual.
...
1. Any wording carrying the idea in `The third-party test is the operational form of the identifiability rule`.
...
Say: "Next time: what decides whether a simulation survives."
...
| | |
|---|---|
| **Follows** | Lesson 23 — Auditing For Identifiability |
| **Leads to** | Lesson 25 — Persistence Named |

**Transition in.** Lesson 23 established students audit a partner's maps for unidentifiable simulations. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate identifiability. Lesson 25 assumes it and builds students name persistence and connect it to sticking.
