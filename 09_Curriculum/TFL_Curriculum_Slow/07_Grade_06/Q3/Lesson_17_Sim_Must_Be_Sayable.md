# Lesson 17 — Sim(t) Must Be Sayable

**Grade 6** · Naming The System · **Quarter 3** · **45 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Sim(t) Must Be Sayable: students apply the identifiability rule? |
| **Core concept** | A Sim(t) must be stateable specifically enough that somebody else could check whether it happened. |
| **Student outcome** | Students apply the identifiability rule. |
| **Previous lesson** | Lesson 16 — The Window Review |
| **Next lesson** | Lesson 18 — The Third Party Test |
...
**The conceptual step.** A Sim(t) must be stateable specifically enough that somebody else could check whether it happened. Statements that cannot be sharpened fall outside what the framework covers.
...
**What depends on it.** Lesson 18 — The Third Party Test — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A Sim(t) must be stateable specifically enough that somebody else could check whether it happened. Statements that cannot be sharpened fall outside what the framework covers.
...
1. I expected question four to be fractions — checkable.
2. I expected the bus at 8:10 — checkable.

### One non-example

I had a bad feeling — nothing checkable, and it cannot be sharpened.
...
That the framework has a stateable boundary.

### What this activity does not establish

Whether unsharpenable states are unimportant.
...
| Statement | Status |
|---|---|
| A Sim(t) must be stateable specifically enough that somebody else could check whether it happened. | Framework-derived, appropriate at this grade |
| That the framework has a stateable boundary. | What this specific activity can show |
| Whether unsharpenable states are unimportant. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Window Review — specifically: students consolidate the temporal window.

**How it was taught.** Through the activity: review with eight statements marked correct or confused

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with eight statements marked correct or confused, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | I expected question four to be fractions — checkable. |
| **Non-example** | I had a bad feeling — nothing checkable, and it cannot be sharpened. |
...
> "Next time: the rule about what counts as a Sim(t)."
...
**Exact wording.** "Two statements on the board: I had a bad feeling about the test, and I expected question four to be fractions."
...
**Target observation.** That the framework has a stateable boundary.
...
> "A Sim(t) must be stateable specifically enough that somebody else could check whether it happened. You just saw that when two statements on the board: I had a bad feeling about the test, and I expected question four to be fractions.
> Last time we said: Next time: the rule about what counts as a Sim(t). This is the next part of that.
...
**What students must not infer.** Whether unsharpenable states are unimportant.

### 4. Worked example

**The example.** I expected question four to be fractions — checkable.
...
**Completed answer.** I expected question four to be fractions — checkable. — which demonstrates that the framework has a stateable boundary.
...
**Conclusions not licensed.** Whether unsharpenable states are unimportant.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. I expected the bus at 8:10 — checkable. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. I had a bad feeling — nothing checkable, and it cannot be sharpened. Why is this not an
example?"
...
**Exact student instructions.** Write five vague expectations and attempt to sharpen each; mark the unsharpenable.
...
- *Licensed conclusion.* That the framework has a stateable boundary.
- *Not licensed.* Whether unsharpenable states are unimportant.
...
- *Expected response.* That the framework has a stateable boundary.
...
1. Any wording carrying the idea in `A Sim(t) must be stateable specifically enough that somebody else could check whether it happened`.
...
Say: "This is a boundary of the model, not a failing of you."
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Window Review |
| **Leads to** | Lesson 18 — The Third Party Test |

**Transition in.** Lesson 16 established students consolidate the temporal window. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students apply the identifiability rule. Lesson 18 assumes it and builds students test whether somebody absent could check their Sim(t).
