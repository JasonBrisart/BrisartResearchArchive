# Lesson 23 — Auditing For Identifiability
...
| | |
|---|---|
| **Central question** | Auditing For Identifiability: students audit a partner's maps for unidentifiable simulations? |
| **Core concept** | Failing Sim(t) lines are easier to see in another person's work, because the auditor lacks the writer's private knowledge of what was meant. |
| **Student outcome** | Students audit a partner's maps for unidentifiable simulations. |
| **Previous lesson** | Lesson 22 — The Boundary List |
| **Next lesson** | Lesson 24 — The Identifiability Review |
...
**The conceptual step.** Failing Sim(t) lines are easier to see in another person's work, because the auditor lacks the writer's private knowledge of what was meant.
...
**What depends on it.** Lesson 24 — The Identifiability Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Failing Sim(t) lines are easier to see in another person's work, because the auditor lacks the writer's private knowledge of what was meant.
...
1. An audit marking a Sim(t) that names no outcome.
2. An audit marking a Sim(t) that is a mood.

### One non-example

An audit passing all five maps without comment.
...
That identifiability failures are externally detectable.

### What this activity does not establish

Whether the maps are otherwise sound.
...
| Statement | Status |
|---|---|
| Failing Sim(t) lines are easier to see in another person's work, because the auditor lacks the writer's private knowledge of what was meant. | Framework-derived, appropriate at this grade |
| That identifiability failures are externally detectable. | What this specific activity can show |
| Whether the maps are otherwise sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — The Boundary List — specifically: students catalogue what the rule excludes.

**How it was taught.** Through the activity: build a list of five categories the identifiability rule excludes

**Quick check.** Ask for the closing sentence of Lesson 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: build a list of five categories the identifiability rule excludes, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit marking a Sim(t) that names no outcome. |
| **Non-example** | An audit passing all five maps without comment. |
...
> "Knowing what is excluded is knowing the model."
...
**Exact wording.** "Say: find the Sim(t) lines that would not survive the third-party test."
...
**Target observation.** That identifiability failures are externally detectable.
...
> "Failing Sim(t) lines are easier to see in another person's work, because the auditor lacks the writer's private knowledge of what was meant. You just saw that when say: find the Sim(t) lines that would not survive the third-party test.
> Last time we said: Knowing what is excluded is knowing the model. This is the next part of that.
...
**What students must not infer.** Whether the maps are otherwise sound.

### 4. Worked example

**The example.** An audit marking a Sim(t) that names no outcome.
...
**Completed answer.** An audit marking a Sim(t) that names no outcome. — which demonstrates that identifiability failures are externally detectable.
...
**Conclusions not licensed.** Whether the maps are otherwise sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An audit marking a Sim(t) that is a mood. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit passing all five maps without comment. Why is this not an
example?"
...
**Exact student instructions.** Audit a partner's five maps and mark every failing Sim(t).
...
- *Licensed conclusion.* That identifiability failures are externally detectable.
- *Not licensed.* Whether the maps are otherwise sound.
...
- *Expected response.* That identifiability failures are externally detectable.
...
1. Any wording carrying the idea in `Failing Sim(t) lines are easier to see in another person's work, because the auditor lacks the writer's private knowledge of what was meant`.
...
Say: "The failing ones are easy to spot in somebody else's work."
...
| | |
|---|---|
| **Follows** | Lesson 22 — The Boundary List |
| **Leads to** | Lesson 24 — The Identifiability Review |

**Transition in.** Lesson 22 established students catalogue what the rule excludes. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit a partner's maps for unidentifiable simulations. Lesson 24 assumes it and builds students consolidate identifiability.
