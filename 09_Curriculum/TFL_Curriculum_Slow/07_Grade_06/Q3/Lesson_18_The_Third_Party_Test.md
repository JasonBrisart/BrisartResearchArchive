# Lesson 18 — The Third Party Test
...
| | |
|---|---|
| **Central question** | The Third Party Test: students test whether somebody absent could check their Sim(t)? |
| **Core concept** | The test is whether a third party could check the statement, not whether the writer knows what they meant. |
| **Student outcome** | Students test whether somebody absent could check their Sim(t). |
| **Previous lesson** | Lesson 17 — Sim(t) Must Be Sayable |
| **Next lesson** | Lesson 19 — Sharpening Practice |
...
**The conceptual step.** The test is whether a third party could check the statement, not whether the writer knows what they meant. Having a partner apply it removes the writer's private knowledge.
...
**What depends on it.** Lesson 19 — Sharpening Practice — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The test is whether a third party could check the statement, not whether the writer knows what they meant. Having a partner apply it removes the writer's private knowledge.
...
1. A Sim(t) a partner confirms is checkable.
2. A Sim(t) a partner rejects as too vague.

### One non-example

A Sim(t) accepted because the writer knows the intention.
...
That the standard is external checkability.

### What this activity does not establish

Whether the Sim(t) was accurate.
...
| Statement | Status |
|---|---|
| The test is whether a third party could check the statement, not whether the writer knows what they meant. | Framework-derived, appropriate at this grade |
| That the standard is external checkability. | What this specific activity can show |
| Whether the Sim(t) was accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Sim(t) Must Be Sayable — specifically: students apply the identifiability rule.

**How it was taught.** Through the activity: write five vague expectations and attempt to sharpen each; mark the unsharpenable

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: write five vague expectations and attempt to sharpen each; mark the unsharpenable, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Sim(t) a partner confirms is checkable. |
| **Non-example** | A Sim(t) accepted because the writer knows the intention. |
...
> "This is a boundary of the model, not a failing of you."
...
**Exact wording.** "Ask whether somebody who was not here could check that it happened."
...
**Target observation.** That the standard is external checkability.
...
> "The test is whether a third party could check the statement, not whether the writer knows what they meant. You just saw that when ask whether somebody who was not here could check that it happened.
> Last time we said: This is a boundary of the model, not a failing of you. This is the next part of that.
...
**What students must not infer.** Whether the Sim(t) was accurate.

### 4. Worked example

**The example.** A Sim(t) a partner confirms is checkable.
...
**Completed answer.** A Sim(t) a partner confirms is checkable. — which demonstrates that the standard is external checkability.
...
**Conclusions not licensed.** Whether the Sim(t) was accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A Sim(t) a partner rejects as too vague. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A Sim(t) accepted because the writer knows the intention. Why is this not an
example?"
...
**Exact student instructions.** Apply the third-party test to ten of their own Sim(t) statements.
...
- *Licensed conclusion.* That the standard is external checkability.
- *Not licensed.* Whether the Sim(t) was accurate.
...
- *Expected response.* That the standard is external checkability.
...
1. Any wording carrying the idea in `The test is whether a third party could check the statement, not whether the writer knows what they meant`.
...
Say: "Checkable by somebody else is the standard."
...
| | |
|---|---|
| **Follows** | Lesson 17 — Sim(t) Must Be Sayable |
| **Leads to** | Lesson 19 — Sharpening Practice |

**Transition in.** Lesson 17 established students apply the identifiability rule. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students test whether somebody absent could check their Sim(t). Lesson 19 assumes it and builds students sharpen vague statements systematically.
