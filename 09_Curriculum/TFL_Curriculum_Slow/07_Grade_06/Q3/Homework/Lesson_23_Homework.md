# Lesson 23 Homework — Auditing For Identifiability

**Grade 6** · Naming The System · **Quarter 3**
**Follows:** Lesson 23 — Auditing For Identifiability · **Points:** 5 · **Optional:** yes
...
Audit a partner's five maps and mark every failing Sim(t).

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student receives an audit marking at least one failure
...
Lesson 24 is **The Identifiability Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
