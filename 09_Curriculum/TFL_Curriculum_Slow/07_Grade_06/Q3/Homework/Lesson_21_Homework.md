# Lesson 21 Homework — Identifiability Elsewhere

**Grade 6** · Naming The System · **Quarter 3**
**Follows:** Lesson 21 — Identifiability Elsewhere · **Points:** 5 · **Optional:** yes
...
Five outside predictions tested for identifiability.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student tests five outside predictions
...
Lesson 22 is **The Boundary List**, which assumes you arrive holding it. Write one thing you expect it to be about:
