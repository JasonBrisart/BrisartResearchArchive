# Lesson 22 Homework — The Boundary List

**Grade 6** · Naming The System · **Quarter 3**
**Follows:** Lesson 22 — The Boundary List · **Points:** 5 · **Optional:** yes
...
Build a list of five categories the identifiability rule excludes.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student lists five excluded categories
...
Lesson 23 is **Auditing For Identifiability**, which assumes you arrive holding it. Write one thing you expect it to be about:
