# Lesson 19 Homework — Sharpening Practice

**Grade 6** · Naming The System · **Quarter 3**
**Follows:** Lesson 19 — Sharpening Practice · **Points:** 5 · **Optional:** yes
...
Sharpen eight vague statements, showing the intermediate step for each.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student shows an intermediate step for at least six
...
Lesson 20 is **Feelings Are Not Simulations**, which assumes you arrive holding it. Write one thing you expect it to be about:
