...
| | |
|---|---|
| **Central question** | The Window Review: students consolidate the temporal window? |
| **Core concept** | The rate-versus-duration confusion is persistent. |
| **Student outcome** | Students consolidate the temporal window. |
| **Previous lesson** | Lesson 15 — The Window Argument |
| **Next lesson** | Lesson 17 — Sim(t) Must Be Sayable |
...
**The conceptual step.** The rate-versus-duration confusion is persistent. The review tests whether the distinction survives when working quickly.
...
**What depends on it.** Lesson 17 — Sim(t) Must Be Sayable — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The rate-versus-duration confusion is persistent. The review tests whether the distinction survives when working quickly.
...
1. A statement correctly marked as confusing the two.
2. A statement correctly marked as sound.

### One non-example

Marking by whether the number sounds plausible.
...
Whether the rate-duration distinction is secure.

### What this activity does not establish

Whether the interval is accurate.
...
| Statement | Status |
|---|---|
| The rate-versus-duration confusion is persistent. | Framework-derived, appropriate at this grade |
| Whether the rate-duration distinction is secure. | What this specific activity can show |
| Whether the interval is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — The Window Argument — specifically: students evaluate the window range as a claim.

**How it was taught.** Through the activity: write which framework claims need the exact range and which need only discreteness

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: write which framework claims need the exact range and which need only discreteness, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A statement correctly marked as confusing the two. |
| **Non-example** | Marking by whether the number sounds plausible. |
...
> "Most claims only need discreteness. Worth knowing."
...
**Exact wording.** "Ask how long, and what that number is not."
...
**Target observation.** Whether the rate-duration distinction is secure.
...
> "The rate-versus-duration confusion is persistent. You just saw that when ask how long, and what that number is not.
> Last time we said: Most claims only need discreteness. Worth knowing. This is the next part of that.
...
**What students must not infer.** Whether the interval is accurate.

### 4. Worked example

**The example.** A statement correctly marked as confusing the two.
...
**Completed answer.** A statement correctly marked as confusing the two. — which demonstrates whether the rate-duration distinction is secure.
...
**Conclusions not licensed.** Whether the interval is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A statement correctly marked as sound. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Marking by whether the number sounds plausible. Why is this not an
example?"
...
**Exact student instructions.** Review with eight statements marked correct or confused.
...
- *Licensed conclusion.* Whether the rate-duration distinction is secure.
- *Not licensed.* Whether the interval is accurate.
...
- *Expected response.* Whether the rate-duration distinction is secure.
...
1. Any wording carrying the idea in `The rate-versus-duration confusion is persistent`.
...
Say: "Next time: the rule about what counts as a Sim(t)."
...
| | |
|---|---|
| **Follows** | Lesson 15 — The Window Argument |
| **Leads to** | Lesson 17 — Sim(t) Must Be Sayable |

**Transition in.** Lesson 15 established students evaluate the window range as a claim. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the temporal window. Lesson 17 assumes it and builds students apply the identifiability rule.
