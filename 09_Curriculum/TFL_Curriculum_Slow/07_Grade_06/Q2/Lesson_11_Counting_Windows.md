...
| | |
|---|---|
| **Central question** | Counting Windows: students estimate window counts for real activities? |
| **Core concept** | Estimating window counts requires arithmetic rather than intuition. |
| **Student outcome** | Students estimate window counts for real activities. |
| **Previous lesson** | Lesson 10 — Update Rate Is Not Duration |
| **Next lesson** | Lesson 12 — Inside One Window |
...
**The conceptual step.** Estimating window counts requires arithmetic rather than intuition. Writing the division out is what makes the scale visible.
...
**What depends on it.** Lesson 12 — Inside One Window — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Estimating window counts requires arithmetic rather than intuition. Writing the division out is what makes the scale visible.
...
1. A forty-five minute lesson estimated at about thirteen thousand windows.
2. A student showing the division for each estimate.

### One non-example

An estimate produced without any calculation.
...
That window counts can be estimated arithmetically.

### What this activity does not establish

The exact number for any activity.
...
| Statement | Status |
|---|---|
| Estimating window counts requires arithmetic rather than intuition. | Framework-derived, appropriate at this grade |
| That window counts can be estimated arithmetically. | What this specific activity can show |
| The exact number for any activity. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 10 — Update Rate Is Not Duration — specifically: students distinguish update rate from content duration.

**How it was taught.** Through the activity: identify which of six statements confuse the two, and correct each

**Quick check.** Ask for the closing sentence of Lesson 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 10: identify which of six statements confuse the two, and correct each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A forty-five minute lesson estimated at about thirteen thousand windows. |
| **Non-example** | An estimate produced without any calculation. |
...
> "Update rate is not content duration."
...
**Exact wording.** "Ask how many windows are in this lesson so far."
...
**Target observation.** That window counts can be estimated arithmetically.
...
> "Estimating window counts requires arithmetic rather than intuition. You just saw that when ask how many windows are in this lesson so far.
> Last time we said: Update rate is not content duration. This is the next part of that.
...
**What students must not infer.** The exact number for any activity.

### 4. Worked example

**The example.** A forty-five minute lesson estimated at about thirteen thousand windows.
...
**Completed answer.** A forty-five minute lesson estimated at about thirteen thousand windows. — which demonstrates that window counts can be estimated arithmetically.
...
**Conclusions not licensed.** The exact number for any activity.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student showing the division for each estimate. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An estimate produced without any calculation. Why is this not an
example?"
...
**Exact student instructions.** Window estimates for five activities of different lengths, with arithmetic shown.
...
- *Licensed conclusion.* That window counts can be estimated arithmetically.
- *Not licensed.* The exact number for any activity.
...
- *Expected response.* That window counts can be estimated arithmetically.
...
1. Any wording carrying the idea in `Estimating window counts requires arithmetic rather than intuition`.
...
Say: "The numbers get large very fast."
...
| | |
|---|---|
| **Follows** | Lesson 10 — Update Rate Is Not Duration |
| **Leads to** | Lesson 12 — Inside One Window |

**Transition in.** Lesson 10 established students distinguish update rate from content duration. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students estimate window counts for real activities. Lesson 12 assumes it and builds students state the order of operations within a window.
