...
|---|---|---|---|---|---|---|
| `Lesson_09_Printout.md` | Lesson 9 — How Fast | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_10_Printout.md` | Lesson 10 — Update Rate Is Not Duration | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 9 work |
| `Lesson_11_Printout.md` | Lesson 11 — Counting Windows | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 10 work |
| `Lesson_12_Printout.md` | Lesson 12 — Inside One Window | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 11 work |
| `Lesson_13_Printout.md` | Lesson 13 — F(t) Carries Forward | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 12 work |
| `Lesson_14_Printout.md` | Lesson 14 — Windows In Other Subjects | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 13 work |
| `Lesson_15_Printout.md` | Lesson 15 — The Window Argument | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 14 work |
| `Lesson_16_Printout.md` | Lesson 16 — The Window Review | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 15 work |
...
**Lesson 13 — F(t) Carries Forward.** If you only have time to print one
