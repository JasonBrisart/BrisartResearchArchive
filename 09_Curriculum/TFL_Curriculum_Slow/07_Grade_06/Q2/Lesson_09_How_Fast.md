...
| | |
|---|---|
| **Central question** | How Fast: students learn the length of the temporal window? |
| **Core concept** | The temporal window is roughly 100 to 300 milliseconds. |
| **Student outcome** | Students learn the length of the temporal window. |
| **Previous lesson** | Lesson 8 — The Five Names Review |
| **Next lesson** | Lesson 10 — Update Rate Is Not Duration |
...
**The conceptual step.** The temporal window is roughly 100 to 300 milliseconds. It is an approximate operating range rather than a measured universal constant, and saying so now prevents a false belief later.
...
**What depends on it.** Lesson 10 — Update Rate Is Not Duration — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The temporal window is roughly 100 to 300 milliseconds. It is an approximate operating range rather than a measured universal constant, and saying so now prevents a false belief later.
...
1. A twenty-second event estimated at about a hundred windows.
2. A student showing the division rather than guessing.

### One non-example

Treating 200 ms as an exact measured value.
...
That the update interval is short and countable.

### What this activity does not establish

That the range is precisely established.
...
| Statement | Status |
|---|---|
| The temporal window is roughly 100 to 300 milliseconds. | Framework-derived, appropriate at this grade |
| That the update interval is short and countable. | What this specific activity can show |
| That the range is precisely established. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Five Names Review — specifically: students consolidate the five variables.

**How it was taught.** Through the activity: review with twelve items sorted into the five variables

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: review with twelve items sorted into the five variables, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A twenty-second event estimated at about a hundred windows. |
| **Non-example** | Treating 200 ms as an exact measured value. |
...
**Exact wording.** "Ask how many times per second experience updates. Collect written guesses."
...
**Target observation.** That the update interval is short and countable.
...
> "The temporal window is roughly 100 to 300 milliseconds. You just saw that when ask how many times per second experience updates.
> Last time we said: Next time: how fast this runs. This is the next part of that.
...
**What students must not infer.** That the range is precisely established.

### 4. Worked example

**The example.** A twenty-second event estimated at about a hundred windows.
...
**Completed answer.** A twenty-second event estimated at about a hundred windows. — which demonstrates that the update interval is short and countable.
...
**Conclusions not licensed.** That the range is precisely established.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student showing the division rather than guessing. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Treating 200 ms as an exact measured value. Why is this not an
example?"
...
**Exact student instructions.** Estimate window counts for six events at 200 ms and check each other's arithmetic.
...
- *Licensed conclusion.* That the update interval is short and countable.
- *Not licensed.* That the range is precisely established.
...
- *Expected response.* That the update interval is short and countable.
...
1. Any wording carrying the idea in `The temporal window is roughly 100 to 300 milliseconds`.
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Five Names Review |
| **Leads to** | Lesson 10 — Update Rate Is Not Duration |

**Transition in.** Lesson 8 established students consolidate the five variables. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students learn the length of the temporal window. Lesson 10 assumes it and builds students distinguish update rate from content duration.
