...
| | |
|---|---|
| **Central question** | The Window Argument: students evaluate the window range as a claim? |
| **Core concept** | Most framework claims require only that processing is discrete, not that the interval is exactly 100 to 300 ms. |
| **Student outcome** | Students evaluate the window range as a claim. |
| **Previous lesson** | Lesson 14 — Windows In Other Subjects |
| **Next lesson** | Lesson 16 — The Window Review |
...
**The conceptual step.** Most framework claims require only that processing is discrete, not that the interval is exactly 100 to 300 ms. Sorting claims by which they need shows how little rests on the specific number.
...
**What depends on it.** Lesson 16 — The Window Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Most framework claims require only that processing is discrete, not that the interval is exactly 100 to 300 ms. Sorting claims by which they need shows how little rests on the specific number.
...
1. A claim about carry-forward needing only discreteness.
2. A claim about update counts needing the actual interval.

### One non-example

A defence of the number citing invented evidence.
...
That few claims depend on the exact interval.
...
| Statement | Status |
|---|---|
| Most framework claims require only that processing is discrete, not that the interval is exactly 100 to 300 ms. | Framework-derived, appropriate at this grade |
| That few claims depend on the exact interval. | What this specific activity can show |
| Whether the interval is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Windows In Other Subjects — specifically: students apply window reasoning to another subject.

**How it was taught.** Through the activity: five window estimates from science, sport, or music, with arithmetic

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: five window estimates from science, sport, or music, with arithmetic, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A claim about carry-forward needing only discreteness. |
| **Non-example** | A defence of the number citing invented evidence. |
...
> "The arithmetic works on anything with a duration."
...
**Exact wording.** "Ask where 100 to 300 comes from, noting nothing in the framework proves it."
...
**Target observation.** That few claims depend on the exact interval.
...
> "Most framework claims require only that processing is discrete, not that the interval is exactly 100 to 300 ms. You just saw that when ask where 100 to 300 comes from, noting nothing in the framework proves it.
> Last time we said: The arithmetic works on anything with a duration. This is the next part of that.
...
**The example.** A claim about carry-forward needing only discreteness.
...
**Completed answer.** A claim about carry-forward needing only discreteness. — which demonstrates that few claims depend on the exact interval.
...
**Teacher prompt.** "Here is a second case. A claim about update counts needing the actual interval. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence of the number citing invented evidence. Why is this not an
example?"
...
**Exact student instructions.** Write which framework claims need the exact range and which need only discreteness.
...
- *Licensed conclusion.* That few claims depend on the exact interval.
...
- *Expected response.* That few claims depend on the exact interval.
...
1. Any wording carrying the idea in `Most framework claims require only that processing is discrete, not that the interval is exactly 100 to 300 ms`.
...
Say: "Most claims only need discreteness. Worth knowing."
...
| | |
|---|---|
| **Follows** | Lesson 14 — Windows In Other Subjects |
| **Leads to** | Lesson 16 — The Window Review |

**Transition in.** Lesson 14 established students apply window reasoning to another subject. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students evaluate the window range as a claim. Lesson 16 assumes it and builds students consolidate the temporal window.
