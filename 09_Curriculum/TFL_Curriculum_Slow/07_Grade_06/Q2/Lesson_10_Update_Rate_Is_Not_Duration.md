# Lesson 10 — Update Rate Is Not Duration
...
| | |
|---|---|
| **Central question** | Update Rate Is Not Duration: students distinguish update rate from content duration? |
| **Core concept** | How often the system updates is different from how long a piece of content lasts. |
| **Student outcome** | Students distinguish update rate from content duration. |
| **Previous lesson** | Lesson 9 — How Fast |
| **Next lesson** | Lesson 11 — Counting Windows |
...
**The conceptual step.** How often the system updates is different from how long a piece of content lasts. A film updates many times a second while a scene lasts minutes.
...
**What depends on it.** Lesson 11 — Counting Windows — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

How often the system updates is different from how long a piece of content lasts. A film updates many times a second while a scene lasts minutes.
...
1. A five-second thought spanning roughly twenty-five windows.
2. A student correcting a statement that conflates the two.

### One non-example

A statement accepting that a long thought means a long window.
...
That update rate and content duration are independent.

### What this activity does not establish

The actual duration of any thought.
...
| Statement | Status |
|---|---|
| How often the system updates is different from how long a piece of content lasts. | Framework-derived, appropriate at this grade |
| That update rate and content duration are independent. | What this specific activity can show |
| The actual duration of any thought. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 9 — How Fast — specifically: students learn the length of the temporal window.

**How it was taught.** Through the activity: estimate window counts for six events at 200 ms and check each other's arithmetic

**Quick check.** Ask for the closing sentence of Lesson 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 9: estimate window counts for six events at 200 ms and check each other's arithmetic, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A five-second thought spanning roughly twenty-five windows. |
| **Non-example** | A statement accepting that a long thought means a long window. |
...
**Exact wording.** "Say: a thought lasts five seconds, so the window is five seconds. Ask what is wrong."
...
**Target observation.** That update rate and content duration are independent.
...
> "How often the system updates is different from how long a piece of content lasts. You just saw that when say: a thought lasts five seconds, so the window is five seconds.
> Last time we said: Faster than you guessed. This is the next part of that.
...
**What students must not infer.** The actual duration of any thought.

### 4. Worked example

**The example.** A five-second thought spanning roughly twenty-five windows.
...
**Completed answer.** A five-second thought spanning roughly twenty-five windows. — which demonstrates that update rate and content duration are independent.
...
**Conclusions not licensed.** The actual duration of any thought.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student correcting a statement that conflates the two. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A statement accepting that a long thought means a long window. Why is this not an
example?"
...
**Exact student instructions.** Identify which of six statements confuse the two, and correct each.
...
- *Licensed conclusion.* That update rate and content duration are independent.
- *Not licensed.* The actual duration of any thought.
...
- *Expected response.* That update rate and content duration are independent.
...
1. Any wording carrying the idea in `How often the system updates is different from how long a piece of content lasts`.
...
Say: "Update rate is not content duration."
...
| | |
|---|---|
| **Follows** | Lesson 9 — How Fast |
| **Leads to** | Lesson 11 — Counting Windows |

**Transition in.** Lesson 9 established students learn the length of the temporal window. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students distinguish update rate from content duration. Lesson 11 assumes it and builds students estimate window counts for real activities.
