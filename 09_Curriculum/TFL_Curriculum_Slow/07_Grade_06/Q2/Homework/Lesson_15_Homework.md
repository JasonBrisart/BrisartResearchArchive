# Lesson 15 Homework — The Window Argument

**Grade 6** · Naming The System · **Quarter 2**
**Follows:** Lesson 15 — The Window Argument · **Points:** 5 · **Optional:** yes
...
Write which framework claims need the exact range and which need only discreteness.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student routes at least four claims correctly
...
Lesson 16 is **The Window Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
