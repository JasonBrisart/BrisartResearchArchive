# Lesson 13 Homework — F(t) Carries Forward

**Grade 6** · Naming The System · **Quarter 2**
**Follows:** Lesson 13 — F(t) Carries Forward · **Points:** 5 · **Optional:** yes
...
Rewrite one Grade 4 trace in notation, with F(t) propagating between rows.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student's rewritten trace shows F(t) propagating
...
Lesson 14 is **Windows In Other Subjects**, which assumes you arrive holding it. Write one thing you expect it to be about:
