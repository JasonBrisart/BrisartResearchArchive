# Lesson 11 Homework — Counting Windows

**Grade 6** · Naming The System · **Quarter 2**
**Follows:** Lesson 11 — Counting Windows · **Points:** 5 · **Optional:** yes
...
Window estimates for five activities of different lengths, with arithmetic shown.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student shows the arithmetic for five estimates
...
Lesson 12 is **Inside One Window**, which assumes you arrive holding it. Write one thing you expect it to be about:
