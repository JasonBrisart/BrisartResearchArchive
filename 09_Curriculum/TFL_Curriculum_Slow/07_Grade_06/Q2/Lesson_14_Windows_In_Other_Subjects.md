# Lesson 14 — Windows In Other Subjects
...
| | |
|---|---|
| **Central question** | Windows In Other Subjects: students apply window reasoning to another subject? |
| **Core concept** | Window arithmetic applies to any timed event. |
| **Student outcome** | Students apply window reasoning to another subject. |
| **Previous lesson** | Lesson 13 — F(t) Carries Forward |
| **Next lesson** | Lesson 15 — The Window Argument |
...
**The conceptual step.** Window arithmetic applies to any timed event. Using it outside this lesson prevents it being filed as a classroom routine.
...
**What depends on it.** Lesson 15 — The Window Argument — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Window arithmetic applies to any timed event. Using it outside this lesson prevents it being filed as a classroom routine.
...
1. A ten-second sprint estimated at about fifty windows.
2. A musical phrase estimated in windows.

### One non-example

An estimate from this lesson repeated elsewhere.
...
That the arithmetic transfers to any duration.
...
| Statement | Status |
|---|---|
| Window arithmetic applies to any timed event. | Framework-derived, appropriate at this grade |
| That the arithmetic transfers to any duration. | What this specific activity can show |
| Anything about those subjects. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 13 — F(t) Carries Forward — specifically: students connect the notation to Grade 4 carry-forward.

**How it was taught.** Through the activity: rewrite one Grade 4 trace in notation, with F(t) propagating between rows

**Quick check.** Ask for the closing sentence of Lesson 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 13: rewrite one Grade 4 trace in notation, with F(t) propagating between rows, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A ten-second sprint estimated at about fifty windows. |
| **Non-example** | An estimate from this lesson repeated elsewhere. |
...
> "Nothing new was added. The same thing got a precise name."
...
**Exact wording.** "Ask how many windows are in a hundred-metre sprint."
...
**Target observation.** That the arithmetic transfers to any duration.
...
> "Window arithmetic applies to any timed event. You just saw that when ask how many windows are in a hundred-metre sprint.
> Last time we said: Nothing new was added. The same thing got a precise name. This is the next part of that.
...
**The example.** A ten-second sprint estimated at about fifty windows.
...
**Completed answer.** A ten-second sprint estimated at about fifty windows. — which demonstrates that the arithmetic transfers to any duration.
...
**Teacher prompt.** "Here is a second case. A musical phrase estimated in windows. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An estimate from this lesson repeated elsewhere. Why is this not an
example?"
...
**Exact student instructions.** Five window estimates from science, sport, or music, with arithmetic.
...
- *Licensed conclusion.* That the arithmetic transfers to any duration.
...
- *Expected response.* That the arithmetic transfers to any duration.
...
1. Any wording carrying the idea in `Window arithmetic applies to any timed event`.
...
Say: "The arithmetic works on anything with a duration."
...
| | |
|---|---|
| **Follows** | Lesson 13 — F(t) Carries Forward |
| **Leads to** | Lesson 15 — The Window Argument |

**Transition in.** Lesson 13 established students connect the notation to Grade 4 carry-forward. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students apply window reasoning to another subject. Lesson 15 assumes it and builds students evaluate the window range as a claim.
