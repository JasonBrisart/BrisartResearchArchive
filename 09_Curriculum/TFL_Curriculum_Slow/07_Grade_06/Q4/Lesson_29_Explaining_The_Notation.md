# Lesson 29 — Explaining The Notation

**Grade 6** · Naming The System · **Quarter 4** · **45 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Explaining The Notation: students explain the five variables to somebody who does not know them? |
| **Core concept** | Explaining the notation tests whether the student holds the formal names or only the plain-language ideas underneath. |
| **Student outcome** | Students explain the five variables to somebody who does not know them. |
| **Previous lesson** | Lesson 28 — Checking The Notation |
| **Next lesson** | Lesson 30 — Everything Named |
...
**The conceptual step.** Explaining the notation tests whether the student holds the formal names or only the plain-language ideas underneath. Reverting to plain language is the tell.
...
**What depends on it.** Lesson 30 — Everything Named — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Explaining the notation tests whether the student holds the formal names or only the plain-language ideas underneath. Reverting to plain language is the tell.
...
1. An explanation using all five names correctly.
2. A listener asking why E(t) does not build the prediction.

### One non-example

An explanation that abandons the names halfway through.
...
Whether the formal names are securely held.
...
| Statement | Status |
|---|---|
| Explaining the notation tests whether the student holds the formal names or only the plain-language ideas underneath. | Framework-derived, appropriate at this grade |
| Whether the formal names are securely held. | What this specific activity can show |
| Whether the explanation convinced anybody. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — Checking The Notation — specifically: students audit a trace for misused notation.

**How it was taught.** Through the activity: audit a partner's trace for the same three error types

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: audit a partner's trace for the same three error types, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An explanation using all five names correctly. |
| **Non-example** | An explanation that abandons the names halfway through. |
...
> "The E(t) error is the one to watch for."
...
**Exact wording.** "Say: today you teach it, using the proper names."
...
**Target observation.** Whether the formal names are securely held.
...
> "Explaining the notation tests whether the student holds the formal names or only the plain-language ideas underneath. You just saw that when say: today you teach it, using the proper names.
> Last time we said: The E(t) error is the one to watch for. This is the next part of that.
...
**The example.** An explanation using all five names correctly.
...
**Completed answer.** An explanation using all five names correctly. — which demonstrates whether the formal names are securely held.
...
**Teacher prompt.** "Here is a second case. A listener asking why E(t) does not build the prediction. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An explanation that abandons the names halfway through. Why is this not an
example?"
...
**Exact student instructions.** Explain to a buddy; record the hardest question asked.
...
- *Licensed conclusion.* Whether the formal names are securely held.
...
- *Expected response.* Whether the formal names are securely held.
...
1. Any wording carrying the idea in `Explaining the notation tests whether the student holds the formal names or only the plain-language ideas underneath`.
...
Say: "If you can teach the names, you have them."
...
| | |
|---|---|
| **Follows** | Lesson 28 — Checking The Notation |
| **Leads to** | Lesson 30 — Everything Named |

**Transition in.** Lesson 28 established students audit a trace for misused notation. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain the five variables to somebody who does not know them. Lesson 30 assumes it and builds students produce and defend a fully notated trace.
