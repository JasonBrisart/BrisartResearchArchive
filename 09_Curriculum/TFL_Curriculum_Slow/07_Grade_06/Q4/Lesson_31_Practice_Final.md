...
| **Previous lesson** | Lesson 30 — Everything Named |
...
1. A student identifying the gating constraint as their weak point.
2. A student finding they confuse Minfo(t) and Sim(t) under pressure.
...
**Prerequisite.** The content of Lesson 30 — Everything Named — specifically: students produce and defend a fully notated trace.

**How it was taught.** Through the activity: a four-row trace, audited, repaired, with one row explained aloud

**Quick check.** Ask for the closing sentence of Lesson 30. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 30: a four-row trace, audited, repaired, with one row explained aloud, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student identifying the gating constraint as their weak point. |
...
> "Next year: persistence and being right are completely different things."
...
> Last time we said: Next year: persistence and being right are completely different things. This is the next part of that.
...
**The example.** A student identifying the gating constraint as their weak point.
...
**Completed answer.** A student identifying the gating constraint as their weak point. — which demonstrates where each student is weakest.
...
**Teacher prompt.** "Here is a second case. A student finding they confuse Minfo(t) and Sim(t) under pressure. Work it through with me."
...
| | |
|---|---|
| **Follows** | Lesson 30 — Everything Named |
| **Leads to** | Lesson 32 — Final Assessment |

**Transition in.** Lesson 30 established students produce and defend a fully notated trace. This lesson uses that as the starting point.
