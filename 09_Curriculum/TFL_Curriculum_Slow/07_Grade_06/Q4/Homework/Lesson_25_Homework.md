# Lesson 25 Homework — Persistence Named

**Grade 6** · Naming The System · **Quarter 4**
**Follows:** Lesson 25 — Persistence Named · **Points:** 5 · **Optional:** yes
...
Rewrite Grade 1 sticking work using persistence and identify E(t) in each case.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student uses persistence correctly in three sentences
...
Lesson 26 is **The Five Column Trace**, which assumes you arrive holding it. Write one thing you expect it to be about:
