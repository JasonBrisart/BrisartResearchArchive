# Lesson 26 — The Five Column Trace
...
| | |
|---|---|
| **Central question** | The Five Column Trace: students produce a five-column trace across three windows? |
| **Core concept** | The five-column trace combines the five variables with the inheritance requirement from Grade 4. |
| **Student outcome** | Students produce a five-column trace across three windows. |
| **Previous lesson** | Lesson 25 — Persistence Named |
| **Next lesson** | Lesson 27 — Longer Traces |
...
**The conceptual step.** The five-column trace combines the five variables with the inheritance requirement from Grade 4. Connection between rows is what makes it a trace.
...
**What depends on it.** Lesson 27 — Longer Traces — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The five-column trace combines the five variables with the inheritance requirement from Grade 4. Connection between rows is what makes it a trace.
...
1. Three rows where F(t) from row one appears in row two.
2. A trace where the connection is visible in every row.

### One non-example

Three well-filled rows with no connection between them.
...
That the five variables can be traced across windows.
...
| Statement | Status |
|---|---|
| The five-column trace combines the five variables with the inheritance requirement from Grade 4. | Framework-derived, appropriate at this grade |
| That the five variables can be traced across windows. | What this specific activity can show |
| Whether the trace is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — Persistence Named — specifically: students name persistence and connect it to sticking.

**How it was taught.** Through the activity: rewrite Grade 1 sticking work using persistence and identify E(t) in each case

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: rewrite Grade 1 sticking work using persistence and identify E(t) in each case, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Three rows where F(t) from row one appears in row two. |
| **Non-example** | Three well-filled rows with no connection between them. |
...
> "Persistence is the proper word."
...
**Exact wording.** "Put a blank five-column table across three rows on the board."
...
**Target observation.** That the five variables can be traced across windows.
...
> "The five-column trace combines the five variables with the inheritance requirement from Grade 4. You just saw that when put a blank five-column table across three rows on the board.
> Last time we said: Persistence is the proper word. This is the next part of that.
...
**The example.** Three rows where F(t) from row one appears in row two.
...
**Completed answer.** Three rows where F(t) from row one appears in row two. — which demonstrates that the five variables can be traced across windows.
...
**Teacher prompt.** "Here is a second case. A trace where the connection is visible in every row. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Three well-filled rows with no connection between them. Why is this not an
example?"
...
**Exact student instructions.** A three-row five-column trace on one real episode.
...
- *Licensed conclusion.* That the five variables can be traced across windows.
...
- *Expected response.* That the five variables can be traced across windows.
...
1. Any wording carrying the idea in `The five-column trace combines the five variables with the inheritance requirement from Grade 4`.
...
Say: "The trace is the tool for the next six years."
...
| | |
|---|---|
| **Follows** | Lesson 25 — Persistence Named |
| **Leads to** | Lesson 27 — Longer Traces |

**Transition in.** Lesson 25 established students name persistence and connect it to sticking. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students produce a five-column trace across three windows. Lesson 27 assumes it and builds students extend the notated trace to six windows.
