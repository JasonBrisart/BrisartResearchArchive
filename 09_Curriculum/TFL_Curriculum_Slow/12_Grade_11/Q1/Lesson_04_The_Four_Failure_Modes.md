# Lesson 4 — The Four Failure Modes
...
| | |
|---|---|
| **Central question** | The Four Failure Modes: students name the four ways Sim(t) capture goes wrong? |
| **Core concept** | The four failure modes are retrospective collection, leading elicitation, unfalsifiable content, and self-scoring by the experimenter. |
| **Student outcome** | Students name the four ways Sim(t) capture goes wrong. |
| **Previous lesson** | Lesson 3 — Measuring Sim(t) |
| **Next lesson** | Lesson 5 — Measuring E(t) |
...
**The conceptual step.** The four failure modes are retrospective collection, leading elicitation, unfalsifiable content, and self-scoring by the experimenter. Each is distinct and separately detectable.
...
**What depends on it.** Lesson 5 — Measuring E(t) — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The four failure modes are retrospective collection, leading elicitation, unfalsifiable content, and self-scoring by the experimenter. Each is distinct and separately detectable.
...
1. A protocol audited and found to collect retrospectively.
2. A protocol audited and found to use a leading prompt.

### One non-example

Two distinct failure modes reported as one.
...
That the failure modes are separately identifiable.

### What this activity does not establish

How common each is in published work.
...
| Statement | Status |
|---|---|
| The four failure modes are retrospective collection, leading elicitation, unfalsifiable content, and self-scoring by the experimenter. | Framework-derived, appropriate at this grade |
| That the failure modes are separately identifiable. | What this specific activity can show |
| How common each is in published work. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — Measuring Sim(t) — specifically: students design a contamination-resistant capture of simulation content.

**How it was taught.** Through the activity: write a Sim(t) protocol with a verbatim prompt, timing, scoring rule, and three worked examples

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: write a Sim(t) protocol with a verbatim prompt, timing, scoring rule, and three worked examples, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A protocol audited and found to collect retrospectively. |
| **Non-example** | Two distinct failure modes reported as one. |
...
> "The unscoreable example is the one everybody omits."
...
**Exact wording.** "Say: all four are routinely violated in work claiming to study prediction."
...
**Target observation.** That the failure modes are separately identifiable.
...
> "The four failure modes are retrospective collection, leading elicitation, unfalsifiable content, and self-scoring by the experimenter. You just saw that when say: all four are routinely violated in work claiming to study prediction.
> Last time we said: The unscoreable example is the one everybody omits. This is the next part of that.
...
**What students must not infer.** How common each is in published work.

### 4. Worked example

**The example.** A protocol audited and found to collect retrospectively.
...
**Completed answer.** A protocol audited and found to collect retrospectively. — which demonstrates that the failure modes are separately identifiable.
...
**Conclusions not licensed.** How common each is in published work.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A protocol audited and found to use a leading prompt. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two distinct failure modes reported as one. Why is this not an
example?"
...
**Exact student instructions.** Audit four described protocols for the four failure modes.
...
- *Licensed conclusion.* That the failure modes are separately identifiable.
- *Not licensed.* How common each is in published work.
...
- *Expected response.* That the failure modes are separately identifiable.
...
1. Any wording carrying the idea in `The four failure modes are retrospective collection, leading elicitation, unfalsifiable content, and self-scoring by the experimenter`.
...
Say: "Knowing the four means you can spot them in anybody's work."
...
| | |
|---|---|
| **Follows** | Lesson 3 — Measuring Sim(t) |
| **Leads to** | Lesson 5 — Measuring E(t) |

**Transition in.** Lesson 3 established students design a contamination-resistant capture of simulation content. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students name the four ways Sim(t) capture goes wrong. Lesson 5 assumes it and builds students separate intensity from arousal and from the outcome.
