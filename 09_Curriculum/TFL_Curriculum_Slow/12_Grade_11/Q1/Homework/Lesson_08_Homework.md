# Lesson 8 Homework — The Measurement Review

**Grade 11** · Measurement and Rivals · **Quarter 1**
**Follows:** Lesson 8 — The Measurement Review · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 8 ended on, from memory:
...
Review with six maps audited for executability.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class identifies unrunnable lines in at least four maps
...
Lesson 9 is **Three Other Explanations**, which assumes you arrive holding it. Write one thing you expect it to be about:
