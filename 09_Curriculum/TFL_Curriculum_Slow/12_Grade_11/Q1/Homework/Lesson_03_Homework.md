# Lesson 3 Homework — Measuring Sim(t)

**Grade 11** · Measurement and Rivals · **Quarter 1**
**Follows:** Lesson 3 — Measuring Sim(t) · **Points:** 5 · **Optional:** yes
...
Write a Sim(t) protocol with a verbatim prompt, timing, scoring rule, and three worked examples.
...
Lesson 4 is **The Four Failure Modes**, which assumes you arrive holding it. Write one thing you expect it to be about:
