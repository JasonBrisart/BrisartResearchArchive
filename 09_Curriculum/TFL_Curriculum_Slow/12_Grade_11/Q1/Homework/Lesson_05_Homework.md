# Lesson 5 Homework — Measuring E(t)

**Grade 11** · Measurement and Rivals · **Quarter 1**
**Follows:** Lesson 5 — Measuring E(t) · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 5 ended on, from memory:
...
Audit their instrument against three requirements and name an alternative reason for a correlation.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces a genuine alternative reason
...
Lesson 6 is **Measuring Persistence**, which assumes you arrive holding it. Write one thing you expect it to be about:
