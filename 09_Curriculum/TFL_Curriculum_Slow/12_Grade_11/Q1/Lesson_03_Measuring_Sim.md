...
| | |
|---|---|
| **Central question** | Measuring Sim(t): students design a contamination-resistant capture of simulation content? |
| **Core concept** | A Sim(t) protocol must specify the verbatim prompt, when it is delivered, how responses are scored, and what an unscoreable response looks like. |
| **Student outcome** | Students design a contamination-resistant capture of simulation content. |
| **Previous lesson** | Lesson 2 — The Measurement Map |
| **Next lesson** | Lesson 4 — The Four Failure Modes |
...
**The conceptual step.** A Sim(t) protocol must specify the verbatim prompt, when it is delivered, how responses are scored, and what an unscoreable response looks like.
...
**What depends on it.** Lesson 4 — The Four Failure Modes — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A Sim(t) protocol must specify the verbatim prompt, when it is delivered, how responses are scored, and what an unscoreable response looks like.
...
1. A protocol with the exact prompt written out.
2. A worked example of a response the rule cannot score.

### One non-example

A protocol describing the prompt rather than stating it.
...
That capture protocols can be specified completely.

### What this activity does not establish

Whether the protocol captures what it claims.
...
| Statement | Status |
|---|---|
| A Sim(t) protocol must specify the verbatim prompt, when it is delivered, how responses are scored, and what an unscoreable response looks like. | Framework-derived, appropriate at this grade |
| That capture protocols can be specified completely. | What this specific activity can show |
| Whether the protocol captures what it claims. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — The Measurement Map — specifically: students build a seven-line measurement map.

**How it was taught.** Through the activity: build a first-draft map, then have a partner mark every unrunnable line

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: build a first-draft map, then have a partner mark every unrunnable line, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A protocol with the exact prompt written out. |
| **Non-example** | A protocol describing the prompt rather than stating it. |
...
> "Most first maps come back heavily marked. That is the intended result."
...
**Exact wording.** "Say: simulation content is what the framework most depends on and the hardest to get honestly."
...
**Target observation.** That capture protocols can be specified completely.
...
> "A Sim(t) protocol must specify the verbatim prompt, when it is delivered, how responses are scored, and what an unscoreable response looks like. You just saw that when say: simulation content is what the framework most depends on and the hardest to get honestly.
> Last time we said: Most first maps come back heavily marked. That is the intended result. This is the next part of that.
...
**What students must not infer.** Whether the protocol captures what it claims.

### 4. Worked example

**The example.** A protocol with the exact prompt written out.
...
**Completed answer.** A protocol with the exact prompt written out. — which demonstrates that capture protocols can be specified completely.
...
**Conclusions not licensed.** Whether the protocol captures what it claims.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A worked example of a response the rule cannot score. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A protocol describing the prompt rather than stating it. Why is this not an
example?"
...
**Exact student instructions.** Write a Sim(t) protocol with a verbatim prompt, timing, scoring rule, and three worked examples.
...
- *Licensed conclusion.* That capture protocols can be specified completely.
- *Not licensed.* Whether the protocol captures what it claims.
...
- *Expected response.* That capture protocols can be specified completely.
...
1. Any wording carrying the idea in `A Sim(t) protocol must specify the verbatim prompt, when it is delivered, how responses are scored, and what an unscoreable response looks like`.
...
Say: "The unscoreable example is the one everybody omits."
...
| | |
|---|---|
| **Follows** | Lesson 2 — The Measurement Map |
| **Leads to** | Lesson 4 — The Four Failure Modes |

**Transition in.** Lesson 2 established students build a seven-line measurement map. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students design a contamination-resistant capture of simulation content. Lesson 4 assumes it and builds students name the four ways Sim(t) capture goes wrong.
