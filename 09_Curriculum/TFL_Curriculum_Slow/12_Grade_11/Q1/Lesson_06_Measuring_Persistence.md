# Lesson 6 — Measuring Persistence
...
| | |
|---|---|
| **Central question** | Measuring Persistence: students prespecify a persistence criterion and a sampling interval? |
| **Core concept** | A persistence criterion must be fixed before data collection and must state how partial matches are scored. |
| **Student outcome** | Students prespecify a persistence criterion and a sampling interval. |
| **Previous lesson** | Lesson 5 — Measuring E(t) |
| **Next lesson** | Lesson 7 — Completing The Map |
...
**The conceptual step.** A persistence criterion must be fixed before data collection and must state how partial matches are scored. Deciding afterwards means choosing the result.
...
**What depends on it.** Lesson 7 — Completing The Map — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A persistence criterion must be fixed before data collection and must state how partial matches are scored. Deciding afterwards means choosing the result.
...
2. A named vulnerability in one's own criterion.

### One non-example

A criterion with no rule for borderline cases.
...
| Statement | Status |
|---|---|
| A persistence criterion must be fixed before data collection and must state how partial matches are scored. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 5 — Measuring E(t) — specifically: students separate intensity from arousal and from the outcome.

**How it was taught.** Through the activity: audit their instrument against three requirements and name an alternative reason for a correlation

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: audit their instrument against three requirements and name an alternative reason for a correlation, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A criterion with no rule for borderline cases. |
...
> "A student who cannot name one has built the circle into the measurement."
...
**Exact wording.** "Say: persisting for how long? Detected by what? Decide after seeing the data and you have chosen your result."
...
> "A persistence criterion must be fixed before data collection and must state how partial matches are scored. You just saw that when say: persisting for how long? Detected by what? Decide after seeing the data and you have chosen your result.
> Last time we said: A student who cannot name one has built the circle into the measurement. This is the next part of that.
...
**Teacher prompt.** "Here is a second case. A named vulnerability in one's own criterion. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A criterion with no rule for borderline cases. Why is this not an
example?"
...
**Exact student instructions.** Complete both specifications and identify a post-hoc vulnerability in their own criterion.
...
1. Any wording carrying the idea in `A persistence criterion must be fixed before data collection and must state how partial matches are scored`.
...
Say: "Naming how your criterion could be gamed is what stops you gaming it."
...
| | |
|---|---|
| **Follows** | Lesson 5 — Measuring E(t) |
| **Leads to** | Lesson 7 — Completing The Map |

**Transition in.** Lesson 5 established students separate intensity from arousal and from the outcome. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students prespecify a persistence criterion and a sampling interval. Lesson 7 assumes it and builds students produce a map every line of which is executable.
