# Lesson 5 — Measuring E(t)

**Grade 11** · Measurement and Rivals · **Quarter 1** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Measuring E(t): students separate intensity from arousal and from the outcome? |
| **Core concept** | An E(t) instrument must be independent of the outcome in time and judgement, distinguishable from general arousal, and bounded. |
| **Student outcome** | Students separate intensity from arousal and from the outcome. |
| **Previous lesson** | Lesson 4 — The Four Failure Modes |
| **Next lesson** | Lesson 6 — Measuring Persistence |
| **Materials** | Lab books; printed measurement map templates |
...
**The conceptual step.** An E(t) instrument must be independent of the outcome in time and judgement, distinguishable from general arousal, and bounded. Failing the first guarantees a correlation by construction.

**Why students need it now.** This grade owns one idea: operationalisation, the three rival accounts, and confound control.
...
that my data fits the framework, so it supports it. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Multi-source synthesis. Conflicting evidence reconciled explicitly, and rival explanations stated in their strongest form.

**What depends on it.** Lesson 6 — Measuring Persistence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An E(t) instrument must be independent of the outcome in time and judgement, distinguishable from general arousal, and bounded. Failing the first guarantees a correlation by construction.

### How this is stated at this grade

Multi-source synthesis. Conflicting evidence reconciled explicitly, and rival explanations stated in their strongest form.

Use only the vocabulary released at or before this grade. Terms not yet available:
Prespecified analysis plans as a formal requirement, gate compliance.

### Why the concept matters

The whole grade rests on operationalisation, the three rival accounts, and confound control. If a student leaves this
...
2. An instrument with a separate arousal channel.

### One non-example

An instrument rating intensity and persistence in one judgement.
...
That circularity can be built into measurement unnoticed.
...
| Statement | Status |
|---|---|
| An E(t) instrument must be independent of the outcome in time and judgement, distinguishable from general arousal, and bounded. | Framework-derived, appropriate at this grade |
| That circularity can be built into measurement unnoticed. | What this specific activity can show |
| Whether the instrument is valid. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — The Four Failure Modes — specifically: students name the four ways Sim(t) capture goes wrong.

**How it was taught.** Through the activity: audit four described protocols for the four failure modes

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: audit four described protocols for the four failure modes, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | the framework applies only where all variables can be measured. |
| **Student wording** | The framework applies only where all variables can be measured. |
| **Correct example** | An instrument rating intensity before the outcome is known. |
| **Non-example** | An instrument rating intensity and persistence in one judgement. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for the framework applies only where all variables can be measured." |

### operationalise

| | |
|---|---|
| **Teacher definition** | specify how a variable will actually be measured. |
| **Student wording** | Specify how a variable will actually be measured. |
| **Correct example** | An instrument rating intensity before the outcome is known. |
| **Non-example** | An instrument rating intensity and persistence in one judgement. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for specify how a variable will actually be measured." |

### uncertainty-only

| | |
|---|---|
| **Teacher definition** | persistence reflects unresolved ambiguity. |
| **Student wording** | Persistence reflects unresolved ambiguity. |
| **Correct example** | An instrument rating intensity before the outcome is known. |
| **Non-example** | An instrument rating intensity and persistence in one judgement. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for persistence reflects unresolved ambiguity." |


Do not introduce terminology from later grades. Prespecified analysis plans as a formal requirement, gate compliance.

## Materials and preparation

**Teacher materials.** Lab books; Printed measurement map templates; Printed differential tables; A timer.
...
> "Knowing the four means you can spot them in anybody's work."
...
**Exact wording.** "Say: rate intensity and persistence in the same survey and you will find a correlation. Why is that worthless?"
...
**Target observation.** That circularity can be built into measurement unnoticed.
...
> "An E(t) instrument must be independent of the outcome in time and judgement, distinguishable from general arousal, and bounded. You just saw that when say: rate intensity and persistence in the same survey and you will find a correlation.
> Last time we said: Knowing the four means you can spot them in anybody's work. This is the next part of that.
> It matters because a result consistent with everything discriminates nothing"
...
**Terminology to introduce here.** testability constraint, operationalise, uncertainty-only.
...
**Completed answer.** An instrument rating intensity before the outcome is known. — which demonstrates that circularity can be built into measurement unnoticed.
...
**Teacher prompt.** "Here is a second case. An instrument with a separate arousal channel. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An instrument rating intensity and persistence in one judgement. Why is this not an
example?"
...
**Exact student instructions.** Audit their instrument against three requirements and name an alternative reason for a correlation.
...
- *Licensed conclusion.* That circularity can be built into measurement unnoticed.
...
- *Expected response.* That circularity can be built into measurement unnoticed.
...
3. **Misconception check.** Somebody says: "My data fits the framework, so it supports it" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `An E(t) instrument must be independent of the outcome in time and judgement, distinguishable from general arousal, and bounded`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Consistency is not evidence for.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "A student who cannot name one has built the circle into the measurement."
...
### 1. "My data fits the framework, so it supports it"

**What the student says or does.** My data fits the framework, so it supports it — usually while otherwise engaging well.

**Why it is understandable.** Fitting feels like confirmation.
...
**Exact correction.** Apply the three rivals to the same data.

**Say this.** "Consistency is not evidence for."
...
### 2. "Measuring intensity means asking how strongly somebody felt"

**What the student says or does.** Measuring intensity means asking how strongly somebody felt — usually while otherwise engaging well.

**Why it is understandable.** The obvious instrument conflates several things.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Show that rating both at once guarantees correlation by construction.

**Say this.** "If they are one judgement, the correlation is an artefact."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "The rivals are easy to knock down"

**What the student says or does.** The rivals are easy to knock down — usually while otherwise engaging well.

**Why it is understandable.** Students build strawmen without noticing.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Have somebody who prefers the rival check the statement.

**Say this.** "If you operationalise the rival, you will operationalise it to lose."
...
**Visual or physical support.** Provide the measurement map with one line worked as an example.
...
Ask for a published claim in any field that fails the constraint.
...
Specifically, do not introduce: Prespecified analysis plans as a formal requirement, gate compliance.
...
| | |
|---|---|
| **Follows** | Lesson 4 — The Four Failure Modes |
| **Leads to** | Lesson 6 — Measuring Persistence |

**Transition in.** Lesson 4 established students name the four ways Sim(t) capture goes wrong. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students separate intensity from arousal and from the outcome. Lesson 6 assumes it and builds students prespecify a persistence criterion and a sampling interval.
