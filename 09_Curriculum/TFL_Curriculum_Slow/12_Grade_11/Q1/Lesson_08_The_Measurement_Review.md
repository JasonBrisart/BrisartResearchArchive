# Lesson 8 — The Measurement Review
...
| | |
|---|---|
| **Central question** | The Measurement Review: students consolidate measurement? |
| **Core concept** | The Sim(t) line is consistently the hardest because simulation content resists specification. |
| **Student outcome** | Students consolidate measurement. |
| **Previous lesson** | Lesson 7 — Completing The Map |
| **Next lesson** | Lesson 9 — Three Other Explanations |
...
**The conceptual step.** The Sim(t) line is consistently the hardest because simulation content resists specification. The review tests whether vague lines are still being accepted.
...
**What depends on it.** Lesson 9 — Three Other Explanations — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The Sim(t) line is consistently the hardest because simulation content resists specification. The review tests whether vague lines are still being accepted.
...
1. A vague Sim(t) line correctly identified.
2. A map audited and three unrunnable lines found.

### One non-example

A map passed with a vague Sim(t) line.
...
Whether the executability standard is habitual.

### What this activity does not establish

Whether the maps are good.
...
| Statement | Status |
|---|---|
| The Sim(t) line is consistently the hardest because simulation content resists specification. | Framework-derived, appropriate at this grade |
| Whether the executability standard is habitual. | What this specific activity can show |
| Whether the maps are good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — Completing The Map — specifically: students produce a map every line of which is executable.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: rebuild the map and have two people mark it independently, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A vague Sim(t) line correctly identified. |
| **Non-example** | A map passed with a vague Sim(t) line. |
...
**Exact wording.** "Ask which of the seven lines is hardest, and why."
...
**Target observation.** Whether the executability standard is habitual.
...
> "The Sim(t) line is consistently the hardest because simulation content resists specification. You just saw that when ask which of the seven lines is hardest, and why.
...
**What students must not infer.** Whether the maps are good.

### 4. Worked example

**The example.** A vague Sim(t) line correctly identified.
...
**Completed answer.** A vague Sim(t) line correctly identified. — which demonstrates whether the executability standard is habitual.
...
**Conclusions not licensed.** Whether the maps are good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A map audited and three unrunnable lines found. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A map passed with a vague Sim(t) line. Why is this not an
example?"
...
**Exact student instructions.** Review with six maps audited for executability.
...
- *Licensed conclusion.* Whether the executability standard is habitual.
- *Not licensed.* Whether the maps are good.
...
- *Expected response.* Whether the executability standard is habitual.
...
1. Any wording carrying the idea in `The Sim(t) line is consistently the hardest because simulation content resists specification`.
...
Say: "Next time: three other explanations for everything you find."
...
| | |
|---|---|
| **Follows** | Lesson 7 — Completing The Map |
| **Leads to** | Lesson 9 — Three Other Explanations |

**Transition in.** Lesson 7 established students produce a map every line of which is executable. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate measurement. Lesson 9 assumes it and builds students state the three rival accounts.
