...
| | |
|---|---|
| **Central question** | Completing The Map: students produce a map every line of which is executable? |
| **Core concept** | Executability is established by independent markers returning no questions. |
| **Student outcome** | Students produce a map every line of which is executable. |
| **Previous lesson** | Lesson 6 — Measuring Persistence |
| **Next lesson** | Lesson 8 — The Measurement Review |
...
**The conceptual step.** Executability is established by independent markers returning no questions. One clean run may reflect a charitable reader rather than a complete map.
...
**What depends on it.** Lesson 8 — The Measurement Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Executability is established by independent markers returning no questions. One clean run may reflect a charitable reader rather than a complete map.
...
2. A map revised after the first marker and confirmed by the second.
...
Whether the map would yield good data.
...
| Statement | Status |
|---|---|
| Executability is established by independent markers returning no questions. | Framework-derived, appropriate at this grade |
| That executability is testable by independent handover. | What this specific activity can show |
| Whether the map would yield good data. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — Measuring Persistence — specifically: students prespecify a persistence criterion and a sampling interval.

**How it was taught.** Through the activity: complete both specifications and identify a post-hoc vulnerability in their own criterion

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: complete both specifications and identify a post-hoc vulnerability in their own criterion, in miniature, using one example only. Then ask for the sentence again.
...
> "Naming how your criterion could be gamed is what stops you gaming it."
...
**Exact wording.** "Say: rebuild it. This time nobody should have a single question."
...
> "Executability is established by independent markers returning no questions. You just saw that when say: rebuild it.
> Last time we said: Naming how your criterion could be gamed is what stops you gaming it. This is the next part of that.
...
**What students must not infer.** Whether the map would yield good data.
...
**Conclusions not licensed.** Whether the map would yield good data.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A map revised after the first marker and confirmed by the second. Work it through with me."
...
- *Not licensed.* Whether the map would yield good data.
...
1. Any wording carrying the idea in `Executability is established by independent markers returning no questions`.
...
| | |
|---|---|
| **Follows** | Lesson 6 — Measuring Persistence |
| **Leads to** | Lesson 8 — The Measurement Review |

**Transition in.** Lesson 6 established students prespecify a persistence criterion and a sampling interval. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students produce a map every line of which is executable. Lesson 8 assumes it and builds students consolidate measurement.
