...
| | |
|---|---|
| **Central question** | The Confound Review: students consolidate confound control? |
| **Core concept** | Dismissing a confound requires a written reason. |
| **Student outcome** | Students consolidate confound control. |
| **Previous lesson** | Lesson 23 — The Adjudicating Design |
| **Next lesson** | Lesson 25 — What Cannot Be Measured |
...
**The conceptual step.** Dismissing a confound requires a written reason. The review tests whether reasons are still being supplied under time pressure.
...
**What depends on it.** Lesson 25 — What Cannot Be Measured — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Dismissing a confound requires a written reason. The review tests whether reasons are still being supplied under time pressure.
...
1. A confound dismissed with an adequate reason.
2. An uncontrolled confound found in a peer design.

### One non-example

A confound dismissed as obviously not applicable.
...
Whether reasoned dismissal is habitual.
...
| Statement | Status |
|---|---|
| Dismissing a confound requires a written reason. | Framework-derived, appropriate at this grade |
| Whether reasoned dismissal is habitual. | What this specific activity can show |
| Whether the controls suffice. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — The Adjudicating Design — specifically: students present a design that distinguishes the four accounts.

**How it was taught.** Through the activity: a six-minute presentation facing one question from each rival advocate

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: a six-minute presentation facing one question from each rival advocate, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A confound dismissed with an adequate reason. |
| **Non-example** | A confound dismissed as obviously not applicable. |
...
**Exact wording.** "Ask which of the seven confounds is hardest to control."
...
**Target observation.** Whether reasoned dismissal is habitual.
...
> "Dismissing a confound requires a written reason. You just saw that when ask which of the seven confounds is hardest to control.
...
**The example.** A confound dismissed with an adequate reason.
...
**Completed answer.** A confound dismissed with an adequate reason. — which demonstrates whether reasoned dismissal is habitual.
...
**Teacher prompt.** "Here is a second case. An uncontrolled confound found in a peer design. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A confound dismissed as obviously not applicable. Why is this not an
example?"
...
**Exact student instructions.** Review with six designs audited for the seven confounds.
...
- *Licensed conclusion.* Whether reasoned dismissal is habitual.
...
- *Expected response.* Whether reasoned dismissal is habitual.
...
1. Any wording carrying the idea in `Dismissing a confound requires a written reason`.
...
Say: "Next time: measuring things nobody has measured yet."
...
| | |
|---|---|
| **Follows** | Lesson 23 — The Adjudicating Design |
| **Leads to** | Lesson 25 — What Cannot Be Measured |

**Transition in.** Lesson 23 established students present a design that distinguishes the four accounts. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate confound control. Lesson 25 assumes it and builds students identify framework claims that currently resist measurement.
