...
**Grade 11** · Measurement and Rivals · **Quarter 3** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Confounds: students identify what must be controlled for a result to mean anything? |
| **Core concept** | Seven standard confounds apply to persistence work, and selection of which predictions get logged is the one that most often goes unnoticed. |
| **Student outcome** | Students identify what must be controlled for a result to mean anything. |
| **Previous lesson** | Lesson 16 — The Rivals Review |
| **Next lesson** | Lesson 18 — Intensity And Ambiguity |
...
**The conceptual step.** Seven standard confounds apply to persistence work, and selection of which predictions get logged is the one that most often goes unnoticed.
...
**What depends on it.** Lesson 18 — Intensity And Ambiguity — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Seven standard confounds apply to persistence work, and selection of which predictions get logged is the one that most often goes unnoticed.
...
2. A confound dismissed with a written reason.

### One non-example

Four confounds marked not applicable with no reasons.
...
That confounds can be enumerated and addressed.
...
| Statement | Status |
|---|---|
| Seven standard confounds apply to persistence work, and selection of which predictions get logged is the one that most often goes unnoticed. | Framework-derived, appropriate at this grade |
| That confounds can be enumerated and addressed. | What this specific activity can show |
| Whether the controls are sufficient. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Rivals Review — specifically: students consolidate the rival accounts.

**How it was taught.** Through the activity: review with a five-row differential table completed

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with a five-row differential table completed, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | Four confounds marked not applicable with no reasons. |
...
> "Next time: what would ruin your result."
...
**Exact wording.** "Say: your design is the defendant today. Most will not survive intact."
...
**Target observation.** That confounds can be enumerated and addressed.
...
> "Seven standard confounds apply to persistence work, and selection of which predictions get logged is the one that most often goes unnoticed. You just saw that when say: your design is the defendant today.
> Last time we said: Next time: what would ruin your result. This is the next part of that.
...
**What students must not infer.** Whether the controls are sufficient.
...
**Completed answer.** A confound controlled with the residual risk named. — which demonstrates that confounds can be enumerated and addressed.
...
**Conclusions not licensed.** Whether the controls are sufficient.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A confound dismissed with a written reason. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Four confounds marked not applicable with no reasons. Why is this not an
example?"
...
**Exact student instructions.** Complete a seven-row confound table with a control and residual risk for each.
...
- *Licensed conclusion.* That confounds can be enumerated and addressed.
- *Not licensed.* Whether the controls are sufficient.
...
- *Expected response.* That confounds can be enumerated and addressed.
...
1. Any wording carrying the idea in `Seven standard confounds apply to persistence work, and selection of which predictions get logged is the one that most often goes unnoticed`.
...
Say: "The seventh one ruined your Grade 7 logs and nobody noticed at the time."
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Rivals Review |
| **Leads to** | Lesson 18 — Intensity And Ambiguity |

**Transition in.** Lesson 16 established students consolidate the rival accounts. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify what must be controlled for a result to mean anything. Lesson 18 assumes it and builds students separate the two variables that usually move together.
