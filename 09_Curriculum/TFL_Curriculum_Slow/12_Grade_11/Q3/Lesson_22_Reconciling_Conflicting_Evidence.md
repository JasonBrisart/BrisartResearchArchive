# Lesson 22 — Reconciling Conflicting Evidence
...
| | |
|---|---|
| **Central question** | Reconciling Conflicting Evidence: students handle results that point in different directions? |
| **Core concept** | Conflicting results are both recorded and a resolving observation is named. |
| **Student outcome** | Students handle results that point in different directions. |
| **Previous lesson** | Lesson 21 — Answering The Audit |
| **Next lesson** | Lesson 23 — The Adjudicating Design |
...
**The conceptual step.** Conflicting results are both recorded and a resolving observation is named. Discarding the inconvenient one is the error this lesson prevents.
...
**What depends on it.** Lesson 23 — The Adjudicating Design — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Conflicting results are both recorded and a resolving observation is named. Discarding the inconvenient one is the error this lesson prevents.
...
1. Both results written up with a resolving observation named.
2. A conflict left open with the resolver specified.

### One non-example

The result matching the student's expectation retained alone.
...
**Prerequisite.** The content of Lesson 21 — Answering The Audit — specifically: students revise a design against adversarial feedback.

**How it was taught.** Through the activity: revise the design against all three attacks and state what changed

**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: revise the design against all three attacks and state what changed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Both results written up with a resolving observation named. |
| **Non-example** | The result matching the student's expectation retained alone. |
...
**Exact wording.** "Put up two conflicting class results, both honestly collected, and ask what now."
...
> "Conflicting results are both recorded and a resolving observation is named. You just saw that when put up two conflicting class results, both honestly collected, and ask what now.
...
**The example.** Both results written up with a resolving observation named.
...
**Completed answer.** Both results written up with a resolving observation named. — which demonstrates that conflicts are recorded rather than resolved by preference.
...
**Teacher prompt.** "Now one that does not work. The result matching the student's expectation retained alone. Why is this not an
example?"
...
Say: "You do not pick the one you like."
...
| | |
|---|---|
| **Follows** | Lesson 21 — Answering The Audit |
| **Leads to** | Lesson 23 — The Adjudicating Design |

**Transition in.** Lesson 21 established students revise a design against adversarial feedback. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students handle results that point in different directions. Lesson 23 assumes it and builds students present a design that distinguishes the four accounts.
