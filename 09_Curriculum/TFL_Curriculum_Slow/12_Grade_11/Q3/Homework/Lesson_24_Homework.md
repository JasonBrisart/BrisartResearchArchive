# Lesson 24 Homework — The Confound Review

**Grade 11** · Measurement and Rivals · **Quarter 3**
**Follows:** Lesson 24 — The Confound Review · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 24 ended on, from memory:
...
Review with six designs audited for the seven confounds.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class finds uncontrolled confounds in at least four designs
...
Lesson 25 is **What Cannot Be Measured**, which assumes you arrive holding it. Write one thing you expect it to be about:
