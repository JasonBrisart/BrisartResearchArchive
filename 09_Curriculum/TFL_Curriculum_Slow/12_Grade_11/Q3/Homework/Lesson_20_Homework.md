# Lesson 20 Homework — The Adversarial Audit

**Grade 11** · Measurement and Rivals · **Quarter 3**
**Follows:** Lesson 20 — The Adversarial Audit · **Points:** 5 · **Optional:** yes
...
Three rotating rounds of written attack; designers take notes without defending.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student receives three attacks, one per rival
...
Lesson 21 is **Answering The Audit**, which assumes you arrive holding it. Write one thing you expect it to be about:
