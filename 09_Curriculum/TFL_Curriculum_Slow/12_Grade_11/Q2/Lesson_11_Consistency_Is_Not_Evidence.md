# Lesson 11 — Consistency Is Not Evidence
...
| | |
|---|---|
| **Central question** | Consistency Is Not Evidence: students discover their own results fit the rivals equally well? |
| **Core concept** | A result every account predicts distinguishes between none of them. |
| **Student outcome** | Students discover their own results fit the rivals equally well. |
| **Previous lesson** | Lesson 10 — Stating A Rival Fairly |
| **Next lesson** | Lesson 12 — The Discriminating Condition |
...
**The conceptual step.** A result every account predicts distinguishes between none of them. Plausibility arguments do not substitute for differential prediction.
...
**What depends on it.** Lesson 12 — The Discriminating Condition — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A result every account predicts distinguishes between none of them. Plausibility arguments do not substitute for differential prediction.
...
2. A student concluding their result discriminates nothing.

### One non-example

An argument that the rivals are less plausible.
...
| Statement | Status |
|---|---|
| A result every account predicts distinguishes between none of them. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 10 — Stating A Rival Fairly — specifically: students state rivals as their proponents would.

**How it was taught.** Through the activity: write each rival and have it checked by a classmate assigned to defend it

**Quick check.** Ask for the closing sentence of Lesson 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 10: write each rival and have it checked by a classmate assigned to defend it, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | An argument that the rivals are less plausible. |
...
**Exact wording.** "Put a student result on the board with its framework explanation, then apply each rival."
...
> "A result every account predicts distinguishes between none of them. You just saw that when put a student result on the board with its framework explanation, then apply each rival.
...
**Teacher prompt.** "Here is a second case. A student concluding their result discriminates nothing. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An argument that the rivals are less plausible. Why is this not an
example?"
...
1. Any wording carrying the idea in `A result every account predicts distinguishes between none of them`.
...
Say: "Fitting is not supporting. Distinguishing requires a design."
...
| | |
|---|---|
| **Follows** | Lesson 10 — Stating A Rival Fairly |
| **Leads to** | Lesson 12 — The Discriminating Condition |

**Transition in.** Lesson 10 established students state rivals as their proponents would. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students discover their own results fit the rivals equally well. Lesson 12 assumes it and builds students identify where the four accounts come apart.
