# Lesson 14 — Redesigning To Discriminate
...
| | |
|---|---|
| **Central question** | Redesigning To Discriminate: students revise a design so it enters the discriminating condition? |
| **Core concept** | Entering the discriminating condition costs naturalness, sample availability, or effort. |
| **Student outcome** | Students revise a design so it enters the discriminating condition. |
| **Previous lesson** | Lesson 13 — The Generalisation Problem |
| **Next lesson** | Lesson 15 — Rivals From Elsewhere |
...
**The conceptual step.** Entering the discriminating condition costs naturalness, sample availability, or effort. Stating the cost is part of the redesign.
...
**What depends on it.** Lesson 15 — Rivals From Elsewhere — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Entering the discriminating condition costs naturalness, sample availability, or effort. Stating the cost is part of the redesign.
...
2. A cost stated as reduced ecological validity.

### One non-example

A redesign claiming entry on three criteria.
...
| Statement | Status |
|---|---|
| Entering the discriminating condition costs naturalness, sample availability, or effort. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 13 — The Generalisation Problem — specifically: students address the rarity of the discriminating condition.

**How it was taught.** Through the activity: write the generalisation limit for their own design

**Quick check.** Ask for the closing sentence of Lesson 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 13: write the generalisation limit for their own design, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A redesign claiming entry on three criteria. |
...
> "Laboratory results in a rare cell tell you about mechanism, not typical operation."
...
**Exact wording.** "Say: your design does not enter the cell. Redesign it."
...
> "Entering the discriminating condition costs naturalness, sample availability, or effort. You just saw that when say: your design does not enter the cell.
> Last time we said: Laboratory results in a rare cell tell you about mechanism, not typical operation. This is the next part of that.
...
**Teacher prompt.** "Here is a second case. A cost stated as reduced ecological validity. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A redesign claiming entry on three criteria. Why is this not an
example?"
...
**Exact student instructions.** Redesign one investigation to enter the cell and state the cost.
...
1. Any wording carrying the idea in `Entering the discriminating condition costs naturalness, sample availability, or effort`.
...
| | |
|---|---|
| **Follows** | Lesson 13 — The Generalisation Problem |
| **Leads to** | Lesson 15 — Rivals From Elsewhere |

**Transition in.** Lesson 13 established students address the rarity of the discriminating condition. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students revise a design so it enters the discriminating condition. Lesson 15 assumes it and builds students find competing accounts outside the supplied three.
