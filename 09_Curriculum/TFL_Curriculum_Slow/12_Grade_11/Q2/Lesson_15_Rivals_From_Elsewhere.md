# Lesson 15 — Rivals From Elsewhere
...
| | |
|---|---|
| **Central question** | Rivals From Elsewhere: students find competing accounts outside the supplied three? |
| **Core concept** | The three supplied rivals are teaching devices. |
| **Student outcome** | Students find competing accounts outside the supplied three. |
| **Previous lesson** | Lesson 14 — Redesigning To Discriminate |
| **Next lesson** | Lesson 16 — The Rivals Review |
...
**The conceptual step.** The three supplied rivals are teaching devices. Real competition comes from the student's own reading, and non-divergence has three possible explanations.
...
**What depends on it.** Lesson 16 — The Rivals Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The three supplied rivals are teaching devices. Real competition comes from the student's own reading, and non-divergence has three possible explanations.
...
1. An outside account with a stated divergence.
2. An outside account found to make no distinguishable prediction.

### One non-example

An outside account presented with no divergence attempted.
...
That the competition extends beyond the supplied three.
...
| Statement | Status |
|---|---|
| The three supplied rivals are teaching devices. | Framework-derived, appropriate at this grade |
| That the competition extends beyond the supplied three. | What this specific activity can show |
| Which account is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Redesigning To Discriminate — specifically: students revise a design so it enters the discriminating condition.

**How it was taught.** Through the activity: redesign one investigation to enter the cell and state the cost

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: redesign one investigation to enter the cell and state the cost, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An outside account with a stated divergence. |
| **Non-example** | An outside account presented with no divergence attempted. |
...
**Exact wording.** "Say: uncertainty, arousal, and habit are teaching rivals. What else is out there?"
...
**Target observation.** That the competition extends beyond the supplied three.
...
> "The three supplied rivals are teaching devices. You just saw that when say: uncertainty, arousal, and habit are teaching rivals.
...
**The example.** An outside account with a stated divergence.
...
**Completed answer.** An outside account with a stated divergence. — which demonstrates that the competition extends beyond the supplied three.
...
**Teacher prompt.** "Here is a second case. An outside account found to make no distinguishable prediction. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An outside account presented with no divergence attempted. Why is this not an
example?"
...
**Exact student instructions.** Identify two outside accounts and state where each diverges from TFL.
...
- *Licensed conclusion.* That the competition extends beyond the supplied three.
...
- *Expected response.* That the competition extends beyond the supplied three.
...
1. Any wording carrying the idea in `The three supplied rivals are teaching devices`.
...
Say: "The real competition is bigger than three."
...
| | |
|---|---|
| **Follows** | Lesson 14 — Redesigning To Discriminate |
| **Leads to** | Lesson 16 — The Rivals Review |

**Transition in.** Lesson 14 established students revise a design so it enters the discriminating condition. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find competing accounts outside the supplied three. Lesson 16 assumes it and builds students consolidate the rival accounts.
