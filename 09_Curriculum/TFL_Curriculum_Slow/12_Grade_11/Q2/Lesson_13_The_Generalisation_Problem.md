# Lesson 13 — The Generalisation Problem
...
| | |
|---|---|
| **Central question** | The Generalisation Problem: students address the rarity of the discriminating condition? |
| **Core concept** | The discriminating condition is rare in natural settings. |
| **Student outcome** | Students address the rarity of the discriminating condition. |
| **Previous lesson** | Lesson 12 — The Discriminating Condition |
| **Next lesson** | Lesson 14 — Redesigning To Discriminate |
...
**The conceptual step.** The discriminating condition is rare in natural settings. Results obtained there speak to mechanism rather than to typical operation, and the limit must be stated.
...
**What depends on it.** Lesson 14 — Redesigning To Discriminate — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The discriminating condition is rare in natural settings. Results obtained there speak to mechanism rather than to typical operation, and the limit must be stated.
...
1. A stated limit that results apply to the rare condition only.
2. An honest estimate that the condition is uncommon.

### One non-example

A claim that the condition occurs frequently in daily life.
...
That rarity constrains generalisation.

### What this activity does not establish

How rare the condition actually is.
...
| That rarity constrains generalisation. | What this specific activity can show |
| How rare the condition actually is. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — The Discriminating Condition — specifically: students identify where the four accounts come apart.

**How it was taught.** Through the activity: identify the discriminating condition and state whether their design enters it

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: identify the discriminating condition and state whether their design enters it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A stated limit that results apply to the rare condition only. |
| **Non-example** | A claim that the condition occurs frequently in daily life. |
...
> "Any design that never enters that cell is not adjudicating."
...
**Exact wording.** "Ask how often, in real life, somebody cares intensely about something already settled and novel."
...
**Target observation.** That rarity constrains generalisation.
...
> "The discriminating condition is rare in natural settings. You just saw that when ask how often, in real life, somebody cares intensely about something already settled and novel.
> Last time we said: Any design that never enters that cell is not adjudicating. This is the next part of that.
...
**What students must not infer.** How rare the condition actually is.

### 4. Worked example

**The example.** A stated limit that results apply to the rare condition only.
...
**Completed answer.** A stated limit that results apply to the rare condition only. — which demonstrates that rarity constrains generalisation.
...
**Conclusions not licensed.** How rare the condition actually is.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An honest estimate that the condition is uncommon. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that the condition occurs frequently in daily life. Why is this not an
example?"
...
**Exact student instructions.** Write the generalisation limit for their own design.
...
- *Licensed conclusion.* That rarity constrains generalisation.
- *Not licensed.* How rare the condition actually is.
...
- *Expected response.* That rarity constrains generalisation.
...
Say: "Laboratory results in a rare cell tell you about mechanism, not typical operation."
...
| | |
|---|---|
| **Follows** | Lesson 12 — The Discriminating Condition |
| **Leads to** | Lesson 14 — Redesigning To Discriminate |

**Transition in.** Lesson 12 established students identify where the four accounts come apart. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students address the rarity of the discriminating condition. Lesson 14 assumes it and builds students revise a design so it enters the discriminating condition.
