# Lesson 10 Homework — Stating A Rival Fairly

**Grade 11** · Measurement and Rivals · **Quarter 2**
**Follows:** Lesson 10 — Stating A Rival Fairly · **Points:** 5 · **Optional:** yes
...
Write each rival and have it checked by a classmate assigned to defend it.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every rival statement carries a recorded objection from a checker
...
Lesson 11 is **Consistency Is Not Evidence**, which assumes you arrive holding it. Write one thing you expect it to be about:
