...
| | |
|---|---|
| **Central question** | The Honest Write-Up: students write a result with limits, confounds, and alternatives stated? |
| **Core concept** | An honest write-up contains the result, its limits, the confounds addressed, and the alternative explanations. |
| **Student outcome** | Students write a result with limits, confounds, and alternatives stated. |
| **Previous lesson** | Lesson 27 — Resolution And Claim Scale |
| **Next lesson** | Lesson 29 — Explaining Measurement |
...
**The conceptual step.** An honest write-up contains the result, its limits, the confounds addressed, and the alternative explanations. The alternatives are the most frequently omitted.
...
**What depends on it.** Lesson 29 — Explaining Measurement — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An honest write-up contains the result, its limits, the confounds addressed, and the alternative explanations. The alternatives are the most frequently omitted.
...
1. A write-up containing all four elements.
2. A write-up naming two genuine alternatives.

### One non-example

A write-up with results and limits but no alternatives.
...
That honest reporting has stateable components.
...
| Statement | Status |
|---|---|
| An honest write-up contains the result, its limits, the confounds addressed, and the alternative explanations. | Framework-derived, appropriate at this grade |
| That honest reporting has stateable components. | What this specific activity can show |
| Whether the result is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — Resolution And Claim Scale — specifically: students match what they claim to what they observed.

**How it was taught.** Through the activity: write a resolution declaration naming the conclusions their design does not license

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: write a resolution declaration naming the conclusions their design does not license, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A write-up containing all four elements. |
| **Non-example** | A write-up with results and limits but no alternatives. |
...
> "Observing at one scale and concluding at another is the commonest error in this area."
...
**Exact wording.** "Say: everything you know about being honest with a result. In one document."
...
**Target observation.** That honest reporting has stateable components.
...
> "An honest write-up contains the result, its limits, the confounds addressed, and the alternative explanations. You just saw that when say: everything you know about being honest with a result.
> Last time we said: Observing at one scale and concluding at another is the commonest error in this area. This is the next part of that.
...
**The example.** A write-up containing all four elements.
...
**Completed answer.** A write-up containing all four elements. — which demonstrates that honest reporting has stateable components.
...
**Teacher prompt.** "Here is a second case. A write-up naming two genuine alternatives. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A write-up with results and limits but no alternatives. Why is this not an
example?"
...
**Exact student instructions.** A complete write-up with results, limits, confounds, and alternatives.
...
- *Licensed conclusion.* That honest reporting has stateable components.
...
- *Expected response.* That honest reporting has stateable components.
...
1. Any wording carrying the idea in `An honest write-up contains the result, its limits, the confounds addressed, and the alternative explanations`.
...
Say: "That is what an honest result looks like."
...
| | |
|---|---|
| **Follows** | Lesson 27 — Resolution And Claim Scale |
| **Leads to** | Lesson 29 — Explaining Measurement |

**Transition in.** Lesson 27 established students match what they claim to what they observed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students write a result with limits, confounds, and alternatives stated. Lesson 29 assumes it and builds students explain why measurement is hard here to somebody else.
