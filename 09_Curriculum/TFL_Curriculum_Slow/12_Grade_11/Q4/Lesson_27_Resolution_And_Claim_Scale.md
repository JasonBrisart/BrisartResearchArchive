# Lesson 27 — Resolution And Claim Scale
...
| | |
|---|---|
| **Central question** | Resolution And Claim Scale: students match what they claim to what they observed? |
| **Core concept** | A resolution declaration matches claim scale to observation scale and names the conclusions the design does not license. |
| **Student outcome** | Students match what they claim to what they observed. |
| **Previous lesson** | Lesson 26 — Estimating The Weights |
| **Next lesson** | Lesson 28 — The Honest Write-Up |
...
**The conceptual step.** A resolution declaration matches claim scale to observation scale and names the conclusions the design does not license.
...
**What depends on it.** Lesson 28 — The Honest Write-Up — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A resolution declaration matches claim scale to observation scale and names the conclusions the design does not license.
...
1. A declaration excluding within-window conclusions.
2. A named conclusion the design cannot support.

### One non-example

A declaration stating that limitations exist.
...
That claim scale must match observation scale.
...
| Statement | Status |
|---|---|
| A resolution declaration matches claim scale to observation scale and names the conclusions the design does not license. | Framework-derived, appropriate at this grade |
| That claim scale must match observation scale. | What this specific activity can show |
| Whether the design is otherwise sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — Estimating The Weights — specifically: students determine whether their design can recover parameters.

**How it was taught.** Through the activity: write an estimation feasibility statement naming which claims survive without the weights

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: write an estimation feasibility statement naming which claims survive without the weights, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A declaration excluding within-window conclusions. |
| **Non-example** | A declaration stating that limitations exist. |
...
> "Most designs cannot. Declaring that is the correct answer."
...
**Exact wording.** "Say: the framework specifies windows of milliseconds. You observe at minutes. What follows?"
...
**Target observation.** That claim scale must match observation scale.
...
> "A resolution declaration matches claim scale to observation scale and names the conclusions the design does not license. You just saw that when say: the framework specifies windows of milliseconds.
> Last time we said: Most designs cannot. Declaring that is the correct answer. This is the next part of that.
...
**The example.** A declaration excluding within-window conclusions.
...
**Completed answer.** A declaration excluding within-window conclusions. — which demonstrates that claim scale must match observation scale.
...
**Teacher prompt.** "Now one that does not work. A declaration stating that limitations exist. Why is this not an
example?"
...
**Exact student instructions.** Write a resolution declaration naming the conclusions their design does not license.
...
- *Licensed conclusion.* That claim scale must match observation scale.
...
- *Expected response.* That claim scale must match observation scale.
...
1. Any wording carrying the idea in `A resolution declaration matches claim scale to observation scale and names the conclusions the design does not license`.
...
Say: "Observing at one scale and concluding at another is the commonest error in this area."
...
| | |
|---|---|
| **Follows** | Lesson 26 — Estimating The Weights |
| **Leads to** | Lesson 28 — The Honest Write-Up |

**Transition in.** Lesson 26 established students determine whether their design can recover parameters. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students match what they claim to what they observed. Lesson 28 assumes it and builds students write a result with limits, confounds, and alternatives stated.
