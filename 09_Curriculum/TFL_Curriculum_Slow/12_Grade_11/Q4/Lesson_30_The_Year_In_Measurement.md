# Lesson 30 — The Year In Measurement
...
| | |
|---|---|
| **Central question** | The Year In Measurement: students review the year through their own maps? |
| **Core concept** | Comparing the first measurement map with the latest gives direct evidence of the year's progress in operationalisation. |
| **Student outcome** | Students review the year through their own maps. |
| **Previous lesson** | Lesson 29 — Explaining Measurement |
...
**The conceptual step.** Comparing the first measurement map with the latest gives direct evidence of the year's progress in operationalisation.
...
Comparing the first measurement map with the latest gives direct evidence of the year's progress in operationalisation.
...
1. A Lesson 2 map beside a Lesson 27 one.
2. A student noticing their early maps described intentions.

### One non-example

Reviewing only the most recent map.
...
That the student's measurement work improved measurably.
...
| Statement | Status |
|---|---|
| Comparing the first measurement map with the latest gives direct evidence of the year's progress in operationalisation. | Framework-derived, appropriate at this grade |
| That the student's measurement work improved measurably. | What this specific activity can show |
| Any external quality standard. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 29 — Explaining Measurement — specifically: students explain why measurement is hard here to somebody else.
...
| **Correct example** | A Lesson 2 map beside a Lesson 27 one. |
| **Non-example** | Reviewing only the most recent map. |
...
> "Most people assume measurement is the easy part."
...
**Exact wording.** "Lay out every measurement map from the year."
...
**Target observation.** That the student's measurement work improved measurably.
...
> "Comparing the first measurement map with the latest gives direct evidence of the year's progress in operationalisation. You just saw that when lay out every measurement map from the year.
> Last time we said: Most people assume measurement is the easy part. This is the next part of that.
...
**The example.** A Lesson 2 map beside a Lesson 27 one.
...
**Completed answer.** A Lesson 2 map beside a Lesson 27 one. — which demonstrates that the student's measurement work improved measurably.
...
**Teacher prompt.** "Here is a second case. A student noticing their early maps described intentions. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reviewing only the most recent map. Why is this not an
example?"
...
**Exact student instructions.** Compare the Lesson 2 map with the latest and write what changed.
...
- *Licensed conclusion.* That the student's measurement work improved measurably.
...
- *Expected response.* That the student's measurement work improved measurably.
...
1. Any wording carrying the idea in `Comparing the first measurement map with the latest gives direct evidence of the year's progress in operationalisation`.
...
Say: "Next year: falsification, scope, and a capstone you defend."
...
| | |
|---|---|
| **Follows** | Lesson 29 — Explaining Measurement |
| **Leads to** | Lesson 31 — Practice Final |

**Transition in.** Lesson 29 established students explain why measurement is hard here to somebody else. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students review the year through their own maps. Lesson 31 assumes it and builds students rehearse the final under conditions.
