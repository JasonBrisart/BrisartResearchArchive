# Lesson 29 — Explaining Measurement
...
| | |
|---|---|
| **Central question** | Explaining Measurement: students explain why measurement is hard here to somebody else? |
| **Core concept** | Explaining measurement difficulty requires naming the specific failure modes. |
| **Student outcome** | Students explain why measurement is hard here to somebody else. |
| **Previous lesson** | Lesson 28 — The Honest Write-Up |
| **Next lesson** | Lesson 30 — The Year In Measurement |
...
**The conceptual step.** Explaining measurement difficulty requires naming the specific failure modes. Presenting it as straightforward misses the content.
...
**What depends on it.** Lesson 30 — The Year In Measurement — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Explaining measurement difficulty requires naming the specific failure modes. Presenting it as straightforward misses the content.
...
1. An explanation naming the four Sim(t) failure modes.
2. A listener asking why self-report is used at all.

### One non-example

An explanation presenting measurement as routine.
...
Whether the difficulties are held specifically.
...
| Statement | Status |
|---|---|
| Explaining measurement difficulty requires naming the specific failure modes. | Framework-derived, appropriate at this grade |
| Whether the difficulties are held specifically. | What this specific activity can show |
| Whether measurement is possible. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — The Honest Write-Up — specifically: students write a result with limits, confounds, and alternatives stated.

**How it was taught.** Through the activity: a complete write-up with results, limits, confounds, and alternatives

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: a complete write-up with results, limits, confounds, and alternatives, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An explanation naming the four Sim(t) failure modes. |
| **Non-example** | An explanation presenting measurement as routine. |
...
> "That is what an honest result looks like."
...
**Exact wording.** "Say: today you teach why this is difficult."
...
**Target observation.** Whether the difficulties are held specifically.
...
> "Explaining measurement difficulty requires naming the specific failure modes. You just saw that when say: today you teach why this is difficult.
> Last time we said: That is what an honest result looks like. This is the next part of that.
...
**What students must not infer.** Whether measurement is possible.

### 4. Worked example

**The example.** An explanation naming the four Sim(t) failure modes.
...
**Completed answer.** An explanation naming the four Sim(t) failure modes. — which demonstrates whether the difficulties are held specifically.
...
**Conclusions not licensed.** Whether measurement is possible.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A listener asking why self-report is used at all. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An explanation presenting measurement as routine. Why is this not an
example?"
...
- *Licensed conclusion.* Whether the difficulties are held specifically.
- *Not licensed.* Whether measurement is possible.
...
- *Expected response.* Whether the difficulties are held specifically.
...
1. Any wording carrying the idea in `Explaining measurement difficulty requires naming the specific failure modes`.
...
Say: "Most people assume measurement is the easy part."
...
| | |
|---|---|
| **Follows** | Lesson 28 — The Honest Write-Up |
| **Leads to** | Lesson 30 — The Year In Measurement |

**Transition in.** Lesson 28 established students write a result with limits, confounds, and alternatives stated. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain why measurement is hard here to somebody else. Lesson 30 assumes it and builds students review the year through their own maps.
