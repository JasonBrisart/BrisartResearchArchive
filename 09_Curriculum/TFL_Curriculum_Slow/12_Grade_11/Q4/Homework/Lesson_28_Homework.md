# Lesson 28 Homework — The Honest Write-Up

**Grade 11** · Measurement and Rivals · **Quarter 4**
**Follows:** Lesson 28 — The Honest Write-Up · **Points:** 5 · **Optional:** yes
...
A complete write-up with results, limits, confounds, and alternatives.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every write-up contains all four elements
...
Lesson 29 is **Explaining Measurement**, which assumes you arrive holding it. Write one thing you expect it to be about:
