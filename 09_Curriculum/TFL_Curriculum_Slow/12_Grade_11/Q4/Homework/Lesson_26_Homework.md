# Lesson 26 Homework — Estimating The Weights

**Grade 11** · Measurement and Rivals · **Quarter 4**
**Follows:** Lesson 26 — Estimating The Weights · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 26 ended on, from memory:
...
Write an estimation feasibility statement naming which claims survive without the weights.
...
Lesson 27 is **Resolution And Claim Scale**, which assumes you arrive holding it. Write one thing you expect it to be about:
