# Lesson 27 Homework — Resolution And Claim Scale

**Grade 11** · Measurement and Rivals · **Quarter 4**
**Follows:** Lesson 27 — Resolution And Claim Scale · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 27 ended on, from memory:
...
Write a resolution declaration naming the conclusions their design does not license.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names real excluded conclusions
...
Lesson 28 is **The Honest Write-Up**, which assumes you arrive holding it. Write one thing you expect it to be about:
