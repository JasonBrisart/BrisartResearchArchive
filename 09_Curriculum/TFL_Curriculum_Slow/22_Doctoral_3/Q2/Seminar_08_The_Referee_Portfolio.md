# Seminar 8 — The Referee Portfolio
...
| | |
|---|---|
| **Central question** | The Referee Portfolio: participants produce two full referee reports? |
| **Core concept** | A referee portfolio demonstrates consistent seven-section reporting with located findings. |
| **Student outcome** | Participants produce two full referee reports. |
| **Previous seminar** | Seminar 7 — Calibration |
| **Next seminar** | Seminar 9 — Moving A Question |
...
**The conceptual step.** A referee portfolio demonstrates consistent seven-section reporting with located findings. A verdict resting on the framework's status incurs an automatic deduction.
...
**What depends on it.** Seminar 9 — Moving A Question — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A referee portfolio demonstrates consistent seven-section reporting with located findings. A verdict resting on the framework's status incurs an automatic deduction.
...
1. Two reports with located findings throughout.
2. A report whose verdict rests entirely on design quality.

### One non-example

A report recommending rejection because the framework is unvalidated.
...
That referee standard is consistent and auditable.

### What this activity does not establish

Whether the manuscripts are sound.
...
| Statement | Status |
|---|---|
| A referee portfolio demonstrates consistent seven-section reporting with located findings. | Framework-derived, appropriate at this grade |
| That referee standard is consistent and auditable. | What this specific activity can show |
| Whether the manuscripts are sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 7 — Calibration — specifically: participants compare reports against others on the same work.

**How it was taught.** Through the activity: compare their report against the instructor's and two peers', classifying divergence

**Quick check.** Ask for the closing sentence of Seminar 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 7: compare their report against the instructor's and two peers', classifying divergence, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two reports with located findings throughout. |
| **Non-example** | A report recommending rejection because the framework is unvalidated. |
...
> "Disagreement about whether the framework's existence is the problem is not normal."
...
**Exact wording.** "Say: two manuscripts. Blind. No discussion during."
...
**Target observation.** That referee standard is consistent and auditable.
...
> "A referee portfolio demonstrates consistent seven-section reporting with located findings. You just saw that when say: two manuscripts.
> Last time we said: Disagreement about whether the framework's existence is the problem is not normal. This is the next part of that.
...
**What students must not infer.** Whether the manuscripts are sound.

### 4. Worked example

**The example.** Two reports with located findings throughout.
...
**Completed answer.** Two reports with located findings throughout. — which demonstrates that referee standard is consistent and auditable.
...
**Conclusions not licensed.** Whether the manuscripts are sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A report whose verdict rests entirely on design quality. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A report recommending rejection because the framework is unvalidated. Why is this not an
example?"
...
**Exact student instructions.** Two complete seven-section reports submitted.
...
- *Licensed conclusion.* That referee standard is consistent and auditable.
- *Not licensed.* Whether the manuscripts are sound.
...
- *Expected response.* That referee standard is consistent and auditable.
...
1. Any wording carrying the idea in `A referee portfolio demonstrates consistent seven-section reporting with located findings`.
...
Say: "That is referee-standard work."
...
| | |
|---|---|
| **Follows** | Seminar 7 — Calibration |
| **Leads to** | Seminar 9 — Moving A Question |

**Transition in.** Seminar 7 established participants compare reports against others on the same work. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants produce two full referee reports. Seminar 9 assumes it and builds participants define a question narrow enough to be moved.
