...
| | |
|---|---|
| **Central question** | Calibration: participants compare reports against others on the same work? |
| **Core concept** | Reviewer divergence classifies as a disagreement about fact or about standard. |
| **Student outcome** | Participants compare reports against others on the same work. |
| **Previous seminar** | Seminar 6 — Auditing Adjudication And Inference |
| **Next seminar** | Seminar 8 — The Referee Portfolio |
...
**The conceptual step.** Reviewer divergence classifies as a disagreement about fact or about standard. Divergence traceable to the framework's status is a reviewer error rather than a legitimate difference.
...
**What depends on it.** Seminar 8 — The Referee Portfolio — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Reviewer divergence classifies as a disagreement about fact or about standard. Divergence traceable to the framework's status is a reviewer error rather than a legitimate difference.
...
1. A divergence classified as a standards difference.
2. A divergence traced to a reviewer reviewing the framework.
...
| Statement | Status |
|---|---|
| Reviewer divergence classifies as a disagreement about fact or about standard. | Framework-derived, appropriate at this grade |
| That divergence has classifiable sources. | What this specific activity can show |
| Which report is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 6 — Auditing Adjudication And Inference — specifically: participants judge rival fairness and the inference gap.

**How it was taught.** Through the activity: audit two manuscripts, stating the gap in whichever direction it runs

**Quick check.** Ask for the closing sentence of Seminar 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 6: audit two manuscripts, stating the gap in whichever direction it runs, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A divergence classified as a standards difference. |
...
> "The gap runs both ways. Underclaiming is also a finding."
...
**Exact wording.** "Put up two divergent reports on one manuscript, read anonymously."
...
> "Reviewer divergence classifies as a disagreement about fact or about standard. You just saw that when put up two divergent reports on one manuscript, read anonymously.
> Last time we said: The gap runs both ways. Underclaiming is also a finding. This is the next part of that.
...
**What students must not infer.** Which report is correct.

### 4. Worked example

**The example.** A divergence classified as a standards difference.
...
**Completed answer.** A divergence classified as a standards difference. — which demonstrates that divergence has classifiable sources.
...
**Conclusions not licensed.** Which report is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A divergence traced to a reviewer reviewing the framework. Work it through with me."
...
**Exact student instructions.** Compare their report against the instructor's and two peers', classifying divergence.
...
- *Not licensed.* Which report is correct.
...
1. Any wording carrying the idea in `Reviewer divergence classifies as a disagreement about fact or about standard`.
...
Say: "Disagreement about whether the framework's existence is the problem is not normal."
...
| | |
|---|---|
| **Follows** | Seminar 6 — Auditing Adjudication And Inference |
| **Leads to** | Seminar 8 — The Referee Portfolio |

**Transition in.** Seminar 6 established participants judge rival fairness and the inference gap. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants compare reports against others on the same work. Seminar 8 assumes it and builds participants produce two full referee reports.
