...
| | |
|---|---|
| **Central question** | The Reverse Ladder: participants state what a null result licenses? |
| **Core concept** | The reverse ladder states what a null licenses. |
| **Student outcome** | Participants state what a null result licenses. |
| **Previous seminar** | Seminar 2 — The Inference Ladder |
| **Next seminar** | Seminar 4 — The Referee's Problem |
...
**The conceptual step.** The reverse ladder states what a null licenses. A null fires a falsification condition only if the condition was prespecified and the controls held.
...
**What depends on it.** Seminar 4 — The Referee's Problem — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The reverse ladder states what a null licenses. A null fires a falsification condition only if the condition was prespecified and the controls held.
...
2. A reverse ladder confirming firing, with controls verified.

### One non-example

A proposal with no reverse ladder written.
...
That nulls have their own inference structure.
...
| Statement | Status |
|---|---|
| The reverse ladder states what a null licenses. | Framework-derived, appropriate at this grade |
| That nulls have their own inference structure. | What this specific activity can show |
| Whether a null will occur. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 2 — The Inference Ladder — specifically: participants place the ceiling for a single study.

**How it was taught.** Through the activity: argue an assigned ceiling position with reasons

**Quick check.** Ask for the closing sentence of Seminar 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 2: argue an assigned ceiling position with reasons, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A proposal with no reverse ladder written. |
...
> "The more conservative position protects the framework from being discredited."
...
**Target observation.** That nulls have their own inference structure.
...
> "The reverse ladder states what a null licenses. You just saw that when ask: you run it and find nothing.
> Last time we said: The more conservative position protects the framework from being discredited. This is the next part of that.
...
**Completed answer.** A reverse ladder stating the null would not fire the condition. — which demonstrates that nulls have their own inference structure.
...
**Teacher prompt.** "Here is a second case. A reverse ladder confirming firing, with controls verified. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A proposal with no reverse ladder written. Why is this not an
example?"
...
**Exact student instructions.** Write the reverse ladder for their own proposal and state whether the condition fires.
...
- *Licensed conclusion.* That nulls have their own inference structure.
...
- *Expected response.* That nulls have their own inference structure.
...
1. Any wording carrying the idea in `The reverse ladder states what a null licenses`.
...
Say: "This half is neglected and it is the one that keeps a null informative."
...
| | |
|---|---|
| **Follows** | Seminar 2 — The Inference Ladder |
| **Leads to** | Seminar 4 — The Referee's Problem |

**Transition in.** Seminar 2 established participants place the ceiling for a single study. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants state what a null result licenses. Seminar 4 assumes it and builds participants state the two failure directions in reviewing.
