...
|---|---|---|---|---|---|---|
| `Seminar_01_Printout.md` | Seminar 1 — Overclaiming Is The Default | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Seminar_02_Printout.md` | Seminar 2 — The Inference Ladder | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 1 work |
| `Seminar_03_Printout.md` | Seminar 3 — The Reverse Ladder | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 2 work |
| `Seminar_04_Printout.md` | Seminar 4 — The Referee's Problem | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 3 work |
...
**Seminar 3 — The Reverse Ladder.** If you only have time to print one
