# Seminar 4 — The Referee's Problem

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 1** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Referee's Problem: participants state the two failure directions in reviewing? |
| **Core concept** | A referee report on work about an unvalidated framework requires a disclosure section absent from standard templates: does the manuscript represent the framework's status accurately?. |
| **Student outcome** | Participants state the two failure directions in reviewing. |
| **Previous seminar** | Seminar 3 — The Reverse Ladder |
| **Next seminar** | Seminar 5 — Auditing Measurement As A Referee |
| **Materials** | Specimen manuscripts; peer proposals |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_04_Printout.md` |
| **Homework** | `Homework/Seminar_04_Homework.md` |

## Why this lesson exists

**The conceptual step.** A referee report on work about an unvalidated framework requires a disclosure section absent from standard templates: does the manuscript represent the framework's status accurately?

**Why students need it now.** This grade owns one idea: the inference ladder in both directions, and referee-quality review.
This seminar supplies one component of it. Without this component the student can
...
that rung four is reachable from one study. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** The inference ceiling is declared in both directions. A verdict resting on the framework's status is a reviewer error and is penalised.

**What depends on it.** Seminar 5 — Auditing Measurement As A Referee — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A referee report on work about an unvalidated framework requires a disclosure section absent from standard templates: does the manuscript represent the framework's status accurately?

### How this is stated at this grade

The inference ceiling is declared in both directions. A verdict resting on the framework's status is a reviewer error and is penalised.

Use only the vocabulary released at or before this grade. Terms not yet available:
Governance instruments, supervision plans.

### Why the concept matters

The whole grade rests on the inference ladder in both directions, and referee-quality review. If a student leaves this
seminar without the component taught here, the remaining seminars in the quarter
will feel arbitrary, because each one assumes it.

### Two concrete examples

1. A report with a completed disclosure section.
2. A disclosure finding that the manuscript overclaimed status.

### One non-example

A report using a standard template with no disclosure section.
...
That this literature requires an additional review section.

### What this activity does not establish

Whether the manuscript is sound.
...
### Scope boundary for this seminar
...
| Statement | Status |
|---|---|
| A referee report on work about an unvalidated framework requires a disclosure section absent from standard templates: does the manuscript represent the framework's status accurately?. | Framework-derived, appropriate at this grade |
| That this literature requires an additional review section. | What this specific activity can show |
| Whether the manuscript is sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 3 — The Reverse Ladder — specifically: participants state what a null result licenses.

**How it was taught.** Through the activity: write the reverse ladder for their own proposal and state whether the condition fires

**Quick check.** Ask for the closing sentence of Seminar 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 3: write the reverse ladder for their own proposal and state whether the condition fires, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | the graded set of claims a result licenses. |
| **Student wording** | The graded set of claims a result licenses. |
| **Correct example** | A report with a completed disclosure section. |
| **Non-example** | A report using a standard template with no disclosure section. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for the graded set of claims a result licenses." |

### referee report

| | |
|---|---|
| **Teacher definition** | a structured judgement to journal standard. |
| **Student wording** | A structured judgement to journal standard. |
| **Correct example** | A report with a completed disclosure section. |
| **Non-example** | A report using a standard template with no disclosure section. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a structured judgement to journal standard." |

### disclosure audit

| | |
|---|---|
| **Teacher definition** | checking whether a manuscript represents status accurately. |
| **Student wording** | Checking whether a manuscript represents status accurately. |
| **Correct example** | A report with a completed disclosure section. |
| **Non-example** | A report using a standard template with no disclosure section. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for checking whether a manuscript represents status accurately." |


Do not introduce terminology from later grades. Governance instruments, supervision plans.

## Materials and preparation

**Teacher materials.** Specimen manuscripts; Peer proposals; Printed inference ladders; Review templates.

**Student materials.** One copy of `Printouts/Seminar_04_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 3, kept in the student's folder.
...
**File.** `Printouts/Seminar_04_Printout.md`

**Distribute.** Before the hook. Students complete the *What I think before the
seminar* section before any explanation is given.
...
> "This half is neglected and it is the one that keeps a null informative."
...
**Decision rule.** If fewer than half the group can produce any version of it, spend five minutes on the recovery activity below before starting this seminar.

### 2. Hook

**Exact wording.** "Say: reject on status is reviewing reputation. Accept on rigour is substituting for relevance."
...
**Target observation.** That this literature requires an additional review section.
...
> "A referee report on work about an unvalidated framework requires a disclosure section absent from standard templates: does the manuscript represent the framework's status accurately?. You just saw that when say: reject on status is reviewing reputation.
> Last time we said: This half is neglected and it is the one that keeps a null informative. This is the next part of that.
> It matters because review the inference, not the framework"
...
**Terminology to introduce here.** inference ladder, referee report, disclosure audit.

**What students must not infer.** Whether the manuscript is sound.

### 4. Worked example

**The example.** A report with a completed disclosure section.
...
**Completed answer.** A report with a completed disclosure section. — which demonstrates that this literature requires an additional review section.
...
**Conclusions not licensed.** Whether the manuscript is sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A disclosure finding that the manuscript overclaimed status. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A report using a standard template with no disclosure section. Why is this not an
example?"
...
**Exact student instructions.** Review one instructor-supplied specimen to the seven-section structure.
...
- *Licensed conclusion.* That this literature requires an additional review section.
- *Not licensed.* Whether the manuscript is sound.
...
- *Expected response.* That this literature requires an additional review section.
...
**Decision rule.** Continue to the next seminar only if most students pass oral
...
3. **Misconception check.** Somebody says: "Rung four is reachable from one study" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `A referee report on work about an unvalidated framework requires a disclosure section absent from standard templates: does the manuscript represent the framework's status accurately?`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Overclaiming is how frameworks get discredited.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "The disclosure section is specific to this literature."

**Why this sentence matters.** It is the opening question of Seminar 5, which assumes students arrive holding it.

**Open the next seminar with.** "What did we say at the end last time?"
...
### 1. "Rung four is reachable from one study"

**What the student says or does.** Rung four is reachable from one study — usually while otherwise engaging well.

**Why it is understandable.** Cumulative reasoning feels available immediately.
...
**Exact correction.** Rung four requires converging designs.

**Say this.** "Overclaiming is how frameworks get discredited."
...
### 2. "Reviewer disagreement means one reviewer is wrong"

**What the student says or does.** Reviewer disagreement means one reviewer is wrong — usually while otherwise engaging well.

**Why it is understandable.** Divergence reads as error.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Calibrate. Divergence about standards is normal.

**Say this.** "Editors can see the difference between a standard and a reputation."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "A proposal should test the framework"

**What the student says or does.** A proposal should test the framework — usually while otherwise engaging well.

**Why it is understandable.** The framework is the object of study.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Narrow it to one claim and its least-separable rival.

**Say this.** "Frameworks are not tested as wholes. Move one question."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 4. "This seminar proves the framework is right"
...
**Visual or physical support.** Provide the ladder with rungs one to three worked and instructor specimens.
...
Ask for the editorial letter following three divergent reports.
...
Specifically, do not introduce: Governance instruments, supervision plans.
...
Mention them whenever the content of this seminar touches either.

## Homework connection

**File.** `Homework/Seminar_04_Homework.md`
...
**How to set it.** Optional. Set it if this is the pivot seminar of the quarter,
...
7. What must be retaught before the next seminar?
8. Is the next seminar still appropriate, or does it need a bridging activity?

## Sequence

| | |
|---|---|
| **Follows** | Seminar 3 — The Reverse Ladder |
| **Leads to** | Seminar 5 — Auditing Measurement As A Referee |

**Transition in.** Seminar 3 established participants state what a null result licenses. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants state the two failure directions in reviewing. Seminar 5 assumes it and builds participants judge construct validity and prespecification in others' work.
