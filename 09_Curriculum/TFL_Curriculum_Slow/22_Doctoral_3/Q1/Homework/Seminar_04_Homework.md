# Seminar 4 Homework — The Referee's Problem

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 1**
**Follows:** Seminar 4 — The Referee's Problem · **Points:** 5 · **Optional:** yes
...
Write the sentence Seminar 4 ended on, from memory:
...
Review one instructor-supplied specimen to the seven-section structure.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every report covers all seven sections including disclosure
...
Seminar 5 is **Auditing Measurement As A Referee**, which assumes you arrive holding it. Write one thing you expect it to be about:
