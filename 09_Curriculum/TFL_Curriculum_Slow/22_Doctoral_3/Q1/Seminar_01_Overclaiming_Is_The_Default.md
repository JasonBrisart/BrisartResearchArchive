# Seminar 1 — Overclaiming Is The Default
...
| | |
|---|---|
| **Central question** | Overclaiming Is The Default: participants identify the gap between licensed and claimed inference? |
| **Core concept** | Overclaiming is structural rather than a character failing. |
| **Student outcome** | Participants identify the gap between licensed and claimed inference. |
| **Previous seminar** | None. First seminar of the year. |
| **Next seminar** | Seminar 2 — The Inference Ladder |
...
**The conceptual step.** Overclaiming is structural rather than a character failing. Authors who have lived with a hypothesis for years write discussions from inside it.
...
**What depends on it.** Seminar 2 — The Inference Ladder — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Overclaiming is structural rather than a character failing. Authors who have lived with a hypothesis for years write discussions from inside it.
...
1. A result licensing rung three with rung four claimed.
2. A gap identified in a well-executed study.

### One non-example

A conclusion that the authors were careless.
...
That the licensed-claimed gap is structural.
...
| Statement | Status |
|---|---|
| Overclaiming is structural rather than a character failing. | Framework-derived, appropriate at this grade |
| That the licensed-claimed gap is structural. | What this specific activity can show |
| Whether the claims are true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The participant produces an original evidenced critique.
...
| **Correct example** | A result licensing rung three with rung four claimed. |
| **Non-example** | A conclusion that the authors were careless. |
...
**Exact wording.** "Put up a described result and the discussion section its authors wrote."
...
**Target observation.** That the licensed-claimed gap is structural.
...
> "Overclaiming is structural rather than a character failing. You just saw that when put up a described result and the discussion section its authors wrote.
...
**The example.** A result licensing rung three with rung four claimed.
...
**Completed answer.** A result licensing rung three with rung four claimed. — which demonstrates that the licensed-claimed gap is structural.
...
**Teacher prompt.** "Here is a second case. A gap identified in a well-executed study. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A conclusion that the authors were careless. Why is this not an
example?"
...
**Exact student instructions.** Identify licensed and claimed rungs for three described results.
...
- *Licensed conclusion.* That the licensed-claimed gap is structural.
...
- *Expected response.* That the licensed-claimed gap is structural.
...
1. Any wording carrying the idea in `Overclaiming is structural rather than a character failing`.
...
Say: "The gap between licensed and claimed is where most review work happens."
...
| **Leads to** | Seminar 2 — The Inference Ladder |

**Transition in.** This seminar opens the year.

**Transition out.** This seminar establishes participants identify the gap between licensed and claimed inference. Seminar 2 assumes it and builds participants place the ceiling for a single study.
