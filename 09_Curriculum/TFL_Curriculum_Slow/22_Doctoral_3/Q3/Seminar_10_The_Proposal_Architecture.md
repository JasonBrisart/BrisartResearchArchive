# Seminar 10 — The Proposal Architecture

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 3** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Proposal Architecture: participants build the eight-item proposal? |
| **Core concept** | An adjudication proposal has eight items, of which fair rival operationalisation is the one that determines whether the proposal adjudicates at all. |
| **Student outcome** | Participants build the eight-item proposal. |
| **Previous seminar** | Seminar 9 — Moving A Question |
| **Next seminar** | Seminar 11 — Proposal Triage |
...
**The conceptual step.** An adjudication proposal has eight items, of which fair rival operationalisation is the one that determines whether the proposal adjudicates at all.
...
**What depends on it.** Seminar 11 — Proposal Triage — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An adjudication proposal has eight items, of which fair rival operationalisation is the one that determines whether the proposal adjudicates at all.
...
1. A proposal with the rival operationalisation externally checked.
2. A proposal with all eight items present.

### One non-example

A proposal whose rival operationalisation was self-checked.
...
That proposal architecture is stateable and auditable.

### What this activity does not establish

Whether the proposal would succeed.
...
| Statement | Status |
|---|---|
| An adjudication proposal has eight items, of which fair rival operationalisation is the one that determines whether the proposal adjudicates at all. | Framework-derived, appropriate at this grade |
| That proposal architecture is stateable and auditable. | What this specific activity can show |
| Whether the proposal would succeed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 9 — Moving A Question — specifically: participants define a question narrow enough to be moved.

**How it was taught.** Through the activity: draft the open question and the claim-rival pairing

**Quick check.** Ask for the closing sentence of Seminar 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 9: draft the open question and the claim-rival pairing, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A proposal with the rival operationalisation externally checked. |
| **Non-example** | A proposal whose rival operationalisation was self-checked. |
...
> "The fairness requirement is where proposals are won and lost."
...
**Exact wording.** "Say: eight items. Item four is where this is won or lost."
...
**Target observation.** That proposal architecture is stateable and auditable.
...
> "An adjudication proposal has eight items, of which fair rival operationalisation is the one that determines whether the proposal adjudicates at all. You just saw that when say: eight items.
> Last time we said: The fairness requirement is where proposals are won and lost. This is the next part of that.
...
**What students must not infer.** Whether the proposal would succeed.

### 4. Worked example

**The example.** A proposal with the rival operationalisation externally checked.
...
**Completed answer.** A proposal with the rival operationalisation externally checked. — which demonstrates that proposal architecture is stateable and auditable.
...
**Conclusions not licensed.** Whether the proposal would succeed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A proposal with all eight items present. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A proposal whose rival operationalisation was self-checked. Why is this not an
example?"
...
**Exact student instructions.** Draft all eight items with the fairness requirement met.
...
- *Licensed conclusion.* That proposal architecture is stateable and auditable.
- *Not licensed.* Whether the proposal would succeed.
...
- *Expected response.* That proposal architecture is stateable and auditable.
...
1. Any wording carrying the idea in `An adjudication proposal has eight items, of which fair rival operationalisation is the one that determines whether the proposal adjudicates at all`.
...
Say: "A proposal missing item four does not adjudicate."
...
| | |
|---|---|
| **Follows** | Seminar 9 — Moving A Question |
| **Leads to** | Seminar 11 — Proposal Triage |

**Transition in.** Seminar 9 established participants define a question narrow enough to be moved. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants build the eight-item proposal. Seminar 11 assumes it and builds participants judge whether a proposal would move the question.
