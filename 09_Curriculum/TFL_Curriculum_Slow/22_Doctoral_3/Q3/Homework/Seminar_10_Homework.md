# Seminar 10 Homework — The Proposal Architecture

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 3**
**Follows:** Seminar 10 — The Proposal Architecture · **Points:** 5 · **Optional:** yes
...
Draft all eight items with the fairness requirement met.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every proposal contains all eight items
...
Seminar 11 is **Proposal Triage**, which assumes you arrive holding it. Write one thing you expect it to be about:
