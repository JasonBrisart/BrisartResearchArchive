# Seminar 9 Homework — Moving A Question

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 3**
**Follows:** Seminar 9 — Moving A Question · **Points:** 5 · **Optional:** yes
...
Write the sentence Seminar 9 ended on, from memory:
...
Draft the open question and the claim-rival pairing.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every question is narrow enough for one design
...
Seminar 10 is **The Proposal Architecture**, which assumes you arrive holding it. Write one thing you expect it to be about:
