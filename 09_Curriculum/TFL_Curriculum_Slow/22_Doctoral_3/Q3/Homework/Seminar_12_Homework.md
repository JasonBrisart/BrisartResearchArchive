# Seminar 12 Homework — Rebuilding The Proposal

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 3**
**Follows:** Seminar 12 — Rebuilding The Proposal · **Points:** 5 · **Optional:** yes
...
Write the sentence Seminar 12 ended on, from memory:
...
Rebuild and re-submit for a second triage verdict.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the second verdict improves, or the reason is stated
...
Seminar 13 is **Gate Checking**, which assumes you arrive holding it. Write one thing you expect it to be about:
