# Seminar 12 — Rebuilding The Proposal
...
| | |
|---|---|
| **Central question** | Rebuilding The Proposal: participants rebuild the failing item? |
| **Core concept** | Rebuilding must target the named failing item. |
| **Student outcome** | Participants rebuild the failing item. |
| **Previous seminar** | Seminar 11 — Proposal Triage |
| **Next seminar** | Seminar 13 — Gate Checking |
...
**The conceptual step.** Rebuilding must target the named failing item. Improving a different item produces a better proposal with the same verdict.
...
**What depends on it.** Seminar 13 — Gate Checking — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Rebuilding must target the named failing item. Improving a different item produces a better proposal with the same verdict.
...
1. A rebuild targeting the named failing item four.
2. A second verdict improved from middle to positive.

### One non-example

A rebuild improving measurement when adjudication was the failure.
...
Whether the rebuilt proposal succeeds.
...
| Statement | Status |
|---|---|
| Rebuilding must target the named failing item. | Framework-derived, appropriate at this grade |
| That targeted rebuilding shifts verdicts. | What this specific activity can show |
| Whether the rebuilt proposal succeeds. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 11 — Proposal Triage — specifically: participants judge whether a proposal would move the question.

**How it was taught.** Through the activity: verdicts justified against the architecture, naming the failing item, then revised in session

**Quick check.** Ask for the closing sentence of Seminar 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 11: verdicts justified against the architecture, naming the failing item, then revised in session, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A rebuild targeting the named failing item four. |
| **Non-example** | A rebuild improving measurement when adjudication was the failure. |
...
**Exact wording.** "Say: your proposal would produce a result but not move the question. Rebuild that item."
...
> "Rebuilding must target the named failing item. You just saw that when say: your proposal would produce a result but not move the question.
...
**What students must not infer.** Whether the rebuilt proposal succeeds.

### 4. Worked example

**The example.** A rebuild targeting the named failing item four.
...
**Completed answer.** A rebuild targeting the named failing item four. — which demonstrates that targeted rebuilding shifts verdicts.
...
**Conclusions not licensed.** Whether the rebuilt proposal succeeds.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A second verdict improved from middle to positive. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rebuild improving measurement when adjudication was the failure. Why is this not an
example?"
...
- *Not licensed.* Whether the rebuilt proposal succeeds.
...
1. Any wording carrying the idea in `Rebuilding must target the named failing item`.
...
Say: "The distribution should shift. Record it."
...
| | |
|---|---|
| **Follows** | Seminar 11 — Proposal Triage |
| **Leads to** | Seminar 13 — Gate Checking |

**Transition in.** Seminar 11 established participants judge whether a proposal would move the question. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants rebuild the failing item. Seminar 13 assumes it and builds participants check the proposal against both gates.
