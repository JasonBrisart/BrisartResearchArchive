...
| | |
|---|---|
| **Central question** | Moving A Question: participants define a question narrow enough to be moved? |
| **Core concept** | A proposal targets one claim and the rival it is least separable from. |
| **Student outcome** | Participants define a question narrow enough to be moved. |
| **Previous seminar** | Seminar 8 — The Referee Portfolio |
| **Next seminar** | Seminar 10 — The Proposal Architecture |
...
**The conceptual step.** A proposal targets one claim and the rival it is least separable from. Frameworks are not tested as wholes.
...
**What depends on it.** Seminar 10 — The Proposal Architecture — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A proposal targets one claim and the rival it is least separable from. Frameworks are not tested as wholes.
...
2. A question narrow enough for a single design.
...
That research questions can be narrowed to moveable scope.
...
| Statement | Status |
|---|---|
| A proposal targets one claim and the rival it is least separable from. | Framework-derived, appropriate at this grade |
| That research questions can be narrowed to moveable scope. | What this specific activity can show |
| Whether the question can be answered. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 8 — The Referee Portfolio — specifically: participants produce two full referee reports.

**How it was taught.** Through the activity: two complete seven-section reports submitted

**Quick check.** Ask for the closing sentence of Seminar 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 8: two complete seven-section reports submitted, in miniature, using one example only. Then ask for the sentence again.
...
**Exact wording.** "Say: not testing TFL. Pick one claim and the rival it is least separable from."
...
**Target observation.** That research questions can be narrowed to moveable scope.
...
> "A proposal targets one claim and the rival it is least separable from. You just saw that when say: not testing TFL.
> Last time we said: That is referee-standard work. This is the next part of that.
...
**What students must not infer.** Whether the question can be answered.
...
**Completed answer.** A persistence claim paired with the arousal account. — which demonstrates that research questions can be narrowed to moveable scope.
...
**Conclusions not licensed.** Whether the question can be answered.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A question narrow enough for a single design. Work it through with me."
...
**Exact student instructions.** Draft the open question and the claim-rival pairing.
...
- *Licensed conclusion.* That research questions can be narrowed to moveable scope.
- *Not licensed.* Whether the question can be answered.
...
- *Expected response.* That research questions can be narrowed to moveable scope.
...
1. Any wording carrying the idea in `A proposal targets one claim and the rival it is least separable from`.
...
Say: "The fairness requirement is where proposals are won and lost."
...
| | |
|---|---|
| **Follows** | Seminar 8 — The Referee Portfolio |
| **Leads to** | Seminar 10 — The Proposal Architecture |

**Transition in.** Seminar 8 established participants produce two full referee reports. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants define a question narrow enough to be moved. Seminar 10 assumes it and builds participants build the eight-item proposal.
