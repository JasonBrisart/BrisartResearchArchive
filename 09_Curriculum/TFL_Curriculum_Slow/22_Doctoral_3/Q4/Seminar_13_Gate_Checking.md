...
| | |
|---|---|
| **Central question** | Gate Checking: participants check the proposal against both gates? |
| **Core concept** | The two gates are an executable adjudicating design and a correct scope rejection. |
| **Student outcome** | Participants check the proposal against both gates. |
| **Previous seminar** | Seminar 12 — Rebuilding The Proposal |
| **Next seminar** | Seminar 14 — Rehearsing The Defence |
...
**The conceptual step.** The two gates are an executable adjudicating design and a correct scope rejection. Both are checked before any other assessment.
...
**What depends on it.** Seminar 14 — Rehearsing The Defence — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The two gates are an executable adjudicating design and a correct scope rejection. Both are checked before any other assessment.
...
1. A proposal passing a peer gate check on both items.
2. A proposal returned after failing the scope gate.

### One non-example

A proposal submitted with the gates assumed to pass.
...
That gate checking precedes other assessment.

### What this activity does not establish

Whether the proposal is otherwise good.
...
| Statement | Status |
|---|---|
| The two gates are an executable adjudicating design and a correct scope rejection. | Framework-derived, appropriate at this grade |
| That gate checking precedes other assessment. | What this specific activity can show |
| Whether the proposal is otherwise good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 12 — Rebuilding The Proposal — specifically: participants rebuild the failing item.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 12: rebuild and re-submit for a second triage verdict, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A proposal passing a peer gate check on both items. |
| **Non-example** | A proposal submitted with the gates assumed to pass. |
...
> "The distribution should shift. Record it."
...
**Exact wording.** "Say: executable adjudicating design, and a correct scope rejection."
...
**Target observation.** That gate checking precedes other assessment.
...
> "The two gates are an executable adjudicating design and a correct scope rejection. You just saw that when say: executable adjudicating design, and a correct scope rejection.
> Last time we said: The distribution should shift. Record it. This is the next part of that.
...
**What students must not infer.** Whether the proposal is otherwise good.

### 4. Worked example

**The example.** A proposal passing a peer gate check on both items.
...
**Completed answer.** A proposal passing a peer gate check on both items. — which demonstrates that gate checking precedes other assessment.
...
**Conclusions not licensed.** Whether the proposal is otherwise good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A proposal returned after failing the scope gate. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A proposal submitted with the gates assumed to pass. Why is this not an
example?"
...
- *Licensed conclusion.* That gate checking precedes other assessment.
- *Not licensed.* Whether the proposal is otherwise good.
...
- *Expected response.* That gate checking precedes other assessment.
...
1. Any wording carrying the idea in `The two gates are an executable adjudicating design and a correct scope rejection`.
...
| | |
|---|---|
| **Follows** | Seminar 12 — Rebuilding The Proposal |
| **Leads to** | Seminar 14 — Rehearsing The Defence |

**Transition in.** Seminar 12 established participants rebuild the failing item. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants check the proposal against both gates. Seminar 14 assumes it and builds participants rehearse against four challengers.
