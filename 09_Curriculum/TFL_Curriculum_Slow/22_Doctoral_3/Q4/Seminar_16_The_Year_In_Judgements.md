# Seminar 16 — The Year In Judgements
...
| | |
|---|---|
| **Central question** | The Year In Judgements: participants review the year's reviewing and proposals? |
| **Core concept** | A cohort calibration summary is data a journal would find useful. |
| **Student outcome** | Participants review the year's reviewing and proposals. |
| **Previous seminar** | Seminar 15 — Referee Practice And Proposal Defence |
| **Next seminar** | The final examination. |
| **Materials** | Specimen manuscripts; peer proposals |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_16_Printout.md` |
| **Homework** | `Homework/Seminar_16_Homework.md` |

## Why this lesson exists

**The conceptual step.** A cohort calibration summary is data a journal would find useful. Treating it as coursework wastes it.
...
A cohort calibration summary is data a journal would find useful. Treating it as coursework wastes it.
...
1. A calibration summary showing divergence sources across the cohort.
2. A verdict distribution showing most proposals in the middle category.

### One non-example

Summaries filed as coursework with no external use considered.
...
That cohort judgement data has external value.

### What this activity does not establish

Whether the judgements were correct.
...
| Statement | Status |
|---|---|
| A cohort calibration summary is data a journal would find useful. | Framework-derived, appropriate at this grade |
| That cohort judgement data has external value. | What this specific activity can show |
| Whether the judgements were correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 15 — Referee Practice And Proposal Defence — specifically: participants deliver reports and defend a proposal.

**How it was taught.** Through the activity: two reports submitted and a sixteen-minute proposal defence

**Quick check.** Ask for the closing sentence of Seminar 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 15: two reports submitted and a sixteen-minute proposal defence, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A calibration summary showing divergence sources across the cohort. |
| **Non-example** | Summaries filed as coursework with no external use considered. |
...
**Student materials.** One copy of `Printouts/Seminar_16_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 15, kept in the student's folder.
...
**File.** `Printouts/Seminar_16_Printout.md`
...
> "Next year: the dissertation, defended against people meeting it in an hour."
...
**Exact wording.** "Put every report and proposal from the cohort on the board, summarised."
...
**Target observation.** That cohort judgement data has external value.
...
> "A cohort calibration summary is data a journal would find useful. You just saw that when put every report and proposal from the cohort on the board, summarised.
> Last time we said: Next year: the dissertation, defended against people meeting it in an hour. This is the next part of that.
...
**What students must not infer.** Whether the judgements were correct.

### 4. Worked example

**The example.** A calibration summary showing divergence sources across the cohort.
...
**Completed answer.** A calibration summary showing divergence sources across the cohort. — which demonstrates that cohort judgement data has external value.
...
**Conclusions not licensed.** Whether the judgements were correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A verdict distribution showing most proposals in the middle category. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Summaries filed as coursework with no external use considered. Why is this not an
example?"
...
**Exact student instructions.** Build the cohort's calibration summary and proposal verdict distribution.
...
- *Licensed conclusion.* That cohort judgement data has external value.
- *Not licensed.* Whether the judgements were correct.
...
- *Expected response.* That cohort judgement data has external value.
...
1. Any wording carrying the idea in `A cohort calibration summary is data a journal would find useful`.
...
Say: "You can now judge work in this area and design work that would move it."
...
**File.** `Homework/Seminar_16_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 15 — Referee Practice And Proposal Defence |
| **Leads to** | The final examination. |

**Transition in.** Seminar 15 established participants deliver reports and defend a proposal. This seminar uses that as the starting point.
