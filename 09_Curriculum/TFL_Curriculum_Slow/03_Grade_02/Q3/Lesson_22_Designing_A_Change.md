...
| | |
|---|---|
| **Central question** | Designing A Change: students design a trial that would change somebody's expectation? |
| **Core concept** | Building a trial requires establishing a pattern before breaking it. |
| **Student outcome** | Students design a trial that would change somebody's expectation. |
| **Previous lesson** | Lesson 21 — Comparing Myself To Myself |
| **Next lesson** | Lesson 23 — The Failed Trial |
...
**The conceptual step.** Building a trial requires establishing a pattern before breaking it. One repetition is not a pattern, so there is nothing to break.
...
**What depends on it.** Lesson 23 — The Failed Trial — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Building a trial requires establishing a pattern before breaking it. One repetition is not a pattern, so there is nothing to break.
...
1. A trial with four establishing repetitions before the break.
2. A trial that records the number of breaks needed.

### One non-example

A trial that breaks the pattern on the second card.
...
That the student can construct the method.

### What this activity does not establish

Whether their number matches the class figure.
...
| Statement | Status |
|---|---|
| Building a trial requires establishing a pattern before breaking it. | Framework-derived, appropriate at this grade |
| That the student can construct the method. | What this specific activity can show |
| Whether their number matches the class figure. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 21 — Comparing Myself To Myself — specifically: students compare their own expectation across time.

**How it was taught.** Through the activity: a two-point self-comparison with the cause of the change named

**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: a two-point self-comparison with the cause of the change named, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A trial with four establishing repetitions before the break. |
| **Non-example** | A trial that breaks the pattern on the second card. |
...
> "You are not the same as you were in Lesson 1."
...
**Exact wording.** "Say: you have been on the receiving end. Today you build one."
...
**Target observation.** That the student can construct the method.
...
> "Building a trial requires establishing a pattern before breaking it. You just saw that when say: you have been on the receiving end.
> Last time we said: You are not the same as you were in Lesson 1. This is the next part of that.
...
**What students must not infer.** Whether their number matches the class figure.

### 4. Worked example

**The example.** A trial with four establishing repetitions before the break.
...
**Completed answer.** A trial with four establishing repetitions before the break. — which demonstrates that the student can construct the method.
...
**Conclusions not licensed.** Whether their number matches the class figure.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A trial that records the number of breaks needed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A trial that breaks the pattern on the second card. Why is this not an
example?"
...
**Exact student instructions.** Each student designs and runs a three-break trial on a partner.
...
- *Licensed conclusion.* That the student can construct the method.
- *Not licensed.* Whether their number matches the class figure.
...
- *Expected response.* That the student can construct the method.
...
1. Any wording carrying the idea in `Building a trial requires establishing a pattern before breaking it`.
...
Say: "Designing it is harder than being surprised by it."
...
| | |
|---|---|
| **Follows** | Lesson 21 — Comparing Myself To Myself |
| **Leads to** | Lesson 23 — The Failed Trial |

**Transition in.** Lesson 21 established students compare their own expectation across time. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students design a trial that would change somebody's expectation. Lesson 23 assumes it and builds students analyse a trial that produced no change.
