...
| | |
|---|---|
| **Central question** | The Failed Trial: students analyse a trial that produced no change? |
| **Core concept** | A trial producing no change is a result. |
| **Student outcome** | Students analyse a trial that produced no change. |
| **Previous lesson** | Lesson 22 — Designing A Change |
| **Next lesson** | Lesson 24 — The Change Review |
...
**The conceptual step.** A trial producing no change is a result. The two usual causes are an unestablished pattern or a partner who anticipated the break.
...
**What depends on it.** Lesson 24 — The Change Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A trial producing no change is a result. The two usual causes are an unestablished pattern or a partner who anticipated the break.
...
1. A trial that failed because the pattern ran only twice.
2. A trial that failed because the partner guessed the design.

### One non-example

Hiding a failed trial and reporting a different one.
...
That failed trials are informative results.

### What this activity does not establish

Which explanation applies without further evidence.
...
| Statement | Status |
|---|---|
| A trial producing no change is a result. | Framework-derived, appropriate at this grade |
| That failed trials are informative results. | What this specific activity can show |
| Which explanation applies without further evidence. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — Designing A Change — specifically: students design a trial that would change somebody's expectation.

**How it was taught.** Through the activity: each student designs and runs a three-break trial on a partner

**Quick check.** Ask for the closing sentence of Lesson 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: each student designs and runs a three-break trial on a partner, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A trial that failed because the pattern ran only twice. |
| **Non-example** | Hiding a failed trial and reporting a different one. |
...
**Exact wording.** "Ask whose trial did nothing and to describe exactly what they did."
...
**Target observation.** That failed trials are informative results.
...
> "A trial producing no change is a result. You just saw that when ask whose trial did nothing and to describe exactly what they did.
...
**What students must not infer.** Which explanation applies without further evidence.

### 4. Worked example

**The example.** A trial that failed because the pattern ran only twice.
...
**Completed answer.** A trial that failed because the pattern ran only twice. — which demonstrates that failed trials are informative results.
...
**Conclusions not licensed.** Which explanation applies without further evidence.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A trial that failed because the partner guessed the design. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Hiding a failed trial and reporting a different one. Why is this not an
example?"
...
**Exact student instructions.** Analyse one failed trial against two explanations.
...
- *Licensed conclusion.* That failed trials are informative results.
- *Not licensed.* Which explanation applies without further evidence.
...
- *Expected response.* That failed trials are informative results.
...
1. Any wording carrying the idea in `A trial producing no change is a result`.
...
Say: "A trial that did nothing tells you something."
...
| | |
|---|---|
| **Follows** | Lesson 22 — Designing A Change |
| **Leads to** | Lesson 24 — The Change Review |

**Transition in.** Lesson 22 established students design a trial that would change somebody's expectation. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students analyse a trial that produced no change. Lesson 24 assumes it and builds students consolidate the quarter's work on change.
