...
| | |
|---|---|
| **Central question** | The Change Review: students consolidate the quarter's work on change? |
| **Core concept** | A number quoted without its record is an impression. |
| **Student outcome** | Students consolidate the quarter's work on change. |
| **Previous lesson** | Lesson 23 — The Failed Trial |
| **Next lesson** | Lesson 25 — The Comparison Table |
...
**The conceptual step.** A number quoted without its record is an impression. The review enforces the habit of citing the tally.
...
**What depends on it.** Lesson 25 — The Comparison Table — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A number quoted without its record is an impression. The review enforces the habit of citing the tally.
...
1. A student cites the pooled figure and produces the sheet.
2. A student corrects a number by checking the record.

### One non-example

Quoting a remembered figure with no sheet.
...
Whether numbers are cited with their records.

### What this activity does not establish

Whether the class figure generalises.
...
| Statement | Status |
|---|---|
| A number quoted without its record is an impression. | Framework-derived, appropriate at this grade |
| Whether numbers are cited with their records. | What this specific activity can show |
| Whether the class figure generalises. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — The Failed Trial — specifically: students analyse a trial that produced no change.

**How it was taught.** Through the activity: analyse one failed trial against two explanations

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: analyse one failed trial against two explanations, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student cites the pooled figure and produces the sheet. |
| **Non-example** | Quoting a remembered figure with no sheet. |
...
> "A trial that did nothing tells you something."
...
**Exact wording.** "Ask how many breaks and how they know."
...
**Target observation.** Whether numbers are cited with their records.
...
> "A number quoted without its record is an impression. You just saw that when ask how many breaks and how they know.
> Last time we said: A trial that did nothing tells you something. This is the next part of that.
...
**What students must not infer.** Whether the class figure generalises.

### 4. Worked example

**The example.** A student cites the pooled figure and produces the sheet.
...
**Completed answer.** A student cites the pooled figure and produces the sheet. — which demonstrates whether numbers are cited with their records.
...
**Conclusions not licensed.** Whether the class figure generalises.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student corrects a number by checking the record. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Quoting a remembered figure with no sheet. Why is this not an
example?"
...
**Exact student instructions.** Review using the term's pooled numbers and tallies.
...
- *Licensed conclusion.* Whether numbers are cited with their records.
- *Not licensed.* Whether the class figure generalises.
...
- *Expected response.* Whether numbers are cited with their records.
...
1. Any wording carrying the idea in `A number quoted without its record is an impression`.
...
Say: "Next time: the table that holds all of it."
...
| | |
|---|---|
| **Follows** | Lesson 23 — The Failed Trial |
| **Leads to** | Lesson 25 — The Comparison Table |

**Transition in.** Lesson 23 established students analyse a trial that produced no change. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the quarter's work on change. Lesson 25 assumes it and builds students build a four-column comparison unaided.
