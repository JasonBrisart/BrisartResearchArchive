...
| **Core concept** | A broken expectation can reappear. |
| **Student outcome** | Students observe a broken expectation reappearing. |
| **Previous lesson** | Lesson 18 — How Many Breaks |
| **Next lesson** | Lesson 20 — Change Is Not Failure |
...
**The conceptual step.** A broken expectation can reappear. Whether it was present throughout or genuinely returned cannot be told from this data, and saying so is the correct answer.
...
**What depends on it.** Lesson 20 — Change Is Not Failure — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A broken expectation can reappear. Whether it was present throughout or genuinely returned cannot be told from this data, and saying so is the correct answer.
...
1. The circle expectation returns after five unrelated cards.
2. A student writes both explanations and marks neither.

### One non-example

Choosing one explanation because it sounds better.
...
Which of the two explanations is right.
...
| Statement | Status |
|---|---|
| A broken expectation can reappear. | Framework-derived, appropriate at this grade |
| That the expectation reappeared. | What this specific activity can show |
| Which of the two explanations is right. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — How Many Breaks — specifically: students count contradictions needed for a durable change.

**How it was taught.** Through the activity: three-break trial in pairs, class numbers pooled

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: three-break trial in pairs, class numbers pooled, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The circle expectation returns after five unrelated cards. |
| **Non-example** | Choosing one explanation because it sounds better. |
...
> "We counted instead of guessing."
...
**Exact wording.** "Break the pattern, run five unrelated cards, then return to the original."
...
> "A broken expectation can reappear. You just saw that when break the pattern, run five unrelated cards, then return to the original.
> Last time we said: We counted instead of guessing. This is the next part of that.
...
**What students must not infer.** Which of the two explanations is right.

### 4. Worked example

**The example.** The circle expectation returns after five unrelated cards.
...
**Completed answer.** The circle expectation returns after five unrelated cards. — which demonstrates that the expectation reappeared.
...
**Conclusions not licensed.** Which of the two explanations is right.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student writes both explanations and marks neither. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Choosing one explanation because it sounds better. Why is this not an
example?"
...
**Exact student instructions.** Record the full sequence and write both possible explanations.
...
- *Not licensed.* Which of the two explanations is right.
...
1. Any wording carrying the idea in `A broken expectation can reappear`.
...
Say: "We cannot tell which. That is an honest answer."
...
| | |
|---|---|
| **Follows** | Lesson 18 — How Many Breaks |
| **Leads to** | Lesson 20 — Change Is Not Failure |

**Transition in.** Lesson 18 established students count contradictions needed for a durable change. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students observe a broken expectation reappearing. Lesson 20 assumes it and builds students frame a changed expectation as an update.
