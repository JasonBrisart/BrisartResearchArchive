...
| | |
|---|---|
| **Central question** | How Many Breaks: students count contradictions needed for a durable change? |
| **Core concept** | Counting produces a number; guessing produces an impression. |
| **Student outcome** | Students count contradictions needed for a durable change. |
| **Previous lesson** | Lesson 17 — The Pattern Break |
| **Next lesson** | Lesson 19 — The Return |
...
**The conceptual step.** Counting produces a number; guessing produces an impression. The pooled class figure is evidence in a way an individual opinion is not.
...
**What depends on it.** Lesson 19 — The Return — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Counting produces a number; guessing produces an impression. The pooled class figure is evidence in a way an individual opinion is not.
...
1. A pooled figure of two to three breaks.
2. A pair whose tally shows the change on break three.

### One non-example

A reported number with no tally sheet behind it.
...
That the question can be answered by counting.

### What this activity does not establish

Any general figure beyond this class.
...
| Statement | Status |
|---|---|
| Counting produces a number; guessing produces an impression. | Framework-derived, appropriate at this grade |
| That the question can be answered by counting. | What this specific activity can show |
| Any general figure beyond this class. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — The Pattern Break — specifically: students record how expectations survive a single contradiction.

**How it was taught.** Through the activity: nine-card tally showing the drop and the recovery

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: nine-card tally showing the drop and the recovery, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A pooled figure of two to three breaks. |
| **Non-example** | A reported number with no tally sheet behind it. |
...
**Exact wording.** "Ask how many they think it takes. Collect written predictions first."
...
**Target observation.** That the question can be answered by counting.
...
> "Counting produces a number; guessing produces an impression. You just saw that when ask how many they think it takes.
> Last time we said: One break did not change it. This is the next part of that.
...
**What students must not infer.** Any general figure beyond this class.

### 4. Worked example

**The example.** A pooled figure of two to three breaks.
...
**Completed answer.** A pooled figure of two to three breaks. — which demonstrates that the question can be answered by counting.
...
**Conclusions not licensed.** Any general figure beyond this class.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A pair whose tally shows the change on break three. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A reported number with no tally sheet behind it. Why is this not an
example?"
...
**Exact student instructions.** Three-break trial in pairs, class numbers pooled.
...
- *Licensed conclusion.* That the question can be answered by counting.
- *Not licensed.* Any general figure beyond this class.
...
- *Expected response.* That the question can be answered by counting.
...
1. Any wording carrying the idea in `Counting produces a number; guessing produces an impression`.
...
Say: "We counted instead of guessing."
...
| | |
|---|---|
| **Follows** | Lesson 17 — The Pattern Break |
| **Leads to** | Lesson 19 — The Return |

**Transition in.** Lesson 17 established students record how expectations survive a single contradiction. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students count contradictions needed for a durable change. Lesson 19 assumes it and builds students observe a broken expectation reappearing.
