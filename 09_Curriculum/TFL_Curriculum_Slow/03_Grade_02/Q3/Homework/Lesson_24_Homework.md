# Lesson 24 Homework — The Change Review

**Grade 2** · Comparing and Checking · **Quarter 3**
**Follows:** Lesson 24 — The Change Review · **Points:** 5 · **Optional:** yes
...
Review using the term's pooled numbers and tallies.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class cites the record rather than an impression
...
Lesson 25 is **The Comparison Table**, which assumes you arrive holding it. Write one thing you expect it to be about:
