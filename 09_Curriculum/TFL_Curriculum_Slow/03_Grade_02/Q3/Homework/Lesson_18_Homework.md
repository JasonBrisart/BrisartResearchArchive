# Lesson 18 Homework — How Many Breaks

**Grade 2** · Comparing and Checking · **Quarter 3**
**Follows:** Lesson 18 — How Many Breaks · **Points:** 5 · **Optional:** yes
...
Three-break trial in pairs, class numbers pooled.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class has a pooled number greater than one
...
Lesson 19 is **The Return**, which assumes you arrive holding it. Write one thing you expect it to be about:
