# Lesson 21 Homework — Comparing Myself To Myself

**Grade 2** · Comparing and Checking · **Quarter 3**
**Follows:** Lesson 21 — Comparing Myself To Myself · **Points:** 5 · **Optional:** yes
...
A two-point self-comparison with the cause of the change named.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names a cause
...
Lesson 22 is **Designing A Change**, which assumes you arrive holding it. Write one thing you expect it to be about:
