# Lesson 15 — Evidence In Other Lessons
...
| | |
|---|---|
| **Central question** | Evidence In Other Lessons: students apply evidence to claims from other subjects? |
| **Core concept** | The evidence rule is general. |
| **Student outcome** | Students apply evidence to claims from other subjects. |
| **Previous lesson** | Lesson 14 — Changing Your Mind |
| **Next lesson** | Lesson 16 — The Evidence Review |
...
**The conceptual step.** The evidence rule is general. Applying it in other subjects prevents it being filed as a habit belonging to this lesson only.
...
**What depends on it.** Lesson 16 — The Evidence Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The evidence rule is general. Applying it in other subjects prevents it being filed as a habit belonging to this lesson only.
...
1. A science claim supported by what was observed.
2. A maths claim supported by the working shown.
...
That the evidence rule transfers.
...
| Statement | Status |
|---|---|
| The evidence rule is general. | Framework-derived, appropriate at this grade |
| That the evidence rule transfers. | What this specific activity can show |
| Anything about those subjects. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Changing Your Mind — specifically: students revise a claim when evidence does not support it.

**How it was taught.** Through the activity: each student revises one claim in light of a failed evidence check

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: each student revises one claim in light of a failed evidence check, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A science claim supported by what was observed. |
...
> "Changing a claim when the evidence fails is correct, not weak."
...
**Exact wording.** "Take a claim from maths or science and ask for the evidence."
...
**Target observation.** That the evidence rule transfers.
...
> "The evidence rule is general. You just saw that when take a claim from maths or science and ask for the evidence.
> Last time we said: Changing a claim when the evidence fails is correct, not weak. This is the next part of that.
...
**The example.** A science claim supported by what was observed.
...
**Completed answer.** A science claim supported by what was observed. — which demonstrates that the evidence rule transfers.
...
**Teacher prompt.** "Here is a second case. A maths claim supported by the working shown. Work it through with me."
...
**Exact student instructions.** Four cross-subject claims, each evidenced.
...
- *Licensed conclusion.* That the evidence rule transfers.
...
- *Expected response.* That the evidence rule transfers.
...
1. Any wording carrying the idea in `The evidence rule is general`.
...
| | |
|---|---|
| **Follows** | Lesson 14 — Changing Your Mind |
| **Leads to** | Lesson 16 — The Evidence Review |

**Transition in.** Lesson 14 established students revise a claim when evidence does not support it. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students apply evidence to claims from other subjects. Lesson 16 assumes it and builds students consolidate evidence.
