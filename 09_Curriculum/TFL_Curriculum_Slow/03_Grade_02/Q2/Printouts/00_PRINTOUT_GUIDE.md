...
**Grade 2** · Comparing and Checking
...
|---|---|---|---|---|---|---|
| `Lesson_09_Printout.md` | Lesson 9 — Pointing At Evidence | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_10_Printout.md` | Lesson 10 — Strong And Weak Evidence | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 9 work |
| `Lesson_11_Printout.md` | Lesson 11 — Evidence For A Memory | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 10 work |
| `Lesson_12_Printout.md` | Lesson 12 — Collecting Evidence | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 11 work |
| `Lesson_13_Printout.md` | Lesson 13 — Evidence Somebody Else Can Check | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 12 work |
| `Lesson_14_Printout.md` | Lesson 14 — Changing Your Mind | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 13 work |
| `Lesson_15_Printout.md` | Lesson 15 — Evidence In Other Lessons | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 14 work |
| `Lesson_16_Printout.md` | Lesson 16 — The Evidence Review | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 15 work |
...
**Lesson 13 — Evidence Somebody Else Can Check.** If you only have time to print one
