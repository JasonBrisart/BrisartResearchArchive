# Lesson 11 — Evidence For A Memory
...
| | |
|---|---|
| **Central question** | Evidence For A Memory: students support a claim about what they remembered? |
| **Core concept** | Some claims cannot be supported, and marking them honestly is better work than inventing support. |
| **Student outcome** | Students support a claim about what they remembered. |
| **Previous lesson** | Lesson 10 — Strong And Weak Evidence |
| **Next lesson** | Lesson 12 — Collecting Evidence |
...
**The conceptual step.** Some claims cannot be supported, and marking them honestly is better work than inventing support. The question mark is a legitimate answer.
...
**What depends on it.** Lesson 12 — Collecting Evidence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Some claims cannot be supported, and marking them honestly is better work than inventing support. The question mark is a legitimate answer.
...
1. A memory supported by a photo or a note.
2. A memory nobody can check, marked with a question mark.

### One non-example

A memory supported by an invented detail.
...
That unsupportable claims can be marked honestly.
...
| Statement | Status |
|---|---|
| Some claims cannot be supported, and marking them honestly is better work than inventing support. | Framework-derived, appropriate at this grade |
| That unsupportable claims can be marked honestly. | What this specific activity can show |
| Whether the memory is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 10 — Strong And Weak Evidence — specifically: students distinguish stronger from weaker evidence.

**How it was taught.** Through the activity: six evidence items ranked stronger or weaker with reasons

**Quick check.** Ask for the closing sentence of Lesson 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 10: six evidence items ranked stronger or weaker with reasons, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A memory supported by a photo or a note. |
| **Non-example** | A memory supported by an invented detail. |
...
**Exact wording.** "Say: you said you remembered that. How do we know?"
...
**Target observation.** That unsupportable claims can be marked honestly.
...
> "Some claims cannot be supported, and marking them honestly is better work than inventing support. You just saw that when say: you said you remembered that.
> Last time we said: Some evidence is better than other evidence. This is the next part of that.
...
**What students must not infer.** Whether the memory is accurate.

### 4. Worked example

**The example.** A memory supported by a photo or a note.
...
**Completed answer.** A memory supported by a photo or a note. — which demonstrates that unsupportable claims can be marked honestly.
...
**Conclusions not licensed.** Whether the memory is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A memory nobody can check, marked with a question mark. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A memory supported by an invented detail. Why is this not an
example?"
...
**Exact student instructions.** Three memory claims, each with evidence or a question mark.
...
- *Licensed conclusion.* That unsupportable claims can be marked honestly.
- *Not licensed.* Whether the memory is accurate.
...
- *Expected response.* That unsupportable claims can be marked honestly.
...
1. Any wording carrying the idea in `Some claims cannot be supported, and marking them honestly is better work than inventing support`.
...
Say: "A question mark is honest. Inventing evidence is not."
...
| | |
|---|---|
| **Follows** | Lesson 10 — Strong And Weak Evidence |
| **Leads to** | Lesson 12 — Collecting Evidence |

**Transition in.** Lesson 10 established students distinguish stronger from weaker evidence. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students support a claim about what they remembered. Lesson 12 assumes it and builds students gather evidence deliberately before making a claim.
