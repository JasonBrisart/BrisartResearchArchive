# Lesson 12 — Collecting Evidence

**Grade 2** · Comparing and Checking · **Quarter 2** · **30 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Collecting Evidence: students gather evidence deliberately before making a claim? |
| **Core concept** | Collecting evidence before forming the claim prevents the claim from selecting its own support. |
| **Student outcome** | Students gather evidence deliberately before making a claim. |
| **Previous lesson** | Lesson 11 — Evidence For A Memory |
| **Next lesson** | Lesson 13 — Evidence Somebody Else Can Check |
...
**The conceptual step.** Collecting evidence before forming the claim prevents the claim from selecting its own support. Order is what makes it honest.
...
**What depends on it.** Lesson 13 — Evidence Somebody Else Can Check — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Collecting evidence before forming the claim prevents the claim from selecting its own support. Order is what makes it honest.
...
1. Three observations collected, then a claim drawn from them.
2. A claim narrower than expected because the evidence was thin.

### One non-example

A claim written first with evidence found afterwards.
...
That evidence-first order changes the claim.

### What this activity does not establish

That the claim is now correct.
...
| Statement | Status |
|---|---|
| Collecting evidence before forming the claim prevents the claim from selecting its own support. | Framework-derived, appropriate at this grade |
| That evidence-first order changes the claim. | What this specific activity can show |
| That the claim is now correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 11 — Evidence For A Memory — specifically: students support a claim about what they remembered.

**How it was taught.** Through the activity: three memory claims, each with evidence or a question mark

**Quick check.** Ask for the closing sentence of Lesson 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 11: three memory claims, each with evidence or a question mark, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Three observations collected, then a claim drawn from them. |
| **Non-example** | A claim written first with evidence found afterwards. |
...
> "A question mark is honest. Inventing evidence is not."
...
**Exact wording.** "Say: today the evidence comes first, then the claim."
...
**Target observation.** That evidence-first order changes the claim.
...
> "Collecting evidence before forming the claim prevents the claim from selecting its own support. You just saw that when say: today the evidence comes first, then the claim.
> Last time we said: A question mark is honest. Inventing evidence is not. This is the next part of that.
...
**What students must not infer.** That the claim is now correct.

### 4. Worked example

**The example.** Three observations collected, then a claim drawn from them.
...
**Completed answer.** Three observations collected, then a claim drawn from them. — which demonstrates that evidence-first order changes the claim.
...
**Conclusions not licensed.** That the claim is now correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A claim narrower than expected because the evidence was thin. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim written first with evidence found afterwards. Why is this not an
example?"
...
**Exact student instructions.** Evidence-first task: collect three observations, then write one claim they support.
...
- *Licensed conclusion.* That evidence-first order changes the claim.
- *Not licensed.* That the claim is now correct.
...
- *Expected response.* That evidence-first order changes the claim.
...
1. Any wording carrying the idea in `Collecting evidence before forming the claim prevents the claim from selecting its own support`.
...
Say: "Collecting first stops you deciding first."
...
| | |
|---|---|
| **Follows** | Lesson 11 — Evidence For A Memory |
| **Leads to** | Lesson 13 — Evidence Somebody Else Can Check |

**Transition in.** Lesson 11 established students support a claim about what they remembered. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students gather evidence deliberately before making a claim. Lesson 13 assumes it and builds students test whether a partner can verify their evidence.
