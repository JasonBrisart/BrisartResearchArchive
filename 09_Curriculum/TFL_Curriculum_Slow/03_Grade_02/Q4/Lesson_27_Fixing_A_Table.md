...
| | |
|---|---|
| **Central question** | Fixing A Table: students repair a checked table? |
| **Core concept** | Crossing out a row that cannot be supported is a legitimate repair, not a loss. |
| **Student outcome** | Students repair a checked table. |
| **Previous lesson** | Lesson 26 — Checking A Table |
| **Next lesson** | Lesson 28 — Tables From Other Subjects |
...
**The conceptual step.** Crossing out a row that cannot be supported is a legitimate repair, not a loss. The repaired table is stronger for being shorter.
...
**What depends on it.** Lesson 28 — Tables From Other Subjects — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Crossing out a row that cannot be supported is a legitimate repair, not a loss. The repaired table is stronger for being shorter.
...
1. A row crossed out because no evidence exists.
2. A row repaired by adding the missing memory.

### One non-example

A row defended without being changed.
...
That removal is a valid repair.

### What this activity does not establish

That the repaired table is complete.
...
| Statement | Status |
|---|---|
| Crossing out a row that cannot be supported is a legitimate repair, not a loss. | Framework-derived, appropriate at this grade |
| That removal is a valid repair. | What this specific activity can show |
| That the repaired table is complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — Checking A Table — specifically: students audit somebody else's table.

**How it was taught.** Through the activity: swap tables and mark every row missing a column or with unpointable evidence

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: swap tables and mark every row missing a column or with unpointable evidence, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A row crossed out because no evidence exists. |
| **Non-example** | A row defended without being changed. |
...
> "Read the columns. Find the gaps."
...
**Exact wording.** "Say: your table came back with notes. Today you fix it."
...
**Target observation.** That removal is a valid repair.
...
> "Crossing out a row that cannot be supported is a legitimate repair, not a loss. You just saw that when say: your table came back with notes.
> Last time we said: Read the columns. Find the gaps. This is the next part of that.
...
**What students must not infer.** That the repaired table is complete.

### 4. Worked example

**The example.** A row crossed out because no evidence exists.
...
**Completed answer.** A row crossed out because no evidence exists. — which demonstrates that removal is a valid repair.
...
**Conclusions not licensed.** That the repaired table is complete.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A row repaired by adding the missing memory. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A row defended without being changed. Why is this not an
example?"
...
**Exact student instructions.** Repair every noted row, including at least one crossed out.
...
- *Licensed conclusion.* That removal is a valid repair.
- *Not licensed.* That the repaired table is complete.
...
- *Expected response.* That removal is a valid repair.
...
1. Any wording carrying the idea in `Crossing out a row that cannot be supported is a legitimate repair, not a loss`.
...
| | |
|---|---|
| **Follows** | Lesson 26 — Checking A Table |
| **Leads to** | Lesson 28 — Tables From Other Subjects |

**Transition in.** Lesson 26 established students audit somebody else's table. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students repair a checked table. Lesson 28 assumes it and builds students build a comparison table on non-TFL material.
