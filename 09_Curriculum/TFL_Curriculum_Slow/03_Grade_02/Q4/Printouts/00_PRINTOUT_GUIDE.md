...
|---|---|---|---|---|---|---|
| `Lesson_25_Printout.md` | Lesson 25 — The Comparison Table | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_26_Printout.md` | Lesson 26 — Checking A Table | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 25 work |
| `Lesson_27_Printout.md` | Lesson 27 — Fixing A Table | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 26 work |
| `Lesson_28_Printout.md` | Lesson 28 — Tables From Other Subjects | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 27 work |
| `Lesson_29_Printout.md` | Lesson 29 — Explaining The Table | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 28 work |
| `Lesson_30_Printout.md` | Lesson 30 — The Whole Comparison | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 29 work |
| `Lesson_31_Printout.md` | Lesson 31 — Practice Final | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 30 work |
| `Lesson_32_Printout.md` | Lesson 32 — Final Assessment | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 31 work |
...
**Lesson 29 — Explaining The Table.** If you only have time to print one
