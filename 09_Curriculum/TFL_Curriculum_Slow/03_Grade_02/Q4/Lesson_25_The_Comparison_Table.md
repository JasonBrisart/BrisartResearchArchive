# Lesson 25 — The Comparison Table
...
| | |
|---|---|
| **Central question** | The Comparison Table: students build a four-column comparison unaided? |
| **Core concept** | The four-column table holds everything the year has taught. |
| **Student outcome** | Students build a four-column comparison unaided. |
| **Previous lesson** | Lesson 24 — The Change Review |
| **Next lesson** | Lesson 26 — Checking A Table |
...
**The conceptual step.** The four-column table holds everything the year has taught. A row with a blank evidence column is not finished.
...
**What depends on it.** Lesson 26 — Checking A Table — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The four-column table holds everything the year has taught. A row with a blank evidence column is not finished.
...
1. A row with all four columns filled and pointable evidence.
2. A row crossed out because the evidence could not be supplied.

### One non-example

A row with three columns filled and evidence left blank.
...
Whether the student can assemble the year's tool unaided.

### What this activity does not establish

Whether the comparison is interesting.
...
| Statement | Status |
|---|---|
| The four-column table holds everything the year has taught. | Framework-derived, appropriate at this grade |
| Whether the student can assemble the year's tool unaided. | What this specific activity can show |
| Whether the comparison is interesting. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 24 — The Change Review — specifically: students consolidate the quarter's work on change.

**How it was taught.** Through the activity: review using the term's pooled numbers and tallies

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: review using the term's pooled numbers and tallies, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A row with all four columns filled and pointable evidence. |
| **Non-example** | A row with three columns filled and evidence left blank. |
...
> "Next time: the table that holds all of it."
...
**Exact wording.** "Blank four-column table on the board: WHO, EXPECTED, FROM WHAT MEMORY, EVIDENCE."
...
**Target observation.** Whether the student can assemble the year's tool unaided.
...
> "The four-column table holds everything the year has taught. You just saw that when blank four-column table on the board: WHO, EXPECTED, FROM WHAT MEMORY, EVIDENCE.
> Last time we said: Next time: the table that holds all of it. This is the next part of that.
...
**What students must not infer.** Whether the comparison is interesting.

### 4. Worked example

**The example.** A row with all four columns filled and pointable evidence.
...
**Completed answer.** A row with all four columns filled and pointable evidence. — which demonstrates whether the student can assemble the year's tool unaided.
...
**Conclusions not licensed.** Whether the comparison is interesting.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A row crossed out because the evidence could not be supplied. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A row with three columns filled and evidence left blank. Why is this not an
example?"
...
**Exact student instructions.** Four complete rows about one shared event, two people plus a self-comparison.
...
- *Licensed conclusion.* Whether the student can assemble the year's tool unaided.
- *Not licensed.* Whether the comparison is interesting.
...
- *Expected response.* Whether the student can assemble the year's tool unaided.
...
1. Any wording carrying the idea in `The four-column table holds everything the year has taught`.
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Change Review |
| **Leads to** | Lesson 26 — Checking A Table |

**Transition in.** Lesson 24 established students consolidate the quarter's work on change. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students build a four-column comparison unaided. Lesson 26 assumes it and builds students audit somebody else's table.
