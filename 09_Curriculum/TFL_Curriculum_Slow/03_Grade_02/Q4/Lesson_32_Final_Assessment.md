...
| **Core concept** | The four exit outcomes together constitute readiness for Grade 3, where the three parts combine into a single moment. |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 3, where the three parts combine into a single moment.
...
The four exit outcomes together constitute readiness for Grade 3, where the three parts combine into a single moment.
...
2. A student completes the cause item fully and the rest adequately.

### One non-example

A student who writes at length on the comparison and omits the cause.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 3, where the three parts combine into a single moment. | Framework-derived, appropriate at this grade |
...
**How it was taught.** Through the activity: a full practice final, self-marked against the key

**Quick check.** Ask for the closing sentence of Lesson 31. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 31: a full practice final, self-marked against the key, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A student who writes at length on the comparison and omits the cause. |
...
> "The four exit outcomes together constitute readiness for Grade 3, where the three parts combine into a single moment. You just saw that when say: everything you know, on your own.
> Last time we said: Now you know what to look at. This is the next part of that.
...
**Teacher prompt.** "Here is a second case. A student completes the cause item fully and the rest adequately. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student who writes at length on the comparison and omits the cause. Why is this not an
example?"
...
**Exact student instructions.** The final: build a comparison, name the cause, find a missing element, compare across time.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 3, where the three parts combine into a single moment`.
...
Say: "Next year: three parts become one moment."
