# Lesson 28 — Tables From Other Subjects
...
| | |
|---|---|
| **Central question** | Tables From Other Subjects: students build a comparison table on non-TFL material? |
| **Core concept** | The comparison table is a general tool. |
| **Student outcome** | Students build a comparison table on non-TFL material. |
| **Previous lesson** | Lesson 27 — Fixing A Table |
| **Next lesson** | Lesson 29 — Explaining The Table |
...
**The conceptual step.** The comparison table is a general tool. Using it on outside material shows it is not tied to this lesson's content.
...
**What depends on it.** Lesson 29 — Explaining The Table — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The comparison table is a general tool. Using it on outside material shows it is not tied to this lesson's content.
...
1. Two accounts of an event from a story, compared.
2. Two reports of a science observation, compared.

### One non-example

A table built from this lesson's material in a different notebook.
...
That the tool transfers to other material.
...
| Statement | Status |
|---|---|
| The comparison table is a general tool. | Framework-derived, appropriate at this grade |
| That the tool transfers to other material. | What this specific activity can show |
| Anything about the other subject. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — Fixing A Table — specifically: students repair a checked table.

**How it was taught.** Through the activity: repair every noted row, including at least one crossed out

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: repair every noted row, including at least one crossed out, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two accounts of an event from a story, compared. |
| **Non-example** | A table built from this lesson's material in a different notebook. |
...
**Exact wording.** "Take two accounts of the same event from a reading lesson."
...
**Target observation.** That the tool transfers to other material.
...
> "The comparison table is a general tool. You just saw that when take two accounts of the same event from a reading lesson.
> Last time we said: Crossing out is a fix. This is the next part of that.
...
**The example.** Two accounts of an event from a story, compared.
...
**Completed answer.** Two accounts of an event from a story, compared. — which demonstrates that the tool transfers to other material.
...
**Teacher prompt.** "Here is a second case. Two reports of a science observation, compared. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A table built from this lesson's material in a different notebook. Why is this not an
example?"
...
**Exact student instructions.** A four-column table comparing two accounts from another subject.
...
- *Licensed conclusion.* That the tool transfers to other material.
...
- *Expected response.* That the tool transfers to other material.
...
1. Any wording carrying the idea in `The comparison table is a general tool`.
...
Say: "The tool works on anything with two accounts."
...
| | |
|---|---|
| **Follows** | Lesson 27 — Fixing A Table |
| **Leads to** | Lesson 29 — Explaining The Table |

**Transition in.** Lesson 27 established students repair a checked table. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students build a comparison table on non-TFL material. Lesson 29 assumes it and builds students explain the table to somebody who was not there.
