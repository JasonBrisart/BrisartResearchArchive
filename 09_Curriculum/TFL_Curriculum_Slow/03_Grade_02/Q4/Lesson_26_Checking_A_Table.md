...
| | |
|---|---|
| **Central question** | Checking A Table: students audit somebody else's table? |
| **Core concept** | Auditing means locating specific gaps, not delivering a verdict. |
| **Student outcome** | Students audit somebody else's table. |
| **Previous lesson** | Lesson 25 — The Comparison Table |
| **Next lesson** | Lesson 27 — Fixing A Table |
...
**The conceptual step.** Auditing means locating specific gaps, not delivering a verdict. A note must name the row and the column.
...
**What depends on it.** Lesson 27 — Fixing A Table — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Auditing means locating specific gaps, not delivering a verdict. A note must name the row and the column.
...
1. A note reading row three, evidence column empty.
2. A note reading row one, evidence cannot be pointed at.

### One non-example

A note reading this table is fine.
...
That gaps can be located specifically.

### What this activity does not establish

Whether the table's content is correct.
...
| Statement | Status |
|---|---|
| Auditing means locating specific gaps, not delivering a verdict. | Framework-derived, appropriate at this grade |
| That gaps can be located specifically. | What this specific activity can show |
| Whether the table's content is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — The Comparison Table — specifically: students build a four-column comparison unaided.

**How it was taught.** Through the activity: four complete rows about one shared event, two people plus a self-comparison

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: four complete rows about one shared event, two people plus a self-comparison, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A note reading row three, evidence column empty. |
| **Non-example** | A note reading this table is fine. |
...
**Exact wording.** "A deliberately broken table on the board. Ask what is wrong."
...
**Target observation.** That gaps can be located specifically.
...
> "Auditing means locating specific gaps, not delivering a verdict. You just saw that when a deliberately broken table on the board.
> Last time we said: The table is the tool. This is the next part of that.
...
**What students must not infer.** Whether the table's content is correct.

### 4. Worked example

**The example.** A note reading row three, evidence column empty.
...
**Completed answer.** A note reading row three, evidence column empty. — which demonstrates that gaps can be located specifically.
...
**Conclusions not licensed.** Whether the table's content is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A note reading row one, evidence cannot be pointed at. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A note reading this table is fine. Why is this not an
example?"
...
**Exact student instructions.** Swap tables and mark every row missing a column or with unpointable evidence.
...
- *Licensed conclusion.* That gaps can be located specifically.
- *Not licensed.* Whether the table's content is correct.
...
- *Expected response.* That gaps can be located specifically.
...
1. Any wording carrying the idea in `Auditing means locating specific gaps, not delivering a verdict`.
...
Say: "Read the columns. Find the gaps."
...
| | |
|---|---|
| **Follows** | Lesson 25 — The Comparison Table |
| **Leads to** | Lesson 27 — Fixing A Table |

**Transition in.** Lesson 25 established students build a four-column comparison unaided. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit somebody else's table. Lesson 27 assumes it and builds students repair a checked table.
