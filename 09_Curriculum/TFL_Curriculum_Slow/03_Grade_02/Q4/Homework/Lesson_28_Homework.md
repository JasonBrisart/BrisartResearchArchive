# Lesson 28 Homework — Tables From Other Subjects

**Grade 2** · Comparing and Checking · **Quarter 4**
**Follows:** Lesson 28 — Tables From Other Subjects · **Points:** 5 · **Optional:** yes
...
A four-column table comparing two accounts from another subject.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student completes four rows on outside material
...
Lesson 29 is **Explaining The Table**, which assumes you arrive holding it. Write one thing you expect it to be about:
