# Lesson 30 — The Whole Comparison
...
| | |
|---|---|
| **Central question** | The Whole Comparison: students produce, check, and repair a complete comparison? |
| **Core concept** | The full cycle of build, check, repair, and report is the year's terminal skill. |
| **Student outcome** | Students produce, check, and repair a complete comparison. |
| **Previous lesson** | Lesson 29 — Explaining The Table |
...
**The conceptual step.** The full cycle of build, check, repair, and report is the year's terminal skill. A finding without a named cause is incomplete.
...
The full cycle of build, check, repair, and report is the year's terminal skill. A finding without a named cause is incomplete.
...
1. A finding naming the differing memory as the cause.
2. A repaired table read aloud with its cause.

### One non-example

A finding stating only that two people differed.
...
Whether the student can run the whole cycle.
...
| Statement | Status |
|---|---|
| The full cycle of build, check, repair, and report is the year's terminal skill. | Framework-derived, appropriate at this grade |
| Whether the student can run the whole cycle. | What this specific activity can show |
| Whether the finding is important. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 29 — Explaining The Table — specifically: students explain the table to somebody who was not there.

**How it was taught.** Through the activity: each student explains the four columns to a buddy and records one question asked

**Quick check.** Ask for the closing sentence of Lesson 29. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 29: each student explains the four columns to a buddy and records one question asked, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A finding naming the differing memory as the cause. |
| **Non-example** | A finding stating only that two people differed. |
...
> "The question is the useful bit."
...
**Exact wording.** "Say: build it, check it, fix it, then tell me what you found."
...
**Target observation.** Whether the student can run the whole cycle.
...
> "The full cycle of build, check, repair, and report is the year's terminal skill. You just saw that when say: build it, check it, fix it, then tell me what you found.
> Last time we said: The question is the useful bit. This is the next part of that.
...
**What students must not infer.** Whether the finding is important.

### 4. Worked example

**The example.** A finding naming the differing memory as the cause.
...
**Completed answer.** A finding naming the differing memory as the cause. — which demonstrates whether the student can run the whole cycle.
...
**Conclusions not licensed.** Whether the finding is important.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A repaired table read aloud with its cause. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A finding stating only that two people differed. Why is this not an
example?"
...
**Exact student instructions.** Full cycle: build, swap, check, repair, read one finding aloud.
...
- *Licensed conclusion.* Whether the student can run the whole cycle.
- *Not licensed.* Whether the finding is important.
...
- *Expected response.* Whether the student can run the whole cycle.
...
1. Any wording carrying the idea in `The full cycle of build, check, repair, and report is the year's terminal skill`.
...
Say: "Next year: all of this fits into one single moment."
...
| | |
|---|---|
| **Follows** | Lesson 29 — Explaining The Table |
| **Leads to** | Lesson 31 — Practice Final |

**Transition in.** Lesson 29 established students explain the table to somebody who was not there. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students produce, check, and repair a complete comparison. Lesson 31 assumes it and builds students rehearse the final under conditions.
