# Lesson 8 — The Comparison Review
...
| | |
|---|---|
| **Central question** | The Comparison Review: students consolidate comparison? |
| **Core concept** | A comparison is incomplete without a named cause. |
| **Student outcome** | Students consolidate comparison. |
| **Previous lesson** | Lesson 7 — Comparing With A Partner |
| **Next lesson** | Lesson 9 — Pointing At Evidence |
...
**The conceptual step.** A comparison is incomplete without a named cause. The relay format tests whether the cause step survives under speed.
...
**What depends on it.** Lesson 9 — Pointing At Evidence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A comparison is incomplete without a named cause. The relay format tests whether the cause step survives under speed.
...
1. A completed pair with the cause named.
2. A student self-corrects by adding the cause.

### One non-example

A pair with the difference stated but no cause.
...
Whether the cause step is habitual.

### What this activity does not establish

Accuracy of the named cause.
...
| Statement | Status |
|---|---|
| A comparison is incomplete without a named cause. | Framework-derived, appropriate at this grade |
| Whether the cause step is habitual. | What this specific activity can show |
| Accuracy of the named cause. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — Comparing With A Partner — specifically: students run a full comparison with a partner on a shared event.

**How it was taught.** Through the activity: both reconstruct, then compare and name the cause of the difference

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: both reconstruct, then compare and name the cause of the difference, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A completed pair with the cause named. |
| **Non-example** | A pair with the difference stated but no cause. |
...
> "One event. Two different expectations."
...
**Exact wording.** "Ask what comparing needs and what causes a difference."
...
**Target observation.** Whether the cause step is habitual.
...
> "A comparison is incomplete without a named cause. You just saw that when ask what comparing needs and what causes a difference.
> Last time we said: One event. Two different expectations. This is the next part of that.
...
**What students must not infer.** Accuracy of the named cause.

### 4. Worked example

**The example.** A completed pair with the cause named.
...
**Completed answer.** A completed pair with the cause named. — which demonstrates whether the cause step is habitual.
...
**Conclusions not licensed.** Accuracy of the named cause.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student self-corrects by adding the cause. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A pair with the difference stated but no cause. Why is this not an
example?"
...
**Exact student instructions.** Review relay with six comparison pairs to complete.
...
- *Licensed conclusion.* Whether the cause step is habitual.
- *Not licensed.* Accuracy of the named cause.
...
- *Expected response.* Whether the cause step is habitual.
...
1. Any wording carrying the idea in `A comparison is incomplete without a named cause`.
...
Say: "Next time: how you show your answer is right."
...
| | |
|---|---|
| **Follows** | Lesson 7 — Comparing With A Partner |
| **Leads to** | Lesson 9 — Pointing At Evidence |

**Transition in.** Lesson 7 established students run a full comparison with a partner on a shared event. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate comparison. Lesson 9 assumes it and builds students support a claim by pointing at something.
