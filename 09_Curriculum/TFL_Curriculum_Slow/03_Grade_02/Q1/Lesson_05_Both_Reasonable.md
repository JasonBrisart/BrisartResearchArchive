...
| | |
|---|---|
| **Central question** | Both Reasonable: students accept that two differing expectations can both be reasonable? |
| **Core concept** | Two well-traced expectations can differ without either being an error. |
| **Student outcome** | Students accept that two differing expectations can both be reasonable. |
| **Previous lesson** | Lesson 4 — Comparing Across The Day |
| **Next lesson** | Lesson 6 — When One Is Wrong |
...
**The conceptual step.** Two well-traced expectations can differ without either being an error. Difference and error are separate judgements.
...
**What depends on it.** Lesson 6 — When One Is Wrong — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Two well-traced expectations can differ without either being an error. Difference and error are separate judgements.
...
1. Two students expect different weather, both from real evidence.
2. Two students expect different lessons, both from the timetable.

### One non-example

A case where one expectation ignored the available evidence.
...
That difference does not imply error.

### What this activity does not establish

Whether either expectation was correct.
...
| Statement | Status |
|---|---|
| Two well-traced expectations can differ without either being an error. | Framework-derived, appropriate at this grade |
| That difference does not imply error. | What this specific activity can show |
| Whether either expectation was correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — Comparing Across The Day — specifically: students compare expectations from different points in one day.

**How it was taught.** Through the activity: four expectations from across one day, compared in two pairs

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: four expectations from across one day, compared in two pairs, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two students expect different weather, both from real evidence. |
| **Non-example** | A case where one expectation ignored the available evidence. |
...
> "Even your own expectations differ across a day."
...
**Exact wording.** "Present a genuinely ambiguous case with two good traces."
...
**Target observation.** That difference does not imply error.
...
> "Two well-traced expectations can differ without either being an error. You just saw that when present a genuinely ambiguous case with two good traces.
> Last time we said: Even your own expectations differ across a day. This is the next part of that.
...
**What students must not infer.** Whether either expectation was correct.

### 4. Worked example

**The example.** Two students expect different weather, both from real evidence.
...
**Completed answer.** Two students expect different weather, both from real evidence. — which demonstrates that difference does not imply error.
...
**Conclusions not licensed.** Whether either expectation was correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Two students expect different lessons, both from the timetable. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A case where one expectation ignored the available evidence. Why is this not an
example?"
...
**Exact student instructions.** Find one comparison where both sides were reasonable and say why.
...
- *Licensed conclusion.* That difference does not imply error.
- *Not licensed.* Whether either expectation was correct.
...
- *Expected response.* That difference does not imply error.
...
1. Any wording carrying the idea in `Two well-traced expectations can differ without either being an error`.
...
Say: "Different does not mean wrong."
...
| | |
|---|---|
| **Follows** | Lesson 4 — Comparing Across The Day |
| **Leads to** | Lesson 6 — When One Is Wrong |

**Transition in.** Lesson 4 established students compare expectations from different points in one day. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students accept that two differing expectations can both be reasonable. Lesson 6 assumes it and builds students handle the case where one expectation was checkable and wrong.
