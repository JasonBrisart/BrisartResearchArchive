# Lesson 1 Homework — Two Side By Side

**Grade 2** · Comparing and Checking · **Quarter 1**
**Follows:** Lesson 1 — Two Side By Side · **Points:** 5 · **Optional:** yes
...
Pairs pick one differing pair and write both plus one difference.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every pair states a difference, not just two expectations
...
Lesson 2 is **Why They Differed**, which assumes you arrive holding it. Write one thing you expect it to be about:
