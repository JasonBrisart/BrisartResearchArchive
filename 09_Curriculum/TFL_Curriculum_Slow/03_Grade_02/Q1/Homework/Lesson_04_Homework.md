# Lesson 4 Homework — Comparing Across The Day

**Grade 2** · Comparing and Checking · **Quarter 1**
**Follows:** Lesson 4 — Comparing Across The Day · **Points:** 5 · **Optional:** yes
...
Four expectations from across one day, compared in two pairs.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student compares two pairs
...
Lesson 5 is **Both Reasonable**, which assumes you arrive holding it. Write one thing you expect it to be about:
