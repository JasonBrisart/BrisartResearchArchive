# Lesson 8 Homework — The Comparison Review

**Grade 2** · Comparing and Checking · **Quarter 1**
**Follows:** Lesson 8 — The Comparison Review · **Points:** 5 · **Optional:** yes
...
Review relay with six comparison pairs to complete.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class completes at least four correctly
...
Lesson 9 is **Pointing At Evidence**, which assumes you arrive holding it. Write one thing you expect it to be about:
