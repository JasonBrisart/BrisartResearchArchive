# Lesson 5 Homework — Both Reasonable

**Grade 2** · Comparing and Checking · **Quarter 1**
**Follows:** Lesson 5 — Both Reasonable · **Points:** 5 · **Optional:** yes
...
Find one comparison where both sides were reasonable and say why.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** students can state that difference is not error
...
Lesson 6 is **When One Is Wrong**, which assumes you arrive holding it. Write one thing you expect it to be about:
