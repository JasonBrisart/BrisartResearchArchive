# Lesson 7 Homework — Comparing With A Partner

**Grade 2** · Comparing and Checking · **Quarter 1**
**Follows:** Lesson 7 — Comparing With A Partner · **Points:** 5 · **Optional:** yes
...
Both reconstruct, then compare and name the cause of the difference.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every pair names a cause
...
Lesson 8 is **The Comparison Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
