...
| | |
|---|---|
| **Central question** | Two Side By Side: students set two expectations side by side and state one difference? |
| **Core concept** | Comparing requires two items and a stated difference. |
| **Student outcome** | Students set two expectations side by side and state one difference. |
| **Previous lesson** | None. First lesson of the year. |
| **Next lesson** | Lesson 2 — Why They Differed |
...
**The conceptual step.** Comparing requires two items and a stated difference. Listing two expectations without naming the difference is not a comparison.
...
**What depends on it.** Lesson 2 — Why They Differed — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Comparing requires two items and a stated difference. Listing two expectations without naming the difference is not a comparison.
...
1. Two expectations about the hidden object with the difference named.
2. Two expectations about the weather with the difference named.

### One non-example

Two expectations written down with nothing said about them.
...
That comparison requires an explicit stated difference.

### What this activity does not establish

Why the two differ, which is next lesson.
...
| Statement | Status |
|---|---|
| Comparing requires two items and a stated difference. | Framework-derived, appropriate at this grade |
| That comparison requires an explicit stated difference. | What this specific activity can show |
| Why the two differ, which is next lesson. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The student traces any expectation to a source unaided.
...
| **Correct example** | Two expectations about the hidden object with the difference named. |
| **Non-example** | Two expectations written down with nothing said about them. |
...
**Exact wording.** "Show a partly hidden object. Collect written guesses, read two aloud that differ."
...
**Target observation.** That comparison requires an explicit stated difference.
...
> "Comparing requires two items and a stated difference. You just saw that when show a partly hidden object.
...
**What students must not infer.** Why the two differ, which is next lesson.

### 4. Worked example

**The example.** Two expectations about the hidden object with the difference named.
...
**Completed answer.** Two expectations about the hidden object with the difference named. — which demonstrates that comparison requires an explicit stated difference.
...
**Conclusions not licensed.** Why the two differ, which is next lesson.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Two expectations about the weather with the difference named. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two expectations written down with nothing said about them. Why is this not an
example?"
...
**Exact student instructions.** Pairs pick one differing pair and write both plus one difference.
...
- *Licensed conclusion.* That comparison requires an explicit stated difference.
- *Not licensed.* Why the two differ, which is next lesson.
...
- *Expected response.* That comparison requires an explicit stated difference.
...
1. Any wording carrying the idea in `Comparing requires two items and a stated difference`.
...
| **Leads to** | Lesson 2 — Why They Differed |

**Transition in.** This lesson opens the year.

**Transition out.** This lesson establishes students set two expectations side by side and state one difference. Lesson 2 assumes it and builds students name the memory behind each of two expectations.
