...
|---|---|---|---|---|---|---|
| `Convening_04_Printout.md` | Convening 4 — Preservation And The Citing Literature | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Convening_05_Printout.md` | Convening 5 — Multi-Institution Replication | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | Convening 4 work |
| `Convening_06_Printout.md` | Convening 6 — Preserving Nulls And Deviations | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | Convening 5 work |
...
**Convening 5 — Multi-Institution Replication.** If you only have time to print one
