# Convening 5 — Multi-Institution Replication

**Field Stewardship** · Governing The Examination · **Quarter 2** · **Full day**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Multi-Institution Replication: participants build an adoptable consortium protocol? |
| **Core concept** | A consortium protocol locks what must be common and leaves local implementation to each site. |
| **Student outcome** | Participants build an adoptable consortium protocol. |
| **Previous convening** | Convening 4 — Preservation And The Citing Literature |
| **Next convening** | Convening 6 — Preserving Nulls And Deviations |
| **Materials** | The full specification and its version history; instrument templates |
| **Preparation** | three hours |
| **Student printout** | `Printouts/Convening_05_Printout.md` |
| **Homework** | `Homework/Convening_05_Homework.md` |

## Why this lesson exists

**The conceptual step.** A consortium protocol locks what must be common and leaves local implementation to each site. A protocol dictating local settings will not be adopted, and an unadopted protocol produces nothing.
...
**What depends on it.** Convening 6 — Preserving Nulls And Deviations — opens by assuming this convening's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A consortium protocol locks what must be common and leaves local implementation to each site. A protocol dictating local settings will not be adopted, and an unadopted protocol produces nothing.
...
1. A protocol an unaffiliated institution could join unaided.
2. A protocol locking outcome definitions but not local procedures.

### One non-example

A protocol specifying the recording equipment each site must use.
...
That adoptability constrains protocol design.

### What this activity does not establish

Whether the protocol would be adopted.
...
| Statement | Status |
|---|---|
| A consortium protocol locks what must be common and leaves local implementation to each site. | Framework-derived, appropriate at this grade |
| That adoptability constrains protocol design. | What this specific activity can show |
| Whether the protocol would be adopted. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Convening 4 — Preservation And The Citing Literature — specifically: participants guarantee that superseded versions remain interpretable.

**How it was taught.** Through the activity: write the preservation clause and test it against three citation scenarios

**Quick check.** Ask for the closing sentence of Convening 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Convening 4: write the preservation clause and test it against three citation scenarios, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A protocol an unaffiliated institution could join unaided. |
| **Non-example** | A protocol specifying the recording equipment each site must use. |
...
**Student materials.** One copy of `Printouts/Convening_05_Printout.md` per student.

**Prior student data required.** Work produced in Convening 4, kept in the student's folder.
...
**File.** `Printouts/Convening_05_Printout.md`
...
> "The record must remain interpretable after you are gone."
...
**Exact wording.** "Say: ten studies that cannot be compared are ten anecdotes with statistics attached."
...
**Target observation.** That adoptability constrains protocol design.
...
> "A consortium protocol locks what must be common and leaves local implementation to each site. You just saw that when say: ten studies that cannot be compared are ten anecdotes with statistics attached.
> Last time we said: The record must remain interpretable after you are gone. This is the next part of that.
...
**What students must not infer.** Whether the protocol would be adopted.

### 4. Worked example

**The example.** A protocol an unaffiliated institution could join unaided.
...
**Completed answer.** A protocol an unaffiliated institution could join unaided. — which demonstrates that adoptability constrains protocol design.
...
**Conclusions not licensed.** Whether the protocol would be adopted.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A protocol locking outcome definitions but not local procedures. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A protocol specifying the recording equipment each site must use. Why is this not an
example?"
...
**Exact student instructions.** Draft the protocol and test whether an unaffiliated institution could join.
...
- *Licensed conclusion.* That adoptability constrains protocol design.
- *Not licensed.* Whether the protocol would be adopted.
...
- *Expected response.* That adoptability constrains protocol design.
...
1. Any wording carrying the idea in `A consortium protocol locks what must be common and leaves local implementation to each site`.
...
Say: "A protocol dictating local implementation will not be adopted."

**Why this sentence matters.** It is the opening question of Convening 6, which assumes students arrive holding it.
...
**File.** `Homework/Convening_05_Homework.md`
...
| | |
|---|---|
| **Follows** | Convening 4 — Preservation And The Citing Literature |
| **Leads to** | Convening 6 — Preserving Nulls And Deviations |

**Transition in.** Convening 4 established participants guarantee that superseded versions remain interpretable. This convening uses that as the starting point.

**Transition out.** This convening establishes participants build an adoptable consortium protocol. Convening 6 assumes it and builds participants require preservation of unfavourable results.
