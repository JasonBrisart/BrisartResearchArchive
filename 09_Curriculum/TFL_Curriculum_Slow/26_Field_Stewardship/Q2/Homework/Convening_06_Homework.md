# Convening 6 Homework — Preserving Nulls And Deviations

**Field Stewardship** · Governing The Examination · **Quarter 2**
**Follows:** Convening 6 — Preserving Nulls And Deviations · **Points:** 5 · **Optional:** yes
...
Write the sentence Convening 6 ended on, from memory:
...
Write the preservation requirement covering nulls, deviations, and withdrawals.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** null preservation is required rather than optional
...
Convening 7 is **Registries And The Public Record**, which assumes you arrive holding it. Write one thing you expect it to be about:
