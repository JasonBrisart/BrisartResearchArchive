# Convening 5 Homework — Multi-Institution Replication

**Field Stewardship** · Governing The Examination · **Quarter 2**
**Follows:** Convening 5 — Multi-Institution Replication · **Points:** 5 · **Optional:** yes
...
Write the sentence Convening 5 ended on, from memory:
...
Draft the protocol and test whether an unaffiliated institution could join.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the protocol permits joining without author contact
...
Convening 6 is **Preserving Nulls And Deviations**, which assumes you arrive holding it. Write one thing you expect it to be about:
