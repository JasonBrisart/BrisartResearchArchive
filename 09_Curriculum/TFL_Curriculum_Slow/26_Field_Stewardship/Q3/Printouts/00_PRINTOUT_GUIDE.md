...
Every convening in this quarter has one matching student printout. Distribute
it **before the hook** so students can record their initial thinking before any
explanation is given.

## What is here

| Printout | Matching convening | Pages | Distribute | Student action | After | Prior data |
|---|---|---|---|---|---|---|
| `Convening_07_Printout.md` | Convening 7 — Registries And The Public Record | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Convening_08_Printout.md` | Convening 8 — Abandoned Registrations | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | Convening 7 work |
| `Convening_09_Printout.md` | Convening 9 — Supersession, Retirement, And Graceful Failure | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | Convening 8 work |

## When to distribute

Always before the hook. The *What I think before the convening* section is only
...
| What I think before the convening | Before any explanation |
...
## The pivot convening of this quarter

**Convening 8 — Abandoned Registrations.** If you only have time to print one
