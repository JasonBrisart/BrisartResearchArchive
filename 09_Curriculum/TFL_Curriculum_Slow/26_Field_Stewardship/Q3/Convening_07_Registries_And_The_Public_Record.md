# Convening 7 — Registries And The Public Record
...
| | |
|---|---|
| **Central question** | Registries And The Public Record: participants specify infrastructure making prespecification verifiable? |
| **Core concept** | A registry makes prespecification verifiable. |
| **Student outcome** | Participants specify infrastructure making prespecification verifiable. |
| **Previous convening** | Convening 6 — Preserving Nulls And Deviations |
| **Next convening** | Convening 8 — Abandoned Registrations |
| **Materials** | The full specification and its version history; instrument templates |
| **Preparation** | three hours |
| **Student printout** | `Printouts/Convening_07_Printout.md` |
| **Homework** | `Homework/Convening_07_Homework.md` |

## Why this lesson exists

**The conceptual step.** A registry makes prespecification verifiable. Without an operator succession plan it is a single point of failure holding the field's entire record.
...
**What depends on it.** Convening 8 — Abandoned Registrations — opens by assuming this convening's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A registry makes prespecification verifiable. Without an operator succession plan it is a single point of failure holding the field's entire record.
...
1. A registry specification with a named succession arrangement.
2. A specification naming the archive that would receive the record.

### One non-example

A registry specification with no succession plan.
...
That registries require succession planning.

### What this activity does not establish

Whether the registry would be built.
...
| Statement | Status |
|---|---|
| A registry makes prespecification verifiable. | Framework-derived, appropriate at this grade |
| That registries require succession planning. | What this specific activity can show |
| Whether the registry would be built. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Convening 6 — Preserving Nulls And Deviations — specifically: participants require preservation of unfavourable results.

**How it was taught.** Through the activity: write the preservation requirement covering nulls, deviations, and withdrawals

**Quick check.** Ask for the closing sentence of Convening 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Convening 6: write the preservation requirement covering nulls, deviations, and withdrawals, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A registry specification with a named succession arrangement. |
| **Non-example** | A registry specification with no succession plan. |
...
**Student materials.** One copy of `Printouts/Convening_07_Printout.md` per student.

**Prior student data required.** Work produced in Convening 6, kept in the student's folder.
...
**File.** `Printouts/Convening_07_Printout.md`
...
> "Optional null preservation produces a literature that cannot be read."
...
**Exact wording.** "Say: every level below this requires prespecification. None can verify it."
...
**Target observation.** That registries require succession planning.
...
> "A registry makes prespecification verifiable. You just saw that when say: every level below this requires prespecification.
> Last time we said: Optional null preservation produces a literature that cannot be read. This is the next part of that.
...
**What students must not infer.** Whether the registry would be built.

### 4. Worked example

**The example.** A registry specification with a named succession arrangement.
...
**Completed answer.** A registry specification with a named succession arrangement. — which demonstrates that registries require succession planning.
...
**Conclusions not licensed.** Whether the registry would be built.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A specification naming the archive that would receive the record. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A registry specification with no succession plan. Why is this not an
example?"
...
**Exact student instructions.** Draft the specification including the operator succession plan.
...
- *Licensed conclusion.* That registries require succession planning.
- *Not licensed.* Whether the registry would be built.
...
- *Expected response.* That registries require succession planning.
...
1. Any wording carrying the idea in `A registry makes prespecification verifiable`.
...
Say: "A registry with no succession is a single point of failure holding the record."

**Why this sentence matters.** It is the opening question of Convening 8, which assumes students arrive holding it.
...
**File.** `Homework/Convening_07_Homework.md`
...
| | |
|---|---|
| **Follows** | Convening 6 — Preserving Nulls And Deviations |
| **Leads to** | Convening 8 — Abandoned Registrations |

**Transition in.** Convening 6 established participants require preservation of unfavourable results. This convening uses that as the starting point.

**Transition out.** This convening establishes participants specify infrastructure making prespecification verifiable. Convening 8 assumes it and builds participants keep unfinished work discoverable.
