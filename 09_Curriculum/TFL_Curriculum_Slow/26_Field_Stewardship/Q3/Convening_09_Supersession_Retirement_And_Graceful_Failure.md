# Convening 9 — Supersession, Retirement, And Graceful Failure
...
| | |
|---|---|
| **Central question** | Supersession, Retirement, And Graceful Failure: participants specify how the programme concludes? |
| **Core concept** | A retirement policy governs the programme of examination rather than the framework or its author's work. |
| **Student outcome** | Participants specify how the programme concludes. |
| **Previous convening** | Convening 8 — Abandoned Registrations |
| **Next convening** | Convening 10 — The Charter Assembled |
| **Materials** | The full specification and its version history; instrument templates |
| **Preparation** | three hours |
| **Student printout** | `Printouts/Convening_09_Printout.md` |
| **Homework** | `Homework/Convening_09_Homework.md` |

## Why this lesson exists

**The conceptual step.** A retirement policy governs the programme of examination rather than the framework or its author's work. The scope limitation belongs in the first paragraph to prevent misreading.
...
**What depends on it.** Convening 10 — The Charter Assembled — opens by assuming this convening's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A retirement policy governs the programme of examination rather than the framework or its author's work. The scope limitation belongs in the first paragraph to prevent misreading.
...
1. A policy opening with an explicit scope limitation.
2. A policy distinguishing refutation from dormancy.

### One non-example

A policy that reads as authorising termination of the framework.
...
That retirement policies require scope limitation.

### What this activity does not establish

Whether retirement will occur.
...
| Statement | Status |
|---|---|
| A retirement policy governs the programme of examination rather than the framework or its author's work. | Framework-derived, appropriate at this grade |
| That retirement policies require scope limitation. | What this specific activity can show |
| Whether retirement will occur. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Convening 8 — Abandoned Registrations — specifically: participants keep unfinished work discoverable.

**How it was taught.** Through the activity: write the discoverability rule and test it against three abandonment scenarios

**Quick check.** Ask for the closing sentence of Convening 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Convening 8: write the discoverability rule and test it against three abandonment scenarios, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A policy opening with an explicit scope limitation. |
| **Non-example** | A policy that reads as authorising termination of the framework. |
...
**Student materials.** One copy of `Printouts/Convening_09_Printout.md` per student.

**Prior student data required.** Work produced in Convening 8, kept in the student's folder.
...
**File.** `Printouts/Convening_09_Printout.md`
...
> "Abandoned registrations are the most informative part of a registry."
...
**Exact wording.** "Say: you are writing this today because today nobody's career depends on the answer."
...
**Target observation.** That retirement policies require scope limitation.
...
> "A retirement policy governs the programme of examination rather than the framework or its author's work. You just saw that when say: you are writing this today because today nobody's career depends on the answer.
> Last time we said: Abandoned registrations are the most informative part of a registry. This is the next part of that.
...
**What students must not infer.** Whether retirement will occur.

### 4. Worked example

**The example.** A policy opening with an explicit scope limitation.
...
**Completed answer.** A policy opening with an explicit scope limitation. — which demonstrates that retirement policies require scope limitation.
...
**Conclusions not licensed.** Whether retirement will occur.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A policy distinguishing refutation from dormancy. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A policy that reads as authorising termination of the framework. Why is this not an
example?"
...
**Exact student instructions.** Draft the retirement policy opening with the scope limitation.
...
- *Licensed conclusion.* That retirement policies require scope limitation.
- *Not licensed.* Whether retirement will occur.
...
- *Expected response.* That retirement policies require scope limitation.
...
1. Any wording carrying the idea in `A retirement policy governs the programme of examination rather than the framework or its author's work`.
...
Say: "Refutation is a result. Drift is a loss."

**Why this sentence matters.** It is the opening question of Convening 10, which assumes students arrive holding it.
...
**File.** `Homework/Convening_09_Homework.md`
...
| | |
|---|---|
| **Follows** | Convening 8 — Abandoned Registrations |
| **Leads to** | Convening 10 — The Charter Assembled |

**Transition in.** Convening 8 established participants keep unfinished work discoverable. This convening uses that as the starting point.

**Transition out.** This convening establishes participants specify how the programme concludes. Convening 10 assumes it and builds participants assemble all five instruments into one charter.
