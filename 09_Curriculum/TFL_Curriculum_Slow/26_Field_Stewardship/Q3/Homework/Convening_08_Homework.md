# Convening 8 Homework — Abandoned Registrations

**Field Stewardship** · Governing The Examination · **Quarter 3**
**Follows:** Convening 8 — Abandoned Registrations · **Points:** 5 · **Optional:** yes
...
Write the sentence Convening 8 ended on, from memory:
...
Write the discoverability rule and test it against three abandonment scenarios.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every rule survives all three scenarios
...
Convening 9 is **Supersession, Retirement, And Graceful Failure**, which assumes you arrive holding it. Write one thing you expect it to be about:
