# Convening 8 — Abandoned Registrations

**Field Stewardship** · Governing The Examination · **Quarter 3** · **Full day**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Abandoned Registrations: participants keep unfinished work discoverable? |
| **Core concept** | Abandoned registrations are the most informative part of a registry because they reveal the gap between what was started and what was published. |
| **Student outcome** | Participants keep unfinished work discoverable. |
| **Previous convening** | Convening 7 — Registries And The Public Record |
| **Next convening** | Convening 9 — Supersession, Retirement, And Graceful Failure |
| **Materials** | The full specification and its version history; instrument templates |
| **Preparation** | three hours |
| **Student printout** | `Printouts/Convening_08_Printout.md` |
| **Homework** | `Homework/Convening_08_Homework.md` |

## Why this lesson exists

**The conceptual step.** Abandoned registrations are the most informative part of a registry because they reveal the gap between what was started and what was published. Removing them destroys that information.

**Why students need it now.** This grade owns one idea: instruments a body other than their author could adopt and operate.
This convening supplies one component of it. Without this component the student can
...
that governance means control of the framework. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Every instrument must be adoptable by a body that did not write it, tested by blind adoption rather than by reading.

**What depends on it.** Convening 9 — Supersession, Retirement, And Graceful Failure — opens by assuming this convening's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Abandoned registrations are the most informative part of a registry because they reveal the gap between what was started and what was published. Removing them destroys that information.

### How this is stated at this grade

Every instrument must be adoptable by a body that did not write it, tested by blind adoption rather than by reading.

Use only the vocabulary released at or before this grade. Terms not yet available:
Nothing is withheld. This is the terminal level.

### Why the concept matters

The whole grade rests on instruments a body other than their author could adopt and operate. If a student leaves this
convening without the component taught here, the remaining convenings in the quarter
will feel arbitrary, because each one assumes it.

### Two concrete examples

1. A rule keeping abandoned registrations permanently discoverable.
2. A rule tested against a registration abandoned after data collection.

### One non-example

A rule permitting removal of registrations never completed.
...
That abandoned registrations carry information.

### What this activity does not establish

Whether the rule would be adopted.
...
### Scope boundary for this convening
...
| Statement | Status |
|---|---|
| Abandoned registrations are the most informative part of a registry because they reveal the gap between what was started and what was published. | Framework-derived, appropriate at this grade |
| That abandoned registrations carry information. | What this specific activity can show |
| Whether the rule would be adopted. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Convening 7 — Registries And The Public Record — specifically: participants specify infrastructure making prespecification verifiable.

**How it was taught.** Through the activity: draft the specification including the operator succession plan

**Quick check.** Ask for the closing sentence of Convening 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Convening 7: draft the specification including the operator succession plan, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | which document governs when two disagree. |
| **Student wording** | Which document governs when two disagree. |
| **Correct example** | A rule keeping abandoned registrations permanently discoverable. |
| **Non-example** | A rule permitting removal of registrations never completed. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for which document governs when two disagree." |

### supersession

| | |
|---|---|
| **Teacher definition** | declaring a version superseded without deleting it. |
| **Student wording** | Declaring a version superseded without deleting it. |
| **Correct example** | A rule keeping abandoned registrations permanently discoverable. |
| **Non-example** | A rule permitting removal of registrations never completed. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for declaring a version superseded without deleting it." |

### consortium protocol

| | |
|---|---|
| **Teacher definition** | what is locked and what is adaptable across sites. |
| **Student wording** | What is locked and what is adaptable across sites. |
| **Correct example** | A rule keeping abandoned registrations permanently discoverable. |
| **Non-example** | A rule permitting removal of registrations never completed. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for what is locked and what is adaptable across sites." |


Do not introduce terminology from later grades. Nothing is withheld. This is the terminal level.

## Materials and preparation

**Teacher materials.** The full specification and its version history; Instrument templates; Manufactured dispute cases; Whiteboard.

**Student materials.** One copy of `Printouts/Convening_08_Printout.md` per student.

**Prior student data required.** Work produced in Convening 7, kept in the student's folder.
...
**File.** `Printouts/Convening_08_Printout.md`

**Distribute.** Before the hook. Students complete the *What I think before the
convening* section before any explanation is given.
...
> "A registry with no succession is a single point of failure holding the record."
...
**Decision rule.** If fewer than half the group can produce any version of it, spend five minutes on the recovery activity below before starting this convening.

### 2. Hook

**Exact wording.** "Say: if an abandoned registration is invisible, the registry measures enthusiasm."
...
**Target observation.** That abandoned registrations carry information.
...
> "Abandoned registrations are the most informative part of a registry because they reveal the gap between what was started and what was published. You just saw that when say: if an abandoned registration is invisible, the registry measures enthusiasm.
> Last time we said: A registry with no succession is a single point of failure holding the record. This is the next part of that.
> It matters because version drift, unpreserved nulls, and unreplicated findings have no responsible party by default"
...
**Terminology to introduce here.** version authority, supersession, consortium protocol.

**What students must not infer.** Whether the rule would be adopted.

### 4. Worked example

**The example.** A rule keeping abandoned registrations permanently discoverable.
...
**Completed answer.** A rule keeping abandoned registrations permanently discoverable. — which demonstrates that abandoned registrations carry information.
...
**Conclusions not licensed.** Whether the rule would be adopted.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A rule tested against a registration abandoned after data collection. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rule permitting removal of registrations never completed. Why is this not an
example?"
...
**Exact student instructions.** Write the discoverability rule and test it against three abandonment scenarios.
...
- *Licensed conclusion.* That abandoned registrations carry information.
- *Not licensed.* Whether the rule would be adopted.
...
- *Expected response.* That abandoned registrations carry information.
...
**Decision rule.** Continue to the next convening only if most students pass oral
...
3. **Misconception check.** Somebody says: "Governance means control of the framework" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `Abandoned registrations are the most informative part of a registry because they reveal the gap between what was started and what was published`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: This confers capability, not ownership.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "Abandoned registrations are the most informative part of a registry."

**Why this sentence matters.** It is the opening question of Convening 9, which assumes students arrive holding it.

**Open the next convening with.** "What did we say at the end last time?"
...
### 1. "Governance means control of the framework"

**What the student says or does.** Governance means control of the framework — usually while otherwise engaging well.

**Why it is understandable.** The instruments look like authority.
...
**Exact correction.** The body governs the examination, not the specification.

**Say this.** "This confers capability, not ownership."
...
### 2. "Superseding a version means removing it"

**What the student says or does.** Superseding a version means removing it — usually while otherwise engaging well.

**Why it is understandable.** Supersession sounds like replacement.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Erasing superseded versions destroys the citing literature's interpretability.

**Say this.** "Supersession is not deletion."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "Standardising implementation improves comparability"

**What the student says or does.** Standardising implementation improves comparability — usually while otherwise engaging well.

**Why it is understandable.** Uniformity looks like rigour.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** A protocol dictating local implementation will not be adopted.

**Say this.** "A protocol nobody runs produces nothing."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 4. "This convening proves the framework is right"
...
**Visual or physical support.** Provide one worked instrument with its blind-adoption test recorded.
...
Ask for the succession plan if the operating body dissolves in five years.
...
Specifically, do not introduce: Nothing is withheld. This is the terminal level.
...
- Whether the charter recommends proceeding
...
Mention them whenever the content of this convening touches either.

## Homework connection

**File.** `Homework/Convening_08_Homework.md`
...
**How to set it.** Optional. Set it if this is the pivot convening of the quarter,
...
7. What must be retaught before the next convening?
8. Is the next convening still appropriate, or does it need a bridging activity?

## Sequence

| | |
|---|---|
| **Follows** | Convening 7 — Registries And The Public Record |
| **Leads to** | Convening 9 — Supersession, Retirement, And Graceful Failure |

**Transition in.** Convening 7 established participants specify infrastructure making prespecification verifiable. This convening uses that as the starting point.

**Transition out.** This convening establishes participants keep unfinished work discoverable. Convening 9 assumes it and builds participants specify how the programme concludes.
