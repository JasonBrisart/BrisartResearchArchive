# Convening 10 — The Charter Assembled

**Field Stewardship** · Governing The Examination · **Quarter 4** · **Full day**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Charter Assembled: participants assemble all five instruments into one charter? |
| **Core concept** | A charter containing five instruments is assessed by whether another body could adopt and operate it. |
| **Student outcome** | Participants assemble all five instruments into one charter. |
| **Previous convening** | Convening 9 — Supersession, Retirement, And Graceful Failure |
| **Next convening** | Convening 11 — Blind Adoption |
| **Materials** | The full specification and its version history; instrument templates |
| **Preparation** | three hours |
| **Student printout** | `Printouts/Convening_10_Printout.md` |
| **Homework** | `Homework/Convening_10_Homework.md` |

## Why this lesson exists

**The conceptual step.** A charter containing five instruments is assessed by whether another body could adopt and operate it. A charter requiring its authors is a committee.
...
**What depends on it.** Convening 11 — Blind Adoption — opens by assuming this convening's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A charter containing five instruments is assessed by whether another body could adopt and operate it. A charter requiring its authors is a committee.
...
1. A charter with all five instruments present.
2. A charter self-audited against both gates before exchange.

### One non-example

A charter whose procedures require the drafting group to interpret them.
...
That charters are assessed by adoptability.

### What this activity does not establish

Whether the charter would be adopted.
...
| Statement | Status |
|---|---|
| A charter containing five instruments is assessed by whether another body could adopt and operate it. | Framework-derived, appropriate at this grade |
| That charters are assessed by adoptability. | What this specific activity can show |
| Whether the charter would be adopted. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Convening 9 — Supersession, Retirement, And Graceful Failure — specifically: participants specify how the programme concludes.

**How it was taught.** Through the activity: draft the retirement policy opening with the scope limitation

**Quick check.** Ask for the closing sentence of Convening 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Convening 9: draft the retirement policy opening with the scope limitation, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A charter with all five instruments present. |
| **Non-example** | A charter whose procedures require the drafting group to interpret them. |
...
**Student materials.** One copy of `Printouts/Convening_10_Printout.md` per student.

**Prior student data required.** Work produced in Convening 9, kept in the student's folder.
...
**File.** `Printouts/Convening_10_Printout.md`
...
> "Refutation is a result. Drift is a loss."
...
**Exact wording.** "Say: five instruments. Every one adoptable by a body that did not write it."
...
**Target observation.** That charters are assessed by adoptability.
...
> "A charter containing five instruments is assessed by whether another body could adopt and operate it. You just saw that when say: five instruments.
> Last time we said: Refutation is a result. Drift is a loss. This is the next part of that.
...
**What students must not infer.** Whether the charter would be adopted.

### 4. Worked example

**The example.** A charter with all five instruments present.
...
**Completed answer.** A charter with all five instruments present. — which demonstrates that charters are assessed by adoptability.
...
**Conclusions not licensed.** Whether the charter would be adopted.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A charter self-audited against both gates before exchange. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A charter whose procedures require the drafting group to interpret them. Why is this not an
example?"
...
**Exact student instructions.** Assemble the charter and self-audit against both gates.
...
- *Licensed conclusion.* That charters are assessed by adoptability.
- *Not licensed.* Whether the charter would be adopted.
...
- *Expected response.* That charters are assessed by adoptability.
...
1. Any wording carrying the idea in `A charter containing five instruments is assessed by whether another body could adopt and operate it`.
...
Say: "A charter that requires its authors is a committee, not a charter."

**Why this sentence matters.** It is the opening question of Convening 11, which assumes students arrive holding it.
...
**File.** `Homework/Convening_10_Homework.md`
...
| | |
|---|---|
| **Follows** | Convening 9 — Supersession, Retirement, And Graceful Failure |
| **Leads to** | Convening 11 — Blind Adoption |

**Transition in.** Convening 9 established participants specify how the programme concludes. This convening uses that as the starting point.

**Transition out.** This convening establishes participants assemble all five instruments into one charter. Convening 11 assumes it and builds participants test the charter by having another body operate it.
