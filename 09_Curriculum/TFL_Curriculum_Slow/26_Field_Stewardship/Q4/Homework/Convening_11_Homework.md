# Convening 11 Homework — Blind Adoption

**Field Stewardship** · Governing The Examination · **Quarter 4**
**Follows:** Convening 11 — Blind Adoption · **Points:** 5 · **Optional:** yes
...
Write the sentence Convening 11 ended on, from memory:
...
Five operations performed blind, with every failure reported back.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** both gates are passed by blind adoption
...
Convening 12 is **Charter Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
