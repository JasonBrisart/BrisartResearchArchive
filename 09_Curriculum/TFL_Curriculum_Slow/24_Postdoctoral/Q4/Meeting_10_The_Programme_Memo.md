...
| | |
|---|---|
| **Central question** | The Programme Memo: participants assemble the full recommendation? |
| **Core concept** | A programme memo may recommend against proceeding and still be complete. |
| **Student outcome** | Participants assemble the full recommendation. |
| **Previous meeting** | Meeting 9 — Costing The Programme |
| **Next meeting** | Meeting 11 — Rehearsing The Defence |
| **Materials** | The participant's dissertation and proposal; programme memo templates |
| **Preparation** | an hour |
| **Student printout** | `Printouts/Meeting_10_Printout.md` |
| **Homework** | `Homework/Meeting_10_Homework.md` |

## Why this lesson exists

**The conceptual step.** A programme memo may recommend against proceeding and still be complete. Recommending proceeding without stop conditions is recommending indefinite continuation.
...
**What depends on it.** Meeting 11 — Rehearsing The Defence — opens by assuming this meeting's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A programme memo may recommend against proceeding and still be complete. Recommending proceeding without stop conditions is recommending indefinite continuation.
...
1. A memo recommending against the programme with reasons.
2. A memo with stop conditions naming specific observations.

### One non-example

A memo recommending proceeding with no ending specified.
...
That memos may recommend either direction.
...
| Statement | Status |
|---|---|
| A programme memo may recommend against proceeding and still be complete. | Framework-derived, appropriate at this grade |
| That memos may recommend either direction. | What this specific activity can show |
| Whether the recommendation is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Meeting 9 — Costing The Programme — specifically: participants cost the programme honestly in people and years.

**How it was taught.** Through the activity: cost the programme in people-years and identify the most expensive failure mode

**Quick check.** Ask for the closing sentence of Meeting 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Meeting 9: cost the programme in people-years and identify the most expensive failure mode, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A memo recommending against the programme with reasons. |
| **Non-example** | A memo recommending proceeding with no ending specified. |
...
**Student materials.** One copy of `Printouts/Meeting_10_Printout.md` per student.

**Prior student data required.** Work produced in Meeting 9, kept in the student's folder.
...
**File.** `Printouts/Meeting_10_Printout.md`
...
> "The expensive failure is the one to structure against first."
...
**Exact wording.** "Say: recommendation, sequence, value under refutation, five fixes, stop conditions."
...
**Target observation.** That memos may recommend either direction.
...
> "A programme memo may recommend against proceeding and still be complete. You just saw that when say: recommendation, sequence, value under refutation, five fixes, stop conditions.
> Last time we said: The expensive failure is the one to structure against first. This is the next part of that.
...
**What students must not infer.** Whether the recommendation is correct.

### 4. Worked example

**The example.** A memo recommending against the programme with reasons.
...
**Completed answer.** A memo recommending against the programme with reasons. — which demonstrates that memos may recommend either direction.
...
**Conclusions not licensed.** Whether the recommendation is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A memo with stop conditions naming specific observations. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A memo recommending proceeding with no ending specified. Why is this not an
example?"
...
**Exact student instructions.** Assemble the memo and self-audit against the gate.
...
- *Licensed conclusion.* That memos may recommend either direction.
- *Not licensed.* Whether the recommendation is correct.
...
- *Expected response.* That memos may recommend either direction.
...
1. Any wording carrying the idea in `A programme memo may recommend against proceeding and still be complete`.
...
Say: "A memo recommending against a programme is a complete artifact."

**Why this sentence matters.** It is the opening question of Meeting 11, which assumes students arrive holding it.
...
**File.** `Homework/Meeting_10_Homework.md`
...
| | |
|---|---|
| **Follows** | Meeting 9 — Costing The Programme |
| **Leads to** | Meeting 11 — Rehearsing The Defence |

**Transition in.** Meeting 9 established participants cost the programme honestly in people and years. This meeting uses that as the starting point.

**Transition out.** This meeting establishes participants assemble the full recommendation. Meeting 11 assumes it and builds participants rehearse against three challengers.
