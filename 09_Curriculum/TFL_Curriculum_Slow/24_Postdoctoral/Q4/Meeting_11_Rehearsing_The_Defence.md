# Meeting 11 — Rehearsing The Defence

**Postdoctoral** · Programme Design · **Quarter 4** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Rehearsing The Defence: participants rehearse against three challengers? |
| **Core concept** | The early-career challenge asks what protects a junior researcher whose career depends on the programme. |
| **Student outcome** | Participants rehearse against three challengers. |
| **Previous meeting** | Meeting 10 — The Programme Memo |
| **Next meeting** | Meeting 12 — Memo Defence |
| **Materials** | The participant's dissertation and proposal; programme memo templates |
| **Preparation** | an hour |
| **Student printout** | `Printouts/Meeting_11_Printout.md` |
| **Homework** | `Homework/Meeting_11_Homework.md` |

## Why this lesson exists

**The conceptual step.** The early-career challenge asks what protects a junior researcher whose career depends on the programme. It is answered with a mechanism, not with an intention to be supportive.
...
**What depends on it.** Meeting 12 — Memo Defence — opens by assuming this meeting's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The early-career challenge asks what protects a junior researcher whose career depends on the programme. It is answered with a mechanism, not with an intention to be supportive.
...
1. A mechanism protecting a student if the framework is refuted.
2. A recorded list of three unanswered questions.

### One non-example

An answer stating the participant would support their students.
...
That protection requires mechanisms rather than intentions.
...
| Statement | Status |
|---|---|
| The early-career challenge asks what protects a junior researcher whose career depends on the programme. | Framework-derived, appropriate at this grade |
| That protection requires mechanisms rather than intentions. | What this specific activity can show |
| Whether the programme is warranted. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Meeting 10 — The Programme Memo — specifically: participants assemble the full recommendation.

**How it was taught.** Through the activity: assemble the memo and self-audit against the gate

**Quick check.** Ask for the closing sentence of Meeting 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Meeting 10: assemble the memo and self-audit against the gate, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A mechanism protecting a student if the framework is refuted. |
| **Non-example** | An answer stating the participant would support their students. |
...
**Student materials.** One copy of `Printouts/Meeting_11_Printout.md` per student.

**Prior student data required.** Work produced in Meeting 10, kept in the student's folder.
...
**File.** `Printouts/Meeting_11_Printout.md`
...
> "A memo recommending against a programme is a complete artifact."
...
**Exact wording.** "Assign three roles: the funder, the sceptic, and the early-career member."
...
**Target observation.** That protection requires mechanisms rather than intentions.
...
> "The early-career challenge asks what protects a junior researcher whose career depends on the programme. You just saw that when assign three roles: the funder, the sceptic, and the early-career member.
> Last time we said: A memo recommending against a programme is a complete artifact. This is the next part of that.
...
**The example.** A mechanism protecting a student if the framework is refuted.
...
**Completed answer.** A mechanism protecting a student if the framework is refuted. — which demonstrates that protection requires mechanisms rather than intentions.
...
**Teacher prompt.** "Here is a second case. A recorded list of three unanswered questions. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An answer stating the participant would support their students. Why is this not an
example?"
...
- *Licensed conclusion.* That protection requires mechanisms rather than intentions.
...
- *Expected response.* That protection requires mechanisms rather than intentions.
...
1. Any wording carrying the idea in `The early-career challenge asks what protects a junior researcher whose career depends on the programme`.
...
Say: "The early-career challenge is the hardest and the most important."

**Why this sentence matters.** It is the opening question of Meeting 12, which assumes students arrive holding it.
...
**File.** `Homework/Meeting_11_Homework.md`
...
| | |
|---|---|
| **Follows** | Meeting 10 — The Programme Memo |
| **Leads to** | Meeting 12 — Memo Defence |

**Transition in.** Meeting 10 established participants assemble the full recommendation. This meeting uses that as the starting point.

**Transition out.** This meeting establishes participants rehearse against three challengers. Meeting 12 assumes it and builds participants deliver and defend the recommendation.
