# Meeting 2 — Single-Point Dependency
...
| | |
|---|---|
| **Central question** | Single-Point Dependency: participants identify programmes one result would end? |
| **Core concept** | Single-point dependency means every project in a programme assumes the framework is correct. |
| **Student outcome** | Participants identify programmes one result would end. |
| **Previous meeting** | Meeting 1 — Programmes Fail Differently |
| **Next meeting** | Meeting 3 — Confirmation Drift |
| **Materials** | The participant's dissertation and proposal; programme memo templates |
| **Preparation** | an hour |
| **Student printout** | `Printouts/Meeting_02_Printout.md` |
| **Homework** | `Homework/Meeting_02_Homework.md` |

## Why this lesson exists

**The conceptual step.** Single-point dependency means every project in a programme assumes the framework is correct. One refutation ends the programme, and the structure rather than the result is at fault.
...
**What depends on it.** Meeting 3 — Confirmation Drift — opens by assuming this meeting's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Single-point dependency means every project in a programme assumes the framework is correct. One refutation ends the programme, and the structure rather than the result is at fault.
...
1. A study six that produces a measurement contribution under refutation.
2. A programme audited and repaired at every study.

### One non-example

A programme where only the first study is hedged.
...
That dependency can be audited and repaired structurally.

### What this activity does not establish

Whether refutation will occur.
...
| Statement | Status |
|---|---|
| Single-point dependency means every project in a programme assumes the framework is correct. | Framework-derived, appropriate at this grade |
| That dependency can be audited and repaired structurally. | What this specific activity can show |
| Whether refutation will occur. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Meeting 1 — Programmes Fail Differently — specifically: participants distinguish programme failure from study failure.

**How it was taught.** Through the activity: list candidate failure modes before being given the five

**Quick check.** Ask for the closing sentence of Meeting 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Meeting 1: list candidate failure modes before being given the five, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A study six that produces a measurement contribution under refutation. |
| **Non-example** | A programme where only the first study is hedged. |
...
**Student materials.** One copy of `Printouts/Meeting_02_Printout.md` per student.

**Prior student data required.** Work produced in Meeting 1, kept in the student's folder.
...
**File.** `Printouts/Meeting_02_Printout.md`
...
> "Structural failures need structural fixes."
...
**Exact wording.** "Say: every project assumes the framework is correct. One refutation ends it."
...
**Target observation.** That dependency can be audited and repaired structurally.
...
> "Single-point dependency means every project in a programme assumes the framework is correct. You just saw that when say: every project assumes the framework is correct.
> Last time we said: Structural failures need structural fixes. This is the next part of that.
...
**What students must not infer.** Whether refutation will occur.

### 4. Worked example

**The example.** A study six that produces a measurement contribution under refutation.
...
**Completed answer.** A study six that produces a measurement contribution under refutation. — which demonstrates that dependency can be audited and repaired structurally.
...
**Conclusions not licensed.** Whether refutation will occur.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A programme audited and repaired at every study. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A programme where only the first study is hedged. Why is this not an
example?"
...
**Exact student instructions.** Audit the draft programme for dependency and repair it throughout.
...
- *Licensed conclusion.* That dependency can be audited and repaired structurally.
- *Not licensed.* Whether refutation will occur.
...
- *Expected response.* That dependency can be audited and repaired structurally.
...
1. Any wording carrying the idea in `Single-point dependency means every project in a programme assumes the framework is correct`.
...
Say: "If one result ends everything, the structure failed, not the result."

**Why this sentence matters.** It is the opening question of Meeting 3, which assumes students arrive holding it.
...
**File.** `Homework/Meeting_02_Homework.md`
...
| | |
|---|---|
| **Follows** | Meeting 1 — Programmes Fail Differently |
| **Leads to** | Meeting 3 — Confirmation Drift |

**Transition in.** Meeting 1 established participants distinguish programme failure from study failure. This meeting uses that as the starting point.

**Transition out.** This meeting establishes participants identify programmes one result would end. Meeting 3 assumes it and builds participants build enforcement against progressively weaker designs.
