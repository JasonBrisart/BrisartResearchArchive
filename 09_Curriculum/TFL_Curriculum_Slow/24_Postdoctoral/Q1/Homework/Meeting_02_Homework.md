# Meeting 2 Homework — Single-Point Dependency

**Postdoctoral** · Programme Design · **Quarter 1**
**Follows:** Meeting 2 — Single-Point Dependency · **Points:** 5 · **Optional:** yes
...
Write the sentence Meeting 2 ended on, from memory:
...
Audit the draft programme for dependency and repair it throughout.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every study produces a publishable result under refutation
...
Meeting 3 is **Confirmation Drift**, which assumes you arrive holding it. Write one thing you expect it to be about:
