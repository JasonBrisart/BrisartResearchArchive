# Meeting 6 — Reputational Entanglement
...
| | |
|---|---|
| **Central question** | Reputational Entanglement: participants protect people from the programme's outcome? |
| **Core concept** | Reputational entanglement occurs when members' standing depends on the framework being correct. |
| **Student outcome** | Participants protect people from the programme's outcome. |
| **Previous meeting** | Meeting 5 — Specification Drift |
| **Next meeting** | Meeting 7 — Stop Conditions |
| **Materials** | The participant's dissertation and proposal; programme memo templates |
| **Preparation** | an hour |
| **Student printout** | `Printouts/Meeting_06_Printout.md` |
| **Homework** | `Homework/Meeting_06_Homework.md` |

## Why this lesson exists

**The conceptual step.** Reputational entanglement occurs when members' standing depends on the framework being correct. Portable competences and explicit credit for disconfirming results are the structural protections.
...
**What depends on it.** Meeting 7 — Stop Conditions — opens by assuming this meeting's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Reputational entanglement occurs when members' standing depends on the framework being correct. Portable competences and explicit credit for disconfirming results are the structural protections.
...
1. Measurement design named as a portable competence.
2. A credit mechanism rewarding a well-run disconfirming study.

### One non-example

Framework expertise listed as a transferable skill.
...
That entanglement can be structurally reduced.
...
| Statement | Status |
|---|---|
| Reputational entanglement occurs when members' standing depends on the framework being correct. | Framework-derived, appropriate at this grade |
| That entanglement can be structurally reduced. | What this specific activity can show |
| Whether the framework survives. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Meeting 5 — Specification Drift — specifically: participants install detection for quiet modification.

**How it was taught.** Through the activity: specify the change log, its maintainer, and its review interval

**Quick check.** Ask for the closing sentence of Meeting 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Meeting 5: specify the change log, its maintainer, and its review interval, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Measurement design named as a portable competence. |
| **Non-example** | Framework expertise listed as a transferable skill. |
...
**Student materials.** One copy of `Printouts/Meeting_06_Printout.md` per student.

**Prior student data required.** Work produced in Meeting 5, kept in the student's folder.
...
**File.** `Printouts/Meeting_06_Printout.md`
...
> "You will not notice drift. That is what makes it drift."
...
**Exact wording.** "Say: members' standing becomes tied to the framework being true."
...
**Target observation.** That entanglement can be structurally reduced.
...
> "Reputational entanglement occurs when members' standing depends on the framework being correct. You just saw that when say: members' standing becomes tied to the framework being true.
> Last time we said: You will not notice drift. That is what makes it drift. This is the next part of that.
...
**The example.** Measurement design named as a portable competence.
...
**Completed answer.** Measurement design named as a portable competence. — which demonstrates that entanglement can be structurally reduced.
...
**Teacher prompt.** "Here is a second case. A credit mechanism rewarding a well-run disconfirming study. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Framework expertise listed as a transferable skill. Why is this not an
example?"
...
**Exact student instructions.** List portable competences and specify how disconfirming results are credited.
...
- *Licensed conclusion.* That entanglement can be structurally reduced.
...
- *Expected response.* That entanglement can be structurally reduced.
...
1. Any wording carrying the idea in `Reputational entanglement occurs when members' standing depends on the framework being correct`.
...
Say: "If disconfirming results are quietly filed, nobody will produce one."

**Why this sentence matters.** It is the opening question of Meeting 7, which assumes students arrive holding it.
...
**File.** `Homework/Meeting_06_Homework.md`
...
| | |
|---|---|
| **Follows** | Meeting 5 — Specification Drift |
| **Leads to** | Meeting 7 — Stop Conditions |

**Transition in.** Meeting 5 established participants install detection for quiet modification. This meeting uses that as the starting point.

**Transition out.** This meeting establishes participants protect people from the programme's outcome. Meeting 7 assumes it and builds participants name the observations that would end the programme.
