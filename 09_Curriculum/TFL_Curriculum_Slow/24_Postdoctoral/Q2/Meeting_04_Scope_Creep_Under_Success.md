# Meeting 4 — Scope Creep Under Success
...
| | |
|---|---|
| **Central question** | Scope Creep Under Success: participants install boundary checks at project initiation? |
| **Core concept** | Apparent success invites out-of-scope application. |
| **Student outcome** | Participants install boundary checks at project initiation. |
| **Previous meeting** | Meeting 3 — Confirmation Drift |
| **Next meeting** | Meeting 5 — Specification Drift |
| **Materials** | The participant's dissertation and proposal; programme memo templates |
| **Preparation** | an hour |
| **Student printout** | `Printouts/Meeting_04_Printout.md` |
| **Homework** | `Homework/Meeting_04_Homework.md` |

## Why this lesson exists

**The conceptual step.** Apparent success invites out-of-scope application. A verbatim standing refusal written in advance does not soften under social pressure the way an improvised one does.
...
**What depends on it.** Meeting 5 — Specification Drift — opens by assuming this meeting's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Apparent success invites out-of-scope application. A verbatim standing refusal written in advance does not soften under social pressure the way an improvised one does.
...
1. A verbatim refusal for clinical extension proposals.
2. An initiation checkpoint that applies the refusal automatically.

### One non-example

A plan to assess scope proposals as they arise.
...
That scope enforcement requires prepared wording.

### What this activity does not establish

Whether scope creep will occur.
...
| Statement | Status |
|---|---|
| Apparent success invites out-of-scope application. | Framework-derived, appropriate at this grade |
| That scope enforcement requires prepared wording. | What this specific activity can show |
| Whether scope creep will occur. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Meeting 3 — Confirmation Drift — specifically: participants build enforcement against progressively weaker designs.

**How it was taught.** Through the activity: specify who enforces the discriminating-condition requirement and their authority

**Quick check.** Ask for the closing sentence of Meeting 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Meeting 3: specify who enforces the discriminating-condition requirement and their authority, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A verbatim refusal for clinical extension proposals. |
| **Non-example** | A plan to assess scope proposals as they arise. |
...
**Student materials.** One copy of `Printouts/Meeting_04_Printout.md` per student.

**Prior student data required.** Work produced in Meeting 3, kept in the student's folder.
...
**File.** `Printouts/Meeting_04_Printout.md`
...
> "An enforcer without authority to stop is a commenter."
...
**Exact wording.** "Say: apparent success invites application to identity, groups, and clinical populations."
...
**Target observation.** That scope enforcement requires prepared wording.
...
> "Apparent success invites out-of-scope application. You just saw that when say: apparent success invites application to identity, groups, and clinical populations.
> Last time we said: An enforcer without authority to stop is a commenter. This is the next part of that.
...
**What students must not infer.** Whether scope creep will occur.

### 4. Worked example

**The example.** A verbatim refusal for clinical extension proposals.
...
**Completed answer.** A verbatim refusal for clinical extension proposals. — which demonstrates that scope enforcement requires prepared wording.
...
**Conclusions not licensed.** Whether scope creep will occur.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An initiation checkpoint that applies the refusal automatically. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A plan to assess scope proposals as they arise. Why is this not an
example?"
...
**Exact student instructions.** Specify the initiation checkpoint and write the verbatim standing refusal.
...
- *Licensed conclusion.* That scope enforcement requires prepared wording.
- *Not licensed.* Whether scope creep will occur.
...
- *Expected response.* That scope enforcement requires prepared wording.
...
1. Any wording carrying the idea in `Apparent success invites out-of-scope application`.
...
Say: "Improvised refusals soften under pressure. Verbatim ones do not."

**Why this sentence matters.** It is the opening question of Meeting 5, which assumes students arrive holding it.
...
**File.** `Homework/Meeting_04_Homework.md`
...
| | |
|---|---|
| **Follows** | Meeting 3 — Confirmation Drift |
| **Leads to** | Meeting 5 — Specification Drift |

**Transition in.** Meeting 3 established participants build enforcement against progressively weaker designs. This meeting uses that as the starting point.

**Transition out.** This meeting establishes participants install boundary checks at project initiation. Meeting 5 assumes it and builds participants install detection for quiet modification.
