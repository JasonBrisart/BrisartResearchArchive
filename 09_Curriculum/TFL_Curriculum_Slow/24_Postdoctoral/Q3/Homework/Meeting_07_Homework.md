# Meeting 7 Homework — Stop Conditions

**Postdoctoral** · Programme Design · **Quarter 3**
**Follows:** Meeting 7 — Stop Conditions · **Points:** 5 · **Optional:** yes
...
Write the sentence Meeting 7 ended on, from memory:
...
Write stop conditions naming observations, each with a decision authority.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every stop condition names an observation, not a circumstance
...
Meeting 8 is **The Study Sequence**, which assumes you arrive holding it. Write one thing you expect it to be about:
