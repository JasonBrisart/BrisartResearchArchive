...
| | |
|---|---|
| **Central question** | Stop Conditions: participants name the observations that would end the programme? |
| **Core concept** | A stop condition names an observation that would end the programme, with a decision authority. |
| **Student outcome** | Participants name the observations that would end the programme. |
| **Previous meeting** | Meeting 6 — Reputational Entanglement |
| **Next meeting** | Meeting 8 — The Study Sequence |
| **Materials** | The participant's dissertation and proposal; programme memo templates |
| **Preparation** | an hour |
| **Student printout** | `Printouts/Meeting_07_Printout.md` |
| **Homework** | `Homework/Meeting_07_Homework.md` |

## Why this lesson exists

**The conceptual step.** A stop condition names an observation that would end the programme, with a decision authority. Funding and waning interest are circumstances rather than conditions.
...
**What depends on it.** Meeting 8 — The Study Sequence — opens by assuming this meeting's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A stop condition names an observation that would end the programme, with a decision authority. Funding and waning interest are circumstances rather than conditions.
...
1. A stop condition naming three consecutive failed adjudications.
2. A condition with a named decision authority attached.

### One non-example

A stop condition reading: if funding is not renewed.
...
That stop conditions name observations.

### What this activity does not establish

Whether the conditions will be met.
...
| Statement | Status |
|---|---|
| A stop condition names an observation that would end the programme, with a decision authority. | Framework-derived, appropriate at this grade |
| That stop conditions name observations. | What this specific activity can show |
| Whether the conditions will be met. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Meeting 6 — Reputational Entanglement — specifically: participants protect people from the programme's outcome.

**How it was taught.** Through the activity: list portable competences and specify how disconfirming results are credited

**Quick check.** Ask for the closing sentence of Meeting 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Meeting 6: list portable competences and specify how disconfirming results are credited, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A stop condition naming three consecutive failed adjudications. |
| **Non-example** | A stop condition reading: if funding is not renewed. |
...
**Student materials.** One copy of `Printouts/Meeting_07_Printout.md` per student.

**Prior student data required.** Work produced in Meeting 6, kept in the student's folder.
...
**File.** `Printouts/Meeting_07_Printout.md`
...
> "If disconfirming results are quietly filed, nobody will produce one."
...
**Exact wording.** "Ask what would end this programme. Most answers will name funding."
...
**Target observation.** That stop conditions name observations.
...
> "A stop condition names an observation that would end the programme, with a decision authority. You just saw that when ask what would end this programme.
> Last time we said: If disconfirming results are quietly filed, nobody will produce one. This is the next part of that.
...
**What students must not infer.** Whether the conditions will be met.

### 4. Worked example

**The example.** A stop condition naming three consecutive failed adjudications.
...
**Completed answer.** A stop condition naming three consecutive failed adjudications. — which demonstrates that stop conditions name observations.
...
**Conclusions not licensed.** Whether the conditions will be met.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A condition with a named decision authority attached. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A stop condition reading: if funding is not renewed. Why is this not an
example?"
...
**Exact student instructions.** Write stop conditions naming observations, each with a decision authority.
...
- *Licensed conclusion.* That stop conditions name observations.
- *Not licensed.* Whether the conditions will be met.
...
- *Expected response.* That stop conditions name observations.
...
1. Any wording carrying the idea in `A stop condition names an observation that would end the programme, with a decision authority`.
...
Say: "Without them, continuing is not a decision you are making."

**Why this sentence matters.** It is the opening question of Meeting 8, which assumes students arrive holding it.
...
**File.** `Homework/Meeting_07_Homework.md`
...
| | |
|---|---|
| **Follows** | Meeting 6 — Reputational Entanglement |
| **Leads to** | Meeting 8 — The Study Sequence |

**Transition in.** Meeting 6 established participants protect people from the programme's outcome. This meeting uses that as the starting point.

**Transition out.** This meeting establishes participants name the observations that would end the programme. Meeting 8 assumes it and builds participants order the programme's studies with dependencies stated.
