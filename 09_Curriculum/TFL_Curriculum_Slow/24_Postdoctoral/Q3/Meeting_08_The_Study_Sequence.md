...
| | |
|---|---|
| **Central question** | The Study Sequence: participants order the programme's studies with dependencies stated? |
| **Core concept** | A study sequence states dependencies and gives each study its own falsification condition. |
| **Student outcome** | Participants order the programme's studies with dependencies stated. |
| **Previous meeting** | Meeting 7 — Stop Conditions |
| **Next meeting** | Meeting 9 — Costing The Programme |
| **Materials** | The participant's dissertation and proposal; programme memo templates |
| **Preparation** | an hour |
| **Student printout** | `Printouts/Meeting_08_Printout.md` |
| **Homework** | `Homework/Meeting_08_Homework.md` |

## Why this lesson exists

**The conceptual step.** A study sequence states dependencies and gives each study its own falsification condition. A single programme-level condition leaves individual studies untestable.
...
**What depends on it.** Meeting 9 — Costing The Programme — opens by assuming this meeting's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A study sequence states dependencies and gives each study its own falsification condition. A single programme-level condition leaves individual studies untestable.
...
1. A sequence with eight per-study falsification conditions.
2. A dependency map showing which studies are contingent.

### One non-example

A programme with one overall falsification condition.
...
That sequences require per-study conditions.

### What this activity does not establish

Whether the sequence is optimal.
...
| Statement | Status |
|---|---|
| A study sequence states dependencies and gives each study its own falsification condition. | Framework-derived, appropriate at this grade |
| That sequences require per-study conditions. | What this specific activity can show |
| Whether the sequence is optimal. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Meeting 7 — Stop Conditions — specifically: participants name the observations that would end the programme.

**How it was taught.** Through the activity: write stop conditions naming observations, each with a decision authority

**Quick check.** Ask for the closing sentence of Meeting 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Meeting 7: write stop conditions naming observations, each with a decision authority, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A sequence with eight per-study falsification conditions. |
| **Non-example** | A programme with one overall falsification condition. |
...
**Student materials.** One copy of `Printouts/Meeting_08_Printout.md` per student.

**Prior student data required.** Work produced in Meeting 7, kept in the student's folder.
...
**File.** `Printouts/Meeting_08_Printout.md`
...
> "Without them, continuing is not a decision you are making."
...
**Exact wording.** "Ask which of eight studies depend on which, and what happens if one fails."
...
**Target observation.** That sequences require per-study conditions.
...
> "A study sequence states dependencies and gives each study its own falsification condition. You just saw that when ask which of eight studies depend on which, and what happens if one fails.
> Last time we said: Without them, continuing is not a decision you are making. This is the next part of that.
...
**What students must not infer.** Whether the sequence is optimal.

### 4. Worked example

**The example.** A sequence with eight per-study falsification conditions.
...
**Completed answer.** A sequence with eight per-study falsification conditions. — which demonstrates that sequences require per-study conditions.
...
**Conclusions not licensed.** Whether the sequence is optimal.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A dependency map showing which studies are contingent. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A programme with one overall falsification condition. Why is this not an
example?"
...
**Exact student instructions.** Draft the sequence with dependencies and per-study falsification conditions.
...
- *Licensed conclusion.* That sequences require per-study conditions.
- *Not licensed.* Whether the sequence is optimal.
...
- *Expected response.* That sequences require per-study conditions.
...
1. Any wording carrying the idea in `A study sequence states dependencies and gives each study its own falsification condition`.
...
Say: "A sequence with no per-study conditions is a wish list."

**Why this sentence matters.** It is the opening question of Meeting 9, which assumes students arrive holding it.
...
**File.** `Homework/Meeting_08_Homework.md`
...
| | |
|---|---|
| **Follows** | Meeting 7 — Stop Conditions |
| **Leads to** | Meeting 9 — Costing The Programme |

**Transition in.** Meeting 7 established participants name the observations that would end the programme. This meeting uses that as the starting point.

**Transition out.** This meeting establishes participants order the programme's studies with dependencies stated. Meeting 9 assumes it and builds participants cost the programme honestly in people and years.
