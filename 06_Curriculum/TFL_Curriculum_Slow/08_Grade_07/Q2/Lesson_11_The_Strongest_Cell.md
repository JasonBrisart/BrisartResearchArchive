...
| | |
|---|---|
| **Central question** | The Strongest Cell: students examine the inaccurate-and-persisted cell? |
| **Core concept** | The inaccurate-and-persisted cell is the one that defeats the intuition that strong feelings indicate correctness. |
| **Student outcome** | Students examine the inaccurate-and-persisted cell. |
| **Previous lesson** | Lesson 10 — The Four Box Study |
| **Next lesson** | Lesson 12 — The Other Diagonal |
...
**The conceptual step.** The inaccurate-and-persisted cell is the one that defeats the intuition that strong feelings indicate correctness. Its size in the class data is the argument.
...
**What depends on it.** Lesson 12 — The Other Diagonal — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The inaccurate-and-persisted cell is the one that defeats the intuition that strong feelings indicate correctness. Its size in the class data is the argument.
...
1. An entry that was wrong, rated high intensity, and persisted for days.
2. A pooled count showing this cell is not rare.

### One non-example

Dismissing the cell as containing a few odd cases.
...
That inaccurate predictions can persist strongly.
...
| Statement | Status |
|---|---|
| The inaccurate-and-persisted cell is the one that defeats the intuition that strong feelings indicate correctness. | Framework-derived, appropriate at this grade |
| That inaccurate predictions can persist strongly. | What this specific activity can show |
| Why they persist. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 10 — The Four Box Study — specifically: students test the independence claim on their own prospective data.

**How it was taught.** Through the activity: sort at least eight logged predictions into the matrix and answer three questions

**Quick check.** Ask for the closing sentence of Lesson 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 10: sort at least eight logged predictions into the matrix and answer three questions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An entry that was wrong, rated high intensity, and persisted for days. |
| **Non-example** | Dismissing the cell as containing a few odd cases. |
...
> "Being right does not make it stick. Mattering does."
...
**Exact wording.** "Point at the pooled class numbers in that cell and say this box is the whole argument."
...
**Target observation.** That inaccurate predictions can persist strongly.
...
> "The inaccurate-and-persisted cell is the one that defeats the intuition that strong feelings indicate correctness. You just saw that when point at the pooled class numbers in that cell and say this box is the whole argument.
> Last time we said: Being right does not make it stick. Mattering does. This is the next part of that.
...
**What students must not infer.** Why they persist.

### 4. Worked example

**The example.** An entry that was wrong, rated high intensity, and persisted for days.
...
**Completed answer.** An entry that was wrong, rated high intensity, and persisted for days. — which demonstrates that inaccurate predictions can persist strongly.
...
**Conclusions not licensed.** Why they persist.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A pooled count showing this cell is not rare. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Dismissing the cell as containing a few odd cases. Why is this not an
example?"
...
**Exact student instructions.** Write a paragraph on their own inaccurate-persisted entries with the E(t) rating of each.
...
- *Licensed conclusion.* That inaccurate predictions can persist strongly.
- *Not licensed.* Why they persist.
...
- *Expected response.* That inaccurate predictions can persist strongly.
...
1. Any wording carrying the idea in `The inaccurate-and-persisted cell is the one that defeats the intuition that strong feelings indicate correctness`.
...
Say: "Wrong and stuck. That is why the distinction matters."
...
| | |
|---|---|
| **Follows** | Lesson 10 — The Four Box Study |
| **Leads to** | Lesson 12 — The Other Diagonal |

**Transition in.** Lesson 10 established students test the independence claim on their own prospective data. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students examine the inaccurate-and-persisted cell. Lesson 12 assumes it and builds students examine the accurate-and-faded cell.
