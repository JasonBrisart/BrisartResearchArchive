# Lesson 13 Homework — Pooling The Class

**Grade 7** · Persistence Is Not Accuracy · **Quarter 2**
**Follows:** Lesson 13 — Pooling The Class · **Points:** 5 · **Optional:** yes
...
Build the pooled class matrix and compute the proportion in each cell.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class has a pooled matrix with all four cells populated
...
Lesson 14 is **What Would Have Changed My Mind**, which assumes you arrive holding it. Write one thing you expect it to be about:
