# Lesson 15 — Intensity Is Not Confidence
...
| | |
|---|---|
| **Central question** | Intensity Is Not Confidence: students separate how much it mattered from how sure they were? |
| **Core concept** | Intensity is how much it mattered; confidence is how sure you were. |
| **Student outcome** | Students separate how much it mattered from how sure they were. |
| **Previous lesson** | Lesson 14 — What Would Have Changed My Mind |
| **Next lesson** | Lesson 16 — The Distinction Review |
| **Materials** | Printed prediction logs; notebooks |
| **Preparation** | fifteen minutes |
| **Student printout** | `Printouts/Lesson_15_Printout.md` |
| **Homework** | `Homework/Lesson_15_Homework.md` |

## Why this lesson exists

**The conceptual step.** Intensity is how much it mattered; confidence is how sure you were. They often diverge, and the framework uses intensity rather than confidence.
...
**What depends on it.** Lesson 16 — The Distinction Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Intensity is how much it mattered; confidence is how sure you were. They often diverge, and the framework uses intensity rather than confidence.
...
1. An entry rated high intensity and low confidence.
2. An entry rated low intensity and high confidence.

### One non-example

Ten entries where both scales received identical ratings.
...
That intensity and confidence are separately rateable.

### What this activity does not establish

Which one predicts persistence better.
...
| Statement | Status |
|---|---|
| Intensity is how much it mattered; confidence is how sure you were. | Framework-derived, appropriate at this grade |
| That intensity and confidence are separately rateable. | What this specific activity can show |
| Which one predicts persistence better. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — What Would Have Changed My Mind — specifically: students state in advance what result would count against the claim.

**How it was taught.** Through the activity: for three claims, write what result would have counted against each

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: for three claims, write what result would have counted against each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An entry rated high intensity and low confidence. |
| **Non-example** | Ten entries where both scales received identical ratings. |
...
**Student materials.** One copy of `Printouts/Lesson_15_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 14, kept in the student's folder.
...
**File.** `Printouts/Lesson_15_Printout.md`
...
> "Say what would change your mind before you say what you found."
...
**Exact wording.** "Ask whether something can matter a lot while they are not sure about it."
...
**Target observation.** That intensity and confidence are separately rateable.
...
> "Intensity is how much it mattered; confidence is how sure you were. You just saw that when ask whether something can matter a lot while they are not sure about it.
> Last time we said: Say what would change your mind before you say what you found. This is the next part of that.
...
**What students must not infer.** Which one predicts persistence better.

### 4. Worked example

**The example.** An entry rated high intensity and low confidence.
...
**Completed answer.** An entry rated high intensity and low confidence. — which demonstrates that intensity and confidence are separately rateable.
...
**Conclusions not licensed.** Which one predicts persistence better.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An entry rated low intensity and high confidence. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Ten entries where both scales received identical ratings. Why is this not an
example?"
...
**Exact student instructions.** Re-rate ten log entries on both scales and compare the two columns.
...
- *Licensed conclusion.* That intensity and confidence are separately rateable.
- *Not licensed.* Which one predicts persistence better.
...
- *Expected response.* That intensity and confidence are separately rateable.
...
1. Any wording carrying the idea in `Intensity is how much it mattered; confidence is how sure you were`.
...
Say: "Two different things. The model uses one of them."

**Why this sentence matters.** It is the opening question of Lesson 16, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_15_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 14 — What Would Have Changed My Mind |
| **Leads to** | Lesson 16 — The Distinction Review |

**Transition in.** Lesson 14 established students state in advance what result would count against the claim. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students separate how much it mattered from how sure they were. Lesson 16 assumes it and builds students consolidate the central distinction.
