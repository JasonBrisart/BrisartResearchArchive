...
**Grade 7** · Persistence Is Not Accuracy
...
|---|---|---|---|---|---|---|
| `Lesson_17_Printout.md` | Lesson 17 — Contradiction Mechanics | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_18_Printout.md` | Lesson 18 — Counting The Breaks | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 17 work |
| `Lesson_19_Printout.md` | Lesson 19 — When My Data Disagrees | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 18 work |
| `Lesson_20_Printout.md` | Lesson 20 — Persistence Is Mechanical | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 19 work |
| `Lesson_21_Printout.md` | Lesson 21 — Closing The Log | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 20 work |
| `Lesson_22_Printout.md` | Lesson 22 — Presenting Your Data | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 21 work |
| `Lesson_23_Printout.md` | Lesson 23 — Is That What This Is For | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 22 work |
| `Lesson_24_Printout.md` | Lesson 24 — The Mechanism Review | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 23 work |
...
**Lesson 21 — Closing The Log.** If you only have time to print one
