# Lesson 19 — When My Data Disagrees
...
| | |
|---|---|
| **Central question** | When My Data Disagrees: students report honestly a result that does not fit? |
| **Core concept** | An entry the framework does not predict well is reported as it stands. |
| **Student outcome** | Students report honestly a result that does not fit. |
| **Previous lesson** | Lesson 18 — Counting The Breaks |
| **Next lesson** | Lesson 20 — Persistence Is Mechanical |
...
**The conceptual step.** An entry the framework does not predict well is reported as it stands. Inventing a reason to exclude it is the error, and the temptation is strongest when the data is otherwise tidy.
...
**What depends on it.** Lesson 20 — Persistence Is Mechanical — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An entry the framework does not predict well is reported as it stands. Inventing a reason to exclude it is the error, and the temptation is strongest when the data is otherwise tidy.
...
1. A high-intensity entry that did not persist.
2. A low-intensity entry that persisted for a week.

### One non-example

An entry dismissed because the student was tired that day.
...
That awkward entries are reported rather than excluded.
...
| Statement | Status |
|---|---|
| An entry the framework does not predict well is reported as it stands. | Framework-derived, appropriate at this grade |
| That awkward entries are reported rather than excluded. | What this specific activity can show |
| Why the entry does not fit. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — Counting The Breaks — specifically: students measure how many contradictions produce durable change.

**How it was taught.** Through the activity: a three-break trial in pairs with class numbers pooled and compared to predictions

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: a three-break trial in pairs with class numbers pooled and compared to predictions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A high-intensity entry that did not persist. |
| **Non-example** | An entry dismissed because the student was tired that day. |
...
**Exact wording.** "Ask who has a log entry the framework does not predict well, and to read it out."
...
**Target observation.** That awkward entries are reported rather than excluded.
...
> "An entry the framework does not predict well is reported as it stands. You just saw that when ask who has a log entry the framework does not predict well, and to read it out.
...
**What students must not infer.** Why the entry does not fit.

### 4. Worked example

**The example.** A high-intensity entry that did not persist.
...
**Completed answer.** A high-intensity entry that did not persist. — which demonstrates that awkward entries are reported rather than excluded.
...
**Conclusions not licensed.** Why the entry does not fit.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A low-intensity entry that persisted for a week. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An entry dismissed because the student was tired that day. Why is this not an
example?"
...
**Exact student instructions.** Identify and describe one poorly fitting entry without explaining it away.
...
- *Licensed conclusion.* That awkward entries are reported rather than excluded.
- *Not licensed.* Why the entry does not fit.
...
- *Expected response.* That awkward entries are reported rather than excluded.
...
1. Any wording carrying the idea in `An entry the framework does not predict well is reported as it stands`.
...
Say: "Reporting the awkward case is the job."
...
| | |
|---|---|
| **Follows** | Lesson 18 — Counting The Breaks |
| **Leads to** | Lesson 20 — Persistence Is Mechanical |

**Transition in.** Lesson 18 established students measure how many contradictions produce durable change. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students report honestly a result that does not fit. Lesson 20 assumes it and builds students keep persistence low-stakes and non-clinical.
