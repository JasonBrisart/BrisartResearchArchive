# Lesson 22 — Presenting Your Data
...
| | |
|---|---|
| **Central question** | Presenting Your Data: students present their own four-box result to the class? |
| **Core concept** | A presentation of a result is incomplete without stating what would have counted against it. |
| **Student outcome** | Students present their own four-box result to the class. |
| **Previous lesson** | Lesson 21 — Closing The Log |
| **Next lesson** | Lesson 23 — Is That What This Is For |
...
**The conceptual step.** A presentation of a result is incomplete without stating what would have counted against it. Asking for it publicly makes the requirement real.
...
**What depends on it.** Lesson 23 — Is That What This Is For — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A presentation of a result is incomplete without stating what would have counted against it. Asking for it publicly makes the requirement real.
...
1. A presentation including the disconfirming condition.
2. A student asked for the disconfirmer and supplying it.

### One non-example

A presentation of the matrix and finding only.
...
That results are presented with their disconfirmers.
...
| Statement | Status |
|---|---|
| A presentation of a result is incomplete without stating what would have counted against it. | Framework-derived, appropriate at this grade |
| That results are presented with their disconfirmers. | What this specific activity can show |
| Whether the finding is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 21 — Closing The Log — specifically: students complete and total their prediction log.

**How it was taught.** Through the activity: final log audit, totals computed, and the four-box matrix rebuilt on the full set

**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: final log audit, totals computed, and the four-box matrix rebuilt on the full set, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A presentation including the disconfirming condition. |
| **Non-example** | A presentation of the matrix and finding only. |
...
> "That is a real dataset that you collected properly."
...
**Exact wording.** "Say: three minutes each. Your data, what it shows, and what would have counted against it."
...
**Target observation.** That results are presented with their disconfirmers.
...
> "A presentation of a result is incomplete without stating what would have counted against it. You just saw that when say: three minutes each.
> Last time we said: That is a real dataset that you collected properly. This is the next part of that.
...
**What students must not infer.** Whether the finding is correct.

### 4. Worked example

**The example.** A presentation including the disconfirming condition.
...
**Completed answer.** A presentation including the disconfirming condition. — which demonstrates that results are presented with their disconfirmers.
...
**Conclusions not licensed.** Whether the finding is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student asked for the disconfirmer and supplying it. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A presentation of the matrix and finding only. Why is this not an
example?"
...
**Exact student instructions.** A three-minute presentation with the matrix, the finding, and the disconfirmer.
...
- *Licensed conclusion.* That results are presented with their disconfirmers.
- *Not licensed.* Whether the finding is correct.
...
- *Expected response.* That results are presented with their disconfirmers.
...
1. Any wording carrying the idea in `A presentation of a result is incomplete without stating what would have counted against it`.
...
Say: "Saying it aloud is different from writing it."
...
| | |
|---|---|
| **Follows** | Lesson 21 — Closing The Log |
| **Leads to** | Lesson 23 — Is That What This Is For |

**Transition in.** Lesson 21 established students complete and total their prediction log. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students present their own four-box result to the class. Lesson 23 assumes it and builds students reject applications outside the model's scope.
