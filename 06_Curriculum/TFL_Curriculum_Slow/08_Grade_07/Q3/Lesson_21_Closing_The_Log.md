...
| | |
|---|---|
| **Central question** | Closing The Log: students complete and total their prediction log? |
| **Core concept** | The closed log is a dataset the student collected themselves under stated rules. |
| **Student outcome** | Students complete and total their prediction log. |
| **Previous lesson** | Lesson 20 — Persistence Is Mechanical |
| **Next lesson** | Lesson 22 — Presenting Your Data |
...
**The conceptual step.** The closed log is a dataset the student collected themselves under stated rules. Rebuilding the matrix on the full set is more reliable than the mid-year version.
...
**What depends on it.** Lesson 22 — Presenting Your Data — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The closed log is a dataset the student collected themselves under stated rules. Rebuilding the matrix on the full set is more reliable than the mid-year version.
...
1. A closed log with twenty-two entries, sixteen surviving audit.
2. A rebuilt matrix with all four cells populated.

### One non-example

A log closed with six entries, discovered too late.
...
That a student-collected dataset can be assembled properly.

### What this activity does not establish

Whether the dataset supports general claims.
...
| Statement | Status |
|---|---|
| The closed log is a dataset the student collected themselves under stated rules. | Framework-derived, appropriate at this grade |
| That a student-collected dataset can be assembled properly. | What this specific activity can show |
| Whether the dataset supports general claims. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — Persistence Is Mechanical — specifically: students keep persistence low-stakes and non-clinical.

**How it was taught.** Through the activity: rewrite four persistence examples so every one is mechanical and low-stakes

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: rewrite four persistence examples so every one is mechanical and low-stakes, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A closed log with twenty-two entries, sixteen surviving audit. |
| **Non-example** | A log closed with six entries, discovered too late. |
...
> "Persistence just means it carried into the next cycle."
...
**Exact wording.** "Say: twenty weeks. Close it and count what you have."
...
**Target observation.** That a student-collected dataset can be assembled properly.
...
> "The closed log is a dataset the student collected themselves under stated rules. You just saw that when say: twenty weeks.
> Last time we said: Persistence just means it carried into the next cycle. This is the next part of that.
...
**What students must not infer.** Whether the dataset supports general claims.

### 4. Worked example

**The example.** A closed log with twenty-two entries, sixteen surviving audit.
...
**Completed answer.** A closed log with twenty-two entries, sixteen surviving audit. — which demonstrates that a student-collected dataset can be assembled properly.
...
**Conclusions not licensed.** Whether the dataset supports general claims.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A rebuilt matrix with all four cells populated. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A log closed with six entries, discovered too late. Why is this not an
example?"
...
**Exact student instructions.** Final log audit, totals computed, and the four-box matrix rebuilt on the full set.
...
- *Licensed conclusion.* That a student-collected dataset can be assembled properly.
- *Not licensed.* Whether the dataset supports general claims.
...
- *Expected response.* That a student-collected dataset can be assembled properly.
...
1. Any wording carrying the idea in `The closed log is a dataset the student collected themselves under stated rules`.
...
Say: "That is a real dataset that you collected properly."
...
| | |
|---|---|
| **Follows** | Lesson 20 — Persistence Is Mechanical |
| **Leads to** | Lesson 22 — Presenting Your Data |

**Transition in.** Lesson 20 established students keep persistence low-stakes and non-clinical. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students complete and total their prediction log. Lesson 22 assumes it and builds students present their own four-box result to the class.
