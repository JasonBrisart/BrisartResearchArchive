...
| | |
|---|---|
| **Central question** | Below The Threshold: students name the three outcomes when intensity fails to clear the bar? |
| **Core concept** | Below threshold a simulation may decay, be replaced by an alternative, or be suppressed. |
| **Student outcome** | Students name the three outcomes when intensity fails to clear the bar. |
| **Previous lesson** | Lesson 3 — Which Way The Threshold Goes |
| **Next lesson** | Lesson 5 — Logging Properly |
...
**The conceptual step.** Below threshold a simulation may decay, be replaced by an alternative, or be suppressed. Collapsing these into forgotten loses the distinction between three different observable outcomes.
...
**What depends on it.** Lesson 5 — Logging Properly — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Below threshold a simulation may decay, be replaced by an alternative, or be suppressed. Collapsing these into forgotten loses the distinction between three different observable outcomes.
...
1. A simulation that decayed with nothing replacing it.
2. A simulation replaced by a different expectation.

### One non-example

A simulation described as having vanished entirely.
...
That below-threshold has three distinguishable outcomes.

### What this activity does not establish

Which outcome occurs most often.
...
| Statement | Status |
|---|---|
| Below threshold a simulation may decay, be replaced by an alternative, or be suppressed. | Framework-derived, appropriate at this grade |
| That below-threshold has three distinguishable outcomes. | What this specific activity can show |
| Which outcome occurs most often. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — Which Way The Threshold Goes — specifically: students reason correctly about threshold direction.

**How it was taught.** Through the activity: complete a six-row parameter table predicting the effect of each change

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: complete a six-row parameter table predicting the effect of each change, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A simulation that decayed with nothing replacing it. |
| **Non-example** | A simulation described as having vanished entirely. |
...
> "Two minutes here prevents six years of a predictable error."
...
**Exact wording.** "Ask what happens to a simulation that does not clear it, and whether it just vanishes."
...
**Target observation.** That below-threshold has three distinguishable outcomes.
...
> "Below threshold a simulation may decay, be replaced by an alternative, or be suppressed. You just saw that when ask what happens to a simulation that does not clear it, and whether it just vanishes.
> Last time we said: Two minutes here prevents six years of a predictable error. This is the next part of that.
...
**What students must not infer.** Which outcome occurs most often.

### 4. Worked example

**The example.** A simulation that decayed with nothing replacing it.
...
**Completed answer.** A simulation that decayed with nothing replacing it. — which demonstrates that below-threshold has three distinguishable outcomes.
...
**Conclusions not licensed.** Which outcome occurs most often.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A simulation replaced by a different expectation. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A simulation described as having vanished entirely. Why is this not an
example?"
...
**Exact student instructions.** Classify eight described cases into the three outcomes with justifications.
...
- *Licensed conclusion.* That below-threshold has three distinguishable outcomes.
- *Not licensed.* Which outcome occurs most often.
...
- *Expected response.* That below-threshold has three distinguishable outcomes.
...
1. Any wording carrying the idea in `Below threshold a simulation may decay, be replaced by an alternative, or be suppressed`.
...
Say: "Three things happen, and vanishing is not one."
...
| | |
|---|---|
| **Follows** | Lesson 3 — Which Way The Threshold Goes |
| **Leads to** | Lesson 5 — Logging Properly |

**Transition in.** Lesson 3 established students reason correctly about threshold direction. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students name the three outcomes when intensity fails to clear the bar. Lesson 5 assumes it and builds students improve their log entries against the four rules.
