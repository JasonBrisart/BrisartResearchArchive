...
|---|---|---|---|---|---|---|
| `Lesson_01_Printout.md` | Lesson 1 — Starting The Log | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_02_Printout.md` | Lesson 2 — The Persistence Condition | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 1 work |
| `Lesson_03_Printout.md` | Lesson 3 — Which Way The Threshold Goes | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 2 work |
| `Lesson_04_Printout.md` | Lesson 4 — Below The Threshold | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 3 work |
| `Lesson_05_Printout.md` | Lesson 5 — Logging Properly | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 4 work |
| `Lesson_06_Printout.md` | Lesson 6 — Intensity At The Time | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 5 work |
| `Lesson_07_Printout.md` | Lesson 7 — What Makes A Good Entry | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 6 work |
| `Lesson_08_Printout.md` | Lesson 8 — The Log Review | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 7 work |
...
**Lesson 5 — Logging Properly.** If you only have time to print one
