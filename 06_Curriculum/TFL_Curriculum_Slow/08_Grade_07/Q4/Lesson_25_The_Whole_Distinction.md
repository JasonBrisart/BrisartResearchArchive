# Lesson 25 — The Whole Distinction

**Grade 7** · Persistence Is Not Accuracy · **Quarter 4** · **45 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Whole Distinction: students present a data-backed argument for the central claim? |
| **Core concept** | A complete argument includes the claim, the personal data, the pooled data, the disconfirming condition, and the poorly fitting case. |
| **Student outcome** | Students present a data-backed argument for the central claim. |
| **Previous lesson** | Lesson 24 — The Mechanism Review |
| **Next lesson** | Lesson 26 — Defending The Argument |
| **Materials** | Printed prediction logs; notebooks |
| **Preparation** | fifteen minutes |
| **Student printout** | `Printouts/Lesson_25_Printout.md` |
| **Homework** | `Homework/Lesson_25_Homework.md` |

## Why this lesson exists

**The conceptual step.** A complete argument includes the claim, the personal data, the pooled data, the disconfirming condition, and the poorly fitting case. Omitting the last makes it weaker, not stronger.

**Why students need it now.** This grade owns one idea: the central distinction of the entire curriculum, tested on the student's own data.
...
that if I felt strongly about it, I was probably right. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Comparative analysis with collected data. A student states what would change their mind before presenting a conclusion.

**What depends on it.** Lesson 26 — Defending The Argument — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A complete argument includes the claim, the personal data, the pooled data, the disconfirming condition, and the poorly fitting case. Omitting the last makes it weaker, not stronger.

### How this is stated at this grade

Comparative analysis with collected data. A student states what would change their mind before presenting a conclusion.

Use only the vocabulary released at or before this grade. Terms not yet available:
The integration function, w1/w2/w3, the three rival accounts.

### Why the concept matters

The whole grade rests on the central distinction of the entire curriculum, tested on the student's own data. If a student leaves this
...
1. A five-part argument including the awkward entry.
2. An argument read aloud with the disconfirmer stated.

### One non-example

A four-part argument with the poorly fitting case removed.
...
Whether the student can assemble a data-backed argument.

### What this activity does not establish

Whether the argument establishes the claim.
...
| Statement | Status |
|---|---|
| A complete argument includes the claim, the personal data, the pooled data, the disconfirming condition, and the poorly fitting case. | Framework-derived, appropriate at this grade |
| Whether the student can assemble a data-backed argument. | What this specific activity can show |
| Whether the argument establishes the claim. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 24 — The Mechanism Review — specifically: students consolidate contradiction and scope.

**How it was taught.** Through the activity: review with eight cases classified and four applications judged

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: review with eight cases classified and four applications judged, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | the persistence threshold required for carry-over. |
| **Student wording** | The persistence threshold required for carry-over. |
| **Correct example** | A five-part argument including the awkward entry. |
| **Non-example** | A four-part argument with the poorly fitting case removed. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for the persistence threshold required for carry-over." |

### accuracy

| | |
|---|---|
| **Teacher definition** | whether Sim(t) matched what actually happened. |
| **Student wording** | Whether sim(t) matched what actually happened. |
| **Correct example** | A five-part argument including the awkward entry. |
| **Non-example** | A four-part argument with the poorly fitting case removed. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for whether Sim(t) matched what actually happened." |

### decay

| | |
|---|---|
| **Teacher definition** | a simulation weakening and not carrying forward. |
| **Student wording** | A simulation weakening and not carrying forward. |
| **Correct example** | A five-part argument including the awkward entry. |
| **Non-example** | A four-part argument with the poorly fitting case removed. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a simulation weakening and not carrying forward." |


Do not introduce terminology from later grades. The integration function, w1/w2/w3, the three rival accounts.

## Materials and preparation

**Teacher materials.** Printed prediction logs; Notebooks; Printed four-box matrices; Index cards; A timer.

**Student materials.** One copy of `Printouts/Lesson_25_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 24, kept in the student's folder.
...
**File.** `Printouts/Lesson_25_Printout.md`
...
> "Next time: putting the whole argument together."
...
**Exact wording.** "Say: your data, the class data, and everything about the threshold. Present the case."
...
**Target observation.** Whether the student can assemble a data-backed argument.
...
> "A complete argument includes the claim, the personal data, the pooled data, the disconfirming condition, and the poorly fitting case. You just saw that when say: your data, the class data, and everything about the threshold.
> Last time we said: Next time: putting the whole argument together. This is the next part of that.
> It matters because how strongly it mattered decides whether it lasted. It says nothing about whether it was right"
...
**Terminology to introduce here.** theta_persistence, accuracy, decay.

**What students must not infer.** Whether the argument establishes the claim.

### 4. Worked example

**The example.** A five-part argument including the awkward entry.
...
**Completed answer.** A five-part argument including the awkward entry. — which demonstrates whether the student can assemble a data-backed argument.
...
**Conclusions not licensed.** Whether the argument establishes the claim.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An argument read aloud with the disconfirmer stated. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A four-part argument with the poorly fitting case removed. Why is this not an
example?"
...
**Exact student instructions.** A five-part written argument with one part read aloud.
...
- *Licensed conclusion.* Whether the student can assemble a data-backed argument.
- *Not licensed.* Whether the argument establishes the claim.
...
- *Expected response.* Whether the student can assemble a data-backed argument.
...
3. **Misconception check.** Somebody says: "If I felt strongly about it, I was probably right" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `A complete argument includes the claim, the personal data, the pooled data, the disconfirming condition, and the poorly fitting case`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Intensity decides how long it stuck, not whether it was right.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "Next year: what contradiction actually does, and why the framework refuses to explain everything."

**Why this sentence matters.** It is the opening question of Lesson 26, which assumes students arrive holding it.
...
### 1. "If I felt strongly about it, I was probably right"

**What the student says or does.** If I felt strongly about it, I was probably right — usually while otherwise engaging well.

**Why it is understandable.** Confidence and accuracy feel identical from the inside.
...
**Exact correction.** The four-box study on the student's own prospective data.

**Say this.** "Intensity decides how long it stuck, not whether it was right."
...
### 2. "Persistence means I cannot stop thinking about it"

**What the student says or does.** Persistence means I cannot stop thinking about it — usually while otherwise engaging well.

**Why it is understandable.** The word carries everyday intrusive connotations.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Keep persistence mechanical and low-stakes.

**Say this.** "Persistence just means it carried into the next cycle."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "Raising the threshold means more persistence"

**What the student says or does.** Raising the threshold means more persistence — usually while otherwise engaging well.

**Why it is understandable.** The intuitive reading of higher as more.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** The passing-grade analogy, then the direction table.

**Say this.** "Raising the pass mark does not mean more people pass."
...
**Visual or physical support.** Provide the log as a daily sheet with intensity as a three-point circle.
...
Ask for one case in their own data the framework does not predict well.
...
Specifically, do not introduce: The integration function, w1/w2/w3, the three rival accounts.
...
- Whether the student's own data favoured the framework

## Homework connection

**File.** `Homework/Lesson_25_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Mechanism Review |
| **Leads to** | Lesson 26 — Defending The Argument |

**Transition in.** Lesson 24 established students consolidate contradiction and scope. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students present a data-backed argument for the central claim. Lesson 26 assumes it and builds students defend their argument against a classmate's challenge.
