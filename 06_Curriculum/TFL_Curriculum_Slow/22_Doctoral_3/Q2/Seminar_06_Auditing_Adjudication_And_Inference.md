# Seminar 6 — Auditing Adjudication And Inference
...
| | |
|---|---|
| **Central question** | Auditing Adjudication And Inference: participants judge rival fairness and the inference gap? |
| **Core concept** | The inference gap runs in both directions. |
| **Student outcome** | Participants judge rival fairness and the inference gap. |
| **Previous seminar** | Seminar 5 — Auditing Measurement As A Referee |
| **Next seminar** | Seminar 7 — Calibration |
...
**The conceptual step.** The inference gap runs in both directions. Underclaiming is a finding as much as overclaiming, and referees trained only to detect inflation miss it.
...
**What depends on it.** Seminar 7 — Calibration — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The inference gap runs in both directions. Underclaiming is a finding as much as overclaiming, and referees trained only to detect inflation miss it.
...
1. An audit naming licensed rung three and claimed rung four.
2. An audit identifying underclaiming in a strong manuscript.

### One non-example

An audit checking only for inflated claims.
...
That the inference gap is bidirectional.
...
| Statement | Status |
|---|---|
| The inference gap runs in both directions. | Framework-derived, appropriate at this grade |
| That the inference gap is bidirectional. | What this specific activity can show |
| Whether the claims are correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 5 — Auditing Measurement As A Referee — specifically: participants judge construct validity and prespecification in others' work.

**How it was taught.** Through the activity: audit measurement in two manuscripts with located findings per check

**Quick check.** Ask for the closing sentence of Seminar 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 5: audit measurement in two manuscripts with located findings per check, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit naming licensed rung three and claimed rung four. |
| **Non-example** | An audit checking only for inflated claims. |
...
> "An author's assertion of prespecification is not evidence."
...
**Exact wording.** "Say: two checks most referees omit. Fairness, and the inference gap."
...
**Target observation.** That the inference gap is bidirectional.
...
> "The inference gap runs in both directions. You just saw that when say: two checks most referees omit.
> Last time we said: An author's assertion of prespecification is not evidence. This is the next part of that.
...
**What students must not infer.** Whether the claims are correct.

### 4. Worked example

**The example.** An audit naming licensed rung three and claimed rung four.
...
**Completed answer.** An audit naming licensed rung three and claimed rung four. — which demonstrates that the inference gap is bidirectional.
...
**Conclusions not licensed.** Whether the claims are correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An audit identifying underclaiming in a strong manuscript. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit checking only for inflated claims. Why is this not an
example?"
...
**Exact student instructions.** Audit two manuscripts, stating the gap in whichever direction it runs.
...
- *Licensed conclusion.* That the inference gap is bidirectional.
- *Not licensed.* Whether the claims are correct.
...
- *Expected response.* That the inference gap is bidirectional.
...
1. Any wording carrying the idea in `The inference gap runs in both directions`.
...
Say: "The gap runs both ways. Underclaiming is also a finding."
...
| | |
|---|---|
| **Follows** | Seminar 5 — Auditing Measurement As A Referee |
| **Leads to** | Seminar 7 — Calibration |

**Transition in.** Seminar 5 established participants judge construct validity and prespecification in others' work. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants judge rival fairness and the inference gap. Seminar 7 assumes it and builds participants compare reports against others on the same work.
