# Seminar 5 Homework — Auditing Measurement As A Referee

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 2**
**Follows:** Seminar 5 — Auditing Measurement As A Referee · **Points:** 5 · **Optional:** yes
...
Write the sentence Seminar 5 ended on, from memory:
...
Audit measurement in two manuscripts with located findings per check.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every audit carries findings rather than verdicts
...
Seminar 6 is **Auditing Adjudication And Inference**, which assumes you arrive holding it. Write one thing you expect it to be about:
