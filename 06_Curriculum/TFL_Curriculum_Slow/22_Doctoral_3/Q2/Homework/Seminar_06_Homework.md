# Seminar 6 Homework — Auditing Adjudication And Inference

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 2**
**Follows:** Seminar 6 — Auditing Adjudication And Inference · **Points:** 5 · **Optional:** yes
...
Write the sentence Seminar 6 ended on, from memory:
...
Audit two manuscripts, stating the gap in whichever direction it runs.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every audit names licensed rung, claimed rung, and the gap
...
Seminar 7 is **Calibration**, which assumes you arrive holding it. Write one thing you expect it to be about:
