...
|---|---|---|---|---|---|---|
| `Seminar_05_Printout.md` | Seminar 5 — Auditing Measurement As A Referee | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Seminar_06_Printout.md` | Seminar 6 — Auditing Adjudication And Inference | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 5 work |
| `Seminar_07_Printout.md` | Seminar 7 — Calibration | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 6 work |
| `Seminar_08_Printout.md` | Seminar 8 — The Referee Portfolio | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 7 work |
...
**Seminar 7 — Calibration.** If you only have time to print one
