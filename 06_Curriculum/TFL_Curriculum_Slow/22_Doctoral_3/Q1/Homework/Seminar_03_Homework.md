# Seminar 3 Homework — The Reverse Ladder

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 1**
**Follows:** Seminar 3 — The Reverse Ladder · **Points:** 5 · **Optional:** yes
...
Write the sentence Seminar 3 ended on, from memory:
...
Write the reverse ladder for their own proposal and state whether the condition fires.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every participant states honestly whether a null fires their condition
...
Seminar 4 is **The Referee's Problem**, which assumes you arrive holding it. Write one thing you expect it to be about:
