# Seminar 2 Homework — The Inference Ladder

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 1**
**Follows:** Seminar 2 — The Inference Ladder · **Points:** 5 · **Optional:** yes
...
Argue an assigned ceiling position with reasons.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every participant argues a ceiling position
...
Seminar 3 is **The Reverse Ladder**, which assumes you arrive holding it. Write one thing you expect it to be about:
