# Seminar 11 Homework — Proposal Triage

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 3**
**Follows:** Seminar 11 — Proposal Triage · **Points:** 5 · **Optional:** yes
...
Write the sentence Seminar 11 ended on, from memory:
...
Verdicts justified against the architecture, naming the failing item, then revised in session.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every verdict names the specific failing item
...
Seminar 12 is **Rebuilding The Proposal**, which assumes you arrive holding it. Write one thing you expect it to be about:
