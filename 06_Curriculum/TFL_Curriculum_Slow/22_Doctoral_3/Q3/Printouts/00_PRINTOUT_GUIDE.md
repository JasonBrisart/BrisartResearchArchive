...
|---|---|---|---|---|---|---|
| `Seminar_09_Printout.md` | Seminar 9 — Moving A Question | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Seminar_10_Printout.md` | Seminar 10 — The Proposal Architecture | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 9 work |
| `Seminar_11_Printout.md` | Seminar 11 — Proposal Triage | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 10 work |
| `Seminar_12_Printout.md` | Seminar 12 — Rebuilding The Proposal | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 11 work |
...
**Seminar 11 — Proposal Triage.** If you only have time to print one
