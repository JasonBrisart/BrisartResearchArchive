# Session 12 — Conditional Determinism
...
| | |
|---|---|
| **Central question** | Conditional Determinism: students state what the framework guarantees about repeatability? |
| **Core concept** | Conditional determinism is a claim about the architecture under fixed parameters, not a claim about human behaviour. |
| **Student outcome** | Students state what the framework guarantees about repeatability. |
| **Previous session** | Session 11 — Closure And Its Cost |
| **Next session** | Session 13 — The Guarantee Set |
| **Materials** | Index cards for standing objections; the full specification, printed |
| **Preparation** | thirty minutes |
| **Student printout** | `Printouts/Session_12_Printout.md` |
| **Homework** | `Homework/Session_12_Homework.md` |

## Why this lesson exists

**The conceptual step.** Conditional determinism is a claim about the architecture under fixed parameters, not a claim about human behaviour. The condition is what makes it checkable.
...
**What depends on it.** Session 13 — The Guarantee Set — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Conditional determinism is a claim about the architecture under fixed parameters, not a claim about human behaviour. The condition is what makes it checkable.
...
1. A violating observation of differing outputs under identical conditions.
2. A statement including the fixed-parameter condition.

### One non-example

A claim that the same input always produces the same experience.
...
That the guarantee is conditional and checkable.

### What this activity does not establish

Whether people are deterministic.
...
| Statement | Status |
|---|---|
| Conditional determinism is a claim about the architecture under fixed parameters, not a claim about human behaviour. | Framework-derived, appropriate at this grade |
| That the guarantee is conditional and checkable. | What this specific activity can show |
| Whether people are deterministic. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 11 — Closure And Its Cost — specifically: students evaluate whether variable closure is principled or convenient.

**How it was taught.** Through the activity: test whether the excluded variables are the threatening ones

**Quick check.** Ask for the closing sentence of Session 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 11: test whether the excluded variables are the threatening ones, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A violating observation of differing outputs under identical conditions. |
| **Non-example** | A claim that the same input always produces the same experience. |
...
**Student materials.** One copy of `Printouts/Session_12_Printout.md` per student.

**Prior student data required.** Work produced in Session 11, kept in the student's folder.
...
**File.** `Printouts/Session_12_Printout.md`
...
> "If closure were convenient, the excluded ones would be the threatening ones."
...
**Exact wording.** "Ask: same inputs, same parameters. Same F(t)?"
...
**Target observation.** That the guarantee is conditional and checkable.
...
> "Conditional determinism is a claim about the architecture under fixed parameters, not a claim about human behaviour. You just saw that when ask: same inputs, same parameters.
> Last time we said: If closure were convenient, the excluded ones would be the threatening ones. This is the next part of that.
...
**What students must not infer.** Whether people are deterministic.

### 4. Worked example

**The example.** A violating observation of differing outputs under identical conditions.
...
**Completed answer.** A violating observation of differing outputs under identical conditions. — which demonstrates that the guarantee is conditional and checkable.
...
**Conclusions not licensed.** Whether people are deterministic.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A statement including the fixed-parameter condition. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that the same input always produces the same experience. Why is this not an
example?"
...
**Exact student instructions.** Explain what conditionally is doing and name a violating observation.
...
- *Licensed conclusion.* That the guarantee is conditional and checkable.
- *Not licensed.* Whether people are deterministic.
...
- *Expected response.* That the guarantee is conditional and checkable.
...
1. Any wording carrying the idea in `Conditional determinism is a claim about the architecture under fixed parameters, not a claim about human behaviour`.
...
Say: "Same inputs and parameters give the same output. That is checkable."

**Why this sentence matters.** It is the opening question of Session 13, which assumes students arrive holding it.
...
**File.** `Homework/Session_12_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 11 — Closure And Its Cost |
| **Leads to** | Session 13 — The Guarantee Set |

**Transition in.** Session 11 established students evaluate whether variable closure is principled or convenient. This session uses that as the starting point.

**Transition out.** This session establishes students state what the framework guarantees about repeatability. Session 13 assumes it and builds students state the architectural commitments and their limits.
