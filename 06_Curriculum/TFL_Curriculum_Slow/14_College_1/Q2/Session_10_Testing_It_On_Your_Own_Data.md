# Session 10 — Testing It On Your Own Data
...
| | |
|---|---|
| **Central question** | Testing It On Your Own Data: students run the four-box study on prospectively collected data? |
| **Core concept** | Self-collected data that fits the framework also fits the rivals. |
| **Student outcome** | Students run the four-box study on prospectively collected data. |
| **Previous session** | Session 9 — The Gating Claim |
| **Next session** | Session 11 — Closure And Its Cost |
...
**The conceptual step.** Self-collected data that fits the framework also fits the rivals. Discovering this on one's own data is more persuasive than being told.
...
**What depends on it.** Session 11 — Closure And Its Cost — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Self-collected data that fits the framework also fits the rivals. Discovering this on one's own data is more persuasive than being told.
...
1. A four-box matrix with all cells populated.
2. Three named reasons the data might mislead, including selection.

### One non-example

A conclusion that the data supports the framework.
...
That self-collected data can be assembled and critiqued.

### What this activity does not establish

Whether the framework is supported.
...
| Statement | Status |
|---|---|
| Self-collected data that fits the framework also fits the rivals. | Framework-derived, appropriate at this grade |
| That self-collected data can be assembled and critiqued. | What this specific activity can show |
| Whether the framework is supported. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 9 — The Gating Claim — specifically: students state and pressure the exclusive gating claim.

**How it was taught.** Through the activity: write the deciding observation and a 250-word structural argument

**Quick check.** Ask for the closing sentence of Session 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 9: write the deciding observation and a 250-word structural argument, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A four-box matrix with all cells populated. |
| **Non-example** | A conclusion that the data supports the framework. |
...
> "That is a real falsification condition for a specific claim."
...
**Exact wording.** "Say: six weeks ago you started recording predictions before outcomes."
...
**Target observation.** That self-collected data can be assembled and critiqued.
...
> "Self-collected data that fits the framework also fits the rivals. You just saw that when say: six weeks ago you started recording predictions before outcomes.
> Last time we said: That is a real falsification condition for a specific claim. This is the next part of that.
...
**What students must not infer.** Whether the framework is supported.

### 4. Worked example

**The example.** A four-box matrix with all cells populated.
...
**Completed answer.** A four-box matrix with all cells populated. — which demonstrates that self-collected data can be assembled and critiqued.
...
**Conclusions not licensed.** Whether the framework is supported.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Three named reasons the data might mislead, including selection. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A conclusion that the data supports the framework. Why is this not an
example?"
...
**Exact student instructions.** Sort eight logged predictions and answer four questions, the fourth being three reasons the data might mislead.
...
- *Licensed conclusion.* That self-collected data can be assembled and critiqued.
- *Not licensed.* Whether the framework is supported.
...
- *Expected response.* That self-collected data can be assembled and critiqued.
...
1. Any wording carrying the idea in `Self-collected data that fits the framework also fits the rivals`.
...
Say: "Your data is consistent with the framework and with two rivals."
...
| | |
|---|---|
| **Follows** | Session 9 — The Gating Claim |
| **Leads to** | Session 11 — Closure And Its Cost |

**Transition in.** Session 9 established students state and pressure the exclusive gating claim. This session uses that as the starting point.

**Transition out.** This session establishes students run the four-box study on prospectively collected data. Session 11 assumes it and builds students evaluate whether variable closure is principled or convenient.
