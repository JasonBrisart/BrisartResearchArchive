# Session 12 Homework — Conditional Determinism

**College Year 1** · The Framework and Its Status · **Quarter 2**
**Follows:** Session 12 — Conditional Determinism · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 12 ended on, from memory:
...
Explain what conditionally is doing and name a violating observation.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student identifies fixed parameters as the condition
...
Session 13 is **The Guarantee Set**, which assumes you arrive holding it. Write one thing you expect it to be about:
