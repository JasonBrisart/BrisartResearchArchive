# Session 10 Homework — Testing It On Your Own Data

**College Year 1** · The Framework and Its Status · **Quarter 2**
**Follows:** Session 10 — Testing It On Your Own Data · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 10 ended on, from memory:
...
Sort eight logged predictions and answer four questions, the fourth being three reasons the data might mislead.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces three genuine reasons
...
Session 11 is **Closure And Its Cost**, which assumes you arrive holding it. Write one thing you expect it to be about:
