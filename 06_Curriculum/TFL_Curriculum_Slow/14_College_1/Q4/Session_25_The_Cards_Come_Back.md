# Session 25 — The Cards Come Back
...
| | |
|---|---|
| **Central question** | The Cards Come Back: students evaluate their own opening objection? |
| **Core concept** | An objection that survives a term of study is a real objection. |
| **Student outcome** | Students evaluate their own opening objection. |
| **Previous session** | Session 24 — Comparing With Your Own Field |
| **Next session** | Session 26 — The Year In Objections |
| **Materials** | Index cards for standing objections; the full specification, printed |
| **Preparation** | thirty minutes |
| **Student printout** | `Printouts/Session_25_Printout.md` |
| **Homework** | `Homework/Session_25_Homework.md` |

## Why this lesson exists

**The conceptual step.** An objection that survives a term of study is a real objection. Converting it into a falsification condition turns a complaint into a testable commitment.
...
**What depends on it.** Session 26 — The Year In Objections — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An objection that survives a term of study is a real objection. Converting it into a falsification condition turns a complaint into a testable commitment.
...
1. An objection marked answered, with what answered it.
2. A standing objection converted into a falsification condition.

### One non-example

An earlier objection dismissed as having been uninformed.
...
That objections can be tracked and converted.

### What this activity does not establish

Whether the standing objections are correct.
...
| Statement | Status |
|---|---|
| An objection that survives a term of study is a real objection. | Framework-derived, appropriate at this grade |
| That objections can be tracked and converted. | What this specific activity can show |
| Whether the standing objections are correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 24 — Comparing With Your Own Field — specifically: students situate TFL against a framework from their own discipline.

**How it was taught.** Through the activity: compare TFL with one framework from their own field on four dimensions

**Quick check.** Ask for the closing sentence of Session 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 24: compare TFL with one framework from their own field on four dimensions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An objection marked answered, with what answered it. |
| **Non-example** | An earlier objection dismissed as having been uninformed. |
...
**Student materials.** One copy of `Printouts/Session_25_Printout.md` per student.

**Prior student data required.** Work produced in Session 24, kept in the student's folder.
...
**File.** `Printouts/Session_25_Printout.md`
...
> "Every field has one of these. Now you can recognise it."
...
**Exact wording.** "Hand back the Session 1 cards. Say: mark it answered, partly, or still standing."
...
**Target observation.** That objections can be tracked and converted.
...
> "An objection that survives a term of study is a real objection. You just saw that when hand back the Session 1 cards.
> Last time we said: Every field has one of these. Now you can recognise it. This is the next part of that.
...
**What students must not infer.** Whether the standing objections are correct.

### 4. Worked example

**The example.** An objection marked answered, with what answered it.
...
**Completed answer.** An objection marked answered, with what answered it. — which demonstrates that objections can be tracked and converted.
...
**Conclusions not licensed.** Whether the standing objections are correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A standing objection converted into a falsification condition. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An earlier objection dismissed as having been uninformed. Why is this not an
example?"
...
**Exact student instructions.** Write one paragraph on the objection's fate and convert any standing one into a condition.
...
- *Licensed conclusion.* That objections can be tracked and converted.
- *Not licensed.* Whether the standing objections are correct.
...
- *Expected response.* That objections can be tracked and converted.
...
1. Any wording carrying the idea in `An objection that survives a term of study is a real objection`.
...
Say: "The ones still standing are the real ones."

**Why this sentence matters.** It is the opening question of Session 26, which assumes students arrive holding it.
...
**File.** `Homework/Session_25_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 24 — Comparing With Your Own Field |
| **Leads to** | Session 26 — The Year In Objections |

**Transition in.** Session 24 established students situate TFL against a framework from their own discipline. This session uses that as the starting point.

**Transition out.** This session establishes students evaluate their own opening objection. Session 26 assumes it and builds students review the year through the class's objections.
