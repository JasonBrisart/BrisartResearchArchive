...
| | |
|---|---|
| **Central question** | Practice Final: students rehearse the final under conditions? |
| **Core concept** | The practice final is marked gate-first, exactly as the real paper will be. |
| **Student outcome** | Students rehearse the final under conditions. |
| **Previous session** | Session 26 — The Year In Objections |
...
**The conceptual step.** The practice final is marked gate-first, exactly as the real paper will be. Its purpose is locating gaps while there is still time.
...
The practice final is marked gate-first, exactly as the real paper will be. Its purpose is locating gaps while there is still time.
...
1. A practice paper marked gate-first.
2. A student discovering their scope answer would fail.

### One non-example

A practice paper marked for total score only.
...
Whether each student would pass.
...
| Statement | Status |
|---|---|
| The practice final is marked gate-first, exactly as the real paper will be. | Framework-derived, appropriate at this grade |
| Whether each student would pass. | What this specific activity can show |
| The final grade. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 26 — The Year In Objections — specifically: students review the year through the class's objections.

**How it was taught.** Through the activity: sort the class's objections into answered, sharpened, abandoned, and standing

**Quick check.** Ask for the closing sentence of Session 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 26: sort the class's objections into answered, sharpened, abandoned, and standing, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A practice paper marked gate-first. |
| **Non-example** | A practice paper marked for total score only. |
...
> "Sharpened and abandoned are both good outcomes."
...
**Exact wording.** "Say: same as the real one, including both gates."
...
**Target observation.** Whether each student would pass.
...
> "The practice final is marked gate-first, exactly as the real paper will be. You just saw that when say: same as the real one, including both gates.
> Last time we said: Sharpened and abandoned are both good outcomes. This is the next part of that.
...
**The example.** A practice paper marked gate-first.
...
**Completed answer.** A practice paper marked gate-first. — which demonstrates whether each student would pass.
...
**Teacher prompt.** "Here is a second case. A student discovering their scope answer would fail. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A practice paper marked for total score only. Why is this not an
example?"
...
**Exact student instructions.** A full practice final, self-marked, gates checked first.
...
- *Licensed conclusion.* Whether each student would pass.
...
- *Expected response.* Whether each student would pass.
...
1. Any wording carrying the idea in `The practice final is marked gate-first, exactly as the real paper will be`.
...
Say: "Now you know what to review."
...
| | |
|---|---|
| **Follows** | Session 26 — The Year In Objections |
| **Leads to** | Session 28 — Final Assessment |

**Transition in.** Session 26 established students review the year through the class's objections. This session uses that as the starting point.

**Transition out.** This session establishes students rehearse the final under conditions. Session 28 assumes it and builds students demonstrate integrated command of the framework and its status.
