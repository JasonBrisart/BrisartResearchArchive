# Session 28 Homework — Final Assessment

**College Year 1** · The Framework and Its Status · **Quarter 4**
**Follows:** Session 28 — Final Assessment · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 28 ended on, from memory:
...
The gated final: both relations, closure, a trace, falsification, scope, the rivals, status.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** both gates are satisfied
...
This is the last session of the year, so this prepares you for the final rather than for a new session.
