# Session 24 — Comparing With Your Own Field
...
| | |
|---|---|
| **Central question** | Comparing With Your Own Field: students situate TFL against a framework from their own discipline? |
| **Core concept** | Every field contains frameworks at the pre-validation stage. |
| **Student outcome** | Students situate TFL against a framework from their own discipline. |
| **Previous session** | Session 23 — What The Framework Needs |
| **Next session** | Session 25 — The Cards Come Back |
| **Materials** | Index cards for standing objections; the full specification, printed |
| **Preparation** | thirty minutes |
| **Student printout** | `Printouts/Session_24_Printout.md` |
| **Homework** | `Homework/Session_24_Homework.md` |

## Why this lesson exists

**The conceptual step.** Every field contains frameworks at the pre-validation stage. Recognising one in the student's own discipline is what makes the methodological content transferable.
...
**What depends on it.** Session 25 — The Cards Come Back — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every field contains frameworks at the pre-validation stage. Recognising one in the student's own discipline is what makes the methodological content transferable.
...
1. A contested framework from the student's discipline, compared.
2. A comparison on specification, falsifiability, status, and uptake.

### One non-example

A fully settled framework chosen because it is easier to describe.
...
That the situation is general rather than unique.
...
| Statement | Status |
|---|---|
| Every field contains frameworks at the pre-validation stage. | Framework-derived, appropriate at this grade |
| That the situation is general rather than unique. | What this specific activity can show |
| Which framework is better. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 23 — What The Framework Needs — specifically: students state what would move the question forward.

**How it was taught.** Through the activity: write three requirements for progress, ranked by feasibility

**Quick check.** Ask for the closing sentence of Session 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 23: write three requirements for progress, ranked by feasibility, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A contested framework from the student's discipline, compared. |
| **Non-example** | A fully settled framework chosen because it is easier to describe. |
...
**Student materials.** One copy of `Printouts/Session_24_Printout.md` per student.

**Prior student data required.** Work produced in Session 23, kept in the student's folder.
...
**File.** `Printouts/Session_24_Printout.md`
...
> "Naming what is needed is more useful than deciding whether you believe it."
...
**Exact wording.** "Ask them to find something in their major at a similar stage."
...
**Target observation.** That the situation is general rather than unique.
...
> "Every field contains frameworks at the pre-validation stage. You just saw that when ask them to find something in their major at a similar stage.
> Last time we said: Naming what is needed is more useful than deciding whether you believe it. This is the next part of that.
...
**What students must not infer.** Which framework is better.

### 4. Worked example

**The example.** A contested framework from the student's discipline, compared.
...
**Completed answer.** A contested framework from the student's discipline, compared. — which demonstrates that the situation is general rather than unique.
...
**Conclusions not licensed.** Which framework is better.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A comparison on specification, falsifiability, status, and uptake. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A fully settled framework chosen because it is easier to describe. Why is this not an
example?"
...
**Exact student instructions.** Compare TFL with one framework from their own field on four dimensions.
...
- *Licensed conclusion.* That the situation is general rather than unique.
- *Not licensed.* Which framework is better.
...
- *Expected response.* That the situation is general rather than unique.
...
1. Any wording carrying the idea in `Every field contains frameworks at the pre-validation stage`.
...
Say: "Every field has one of these. Now you can recognise it."

**Why this sentence matters.** It is the opening question of Session 25, which assumes students arrive holding it.
...
**File.** `Homework/Session_24_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 23 — What The Framework Needs |
| **Leads to** | Session 25 — The Cards Come Back |

**Transition in.** Session 23 established students state what would move the question forward. This session uses that as the starting point.

**Transition out.** This session establishes students situate TFL against a framework from their own discipline. Session 25 assumes it and builds students evaluate their own opening objection.
