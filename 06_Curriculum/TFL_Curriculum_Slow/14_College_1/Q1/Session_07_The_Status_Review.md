...
| | |
|---|---|
| **Central question** | The Status Review: students consolidate status and the declared set? |
| **Core concept** | Status statements can be inflated in either direction. |
| **Student outcome** | Students consolidate status and the declared set. |
| **Previous session** | Session 6 — Belief At Adult Scale |
| **Next session** | Session 8 — The Window As A Free Parameter |
...
**The conceptual step.** Status statements can be inflated in either direction. Judging six of them tests whether both failure modes are being detected rather than only overclaiming.
...
**What depends on it.** Session 8 — The Window As A Free Parameter — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Status statements can be inflated in either direction. Judging six of them tests whether both failure modes are being detected rather than only overclaiming.
...
1. A statement correctly judged as overclaiming.
2. A statement correctly judged as underclaiming.

### One non-example

A dismissive statement accepted as appropriately cautious.
...
Whether both inflation directions are detected.
...
| Statement | Status |
|---|---|
| Status statements can be inflated in either direction. | Framework-derived, appropriate at this grade |
| Whether both inflation directions are detected. | What this specific activity can show |
| Whether the framework is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 6 — Belief At Adult Scale — specifically: students state Belief(t)'s different status from the five signals.

**How it was taught.** Through the activity: explain why belief is a structural prior rather than a momentary signal, with an example

**Quick check.** Ask for the closing sentence of Session 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 6: explain why belief is a structural prior rather than a momentary signal, with an example, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A statement correctly judged as overclaiming. |
| **Non-example** | A dismissive statement accepted as appropriately cautious. |
...
> "Not a sixth signal. A constraint on how the five behave."
...
**Exact wording.** "Ask them to state the status in three sentences, then name the five."
...
**Target observation.** Whether both inflation directions are detected.
...
> "Status statements can be inflated in either direction. You just saw that when ask them to state the status in three sentences, then name the five.
> Last time we said: Not a sixth signal. A constraint on how the five behave. This is the next part of that.
...
**The example.** A statement correctly judged as overclaiming.
...
**Completed answer.** A statement correctly judged as overclaiming. — which demonstrates whether both inflation directions are detected.
...
**Teacher prompt.** "Here is a second case. A statement correctly judged as underclaiming. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A dismissive statement accepted as appropriately cautious. Why is this not an
example?"
...
**Exact student instructions.** Review with six status statements judged for inflation in either direction.
...
- *Licensed conclusion.* Whether both inflation directions are detected.
...
- *Expected response.* Whether both inflation directions are detected.
...
1. Any wording carrying the idea in `Status statements can be inflated in either direction`.
...
Say: "Next: the number everybody accepts without checking."
...
| | |
|---|---|
| **Follows** | Session 6 — Belief At Adult Scale |
| **Leads to** | Session 8 — The Window As A Free Parameter |

**Transition in.** Session 6 established students state Belief(t)'s different status from the five signals. This session uses that as the starting point.

**Transition out.** This session establishes students consolidate status and the declared set. Session 8 assumes it and builds students criticise the temporal window specification.
