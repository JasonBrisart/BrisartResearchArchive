# Session 16 — Consistency Is Not Evidence
...
| | |
|---|---|
| **Central question** | Consistency Is Not Evidence: students find their own results fit the rivals equally well? |
| **Core concept** | A result predicted by every account discriminates between none of them. |
| **Student outcome** | Students find their own results fit the rivals equally well. |
| **Previous session** | Session 15 — Three Rivals At Adult Scale |
| **Next session** | Session 17 — The Discriminating Condition |
...
**The conceptual step.** A result predicted by every account discriminates between none of them. Plausibility arguments are not a substitute for differential prediction.
...
**What depends on it.** Session 17 — The Discriminating Condition — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A result predicted by every account discriminates between none of them. Plausibility arguments are not a substitute for differential prediction.
...
1. A result equally predicted by all four accounts.
2. A student concluding their strongest result discriminates nothing.

### One non-example

An argument that the habit account is implausible here.
...
That consistency does not constitute support.
...
| Statement | Status |
|---|---|
| A result predicted by every account discriminates between none of them. | Framework-derived, appropriate at this grade |
| That consistency does not constitute support. | What this specific activity can show |
| Which account is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 15 — Three Rivals At Adult Scale — specifically: students state the rivals in forms their proponents would accept.

**How it was taught.** Through the activity: write each rival and have it checked by a classmate who finds it plausible

**Quick check.** Ask for the closing sentence of Session 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 15: write each rival and have it checked by a classmate who finds it plausible, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A result equally predicted by all four accounts. |
| **Non-example** | An argument that the habit account is implausible here. |
...
> "If you operationalise the rival, you will operationalise it to lose."
...
**Exact wording.** "Put a strong student result up with its framework explanation, then apply each rival."
...
**Target observation.** That consistency does not constitute support.
...
> "A result predicted by every account discriminates between none of them. You just saw that when put a strong student result up with its framework explanation, then apply each rival.
> Last time we said: If you operationalise the rival, you will operationalise it to lose. This is the next part of that.
...
**The example.** A result equally predicted by all four accounts.
...
**Completed answer.** A result equally predicted by all four accounts. — which demonstrates that consistency does not constitute support.
...
**Teacher prompt.** "Here is a second case. A student concluding their strongest result discriminates nothing. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An argument that the habit account is implausible here. Why is this not an
example?"
...
**Exact student instructions.** Apply all three rivals to three of their own results.
...
- *Licensed conclusion.* That consistency does not constitute support.
...
- *Expected response.* That consistency does not constitute support.
...
1. Any wording carrying the idea in `A result predicted by every account discriminates between none of them`.
...
Say: "This is the most useful disappointment of the course."
...
| | |
|---|---|
| **Follows** | Session 15 — Three Rivals At Adult Scale |
| **Leads to** | Session 17 — The Discriminating Condition |

**Transition in.** Session 15 established students state the rivals in forms their proponents would accept. This session uses that as the starting point.

**Transition out.** This session establishes students find their own results fit the rivals equally well. Session 17 assumes it and builds students locate where the four accounts come apart.
