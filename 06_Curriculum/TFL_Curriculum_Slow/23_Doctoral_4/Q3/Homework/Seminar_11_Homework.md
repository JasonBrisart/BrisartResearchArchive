# Seminar 11 Homework — The Scope Section

**Doctoral Year 4** · Dissertation and Defence · **Quarter 3**
**Follows:** Seminar 11 — The Scope Section · **Points:** 5 · **Optional:** yes
...
Write the rejection with boundary and alternative level.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every rejection names a boundary and an alternative level
...
Seminar 12 is **Gate Checking**, which assumes you arrive holding it. Write one thing you expect it to be about:
