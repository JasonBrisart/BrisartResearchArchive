# Seminar 12 Homework — Gate Checking

**Doctoral Year 4** · Dissertation and Defence · **Quarter 3**
**Follows:** Seminar 12 — Gate Checking · **Points:** 5 · **Optional:** yes
...
Peer gate check with failures returned for repair.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every dissertation passes a peer gate check on both items
...
Seminar 13 is **The Mock Defence**, which assumes you arrive holding it. Write one thing you expect it to be about:
