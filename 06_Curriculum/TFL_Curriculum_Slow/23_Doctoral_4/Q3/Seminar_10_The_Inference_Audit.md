# Seminar 10 — The Inference Audit

**Doctoral Year 4** · Dissertation and Defence · **Quarter 3** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Inference Audit: participants audit their own dissertation for ceiling breaches? |
| **Core concept** | Every dissertation exceeds its declared inference ceiling somewhere, usually in the abstract or the closing paragraph. |
| **Student outcome** | Participants audit their own dissertation for ceiling breaches. |
| **Previous seminar** | Seminar 9 — The Limitations Section |
| **Next seminar** | Seminar 11 — The Scope Section |
| **Materials** | The participant's own proposal and data; dissertation structure templates |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_10_Printout.md` |
| **Homework** | `Homework/Seminar_10_Homework.md` |

## Why this lesson exists

**The conceptual step.** Every dissertation exceeds its declared inference ceiling somewhere, usually in the abstract or the closing paragraph. Requiring a minimum forces genuine auditing.
...
**What depends on it.** Seminar 11 — The Scope Section — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every dissertation exceeds its declared inference ceiling somewhere, usually in the abstract or the closing paragraph. Requiring a minimum forces genuine auditing.
...
1. A breach found in the abstract and repaired.
2. A breach found in the closing paragraph.

### One non-example

An audit concluding no breaches occurred.
...
That ceiling breaches are universal and findable.

### What this activity does not establish

Whether the repaired claims are correct.
...
| Statement | Status |
|---|---|
| Every dissertation exceeds its declared inference ceiling somewhere, usually in the abstract or the closing paragraph. | Framework-derived, appropriate at this grade |
| That ceiling breaches are universal and findable. | What this specific activity can show |
| Whether the repaired claims are correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 9 — The Limitations Section — specifically: participants state limits specifically rather than generically.

**How it was taught.** Through the activity: rewrite limitations so each names an excluded conclusion

**Quick check.** Ask for the closing sentence of Seminar 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 9: rewrite limitations so each names an excluded conclusion, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A breach found in the abstract and repaired. |
| **Non-example** | An audit concluding no breaches occurred. |
...
**Student materials.** One copy of `Printouts/Seminar_10_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 9, kept in the student's folder.
...
**File.** `Printouts/Seminar_10_Printout.md`
...
> "A limitation without an excluded conclusion is decoration."
...
**Exact wording.** "Say: you declared a ceiling. Find every place you exceeded it."
...
**Target observation.** That ceiling breaches are universal and findable.
...
> "Every dissertation exceeds its declared inference ceiling somewhere, usually in the abstract or the closing paragraph. You just saw that when say: you declared a ceiling.
> Last time we said: A limitation without an excluded conclusion is decoration. This is the next part of that.
...
**What students must not infer.** Whether the repaired claims are correct.

### 4. Worked example

**The example.** A breach found in the abstract and repaired.
...
**Completed answer.** A breach found in the abstract and repaired. — which demonstrates that ceiling breaches are universal and findable.
...
**Conclusions not licensed.** Whether the repaired claims are correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A breach found in the closing paragraph. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit concluding no breaches occurred. Why is this not an
example?"
...
**Exact student instructions.** Audit the full draft for ceiling breaches and repair each.
...
- *Licensed conclusion.* That ceiling breaches are universal and findable.
- *Not licensed.* Whether the repaired claims are correct.
...
- *Expected response.* That ceiling breaches are universal and findable.
...
1. Any wording carrying the idea in `Every dissertation exceeds its declared inference ceiling somewhere, usually in the abstract or the closing paragraph`.
...
Say: "You will exceed it somewhere. Everybody does."

**Why this sentence matters.** It is the opening question of Seminar 11, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_10_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 9 — The Limitations Section |
| **Leads to** | Seminar 11 — The Scope Section |

**Transition in.** Seminar 9 established participants state limits specifically rather than generically. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants audit their own dissertation for ceiling breaches. Seminar 11 assumes it and builds participants write the formal rejection their dissertation requires.
