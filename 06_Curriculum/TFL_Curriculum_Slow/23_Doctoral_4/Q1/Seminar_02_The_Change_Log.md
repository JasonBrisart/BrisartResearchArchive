# Seminar 2 — The Change Log

**Doctoral Year 4** · Dissertation and Defence · **Quarter 1** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Change Log: participants document every modification and its cost? |
| **Core concept** | Specification drift is the quiet modification of a framework until it becomes unfalsifiable. |
| **Student outcome** | Participants document every modification and its cost. |
| **Previous seminar** | Seminar 1 — The Hedged Dissertation |
| **Next seminar** | Seminar 3 — Reporting What Happened |
| **Materials** | The participant's own proposal and data; dissertation structure templates |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_02_Printout.md` |
| **Homework** | `Homework/Seminar_02_Homework.md` |

## Why this lesson exists

**The conceptual step.** Specification drift is the quiet modification of a framework until it becomes unfalsifiable. A change log with no entries after two years indicates the log was not kept.

**Why students need it now.** This grade owns one idea: hedged design, and writing both discussions before the result is known.
...
that a null result is a failed dissertation. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Defence against four assigned adversarial roles. Every claim must stay inside the declared inference ceiling.

**What depends on it.** Seminar 3 — Reporting What Happened — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Specification drift is the quiet modification of a framework until it becomes unfalsifiable. A change log with no entries after two years indicates the log was not kept.

### How this is stated at this grade

Defence against four assigned adversarial roles. Every claim must stay inside the declared inference ceiling.

Use only the vocabulary released at or before this grade. Terms not yet available:
Governance instruments, institutional stewardship artifacts.

### Why the concept matters

The whole grade rests on hedged design, and writing both discussions before the result is known. If a student leaves this
...
1. A log entry naming a modification and the result that prompted it.
2. A reconstructed log with four entries across two years.

### One non-example

A report that no modifications were made.
...
That drift is detectable only by documentation.

### What this activity does not establish

Whether the modifications were justified.
...
| Statement | Status |
|---|---|
| Specification drift is the quiet modification of a framework until it becomes unfalsifiable. | Framework-derived, appropriate at this grade |
| That drift is detectable only by documentation. | What this specific activity can show |
| Whether the modifications were justified. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 1 — The Hedged Dissertation — specifically: participants confirm their work produces value under either outcome.

**How it was taught.** Through the activity: state the contribution under each outcome and repair the design if either is empty

**Quick check.** Ask for the closing sentence of Seminar 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 1: state the contribution under each outcome and repair the design if either is empty, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | a study producing value under either outcome. |
| **Student wording** | A study producing value under either outcome. |
| **Correct example** | A log entry naming a modification and the result that prompted it. |
| **Non-example** | A report that no modifications were made. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a study producing value under either outcome." |

### change log

| | |
|---|---|
| **Teacher definition** | documentation of every modification and what prompted it. |
| **Student wording** | Documentation of every modification and what prompted it. |
| **Correct example** | A log entry naming a modification and the result that prompted it. |
| **Non-example** | A report that no modifications were made. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for documentation of every modification and what prompted it." |

### availability statement

| | |
|---|---|
| **Teacher definition** | what others can obtain and under what terms. |
| **Student wording** | What others can obtain and under what terms. |
| **Correct example** | A log entry naming a modification and the result that prompted it. |
| **Non-example** | A report that no modifications were made. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for what others can obtain and under what terms." |


Do not introduce terminology from later grades. Governance instruments, institutional stewardship artifacts.

## Materials and preparation

**Teacher materials.** The participant's own proposal and data; Dissertation structure templates; Whiteboard.

**Student materials.** One copy of `Printouts/Seminar_02_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 1, kept in the student's folder.
...
**File.** `Printouts/Seminar_02_Printout.md`
...
> "If your degree depends on the framework being true, the design failed first."
...
**Exact wording.** "Say: specification drift has ended the most research programmes and never announces itself."
...
**Target observation.** That drift is detectable only by documentation.
...
> "Specification drift is the quiet modification of a framework until it becomes unfalsifiable. You just saw that when say: specification drift has ended the most research programmes and never announces itself.
> Last time we said: If your degree depends on the framework being true, the design failed first. This is the next part of that.
> It matters because four years of work, defended in an hour, against people meeting it for the first time"
...
**Terminology to introduce here.** hedged design, change log, availability statement.

**What students must not infer.** Whether the modifications were justified.

### 4. Worked example

**The example.** A log entry naming a modification and the result that prompted it.
...
**Completed answer.** A log entry naming a modification and the result that prompted it. — which demonstrates that drift is detectable only by documentation.
...
**Conclusions not licensed.** Whether the modifications were justified.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A reconstructed log with four entries across two years. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A report that no modifications were made. Why is this not an
example?"
...
**Exact student instructions.** Reconstruct a change log for work done so far.
...
- *Licensed conclusion.* That drift is detectable only by documentation.
- *Not licensed.* Whether the modifications were justified.
...
- *Expected response.* That drift is detectable only by documentation.
...
3. **Misconception check.** Somebody says: "A null result is a failed dissertation" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `Specification drift is the quiet modification of a framework until it becomes unfalsifiable`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: If your degree depends on the framework being true, the design failed first.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "A log with no entries after two years means the log was not kept."

**Why this sentence matters.** It is the opening question of Seminar 3, which assumes students arrive holding it.
...
### 1. "A null result is a failed dissertation"

**What the student says or does.** A null result is a failed dissertation — usually while otherwise engaging well.

**Why it is understandable.** The positive result is the one imagined during design.
...
**Exact correction.** A hedged design produces a publishable result either way.

**Say this.** "If your degree depends on the framework being true, the design failed first."
...
### 2. "The discussion is written after the result"

**What the student says or does.** The discussion is written after the result — usually while otherwise engaging well.

**Why it is understandable.** It reports the result, so it feels downstream.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Write both discussions in advance.

**Say this.** "The honest version is the one written by somebody who did not yet know."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "Modifications during the project are just refinements"

**What the student says or does.** Modifications during the project are just refinements — usually while otherwise engaging well.

**Why it is understandable.** Small changes feel invisible.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** The change log.

**Say this.** "Drift never announces itself. The log is the only reliable detection."
...
**Visual or physical support.** Provide the structure with the both-discussions requirement worked.
...
Ask for the referee report they expect their dissertation to receive.
...
Specifically, do not introduce: Governance instruments, institutional stewardship artifacts.
...
- Whether the result was positive or null
...
**File.** `Homework/Seminar_02_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 1 — The Hedged Dissertation |
| **Leads to** | Seminar 3 — Reporting What Happened |

**Transition in.** Seminar 1 established participants confirm their work produces value under either outcome. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants document every modification and its cost. Seminar 3 assumes it and builds participants write results without interpretation.
