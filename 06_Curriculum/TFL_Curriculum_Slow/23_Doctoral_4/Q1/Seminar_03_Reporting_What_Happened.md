# Seminar 3 — Reporting What Happened
...
| | |
|---|---|
| **Central question** | Reporting What Happened: participants write results without interpretation? |
| **Core concept** | A results section reports observations. |
| **Student outcome** | Participants write results without interpretation. |
| **Previous seminar** | Seminar 2 — The Change Log |
| **Next seminar** | Seminar 4 — Prespecified Versus Exploratory |
| **Materials** | The participant's own proposal and data; dissertation structure templates |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_03_Printout.md` |
| **Homework** | `Homework/Seminar_03_Homework.md` |

## Why this lesson exists

**The conceptual step.** A results section reports observations. A reader must be able to reach a different conclusion from the same results, which interpretive language prevents.
...
**What depends on it.** Seminar 4 — Prespecified Versus Exploratory — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A results section reports observations. A reader must be able to reach a different conclusion from the same results, which interpretive language prevents.
...
1. A results section stating observations without evaluation.
2. A section cleaned of evaluative adverbs.

### One non-example

A results section explaining what the pattern means.
...
That reporting and interpreting are separable.
...
| Statement | Status |
|---|---|
| A results section reports observations. | Framework-derived, appropriate at this grade |
| That reporting and interpreting are separable. | What this specific activity can show |
| Whether the interpretation is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 2 — The Change Log — specifically: participants document every modification and its cost.

**How it was taught.** Through the activity: reconstruct a change log for work done so far

**Quick check.** Ask for the closing sentence of Seminar 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 2: reconstruct a change log for work done so far, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A results section stating observations without evaluation. |
| **Non-example** | A results section explaining what the pattern means. |
...
**Student materials.** One copy of `Printouts/Seminar_03_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 2, kept in the student's folder.
...
**File.** `Printouts/Seminar_03_Printout.md`
...
> "A log with no entries after two years means the log was not kept."
...
**Exact wording.** "Put up a results section with interpretation woven through and ask where reporting stops."
...
**Target observation.** That reporting and interpreting are separable.
...
> "A results section reports observations. You just saw that when put up a results section with interpretation woven through and ask where reporting stops.
> Last time we said: A log with no entries after two years means the log was not kept. This is the next part of that.
...
**What students must not infer.** Whether the interpretation is correct.

### 4. Worked example

**The example.** A results section stating observations without evaluation.
...
**Completed answer.** A results section stating observations without evaluation. — which demonstrates that reporting and interpreting are separable.
...
**Conclusions not licensed.** Whether the interpretation is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A section cleaned of evaluative adverbs. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A results section explaining what the pattern means. Why is this not an
example?"
...
**Exact student instructions.** Write a results section with no interpretive language, peer-marked.
...
- *Licensed conclusion.* That reporting and interpreting are separable.
- *Not licensed.* Whether the interpretation is correct.
...
- *Expected response.* That reporting and interpreting are separable.
...
1. Any wording carrying the idea in `A results section reports observations`.
...
Say: "A reader must be able to reach a different conclusion from your results."

**Why this sentence matters.** It is the opening question of Seminar 4, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_03_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 2 — The Change Log |
| **Leads to** | Seminar 4 — Prespecified Versus Exploratory |

**Transition in.** Seminar 2 established participants document every modification and its cost. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants write results without interpretation. Seminar 4 assumes it and builds participants label every analysis honestly.
