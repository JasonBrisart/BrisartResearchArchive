# Lesson 22 Homework — Alternatives In Other Subjects

**Grade 5** · Invisible and Broken · **Quarter 3**
**Follows:** Lesson 22 — Alternatives In Other Subjects · **Points:** 5 · **Optional:** yes
...
Three cross-subject claims, each with an alternative and a separator.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces three with separators
...
Lesson 23 is **The Full Investigation**, which assumes you arrive holding it. Write one thing you expect it to be about:
