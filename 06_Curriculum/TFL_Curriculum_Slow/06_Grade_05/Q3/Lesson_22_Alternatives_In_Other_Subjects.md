# Lesson 22 — Alternatives In Other Subjects
...
| | |
|---|---|
| **Central question** | Alternatives In Other Subjects: students apply alternatives to a claim from another subject? |
| **Core concept** | Offering alternatives is a general habit. |
| **Student outcome** | Students apply alternatives to a claim from another subject. |
| **Previous lesson** | Lesson 21 — Choosing Between Explanations |
| **Next lesson** | Lesson 23 — The Full Investigation |
...
**The conceptual step.** Offering alternatives is a general habit. Applying it to outside claims prevents it being filed as a routine belonging to this lesson.
...
**What depends on it.** Lesson 23 — The Full Investigation — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Offering alternatives is a general habit. Applying it to outside claims prevents it being filed as a routine belonging to this lesson.
...
1. An alternative explanation for a science result.
2. A separator named for a historical claim.

### One non-example

An alternative from this lesson reused elsewhere.
...
| Statement | Status |
|---|---|
| Offering alternatives is a general habit. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 21 — Choosing Between Explanations — specifically: students identify evidence that separates two explanations.

**How it was taught.** Through the activity: for each alternative, name one separating observation

**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: for each alternative, name one separating observation, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An alternative explanation for a science result. |
| **Non-example** | An alternative from this lesson reused elsewhere. |
...
> "You choose by finding what they disagree about."
...
**Exact wording.** "Take a science or history claim and ask what else explains it."
...
> "Offering alternatives is a general habit. You just saw that when take a science or history claim and ask what else explains it.
> Last time we said: You choose by finding what they disagree about. This is the next part of that.
...
**The example.** An alternative explanation for a science result.
...
**Completed answer.** An alternative explanation for a science result. — which demonstrates that the habit transfers to any claim.
...
**Teacher prompt.** "Here is a second case. A separator named for a historical claim. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An alternative from this lesson reused elsewhere. Why is this not an
example?"
...
**Exact student instructions.** Three cross-subject claims, each with an alternative and a separator.
...
1. Any wording carrying the idea in `Offering alternatives is a general habit`.
...
Say: "It works on any claim, anywhere."
...
| | |
|---|---|
| **Follows** | Lesson 21 — Choosing Between Explanations |
| **Leads to** | Lesson 23 — The Full Investigation |

**Transition in.** Lesson 21 established students identify evidence that separates two explanations. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students apply alternatives to a claim from another subject. Lesson 23 assumes it and builds students run a complete investigation unaided.
