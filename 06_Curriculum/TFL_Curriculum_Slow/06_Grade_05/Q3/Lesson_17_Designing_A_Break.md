...
| | |
|---|---|
| **Central question** | Designing A Break: students design an engineered mismatch of their own? |
| **Core concept** | Designing a break requires establishing a pattern first. |
| **Student outcome** | Students design an engineered mismatch of their own. |
| **Previous lesson** | Lesson 16 — The Contradiction Review |
| **Next lesson** | Lesson 18 — The Failed Break |
...
**The conceptual step.** Designing a break requires establishing a pattern first. One repetition is not a pattern, so there is nothing to break.
...
**What depends on it.** Lesson 18 — The Failed Break — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Designing a break requires establishing a pattern first. One repetition is not a pattern, so there is nothing to break.
...
1. A break with four establishing repetitions.
2. A break that produced a visible reaction and was recorded.

### One non-example

A break attempted after a single repetition.
...
Whether their result matches the class figure.
...
| Statement | Status |
|---|---|
| Designing a break requires establishing a pattern first. | Framework-derived, appropriate at this grade |
| That the student can construct the method. | What this specific activity can show |
| Whether their result matches the class figure. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Contradiction Review — specifically: students consolidate contradiction.

**How it was taught.** Through the activity: review with eight cases classified and the deleted category defended against

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with eight cases classified and the deleted category defended against, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A break with four establishing repetitions. |
| **Non-example** | A break attempted after a single repetition. |
...
> "Next time: designing the break yourself."
...
**Exact wording.** "Say: you have been on the receiving end all year. Today you build one."
...
> "Designing a break requires establishing a pattern first. You just saw that when say: you have been on the receiving end all year.
> Last time we said: Next time: designing the break yourself. This is the next part of that.
...
**What students must not infer.** Whether their result matches the class figure.

### 4. Worked example

**The example.** A break with four establishing repetitions.
...
**Completed answer.** A break with four establishing repetitions. — which demonstrates that the student can construct the method.
...
**Conclusions not licensed.** Whether their result matches the class figure.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A break that produced a visible reaction and was recorded. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A break attempted after a single repetition. Why is this not an
example?"
...
**Exact student instructions.** Design and run a break on a partner, recording before, during, and after.
...
- *Not licensed.* Whether their result matches the class figure.
...
1. Any wording carrying the idea in `Designing a break requires establishing a pattern first`.
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Contradiction Review |
| **Leads to** | Lesson 18 — The Failed Break |

**Transition in.** Lesson 16 established students consolidate contradiction. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students design an engineered mismatch of their own. Lesson 18 assumes it and builds students analyse a break that produced no surprise.
