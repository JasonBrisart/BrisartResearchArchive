# Lesson 14 — Contradiction Elsewhere
...
| | |
|---|---|
| **Central question** | Contradiction Elsewhere: students find contradiction outside the classroom? |
| **Core concept** | Real contradictions occur constantly and can be classified using the same three outcomes as the classroom trials. |
| **Student outcome** | Students find contradiction outside the classroom. |
| **Previous lesson** | Lesson 13 — Stronger Contradictions |
| **Next lesson** | Lesson 15 — The Contradiction Log |
...
**The conceptual step.** Real contradictions occur constantly and can be classified using the same three outcomes as the classroom trials.
...
**What depends on it.** Lesson 15 — The Contradiction Log — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Real contradictions occur constantly and can be classified using the same three outcomes as the classroom trials.
...
1. A real contradiction classified as revision.
2. A real contradiction classified as suppression, with the return noted.

### One non-example

A contradiction described with no outcome named.
...
That the classification applies to real events.
...
| Statement | Status |
|---|---|
| Real contradictions occur constantly and can be classified using the same three outcomes as the classroom trials. | Framework-derived, appropriate at this grade |
| That the classification applies to real events. | What this specific activity can show |
| How often contradictions occur. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 13 — Stronger Contradictions — specifically: students test whether a stronger break changes the count.

**How it was taught.** Through the activity: compare a mild and a strong break on the same expectation

**Quick check.** Ask for the closing sentence of Lesson 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 13: compare a mild and a strong break on the same expectation, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A real contradiction classified as revision. |
| **Non-example** | A contradiction described with no outcome named. |
...
**Exact wording.** "Ask where something did not go how they expected this week."
...
**Target observation.** That the classification applies to real events.
...
> "Real contradictions occur constantly and can be classified using the same three outcomes as the classroom trials. You just saw that when ask where something did not go how they expected this week.
> Last time we said: Now you have two numbers to compare. This is the next part of that.
...
**What students must not infer.** How often contradictions occur.

### 4. Worked example

**The example.** A real contradiction classified as revision.
...
**Completed answer.** A real contradiction classified as revision. — which demonstrates that the classification applies to real events.
...
**Conclusions not licensed.** How often contradictions occur.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A real contradiction classified as suppression, with the return noted. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A contradiction described with no outcome named. Why is this not an
example?"
...
**Exact student instructions.** Three real contradictions classified into the three outcomes.
...
- *Licensed conclusion.* That the classification applies to real events.
- *Not licensed.* How often contradictions occur.
...
- *Expected response.* That the classification applies to real events.
...
1. Any wording carrying the idea in `Real contradictions occur constantly and can be classified using the same three outcomes as the classroom trials`.
...
Say: "It happens constantly. Now you can name what it did."
...
| | |
|---|---|
| **Follows** | Lesson 13 — Stronger Contradictions |
| **Leads to** | Lesson 15 — The Contradiction Log |

**Transition in.** Lesson 13 established students test whether a stronger break changes the count. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find contradiction outside the classroom. Lesson 15 assumes it and builds students begin a running log of contradictions.
