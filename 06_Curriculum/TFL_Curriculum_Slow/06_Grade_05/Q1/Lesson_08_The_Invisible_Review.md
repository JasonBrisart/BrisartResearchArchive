...
| | |
|---|---|
| **Central question** | The Invisible Review: students consolidate the quarter's work on invisibility? |
| **Core concept** | The break test is the quarter's method. |
| **Student outcome** | Students consolidate the quarter's work on invisibility. |
| **Previous lesson** | Lesson 7 — Invisible In Other Subjects |
| **Next lesson** | Lesson 9 — The Pattern Trial |
...
**The conceptual step.** The break test is the quarter's method. The review tests whether it is applied as a requirement rather than an option.
...
**What depends on it.** Lesson 9 — The Pattern Trial — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The break test is the quarter's method. The review tests whether it is applied as a requirement rather than an option.
...
1. A claimed expectation confirmed by the break test.
2. A claimed expectation rejected because breaking it would not surprise.

### One non-example

A claimed expectation accepted without testing.
...
Whether the break test is habitual.

### What this activity does not establish

Whether all claimed expectations are genuine.
...
| Statement | Status |
|---|---|
| The break test is the quarter's method. | Framework-derived, appropriate at this grade |
| Whether the break test is habitual. | What this specific activity can show |
| Whether all claimed expectations are genuine. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — Invisible In Other Subjects — specifically: students find invisible expectations in other lessons.

**How it was taught.** Through the activity: five cross-subject invisible expectations with break tests

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: five cross-subject invisible expectations with break tests, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A claimed expectation confirmed by the break test. |
| **Non-example** | A claimed expectation accepted without testing. |
...
**Exact wording.** "Ask why we break things on purpose."
...
**Target observation.** Whether the break test is habitual.
...
> "The break test is the quarter's method. You just saw that when ask why we break things on purpose.
> Last time we said: It is running in every lesson. This is the next part of that.
...
**What students must not infer.** Whether all claimed expectations are genuine.

### 4. Worked example

**The example.** A claimed expectation confirmed by the break test.
...
**Completed answer.** A claimed expectation confirmed by the break test. — which demonstrates whether the break test is habitual.
...
**Conclusions not licensed.** Whether all claimed expectations are genuine.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A claimed expectation rejected because breaking it would not surprise. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claimed expectation accepted without testing. Why is this not an
example?"
...
**Exact student instructions.** Review with six claimed expectations tested by the break test.
...
- *Licensed conclusion.* Whether the break test is habitual.
- *Not licensed.* Whether all claimed expectations are genuine.
...
- *Expected response.* Whether the break test is habitual.
...
1. Any wording carrying the idea in `The break test is the quarter's method`.
...
Say: "Next time: what breaking one actually does."
...
| | |
|---|---|
| **Follows** | Lesson 7 — Invisible In Other Subjects |
| **Leads to** | Lesson 9 — The Pattern Trial |

**Transition in.** Lesson 7 established students find invisible expectations in other lessons. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the quarter's work on invisibility. Lesson 9 assumes it and builds students record class expectations across a broken pattern.
