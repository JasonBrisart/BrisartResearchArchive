# Lesson 2 Homework — The Break Test

**Grade 5** · Invisible and Broken · **Quarter 1**
**Follows:** Lesson 2 — The Break Test · **Points:** 5 · **Optional:** yes
...
Apply the break test to the Lesson 1 list, with the break and the surprise level.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student applies the test to at least eight items
...
Lesson 3 is **Ranking By Surprise**, which assumes you arrive holding it. Write one thing you expect it to be about:
