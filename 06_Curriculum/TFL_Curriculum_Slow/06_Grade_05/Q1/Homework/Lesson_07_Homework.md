# Lesson 7 Homework — Invisible In Other Subjects

**Grade 5** · Invisible and Broken · **Quarter 1**
**Follows:** Lesson 7 — Invisible In Other Subjects · **Points:** 5 · **Optional:** yes
...
Five cross-subject invisible expectations with break tests.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces five from other subjects
...
Lesson 8 is **The Invisible Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
