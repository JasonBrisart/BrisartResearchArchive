# Lesson 7 — Invisible In Other Subjects
...
| | |
|---|---|
| **Central question** | Invisible In Other Subjects: students find invisible expectations in other lessons? |
| **Core concept** | Invisible expectations run in every lesson. |
| **Student outcome** | Students find invisible expectations in other lessons. |
| **Previous lesson** | Lesson 6 — The Chair Argument |
| **Next lesson** | Lesson 8 — The Invisible Review |
...
**The conceptual step.** Invisible expectations run in every lesson. Applying the break test in another subject prevents the method being filed as belonging here.
...
**What depends on it.** Lesson 8 — The Invisible Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Invisible expectations run in every lesson. Applying the break test in another subject prevents the method being filed as belonging here.
...
1. Expecting the numbers on the board to stay put.
2. Expecting the reading book to open the same way.

### One non-example

An expectation from this lesson written in another notebook.
...
That the method transfers to other lessons.
...
| Statement | Status |
|---|---|
| Invisible expectations run in every lesson. | Framework-derived, appropriate at this grade |
| That the method transfers to other lessons. | What this specific activity can show |
| Anything about those subjects. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — The Chair Argument — specifically: students construct the full argument for an invisible expectation.

**How it was taught.** Through the activity: build a three-step argument: no surprise, break test, therefore expectation

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: build a three-step argument: no surprise, break test, therefore expectation, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Expecting the numbers on the board to stay put. |
| **Non-example** | An expectation from this lesson written in another notebook. |
...
> "That is an argument, not a feeling."
...
**Exact wording.** "Ask what they expect in a maths lesson that they never notice."
...
**Target observation.** That the method transfers to other lessons.
...
> "Invisible expectations run in every lesson. You just saw that when ask what they expect in a maths lesson that they never notice.
> Last time we said: That is an argument, not a feeling. This is the next part of that.
...
**The example.** Expecting the numbers on the board to stay put.
...
**Completed answer.** Expecting the numbers on the board to stay put. — which demonstrates that the method transfers to other lessons.
...
**Teacher prompt.** "Here is a second case. Expecting the reading book to open the same way. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An expectation from this lesson written in another notebook. Why is this not an
example?"
...
**Exact student instructions.** Five cross-subject invisible expectations with break tests.
...
- *Licensed conclusion.* That the method transfers to other lessons.
...
- *Expected response.* That the method transfers to other lessons.
...
1. Any wording carrying the idea in `Invisible expectations run in every lesson`.
...
Say: "It is running in every lesson."
...
| | |
|---|---|
| **Follows** | Lesson 6 — The Chair Argument |
| **Leads to** | Lesson 8 — The Invisible Review |

**Transition in.** Lesson 6 established students construct the full argument for an invisible expectation. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find invisible expectations in other lessons. Lesson 8 assumes it and builds students consolidate the quarter's work on invisibility.
