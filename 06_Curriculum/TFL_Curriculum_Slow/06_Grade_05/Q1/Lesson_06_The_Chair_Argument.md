...
| | |
|---|---|
| **Central question** | The Chair Argument: students construct the full argument for an invisible expectation? |
| **Core concept** | The claim that an unnoticed expectation existed is established by a three-step argument, not by assertion. |
| **Student outcome** | Students construct the full argument for an invisible expectation. |
| **Previous lesson** | Lesson 5 — Why Invisible |
| **Next lesson** | Lesson 7 — Invisible In Other Subjects |
...
**The conceptual step.** The claim that an unnoticed expectation existed is established by a three-step argument, not by assertion. Numbering the steps makes the structure explicit.
...
**What depends on it.** Lesson 7 — Invisible In Other Subjects — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The claim that an unnoticed expectation existed is established by a three-step argument, not by assertion. Numbering the steps makes the structure explicit.
...
1. A numbered three-step argument about the chair.
2. A three-step argument about the door handle.

### One non-example

An assertion that of course they expected it.
...
That the claim rests on a reconstructable argument.

### What this activity does not establish

Whether the expectation was conscious.
...
| Statement | Status |
|---|---|
| The claim that an unnoticed expectation existed is established by a three-step argument, not by assertion. | Framework-derived, appropriate at this grade |
| That the claim rests on a reconstructable argument. | What this specific activity can show |
| Whether the expectation was conscious. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — Why Invisible — specifically: students explain why correct expectations leave no trace.

**How it was taught.** Through the activity: write an explanation, then test it against three cases

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: write an explanation, then test it against three cases, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A numbered three-step argument about the chair. |
| **Non-example** | An assertion that of course they expected it. |
...
> "Nothing to notice means it matched."
...
**Exact wording.** "Ask them to convince you they expected the chair to hold them."
...
**Target observation.** That the claim rests on a reconstructable argument.
...
> "The claim that an unnoticed expectation existed is established by a three-step argument, not by assertion. You just saw that when ask them to convince you they expected the chair to hold them.
> Last time we said: Nothing to notice means it matched. This is the next part of that.
...
**What students must not infer.** Whether the expectation was conscious.

### 4. Worked example

**The example.** A numbered three-step argument about the chair.
...
**Completed answer.** A numbered three-step argument about the chair. — which demonstrates that the claim rests on a reconstructable argument.
...
**Conclusions not licensed.** Whether the expectation was conscious.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A three-step argument about the door handle. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An assertion that of course they expected it. Why is this not an
example?"
...
**Exact student instructions.** Build a three-step argument: no surprise, break test, therefore expectation.
...
- *Licensed conclusion.* That the claim rests on a reconstructable argument.
- *Not licensed.* Whether the expectation was conscious.
...
- *Expected response.* That the claim rests on a reconstructable argument.
...
1. Any wording carrying the idea in `The claim that an unnoticed expectation existed is established by a three-step argument, not by assertion`.
...
Say: "That is an argument, not a feeling."
...
| | |
|---|---|
| **Follows** | Lesson 5 — Why Invisible |
| **Leads to** | Lesson 7 — Invisible In Other Subjects |

**Transition in.** Lesson 5 established students explain why correct expectations leave no trace. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students construct the full argument for an invisible expectation. Lesson 7 assumes it and builds students find invisible expectations in other lessons.
