...
| **Previous lesson** | Lesson 30 — The Year In Investigations |
...
**The conceptual step.** The practice final is a diagnostic. Self-marking against the key converts the score into a review list.
...
The practice final is a diagnostic. Self-marking against the key converts the score into a review list.
...
1. A student identifying the separator as their weak point.
2. A student finding their limits are still generic.
...
**Prerequisite.** The content of Lesson 30 — The Year In Investigations — specifically: students review the year using their own investigations.

**How it was taught.** Through the activity: order their own work and compare an early trial with a late one

**Quick check.** Ask for the closing sentence of Lesson 30. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 30: order their own work and compare an early trial with a late one, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student identifying the separator as their weak point. |
...
> "Next year: everything gets a proper name."
...
> Last time we said: Next year: everything gets a proper name. This is the next part of that.
...
**The example.** A student identifying the separator as their weak point.
...
**Completed answer.** A student identifying the separator as their weak point. — which demonstrates where each student is weakest.
...
**Teacher prompt.** "Here is a second case. A student finding their limits are still generic. Work it through with me."
...
| | |
|---|---|
| **Follows** | Lesson 30 — The Year In Investigations |
| **Leads to** | Lesson 32 — Final Assessment |

**Transition in.** Lesson 30 established students review the year using their own investigations. This lesson uses that as the starting point.
