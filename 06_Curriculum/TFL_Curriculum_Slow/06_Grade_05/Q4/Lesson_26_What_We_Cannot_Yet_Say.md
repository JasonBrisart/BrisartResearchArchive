# Lesson 26 — What We Cannot Yet Say
...
| | |
|---|---|
| **Central question** | What We Cannot Yet Say: students list the year's unanswered questions? |
| **Core concept** | Listing genuinely open questions requires distinguishing them from answered ones. |
| **Student outcome** | Students list the year's unanswered questions. |
| **Previous lesson** | Lesson 25 — When My Data Disagrees |
| **Next lesson** | Lesson 27 — The Honest Result |
...
**The conceptual step.** Listing genuinely open questions requires distinguishing them from answered ones. The sealed list becomes next year's opening check.
...
**What depends on it.** Lesson 27 — The Honest Result — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Listing genuinely open questions requires distinguishing them from answered ones. The sealed list becomes next year's opening check.
...
1. An open question about why expectations return.
2. An open question about what decides how long something sticks.

### One non-example

A question the year answered, listed as open.
...
That the student can identify what remains unanswered.

### What this activity does not establish

The answers, which are withheld.
...
| Statement | Status |
|---|---|
| Listing genuinely open questions requires distinguishing them from answered ones. | Framework-derived, appropriate at this grade |
| That the student can identify what remains unanswered. | What this specific activity can show |
| The answers, which are withheld. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — When My Data Disagrees — specifically: students report honestly a result that does not fit.

**How it was taught.** Through the activity: describe one poorly fitting case precisely, without explaining it away

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: describe one poorly fitting case precisely, without explaining it away, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An open question about why expectations return. |
| **Non-example** | A question the year answered, listed as open. |
...
**Exact wording.** "Put everything found that could not be explained on the board."
...
**Target observation.** That the student can identify what remains unanswered.
...
> "Listing genuinely open questions requires distinguishing them from answered ones. You just saw that when put everything found that could not be explained on the board.
...
**What students must not infer.** The answers, which are withheld.

### 4. Worked example

**The example.** An open question about why expectations return.
...
**Completed answer.** An open question about why expectations return. — which demonstrates that the student can identify what remains unanswered.
...
**Conclusions not licensed.** The answers, which are withheld.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An open question about what decides how long something sticks. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A question the year answered, listed as open. Why is this not an
example?"
...
**Exact student instructions.** Each student writes and seals a list of open questions for Grade 6.
...
- *Licensed conclusion.* That the student can identify what remains unanswered.
- *Not licensed.* The answers, which are withheld.
...
- *Expected response.* That the student can identify what remains unanswered.
...
1. Any wording carrying the idea in `Listing genuinely open questions requires distinguishing them from answered ones`.
...
Say: "Next year you get the proper names. Not all answers."
...
| | |
|---|---|
| **Follows** | Lesson 25 — When My Data Disagrees |
| **Leads to** | Lesson 27 — The Honest Result |

**Transition in.** Lesson 25 established students report honestly a result that does not fit. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students list the year's unanswered questions. Lesson 27 assumes it and builds students write a result with its limits stated.
