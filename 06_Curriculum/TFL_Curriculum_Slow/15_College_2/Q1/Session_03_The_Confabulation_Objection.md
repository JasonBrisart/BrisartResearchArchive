# Session 3 — The Confabulation Objection
...
| | |
|---|---|
| **Central question** | The Confabulation Objection: students state the objection that threatens all self-report? |
| **Core concept** | Confabulation is the construction of an expectation after the outcome. |
| **Student outcome** | Students state the objection that threatens all self-report. |
| **Previous session** | Session 2 — Is The Constraint Too Demanding |
| **Next session** | Session 4 — Prespecification |
...
**The conceptual step.** Confabulation is the construction of an expectation after the outcome. It threatens all retrospective self-report, and the subjective sense of genuineness is not evidence against it.
...
**What depends on it.** Session 4 — Prespecification — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Confabulation is the construction of an expectation after the outcome. It threatens all retrospective self-report, and the subjective sense of genuineness is not evidence against it.
...
1. An assessment that most retrospective entries are threatened.
2. The objection stated at full strength before any answer.

### One non-example

The objection dismissed because the reports felt authentic.
...
That the objection is serious and quantifiable.

### What this activity does not establish

Whether confabulation occurred.
...
| Statement | Status |
|---|---|
| Confabulation is the construction of an expectation after the outcome. | Framework-derived, appropriate at this grade |
| That the objection is serious and quantifiable. | What this specific activity can show |
| Whether confabulation occurred. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 2 — Is The Constraint Too Demanding — specifically: students argue whether in-principle falsifiability is enough.

**How it was taught.** Through the activity: write their current position and what evidence over the year would change it

**Quick check.** Ask for the closing sentence of Session 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 2: write their current position and what evidence over the year would change it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An assessment that most retrospective entries are threatened. |
| **Non-example** | The objection dismissed because the reports felt authentic. |
...
> "You are going to settle this for yourselves by attempting it."
...
**Exact wording.** "Run three engineered mismatches, then ask how they know they did not construct the expectation afterwards."
...
**Target observation.** That the objection is serious and quantifiable.
...
> "Confabulation is the construction of an expectation after the outcome. You just saw that when run three engineered mismatches, then ask how they know they did not construct the expectation afterwards.
> Last time we said: You are going to settle this for yourselves by attempting it. This is the next part of that.
...
**What students must not infer.** Whether confabulation occurred.

### 4. Worked example

**The example.** An assessment that most retrospective entries are threatened.
...
**Completed answer.** An assessment that most retrospective entries are threatened. — which demonstrates that the objection is serious and quantifiable.
...
**Conclusions not licensed.** Whether confabulation occurred.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The objection stated at full strength before any answer. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. The objection dismissed because the reports felt authentic. Why is this not an
example?"
...
**Exact student instructions.** State the objection in its strongest form and assess what proportion of their data it threatens.
...
- *Licensed conclusion.* That the objection is serious and quantifiable.
- *Not licensed.* Whether confabulation occurred.
...
- *Expected response.* That the objection is serious and quantifiable.
...
1. Any wording carrying the idea in `Confabulation is the construction of an expectation after the outcome`.
...
Say: "The answer is not clever. It is just timing."
...
| | |
|---|---|
| **Follows** | Session 2 — Is The Constraint Too Demanding |
| **Leads to** | Session 4 — Prespecification |

**Transition in.** Session 2 established students argue whether in-principle falsifiability is enough. This session uses that as the starting point.

**Transition out.** This session establishes students state the objection that threatens all self-report. Session 4 assumes it and builds students answer the confabulation objection with timing.
