# Session 7 — Is Self-Report Adequate At All
...
| | |
|---|---|
| **Central question** | Is Self-Report Adequate At All: students assess the limits of report-based measurement? |
| **Core concept** | Self-report can access content but not timing. |
| **Student outcome** | Students assess the limits of report-based measurement. |
| **Previous session** | Session 6 — Blind Coding And Reliability |
| **Next session** | Session 8 — Measuring Intensity |
...
**The conceptual step.** Self-report can access content but not timing. A hypothesis about within-window mechanism cannot be carried by report, and every complementary measure brings its own assumptions.
...
**What depends on it.** Session 8 — Measuring Intensity — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Self-report can access content but not timing. A hypothesis about within-window mechanism cannot be carried by report, and every complementary measure brings its own assumptions.
...
1. A content hypothesis report can carry.
2. A timing hypothesis report cannot carry.

### One non-example

A reaction-time complement proposed with no assumptions named.
...
That report has a stateable domain of adequacy.

### What this activity does not establish

Whether report is reliable.
...
| Statement | Status |
|---|---|
| Self-report can access content but not timing. | Framework-derived, appropriate at this grade |
| That report has a stateable domain of adequacy. | What this specific activity can show |
| Whether report is reliable. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 6 — Blind Coding And Reliability — specifically: students specify who scores and what they know.

**How it was taught.** Through the activity: specify the coding scheme, the scorer's knowledge, and how reliability is reported

**Quick check.** Ask for the closing sentence of Session 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 6: specify the coding scheme, the scorer's knowledge, and how reliability is reported, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A content hypothesis report can carry. |
| **Non-example** | A reaction-time complement proposed with no assumptions named. |
...
> "A scorer who knows the hypothesis is not a scorer."
...
**Exact wording.** "Assign two positions on whether report can access a 100 ms process."
...
**Target observation.** That report has a stateable domain of adequacy.
...
> "Self-report can access content but not timing. You just saw that when assign two positions on whether report can access a 100 ms process.
> Last time we said: A scorer who knows the hypothesis is not a scorer. This is the next part of that.
...
**What students must not infer.** Whether report is reliable.

### 4. Worked example

**The example.** A content hypothesis report can carry.
...
**Completed answer.** A content hypothesis report can carry. — which demonstrates that report has a stateable domain of adequacy.
...
**Conclusions not licensed.** Whether report is reliable.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A timing hypothesis report cannot carry. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A reaction-time complement proposed with no assumptions named. Why is this not an
example?"
...
**Exact student instructions.** Identify which of their hypotheses report can and cannot carry, and propose one complement.
...
- *Licensed conclusion.* That report has a stateable domain of adequacy.
- *Not licensed.* Whether report is reliable.
...
- *Expected response.* That report has a stateable domain of adequacy.
...
1. Any wording carrying the idea in `Self-report can access content but not timing`.
...
Say: "Report of content is not report of mechanism. But report is slow."
...
| | |
|---|---|
| **Follows** | Session 6 — Blind Coding And Reliability |
| **Leads to** | Session 8 — Measuring Intensity |

**Transition in.** Session 6 established students specify who scores and what they know. This session uses that as the starting point.

**Transition out.** This session establishes students assess the limits of report-based measurement. Session 8 assumes it and builds students build an E(t) instrument that avoids circularity.
