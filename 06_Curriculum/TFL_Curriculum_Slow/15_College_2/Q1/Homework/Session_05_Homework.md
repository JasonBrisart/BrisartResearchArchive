# Session 5 Homework — Capturing Sim(t)

**College Year 2** · Operationalisation and First Critique · **Quarter 1**
**Follows:** Session 5 — Capturing Sim(t) · **Points:** 5 · **Optional:** yes
...
Write the full protocol with verbatim prompt, timing, scoring, and three worked examples.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every protocol includes an unscoreable worked example
...
Session 6 is **Blind Coding And Reliability**, which assumes you arrive holding it. Write one thing you expect it to be about:
