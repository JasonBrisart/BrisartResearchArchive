# Session 4 Homework — Prespecification

**College Year 2** · Operationalisation and First Critique · **Quarter 1**
**Follows:** Session 4 — Prespecification · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 4 ended on, from memory:
...
Rebuild one dataset under prespecification rules and compute the survival rate.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student quantifies how much of their old data survives
...
Session 5 is **Capturing Sim(t)**, which assumes you arrive holding it. Write one thing you expect it to be about:
