...
| | |
|---|---|
| **Central question** | Construct Validity: students ask what their instrument actually measures? |
| **Core concept** | Construct validity asks whether the instrument measures what it claims. |
| **Student outcome** | Students ask what their instrument actually measures. |
| **Previous session** | Session 9 — Arousal As A Rival In Disguise |
| **Next session** | Session 11 — Persistence And Sampling |
...
**The conceptual step.** Construct validity asks whether the instrument measures what it claims. A technically flawless instrument can measure engagement, social desirability, or task demand instead.
...
**What depends on it.** Session 11 — Persistence And Sampling — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Construct validity asks whether the instrument measures what it claims. A technically flawless instrument can measure engagement, social desirability, or task demand instead.
...
1. Engagement named as a plausible alternative construct.
2. A method for distinguishing intensity from social desirability.

### One non-example

An implausible alternative named to fill the requirement.
...
That technical soundness does not establish validity.
...
| Statement | Status |
|---|---|
| Construct validity asks whether the instrument measures what it claims. | Framework-derived, appropriate at this grade |
| That technical soundness does not establish validity. | What this specific activity can show |
| What the instrument measures. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 9 — Arousal As A Rival In Disguise — specifically: students separate intensity from general activation.

**How it was taught.** Through the activity: add a separate activation index and state how the two measures are distinguished

**Quick check.** Ask for the closing sentence of Session 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 9: add a separate activation index and state how the two measures are distinguished, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Engagement named as a plausible alternative construct. |
| **Non-example** | An implausible alternative named to fill the requirement. |
...
> "This is the arousal rival appearing as a measurement problem."
...
**Target observation.** That technical soundness does not establish validity.
...
> "Construct validity asks whether the instrument measures what it claims. You just saw that when put a technically sound instrument up and ask what it is measuring.
> Last time we said: This is the arousal rival appearing as a measurement problem. This is the next part of that.
...
**What students must not infer.** What the instrument measures.

### 4. Worked example

**The example.** Engagement named as a plausible alternative construct.
...
**Completed answer.** Engagement named as a plausible alternative construct. — which demonstrates that technical soundness does not establish validity.
...
**Conclusions not licensed.** What the instrument measures.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A method for distinguishing intensity from social desirability. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An implausible alternative named to fill the requirement. Why is this not an
example?"
...
**Exact student instructions.** Name three plausible alternative constructs per instrument and how to distinguish them.
...
- *Licensed conclusion.* That technical soundness does not establish validity.
- *Not licensed.* What the instrument measures.
...
- *Expected response.* That technical soundness does not establish validity.
...
1. Any wording carrying the idea in `Construct validity asks whether the instrument measures what it claims`.
...
Say: "An instrument that runs perfectly can still measure the wrong thing."
...
| | |
|---|---|
| **Follows** | Session 9 — Arousal As A Rival In Disguise |
| **Leads to** | Session 11 — Persistence And Sampling |

**Transition in.** Session 9 established students separate intensity from general activation. This session uses that as the starting point.

**Transition out.** This session establishes students ask what their instrument actually measures. Session 11 assumes it and builds students prespecify a criterion and justify an interval.
