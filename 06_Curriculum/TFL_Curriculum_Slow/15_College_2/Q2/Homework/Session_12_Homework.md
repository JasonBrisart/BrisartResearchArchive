# Session 12 Homework — The Measurement Map

**College Year 2** · Operationalisation and First Critique · **Quarter 2**
**Follows:** Session 12 — The Measurement Map · **Points:** 5 · **Optional:** yes
...
Build the map and have two classmates mark unrunnable lines independently.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** at least one marker returns zero questions
...
Session 13 is **The External Run**, which assumes you arrive holding it. Write one thing you expect it to be about:
