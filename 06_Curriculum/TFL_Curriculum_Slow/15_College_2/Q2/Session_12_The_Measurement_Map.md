# Session 12 — The Measurement Map
...
| | |
|---|---|
| **Central question** | The Measurement Map: students assemble all instruments into a seven-line map? |
| **Core concept** | Executability is established by independent handover. |
| **Student outcome** | Students assemble all instruments into a seven-line map. |
| **Previous session** | Session 11 — Persistence And Sampling |
| **Next session** | Session 13 — The External Run |
...
**The conceptual step.** Executability is established by independent handover. A single clean run may reflect a charitable reader rather than a complete map.
...
**What depends on it.** Session 13 — The External Run — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Executability is established by independent handover. A single clean run may reflect a charitable reader rather than a complete map.
...
2. A map revised after the first marker found three gaps.

### One non-example

A map declared executable after one reader had no questions.
...
That executability is testable by independent handover.
...
| Statement | Status |
|---|---|
| Executability is established by independent handover. | Framework-derived, appropriate at this grade |
| That executability is testable by independent handover. | What this specific activity can show |
| Whether the map yields valid data. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 11 — Persistence And Sampling — specifically: students prespecify a criterion and justify an interval.

**How it was taught.** Through the activity: complete both specifications and identify a post-hoc vulnerability

**Quick check.** Ask for the closing sentence of Session 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 11: complete both specifications and identify a post-hoc vulnerability, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A map declared executable after one reader had no questions. |
...
> "Naming how it could be gamed is what stops you gaming it."
...
**Exact wording.** "Say: seven lines. If somebody cannot run your study from them, it is not a map."
...
**Target observation.** That executability is testable by independent handover.
...
> "Executability is established by independent handover. You just saw that when say: seven lines.
> Last time we said: Naming how it could be gamed is what stops you gaming it. This is the next part of that.
...
**Completed answer.** A map returning zero questions from one of two markers. — which demonstrates that executability is testable by independent handover.
...
**Teacher prompt.** "Here is a second case. A map revised after the first marker found three gaps. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A map declared executable after one reader had no questions. Why is this not an
example?"
...
**Exact student instructions.** Build the map and have two classmates mark unrunnable lines independently.
...
- *Licensed conclusion.* That executability is testable by independent handover.
...
- *Expected response.* That executability is testable by independent handover.
...
1. Any wording carrying the idea in `Executability is established by independent handover`.
...
| | |
|---|---|
| **Follows** | Session 11 — Persistence And Sampling |
| **Leads to** | Session 13 — The External Run |

**Transition in.** Session 11 established students prespecify a criterion and justify an interval. This session uses that as the starting point.

**Transition out.** This session establishes students assemble all instruments into a seven-line map. Session 13 assumes it and builds students test protocols by handing them to somebody else.
