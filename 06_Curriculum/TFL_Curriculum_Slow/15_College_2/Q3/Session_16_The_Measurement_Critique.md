# Session 16 — The Measurement Critique
...
| | |
|---|---|
| **Central question** | The Measurement Critique: students critique a measurement claim in writing? |
| **Core concept** | A measurement critique evaluates whether the study supports its own claim. |
| **Student outcome** | Students critique a measurement claim in writing. |
| **Previous session** | Session 15 — Repairing A Protocol |
| **Next session** | Session 17 — What The Study Could Legitimately Claim |
...
**The conceptual step.** A measurement critique evaluates whether the study supports its own claim. Critiquing the framework instead is a different and easier task.
...
**What depends on it.** Session 17 — What The Study Could Legitimately Claim — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A measurement critique evaluates whether the study supports its own claim. Critiquing the framework instead is a different and easier task.
...
1. A critique naming retrospective collection as a failure.
2. A critique naming absent blind coding.

### One non-example

A critique arguing the framework is implausible.
...
That measurement critique is separable from framework critique.
...
| Statement | Status |
|---|---|
| A measurement critique evaluates whether the study supports its own claim. | Framework-derived, appropriate at this grade |
| That measurement critique is separable from framework critique. | What this specific activity can show |
| Whether the framework is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 15 — Repairing A Protocol — specifically: students revise against external-run feedback.

**How it was taught.** Through the activity: repair the protocol and run a second external test

**Quick check.** Ask for the closing sentence of Session 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 15: repair the protocol and run a second external test, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A critique naming retrospective collection as a failure. |
| **Non-example** | A critique arguing the framework is implausible. |
...
> "If the second run matches the first, the repair missed."
...
**Exact wording.** "Put up a flawed published-style claim and say: critique the measurement, not the framework."
...
**Target observation.** That measurement critique is separable from framework critique.
...
> "A measurement critique evaluates whether the study supports its own claim. You just saw that when put up a flawed published-style claim and say: critique the measurement, not the framework.
> Last time we said: If the second run matches the first, the repair missed. This is the next part of that.
...
**The example.** A critique naming retrospective collection as a failure.
...
**Completed answer.** A critique naming retrospective collection as a failure. — which demonstrates that measurement critique is separable from framework critique.
...
**Teacher prompt.** "Here is a second case. A critique naming absent blind coding. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A critique arguing the framework is implausible. Why is this not an
example?"
...
**Exact student instructions.** Produce a written critique naming at least six specific measurement failures.
...
- *Licensed conclusion.* That measurement critique is separable from framework critique.
...
- *Expected response.* That measurement critique is separable from framework critique.
...
1. Any wording carrying the idea in `A measurement critique evaluates whether the study supports its own claim`.
...
Say: "Critique the measurement, not the framework. Different jobs."
...
| | |
|---|---|
| **Follows** | Session 15 — Repairing A Protocol |
| **Leads to** | Session 17 — What The Study Could Legitimately Claim |

**Transition in.** Session 15 established students revise against external-run feedback. This session uses that as the starting point.

**Transition out.** This session establishes students critique a measurement claim in writing. Session 17 assumes it and builds students state the weaker claim a flawed design supports.
