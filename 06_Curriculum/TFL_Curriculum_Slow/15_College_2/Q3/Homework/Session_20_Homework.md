# Session 20 Homework — Complementary Measures

**College Year 2** · Operationalisation and First Critique · **Quarter 3**
**Follows:** Session 20 — Complementary Measures · **Points:** 5 · **Optional:** yes
...
Propose two complementary measures and state the assumptions each brings.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every proposal states its assumptions
...
Session 21 is **The Complete Protocol**, which assumes you arrive holding it. Write one thing you expect it to be about:
