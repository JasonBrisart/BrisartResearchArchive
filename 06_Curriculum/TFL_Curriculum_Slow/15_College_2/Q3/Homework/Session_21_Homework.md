# Session 21 Homework — The Complete Protocol

**College Year 2** · Operationalisation and First Critique · **Quarter 3**
**Follows:** Session 21 — The Complete Protocol · **Points:** 5 · **Optional:** yes
...
Assemble the complete package and swap for a full audit.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every package contains all six components
...
Session 22 is **Defending The Protocol**, which assumes you arrive holding it. Write one thing you expect it to be about:
