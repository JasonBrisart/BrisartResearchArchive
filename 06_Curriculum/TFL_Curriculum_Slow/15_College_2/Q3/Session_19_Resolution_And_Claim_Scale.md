# Session 19 — Resolution And Claim Scale
...
| | |
|---|---|
| **Central question** | Resolution And Claim Scale: students match claim scale to observation scale? |
| **Core concept** | A resolution declaration matches claim scale to observation scale. |
| **Student outcome** | Students match claim scale to observation scale. |
| **Previous session** | Session 18 — Critiquing Your Own Protocol |
| **Next session** | Session 20 — Complementary Measures |
...
**The conceptual step.** A resolution declaration matches claim scale to observation scale. It names the conclusions the design does not license rather than stating that limitations exist.
...
**What depends on it.** Session 20 — Complementary Measures — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A resolution declaration matches claim scale to observation scale. It names the conclusions the design does not license rather than stating that limitations exist.
...
1. A declaration excluding within-window conclusions explicitly.
2. A named conclusion the design cannot support.

### One non-example

A declaration stating that the study has limitations.
...
That claim and observation scale must match.
...
| Statement | Status |
|---|---|
| A resolution declaration matches claim scale to observation scale. | Framework-derived, appropriate at this grade |
| That claim and observation scale must match. | What this specific activity can show |
| Whether the design is otherwise sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 18 — Critiquing Your Own Protocol — specifically: students apply the critique standard to their own work.

**How it was taught.** Through the activity: self-critique naming at least four failures in their own protocol

**Quick check.** Ask for the closing sentence of Session 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 18: self-critique naming at least four failures in their own protocol, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A declaration excluding within-window conclusions explicitly. |
| **Non-example** | A declaration stating that the study has limitations. |
...
**Exact wording.** "Say: the framework specifies milliseconds. You observe at minutes. What follows?"
...
**Target observation.** That claim and observation scale must match.
...
> "A resolution declaration matches claim scale to observation scale. You just saw that when say: the framework specifies milliseconds.
...
**The example.** A declaration excluding within-window conclusions explicitly.
...
**Completed answer.** A declaration excluding within-window conclusions explicitly. — which demonstrates that claim and observation scale must match.
...
**Teacher prompt.** "Here is a second case. A named conclusion the design cannot support. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A declaration stating that the study has limitations. Why is this not an
example?"
...
**Exact student instructions.** Write a resolution declaration naming conclusions not licensed.
...
- *Licensed conclusion.* That claim and observation scale must match.
...
- *Expected response.* That claim and observation scale must match.
...
1. Any wording carrying the idea in `A resolution declaration matches claim scale to observation scale`.
...
Say: "It is not modesty. It is what makes your result interpretable."
...
| | |
|---|---|
| **Follows** | Session 18 — Critiquing Your Own Protocol |
| **Leads to** | Session 20 — Complementary Measures |

**Transition in.** Session 18 established students apply the critique standard to their own work. This session uses that as the starting point.

**Transition out.** This session establishes students match claim scale to observation scale. Session 20 assumes it and builds students propose a non-report measure and its assumptions.
