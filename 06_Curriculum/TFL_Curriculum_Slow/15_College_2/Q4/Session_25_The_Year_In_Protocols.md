# Session 25 — The Year In Protocols
...
| | |
|---|---|
| **Central question** | The Year In Protocols: students review the year through their own protocols? |
| **Core concept** | Comparing the first protocol draft with the final gives direct evidence of the year's progress in operationalisation. |
| **Student outcome** | Students review the year through their own protocols. |
| **Previous session** | Session 24 — Measurement In Your Own Field |
...
**The conceptual step.** Comparing the first protocol draft with the final gives direct evidence of the year's progress in operationalisation.
...
Comparing the first protocol draft with the final gives direct evidence of the year's progress in operationalisation.
...
1. A Session 5 draft beside the final package.
2. A student noticing their first draft described rather than specified.

### One non-example

Reviewing only the final version.
...
That measurement work improved measurably.
...
| Statement | Status |
|---|---|
| Comparing the first protocol draft with the final gives direct evidence of the year's progress in operationalisation. | Framework-derived, appropriate at this grade |
| That measurement work improved measurably. | What this specific activity can show |
| Any external quality standard. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 24 — Measurement In Your Own Field — specifically: students compare measurement standards with their own discipline.

**How it was taught.** Through the activity: compare three measurement practices from their own field against this course's standard

**Quick check.** Ask for the closing sentence of Session 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 24: compare three measurement practices from their own field against this course's standard, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Session 5 draft beside the final package. |
| **Non-example** | Reviewing only the final version. |
...
> "Every field has this problem. Some handle it better."
...
**Exact wording.** "Lay out every protocol version from the year."
...
**Target observation.** That measurement work improved measurably.
...
> "Comparing the first protocol draft with the final gives direct evidence of the year's progress in operationalisation. You just saw that when lay out every protocol version from the year.
> Last time we said: Every field has this problem. Some handle it better. This is the next part of that.
...
**The example.** A Session 5 draft beside the final package.
...
**Completed answer.** A Session 5 draft beside the final package. — which demonstrates that measurement work improved measurably.
...
**Teacher prompt.** "Here is a second case. A student noticing their first draft described rather than specified. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reviewing only the final version. Why is this not an
example?"
...
**Exact student instructions.** Compare the first draft with the final and write what changed.
...
- *Licensed conclusion.* That measurement work improved measurably.
...
- *Expected response.* That measurement work improved measurably.
...
1. Any wording carrying the idea in `Comparing the first protocol draft with the final gives direct evidence of the year's progress in operationalisation`.
...
Say: "Next year: three accounts that explain your data as well as this one."
...
| | |
|---|---|
| **Follows** | Session 24 — Measurement In Your Own Field |
| **Leads to** | Session 26 — Practice Final |

**Transition in.** Session 24 established students compare measurement standards with their own discipline. This session uses that as the starting point.

**Transition out.** This session establishes students review the year through their own protocols. Session 26 assumes it and builds students rehearse the final under conditions.
