...
| | |
|---|---|
| **Central question** | Final Assessment: students demonstrate integrated command of measurement? |
| **Core concept** | The five outcomes together constitute readiness for Year 3, which introduces formal adjudication against rival accounts. |
| **Student outcome** | Students demonstrate integrated command of measurement. |
| **Previous session** | Session 27 — Final Preparation |
...
| **Student printout** | `Printouts/Session_28_Printout.md` |
| **Homework** | `Homework/Session_28_Homework.md` |

## Why this lesson exists

**The conceptual step.** The five outcomes together constitute readiness for Year 3, which introduces formal adjudication against rival accounts.
...
The five outcomes together constitute readiness for Year 3, which introduces formal adjudication against rival accounts.
...
1. A paper demonstrating all five outcomes.
2. A measurement critique naming six specific failures.

### One non-example

A paper with four outcomes and the critique unattempted.
...
Whether the outcomes are demonstrated.
...
| Statement | Status |
|---|---|
| The five outcomes together constitute readiness for Year 3, which introduces formal adjudication against rival accounts. | Framework-derived, appropriate at this grade |
| Whether the outcomes are demonstrated. | What this specific activity can show |
| Whether the protocols are valid. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 27 — Final Preparation — specifically: students address the weaknesses the practice final revealed.

**How it was taught.** Through the activity: targeted review of each student's two weakest areas

**Quick check.** Ask for the closing sentence of Session 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 27: targeted review of each student's two weakest areas, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A paper demonstrating all five outcomes. |
| **Non-example** | A paper with four outcomes and the critique unattempted. |
...
**Student materials.** One copy of `Printouts/Session_28_Printout.md` per student.

**Prior student data required.** Work produced in Session 27, kept in the student's folder.
...
**File.** `Printouts/Session_28_Printout.md`
...
> "That is the last useful thing before the final."
...
**Exact wording.** "Say: everything you know about measuring this properly."
...
**Target observation.** Whether the outcomes are demonstrated.
...
> "The five outcomes together constitute readiness for Year 3, which introduces formal adjudication against rival accounts. You just saw that when say: everything you know about measuring this properly.
> Last time we said: That is the last useful thing before the final. This is the next part of that.
...
**The example.** A paper demonstrating all five outcomes.
...
**Completed answer.** A paper demonstrating all five outcomes. — which demonstrates whether the outcomes are demonstrated.
...
**Teacher prompt.** "Here is a second case. A measurement critique naming six specific failures. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A paper with four outcomes and the critique unattempted. Why is this not an
example?"
...
**Exact student instructions.** The final: a map, a Sim(t) protocol, an E(t) audit, construct validity, a measurement critique.
...
- *Licensed conclusion.* Whether the outcomes are demonstrated.
...
- *Expected response.* Whether the outcomes are demonstrated.
...
1. Any wording carrying the idea in `The five outcomes together constitute readiness for Year 3, which introduces formal adjudication against rival accounts`.
...
Say: "Next year: three other explanations that fit your result as well."
...
**File.** `Homework/Session_28_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 27 — Final Preparation |
| **Leads to** | The final examination. |

**Transition in.** Session 27 established students address the weaknesses the practice final revealed. This session uses that as the starting point.
