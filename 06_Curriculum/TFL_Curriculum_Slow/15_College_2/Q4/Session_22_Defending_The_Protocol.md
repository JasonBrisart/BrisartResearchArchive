# Session 22 — Defending The Protocol

**College Year 2** · Operationalisation and First Critique · **Quarter 4** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Defending The Protocol: students defend measurement choices under challenge? |
| **Core concept** | An instrument is defended by addressing what else it might capture, not by restating what it was intended to capture. |
| **Student outcome** | Students defend measurement choices under challenge. |
| **Previous session** | Session 21 — The Complete Protocol |
| **Next session** | Session 23 — What I Could Not Measure |
...
**The conceptual step.** An instrument is defended by addressing what else it might capture, not by restating what it was intended to capture. Intent is not validity.
...
**What depends on it.** Session 23 — What I Could Not Measure — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An instrument is defended by addressing what else it might capture, not by restating what it was intended to capture. Intent is not validity.
...
1. A defence naming and excluding an alternative construct.
2. A defence conceding an instrument may capture engagement.

### One non-example

A defence restating what the instrument was designed to measure.
...
Whether measurement choices can be defended.
...
| Statement | Status |
|---|---|
| An instrument is defended by addressing what else it might capture, not by restating what it was intended to capture. | Framework-derived, appropriate at this grade |
| Whether measurement choices can be defended. | What this specific activity can show |
| Whether the instruments are valid. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 21 — The Complete Protocol — specifically: students assemble a full measurement package.

**How it was taught.** Through the activity: assemble the complete package and swap for a full audit

**Quick check.** Ask for the closing sentence of Session 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 21: assemble the complete package and swap for a full audit, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence naming and excluding an alternative construct. |
| **Non-example** | A defence restating what the instrument was designed to measure. |
...
> "That is a measurement package. Next year it gets adjudicated."
...
**Exact wording.** "Say: present the map, the instruments, the criterion, and what it cannot see."
...
**Target observation.** Whether measurement choices can be defended.
...
> "An instrument is defended by addressing what else it might capture, not by restating what it was intended to capture. You just saw that when say: present the map, the instruments, the criterion, and what it cannot see.
> Last time we said: That is a measurement package. Next year it gets adjudicated. This is the next part of that.
...
**What students must not infer.** Whether the instruments are valid.

### 4. Worked example

**The example.** A defence naming and excluding an alternative construct.
...
**Completed answer.** A defence naming and excluding an alternative construct. — which demonstrates whether measurement choices can be defended.
...
**Conclusions not licensed.** Whether the instruments are valid.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A defence conceding an instrument may capture engagement. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence restating what the instrument was designed to measure. Why is this not an
example?"
...
**Exact student instructions.** A six-minute presentation facing questions on validity, circularity, and runnability.
...
- *Licensed conclusion.* Whether measurement choices can be defended.
- *Not licensed.* Whether the instruments are valid.
...
- *Expected response.* Whether measurement choices can be defended.
...
1. Any wording carrying the idea in `An instrument is defended by addressing what else it might capture, not by restating what it was intended to capture`.
...
Say: "Intent is not validity. What else could it be picking up?"
...
| | |
|---|---|
| **Follows** | Session 21 — The Complete Protocol |
| **Leads to** | Session 23 — What I Could Not Measure |

**Transition in.** Session 21 established students assemble a full measurement package. This session uses that as the starting point.

**Transition out.** This session establishes students defend measurement choices under challenge. Session 23 assumes it and builds students catalogue what resisted measurement this year.
