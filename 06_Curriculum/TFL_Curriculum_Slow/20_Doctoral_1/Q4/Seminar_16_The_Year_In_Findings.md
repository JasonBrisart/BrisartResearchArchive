# Seminar 16 — The Year In Findings
...
| | |
|---|---|
| **Central question** | The Year In Findings: participants review the year's collective findings? |
| **Core concept** | A consolidated gap register produced by a cohort is a genuine contribution to the literature rather than a course exercise. |
| **Student outcome** | Participants review the year's collective findings. |
| **Previous seminar** | Seminar 15 — Audit Review |
...
**The conceptual step.** A consolidated gap register produced by a cohort is a genuine contribution to the literature rather than a course exercise.
...
A consolidated gap register produced by a cohort is a genuine contribution to the literature rather than a course exercise.
...
1. A register with fifteen entries ranked by dependency.
2. A discussion of who outside the seminar should receive it.

### One non-example

A register filed as coursework with no circulation considered.
...
That cohort work can constitute a contribution.
...
| Statement | Status |
|---|---|
| A consolidated gap register produced by a cohort is a genuine contribution to the literature rather than a course exercise. | Framework-derived, appropriate at this grade |
| That cohort work can constitute a contribution. | What this specific activity can show |
| Whether the register is complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 15 — Audit Review — specifically: participants defend the audit and their field placement.

**How it was taught.** Through the activity: present the audit, ranking, rivals, and placement against three challengers

**Quick check.** Ask for the closing sentence of Seminar 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 15: present the audit, ranking, rivals, and placement against three challengers, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A register with fifteen entries ranked by dependency. |
| **Non-example** | A register filed as coursework with no circulation considered. |
...
> "Next year you turn the strongest of these into original critique."
...
**Exact wording.** "Put every audit entry from the cohort on the board, pooled and sorted."
...
**Target observation.** That cohort work can constitute a contribution.
...
> "A consolidated gap register produced by a cohort is a genuine contribution to the literature rather than a course exercise. You just saw that when put every audit entry from the cohort on the board, pooled and sorted.
> Last time we said: Next year you turn the strongest of these into original critique. This is the next part of that.
...
**What students must not infer.** Whether the register is complete.

### 4. Worked example

**The example.** A register with fifteen entries ranked by dependency.
...
**Completed answer.** A register with fifteen entries ranked by dependency. — which demonstrates that cohort work can constitute a contribution.
...
**Conclusions not licensed.** Whether the register is complete.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A discussion of who outside the seminar should receive it. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A register filed as coursework with no circulation considered. Why is this not an
example?"
...
**Exact student instructions.** Build the cohort's consolidated gap register with rankings.
...
- *Licensed conclusion.* That cohort work can constitute a contribution.
- *Not licensed.* Whether the register is complete.
...
- *Expected response.* That cohort work can constitute a contribution.
...
1. Any wording carrying the idea in `A consolidated gap register produced by a cohort is a genuine contribution to the literature rather than a course exercise`.
...
Say: "That register is a real contribution, and it did not exist in September."
...
| | |
|---|---|
| **Follows** | Seminar 15 — Audit Review |
| **Leads to** | The final examination. |

**Transition in.** Seminar 15 established participants defend the audit and their field placement. This seminar uses that as the starting point.
