# Seminar 14 Homework — Revising The Audit

**Doctoral Year 1** · Specification Audit · **Quarter 4**
**Follows:** Seminar 14 — Revising The Audit · **Points:** 5 · **Optional:** yes
...
Revise the document and log every change with its source.
...
Seminar 15 is **Audit Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
