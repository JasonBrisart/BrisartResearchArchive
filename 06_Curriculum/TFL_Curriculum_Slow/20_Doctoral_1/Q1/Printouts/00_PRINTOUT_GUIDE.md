...
|---|---|---|---|---|---|---|
| `Seminar_01_Printout.md` | Seminar 1 — The Framework As Object Of Study | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Seminar_02_Printout.md` | Seminar 2 — Reading For Silence | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 1 work |
| `Seminar_03_Printout.md` | Seminar 3 — Sorting The Gaps | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 2 work |
| `Seminar_04_Printout.md` | Seminar 4 — Ranking By What Rests On Them | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Seminar 3 work |
...
**Seminar 3 — Sorting The Gaps.** If you only have time to print one
