...
| | |
|---|---|
| **Central question** | Auditing Conditions: students audit a partner's falsification conditions? |
| **Core concept** | An audit traces the firing pathway independently rather than accepting the author's assertion that the condition could fire. |
| **Student outcome** | Students audit a partner's falsification conditions. |
| **Previous lesson** | Lesson 6 — Conditions For Other Claims |
| **Next lesson** | Lesson 8 — The Falsification Review |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_07_Printout.md` |
| **Homework** | `Homework/Lesson_07_Homework.md` |

## Why this lesson exists

**The conceptual step.** An audit traces the firing pathway independently rather than accepting the author's assertion that the condition could fire.
...
**What depends on it.** Lesson 8 — The Falsification Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An audit traces the firing pathway independently rather than accepting the author's assertion that the condition could fire.
...
1. An audit tracing a pathway and confirming it.
2. An audit tracing a pathway and finding it cannot fire.

### One non-example

An audit accepting the author's claim that the condition works.
...
Whether the conditions are good.
...
| Statement | Status |
|---|---|
| An audit traces the firing pathway independently rather than accepting the author's assertion that the condition could fire. | Framework-derived, appropriate at this grade |
| That firing claims require independent tracing. | What this specific activity can show |
| Whether the conditions are good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — Conditions For Other Claims — specifically: students write falsification conditions for non-TFL claims.

**How it was taught.** Through the activity: write falsification conditions for three outside claims

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: write falsification conditions for three outside claims, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit tracing a pathway and confirming it. |
| **Non-example** | An audit accepting the author's claim that the condition works. |
...
**Student materials.** One copy of `Printouts/Lesson_07_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 6, kept in the student's folder.
...
**File.** `Printouts/Lesson_07_Printout.md`
...
> "Some public claims have no possible disconfirming result. Now you can see that."
...
**Exact wording.** "Say: check theirs against the four requirements. Trace the firing pathway yourself."
...
> "An audit traces the firing pathway independently rather than accepting the author's assertion that the condition could fire. You just saw that when say: check theirs against the four requirements.
> Last time we said: Some public claims have no possible disconfirming result. Now you can see that. This is the next part of that.
...
**What students must not infer.** Whether the conditions are good.

### 4. Worked example

**The example.** An audit tracing a pathway and confirming it.
...
**Completed answer.** An audit tracing a pathway and confirming it. — which demonstrates that firing claims require independent tracing.
...
**Conclusions not licensed.** Whether the conditions are good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An audit tracing a pathway and finding it cannot fire. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit accepting the author's claim that the condition works. Why is this not an
example?"
...
**Exact student instructions.** Audit a partner's four conditions and trace each pathway.
...
- *Not licensed.* Whether the conditions are good.
...
1. Any wording carrying the idea in `An audit traces the firing pathway independently rather than accepting the author's assertion that the condition could fire`.
...
Say: "The author saying it fires is not evidence that it does."

**Why this sentence matters.** It is the opening question of Lesson 8, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_07_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 6 — Conditions For Other Claims |
| **Leads to** | Lesson 8 — The Falsification Review |

**Transition in.** Lesson 6 established students write falsification conditions for non-TFL claims. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit a partner's falsification conditions. Lesson 8 assumes it and builds students consolidate falsification.
