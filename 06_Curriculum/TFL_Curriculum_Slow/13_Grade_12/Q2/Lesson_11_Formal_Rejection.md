# Lesson 11 — Formal Rejection

**Grade 12** · Falsification and Scope · **Quarter 2** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Formal Rejection: students reject an invalid application in the required form? |
| **Core concept** | A formal rejection names the proposal, the boundary violated, and the level of analysis where the question does belong. |
| **Student outcome** | Students reject an invalid application in the required form. |
| **Previous lesson** | Lesson 10 — Simulations Are Not Wishes |
| **Next lesson** | Lesson 12 — The Clinical Case |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_11_Printout.md` |
| **Homework** | `Homework/Lesson_11_Homework.md` |

## Why this lesson exists

**The conceptual step.** A formal rejection names the proposal, the boundary violated, and the level of analysis where the question does belong. Rejection is redirection, not dismissal.
...
**What depends on it.** Lesson 12 — The Clinical Case — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A formal rejection names the proposal, the boundary violated, and the level of analysis where the question does belong. Rejection is redirection, not dismissal.
...
1. A rejection naming the timescale boundary and redirecting to developmental work.
2. A rejection naming the clinical exclusion and redirecting appropriately.

### One non-example

A rejection naming the boundary with no alternative level.
...
That rejection has a required form.

### What this activity does not establish

Whether the redirected question is answerable.
...
| Statement | Status |
|---|---|
| A formal rejection names the proposal, the boundary violated, and the level of analysis where the question does belong. | Framework-derived, appropriate at this grade |
| That rejection has a required form. | What this specific activity can show |
| Whether the redirected question is answerable. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 10 — Simulations Are Not Wishes — specifically: students state what a simulation is treated as.

**How it was taught.** Through the activity: rewrite six agency-laden statements in non-agentive terms

**Quick check.** Ask for the closing sentence of Lesson 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 10: rewrite six agency-laden statements in non-agentive terms, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A rejection naming the timescale boundary and redirecting to developmental work. |
| **Non-example** | A rejection naming the boundary with no alternative level. |
...
**Student materials.** One copy of `Printouts/Lesson_11_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 10, kept in the student's folder.
...
**File.** `Printouts/Lesson_11_Printout.md`
...
> "The moment somebody says the system wants something, it has been misread."
...
**Exact wording.** "Put up the clinical proposal and ask whether it is out of scope or something worse."
...
**Target observation.** That rejection has a required form.
...
> "A formal rejection names the proposal, the boundary violated, and the level of analysis where the question does belong. You just saw that when put up the clinical proposal and ask whether it is out of scope or something worse.
> Last time we said: The moment somebody says the system wants something, it has been misread. This is the next part of that.
...
**What students must not infer.** Whether the redirected question is answerable.

### 4. Worked example

**The example.** A rejection naming the timescale boundary and redirecting to developmental work.
...
**Completed answer.** A rejection naming the timescale boundary and redirecting to developmental work. — which demonstrates that rejection has a required form.
...
**Conclusions not licensed.** Whether the redirected question is answerable.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A rejection naming the clinical exclusion and redirecting appropriately. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rejection naming the boundary with no alternative level. Why is this not an
example?"
...
**Exact student instructions.** Write formal rejections for three invalid proposals with boundary and alternative level.
...
- *Licensed conclusion.* That rejection has a required form.
- *Not licensed.* Whether the redirected question is answerable.
...
- *Expected response.* That rejection has a required form.
...
1. Any wording carrying the idea in `A formal rejection names the proposal, the boundary violated, and the level of analysis where the question does belong`.
...
Say: "Exclusion is not dismissal. It points at a different level of analysis."

**Why this sentence matters.** It is the opening question of Lesson 12, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_11_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 10 — Simulations Are Not Wishes |
| **Leads to** | Lesson 12 — The Clinical Case |

**Transition in.** Lesson 10 established students state what a simulation is treated as. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students reject an invalid application in the required form. Lesson 12 assumes it and builds students understand why the clinical application is a misuse.
