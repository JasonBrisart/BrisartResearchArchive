# Lesson 19 — The Capstone Falsification Condition

**Grade 12** · Falsification and Scope · **Quarter 3** · **50 minutes**
...
| **Core concept** | The capstone condition must be demonstrably triggerable by a result the design could actually produce. |
| **Student outcome** | Students write the condition their capstone could trigger. |
| **Previous lesson** | Lesson 18 — Choosing The Capstone Claim |
| **Next lesson** | Lesson 20 — Designing The Capstone |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_19_Printout.md` |
| **Homework** | `Homework/Lesson_19_Homework.md` |

## Why this lesson exists

**The conceptual step.** The capstone condition must be demonstrably triggerable by a result the design could actually produce. Assertion is not demonstration.
...
**What depends on it.** Lesson 20 — Designing The Capstone — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The capstone condition must be demonstrably triggerable by a result the design could actually produce. Assertion is not demonstration.
...
2. A condition revised after the pathway failed.

### One non-example

A condition asserted to be checkable with no pathway.
...
That capstone conditions can be demonstrated triggerable.
...
| Statement | Status |
|---|---|
| The capstone condition must be demonstrably triggerable by a result the design could actually produce. | Framework-derived, appropriate at this grade |
| That capstone conditions can be demonstrated triggerable. | What this specific activity can show |
| Whether the condition will fire. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — Choosing The Capstone Claim — specifically: students select one claim narrow enough to be settled.

**How it was taught.** Through the activity: select a claim, name its least-separable rival, and justify the pairing

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: select a claim, name its least-separable rival, and justify the pairing, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A condition asserted to be checkable with no pathway. |
...
**Student materials.** One copy of `Printouts/Lesson_19_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 18, kept in the student's folder.
...
**File.** `Printouts/Lesson_19_Printout.md`
...
**Target observation.** That capstone conditions can be demonstrated triggerable.
...
> "The capstone condition must be demonstrably triggerable by a result the design could actually produce. You just saw that when say: before any design work, write what would make you abandon this claim.
...
**Completed answer.** A condition with the triggering observations written out. — which demonstrates that capstone conditions can be demonstrated triggerable.
...
**Teacher prompt.** "Here is a second case. A condition revised after the pathway failed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A condition asserted to be checkable with no pathway. Why is this not an
example?"
...
- *Licensed conclusion.* That capstone conditions can be demonstrated triggerable.
...
- *Expected response.* That capstone conditions can be demonstrated triggerable.
...
1. Any wording carrying the idea in `The capstone condition must be demonstrably triggerable by a result the design could actually produce`.
...
**Why this sentence matters.** It is the opening question of Lesson 20, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_19_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 18 — Choosing The Capstone Claim |
| **Leads to** | Lesson 20 — Designing The Capstone |

**Transition in.** Lesson 18 established students select one claim narrow enough to be settled. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students write the condition their capstone could trigger. Lesson 20 assumes it and builds students build the design around the condition.
