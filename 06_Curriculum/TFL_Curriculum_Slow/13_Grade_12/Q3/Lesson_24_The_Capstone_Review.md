...
| | |
|---|---|
| **Central question** | The Capstone Review: students consolidate capstone construction? |
| **Core concept** | The gate check runs before any other assessment. |
| **Student outcome** | Students consolidate capstone construction. |
| **Previous lesson** | Lesson 23 — Confirmatory And Exploratory |
| **Next lesson** | Lesson 25 — Assembling The Capstone |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_24_Printout.md` |
| **Homework** | `Homework/Lesson_24_Homework.md` |

## Why this lesson exists

**The conceptual step.** The gate check runs before any other assessment. A capstone missing a gate does not pass regardless of the quality of the other seven parts.
...
**What depends on it.** Lesson 25 — Assembling The Capstone — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The gate check runs before any other assessment. A capstone missing a gate does not pass regardless of the quality of the other seven parts.
...
1. A capstone audited with both gates present.
2. A capstone returned for a missing gate.

### One non-example

A capstone with seven parts and a gate deferred.
...
Whether all eight parts are present.

### What this activity does not establish

Whether the capstone is good.
...
| Statement | Status |
|---|---|
| The gate check runs before any other assessment. | Framework-derived, appropriate at this grade |
| Whether all eight parts are present. | What this specific activity can show |
| Whether the capstone is good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — Confirmatory And Exploratory — specifically: students separate prespecified tests from exploration.

**How it was taught.** Through the activity: mark every planned analysis as confirmatory or exploratory before any data exist

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: mark every planned analysis as confirmatory or exploratory before any data exist, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A capstone audited with both gates present. |
| **Non-example** | A capstone with seven parts and a gate deferred. |
...
**Student materials.** One copy of `Printouts/Lesson_24_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 23, kept in the student's folder.
...
**File.** `Printouts/Lesson_24_Printout.md`
...
> "Prespecify the confirmatory test, label everything else, report both."
...
**Exact wording.** "Ask which two of the eight parts are gates."
...
**Target observation.** Whether all eight parts are present.
...
> "The gate check runs before any other assessment. You just saw that when ask which two of the eight parts are gates.
> Last time we said: Prespecify the confirmatory test, label everything else, report both. This is the next part of that.
...
**What students must not infer.** Whether the capstone is good.

### 4. Worked example

**The example.** A capstone audited with both gates present.
...
**Completed answer.** A capstone audited with both gates present. — which demonstrates whether all eight parts are present.
...
**Conclusions not licensed.** Whether the capstone is good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A capstone returned for a missing gate. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A capstone with seven parts and a gate deferred. Why is this not an
example?"
...
**Exact student instructions.** Review with the capstone audited against all eight parts.
...
- *Licensed conclusion.* Whether all eight parts are present.
- *Not licensed.* Whether the capstone is good.
...
- *Expected response.* Whether all eight parts are present.
...
1. Any wording carrying the idea in `The gate check runs before any other assessment`.
...
Say: "Next time you assemble and defend it."

**Why this sentence matters.** It is the opening question of Lesson 25, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_24_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 23 — Confirmatory And Exploratory |
| **Leads to** | Lesson 25 — Assembling The Capstone |

**Transition in.** Lesson 23 established students separate prespecified tests from exploration. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate capstone construction. Lesson 25 assumes it and builds students produce the complete capstone package.
