...
| | |
|---|---|
| **Central question** | Final Assessment: students demonstrate the year's outcomes on a gated paper? |
| **Core concept** | The gated final requires both gate items regardless of total score. |
| **Student outcome** | Students demonstrate the year's outcomes on a gated paper. |
| **Previous lesson** | Lesson 31 — Practice Final |
| **Next lesson** | The final examination. |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_32_Printout.md` |
| **Homework** | `Homework/Lesson_32_Homework.md` |
...
2. A gate A answer naming a possible observation with controls.
...
**Prerequisite.** The content of Lesson 31 — Practice Final — specifically: students rehearse the gated final under conditions.

**How it was taught.** Through the activity: a full practice final, self-marked, with both gates checked first

**Quick check.** Ask for the closing sentence of Lesson 31. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 31: a full practice final, self-marked, with both gates checked first, in miniature, using one example only. Then ask for the sentence again.
...
**Student materials.** One copy of `Printouts/Lesson_32_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 31, kept in the student's folder.
...
**File.** `Printouts/Lesson_32_Printout.md`
...
**Teacher prompt.** "Here is a second case. A gate A answer naming a possible observation with controls. Work it through with me."
...
**Exact student instructions.** The gated final: falsification, scope, the exclusion set, and the advocacy order rule.
...
Say: "Next: whether this framework is worth believing, and how anybody would find out."
...
**File.** `Homework/Lesson_32_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 31 — Practice Final |
| **Leads to** | The final examination. |

**Transition in.** Lesson 31 established students rehearse the gated final under conditions. This lesson uses that as the starting point.
