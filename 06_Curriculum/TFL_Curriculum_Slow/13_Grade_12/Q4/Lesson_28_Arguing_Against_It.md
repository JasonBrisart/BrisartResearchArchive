...
| | |
|---|---|
| **Central question** | Arguing Against It: students build the strongest case against the framework? |
| **Core concept** | Arguing against the framework competently is the year's central capability. |
| **Student outcome** | Students build the strongest case against the framework. |
| **Previous lesson** | Lesson 27 — Revising After The Mock |
| **Next lesson** | Lesson 29 — Explaining Falsification |
...
**The conceptual step.** Arguing against the framework competently is the year's central capability. The argument is judged on reasoning quality, never on which conclusion it reaches.
...
**What depends on it.** Lesson 29 — Explaining Falsification — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Arguing against the framework competently is the year's central capability. The argument is judged on reasoning quality, never on which conclusion it reaches.
...
1. An argument citing the unmeasurability of key claims.
2. An argument citing the redundancy charge.

### One non-example

A deliberately weak argument written by a sympathiser.
...
That the case against can be made competently.

### What this activity does not establish

Whether the case against succeeds.
...
| Statement | Status |
|---|---|
| Arguing against the framework competently is the year's central capability. | Framework-derived, appropriate at this grade |
| That the case against can be made competently. | What this specific activity can show |
| Whether the case against succeeds. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — Revising After The Mock — specifically: students revise the capstone against mock-defence feedback.

**How it was taught.** Through the activity: revise the capstone and mark what changed for each unanswered question

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: revise the capstone and mark what changed for each unanswered question, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An argument citing the unmeasurability of key claims. |
| **Non-example** | A deliberately weak argument written by a sympathiser. |
...
> "A question you could not answer is a gap, not bad luck."
...
**Exact wording.** "Say: today you argue it is not worth the field's attention. Best case."
...
**Target observation.** That the case against can be made competently.
...
> "Arguing against the framework competently is the year's central capability. You just saw that when say: today you argue it is not worth the field's attention.
> Last time we said: A question you could not answer is a gap, not bad luck. This is the next part of that.
...
**What students must not infer.** Whether the case against succeeds.

### 4. Worked example

**The example.** An argument citing the unmeasurability of key claims.
...
**Completed answer.** An argument citing the unmeasurability of key claims. — which demonstrates that the case against can be made competently.
...
**Conclusions not licensed.** Whether the case against succeeds.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An argument citing the redundancy charge. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A deliberately weak argument written by a sympathiser. Why is this not an
example?"
...
**Exact student instructions.** A 400-word argument against the framework, judged on quality not conclusion.
...
- *Licensed conclusion.* That the case against can be made competently.
- *Not licensed.* Whether the case against succeeds.
...
- *Expected response.* That the case against can be made competently.
...
1. Any wording carrying the idea in `Arguing against the framework competently is the year's central capability`.
...
Say: "A well-argued case against is a passing submission. Always was."
...
| | |
|---|---|
| **Follows** | Lesson 27 — Revising After The Mock |
| **Leads to** | Lesson 29 — Explaining Falsification |

**Transition in.** Lesson 27 established students revise the capstone against mock-defence feedback. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students build the strongest case against the framework. Lesson 29 assumes it and builds students explain falsification to somebody who has not met it.
