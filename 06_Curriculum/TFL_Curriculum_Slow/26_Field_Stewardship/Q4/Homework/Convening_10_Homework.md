# Convening 10 Homework — The Charter Assembled

**Field Stewardship** · Governing The Examination · **Quarter 4**
**Follows:** Convening 10 — The Charter Assembled · **Points:** 5 · **Optional:** yes
...
Write the sentence Convening 10 ended on, from memory:
...
Assemble the charter and self-audit against both gates.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every charter contains all five instruments
...
Convening 11 is **Blind Adoption**, which assumes you arrive holding it. Write one thing you expect it to be about:
