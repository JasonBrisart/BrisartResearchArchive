# Convening 4 — Preservation And The Citing Literature
...
| | |
|---|---|
| **Central question** | Preservation And The Citing Literature: participants guarantee that superseded versions remain interpretable? |
| **Core concept** | Erasing a superseded version destroys the interpretability of every paper that cited it. |
| **Student outcome** | Participants guarantee that superseded versions remain interpretable. |
| **Previous convening** | Convening 3 — Version Authority |
| **Next convening** | Convening 5 — Multi-Institution Replication |
| **Materials** | The full specification and its version history; instrument templates |
| **Preparation** | three hours |
| **Student printout** | `Printouts/Convening_04_Printout.md` |
| **Homework** | `Homework/Convening_04_Homework.md` |

## Why this lesson exists

**The conceptual step.** Erasing a superseded version destroys the interpretability of every paper that cited it. The preservation clause must survive citation scenarios that arise years later.
...
**What depends on it.** Convening 5 — Multi-Institution Replication — opens by assuming this convening's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Erasing a superseded version destroys the interpretability of every paper that cited it. The preservation clause must survive citation scenarios that arise years later.
...
1. A clause preserving all superseded versions permanently.
2. A clause tested against a paper citing a withdrawn version.

### One non-example

A clause permitting deletion of versions found to contain errors.
...
That preservation protects the citing literature.

### What this activity does not establish

Whether the clause would be adopted.
...
| Statement | Status |
|---|---|
| Erasing a superseded version destroys the interpretability of every paper that cited it. | Framework-derived, appropriate at this grade |
| That preservation protects the citing literature. | What this specific activity can show |
| Whether the clause would be adopted. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Convening 3 — Version Authority — specifically: participants produce a policy resolving which document governs.

**How it was taught.** Through the activity: draft the policy and test it by blind resolution of a manufactured dispute

**Quick check.** Ask for the closing sentence of Convening 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Convening 3: draft the policy and test it by blind resolution of a manufactured dispute, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A clause preserving all superseded versions permanently. |
| **Non-example** | A clause permitting deletion of versions found to contain errors. |
...
**Student materials.** One copy of `Printouts/Convening_04_Printout.md` per student.

**Prior student data required.** Work produced in Convening 3, kept in the student's folder.
...
**File.** `Printouts/Convening_04_Printout.md`
...
**Exact wording.** "Say: a body that erases superseded versions destroys the work that cited them."
...
**Target observation.** That preservation protects the citing literature.
...
> "Erasing a superseded version destroys the interpretability of every paper that cited it. You just saw that when say: a body that erases superseded versions destroys the work that cited them.
> Last time we said: Supersession is not deletion. This is the next part of that.
...
**What students must not infer.** Whether the clause would be adopted.

### 4. Worked example

**The example.** A clause preserving all superseded versions permanently.
...
**Completed answer.** A clause preserving all superseded versions permanently. — which demonstrates that preservation protects the citing literature.
...
**Conclusions not licensed.** Whether the clause would be adopted.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A clause tested against a paper citing a withdrawn version. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A clause permitting deletion of versions found to contain errors. Why is this not an
example?"
...
**Exact student instructions.** Write the preservation clause and test it against three citation scenarios.
...
- *Licensed conclusion.* That preservation protects the citing literature.
- *Not licensed.* Whether the clause would be adopted.
...
- *Expected response.* That preservation protects the citing literature.
...
1. Any wording carrying the idea in `Erasing a superseded version destroys the interpretability of every paper that cited it`.
...
Say: "The record must remain interpretable after you are gone."

**Why this sentence matters.** It is the opening question of Convening 5, which assumes students arrive holding it.
...
**File.** `Homework/Convening_04_Homework.md`
...
| | |
|---|---|
| **Follows** | Convening 3 — Version Authority |
| **Leads to** | Convening 5 — Multi-Institution Replication |

**Transition in.** Convening 3 established participants produce a policy resolving which document governs. This convening uses that as the starting point.

**Transition out.** This convening establishes participants guarantee that superseded versions remain interpretable. Convening 5 assumes it and builds participants build an adoptable consortium protocol.
