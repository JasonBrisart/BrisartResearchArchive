...
|---|---|---|---|---|---|---|
| `Convening_01_Printout.md` | Convening 1 — The Framework At Field Scale | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Convening_02_Printout.md` | Convening 2 — Mapping The Functions | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | Convening 1 work |
| `Convening_03_Printout.md` | Convening 3 — Version Authority | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | Convening 2 work |
...
**Convening 2 — Mapping The Functions.** If you only have time to print one
