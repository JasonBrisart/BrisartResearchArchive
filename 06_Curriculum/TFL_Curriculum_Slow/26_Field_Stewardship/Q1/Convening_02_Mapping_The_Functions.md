# Convening 2 — Mapping The Functions
...
| | |
|---|---|
| **Central question** | Mapping The Functions: participants determine what breaks if each function stays unowned? |
| **Core concept** | Each unowned function has a specific breakage and a minimum sufficient instrument. |
| **Student outcome** | Participants determine what breaks if each function stays unowned. |
| **Previous convening** | Convening 1 — The Framework At Field Scale |
| **Next convening** | Convening 3 — Version Authority |
| **Materials** | The full specification and its version history; instrument templates |
| **Preparation** | three hours |
| **Student printout** | `Printouts/Convening_02_Printout.md` |
| **Homework** | `Homework/Convening_02_Homework.md` |

## Why this lesson exists

**The conceptual step.** Each unowned function has a specific breakage and a minimum sufficient instrument. Maximal instruments are not built, which means the function stays unowned.
...
**What depends on it.** Convening 3 — Version Authority — opens by assuming this convening's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Each unowned function has a specific breakage and a minimum sufficient instrument. Maximal instruments are not built, which means the function stays unowned.
...
1. Version drift as the breakage, with a one-page policy as the minimum.
2. Null loss as the breakage, with a registry field as the minimum.

### One non-example

A comprehensive governance platform proposed as the instrument.
...
That minimum sufficient instruments can be identified.

### What this activity does not establish

Whether the instruments will be built.
...
| Statement | Status |
|---|---|
| Each unowned function has a specific breakage and a minimum sufficient instrument. | Framework-derived, appropriate at this grade |
| That minimum sufficient instruments can be identified. | What this specific activity can show |
| Whether the instruments will be built. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Convening 1 — The Framework At Field Scale — specifically: participants identify which field functions have no owner.

**How it was taught.** Through the activity: draft the field position statement including what the body does not claim

**Quick check.** Ask for the closing sentence of Convening 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Convening 1: draft the field position statement including what the body does not claim, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Version drift as the breakage, with a one-page policy as the minimum. |
| **Non-example** | A comprehensive governance platform proposed as the instrument. |
...
**Student materials.** One copy of `Printouts/Convening_02_Printout.md` per student.

**Prior student data required.** Work produced in Convening 1, kept in the student's folder.
...
**File.** `Printouts/Convening_02_Printout.md`
...
> "Nobody is the usual answer, and that is the convening's finding."
...
**Exact wording.** "Ask what breaks if nobody owns each of the five functions."
...
**Target observation.** That minimum sufficient instruments can be identified.
...
> "Each unowned function has a specific breakage and a minimum sufficient instrument. You just saw that when ask what breaks if nobody owns each of the five functions.
> Last time we said: Nobody is the usual answer, and that is the convening's finding. This is the next part of that.
...
**What students must not infer.** Whether the instruments will be built.

### 4. Worked example

**The example.** Version drift as the breakage, with a one-page policy as the minimum.
...
**Completed answer.** Version drift as the breakage, with a one-page policy as the minimum. — which demonstrates that minimum sufficient instruments can be identified.
...
**Conclusions not licensed.** Whether the instruments will be built.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Null loss as the breakage, with a registry field as the minimum. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A comprehensive governance platform proposed as the instrument. Why is this not an
example?"
...
**Exact student instructions.** For each function, state what breaks and the minimum instrument that would fix it.
...
- *Licensed conclusion.* That minimum sufficient instruments can be identified.
- *Not licensed.* Whether the instruments will be built.
...
- *Expected response.* That minimum sufficient instruments can be identified.
...
1. Any wording carrying the idea in `Each unowned function has a specific breakage and a minimum sufficient instrument`.
...
Say: "The minimum instrument is what you can actually build this year."

**Why this sentence matters.** It is the opening question of Convening 3, which assumes students arrive holding it.
...
**File.** `Homework/Convening_02_Homework.md`
...
| | |
|---|---|
| **Follows** | Convening 1 — The Framework At Field Scale |
| **Leads to** | Convening 3 — Version Authority |

**Transition in.** Convening 1 established participants identify which field functions have no owner. This convening uses that as the starting point.

**Transition out.** This convening establishes participants determine what breaks if each function stays unowned. Convening 3 assumes it and builds participants produce a policy resolving which document governs.
