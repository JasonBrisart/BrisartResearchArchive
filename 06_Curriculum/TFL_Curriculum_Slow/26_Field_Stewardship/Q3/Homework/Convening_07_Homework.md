# Convening 7 Homework — Registries And The Public Record

**Field Stewardship** · Governing The Examination · **Quarter 3**
**Follows:** Convening 7 — Registries And The Public Record · **Points:** 5 · **Optional:** yes
...
Write the sentence Convening 7 ended on, from memory:
...
Draft the specification including the operator succession plan.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every specification names a succession plan
...
Convening 8 is **Abandoned Registrations**, which assumes you arrive holding it. Write one thing you expect it to be about:
