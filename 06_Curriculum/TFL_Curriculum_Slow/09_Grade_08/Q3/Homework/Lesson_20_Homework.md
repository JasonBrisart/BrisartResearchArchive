# Lesson 20 Homework — The Assumption Behind The Method

**Grade 8** · Contradiction and Limits · **Quarter 3**
**Follows:** Lesson 20 — The Assumption Behind The Method · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 20 ended on, from memory:
...
List the assumptions behind three of their own measurement choices.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names at least three method assumptions
...
Lesson 21 is **Assumptions In Other Subjects**, which assumes you arrive holding it. Write one thing you expect it to be about:
