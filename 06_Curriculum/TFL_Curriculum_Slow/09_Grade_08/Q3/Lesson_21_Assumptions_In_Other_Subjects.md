# Lesson 21 — Assumptions In Other Subjects
...
| | |
|---|---|
| **Central question** | Assumptions In Other Subjects: students audit a claim from another subject? |
| **Core concept** | Assumption auditing is a general habit. |
| **Student outcome** | Students audit a claim from another subject. |
| **Previous lesson** | Lesson 20 — The Assumption Behind The Method |
| **Next lesson** | Lesson 22 — When An Assumption Fails |
...
**The conceptual step.** Assumption auditing is a general habit. Applying it to outside claims prevents it being filed as a routine belonging to this lesson.
...
**What depends on it.** Lesson 22 — When An Assumption Fails — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Assumption auditing is a general habit. Applying it to outside claims prevents it being filed as a routine belonging to this lesson.
...
1. A news claim audited for its unstated assumptions.
2. A science claim with its weakest assumption identified.

### One non-example

A claim from this lesson reused in another notebook.
...
That the habit transfers to any claim.
...
| Statement | Status |
|---|---|
| Assumption auditing is a general habit. | Framework-derived, appropriate at this grade |
| That the habit transfers to any claim. | What this specific activity can show |
| Anything about those subjects. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — The Assumption Behind The Method — specifically: students connect assumptions to their own measurement choices.

**How it was taught.** Through the activity: list the assumptions behind three of their own measurement choices

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: list the assumptions behind three of their own measurement choices, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A news claim audited for its unstated assumptions. |
| **Non-example** | A claim from this lesson reused in another notebook. |
...
> "Every measurement choice is an assumption in disguise."
...
**Exact wording.** "Take a claim from science, history, or the news."
...
**Target observation.** That the habit transfers to any claim.
...
> "Assumption auditing is a general habit. You just saw that when take a claim from science, history, or the news.
> Last time we said: Every measurement choice is an assumption in disguise. This is the next part of that.
...
**What students must not infer.** Anything about those subjects.

### 4. Worked example

**The example.** A news claim audited for its unstated assumptions.
...
**Completed answer.** A news claim audited for its unstated assumptions. — which demonstrates that the habit transfers to any claim.
...
**Conclusions not licensed.** Anything about those subjects.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A science claim with its weakest assumption identified. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim from this lesson reused in another notebook. Why is this not an
example?"
...
**Exact student instructions.** Audit three outside claims for assumptions and rank each set.
...
- *Licensed conclusion.* That the habit transfers to any claim.
- *Not licensed.* Anything about those subjects.
...
- *Expected response.* That the habit transfers to any claim.
...
1. Any wording carrying the idea in `Assumption auditing is a general habit`.
...
Say: "Every claim anywhere is standing on something."
...
| | |
|---|---|
| **Follows** | Lesson 20 — The Assumption Behind The Method |
| **Leads to** | Lesson 22 — When An Assumption Fails |

**Transition in.** Lesson 20 established students connect assumptions to their own measurement choices. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit a claim from another subject. Lesson 22 assumes it and builds students trace what happens when an assumption turns out false.
