# Lesson 6 Homework — Reading Your Own Sampling

**Grade 8** · Contradiction and Limits · **Quarter 1**
**Follows:** Lesson 6 — Reading Your Own Sampling · **Points:** 5 · **Optional:** yes
...
Write up their own log with the classification and its explicit limit.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student states the limit alongside the classification
...
Lesson 7 is **Improving The Sampling**, which assumes you arrive holding it. Write one thing you expect it to be about:
