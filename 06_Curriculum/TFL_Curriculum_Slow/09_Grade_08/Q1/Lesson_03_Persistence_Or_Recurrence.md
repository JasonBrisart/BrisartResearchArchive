# Lesson 3 — Persistence Or Recurrence

**Grade 8** · Contradiction and Limits · **Quarter 1** · **45 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Persistence Or Recurrence: students define recurrence and distinguish it from persistence? |
| **Core concept** | Persistence is continuous carry-forward; recurrence is reappearance after an observed absence. |
| **Student outcome** | Students define recurrence and distinguish it from persistence. |
| **Previous lesson** | Lesson 2 — Counting The Breaks |
| **Next lesson** | Lesson 4 — The Sampling Problem |
...
**The conceptual step.** Persistence is continuous carry-forward; recurrence is reappearance after an observed absence. Distinguishing them requires observing the gap, which most descriptions do not supply.
...
**What depends on it.** Lesson 4 — The Sampling Problem — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Persistence is continuous carry-forward; recurrence is reappearance after an observed absence. Distinguishing them requires observing the gap, which most descriptions do not supply.
...
1. A case with an observed absence, classified as recurrence.
2. A case with continuous observation, classified as persistence.

### One non-example

A case with no observation of the interval, forced into a category.
...
That the distinction requires observing the interval.
...
| Statement | Status |
|---|---|
| Persistence is continuous carry-forward; recurrence is reappearance after an observed absence. | Framework-derived, appropriate at this grade |
| That the distinction requires observing the interval. | What this specific activity can show |
| Which occurs more often. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — Counting The Breaks — specifically: students measure how many contradictions produce durable change.

**How it was taught.** Through the activity: a three-break trial in pairs, pooled, compared against predictions

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: a three-break trial in pairs, pooled, compared against predictions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A case with an observed absence, classified as recurrence. |
| **Non-example** | A case with no observation of the interval, forced into a category. |
...
> "You tested a claim instead of accepting it."
...
**Exact wording.** "Ask whether, between the square and the next circle, the expectation was running the whole time."
...
**Target observation.** That the distinction requires observing the interval.
...
> "Persistence is continuous carry-forward; recurrence is reappearance after an observed absence. You just saw that when ask whether, between the square and the next circle, the expectation was running the whole time.
> Last time we said: You tested a claim instead of accepting it. This is the next part of that.
...
**What students must not infer.** Which occurs more often.

### 4. Worked example

**The example.** A case with an observed absence, classified as recurrence.
...
**Completed answer.** A case with an observed absence, classified as recurrence. — which demonstrates that the distinction requires observing the interval.
...
**Conclusions not licensed.** Which occurs more often.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A case with continuous observation, classified as persistence. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A case with no observation of the interval, forced into a category. Why is this not an
example?"
...
**Exact student instructions.** Classify five described cases as persistent, recurrent, resolved, or unclassifiable.
...
- *Licensed conclusion.* That the distinction requires observing the interval.
- *Not licensed.* Which occurs more often.
...
- *Expected response.* That the distinction requires observing the interval.
...
1. Any wording carrying the idea in `Persistence is continuous carry-forward; recurrence is reappearance after an observed absence`.
...
Say: "Marking one unclassifiable is the correct answer."
...
| | |
|---|---|
| **Follows** | Lesson 2 — Counting The Breaks |
| **Leads to** | Lesson 4 — The Sampling Problem |

**Transition in.** Lesson 2 established students measure how many contradictions produce durable change. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students define recurrence and distinguish it from persistence. Lesson 4 assumes it and builds students discover that sampling rate sets what can be seen.
