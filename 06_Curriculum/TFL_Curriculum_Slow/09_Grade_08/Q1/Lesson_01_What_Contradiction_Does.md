# Lesson 1 — What Contradiction Does
...
| | |
|---|---|
| **Central question** | What Contradiction Does: students record the drop and recovery across a broken pattern? |
| **Core concept** | Contradiction produces a measurable drop followed by recovery. |
...
| **Next lesson** | Lesson 2 — Counting The Breaks |
...
**The conceptual step.** Contradiction produces a measurable drop followed by recovery. The pattern is mechanical, and describing it in terms of stubbornness imports agency the framework does not claim.
...
**What depends on it.** Lesson 2 — Counting The Breaks — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Contradiction produces a measurable drop followed by recovery. The pattern is mechanical, and describing it in terms of stubbornness imports agency the framework does not claim.
...
1. A plot showing recovery within two trials.
2. A paragraph describing suppression followed by re-entry.

### One non-example

A paragraph describing the class as reluctant to learn.
...
That contradiction produces drop and recovery.
...
| Statement | Status |
|---|---|
| Contradiction produces a measurable drop followed by recovery. | Framework-derived, appropriate at this grade |
| That contradiction produces drop and recovery. | What this specific activity can show |
| Why recovery occurs. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The student demonstrates persistence-accuracy independence from own data.
...
| **Correct example** | A plot showing recovery within two trials. |
| **Non-example** | A paragraph describing the class as reluctant to learn. |
...
**Exact wording.** "Run a nine-card pattern trial with class percentages recorded on the board."
...
**Target observation.** That contradiction produces drop and recovery.
...
> "Contradiction produces a measurable drop followed by recovery. You just saw that when run a nine-card pattern trial with class percentages recorded on the board.
...
**What students must not infer.** Why recovery occurs.

### 4. Worked example

**The example.** A plot showing recovery within two trials.
...
**Completed answer.** A plot showing recovery within two trials. — which demonstrates that contradiction produces drop and recovery.
...
**Conclusions not licensed.** Why recovery occurs.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A paragraph describing suppression followed by re-entry. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A paragraph describing the class as reluctant to learn. Why is this not an
example?"
...
**Exact student instructions.** Plot the percentages and write one paragraph on what the recovery shows.
...
- *Licensed conclusion.* That contradiction produces drop and recovery.
- *Not licensed.* Why recovery occurs.
...
- *Expected response.* That contradiction produces drop and recovery.
...
1. Any wording carrying the idea in `Contradiction produces a measurable drop followed by recovery`.
...
Say: "Revision. Suppression. Not deletion. Your own numbers showed it."
...
| **Leads to** | Lesson 2 — Counting The Breaks |

**Transition in.** This lesson opens the year.

**Transition out.** This lesson establishes students record the drop and recovery across a broken pattern. Lesson 2 assumes it and builds students measure how many contradictions produce durable change.
