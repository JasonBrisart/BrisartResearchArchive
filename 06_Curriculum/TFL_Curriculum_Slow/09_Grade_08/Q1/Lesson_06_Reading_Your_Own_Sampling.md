# Lesson 6 — Reading Your Own Sampling
...
| | |
|---|---|
| **Central question** | Reading Your Own Sampling: students interpret a sampling log within its limits? |
| **Core concept** | A classification must be stated with the rate that produced it. |
| **Student outcome** | Students interpret a sampling log within its limits. |
| **Previous lesson** | Lesson 5 — Running The Sampling |
| **Next lesson** | Lesson 7 — Improving The Sampling |
...
**The conceptual step.** A classification must be stated with the rate that produced it. Claiming recurrence from a schedule that could not observe the absence is the standard error.
...
**What depends on it.** Lesson 7 — Improving The Sampling — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A classification must be stated with the rate that produced it. Claiming recurrence from a schedule that could not observe the absence is the standard error.
...
1. A recurrence claim supported by an observed absence at a checkpoint.
2. A classification stated with its detection floor.

### One non-example

A recurrence claim from a schedule too coarse to see the gap.
...
That classifications must carry their sampling limits.

### What this activity does not establish

What actually happened between checkpoints.
...
| Statement | Status |
|---|---|
| A classification must be stated with the rate that produced it. | Framework-derived, appropriate at this grade |
| That classifications must carry their sampling limits. | What this specific activity can show |
| What actually happened between checkpoints. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — Running The Sampling — specifically: students collect sampled data on one of their own expectations.

**How it was taught.** Through the activity: a five-checkpoint sampling log run across a full day

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: a five-checkpoint sampling log run across a full day, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A recurrence claim supported by an observed absence at a checkpoint. |
| **Non-example** | A recurrence claim from a schedule too coarse to see the gap. |
...
> "Now you have data with a known rate."
...
**Exact wording.** "Put one student's five-checkpoint log on the board and ask: persistent or recurrent?"
...
**Target observation.** That classifications must carry their sampling limits.
...
> "A classification must be stated with the rate that produced it. You just saw that when put one student's five-checkpoint log on the board and ask: persistent or recurrent?.
> Last time we said: Now you have data with a known rate. This is the next part of that.
...
**What students must not infer.** What actually happened between checkpoints.

### 4. Worked example

**The example.** A recurrence claim supported by an observed absence at a checkpoint.
...
**Completed answer.** A recurrence claim supported by an observed absence at a checkpoint. — which demonstrates that classifications must carry their sampling limits.
...
**Conclusions not licensed.** What actually happened between checkpoints.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A classification stated with its detection floor. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A recurrence claim from a schedule too coarse to see the gap. Why is this not an
example?"
...
**Exact student instructions.** Write up their own log with the classification and its explicit limit.
...
- *Licensed conclusion.* That classifications must carry their sampling limits.
- *Not licensed.* What actually happened between checkpoints.
...
- *Expected response.* That classifications must carry their sampling limits.
...
1. Any wording carrying the idea in `A classification must be stated with the rate that produced it`.
...
Say: "A result without its rate is not interpretable."
...
| | |
|---|---|
| **Follows** | Lesson 5 — Running The Sampling |
| **Leads to** | Lesson 7 — Improving The Sampling |

**Transition in.** Lesson 5 established students collect sampled data on one of their own expectations. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students interpret a sampling log within its limits. Lesson 7 assumes it and builds students design a schedule that could detect a shorter gap.
