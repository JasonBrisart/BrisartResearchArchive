# Lesson 11 — Belief Versus Expectation
...
| | |
|---|---|
| **Central question** | Belief Versus Expectation: students distinguish a belief from a momentary expectation? |
| **Core concept** | A belief operates across cycles as a structural constraint; an expectation is generated within one. |
| **Student outcome** | Students distinguish a belief from a momentary expectation. |
| **Previous lesson** | Lesson 10 — Where Belief Comes From |
| **Next lesson** | Lesson 12 — Three Dynamics |
...
**The conceptual step.** A belief operates across cycles as a structural constraint; an expectation is generated within one. The timescale test separates them.
...
**What depends on it.** Lesson 12 — Three Dynamics — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A belief operates across cycles as a structural constraint; an expectation is generated within one. The timescale test separates them.
...
1. A belief about how lessons usually run, sorted as belief.
2. An expectation about the next thirty seconds, sorted as expectation.

### One non-example

A statement sorted by how strongly it is held.
...
That the timescale test separates the two.

### What this activity does not establish

How beliefs and expectations interact.
...
| Statement | Status |
|---|---|
| A belief operates across cycles as a structural constraint; an expectation is generated within one. | Framework-derived, appropriate at this grade |
| That the timescale test separates the two. | What this specific activity can show |
| How beliefs and expectations interact. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 10 — Where Belief Comes From — specifically: students trace a belief to its source.

**How it was taught.** Through the activity: trace three of their own beliefs to a source and rate each one's stability

**Quick check.** Ask for the closing sentence of Lesson 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 10: trace three of their own beliefs to a source and rate each one's stability, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A belief about how lessons usually run, sorted as belief. |
| **Non-example** | A statement sorted by how strongly it is held. |
...
> "Beliefs are built too. They are just built slower."
...
**Exact wording.** "Ask how a belief differs from what you expect in the next second."
...
**Target observation.** That the timescale test separates the two.
...
> "A belief operates across cycles as a structural constraint; an expectation is generated within one. You just saw that when ask how a belief differs from what you expect in the next second.
> Last time we said: Beliefs are built too. They are just built slower. This is the next part of that.
...
**What students must not infer.** How beliefs and expectations interact.

### 4. Worked example

**The example.** A belief about how lessons usually run, sorted as belief.
...
**Completed answer.** A belief about how lessons usually run, sorted as belief. — which demonstrates that the timescale test separates the two.
...
**Conclusions not licensed.** How beliefs and expectations interact.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An expectation about the next thirty seconds, sorted as expectation. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A statement sorted by how strongly it is held. Why is this not an
example?"
...
**Exact student instructions.** Sort twelve statements into beliefs and expectations with the deciding criterion named.
...
- *Licensed conclusion.* That the timescale test separates the two.
- *Not licensed.* How beliefs and expectations interact.
...
- *Expected response.* That the timescale test separates the two.
...
1. Any wording carrying the idea in `A belief operates across cycles as a structural constraint; an expectation is generated within one`.
...
Say: "One lasts across cycles. One is inside a cycle."
...
| | |
|---|---|
| **Follows** | Lesson 10 — Where Belief Comes From |
| **Leads to** | Lesson 12 — Three Dynamics |

**Transition in.** Lesson 10 established students trace a belief to its source. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students distinguish a belief from a momentary expectation. Lesson 12 assumes it and builds students classify system behaviour into the three dynamics.
