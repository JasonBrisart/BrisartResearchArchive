...
| | |
|---|---|
| **Central question** | The Dynamics Review: students consolidate belief and dynamics? |
| **Core concept** | Naming a dynamic without its driving condition is a label rather than a classification. |
| **Student outcome** | Students consolidate belief and dynamics. |
| **Previous lesson** | Lesson 15 — Dynamics Elsewhere |
| **Next lesson** | Lesson 17 — Stating An Assumption |
...
**The conceptual step.** Naming a dynamic without its driving condition is a label rather than a classification. The review enforces the condition as a required part.
...
**What depends on it.** Lesson 17 — Stating An Assumption — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Naming a dynamic without its driving condition is a label rather than a classification. The review enforces the condition as a required part.
...
1. A dynamic named with its driving condition.
2. A scenario marked unclassifiable with a reason.

### One non-example

A dynamic named with no condition stated.
...
Whether the condition requirement is habitual.
...
| Statement | Status |
|---|---|
| Naming a dynamic without its driving condition is a label rather than a classification. | Framework-derived, appropriate at this grade |
| Whether the condition requirement is habitual. | What this specific activity can show |
| Whether the classifications are correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — Dynamics Elsewhere — specifically: students find the dynamics in non-personal systems.

**How it was taught.** Through the activity: three non-personal examples, one per dynamic, with conditions named

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: three non-personal examples, one per dynamic, with conditions named, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A dynamic named with its driving condition. |
| **Non-example** | A dynamic named with no condition stated. |
...
> "The shapes are about conditions, not about who."
...
**Exact wording.** "Ask what the three dynamics are and what drives each."
...
**Target observation.** Whether the condition requirement is habitual.
...
> "Naming a dynamic without its driving condition is a label rather than a classification. You just saw that when ask what the three dynamics are and what drives each.
> Last time we said: The shapes are about conditions, not about who. This is the next part of that.
...
**What students must not infer.** Whether the classifications are correct.

### 4. Worked example

**The example.** A dynamic named with its driving condition.
...
**Completed answer.** A dynamic named with its driving condition. — which demonstrates whether the condition requirement is habitual.
...
**Conclusions not licensed.** Whether the classifications are correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A scenario marked unclassifiable with a reason. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A dynamic named with no condition stated. Why is this not an
example?"
...
**Exact student instructions.** Review with nine scenarios classified with conditions.
...
- *Licensed conclusion.* Whether the condition requirement is habitual.
- *Not licensed.* Whether the classifications are correct.
...
- *Expected response.* Whether the condition requirement is habitual.
...
1. Any wording carrying the idea in `Naming a dynamic without its driving condition is a label rather than a classification`.
...
Say: "Next time: what your claims are standing on."
...
| | |
|---|---|
| **Follows** | Lesson 15 — Dynamics Elsewhere |
| **Leads to** | Lesson 17 — Stating An Assumption |

**Transition in.** Lesson 15 established students find the dynamics in non-personal systems. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate belief and dynamics. Lesson 17 assumes it and builds students write the assumptions underneath their own claims.
