# Lesson 12 Homework — Three Dynamics

**Grade 8** · Contradiction and Limits · **Quarter 2**
**Follows:** Lesson 12 — Three Dynamics · **Points:** 5 · **Optional:** yes
...
Classify eight scenarios and state the driving condition for each.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student classifies at least six with conditions named
...
Lesson 13 is **Dynamics In Data**, which assumes you arrive holding it. Write one thing you expect it to be about:
