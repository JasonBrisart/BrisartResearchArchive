# Lesson 9 Homework — Belief As A Prior

**Grade 8** · Contradiction and Limits · **Quarter 2**
**Follows:** Lesson 9 — Belief As A Prior · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 9 ended on, from memory:
...
Trace one ambiguous situation and state what a differently-believing person would expect.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names what somebody else would have expected
...
Lesson 10 is **Where Belief Comes From**, which assumes you arrive holding it. Write one thing you expect it to be about:
