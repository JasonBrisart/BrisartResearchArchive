# Lesson 14 — Escalation Is Not A Diagnosis
...
| | |
|---|---|
| **Central question** | Escalation Is Not A Diagnosis: students state the boundary around the escalation dynamic? |
| **Core concept** | Escalation names a system behaviour under stated conditions. |
| **Student outcome** | Students state the boundary around the escalation dynamic. |
| **Previous lesson** | Lesson 13 — Dynamics In Data |
| **Next lesson** | Lesson 15 — Dynamics Elsewhere |
...
**The conceptual step.** Escalation names a system behaviour under stated conditions. Using it to describe a person is a category error and is outside what the framework covers.
...
**What depends on it.** Lesson 15 — Dynamics Elsewhere — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Escalation names a system behaviour under stated conditions. Using it to describe a person is a category error and is outside what the framework covers.
...
1. An escalation description in terms of conditions only.
2. A rewritten description with the person removed.

### One non-example

A description of a classmate as escalating.
...
That the dynamic describes conditions, not people.
...
| Statement | Status |
|---|---|
| Escalation names a system behaviour under stated conditions. | Framework-derived, appropriate at this grade |
| That the dynamic describes conditions, not people. | What this specific activity can show |
| Anything about individuals. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 13 — Dynamics In Data — specifically: students find the three dynamics in their own sampling data.

**How it was taught.** Through the activity: classify their own log and two classmates' logs into the three dynamics

**Quick check.** Ask for the closing sentence of Lesson 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 13: classify their own log and two classmates' logs into the three dynamics, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An escalation description in terms of conditions only. |
| **Non-example** | A description of a classmate as escalating. |
...
> "You can see the shapes in real data, not just in descriptions."
...
**Exact wording.** "Say: escalation sounds like it describes a person. It does not."
...
**Target observation.** That the dynamic describes conditions, not people.
...
> "Escalation names a system behaviour under stated conditions. You just saw that when say: escalation sounds like it describes a person.
> Last time we said: You can see the shapes in real data, not just in descriptions. This is the next part of that.
...
**What students must not infer.** Anything about individuals.

### 4. Worked example

**The example.** An escalation description in terms of conditions only.
...
**Completed answer.** An escalation description in terms of conditions only. — which demonstrates that the dynamic describes conditions, not people.
...
**Conclusions not licensed.** Anything about individuals.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A rewritten description with the person removed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A description of a classmate as escalating. Why is this not an
example?"
...
**Exact student instructions.** Rewrite four escalation descriptions so none describes a person.
...
- *Licensed conclusion.* That the dynamic describes conditions, not people.
- *Not licensed.* Anything about individuals.
...
- *Expected response.* That the dynamic describes conditions, not people.
...
1. Any wording carrying the idea in `Escalation names a system behaviour under stated conditions`.
...
Say: "It describes a loop under conditions. Nothing else."
...
| | |
|---|---|
| **Follows** | Lesson 13 — Dynamics In Data |
| **Leads to** | Lesson 15 — Dynamics Elsewhere |

**Transition in.** Lesson 13 established students find the three dynamics in their own sampling data. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state the boundary around the escalation dynamic. Lesson 15 assumes it and builds students find the dynamics in non-personal systems.
