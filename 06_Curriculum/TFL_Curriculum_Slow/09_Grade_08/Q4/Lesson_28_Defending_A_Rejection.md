# Lesson 28 — Defending A Rejection
...
| | |
|---|---|
| **Central question** | Defending A Rejection: students defend a scope rejection against a challenge? |
| **Core concept** | A rejection must be defensible against challenge. |
| **Student outcome** | Students defend a scope rejection against a challenge. |
| **Previous lesson** | Lesson 27 — Borderline Cases |
| **Next lesson** | Lesson 29 — Explaining The Limits |
...
**The conceptual step.** A rejection must be defensible against challenge. Restating it more firmly is not a defence, and the distinction matters because rejections are frequently challenged.
...
**What depends on it.** Lesson 29 — Explaining The Limits — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A rejection must be defensible against challenge. Restating it more firmly is not a defence, and the distinction matters because rejections are frequently challenged.
...
1. A defence engaging with the specific boundary challenged.
2. A defence conceding that a case is genuinely borderline.
...
| Statement | Status |
|---|---|
| A rejection must be defensible against challenge. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 27 — Borderline Cases — specifically: students resolve genuinely ambiguous scope questions.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: resolve three borderline proposals by identifiability rather than duration, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence engaging with the specific boundary challenged. |
...
> "A rejection must be defensible against challenge. You just saw that when say: somebody thinks your rejection was wrong.
...
**The example.** A defence engaging with the specific boundary challenged.
...
**Completed answer.** A defence engaging with the specific boundary challenged. — which demonstrates whether rejections can be defended.
...
**Teacher prompt.** "Here is a second case. A defence conceding that a case is genuinely borderline. Work it through with me."
...
**Exact student instructions.** Each student defends one rejection against two written challenges.
...
1. Any wording carrying the idea in `A rejection must be defensible against challenge`.
...
Say: "A rejection you cannot defend is just an opinion."
...
| | |
|---|---|
| **Follows** | Lesson 27 — Borderline Cases |
| **Leads to** | Lesson 29 — Explaining The Limits |

**Transition in.** Lesson 27 established students resolve genuinely ambiguous scope questions. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students defend a scope rejection against a challenge. Lesson 29 assumes it and builds students explain the model's boundaries to somebody else.
