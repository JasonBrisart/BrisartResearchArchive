# Lesson 19 Homework — Repairing A Method

**Grade 10** · The Gate and the Guarantees · **Quarter 3**
**Follows:** Lesson 19 — Repairing A Method · **Points:** 5 · **Optional:** yes
...
Repair the design and have a second classmate attempt it.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the second run produces fewer questions than the first
...
Lesson 20 is **Running The Investigation**, which assumes you arrive holding it. Write one thing you expect it to be about:
