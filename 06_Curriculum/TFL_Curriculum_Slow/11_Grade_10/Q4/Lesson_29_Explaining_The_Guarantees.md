# Lesson 29 — Explaining The Guarantees
...
| | |
|---|---|
| **Central question** | Explaining The Guarantees: students explain guarantees and their limits to somebody else? |
| **Core concept** | Explaining the architecture requires stating both what it commits to and what it declines to promise. |
| **Student outcome** | Students explain guarantees and their limits to somebody else. |
| **Previous lesson** | Lesson 28 — Redesigning To Separate |
| **Next lesson** | Lesson 30 — The Year In Designs |
...
**The conceptual step.** Explaining the architecture requires stating both what it commits to and what it declines to promise. The refusals are usually the more surprising half.
...
**What depends on it.** Lesson 30 — The Year In Designs — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Explaining the architecture requires stating both what it commits to and what it declines to promise. The refusals are usually the more surprising half.
...
1. An explanation covering both promises and refusals.
2. A listener asking why it does not promise resolution.

### One non-example

An explanation listing only the guarantees.
...
| Statement | Status |
|---|---|
| Explaining the architecture requires stating both what it commits to and what it declines to promise. | Framework-derived, appropriate at this grade |
| Whether both halves are held. | What this specific activity can show |
| Whether the guarantees hold. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — Redesigning To Separate — specifically: students revise a design so it can distinguish explanations.

**How it was taught.** Through the activity: redesign one investigation so it produces separating evidence

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: redesign one investigation so it produces separating evidence, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An explanation covering both promises and refusals. |
| **Non-example** | An explanation listing only the guarantees. |
...
> "Now it would tell you something either way."
...
**Exact wording.** "Say: today you teach what the architecture promises and what it refuses."
...
**Target observation.** Whether both halves are held.
...
> "Explaining the architecture requires stating both what it commits to and what it declines to promise. You just saw that when say: today you teach what the architecture promises and what it refuses.
> Last time we said: Now it would tell you something either way. This is the next part of that.
...
**The example.** An explanation covering both promises and refusals.
...
**Completed answer.** An explanation covering both promises and refusals. — which demonstrates whether both halves are held.
...
**Teacher prompt.** "Here is a second case. A listener asking why it does not promise resolution. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An explanation listing only the guarantees. Why is this not an
example?"
...
- *Licensed conclusion.* Whether both halves are held.
...
- *Expected response.* Whether both halves are held.
...
1. Any wording carrying the idea in `Explaining the architecture requires stating both what it commits to and what it declines to promise`.
...
Say: "The refusals surprise people more than the promises."
...
| | |
|---|---|
| **Follows** | Lesson 28 — Redesigning To Separate |
| **Leads to** | Lesson 30 — The Year In Designs |

**Transition in.** Lesson 28 established students revise a design so it can distinguish explanations. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain guarantees and their limits to somebody else. Lesson 30 assumes it and builds students review the year through their own designs.
