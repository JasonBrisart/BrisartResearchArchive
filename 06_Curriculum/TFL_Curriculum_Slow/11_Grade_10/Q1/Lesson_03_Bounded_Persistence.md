...
| | |
|---|---|
| **Central question** | Bounded Persistence: students explain why E(t) must be bounded? |
| **Core concept** | If E(t) were unbounded, arbitrarily long persistence could always be explained by arbitrarily high intensity, which would make the persistence claim unfalsifiable. |
| **Student outcome** | Students explain why E(t) must be bounded. |
| **Previous lesson** | Lesson 2 — Exclusive Gating |
| **Next lesson** | Lesson 4 — The Gate Under Pressure |
...
**The conceptual step.** If E(t) were unbounded, arbitrarily long persistence could always be explained by arbitrarily high intensity, which would make the persistence claim unfalsifiable.
...
**What depends on it.** Lesson 4 — The Gate Under Pressure — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

If E(t) were unbounded, arbitrarily long persistence could always be explained by arbitrarily high intensity, which would make the persistence claim unfalsifiable.
...
1. An unbounded E(t) explaining any persistence duration.
2. A violating observation of persistence beyond the bound.

### One non-example

Stating that E(t) is bounded with no reason given.
...
That boundedness protects falsifiability.

### What this activity does not establish

Where the bound lies.
...
| Statement | Status |
|---|---|
| If E(t) were unbounded, arbitrarily long persistence could always be explained by arbitrarily high intensity, which would make the persistence claim unfalsifiable. | Framework-derived, appropriate at this grade |
| That boundedness protects falsifiability. | What this specific activity can show |
| Where the bound lies. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — Exclusive Gating — specifically: students state the exclusivity claim in its strongest form.

**How it was taught.** Through the activity: write the three-part exclusivity claim and give one example of each denial

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: write the three-part exclusivity claim and give one example of each denial, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An unbounded E(t) explaining any persistence duration. |
| **Non-example** | Stating that E(t) is bounded with no reason given. |
...
> "Most accounts of emotion say the opposite. The narrowness makes it testable."
...
**Exact wording.** "Ask what would happen if E(t) had no upper limit, and what the model could then explain."
...
**Target observation.** That boundedness protects falsifiability.
...
> "If E(t) were unbounded, arbitrarily long persistence could always be explained by arbitrarily high intensity, which would make the persistence claim unfalsifiable. You just saw that when ask what would happen if E(t) had no upper limit, and what the model could then explain.
> Last time we said: Most accounts of emotion say the opposite. The narrowness makes it testable. This is the next part of that.
...
**What students must not infer.** Where the bound lies.

### 4. Worked example

**The example.** An unbounded E(t) explaining any persistence duration.
...
**Completed answer.** An unbounded E(t) explaining any persistence duration. — which demonstrates that boundedness protects falsifiability.
...
**Conclusions not licensed.** Where the bound lies.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A violating observation of persistence beyond the bound. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Stating that E(t) is bounded with no reason given. Why is this not an
example?"
...
**Exact student instructions.** Write why unbounded E(t) would be a problem and name a violating observation.
...
- *Licensed conclusion.* That boundedness protects falsifiability.
- *Not licensed.* Where the bound lies.
...
- *Expected response.* That boundedness protects falsifiability.
...
1. Any wording carrying the idea in `If E(t) were unbounded, arbitrarily long persistence could always be explained by arbitrarily high intensity, which would make the persistence claim unfalsifiable`.
...
Say: "Boundedness stops the gate from explaining everything."
...
| | |
|---|---|
| **Follows** | Lesson 2 — Exclusive Gating |
| **Leads to** | Lesson 4 — The Gate Under Pressure |

**Transition in.** Lesson 2 established students state the exclusivity claim in its strongest form. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain why E(t) must be bounded. Lesson 4 assumes it and builds students argue three positions on the exclusive gating claim.
