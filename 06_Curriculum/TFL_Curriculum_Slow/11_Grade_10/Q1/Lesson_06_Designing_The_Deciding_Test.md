# Lesson 6 — Designing The Deciding Test
...
| | |
|---|---|
| **Central question** | Designing The Deciding Test: students sketch the design that would settle the gating question? |
| **Core concept** | Distinguishing a within-window effect from a propagated one is the hard part of any gating test. |
| **Student outcome** | Students sketch the design that would settle the gating question. |
| **Previous lesson** | Lesson 5 — The Mediation Defence |
| **Next lesson** | Lesson 7 — Gating In Other Accounts |
...
**The conceptual step.** Distinguishing a within-window effect from a propagated one is the hard part of any gating test. An attempted answer is work; a blank is not.
...
**What depends on it.** Lesson 7 — Gating In Other Accounts — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Distinguishing a within-window effect from a propagated one is the hard part of any gating test. An attempted answer is work; a blank is not.
...
1. A sketch proposing high-resolution within-window measurement.
2. A sketch attempting the distinction and admitting it is incomplete.

### One non-example

A sketch omitting the distinguishing line entirely.
...
That the deciding test can be sketched.

### What this activity does not establish

Whether the sketch would work.
...
| Statement | Status |
|---|---|
| Distinguishing a within-window effect from a propagated one is the hard part of any gating test. | Framework-derived, appropriate at this grade |
| That the deciding test can be sketched. | What this specific activity can show |
| Whether the sketch would work. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — The Mediation Defence — specifically: students evaluate whether the mediation defence is principled.

**How it was taught.** Through the activity: assess the defence against the unfalsifiability charge and state what would settle it

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: assess the defence against the unfalsifiability charge and state what would settle it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A sketch proposing high-resolution within-window measurement. |
| **Non-example** | A sketch omitting the distinguishing line entirely. |
...
> "Either principled or a rescue. Specifying the evidence decides which."
...
**Exact wording.** "Say: you said what would settle it. Now sketch how you would look."
...
**Target observation.** That the deciding test can be sketched.
...
> "Distinguishing a within-window effect from a propagated one is the hard part of any gating test. You just saw that when say: you said what would settle it.
> Last time we said: Either principled or a rescue. Specifying the evidence decides which. This is the next part of that.
...
**What students must not infer.** Whether the sketch would work.

### 4. Worked example

**The example.** A sketch proposing high-resolution within-window measurement.
...
**Completed answer.** A sketch proposing high-resolution within-window measurement. — which demonstrates that the deciding test can be sketched.
...
**Conclusions not licensed.** Whether the sketch would work.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A sketch attempting the distinction and admitting it is incomplete. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A sketch omitting the distinguishing line entirely. Why is this not an
example?"
...
**Exact student instructions.** A four-line design sketch including how to distinguish within-window from propagation.
...
- *Licensed conclusion.* That the deciding test can be sketched.
- *Not licensed.* Whether the sketch would work.
...
- *Expected response.* That the deciding test can be sketched.
...
1. Any wording carrying the idea in `Distinguishing a within-window effect from a propagated one is the hard part of any gating test`.
...
Say: "That fourth line is the hard part and the important one."
...
| | |
|---|---|
| **Follows** | Lesson 5 — The Mediation Defence |
| **Leads to** | Lesson 7 — Gating In Other Accounts |

**Transition in.** Lesson 5 established students evaluate whether the mediation defence is principled. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students sketch the design that would settle the gating question. Lesson 7 assumes it and builds students compare TFL's affect claim with another account.
