...
| | |
|---|---|
| **Central question** | The Gating Review: students consolidate exclusive gating? |
| **Core concept** | Exclusive gating requires all three denials. |
| **Student outcome** | Students consolidate exclusive gating. |
| **Previous lesson** | Lesson 7 — Gating In Other Accounts |
| **Next lesson** | Lesson 9 — The Guarantee Set |
...
**The conceptual step.** Exclusive gating requires all three denials. The review tests whether the full claim survives under time pressure.
...
**What depends on it.** Lesson 9 — The Guarantee Set — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Exclusive gating requires all three denials. The review tests whether the full claim survives under time pressure.
...
1. A statement correctly marked inconsistent with exclusivity.
2. A statement correctly marked consistent.

### One non-example

A statement of gating with only one denial.
...
Whether the full claim is securely held.
...
| Statement | Status |
|---|---|
| Exclusive gating requires all three denials. | Framework-derived, appropriate at this grade |
| Whether the full claim is securely held. | What this specific activity can show |
| Whether the claim is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — Gating In Other Accounts — specifically: students compare TFL's affect claim with another account.

**How it was taught.** Through the activity: compare three outside accounts against exclusive gating and mark where they differ

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: compare three outside accounts against exclusive gating and mark where they differ, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A statement correctly marked inconsistent with exclusivity. |
| **Non-example** | A statement of gating with only one denial. |
...
> "Most accounts give affect a wider role. That is the contest."
...
**Exact wording.** "Ask for the three denials and what would refute them."
...
**Target observation.** Whether the full claim is securely held.
...
> "Exclusive gating requires all three denials. You just saw that when ask for the three denials and what would refute them.
> Last time we said: Most accounts give affect a wider role. That is the contest. This is the next part of that.
...
**What students must not infer.** Whether the claim is correct.

### 4. Worked example

**The example.** A statement correctly marked inconsistent with exclusivity.
...
**Completed answer.** A statement correctly marked inconsistent with exclusivity. — which demonstrates whether the full claim is securely held.
...
**Conclusions not licensed.** Whether the claim is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A statement correctly marked consistent. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A statement of gating with only one denial. Why is this not an
example?"
...
**Exact student instructions.** Review with six statements marked consistent or inconsistent with exclusive gating.
...
- *Licensed conclusion.* Whether the full claim is securely held.
- *Not licensed.* Whether the claim is correct.
...
- *Expected response.* Whether the full claim is securely held.
...
1. Any wording carrying the idea in `Exclusive gating requires all three denials`.
...
Say: "Next time: what the architecture actually promises."
...
| | |
|---|---|
| **Follows** | Lesson 7 — Gating In Other Accounts |
| **Leads to** | Lesson 9 — The Guarantee Set |

**Transition in.** Lesson 7 established students compare TFL's affect claim with another account. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate exclusive gating. Lesson 9 assumes it and builds students state what the architecture commits to.
