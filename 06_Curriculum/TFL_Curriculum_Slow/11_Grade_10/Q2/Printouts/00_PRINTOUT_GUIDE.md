...
**Grade 10** · The Gate and the Guarantees
...
|---|---|---|---|---|---|---|
| `Lesson_09_Printout.md` | Lesson 9 — The Guarantee Set | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_10_Printout.md` | Lesson 10 — Convergence Is Not Guaranteed | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 9 work |
| `Lesson_11_Printout.md` | Lesson 11 — Violating A Guarantee | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 10 work |
| `Lesson_12_Printout.md` | Lesson 12 — Ranking The Guarantees | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 11 work |
| `Lesson_13_Printout.md` | Lesson 13 — Guarantees Versus Predictions | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 12 work |
| `Lesson_14_Printout.md` | Lesson 14 — The Missing Guarantee | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 13 work |
| `Lesson_15_Printout.md` | Lesson 15 — Guarantees Under Challenge | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 14 work |
| `Lesson_16_Printout.md` | Lesson 16 — The Guarantee Review | 3–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 15 work |
...
**Lesson 13 — Guarantees Versus Predictions.** If you only have time to print one
