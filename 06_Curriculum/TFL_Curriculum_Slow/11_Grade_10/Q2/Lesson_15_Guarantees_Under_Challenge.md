# Lesson 15 — Guarantees Under Challenge
...
| | |
|---|---|
| **Central question** | Guarantees Under Challenge: students defend a guarantee against a challenge? |
| **Core concept** | A guarantee must be defensible against the charge of emptiness. |
| **Student outcome** | Students defend a guarantee against a challenge. |
| **Previous lesson** | Lesson 14 — The Missing Guarantee |
| **Next lesson** | Lesson 16 — The Guarantee Review |
...
**The conceptual step.** A guarantee must be defensible against the charge of emptiness. The defence is to supply the violating observation, which restating cannot do.
...
**What depends on it.** Lesson 16 — The Guarantee Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A guarantee must be defensible against the charge of emptiness. The defence is to supply the violating observation, which restating cannot do.
...
1. A defence supplying the violating observation.
2. A defence conceding that one guarantee is weakly specified.

### One non-example

A defence restating the guarantee more firmly.
...
Whether guarantees can be defended.
...
| Statement | Status |
|---|---|
| A guarantee must be defensible against the charge of emptiness. | Framework-derived, appropriate at this grade |
| Whether guarantees can be defended. | What this specific activity can show |
| Whether the guarantees hold. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — The Missing Guarantee — specifically: students identify guarantees a reader might expect but not find.

**How it was taught.** Through the activity: list three absent guarantees and say why each is absent

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: list three absent guarantees and say why each is absent, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence supplying the violating observation. |
| **Non-example** | A defence restating the guarantee more firmly. |
...
> "The absences are as informative as the promises."
...
**Exact wording.** "Say: somebody says this guarantee is empty. Answer them."
...
**Target observation.** Whether guarantees can be defended.
...
> "A guarantee must be defensible against the charge of emptiness. You just saw that when say: somebody says this guarantee is empty.
> Last time we said: The absences are as informative as the promises. This is the next part of that.
...
**The example.** A defence supplying the violating observation.
...
**Completed answer.** A defence supplying the violating observation. — which demonstrates whether guarantees can be defended.
...
**Teacher prompt.** "Here is a second case. A defence conceding that one guarantee is weakly specified. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence restating the guarantee more firmly. Why is this not an
example?"
...
**Exact student instructions.** Defend two guarantees against written challenges.
...
- *Licensed conclusion.* Whether guarantees can be defended.
...
- *Expected response.* Whether guarantees can be defended.
...
1. Any wording carrying the idea in `A guarantee must be defensible against the charge of emptiness`.
...
Say: "A guarantee you cannot defend is a slogan after all."
...
| | |
|---|---|
| **Follows** | Lesson 14 — The Missing Guarantee |
| **Leads to** | Lesson 16 — The Guarantee Review |

**Transition in.** Lesson 14 established students identify guarantees a reader might expect but not find. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students defend a guarantee against a challenge. Lesson 16 assumes it and builds students consolidate the guarantee set.
