# Meeting 9 — Costing The Programme

**Postdoctoral** · Programme Design · **Quarter 3** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Costing The Programme: participants cost the programme honestly in people and years? |
| **Core concept** | A programme costing includes supervision, analysis, writing, and review rather than data collection alone. |
| **Student outcome** | Participants cost the programme honestly in people and years. |
| **Previous meeting** | Meeting 8 — The Study Sequence |
| **Next meeting** | Meeting 10 — The Programme Memo |
| **Materials** | The participant's dissertation and proposal; programme memo templates |
| **Preparation** | an hour |
| **Student printout** | `Printouts/Meeting_09_Printout.md` |
| **Homework** | `Homework/Meeting_09_Homework.md` |

## Why this lesson exists

**The conceptual step.** A programme costing includes supervision, analysis, writing, and review rather than data collection alone. The most expensive failure mode is the one to structure against first.
...
**What depends on it.** Meeting 10 — The Programme Memo — opens by assuming this meeting's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A programme costing includes supervision, analysis, writing, and review rather than data collection alone. The most expensive failure mode is the one to structure against first.
...
1. A costing including supervision and writing time.
2. Single-point dependency identified as the most expensive failure.

### One non-example

A costing covering only data collection.
...
That costing identifies structural priorities.
...
| Statement | Status |
|---|---|
| A programme costing includes supervision, analysis, writing, and review rather than data collection alone. | Framework-derived, appropriate at this grade |
| That costing identifies structural priorities. | What this specific activity can show |
| Whether the programme is affordable. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Meeting 8 — The Study Sequence — specifically: participants order the programme's studies with dependencies stated.

**How it was taught.** Through the activity: draft the sequence with dependencies and per-study falsification conditions

**Quick check.** Ask for the closing sentence of Meeting 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Meeting 8: draft the sequence with dependencies and per-study falsification conditions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A costing including supervision and writing time. |
| **Non-example** | A costing covering only data collection. |
...
**Student materials.** One copy of `Printouts/Meeting_09_Printout.md` per student.

**Prior student data required.** Work produced in Meeting 8, kept in the student's folder.
...
**File.** `Printouts/Meeting_09_Printout.md`
...
> "A sequence with no per-study conditions is a wish list."
...
**Exact wording.** "Ask who runs this, for how long, and what each person gets out of it."
...
**Target observation.** That costing identifies structural priorities.
...
> "A programme costing includes supervision, analysis, writing, and review rather than data collection alone. You just saw that when ask who runs this, for how long, and what each person gets out of it.
> Last time we said: A sequence with no per-study conditions is a wish list. This is the next part of that.
...
**What students must not infer.** Whether the programme is affordable.

### 4. Worked example

**The example.** A costing including supervision and writing time.
...
**Completed answer.** A costing including supervision and writing time. — which demonstrates that costing identifies structural priorities.
...
**Conclusions not licensed.** Whether the programme is affordable.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Single-point dependency identified as the most expensive failure. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A costing covering only data collection. Why is this not an
example?"
...
**Exact student instructions.** Cost the programme in people-years and identify the most expensive failure mode.
...
- *Licensed conclusion.* That costing identifies structural priorities.
- *Not licensed.* Whether the programme is affordable.
...
- *Expected response.* That costing identifies structural priorities.
...
1. Any wording carrying the idea in `A programme costing includes supervision, analysis, writing, and review rather than data collection alone`.
...
Say: "The expensive failure is the one to structure against first."

**Why this sentence matters.** It is the opening question of Meeting 10, which assumes students arrive holding it.
...
**File.** `Homework/Meeting_09_Homework.md`
...
| | |
|---|---|
| **Follows** | Meeting 8 — The Study Sequence |
| **Leads to** | Meeting 10 — The Programme Memo |

**Transition in.** Meeting 8 established participants order the programme's studies with dependencies stated. This meeting uses that as the starting point.

**Transition out.** This meeting establishes participants cost the programme honestly in people and years. Meeting 10 assumes it and builds participants assemble the full recommendation.
