# Meeting 3 — Confirmation Drift

**Postdoctoral** · Programme Design · **Quarter 1** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Confirmation Drift: participants build enforcement against progressively weaker designs? |
| **Core concept** | Confirmation drift occurs when early ambiguous support makes later designs progressively less discriminating. |
| **Student outcome** | Participants build enforcement against progressively weaker designs. |
| **Previous meeting** | Meeting 2 — Single-Point Dependency |
| **Next meeting** | Meeting 4 — Scope Creep Under Success |
| **Materials** | The participant's dissertation and proposal; programme memo templates |
| **Preparation** | an hour |
| **Student printout** | `Printouts/Meeting_03_Printout.md` |
| **Homework** | `Homework/Meeting_03_Homework.md` |

## Why this lesson exists

**The conceptual step.** Confirmation drift occurs when early ambiguous support makes later designs progressively less discriminating. The enforcer must have authority to stop and must not be the programme's principal.
...
**What depends on it.** Meeting 4 — Scope Creep Under Success — opens by assuming this meeting's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Confirmation drift occurs when early ambiguous support makes later designs progressively less discriminating. The enforcer must have authority to stop and must not be the programme's principal.
...
1. An enforcer named with explicit authority to halt a study.
2. An enforcer external to the programme's leadership.

### One non-example

The principal investigator named as their own enforcer.
...
That drift requires structural enforcement.
...
| Statement | Status |
|---|---|
| Confirmation drift occurs when early ambiguous support makes later designs progressively less discriminating. | Framework-derived, appropriate at this grade |
| That drift requires structural enforcement. | What this specific activity can show |
| Whether drift will occur. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Meeting 2 — Single-Point Dependency — specifically: participants identify programmes one result would end.

**How it was taught.** Through the activity: audit the draft programme for dependency and repair it throughout

**Quick check.** Ask for the closing sentence of Meeting 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Meeting 2: audit the draft programme for dependency and repair it throughout, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An enforcer named with explicit authority to halt a study. |
| **Non-example** | The principal investigator named as their own enforcer. |
...
**Student materials.** One copy of `Printouts/Meeting_03_Printout.md` per student.

**Prior student data required.** Work produced in Meeting 2, kept in the student's folder.
...
**File.** `Printouts/Meeting_03_Printout.md`
...
> "If one result ends everything, the structure failed, not the result."
...
**Exact wording.** "Say: early ambiguous support makes later designs less discriminating."
...
**Target observation.** That drift requires structural enforcement.
...
> "Confirmation drift occurs when early ambiguous support makes later designs progressively less discriminating. You just saw that when say: early ambiguous support makes later designs less discriminating.
> Last time we said: If one result ends everything, the structure failed, not the result. This is the next part of that.
...
**The example.** An enforcer named with explicit authority to halt a study.
...
**Completed answer.** An enforcer named with explicit authority to halt a study. — which demonstrates that drift requires structural enforcement.
...
**Teacher prompt.** "Here is a second case. An enforcer external to the programme's leadership. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. The principal investigator named as their own enforcer. Why is this not an
example?"
...
**Exact student instructions.** Specify who enforces the discriminating-condition requirement and their authority.
...
- *Licensed conclusion.* That drift requires structural enforcement.
...
- *Expected response.* That drift requires structural enforcement.
...
1. Any wording carrying the idea in `Confirmation drift occurs when early ambiguous support makes later designs progressively less discriminating`.
...
Say: "An enforcer without authority to stop is a commenter."

**Why this sentence matters.** It is the opening question of Meeting 4, which assumes students arrive holding it.
...
**File.** `Homework/Meeting_03_Homework.md`
...
| | |
|---|---|
| **Follows** | Meeting 2 — Single-Point Dependency |
| **Leads to** | Meeting 4 — Scope Creep Under Success |

**Transition in.** Meeting 2 established participants identify programmes one result would end. This meeting uses that as the starting point.

**Transition out.** This meeting establishes participants build enforcement against progressively weaker designs. Meeting 4 assumes it and builds participants install boundary checks at project initiation.
