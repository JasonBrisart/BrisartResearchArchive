...
| | |
|---|---|
| **Central question** | The Surprise Chart: children review the quarter's surprises and see the pattern? |
| **Core concept** | Every recorded surprise has a guess behind it. |
| **Student outcome** | Children review the quarter's surprises and see the pattern. |
| **Previous lesson** | Lesson 15 — Surprise At Home |
| **Next lesson** | Lesson 17 — Stuck In Your Head |
...
**The conceptual step.** Every recorded surprise has a guess behind it. Reviewing the term makes that pattern visible across many separate cases.
...
**What depends on it.** Lesson 17 — Stuck In Your Head — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every recorded surprise has a guess behind it. Reviewing the term makes that pattern visible across many separate cases.
...
1. The song stop, with the missing continuation named.
2. The counting skip, with four named as the expected number.

### One non-example

A surprise nobody can attach an expectation to — it goes back for another try.
...
That the surprise-to-guess link holds across many cases.

### What this activity does not establish

That all guesses produce surprises.
...
| Statement | Status |
|---|---|
| Every recorded surprise has a guess behind it. | Framework-derived, appropriate at this grade |
| That the surprise-to-guess link holds across many cases. | What this specific activity can show |
| That all guesses produce surprises. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — Surprise At Home — specifically: children report a surprise from outside the classroom.

**How it was taught.** Through the activity: each child shares one home surprise and says what they expected instead

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: each child shares one home surprise and says what they expected instead, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The song stop, with the missing continuation named. |
| **Non-example** | A surprise nobody can attach an expectation to — it goes back for another try. |
...
> "Surprises happen everywhere, not only here."
...
**Exact wording.** "Point at the SURPRISE chart and ask what surprised us this term."
...
**Target observation.** That the surprise-to-guess link holds across many cases.
...
> "Every recorded surprise has a guess behind it. You just saw that when point at the SURPRISE chart and ask what surprised us this term.
> Last time we said: Surprises happen everywhere, not only here. This is the next part of that.
...
**What students must not infer.** That all guesses produce surprises.

### 4. Worked example

**The example.** The song stop, with the missing continuation named.
...
**Completed answer.** The song stop, with the missing continuation named. — which demonstrates that the surprise-to-guess link holds across many cases.
...
**Conclusions not licensed.** That all guesses produce surprises.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The counting skip, with four named as the expected number. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A surprise nobody can attach an expectation to — it goes back for another try. Why is this not an
example?"
...
**Exact student instructions.** Build the class surprise tally. For each, the group says what was expected instead.
...
- *Licensed conclusion.* That the surprise-to-guess link holds across many cases.
- *Not licensed.* That all guesses produce surprises.
...
- *Expected response.* That the surprise-to-guess link holds across many cases.
...
1. Any wording carrying the idea in `Every recorded surprise has a guess behind it`.
...
Say: "Every surprise means a guess was there first."
...
| | |
|---|---|
| **Follows** | Lesson 15 — Surprise At Home |
| **Leads to** | Lesson 17 — Stuck In Your Head |

**Transition in.** Lesson 15 established children report a surprise from outside the classroom. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children review the quarter's surprises and see the pattern. Lesson 17 assumes it and builds children notice some things stay with them and some do not.
