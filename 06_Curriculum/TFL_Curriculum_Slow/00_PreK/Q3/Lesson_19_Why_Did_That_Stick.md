...
| | |
|---|---|
| **Central question** | Why Did That Stick: children begin to say why something stayed with them? |
| **Core concept** | Sticking has a cause, and the cause is how much it mattered. |
| **Student outcome** | Children begin to say why something stayed with them. |
| **Previous lesson** | Lesson 18 — The Song You Cannot Stop |
| **Next lesson** | Lesson 20 — Right But Forgotten |
...
**The conceptual step.** Sticking has a cause, and the cause is how much it mattered. This is the first form of the idea that carries all the way to Grade 7.
...
**What depends on it.** Lesson 20 — Right But Forgotten — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Sticking has a cause, and the cause is how much it mattered. This is the first form of the idea that carries all the way to Grade 7.
...
1. A child says the song stuck because they love it.
2. A child says the surprise stuck because it was funny.

### One non-example

A child who says it stuck because it was correct.
...
That mattering is connected to sticking.

### What this activity does not establish

That mattering is the only cause, or how strong the link is.
...
| Statement | Status |
|---|---|
| Sticking has a cause, and the cause is how much it mattered. | Framework-derived, appropriate at this grade |
| That mattering is connected to sticking. | What this specific activity can show |
| That mattering is the only cause, or how strong the link is. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — The Song You Cannot Stop — specifically: children recognise persistence in a familiar everyday form.

**How it was taught.** Through the activity: children report whether the song kept going in their head, and for how long

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: children report whether the song kept going in their head, and for how long, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child says the song stuck because they love it. |
| **Non-example** | A child who says it stuck because it was correct. |
...
> "That is sticking. It kept going without you playing it."
...
**Exact wording.** "Take one thing from the stuck column and ask why that one."
...
**Target observation.** That mattering is connected to sticking.
...
> "Sticking has a cause, and the cause is how much it mattered. You just saw that when take one thing from the stuck column and ask why that one.
> Last time we said: That is sticking. It kept going without you playing it. This is the next part of that.
...
**What students must not infer.** That mattering is the only cause, or how strong the link is.

### 4. Worked example

**The example.** A child says the song stuck because they love it.
...
**Completed answer.** A child says the song stuck because they love it. — which demonstrates that mattering is connected to sticking.
...
**Conclusions not licensed.** That mattering is the only cause, or how strong the link is.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child says the surprise stuck because it was funny. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who says it stuck because it was correct. Why is this not an
example?"
...
**Exact student instructions.** Each child gives a reason for their own stuck item. Accept any reason.
...
- *Licensed conclusion.* That mattering is connected to sticking.
- *Not licensed.* That mattering is the only cause, or how strong the link is.
...
- *Expected response.* That mattering is connected to sticking.
...
1. Any wording carrying the idea in `Sticking has a cause, and the cause is how much it mattered`.
...
Say: "It stuck because it mattered to you."
...
| | |
|---|---|
| **Follows** | Lesson 18 — The Song You Cannot Stop |
| **Leads to** | Lesson 20 — Right But Forgotten |

**Transition in.** Lesson 18 established children recognise persistence in a familiar everyday form. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children begin to say why something stayed with them. Lesson 20 assumes it and builds children find a correct guess they forgot immediately.
