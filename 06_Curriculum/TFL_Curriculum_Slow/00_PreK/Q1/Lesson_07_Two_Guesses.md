...
| | |
|---|---|
| **Central question** | Two Guesses: children hear that two people can guess differently about the same thing? |
| **Core concept** | Two children given the same evidence can produce different guesses. |
| **Student outcome** | Children hear that two people can guess differently about the same thing. |
| **Previous lesson** | Lesson 6 — Guessing By Touch |
| **Next lesson** | Lesson 8 — The Guessing Chart |
...
**The conceptual step.** Two children given the same evidence can produce different guesses. Difference is normal and is not an error.
...
**What depends on it.** Lesson 8 — The Guessing Chart — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Two children given the same evidence can produce different guesses. Difference is normal and is not an error.
...
1. Two children see the same covered shape and say ball and apple.
2. Two children hear the same sound and say door and chair.

### One non-example

Two children giving the same answer — no difference to notice.
...
That the same evidence can produce different guesses.

### What this activity does not establish

Why they differ, which is Kindergarten work.
...
| Statement | Status |
|---|---|
| Two children given the same evidence can produce different guesses. | Framework-derived, appropriate at this grade |
| That the same evidence can produce different guesses. | What this specific activity can show |
| Why they differ, which is Kindergarten work. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — Guessing By Touch — specifically: children guess using one sense when another is removed.

**How it was taught.** Through the activity: four objects, each felt and guessed before being revealed

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: four objects, each felt and guessed before being revealed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two children see the same covered shape and say ball and apple. |
| **Non-example** | Two children giving the same answer — no difference to notice. |
...
> "Even with your eyes closed, your brain still guesses."
...
**Exact wording.** "Show something mostly hidden. Take two different answers and put both on the chart."
...
**Target observation.** That the same evidence can produce different guesses.
...
> "Two children given the same evidence can produce different guesses. You just saw that when show something mostly hidden.
> Last time we said: Even with your eyes closed, your brain still guesses. This is the next part of that.
...
**What students must not infer.** Why they differ, which is Kindergarten work.

### 4. Worked example

**The example.** Two children see the same covered shape and say ball and apple.
...
**Completed answer.** Two children see the same covered shape and say ball and apple. — which demonstrates that the same evidence can produce different guesses.
...
**Conclusions not licensed.** Why they differ, which is Kindergarten work.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Two children hear the same sound and say door and chair. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two children giving the same answer — no difference to notice. Why is this not an
example?"
...
**Exact student instructions.** Partner guessing: pairs guess about the same hidden object and compare.
...
- *Licensed conclusion.* That the same evidence can produce different guesses.
- *Not licensed.* Why they differ, which is Kindergarten work.
...
- *Expected response.* That the same evidence can produce different guesses.
...
1. Any wording carrying the idea in `Two children given the same evidence can produce different guesses`.
...
Say: "Two people can guess different things. Nobody is in trouble."
...
| | |
|---|---|
| **Follows** | Lesson 6 — Guessing By Touch |
| **Leads to** | Lesson 8 — The Guessing Chart |

**Transition in.** Lesson 6 established children guess using one sense when another is removed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children hear that two people can guess differently about the same thing. Lesson 8 assumes it and builds children review the quarter and see that guessing happened every session.
