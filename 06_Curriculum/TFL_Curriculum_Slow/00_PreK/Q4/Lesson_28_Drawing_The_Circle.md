...
| | |
|---|---|
| **Central question** | Drawing The Circle: children draw the cycle with arrows? |
| **Core concept** | A drawing with a returning arrow shows the child has the shape, not just the sequence. |
| **Student outcome** | Children draw the cycle with arrows. |
| **Previous lesson** | Lesson 27 — Walking The Circle |
| **Next lesson** | Lesson 29 — The Circle At Home |
...
**The conceptual step.** A drawing with a returning arrow shows the child has the shape, not just the sequence. Lines and circles mean different things here.
...
**What depends on it.** Lesson 29 — The Circle At Home — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A drawing with a returning arrow shows the child has the shape, not just the sequence. Lines and circles mean different things here.
...
1. A circle with arrows returning to the start.
2. A child who explains the return even if the drawing is rough.

### One non-example

A straight line of three pictures with no return.
...
Whether the child holds the cyclical shape.
...
| Statement | Status |
|---|---|
| A drawing with a returning arrow shows the child has the shape, not just the sequence. | Framework-derived, appropriate at this grade |
| Whether the child holds the cyclical shape. | What this specific activity can show |
| Drawing skill. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — Walking The Circle — specifically: children physically walk the cycle.

**How it was taught.** Through the activity: small groups walk the triangle twice, saying a real thing at each spot

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: small groups walk the triangle twice, saying a real thing at each spot, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A circle with arrows returning to the start. |
| **Non-example** | A straight line of three pictures with no return. |
...
> "You came back to the start. It goes round."
...
**Exact wording.** "Draw a big circle on chart paper and trace it with a finger three times."
...
**Target observation.** Whether the child holds the cyclical shape.
...
> "A drawing with a returning arrow shows the child has the shape, not just the sequence. You just saw that when draw a big circle on chart paper and trace it with a finger three times.
> Last time we said: You came back to the start. It goes round. This is the next part of that.
...
**What students must not infer.** Drawing skill.

### 4. Worked example

**The example.** A circle with arrows returning to the start.
...
**Completed answer.** A circle with arrows returning to the start. — which demonstrates whether the child holds the cyclical shape.
...
**Conclusions not licensed.** Drawing skill.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child who explains the return even if the drawing is rough. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A straight line of three pictures with no return. Why is this not an
example?"
...
**Exact student instructions.** Each child draws their own circle with arrows going round.
...
- *Licensed conclusion.* Whether the child holds the cyclical shape.
- *Not licensed.* Drawing skill.
...
- *Expected response.* Whether the child holds the cyclical shape.
...
1. Any wording carrying the idea in `A drawing with a returning arrow shows the child has the shape, not just the sequence`.
...
Say: "The arrow goes back to where it started."
...
| | |
|---|---|
| **Follows** | Lesson 27 — Walking The Circle |
| **Leads to** | Lesson 29 — The Circle At Home |

**Transition in.** Lesson 27 established children physically walk the cycle. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children draw the cycle with arrows. Lesson 29 assumes it and builds children find the cycle outside school.
