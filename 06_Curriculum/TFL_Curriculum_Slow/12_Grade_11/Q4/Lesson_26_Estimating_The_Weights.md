# Lesson 26 — Estimating The Weights

**Grade 11** · Measurement and Rivals · **Quarter 4** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Estimating The Weights: students determine whether their design can recover parameters? |
| **Core concept** | Memory and simulation covary by construction in most tasks, making the weights unidentifiable. |
| **Student outcome** | Students determine whether their design can recover parameters. |
| **Previous lesson** | Lesson 25 — What Cannot Be Measured |
| **Next lesson** | Lesson 27 — Resolution And Claim Scale |
...
**The conceptual step.** Memory and simulation covary by construction in most tasks, making the weights unidentifiable. Declaring estimation infeasible is the correct answer for most designs.
...
**What depends on it.** Lesson 27 — Resolution And Claim Scale — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Memory and simulation covary by construction in most tasks, making the weights unidentifiable. Declaring estimation infeasible is the correct answer for most designs.
...
1. A feasibility statement declaring estimation infeasible.
2. A statement naming which claims survive without the weights.

### One non-example

A proposal to estimate weights from collinear predictors.
...
That estimation feasibility can be assessed honestly.
...
| Statement | Status |
|---|---|
| Memory and simulation covary by construction in most tasks, making the weights unidentifiable. | Framework-derived, appropriate at this grade |
| That estimation feasibility can be assessed honestly. | What this specific activity can show |
| What the weights are. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — What Cannot Be Measured — specifically: students identify framework claims that currently resist measurement.

**How it was taught.** Through the activity: list four currently untestable claims and say what would be needed for each

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: list four currently untestable claims and say what would be needed for each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A feasibility statement declaring estimation infeasible. |
| **Non-example** | A proposal to estimate weights from collinear predictors. |
...
> "Some of it is not testable yet. That is a real state of affairs."
...
**Exact wording.** "Ask what it would take to estimate w1, w2, w3, and whether they can."
...
**Target observation.** That estimation feasibility can be assessed honestly.
...
> "Memory and simulation covary by construction in most tasks, making the weights unidentifiable. You just saw that when ask what it would take to estimate w1, w2, w3, and whether they can.
> Last time we said: Some of it is not testable yet. That is a real state of affairs. This is the next part of that.
...
**The example.** A feasibility statement declaring estimation infeasible.
...
**Completed answer.** A feasibility statement declaring estimation infeasible. — which demonstrates that estimation feasibility can be assessed honestly.
...
**Teacher prompt.** "Here is a second case. A statement naming which claims survive without the weights. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A proposal to estimate weights from collinear predictors. Why is this not an
example?"
...
**Exact student instructions.** Write an estimation feasibility statement naming which claims survive without the weights.
...
- *Licensed conclusion.* That estimation feasibility can be assessed honestly.
...
- *Expected response.* That estimation feasibility can be assessed honestly.
...
1. Any wording carrying the idea in `Memory and simulation covary by construction in most tasks, making the weights unidentifiable`.
...
Say: "Most designs cannot. Declaring that is the correct answer."
...
| | |
|---|---|
| **Follows** | Lesson 25 — What Cannot Be Measured |
| **Leads to** | Lesson 27 — Resolution And Claim Scale |

**Transition in.** Lesson 25 established students identify framework claims that currently resist measurement. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students determine whether their design can recover parameters. Lesson 27 assumes it and builds students match what they claim to what they observed.
