...
| | |
|---|---|
| **Central question** | The Measurement Map: students build a seven-line measurement map? |
| **Core concept** | A measurement map states, for each variable and parameter, exactly what somebody physically does to obtain it. |
| **Student outcome** | Students build a seven-line measurement map. |
| **Previous lesson** | Lesson 1 — The Testability Constraint |
| **Next lesson** | Lesson 3 — Measuring Sim(t) |
...
**The conceptual step.** A measurement map states, for each variable and parameter, exactly what somebody physically does to obtain it. Intentions are not procedures.
...
**What depends on it.** Lesson 3 — Measuring Sim(t) — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A measurement map states, for each variable and parameter, exactly what somebody physically does to obtain it. Intentions are not procedures.
...
1. A line stating the exact prompt and response format.
2. A line stating the recording interval and the device.

### One non-example

A line stating that intensity will be assessed appropriately.
...
That maps can be audited for runnability.

### What this activity does not establish

Whether the map would produce good data.
...
| Statement | Status |
|---|---|
| A measurement map states, for each variable and parameter, exactly what somebody physically does to obtain it. | Framework-derived, appropriate at this grade |
| That maps can be audited for runnability. | What this specific activity can show |
| Whether the map would produce good data. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 1 — The Testability Constraint — specifically: students state the testability constraint and apply it.

**How it was taught.** Through the activity: apply the constraint to four proposals, marking each valid or invalid with reasons

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: apply the constraint to four proposals, marking each valid or invalid with reasons, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A line stating the exact prompt and response format. |
| **Non-example** | A line stating that intensity will be assessed appropriately. |
...
> "By the framework's own standard, most casual uses are invalid."
...
**Exact wording.** "Say: five variables and two parameters. Seven lines. If somebody cannot run your study from those, it is not a map."
...
**Target observation.** That maps can be audited for runnability.
...
> "A measurement map states, for each variable and parameter, exactly what somebody physically does to obtain it. You just saw that when say: five variables and two parameters.
> Last time we said: By the framework's own standard, most casual uses are invalid. This is the next part of that.
...
**What students must not infer.** Whether the map would produce good data.

### 4. Worked example

**The example.** A line stating the exact prompt and response format.
...
**Completed answer.** A line stating the exact prompt and response format. — which demonstrates that maps can be audited for runnability.
...
**Conclusions not licensed.** Whether the map would produce good data.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A line stating the recording interval and the device. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A line stating that intensity will be assessed appropriately. Why is this not an
example?"
...
**Exact student instructions.** Build a first-draft map, then have a partner mark every unrunnable line.
...
- *Licensed conclusion.* That maps can be audited for runnability.
- *Not licensed.* Whether the map would produce good data.
...
- *Expected response.* That maps can be audited for runnability.
...
1. Any wording carrying the idea in `A measurement map states, for each variable and parameter, exactly what somebody physically does to obtain it`.
...
Say: "Most first maps come back heavily marked. That is the intended result."
...
| | |
|---|---|
| **Follows** | Lesson 1 — The Testability Constraint |
| **Leads to** | Lesson 3 — Measuring Sim(t) |

**Transition in.** Lesson 1 established students state the testability constraint and apply it. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students build a seven-line measurement map. Lesson 3 assumes it and builds students design a contamination-resistant capture of simulation content.
