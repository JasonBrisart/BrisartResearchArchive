# Lesson 9 — Three Other Explanations
...
| | |
|---|---|
| **Central question** | Three Other Explanations: students state the three rival accounts? |
| **Core concept** | The three teaching rivals are uncertainty-only, arousal-only, and habit-based. |
| **Student outcome** | Students state the three rival accounts. |
| **Previous lesson** | Lesson 8 — The Measurement Review |
| **Next lesson** | Lesson 10 — Stating A Rival Fairly |
...
**The conceptual step.** The three teaching rivals are uncertainty-only, arousal-only, and habit-based. Each must be stated in a form its proponents would accept.
...
**What depends on it.** Lesson 10 — Stating A Rival Fairly — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The three teaching rivals are uncertainty-only, arousal-only, and habit-based. Each must be stated in a form its proponents would accept.
...
1. The uncertainty account stated as its proponents would.
2. A differential table with four genuinely distinct predictions.

### One non-example

A rival stated in a form designed to fail.
...
That rivals can be stated fairly and compared.
...
| Statement | Status |
|---|---|
| The three teaching rivals are uncertainty-only, arousal-only, and habit-based. | Framework-derived, appropriate at this grade |
| That rivals can be stated fairly and compared. | What this specific activity can show |
| Which rival is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Measurement Review — specifically: students consolidate measurement.

**How it was taught.** Through the activity: review with six maps audited for executability

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: review with six maps audited for executability, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The uncertainty account stated as its proponents would. |
| **Non-example** | A rival stated in a form designed to fail. |
...
> "Next time: three other explanations for everything you find."
...
**Exact wording.** "Present a persistence result and ask them to explain it without using the framework."
...
**Target observation.** That rivals can be stated fairly and compared.
...
> "The three teaching rivals are uncertainty-only, arousal-only, and habit-based. You just saw that when present a persistence result and ask them to explain it without using the framework.
> Last time we said: Next time: three other explanations for everything you find. This is the next part of that.
...
**The example.** The uncertainty account stated as its proponents would.
...
**Completed answer.** The uncertainty account stated as its proponents would. — which demonstrates that rivals can be stated fairly and compared.
...
**Teacher prompt.** "Here is a second case. A differential table with four genuinely distinct predictions. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rival stated in a form designed to fail. Why is this not an
example?"
...
**Exact student instructions.** Complete a four-row differential prediction table for one scenario.
...
- *Licensed conclusion.* That rivals can be stated fairly and compared.
...
- *Expected response.* That rivals can be stated fairly and compared.
...
1. Any wording carrying the idea in `The three teaching rivals are uncertainty-only, arousal-only, and habit-based`.
...
Say: "A valid implementation must permit adjudication against these."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Measurement Review |
| **Leads to** | Lesson 10 — Stating A Rival Fairly |

**Transition in.** Lesson 8 established students consolidate measurement. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state the three rival accounts. Lesson 10 assumes it and builds students state rivals as their proponents would.
