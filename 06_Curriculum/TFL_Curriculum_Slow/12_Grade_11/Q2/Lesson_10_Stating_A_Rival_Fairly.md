# Lesson 10 — Stating A Rival Fairly
...
| **Previous lesson** | Lesson 9 — Three Other Explanations |
| **Next lesson** | Lesson 11 — Consistency Is Not Evidence |
...
**The conceptual step.** A rival stated by somebody who rejects it will be stated to lose. Assigned checkers who find the rival plausible are the only reliable safeguard.
...
**What depends on it.** Lesson 11 — Consistency Is Not Evidence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A rival stated by somebody who rejects it will be stated to lose. Assigned checkers who find the rival plausible are the only reliable safeguard.
...
1. A rival statement a checker accepts as fair.
2. A rival statement revised after the checker objected.

### One non-example

A rival checked by a friend who shares the author's view.
...
That fair statement requires external checking.
...
| That fair statement requires external checking. | What this specific activity can show |
| Which rival is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 9 — Three Other Explanations — specifically: students state the three rival accounts.

**How it was taught.** Through the activity: complete a four-row differential prediction table for one scenario

**Quick check.** Ask for the closing sentence of Lesson 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 9: complete a four-row differential prediction table for one scenario, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A rival statement a checker accepts as fair. |
| **Non-example** | A rival checked by a friend who shares the author's view. |
...
> "A valid implementation must permit adjudication against these."
...
**Exact wording.** "Put up two statements of the uncertainty account, one by a believer and one by an opponent."
...
**Target observation.** That fair statement requires external checking.
...
> "A rival stated by somebody who rejects it will be stated to lose. You just saw that when put up two statements of the uncertainty account, one by a believer and one by an opponent.
> Last time we said: A valid implementation must permit adjudication against these. This is the next part of that.
...
**The example.** A rival statement a checker accepts as fair.
...
**Completed answer.** A rival statement a checker accepts as fair. — which demonstrates that fair statement requires external checking.
...
**Teacher prompt.** "Here is a second case. A rival statement revised after the checker objected. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rival checked by a friend who shares the author's view. Why is this not an
example?"
...
**Exact student instructions.** Write each rival and have it checked by a classmate assigned to defend it.
...
- *Licensed conclusion.* That fair statement requires external checking.
...
- *Expected response.* That fair statement requires external checking.
...
| | |
|---|---|
| **Follows** | Lesson 9 — Three Other Explanations |
| **Leads to** | Lesson 11 — Consistency Is Not Evidence |

**Transition in.** Lesson 9 established students state the three rival accounts. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state rivals as their proponents would. Lesson 11 assumes it and builds students discover their own results fit the rivals equally well.
