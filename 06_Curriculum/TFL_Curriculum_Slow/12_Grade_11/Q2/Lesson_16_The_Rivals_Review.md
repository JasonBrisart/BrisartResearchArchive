...
| | |
|---|---|
| **Central question** | The Rivals Review: students consolidate the rival accounts? |
| **Core concept** | Coinciding prediction rows are a finding about the design rather than a student error. |
| **Student outcome** | Students consolidate the rival accounts. |
| **Previous lesson** | Lesson 15 — Rivals From Elsewhere |
| **Next lesson** | Lesson 17 — Confounds |
...
**The conceptual step.** Coinciding prediction rows are a finding about the design rather than a student error. Marking them as findings preserves the honest record.
...
**What depends on it.** Lesson 17 — Confounds — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Coinciding prediction rows are a finding about the design rather than a student error. Marking them as findings preserves the honest record.
...
1. A five-row table with distinct predictions.
2. A coinciding row marked as a design finding.

### One non-example

A row adjusted to force distinctness.
...
Whether fair statement and differential prediction are habitual.
...
| Statement | Status |
|---|---|
| Coinciding prediction rows are a finding about the design rather than a student error. | Framework-derived, appropriate at this grade |
| Whether fair statement and differential prediction are habitual. | What this specific activity can show |
| Which account is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — Rivals From Elsewhere — specifically: students find competing accounts outside the supplied three.

**How it was taught.** Through the activity: identify two outside accounts and state where each diverges from TFL

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: identify two outside accounts and state where each diverges from TFL, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A five-row table with distinct predictions. |
| **Non-example** | A row adjusted to force distinctness. |
...
> "The real competition is bigger than three."
...
**Exact wording.** "Ask for the three rivals, fairly stated, and where they come apart."
...
**Target observation.** Whether fair statement and differential prediction are habitual.
...
> "Coinciding prediction rows are a finding about the design rather than a student error. You just saw that when ask for the three rivals, fairly stated, and where they come apart.
> Last time we said: The real competition is bigger than three. This is the next part of that.
...
**The example.** A five-row table with distinct predictions.
...
**Completed answer.** A five-row table with distinct predictions. — which demonstrates whether fair statement and differential prediction are habitual.
...
**Teacher prompt.** "Here is a second case. A coinciding row marked as a design finding. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A row adjusted to force distinctness. Why is this not an
example?"
...
**Exact student instructions.** Review with a five-row differential table completed.
...
- *Licensed conclusion.* Whether fair statement and differential prediction are habitual.
...
- *Expected response.* Whether fair statement and differential prediction are habitual.
...
1. Any wording carrying the idea in `Coinciding prediction rows are a finding about the design rather than a student error`.
...
Say: "Next time: what would ruin your result."
...
| | |
|---|---|
| **Follows** | Lesson 15 — Rivals From Elsewhere |
| **Leads to** | Lesson 17 — Confounds |

**Transition in.** Lesson 15 established students find competing accounts outside the supplied three. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the rival accounts. Lesson 17 assumes it and builds students identify what must be controlled for a result to mean anything.
