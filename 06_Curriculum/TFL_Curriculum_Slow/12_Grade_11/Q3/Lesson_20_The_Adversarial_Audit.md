# Lesson 20 — The Adversarial Audit
...
| | |
|---|---|
| **Central question** | The Adversarial Audit: students attack a design using an assigned rival account? |
| **Core concept** | Adversarial audit requires the designer to listen rather than defend. |
| **Student outcome** | Students attack a design using an assigned rival account. |
| **Previous lesson** | Lesson 19 — Selection Effects |
| **Next lesson** | Lesson 21 — Answering The Audit |
...
**The conceptual step.** Adversarial audit requires the designer to listen rather than defend. Defending in real time stops the designer hearing the attack.
...
**What depends on it.** Lesson 21 — Answering The Audit — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Adversarial audit requires the designer to listen rather than defend. Defending in real time stops the designer hearing the attack.
...
2. A designer taking notes silently during the attack.

### One non-example

A designer arguing back during the first round.
...
That designs can be attacked systematically.
...
| Statement | Status |
|---|---|
| Adversarial audit requires the designer to listen rather than defend. | Framework-derived, appropriate at this grade |
| That designs can be attacked systematically. | What this specific activity can show |
| Whether the design survives. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — Selection Effects — specifically: students identify bias in which predictions get recorded.

**How it was taught.** Through the activity: audit their own historical logs for selection bias and estimate its direction

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: audit their own historical logs for selection bias and estimate its direction, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A designer arguing back during the first round. |
...
> "You selected without meaning to. Everybody does."
...
**Exact wording.** "Say: you are assigned one rival. Explain their result using it."
...
**Target observation.** That designs can be attacked systematically.
...
> "Adversarial audit requires the designer to listen rather than defend. You just saw that when say: you are assigned one rival.
> Last time we said: You selected without meaning to. Everybody does. This is the next part of that.
...
**Completed answer.** A design attacked from all three rival positions. — which demonstrates that designs can be attacked systematically.
...
**Teacher prompt.** "Here is a second case. A designer taking notes silently during the attack. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A designer arguing back during the first round. Why is this not an
example?"
...
**Exact student instructions.** Three rotating rounds of written attack; designers take notes without defending.
...
- *Licensed conclusion.* That designs can be attacked systematically.
...
- *Expected response.* That designs can be attacked systematically.
...
1. Any wording carrying the idea in `Adversarial audit requires the designer to listen rather than defend`.
...
Say: "If a design cannot survive this room, it will not survive anywhere."
...
| | |
|---|---|
| **Follows** | Lesson 19 — Selection Effects |
| **Leads to** | Lesson 21 — Answering The Audit |

**Transition in.** Lesson 19 established students identify bias in which predictions get recorded. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students attack a design using an assigned rival account. Lesson 21 assumes it and builds students revise a design against adversarial feedback.
