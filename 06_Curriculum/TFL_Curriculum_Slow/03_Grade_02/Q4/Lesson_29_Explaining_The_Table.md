# Lesson 29 — Explaining The Table

**Grade 2** · Comparing and Checking · **Quarter 4** · **30 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Explaining The Table: students explain the table to somebody who was not there? |
| **Core concept** | Explaining the tool to somebody absent tests whether the student holds the structure or only the habit of filling it in. |
| **Student outcome** | Students explain the table to somebody who was not there. |
| **Previous lesson** | Lesson 28 — Tables From Other Subjects |
| **Next lesson** | Lesson 30 — The Whole Comparison |
...
**The conceptual step.** Explaining the tool to somebody absent tests whether the student holds the structure or only the habit of filling it in.
...
**What depends on it.** Lesson 30 — The Whole Comparison — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Explaining the tool to somebody absent tests whether the student holds the structure or only the habit of filling it in.
...
1. A listener asks why the evidence column exists.
2. A listener asks what to do with a blank column.

### One non-example

Reporting that the listener followed it perfectly.
...
Where the student's understanding of the tool runs out.
...
| Statement | Status |
|---|---|
| Explaining the tool to somebody absent tests whether the student holds the structure or only the habit of filling it in. | Framework-derived, appropriate at this grade |
| Where the student's understanding of the tool runs out. | What this specific activity can show |
| Whether the explanation was complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — Tables From Other Subjects — specifically: students build a comparison table on non-TFL material.

**How it was taught.** Through the activity: a four-column table comparing two accounts from another subject

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: a four-column table comparing two accounts from another subject, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A listener asks why the evidence column exists. |
| **Non-example** | Reporting that the listener followed it perfectly. |
...
> "The tool works on anything with two accounts."
...
**Target observation.** Where the student's understanding of the tool runs out.
...
> "Explaining the tool to somebody absent tests whether the student holds the structure or only the habit of filling it in. You just saw that when say: today you teach it.
> Last time we said: The tool works on anything with two accounts. This is the next part of that.
...
**The example.** A listener asks why the evidence column exists.
...
**Completed answer.** A listener asks why the evidence column exists. — which demonstrates where the student's understanding of the tool runs out.
...
**Teacher prompt.** "Here is a second case. A listener asks what to do with a blank column. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reporting that the listener followed it perfectly. Why is this not an
example?"
...
**Exact student instructions.** Each student explains the four columns to a buddy and records one question asked.
...
- *Licensed conclusion.* Where the student's understanding of the tool runs out.
...
- *Expected response.* Where the student's understanding of the tool runs out.
...
1. Any wording carrying the idea in `Explaining the tool to somebody absent tests whether the student holds the structure or only the habit of filling it in`.
...
Say: "The question is the useful bit."
...
| | |
|---|---|
| **Follows** | Lesson 28 — Tables From Other Subjects |
| **Leads to** | Lesson 30 — The Whole Comparison |

**Transition in.** Lesson 28 established students build a comparison table on non-TFL material. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain the table to somebody who was not there. Lesson 30 assumes it and builds students produce, check, and repair a complete comparison.
