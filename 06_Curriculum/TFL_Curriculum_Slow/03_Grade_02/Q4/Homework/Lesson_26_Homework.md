# Lesson 26 Homework — Checking A Table

**Grade 2** · Comparing and Checking · **Quarter 4**
**Follows:** Lesson 26 — Checking A Table · **Points:** 5 · **Optional:** yes
...
Swap tables and mark every row missing a column or with unpointable evidence.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student receives a checked table with a specific note
...
Lesson 27 is **Fixing A Table**, which assumes you arrive holding it. Write one thing you expect it to be about:
