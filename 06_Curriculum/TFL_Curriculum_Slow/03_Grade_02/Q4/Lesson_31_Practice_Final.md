...
| **Core concept** | The practice final locates gaps while there is still time to close them. |
| **Student outcome** | Students rehearse the final under conditions. |
| **Previous lesson** | Lesson 30 — The Whole Comparison |
...
**The conceptual step.** The practice final locates gaps while there is still time to close them. Self-marking is what makes the diagnosis usable.
...
The practice final locates gaps while there is still time to close them. Self-marking is what makes the diagnosis usable.
...
1. A student identifies the evidence column as their weak point.
2. A student finds they cannot name causes reliably.

### One non-example

Treating the practice as the graded assessment.
...
| Statement | Status |
|---|---|
| The practice final locates gaps while there is still time to close them. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 30 — The Whole Comparison — specifically: students produce, check, and repair a complete comparison.

**How it was taught.** Through the activity: full cycle: build, swap, check, repair, read one finding aloud

**Quick check.** Ask for the closing sentence of Lesson 30. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 30: full cycle: build, swap, check, repair, read one finding aloud, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student identifies the evidence column as their weak point. |
| **Non-example** | Treating the practice as the graded assessment. |
...
> "Next year: all of this fits into one single moment."
...
> "The practice final locates gaps while there is still time to close them. You just saw that when say: same as the real one.
> Last time we said: Next year: all of this fits into one single moment. This is the next part of that.
...
**The example.** A student identifies the evidence column as their weak point.
...
**Completed answer.** A student identifies the evidence column as their weak point. — which demonstrates where each student is weakest.
...
**Teacher prompt.** "Here is a second case. A student finds they cannot name causes reliably. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Treating the practice as the graded assessment. Why is this not an
example?"
...
**Exact student instructions.** A full practice final, self-marked against the key.
...
1. Any wording carrying the idea in `The practice final locates gaps while there is still time to close them`.
...
Say: "Now you know what to look at."
...
| | |
|---|---|
| **Follows** | Lesson 30 — The Whole Comparison |
| **Leads to** | Lesson 32 — Final Assessment |

**Transition in.** Lesson 30 established students produce, check, and repair a complete comparison. This lesson uses that as the starting point.
