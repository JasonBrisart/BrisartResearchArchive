...
| | |
|---|---|
| **Central question** | When One Is Wrong: students handle the case where one expectation was checkable and wrong? |
| **Core concept** | Being falsified is different from merely differing. |
| **Student outcome** | Students handle the case where one expectation was checkable and wrong. |
| **Previous lesson** | Lesson 5 — Both Reasonable |
| **Next lesson** | Lesson 7 — Comparing With A Partner |
...
**The conceptual step.** Being falsified is different from merely differing. The checkability test separates the two cases.
...
**What depends on it.** Lesson 7 — Comparing With A Partner — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Being falsified is different from merely differing. The checkability test separates the two cases.
...
1. One expected the door locked, it was open, and both could see it.
2. One expected rain, the sky stayed clear all day.

### One non-example

Two expectations about something nobody can check.
...
That falsification and disagreement are different.

### What this activity does not establish

Which expectation was better reasoned.
...
| Statement | Status |
|---|---|
| Being falsified is different from merely differing. | Framework-derived, appropriate at this grade |
| That falsification and disagreement are different. | What this specific activity can show |
| Which expectation was better reasoned. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — Both Reasonable — specifically: students accept that two differing expectations can both be reasonable.

**How it was taught.** Through the activity: find one comparison where both sides were reasonable and say why

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: find one comparison where both sides were reasonable and say why, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | One expected the door locked, it was open, and both could see it. |
| **Non-example** | Two expectations about something nobody can check. |
...
**Exact wording.** "Present a case where one expectation was clearly falsified."
...
**Target observation.** That falsification and disagreement are different.
...
> "Being falsified is different from merely differing. You just saw that when present a case where one expectation was clearly falsified.
> Last time we said: Different does not mean wrong. This is the next part of that.
...
**What students must not infer.** Which expectation was better reasoned.

### 4. Worked example

**The example.** One expected the door locked, it was open, and both could see it.
...
**Completed answer.** One expected the door locked, it was open, and both could see it. — which demonstrates that falsification and disagreement are different.
...
**Conclusions not licensed.** Which expectation was better reasoned.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. One expected rain, the sky stayed clear all day. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two expectations about something nobody can check. Why is this not an
example?"
...
**Exact student instructions.** Three cases sorted: both reasonable, one falsified, or not yet checkable.
...
- *Licensed conclusion.* That falsification and disagreement are different.
- *Not licensed.* Which expectation was better reasoned.
...
- *Expected response.* That falsification and disagreement are different.
...
1. Any wording carrying the idea in `Being falsified is different from merely differing`.
...
Say: "Sometimes one is wrong. That is different from disagreeing."
...
| | |
|---|---|
| **Follows** | Lesson 5 — Both Reasonable |
| **Leads to** | Lesson 7 — Comparing With A Partner |

**Transition in.** Lesson 5 established students accept that two differing expectations can both be reasonable. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students handle the case where one expectation was checkable and wrong. Lesson 7 assumes it and builds students run a full comparison with a partner on a shared event.
