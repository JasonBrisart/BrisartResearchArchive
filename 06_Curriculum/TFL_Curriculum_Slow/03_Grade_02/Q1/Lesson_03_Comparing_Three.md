...
| | |
|---|---|
| **Central question** | Comparing Three: students extend comparison beyond a pair? |
| **Core concept** | Three items are compared as three pairs, not as one three-way act. |
| **Student outcome** | Students extend comparison beyond a pair. |
| **Previous lesson** | Lesson 2 — Why They Differed |
| **Next lesson** | Lesson 4 — Comparing Across The Day |
...
**The conceptual step.** Three items are compared as three pairs, not as one three-way act. The pairwise method is what keeps the comparison tractable.
...
**What depends on it.** Lesson 4 — Comparing Across The Day — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Three items are compared as three pairs, not as one three-way act. The pairwise method is what keeps the comparison tractable.
...
1. Comparing A with B, then B with C.
2. Naming two differences from three answers.

### One non-example

Trying to state one difference that covers all three.
...
That multi-item comparison decomposes into pairs.

### What this activity does not establish

Any ranking of the three.
...
| Statement | Status |
|---|---|
| Three items are compared as three pairs, not as one three-way act. | Framework-derived, appropriate at this grade |
| That multi-item comparison decomposes into pairs. | What this specific activity can show |
| Any ranking of the three. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — Why They Differed — specifically: students name the memory behind each of two expectations.

**How it was taught.** Through the activity: trace both halves of their Lesson 1 comparison to two different memories

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: trace both halves of their Lesson 1 comparison to two different memories, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Comparing A with B, then B with C. |
| **Non-example** | Trying to state one difference that covers all three. |
...
> "Different memories cause different expectations."
...
**Exact wording.** "Three answers on the board. Ask what now."
...
**Target observation.** That multi-item comparison decomposes into pairs.
...
> "Three items are compared as three pairs, not as one three-way act. You just saw that when three answers on the board.
> Last time we said: Different memories cause different expectations. This is the next part of that.
...
**What students must not infer.** Any ranking of the three.

### 4. Worked example

**The example.** Comparing A with B, then B with C.
...
**Completed answer.** Comparing A with B, then B with C. — which demonstrates that multi-item comparison decomposes into pairs.
...
**Conclusions not licensed.** Any ranking of the three.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Naming two differences from three answers. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Trying to state one difference that covers all three. Why is this not an
example?"
...
**Exact student instructions.** A three-way comparison with two differences named.
...
- *Licensed conclusion.* That multi-item comparison decomposes into pairs.
- *Not licensed.* Any ranking of the three.
...
- *Expected response.* That multi-item comparison decomposes into pairs.
...
1. Any wording carrying the idea in `Three items are compared as three pairs, not as one three-way act`.
...
Say: "More than two can be compared, but you compare them in pairs."
...
| | |
|---|---|
| **Follows** | Lesson 2 — Why They Differed |
| **Leads to** | Lesson 4 — Comparing Across The Day |

**Transition in.** Lesson 2 established students name the memory behind each of two expectations. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students extend comparison beyond a pair. Lesson 4 assumes it and builds students compare expectations from different points in one day.
