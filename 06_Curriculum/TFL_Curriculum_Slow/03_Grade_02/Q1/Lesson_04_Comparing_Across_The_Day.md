# Lesson 4 — Comparing Across The Day
...
| | |
|---|---|
| **Central question** | Comparing Across The Day: students compare expectations from different points in one day? |
| **Core concept** | Comparison also works within one person across time. |
| **Student outcome** | Students compare expectations from different points in one day. |
| **Previous lesson** | Lesson 3 — Comparing Three |
| **Next lesson** | Lesson 5 — Both Reasonable |
...
**The conceptual step.** Comparison also works within one person across time. The same topic at two times is the controlled case.
...
**What depends on it.** Lesson 5 — Both Reasonable — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Comparison also works within one person across time. The same topic at two times is the controlled case.
...
1. Expecting sun at 9am and rain at 2pm.
2. Expecting a quiet hall in the morning and a loud one at lunch.

### One non-example

Comparing this morning's weather expectation with this afternoon's lunch expectation.
...
That one person's expectations change across a day.

### What this activity does not establish

Why they changed, which is later this year.
...
| Statement | Status |
|---|---|
| Comparison also works within one person across time. | Framework-derived, appropriate at this grade |
| That one person's expectations change across a day. | What this specific activity can show |
| Why they changed, which is later this year. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — Comparing Three — specifically: students extend comparison beyond a pair.

**How it was taught.** Through the activity: a three-way comparison with two differences named

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: a three-way comparison with two differences named, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Expecting sun at 9am and rain at 2pm. |
| **Non-example** | Comparing this morning's weather expectation with this afternoon's lunch expectation. |
...
> "More than two can be compared, but you compare them in pairs."
...
**Exact wording.** "Ask what they expected this morning, and what they expect now."
...
**Target observation.** That one person's expectations change across a day.
...
> "Comparison also works within one person across time. You just saw that when ask what they expected this morning, and what they expect now.
> Last time we said: More than two can be compared, but you compare them in pairs. This is the next part of that.
...
**What students must not infer.** Why they changed, which is later this year.

### 4. Worked example

**The example.** Expecting sun at 9am and rain at 2pm.
...
**Completed answer.** Expecting sun at 9am and rain at 2pm. — which demonstrates that one person's expectations change across a day.
...
**Conclusions not licensed.** Why they changed, which is later this year.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Expecting a quiet hall in the morning and a loud one at lunch. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Comparing this morning's weather expectation with this afternoon's lunch expectation. Why is this not an
example?"
...
**Exact student instructions.** Four expectations from across one day, compared in two pairs.
...
- *Licensed conclusion.* That one person's expectations change across a day.
- *Not licensed.* Why they changed, which is later this year.
...
- *Expected response.* That one person's expectations change across a day.
...
1. Any wording carrying the idea in `Comparison also works within one person across time`.
...
Say: "Even your own expectations differ across a day."
...
| | |
|---|---|
| **Follows** | Lesson 3 — Comparing Three |
| **Leads to** | Lesson 5 — Both Reasonable |

**Transition in.** Lesson 3 established students extend comparison beyond a pair. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students compare expectations from different points in one day. Lesson 5 assumes it and builds students accept that two differing expectations can both be reasonable.
