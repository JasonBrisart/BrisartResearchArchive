# Lesson 21 — Comparing Myself To Myself
...
| | |
|---|---|
| **Central question** | Comparing Myself To Myself: students compare their own expectation across time? |
| **Core concept** | A student can compare themselves at two times. |
| **Student outcome** | Students compare their own expectation across time. |
| **Previous lesson** | Lesson 20 — Change Is Not Failure |
| **Next lesson** | Lesson 22 — Designing A Change |
...
**The conceptual step.** A student can compare themselves at two times. Naming the cause of the change is what makes it a comparison rather than an observation.
...
**What depends on it.** Lesson 22 — Designing A Change — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A student can compare themselves at two times. Naming the cause of the change is what makes it a comparison rather than an observation.
...
1. The Lesson 1 expectation about the hidden object versus now.
2. The early pattern expectation versus the late one.

### One non-example

Claiming the expectation never changed all year.
...
That self-comparison across time is possible.

### What this activity does not establish

Whether the later expectation is better.
...
| Statement | Status |
|---|---|
| A student can compare themselves at two times. | Framework-derived, appropriate at this grade |
| That self-comparison across time is possible. | What this specific activity can show |
| Whether the later expectation is better. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — Change Is Not Failure — specifically: students frame a changed expectation as an update.

**How it was taught.** Through the activity: one of their own changed expectations, with why the first was reasonable

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: one of their own changed expectations, with why the first was reasonable, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The Lesson 1 expectation about the hidden object versus now. |
| **Non-example** | Claiming the expectation never changed all year. |
...
> "Changing is what is supposed to happen."
...
**Exact wording.** "Read aloud, anonymously, one Lesson 1 expectation and the same student's now."
...
**Target observation.** That self-comparison across time is possible.
...
> "A student can compare themselves at two times. You just saw that when read aloud, anonymously, one Lesson 1 expectation and the same student's now.
> Last time we said: Changing is what is supposed to happen. This is the next part of that.
...
**What students must not infer.** Whether the later expectation is better.

### 4. Worked example

**The example.** The Lesson 1 expectation about the hidden object versus now.
...
**Completed answer.** The Lesson 1 expectation about the hidden object versus now. — which demonstrates that self-comparison across time is possible.
...
**Conclusions not licensed.** Whether the later expectation is better.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The early pattern expectation versus the late one. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Claiming the expectation never changed all year. Why is this not an
example?"
...
**Exact student instructions.** A two-point self-comparison with the cause of the change named.
...
- *Licensed conclusion.* That self-comparison across time is possible.
- *Not licensed.* Whether the later expectation is better.
...
- *Expected response.* That self-comparison across time is possible.
...
1. Any wording carrying the idea in `A student can compare themselves at two times`.
...
Say: "You are not the same as you were in Lesson 1."
...
| | |
|---|---|
| **Follows** | Lesson 20 — Change Is Not Failure |
| **Leads to** | Lesson 22 — Designing A Change |

**Transition in.** Lesson 20 established students frame a changed expectation as an update. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students compare their own expectation across time. Lesson 22 assumes it and builds students design a trial that would change somebody's expectation.
