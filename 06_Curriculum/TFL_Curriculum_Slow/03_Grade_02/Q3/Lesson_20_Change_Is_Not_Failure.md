# Lesson 20 — Change Is Not Failure

**Grade 2** · Comparing and Checking · **Quarter 3** · **30 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Change Is Not Failure: students frame a changed expectation as an update? |
| **Core concept** | An expectation that changed because new information arrived was not a mistake. |
| **Student outcome** | Students frame a changed expectation as an update. |
| **Previous lesson** | Lesson 19 — The Return |
| **Next lesson** | Lesson 21 — Comparing Myself To Myself |
...
**The conceptual step.** An expectation that changed because new information arrived was not a mistake. It was correct given what was available at the time.
...
**What depends on it.** Lesson 21 — Comparing Myself To Myself — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An expectation that changed because new information arrived was not a mistake. It was correct given what was available at the time.
...
1. Expected outdoor play, then it rained, and the expectation updated.
2. Expected a substitute teacher, then the regular one arrived.

### One non-example

Treating the original expectation as having been foolish.
...
That change is an update, not an error.

### What this activity does not establish

Whether the updated expectation is correct.
...
| Statement | Status |
|---|---|
| An expectation that changed because new information arrived was not a mistake. | Framework-derived, appropriate at this grade |
| That change is an update, not an error. | What this specific activity can show |
| Whether the updated expectation is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — The Return — specifically: students observe a broken expectation reappearing.

**How it was taught.** Through the activity: record the full sequence and write both possible explanations

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: record the full sequence and write both possible explanations, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Expected outdoor play, then it rained, and the expectation updated. |
| **Non-example** | Treating the original expectation as having been foolish. |
...
> "We cannot tell which. That is an honest answer."
...
**Exact wording.** "Present a case where the first expectation was right and then things changed."
...
**Target observation.** That change is an update, not an error.
...
> "An expectation that changed because new information arrived was not a mistake. You just saw that when present a case where the first expectation was right and then things changed.
> Last time we said: We cannot tell which. That is an honest answer. This is the next part of that.
...
**What students must not infer.** Whether the updated expectation is correct.

### 4. Worked example

**The example.** Expected outdoor play, then it rained, and the expectation updated.
...
**Completed answer.** Expected outdoor play, then it rained, and the expectation updated. — which demonstrates that change is an update, not an error.
...
**Conclusions not licensed.** Whether the updated expectation is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Expected a substitute teacher, then the regular one arrived. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Treating the original expectation as having been foolish. Why is this not an
example?"
...
**Exact student instructions.** One of their own changed expectations, with why the first was reasonable.
...
- *Licensed conclusion.* That change is an update, not an error.
- *Not licensed.* Whether the updated expectation is correct.
...
- *Expected response.* That change is an update, not an error.
...
1. Any wording carrying the idea in `An expectation that changed because new information arrived was not a mistake`.
...
Say: "Changing is what is supposed to happen."
...
| | |
|---|---|
| **Follows** | Lesson 19 — The Return |
| **Leads to** | Lesson 21 — Comparing Myself To Myself |

**Transition in.** Lesson 19 established students observe a broken expectation reappearing. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students frame a changed expectation as an update. Lesson 21 assumes it and builds students compare their own expectation across time.
