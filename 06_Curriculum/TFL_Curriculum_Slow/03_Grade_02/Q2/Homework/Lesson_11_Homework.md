# Lesson 11 Homework — Evidence For A Memory

**Grade 2** · Comparing and Checking · **Quarter 2**
**Follows:** Lesson 11 — Evidence For A Memory · **Points:** 5 · **Optional:** yes
...
Three memory claims, each with evidence or a question mark.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student marks at least one with a question mark
...
Lesson 12 is **Collecting Evidence**, which assumes you arrive holding it. Write one thing you expect it to be about:
