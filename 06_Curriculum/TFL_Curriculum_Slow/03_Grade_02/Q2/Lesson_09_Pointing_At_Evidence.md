...
| | |
|---|---|
| **Central question** | Pointing At Evidence: students support a claim by pointing at something? |
| **Core concept** | Evidence is something you can point at. |
| **Student outcome** | Students support a claim by pointing at something. |
| **Previous lesson** | Lesson 8 — The Comparison Review |
| **Next lesson** | Lesson 10 — Strong And Weak Evidence |
...
**The conceptual step.** Evidence is something you can point at. Confidence is not evidence, and crossing out an unsupportable claim is a correct outcome.
...
**What depends on it.** Lesson 10 — Strong And Weak Evidence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Evidence is something you can point at. Confidence is not evidence, and crossing out an unsupportable claim is a correct outcome.
...
1. Pointing at the timetable to support an expectation about the next lesson.
2. Pointing at the sky to support an expectation about rain.

### One non-example

Saying you are certain, with nothing to point at.
...
That claims require pointable support.
...
| Statement | Status |
|---|---|
| Evidence is something you can point at. | Framework-derived, appropriate at this grade |
| That claims require pointable support. | What this specific activity can show |
| Whether the evidence is strong. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Comparison Review — specifically: students consolidate comparison.

**How it was taught.** Through the activity: review relay with six comparison pairs to complete

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: review relay with six comparison pairs to complete, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Pointing at the timetable to support an expectation about the next lesson. |
| **Non-example** | Saying you are certain, with nothing to point at. |
...
> "Next time: how you show your answer is right."
...
**Exact wording.** "Make a claim with no support and ask why anybody should believe it."
...
**Target observation.** That claims require pointable support.
...
> "Evidence is something you can point at. You just saw that when make a claim with no support and ask why anybody should believe it.
> Last time we said: Next time: how you show your answer is right. This is the next part of that.
...
**What students must not infer.** Whether the evidence is strong.

### 4. Worked example

**The example.** Pointing at the timetable to support an expectation about the next lesson.
...
**Completed answer.** Pointing at the timetable to support an expectation about the next lesson. — which demonstrates that claims require pointable support.
...
**Conclusions not licensed.** Whether the evidence is strong.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Pointing at the sky to support an expectation about rain. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Saying you are certain, with nothing to point at. Why is this not an
example?"
...
**Exact student instructions.** Four of their own claims, each given pointable evidence or crossed out.
...
- *Licensed conclusion.* That claims require pointable support.
- *Not licensed.* Whether the evidence is strong.
...
- *Expected response.* That claims require pointable support.
...
1. Any wording carrying the idea in `Evidence is something you can point at`.
...
Say: "If you cannot point at it, it is not evidence yet."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Comparison Review |
| **Leads to** | Lesson 10 — Strong And Weak Evidence |

**Transition in.** Lesson 8 established students consolidate comparison. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students support a claim by pointing at something. Lesson 10 assumes it and builds students distinguish stronger from weaker evidence.
