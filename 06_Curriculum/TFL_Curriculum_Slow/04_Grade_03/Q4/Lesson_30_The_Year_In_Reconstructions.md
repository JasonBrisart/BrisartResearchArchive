# Lesson 30 — The Year In Reconstructions

**Grade 3** · Right Now · **Quarter 4** · **35 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Year In Reconstructions: students review the year using their own work? |
| **Core concept** | Comparing an early reconstruction with a late one gives the student direct evidence of their own change, which no external mark can supply. |
| **Student outcome** | Students review the year using their own work. |
| **Previous lesson** | Lesson 29 — Explaining Right Now |
...
**The conceptual step.** Comparing an early reconstruction with a late one gives the student direct evidence of their own change, which no external mark can supply.
...
Comparing an early reconstruction with a late one gives the student direct evidence of their own change, which no external mark can supply.
...
1. A Lesson 2 reconstruction beside a Lesson 23 one.
2. A student noticing their early work had no evidence column.

### One non-example

Reviewing only the most recent reconstructions.
...
That the student's own work changed measurably.
...
| Statement | Status |
|---|---|
| Comparing an early reconstruction with a late one gives the student direct evidence of their own change, which no external mark can supply. | Framework-derived, appropriate at this grade |
| That the student's own work changed measurably. | What this specific activity can show |
| Any external quality standard. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 29 — Explaining Right Now — specifically: students explain the combined moment to somebody else.

**How it was taught.** Through the activity: each student explains right now to a buddy and records one question asked

**Quick check.** Ask for the closing sentence of Lesson 29. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 29: each student explains right now to a buddy and records one question asked, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Lesson 2 reconstruction beside a Lesson 23 one. |
| **Non-example** | Reviewing only the most recent reconstructions. |
...
> "The question is the useful output."
...
**Exact wording.** "Lay out every reconstruction from the year."
...
**Target observation.** That the student's own work changed measurably.
...
> "Comparing an early reconstruction with a late one gives the student direct evidence of their own change, which no external mark can supply. You just saw that when lay out every reconstruction from the year.
> Last time we said: The question is the useful output. This is the next part of that.
...
**The example.** A Lesson 2 reconstruction beside a Lesson 23 one.
...
**Completed answer.** A Lesson 2 reconstruction beside a Lesson 23 one. — which demonstrates that the student's own work changed measurably.
...
**Teacher prompt.** "Here is a second case. A student noticing their early work had no evidence column. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reviewing only the most recent reconstructions. Why is this not an
example?"
...
**Exact student instructions.** Order their own work by term and compare an early one with a late one.
...
- *Licensed conclusion.* That the student's own work changed measurably.
...
- *Expected response.* That the student's own work changed measurably.
...
1. Any wording carrying the idea in `Comparing an early reconstruction with a late one gives the student direct evidence of their own change, which no external mark can supply`.
...
Say: "Look at the difference between the first and the last."
...
| | |
|---|---|
| **Follows** | Lesson 29 — Explaining Right Now |
| **Leads to** | Lesson 31 — Practice Final |

**Transition in.** Lesson 29 established students explain the combined moment to somebody else. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students review the year using their own work. Lesson 31 assumes it and builds students rehearse the final under conditions.
