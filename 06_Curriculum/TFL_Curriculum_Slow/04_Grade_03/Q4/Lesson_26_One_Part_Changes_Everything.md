# Lesson 26 — One Part Changes Everything
...
| | |
|---|---|
| **Central question** | One Part Changes Everything: students test what happens when each part is varied? |
| **Core concept** | Varying one part at a time shows how each contributes. |
| **Student outcome** | Students test what happens when each part is varied. |
| **Previous lesson** | Lesson 25 — When The Moment Was Wrong |
| **Next lesson** | Lesson 27 — Moments In A Row |
...
**The conceptual step.** Varying one part at a time shows how each contributes. Changing more than one at once makes the effect of any single part unreadable.
...
**What depends on it.** Lesson 27 — Moments In A Row — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Varying one part at a time shows how each contributes. Changing more than one at once makes the effect of any single part unreadable.
...
1. Varying only the remembering and describing the resulting moment.
2. Varying only the noticing and describing the difference.

### One non-example

Varying two parts and reporting one combined result.
...
That each part contributes distinctly to the moment.

### What this activity does not establish

How much each part contributes.
...
| Statement | Status |
|---|---|
| Varying one part at a time shows how each contributes. | Framework-derived, appropriate at this grade |
| That each part contributes distinctly to the moment. | What this specific activity can show |
| How much each part contributes. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — When The Moment Was Wrong — specifically: students reconstruct a moment whose expectation failed.

**How it was taught.** Through the activity: both moments reconstructed in full; identify which part changed

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: both moments reconstructed in full; identify which part changed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Varying only the remembering and describing the resulting moment. |
| **Non-example** | Varying two parts and reporting one combined result. |
...
> "One part changed and the whole moment changed with it."
...
**Exact wording.** "Ask what would have happened if only the remembering had been different."
...
**Target observation.** That each part contributes distinctly to the moment.
...
> "Varying one part at a time shows how each contributes. You just saw that when ask what would have happened if only the remembering had been different.
> Last time we said: One part changed and the whole moment changed with it. This is the next part of that.
...
**What students must not infer.** How much each part contributes.

### 4. Worked example

**The example.** Varying only the remembering and describing the resulting moment.
...
**Completed answer.** Varying only the remembering and describing the resulting moment. — which demonstrates that each part contributes distinctly to the moment.
...
**Conclusions not licensed.** How much each part contributes.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Varying only the noticing and describing the difference. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Varying two parts and reporting one combined result. Why is this not an
example?"
...
**Exact student instructions.** Three thought experiments, one per part, each with the resulting moment.
...
- *Licensed conclusion.* That each part contributes distinctly to the moment.
- *Not licensed.* How much each part contributes.
...
- *Expected response.* That each part contributes distinctly to the moment.
...
1. Any wording carrying the idea in `Varying one part at a time shows how each contributes`.
...
Say: "The parts are not independent of each other."
...
| | |
|---|---|
| **Follows** | Lesson 25 — When The Moment Was Wrong |
| **Leads to** | Lesson 27 — Moments In A Row |

**Transition in.** Lesson 25 established students reconstruct a moment whose expectation failed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students test what happens when each part is varied. Lesson 27 assumes it and builds students reconstruct two consecutive moments.
