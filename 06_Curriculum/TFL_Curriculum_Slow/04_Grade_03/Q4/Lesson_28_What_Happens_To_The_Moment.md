# Lesson 28 — What Happens To The Moment
...
| | |
|---|---|
| **Central question** | What Happens To The Moment: students confront the open question of what happens next? |
| **Core concept** | The question of what happens to a moment when the next begins is the Grade 4 subject. |
| **Student outcome** | Students confront the open question of what happens next. |
| **Previous lesson** | Lesson 27 — Moments In A Row |
| **Next lesson** | Lesson 29 — Explaining Right Now |
...
**The conceptual step.** The question of what happens to a moment when the next begins is the Grade 4 subject. Sealing a prediction now makes next year's opening a genuine check.
...
**What depends on it.** Lesson 29 — Explaining Right Now — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The question of what happens to a moment when the next begins is the Grade 4 subject. Sealing a prediction now makes next year's opening a genuine check.
...
1. A sealed prediction that it disappears.
2. A sealed prediction that some of it stays.

### One non-example

An answer given by the teacher, which destroys next year's hook.
...
That the student can commit to a long-interval prediction.

### What this activity does not establish

The answer, which is withheld deliberately.
...
| Statement | Status |
|---|---|
| The question of what happens to a moment when the next begins is the Grade 4 subject. | Framework-derived, appropriate at this grade |
| That the student can commit to a long-interval prediction. | What this specific activity can show |
| The answer, which is withheld deliberately. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — Moments In A Row — specifically: students reconstruct two consecutive moments.

**How it was taught.** Through the activity: two consecutive reconstructions from the same minute

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: two consecutive reconstructions from the same minute, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A sealed prediction that it disappears. |
| **Non-example** | An answer given by the teacher, which destroys next year's hook. |
...
> "They happened one after the other. Something connects them."
...
**Exact wording.** "Ask what happens to your right now when the next moment starts."
...
**Target observation.** That the student can commit to a long-interval prediction.
...
> "The question of what happens to a moment when the next begins is the Grade 4 subject. You just saw that when ask what happens to your right now when the next moment starts.
> Last time we said: They happened one after the other. Something connects them. This is the next part of that.
...
**What students must not infer.** The answer, which is withheld deliberately.

### 4. Worked example

**The example.** A sealed prediction that it disappears.
...
**Completed answer.** A sealed prediction that it disappears. — which demonstrates that the student can commit to a long-interval prediction.
...
**Conclusions not licensed.** The answer, which is withheld deliberately.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A sealed prediction that some of it stays. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An answer given by the teacher, which destroys next year's hook. Why is this not an
example?"
...
**Exact student instructions.** Each student writes and seals an answer, dated, for Grade 4 Lesson 1.
...
- *Licensed conclusion.* That the student can commit to a long-interval prediction.
- *Not licensed.* The answer, which is withheld deliberately.
...
- *Expected response.* That the student can commit to a long-interval prediction.
...
1. Any wording carrying the idea in `The question of what happens to a moment when the next begins is the Grade 4 subject`.
...
Say: "Next year you find out. I am not telling you today."
...
| | |
|---|---|
| **Follows** | Lesson 27 — Moments In A Row |
| **Leads to** | Lesson 29 — Explaining Right Now |

**Transition in.** Lesson 27 established students reconstruct two consecutive moments. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students confront the open question of what happens next. Lesson 29 assumes it and builds students explain the combined moment to somebody else.
