# Lesson 23 — The Full Reconstruction
...
| | |
|---|---|
| **Central question** | The Full Reconstruction: students produce a supported reconstruction unaided? |
| **Core concept** | The full method is reconstruction, support, and forward check. |
| **Student outcome** | Students produce a supported reconstruction unaided. |
| **Previous lesson** | Lesson 22 — Repairing A Reconstruction |
| **Next lesson** | Lesson 24 — The Evidence Review |
...
**The conceptual step.** The full method is reconstruction, support, and forward check. Producing it unaided is the year's central skill.
...
**What depends on it.** Lesson 24 — The Evidence Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The full method is reconstruction, support, and forward check. Producing it unaided is the year's central skill.
...
1. Two reconstructions with evidence on every line, checked by a partner.
2. A reconstruction with two question marks, which is honest.

### One non-example

A reconstruction with no evidence column completed.
...
Whether the student can run the whole method unaided.

### What this activity does not establish

Whether the reconstructions are accurate.
...
| Statement | Status |
|---|---|
| The full method is reconstruction, support, and forward check. | Framework-derived, appropriate at this grade |
| Whether the student can run the whole method unaided. | What this specific activity can show |
| Whether the reconstructions are accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — Repairing A Reconstruction — specifically: students repair a reconstruction after audit.

**How it was taught.** Through the activity: repair every marked line, either with evidence or a question mark

**Quick check.** Ask for the closing sentence of Lesson 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: repair every marked line, either with evidence or a question mark, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two reconstructions with evidence on every line, checked by a partner. |
| **Non-example** | A reconstruction with no evidence column completed. |
...
> "A question mark is a legitimate repair."
...
**Exact wording.** "Say: everything today, on your own. Format questions only."
...
**Target observation.** Whether the student can run the whole method unaided.
...
> "The full method is reconstruction, support, and forward check. You just saw that when say: everything today, on your own.
> Last time we said: A question mark is a legitimate repair. This is the next part of that.
...
**What students must not infer.** Whether the reconstructions are accurate.

### 4. Worked example

**The example.** Two reconstructions with evidence on every line, checked by a partner.
...
**Completed answer.** Two reconstructions with evidence on every line, checked by a partner. — which demonstrates whether the student can run the whole method unaided.
...
**Conclusions not licensed.** Whether the reconstructions are accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A reconstruction with two question marks, which is honest. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A reconstruction with no evidence column completed. Why is this not an
example?"
...
**Exact student instructions.** Two complete supported reconstructions, swapped for a forward check.
...
- *Licensed conclusion.* Whether the student can run the whole method unaided.
- *Not licensed.* Whether the reconstructions are accurate.
...
- *Expected response.* Whether the student can run the whole method unaided.
...
1. Any wording carrying the idea in `The full method is reconstruction, support, and forward check`.
...
Say: "You can take any moment apart and show your working."
...
| | |
|---|---|
| **Follows** | Lesson 22 — Repairing A Reconstruction |
| **Leads to** | Lesson 24 — The Evidence Review |

**Transition in.** Lesson 22 established students repair a reconstruction after audit. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students produce a supported reconstruction unaided. Lesson 24 assumes it and builds students consolidate evidence for reconstructions.
