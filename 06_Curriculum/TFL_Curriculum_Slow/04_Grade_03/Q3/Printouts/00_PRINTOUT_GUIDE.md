...
|---|---|---|---|---|---|---|
| `Lesson_17_Printout.md` | Lesson 17 — Evidence For A Moment | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_18_Printout.md` | Lesson 18 — Strong And Weak Lines | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 17 work |
| `Lesson_19_Printout.md` | Lesson 19 — Evidence From Somebody Else | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 18 work |
| `Lesson_20_Printout.md` | Lesson 20 — When Accounts Disagree | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 19 work |
| `Lesson_21_Printout.md` | Lesson 21 — The Question Mark Audit | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 20 work |
| `Lesson_22_Printout.md` | Lesson 22 — Repairing A Reconstruction | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 21 work |
| `Lesson_23_Printout.md` | Lesson 23 — The Full Reconstruction | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 22 work |
| `Lesson_24_Printout.md` | Lesson 24 — The Evidence Review | 2–3 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 23 work |
...
**Lesson 21 — The Question Mark Audit.** If you only have time to print one
