# Lesson 20 Homework — When Accounts Disagree

**Grade 3** · Right Now · **Quarter 3**
**Follows:** Lesson 20 — When Accounts Disagree · **Points:** 5 · **Optional:** yes
...
Reconcile the conflict: state both, explain it, and name what would resolve it.
...
Lesson 21 is **The Question Mark Audit**, which assumes you arrive holding it. Write one thing you expect it to be about:
