# Lesson 21 Homework — The Question Mark Audit

**Grade 3** · Right Now · **Quarter 3**
**Follows:** Lesson 21 — The Question Mark Audit · **Points:** 5 · **Optional:** yes
...
Audit a partner's two reconstructions for unmarked unsupported lines.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student receives an audit naming at least one unmarked gap
...
Lesson 22 is **Repairing A Reconstruction**, which assumes you arrive holding it. Write one thing you expect it to be about:
