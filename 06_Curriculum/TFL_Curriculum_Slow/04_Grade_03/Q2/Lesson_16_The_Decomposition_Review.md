# Lesson 16 — The Decomposition Review
...
| | |
|---|---|
| **Central question** | The Decomposition Review: students consolidate decomposition? |
| **Core concept** | The forward check is what separates a decomposition from a guess. |
| **Student outcome** | Students consolidate decomposition. |
| **Previous lesson** | Lesson 15 — When You Cannot Decompose |
| **Next lesson** | Lesson 17 — Evidence For A Moment |
...
**The conceptual step.** The forward check is what separates a decomposition from a guess. The review enforces it as a habit rather than an optional step.
...
**What depends on it.** Lesson 17 — Evidence For A Moment — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The forward check is what separates a decomposition from a guess. The review enforces it as a habit rather than an optional step.
...
1. A decomposition checked forwards and confirmed.
2. A decomposition checked forwards and rejected.

### One non-example

A decomposition accepted without being checked.
...
Whether the forward check is habitual.

### What this activity does not establish

Whether decompositions are usually correct.
...
| Statement | Status |
|---|---|
| The forward check is what separates a decomposition from a guess. | Framework-derived, appropriate at this grade |
| Whether the forward check is habitual. | What this specific activity can show |
| Whether decompositions are usually correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — When You Cannot Decompose — specifically: students mark a moment they cannot take apart.

**How it was taught.** Through the activity: attempt five decompositions and mark any that resist, with why

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: attempt five decompositions and mark any that resist, with why, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A decomposition checked forwards and confirmed. |
| **Non-example** | A decomposition accepted without being checked. |
...
> "Marking one is honest. Inventing parts is not."
...
**Exact wording.** "Ask what decomposing is and how you check it."
...
**Target observation.** Whether the forward check is habitual.
...
> "The forward check is what separates a decomposition from a guess. You just saw that when ask what decomposing is and how you check it.
> Last time we said: Marking one is honest. Inventing parts is not. This is the next part of that.
...
**What students must not infer.** Whether decompositions are usually correct.

### 4. Worked example

**The example.** A decomposition checked forwards and confirmed.
...
**Completed answer.** A decomposition checked forwards and confirmed. — which demonstrates whether the forward check is habitual.
...
**Conclusions not licensed.** Whether decompositions are usually correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A decomposition checked forwards and rejected. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A decomposition accepted without being checked. Why is this not an
example?"
...
**Exact student instructions.** Review with eight decompositions to check forwards.
...
- *Licensed conclusion.* Whether the forward check is habitual.
- *Not licensed.* Whether decompositions are usually correct.
...
- *Expected response.* Whether the forward check is habitual.
...
1. Any wording carrying the idea in `The forward check is what separates a decomposition from a guess`.
...
Say: "Next time: how do we know any of this is true?"
...
| | |
|---|---|
| **Follows** | Lesson 15 — When You Cannot Decompose |
| **Leads to** | Lesson 17 — Evidence For A Moment |

**Transition in.** Lesson 15 established students mark a moment they cannot take apart. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate decomposition. Lesson 17 assumes it and builds students support a reconstruction with pointable evidence.
