# Lesson 14 — Decomposing Your Own
...
| | |
|---|---|
| **Central question** | Decomposing Your Own: students decompose a moment they had themselves? |
| **Core concept** | Decomposing your own moment is harder than decomposing a described one, because you have more material than the three lines can hold and must select. |
| **Student outcome** | Students decompose a moment they had themselves. |
| **Previous lesson** | Lesson 13 — The Wrong Part |
| **Next lesson** | Lesson 15 — When You Cannot Decompose |
...
**The conceptual step.** Decomposing your own moment is harder than decomposing a described one, because you have more material than the three lines can hold and must select.
...
**What depends on it.** Lesson 15 — When You Cannot Decompose — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Decomposing your own moment is harder than decomposing a described one, because you have more material than the three lines can hold and must select.
...
1. A three-line self-decomposition that survives a partner's check.
2. A student reporting the difficulty of selecting.

### One non-example

A paragraph of narrative offered as a decomposition.
...
That self-decomposition is possible but harder.

### What this activity does not establish

That the self-decomposition is accurate.
...
| Statement | Status |
|---|---|
| Decomposing your own moment is harder than decomposing a described one, because you have more material than the three lines can hold and must select. | Framework-derived, appropriate at this grade |
| That self-decomposition is possible but harder. | What this specific activity can show |
| That the self-decomposition is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 13 — The Wrong Part — specifically: students find the single incorrect part in a decomposition.

**How it was taught.** Through the activity: six decompositions, each with one planted error, located and corrected

**Quick check.** Ask for the closing sentence of Lesson 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 13: six decompositions, each with one planted error, located and corrected, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A three-line self-decomposition that survives a partner's check. |
| **Non-example** | A paragraph of narrative offered as a decomposition. |
...
> "One wrong part breaks the whole thing."
...
**Exact wording.** "Say: now one of yours. Harder, because you were inside it."
...
**Target observation.** That self-decomposition is possible but harder.
...
> "Decomposing your own moment is harder than decomposing a described one, because you have more material than the three lines can hold and must select. You just saw that when say: now one of yours.
> Last time we said: One wrong part breaks the whole thing. This is the next part of that.
...
**What students must not infer.** That the self-decomposition is accurate.

### 4. Worked example

**The example.** A three-line self-decomposition that survives a partner's check.
...
**Completed answer.** A three-line self-decomposition that survives a partner's check. — which demonstrates that self-decomposition is possible but harder.
...
**Conclusions not licensed.** That the self-decomposition is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student reporting the difficulty of selecting. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A paragraph of narrative offered as a decomposition. Why is this not an
example?"
...
**Exact student instructions.** Three self-decompositions, each checked forwards by a partner.
...
- *Licensed conclusion.* That self-decomposition is possible but harder.
- *Not licensed.* That the self-decomposition is accurate.
...
- *Expected response.* That self-decomposition is possible but harder.
...
1. Any wording carrying the idea in `Decomposing your own moment is harder than decomposing a described one, because you have more material than the three lines can hold and must select`.
...
Say: "Your own moments are harder because you were in them."
...
| | |
|---|---|
| **Follows** | Lesson 13 — The Wrong Part |
| **Leads to** | Lesson 15 — When You Cannot Decompose |

**Transition in.** Lesson 13 established students find the single incorrect part in a decomposition. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students decompose a moment they had themselves. Lesson 15 assumes it and builds students mark a moment they cannot take apart.
