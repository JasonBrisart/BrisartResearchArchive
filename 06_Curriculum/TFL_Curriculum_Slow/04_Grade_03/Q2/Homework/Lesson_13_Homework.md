# Lesson 13 Homework — The Wrong Part

**Grade 3** · Right Now · **Quarter 2**
**Follows:** Lesson 13 — The Wrong Part · **Points:** 5 · **Optional:** yes
...
Six decompositions, each with one planted error, located and corrected.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student locates at least four planted errors
...
Lesson 14 is **Decomposing Your Own**, which assumes you arrive holding it. Write one thing you expect it to be about:
