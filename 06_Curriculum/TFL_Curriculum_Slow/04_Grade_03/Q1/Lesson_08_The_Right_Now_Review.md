...
| | |
|---|---|
| **Central question** | The Right Now Review: students consolidate the quarter's reconstruction work? |
| **Core concept** | The combination requirement must survive speed. |
| **Student outcome** | Students consolidate the quarter's reconstruction work. |
| **Previous lesson** | Lesson 7 — The Invisible Right Now |
| **Next lesson** | Lesson 9 — Taking A Moment Apart |
...
**The conceptual step.** The combination requirement must survive speed. The review tests whether students can still tell a combined statement from a list when working quickly.
...
**What depends on it.** Lesson 9 — Taking A Moment Apart — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The combination requirement must survive speed. The review tests whether students can still tell a combined statement from a list when working quickly.
...
1. A final line correctly marked as combined.
2. A final line correctly marked as a list.

### One non-example

Marking by how long the sentence is.
...
Whether the list-versus-combination distinction is secure.

### What this activity does not establish

Whether any reconstruction is accurate.
...
| Statement | Status |
|---|---|
| The combination requirement must survive speed. | Framework-derived, appropriate at this grade |
| Whether the list-versus-combination distinction is secure. | What this specific activity can show |
| Whether any reconstruction is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — The Invisible Right Now — specifically: students reconstruct a moment in which nothing surprising happened.

**How it was taught.** Through the activity: three reconstructions of entirely routine moments

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: three reconstructions of entirely routine moments, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A final line correctly marked as combined. |
| **Non-example** | Marking by how long the sentence is. |
...
> "Even the boring moments are built out of three things."
...
**Exact wording.** "Ask what right now is made of and how it arrives."
...
**Target observation.** Whether the list-versus-combination distinction is secure.
...
> "The combination requirement must survive speed. You just saw that when ask what right now is made of and how it arrives.
> Last time we said: Even the boring moments are built out of three things. This is the next part of that.
...
**What students must not infer.** Whether any reconstruction is accurate.

### 4. Worked example

**The example.** A final line correctly marked as combined.
...
**Completed answer.** A final line correctly marked as combined. — which demonstrates whether the list-versus-combination distinction is secure.
...
**Conclusions not licensed.** Whether any reconstruction is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A final line correctly marked as a list. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Marking by how long the sentence is. Why is this not an
example?"
...
**Exact student instructions.** Review with six reconstructions marked for list-versus-combination.
...
- *Licensed conclusion.* Whether the list-versus-combination distinction is secure.
- *Not licensed.* Whether any reconstruction is accurate.
...
- *Expected response.* Whether the list-versus-combination distinction is secure.
...
1. Any wording carrying the idea in `The combination requirement must survive speed`.
...
Say: "Next time: taking a moment apart on purpose."
...
| | |
|---|---|
| **Follows** | Lesson 7 — The Invisible Right Now |
| **Leads to** | Lesson 9 — Taking A Moment Apart |

**Transition in.** Lesson 7 established students reconstruct a moment in which nothing surprising happened. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the quarter's reconstruction work. Lesson 9 assumes it and builds students decompose a described moment into three parts.
