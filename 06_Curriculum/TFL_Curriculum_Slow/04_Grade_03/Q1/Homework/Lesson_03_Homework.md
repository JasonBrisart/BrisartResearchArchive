# Lesson 3 Homework — Same Input, Different Moment

**Grade 3** · Right Now · **Quarter 1**
**Follows:** Lesson 3 — Same Input, Different Moment · **Points:** 5 · **Optional:** yes
...
Two students' templates side by side; the class identifies the differing line.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class locates the differing line as the remembering
...
Lesson 4 is **Right Now Somewhere Else**, which assumes you arrive holding it. Write one thing you expect it to be about:
