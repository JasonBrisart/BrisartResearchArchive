# Session 6 Homework — Rivals From Your Own Field

**College Year 3** · Adjudication · **Quarter 1**
**Follows:** Session 6 — Rivals From Your Own Field · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 6 ended on, from memory:
...
Present two field rivals with readings, standing, agreement, divergence, and a separator.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student presents two field rivals with divergence lines attempted
...
Session 7 is **The Redundancy Charge**, which assumes you arrive holding it. Write one thing you expect it to be about:
