# Session 3 Homework — The Differential Table

**College Year 3** · Adjudication · **Quarter 1**
**Follows:** Session 3 — The Differential Table · **Points:** 5 · **Optional:** yes
...
Build the table for one scenario and mark any coinciding rows.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has four distinct rows or an honestly marked coincidence
...
Session 4 is **The Discriminating Condition**, which assumes you arrive holding it. Write one thing you expect it to be about:
