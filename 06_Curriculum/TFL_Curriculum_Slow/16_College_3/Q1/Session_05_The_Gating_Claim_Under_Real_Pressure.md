# Session 5 — The Gating Claim Under Real Pressure

**College Year 3** · Adjudication · **Quarter 1** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Gating Claim Under Real Pressure: students confront the unfalsifiability charge against exclusive gating? |
| **Core concept** | The mediation defence attributes apparent affect-on-interpretation effects to propagation. |
| **Student outcome** | Students confront the unfalsifiability charge against exclusive gating. |
| **Previous session** | Session 4 — The Discriminating Condition |
| **Next session** | Session 6 — Rivals From Your Own Field |
| **Materials** | Discipline readings selected by the instructor; printed differential tables |
...
**The conceptual step.** The mediation defence attributes apparent affect-on-interpretation effects to propagation. Whether this is principled or an unfalsifiable rescue depends on whether the two can be distinguished empirically.

**Why students need it now.** This grade owns one idea: fair operationalisation of rivals, and the redundancy charge.
...
that three rivals is the whole competition. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Rivals stated as their proponents would state them, and checked by somebody who finds them plausible.

**What depends on it.** Session 6 — Rivals From Your Own Field — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The mediation defence attributes apparent affect-on-interpretation effects to propagation. Whether this is principled or an unfalsifiable rescue depends on whether the two can be distinguished empirically.

### How this is stated at this grade

Rivals stated as their proponents would state them, and checked by somebody who finds them plausible.

Use only the vocabulary released at or before this grade. Terms not yet available:
Referee-quality review, publication-standard measurement audit.

### Why the concept matters

The whole grade rests on fair operationalisation of rivals, and the redundancy charge. If a student leaves this
...
1. A sketch attempting the within-window versus propagation distinction.
2. An honest record that the room could not specify the evidence.

### One non-example

A resolution declaring the mediation defence adequate.
...
That the charge is live and the resolution is specifiable.

### What this activity does not establish

Whether the defence is principled.
...
| Statement | Status |
|---|---|
| The mediation defence attributes apparent affect-on-interpretation effects to propagation. | Framework-derived, appropriate at this grade |
| That the charge is live and the resolution is specifiable. | What this specific activity can show |
| Whether the defence is principled. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 4 — The Discriminating Condition — specifically: students locate the cell where accounts come apart.

**How it was taught.** Through the activity: determine whether their design enters the cell and address the generalisation limit

**Quick check.** Ask for the closing sentence of Session 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 4: determine whether their design enters the cell and address the generalisation limit, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | designing so competing accounts make different predictions. |
| **Student wording** | Designing so competing accounts make different predictions. |
| **Correct example** | A sketch attempting the within-window versus propagation distinction. |
| **Non-example** | A resolution declaring the mediation defence adequate. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for designing so competing accounts make different predictions." |

### fair operationalisation

| | |
|---|---|
| **Teacher definition** | stating a rival as its proponents would. |
| **Student wording** | Stating a rival as its proponents would. |
| **Correct example** | A sketch attempting the within-window versus propagation distinction. |
| **Non-example** | A resolution declaring the mediation defence adequate. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for stating a rival as its proponents would." |

### redundancy charge

| | |
|---|---|
| **Teacher definition** | the claim that a framework restates existing accounts. |
| **Student wording** | The claim that a framework restates existing accounts. |
| **Correct example** | A sketch attempting the within-window versus propagation distinction. |
| **Non-example** | A resolution declaring the mediation defence adequate. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for the claim that a framework restates existing accounts." |


Do not introduce terminology from later grades. Referee-quality review, publication-standard measurement audit.

## Materials and preparation

**Teacher materials.** Discipline readings selected by the instructor; Printed differential tables; Whiteboard.
...
**Exact wording.** "Assign three groups: the empirical case, the mediation defence, the unfalsifiability charge."
...
**Target observation.** That the charge is live and the resolution is specifiable.
...
> "The mediation defence attributes apparent affect-on-interpretation effects to propagation. You just saw that when assign three groups: the empirical case, the mediation defence, the unfalsifiability charge.
> Last time we said: A design that never enters that cell is not adjudicating. This is the next part of that.
> It matters because your data is consistent with the framework and with two rivals. Consistency is not evidence"
...
**Terminology to introduce here.** adjudication, fair operationalisation, redundancy charge.

**What students must not infer.** Whether the defence is principled.

### 4. Worked example

**The example.** A sketch attempting the within-window versus propagation distinction.
...
**Completed answer.** A sketch attempting the within-window versus propagation distinction. — which demonstrates that the charge is live and the resolution is specifiable.
...
**Conclusions not licensed.** Whether the defence is principled.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An honest record that the room could not specify the evidence. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A resolution declaring the mediation defence adequate. Why is this not an
example?"
...
**Exact student instructions.** Write the deciding design sketch with the distinguishing line completed.
...
- *Licensed conclusion.* That the charge is live and the resolution is specifiable.
- *Not licensed.* Whether the defence is principled.
...
- *Expected response.* That the charge is live and the resolution is specifiable.
...
3. **Misconception check.** Somebody says: "Three rivals is the whole competition" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `The mediation defence attributes apparent affect-on-interpretation effects to propagation`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Your field already has a literature explaining something here.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "If the room cannot specify the evidence, the charge stands. Record that."
...
### 1. "Three rivals is the whole competition"

**What the student says or does.** Three rivals is the whole competition — usually while otherwise engaging well.

**Why it is understandable.** The package supplies three, so students stop there.
...
**Exact correction.** Require two field-specific rivals with readings.

**Say this.** "Your field already has a literature explaining something here."
...
### 2. "My field's account never diverges, so they agree"

**What the student says or does.** My field's account never diverges, so they agree — usually while otherwise engaging well.

**Why it is understandable.** Non-divergence reads as agreement.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Name the three possibilities.

**Say this.** "Determine which one is true. That is a paper."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "The mediation defence settles the gating challenge"

**What the student says or does.** The mediation defence settles the gating challenge — usually while otherwise engaging well.

**Why it is understandable.** It is available, so students treat it as a resolution.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Pose the unfalsifiability charge directly.

**Say this.** "Specify the within-window evidence, or the charge stands."
...
**Visual or physical support.** Provide one worked field-rival comparison with the divergence line completed.
...
Ask them to determine whether their field rival is a special case of TFL.
...
Specifically, do not introduce: Referee-quality review, publication-standard measurement audit.
...
| | |
|---|---|
| **Follows** | Session 4 — The Discriminating Condition |
| **Leads to** | Session 6 — Rivals From Your Own Field |

**Transition in.** Session 4 established students locate the cell where accounts come apart. This session uses that as the starting point.

**Transition out.** This session establishes students confront the unfalsifiability charge against exclusive gating. Session 6 assumes it and builds students identify the real competing accounts in their literature.
