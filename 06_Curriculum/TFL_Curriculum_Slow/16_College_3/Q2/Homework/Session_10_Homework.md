# Session 10 Homework — The Adversarial Round

**College Year 3** · Adjudication · **Quarter 2**
**Follows:** Session 10 — The Adversarial Round · **Points:** 5 · **Optional:** yes
...
Deliver a written attack and receive one per rival on their own design.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every design is attacked from every rival position
...
Session 11 is **Answering The Adversarial Round**, which assumes you arrive holding it. Write one thing you expect it to be about:
