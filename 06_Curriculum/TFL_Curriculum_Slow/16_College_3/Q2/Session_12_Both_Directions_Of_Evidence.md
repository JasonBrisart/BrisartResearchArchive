# Session 12 — Both Directions Of Evidence

**College Year 3** · Adjudication · **Quarter 2** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Both Directions Of Evidence: students state what would favour the rival? |
| **Core concept** | A design that can only produce evidence favouring one account is a confirmation machine. |
| **Student outcome** | Students state what would favour the rival. |
| **Previous session** | Session 11 — Answering The Adversarial Round |
| **Next session** | Session 13 — Reconciling Conflicting Evidence |
...
**The conceptual step.** A design that can only produce evidence favouring one account is a confirmation machine. Stating what would favour each rival is the test of genuine adjudication.
...
**What depends on it.** Session 13 — Reconciling Conflicting Evidence — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A design that can only produce evidence favouring one account is a confirmation machine. Stating what would favour each rival is the test of genuine adjudication.
...
1. A result stated that would favour the arousal account.
2. A result stated that would favour the habit account.

### One non-example

Only framework-favouring results specified.
...
That adjudicating designs favour accounts in both directions.

### What this activity does not establish

Which account the evidence will favour.
...
| Statement | Status |
|---|---|
| A design that can only produce evidence favouring one account is a confirmation machine. | Framework-derived, appropriate at this grade |
| That adjudicating designs favour accounts in both directions. | What this specific activity can show |
| Which account the evidence will favour. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 11 — Answering The Adversarial Round — specifically: students revise a design against adversarial feedback.

**How it was taught.** Through the activity: revise the design and state what changed for each landing attack

**Quick check.** Ask for the closing sentence of Session 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 11: revise the design and state what changed for each landing attack, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A result stated that would favour the arousal account. |
| **Non-example** | Only framework-favouring results specified. |
...
> "A design that answers all three is worth running."
...
**Exact wording.** "Say: you said what would favour the framework. Now the reverse."
...
**Target observation.** That adjudicating designs favour accounts in both directions.
...
> "A design that can only produce evidence favouring one account is a confirmation machine. You just saw that when say: you said what would favour the framework.
> Last time we said: A design that answers all three is worth running. This is the next part of that.
...
**What students must not infer.** Which account the evidence will favour.

### 4. Worked example

**The example.** A result stated that would favour the arousal account.
...
**Completed answer.** A result stated that would favour the arousal account. — which demonstrates that adjudicating designs favour accounts in both directions.
...
**Conclusions not licensed.** Which account the evidence will favour.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A result stated that would favour the habit account. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Only framework-favouring results specified. Why is this not an
example?"
...
**Exact student instructions.** State one result favouring each account over the others.
...
- *Licensed conclusion.* That adjudicating designs favour accounts in both directions.
- *Not licensed.* Which account the evidence will favour.
...
- *Expected response.* That adjudicating designs favour accounts in both directions.
...
1. Any wording carrying the idea in `A design that can only produce evidence favouring one account is a confirmation machine`.
...
Say: "A design that can only favour one is a confirmation machine."
...
| | |
|---|---|
| **Follows** | Session 11 — Answering The Adversarial Round |
| **Leads to** | Session 13 — Reconciling Conflicting Evidence |

**Transition in.** Session 11 established students revise a design against adversarial feedback. This session uses that as the starting point.

**Transition out.** This session establishes students state what would favour the rival. Session 13 assumes it and builds students handle results pointing in different directions.
