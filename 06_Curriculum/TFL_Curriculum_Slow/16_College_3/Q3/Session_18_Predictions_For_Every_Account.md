# Session 18 — Predictions For Every Account
...
| | |
|---|---|
| **Central question** | Predictions For Every Account: students derive predictions for five accounts including field rivals? |
| **Core concept** | Adjudicating against five accounts including a field rival is a realistic test. |
| **Student outcome** | Students derive predictions for five accounts including field rivals. |
| **Previous session** | Session 17 — Entering The Discriminating Cell |
| **Next session** | Session 19 — The Adjudicating Design |
...
**The conceptual step.** Adjudicating against five accounts including a field rival is a realistic test. Coinciding rows require either a redesign or an honest note.
...
**What depends on it.** Session 19 — The Adjudicating Design — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Adjudicating against five accounts including a field rival is a realistic test. Coinciding rows require either a redesign or an honest note.
...
2. A coinciding row marked and the design revised.

### One non-example

The same prediction entered for two different accounts.
...
That multi-account adjudication is achievable.
...
| Statement | Status |
|---|---|
| Adjudicating against five accounts including a field rival is a realistic test. | Framework-derived, appropriate at this grade |
| That multi-account adjudication is achievable. | What this specific activity can show |
| Which account is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 17 — Entering The Discriminating Cell — specifically: students redesign to enter the discriminating condition.

**How it was taught.** Through the activity: redesign to enter the cell and state what entry costs

**Quick check.** Ask for the closing sentence of Session 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 17: redesign to enter the cell and state what entry costs, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | The same prediction entered for two different accounts. |
...
> "Entering the cell costs something. Say what."
...
**Exact wording.** "Say: five accounts now. Yours, the three, and your field rival."
...
**Target observation.** That multi-account adjudication is achievable.
...
> "Adjudicating against five accounts including a field rival is a realistic test. You just saw that when say: five accounts now.
> Last time we said: Entering the cell costs something. Say what. This is the next part of that.
...
**Completed answer.** A five-row table with all predictions distinct. — which demonstrates that multi-account adjudication is achievable.
...
**Teacher prompt.** "Here is a second case. A coinciding row marked and the design revised. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. The same prediction entered for two different accounts. Why is this not an
example?"
...
**Exact student instructions.** Complete a five-row prediction table with all rows distinct.
...
- *Licensed conclusion.* That multi-account adjudication is achievable.
...
- *Expected response.* That multi-account adjudication is achievable.
...
1. Any wording carrying the idea in `Adjudicating against five accounts including a field rival is a realistic test`.
...
Say: "Five accounts is a real adjudication."
...
| | |
|---|---|
| **Follows** | Session 17 — Entering The Discriminating Cell |
| **Leads to** | Session 19 — The Adjudicating Design |

**Transition in.** Session 17 established students redesign to enter the discriminating condition. This session uses that as the starting point.

**Transition out.** This session establishes students derive predictions for five accounts including field rivals. Session 19 assumes it and builds students present a design distinguishing all accounts.
