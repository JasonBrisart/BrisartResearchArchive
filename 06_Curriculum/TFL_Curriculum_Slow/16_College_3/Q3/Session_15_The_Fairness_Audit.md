...
| | |
|---|---|
| **Central question** | The Fairness Audit: students audit whether a rival was given a fair test? |
| **Core concept** | Operationalising a rival to lose is the commonest integrity failure in adjudication work, and it is rarely deliberate. |
| **Student outcome** | Students audit whether a rival was given a fair test. |
| **Previous session** | Session 14 — The Midterm Review |
| **Next session** | Session 16 — Repairing The Rival |
...
**The conceptual step.** Operationalising a rival to lose is the commonest integrity failure in adjudication work, and it is rarely deliberate. External audit by the rival's defender is the safeguard.
...
**What depends on it.** Session 16 — Repairing The Rival — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Operationalising a rival to lose is the commonest integrity failure in adjudication work, and it is rarely deliberate. External audit by the rival's defender is the safeguard.
...
1. An audit marking a weakened rival operationalisation.
2. A weakening identified by the rival's assigned defender.

### One non-example

A student passing their own operationalisation as fair.
...
That fairness failures are externally detectable.
...
| Statement | Status |
|---|---|
| Operationalising a rival to lose is the commonest integrity failure in adjudication work, and it is rarely deliberate. | Framework-derived, appropriate at this grade |
| That fairness failures are externally detectable. | What this specific activity can show |
...
**How it was taught.** Through the activity: review covering rivals, fair operationalisation, the table, the condition, and confounds

**Quick check.** Ask for the closing sentence of Session 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 14: review covering rivals, fair operationalisation, the table, the condition, and confounds, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit marking a weakened rival operationalisation. |
| **Non-example** | A student passing their own operationalisation as fair. |
...
**Exact wording.** "Ask whether the rival's proponents would accept how it was operationalised."
...
**Target observation.** That fairness failures are externally detectable.
...
> "Operationalising a rival to lose is the commonest integrity failure in adjudication work, and it is rarely deliberate. You just saw that when ask whether the rival's proponents would accept how it was operationalised.
...
**The example.** An audit marking a weakened rival operationalisation.
...
**Completed answer.** An audit marking a weakened rival operationalisation. — which demonstrates that fairness failures are externally detectable.
...
**Teacher prompt.** "Here is a second case. A weakening identified by the rival's assigned defender. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student passing their own operationalisation as fair. Why is this not an
example?"
...
**Exact student instructions.** Audit three designs for fair operationalisation and mark every weakening.
...
- *Licensed conclusion.* That fairness failures are externally detectable.
...
- *Expected response.* That fairness failures are externally detectable.
...
1. Any wording carrying the idea in `Operationalising a rival to lose is the commonest integrity failure in adjudication work, and it is rarely deliberate`.
...
Say: "Operationalising the rival to lose is the commonest integrity failure."
...
| **Leads to** | Session 16 — Repairing The Rival |

**Transition in.** Session 14 established students consolidate the first half. This session uses that as the starting point.

**Transition out.** This session establishes students audit whether a rival was given a fair test. Session 16 assumes it and builds students strengthen a rival they had weakened.
