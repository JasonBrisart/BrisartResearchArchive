...
| **Previous session** | Session 25 — The Year In Comparisons |
...
1. A student identifying fair operationalisation as their weak point.
2. A student finding their tables still contain coinciding rows.
...
**Prerequisite.** The content of Session 25 — The Year In Comparisons — specifically: students review the year through their own comparisons.

**How it was taught.** Through the activity: compare the first table with the latest and write what improved

**Quick check.** Ask for the closing sentence of Session 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 25: compare the first table with the latest and write what improved, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student identifying fair operationalisation as their weak point. |
...
> "Next year: a capstone that could fail."
...
> Last time we said: Next year: a capstone that could fail. This is the next part of that.
...
**The example.** A student identifying fair operationalisation as their weak point.
...
**Completed answer.** A student identifying fair operationalisation as their weak point. — which demonstrates where each student is weakest.
...
**Teacher prompt.** "Here is a second case. A student finding their tables still contain coinciding rows. Work it through with me."
...
| | |
|---|---|
| **Follows** | Session 25 — The Year In Comparisons |
| **Leads to** | Session 27 — Final Preparation |

**Transition in.** Session 25 established students review the year through their own comparisons. This session uses that as the starting point.

**Transition out.** This session establishes students rehearse the final under conditions. Session 27 assumes it and builds students address weaknesses the practice revealed.
