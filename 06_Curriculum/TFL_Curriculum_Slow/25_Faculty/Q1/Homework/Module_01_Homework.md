# Module 1 Homework — Institutional Position And Disclosure

**Faculty** · Institutional Stewardship · **Quarter 1**
**Follows:** Module 1 — Institutional Position And Disclosure · **Points:** 5 · **Optional:** yes
...
Write the sentence Module 1 ended on, from memory:
...
Draft the protocol with verbatim wording, contexts, responsibility, and review interval.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every protocol has verbatim wording and a named role per context
...
Explain today's module to **one person who was not there**.
...
Module 2 is **Testing The Disclosure**, which assumes you arrive holding it. Write one thing you expect it to be about:
