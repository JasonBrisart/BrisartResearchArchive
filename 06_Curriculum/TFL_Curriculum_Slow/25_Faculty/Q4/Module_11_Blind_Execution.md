...
| | |
|---|---|
| **Central question** | Blind Execution: participants test every artifact by having somebody else perform it? |
| **Core concept** | Blind execution is the assessment. |
| **Student outcome** | Participants test every artifact by having somebody else perform it. |
| **Previous module** | Module 10 — Assembling The Portfolio |
| **Next module** | Module 12 — Portfolio Review |
| **Materials** | Institutional standards documentation; licensing terms |
| **Preparation** | ninety minutes |
| **Student printout** | `Printouts/Module_11_Printout.md` |
| **Homework** | `Homework/Module_11_Homework.md` |

## Why this lesson exists

**The conceptual step.** Blind execution is the assessment. The failures reported back constitute the grade, and any assistance from the author invalidates the test.
...
**What depends on it.** Module 12 — Portfolio Review — opens by assuming this module's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Blind execution is the assessment. The failures reported back constitute the grade, and any assistance from the author invalidates the test.
...
1. A disclosure protocol performed blind by a stranger.
2. A scope procedure applied blind to an unseen proposal.

### One non-example

An artifact performed with the author answering questions.
...
That artifacts are graded by blind performance.

### What this activity does not establish

Whether the artifacts are otherwise good.
...
| Statement | Status |
|---|---|
| Blind execution is the assessment. | Framework-derived, appropriate at this grade |
| That artifacts are graded by blind performance. | What this specific activity can show |
| Whether the artifacts are otherwise good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Module 10 — Assembling The Portfolio — specifically: participants assemble all stewardship artifacts.

**How it was taught.** Through the activity: assemble the portfolio and self-audit against the executability gate

**Quick check.** Ask for the closing sentence of Module 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Module 10: assemble the portfolio and self-audit against the executability gate, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A disclosure protocol performed blind by a stranger. |
| **Non-example** | An artifact performed with the author answering questions. |
...
**Student materials.** One copy of `Printouts/Module_11_Printout.md` per student.

**Prior student data required.** Work produced in Module 10, kept in the student's folder.
...
**File.** `Printouts/Module_11_Printout.md`
...
> "Institutional capacity that depends on one person's judgment is just that person."
...
**Exact wording.** "Say: exchange portfolios with somebody you have not worked with."
...
**Target observation.** That artifacts are graded by blind performance.
...
> "Blind execution is the assessment. You just saw that when say: exchange portfolios with somebody you have not worked with.
> Last time we said: Institutional capacity that depends on one person's judgment is just that person. This is the next part of that.
...
**What students must not infer.** Whether the artifacts are otherwise good.

### 4. Worked example

**The example.** A disclosure protocol performed blind by a stranger.
...
**Completed answer.** A disclosure protocol performed blind by a stranger. — which demonstrates that artifacts are graded by blind performance.
...
**Conclusions not licensed.** Whether the artifacts are otherwise good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A scope procedure applied blind to an unseen proposal. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An artifact performed with the author answering questions. Why is this not an
example?"
...
**Exact student instructions.** Four artifacts performed blind, with every failure reported back.
...
- *Licensed conclusion.* That artifacts are graded by blind performance.
- *Not licensed.* Whether the artifacts are otherwise good.
...
- *Expected response.* That artifacts are graded by blind performance.
...
1. Any wording carrying the idea in `Blind execution is the assessment`.
...
Say: "The failures reported back are the grade."

**Why this sentence matters.** It is the opening question of Module 12, which assumes students arrive holding it.
...
**File.** `Homework/Module_11_Homework.md`
...
| | |
|---|---|
| **Follows** | Module 10 — Assembling The Portfolio |
| **Leads to** | Module 12 — Portfolio Review |

**Transition in.** Module 10 established participants assemble all stewardship artifacts. This module uses that as the starting point.

**Transition out.** This module establishes participants test every artifact by having somebody else perform it. Module 12 assumes it and builds participants defend a portfolio tested by blind execution.
