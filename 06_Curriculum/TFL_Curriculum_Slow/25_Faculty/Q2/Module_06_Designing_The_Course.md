...
| | |
|---|---|
| **Central question** | Designing The Course: participants produce a defensible syllabus? |
| **Core concept** | A syllabus whose learning outcomes survive the framework's refutation is defensible to a curriculum committee. |
| **Student outcome** | Participants produce a defensible syllabus. |
| **Previous module** | Module 5 — Testing The Procedure |
| **Next module** | Module 7 — Building A Review Process |
| **Materials** | Institutional standards documentation; licensing terms |
| **Preparation** | ninety minutes |
| **Student printout** | `Printouts/Module_06_Printout.md` |
| **Homework** | `Homework/Module_06_Homework.md` |

## Why this lesson exists

**The conceptual step.** A syllabus whose learning outcomes survive the framework's refutation is defensible to a curriculum committee. Outcomes phrased as framework knowledge do not survive it.
...
**What depends on it.** Module 7 — Building A Review Process — opens by assuming this module's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A syllabus whose learning outcomes survive the framework's refutation is defensible to a curriculum committee. Outcomes phrased as framework knowledge do not survive it.
...
1. An outcome phrased as competence in measurement design.
2. An outcome that remains valid if the framework is refuted mid-term.

### One non-example

An outcome phrased as understanding the framework's claims.
...
That outcomes can be made refutation-proof.

### What this activity does not establish

Whether the course should run.
...
| Statement | Status |
|---|---|
| A syllabus whose learning outcomes survive the framework's refutation is defensible to a curriculum committee. | Framework-derived, appropriate at this grade |
| That outcomes can be made refutation-proof. | What this specific activity can show |
| Whether the course should run. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Module 5 — Testing The Procedure — specifically: participants test enforcement by blind application.

**How it was taught.** Through the activity: blind application test with every ambiguity recorded

**Quick check.** Ask for the closing sentence of Module 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Module 5: blind application test with every ambiguity recorded, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An outcome phrased as competence in measurement design. |
| **Non-example** | An outcome phrased as understanding the framework's claims. |
...
**Student materials.** One copy of `Printouts/Module_06_Printout.md` per student.

**Prior student data required.** Work produced in Module 5, kept in the student's folder.
...
**File.** `Printouts/Module_06_Printout.md`
...
> "The ambiguities are where it will fail in practice."
...
**Exact wording.** "Say: three audiences. Your students, your chair, and a critic. Write for the third."
...
**Target observation.** That outcomes can be made refutation-proof.
...
> "A syllabus whose learning outcomes survive the framework's refutation is defensible to a curriculum committee. You just saw that when say: three audiences.
> Last time we said: The ambiguities are where it will fail in practice. This is the next part of that.
...
**What students must not infer.** Whether the course should run.

### 4. Worked example

**The example.** An outcome phrased as competence in measurement design.
...
**Completed answer.** An outcome phrased as competence in measurement design. — which demonstrates that outcomes can be made refutation-proof.
...
**Conclusions not licensed.** Whether the course should run.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An outcome that remains valid if the framework is refuted mid-term. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An outcome phrased as understanding the framework's claims. Why is this not an
example?"
...
**Exact student instructions.** Draft the syllabus and present to a partner playing curriculum committee.
...
- *Licensed conclusion.* That outcomes can be made refutation-proof.
- *Not licensed.* Whether the course should run.
...
- *Expected response.* That outcomes can be made refutation-proof.
...
1. Any wording carrying the idea in `A syllabus whose learning outcomes survive the framework's refutation is defensible to a curriculum committee`.
...
Say: "The mid-term refutation question is the one nobody prepares for."

**Why this sentence matters.** It is the opening question of Module 7, which assumes students arrive holding it.
...
**File.** `Homework/Module_06_Homework.md`
...
| | |
|---|---|
| **Follows** | Module 5 — Testing The Procedure |
| **Leads to** | Module 7 — Building A Review Process |

**Transition in.** Module 5 established participants test enforcement by blind application. This module uses that as the starting point.

**Transition out.** This module establishes participants produce a defensible syllabus. Module 7 assumes it and builds participants produce a review protocol and reviewer brief.
