# Module 6 Homework — Designing The Course

**Faculty** · Institutional Stewardship · **Quarter 2**
**Follows:** Module 6 — Designing The Course · **Points:** 5 · **Optional:** yes
...
Write the sentence Module 6 ended on, from memory:
...
Draft the syllabus and present to a partner playing curriculum committee.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** outcomes survive the framework's refutation
...
Module 7 is **Building A Review Process**, which assumes you arrive holding it. Write one thing you expect it to be about:
