# Seminar 11 — Proportionate Assessment
...
| | |
|---|---|
| **Central question** | Proportionate Assessment: participants match the verdict to the critique's scope? |
| **Core concept** | Proportionate assessment matches the verdict to what the critique establishes. |
| **Student outcome** | Participants match the verdict to the critique's scope. |
| **Previous seminar** | Seminar 10 — The Closure Path |
| **Next seminar** | Seminar 12 — The Paper Assembled |
...
**The conceptual step.** Proportionate assessment matches the verdict to what the critique establishes. Both inflation and minimisation are errors, tested by asking what rests on the gap.
...
**What depends on it.** Seminar 12 — The Paper Assembled — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Proportionate assessment matches the verdict to what the critique establishes. Both inflation and minimisation are errors, tested by asking what rests on the gap.
...
1. A local gap assessed as local with the dependency stated.
...
**Prerequisite.** The content of Seminar 10 — The Closure Path — specifically: participants specify what would resolve the issue raised.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 10: write the closure path distinguishing theoretical from empirical work, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A local gap assessed as local with the dependency stated. |
...
> "The closure path is what makes it research."
...
**Exact wording.** "Put up two assessments, one proportionate and one converting a parameter gap into a verdict."
...
> "Proportionate assessment matches the verdict to what the critique establishes. You just saw that when put up two assessments, one proportionate and one converting a parameter gap into a verdict.
> Last time we said: The closure path is what makes it research. This is the next part of that.
...
**The example.** A local gap assessed as local with the dependency stated.
...
**Completed answer.** A local gap assessed as local with the dependency stated. — which demonstrates that assessments can be checked for proportion.
...
**Exact student instructions.** Write the assessment, checked for proportion in both directions.
...
| | |
|---|---|
| **Follows** | Seminar 10 — The Closure Path |
| **Leads to** | Seminar 12 — The Paper Assembled |

**Transition in.** Seminar 10 established participants specify what would resolve the issue raised. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants match the verdict to the critique's scope. Seminar 12 assumes it and builds participants assemble the full critique paper.
