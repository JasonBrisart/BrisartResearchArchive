# Seminar 1 — What Makes A Critique Original
...
| | |
|---|---|
| **Central question** | What Makes A Critique Original: participants distinguish critique from complaint and status objection? |
| **Core concept** | Original critique takes one of three forms: specification, structural, or adjudication. |
| **Student outcome** | Participants distinguish critique from complaint and status objection. |
| **Previous seminar** | None. First seminar of the year. |
| **Next seminar** | Seminar 2 — Stating The Target Fairly |
...
**The conceptual step.** Original critique takes one of three forms: specification, structural, or adjudication. Status objections and theory preferences are neither.
...
**What depends on it.** Seminar 2 — Stating The Target Fairly — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Original critique takes one of three forms: specification, structural, or adjudication. Status objections and theory preferences are neither.
...
1. A specification critique targeting an undocumented gap.
2. A structural critique targeting an internal tension.

### One non-example

A critique restating a limitation the specification acknowledges.
...
That originality has a stateable test.
...
| Statement | Status |
|---|---|
| Original critique takes one of three forms: specification, structural, or adjudication. | Framework-derived, appropriate at this grade |
| That originality has a stateable test. | What this specific activity can show |
| Whether the critique succeeds. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The participant produces a located audit and ranks gaps by dependency.
...
| **Correct example** | A specification critique targeting an undocumented gap. |
| **Non-example** | A critique restating a limitation the specification acknowledges. |
...
**Exact wording.** "Read three submitted paragraphs aloud: a status objection, a preference, a real gap."
...
**Target observation.** That originality has a stateable test.
...
> "Original critique takes one of three forms: specification, structural, or adjudication. You just saw that when read three submitted paragraphs aloud: a status objection, a preference, a real gap.
...
**The example.** A specification critique targeting an undocumented gap.
...
**Completed answer.** A specification critique targeting an undocumented gap. — which demonstrates that originality has a stateable test.
...
**Teacher prompt.** "Now one that does not work. A critique restating a limitation the specification acknowledges. Why is this not an
example?"
...
**Exact student instructions.** Classify their Year 1 gaps by form and select a primary.
...
- *Licensed conclusion.* That originality has a stateable test.
...
- *Expected response.* That originality has a stateable test.
...
1. Any wording carrying the idea in `Original critique takes one of three forms: specification, structural, or adjudication`.
...
Say: "Restating the status is not critique. Neither is preferring a different theory."
...
| **Leads to** | Seminar 2 — Stating The Target Fairly |

**Transition in.** This seminar opens the year.

**Transition out.** This seminar establishes participants distinguish critique from complaint and status objection. Seminar 2 assumes it and builds participants render the framework's position in its strongest form.
