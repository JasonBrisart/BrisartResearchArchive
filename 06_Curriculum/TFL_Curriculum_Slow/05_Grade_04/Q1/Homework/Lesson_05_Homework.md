# Lesson 5 Homework — Inheritance In A Story

**Grade 4** · Carry Forward · **Quarter 1**
**Follows:** Lesson 5 — Inheritance In A Story · **Points:** 5 · **Optional:** yes
...
Trace one character across four moments using the inheritance column.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student's trace has specific inheritance in three rows
...
Lesson 6 is **Inheritance In A Day**, which assumes you arrive holding it. Write one thing you expect it to be about:
