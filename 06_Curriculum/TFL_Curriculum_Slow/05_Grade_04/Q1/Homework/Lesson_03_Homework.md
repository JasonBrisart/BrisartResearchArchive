# Lesson 3 Homework — The Inheritance Column

**Grade 4** · Carry Forward · **Quarter 1**
**Follows:** Lesson 3 — The Inheritance Column · **Points:** 5 · **Optional:** yes
...
Trace one real episode across four moments; only the inheritance column is checked.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** rows two to four inherit specific content from the row above
...
Lesson 4 is **The Chain**, which assumes you arrive holding it. Write one thing you expect it to be about:
