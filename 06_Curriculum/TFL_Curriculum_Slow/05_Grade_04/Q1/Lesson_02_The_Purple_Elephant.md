...
| | |
|---|---|
| **Central question** | The Purple Elephant: students demonstrate they cannot start a moment fresh? |
| **Core concept** | A moment cannot be started from nothing. |
| **Student outcome** | Students demonstrate they cannot start a moment fresh. |
| **Previous lesson** | Lesson 1 — Opening The Envelope |
| **Next lesson** | Lesson 3 — The Inheritance Column |
...
**The conceptual step.** A moment cannot be started from nothing. The attempt to clear the mind always results in something else arriving, which itself came from somewhere.
...
**What depends on it.** Lesson 3 — The Inheritance Column — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A moment cannot be started from nothing. The attempt to clear the mind always results in something else arriving, which itself came from somewhere.
...
1. An attempted reset that produced a different thought instead.
2. A student reporting the elephant returned immediately.

### One non-example

A claim that the mind was completely emptied, with nothing reported.
...
That attempted resets produce replacement rather than emptiness.

### What this activity does not establish

Any mechanism for why.
...
| Statement | Status |
|---|---|
| A moment cannot be started from nothing. | Framework-derived, appropriate at this grade |
| That attempted resets produce replacement rather than emptiness. | What this specific activity can show |
| Any mechanism for why. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 1 — Opening The Envelope — specifically: students compare their sealed Grade 3 prediction with the answer.

**How it was taught.** Through the activity: write one paragraph comparing the sealed answer with the real one

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: write one paragraph comparing the sealed answer with the real one, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An attempted reset that produced a different thought instead. |
| **Non-example** | A claim that the mind was completely emptied, with nothing reported. |
...
> "Nothing starts from zero. That sentence is the whole year."
...
**Exact wording.** "Ask them to think about a purple elephant, then to clear their mind completely."
...
**Target observation.** That attempted resets produce replacement rather than emptiness.
...
> "A moment cannot be started from nothing. You just saw that when ask them to think about a purple elephant, then to clear their mind completely.
> Last time we said: Nothing starts from zero. That sentence is the whole year. This is the next part of that.
...
**What students must not infer.** Any mechanism for why.

### 4. Worked example

**The example.** An attempted reset that produced a different thought instead.
...
**Completed answer.** An attempted reset that produced a different thought instead. — which demonstrates that attempted resets produce replacement rather than emptiness.
...
**Conclusions not licensed.** Any mechanism for why.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student reporting the elephant returned immediately. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that the mind was completely emptied, with nothing reported. Why is this not an
example?"
...
**Exact student instructions.** Attempt the reset on three self-chosen topics and record what happened.
...
- *Licensed conclusion.* That attempted resets produce replacement rather than emptiness.
- *Not licensed.* Any mechanism for why.
...
- *Expected response.* That attempted resets produce replacement rather than emptiness.
...
1. Any wording carrying the idea in `A moment cannot be started from nothing`.
...
Say: "You cannot start a moment from nothing."
...
| | |
|---|---|
| **Follows** | Lesson 1 — Opening The Envelope |
| **Leads to** | Lesson 3 — The Inheritance Column |

**Transition in.** Lesson 1 established students compare their sealed Grade 3 prediction with the answer. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students demonstrate they cannot start a moment fresh. Lesson 3 assumes it and builds students trace one episode across four moments showing inheritance.
