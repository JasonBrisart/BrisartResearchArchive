...
| | |
|---|---|
| **Central question** | Inheritance In A Day: students trace carry-forward across their own day? |
| **Core concept** | A day is a chain rather than a list of separate events. |
| **Student outcome** | Students trace carry-forward across their own day. |
| **Previous lesson** | Lesson 5 — Inheritance In A Story |
| **Next lesson** | Lesson 7 — The Broken Chain |
...
**The conceptual step.** A day is a chain rather than a list of separate events. The inheritance column is what turns a timetable into a trace.
...
**What depends on it.** Lesson 7 — The Broken Chain — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A day is a chain rather than a list of separate events. The inheritance column is what turns a timetable into a trace.
...
1. An unresolved argument at break affecting the next lesson.
2. A result from the morning changing what was expected at lunch.

### One non-example

A list of the day's events with no inheritance named.
...
That a day can be traced as a connected chain.

### What this activity does not establish

How much carries between any two points.
...
| Statement | Status |
|---|---|
| A day is a chain rather than a list of separate events. | Framework-derived, appropriate at this grade |
| That a day can be traced as a connected chain. | What this specific activity can show |
| How much carries between any two points. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — Inheritance In A Story — specifically: students find carry-forward in a narrative text.

**How it was taught.** Through the activity: trace one character across four moments using the inheritance column

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: trace one character across four moments using the inheritance column, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An unresolved argument at break affecting the next lesson. |
| **Non-example** | A list of the day's events with no inheritance named. |
...
> "Writers do this on purpose. Now you can see it."
...
**Exact wording.** "Draw the school day as a line and ask where one moment set up the next."
...
**Target observation.** That a day can be traced as a connected chain.
...
> "A day is a chain rather than a list of separate events. You just saw that when draw the school day as a line and ask where one moment set up the next.
> Last time we said: Writers do this on purpose. Now you can see it. This is the next part of that.
...
**What students must not infer.** How much carries between any two points.

### 4. Worked example

**The example.** An unresolved argument at break affecting the next lesson.
...
**Completed answer.** An unresolved argument at break affecting the next lesson. — which demonstrates that a day can be traced as a connected chain.
...
**Conclusions not licensed.** How much carries between any two points.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A result from the morning changing what was expected at lunch. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A list of the day's events with no inheritance named. Why is this not an
example?"
...
**Exact student instructions.** A four-row trace across one school day with inheritance named at each step.
...
- *Licensed conclusion.* That a day can be traced as a connected chain.
- *Not licensed.* How much carries between any two points.
...
- *Expected response.* That a day can be traced as a connected chain.
...
1. Any wording carrying the idea in `A day is a chain rather than a list of separate events`.
...
Say: "Your day is one long chain, not a list of separate things."
...
| | |
|---|---|
| **Follows** | Lesson 5 — Inheritance In A Story |
| **Leads to** | Lesson 7 — The Broken Chain |

**Transition in.** Lesson 5 established students find carry-forward in a narrative text. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students trace carry-forward across their own day. Lesson 7 assumes it and builds students identify the impossible row in a defective trace.
