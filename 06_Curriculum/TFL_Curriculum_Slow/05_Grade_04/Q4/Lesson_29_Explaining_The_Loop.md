...
| | |
|---|---|
| **Central question** | Explaining The Loop: students explain the closed loop to an adult? |
| **Core concept** | Explaining the closed loop to an adult is the terminal check. |
| **Student outcome** | Students explain the closed loop to an adult. |
| **Previous lesson** | Lesson 28 — The Loop In One Sentence |
| **Next lesson** | Lesson 30 — The Year In Chains |
...
**The conceptual step.** Explaining the closed loop to an adult is the terminal check. Adults reliably ask where it started, which is the question the year answers.
...
**What depends on it.** Lesson 30 — The Year In Chains — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Explaining the closed loop to an adult is the terminal check. Adults reliably ask where it started, which is the question the year answers.
...
1. An adult asks where the loop began.
2. An adult asks whether it ever stops.

### One non-example

Reporting that the adult asked nothing.
...
Whether the student can explain the closed loop unsupported.

### What this activity does not establish

Whether the adult was convinced.
...
| Statement | Status |
|---|---|
| Explaining the closed loop to an adult is the terminal check. | Framework-derived, appropriate at this grade |
| Whether the student can explain the closed loop unsupported. | What this specific activity can show |
| Whether the adult was convinced. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — The Loop In One Sentence — specifically: students state the year's idea in a single sentence.

**How it was taught.** Through the activity: write, refine, and peer-check a one-sentence statement of carry-forward

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: write, refine, and peer-check a one-sentence statement of carry-forward, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An adult asks where the loop began. |
| **Non-example** | Reporting that the adult asked nothing. |
...
> "If you can say it in one sentence, you have it."
...
**Exact wording.** "Say: today you teach the whole thing."
...
**Target observation.** Whether the student can explain the closed loop unsupported.
...
> "Explaining the closed loop to an adult is the terminal check. You just saw that when say: today you teach the whole thing.
> Last time we said: If you can say it in one sentence, you have it. This is the next part of that.
...
**What students must not infer.** Whether the adult was convinced.

### 4. Worked example

**The example.** An adult asks where the loop began.
...
**Completed answer.** An adult asks where the loop began. — which demonstrates whether the student can explain the closed loop unsupported.
...
**Conclusions not licensed.** Whether the adult was convinced.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An adult asks whether it ever stops. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reporting that the adult asked nothing. Why is this not an
example?"
...
**Exact student instructions.** Explain the loop to a visiting adult; record the hardest question.
...
- *Licensed conclusion.* Whether the student can explain the closed loop unsupported.
- *Not licensed.* Whether the adult was convinced.
...
- *Expected response.* Whether the student can explain the closed loop unsupported.
...
1. Any wording carrying the idea in `Explaining the closed loop to an adult is the terminal check`.
...
Say: "You taught it. That means you have it."
...
| | |
|---|---|
| **Follows** | Lesson 28 — The Loop In One Sentence |
| **Leads to** | Lesson 30 — The Year In Chains |

**Transition in.** Lesson 28 established students state the year's idea in a single sentence. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain the closed loop to an adult. Lesson 30 assumes it and builds students review the year using their own traces.
