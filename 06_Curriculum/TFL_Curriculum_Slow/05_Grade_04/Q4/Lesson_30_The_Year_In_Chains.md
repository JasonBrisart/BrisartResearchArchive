...
| | |
|---|---|
| **Central question** | The Year In Chains: students review the year using their own traces? |
| **Core concept** | Comparing an early four-row trace with a late audited eight-row one gives direct evidence of the year's progress. |
...
**The conceptual step.** Comparing an early four-row trace with a late audited eight-row one gives direct evidence of the year's progress.
...
Comparing an early four-row trace with a late audited eight-row one gives direct evidence of the year's progress.
...
1. A Lesson 3 trace beside a Lesson 23 one.
2. A student noticing their early inheritance entries were generic.

### One non-example

Reviewing only the most recent traces.
...
| Statement | Status |
|---|---|
| Comparing an early four-row trace with a late audited eight-row one gives direct evidence of the year's progress. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 29 — Explaining The Loop — specifically: students explain the closed loop to an adult.

**How it was taught.** Through the activity: explain the loop to a visiting adult; record the hardest question

**Quick check.** Ask for the closing sentence of Lesson 29. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 29: explain the loop to a visiting adult; record the hardest question, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Lesson 3 trace beside a Lesson 23 one. |
| **Non-example** | Reviewing only the most recent traces. |
...
> "You taught it. That means you have it."
...
> "Comparing an early four-row trace with a late audited eight-row one gives direct evidence of the year's progress. You just saw that when lay out every trace from the year.
> Last time we said: You taught it. That means you have it. This is the next part of that.
...
**The example.** A Lesson 3 trace beside a Lesson 23 one.
...
**Completed answer.** A Lesson 3 trace beside a Lesson 23 one. — which demonstrates that the student's own work changed measurably.
...
**Teacher prompt.** "Here is a second case. A student noticing their early inheritance entries were generic. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reviewing only the most recent traces. Why is this not an
example?"
...
**Exact student instructions.** Compare a Lesson 3 trace with a Lesson 23 trace and write what changed.
...
1. Any wording carrying the idea in `Comparing an early four-row trace with a late audited eight-row one gives direct evidence of the year's progress`.
...
Say: "Next year: why you cannot see the loop when it is working."
...
**Transition in.** Lesson 29 established students explain the closed loop to an adult. This lesson uses that as the starting point.
