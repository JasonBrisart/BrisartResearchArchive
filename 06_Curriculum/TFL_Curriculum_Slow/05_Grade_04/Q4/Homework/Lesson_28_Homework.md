# Lesson 28 Homework — The Loop In One Sentence

**Grade 4** · Carry Forward · **Quarter 4**
**Follows:** Lesson 28 — The Loop In One Sentence · **Points:** 5 · **Optional:** yes
...
Write, refine, and peer-check a one-sentence statement of carry-forward.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces a one-sentence statement that is not a list
...
Lesson 29 is **Explaining The Loop**, which assumes you arrive holding it. Write one thing you expect it to be about:
