# Lesson 20 — Chains In Other Subjects
...
| | |
|---|---|
| **Central question** | Chains In Other Subjects: students find carry-forward in non-TFL material? |
| **Core concept** | The inheritance trace is a general tool for anything sequential. |
| **Student outcome** | Students find carry-forward in non-TFL material. |
| **Previous lesson** | Lesson 19 — Repairing Eight Rows |
| **Next lesson** | Lesson 21 — The Chain With A Gap |
...
**The conceptual step.** The inheritance trace is a general tool for anything sequential. Applying it outside this lesson prevents it being filed as a classroom ritual.
...
**What depends on it.** Lesson 21 — The Chain With A Gap — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The inheritance trace is a general tool for anything sequential. Applying it outside this lesson prevents it being filed as a classroom ritual.
...
1. A six-row trace of a historical sequence.
2. A six-row trace of a scientific process.

### One non-example

A trace of this lesson's material in a different notebook.
...
That the tool transfers to sequential material anywhere.

### What this activity does not establish

Anything about the other subject.
...
| Statement | Status |
|---|---|
| The inheritance trace is a general tool for anything sequential. | Framework-derived, appropriate at this grade |
| That the tool transfers to sequential material anywhere. | What this specific activity can show |
| Anything about the other subject. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — Repairing Eight Rows — specifically: students repair a long chain after audit.

**How it was taught.** Through the activity: repair the audited trace and record each repair type

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: repair the audited trace and record each repair type, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A six-row trace of a historical sequence. |
| **Non-example** | A trace of this lesson's material in a different notebook. |
...
> "Repairs cascade. Fixing the first often fixes the rest."
...
**Exact wording.** "Take a sequence from history or science."
...
**Target observation.** That the tool transfers to sequential material anywhere.
...
> "The inheritance trace is a general tool for anything sequential. You just saw that when take a sequence from history or science.
> Last time we said: Repairs cascade. Fixing the first often fixes the rest. This is the next part of that.
...
**What students must not infer.** Anything about the other subject.

### 4. Worked example

**The example.** A six-row trace of a historical sequence.
...
**Completed answer.** A six-row trace of a historical sequence. — which demonstrates that the tool transfers to sequential material anywhere.
...
**Conclusions not licensed.** Anything about the other subject.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A six-row trace of a scientific process. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A trace of this lesson's material in a different notebook. Why is this not an
example?"
...
**Exact student instructions.** A six-row inheritance trace on material from another subject.
...
- *Licensed conclusion.* That the tool transfers to sequential material anywhere.
- *Not licensed.* Anything about the other subject.
...
- *Expected response.* That the tool transfers to sequential material anywhere.
...
1. Any wording carrying the idea in `The inheritance trace is a general tool for anything sequential`.
...
Say: "The tool works on anything that happens in order."
...
| | |
|---|---|
| **Follows** | Lesson 19 — Repairing Eight Rows |
| **Leads to** | Lesson 21 — The Chain With A Gap |

**Transition in.** Lesson 19 established students repair a long chain after audit. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find carry-forward in non-TFL material. Lesson 21 assumes it and builds students handle a chain interrupted by sleep or absence.
