# Session 8 — Reviewing The Inference, Not The Framework

**Master's Year 2** · Design Review and Defence · **Quarter 2** · **100 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Reviewing The Inference, Not The Framework: students avoid the two standard reviewer failures? |
| **Core concept** | Reviewers fail in two directions: rejecting because the framework is unvalidated, or accepting because the methods are careful regardless of relevance. |
| **Student outcome** | Students avoid the two standard reviewer failures. |
| **Previous session** | Session 7 — Calibration |
| **Next session** | Session 9 — Receiving Review |
| **Materials** | Specimen manuscripts supplied by the instructor; review protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_08_Printout.md` |
| **Homework** | `Homework/Session_08_Homework.md` |

## Why this lesson exists

**The conceptual step.** Reviewers fail in two directions: rejecting because the framework is unvalidated, or accepting because the methods are careful regardless of relevance. Both are errors.

**Why students need it now.** This grade owns one idea: journal-standard review, and calibration against other reviewers.
...
that a good review is a gentle review. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Peer review to journal structure. Fatal flaws must be named specifically; a review that misses one is a failed review.

**What depends on it.** Session 9 — Receiving Review — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Reviewers fail in two directions: rejecting because the framework is unvalidated, or accepting because the methods are careful regardless of relevance. Both are errors.

### How this is stated at this grade

Peer review to journal structure. Fatal flaws must be named specifically; a review that misses one is a failed review.

Use only the vocabulary released at or before this grade. Terms not yet available:
Original specification critique, referee reports on published manuscripts.

### Why the concept matters

The whole grade rests on journal-standard review, and calibration against other reviewers. If a student leaves this
...
1. A past review identified as having rejected on status grounds.
2. A past review identified as accepting on rigour alone.

### One non-example

A claim that neither failure appears in the student's work.
...
That both failure directions are detectable in one's own reviews.

### What this activity does not establish

Which review verdicts were correct.
...
| Statement | Status |
|---|---|
| Reviewers fail in two directions: rejecting because the framework is unvalidated, or accepting because the methods are careful regardless of relevance. | Framework-derived, appropriate at this grade |
| That both failure directions are detectable in one's own reviews. | What this specific activity can show |
| Which review verdicts were correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 7 — Calibration — specifically: students compare their review against others of the same work.

**How it was taught.** Through the activity: compare their review against the instructor's and two peers', accounting for divergence

**Quick check.** Ask for the closing sentence of Session 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 7: compare their review against the instructor's and two peers', accounting for divergence, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | a defect that makes the result uninterpretable. |
| **Student wording** | A defect that makes the result uninterpretable. |
| **Correct example** | A past review identified as having rejected on status grounds. |
| **Non-example** | A claim that neither failure appears in the student's work. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a defect that makes the result uninterpretable." |

### calibration

| | |
|---|---|
| **Teacher definition** | comparing your review against others of the same work. |
| **Student wording** | Comparing your review against others of the same work. |
| **Correct example** | A past review identified as having rejected on status grounds. |
| **Non-example** | A claim that neither failure appears in the student's work. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for comparing your review against others of the same work." |

### review protocol

| | |
|---|---|
| **Teacher definition** | the fixed structure every review follows. |
| **Student wording** | The fixed structure every review follows. |
| **Correct example** | A past review identified as having rejected on status grounds. |
| **Non-example** | A claim that neither failure appears in the student's work. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for the fixed structure every review follows." |


Do not introduce terminology from later grades. Original specification critique, referee reports on published manuscripts.

## Materials and preparation

**Teacher materials.** Specimen manuscripts supplied by the instructor; Review protocol templates; Lab books; Whiteboard.

**Student materials.** One copy of `Printouts/Session_08_Printout.md` per student.

**Prior student data required.** Work produced in Session 7, kept in the student's folder.
...
**File.** `Printouts/Session_08_Printout.md`
...
> "Divergence traceable to reviewing the framework is a reviewer error."
...
**Exact wording.** "Put up two flawed reviews: one rejecting on status, one accepting on rigour."
...
**Target observation.** That both failure directions are detectable in one's own reviews.
...
> "Reviewers fail in two directions: rejecting because the framework is unvalidated, or accepting because the methods are careful regardless of relevance. You just saw that when put up two flawed reviews: one rejecting on status, one accepting on rigour.
> Last time we said: Divergence traceable to reviewing the framework is a reviewer error. This is the next part of that.
> It matters because a design that cannot survive this room will not survive review"
...
**Terminology to introduce here.** fatal flaw, calibration, review protocol.

**What students must not infer.** Which review verdicts were correct.

### 4. Worked example

**The example.** A past review identified as having rejected on status grounds.
...
**Completed answer.** A past review identified as having rejected on status grounds. — which demonstrates that both failure directions are detectable in one's own reviews.
...
**Conclusions not licensed.** Which review verdicts were correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A past review identified as accepting on rigour alone. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that neither failure appears in the student's work. Why is this not an
example?"
...
**Exact student instructions.** Audit their own past reviews for both failure directions.
...
- *Licensed conclusion.* That both failure directions are detectable in one's own reviews.
- *Not licensed.* Which review verdicts were correct.
...
- *Expected response.* That both failure directions are detectable in one's own reviews.
...
3. **Misconception check.** Somebody says: "A good review is a gentle review" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `Reviewers fail in two directions: rejecting because the framework is unvalidated, or accepting because the methods are careful regardless of relevance`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: One reviewer would have let an uninterpretable study run.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "Rigour substituting for relevance is this cohort's failure."

**Why this sentence matters.** It is the opening question of Session 9, which assumes students arrive holding it.
...
### 1. "A good review is a gentle review"

**What the student says or does.** A good review is a gentle review — usually while otherwise engaging well.

**Why it is understandable.** Social pressure in a small cohort.
...
**Exact correction.** Run the calibration exercise on two reviews of the same design.

**Say this.** "One reviewer would have let an uninterpretable study run."
...
### 2. "If the methods are careful the design is sound"

**What the student says or does.** If the methods are careful the design is sound — usually while otherwise engaging well.

**Why it is understandable.** Rigour is visible; relevance is not.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Show a meticulous design that never enters the discriminating condition.

**Say this.** "Careful and irrelevant is a real category, and the commonest one."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "I should review whether the framework is plausible"

**What the student says or does.** I should review whether the framework is plausible — usually while otherwise engaging well.

**Why it is understandable.** The framework's status is salient.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** State the governing rule: review the inference, not the framework.

**Say this.** "Ask whether the design supports what it claims."
...
**Visual or physical support.** Provide the review protocol as a form with executability pre-worked.
...
Ask them to review the same design twice a week apart and account for drift.
...
Specifically, do not introduce: Original specification critique, referee reports on published manuscripts.
...
Mention them whenever the content of this session touches either.

## Homework connection

**File.** `Homework/Session_08_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 7 — Calibration |
| **Leads to** | Session 9 — Receiving Review |

**Transition in.** Session 7 established students compare their review against others of the same work. This session uses that as the starting point.

**Transition out.** This session establishes students avoid the two standard reviewer failures. Session 9 assumes it and builds students revise against reviews they disagree with.
