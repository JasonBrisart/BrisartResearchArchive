# Session 5 Homework — The Falsifiability Section

**Master's Year 2** · Design Review and Defence · **Quarter 1**
**Follows:** Session 5 — The Falsifiability Section · **Points:** 5 · **Optional:** yes
...
Audit two designs, tracing each firing pathway personally.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every pathway is traced rather than accepted
...
Session 6 is **Scope And Recommendation**, which assumes you arrive holding it. Write one thing you expect it to be about:
