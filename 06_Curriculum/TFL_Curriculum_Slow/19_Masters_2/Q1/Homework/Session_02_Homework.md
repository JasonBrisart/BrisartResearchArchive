# Session 2 Homework — The Executability Section

**Master's Year 2** · Design Review and Defence · **Quarter 1**
**Follows:** Session 2 — The Executability Section · **Points:** 5 · **Optional:** yes
...
Executability audits on two designs with complete clarification lists.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every list is specific and line-by-line
...
Session 3 is **The Measurement Section**, which assumes you arrive holding it. Write one thing you expect it to be about:
