# Session 1 Homework — What Review Is For

**Master's Year 2** · Design Review and Defence · **Quarter 1**
**Follows:** Session 1 — What Review Is For · **Points:** 5 · **Optional:** yes
...
Read the six-section protocol and review one specimen design in outline.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every outline covers all six sections
...
Session 2 is **The Executability Section**, which assumes you arrive holding it. Write one thing you expect it to be about:
