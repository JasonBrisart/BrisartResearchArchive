...
| | |
|---|---|
| **Central question** | What Review Is For: students state the purpose and structure of design review? |
| **Core concept** | Design review follows a fixed six-section protocol. |
| **Student outcome** | Students state the purpose and structure of design review. |
| **Previous session** | None. First session of the year. |
| **Next session** | Session 2 — The Executability Section |
...
**The conceptual step.** Design review follows a fixed six-section protocol. Reviewing by listing impressions produces nothing actionable, and politeness that withholds a fatal flaw harms the author.
...
**What depends on it.** Session 2 — The Executability Section — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Design review follows a fixed six-section protocol. Reviewing by listing impressions produces nothing actionable, and politeness that withholds a fatal flaw harms the author.
...
1. An outline covering all six sections of a specimen design.
2. A finding located to a specific section.

### One non-example

A review listing what the reviewer found interesting.
...
That review has a fixed structure.

### What this activity does not establish

Whether the specimen design is good.
...
| Statement | Status |
|---|---|
| Design review follows a fixed six-section protocol. | Framework-derived, appropriate at this grade |
| That review has a fixed structure. | What this specific activity can show |
| Whether the specimen design is good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The student produces an executable measurement map and declares resolution.
...
| **Correct example** | An outline covering all six sections of a specimen design. |
| **Non-example** | A review listing what the reviewer found interesting. |
...
**Exact wording.** "Hand back the Year 1 Session 1 drafts. Say: this year you become the person who makes the marks."
...
**Target observation.** That review has a fixed structure.
...
> "Design review follows a fixed six-section protocol. You just saw that when hand back the Year 1 Session 1 drafts.
...
**What students must not infer.** Whether the specimen design is good.

### 4. Worked example

**The example.** An outline covering all six sections of a specimen design.
...
**Completed answer.** An outline covering all six sections of a specimen design. — which demonstrates that review has a fixed structure.
...
**Conclusions not licensed.** Whether the specimen design is good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A finding located to a specific section. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A review listing what the reviewer found interesting. Why is this not an
example?"
...
**Exact student instructions.** Read the six-section protocol and review one specimen design in outline.
...
- *Licensed conclusion.* That review has a fixed structure.
- *Not licensed.* Whether the specimen design is good.
...
- *Expected response.* That review has a fixed structure.
...
1. Any wording carrying the idea in `Design review follows a fixed six-section protocol`.
...
Say: "Politeness that withholds a fatal flaw is not kindness."
...
| **Leads to** | Session 2 — The Executability Section |

**Transition in.** This session opens the year.

**Transition out.** This session establishes students state the purpose and structure of design review. Session 2 assumes it and builds students audit whether a design can be run at all.
