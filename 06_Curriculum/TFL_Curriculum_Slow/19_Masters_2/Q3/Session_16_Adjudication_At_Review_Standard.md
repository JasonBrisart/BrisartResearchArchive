# Session 16 — Adjudication At Review Standard

**Master's Year 2** · Design Review and Defence · **Quarter 3** · **100 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Adjudication At Review Standard: students judge whether a design would move a question? |
| **Core concept** | Most designs produce a result without moving the question. |
| **Student outcome** | Students judge whether a design would move a question. |
| **Previous session** | Session 15 — Human Subjects And Institutional Duty |
| **Next session** | Session 17 — Rebuilding After Review |
| **Materials** | Specimen manuscripts supplied by the instructor; review protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_16_Printout.md` |
| **Homework** | `Homework/Session_16_Homework.md` |

## Why this lesson exists

**The conceptual step.** Most designs produce a result without moving the question. Naming the failing element is what makes the verdict actionable rather than dismissive.
...
**What depends on it.** Session 17 — Rebuilding After Review — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Most designs produce a result without moving the question. Naming the failing element is what makes the verdict actionable rather than dismissive.
...
1. A middle verdict naming non-entry to the discriminating cell.
2. A negative verdict naming an uninterpretable measurement.

### One non-example

A verdict delivered with no failing element named.
...
That triage verdicts require named failing elements.

### What this activity does not establish

Whether the designs are worth running.
...
| Statement | Status |
|---|---|
| Most designs produce a result without moving the question. | Framework-derived, appropriate at this grade |
| That triage verdicts require named failing elements. | What this specific activity can show |
| Whether the designs are worth running. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 15 — Human Subjects And Institutional Duty — specifically: students state the obligations attached to running studies on people.

**How it was taught.** Through the activity: complete the compliance checklist and state the approval route if pursued

**Quick check.** Ask for the closing sentence of Session 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 15: complete the compliance checklist and state the approval route if pursued, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A middle verdict naming non-entry to the discriminating cell. |
| **Non-example** | A verdict delivered with no failing element named. |
...
**Student materials.** One copy of `Printouts/Session_16_Printout.md` per student.

**Prior student data required.** Work produced in Session 15, kept in the student's folder.
...
**File.** `Printouts/Session_16_Printout.md`
...
> "This is not paperwork. It is the difference between a design and a study."
...
**Exact wording.** "State the three verdicts: would move it, would produce a result, would produce nothing interpretable."
...
**Target observation.** That triage verdicts require named failing elements.
...
> "Most designs produce a result without moving the question. You just saw that when state the three verdicts: would move it, would produce a result, would produce nothing interpretable.
> Last time we said: This is not paperwork. It is the difference between a design and a study. This is the next part of that.
...
**What students must not infer.** Whether the designs are worth running.

### 4. Worked example

**The example.** A middle verdict naming non-entry to the discriminating cell.
...
**Completed answer.** A middle verdict naming non-entry to the discriminating cell. — which demonstrates that triage verdicts require named failing elements.
...
**Conclusions not licensed.** Whether the designs are worth running.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A negative verdict naming an uninterpretable measurement. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A verdict delivered with no failing element named. Why is this not an
example?"
...
**Exact student instructions.** Assign verdicts to six designs, each justified by the failing element.
...
- *Licensed conclusion.* That triage verdicts require named failing elements.
- *Not licensed.* Whether the designs are worth running.
...
- *Expected response.* That triage verdicts require named failing elements.
...
1. Any wording carrying the idea in `Most designs produce a result without moving the question`.
...
Say: "The middle verdict is the most common and the most useful."

**Why this sentence matters.** It is the opening question of Session 17, which assumes students arrive holding it.
...
**File.** `Homework/Session_16_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 15 — Human Subjects And Institutional Duty |
| **Leads to** | Session 17 — Rebuilding After Review |

**Transition in.** Session 15 established students state the obligations attached to running studies on people. This session uses that as the starting point.

**Transition out.** This session establishes students judge whether a design would move a question. Session 17 assumes it and builds students rebuild a design that received a negative verdict.
