# Lesson 6 — Expectations You Never Made
...
| | |
|---|---|
| **Central question** | Expectations You Never Made: students recognise expectations they did not deliberately form? |
| **Core concept** | An expectation can be present without being formed on purpose. |
| **Student outcome** | Students recognise expectations they did not deliberately form. |
| **Previous lesson** | Lesson 5 — Expecting At Home |
| **Next lesson** | Lesson 7 — Comparing Expectations |
...
**The conceptual step.** An expectation can be present without being formed on purpose. The break test recovers it: if breaking it would surprise you, it was there.
...
**What depends on it.** Lesson 7 — Comparing Expectations — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An expectation can be present without being formed on purpose. The break test recovers it: if breaking it would surprise you, it was there.
...
1. The floor holding you up, tested by imagining it not doing so.
2. The door opening outward, tested by imagining it stuck.

### One non-example

A decision to guess the lottery numbers, which was deliberate.
...
That expectations exist without deliberate formation.

### What this activity does not establish

Where they come from, which is next quarter.
...
| Statement | Status |
|---|---|
| An expectation can be present without being formed on purpose. | Framework-derived, appropriate at this grade |
| That expectations exist without deliberate formation. | What this specific activity can show |
| Where they come from, which is next quarter. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — Expecting At Home — specifically: students extend expectation-finding beyond school.

**How it was taught.** Through the activity: five home expectations written up, then compared in pairs

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: five home expectations written up, then compared in pairs, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The floor holding you up, tested by imagining it not doing so. |
| **Non-example** | A decision to guess the lottery numbers, which was deliberate. |
...
**Exact wording.** "Ask what would happen if this chair had collapsed. They react."
...
**Target observation.** That expectations exist without deliberate formation.
...
> "An expectation can be present without being formed on purpose. You just saw that when ask what would happen if this chair had collapsed.
> Last time we said: It runs at home too. This is the next part of that.
...
**What students must not infer.** Where they come from, which is next quarter.

### 4. Worked example

**The example.** The floor holding you up, tested by imagining it not doing so.
...
**Completed answer.** The floor holding you up, tested by imagining it not doing so. — which demonstrates that expectations exist without deliberate formation.
...
**Conclusions not licensed.** Where they come from, which is next quarter.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The door opening outward, tested by imagining it stuck. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A decision to guess the lottery numbers, which was deliberate. Why is this not an
example?"
...
**Exact student instructions.** Hunt three unnoticed expectations, each with how they know it was there.
...
- *Licensed conclusion.* That expectations exist without deliberate formation.
- *Not licensed.* Where they come from, which is next quarter.
...
- *Expected response.* That expectations exist without deliberate formation.
...
1. Any wording carrying the idea in `An expectation can be present without being formed on purpose`.
...
Say: "When your expectation is right, you do not notice it."
...
| | |
|---|---|
| **Follows** | Lesson 5 — Expecting At Home |
| **Leads to** | Lesson 7 — Comparing Expectations |

**Transition in.** Lesson 5 established students extend expectation-finding beyond school. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students recognise expectations they did not deliberately form. Lesson 7 assumes it and builds students notice that classmates expect different things.
