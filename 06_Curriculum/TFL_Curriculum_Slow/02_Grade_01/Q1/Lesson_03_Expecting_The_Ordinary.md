# Lesson 3 — Expecting The Ordinary
...
| | |
|---|---|
| **Central question** | Expecting The Ordinary: students find expectations about routine events? |
| **Core concept** | Most expectations are about ordinary things and go unnoticed because they are met. |
| **Student outcome** | Students find expectations about routine events. |
| **Previous lesson** | Lesson 2 — Three Parts In A Row |
| **Next lesson** | Lesson 4 — Expecting At School |
...
**The conceptual step.** Most expectations are about ordinary things and go unnoticed because they are met. Routine is where nearly all of them live.
...
**What depends on it.** Lesson 4 — Expecting At School — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Most expectations are about ordinary things and go unnoticed because they are met. Routine is where nearly all of them live.
...
1. Expecting the chair to hold your weight.
2. Expecting the light to come on when the switch moves.

### One non-example

Expecting to win a prize, which is not routine and not ordinary.
...
That routine events carry unnoticed expectations.

### What this activity does not establish

How many there are, which nobody can count.
...
| Statement | Status |
|---|---|
| Most expectations are about ordinary things and go unnoticed because they are met. | Framework-derived, appropriate at this grade |
| That routine events carry unnoticed expectations. | What this specific activity can show |
| How many there are, which nobody can count. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — Three Parts In A Row — specifically: students identify notice, remember, and expect in one moment.

**How it was taught.** Through the activity: three-column page, four rows about this room, each connecting across

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: three-column page, four rows about this room, each connecting across, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Expecting the chair to hold your weight. |
| **Non-example** | Expecting to win a prize, which is not routine and not ordinary. |
...
> "Three parts, every time, in that order."
...
**Exact wording.** "Sit down in a chair, ordinarily. Ask whether anybody was surprised."
...
**Target observation.** That routine events carry unnoticed expectations.
...
> "Most expectations are about ordinary things and go unnoticed because they are met. You just saw that when sit down in a chair, ordinarily.
> Last time we said: Three parts, every time, in that order. This is the next part of that.
...
**What students must not infer.** How many there are, which nobody can count.

### 4. Worked example

**The example.** Expecting the chair to hold your weight.
...
**Completed answer.** Expecting the chair to hold your weight. — which demonstrates that routine events carry unnoticed expectations.
...
**Conclusions not licensed.** How many there are, which nobody can count.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Expecting the light to come on when the switch moves. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Expecting to win a prize, which is not routine and not ordinary. Why is this not an
example?"
...
**Exact student instructions.** Hunt five routine expectations: doors, stairs, lights, the bell, the floor.
...
- *Licensed conclusion.* That routine events carry unnoticed expectations.
- *Not licensed.* How many there are, which nobody can count.
...
- *Expected response.* That routine events carry unnoticed expectations.
...
1. Any wording carrying the idea in `Most expectations are about ordinary things and go unnoticed because they are met`.
...
Say: "You expect hundreds of things a day without noticing."
...
| | |
|---|---|
| **Follows** | Lesson 2 — Three Parts In A Row |
| **Leads to** | Lesson 4 — Expecting At School |

**Transition in.** Lesson 2 established students identify notice, remember, and expect in one moment. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find expectations about routine events. Lesson 4 assumes it and builds students map expectations onto the school day.
