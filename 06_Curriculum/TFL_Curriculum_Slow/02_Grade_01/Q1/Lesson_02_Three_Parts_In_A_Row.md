# Lesson 2 — Three Parts In A Row

**Grade 1** · Where Guesses Come From · **Quarter 1** · **25 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Three Parts In A Row: students identify notice, remember, and expect in one moment? |
| **Core concept** | The three parts occur together and in a fixed order. |
| **Student outcome** | Students identify notice, remember, and expect in one moment. |
| **Previous lesson** | Lesson 1 — The Proper Word |
| **Next lesson** | Lesson 3 — Expecting The Ordinary |
...
**The conceptual step.** The three parts occur together and in a fixed order. A row that does not connect across is three observations, not one moment.

**Why students need it now.** This grade owns one idea: tracing an expectation backwards to the memory that produced it.
...
that predicting means guessing on purpose. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Short written sentences. One sentence per idea, two joined with 'so' or 'because'. Drawing remains an acceptable substitute for any answer.

**What depends on it.** Lesson 3 — Expecting The Ordinary — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The three parts occur together and in a fixed order. A row that does not connect across is three observations, not one moment.

### How this is stated at this grade

Short written sentences. One sentence per idea, two joined with 'so' or 'because'. Drawing remains an acceptable substitute for any answer.
...
The whole grade rests on tracing an expectation backwards to the memory that produced it. If a student leaves this
...
1. Noticed the coats, remembered outdoor play, expected to go outside.
2. Noticed the clock, remembered lunch, expected the bell.

### One non-example

Noticed the fan, remembered a holiday, expected rain — the three do not connect.
...
That the three parts co-occur and connect within one moment.

### What this activity does not establish

Which part comes first in time, which is Grade 6 work.
...
| Statement | Status |
|---|---|
| The three parts occur together and in a fixed order. | Framework-derived, appropriate at this grade |
| That the three parts co-occur and connect within one moment. | What this specific activity can show |
| Which part comes first in time, which is Grade 6 work. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 1 — The Proper Word — specifically: students use expect in place of guess.

**How it was taught.** Through the activity: rewrite four Kindergarten frames using EXPECT, in notebooks

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: rewrite four Kindergarten frames using EXPECT, in notebooks, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | the proper word for a guess about what happens next. |
| **Student wording** | The proper word for a guess about what happens next. |
| **Correct example** | Noticed the coats, remembered outdoor play, expected to go outside. |
| **Non-example** | Noticed the fan, remembered a holiday, expected rain — the three do not connect. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for the proper word for a guess about what happens next." |

### because

| | |
|---|---|
| **Teacher definition** | the word that joins a guess to where it came from. |
| **Student wording** | The word that joins a guess to where it came from. |
| **Correct example** | Noticed the coats, remembered outdoor play, expected to go outside. |
| **Non-example** | Noticed the fan, remembered a holiday, expected rain — the three do not connect. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for the word that joins a guess to where it came from." |
...
**Teacher materials.** Notebooks; Chart paper; Index cards; A familiar picture book; An audio source.
...
> "Expect is the word. Next time we line up all three parts."
...
**Exact wording.** "Say: something happened to you in the last ten seconds, tell me every part of it. Take three answers and correct none."
...
**Target observation.** That the three parts co-occur and connect within one moment.
...
> "The three parts occur together and in a fixed order. You just saw that when say: something happened to you in the last ten seconds, tell me every part of it.
> Last time we said: Expect is the word. Next time we line up all three parts. This is the next part of that.
> It matters because a guess is built, and I can say what it was built from"
...
**Terminology to introduce here.** expect, because.

**What students must not infer.** Which part comes first in time, which is Grade 6 work.

### 4. Worked example

**The example.** Noticed the coats, remembered outdoor play, expected to go outside.
...
**Completed answer.** Noticed the coats, remembered outdoor play, expected to go outside. — which demonstrates that the three parts co-occur and connect within one moment.
...
**Conclusions not licensed.** Which part comes first in time, which is Grade 6 work.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Noticed the clock, remembered lunch, expected the bell. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Noticed the fan, remembered a holiday, expected rain — the three do not connect. Why is this not an
example?"
...
**Exact student instructions.** Three-column page, four rows about this room, each connecting across.
...
- *Licensed conclusion.* That the three parts co-occur and connect within one moment.
- *Not licensed.* Which part comes first in time, which is Grade 6 work.
...
- *Expected response.* That the three parts co-occur and connect within one moment.
...
3. **Misconception check.** Somebody says: "Predicting means guessing on purpose" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `The three parts occur together and in a fixed order`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Expecting runs all the time. Deciding to guess is one small piece.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "Three parts, every time, in that order."
...
### 1. "Predicting means guessing on purpose"

**What the student says or does.** Predicting means guessing on purpose — usually while otherwise engaging well.

**Why it is understandable.** Everyday use of the word implies deliberate effort.
...
**Exact correction.** Ask about an expectation they never chose. The chair. The door.

**Say this.** "Expecting runs all the time. Deciding to guess is one small piece."
...
### 2. "'I just knew' is a complete answer"

**What the student says or does.** 'I just knew' is a complete answer — usually while otherwise engaging well.

**Why it is understandable.** The source is invisible, so the expectation feels self-generated.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Push once, every time: 'Knew from what?'

**Say this.** "Everything you expect came from somewhere."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "A wrong expectation was a bad one"

**What the student says or does.** A wrong expectation was a bad one — usually while otherwise engaging well.

**Why it is understandable.** Students carry the general school rule that wrong answers lose points.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Show the mark scheme. Points are for the trace, not the outcome.

**Say this.** "Being wrong costs you nothing. Leaving it blank costs you the points."
...
**Visual or physical support.** Provide the sentence frame on a desk card. Allow drawing for either half.
...
Ask the student to find an expectation whose source they cannot name.
...
| | |
|---|---|
| **Follows** | Lesson 1 — The Proper Word |
| **Leads to** | Lesson 3 — Expecting The Ordinary |

**Transition in.** Lesson 1 established students use expect in place of guess. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify notice, remember, and expect in one moment. Lesson 3 assumes it and builds students find expectations about routine events.
