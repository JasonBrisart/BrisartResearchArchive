...
| | |
|---|---|
| **Central question** | Expecting At Home: students extend expectation-finding beyond school? |
| **Core concept** | Expecting is not a school activity. |
| **Student outcome** | Students extend expectation-finding beyond school. |
| **Previous lesson** | Lesson 4 — Expecting At School |
| **Next lesson** | Lesson 6 — Expectations You Never Made |
...
**The conceptual step.** Expecting is not a school activity. Finding it at home is evidence that it belongs to the student rather than to the lesson.
...
**What depends on it.** Lesson 6 — Expectations You Never Made — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Expecting is not a school activity. Finding it at home is evidence that it belongs to the student rather than to the lesson.
...
1. I expect the kettle to be hot after it boils.
2. I expect the dog to come when the door opens.

### One non-example

A school example repeated because it is easier to write.
...
That expecting occurs outside school.

### What this activity does not establish

Any comparison between home and school rates.
...
| Statement | Status |
|---|---|
| Expecting is not a school activity. | Framework-derived, appropriate at this grade |
| That expecting occurs outside school. | What this specific activity can show |
| Any comparison between home and school rates. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — Expecting At School — specifically: students map expectations onto the school day.

**How it was taught.** Through the activity: each student marks three points on their own day line and writes the expectation at each

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: each student marks three points on their own day line and writes the expectation at each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | I expect the kettle to be hot after it boils. |
| **Non-example** | A school example repeated because it is easier to write. |
...
> "Your whole day is full of them."
...
**Exact wording.** "Ask where else, not here, at home."
...
**Target observation.** That expecting occurs outside school.
...
> "Expecting is not a school activity. You just saw that when ask where else, not here, at home.
> Last time we said: Your whole day is full of them. This is the next part of that.
...
**What students must not infer.** Any comparison between home and school rates.

### 4. Worked example

**The example.** I expect the kettle to be hot after it boils.
...
**Completed answer.** I expect the kettle to be hot after it boils. — which demonstrates that expecting occurs outside school.
...
**Conclusions not licensed.** Any comparison between home and school rates.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. I expect the dog to come when the door opens. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A school example repeated because it is easier to write. Why is this not an
example?"
...
**Exact student instructions.** Five home expectations written up, then compared in pairs.
...
- *Licensed conclusion.* That expecting occurs outside school.
- *Not licensed.* Any comparison between home and school rates.
...
- *Expected response.* That expecting occurs outside school.
...
1. Any wording carrying the idea in `Expecting is not a school activity`.
...
| | |
|---|---|
| **Follows** | Lesson 4 — Expecting At School |
| **Leads to** | Lesson 6 — Expectations You Never Made |

**Transition in.** Lesson 4 established students map expectations onto the school day. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students extend expectation-finding beyond school. Lesson 6 assumes it and builds students recognise expectations they did not deliberately form.
