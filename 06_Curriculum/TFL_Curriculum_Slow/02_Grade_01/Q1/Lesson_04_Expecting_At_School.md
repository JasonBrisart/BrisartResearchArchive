...
| | |
|---|---|
| **Central question** | Expecting At School: students map expectations onto the school day? |
| **Core concept** | An expectation is a statement about what comes next, not a label for an event. |
| **Student outcome** | Students map expectations onto the school day. |
| **Previous lesson** | Lesson 3 — Expecting The Ordinary |
| **Next lesson** | Lesson 5 — Expecting At Home |
...
**The conceptual step.** An expectation is a statement about what comes next, not a label for an event. Mapping them onto the day shows how dense they are.
...
**What depends on it.** Lesson 5 — Expecting At Home — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An expectation is a statement about what comes next, not a label for an event. Mapping them onto the day shows how dense they are.
...
1. At 9am I expect the register to be called.
2. At lunch I expect the hall to be loud.

### One non-example

Writing assembly on the line, which names an event, not an expectation.
...
That expectations attach to specific points in time.

### What this activity does not establish

Whether any of them were correct.
...
| Statement | Status |
|---|---|
| An expectation is a statement about what comes next, not a label for an event. | Framework-derived, appropriate at this grade |
| That expectations attach to specific points in time. | What this specific activity can show |
| Whether any of them were correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — Expecting The Ordinary — specifically: students find expectations about routine events.

**How it was taught.** Through the activity: hunt five routine expectations: doors, stairs, lights, the bell, the floor

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: hunt five routine expectations: doors, stairs, lights, the bell, the floor, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | At 9am I expect the register to be called. |
| **Non-example** | Writing assembly on the line, which names an event, not an expectation. |
...
> "You expect hundreds of things a day without noticing."
...
**Exact wording.** "Draw the school day as a line on the board."
...
**Target observation.** That expectations attach to specific points in time.
...
> "An expectation is a statement about what comes next, not a label for an event. You just saw that when draw the school day as a line on the board.
> Last time we said: You expect hundreds of things a day without noticing. This is the next part of that.
...
**What students must not infer.** Whether any of them were correct.

### 4. Worked example

**The example.** At 9am I expect the register to be called.
...
**Completed answer.** At 9am I expect the register to be called. — which demonstrates that expectations attach to specific points in time.
...
**Conclusions not licensed.** Whether any of them were correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. At lunch I expect the hall to be loud. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Writing assembly on the line, which names an event, not an expectation. Why is this not an
example?"
...
**Exact student instructions.** Each student marks three points on their own day line and writes the expectation at each.
...
- *Licensed conclusion.* That expectations attach to specific points in time.
- *Not licensed.* Whether any of them were correct.
...
- *Expected response.* That expectations attach to specific points in time.
...
1. Any wording carrying the idea in `An expectation is a statement about what comes next, not a label for an event`.
...
Say: "Your whole day is full of them."
...
| | |
|---|---|
| **Follows** | Lesson 3 — Expecting The Ordinary |
| **Leads to** | Lesson 5 — Expecting At Home |

**Transition in.** Lesson 3 established students find expectations about routine events. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students map expectations onto the school day. Lesson 5 assumes it and builds students extend expectation-finding beyond school.
