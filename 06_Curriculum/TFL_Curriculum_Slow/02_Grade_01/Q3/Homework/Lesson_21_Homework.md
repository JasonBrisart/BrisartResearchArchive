# Lesson 21 Homework — Interrupts All Day

**Grade 1** · Where Guesses Come From · **Quarter 3**
**Follows:** Lesson 21 — Interrupts All Day · **Points:** 5 · **Optional:** yes
...
Three interrupts collected from the rest of the school day.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student brings three dated interrupts
...
Lesson 22 is **When The Interrupt Is Wrong**, which assumes you arrive holding it. Write one thing you expect it to be about:
