# Lesson 20 Homework — The Prediction Interrupt

**Grade 1** · Where Guesses Come From · **Quarter 3**
**Follows:** Lesson 20 — The Prediction Interrupt · **Points:** 5 · **Optional:** yes
...
Five interrupts across the session, each written before the action.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has five interrupts written before acting
...
Lesson 21 is **Interrupts All Day**, which assumes you arrive holding it. Write one thing you expect it to be about:
