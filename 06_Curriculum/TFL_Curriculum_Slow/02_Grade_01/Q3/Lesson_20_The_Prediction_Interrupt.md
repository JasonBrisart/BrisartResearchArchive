# Lesson 20 — The Prediction Interrupt
...
| | |
|---|---|
| **Central question** | The Prediction Interrupt: students catch an expectation while it is running? |
| **Core concept** | An expectation can be caught in the moment rather than reconstructed afterwards. |
| **Student outcome** | Students catch an expectation while it is running. |
| **Previous lesson** | Lesson 19 — The Pattern Break |
| **Next lesson** | Lesson 21 — Interrupts All Day |
...
**The conceptual step.** An expectation can be caught in the moment rather than reconstructed afterwards. The order of writing and acting is what makes it valid.
...
**What depends on it.** Lesson 21 — Interrupts All Day — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An expectation can be caught in the moment rather than reconstructed afterwards. The order of writing and acting is what makes it valid.
...
1. Before standing, writing that the chair will scrape.
2. Before opening the book, writing which page it opens to.

### One non-example

Writing the expectation after the action, which is a report.
...
That in-the-moment capture is possible.

### What this activity does not establish

Whether the captured expectation is complete.
...
| Statement | Status |
|---|---|
| An expectation can be caught in the moment rather than reconstructed afterwards. | Framework-derived, appropriate at this grade |
| That in-the-moment capture is possible. | What this specific activity can show |
| Whether the captured expectation is complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — The Pattern Break — specifically: students record how a class expectation survives a break.

**How it was taught.** Through the activity: tally the class expectation across nine cards on a printed sheet

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: tally the class expectation across nine cards on a printed sheet, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Before standing, writing that the chair will scrape. |
| **Non-example** | Writing the expectation after the action, which is a report. |
...
> "It was wrong one second ago and you went straight back."
...
**Exact wording.** "Say: freeze before you do the next thing. What do you expect?"
...
**Target observation.** That in-the-moment capture is possible.
...
> "An expectation can be caught in the moment rather than reconstructed afterwards. You just saw that when say: freeze before you do the next thing.
> Last time we said: It was wrong one second ago and you went straight back. This is the next part of that.
...
**What students must not infer.** Whether the captured expectation is complete.

### 4. Worked example

**The example.** Before standing, writing that the chair will scrape.
...
**Completed answer.** Before standing, writing that the chair will scrape. — which demonstrates that in-the-moment capture is possible.
...
**Conclusions not licensed.** Whether the captured expectation is complete.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Before opening the book, writing which page it opens to. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Writing the expectation after the action, which is a report. Why is this not an
example?"
...
**Exact student instructions.** Five interrupts across the session, each written before the action.
...
- *Licensed conclusion.* That in-the-moment capture is possible.
- *Not licensed.* Whether the captured expectation is complete.
...
- *Expected response.* That in-the-moment capture is possible.
...
1. Any wording carrying the idea in `An expectation can be caught in the moment rather than reconstructed afterwards`.
...
Say: "You can catch one while it is still running."
...
| | |
|---|---|
| **Follows** | Lesson 19 — The Pattern Break |
| **Leads to** | Lesson 21 — Interrupts All Day |

**Transition in.** Lesson 19 established students record how a class expectation survives a break. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students catch an expectation while it is running. Lesson 21 assumes it and builds students run interrupts outside the lesson.
