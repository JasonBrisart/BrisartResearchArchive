...
| **Core concept** | The four exit outcomes together constitute readiness for Grade 2. |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 2. All four must be present, not merely attempted.
...
The four exit outcomes together constitute readiness for Grade 2. All four must be present, not merely attempted.
...
2. A student completes three fully and one partially.

### One non-example

A student who writes at length on one item and omits three.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 2. | Framework-derived, appropriate at this grade |
...
| **Non-example** | A student who writes at length on one item and omits three. |
...
> "Now you know what to look at before next time."
...
> "The four exit outcomes together constitute readiness for Grade 2. You just saw that when say: everything you know, on your own.
> Last time we said: Now you know what to look at before next time. This is the next part of that.
...
**Teacher prompt.** "Here is a second case. A student completes three fully and one partially. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student who writes at length on one item and omits three. Why is this not an
example?"
...
**Exact student instructions.** The final: a complete trace, the break test, the sticking question, and a second cycle.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 2`.
...
Say: "Next year: comparing two of these side by side."
