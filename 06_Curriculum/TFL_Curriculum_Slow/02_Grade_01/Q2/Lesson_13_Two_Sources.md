...
| | |
|---|---|
| **Central question** | Two Sources: students find expectations with more than one source? |
| **Core concept** | An expectation can draw on more than one remembered thing. |
| **Student outcome** | Students find expectations with more than one source. |
| **Previous lesson** | Lesson 12 — Tracing Backwards |
| **Next lesson** | Lesson 14 — Somebody Else's Trace |
...
**The conceptual step.** An expectation can draw on more than one remembered thing. Forcing a second source where none exists is worse than reporting one.
...
**What depends on it.** Lesson 14 — Somebody Else's Trace — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An expectation can draw on more than one remembered thing. Forcing a second source where none exists is worse than reporting one.
...
1. Expected a test because of the calendar and because the teacher hinted.
2. Expected rain from the sky and from the forecast.

### One non-example

Inventing a second source to fill the box.
...
That expectations can have multiple sources.
...
| Statement | Status |
|---|---|
| An expectation can draw on more than one remembered thing. | Framework-derived, appropriate at this grade |
| That expectations can have multiple sources. | What this specific activity can show |
| How the sources combine. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — Tracing Backwards — specifically: students formalise the backward trace.

**How it was taught.** Through the activity: trace six of their own expectations from this week backwards

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: trace six of their own expectations from this week backwards, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Expected a test because of the calendar and because the teacher hinted. |
| **Non-example** | Inventing a second source to fill the box. |
...
> "Start at the expectation and walk back."
...
**Exact wording.** "Ask whether an expectation can come from two things at once."
...
**Target observation.** That expectations can have multiple sources.
...
> "An expectation can draw on more than one remembered thing. You just saw that when ask whether an expectation can come from two things at once.
> Last time we said: Start at the expectation and walk back. This is the next part of that.
...
**What students must not infer.** How the sources combine.

### 4. Worked example

**The example.** Expected a test because of the calendar and because the teacher hinted.
...
**Completed answer.** Expected a test because of the calendar and because the teacher hinted. — which demonstrates that expectations can have multiple sources.
...
**Conclusions not licensed.** How the sources combine.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Expected rain from the sky and from the forecast. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Inventing a second source to fill the box. Why is this not an
example?"
...
**Exact student instructions.** Three expectations, each traced to two contributing memories.
...
- *Licensed conclusion.* That expectations can have multiple sources.
- *Not licensed.* How the sources combine.
...
- *Expected response.* That expectations can have multiple sources.
...
1. Any wording carrying the idea in `An expectation can draw on more than one remembered thing`.
...
Say: "Sometimes more than one memory feeds the same expectation."
...
| | |
|---|---|
| **Follows** | Lesson 12 — Tracing Backwards |
| **Leads to** | Lesson 14 — Somebody Else's Trace |

**Transition in.** Lesson 12 established students formalise the backward trace. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find expectations with more than one source. Lesson 14 assumes it and builds students check a partner's trace.
