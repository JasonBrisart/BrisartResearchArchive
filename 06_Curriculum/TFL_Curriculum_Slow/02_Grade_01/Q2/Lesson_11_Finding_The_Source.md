# Lesson 11 — Finding The Source

**Grade 1** · Where Guesses Come From · **Quarter 2** · **25 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Finding The Source: students identify what a stated expectation came from? |
| **Core concept** | An expectation can be traced backwards to a plausible source even when you were not the person who had it. |
| **Student outcome** | Students identify what a stated expectation came from. |
| **Previous lesson** | Lesson 10 — Because Everywhere |
| **Next lesson** | Lesson 12 — Tracing Backwards |
...
**The conceptual step.** An expectation can be traced backwards to a plausible source even when you were not the person who had it. Several sources may work.
...
**What depends on it.** Lesson 12 — Tracing Backwards — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An expectation can be traced backwards to a plausible source even when you were not the person who had it. Several sources may work.
...
1. Expected the gate locked because it is locked after four.
2. Expected the gate locked because a sign said so.

### One non-example

An expectation with no plausible source anybody can supply.
...
That expectations can be traced backwards.

### What this activity does not establish

That the traced source is the actual one.
...
| Statement | Status |
|---|---|
| An expectation can be traced backwards to a plausible source even when you were not the person who had it. | Framework-derived, appropriate at this grade |
| That expectations can be traced backwards. | What this specific activity can show |
| That the traced source is the actual one. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 10 — Because Everywhere — specifically: students apply because to expectations from other lessons.

**How it was taught.** Through the activity: four cross-subject expectations completed with because

**Quick check.** Ask for the closing sentence of Lesson 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 10: four cross-subject expectations completed with because, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Expected the gate locked because it is locked after four. |
| **Non-example** | An expectation with no plausible source anybody can supply. |
...
> "It works in every lesson, not only this one."
...
**Exact wording.** "Say: somebody expected the gate to be locked. Ask what they remembered."
...
**Target observation.** That expectations can be traced backwards.
...
> "An expectation can be traced backwards to a plausible source even when you were not the person who had it. You just saw that when say: somebody expected the gate to be locked.
> Last time we said: It works in every lesson, not only this one. This is the next part of that.
...
**What students must not infer.** That the traced source is the actual one.

### 4. Worked example

**The example.** Expected the gate locked because it is locked after four.
...
**Completed answer.** Expected the gate locked because it is locked after four. — which demonstrates that expectations can be traced backwards.
...
**Conclusions not licensed.** That the traced source is the actual one.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Expected the gate locked because a sign said so. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An expectation with no plausible source anybody can supply. Why is this not an
example?"
...
**Exact student instructions.** Six sourceless expectations, each given a plausible memory.
...
- *Licensed conclusion.* That expectations can be traced backwards.
- *Not licensed.* That the traced source is the actual one.
...
- *Expected response.* That expectations can be traced backwards.
...
1. Any wording carrying the idea in `An expectation can be traced backwards to a plausible source even when you were not the person who had it`.
...
Say: "You can walk backwards from an expectation."
...
| | |
|---|---|
| **Follows** | Lesson 10 — Because Everywhere |
| **Leads to** | Lesson 12 — Tracing Backwards |

**Transition in.** Lesson 10 established students apply because to expectations from other lessons. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify what a stated expectation came from. Lesson 12 assumes it and builds students formalise the backward trace.
