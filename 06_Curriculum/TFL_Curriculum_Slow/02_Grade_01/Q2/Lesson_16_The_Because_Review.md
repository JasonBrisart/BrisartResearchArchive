...
| | |
|---|---|
| **Central question** | The Because Review: students consolidate tracing? |
| **Core concept** | Catching unsourced expectations in others is the active form of the because rule. |
| **Student outcome** | Students consolidate tracing. |
| **Previous lesson** | Lesson 15 — Fixing A Trace |
| **Next lesson** | Lesson 17 — Break It On Purpose |
...
**The conceptual step.** Catching unsourced expectations in others is the active form of the because rule. Students who can catch it hold the rule.
...
**What depends on it.** Lesson 17 — Break It On Purpose — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Catching unsourced expectations in others is the active form of the because rule. Students who can catch it hold the rule.
...
1. A student objects that no memory was named.
2. A student supplies a plausible source for a planted case.

### One non-example

Accepting an unsourced expectation because it sounds confident.
...
Whether the because rule can be applied to others' claims.

### What this activity does not establish

Politeness of the challenge.
...
| Statement | Status |
|---|---|
| Catching unsourced expectations in others is the active form of the because rule. | Framework-derived, appropriate at this grade |
| Whether the because rule can be applied to others' claims. | What this specific activity can show |
| Politeness of the challenge. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — Fixing A Trace — specifically: students repair a trace that was marked.

**How it was taught.** Through the activity: each student repairs every marked trace and says what changed

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: each student repairs every marked trace and says what changed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student objects that no memory was named. |
| **Non-example** | Accepting an unsourced expectation because it sounds confident. |
...
**Exact wording.** "Ask why because matters."
...
**Target observation.** Whether the because rule can be applied to others' claims.
...
> "Catching unsourced expectations in others is the active form of the because rule. You just saw that when ask why because matters.
> Last time we said: Fixing is part of the work. This is the next part of that.
...
**What students must not infer.** Politeness of the challenge.

### 4. Worked example

**The example.** A student objects that no memory was named.
...
**Completed answer.** A student objects that no memory was named. — which demonstrates whether the because rule can be applied to others' claims.
...
**Conclusions not licensed.** Politeness of the challenge.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student supplies a plausible source for a planted case. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Accepting an unsourced expectation because it sounds confident. Why is this not an
example?"
...
**Exact student instructions.** Review with three deliberately unsourced expectations to catch and fix.
...
- *Licensed conclusion.* Whether the because rule can be applied to others' claims.
- *Not licensed.* Politeness of the challenge.
...
- *Expected response.* Whether the because rule can be applied to others' claims.
...
1. Any wording carrying the idea in `Catching unsourced expectations in others is the active form of the because rule`.
...
Say: "Next time: what happens when an expectation is wrong."
...
| | |
|---|---|
| **Follows** | Lesson 15 — Fixing A Trace |
| **Leads to** | Lesson 17 — Break It On Purpose |

**Transition in.** Lesson 15 established students repair a trace that was marked. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate tracing. Lesson 17 assumes it and builds students report the expectation an engineered break revealed.
