# Lesson 10 Homework — Because Everywhere

**Grade 1** · Where Guesses Come From · **Quarter 2**
**Follows:** Lesson 10 — Because Everywhere · **Points:** 5 · **Optional:** yes
...
Four cross-subject expectations completed with because.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student completes four from other subjects
...
Lesson 11 is **Finding The Source**, which assumes you arrive holding it. Write one thing you expect it to be about:
