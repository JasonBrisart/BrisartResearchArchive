# Lesson 25 — The Structural Argument

**Grade 9** · The Formal System · **Quarter 4** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Structural Argument: students argue formally about a proposed modification? |
| **Core concept** | A structural argument evaluates a modification by what it changes, what it costs in falsifiability, and what evidence would justify it. |
| **Student outcome** | Students argue formally about a proposed modification. |
| **Previous lesson** | Lesson 24 — The Parameter Review |
| **Next lesson** | Lesson 26 — Arguing The Other Side |
...
**The conceptual step.** A structural argument evaluates a modification by what it changes, what it costs in falsifiability, and what evidence would justify it. Intuitions about emotion are not structural arguments.
...
**What depends on it.** Lesson 26 — Arguing The Other Side — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A structural argument evaluates a modification by what it changes, what it costs in falsifiability, and what evidence would justify it. Intuitions about emotion are not structural arguments.
...
1. An argument naming a currently-contradicting result the change would absorb.
2. An argument stating what evidence would justify the modification.

### One non-example

An argument that the change feels more realistic.
...
That modifications can be evaluated structurally.

### What this activity does not establish

Whether the modification should be made.
...
| Statement | Status |
|---|---|
| A structural argument evaluates a modification by what it changes, what it costs in falsifiability, and what evidence would justify it. | Framework-derived, appropriate at this grade |
| That modifications can be evaluated structurally. | What this specific activity can show |
| Whether the modification should be made. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 24 — The Parameter Review — specifically: students consolidate parameter work.

**How it was taught.** Through the activity: review with six parameters judged for observational support

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: review with six parameters judged for observational support, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An argument naming a currently-contradicting result the change would absorb. |
| **Non-example** | An argument that the change feels more realistic. |
...
> "Next time: arguing about the structure itself."
...
**Exact wording.** "Say: a researcher proposes E(t) should also scale w3, because strong feelings dominate perception."
...
**Target observation.** That modifications can be evaluated structurally.
...
> "A structural argument evaluates a modification by what it changes, what it costs in falsifiability, and what evidence would justify it. You just saw that when say: a researcher proposes E(t) should also scale w3, because strong feelings dominate perception.
> Last time we said: Next time: arguing about the structure itself. This is the next part of that.
...
**What students must not infer.** Whether the modification should be made.

### 4. Worked example

**The example.** An argument naming a currently-contradicting result the change would absorb.
...
**Completed answer.** An argument naming a currently-contradicting result the change would absorb. — which demonstrates that modifications can be evaluated structurally.
...
**Conclusions not licensed.** Whether the modification should be made.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An argument stating what evidence would justify the modification. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An argument that the change feels more realistic. Why is this not an
example?"
...
**Exact student instructions.** A 250-word structured argument on what changes, what it costs, what would justify it.
...
- *Licensed conclusion.* That modifications can be evaluated structurally.
- *Not licensed.* Whether the modification should be made.
...
- *Expected response.* That modifications can be evaluated structurally.
...
1. Any wording carrying the idea in `A structural argument evaluates a modification by what it changes, what it costs in falsifiability, and what evidence would justify it`.
...
Say: "The strongest answers notice the modification absorbs contradicting results."
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Parameter Review |
| **Leads to** | Lesson 26 — Arguing The Other Side |

**Transition in.** Lesson 24 established students consolidate parameter work. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students argue formally about a proposed modification. Lesson 26 assumes it and builds students argue for the modification they argued against.
