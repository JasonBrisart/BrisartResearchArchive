# Lesson 10 — The Absorption Exercise
...
| | |
|---|---|
| **Central question** | The Absorption Exercise: students test whether a proposed variable can be absorbed? |
| **Core concept** | Some proposed variables can be expressed through the declared set, some cannot, and some only partly. |
| **Student outcome** | Students test whether a proposed variable can be absorbed. |
| **Previous lesson** | Lesson 9 — Variable Closure |
| **Next lesson** | Lesson 11 — The Cost Of Adding |
...
**The conceptual step.** Some proposed variables can be expressed through the declared set, some cannot, and some only partly. Partly is the honest answer for attention.
...
**What depends on it.** Lesson 11 — The Cost Of Adding — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Some proposed variables can be expressed through the declared set, some cannot, and some only partly. Partly is the honest answer for attention.
...
1. A proposal fully absorbable into Input(t) weighting.
2. Attention marked partly absorbable, with the residue named.

### One non-example

A proposal forced into full absorption to keep the model tidy.
...
That absorption has three possible outcomes.

### What this activity does not establish

Whether the residue matters.
...
| Statement | Status |
|---|---|
| Some proposed variables can be expressed through the declared set, some cannot, and some only partly. | Framework-derived, appropriate at this grade |
| That absorption has three possible outcomes. | What this specific activity can show |
| Whether the residue matters. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 9 — Variable Closure — specifically: students state the closure constraint and its cost.

**How it was taught.** Through the activity: analyse four proposed variables for absorption and cost

**Quick check.** Ask for the closing sentence of Lesson 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 9: analyse four proposed variables for absorption and cost, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A proposal fully absorbable into Input(t) weighting. |
| **Non-example** | A proposal forced into full absorption to keep the model tidy. |
...
> "Closure trades explanatory reach for the ability to be wrong."
...
**Exact wording.** "Take attention, the commonest proposal, and ask where it would have to live."
...
**Target observation.** That absorption has three possible outcomes.
...
> "Some proposed variables can be expressed through the declared set, some cannot, and some only partly. You just saw that when take attention, the commonest proposal, and ask where it would have to live.
> Last time we said: Closure trades explanatory reach for the ability to be wrong. This is the next part of that.
...
**What students must not infer.** Whether the residue matters.

### 4. Worked example

**The example.** A proposal fully absorbable into Input(t) weighting.
...
**Completed answer.** A proposal fully absorbable into Input(t) weighting. — which demonstrates that absorption has three possible outcomes.
...
**Conclusions not licensed.** Whether the residue matters.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Attention marked partly absorbable, with the residue named. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A proposal forced into full absorption to keep the model tidy. Why is this not an
example?"
...
**Exact student instructions.** Attempt absorption on four proposals, marking each yes, no, or partly.
...
- *Licensed conclusion.* That absorption has three possible outcomes.
- *Not licensed.* Whether the residue matters.
...
- *Expected response.* That absorption has three possible outcomes.
...
1. Any wording carrying the idea in `Some proposed variables can be expressed through the declared set, some cannot, and some only partly`.
...
Say: "Partly is a real answer. Forcing it either way is not."
...
| | |
|---|---|
| **Follows** | Lesson 9 — Variable Closure |
| **Leads to** | Lesson 11 — The Cost Of Adding |

**Transition in.** Lesson 9 established students state the closure constraint and its cost. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students test whether a proposed variable can be absorbed. Lesson 11 assumes it and builds students quantify what a sixth variable would cost.
