# Lesson 13 — Tracing With The Relation
...
| | |
|---|---|
| **Central question** | Tracing With The Relation: students hand-trace F(t) across multiple cycles? |
| **Core concept** | A formal trace requires explicit propagation: each cycle's carried-in content must be named and must come from the cycle above. |
| **Student outcome** | Students hand-trace F(t) across multiple cycles. |
| **Previous lesson** | Lesson 12 — Closure Versus Convenience |
| **Next lesson** | Lesson 14 — Breaking A Trace |
...
**The conceptual step.** A formal trace requires explicit propagation: each cycle's carried-in content must be named and must come from the cycle above.
...
**What depends on it.** Lesson 14 — Breaking A Trace — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A formal trace requires explicit propagation: each cycle's carried-in content must be named and must come from the cycle above.
...
1. A five-cycle trace with named propagation throughout.
2. A cycle whose carried-in content is the prior F(t).

### One non-example

Five well-written cycles with no propagation named.
...
That propagation must be explicit in a formal trace.
...
| Statement | Status |
|---|---|
| A formal trace requires explicit propagation: each cycle's carried-in content must be named and must come from the cycle above. | Framework-derived, appropriate at this grade |
| That propagation must be explicit in a formal trace. | What this specific activity can show |
| Whether the trace is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — Closure Versus Convenience — specifically: students test whether closure is principled or convenient.

**How it was taught.** Through the activity: test three excluded variables against the convenience challenge

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: test three excluded variables against the convenience challenge, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A five-cycle trace with named propagation throughout. |
| **Non-example** | Five well-written cycles with no propagation named. |
...
> "Check whether the excluded ones are the threatening ones."
...
**Exact wording.** "Say: a trace is correct when cycle three could not have been written without cycle two."
...
**Target observation.** That propagation must be explicit in a formal trace.
...
> "A formal trace requires explicit propagation: each cycle's carried-in content must be named and must come from the cycle above. You just saw that when say: a trace is correct when cycle three could not have been written without cycle two.
> Last time we said: Check whether the excluded ones are the threatening ones. This is the next part of that.
...
**What students must not infer.** Whether the trace is accurate.

### 4. Worked example

**The example.** A five-cycle trace with named propagation throughout.
...
**Completed answer.** A five-cycle trace with named propagation throughout. — which demonstrates that propagation must be explicit in a formal trace.
...
**Conclusions not licensed.** Whether the trace is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A cycle whose carried-in content is the prior F(t). Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Five well-written cycles with no propagation named. Why is this not an
example?"
...
**Exact student instructions.** A five-cycle trace with carried-in content named in every cycle after the first.
...
- *Licensed conclusion.* That propagation must be explicit in a formal trace.
- *Not licensed.* Whether the trace is accurate.
...
- *Expected response.* That propagation must be explicit in a formal trace.
...
1. Any wording carrying the idea in `A formal trace requires explicit propagation: each cycle's carried-in content must be named and must come from the cycle above`.
...
Say: "Propagation is explicit. Nothing arrives from outside the cycle."
...
| | |
|---|---|
| **Follows** | Lesson 12 — Closure Versus Convenience |
| **Leads to** | Lesson 14 — Breaking A Trace |

**Transition in.** Lesson 12 established students test whether closure is principled or convenient. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students hand-trace F(t) across multiple cycles. Lesson 14 assumes it and builds students identify architectural violations in a trace.
