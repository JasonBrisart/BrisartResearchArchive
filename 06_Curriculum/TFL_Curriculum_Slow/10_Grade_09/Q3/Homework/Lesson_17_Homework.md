# Lesson 17 Homework — Opening The Prediction

**Grade 9** · The Formal System · **Quarter 3**
**Follows:** Lesson 17 — Opening The Prediction · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 17 ended on, from memory:
...
Compare the sealed prediction with what they now know and write what would have pointed them right.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student compares their sealed prediction with current understanding
...
Lesson 18 is **Parameters Need Observables**, which assumes you arrive holding it. Write one thing you expect it to be about:
