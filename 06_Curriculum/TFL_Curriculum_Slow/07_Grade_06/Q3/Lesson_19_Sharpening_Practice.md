...
| | |
|---|---|
| **Central question** | Sharpening Practice: students sharpen vague statements systematically? |
| **Core concept** | Sharpening proceeds in steps. |
| **Student outcome** | Students sharpen vague statements systematically. |
| **Previous lesson** | Lesson 18 — The Third Party Test |
| **Next lesson** | Lesson 20 — Feelings Are Not Simulations |
...
**The conceptual step.** Sharpening proceeds in steps. Jumping straight to a specific statement usually produces something unrelated to the original, which the intermediate step prevents.
...
**What depends on it.** Lesson 20 — Feelings Are Not Simulations — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Sharpening proceeds in steps. Jumping straight to a specific statement usually produces something unrelated to the original, which the intermediate step prevents.
...
1. Bad feeling, then worried about the test, then expected question four to be hard.
2. An intermediate step shown for each sharpening.

### One non-example

A leap from a vague feeling to an unrelated specific claim.
...
That sharpening is a traceable process.

### What this activity does not establish

Whether the sharpened version is what was originally meant.
...
| Statement | Status |
|---|---|
| Sharpening proceeds in steps. | Framework-derived, appropriate at this grade |
| That sharpening is a traceable process. | What this specific activity can show |
| Whether the sharpened version is what was originally meant. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — The Third Party Test — specifically: students test whether somebody absent could check their Sim(t).

**How it was taught.** Through the activity: apply the third-party test to ten of their own Sim(t) statements

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: apply the third-party test to ten of their own Sim(t) statements, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Bad feeling, then worried about the test, then expected question four to be hard. |
| **Non-example** | A leap from a vague feeling to an unrelated specific claim. |
...
> "Checkable by somebody else is the standard."
...
**Exact wording.** "Put a deliberately vague statement up and ask them to sharpen it in three steps."
...
**Target observation.** That sharpening is a traceable process.
...
> "Sharpening proceeds in steps. You just saw that when put a deliberately vague statement up and ask them to sharpen it in three steps.
> Last time we said: Checkable by somebody else is the standard. This is the next part of that.
...
**What students must not infer.** Whether the sharpened version is what was originally meant.

### 4. Worked example

**The example.** Bad feeling, then worried about the test, then expected question four to be hard.
...
**Completed answer.** Bad feeling, then worried about the test, then expected question four to be hard. — which demonstrates that sharpening is a traceable process.
...
**Conclusions not licensed.** Whether the sharpened version is what was originally meant.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An intermediate step shown for each sharpening. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A leap from a vague feeling to an unrelated specific claim. Why is this not an
example?"
...
**Exact student instructions.** Sharpen eight vague statements, showing the intermediate step for each.
...
- *Licensed conclusion.* That sharpening is a traceable process.
- *Not licensed.* Whether the sharpened version is what was originally meant.
...
- *Expected response.* That sharpening is a traceable process.
...
1. Any wording carrying the idea in `Sharpening proceeds in steps`.
...
Say: "Sharpening has steps. It is not one leap."
...
| | |
|---|---|
| **Follows** | Lesson 18 — The Third Party Test |
| **Leads to** | Lesson 20 — Feelings Are Not Simulations |

**Transition in.** Lesson 18 established students test whether somebody absent could check their Sim(t). This lesson uses that as the starting point.

**Transition out.** This lesson establishes students sharpen vague statements systematically. Lesson 20 assumes it and builds students separate affective states from predicted content.
