...
| | |
|---|---|
| **Central question** | The Boundary List: students catalogue what the rule excludes? |
| **Core concept** | The identifiability rule excludes moods, vague unease, general orientations, and anything without a stateable outcome. |
| **Student outcome** | Students catalogue what the rule excludes. |
| **Previous lesson** | Lesson 21 — Identifiability Elsewhere |
| **Next lesson** | Lesson 23 — Auditing For Identifiability |
...
**The conceptual step.** The identifiability rule excludes moods, vague unease, general orientations, and anything without a stateable outcome. The exclusions define the model as much as the inclusions.
...
**What depends on it.** Lesson 23 — Auditing For Identifiability — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The identifiability rule excludes moods, vague unease, general orientations, and anything without a stateable outcome. The exclusions define the model as much as the inclusions.
...
1. Moods excluded because they name no outcome.
2. General optimism excluded for the same reason.

### One non-example

Treating the exclusions as gaps the framework should fill.
...
That exclusions define the model's scope.

### What this activity does not establish

Whether the excluded states matter.
...
| Statement | Status |
|---|---|
| The identifiability rule excludes moods, vague unease, general orientations, and anything without a stateable outcome. | Framework-derived, appropriate at this grade |
| That exclusions define the model's scope. | What this specific activity can show |
| Whether the excluded states matter. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 21 — Identifiability Elsewhere — specifically: students apply the rule to claims from outside school.

**How it was taught.** Through the activity: five outside predictions tested for identifiability

**Quick check.** Ask for the closing sentence of Lesson 21. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 21: five outside predictions tested for identifiability, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Moods excluded because they name no outcome. |
| **Non-example** | Treating the exclusions as gaps the framework should fill. |
...
> "Most public predictions fail this test."
...
**Exact wording.** "Ask what this rule keeps out."
...
**Target observation.** That exclusions define the model's scope.
...
> "The identifiability rule excludes moods, vague unease, general orientations, and anything without a stateable outcome. You just saw that when ask what this rule keeps out.
> Last time we said: Most public predictions fail this test. This is the next part of that.
...
**What students must not infer.** Whether the excluded states matter.

### 4. Worked example

**The example.** Moods excluded because they name no outcome.
...
**Completed answer.** Moods excluded because they name no outcome. — which demonstrates that exclusions define the model's scope.
...
**Conclusions not licensed.** Whether the excluded states matter.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. General optimism excluded for the same reason. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Treating the exclusions as gaps the framework should fill. Why is this not an
example?"
...
**Exact student instructions.** Build a list of five categories the identifiability rule excludes.
...
- *Licensed conclusion.* That exclusions define the model's scope.
- *Not licensed.* Whether the excluded states matter.
...
- *Expected response.* That exclusions define the model's scope.
...
1. Any wording carrying the idea in `The identifiability rule excludes moods, vague unease, general orientations, and anything without a stateable outcome`.
...
Say: "Knowing what is excluded is knowing the model."
...
| | |
|---|---|
| **Follows** | Lesson 21 — Identifiability Elsewhere |
| **Leads to** | Lesson 23 — Auditing For Identifiability |

**Transition in.** Lesson 21 established students apply the rule to claims from outside school. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students catalogue what the rule excludes. Lesson 23 assumes it and builds students audit a partner's maps for unidentifiable simulations.
