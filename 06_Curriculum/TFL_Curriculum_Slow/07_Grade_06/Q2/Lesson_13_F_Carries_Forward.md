...
| | |
|---|---|
| **Central question** | F(t) Carries Forward: students connect the notation to Grade 4 carry-forward? |
| **Core concept** | The notation renames what Grade 4 already established. |
| **Student outcome** | Students connect the notation to Grade 4 carry-forward. |
| **Previous lesson** | Lesson 12 — Inside One Window |
| **Next lesson** | Lesson 14 — Windows In Other Subjects |
...
**The conceptual step.** The notation renames what Grade 4 already established. F(t) is the moment, and its propagation to the next window is the inheritance column under a formal name.
...
**What depends on it.** Lesson 14 — Windows In Other Subjects — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The notation renames what Grade 4 already established. F(t) is the moment, and its propagation to the next window is the inheritance column under a formal name.
...
1. A Grade 4 inheritance column rewritten as F(t) propagation.
2. A student recognising their own old work in the new notation.

### One non-example

Treating F(t) propagation as a newly introduced mechanism.
...
That the notation renames established content.
...
| Statement | Status |
|---|---|
| The notation renames what Grade 4 already established. | Framework-derived, appropriate at this grade |
| That the notation renames established content. | What this specific activity can show |
| Any new mechanism. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — Inside One Window — specifically: students state the order of operations within a window.

**How it was taught.** Through the activity: annotate a Lesson 2 map with the order and state what would break if reversed

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: annotate a Lesson 2 map with the order and state what would break if reversed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Grade 4 inheritance column rewritten as F(t) propagation. |
| **Non-example** | Treating F(t) propagation as a newly introduced mechanism. |
...
> "Everything in that order, every window."
...
**Exact wording.** "Put a Grade 4 inheritance trace next to a five-variable map and ask which is which."
...
**Target observation.** That the notation renames established content.
...
> "The notation renames what Grade 4 already established. You just saw that when put a Grade 4 inheritance trace next to a five-variable map and ask which is which.
> Last time we said: Everything in that order, every window. This is the next part of that.
...
**What students must not infer.** Any new mechanism.

### 4. Worked example

**The example.** A Grade 4 inheritance column rewritten as F(t) propagation.
...
**Completed answer.** A Grade 4 inheritance column rewritten as F(t) propagation. — which demonstrates that the notation renames established content.
...
**Conclusions not licensed.** Any new mechanism.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student recognising their own old work in the new notation. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Treating F(t) propagation as a newly introduced mechanism. Why is this not an
example?"
...
**Exact student instructions.** Rewrite one Grade 4 trace in notation, with F(t) propagating between rows.
...
- *Licensed conclusion.* That the notation renames established content.
- *Not licensed.* Any new mechanism.
...
- *Expected response.* That the notation renames established content.
...
1. Any wording carrying the idea in `The notation renames what Grade 4 already established`.
...
Say: "Nothing new was added. The same thing got a precise name."
...
| | |
|---|---|
| **Follows** | Lesson 12 — Inside One Window |
| **Leads to** | Lesson 14 — Windows In Other Subjects |

**Transition in.** Lesson 12 established students state the order of operations within a window. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students connect the notation to Grade 4 carry-forward. Lesson 14 assumes it and builds students apply window reasoning to another subject.
