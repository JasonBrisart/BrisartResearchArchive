# Lesson 7 Homework — Comparing Maps

**Grade 6** · Naming The System · **Quarter 1**
**Follows:** Lesson 7 — Comparing Maps · **Points:** 5 · **Optional:** yes
...
Compare two maps of a shared event and name every differing line.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names at least two differing lines
...
Lesson 8 is **The Five Names Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
