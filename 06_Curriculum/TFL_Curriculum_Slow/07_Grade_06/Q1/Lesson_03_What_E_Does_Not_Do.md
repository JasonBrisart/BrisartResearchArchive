...
| | |
|---|---|
| **Central question** | What E(t) Does Not Do: students state the gating constraint? |
| **Core concept** | E(t) governs whether a simulation carries into the next window. |
| **Student outcome** | Students state the gating constraint. |
| **Previous lesson** | Lesson 2 — The Five Names |
| **Next lesson** | Lesson 4 — Mapping Other People's Moments |
...
**The conceptual step.** E(t) governs whether a simulation carries into the next window. It does not build the simulation, does not weight the integration, and does not indicate accuracy. This constraint is the framework's most exposed commitment.
...
**What depends on it.** Lesson 4 — Mapping Other People's Moments — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

E(t) governs whether a simulation carries into the next window. It does not build the simulation, does not weight the integration, and does not indicate accuracy. This constraint is the framework's most exposed commitment.
...
1. A strongly felt expectation that turned out wrong and still persisted.
2. A correct expectation with low intensity that faded immediately.

### One non-example

An example where intensity is described as making the guess better.
...
That E(t) has a narrow, stated role.

### What this activity does not establish

Whether the constraint is empirically true.
...
| Statement | Status |
|---|---|
| E(t) governs whether a simulation carries into the next window. | Framework-derived, appropriate at this grade |
| That E(t) has a narrow, stated role. | What this specific activity can show |
| Whether the constraint is empirically true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — The Five Names — specifically: students map plain-language parts onto the five declared variables.

**How it was taught.** Through the activity: map three real moments to all five variables using the printed template

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: map three real moments to all five variables using the printed template, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A strongly felt expectation that turned out wrong and still persisted. |
| **Non-example** | An example where intensity is described as making the guess better. |
...
> "Five names. Next time, the rule that surprises everybody."
...
**Exact wording.** "Ask which of the five builds your expectation. Record the votes."
...
**Target observation.** That E(t) has a narrow, stated role.
...
> "E(t) governs whether a simulation carries into the next window. You just saw that when ask which of the five builds your expectation.
> Last time we said: Five names. Next time, the rule that surprises everybody. This is the next part of that.
...
**What students must not infer.** Whether the constraint is empirically true.

### 4. Worked example

**The example.** A strongly felt expectation that turned out wrong and still persisted.
...
**Completed answer.** A strongly felt expectation that turned out wrong and still persisted. — which demonstrates that E(t) has a narrow, stated role.
...
**Conclusions not licensed.** Whether the constraint is empirically true.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A correct expectation with low intensity that faded immediately. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An example where intensity is described as making the guess better. Why is this not an
example?"
...
**Exact student instructions.** Write the constraint in their own words and find a supporting example.
...
- *Licensed conclusion.* That E(t) has a narrow, stated role.
- *Not licensed.* Whether the constraint is empirically true.
...
- *Expected response.* That E(t) has a narrow, stated role.
...
1. Any wording carrying the idea in `E(t) governs whether a simulation carries into the next window`.
...
Say: "E(t) decides survival, not content. Most important sentence this year."
...
| | |
|---|---|
| **Follows** | Lesson 2 — The Five Names |
| **Leads to** | Lesson 4 — Mapping Other People's Moments |

**Transition in.** Lesson 2 established students map plain-language parts onto the five declared variables. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state the gating constraint. Lesson 4 assumes it and builds students map a described moment they did not experience.
