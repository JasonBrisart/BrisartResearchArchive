# Lesson 5 — Mapping Across A Lesson
...
| | |
|---|---|
| **Central question** | Mapping Across A Lesson: students map several moments from one continuous period? |
| **Core concept** | Mapping four moments from one twenty-minute period shows how sparse the sampling is. |
| **Student outcome** | Students map several moments from one continuous period. |
| **Previous lesson** | Lesson 4 — Mapping Other People's Moments |
| **Next lesson** | Lesson 6 — When Sim(t) Is Unclear |
...
**The conceptual step.** Mapping four moments from one twenty-minute period shows how sparse the sampling is. The gap between four maps and thousands of windows is the point.
...
**What depends on it.** Lesson 6 — When Sim(t) Is Unclear — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Mapping four moments from one twenty-minute period shows how sparse the sampling is. The gap between four maps and thousands of windows is the point.
...
1. Four maps from the last twenty minutes, in order.
2. A student estimating how many windows fell between their maps.

### One non-example

Four maps drawn from four different days.
...
That mapping samples a dense sequence.

### What this activity does not establish

How many windows actually occurred.
...
| Statement | Status |
|---|---|
| Mapping four moments from one twenty-minute period shows how sparse the sampling is. | Framework-derived, appropriate at this grade |
| That mapping samples a dense sequence. | What this specific activity can show |
| How many windows actually occurred. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — Mapping Other People's Moments — specifically: students map a described moment they did not experience.

**How it was taught.** Through the activity: map four described moments to all five variables

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: map four described moments to all five variables, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Four maps from the last twenty minutes, in order. |
| **Non-example** | Four maps drawn from four different days. |
...
> "You can do it for other people, from what they tell you."
...
**Exact wording.** "Say: four moments from this lesson so far. Map all four."
...
**Target observation.** That mapping samples a dense sequence.
...
> "Mapping four moments from one twenty-minute period shows how sparse the sampling is. You just saw that when say: four moments from this lesson so far.
> Last time we said: You can do it for other people, from what they tell you. This is the next part of that.
...
**What students must not infer.** How many windows actually occurred.

### 4. Worked example

**The example.** Four maps from the last twenty minutes, in order.
...
**Completed answer.** Four maps from the last twenty minutes, in order. — which demonstrates that mapping samples a dense sequence.
...
**Conclusions not licensed.** How many windows actually occurred.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student estimating how many windows fell between their maps. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Four maps drawn from four different days. Why is this not an
example?"
...
**Exact student instructions.** Four mapped moments from within the session, in order.
...
- *Licensed conclusion.* That mapping samples a dense sequence.
- *Not licensed.* How many windows actually occurred.
...
- *Expected response.* That mapping samples a dense sequence.
...
1. Any wording carrying the idea in `Mapping four moments from one twenty-minute period shows how sparse the sampling is`.
...
Say: "Four moments in twenty minutes. There were thousands."
...
| | |
|---|---|
| **Follows** | Lesson 4 — Mapping Other People's Moments |
| **Leads to** | Lesson 6 — When Sim(t) Is Unclear |

**Transition in.** Lesson 4 established students map a described moment they did not experience. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students map several moments from one continuous period. Lesson 6 assumes it and builds students mark moments where the simulation cannot be stated.
