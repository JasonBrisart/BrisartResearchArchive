# Lesson 28 Homework — Checking The Notation

**Grade 6** · Naming The System · **Quarter 4**
**Follows:** Lesson 28 — Checking The Notation · **Points:** 5 · **Optional:** yes
...
Audit a partner's trace for the same three error types.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student finds at least two of three error types
...
Lesson 29 is **Explaining The Notation**, which assumes you arrive holding it. Write one thing you expect it to be about:
