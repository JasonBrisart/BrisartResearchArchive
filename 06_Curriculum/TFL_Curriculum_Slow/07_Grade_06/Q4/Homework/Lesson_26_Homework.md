# Lesson 26 Homework — The Five Column Trace

**Grade 6** · Naming The System · **Quarter 4**
**Follows:** Lesson 26 — The Five Column Trace · **Points:** 5 · **Optional:** yes
...
A three-row five-column trace on one real episode.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has three rows with visible connection
...
Lesson 27 is **Longer Traces**, which assumes you arrive holding it. Write one thing you expect it to be about:
