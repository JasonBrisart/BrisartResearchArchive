...
| | |
|---|---|
| **Central question** | Longer Traces: students extend the notated trace to six windows? |
| **Core concept** | Longer notated traces fade in the same way as Grade 4 chains. |
| **Student outcome** | Students extend the notated trace to six windows. |
| **Previous lesson** | Lesson 26 — The Five Column Trace |
| **Next lesson** | Lesson 28 — Checking The Notation |
...
**The conceptual step.** Longer notated traces fade in the same way as Grade 4 chains. Marking the fade must be scored as highly as filling the row, or students will invent content.
...
**What depends on it.** Lesson 28 — Checking The Notation — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Longer notated traces fade in the same way as Grade 4 chains. Marking the fade must be scored as highly as filling the row, or students will invent content.
...
1. A six-row trace with rows five and six marked faint.
2. A marked-faint row scored at full credit.

### One non-example

A six-row trace with invented content in the later rows.
...
That notated traces fade and the fade can be marked.

### What this activity does not establish

How long a trace can honestly run.
...
| Statement | Status |
|---|---|
| Longer notated traces fade in the same way as Grade 4 chains. | Framework-derived, appropriate at this grade |
| That notated traces fade and the fade can be marked. | What this specific activity can show |
| How long a trace can honestly run. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — The Five Column Trace — specifically: students produce a five-column trace across three windows.

**How it was taught.** Through the activity: a three-row five-column trace on one real episode

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: a three-row five-column trace on one real episode, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A six-row trace with rows five and six marked faint. |
| **Non-example** | A six-row trace with invented content in the later rows. |
...
> "The trace is the tool for the next six years."
...
**Exact wording.** "Say: three was the warm-up. Six today."
...
**Target observation.** That notated traces fade and the fade can be marked.
...
> "Longer notated traces fade in the same way as Grade 4 chains. You just saw that when say: three was the warm-up.
> Last time we said: The trace is the tool for the next six years. This is the next part of that.
...
**What students must not infer.** How long a trace can honestly run.

### 4. Worked example

**The example.** A six-row trace with rows five and six marked faint.
...
**Completed answer.** A six-row trace with rows five and six marked faint. — which demonstrates that notated traces fade and the fade can be marked.
...
**Conclusions not licensed.** How long a trace can honestly run.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A marked-faint row scored at full credit. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A six-row trace with invented content in the later rows. Why is this not an
example?"
...
**Exact student instructions.** A six-row five-column trace with honest marking where it fades.
...
- *Licensed conclusion.* That notated traces fade and the fade can be marked.
- *Not licensed.* How long a trace can honestly run.
...
- *Expected response.* That notated traces fade and the fade can be marked.
...
1. Any wording carrying the idea in `Longer notated traces fade in the same way as Grade 4 chains`.
...
Say: "It gets harder. Marking it is the honest move."
...
| | |
|---|---|
| **Follows** | Lesson 26 — The Five Column Trace |
| **Leads to** | Lesson 28 — Checking The Notation |

**Transition in.** Lesson 26 established students produce a five-column trace across three windows. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students extend the notated trace to six windows. Lesson 28 assumes it and builds students audit a trace for misused notation.
