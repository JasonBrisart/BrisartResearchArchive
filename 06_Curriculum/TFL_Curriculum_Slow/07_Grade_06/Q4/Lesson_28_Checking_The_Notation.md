# Lesson 28 — Checking The Notation
...
| | |
|---|---|
| **Central question** | Checking The Notation: students audit a trace for misused notation? |
| **Core concept** | The three common notation errors are a mood in the Sim(t) line, E(t) described as building the prediction, and F(t) treated as one of the inputs rather than the result. |
| **Student outcome** | Students audit a trace for misused notation. |
| **Previous lesson** | Lesson 27 — Longer Traces |
| **Next lesson** | Lesson 29 — Explaining The Notation |
...
**The conceptual step.** The three common notation errors are a mood in the Sim(t) line, E(t) described as building the prediction, and F(t) treated as one of the inputs rather than the result.
...
**What depends on it.** Lesson 29 — Explaining The Notation — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The three common notation errors are a mood in the Sim(t) line, E(t) described as building the prediction, and F(t) treated as one of the inputs rather than the result.
...
1. An audit catching a mood in the Sim(t) column.
2. An audit catching E(t) described as generating content.

### One non-example

An audit catching only the most obvious of the three.
...
That notation misuse is detectable by audit.

### What this activity does not establish

Whether the trace's content is accurate.
...
| Statement | Status |
|---|---|
| The three common notation errors are a mood in the Sim(t) line, E(t) described as building the prediction, and F(t) treated as one of the inputs rather than the result. | Framework-derived, appropriate at this grade |
| That notation misuse is detectable by audit. | What this specific activity can show |
| Whether the trace's content is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — Longer Traces — specifically: students extend the notated trace to six windows.

**How it was taught.** Through the activity: a six-row five-column trace with honest marking where it fades

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: a six-row five-column trace with honest marking where it fades, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit catching a mood in the Sim(t) column. |
| **Non-example** | An audit catching only the most obvious of the three. |
...
> "It gets harder. Marking it is the honest move."
...
**Exact wording.** "Put up a trace with three planted notation errors and ask them to find them."
...
**Target observation.** That notation misuse is detectable by audit.
...
> "The three common notation errors are a mood in the Sim(t) line, E(t) described as building the prediction, and F(t) treated as one of the inputs rather than the result. You just saw that when put up a trace with three planted notation errors and ask them to find them.
> Last time we said: It gets harder. Marking it is the honest move. This is the next part of that.
...
**What students must not infer.** Whether the trace's content is accurate.

### 4. Worked example

**The example.** An audit catching a mood in the Sim(t) column.
...
**Completed answer.** An audit catching a mood in the Sim(t) column. — which demonstrates that notation misuse is detectable by audit.
...
**Conclusions not licensed.** Whether the trace's content is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An audit catching E(t) described as generating content. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit catching only the most obvious of the three. Why is this not an
example?"
...
**Exact student instructions.** Audit a partner's trace for the same three error types.
...
- *Licensed conclusion.* That notation misuse is detectable by audit.
- *Not licensed.* Whether the trace's content is accurate.
...
- *Expected response.* That notation misuse is detectable by audit.
...
1. Any wording carrying the idea in `The three common notation errors are a mood in the Sim(t) line, E(t) described as building the prediction, and F(t) treated as one of the inputs rather than the result`.
...
Say: "The E(t) error is the one to watch for."
...
| | |
|---|---|
| **Follows** | Lesson 27 — Longer Traces |
| **Leads to** | Lesson 29 — Explaining The Notation |

**Transition in.** Lesson 27 established students extend the notated trace to six windows. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit a trace for misused notation. Lesson 29 assumes it and builds students explain the five variables to somebody who does not know them.
