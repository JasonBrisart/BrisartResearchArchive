# Session 8 — The Independent Critique
...
| | |
|---|---|
| **Central question** | The Independent Critique: students select a critique form and target? |
| **Core concept** | An independent critique takes one of three forms: specification, structural, or adjudication. |
| **Student outcome** | Students select a critique form and target. |
| **Previous session** | Session 7 — Confirmatory And Exploratory |
| **Next session** | Session 9 — Evidence For A Critique |
...
**The conceptual step.** An independent critique takes one of three forms: specification, structural, or adjudication. A status objection is none of them.
...
**What depends on it.** Session 9 — Evidence For A Critique — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An independent critique takes one of three forms: specification, structural, or adjudication. A status objection is none of them.
...
1. A specification critique targeting the threshold's underspecification.
2. A structural critique targeting an internal tension.

### One non-example

A critique restating that the framework is unvalidated.
...
That critique has stateable qualifying forms.

### What this activity does not establish

Whether the critique succeeds.
...
| Statement | Status |
|---|---|
| An independent critique takes one of three forms: specification, structural, or adjudication. | Framework-derived, appropriate at this grade |
| That critique has stateable qualifying forms. | What this specific activity can show |
| Whether the critique succeeds. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 7 — Confirmatory And Exploratory — specifically: students separate prespecified tests from exploration.

**How it was taught.** Through the activity: mark every planned analysis as confirmatory or exploratory before data exist

**Quick check.** Ask for the closing sentence of Session 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 7: mark every planned analysis as confirmatory or exploratory before data exist, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A specification critique targeting the threshold's underspecification. |
| **Non-example** | A critique restating that the framework is unvalidated. |
...
> "Prespecify the confirmatory test, label the rest, report both."
...
**Exact wording.** "Say: restating the status is not a critique. Neither is preferring a different theory."
...
**Target observation.** That critique has stateable qualifying forms.
...
> "An independent critique takes one of three forms: specification, structural, or adjudication. You just saw that when say: restating the status is not a critique.
> Last time we said: Prespecify the confirmatory test, label the rest, report both. This is the next part of that.
...
**What students must not infer.** Whether the critique succeeds.

### 4. Worked example

**The example.** A specification critique targeting the threshold's underspecification.
...
**Completed answer.** A specification critique targeting the threshold's underspecification. — which demonstrates that critique has stateable qualifying forms.
...
**Conclusions not licensed.** Whether the critique succeeds.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A structural critique targeting an internal tension. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A critique restating that the framework is unvalidated. Why is this not an
example?"
...
**Exact student instructions.** Select a form and draft the target statement, fairly rendered.
...
- *Licensed conclusion.* That critique has stateable qualifying forms.
- *Not licensed.* Whether the critique succeeds.
...
- *Expected response.* That critique has stateable qualifying forms.
...
1. Any wording carrying the idea in `An independent critique takes one of three forms: specification, structural, or adjudication`.
...
Say: "If a reader can tell which side you take, rewrite it."
...
| | |
|---|---|
| **Follows** | Session 7 — Confirmatory And Exploratory |
| **Leads to** | Session 9 — Evidence For A Critique |

**Transition in.** Session 7 established students separate prespecified tests from exploration. This session uses that as the starting point.

**Transition out.** This session establishes students select a critique form and target. Session 9 assumes it and builds students support every critique claim with a location or citation.
