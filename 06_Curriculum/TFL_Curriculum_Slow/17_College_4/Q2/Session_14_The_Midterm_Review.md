...
| **Core concept** | A midterm review must sample the whole term rather than the recent sessions. |
| **Student outcome** | Students consolidate the first half. |
| **Previous session** | Session 13 — Proportionate Assessment |
| **Next session** | Session 15 — Capstone Measurement |
...
**The conceptual step.** A midterm review must sample the whole term rather than the recent sessions.
...
**What depends on it.** Session 15 — Capstone Measurement — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A midterm review must sample the whole term rather than the recent sessions.
...
1. A review touching Session 3 and Session 13 equally.
2. A cohort identifying the reverse ladder as its weakest area.

### One non-example

A review covering only the critique sessions.
...
| Statement | Status |
|---|---|
| A midterm review must sample the whole term rather than the recent sessions. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Session 13 — Proportionate Assessment — specifically: students match the verdict to the critique's scope.

**How it was taught.** Through the activity: write the assessment, checked by a classmate for proportion in both directions

**Quick check.** Ask for the closing sentence of Session 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 13: write the assessment, checked by a classmate for proportion in both directions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A review touching Session 3 and Session 13 equally. |
| **Non-example** | A review covering only the critique sessions. |
...
> "Do not convert a local gap into a global verdict, or minimise a load-bearing one."
...
> "A midterm review must sample the whole term rather than the recent sessions. You just saw that when ask what is still unclear about everything so far.
> Last time we said: Do not convert a local gap into a global verdict, or minimise a load-bearing one. This is the next part of that.
...
**The example.** A review touching Session 3 and Session 13 equally.
...
**Completed answer.** A review touching Session 3 and Session 13 equally. — which demonstrates where the cohort is weakest.
...
**Teacher prompt.** "Here is a second case. A cohort identifying the reverse ladder as its weakest area. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A review covering only the critique sessions. Why is this not an
example?"
...
**Exact student instructions.** Review covering order, the claim, the ladder, and the critique.
...
1. Any wording carrying the idea in `A midterm review must sample the whole term rather than the recent sessions`.
...
| | |
|---|---|
| **Follows** | Session 13 — Proportionate Assessment |
| **Leads to** | Session 15 — Capstone Measurement |

**Transition in.** Session 13 established students match the verdict to the critique's scope. This session uses that as the starting point.

**Transition out.** This session establishes students consolidate the first half. Session 15 assumes it and builds students build the measurement map for their capstone.
