# Session 18 — Capstone Scope Rejection
...
| | |
|---|---|
| **Central question** | Capstone Scope Rejection: students reject an invalid variant of their own capstone? |
| **Core concept** | Rejecting an invalid variant of one's own design, and naming why it was tempting, is what prevents building it later. |
| **Student outcome** | Students reject an invalid variant of their own capstone. |
| **Previous session** | Session 17 — Capstone Confounds |
| **Next session** | Session 19 — Assembling The Capstone |
...
**The conceptual step.** Rejecting an invalid variant of one's own design, and naming why it was tempting, is what prevents building it later. Rejecting somebody else's design is easier and less useful.
...
**What depends on it.** Session 19 — Assembling The Capstone — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Rejecting an invalid variant of one's own design, and naming why it was tempting, is what prevents building it later. Rejecting somebody else's design is easier and less useful.
...
1. A rejection of the student's own clinical variant.
2. A stated reason the invalid version appealed.

### One non-example

A rejection of a classmate's design instead.
...
That self-directed scope rejection is achievable.

### What this activity does not establish

Whether the valid design is sound.
...
| Statement | Status |
|---|---|
| Rejecting an invalid variant of one's own design, and naming why it was tempting, is what prevents building it later. | Framework-derived, appropriate at this grade |
| That self-directed scope rejection is achievable. | What this specific activity can show |
| Whether the valid design is sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 17 — Capstone Confounds — specifically: students complete the confound table for the capstone.

**How it was taught.** Through the activity: complete the table and have it adversarially audited

**Quick check.** Ask for the closing sentence of Session 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 17: complete the table and have it adversarially audited, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A rejection of the student's own clinical variant. |
| **Non-example** | A rejection of a classmate's design instead. |
...
> "Residual risk acknowledged beats residual risk dismissed."
...
**Exact wording.** "Ask what the version of their own design would be that is invalid."
...
**Target observation.** That self-directed scope rejection is achievable.
...
> "Rejecting an invalid variant of one's own design, and naming why it was tempting, is what prevents building it later. You just saw that when ask what the version of their own design would be that is invalid.
> Last time we said: Residual risk acknowledged beats residual risk dismissed. This is the next part of that.
...
**What students must not infer.** Whether the valid design is sound.

### 4. Worked example

**The example.** A rejection of the student's own clinical variant.
...
**Completed answer.** A rejection of the student's own clinical variant. — which demonstrates that self-directed scope rejection is achievable.
...
**Conclusions not licensed.** Whether the valid design is sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A stated reason the invalid version appealed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rejection of a classmate's design instead. Why is this not an
example?"
...
**Exact student instructions.** Write a formal rejection of an invalid variant, including why it was tempting.
...
- *Licensed conclusion.* That self-directed scope rejection is achievable.
- *Not licensed.* Whether the valid design is sound.
...
- *Expected response.* That self-directed scope rejection is achievable.
...
1. Any wording carrying the idea in `Rejecting an invalid variant of one's own design, and naming why it was tempting, is what prevents building it later`.
...
Say: "Students who cannot say why will build it again."
...
| | |
|---|---|
| **Follows** | Session 17 — Capstone Confounds |
| **Leads to** | Session 19 — Assembling The Capstone |

**Transition in.** Session 17 established students complete the confound table for the capstone. This session uses that as the starting point.

**Transition out.** This session establishes students reject an invalid variant of their own capstone. Session 19 assumes it and builds students produce the complete capstone package.
