# Session 1 Homework — The Order Rule

**College Year 4** · Independent Critique and Capstone · **Quarter 1**
**Follows:** Session 1 — The Order Rule · **Points:** 5 · **Optional:** yes
...
Reorder three Year 3 arguments so the condition precedes the case.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has three correctly ordered arguments
...
Session 2 is **Choosing The Capstone Claim**, which assumes you arrive holding it. Write one thing you expect it to be about:
