# Session 5 — The Inference Ladder
...
| | |
|---|---|
| **Central question** | The Inference Ladder: students state the highest rung their design licenses? |
| **Core concept** | Rung three is the ceiling for a single well-run study. |
| **Student outcome** | Students state the highest rung their design licenses. |
| **Previous session** | Session 4 — Designing The Capstone |
| **Next session** | Session 6 — The Reverse Ladder |
...
**The conceptual step.** Rung three is the ceiling for a single well-run study. Rung four requires converging designs, and naming the temptation in advance is the safeguard.
...
**What depends on it.** Session 6 — The Reverse Ladder — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Rung three is the ceiling for a single well-run study. Rung four requires converging designs, and naming the temptation in advance is the safeguard.
...
1. A ceiling correctly placed at rung three.
2. A named temptation to claim rung four in the discussion.

### One non-example

A ceiling placed at rung four from a single design.
...
That inference ceilings can be located and temptations named.
...
| Statement | Status |
|---|---|
| Rung three is the ceiling for a single well-run study. | Framework-derived, appropriate at this grade |
| That inference ceilings can be located and temptations named. | What this specific activity can show |
| Whether the result supports the ceiling. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 4 — Designing The Capstone — specifically: students build the design around the condition.

**How it was taught.** Through the activity: draft all seven sections and swap for an executability check

**Quick check.** Ask for the closing sentence of Session 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 4: draft all seven sections and swap for an executability check, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A ceiling correctly placed at rung three. |
| **Non-example** | A ceiling placed at rung four from a single design. |
...
**Exact wording.** "Put five rungs on the board against a hypothetical result."
...
**Target observation.** That inference ceilings can be located and temptations named.
...
> "Rung three is the ceiling for a single well-run study. You just saw that when put five rungs on the board against a hypothetical result.
> Last time we said: The gate is executability. This is the next part of that.
...
**The example.** A ceiling correctly placed at rung three.
...
**Completed answer.** A ceiling correctly placed at rung three. — which demonstrates that inference ceilings can be located and temptations named.
...
**Teacher prompt.** "Here is a second case. A named temptation to claim rung four in the discussion. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A ceiling placed at rung four from a single design. Why is this not an
example?"
...
**Exact student instructions.** Ladder their own anticipated result and name the rung they will be tempted to claim.
...
- *Licensed conclusion.* That inference ceilings can be located and temptations named.
...
- *Expected response.* That inference ceilings can be located and temptations named.
...
1. Any wording carrying the idea in `Rung three is the ceiling for a single well-run study`.
...
Say: "Nobody sets out to overclaim. It happens because you have lived with the hypothesis."
...
| | |
|---|---|
| **Follows** | Session 4 — Designing The Capstone |
| **Leads to** | Session 6 — The Reverse Ladder |

**Transition in.** Session 4 established students build the design around the condition. This session uses that as the starting point.

**Transition out.** This session establishes students state the highest rung their design licenses. Session 6 assumes it and builds students state what a null result licenses.
