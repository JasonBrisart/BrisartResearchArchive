# Lesson 21 — Guessing About Tomorrow
...
| | |
|---|---|
| **Central question** | Guessing About Tomorrow: children guess about an event further ahead? |
| **Core concept** | A guess must be checkable to be worth recording. |
| **Student outcome** | Children guess about an event further ahead. |
| **Previous lesson** | Lesson 20 — Checking A Guess |
| **Next lesson** | Lesson 22 — Guessing About Each Other |
...
**The conceptual step.** A guess must be checkable to be worth recording. Steering toward verifiable content is the first form of that rule.
...
**What depends on it.** Lesson 22 — Guessing About Each Other — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A guess must be checkable to be worth recording. Steering toward verifiable content is the first form of that rule.
...
1. A child guesses it will rain tomorrow.
2. A child guesses a particular classmate will be absent.

### One non-example

A child who guesses tomorrow will be nice — nothing to check.
...
That guesses should be checkable.
...
| Statement | Status |
|---|---|
| A guess must be checkable to be worth recording. | Framework-derived, appropriate at this grade |
| That guesses should be checkable. | What this specific activity can show |
| Precision of the prediction. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — Checking A Guess — specifically: children check a guess made in a previous session.

**How it was taught.** Through the activity: reveal each hidden object. Children mark their own drawing right or wrong

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: reveal each hidden object. Children mark their own drawing right or wrong, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child guesses it will rain tomorrow. |
| **Non-example** | A child who guesses tomorrow will be nice — nothing to check. |
...
> "Some were right and some were wrong. Both were real guesses."
...
**Exact wording.** "Ask what they think will happen tomorrow."
...
**Target observation.** That guesses should be checkable.
...
> "A guess must be checkable to be worth recording. You just saw that when ask what they think will happen tomorrow.
> Last time we said: Some were right and some were wrong. Both were real guesses. This is the next part of that.
...
**What students must not infer.** Precision of the prediction.

### 4. Worked example

**The example.** A child guesses it will rain tomorrow.
...
**Completed answer.** A child guesses it will rain tomorrow. — which demonstrates that guesses should be checkable.
...
**Conclusions not licensed.** Precision of the prediction.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child guesses a particular classmate will be absent. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who guesses tomorrow will be nice — nothing to check. Why is this not an
example?"
...
**Exact student instructions.** Each child draws one tomorrow guess, kept for checking next session.
...
- *Licensed conclusion.* That guesses should be checkable.
- *Not licensed.* Precision of the prediction.
...
- *Expected response.* That guesses should be checkable.
...
1. Any wording carrying the idea in `A guess must be checkable to be worth recording`.
...
Say: "We will check tomorrow. Do not change it."
...
| | |
|---|---|
| **Follows** | Lesson 20 — Checking A Guess |
| **Leads to** | Lesson 22 — Guessing About Each Other |

**Transition in.** Lesson 20 established children check a guess made in a previous session. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children guess about an event further ahead. Lesson 22 assumes it and builds children guess about a partner's choice and check it.
