...
| | |
|---|---|
| **Central question** | The Before Chart: children see the record of before-guesses across the quarter? |
| **Core concept** | The record shows the rule was followed across many cases. |
| **Student outcome** | Children see the record of before-guesses across the quarter. |
| **Previous lesson** | Lesson 22 — Guessing About Each Other |
| **Next lesson** | Lesson 24 — The Before Review |
...
**The conceptual step.** The record shows the rule was followed across many cases. Counting all of them, not only the correct ones, is the point.
...
**What depends on it.** Lesson 24 — The Before Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The record shows the rule was followed across many cases. Counting all of them, not only the correct ones, is the point.
...
1. Twenty before-guesses tallied, right and wrong together.
2. A child insists a wrong one still counts.

### One non-example

A tally that excludes the wrong guesses.
...
That the before-rule held across the quarter.
...
| Statement | Status |
|---|---|
| The record shows the rule was followed across many cases. | Framework-derived, appropriate at this grade |
| That the before-rule held across the quarter. | What this specific activity can show |
| Any success rate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — Guessing About Each Other — specifically: children guess about a partner's choice and check it.

**How it was taught.** Through the activity: four rounds of partner-choice guessing, each checked immediately

**Quick check.** Ask for the closing sentence of Lesson 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: four rounds of partner-choice guessing, each checked immediately, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Twenty before-guesses tallied, right and wrong together. |
| **Non-example** | A tally that excludes the wrong guesses. |
...
> "You guessed about a person. Sometimes right, sometimes not."
...
**Exact wording.** "Point at the BEFORE chart, now full."
...
**Target observation.** That the before-rule held across the quarter.
...
> "The record shows the rule was followed across many cases. You just saw that when point at the BEFORE chart, now full.
> Last time we said: You guessed about a person. Sometimes right, sometimes not. This is the next part of that.
...
**What students must not infer.** Any success rate.

### 4. Worked example

**The example.** Twenty before-guesses tallied, right and wrong together.
...
**Completed answer.** Twenty before-guesses tallied, right and wrong together. — which demonstrates that the before-rule held across the quarter.
...
**Conclusions not licensed.** Any success rate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child insists a wrong one still counts. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A tally that excludes the wrong guesses. Why is this not an
example?"
...
**Exact student instructions.** Tally how many before-guesses were made, and how many were checked.
...
- *Licensed conclusion.* That the before-rule held across the quarter.
- *Not licensed.* Any success rate.
...
- *Expected response.* That the before-rule held across the quarter.
...
1. Any wording carrying the idea in `The record shows the rule was followed across many cases`.
...
Say: "Every one of those was said before. That is what makes it a guess."
...
| | |
|---|---|
| **Follows** | Lesson 22 — Guessing About Each Other |
| **Leads to** | Lesson 24 — The Before Review |

**Transition in.** Lesson 22 established children guess about a partner's choice and check it. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children see the record of before-guesses across the quarter. Lesson 24 assumes it and builds children consolidate the before rule.
