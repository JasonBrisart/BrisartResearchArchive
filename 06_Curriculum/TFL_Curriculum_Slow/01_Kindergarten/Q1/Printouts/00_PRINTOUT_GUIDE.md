...
|---|---|---|---|---|---|---|
| `Lesson_01_Printout.md` | Lesson 1 — Noticing Right Now | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_02_Printout.md` | Lesson 2 — Three Senses | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 1 work |
| `Lesson_03_Printout.md` | Lesson 3 — Noticing Outside | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 2 work |
| `Lesson_04_Printout.md` | Lesson 4 — Noticing What Changed | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 3 work |
| `Lesson_05_Printout.md` | Lesson 5 — Noticing Together | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 4 work |
| `Lesson_06_Printout.md` | Lesson 6 — Noticing Small Things | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 5 work |
| `Lesson_07_Printout.md` | Lesson 7 — Noticing All Day | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 6 work |
| `Lesson_08_Printout.md` | Lesson 8 — The Noticing Review | 1–2 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 7 work |
...
**Lesson 5 — Noticing Together.** If you only have time to print one
