...
| | |
|---|---|
| **Central question** | Noticing Outside: children notice in a different environment? |
| **Core concept** | What is available to notice depends on where you are. |
| **Student outcome** | Children notice in a different environment. |
| **Previous lesson** | Lesson 2 — Three Senses |
| **Next lesson** | Lesson 4 — Noticing What Changed |
...
**The conceptual step.** What is available to notice depends on where you are. The input changes when the environment changes.
...
**What depends on it.** Lesson 4 — Noticing What Changed — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

What is available to notice depends on where you are. The input changes when the environment changes.
...
1. A child hears birds outside that were not audible inside.
2. A child feels wind that the classroom did not have.

### One non-example

A child who repeats the classroom fan answer outdoors.
...
That available input is environment-dependent.

### What this activity does not establish

Any claim about attention or selection.
...
| Statement | Status |
|---|---|
| What is available to notice depends on where you are. | Framework-derived, appropriate at this grade |
| That available input is environment-dependent. | What this specific activity can show |
| Any claim about attention or selection. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — Three Senses — specifically: children notice using three different senses deliberately.

**How it was taught.** Through the activity: the Noticing Hunt across the room, one item per sense, drawn

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: the Noticing Hunt across the room, one item per sense, drawn, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child hears birds outside that were not audible inside. |
| **Non-example** | A child who repeats the classroom fan answer outdoors. |
...
> "You have more than one way to notice."
...
**Exact wording.** "Take the group outside or to a different room."
...
**Target observation.** That available input is environment-dependent.
...
> "What is available to notice depends on where you are. You just saw that when take the group outside or to a different room.
> Last time we said: You have more than one way to notice. This is the next part of that.
...
**What students must not infer.** Any claim about attention or selection.

### 4. Worked example

**The example.** A child hears birds outside that were not audible inside.
...
**Completed answer.** A child hears birds outside that were not audible inside. — which demonstrates that available input is environment-dependent.
...
**Conclusions not licensed.** Any claim about attention or selection.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child feels wind that the classroom did not have. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who repeats the classroom fan answer outdoors. Why is this not an
example?"
...
**Exact student instructions.** Same hunt in the new place. Compare what is noticeable here versus there.
...
- *Licensed conclusion.* That available input is environment-dependent.
- *Not licensed.* Any claim about attention or selection.
...
- *Expected response.* That available input is environment-dependent.
...
1. Any wording carrying the idea in `What is available to notice depends on where you are`.
...
Say: "Different places give you different things to notice."
...
| | |
|---|---|
| **Follows** | Lesson 2 — Three Senses |
| **Leads to** | Lesson 4 — Noticing What Changed |

**Transition in.** Lesson 2 established children notice using three different senses deliberately. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children notice in a different environment. Lesson 4 assumes it and builds children detect a change in a familiar scene.
