# Lesson 5 Homework — Noticing Together

**Kindergarten** · Noticing and Remembering · **Quarter 1**
**Follows:** Lesson 5 — Noticing Together · **Points:** 5 · **Optional:** yes
...
Pairs share their hunt lists and mark one thing only one of them noticed.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every pair finds one difference
...
Lesson 6 is **Noticing Small Things**, which assumes you arrive holding it. Write one thing you expect it to be about:
