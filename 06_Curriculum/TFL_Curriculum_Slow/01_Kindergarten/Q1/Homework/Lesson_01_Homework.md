# Lesson 1 Homework — Noticing Right Now

**Kindergarten** · Noticing and Remembering · **Quarter 1**
**Follows:** Lesson 1 — Noticing Right Now · **Points:** 5 · **Optional:** yes
...
Round robin: each child names one thing noticed. Prompt the stuck by sense.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every child names one thing noticed
...
Lesson 2 is **Three Senses**, which assumes you arrive holding it. Write one thing you expect it to be about:
