...
| | |
|---|---|
| **Central question** | The Year Review: children review the whole year with their own work? |
| **Core concept** | The year's work sorts under the vocabulary the year introduced. |
| **Student outcome** | Children review the whole year with their own work. |
| **Previous lesson** | Lesson 30 — Teaching Somebody Else |
| **Next lesson** | Lesson 32 — Show What You Know |
...
**The conceptual step.** The year's work sorts under the vocabulary the year introduced. Sorting is a check that the categories are usable.
...
**What depends on it.** Lesson 32 — Show What You Know — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The year's work sorts under the vocabulary the year introduced. Sorting is a check that the categories are usable.
...
1. A child files their noticing hunt under NOTICE.
2. A child orders their work by term.

### One non-example

A child who cannot place any item.
...
Whether the year's categories are usable by the child.

### What this activity does not establish

Unaided recall of early sessions.
...
| Statement | Status |
|---|---|
| The year's work sorts under the vocabulary the year introduced. | Framework-derived, appropriate at this grade |
| Whether the year's categories are usable by the child. | What this specific activity can show |
| Unaided recall of early sessions. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 30 — Teaching Somebody Else — specifically: children explain the three parts to another person.

**How it was taught.** Through the activity: each child explains notice, remember, guess to a buddy or visiting adult

**Quick check.** Ask for the closing sentence of Lesson 30. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 30: each child explains notice, remember, guess to a buddy or visiting adult, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child files their noticing hunt under NOTICE. |
| **Non-example** | A child who cannot place any item. |
...
> "If you can say it to somebody else, you have it."
...
**Exact wording.** "Lay out the year's drawings and charts."
...
**Target observation.** Whether the year's categories are usable by the child.
...
> "The year's work sorts under the vocabulary the year introduced. You just saw that when lay out the year's drawings and charts.
> Last time we said: If you can say it to somebody else, you have it. This is the next part of that.
...
**What students must not infer.** Unaided recall of early sessions.

### 4. Worked example

**The example.** A child files their noticing hunt under NOTICE.
...
**Completed answer.** A child files their noticing hunt under NOTICE. — which demonstrates whether the year's categories are usable by the child.
...
**Conclusions not licensed.** Unaided recall of early sessions.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child orders their work by term. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who cannot place any item. Why is this not an
example?"
...
**Exact student instructions.** Children sort their own work under the four words and order it by term.
...
- *Licensed conclusion.* Whether the year's categories are usable by the child.
- *Not licensed.* Unaided recall of early sessions.
...
- *Expected response.* Whether the year's categories are usable by the child.
...
1. Any wording carrying the idea in `The year's work sorts under the vocabulary the year introduced`.
...
Say: "Next time you show me everything."
...
| | |
|---|---|
| **Follows** | Lesson 30 — Teaching Somebody Else |
| **Leads to** | Lesson 32 — Show What You Know |

**Transition in.** Lesson 30 established children explain the three parts to another person. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children review the whole year with their own work. Lesson 32 assumes it and builds children demonstrate the year's outcomes.
