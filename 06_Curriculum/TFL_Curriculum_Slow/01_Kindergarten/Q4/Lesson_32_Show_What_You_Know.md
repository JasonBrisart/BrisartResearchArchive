...
| **Core concept** | The four exit outcomes together constitute readiness for Grade 1, where the word expect is released. |
| **Student outcome** | Children demonstrate the year's outcomes. |
| **Previous lesson** | Lesson 31 — The Year Review |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 1, where the word expect is released.
...
The four exit outcomes together constitute readiness for Grade 1, where the word expect is released.
...
1. A child completes all four in one sitting.
2. A child needs one prompt but completes all four.

### One non-example

A child who performs two and stops.
...
Quality of any single demonstration.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 1, where the word expect is released. | Framework-derived, appropriate at this grade |
| Whether all four exit outcomes are present. | What this specific activity can show |
| Quality of any single demonstration. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 31 — The Year Review — specifically: children review the whole year with their own work.

**How it was taught.** Through the activity: children sort their own work under the four words and order it by term

**Quick check.** Ask for the closing sentence of Lesson 31. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 31: children sort their own work under the four words and order it by term, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child completes all four in one sitting. |
| **Non-example** | A child who performs two and stops. |
...
**Exact wording.** "Tell them to show you and you will watch."
...
> "The four exit outcomes together constitute readiness for Grade 1, where the word expect is released. You just saw that when tell them to show you and you will watch.
> Last time we said: Next time you show me everything. This is the next part of that.
...
**What students must not infer.** Quality of any single demonstration.

### 4. Worked example

**The example.** A child completes all four in one sitting.
...
**Completed answer.** A child completes all four in one sitting. — which demonstrates whether all four exit outcomes are present.
...
**Conclusions not licensed.** Quality of any single demonstration.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child needs one prompt but completes all four. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who performs two and stops. Why is this not an
example?"
...
**Exact student instructions.** Final task: name a notice and a remember, complete the frame, report a surprise, show the loop.
...
- *Not licensed.* Quality of any single demonstration.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 1, where the word expect is released`.
...
Say: "You are doing this right now. Next year you get the proper words."
...
| | |
|---|---|
| **Follows** | Lesson 31 — The Year Review |
| **Leads to** | The final examination. |

**Transition in.** Lesson 31 established children review the whole year with their own work. This lesson uses that as the starting point.
