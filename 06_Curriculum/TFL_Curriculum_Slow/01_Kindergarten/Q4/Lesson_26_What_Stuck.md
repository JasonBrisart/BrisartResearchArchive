...
| | |
|---|---|
| **Central question** | What Stuck: children separate what stayed from what faded? |
| **Core concept** | Sticking has a cause and correctness is not it. |
| **Student outcome** | Children separate what stayed from what faded. |
| **Previous lesson** | Lesson 25 — The Sound That Stops |
| **Next lesson** | Lesson 27 — Notice, Remember, Guess |
...
**The conceptual step.** Sticking has a cause and correctness is not it. At this grade the cause is named simply as mattering.
...
**What depends on it.** Lesson 27 — Notice, Remember, Guess — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Sticking has a cause and correctness is not it. At this grade the cause is named simply as mattering.
...
1. The song break stuck because it was funny.
2. A correct door guess went away immediately.

### One non-example

A child who says it stuck because they got it right.
...
That mattering, not correctness, tracks sticking.
...
| Statement | Status |
|---|---|
| Sticking has a cause and correctness is not it. | Framework-derived, appropriate at this grade |
| That mattering, not correctness, tracks sticking. | What this specific activity can show |
| The strength of that relationship. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 25 — The Sound That Stops — specifically: children report the guess an engineered break revealed.

**How it was taught.** Through the activity: three more breaks. Each child completes the surprise frame aloud

**Quick check.** Ask for the closing sentence of Lesson 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 25: three more breaks. Each child completes the surprise frame aloud, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The song break stuck because it was funny. |
| **Non-example** | A child who says it stuck because they got it right. |
...
**Exact wording.** "Ask cold what they still remember from last time."
...
**Target observation.** That mattering, not correctness, tracks sticking.
...
> "Sticking has a cause and correctness is not it. You just saw that when ask cold what they still remember from last time.
> Last time we said: Breaking it is how we catch it. This is the next part of that.
...
**What students must not infer.** The strength of that relationship.

### 4. Worked example

**The example.** The song break stuck because it was funny.
...
**Completed answer.** The song break stuck because it was funny. — which demonstrates that mattering, not correctness, tracks sticking.
...
**Conclusions not licensed.** The strength of that relationship.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A correct door guess went away immediately. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who says it stuck because they got it right. Why is this not an
example?"
...
**Exact student instructions.** Two-column drawing: STUCK and GONE, with a reason for the stuck one.
...
- *Licensed conclusion.* That mattering, not correctness, tracks sticking.
- *Not licensed.* The strength of that relationship.
...
- *Expected response.* That mattering, not correctness, tracks sticking.
...
1. Any wording carrying the idea in `Sticking has a cause and correctness is not it`.
...
Say: "It stuck because it mattered, not because you were right."
...
| | |
|---|---|
| **Follows** | Lesson 25 — The Sound That Stops |
| **Leads to** | Lesson 27 — Notice, Remember, Guess |

**Transition in.** Lesson 25 established children report the guess an engineered break revealed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children separate what stayed from what faded. Lesson 27 assumes it and builds children use all three parts on one real event.
