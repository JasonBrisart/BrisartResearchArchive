# Session 2 — Capturing Sim(t) At Research Standard

**Master's Year 1** · Executable Measurement · **Quarter 1** · **100 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Capturing Sim(t) At Research Standard: students build a contamination-resistant elicitation protocol with reliability? |
| **Core concept** | A research-standard elicitation protocol specifies the verbatim prompt, its timing, the scoring rule, who scores and what they know, and the reliability statistic to be reported. |
| **Student outcome** | Students build a contamination-resistant elicitation protocol with reliability. |
| **Previous session** | Session 1 — Most Uses Are Not Tests |
| **Next session** | Session 3 — Measuring E(t) Without Circularity |
| **Materials** | Lab books; printed map and protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_02_Printout.md` |
| **Homework** | `Homework/Session_02_Homework.md` |

## Why this lesson exists

**The conceptual step.** A research-standard elicitation protocol specifies the verbatim prompt, its timing, the scoring rule, who scores and what they know, and the reliability statistic to be reported.

**Why students need it now.** This grade owns one idea: executability as the standard, and honest estimation feasibility.
This session supplies one component of it. Without this component the student can
...
that self-report can carry a timing hypothesis. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Designs must be executable by a stranger without clarification. Every measurement choice carries an assumption that must be named.

**What depends on it.** Session 3 — Measuring E(t) Without Circularity — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A research-standard elicitation protocol specifies the verbatim prompt, its timing, the scoring rule, who scores and what they know, and the reliability statistic to be reported.

### How this is stated at this grade

Designs must be executable by a stranger without clarification. Every measurement choice carries an assumption that must be named.

Use only the vocabulary released at or before this grade. Terms not yet available:
Peer review to journal structure, referee reports, governance.

### Why the concept matters

The whole grade rests on executability as the standard, and honest estimation feasibility. If a student leaves this
session without the component taught here, the remaining sessions in the quarter
will feel arbitrary, because each one assumes it.

### Two concrete examples

1. A protocol naming two blind coders and the agreement measure.
2. A worked example of a response the coding rule cannot score.

### One non-example

A protocol stating that responses will be coded for content.
...
That protocols can be specified to executable research standard.

### What this activity does not establish

Whether the protocol captures simulation content.
...
| Statement | Status |
|---|---|
| A research-standard elicitation protocol specifies the verbatim prompt, its timing, the scoring rule, who scores and what they know, and the reliability statistic to be reported. | Framework-derived, appropriate at this grade |
| That protocols can be specified to executable research standard. | What this specific activity can show |
| Whether the protocol captures simulation content. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 1 — Most Uses Are Not Tests — specifically: students apply the testability constraint to their own intended study.

**How it was taught.** Through the activity: draft a measurement map, swap, and have a partner mark every unexecutable line

**Quick check.** Ask for the closing sentence of Session 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 1: draft a measurement map, swap, and have a partner mark every unexecutable line, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | runnable by a competent stranger with no clarification. |
| **Student wording** | Runnable by a competent stranger with no clarification. |
| **Correct example** | A protocol naming two blind coders and the agreement measure. |
| **Non-example** | A protocol stating that responses will be coded for content. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for runnable by a competent stranger with no clarification." |

### collinearity

| | |
|---|---|
| **Teacher definition** | predictors covarying so closely their effects cannot be separated. |
| **Student wording** | Predictors covarying so closely their effects cannot be separated. |
| **Correct example** | A protocol naming two blind coders and the agreement measure. |
| **Non-example** | A protocol stating that responses will be coded for content. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for predictors covarying so closely their effects cannot be separated." |

### resolution declaration

| | |
|---|---|
| **Teacher definition** | a statement matching claim scale to observation scale. |
| **Student wording** | A statement matching claim scale to observation scale. |
| **Correct example** | A protocol naming two blind coders and the agreement measure. |
| **Non-example** | A protocol stating that responses will be coded for content. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a statement matching claim scale to observation scale." |


Do not introduce terminology from later grades. Peer review to journal structure, referee reports, governance.

## Materials and preparation

**Teacher materials.** Lab books; Printed map and protocol templates; Institutional ethics documentation; Whiteboard.

**Student materials.** One copy of `Printouts/Session_02_Printout.md` per student.

**Prior student data required.** Work produced in Session 1, kept in the student's folder.
...
**File.** `Printouts/Session_02_Printout.md`

**Distribute.** Before the hook. Students complete the *What I think before the
session* section before any explanation is given.
...
> "I will keep your marked draft until Session 16."
...
**Decision rule.** If fewer than half the group can produce any version of it, spend five minutes on the recovery activity below before starting this session.

### 2. Hook

**Exact wording.** "Say: the variable the framework most depends on, and the hardest to obtain honestly."
...
**Target observation.** That protocols can be specified to executable research standard.
...
> "A research-standard elicitation protocol specifies the verbatim prompt, its timing, the scoring rule, who scores and what they know, and the reliability statistic to be reported. You just saw that when say: the variable the framework most depends on, and the hardest to obtain honestly.
> Last time we said: I will keep your marked draft until Session 16. This is the next part of that.
> It matters because could another person run this without asking you a single question?"
...
**Terminology to introduce here.** executable, collinearity, resolution declaration.

**What students must not infer.** Whether the protocol captures simulation content.

### 4. Worked example

**The example.** A protocol naming two blind coders and the agreement measure.
...
**Completed answer.** A protocol naming two blind coders and the agreement measure. — which demonstrates that protocols can be specified to executable research standard.
...
**Conclusions not licensed.** Whether the protocol captures simulation content.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A worked example of a response the coding rule cannot score. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A protocol stating that responses will be coded for content. Why is this not an
example?"
...
**Exact student instructions.** Write the full protocol with prompt, timing, scoring, scorer knowledge, and three worked examples.
...
- *Licensed conclusion.* That protocols can be specified to executable research standard.
- *Not licensed.* Whether the protocol captures simulation content.
...
- *Expected response.* That protocols can be specified to executable research standard.
...
**Decision rule.** Continue to the next session only if most students pass oral
...
3. **Misconception check.** Somebody says: "Self-report can carry a timing hypothesis" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `A research-standard elicitation protocol specifies the verbatim prompt, its timing, the scoring rule, who scores and what they know, and the reliability statistic to be reported`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Change the hypothesis or change the instrument.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "The unscoreable example forces you to confront unusable data."

**Why this sentence matters.** It is the opening question of Session 3, which assumes students arrive holding it.

**Open the next session with.** "What did we say at the end last time?"
...
### 1. "Self-report can carry a timing hypothesis"

**What the student says or does.** Self-report can carry a timing hypothesis — usually while otherwise engaging well.

**Why it is understandable.** Report is the available instrument, so it gets used for everything.
...
**Exact correction.** Report of content is not report of mechanism, and report is slow.

**Say this.** "Change the hypothesis or change the instrument."
...
### 2. "The weights can be estimated from any dataset"

**What the student says or does.** The weights can be estimated from any dataset — usually while otherwise engaging well.

**Why it is understandable.** The relation looks like a regression.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Memory and simulation are collinear by construction in most tasks.

**Say this.** "Collinear predictors make coefficients unidentifiable."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "Declaring resolution is modesty"

**What the student says or does.** Declaring resolution is modesty — usually while otherwise engaging well.

**Why it is understandable.** Limitations read as hedging.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Show a design observing at minute resolution concluding in window language.

**Say this.** "It is what makes your result interpretable."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 4. "This session proves the framework is right"
...
**Visual or physical support.** Provide the seven-line map with two lines worked, and pair every run.
...
Ask them to cost the design in hours and participants.
...
Specifically, do not introduce: Peer review to journal structure, referee reports, governance.
...
**File.** `Homework/Session_02_Homework.md`
...
**How to set it.** Optional. Set it if this is the pivot session of the quarter,
...
7. What must be retaught before the next session?
8. Is the next session still appropriate, or does it need a bridging activity?

## Sequence

| | |
|---|---|
| **Follows** | Session 1 — Most Uses Are Not Tests |
| **Leads to** | Session 3 — Measuring E(t) Without Circularity |

**Transition in.** Session 1 established students apply the testability constraint to their own intended study. This session uses that as the starting point.

**Transition out.** This session establishes students build a contamination-resistant elicitation protocol with reliability. Session 3 assumes it and builds students build an intensity instrument that cannot manufacture its result.
