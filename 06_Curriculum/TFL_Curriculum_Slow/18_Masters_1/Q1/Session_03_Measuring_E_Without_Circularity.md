# Session 3 — Measuring E(t) Without Circularity
...
| | |
|---|---|
| **Central question** | Measuring E(t) Without Circularity: students build an intensity instrument that cannot manufacture its result? |
| **Core concept** | Circularity enters measurement when intensity and the outcome share a judgement, a rater, or a time point. |
| **Student outcome** | Students build an intensity instrument that cannot manufacture its result. |
| **Previous session** | Session 2 — Capturing Sim(t) At Research Standard |
| **Next session** | Session 4 — Persistence Criterion And Sampling |
| **Materials** | Lab books; printed map and protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_03_Printout.md` |
| **Homework** | `Homework/Session_03_Homework.md` |

## Why this lesson exists

**The conceptual step.** Circularity enters measurement when intensity and the outcome share a judgement, a rater, or a time point. The audit requires naming an alternative explanation for any correlation the instrument would produce.
...
**What depends on it.** Session 4 — Persistence Criterion And Sampling — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Circularity enters measurement when intensity and the outcome share a judgement, a rater, or a time point. The audit requires naming an alternative explanation for any correlation the instrument would produce.
...
1. An instrument rating intensity before the outcome is available.
2. An alternative explanation citing shared method variance.

### One non-example

An instrument declared clean without the audit being run.
...
That circularity is a measurement property, not a reasoning error.

### What this activity does not establish

Whether the instrument is valid.
...
| Statement | Status |
|---|---|
| Circularity enters measurement when intensity and the outcome share a judgement, a rater, or a time point. | Framework-derived, appropriate at this grade |
| That circularity is a measurement property, not a reasoning error. | What this specific activity can show |
| Whether the instrument is valid. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 2 — Capturing Sim(t) At Research Standard — specifically: students build a contamination-resistant elicitation protocol with reliability.

**How it was taught.** Through the activity: write the full protocol with prompt, timing, scoring, scorer knowledge, and three worked examples

**Quick check.** Ask for the closing sentence of Session 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 2: write the full protocol with prompt, timing, scoring, scorer knowledge, and three worked examples, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An instrument rating intensity before the outcome is available. |
| **Non-example** | An instrument declared clean without the audit being run. |
...
**Student materials.** One copy of `Printouts/Session_03_Printout.md` per student.

**Prior student data required.** Work produced in Session 2, kept in the student's folder.
...
**File.** `Printouts/Session_03_Printout.md`
...
> "The unscoreable example forces you to confront unusable data."
...
**Exact wording.** "Say: you saw the circular version as undergraduates. Today you find how easy it is to build in."
...
**Target observation.** That circularity is a measurement property, not a reasoning error.
...
> "Circularity enters measurement when intensity and the outcome share a judgement, a rater, or a time point. You just saw that when say: you saw the circular version as undergraduates.
> Last time we said: The unscoreable example forces you to confront unusable data. This is the next part of that.
...
**What students must not infer.** Whether the instrument is valid.

### 4. Worked example

**The example.** An instrument rating intensity before the outcome is available.
...
**Completed answer.** An instrument rating intensity before the outcome is available. — which demonstrates that circularity is a measurement property, not a reasoning error.
...
**Conclusions not licensed.** Whether the instrument is valid.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An alternative explanation citing shared method variance. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An instrument declared clean without the audit being run. Why is this not an
example?"
...
**Exact student instructions.** Build the instrument and run the three-question self-audit.
...
- *Licensed conclusion.* That circularity is a measurement property, not a reasoning error.
- *Not licensed.* Whether the instrument is valid.
...
- *Expected response.* That circularity is a measurement property, not a reasoning error.
...
1. Any wording carrying the idea in `Circularity enters measurement when intensity and the outcome share a judgement, a rater, or a time point`.
...
Say: "A student who cannot produce one has built the circle in."

**Why this sentence matters.** It is the opening question of Session 4, which assumes students arrive holding it.
...
**File.** `Homework/Session_03_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 2 — Capturing Sim(t) At Research Standard |
| **Leads to** | Session 4 — Persistence Criterion And Sampling |

**Transition in.** Session 2 established students build a contamination-resistant elicitation protocol with reliability. This session uses that as the starting point.

**Transition out.** This session establishes students build an intensity instrument that cannot manufacture its result. Session 4 assumes it and builds students fix the criterion and interval before data exist.
