# Session 24 — The Year In Designs
...
| | |
|---|---|
| **Central question** | The Year In Designs: students review the year through their own drafts? |
| **Core concept** | Comparing the first marked draft with the submitted portfolio gives direct evidence of the year's progress in operationalisation. |
| **Student outcome** | Students review the year through their own drafts. |
| **Previous session** | Session 23 — Portfolio Submission |
...
**The conceptual step.** Comparing the first marked draft with the submitted portfolio gives direct evidence of the year's progress in operationalisation.
...
Comparing the first marked draft with the submitted portfolio gives direct evidence of the year's progress in operationalisation.
...
1. A Session 1 draft beside the final portfolio.
2. A student noticing their first draft described rather than specified.

### One non-example

Reviewing only the submitted version.
...
That operationalisation improved measurably.
...
| Statement | Status |
|---|---|
| Comparing the first marked draft with the submitted portfolio gives direct evidence of the year's progress in operationalisation. | Framework-derived, appropriate at this grade |
| That operationalisation improved measurably. | What this specific activity can show |
| Any external quality standard. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 23 — Portfolio Submission — specifically: students submit and present the portfolio.

**How it was taught.** Through the activity: presentation and submission, with the gate checked by external execution first

**Quick check.** Ask for the closing sentence of Session 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 23: presentation and submission, with the gate checked by external execution first, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Session 1 draft beside the final portfolio. |
| **Non-example** | Reviewing only the submitted version. |
...
> "Next year you review each other to journal standard."
...
**Exact wording.** "Lay out every draft from Session 1 onward, in order."
...
**Target observation.** That operationalisation improved measurably.
...
> "Comparing the first marked draft with the submitted portfolio gives direct evidence of the year's progress in operationalisation. You just saw that when lay out every draft from Session 1 onward, in order.
> Last time we said: Next year you review each other to journal standard. This is the next part of that.
...
**The example.** A Session 1 draft beside the final portfolio.
...
**Completed answer.** A Session 1 draft beside the final portfolio. — which demonstrates that operationalisation improved measurably.
...
**Teacher prompt.** "Now one that does not work. Reviewing only the submitted version. Why is this not an
example?"
...
**Exact student instructions.** Compare the Session 1 draft with the submitted portfolio and write what changed.
...
- *Licensed conclusion.* That operationalisation improved measurably.
...
- *Expected response.* That operationalisation improved measurably.
...
1. Any wording carrying the idea in `Comparing the first marked draft with the submitted portfolio gives direct evidence of the year's progress in operationalisation`.
...
Say: "Next year: judging somebody else's, which is a different skill."
...
| | |
|---|---|
| **Follows** | Session 23 — Portfolio Submission |
| **Leads to** | The final examination. |

**Transition in.** Session 23 established students submit and present the portfolio. This session uses that as the starting point.
