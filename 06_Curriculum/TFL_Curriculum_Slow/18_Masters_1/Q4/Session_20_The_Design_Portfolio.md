# Session 20 — The Design Portfolio
...
| | |
|---|---|
| **Central question** | The Design Portfolio: students assemble the complete design package? |
| **Core concept** | A complete design portfolio has nine components. |
| **Student outcome** | Students assemble the complete design package. |
| **Previous session** | Session 19 — What This Design Cannot See |
| **Next session** | Session 21 — Rehearsing The Defence |
...
**The conceptual step.** A complete design portfolio has nine components. The estimation feasibility statement is the most frequently omitted because declaring infeasibility feels like a weakness.
...
**What depends on it.** Session 21 — Rehearsing The Defence — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A complete design portfolio has nine components. The estimation feasibility statement is the most frequently omitted because declaring infeasibility feels like a weakness.
...
1. A portfolio with all nine components present.
2. A feasibility statement declaring estimation infeasible.

### One non-example

A portfolio with eight components and no feasibility statement.
...
That design portfolios have stateable completeness.

### What this activity does not establish

Whether the design would work.
...
| Statement | Status |
|---|---|
| A complete design portfolio has nine components. | Framework-derived, appropriate at this grade |
| That design portfolios have stateable completeness. | What this specific activity can show |
| Whether the design would work. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 19 — What This Design Cannot See — specifically: students state specific blind spots.

**How it was taught.** Through the activity: list three blind spots and one conclusion not licensed

**Quick check.** Ask for the closing sentence of Session 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 19: list three blind spots and one conclusion not licensed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A portfolio with all nine components present. |
| **Non-example** | A portfolio with eight components and no feasibility statement. |
...
> "Naming what you cannot see makes the rest interpretable."
...
**Exact wording.** "Say: map, protocols, criterion, declaration, feasibility, design, confounds, plan, rejection."
...
**Target observation.** That design portfolios have stateable completeness.
...
> "A complete design portfolio has nine components. You just saw that when say: map, protocols, criterion, declaration, feasibility, design, confounds, plan, rejection.
> Last time we said: Naming what you cannot see makes the rest interpretable. This is the next part of that.
...
**What students must not infer.** Whether the design would work.

### 4. Worked example

**The example.** A portfolio with all nine components present.
...
**Completed answer.** A portfolio with all nine components present. — which demonstrates that design portfolios have stateable completeness.
...
**Conclusions not licensed.** Whether the design would work.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A feasibility statement declaring estimation infeasible. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A portfolio with eight components and no feasibility statement. Why is this not an
example?"
...
**Exact student instructions.** Assemble all nine components and self-audit against the gate.
...
- *Licensed conclusion.* That design portfolios have stateable completeness.
- *Not licensed.* Whether the design would work.
...
- *Expected response.* That design portfolios have stateable completeness.
...
1. Any wording carrying the idea in `A complete design portfolio has nine components`.
...
Say: "The gate is executability. Everything else is points."
...
| | |
|---|---|
| **Follows** | Session 19 — What This Design Cannot See |
| **Leads to** | Session 21 — Rehearsing The Defence |

**Transition in.** Session 19 established students state specific blind spots. This session uses that as the starting point.

**Transition out.** This session establishes students assemble the complete design package. Session 21 assumes it and builds students rehearse against measurement, inference, and scope challengers.
