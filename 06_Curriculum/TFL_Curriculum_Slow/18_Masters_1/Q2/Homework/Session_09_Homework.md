# Session 9 Homework — Confounds And Controls

**Master's Year 1** · Executable Measurement · **Quarter 2**
**Follows:** Session 9 — Confounds And Controls · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 9 ended on, from memory:
...
Structured peer attack in three rounds, then the seven-row confound table.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** residual risk is acknowledged rather than dismissed
...
Session 10 is **The Analysis Plan**, which assumes you arrive holding it. Write one thing you expect it to be about:
