...
| **Previous session** | Session 11 — Scope Enforcement In Design |
| **Next session** | Session 13 — The Operationalisation Examination |
...
**The conceptual step.** A midterm review must sample the whole term. Reviewing recent sessions alone produces a false sense of readiness.
...
**What depends on it.** Session 13 — The Operationalisation Examination — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A midterm review must sample the whole term. Reviewing recent sessions alone produces a false sense of readiness.
...
1. A review touching Session 2 and Session 11 equally.
2. A cohort identifying estimation feasibility as its weakest area.

### One non-example

A review covering only the analysis plan sessions.
...
What the examination will contain.
...
| What the examination will contain. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 11 — Scope Enforcement In Design — specifically: students reject an invalid variant of their own study.

**How it was taught.** Through the activity: write a formal rejection of an invalid variant of their own design

**Quick check.** Ask for the closing sentence of Session 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 11: write a formal rejection of an invalid variant of their own design, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A review touching Session 2 and Session 11 equally. |
| **Non-example** | A review covering only the analysis plan sessions. |
...
**What students must not infer.** What the examination will contain.

### 4. Worked example

**The example.** A review touching Session 2 and Session 11 equally.
...
**Completed answer.** A review touching Session 2 and Session 11 equally. — which demonstrates where the cohort is weakest.
...
**Conclusions not licensed.** What the examination will contain.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A cohort identifying estimation feasibility as its weakest area. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A review covering only the analysis plan sessions. Why is this not an
example?"
...
**Exact student instructions.** Review covering the constraint, the instruments, the plan, and scope.
...
- *Not licensed.* What the examination will contain.
...
Say: "The examination covers everything up to here."
...
| | |
|---|---|
| **Follows** | Session 11 — Scope Enforcement In Design |
| **Leads to** | Session 13 — The Operationalisation Examination |

**Transition in.** Session 11 established students reject an invalid variant of their own study. This session uses that as the starting point.

**Transition out.** This session establishes students consolidate the first half. Session 13 assumes it and builds students demonstrate measurement command under examination conditions.
