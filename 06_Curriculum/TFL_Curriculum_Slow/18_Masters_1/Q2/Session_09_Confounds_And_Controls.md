# Session 9 — Confounds And Controls
...
| | |
|---|---|
| **Central question** | Confounds And Controls: students identify and control what would invalidate their result? |
| **Core concept** | Seven standard confounds apply to persistence work. |
| **Student outcome** | Students identify and control what would invalidate their result. |
| **Previous session** | Session 8 — Designing To Adjudicate |
| **Next session** | Session 10 — The Analysis Plan |
...
**The conceptual step.** Seven standard confounds apply to persistence work. Acknowledging residual risk after a control is applied is better work than dismissing the confound.
...
**What depends on it.** Session 10 — The Analysis Plan — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Seven standard confounds apply to persistence work. Acknowledging residual risk after a control is applied is better work than dismissing the confound.
...
1. A confound controlled with the residual risk stated.
2. Selection of logged predictions identified as uncontrolled.

### One non-example

Five confounds marked not applicable without written reasons.
...
That confounds require reasoned treatment with residual risk.

### What this activity does not establish

Whether the controls suffice.
...
| Statement | Status |
|---|---|
| Seven standard confounds apply to persistence work. | Framework-derived, appropriate at this grade |
| That confounds require reasoned treatment with residual risk. | What this specific activity can show |
| Whether the controls suffice. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 8 — Designing To Adjudicate — specifically: students build a design entering the discriminating condition.

**How it was taught.** Through the activity: draft the design with predictions for every account, marked for cell entry

**Quick check.** Ask for the closing sentence of Session 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 8: draft the design with predictions for every account, marked for cell entry, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A confound controlled with the residual risk stated. |
| **Non-example** | Five confounds marked not applicable without written reasons. |
...
**Exact wording.** "Say: your design is the defendant. Most will not survive intact."
...
**Target observation.** That confounds require reasoned treatment with residual risk.
...
> "Seven standard confounds apply to persistence work. You just saw that when say: your design is the defendant.
...
**What students must not infer.** Whether the controls suffice.

### 4. Worked example

**The example.** A confound controlled with the residual risk stated.
...
**Completed answer.** A confound controlled with the residual risk stated. — which demonstrates that confounds require reasoned treatment with residual risk.
...
**Conclusions not licensed.** Whether the controls suffice.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Selection of logged predictions identified as uncontrolled. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Five confounds marked not applicable without written reasons. Why is this not an
example?"
...
**Exact student instructions.** Structured peer attack in three rounds, then the seven-row confound table.
...
- *Licensed conclusion.* That confounds require reasoned treatment with residual risk.
- *Not licensed.* Whether the controls suffice.
...
- *Expected response.* That confounds require reasoned treatment with residual risk.
...
1. Any wording carrying the idea in `Seven standard confounds apply to persistence work`.
...
Say: "The seventh one ruined your undergraduate logs and nobody noticed."
...
| | |
|---|---|
| **Follows** | Session 8 — Designing To Adjudicate |
| **Leads to** | Session 10 — The Analysis Plan |

**Transition in.** Session 8 established students build a design entering the discriminating condition. This session uses that as the starting point.

**Transition out.** This session establishes students identify and control what would invalidate their result. Session 10 assumes it and builds students fix every consequential decision before data exist.
