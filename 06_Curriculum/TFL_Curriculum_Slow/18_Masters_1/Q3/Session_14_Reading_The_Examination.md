# Session 14 — Reading The Examination
...
| | |
|---|---|
| **Central question** | Reading The Examination: students diagnose their own examination performance? |
| **Core concept** | The examination is a diagnostic instrument. |
| **Student outcome** | Students diagnose their own examination performance. |
| **Previous session** | Session 13 — The Operationalisation Examination |
| **Next session** | Session 15 — Repairing The Design |
...
**The conceptual step.** The examination is a diagnostic instrument. Converting weaknesses into specific design revisions is the useful output; the mark is not.
...
**What depends on it.** Session 15 — Repairing The Design — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The examination is a diagnostic instrument. Converting weaknesses into specific design revisions is the useful output; the mark is not.
...
1. A weakness in sampling converted into a design revision.
2. Two revisions traced to specific examination sections.

### One non-example

A student focused on the mark rather than the diagnosis.
...
That assessments can be read diagnostically.
...
| Statement | Status |
|---|---|
| The examination is a diagnostic instrument. | Framework-derived, appropriate at this grade |
| That assessments can be read diagnostically. | What this specific activity can show |
| What the mark means. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 13 — The Operationalisation Examination — specifically: students demonstrate measurement command under examination conditions.

**How it was taught.** Through the activity: the examination: the constraint, failure modes, instruments, sampling, estimation

**Quick check.** Ask for the closing sentence of Session 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 13: the examination: the constraint, failure modes, instruments, sampling, estimation, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A weakness in sampling converted into a design revision. |
| **Non-example** | A student focused on the mark rather than the diagnosis. |
...
> "That is the measurement half of the year assessed."
...
**Exact wording.** "Say: your paper says something about your design. Read it that way."
...
**Target observation.** That assessments can be read diagnostically.
...
> "The examination is a diagnostic instrument. You just saw that when say: your paper says something about your design.
> Last time we said: That is the measurement half of the year assessed. This is the next part of that.
...
**What students must not infer.** What the mark means.

### 4. Worked example

**The example.** A weakness in sampling converted into a design revision.
...
**Completed answer.** A weakness in sampling converted into a design revision. — which demonstrates that assessments can be read diagnostically.
...
**Conclusions not licensed.** What the mark means.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Two revisions traced to specific examination sections. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student focused on the mark rather than the diagnosis. Why is this not an
example?"
...
**Exact student instructions.** Convert examination weaknesses into two specific design revisions.
...
- *Licensed conclusion.* That assessments can be read diagnostically.
- *Not licensed.* What the mark means.
...
- *Expected response.* That assessments can be read diagnostically.
...
1. Any wording carrying the idea in `The examination is a diagnostic instrument`.
...
Say: "The examination was a diagnostic, not a verdict."
...
| | |
|---|---|
| **Follows** | Session 13 — The Operationalisation Examination |
| **Leads to** | Session 15 — Repairing The Design |

**Transition in.** Session 13 established students demonstrate measurement command under examination conditions. This session uses that as the starting point.

**Transition out.** This session establishes students diagnose their own examination performance. Session 15 assumes it and builds students revise the design against every source of feedback.
