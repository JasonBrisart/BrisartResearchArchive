# Session 13 — The Operationalisation Examination
...
| | |
|---|---|
| **Central question** | The Operationalisation Examination: students demonstrate measurement command under examination conditions? |
| **Core concept** | The operationalisation examination assesses measurement command under time pressure. |
| **Student outcome** | Students demonstrate measurement command under examination conditions. |
| **Previous session** | Session 12 — The Midterm Review |
| **Next session** | Session 14 — Reading The Examination |
...
**The conceptual step.** The operationalisation examination assesses measurement command under time pressure. Attempting every section matters more than completing any one perfectly.
...
**What depends on it.** Session 14 — Reading The Examination — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The operationalisation examination assesses measurement command under time pressure. Attempting every section matters more than completing any one perfectly.
...
1. A paper with every section attempted.
2. A student allocating time according to the stated weights.

### One non-example

A paper with four sections complete and estimation unattempted.
...
Whether measurement command is demonstrated.

### What this activity does not establish

Whether the protocols are valid.
...
| Statement | Status |
|---|---|
| The operationalisation examination assesses measurement command under time pressure. | Framework-derived, appropriate at this grade |
| Whether measurement command is demonstrated. | What this specific activity can show |
| Whether the protocols are valid. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 12 — The Midterm Review — specifically: students consolidate the first half.

**How it was taught.** Through the activity: review covering the constraint, the instruments, the plan, and scope

**Quick check.** Ask for the closing sentence of Session 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 12: review covering the constraint, the instruments, the plan, and scope, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A paper with every section attempted. |
| **Non-example** | A paper with four sections complete and estimation unattempted. |
...
> "The examination covers everything up to here."
...
**Exact wording.** "Say: ninety minutes. Everything about measuring this properly."
...
**Target observation.** Whether measurement command is demonstrated.
...
> "The operationalisation examination assesses measurement command under time pressure. You just saw that when say: ninety minutes.
> Last time we said: The examination covers everything up to here. This is the next part of that.
...
**What students must not infer.** Whether the protocols are valid.

### 4. Worked example

**The example.** A paper with every section attempted.
...
**Completed answer.** A paper with every section attempted. — which demonstrates whether measurement command is demonstrated.
...
**Conclusions not licensed.** Whether the protocols are valid.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student allocating time according to the stated weights. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A paper with four sections complete and estimation unattempted. Why is this not an
example?"
...
**Exact student instructions.** The examination: the constraint, failure modes, instruments, sampling, estimation.
...
- *Licensed conclusion.* Whether measurement command is demonstrated.
- *Not licensed.* Whether the protocols are valid.
...
- *Expected response.* Whether measurement command is demonstrated.
...
1. Any wording carrying the idea in `The operationalisation examination assesses measurement command under time pressure`.
...
Say: "That is the measurement half of the year assessed."
...
| **Leads to** | Session 14 — Reading The Examination |

**Transition in.** Session 12 established students consolidate the first half. This session uses that as the starting point.

**Transition out.** This session establishes students demonstrate measurement command under examination conditions. Session 14 assumes it and builds students diagnose their own examination performance.
