# Session 18 — Human Subjects And Institutional Duty

**Master's Year 1** · Executable Measurement · **Quarter 3** · **100 minutes**
...
| **Core concept** | Any design involving human participants is subject to institutional approval. |
| **Student outcome** | Students state the obligations attached to running studies on people. |
| **Previous session** | Session 17 — Repairing For Executability |
| **Next session** | Session 19 — What This Design Cannot See |
...
**The conceptual step.** Any design involving human participants is subject to institutional approval. Unapproved work is neither publishable nor defensible, which makes the labelling consequential rather than administrative.
...
**What depends on it.** Session 19 — What This Design Cannot See — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Any design involving human participants is subject to institutional approval. Unapproved work is neither publishable nor defensible, which makes the labelling consequential rather than administrative.
...
1. A design correctly labelled hypothetical pending approval.
2. A completed compliance checklist naming the approval route.

### One non-example

A design treated as ready to run without approval.
...
That institutional duty is a precondition, not paperwork.
...
| Statement | Status |
|---|---|
| Any design involving human participants is subject to institutional approval. | Framework-derived, appropriate at this grade |
| That institutional duty is a precondition, not paperwork. | What this specific activity can show |
| Whether approval would be granted. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 17 — Repairing For Executability — specifically: students revise against the executability list.

**How it was taught.** Through the activity: repair and run a second executability test with a different reader

**Quick check.** Ask for the closing sentence of Session 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 17: repair and run a second executability test with a different reader, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A design correctly labelled hypothetical pending approval. |
| **Non-example** | A design treated as ready to run without approval. |
...
> "If the second matches the first, the repair missed."
...
**Exact wording.** "Say: from the moment your design involves people, institutional requirements apply in full."
...
**Target observation.** That institutional duty is a precondition, not paperwork.
...
> "Any design involving human participants is subject to institutional approval. You just saw that when say: from the moment your design involves people, institutional requirements apply in full.
> Last time we said: If the second matches the first, the repair missed. This is the next part of that.
...
**The example.** A design correctly labelled hypothetical pending approval.
...
**Completed answer.** A design correctly labelled hypothetical pending approval. — which demonstrates that institutional duty is a precondition, not paperwork.
...
**Teacher prompt.** "Here is a second case. A completed compliance checklist naming the approval route. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A design treated as ready to run without approval. Why is this not an
example?"
...
**Exact student instructions.** Complete the compliance checklist and state whether the design is hypothetical.
...
- *Licensed conclusion.* That institutional duty is a precondition, not paperwork.
...
- *Expected response.* That institutional duty is a precondition, not paperwork.
...
1. Any wording carrying the idea in `Any design involving human participants is subject to institutional approval`.
...
Say: "This is the difference between a design and a study."
...
| | |
|---|---|
| **Follows** | Session 17 — Repairing For Executability |
| **Leads to** | Session 19 — What This Design Cannot See |

**Transition in.** Session 17 established students revise against the executability list. This session uses that as the starting point.

**Transition out.** This session establishes students state the obligations attached to running studies on people. Session 19 assumes it and builds students state specific blind spots.
