...
**Postdoctoral** · Programme Design

Every meeting in this quarter has one matching student printout. Distribute
it **before the hook** so students can record their initial thinking before any
explanation is given.

## What is here

| Printout | Matching meeting | Pages | Distribute | Student action | After | Prior data |
|---|---|---|---|---|---|---|
| `Meeting_04_Printout.md` | Meeting 4 — Scope Creep Under Success | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Meeting_05_Printout.md` | Meeting 5 — Specification Drift | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | Meeting 4 work |
| `Meeting_06_Printout.md` | Meeting 6 — Reputational Entanglement | 4–8 | Before the hook | Predicts, notes, works, concludes | Collected | Meeting 5 work |

## When to distribute

Always before the hook. The *What I think before the meeting* section is only
...
| What I think before the meeting | Before any explanation |
...
## The pivot meeting of this quarter

**Meeting 5 — Specification Drift.** If you only have time to print one
