...
| | |
|---|---|
| **Central question** | Memo Defence: participants deliver and defend the recommendation? |
| **Core concept** | The memo defence requires stop conditions naming observations and answers to all three challengers. |
| **Student outcome** | Participants deliver and defend the recommendation. |
| **Previous meeting** | Meeting 11 — Rehearsing The Defence |
| **Next meeting** | The final examination. |
| **Materials** | The participant's dissertation and proposal; programme memo templates |
| **Preparation** | an hour |
| **Student printout** | `Printouts/Meeting_12_Printout.md` |
| **Homework** | `Homework/Meeting_12_Homework.md` |

## Why this lesson exists

**The conceptual step.** The memo defence requires stop conditions naming observations and answers to all three challengers. Either recommendation direction is acceptable.
...
The memo defence requires stop conditions naming observations and answers to all three challengers. Either recommendation direction is acceptable.
...
1. A defence with stop conditions naming observations.
2. A defence answering the early-career challenge with a mechanism.

### One non-example

A recommendation to proceed with no stop conditions stated.
...
Whether the recommendation can be defended.
...
| Statement | Status |
|---|---|
| The memo defence requires stop conditions naming observations and answers to all three challengers. | Framework-derived, appropriate at this grade |
| Whether the recommendation can be defended. | What this specific activity can show |
| Whether the programme is warranted. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Meeting 11 — Rehearsing The Defence — specifically: participants rehearse against three challengers.

**How it was taught.** Through the activity: full rehearsal with unanswered questions recorded

**Quick check.** Ask for the closing sentence of Meeting 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Meeting 11: full rehearsal with unanswered questions recorded, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence with stop conditions naming observations. |
| **Non-example** | A recommendation to proceed with no stop conditions stated. |
...
**Student materials.** One copy of `Printouts/Meeting_12_Printout.md` per student.

**Prior student data required.** Work produced in Meeting 11, kept in the student's folder.
...
**File.** `Printouts/Meeting_12_Printout.md`
...
> "The early-career challenge is the hardest and the most important."
...
**Exact wording.** "Assign two positions on whether committing a lab is premature."
...
**Target observation.** Whether the recommendation can be defended.
...
> "The memo defence requires stop conditions naming observations and answers to all three challengers. You just saw that when assign two positions on whether committing a lab is premature.
> Last time we said: The early-career challenge is the hardest and the most important. This is the next part of that.
...
**The example.** A defence with stop conditions naming observations.
...
**Completed answer.** A defence with stop conditions naming observations. — which demonstrates whether the recommendation can be defended.
...
**Teacher prompt.** "Here is a second case. A defence answering the early-career challenge with a mechanism. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A recommendation to proceed with no stop conditions stated. Why is this not an
example?"
...
**Exact student instructions.** Present the memo and defend against all three challengers.
...
- *Licensed conclusion.* Whether the recommendation can be defended.
...
- *Expected response.* Whether the recommendation can be defended.
...
1. Any wording carrying the idea in `The memo defence requires stop conditions naming observations and answers to all three challengers`.
...
Say: "Next level: you become responsible for other people doing this."
...
**File.** `Homework/Meeting_12_Homework.md`
...
| | |
|---|---|
| **Follows** | Meeting 11 — Rehearsing The Defence |
| **Leads to** | The final examination. |

**Transition in.** Meeting 11 established participants rehearse against three challengers. This meeting uses that as the starting point.
