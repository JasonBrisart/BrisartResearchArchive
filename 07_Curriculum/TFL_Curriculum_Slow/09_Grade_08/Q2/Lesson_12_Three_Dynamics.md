# Lesson 12 — Three Dynamics

**Grade 8** · Contradiction and Limits · **Quarter 2** · **45 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Three Dynamics: students classify system behaviour into the three dynamics? |
| **Core concept** | Rapid resolution, sustained recurrence, and escalation are three behaviours of one system under different conditions. |
| **Student outcome** | Students classify system behaviour into the three dynamics. |
| **Previous lesson** | Lesson 11 — Belief Versus Expectation |
| **Next lesson** | Lesson 13 — Dynamics In Data |
| **Materials** | Notebooks; index cards in contrasting shapes |
...
**The conceptual step.** Rapid resolution, sustained recurrence, and escalation are three behaviours of one system under different conditions. Each has a stated driving condition, and none describes a person.

**Why students need it now.** This grade owns one idea: recurrence, Belief(t), sampling limits, and the assumption audit.
...
that contradiction deletes the simulation. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** An assumption audit is required on every major task. A student states what their claim depends on, not only what it asserts.

**What depends on it.** Lesson 13 — Dynamics In Data — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Rapid resolution, sustained recurrence, and escalation are three behaviours of one system under different conditions. Each has a stated driving condition, and none describes a person.

### How this is stated at this grade

An assumption audit is required on every major task. A student states what their claim depends on, not only what it asserts.

Use only the vocabulary released at or before this grade. Terms not yet available:
The integration function, w1/w2/w3, the three rival accounts by name.

### Why the concept matters

The whole grade rests on recurrence, Belief(t), sampling limits, and the assumption audit. If a student leaves this
...
1. Rapid resolution driven by low intensity and matching input.
2. Sustained recurrence driven by intensity above threshold with no resolving input.

### One non-example

Escalation described as a property of a particular student.
...
That one system produces three behaviours under different conditions.

### What this activity does not establish

Whether the conditions are the only causes.
...
| Statement | Status |
|---|---|
| Rapid resolution, sustained recurrence, and escalation are three behaviours of one system under different conditions. | Framework-derived, appropriate at this grade |
| That one system produces three behaviours under different conditions. | What this specific activity can show |
| Whether the conditions are the only causes. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 11 — Belief Versus Expectation — specifically: students distinguish a belief from a momentary expectation.

**How it was taught.** Through the activity: sort twelve statements into beliefs and expectations with the deciding criterion named

**Quick check.** Ask for the closing sentence of Lesson 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 11: sort twelve statements into beliefs and expectations with the deciding criterion named, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | a simulation being modified after contradiction. |
| **Student wording** | A simulation being modified after contradiction. |
| **Correct example** | Rapid resolution driven by low intensity and matching input. |
| **Non-example** | Escalation described as a property of a particular student. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a simulation being modified after contradiction." |

### suppression

| | |
|---|---|
| **Teacher definition** | a simulation being pushed aside rather than deleted. |
| **Student wording** | A simulation being pushed aside rather than deleted. |
| **Correct example** | Rapid resolution driven by low intensity and matching input. |
| **Non-example** | Escalation described as a property of a particular student. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a simulation being pushed aside rather than deleted." |

### recurrence

| | |
|---|---|
| **Teacher definition** | previously identified content reappearing after absence. |
| **Student wording** | Previously identified content reappearing after absence. |
| **Correct example** | Rapid resolution driven by low intensity and matching input. |
| **Non-example** | Escalation described as a property of a particular student. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for previously identified content reappearing after absence." |


Do not introduce terminology from later grades. The integration function, w1/w2/w3, the three rival accounts by name.

## Materials and preparation

**Teacher materials.** Notebooks; Index cards in contrasting shapes; Printed sampling logs; An ambiguous image or sound; A timer.
...
> "One lasts across cycles. One is inside a cycle."
...
**Exact wording.** "Say: you have found three shapes this year. Today they get names and causes."
...
**Target observation.** That one system produces three behaviours under different conditions.
...
> "Rapid resolution, sustained recurrence, and escalation are three behaviours of one system under different conditions. You just saw that when say: you have found three shapes this year.
> Last time we said: One lasts across cycles. One is inside a cycle. This is the next part of that.
> It matters because a model that explains everything predicts nothing"
...
**Terminology to introduce here.** revision, suppression, recurrence.

**What students must not infer.** Whether the conditions are the only causes.

### 4. Worked example

**The example.** Rapid resolution driven by low intensity and matching input.
...
**Completed answer.** Rapid resolution driven by low intensity and matching input. — which demonstrates that one system produces three behaviours under different conditions.
...
**Conclusions not licensed.** Whether the conditions are the only causes.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Sustained recurrence driven by intensity above threshold with no resolving input. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Escalation described as a property of a particular student. Why is this not an
example?"
...
**Exact student instructions.** Classify eight scenarios and state the driving condition for each.
...
- *Licensed conclusion.* That one system produces three behaviours under different conditions.
- *Not licensed.* Whether the conditions are the only causes.
...
- *Expected response.* That one system produces three behaviours under different conditions.
...
3. **Misconception check.** Somebody says: "Contradiction deletes the simulation" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `Rapid resolution, sustained recurrence, and escalation are three behaviours of one system under different conditions`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: It drives revision or suppression, not instant deletion.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "Same loop, different conditions. Not three different systems."
...
### 1. "Contradiction deletes the simulation"

**What the student says or does.** Contradiction deletes the simulation — usually while otherwise engaging well.

**Why it is understandable.** Students assume mismatch acts like an eraser.
...
**Exact correction.** The multi-break trial with recorded percentages.

**Say this.** "It drives revision or suppression, not instant deletion."
...
### 2. "Recurrence is just persistence I did not notice"

**What the student says or does.** Recurrence is just persistence I did not notice — usually while otherwise engaging well.

**Why it is understandable.** A legitimate objection, not an error.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Credit it, then show that distinguishing them is a measurement problem.

**Say this.** "You are right that you cannot tell from here."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "Belief(t) replaces the input"

**What the student says or does.** Belief(t) replaces the input — usually while otherwise engaging well.

**Why it is understandable.** Students overextend the idea of a prior.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Show a case with unambiguous input where belief does not override it.

**Say this.** "It biases which memories come back. It does not replace what you see."
...
**Visual or physical support.** Provide the sampling log as a five-checkpoint sheet with fixed times.
...
Ask them to design a schedule that could detect a two-minute absence.
...
Specifically, do not introduce: The integration function, w1/w2/w3, the three rival accounts by name.
...
| | |
|---|---|
| **Follows** | Lesson 11 — Belief Versus Expectation |
| **Leads to** | Lesson 13 — Dynamics In Data |

**Transition in.** Lesson 11 established students distinguish a belief from a momentary expectation. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students classify system behaviour into the three dynamics. Lesson 13 assumes it and builds students find the three dynamics in their own sampling data.
