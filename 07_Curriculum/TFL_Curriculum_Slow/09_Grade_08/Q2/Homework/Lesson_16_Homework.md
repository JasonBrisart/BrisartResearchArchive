# Lesson 16 Homework — The Dynamics Review

**Grade 8** · Contradiction and Limits · **Quarter 2**
**Follows:** Lesson 16 — The Dynamics Review · **Points:** 5 · **Optional:** yes
...
Review with nine scenarios classified with conditions.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class classifies at least seven correctly
...
Lesson 17 is **Stating An Assumption**, which assumes you arrive holding it. Write one thing you expect it to be about:
