# Lesson 28 Homework — Defending A Rejection

**Grade 8** · Contradiction and Limits · **Quarter 4**
**Follows:** Lesson 28 — Defending A Rejection · **Points:** 5 · **Optional:** yes
...
Each student defends one rejection against two written challenges.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student answers both challenges specifically
...
Lesson 29 is **Explaining The Limits**, which assumes you arrive holding it. Write one thing you expect it to be about:
