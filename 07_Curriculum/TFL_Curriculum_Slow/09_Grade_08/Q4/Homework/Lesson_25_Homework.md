# Lesson 25 Homework — What The Model Refuses

**Grade 8** · Contradiction and Limits · **Quarter 4**
**Follows:** Lesson 25 — What The Model Refuses · **Points:** 5 · **Optional:** yes
...
Write formal rejections for three invalid proposals with the boundary named.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every rejection names a specific boundary
...
Lesson 26 is **The Clinical Boundary**, which assumes you arrive holding it. Write one thing you expect it to be about:
