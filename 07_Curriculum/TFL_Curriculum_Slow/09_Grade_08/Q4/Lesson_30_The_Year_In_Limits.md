...
| | |
|---|---|
| **Central question** | The Year In Limits: students review the year through what they learned they could not do? |
| **Core concept** | A limitations list is only useful if each item is tied to a specific case. |
| **Student outcome** | Students review the year through what they learned they could not do. |
| **Previous lesson** | Lesson 29 — Explaining The Limits |
...
**The conceptual step.** A limitations list is only useful if each item is tied to a specific case. Generic limitations are not limitations.
...
A limitations list is only useful if each item is tied to a specific case. Generic limitations are not limitations.
...
1. A limitation about sampling rate, tied to a specific log.
2. A limitation about sample size, tied to the class dataset.

### One non-example

A limitation stating more data would be helpful.
...
That the year's limits can be stated specifically.
...
| Statement | Status |
|---|---|
| A limitations list is only useful if each item is tied to a specific case. | Framework-derived, appropriate at this grade |
| That the year's limits can be stated specifically. | What this specific activity can show |
| How to overcome the limits. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 29 — Explaining The Limits — specifically: students explain the model's boundaries to somebody else.

**How it was taught.** Through the activity: explain the exclusions to a buddy; record the hardest question

**Quick check.** Ask for the closing sentence of Lesson 29. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 29: explain the exclusions to a buddy; record the hardest question, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A limitation about sampling rate, tied to a specific log. |
| **Non-example** | A limitation stating more data would be helpful. |
...
> "Most people find the limits more surprising than the content."
...
**Exact wording.** "Ask what they found this year that they could not explain or measure."
...
**Target observation.** That the year's limits can be stated specifically.
...
> "A limitations list is only useful if each item is tied to a specific case. You just saw that when ask what they found this year that they could not explain or measure.
> Last time we said: Most people find the limits more surprising than the content. This is the next part of that.
...
**What students must not infer.** How to overcome the limits.

### 4. Worked example

**The example.** A limitation about sampling rate, tied to a specific log.
...
**Completed answer.** A limitation about sampling rate, tied to a specific log. — which demonstrates that the year's limits can be stated specifically.
...
**Conclusions not licensed.** How to overcome the limits.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A limitation about sample size, tied to the class dataset. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A limitation stating more data would be helpful. Why is this not an
example?"
...
**Exact student instructions.** Write the year's honest limitations list with an example for each.
...
- *Licensed conclusion.* That the year's limits can be stated specifically.
- *Not licensed.* How to overcome the limits.
...
- *Expected response.* That the year's limits can be stated specifically.
...
1. Any wording carrying the idea in `A limitations list is only useful if each item is tied to a specific case`.
...
Say: "Next year: the equations, and why one variable is missing from them."
...
| | |
|---|---|
| **Follows** | Lesson 29 — Explaining The Limits |
| **Leads to** | Lesson 31 — Practice Final |

**Transition in.** Lesson 29 established students explain the model's boundaries to somebody else. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students review the year through what they learned they could not do. Lesson 31 assumes it and builds students rehearse the final under conditions.
