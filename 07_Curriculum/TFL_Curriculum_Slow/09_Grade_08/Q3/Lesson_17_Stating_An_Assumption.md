# Lesson 17 — Stating An Assumption
...
| | |
|---|---|
| **Central question** | Stating An Assumption: students write the assumptions underneath their own claims? |
| **Core concept** | An assumption is something that must be true for the claim to hold. |
| **Student outcome** | Students write the assumptions underneath their own claims. |
| **Previous lesson** | Lesson 16 — The Dynamics Review |
| **Next lesson** | Lesson 18 — Ranking Assumptions |
...
**The conceptual step.** An assumption is something that must be true for the claim to hold. The test is whether the claim falls if the assumption is false; restatements fail this test.
...
**What depends on it.** Lesson 18 — Ranking Assumptions — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An assumption is something that must be true for the claim to hold. The test is whether the claim falls if the assumption is false; restatements fail this test.
...
1. An assumption that the sampling rate was adequate.
2. An assumption that the partner was not guessing the design.

### One non-example

An assumption restating the claim in different words.
...
That claims rest on stateable assumptions.
...
| Statement | Status |
|---|---|
| An assumption is something that must be true for the claim to hold. | Framework-derived, appropriate at this grade |
| That claims rest on stateable assumptions. | What this specific activity can show |
| Whether the assumptions are true. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Dynamics Review — specifically: students consolidate belief and dynamics.

**How it was taught.** Through the activity: review with nine scenarios classified with conditions

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with nine scenarios classified with conditions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An assumption that the sampling rate was adequate. |
| **Non-example** | An assumption restating the claim in different words. |
...
> "Next time: what your claims are standing on."
...
**Exact wording.** "Put a claim on the board with no assumptions listed and ask what must be true for it."
...
**Target observation.** That claims rest on stateable assumptions.
...
> "An assumption is something that must be true for the claim to hold. You just saw that when put a claim on the board with no assumptions listed and ask what must be true for it.
> Last time we said: Next time: what your claims are standing on. This is the next part of that.
...
**What students must not infer.** Whether the assumptions are true.

### 4. Worked example

**The example.** An assumption that the sampling rate was adequate.
...
**Completed answer.** An assumption that the sampling rate was adequate. — which demonstrates that claims rest on stateable assumptions.
...
**Conclusions not licensed.** Whether the assumptions are true.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An assumption that the partner was not guessing the design. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An assumption restating the claim in different words. Why is this not an
example?"
...
**Exact student instructions.** Take four of their own claims and list at least two assumptions under each.
...
- *Licensed conclusion.* That claims rest on stateable assumptions.
- *Not licensed.* Whether the assumptions are true.
...
- *Expected response.* That claims rest on stateable assumptions.
...
1. Any wording carrying the idea in `An assumption is something that must be true for the claim to hold`.
...
Say: "A claim without its assumptions is unfinished work."
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Dynamics Review |
| **Leads to** | Lesson 18 — Ranking Assumptions |

**Transition in.** Lesson 16 established students consolidate belief and dynamics. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students write the assumptions underneath their own claims. Lesson 18 assumes it and builds students identify which assumption is weakest.
