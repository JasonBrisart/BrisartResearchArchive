...
| | |
|---|---|
| **Central question** | The Sampling Review: students consolidate sampling? |
| **Core concept** | A result without its sampling rate cannot be judged. |
| **Student outcome** | Students consolidate sampling. |
| **Previous lesson** | Lesson 7 — Improving The Sampling |
| **Next lesson** | Lesson 9 — Belief As A Prior |
...
**The conceptual step.** A result without its sampling rate cannot be judged. The review enforces the rate as a required part of any reported result.
...
**What depends on it.** Lesson 9 — Belief As A Prior — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A result without its sampling rate cannot be judged. The review enforces the rate as a required part of any reported result.
...
1. A result correctly judged as overreaching its rate.
2. A result correctly judged as within its rate.

### One non-example

A result reported with no rate stated.
...
Whether the rate requirement is habitual.
...
| Statement | Status |
|---|---|
| A result without its sampling rate cannot be judged. | Framework-derived, appropriate at this grade |
| Whether the rate requirement is habitual. | What this specific activity can show |
| Whether the results are accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 7 — Improving The Sampling — specifically: students design a schedule that could detect a shorter gap.

**How it was taught.** Through the activity: design a higher-rate schedule and state what it would cost to run

**Quick check.** Ask for the closing sentence of Lesson 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 7: design a higher-rate schedule and state what it would cost to run, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A result correctly judged as overreaching its rate. |
| **Non-example** | A result reported with no rate stated. |
...
> "Better resolution costs something. Always."
...
**Exact wording.** "Ask what their rate lets them say, and what it does not."
...
**Target observation.** Whether the rate requirement is habitual.
...
> "A result without its sampling rate cannot be judged. You just saw that when ask what their rate lets them say, and what it does not.
> Last time we said: Better resolution costs something. Always. This is the next part of that.
...
**What students must not infer.** Whether the results are accurate.

### 4. Worked example

**The example.** A result correctly judged as overreaching its rate.
...
**Completed answer.** A result correctly judged as overreaching its rate. — which demonstrates whether the rate requirement is habitual.
...
**Conclusions not licensed.** Whether the results are accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A result correctly judged as within its rate. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A result reported with no rate stated. Why is this not an
example?"
...
**Exact student instructions.** Review with six results judged against their stated rates.
...
- *Licensed conclusion.* Whether the rate requirement is habitual.
- *Not licensed.* Whether the results are accurate.
...
- *Expected response.* Whether the rate requirement is habitual.
...
1. Any wording carrying the idea in `A result without its sampling rate cannot be judged`.
...
Say: "Next time: what shapes which memories come back at all."
...
| | |
|---|---|
| **Follows** | Lesson 7 — Improving The Sampling |
| **Leads to** | Lesson 9 — Belief As A Prior |

**Transition in.** Lesson 7 established students design a schedule that could detect a shorter gap. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate sampling. Lesson 9 assumes it and builds students identify Belief(t) constraining retrieval under ambiguity.
