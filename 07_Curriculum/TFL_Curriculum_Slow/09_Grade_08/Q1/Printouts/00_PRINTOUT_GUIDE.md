...
|---|---|---|---|---|---|---|
| `Lesson_01_Printout.md` | Lesson 1 — What Contradiction Does | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_02_Printout.md` | Lesson 2 — Counting The Breaks | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 1 work |
| `Lesson_03_Printout.md` | Lesson 3 — Persistence Or Recurrence | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 2 work |
| `Lesson_04_Printout.md` | Lesson 4 — The Sampling Problem | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 3 work |
| `Lesson_05_Printout.md` | Lesson 5 — Running The Sampling | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 4 work |
| `Lesson_06_Printout.md` | Lesson 6 — Reading Your Own Sampling | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 5 work |
| `Lesson_07_Printout.md` | Lesson 7 — Improving The Sampling | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 6 work |
| `Lesson_08_Printout.md` | Lesson 8 — The Sampling Review | 2–4 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 7 work |
...
**Lesson 5 — Running The Sampling.** If you only have time to print one
