# Lesson 2 Homework — Counting The Breaks

**Grade 8** · Contradiction and Limits · **Quarter 1**
**Follows:** Lesson 2 — Counting The Breaks · **Points:** 5 · **Optional:** yes
...
A three-break trial in pairs, pooled, compared against predictions.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class has a pooled number and each student compared it
...
Lesson 3 is **Persistence Or Recurrence**, which assumes you arrive holding it. Write one thing you expect it to be about:
