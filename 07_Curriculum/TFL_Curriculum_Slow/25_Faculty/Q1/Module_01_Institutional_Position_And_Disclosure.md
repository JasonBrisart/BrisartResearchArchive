# Module 1 — Institutional Position And Disclosure
...
| | |
|---|---|
| **Central question** | Institutional Position And Disclosure: participants produce an executable disclosure protocol? |
| **Core concept** | A disclosure protocol specifies the verbatim wording to be used in each context, who is responsible, and when it is reviewed. |
| **Student outcome** | Participants produce an executable disclosure protocol. |
| **Previous module** | None. First module of the year. |
| **Next module** | Module 2 — Testing The Disclosure |
| **Materials** | Institutional standards documentation; licensing terms |
| **Preparation** | ninety minutes |
| **Student printout** | `Printouts/Module_01_Printout.md` |
| **Homework** | `Homework/Module_01_Homework.md` |

## Why this lesson exists

**The conceptual step.** A disclosure protocol specifies the verbatim wording to be used in each context, who is responsible, and when it is reviewed. Guidance to disclose appropriately is not a protocol.
...
**What depends on it.** Module 2 — Testing The Disclosure — opens by assuming this module's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A disclosure protocol specifies the verbatim wording to be used in each context, who is responsible, and when it is reviewed. Guidance to disclose appropriately is not a protocol.
...
1. A protocol with verbatim wording for a course syllabus.
2. A protocol naming the responsible role for each context.

### One non-example

A protocol instructing staff to represent the status accurately.
...
That protocols require verbatim wording.

### What this activity does not establish

Whether the wording is optimal.
...
| Statement | Status |
|---|---|
| A disclosure protocol specifies the verbatim wording to be used in each context, who is responsible, and when it is reviewed. | Framework-derived, appropriate at this grade |
| That protocols require verbatim wording. | What this specific activity can show |
| Whether the wording is optimal. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The participant designs a hedged programme with real stop conditions.

**How it was taught.** It is assumed on entry rather than taught here.

**Quick check.** No check required.

**If the prerequisite is missing.** Not applicable.
...
| **Correct example** | A protocol with verbatim wording for a course syllabus. |
| **Non-example** | A protocol instructing staff to represent the status accurately. |
...
**Student materials.** One copy of `Printouts/Module_01_Printout.md` per student.

**Prior student data required.** None.
...
**File.** `Printouts/Module_01_Printout.md`
...
This is the first module of the year, so there is nothing to retrieve. Instead ask: "What do you think this course is about?" Take three answers and write them where they can be revisited at the end of the year. Do not correct them.

### 2. Hook

**Exact wording.** "Say: a student who overclaims made an error. A supervisor who permitted it made a larger one."
...
**Target observation.** That protocols require verbatim wording.
...
> "A disclosure protocol specifies the verbatim wording to be used in each context, who is responsible, and when it is reviewed. You just saw that when say: a student who overclaims made an error.
...
**What students must not infer.** Whether the wording is optimal.

### 4. Worked example

**The example.** A protocol with verbatim wording for a course syllabus.
...
**Completed answer.** A protocol with verbatim wording for a course syllabus. — which demonstrates that protocols require verbatim wording.
...
**Conclusions not licensed.** Whether the wording is optimal.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A protocol naming the responsible role for each context. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A protocol instructing staff to represent the status accurately. Why is this not an
example?"
...
**Exact student instructions.** Draft the protocol with verbatim wording, contexts, responsibility, and review interval.
...
- *Licensed conclusion.* That protocols require verbatim wording.
- *Not licensed.* Whether the wording is optimal.
...
- *Expected response.* That protocols require verbatim wording.
...
1. Any wording carrying the idea in `A disclosure protocol specifies the verbatim wording to be used in each context, who is responsible, and when it is reviewed`.
...
Say: "A protocol that says disclose appropriately has not been written."

**Why this sentence matters.** It is the opening question of Module 2, which assumes students arrive holding it.
...
**File.** `Homework/Module_01_Homework.md`
...
| | |
|---|---|
| **Follows** | Nothing. First module of the year. |
| **Leads to** | Module 2 — Testing The Disclosure |

**Transition in.** This module opens the year.

**Transition out.** This module establishes participants produce an executable disclosure protocol. Module 2 assumes it and builds participants test the protocol by blind delivery.
