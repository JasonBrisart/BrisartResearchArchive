# Module 3 Homework — Supervising Students On Unvalidated Work

**Faculty** · Institutional Stewardship · **Quarter 1**
**Follows:** Module 3 — Supervising Students On Unvalidated Work · **Points:** 5 · **Optional:** yes
...
Write the sentence Module 3 ended on, from memory:
...
Draft the plan with verbatim informed-entry wording and an exit decision point.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every plan states what transfers if the student redirects
...
Module 4 is **Scope Enforcement As Procedure**, which assumes you arrive holding it. Write one thing you expect it to be about:
