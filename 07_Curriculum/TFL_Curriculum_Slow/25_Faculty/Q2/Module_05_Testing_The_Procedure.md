# Module 5 — Testing The Procedure

**Faculty** · Institutional Stewardship · **Quarter 2** · **3-4 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Testing The Procedure: participants test enforcement by blind application? |
| **Core concept** | An enforcement procedure is tested by blind application to an unseen proposal. |
| **Student outcome** | Participants test enforcement by blind application. |
| **Previous module** | Module 4 — Scope Enforcement As Procedure |
| **Next module** | Module 6 — Designing The Course |
| **Materials** | Institutional standards documentation; licensing terms |
| **Preparation** | ninety minutes |
| **Student printout** | `Printouts/Module_05_Printout.md` |
| **Homework** | `Homework/Module_05_Homework.md` |

## Why this lesson exists

**The conceptual step.** An enforcement procedure is tested by blind application to an unseen proposal. Every ambiguity the applier encounters is where the procedure will fail in practice.
...
**What depends on it.** Module 6 — Designing The Course — opens by assuming this module's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An enforcement procedure is tested by blind application to an unseen proposal. Every ambiguity the applier encounters is where the procedure will fail in practice.
...
1. A procedure applied blind with four ambiguities recorded.
2. A procedure revised after blind application produced inconsistent verdicts.

### One non-example

A procedure applied with the author clarifying as questions arose.
...
That procedures are tested by blind application.

### What this activity does not establish

Whether the procedure is otherwise good.
...
| Statement | Status |
|---|---|
| An enforcement procedure is tested by blind application to an unseen proposal. | Framework-derived, appropriate at this grade |
| That procedures are tested by blind application. | What this specific activity can show |
| Whether the procedure is otherwise good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Module 4 — Scope Enforcement As Procedure — specifically: participants produce a three-tier enforcement procedure.

**How it was taught.** Through the activity: write the procedure with the verbatim standing response for clinical proposals

**Quick check.** Ask for the closing sentence of Module 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Module 4: write the procedure with the verbatim standing response for clinical proposals, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A procedure applied blind with four ambiguities recorded. |
| **Non-example** | A procedure applied with the author clarifying as questions arose. |
...
**Student materials.** One copy of `Printouts/Module_05_Printout.md` per student.

**Prior student data required.** Work produced in Module 4, kept in the student's folder.
...
**File.** `Printouts/Module_05_Printout.md`
...
> "A checker without authority is a commenter."
...
**Exact wording.** "Say: a colleague applies yours to a proposal you have never seen."
...
**Target observation.** That procedures are tested by blind application.
...
> "An enforcement procedure is tested by blind application to an unseen proposal. You just saw that when say: a colleague applies yours to a proposal you have never seen.
> Last time we said: A checker without authority is a commenter. This is the next part of that.
...
**What students must not infer.** Whether the procedure is otherwise good.

### 4. Worked example

**The example.** A procedure applied blind with four ambiguities recorded.
...
**Completed answer.** A procedure applied blind with four ambiguities recorded. — which demonstrates that procedures are tested by blind application.
...
**Conclusions not licensed.** Whether the procedure is otherwise good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A procedure revised after blind application produced inconsistent verdicts. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A procedure applied with the author clarifying as questions arose. Why is this not an
example?"
...
**Exact student instructions.** Blind application test with every ambiguity recorded.
...
- *Licensed conclusion.* That procedures are tested by blind application.
- *Not licensed.* Whether the procedure is otherwise good.
...
- *Expected response.* That procedures are tested by blind application.
...
1. Any wording carrying the idea in `An enforcement procedure is tested by blind application to an unseen proposal`.
...
Say: "The ambiguities are where it will fail in practice."

**Why this sentence matters.** It is the opening question of Module 6, which assumes students arrive holding it.
...
**File.** `Homework/Module_05_Homework.md`
...
| | |
|---|---|
| **Follows** | Module 4 — Scope Enforcement As Procedure |
| **Leads to** | Module 6 — Designing The Course |

**Transition in.** Module 4 established participants produce a three-tier enforcement procedure. This module uses that as the starting point.

**Transition out.** This module establishes participants test enforcement by blind application. Module 6 assumes it and builds participants produce a defensible syllabus.
