...
| | |
|---|---|
| **Central question** | Portfolio Review: participants defend a portfolio tested by blind execution? |
| **Core concept** | The portfolio defence follows blind execution rather than preceding it. |
| **Student outcome** | Participants defend a portfolio tested by blind execution. |
| **Previous module** | Module 11 — Blind Execution |
| **Next module** | The final examination. |
| **Materials** | Institutional standards documentation; licensing terms |
| **Preparation** | ninety minutes |
| **Student printout** | `Printouts/Module_12_Printout.md` |
| **Homework** | `Homework/Module_12_Homework.md` |

## Why this lesson exists

**The conceptual step.** The portfolio defence follows blind execution rather than preceding it. The student-advocate challenge is answered with a mechanism rather than an intention.
...
**What depends on it.** The final examination assesses this directly.

## Teacher concept guide

### Plain-language explanation

The portfolio defence follows blind execution rather than preceding it. The student-advocate challenge is answered with a mechanism rather than an intention.
...
1. A portfolio passing blind execution on both gates.
2. A mechanism answering the student-advocate challenge.

### One non-example

A defence stating the participant would protect their students.
...
Whether institutional capacity has been built.
...
| Statement | Status |
|---|---|
| The portfolio defence follows blind execution rather than preceding it. | Framework-derived, appropriate at this grade |
| Whether institutional capacity has been built. | What this specific activity can show |
| Whether the framework is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Module 11 — Blind Execution — specifically: participants test every artifact by having somebody else perform it.

**How it was taught.** Through the activity: four artifacts performed blind, with every failure reported back

**Quick check.** Ask for the closing sentence of Module 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Module 11: four artifacts performed blind, with every failure reported back, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A portfolio passing blind execution on both gates. |
| **Non-example** | A defence stating the participant would protect their students. |
...
**Student materials.** One copy of `Printouts/Module_12_Printout.md` per student.

**Prior student data required.** Work produced in Module 11, kept in the student's folder.
...
**File.** `Printouts/Module_12_Printout.md`
...
> "The failures reported back are the grade."
...
**Exact wording.** "Say: artifacts are tested, not described. Blind execution before any defence."
...
**Target observation.** Whether institutional capacity has been built.
...
> "The portfolio defence follows blind execution rather than preceding it. You just saw that when say: artifacts are tested, not described.
> Last time we said: The failures reported back are the grade. This is the next part of that.
...
**The example.** A portfolio passing blind execution on both gates.
...
**Completed answer.** A portfolio passing blind execution on both gates. — which demonstrates whether institutional capacity has been built.
...
**Teacher prompt.** "Here is a second case. A mechanism answering the student-advocate challenge. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence stating the participant would protect their students. Why is this not an
example?"
...
**Exact student instructions.** Eight minutes presenting, eight defending, against four challenge roles.
...
- *Licensed conclusion.* Whether institutional capacity has been built.
...
- *Expected response.* Whether institutional capacity has been built.
...
1. Any wording carrying the idea in `The portfolio defence follows blind execution rather than preceding it`.
...
Say: "The framework is still unvalidated. What changed is that people could now run its examination."

**Why this sentence matters.** It closes the year's argument.
...
**File.** `Homework/Module_12_Homework.md`
...
| | |
|---|---|
| **Follows** | Module 11 — Blind Execution |
| **Leads to** | The final examination. |

**Transition in.** Module 11 established participants test every artifact by having somebody else perform it. This module uses that as the starting point.

**Transition out.** The year's argument closes here and is assessed in the final.
