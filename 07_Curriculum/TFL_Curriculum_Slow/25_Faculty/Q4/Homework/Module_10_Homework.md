# Module 10 Homework — Assembling The Portfolio

**Faculty** · Institutional Stewardship · **Quarter 4**
**Follows:** Module 10 — Assembling The Portfolio · **Points:** 5 · **Optional:** yes
...
Write the sentence Module 10 ended on, from memory:
...
Assemble the portfolio and self-audit against the executability gate.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every portfolio contains all seven artifacts
...
Module 11 is **Blind Execution**, which assumes you arrive holding it. Write one thing you expect it to be about:
