...
| | |
|---|---|
| **Central question** | Final Assessment: students demonstrate the year's outcomes? |
| **Core concept** | The four exit outcomes together constitute readiness for Grade 7, which tests the persistence-accuracy distinction on the student's own data. |
| **Student outcome** | Students demonstrate the year's outcomes. |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 7, which tests the persistence-accuracy distinction on the student's own data.
...
The four exit outcomes together constitute readiness for Grade 7, which tests the persistence-accuracy distinction on the student's own data.
...
1. A student completes all four items.
2. A student states the gating constraint with all three denials.

### One non-example

A student who names the variables but cannot state the constraint.
...
Whether all four exit outcomes are present.

### What this activity does not establish

Quality of any single item.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 7, which tests the persistence-accuracy distinction on the student's own data. | Framework-derived, appropriate at this grade |
| Whether all four exit outcomes are present. | What this specific activity can show |
| Quality of any single item. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 31 — Practice Final — specifically: students rehearse the final under conditions.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 31: a full practice final, self-marked, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A student completes all four items. |
| **Non-example** | A student who names the variables but cannot state the constraint. |
...
**Exact wording.** "Say: everything you know, on your own."
...
**Target observation.** Whether all four exit outcomes are present.
...
> "The four exit outcomes together constitute readiness for Grade 7, which tests the persistence-accuracy distinction on the student's own data. You just saw that when say: everything you know, on your own.
...
**What students must not infer.** Quality of any single item.

### 4. Worked example

**The example.** A student completes all four items.
...
**Completed answer.** A student completes all four items. — which demonstrates whether all four exit outcomes are present.
...
**Conclusions not licensed.** Quality of any single item.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student states the gating constraint with all three denials. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student who names the variables but cannot state the constraint. Why is this not an
example?"
...
**Exact student instructions.** The final: name five variables, state the gating constraint, give the window, apply identifiability.
...
- *Licensed conclusion.* Whether all four exit outcomes are present.
- *Not licensed.* Quality of any single item.
...
- *Expected response.* Whether all four exit outcomes are present.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 7, which tests the persistence-accuracy distinction on the student's own data`.
...
Say: "Next year is the most important year in this sequence."
...
**Transition in.** Lesson 31 established students rehearse the final under conditions. This lesson uses that as the starting point.
