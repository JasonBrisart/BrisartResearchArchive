...
| | |
|---|---|
| **Central question** | Everything Named: students produce and defend a fully notated trace? |
| **Core concept** | Producing, auditing, repairing, and defending a notated trace is the year's terminal skill. |
| **Student outcome** | Students produce and defend a fully notated trace. |
| **Previous lesson** | Lesson 29 — Explaining The Notation |
...
**The conceptual step.** Producing, auditing, repairing, and defending a notated trace is the year's terminal skill. Defending it aloud without reverting to plain language is the hardest part.
...
Producing, auditing, repairing, and defending a notated trace is the year's terminal skill. Defending it aloud without reverting to plain language is the hardest part.
...
1. A row explained aloud in full notation.
2. A trace repaired after audit and then defended.

### One non-example

An explanation that drops into plain language when questioned.
...
Whether the student can defend notated work.
...
| Statement | Status |
|---|---|
| Producing, auditing, repairing, and defending a notated trace is the year's terminal skill. | Framework-derived, appropriate at this grade |
| Whether the student can defend notated work. | What this specific activity can show |
| Whether the trace is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 29 — Explaining The Notation — specifically: students explain the five variables to somebody who does not know them.

**How it was taught.** Through the activity: explain to a buddy; record the hardest question asked

**Quick check.** Ask for the closing sentence of Lesson 29. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 29: explain to a buddy; record the hardest question asked, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A row explained aloud in full notation. |
| **Non-example** | An explanation that drops into plain language when questioned. |
...
> "If you can teach the names, you have them."
...
**Exact wording.** "Say: produce it, get it audited, repair it, then explain one row aloud in notation."
...
**Target observation.** Whether the student can defend notated work.
...
> "Producing, auditing, repairing, and defending a notated trace is the year's terminal skill. You just saw that when say: produce it, get it audited, repair it, then explain one row aloud in notation.
> Last time we said: If you can teach the names, you have them. This is the next part of that.
...
**The example.** A row explained aloud in full notation.
...
**Completed answer.** A row explained aloud in full notation. — which demonstrates whether the student can defend notated work.
...
**Teacher prompt.** "Here is a second case. A trace repaired after audit and then defended. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An explanation that drops into plain language when questioned. Why is this not an
example?"
...
**Exact student instructions.** A four-row trace, audited, repaired, with one row explained aloud.
...
- *Licensed conclusion.* Whether the student can defend notated work.
...
- *Expected response.* Whether the student can defend notated work.
...
1. Any wording carrying the idea in `Producing, auditing, repairing, and defending a notated trace is the year's terminal skill`.
...
Say: "Next year: persistence and being right are completely different things."
...
| | |
|---|---|
| **Follows** | Lesson 29 — Explaining The Notation |
| **Leads to** | Lesson 31 — Practice Final |

**Transition in.** Lesson 29 established students explain the five variables to somebody who does not know them. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students produce and defend a fully notated trace. Lesson 31 assumes it and builds students rehearse the final under conditions.
