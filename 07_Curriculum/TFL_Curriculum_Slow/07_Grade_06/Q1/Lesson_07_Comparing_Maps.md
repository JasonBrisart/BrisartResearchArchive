...
| | |
|---|---|
| **Central question** | Comparing Maps: students compare two maps of the same event? |
| **Core concept** | Two honest maps of one event differ, and the differences are locatable to specific variables. |
| **Student outcome** | Students compare two maps of the same event. |
| **Previous lesson** | Lesson 6 — When Sim(t) Is Unclear |
| **Next lesson** | Lesson 8 — The Five Names Review |
...
**The conceptual step.** Two honest maps of one event differ, and the differences are locatable to specific variables. Difference is not error.
...
**What depends on it.** Lesson 8 — The Five Names Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Two honest maps of one event differ, and the differences are locatable to specific variables. Difference is not error.
...
1. Two maps differing on Minfo(t) but agreeing on Input(t).
2. Two maps differing on E(t) for the same Sim(t).

### One non-example

Two maps assumed to conflict because they differ.
...
That maps of one event differ traceably.
...
| Statement | Status |
|---|---|
| Two honest maps of one event differ, and the differences are locatable to specific variables. | Framework-derived, appropriate at this grade |
| That maps of one event differ traceably. | What this specific activity can show |
| Which map is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — When Sim(t) Is Unclear — specifically: students mark moments where the simulation cannot be stated.

**How it was taught.** Through the activity: attempt five maps and mark any where Sim(t) cannot be stated

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: attempt five maps and mark any where Sim(t) cannot be stated, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Two maps differing on Minfo(t) but agreeing on Input(t). |
| **Non-example** | Two maps assumed to conflict because they differ. |
...
> "Marking one is honest. Inventing a Sim(t) is not."
...
**Exact wording.** "Have two students map one staged event. Put both on the board."
...
**Target observation.** That maps of one event differ traceably.
...
> "Two honest maps of one event differ, and the differences are locatable to specific variables. You just saw that when have two students map one staged event.
> Last time we said: Marking one is honest. Inventing a Sim(t) is not. This is the next part of that.
...
**What students must not infer.** Which map is correct.

### 4. Worked example

**The example.** Two maps differing on Minfo(t) but agreeing on Input(t).
...
**Completed answer.** Two maps differing on Minfo(t) but agreeing on Input(t). — which demonstrates that maps of one event differ traceably.
...
**Conclusions not licensed.** Which map is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Two maps differing on E(t) for the same Sim(t). Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two maps assumed to conflict because they differ. Why is this not an
example?"
...
**Exact student instructions.** Compare two maps of a shared event and name every differing line.
...
- *Licensed conclusion.* That maps of one event differ traceably.
- *Not licensed.* Which map is correct.
...
- *Expected response.* That maps of one event differ traceably.
...
1. Any wording carrying the idea in `Two honest maps of one event differ, and the differences are locatable to specific variables`.
...
Say: "Same event, different maps, and the difference is traceable."
...
| | |
|---|---|
| **Follows** | Lesson 6 — When Sim(t) Is Unclear |
| **Leads to** | Lesson 8 — The Five Names Review |

**Transition in.** Lesson 6 established students mark moments where the simulation cannot be stated. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students compare two maps of the same event. Lesson 8 assumes it and builds students consolidate the five variables.
