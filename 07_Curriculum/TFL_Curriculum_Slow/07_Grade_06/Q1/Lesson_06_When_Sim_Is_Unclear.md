# Lesson 6 — When Sim(t) Is Unclear
...
| | |
|---|---|
| **Central question** | When Sim(t) Is Unclear: students mark moments where the simulation cannot be stated? |
| **Core concept** | Some moments have no stateable Sim(t). |
| **Student outcome** | Students mark moments where the simulation cannot be stated. |
| **Previous lesson** | Lesson 5 — Mapping Across A Lesson |
| **Next lesson** | Lesson 7 — Comparing Maps |
...
**The conceptual step.** Some moments have no stateable Sim(t). Marking one is honest work and maps where the framework stops applying, which is content rather than failure.
...
**What depends on it.** Lesson 7 — Comparing Maps — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Some moments have no stateable Sim(t). Marking one is honest work and maps where the framework stops applying, which is content rather than failure.
...
1. A moment marked unmappable because no specific outcome was expected.
2. A moment marked because only a mood was present.

### One non-example

A vague moment forced into a specific invented Sim(t).
...
That the framework has a boundary students can locate.

### What this activity does not establish

Why those moments lack a stateable Sim(t).
...
| Statement | Status |
|---|---|
| Some moments have no stateable Sim(t). | Framework-derived, appropriate at this grade |
| That the framework has a boundary students can locate. | What this specific activity can show |
| Why those moments lack a stateable Sim(t). | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — Mapping Across A Lesson — specifically: students map several moments from one continuous period.

**How it was taught.** Through the activity: four mapped moments from within the session, in order

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: four mapped moments from within the session, in order, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A moment marked unmappable because no specific outcome was expected. |
| **Non-example** | A vague moment forced into a specific invented Sim(t). |
...
> "Four moments in twenty minutes. There were thousands."
...
**Exact wording.** "Say: some will not map. That is a real answer."
...
**Target observation.** That the framework has a boundary students can locate.
...
> "Some moments have no stateable Sim(t). You just saw that when say: some will not map.
> Last time we said: Four moments in twenty minutes. There were thousands. This is the next part of that.
...
**What students must not infer.** Why those moments lack a stateable Sim(t).

### 4. Worked example

**The example.** A moment marked unmappable because no specific outcome was expected.
...
**Completed answer.** A moment marked unmappable because no specific outcome was expected. — which demonstrates that the framework has a boundary students can locate.
...
**Conclusions not licensed.** Why those moments lack a stateable Sim(t).

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A moment marked because only a mood was present. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A vague moment forced into a specific invented Sim(t). Why is this not an
example?"
...
**Exact student instructions.** Attempt five maps and mark any where Sim(t) cannot be stated.
...
- *Licensed conclusion.* That the framework has a boundary students can locate.
- *Not licensed.* Why those moments lack a stateable Sim(t).
...
- *Expected response.* That the framework has a boundary students can locate.
...
1. Any wording carrying the idea in `Some moments have no stateable Sim(t)`.
...
Say: "Marking one is honest. Inventing a Sim(t) is not."
...
| | |
|---|---|
| **Follows** | Lesson 5 — Mapping Across A Lesson |
| **Leads to** | Lesson 7 — Comparing Maps |

**Transition in.** Lesson 5 established students map several moments from one continuous period. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students mark moments where the simulation cannot be stated. Lesson 7 assumes it and builds students compare two maps of the same event.
