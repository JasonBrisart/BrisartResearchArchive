# Lesson 14 Homework — Windows In Other Subjects

**Grade 6** · Naming The System · **Quarter 2**
**Follows:** Lesson 14 — Windows In Other Subjects · **Points:** 5 · **Optional:** yes
...
Five window estimates from science, sport, or music, with arithmetic.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces five cross-subject estimates
...
Lesson 15 is **The Window Argument**, which assumes you arrive holding it. Write one thing you expect it to be about:
