# Lesson 24 Homework — The Identifiability Review

**Grade 6** · Naming The System · **Quarter 3**
**Follows:** Lesson 24 — The Identifiability Review · **Points:** 5 · **Optional:** yes
...
Review with ten statements marked valid or invalid Sim(t).

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class marks at least eight correctly
...
Lesson 25 is **Persistence Named**, which assumes you arrive holding it. Write one thing you expect it to be about:
