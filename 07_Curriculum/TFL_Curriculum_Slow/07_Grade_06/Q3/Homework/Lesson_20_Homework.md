# Lesson 20 Homework — Feelings Are Not Simulations

**Grade 6** · Naming The System · **Quarter 3**
**Follows:** Lesson 20 — Feelings Are Not Simulations · **Points:** 5 · **Optional:** yes
...
Sort twelve statements into feelings, simulations, and both.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student sorts at least nine correctly
...
Lesson 21 is **Identifiability Elsewhere**, which assumes you arrive holding it. Write one thing you expect it to be about:
