# Lesson 7 — Gating In Other Accounts
...
| | |
|---|---|
| **Central question** | Gating In Other Accounts: students compare TFL's affect claim with another account? |
| **Core concept** | Most accounts of affect give it a wider role than exclusive gating allows. |
| **Student outcome** | Students compare TFL's affect claim with another account. |
| **Previous lesson** | Lesson 6 — Designing The Deciding Test |
| **Next lesson** | Lesson 8 — The Gating Review |
...
**The conceptual step.** Most accounts of affect give it a wider role than exclusive gating allows. Locating the divergence is what makes the contest specifiable.
...
**What depends on it.** Lesson 8 — The Gating Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Most accounts of affect give it a wider role than exclusive gating allows. Locating the divergence is what makes the contest specifiable.
...
1. An account giving affect a role in perception, marked as divergent.
2. An account giving affect a role in memory encoding.

### One non-example

An assumption that other accounts broadly agree.
...
That the claim diverges from mainstream accounts.
...
| Statement | Status |
|---|---|
| Most accounts of affect give it a wider role than exclusive gating allows. | Framework-derived, appropriate at this grade |
| That the claim diverges from mainstream accounts. | What this specific activity can show |
| Which account is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — Designing The Deciding Test — specifically: students sketch the design that would settle the gating question.

**How it was taught.** Through the activity: a four-line design sketch including how to distinguish within-window from propagation

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: a four-line design sketch including how to distinguish within-window from propagation, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An account giving affect a role in perception, marked as divergent. |
| **Non-example** | An assumption that other accounts broadly agree. |
...
> "That fourth line is the hard part and the important one."
...
**Exact wording.** "Take any mainstream account of emotion from psychology or biology."
...
**Target observation.** That the claim diverges from mainstream accounts.
...
> "Most accounts of affect give it a wider role than exclusive gating allows. You just saw that when take any mainstream account of emotion from psychology or biology.
> Last time we said: That fourth line is the hard part and the important one. This is the next part of that.
...
**The example.** An account giving affect a role in perception, marked as divergent.
...
**Completed answer.** An account giving affect a role in perception, marked as divergent. — which demonstrates that the claim diverges from mainstream accounts.
...
**Teacher prompt.** "Here is a second case. An account giving affect a role in memory encoding. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An assumption that other accounts broadly agree. Why is this not an
example?"
...
**Exact student instructions.** Compare three outside accounts against exclusive gating and mark where they differ.
...
- *Licensed conclusion.* That the claim diverges from mainstream accounts.
...
- *Expected response.* That the claim diverges from mainstream accounts.
...
1. Any wording carrying the idea in `Most accounts of affect give it a wider role than exclusive gating allows`.
...
Say: "Most accounts give affect a wider role. That is the contest."
...
| | |
|---|---|
| **Follows** | Lesson 6 — Designing The Deciding Test |
| **Leads to** | Lesson 8 — The Gating Review |

**Transition in.** Lesson 6 established students sketch the design that would settle the gating question. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students compare TFL's affect claim with another account. Lesson 8 assumes it and builds students consolidate exclusive gating.
