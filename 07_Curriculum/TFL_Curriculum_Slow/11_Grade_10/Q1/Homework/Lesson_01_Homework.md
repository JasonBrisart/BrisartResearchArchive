# Lesson 1 Homework — Where E(t) Lives

**Grade 10** · The Gate and the Guarantees · **Quarter 1**
**Follows:** Lesson 1 — Where E(t) Lives · **Points:** 5 · **Optional:** yes
...
Write both relations from memory and annotate which variables appear where.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student writes both and states which variables appear where
...
Lesson 2 is **Exclusive Gating**, which assumes you arrive holding it. Write one thing you expect it to be about:
