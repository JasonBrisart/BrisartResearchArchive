# Lesson 3 Homework — Bounded Persistence

**Grade 10** · The Gate and the Guarantees · **Quarter 1**
**Follows:** Lesson 3 — Bounded Persistence · **Points:** 5 · **Optional:** yes
...
Write why unbounded E(t) would be a problem and name a violating observation.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names a violating observation
...
Lesson 4 is **The Gate Under Pressure**, which assumes you arrive holding it. Write one thing you expect it to be about:
