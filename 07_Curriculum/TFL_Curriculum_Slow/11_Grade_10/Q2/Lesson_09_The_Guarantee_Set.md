...
| | |
|---|---|
| **Central question** | The Guarantee Set: students state what the architecture commits to? |
| **Core concept** | The architecture makes a specific set of commitments. |
| **Student outcome** | Students state what the architecture commits to. |
| **Previous lesson** | Lesson 8 — The Gating Review |
| **Next lesson** | Lesson 10 — Convergence Is Not Guaranteed |
...
**The conceptual step.** The architecture makes a specific set of commitments. What is absent from the set, particularly universal resolution, is as informative as what is present.
...
**What depends on it.** Lesson 10 — Convergence Is Not Guaranteed — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The architecture makes a specific set of commitments. What is absent from the set, particularly universal resolution, is as informative as what is present.
...
1. Threshold-gated persistence recalled with its consequence.
2. Conditional determinism recalled with its condition.

### One non-example

A guarantee recalled by wording with no consequence stated.
...
That the guarantee set has stateable members and absences.
...
| Statement | Status |
|---|---|
| The architecture makes a specific set of commitments. | Framework-derived, appropriate at this grade |
| That the guarantee set has stateable members and absences. | What this specific activity can show |
| Whether the guarantees hold. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Gating Review — specifically: students consolidate exclusive gating.

**How it was taught.** Through the activity: review with six statements marked consistent or inconsistent with exclusive gating

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: review with six statements marked consistent or inconsistent with exclusive gating, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Threshold-gated persistence recalled with its consequence. |
| **Non-example** | A guarantee recalled by wording with no consequence stated. |
...
> "Next time: what the architecture actually promises."
...
**Exact wording.** "Read four claims; students vote guarantee or not. One is a trap."
...
**Target observation.** That the guarantee set has stateable members and absences.
...
> "The architecture makes a specific set of commitments. You just saw that when read four claims; students vote guarantee or not.
> Last time we said: Next time: what the architecture actually promises. This is the next part of that.
...
**The example.** Threshold-gated persistence recalled with its consequence.
...
**Completed answer.** Threshold-gated persistence recalled with its consequence. — which demonstrates that the guarantee set has stateable members and absences.
...
**Teacher prompt.** "Here is a second case. Conditional determinism recalled with its condition. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A guarantee recalled by wording with no consequence stated. Why is this not an
example?"
...
**Exact student instructions.** List the guarantees from the chart, then close it and list from memory.
...
- *Licensed conclusion.* That the guarantee set has stateable members and absences.
...
- *Expected response.* That the guarantee set has stateable members and absences.
...
1. Any wording carrying the idea in `The architecture makes a specific set of commitments`.
...
Say: "Note what is missing. The framework does not promise resolution."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Gating Review |
| **Leads to** | Lesson 10 — Convergence Is Not Guaranteed |

**Transition in.** Lesson 8 established students consolidate exclusive gating. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state what the architecture commits to. Lesson 10 assumes it and builds students state the three conditions under which resolution occurs.
