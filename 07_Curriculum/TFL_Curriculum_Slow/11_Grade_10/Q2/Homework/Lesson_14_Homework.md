# Lesson 14 Homework — The Missing Guarantee

**Grade 10** · The Gate and the Guarantees · **Quarter 2**
**Follows:** Lesson 14 — The Missing Guarantee · **Points:** 5 · **Optional:** yes
...
List three absent guarantees and say why each is absent.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student lists three absent guarantees with reasons
...
Lesson 15 is **Guarantees Under Challenge**, which assumes you arrive holding it. Write one thing you expect it to be about:
