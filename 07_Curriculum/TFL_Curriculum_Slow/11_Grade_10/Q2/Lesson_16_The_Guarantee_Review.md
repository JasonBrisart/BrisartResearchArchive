# Lesson 16 — The Guarantee Review
...
| | |
|---|---|
| **Central question** | The Guarantee Review: students consolidate the guarantee set? |
| **Core concept** | A guarantee named without its violating observation is a slogan. |
| **Student outcome** | Students consolidate the guarantee set. |
| **Previous lesson** | Lesson 15 — Guarantees Under Challenge |
| **Next lesson** | Lesson 17 — Designing An Investigation |
...
**The conceptual step.** A guarantee named without its violating observation is a slogan. The review enforces the pairing.
...
**What depends on it.** Lesson 17 — Designing An Investigation — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A guarantee named without its violating observation is a slogan. The review enforces the pairing.
...
1. A guarantee named with its violation.
2. A violation judged genuinely observable.

### One non-example

A guarantee named with no violation offered.
...
Whether the pairing requirement is habitual.
...
| Statement | Status |
|---|---|
| A guarantee named without its violating observation is a slogan. | Framework-derived, appropriate at this grade |
| Whether the pairing requirement is habitual. | What this specific activity can show |
| Whether the guarantees hold. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — Guarantees Under Challenge — specifically: students defend a guarantee against a challenge.

**How it was taught.** Through the activity: defend two guarantees against written challenges

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: defend two guarantees against written challenges, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A guarantee named with its violation. |
| **Non-example** | A guarantee named with no violation offered. |
...
> "A guarantee you cannot defend is a slogan after all."
...
**Exact wording.** "Ask them to name six and give the violating observation for two."
...
**Target observation.** Whether the pairing requirement is habitual.
...
> "A guarantee named without its violating observation is a slogan. You just saw that when ask them to name six and give the violating observation for two.
> Last time we said: A guarantee you cannot defend is a slogan after all. This is the next part of that.
...
**The example.** A guarantee named with its violation.
...
**Completed answer.** A guarantee named with its violation. — which demonstrates whether the pairing requirement is habitual.
...
**Teacher prompt.** "Here is a second case. A violation judged genuinely observable. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A guarantee named with no violation offered. Why is this not an
example?"
...
**Exact student instructions.** Review with the full set recalled and four violations produced.
...
- *Licensed conclusion.* Whether the pairing requirement is habitual.
...
- *Expected response.* Whether the pairing requirement is habitual.
...
1. Any wording carrying the idea in `A guarantee named without its violating observation is a slogan`.
...
Say: "Next time: designing something somebody else could run."
...
| | |
|---|---|
| **Follows** | Lesson 15 — Guarantees Under Challenge |
| **Leads to** | Lesson 17 — Designing An Investigation |

**Transition in.** Lesson 15 established students defend a guarantee against a challenge. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the guarantee set. Lesson 17 assumes it and builds students design an investigation with a reproducible method.
