...
| | |
|---|---|
| **Central question** | The Design Review: students consolidate reproducible design? |
| **Core concept** | The outcome definition is the most commonly omitted design element. |
| **Student outcome** | Students consolidate reproducible design. |
| **Previous lesson** | Lesson 23 — The Defended Investigation |
| **Next lesson** | Lesson 25 — Somebody Else Explains It |
...
**The conceptual step.** The outcome definition is the most commonly omitted design element. Without it, the result cannot be classified consistently.
...
**What depends on it.** Lesson 25 — Somebody Else Explains It — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The outcome definition is the most commonly omitted design element. Without it, the result cannot be classified consistently.
...
1. A design audited and the missing outcome definition found.
2. A design confirmed complete on all six elements.

### One non-example

A design accepted with the outcome undefined.
...
Whether all six elements are habitual.

### What this activity does not establish

Whether the designs would work.
...
| Statement | Status |
|---|---|
| The outcome definition is the most commonly omitted design element. | Framework-derived, appropriate at this grade |
| Whether all six elements are habitual. | What this specific activity can show |
| Whether the designs would work. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — The Defended Investigation — specifically: students present an investigation and defend its method.

**How it was taught.** Through the activity: a five-minute presentation with three questions taken, one on reproducibility

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: a five-minute presentation with three questions taken, one on reproducibility, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A design audited and the missing outcome definition found. |
| **Non-example** | A design accepted with the outcome undefined. |
...
> "Next year: how you would measure any of this properly."
...
**Exact wording.** "Ask which of the six elements people leave out."
...
**Target observation.** Whether all six elements are habitual.
...
> "The outcome definition is the most commonly omitted design element. You just saw that when ask which of the six elements people leave out.
> Last time we said: Next year: how you would measure any of this properly. This is the next part of that.
...
**What students must not infer.** Whether the designs would work.

### 4. Worked example

**The example.** A design audited and the missing outcome definition found.
...
**Completed answer.** A design audited and the missing outcome definition found. — which demonstrates whether all six elements are habitual.
...
**Conclusions not licensed.** Whether the designs would work.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A design confirmed complete on all six elements. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A design accepted with the outcome undefined. Why is this not an
example?"
...
**Exact student instructions.** Review with six designs audited for the missing element.
...
- *Licensed conclusion.* Whether all six elements are habitual.
- *Not licensed.* Whether the designs would work.
...
- *Expected response.* Whether all six elements are habitual.
...
1. Any wording carrying the idea in `The outcome definition is the most commonly omitted design element`.
...
Say: "Next time: what else explains your result."
...
| | |
|---|---|
| **Follows** | Lesson 23 — The Defended Investigation |
| **Leads to** | Lesson 25 — Somebody Else Explains It |

**Transition in.** Lesson 23 established students present an investigation and defend its method. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate reproducible design. Lesson 25 assumes it and builds students find an explanation of their result that does not use TFL.
