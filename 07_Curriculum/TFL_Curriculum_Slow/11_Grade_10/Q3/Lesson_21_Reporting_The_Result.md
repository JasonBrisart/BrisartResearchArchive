# Lesson 21 — Reporting The Result
...
| | |
|---|---|
| **Central question** | Reporting The Result: students report a result without interpreting it? |
| **Core concept** | A results section reports what was observed. |
| **Student outcome** | Students report a result without interpreting it. |
| **Previous lesson** | Lesson 20 — Running The Investigation |
| **Next lesson** | Lesson 22 — What My Design Cannot See |
...
**The conceptual step.** A results section reports what was observed. Interpretation belongs elsewhere, and a reader must be able to reach a different conclusion from the same results.
...
**What depends on it.** Lesson 22 — What My Design Cannot See — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A results section reports what was observed. Interpretation belongs elsewhere, and a reader must be able to reach a different conclusion from the same results.
...
1. A results section stating counts and observations only.
2. A section cleaned of the word clearly.

### One non-example

A results section explaining what the numbers mean.
...
| Statement | Status |
|---|---|
| A results section reports what was observed. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 20 — Running The Investigation — specifically: students execute their repaired design and collect data.

**How it was taught.** Through the activity: execute the investigation and produce a contemporaneous record

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: execute the investigation and produce a contemporaneous record, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A results section stating counts and observations only. |
| **Non-example** | A results section explaining what the numbers mean. |
...
> "Recorded as you go is the only kind that counts."
...
**Exact wording.** "Put up a report with interpretation woven through and ask where reporting stops."
...
> "A results section reports what was observed. You just saw that when put up a report with interpretation woven through and ask where reporting stops.
> Last time we said: Recorded as you go is the only kind that counts. This is the next part of that.
...
**The example.** A results section stating counts and observations only.
...
**Completed answer.** A results section stating counts and observations only. — which demonstrates that reporting and interpreting are separable.
...
**Teacher prompt.** "Here is a second case. A section cleaned of the word clearly. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A results section explaining what the numbers mean. Why is this not an
example?"
...
1. Any wording carrying the idea in `A results section reports what was observed`.
...
Say: "A reader must be able to disagree with your conclusion from your results."
...
| | |
|---|---|
| **Follows** | Lesson 20 — Running The Investigation |
| **Leads to** | Lesson 22 — What My Design Cannot See |

**Transition in.** Lesson 20 established students execute their repaired design and collect data. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students report a result without interpreting it. Lesson 22 assumes it and builds students state the limits of their own investigation.
