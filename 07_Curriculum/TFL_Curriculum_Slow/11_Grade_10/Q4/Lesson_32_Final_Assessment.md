...
| **Core concept** | The four exit outcomes together constitute readiness for Grade 11, which introduces formal measurement and the rival accounts. |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 11, which introduces formal measurement and the rival accounts.
...
The four exit outcomes together constitute readiness for Grade 11, which introduces formal measurement and the rival accounts.
...
2. A student states exclusive gating with all three denials.

### One non-example

A student who states gating without the denials.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 11, which introduces formal measurement and the rival accounts. | Framework-derived, appropriate at this grade |
...
| **Non-example** | A student who states gating without the denials. |
...
> "The four exit outcomes together constitute readiness for Grade 11, which introduces formal measurement and the rival accounts. You just saw that when say: everything you know, on your own.
...
**Teacher prompt.** "Here is a second case. A student states exclusive gating with all three denials. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student who states gating without the denials. Why is this not an
example?"
...
**Exact student instructions.** The final: both relations, exclusive gating with three denials, a violating observation, a reproducible method.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 11, which introduces formal measurement and the rival accounts`.
...
Say: "Next year: measurement, and the three accounts that explain your data as well as this one."
