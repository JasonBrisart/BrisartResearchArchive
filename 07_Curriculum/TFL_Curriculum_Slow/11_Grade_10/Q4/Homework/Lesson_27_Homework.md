# Lesson 27 Homework — Separating Explanations

**Grade 10** · The Gate and the Guarantees · **Quarter 4**
**Follows:** Lesson 27 — Separating Explanations · **Points:** 5 · **Optional:** yes
...
For three results, name a separating observation and say which it favours.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names a separator for at least two
...
Lesson 28 is **Redesigning To Separate**, which assumes you arrive holding it. Write one thing you expect it to be about:
