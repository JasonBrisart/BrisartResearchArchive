# Session 16 — The Executability Test
...
| | |
|---|---|
| **Central question** | The Executability Test: students test the whole design by external execution? |
| **Core concept** | Executability is tested by a reader unfamiliar with the project. |
| **Student outcome** | Students test the whole design by external execution. |
| **Previous session** | Session 15 — Repairing The Design |
| **Next session** | Session 17 — Repairing For Executability |
...
**The conceptual step.** Executability is tested by a reader unfamiliar with the project. A reader who knows the work fills gaps silently and produces a false result.
...
**What depends on it.** Session 17 — Repairing For Executability — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Executability is tested by a reader unfamiliar with the project. A reader who knows the work fills gaps silently and produces a false result.
...
1. A question list from a reader outside the project's topic.
2. A design revised after eight questions were returned.

### One non-example

A design tested by a collaborator who knows the project.
...
That executability requires an unfamiliar reader.

### What this activity does not establish

Whether the design produces good data.
...
| Statement | Status |
|---|---|
| Executability is tested by a reader unfamiliar with the project. | Framework-derived, appropriate at this grade |
| That executability requires an unfamiliar reader. | What this specific activity can show |
| Whether the design produces good data. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 15 — Repairing The Design — specifically: students revise the design against every source of feedback.

**How it was taught.** Through the activity: a revised design with a change log naming the source of each change

**Quick check.** Ask for the closing sentence of Session 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 15: a revised design with a change log naming the source of each change, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A question list from a reader outside the project's topic. |
| **Non-example** | A design tested by a collaborator who knows the project. |
...
> "A revision without a log is a rewrite."
...
**Exact wording.** "Return the Session 1 drafts with their original markings. Say: that distance is the course."
...
**Target observation.** That executability requires an unfamiliar reader.
...
> "Executability is tested by a reader unfamiliar with the project. You just saw that when return the Session 1 drafts with their original markings.
> Last time we said: A revision without a log is a rewrite. This is the next part of that.
...
**What students must not infer.** Whether the design produces good data.

### 4. Worked example

**The example.** A question list from a reader outside the project's topic.
...
**Completed answer.** A question list from a reader outside the project's topic. — which demonstrates that executability requires an unfamiliar reader.
...
**Conclusions not licensed.** Whether the design produces good data.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A design revised after eight questions were returned. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A design tested by a collaborator who knows the project. Why is this not an
example?"
...
**Exact student instructions.** Exchange complete designs, attempt execution, and return full question lists.
...
- *Licensed conclusion.* That executability requires an unfamiliar reader.
- *Not licensed.* Whether the design produces good data.
...
- *Expected response.* That executability requires an unfamiliar reader.
...
1. Any wording carrying the idea in `Executability is tested by a reader unfamiliar with the project`.
...
Say: "The list is your grade on executability."
...
| | |
|---|---|
| **Follows** | Session 15 — Repairing The Design |
| **Leads to** | Session 17 — Repairing For Executability |

**Transition in.** Session 15 established students revise the design against every source of feedback. This session uses that as the starting point.

**Transition out.** This session establishes students test the whole design by external execution. Session 17 assumes it and builds students revise against the executability list.
