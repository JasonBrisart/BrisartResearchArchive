# Session 14 Homework — Reading The Examination

**Master's Year 1** · Executable Measurement · **Quarter 3**
**Follows:** Session 14 — Reading The Examination · **Points:** 5 · **Optional:** yes
...
Convert examination weaknesses into two specific design revisions.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces two design revisions from the paper
...
Session 15 is **Repairing The Design**, which assumes you arrive holding it. Write one thing you expect it to be about:
