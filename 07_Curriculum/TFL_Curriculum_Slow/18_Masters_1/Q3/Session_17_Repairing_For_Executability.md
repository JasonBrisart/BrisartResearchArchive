# Session 17 — Repairing For Executability
...
| | |
|---|---|
| **Central question** | Repairing For Executability: students revise against the executability list? |
| **Core concept** | Repair converts each question into an explicit line. |
| **Student outcome** | Students revise against the executability list. |
| **Previous session** | Session 16 — The Executability Test |
| **Next session** | Session 18 — Human Subjects And Institutional Duty |
...
**The conceptual step.** Repair converts each question into an explicit line. A second test with a different reader and fewer questions is the evidence the repair worked.
...
**What depends on it.** Session 18 — Human Subjects And Institutional Duty — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Repair converts each question into an explicit line. A second test with a different reader and fewer questions is the evidence the repair worked.
...
1. A second test producing three questions rather than eight.
2. A repair adding explicit timing to an ambiguous step.

### One non-example

A defence that the original wording was adequate.
...
That repair is measurable by re-testing.

### What this activity does not establish

Whether the design is now complete.
...
| Statement | Status |
|---|---|
| Repair converts each question into an explicit line. | Framework-derived, appropriate at this grade |
| That repair is measurable by re-testing. | What this specific activity can show |
| Whether the design is now complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 16 — The Executability Test — specifically: students test the whole design by external execution.

**How it was taught.** Through the activity: exchange complete designs, attempt execution, and return full question lists

**Quick check.** Ask for the closing sentence of Session 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 16: exchange complete designs, attempt execution, and return full question lists, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A second test producing three questions rather than eight. |
| **Non-example** | A defence that the original wording was adequate. |
...
> "The list is your grade on executability."
...
**Exact wording.** "Say: every question becomes a line."
...
**Target observation.** That repair is measurable by re-testing.
...
> "Repair converts each question into an explicit line. You just saw that when say: every question becomes a line.
> Last time we said: The list is your grade on executability. This is the next part of that.
...
**What students must not infer.** Whether the design is now complete.

### 4. Worked example

**The example.** A second test producing three questions rather than eight.
...
**Completed answer.** A second test producing three questions rather than eight. — which demonstrates that repair is measurable by re-testing.
...
**Conclusions not licensed.** Whether the design is now complete.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A repair adding explicit timing to an ambiguous step. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence that the original wording was adequate. Why is this not an
example?"
...
**Exact student instructions.** Repair and run a second executability test with a different reader.
...
- *Licensed conclusion.* That repair is measurable by re-testing.
- *Not licensed.* Whether the design is now complete.
...
- *Expected response.* That repair is measurable by re-testing.
...
1. Any wording carrying the idea in `Repair converts each question into an explicit line`.
...
Say: "If the second matches the first, the repair missed."
...
| | |
|---|---|
| **Follows** | Session 16 — The Executability Test |
| **Leads to** | Session 18 — Human Subjects And Institutional Duty |

**Transition in.** Session 16 established students test the whole design by external execution. This session uses that as the starting point.

**Transition out.** This session establishes students revise against the executability list. Session 18 assumes it and builds students state the obligations attached to running studies on people.
