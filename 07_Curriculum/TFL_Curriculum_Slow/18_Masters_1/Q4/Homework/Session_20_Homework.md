# Session 20 Homework — The Design Portfolio

**Master's Year 1** · Executable Measurement · **Quarter 4**
**Follows:** Session 20 — The Design Portfolio · **Points:** 5 · **Optional:** yes
...
Assemble all nine components and self-audit against the gate.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every portfolio contains all nine components
...
Session 21 is **Rehearsing The Defence**, which assumes you arrive holding it. Write one thing you expect it to be about:
