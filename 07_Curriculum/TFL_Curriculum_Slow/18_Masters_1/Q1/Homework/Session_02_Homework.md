# Session 2 Homework — Capturing Sim(t) At Research Standard

**Master's Year 1** · Executable Measurement · **Quarter 1**
**Follows:** Session 2 — Capturing Sim(t) At Research Standard · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 2 ended on, from memory:
...
Write the full protocol with prompt, timing, scoring, scorer knowledge, and three worked examples.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every protocol names who scores and how reliability is reported
...
Session 3 is **Measuring E(t) Without Circularity**, which assumes you arrive holding it. Write one thing you expect it to be about:
