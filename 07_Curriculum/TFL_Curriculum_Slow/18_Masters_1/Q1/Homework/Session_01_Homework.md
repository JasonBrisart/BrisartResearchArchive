# Session 1 Homework — Most Uses Are Not Tests

**Master's Year 1** · Executable Measurement · **Quarter 1**
**Follows:** Session 1 — Most Uses Are Not Tests · **Points:** 5 · **Optional:** yes
...
Draft a measurement map, swap, and have a partner mark every unexecutable line.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every draft returns marked and the student can say why
...
Session 2 is **Capturing Sim(t) At Research Standard**, which assumes you arrive holding it. Write one thing you expect it to be about:
