...
| | |
|---|---|
| **Central question** | The Map Assembled: students assemble all instruments into one executable map? |
| **Core concept** | Executability is established by independent handover to two markers. |
| **Student outcome** | Students assemble all instruments into one executable map. |
| **Previous session** | Session 6 — Can You Estimate The Weights |
...
**The conceptual step.** Executability is established by independent handover to two markers. A single clean run may reflect a charitable reader rather than a complete map.
...
Executability is established by independent handover to two markers. A single clean run may reflect a charitable reader rather than a complete map.
...
1. A map returning zero questions from one of two markers.
2. A map revised after the first marker found four gaps.

### One non-example

A map declared complete after one reader had no questions.
...
That executability requires independent verification.
...
| Statement | Status |
|---|---|
| Executability is established by independent handover to two markers. | Framework-derived, appropriate at this grade |
| That executability requires independent verification. | What this specific activity can show |
| Whether the map yields valid data. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 6 — Can You Estimate The Weights — specifically: students determine honestly whether their design can recover parameters.

**How it was taught.** Through the activity: write the feasibility statement listing which claims survive without the weights

**Quick check.** Ask for the closing sentence of Session 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 6: write the feasibility statement listing which claims survive without the weights, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A map returning zero questions from one of two markers. |
| **Non-example** | A map declared complete after one reader had no questions. |
...
> "Most course designs cannot. Declaring it is the correct answer."
...
**Exact wording.** "Say: seven lines. Nobody should have a question."
...
**Target observation.** That executability requires independent verification.
...
> "Executability is established by independent handover to two markers. You just saw that when say: seven lines.
> Last time we said: Most course designs cannot. Declaring it is the correct answer. This is the next part of that.
...
**The example.** A map returning zero questions from one of two markers.
...
**Completed answer.** A map returning zero questions from one of two markers. — which demonstrates that executability requires independent verification.
...
**Teacher prompt.** "Here is a second case. A map revised after the first marker found four gaps. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A map declared complete after one reader had no questions. Why is this not an
example?"
...
**Exact student instructions.** Rebuild the map and have two people mark it independently.
...
- *Licensed conclusion.* That executability requires independent verification.
...
- *Expected response.* That executability requires independent verification.
...
1. Any wording carrying the idea in `Executability is established by independent handover to two markers`.
...
Say: "That is what executable means."
...
| | |
|---|---|
| **Follows** | Session 6 — Can You Estimate The Weights |
| **Leads to** | Session 8 — Designing To Adjudicate |

**Transition in.** Session 6 established students determine honestly whether their design can recover parameters. This session uses that as the starting point.

**Transition out.** This session establishes students assemble all instruments into one executable map. Session 8 assumes it and builds students build a design entering the discriminating condition.
