# Session 10 Homework — The Analysis Plan

**Master's Year 1** · Executable Measurement · **Quarter 2**
**Follows:** Session 10 — The Analysis Plan · **Points:** 5 · **Optional:** yes
...
Complete the ten-item plan and peer-audit whether the condition could fire.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every plan contains all ten items including the unscoreable rule
...
Session 11 is **Scope Enforcement In Design**, which assumes you arrive holding it. Write one thing you expect it to be about:
