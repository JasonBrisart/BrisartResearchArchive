...
| | |
|---|---|
| **Central question** | The Evidence Review: students consolidate evidence? |
| **Core concept** | The pointing test is the operational definition of evidence at this grade. |
| **Student outcome** | Students consolidate evidence. |
| **Previous lesson** | Lesson 15 — Evidence In Other Lessons |
| **Next lesson** | Lesson 17 — The Pattern Break |
...
**The conceptual step.** The pointing test is the operational definition of evidence at this grade. The review checks whether it is applied consistently.
...
**What depends on it.** Lesson 17 — The Pattern Break — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The pointing test is the operational definition of evidence at this grade. The review checks whether it is applied consistently.
...
1. The timetable sorted as evidence.
2. Being certain sorted as not-evidence.

### One non-example

Sorting by whether the claim seems true.
...
Whether the pointing test is habitual.

### What this activity does not establish

Any finer distinction of evidence types.
...
| Statement | Status |
|---|---|
| The pointing test is the operational definition of evidence at this grade. | Framework-derived, appropriate at this grade |
| Whether the pointing test is habitual. | What this specific activity can show |
| Any finer distinction of evidence types. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — Evidence In Other Lessons — specifically: students apply evidence to claims from other subjects.

**How it was taught.** Through the activity: four cross-subject claims, each evidenced

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: four cross-subject claims, each evidenced, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The timetable sorted as evidence. |
| **Non-example** | Sorting by whether the claim seems true. |
...
**Exact wording.** "Ask what evidence is and what it is not."
...
**Target observation.** Whether the pointing test is habitual.
...
> "The pointing test is the operational definition of evidence at this grade. You just saw that when ask what evidence is and what it is not.
> Last time we said: Evidence works everywhere. This is the next part of that.
...
**What students must not infer.** Any finer distinction of evidence types.

### 4. Worked example

**The example.** The timetable sorted as evidence.
...
**Completed answer.** The timetable sorted as evidence. — which demonstrates whether the pointing test is habitual.
...
**Conclusions not licensed.** Any finer distinction of evidence types.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Being certain sorted as not-evidence. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Sorting by whether the claim seems true. Why is this not an
example?"
...
**Exact student instructions.** Review with eight items sorted into evidence and not-evidence.
...
- *Licensed conclusion.* Whether the pointing test is habitual.
- *Not licensed.* Any finer distinction of evidence types.
...
- *Expected response.* Whether the pointing test is habitual.
...
1. Any wording carrying the idea in `The pointing test is the operational definition of evidence at this grade`.
...
Say: "Next time: how many times it takes to change an expectation."
...
| | |
|---|---|
| **Follows** | Lesson 15 — Evidence In Other Lessons |
| **Leads to** | Lesson 17 — The Pattern Break |

**Transition in.** Lesson 15 established students apply evidence to claims from other subjects. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate evidence. Lesson 17 assumes it and builds students record how expectations survive a single contradiction.
