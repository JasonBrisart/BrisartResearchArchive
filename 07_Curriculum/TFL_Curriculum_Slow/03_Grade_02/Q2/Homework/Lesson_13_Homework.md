# Lesson 13 Homework — Evidence Somebody Else Can Check

**Grade 2** · Comparing and Checking · **Quarter 2**
**Follows:** Lesson 13 — Evidence Somebody Else Can Check · **Points:** 5 · **Optional:** yes
...
Each student checks a partner's three evidence items.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student receives a checked sheet
...
Lesson 14 is **Changing Your Mind**, which assumes you arrive holding it. Write one thing you expect it to be about:
