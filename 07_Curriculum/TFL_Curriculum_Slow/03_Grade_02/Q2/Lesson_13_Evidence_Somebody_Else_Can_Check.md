# Lesson 13 — Evidence Somebody Else Can Check
...
| | |
|---|---|
| **Central question** | Evidence Somebody Else Can Check: students test whether a partner can verify their evidence? |
| **Core concept** | Evidence has to be checkable by somebody other than the person who offered it. |
| **Student outcome** | Students test whether a partner can verify their evidence. |
| **Previous lesson** | Lesson 12 — Collecting Evidence |
| **Next lesson** | Lesson 14 — Changing Your Mind |
...
**The conceptual step.** Evidence has to be checkable by somebody other than the person who offered it. Physical pointing is the test at this grade.
...
**What depends on it.** Lesson 14 — Changing Your Mind — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Evidence has to be checkable by somebody other than the person who offered it. Physical pointing is the test at this grade.
...
1. A partner points at the timetable and confirms it.
2. A partner cannot find the thing being pointed at.

### One non-example

Accepting evidence because the partner seems sure.
...
That evidence must be externally checkable.

### What this activity does not establish

Whether the evidence supports the claim strongly.
...
| Statement | Status |
|---|---|
| Evidence has to be checkable by somebody other than the person who offered it. | Framework-derived, appropriate at this grade |
| That evidence must be externally checkable. | What this specific activity can show |
| Whether the evidence supports the claim strongly. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — Collecting Evidence — specifically: students gather evidence deliberately before making a claim.

**How it was taught.** Through the activity: evidence-first task: collect three observations, then write one claim they support

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: evidence-first task: collect three observations, then write one claim they support, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A partner points at the timetable and confirms it. |
| **Non-example** | Accepting evidence because the partner seems sure. |
...
> "Collecting first stops you deciding first."
...
**Exact wording.** "Swap evidence sheets and ask whether they can actually check theirs."
...
**Target observation.** That evidence must be externally checkable.
...
> "Evidence has to be checkable by somebody other than the person who offered it. You just saw that when swap evidence sheets and ask whether they can actually check theirs.
> Last time we said: Collecting first stops you deciding first. This is the next part of that.
...
**What students must not infer.** Whether the evidence supports the claim strongly.

### 4. Worked example

**The example.** A partner points at the timetable and confirms it.
...
**Completed answer.** A partner points at the timetable and confirms it. — which demonstrates that evidence must be externally checkable.
...
**Conclusions not licensed.** Whether the evidence supports the claim strongly.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A partner cannot find the thing being pointed at. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Accepting evidence because the partner seems sure. Why is this not an
example?"
...
**Exact student instructions.** Each student checks a partner's three evidence items.
...
- *Licensed conclusion.* That evidence must be externally checkable.
- *Not licensed.* Whether the evidence supports the claim strongly.
...
- *Expected response.* That evidence must be externally checkable.
...
1. Any wording carrying the idea in `Evidence has to be checkable by somebody other than the person who offered it`.
...
Say: "Evidence somebody else cannot check is not finished."
...
| | |
|---|---|
| **Follows** | Lesson 12 — Collecting Evidence |
| **Leads to** | Lesson 14 — Changing Your Mind |

**Transition in.** Lesson 12 established students gather evidence deliberately before making a claim. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students test whether a partner can verify their evidence. Lesson 14 assumes it and builds students revise a claim when evidence does not support it.
