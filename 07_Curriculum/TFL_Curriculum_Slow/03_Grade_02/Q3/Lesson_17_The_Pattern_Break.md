...
| | |
|---|---|
| **Central question** | The Pattern Break: students record how expectations survive a single contradiction? |
| **Core concept** | A single contradiction produces a drop that recovers. |
| **Student outcome** | Students record how expectations survive a single contradiction. |
| **Previous lesson** | Lesson 16 — The Evidence Review |
| **Next lesson** | Lesson 18 — How Many Breaks |
...
**The conceptual step.** A single contradiction produces a drop that recovers. The tally shows this as numbers, which is harder to dispute than an impression.
...
**What depends on it.** Lesson 18 — How Many Breaks — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A single contradiction produces a drop that recovers. The tally shows this as numbers, which is harder to dispute than an impression.
...
1. The count drops at card six and recovers by seven.
2. Most students expect circle again immediately after the square.

### One non-example

A tally completed from memory after all nine cards.
...
That one contradiction does not remove an expectation.

### What this activity does not establish

How many it would take, which is next lesson.
...
| Statement | Status |
|---|---|
| A single contradiction produces a drop that recovers. | Framework-derived, appropriate at this grade |
| That one contradiction does not remove an expectation. | What this specific activity can show |
| How many it would take, which is next lesson. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Evidence Review — specifically: students consolidate evidence.

**How it was taught.** Through the activity: review with eight items sorted into evidence and not-evidence

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with eight items sorted into evidence and not-evidence, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The count drops at card six and recovers by seven. |
| **Non-example** | A tally completed from memory after all nine cards. |
...
> "Next time: how many times it takes to change an expectation."
...
**Exact wording.** "Four circles, then a square. Written expectations before each card."
...
**Target observation.** That one contradiction does not remove an expectation.
...
> "A single contradiction produces a drop that recovers. You just saw that when four circles, then a square.
> Last time we said: Next time: how many times it takes to change an expectation. This is the next part of that.
...
**What students must not infer.** How many it would take, which is next lesson.

### 4. Worked example

**The example.** The count drops at card six and recovers by seven.
...
**Completed answer.** The count drops at card six and recovers by seven. — which demonstrates that one contradiction does not remove an expectation.
...
**Conclusions not licensed.** How many it would take, which is next lesson.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Most students expect circle again immediately after the square. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A tally completed from memory after all nine cards. Why is this not an
example?"
...
**Exact student instructions.** Nine-card tally showing the drop and the recovery.
...
- *Licensed conclusion.* That one contradiction does not remove an expectation.
- *Not licensed.* How many it would take, which is next lesson.
...
- *Expected response.* That one contradiction does not remove an expectation.
...
1. Any wording carrying the idea in `A single contradiction produces a drop that recovers`.
...
Say: "One break did not change it."
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Evidence Review |
| **Leads to** | Lesson 18 — How Many Breaks |

**Transition in.** Lesson 16 established students consolidate evidence. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students record how expectations survive a single contradiction. Lesson 18 assumes it and builds students count contradictions needed for a durable change.
