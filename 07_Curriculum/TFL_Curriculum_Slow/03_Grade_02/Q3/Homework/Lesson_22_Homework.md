# Lesson 22 Homework — Designing A Change

**Grade 2** · Comparing and Checking · **Quarter 3**
**Follows:** Lesson 22 — Designing A Change · **Points:** 5 · **Optional:** yes
...
Each student designs and runs a three-break trial on a partner.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student runs a trial and records the number
...
Lesson 23 is **The Failed Trial**, which assumes you arrive holding it. Write one thing you expect it to be about:
