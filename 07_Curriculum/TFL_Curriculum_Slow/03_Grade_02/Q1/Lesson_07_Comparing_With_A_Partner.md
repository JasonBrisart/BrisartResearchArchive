# Lesson 7 — Comparing With A Partner

**Grade 2** · Comparing and Checking · **Quarter 1** · **30 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Comparing With A Partner: students run a full comparison with a partner on a shared event? |
| **Core concept** | Position determines what is available to notice, which determines what is remembered and expected. |
| **Student outcome** | Students run a full comparison with a partner on a shared event. |
| **Previous lesson** | Lesson 6 — When One Is Wrong |
| **Next lesson** | Lesson 8 — The Comparison Review |
| **Materials** | Notebooks; chart paper |
| **Preparation** | five to ten minutes |
| **Student printout** | `Printouts/Lesson_07_Printout.md` |
| **Homework** | `Homework/Lesson_07_Homework.md` |

## Why this lesson exists

**The conceptual step.** Position determines what is available to notice, which determines what is remembered and expected. The cause of the difference is locatable.

**Why students need it now.** This grade owns one idea: evidence. A claim now has to be supported by something you can point at.
...
that one of the two expectations must be wrong. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Two connected written sentences, or a short paragraph. A claim must be followed by the evidence for it.

**What depends on it.** Lesson 8 — The Comparison Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Position determines what is available to notice, which determines what is remembered and expected. The cause of the difference is locatable.

### How this is stated at this grade

Two connected written sentences, or a short paragraph. A claim must be followed by the evidence for it.

Use only the vocabulary released at or before this grade. Terms not yet available:
Right now as a combined state, carry forward, all notation.

### Why the concept matters

The whole grade rests on evidence. A claim now has to be supported by something you can point at. If a student leaves this
...
1. One student could see the door, the other could not.
2. One student heard the announcement, the other was further away.

### One non-example

Two students in the same position producing the same account.
...
That position causes differences in expectation.

### What this activity does not establish

That either account is complete.
...
| Statement | Status |
|---|---|
| Position determines what is available to notice, which determines what is remembered and expected. | Framework-derived, appropriate at this grade |
| That position causes differences in expectation. | What this specific activity can show |
| That either account is complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — When One Is Wrong — specifically: students handle the case where one expectation was checkable and wrong.

**How it was taught.** Through the activity: three cases sorted: both reasonable, one falsified, or not yet checkable

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: three cases sorted: both reasonable, one falsified, or not yet checkable, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | put two things side by side and say how they differ. |
| **Student wording** | Put two things side by side and say how they differ. |
| **Correct example** | One student could see the door, the other could not. |
| **Non-example** | Two students in the same position producing the same account. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for put two things side by side and say how they differ." |

### evidence

| | |
|---|---|
| **Teacher definition** | the thing you point at to show your answer is right. |
| **Student wording** | The thing you point at to show your answer is right. |
| **Correct example** | One student could see the door, the other could not. |
| **Non-example** | Two students in the same position producing the same account. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for the thing you point at to show your answer is right." |

### change

| | |
|---|---|
| **Teacher definition** | when an expectation is different the second time. |
| **Student wording** | When an expectation is different the second time. |
| **Correct example** | One student could see the door, the other could not. |
| **Non-example** | Two students in the same position producing the same account. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for when an expectation is different the second time." |


Do not introduce terminology from later grades. Right now as a combined state, carry forward, all notation.

## Materials and preparation

**Teacher materials.** Notebooks; Chart paper; Index cards with shape patterns; Printed comparison tables; An audio source.
...
> "Sometimes one is wrong. That is different from disagreeing."
...
**Exact wording.** "Stage a small event with two students in different positions."
...
**Target observation.** That position causes differences in expectation.
...
> "Position determines what is available to notice, which determines what is remembered and expected. You just saw that when stage a small event with two students in different positions.
> Last time we said: Sometimes one is wrong. That is different from disagreeing. This is the next part of that.
> It matters because i can compare two expectations and say what made them different"
...
**Terminology to introduce here.** compare, evidence, change.

**What students must not infer.** That either account is complete.

### 4. Worked example

**The example.** One student could see the door, the other could not.
...
**Completed answer.** One student could see the door, the other could not. — which demonstrates that position causes differences in expectation.
...
**Conclusions not licensed.** That either account is complete.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. One student heard the announcement, the other was further away. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two students in the same position producing the same account. Why is this not an
example?"
...
**Exact student instructions.** Both reconstruct, then compare and name the cause of the difference.
...
- *Licensed conclusion.* That position causes differences in expectation.
- *Not licensed.* That either account is complete.
...
- *Expected response.* That position causes differences in expectation.
...
3. **Misconception check.** Somebody says: "One of the two expectations must be wrong" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `Position determines what is available to notice, which determines what is remembered and expected`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Different does not mean one of you was wrong.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "One event. Two different expectations."
...
### 1. "One of the two expectations must be wrong"

**What the student says or does.** One of the two expectations must be wrong — usually while otherwise engaging well.

**Why it is understandable.** School usually frames difference as error.
...
**Exact correction.** Use a case where both were reasonable and neither checkable.

**Say this.** "Different does not mean one of you was wrong."
...
### 2. "Evidence means saying it louder"

**What the student says or does.** Evidence means saying it louder — usually while otherwise engaging well.

**Why it is understandable.** Students conflate confidence with support.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Ask them to point at the thing.

**Say this.** "If you cannot point at it, it is not evidence yet."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "If my expectation changed, my first one was a mistake"

**What the student says or does.** If my expectation changed, my first one was a mistake — usually while otherwise engaging well.

**Why it is understandable.** Change reads as correction rather than update.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Show a case where the first was correct and the situation changed.

**Say this.** "Something new arrived, so it updated. That is the system working."
...
**Visual or physical support.** Give the comparison as a printed two-column table with the claim pre-started.
...
Ask for two of their own expectations that disagreed at the same time.
...
Specifically, do not introduce: Right now as a combined state, carry forward, all notation.
...
| | |
|---|---|
| **Follows** | Lesson 6 — When One Is Wrong |
| **Leads to** | Lesson 8 — The Comparison Review |

**Transition in.** Lesson 6 established students handle the case where one expectation was checkable and wrong. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students run a full comparison with a partner on a shared event. Lesson 8 assumes it and builds students consolidate comparison.
