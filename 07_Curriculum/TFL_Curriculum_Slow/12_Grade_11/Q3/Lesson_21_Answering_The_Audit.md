...
| | |
|---|---|
| **Central question** | Answering The Audit: students revise a design against adversarial feedback? |
| **Core concept** | A design that answers all three rival attacks is worth running. |
| **Student outcome** | Students revise a design against adversarial feedback. |
| **Previous lesson** | Lesson 20 — The Adversarial Audit |
| **Next lesson** | Lesson 22 — Reconciling Conflicting Evidence |
...
**The conceptual step.** A design that answers all three rival attacks is worth running. Dismissing all three usually means the attacks were not heard.
...
**What depends on it.** Lesson 22 — Reconciling Conflicting Evidence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A design that answers all three rival attacks is worth running. Dismissing all three usually means the attacks were not heard.
...
1. A revision adding a control that answers the arousal attack.
2. A revision conceding one attack and narrowing the claim.

### One non-example

All three attacks dismissed as not applying.
...
Whether the revised design would work.
...
| Statement | Status |
|---|---|
| A design that answers all three rival attacks is worth running. | Framework-derived, appropriate at this grade |
| That designs improve under adversarial revision. | What this specific activity can show |
| Whether the revised design would work. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — The Adversarial Audit — specifically: students attack a design using an assigned rival account.

**How it was taught.** Through the activity: three rotating rounds of written attack; designers take notes without defending

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: three rotating rounds of written attack; designers take notes without defending, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A revision adding a control that answers the arousal attack. |
| **Non-example** | All three attacks dismissed as not applying. |
...
> "If a design cannot survive this room, it will not survive anywhere."
...
**Exact wording.** "Ask which of the three attacks landed."
...
> "A design that answers all three rival attacks is worth running. You just saw that when ask which of the three attacks landed.
> Last time we said: If a design cannot survive this room, it will not survive anywhere. This is the next part of that.
...
**What students must not infer.** Whether the revised design would work.

### 4. Worked example

**The example.** A revision adding a control that answers the arousal attack.
...
**Completed answer.** A revision adding a control that answers the arousal attack. — which demonstrates that designs improve under adversarial revision.
...
**Conclusions not licensed.** Whether the revised design would work.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A revision conceding one attack and narrowing the claim. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. All three attacks dismissed as not applying. Why is this not an
example?"
...
**Exact student instructions.** Revise the design against all three attacks and state what changed.
...
- *Not licensed.* Whether the revised design would work.
...
1. Any wording carrying the idea in `A design that answers all three rival attacks is worth running`.
...
| | |
|---|---|
| **Follows** | Lesson 20 — The Adversarial Audit |
| **Leads to** | Lesson 22 — Reconciling Conflicting Evidence |

**Transition in.** Lesson 20 established students attack a design using an assigned rival account. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students revise a design against adversarial feedback. Lesson 22 assumes it and builds students handle results that point in different directions.
