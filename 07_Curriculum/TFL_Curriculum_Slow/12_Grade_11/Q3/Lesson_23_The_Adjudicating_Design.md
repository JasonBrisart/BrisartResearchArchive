# Lesson 23 — The Adjudicating Design
...
| | |
|---|---|
| **Central question** | The Adjudicating Design: students present a design that distinguishes the four accounts? |
| **Core concept** | An adjudicating design produces four different predictions. |
| **Student outcome** | Students present a design that distinguishes the four accounts. |
| **Previous lesson** | Lesson 22 — Reconciling Conflicting Evidence |
| **Next lesson** | Lesson 24 — The Confound Review |
...
**The conceptual step.** An adjudicating design produces four different predictions. Predictions that differ only in wording do not adjudicate.
...
**What depends on it.** Lesson 24 — The Confound Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An adjudicating design produces four different predictions. Predictions that differ only in wording do not adjudicate.
...
1. Four predictions that genuinely differ.
2. A presentation answering each rival advocate.

### One non-example

Four predictions differing only in phrasing.
...
Whether the design adjudicates.
...
| Statement | Status |
|---|---|
| An adjudicating design produces four different predictions. | Framework-derived, appropriate at this grade |
| Whether the design adjudicates. | What this specific activity can show |
| Which account the design would favour. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — Reconciling Conflicting Evidence — specifically: students handle results that point in different directions.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: reconcile two conflicting results and name a resolving observation, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Four predictions that genuinely differ. |
| **Non-example** | Four predictions differing only in phrasing. |
...
**Exact wording.** "Say: the map, the condition, four predictions, the confound table, and the blind spots."
...
**Target observation.** Whether the design adjudicates.
...
> "An adjudicating design produces four different predictions. You just saw that when say: the map, the condition, four predictions, the confound table, and the blind spots.
...
**The example.** Four predictions that genuinely differ.
...
**Completed answer.** Four predictions that genuinely differ. — which demonstrates whether the design adjudicates.
...
**Teacher prompt.** "Here is a second case. A presentation answering each rival advocate. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Four predictions differing only in phrasing. Why is this not an
example?"
...
**Exact student instructions.** A six-minute presentation facing one question from each rival advocate.
...
- *Licensed conclusion.* Whether the design adjudicates.
...
- *Expected response.* Whether the design adjudicates.
...
1. Any wording carrying the idea in `An adjudicating design produces four different predictions`.
...
| | |
|---|---|
| **Follows** | Lesson 22 — Reconciling Conflicting Evidence |
| **Leads to** | Lesson 24 — The Confound Review |

**Transition in.** Lesson 22 established students handle results that point in different directions. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students present a design that distinguishes the four accounts. Lesson 24 assumes it and builds students consolidate confound control.
