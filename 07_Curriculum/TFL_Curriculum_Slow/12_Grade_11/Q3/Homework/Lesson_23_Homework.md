# Lesson 23 Homework — The Adjudicating Design

**Grade 11** · Measurement and Rivals · **Quarter 3**
**Follows:** Lesson 23 — The Adjudicating Design · **Points:** 5 · **Optional:** yes
...
A six-minute presentation facing one question from each rival advocate.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the four predictions differ from each other
...
Lesson 24 is **The Confound Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
