# Lesson 19 Homework — Selection Effects

**Grade 11** · Measurement and Rivals · **Quarter 3**
**Follows:** Lesson 19 — Selection Effects · **Points:** 5 · **Optional:** yes
...
Audit their own historical logs for selection bias and estimate its direction.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names a direction for the bias in their own logs
...
Lesson 20 is **The Adversarial Audit**, which assumes you arrive holding it. Write one thing you expect it to be about:
