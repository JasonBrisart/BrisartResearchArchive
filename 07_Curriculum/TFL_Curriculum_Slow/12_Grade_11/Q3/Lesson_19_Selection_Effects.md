...
| | |
|---|---|
| **Central question** | Selection Effects: students identify bias in which predictions get recorded? |
| **Core concept** | Selection bias in logging is unintentional and universal. |
| **Student outcome** | Students identify bias in which predictions get recorded. |
| **Previous lesson** | Lesson 18 — Intensity And Ambiguity |
| **Next lesson** | Lesson 20 — The Adversarial Audit |
...
**The conceptual step.** Selection bias in logging is unintentional and universal. Boring periods produce no entries, which biases the sample toward memorable events.
...
**What depends on it.** Lesson 20 — The Adversarial Audit — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Selection bias in logging is unintentional and universal. Boring periods produce no entries, which biases the sample toward memorable events.
...
1. A log audited and found to over-represent surprising events.
2. A stated direction for the bias with a reason.

### One non-example

A claim that every prediction was logged.
...
That selection bias is present and directional.
...
| Statement | Status |
|---|---|
| Selection bias in logging is unintentional and universal. | Framework-derived, appropriate at this grade |
| That selection bias is present and directional. | What this specific activity can show |
| How large the bias is. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — Intensity And Ambiguity — specifically: students separate the two variables that usually move together.

**How it was taught.** Through the activity: redesign one manipulation so intensity varies independently of ambiguity

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: redesign one manipulation so intensity varies independently of ambiguity, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A log audited and found to over-represent surprising events. |
| **Non-example** | A claim that every prediction was logged. |
...
> "This is the confound most designs miss."
...
**Exact wording.** "Ask which predictions they logged in Grade 7: all of them, or the interesting ones?"
...
**Target observation.** That selection bias is present and directional.
...
> "Selection bias in logging is unintentional and universal. You just saw that when ask which predictions they logged in Grade 7: all of them, or the interesting ones?.
> Last time we said: This is the confound most designs miss. This is the next part of that.
...
**What students must not infer.** How large the bias is.

### 4. Worked example

**The example.** A log audited and found to over-represent surprising events.
...
**Completed answer.** A log audited and found to over-represent surprising events. — which demonstrates that selection bias is present and directional.
...
**Conclusions not licensed.** How large the bias is.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A stated direction for the bias with a reason. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that every prediction was logged. Why is this not an
example?"
...
**Exact student instructions.** Audit their own historical logs for selection bias and estimate its direction.
...
- *Licensed conclusion.* That selection bias is present and directional.
- *Not licensed.* How large the bias is.
...
- *Expected response.* That selection bias is present and directional.
...
1. Any wording carrying the idea in `Selection bias in logging is unintentional and universal`.
...
Say: "You selected without meaning to. Everybody does."
...
| | |
|---|---|
| **Follows** | Lesson 18 — Intensity And Ambiguity |
| **Leads to** | Lesson 20 — The Adversarial Audit |

**Transition in.** Lesson 18 established students separate the two variables that usually move together. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify bias in which predictions get recorded. Lesson 20 assumes it and builds students attack a design using an assigned rival account.
