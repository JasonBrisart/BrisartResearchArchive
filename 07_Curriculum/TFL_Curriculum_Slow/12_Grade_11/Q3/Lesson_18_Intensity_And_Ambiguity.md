# Lesson 18 — Intensity And Ambiguity
...
| | |
|---|---|
| **Central question** | Intensity And Ambiguity: students separate the two variables that usually move together? |
| **Core concept** | Intensity and ambiguity covary in natural settings. |
| **Student outcome** | Students separate the two variables that usually move together. |
| **Previous lesson** | Lesson 17 — Confounds |
| **Next lesson** | Lesson 19 — Selection Effects |
...
**The conceptual step.** Intensity and ambiguity covary in natural settings. Separating them experimentally is what allows the framework to be distinguished from the uncertainty account.
...
**What depends on it.** Lesson 19 — Selection Effects — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Intensity and ambiguity covary in natural settings. Separating them experimentally is what allows the framework to be distinguished from the uncertainty account.
...
1. A manipulation varying intensity at fixed ambiguity.
2. A design tracing both variables independently.

### One non-example

A manipulation where both rise together unnoticed.
...
That the two variables can be separated experimentally.
...
| Statement | Status |
|---|---|
| Intensity and ambiguity covary in natural settings. | Framework-derived, appropriate at this grade |
| That the two variables can be separated experimentally. | What this specific activity can show |
| Whether the separation is complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Confounds — specifically: students identify what must be controlled for a result to mean anything.

**How it was taught.** Through the activity: complete a seven-row confound table with a control and residual risk for each

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: complete a seven-row confound table with a control and residual risk for each, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A manipulation varying intensity at fixed ambiguity. |
| **Non-example** | A manipulation where both rise together unnoticed. |
...
> "The seventh one ruined your Grade 7 logs and nobody noticed at the time."
...
**Exact wording.** "Say: when intensity went up in your design, did ambiguity? Then they are confounded."
...
**Target observation.** That the two variables can be separated experimentally.
...
> "Intensity and ambiguity covary in natural settings. You just saw that when say: when intensity went up in your design, did ambiguity? Then they are confounded.
> Last time we said: The seventh one ruined your Grade 7 logs and nobody noticed at the time. This is the next part of that.
...
**What students must not infer.** Whether the separation is complete.

### 4. Worked example

**The example.** A manipulation varying intensity at fixed ambiguity.
...
**Completed answer.** A manipulation varying intensity at fixed ambiguity. — which demonstrates that the two variables can be separated experimentally.
...
**Conclusions not licensed.** Whether the separation is complete.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A design tracing both variables independently. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A manipulation where both rise together unnoticed. Why is this not an
example?"
...
**Exact student instructions.** Redesign one manipulation so intensity varies independently of ambiguity.
...
- *Licensed conclusion.* That the two variables can be separated experimentally.
- *Not licensed.* Whether the separation is complete.
...
- *Expected response.* That the two variables can be separated experimentally.
...
1. Any wording carrying the idea in `Intensity and ambiguity covary in natural settings`.
...
Say: "This is the confound most designs miss."
...
| | |
|---|---|
| **Follows** | Lesson 17 — Confounds |
| **Leads to** | Lesson 19 — Selection Effects |

**Transition in.** Lesson 17 established students identify what must be controlled for a result to mean anything. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students separate the two variables that usually move together. Lesson 19 assumes it and builds students identify bias in which predictions get recorded.
