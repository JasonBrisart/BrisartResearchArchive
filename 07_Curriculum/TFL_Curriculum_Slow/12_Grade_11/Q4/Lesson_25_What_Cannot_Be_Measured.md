# Lesson 25 — What Cannot Be Measured
...
| | |
|---|---|
| **Central question** | What Cannot Be Measured: students identify framework claims that currently resist measurement? |
| **Core concept** | Some framework claims currently resist measurement with available means. |
| **Student outcome** | Students identify framework claims that currently resist measurement. |
| **Previous lesson** | Lesson 24 — The Confound Review |
| **Next lesson** | Lesson 26 — Estimating The Weights |
...
**The conceptual step.** Some framework claims currently resist measurement with available means. Saying so accurately is better than asserting in-principle measurability.
...
**What depends on it.** Lesson 26 — Estimating The Weights — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Some framework claims currently resist measurement with available means. Saying so accurately is better than asserting in-principle measurability.
...
1. A within-window claim listed as currently untestable.
2. A requirement naming the resolution that would be needed.

### One non-example

A claim that everything is measurable in principle.
...
That current untestability can be stated honestly.

### What this activity does not establish

Whether the claims will become testable.
...
| Statement | Status |
|---|---|
| Some framework claims currently resist measurement with available means. | Framework-derived, appropriate at this grade |
| That current untestability can be stated honestly. | What this specific activity can show |
| Whether the claims will become testable. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 24 — The Confound Review — specifically: students consolidate confound control.

**How it was taught.** Through the activity: review with six designs audited for the seven confounds

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: review with six designs audited for the seven confounds, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A within-window claim listed as currently untestable. |
| **Non-example** | A claim that everything is measurable in principle. |
...
> "Next time: measuring things nobody has measured yet."
...
**Exact wording.** "Ask which claims nobody could test right now, with any equipment."
...
**Target observation.** That current untestability can be stated honestly.
...
> "Some framework claims currently resist measurement with available means. You just saw that when ask which claims nobody could test right now, with any equipment.
> Last time we said: Next time: measuring things nobody has measured yet. This is the next part of that.
...
**What students must not infer.** Whether the claims will become testable.

### 4. Worked example

**The example.** A within-window claim listed as currently untestable.
...
**Completed answer.** A within-window claim listed as currently untestable. — which demonstrates that current untestability can be stated honestly.
...
**Conclusions not licensed.** Whether the claims will become testable.
...
**Teacher prompt.** "Now one that does not work. A claim that everything is measurable in principle. Why is this not an
example?"
...
**Exact student instructions.** List four currently untestable claims and say what would be needed for each.
...
- *Licensed conclusion.* That current untestability can be stated honestly.
- *Not licensed.* Whether the claims will become testable.
...
- *Expected response.* That current untestability can be stated honestly.
...
1. Any wording carrying the idea in `Some framework claims currently resist measurement with available means`.
...
Say: "Some of it is not testable yet. That is a real state of affairs."
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Confound Review |
| **Leads to** | Lesson 26 — Estimating The Weights |

**Transition in.** Lesson 24 established students consolidate confound control. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify framework claims that currently resist measurement. Lesson 26 assumes it and builds students determine whether their design can recover parameters.
