...
| **Core concept** | The four exit outcomes together constitute readiness for Grade 12, which is gated on falsification and scope. |
...
**The conceptual step.** The four exit outcomes together constitute readiness for Grade 12, which is gated on falsification and scope.
...
The four exit outcomes together constitute readiness for Grade 12, which is gated on falsification and scope.
...
2. A student states all three rivals fairly.

### One non-example

A student who states rivals in weakened form.
...
| Statement | Status |
|---|---|
| The four exit outcomes together constitute readiness for Grade 12, which is gated on falsification and scope. | Framework-derived, appropriate at this grade |
...
| **Non-example** | A student who states rivals in weakened form. |
...
> "The four exit outcomes together constitute readiness for Grade 12, which is gated on falsification and scope. You just saw that when say: everything you know, on your own.
...
**Teacher prompt.** "Here is a second case. A student states all three rivals fairly. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A student who states rivals in weakened form. Why is this not an
example?"
...
**Exact student instructions.** The final: the constraint, an executable map, three fair rivals, the discriminating condition.
...
1. Any wording carrying the idea in `The four exit outcomes together constitute readiness for Grade 12, which is gated on falsification and scope`.
...
Say: "Next year is gated. You will have to argue against this framework to pass."
