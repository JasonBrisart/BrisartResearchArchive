# Lesson 12 — The Discriminating Condition

**Grade 11** · Measurement and Rivals · **Quarter 2** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Discriminating Condition: students identify where the four accounts come apart? |
| **Core concept** | The discriminating condition requires high intensity, resolved uncertainty, novel content, and identifiable simulation content simultaneously. |
| **Student outcome** | Students identify where the four accounts come apart. |
| **Previous lesson** | Lesson 11 — Consistency Is Not Evidence |
| **Next lesson** | Lesson 13 — The Generalisation Problem |
...
**The conceptual step.** The discriminating condition requires high intensity, resolved uncertainty, novel content, and identifiable simulation content simultaneously. Few designs enter it.
...
**What depends on it.** Lesson 13 — The Generalisation Problem — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The discriminating condition requires high intensity, resolved uncertainty, novel content, and identifiable simulation content simultaneously. Few designs enter it.
...
1. A condition satisfying all four criteria.
2. An honest statement that the design does not enter the cell.

### One non-example

A claim of entry without meeting all four criteria.
...
That the discriminating condition is specifiable.

### What this activity does not establish

Whether the condition occurs naturally.
...
| Statement | Status |
|---|---|
| The discriminating condition requires high intensity, resolved uncertainty, novel content, and identifiable simulation content simultaneously. | Framework-derived, appropriate at this grade |
| That the discriminating condition is specifiable. | What this specific activity can show |
| Whether the condition occurs naturally. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 11 — Consistency Is Not Evidence — specifically: students discover their own results fit the rivals equally well.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 11: apply all three rivals to three of their own results, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A condition satisfying all four criteria. |
| **Non-example** | A claim of entry without meeting all four criteria. |
...
> "Fitting is not supporting. Distinguishing requires a design."
...
**Target observation.** That the discriminating condition is specifiable.
...
> "The discriminating condition requires high intensity, resolved uncertainty, novel content, and identifiable simulation content simultaneously. You just saw that when ask under what conditions the framework predicts differently from all three.
> Last time we said: Fitting is not supporting. Distinguishing requires a design. This is the next part of that.
...
**What students must not infer.** Whether the condition occurs naturally.

### 4. Worked example

**The example.** A condition satisfying all four criteria.
...
**Completed answer.** A condition satisfying all four criteria. — which demonstrates that the discriminating condition is specifiable.
...
**Conclusions not licensed.** Whether the condition occurs naturally.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An honest statement that the design does not enter the cell. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim of entry without meeting all four criteria. Why is this not an
example?"
...
**Exact student instructions.** Identify the discriminating condition and state whether their design enters it.
...
- *Licensed conclusion.* That the discriminating condition is specifiable.
- *Not licensed.* Whether the condition occurs naturally.
...
- *Expected response.* That the discriminating condition is specifiable.
...
1. Any wording carrying the idea in `The discriminating condition requires high intensity, resolved uncertainty, novel content, and identifiable simulation content simultaneously`.
...
Say: "Any design that never enters that cell is not adjudicating."
...
| | |
|---|---|
| **Follows** | Lesson 11 — Consistency Is Not Evidence |
| **Leads to** | Lesson 13 — The Generalisation Problem |

**Transition in.** Lesson 11 established students discover their own results fit the rivals equally well. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify where the four accounts come apart. Lesson 13 assumes it and builds students address the rarity of the discriminating condition.
