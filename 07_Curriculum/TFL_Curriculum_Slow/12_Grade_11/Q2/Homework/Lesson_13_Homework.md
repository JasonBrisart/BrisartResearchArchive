# Lesson 13 Homework — The Generalisation Problem

**Grade 11** · Measurement and Rivals · **Quarter 2**
**Follows:** Lesson 13 — The Generalisation Problem · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 13 ended on, from memory:
...
Write the generalisation limit for their own design.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student addresses the limit rather than ignoring it
...
Lesson 14 is **Redesigning To Discriminate**, which assumes you arrive holding it. Write one thing you expect it to be about:
