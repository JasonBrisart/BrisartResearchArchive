# Lesson 16 Homework — The Rivals Review

**Grade 11** · Measurement and Rivals · **Quarter 2**
**Follows:** Lesson 16 — The Rivals Review · **Points:** 5 · **Optional:** yes
...
Review with a five-row differential table completed.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class completes at least four rows with distinct predictions
...
Lesson 17 is **Confounds**, which assumes you arrive holding it. Write one thing you expect it to be about:
