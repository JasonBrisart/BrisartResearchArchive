# Lesson 4 Homework — The Four Failure Modes

**Grade 11** · Measurement and Rivals · **Quarter 1**
**Follows:** Lesson 4 — The Four Failure Modes · **Points:** 5 · **Optional:** yes
...
Audit four described protocols for the four failure modes.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student identifies at least three failure modes correctly
...
Lesson 5 is **Measuring E(t)**, which assumes you arrive holding it. Write one thing you expect it to be about:
