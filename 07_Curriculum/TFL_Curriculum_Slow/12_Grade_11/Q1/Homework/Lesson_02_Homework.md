# Lesson 2 Homework — The Measurement Map

**Grade 11** · Measurement and Rivals · **Quarter 1**
**Follows:** Lesson 2 — The Measurement Map · **Points:** 5 · **Optional:** yes
...
Build a first-draft map, then have a partner mark every unrunnable line.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has a marked draft with unrunnable lines identified
...
Lesson 3 is **Measuring Sim(t)**, which assumes you arrive holding it. Write one thing you expect it to be about:
