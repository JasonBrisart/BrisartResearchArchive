...
| | |
|---|---|
| **Central question** | The Pattern Break: students record how a class expectation survives a break? |
| **Core concept** | One contradiction does not remove an expectation. |
| **Student outcome** | Students record how a class expectation survives a break. |
| **Previous lesson** | Lesson 18 — Wrong And Traced Well |
| **Next lesson** | Lesson 20 — The Prediction Interrupt |
...
**The conceptual step.** One contradiction does not remove an expectation. The class tally shows the drop and the recovery as numbers rather than as an impression.
...
**What depends on it.** Lesson 20 — The Prediction Interrupt — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

One contradiction does not remove an expectation. The class tally shows the drop and the recovery as numbers rather than as an impression.
...
1. Twenty of twenty-four expect circle after the square.
2. The count drops at card six and recovers by card seven.

### One non-example

A tally filled in after all nine cards were seen.
...
That expectations recover after a single contradiction.

### What this activity does not establish

Why they recover, which is Grade 5.
...
| Statement | Status |
|---|---|
| One contradiction does not remove an expectation. | Framework-derived, appropriate at this grade |
| That expectations recover after a single contradiction. | What this specific activity can show |
| Why they recover, which is Grade 5. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — Wrong And Traced Well — specifically: students see that a wrong expectation can be well traced.

**How it was taught.** Through the activity: add a because to each of the three surprise frames from last lesson

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: add a because to each of the three surprise frames from last lesson, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Twenty of twenty-four expect circle after the square. |
| **Non-example** | A tally filled in after all nine cards were seen. |
...
**Exact wording.** "Four circles, then a square. Collect written expectations before each card."
...
**Target observation.** That expectations recover after a single contradiction.
...
> "One contradiction does not remove an expectation. You just saw that when four circles, then a square.
> Last time we said: Being wrong costs you nothing. This is the next part of that.
...
**What students must not infer.** Why they recover, which is Grade 5.

### 4. Worked example

**The example.** Twenty of twenty-four expect circle after the square.
...
**Completed answer.** Twenty of twenty-four expect circle after the square. — which demonstrates that expectations recover after a single contradiction.
...
**Conclusions not licensed.** Why they recover, which is Grade 5.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The count drops at card six and recovers by card seven. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A tally filled in after all nine cards were seen. Why is this not an
example?"
...
**Exact student instructions.** Tally the class expectation across nine cards on a printed sheet.
...
- *Licensed conclusion.* That expectations recover after a single contradiction.
- *Not licensed.* Why they recover, which is Grade 5.
...
- *Expected response.* That expectations recover after a single contradiction.
...
1. Any wording carrying the idea in `One contradiction does not remove an expectation`.
...
Say: "It was wrong one second ago and you went straight back."
...
| | |
|---|---|
| **Follows** | Lesson 18 — Wrong And Traced Well |
| **Leads to** | Lesson 20 — The Prediction Interrupt |

**Transition in.** Lesson 18 established students see that a wrong expectation can be well traced. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students record how a class expectation survives a break. Lesson 20 assumes it and builds students catch an expectation while it is running.
