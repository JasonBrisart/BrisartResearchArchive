# Lesson 23 Homework — Sorting What Stuck

**Grade 1** · Where Guesses Come From · **Quarter 3**
**Follows:** Lesson 23 — Sorting What Stuck · **Points:** 5 · **Optional:** yes
...
Two-column sort of six real expectations, each marked R or W.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student answers whether R or W decides the column
...
Lesson 24 is **The Wrong Is Useful Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
