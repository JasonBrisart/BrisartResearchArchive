...
| | |
|---|---|
| **Central question** | Tracing Backwards: students formalise the backward trace? |
| **Core concept** | Tracing means starting at the expectation and naming the remembered content behind it. |
| **Student outcome** | Students formalise the backward trace. |
| **Previous lesson** | Lesson 11 — Finding The Source |
| **Next lesson** | Lesson 13 — Two Sources |
...
**The conceptual step.** Tracing means starting at the expectation and naming the remembered content behind it. The endpoint is a memory, not an event.
...
**What depends on it.** Lesson 13 — Two Sources — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Tracing means starting at the expectation and naming the remembered content behind it. The endpoint is a memory, not an event.
...
1. Expected the bus late, traced to remembering it was late yesterday.
2. Expected the door stuck, traced to remembering it sticking before.

### One non-example

Tracing to it was raining, which is an event, not something remembered.
...
That expectations have traceable sources in memory.

### What this activity does not establish

Whether memory is accurate.
...
| Statement | Status |
|---|---|
| Tracing means starting at the expectation and naming the remembered content behind it. | Framework-derived, appropriate at this grade |
| That expectations have traceable sources in memory. | What this specific activity can show |
| Whether memory is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 11 — Finding The Source — specifically: students identify what a stated expectation came from.

**How it was taught.** Through the activity: six sourceless expectations, each given a plausible memory

**Quick check.** Ask for the closing sentence of Lesson 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 11: six sourceless expectations, each given a plausible memory, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Expected the bus late, traced to remembering it was late yesterday. |
| **Non-example** | Tracing to it was raining, which is an event, not something remembered. |
...
> "You can walk backwards from an expectation."
...
**Exact wording.** "Draw a backwards arrow on the chart and name it tracing."
...
**Target observation.** That expectations have traceable sources in memory.
...
> "Tracing means starting at the expectation and naming the remembered content behind it. You just saw that when draw a backwards arrow on the chart and name it tracing.
> Last time we said: You can walk backwards from an expectation. This is the next part of that.
...
**What students must not infer.** Whether memory is accurate.

### 4. Worked example

**The example.** Expected the bus late, traced to remembering it was late yesterday.
...
**Completed answer.** Expected the bus late, traced to remembering it was late yesterday. — which demonstrates that expectations have traceable sources in memory.
...
**Conclusions not licensed.** Whether memory is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Expected the door stuck, traced to remembering it sticking before. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Tracing to it was raining, which is an event, not something remembered. Why is this not an
example?"
...
**Exact student instructions.** Trace six of their own expectations from this week backwards.
...
- *Licensed conclusion.* That expectations have traceable sources in memory.
- *Not licensed.* Whether memory is accurate.
...
- *Expected response.* That expectations have traceable sources in memory.
...
1. Any wording carrying the idea in `Tracing means starting at the expectation and naming the remembered content behind it`.
...
Say: "Start at the expectation and walk back."
...
| | |
|---|---|
| **Follows** | Lesson 11 — Finding The Source |
| **Leads to** | Lesson 13 — Two Sources |

**Transition in.** Lesson 11 established students identify what a stated expectation came from. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students formalise the backward trace. Lesson 13 assumes it and builds students find expectations with more than one source.
