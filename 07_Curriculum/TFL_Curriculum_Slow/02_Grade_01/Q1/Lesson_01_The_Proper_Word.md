...
| | |
|---|---|
| **Central question** | The Proper Word: students use expect in place of guess? |
| **Core concept** | Expect is the precise word for what the children have been calling a guess. |
| **Student outcome** | Students use expect in place of guess. |
| **Previous lesson** | None. First lesson of the year. |
| **Next lesson** | Lesson 2 — Three Parts In A Row |
...
**The conceptual step.** Expect is the precise word for what the children have been calling a guess. Nothing new is being taught; a name is being tightened so later work can be exact.
...
**What depends on it.** Lesson 2 — Three Parts In A Row — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Expect is the precise word for what the children have been calling a guess. Nothing new is being taught; a name is being tightened so later work can be exact.
...
1. I expect the bell to ring at eleven.
2. I expect the door to be unlocked.

### One non-example

I expect to have fun today, which names a hope rather than an outcome.
...
That the class can use one agreed term for the same idea.

### What this activity does not establish

Any new content beyond the renaming.
...
| Statement | Status |
|---|---|
| Expect is the precise word for what the children have been calling a guess. | Framework-derived, appropriate at this grade |
| That the class can use one agreed term for the same idea. | What this specific activity can show |
| Any new content beyond the renaming. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The child separates noticing from remembering without prompting.
...
| **Correct example** | I expect the bell to ring at eleven. |
| **Non-example** | I expect to have fun today, which names a hope rather than an outcome. |
...
**Exact wording.** "Ask the class to finish: I remember we have assembly, so I ___. They say guess. Accept it."
...
**Target observation.** That the class can use one agreed term for the same idea.
...
> "Expect is the precise word for what the children have been calling a guess. You just saw that when ask the class to finish: I remember we have assembly, so I ___.
...
**What students must not infer.** Any new content beyond the renaming.

### 4. Worked example

**The example.** I expect the bell to ring at eleven.
...
**Completed answer.** I expect the bell to ring at eleven. — which demonstrates that the class can use one agreed term for the same idea.
...
**Conclusions not licensed.** Any new content beyond the renaming.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. I expect the door to be unlocked. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. I expect to have fun today, which names a hope rather than an outcome. Why is this not an
example?"
...
**Exact student instructions.** Rewrite four Kindergarten frames using EXPECT, in notebooks.
...
- *Licensed conclusion.* That the class can use one agreed term for the same idea.
- *Not licensed.* Any new content beyond the renaming.
...
- *Expected response.* That the class can use one agreed term for the same idea.
...
1. Any wording carrying the idea in `Expect is the precise word for what the children have been calling a guess`.
...
Say: "Expect is the word. Next time we line up all three parts."
...
| **Leads to** | Lesson 2 — Three Parts In A Row |

**Transition in.** This lesson opens the year.

**Transition out.** This lesson establishes students use expect in place of guess. Lesson 2 assumes it and builds students identify notice, remember, and expect in one moment.
