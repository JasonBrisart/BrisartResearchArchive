...
| | |
|---|---|
| **Central question** | Three Cycles: students extend the chain to three cycles? |
| **Core concept** | Longer chains are harder to hold together, and the difficulty is genuine rather than a failure of effort. |
| **Student outcome** | Students extend the chain to three cycles. |
| **Previous lesson** | Lesson 27 — It Goes Around |
...
**The conceptual step.** Longer chains are harder to hold together, and the difficulty is genuine rather than a failure of effort.
...
Longer chains are harder to hold together, and the difficulty is genuine rather than a failure of effort.
...
1. Three cycles from one lunchtime, each starting from the last outcome.
2. A student marks where the chain became hard to follow.

### One non-example

Three separate traces presented as a chain.
...
That chains get harder to sustain with length.

### What this activity does not establish

Any limit on chain length.
...
| Statement | Status |
|---|---|
| Longer chains are harder to hold together, and the difficulty is genuine rather than a failure of effort. | Framework-derived, appropriate at this grade |
| That chains get harder to sustain with length. | What this specific activity can show |
| Any limit on chain length. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — It Goes Around — specifically: students show the three parts repeating as a cycle.

**How it was taught.** Through the activity: add a second cycle under their Lesson 25 trace, starting from what happened

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: add a second cycle under their Lesson 25 trace, starting from what happened, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Three cycles from one lunchtime, each starting from the last outcome. |
| **Non-example** | Three separate traces presented as a chain. |
...
**Exact wording.** "Say: two was the warm-up, today three."
...
**Target observation.** That chains get harder to sustain with length.
...
> "Longer chains are harder to hold together, and the difficulty is genuine rather than a failure of effort. You just saw that when say: two was the warm-up, today three.
> Last time we said: It does not stop. This is the next part of that.
...
**What students must not infer.** Any limit on chain length.

### 4. Worked example

**The example.** Three cycles from one lunchtime, each starting from the last outcome.
...
**Completed answer.** Three cycles from one lunchtime, each starting from the last outcome. — which demonstrates that chains get harder to sustain with length.
...
**Conclusions not licensed.** Any limit on chain length.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student marks where the chain became hard to follow. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Three separate traces presented as a chain. Why is this not an
example?"
...
**Exact student instructions.** A three-cycle trace on one real episode, each cycle inheriting.
...
- *Licensed conclusion.* That chains get harder to sustain with length.
- *Not licensed.* Any limit on chain length.
...
- *Expected response.* That chains get harder to sustain with length.
...
1. Any wording carrying the idea in `Longer chains are harder to hold together, and the difficulty is genuine rather than a failure of effort`.
...
Say: "The further you go, the harder it gets. That is real."
...
| | |
|---|---|
| **Follows** | Lesson 27 — It Goes Around |
| **Leads to** | Lesson 29 — Explaining The Loop |

**Transition in.** Lesson 27 established students show the three parts repeating as a cycle. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students extend the chain to three cycles. Lesson 29 assumes it and builds students explain the cycle to somebody who was not there.
