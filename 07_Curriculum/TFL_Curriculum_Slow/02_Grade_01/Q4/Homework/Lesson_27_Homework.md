# Lesson 27 Homework — It Goes Around

**Grade 1** · Where Guesses Come From · **Quarter 4**
**Follows:** Lesson 27 — It Goes Around · **Points:** 5 · **Optional:** yes
...
Add a second cycle under their Lesson 25 trace, starting from what happened.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student's second cycle starts from the first cycle's ending
...
Lesson 28 is **Three Cycles**, which assumes you arrive holding it. Write one thing you expect it to be about:
