# Lesson 9 Homework — The Exclusion Set

**Grade 12** · Falsification and Scope · **Quarter 2**
**Follows:** Lesson 9 — The Exclusion Set · **Points:** 5 · **Optional:** yes
...
Write the exclusion set from memory and group eight proposals within it.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces all five groups and six correct markings
...
Lesson 10 is **Simulations Are Not Wishes**, which assumes you arrive holding it. Write one thing you expect it to be about:
