# Lesson 14 — Scope In Other Frameworks
...
| | |
|---|---|
| **Central question** | Scope In Other Frameworks: students examine how other models state their limits? |
| **Core concept** | Explicit scope statements are uncommon. |
| **Student outcome** | Students examine how other models state their limits. |
| **Previous lesson** | Lesson 13 — Borderline Cases |
| **Next lesson** | Lesson 15 — Defending A Rejection |
...
**The conceptual step.** Explicit scope statements are uncommon. Comparing frameworks on this dimension shows what a stated exclusion set buys and costs.
...
**What depends on it.** Lesson 15 — Defending A Rejection — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Explicit scope statements are uncommon. Comparing frameworks on this dimension shows what a stated exclusion set buys and costs.
...
1. A model with an explicit and well-defended scope statement.
2. A model with no stated limits, and the cost identified.

### One non-example

An assumption that all serious models state their limits.
...
That scope statements vary between frameworks.
...
| Statement | Status |
|---|---|
| Explicit scope statements are uncommon. | Framework-derived, appropriate at this grade |
| That scope statements vary between frameworks. | What this specific activity can show |
| Which approach is better. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 13 — Borderline Cases — specifically: students resolve genuinely ambiguous scope questions.

**How it was taught.** Through the activity: resolve three borderline proposals by identifiability rather than duration

**Quick check.** Ask for the closing sentence of Lesson 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 13: resolve three borderline proposals by identifiability rather than duration, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A model with an explicit and well-defended scope statement. |
| **Non-example** | An assumption that all serious models state their limits. |
...
> "Borderline cases are decided by identifiability, not the clock."
...
**Exact wording.** "Take a model from physics, economics, or biology."
...
**Target observation.** That scope statements vary between frameworks.
...
> "Explicit scope statements are uncommon. You just saw that when take a model from physics, economics, or biology.
> Last time we said: Borderline cases are decided by identifiability, not the clock. This is the next part of that.
...
**What students must not infer.** Which approach is better.

### 4. Worked example

**The example.** A model with an explicit and well-defended scope statement.
...
**Completed answer.** A model with an explicit and well-defended scope statement. — which demonstrates that scope statements vary between frameworks.
...
**Conclusions not licensed.** Which approach is better.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A model with no stated limits, and the cost identified. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An assumption that all serious models state their limits. Why is this not an
example?"
...
**Exact student instructions.** Compare three outside models' stated limits against TFL's.
...
- *Licensed conclusion.* That scope statements vary between frameworks.
- *Not licensed.* Which approach is better.
...
- *Expected response.* That scope statements vary between frameworks.
...
1. Any wording carrying the idea in `Explicit scope statements are uncommon`.
...
Say: "Some models state their limits. Many do not. Notice which."
...
| | |
|---|---|
| **Follows** | Lesson 13 — Borderline Cases |
| **Leads to** | Lesson 15 — Defending A Rejection |

**Transition in.** Lesson 13 established students resolve genuinely ambiguous scope questions. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students examine how other models state their limits. Lesson 15 assumes it and builds students defend a scope rejection under challenge.
