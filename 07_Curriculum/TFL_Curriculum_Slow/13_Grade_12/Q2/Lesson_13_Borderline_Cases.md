...
| | |
|---|---|
| **Central question** | Borderline Cases: students resolve genuinely ambiguous scope questions? |
| **Core concept** | Borderline scope cases are decided by whether a specific simulation can be identified, not by the length of the interval. |
| **Student outcome** | Students resolve genuinely ambiguous scope questions. |
| **Previous lesson** | Lesson 12 — The Clinical Case |
| **Next lesson** | Lesson 14 — Scope In Other Frameworks |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_13_Printout.md` |
| **Homework** | `Homework/Lesson_13_Homework.md` |

## Why this lesson exists

**The conceptual step.** Borderline scope cases are decided by whether a specific simulation can be identified, not by the length of the interval.
...
**What depends on it.** Lesson 14 — Scope In Other Frameworks — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Borderline scope cases are decided by whether a specific simulation can be identified, not by the length of the interval.
...
1. A long-interval case with identifiable content, resolved inside.
2. A short case with no identifiable content, resolved outside.

### One non-example

A case resolved outside solely because it lasted a day.
...
That identifiability decides borderline cases.
...
| Statement | Status |
|---|---|
| Borderline scope cases are decided by whether a specific simulation can be identified, not by the length of the interval. | Framework-derived, appropriate at this grade |
| That identifiability decides borderline cases. | What this specific activity can show |
| Whether the resolution is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — The Clinical Case — specifically: students understand why the clinical application is a misuse.

**How it was taught.** Through the activity: write the standing refusal verbatim and defend it against two challenges

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: write the standing refusal verbatim and defend it against two challenges, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A long-interval case with identifiable content, resolved inside. |
| **Non-example** | A case resolved outside solely because it lasted a day. |
...
**Student materials.** One copy of `Printouts/Lesson_13_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 12, kept in the student's folder.
...
**File.** `Printouts/Lesson_13_Printout.md`
...
> "Not a stretch. A misuse. Different category."
...
**Exact wording.** "Present a hard case: expectations about a single school day tracked across it."
...
**Target observation.** That identifiability decides borderline cases.
...
> "Borderline scope cases are decided by whether a specific simulation can be identified, not by the length of the interval. You just saw that when present a hard case: expectations about a single school day tracked across it.
> Last time we said: Not a stretch. A misuse. Different category. This is the next part of that.
...
**What students must not infer.** Whether the resolution is correct.

### 4. Worked example

**The example.** A long-interval case with identifiable content, resolved inside.
...
**Completed answer.** A long-interval case with identifiable content, resolved inside. — which demonstrates that identifiability decides borderline cases.
...
**Conclusions not licensed.** Whether the resolution is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A short case with no identifiable content, resolved outside. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A case resolved outside solely because it lasted a day. Why is this not an
example?"
...
**Exact student instructions.** Resolve three borderline proposals by identifiability rather than duration.
...
- *Licensed conclusion.* That identifiability decides borderline cases.
- *Not licensed.* Whether the resolution is correct.
...
- *Expected response.* That identifiability decides borderline cases.
...
1. Any wording carrying the idea in `Borderline scope cases are decided by whether a specific simulation can be identified, not by the length of the interval`.
...
Say: "Borderline cases are decided by identifiability, not the clock."

**Why this sentence matters.** It is the opening question of Lesson 14, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_13_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 12 — The Clinical Case |
| **Leads to** | Lesson 14 — Scope In Other Frameworks |

**Transition in.** Lesson 12 established students understand why the clinical application is a misuse. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students resolve genuinely ambiguous scope questions. Lesson 14 assumes it and builds students examine how other models state their limits.
