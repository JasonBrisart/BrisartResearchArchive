# Lesson 25 — Assembling The Capstone
...
| **Core concept** | Assembling the capstone means all eight parts present and both gates passing a peer check before submission. |
| **Student outcome** | Students produce the complete capstone package. |
| **Previous lesson** | Lesson 24 — The Capstone Review |
| **Next lesson** | Lesson 26 — The Mock Defence |
...
**The conceptual step.** Assembling the capstone means all eight parts present and both gates passing a peer check before submission.
...
**What depends on it.** Lesson 26 — The Mock Defence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Assembling the capstone means all eight parts present and both gates passing a peer check before submission.
...
1. A capstone passing a peer gate check on both items.
...
| Statement | Status |
|---|---|
| Assembling the capstone means all eight parts present and both gates passing a peer check before submission. | Framework-derived, appropriate at this grade |
...
**Prerequisite.** The content of Lesson 24 — The Capstone Review — specifically: students consolidate capstone construction.

**How it was taught.** Through the activity: review with the capstone audited against all eight parts

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: review with the capstone audited against all eight parts, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A capstone passing a peer gate check on both items. |
...
> "Next time you assemble and defend it."
...
**Exact wording.** "Say: everything from four years, in one document."
...
> "Assembling the capstone means all eight parts present and both gates passing a peer check before submission. You just saw that when say: everything from four years, in one document.
> Last time we said: Next time you assemble and defend it. This is the next part of that.
...
**The example.** A capstone passing a peer gate check on both items.
...
**Completed answer.** A capstone passing a peer gate check on both items. — which demonstrates whether the capstone is complete.
...
**Exact student instructions.** Assemble the capstone and swap for a peer gate check.
...
1. Any wording carrying the idea in `Assembling the capstone means all eight parts present and both gates passing a peer check before submission`.
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Capstone Review |
| **Leads to** | Lesson 26 — The Mock Defence |

**Transition in.** Lesson 24 established students consolidate capstone construction. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students produce the complete capstone package. Lesson 26 assumes it and builds students rehearse the defence against four roles.
