...
| | |
|---|---|
| **Central question** | The Circularity Trap: students identify what makes a claim unfalsifiable? |
| **Core concept** | Three features keep the persistence claim out of circularity: a threshold, independently measured intensity, and identifiable content. |
| **Student outcome** | Students identify what makes a claim unfalsifiable. |
| **Previous lesson** | Lesson 2 — What Falsification Requires |
| **Next lesson** | Lesson 4 — Absence Is Not Disconfirmation |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_03_Printout.md` |
| **Homework** | `Homework/Lesson_03_Homework.md` |

## Why this lesson exists

**The conceptual step.** Three features keep the persistence claim out of circularity: a threshold, independently measured intensity, and identifiable content. Removing any one restores the circle.
...
**What depends on it.** Lesson 4 — Absence Is Not Disconfirmation — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Three features keep the persistence claim out of circularity: a threshold, independently measured intensity, and identifiable content. Removing any one restores the circle.
...
1. Removing independent measurement, making the claim circular.
2. Removing identifiable content, making the claim unfalsifiable.

### One non-example

Naming the three features without explaining what each prevents.
...
That specific features prevent circularity.

### What this activity does not establish

Whether the features are sufficient.
...
| Statement | Status |
|---|---|
| Three features keep the persistence claim out of circularity: a threshold, independently measured intensity, and identifiable content. | Framework-derived, appropriate at this grade |
| That specific features prevent circularity. | What this specific activity can show |
| Whether the features are sufficient. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — What Falsification Requires — specifically: students state the four requirements of a falsification condition.

**How it was taught.** Through the activity: write four falsification conditions, one per framework claim

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: write four falsification conditions, one per framework claim, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Removing independent measurement, making the claim circular. |
| **Non-example** | Naming the three features without explaining what each prevents. |
...
**Student materials.** One copy of `Printouts/Lesson_03_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 2, kept in the student's folder.
...
**File.** `Printouts/Lesson_03_Printout.md`
...
> "Notice the controls. Without them an alternative explains it."
...
**Exact wording.** "Say: predictions persist when they matter, and if they did not persist they did not matter enough."
...
**Target observation.** That specific features prevent circularity.
...
> "Three features keep the persistence claim out of circularity: a threshold, independently measured intensity, and identifiable content. You just saw that when say: predictions persist when they matter, and if they did not persist they did not matter enough.
> Last time we said: Notice the controls. Without them an alternative explains it. This is the next part of that.
...
**What students must not infer.** Whether the features are sufficient.

### 4. Worked example

**The example.** Removing independent measurement, making the claim circular.
...
**Completed answer.** Removing independent measurement, making the claim circular. — which demonstrates that specific features prevent circularity.
...
**Conclusions not licensed.** Whether the features are sufficient.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Removing identifiable content, making the claim unfalsifiable. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Naming the three features without explaining what each prevents. Why is this not an
example?"
...
**Exact student instructions.** Identify which escape feature each of three modified versions removes.
...
- *Licensed conclusion.* That specific features prevent circularity.
- *Not licensed.* Whether the features are sufficient.
...
- *Expected response.* That specific features prevent circularity.
...
1. Any wording carrying the idea in `Three features keep the persistence claim out of circularity: a threshold, independently measured intensity, and identifiable content`.
...
Say: "Three features hold the framework out of the circle."

**Why this sentence matters.** It is the opening question of Lesson 4, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_03_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 2 — What Falsification Requires |
| **Leads to** | Lesson 4 — Absence Is Not Disconfirmation |

**Transition in.** Lesson 2 established students state the four requirements of a falsification condition. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students identify what makes a claim unfalsifiable. Lesson 4 assumes it and builds students distinguish a null result from a falsification.
