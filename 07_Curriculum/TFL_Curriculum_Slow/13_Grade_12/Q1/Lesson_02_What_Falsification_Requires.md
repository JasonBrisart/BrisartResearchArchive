# Lesson 2 — What Falsification Requires

**Grade 12** · Falsification and Scope · **Quarter 1** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | What Falsification Requires: students state the four requirements of a falsification condition? |
| **Core concept** | A falsification condition must be stated in advance, be observable with the planned measurements, be possible given the design, and be inconsistent with the claim. |
| **Student outcome** | Students state the four requirements of a falsification condition. |
| **Previous lesson** | Lesson 1 — The Two Gates |
| **Next lesson** | Lesson 3 — The Circularity Trap |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_02_Printout.md` |
| **Homework** | `Homework/Lesson_02_Homework.md` |

## Why this lesson exists

**The conceptual step.** A falsification condition must be stated in advance, be observable with the planned measurements, be possible given the design, and be inconsistent with the claim.

**Why students need it now.** This grade owns one idea: falsification conditions, formal scope rejection, and a defended capstone.
...
that 'We found no support' is a falsification condition. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Capstone standard, defended orally against assigned adversarial roles. Advocacy is not accepted before a falsification condition is on record.

**What depends on it.** Lesson 3 — The Circularity Trap — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A falsification condition must be stated in advance, be observable with the planned measurements, be possible given the design, and be inconsistent with the claim.

### How this is stated at this grade

Capstone standard, defended orally against assigned adversarial roles. Advocacy is not accepted before a falsification condition is on record.
...
The whole grade rests on falsification conditions, formal scope rejection, and a defended capstone. If a student leaves this
...
1. A condition naming a specific observation with controls.
2. A condition stated before any data collection.

### One non-example

A condition reading: if we find no support for the claim.
...
That falsification conditions have stateable requirements.

### What this activity does not establish

Whether any condition would fire.
...
| Statement | Status |
|---|---|
| A falsification condition must be stated in advance, be observable with the planned measurements, be possible given the design, and be inconsistent with the claim. | Framework-derived, appropriate at this grade |
| That falsification conditions have stateable requirements. | What this specific activity can show |
| Whether any condition would fire. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 1 — The Two Gates — specifically: students learn the gate requirements for the year.

**How it was taught.** Through the activity: record both gates in the front of the lab book and sign underneath

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: record both gates in the front of the lab book and sign underneath, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | a result that would be inconsistent with the claim. |
| **Student wording** | A result that would be inconsistent with the claim. |
| **Correct example** | A condition naming a specific observation with controls. |
| **Non-example** | A condition reading: if we find no support for the claim. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a result that would be inconsistent with the claim." |

### circularity

| | |
|---|---|
| **Teacher definition** | a claim built so that no result could contradict it. |
| **Student wording** | A claim built so that no result could contradict it. |
| **Correct example** | A condition naming a specific observation with controls. |
| **Non-example** | A condition reading: if we find no support for the claim. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a claim built so that no result could contradict it." |

### invalid application

| | |
|---|---|
| **Teacher definition** | a use of the framework outside what it models. |
| **Student wording** | A use of the framework outside what it models. |
| **Correct example** | A condition naming a specific observation with controls. |
| **Non-example** | A condition reading: if we find no support for the claim. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a use of the framework outside what it models." |
...
**Teacher materials.** Lab books; Printed falsification templates; Printed rejection templates; A timer.

**Student materials.** One copy of `Printouts/Lesson_02_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 1, kept in the student's folder.
...
**File.** `Printouts/Lesson_02_Printout.md`
...
> "Argue against it as well as you argue for it. That is the year."
...
**Exact wording.** "Put up a claim with no possible disconfirming result and ask what would contradict it."
...
**Target observation.** That falsification conditions have stateable requirements.
...
> "A falsification condition must be stated in advance, be observable with the planned measurements, be possible given the design, and be inconsistent with the claim. You just saw that when put up a claim with no possible disconfirming result and ask what would contradict it.
> Last time we said: Argue against it as well as you argue for it. That is the year. This is the next part of that.
> It matters because you must be able to argue against the framework as competently as you argue for it"
...
**Terminology to introduce here.** falsification condition, circularity, invalid application.

**What students must not infer.** Whether any condition would fire.

### 4. Worked example

**The example.** A condition naming a specific observation with controls.
...
**Completed answer.** A condition naming a specific observation with controls. — which demonstrates that falsification conditions have stateable requirements.
...
**Conclusions not licensed.** Whether any condition would fire.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A condition stated before any data collection. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A condition reading: if we find no support for the claim. Why is this not an
example?"
...
**Exact student instructions.** Write four falsification conditions, one per framework claim.
...
- *Licensed conclusion.* That falsification conditions have stateable requirements.
- *Not licensed.* Whether any condition would fire.
...
- *Expected response.* That falsification conditions have stateable requirements.
...
3. **Misconception check.** Somebody says: "'We found no support' is a falsification condition" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `A falsification condition must be stated in advance, be observable with the planned measurements, be possible given the design, and be inconsistent with the claim`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Name the observation that would actually occur.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "Notice the controls. Without them an alternative explains it."

**Why this sentence matters.** It is the opening question of Lesson 3, which assumes students arrive holding it.
...
### 1. "'We found no support' is a falsification condition"

**What the student says or does.** 'We found no support' is a falsification condition — usually while otherwise engaging well.

**Why it is understandable.** Absence feels like disconfirmation.
...
**Exact correction.** Absence may come from poor measurement, low power, or a broken design.

**Say this.** "Name the observation that would actually occur."
...
### 2. "Everything in my life is an instance of this framework"

**What the student says or does.** Everything in my life is an instance of this framework — usually while otherwise engaging well.

**Why it is understandable.** New frameworks feel universal, and capable students over-apply most.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** The scope test, applied to the student's own best idea.

**Say this.** "Years, identity, groups, and brain wiring are different questions."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "A simulation is something the system wants"

**What the student says or does.** A simulation is something the system wants — usually while otherwise engaging well.

**Why it is understandable.** Agency language is the default for anything that predicts.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** State the exclusion: no agency, volition, goals, or selfhood.

**Say this.** "Computational hypotheses. Not intentions, not wishes, not choices."
...
**Visual or physical support.** Provide the falsification template with one condition fully worked.
...
Ask for a falsification condition for a belief they hold outside this subject.
...
- Whether the student's conclusion favours or opposes the framework
...
Mention them whenever the content of this lesson touches either.

## Homework connection

**File.** `Homework/Lesson_02_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 1 — The Two Gates |
| **Leads to** | Lesson 3 — The Circularity Trap |

**Transition in.** Lesson 1 established students learn the gate requirements for the year. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state the four requirements of a falsification condition. Lesson 3 assumes it and builds students identify what makes a claim unfalsifiable.
