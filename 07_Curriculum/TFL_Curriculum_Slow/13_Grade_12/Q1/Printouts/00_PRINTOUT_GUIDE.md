...
|---|---|---|---|---|---|---|
| `Lesson_01_Printout.md` | Lesson 1 — The Two Gates | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | None |
| `Lesson_02_Printout.md` | Lesson 2 — What Falsification Requires | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 1 work |
| `Lesson_03_Printout.md` | Lesson 3 — The Circularity Trap | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 2 work |
| `Lesson_04_Printout.md` | Lesson 4 — Absence Is Not Disconfirmation | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 3 work |
| `Lesson_05_Printout.md` | Lesson 5 — Making A Condition Fire | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 4 work |
| `Lesson_06_Printout.md` | Lesson 6 — Conditions For Other Claims | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 5 work |
| `Lesson_07_Printout.md` | Lesson 7 — Auditing Conditions | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 6 work |
| `Lesson_08_Printout.md` | Lesson 8 — The Falsification Review | 4–6 | Before the hook | Predicts, notes, works, concludes | Collected | Lesson 7 work |
...
**Lesson 5 — Making A Condition Fire.** If you only have time to print one
