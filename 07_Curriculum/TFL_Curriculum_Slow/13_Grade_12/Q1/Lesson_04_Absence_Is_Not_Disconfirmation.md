# Lesson 4 — Absence Is Not Disconfirmation
...
| | |
|---|---|
| **Central question** | Absence Is Not Disconfirmation: students distinguish a null result from a falsification? |
| **Core concept** | A null result may arise from poor measurement, low power, or a broken design. |
| **Student outcome** | Students distinguish a null result from a falsification. |
| **Previous lesson** | Lesson 3 — The Circularity Trap |
| **Next lesson** | Lesson 5 — Making A Condition Fire |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_04_Printout.md` |
| **Homework** | `Homework/Lesson_04_Homework.md` |

## Why this lesson exists

**The conceptual step.** A null result may arise from poor measurement, low power, or a broken design. It falsifies only if the condition was prespecified and the controls held.
...
**What depends on it.** Lesson 5 — Making A Condition Fire — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A null result may arise from poor measurement, low power, or a broken design. It falsifies only if the condition was prespecified and the controls held.
...
1. A null judged non-falsifying because power was inadequate.
2. A null judged falsifying because the condition was prespecified and controls held.

### One non-example

A null treated as refuting the framework.
...
That nulls require assessment before interpretation.

### What this activity does not establish

Whether the framework is false.
...
| Statement | Status |
|---|---|
| A null result may arise from poor measurement, low power, or a broken design. | Framework-derived, appropriate at this grade |
| That nulls require assessment before interpretation. | What this specific activity can show |
| Whether the framework is false. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — The Circularity Trap — specifically: students identify what makes a claim unfalsifiable.

**How it was taught.** Through the activity: identify which escape feature each of three modified versions removes

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: identify which escape feature each of three modified versions removes, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A null judged non-falsifying because power was inadequate. |
| **Non-example** | A null treated as refuting the framework. |
...
**Student materials.** One copy of `Printouts/Lesson_04_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 3, kept in the student's folder.
...
**File.** `Printouts/Lesson_04_Printout.md`
...
> "Three features hold the framework out of the circle."
...
**Exact wording.** "Ask: you ran the study and found nothing. Has the framework been falsified?"
...
**Target observation.** That nulls require assessment before interpretation.
...
> "A null result may arise from poor measurement, low power, or a broken design. You just saw that when ask: you ran the study and found nothing.
> Last time we said: Three features hold the framework out of the circle. This is the next part of that.
...
**What students must not infer.** Whether the framework is false.

### 4. Worked example

**The example.** A null judged non-falsifying because power was inadequate.
...
**Completed answer.** A null judged non-falsifying because power was inadequate. — which demonstrates that nulls require assessment before interpretation.
...
**Conclusions not licensed.** Whether the framework is false.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A null judged falsifying because the condition was prespecified and controls held. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A null treated as refuting the framework. Why is this not an
example?"
...
**Exact student instructions.** Judge four null results for whether they falsify, given the design described.
...
- *Licensed conclusion.* That nulls require assessment before interpretation.
- *Not licensed.* Whether the framework is false.
...
- *Expected response.* That nulls require assessment before interpretation.
...
1. Any wording carrying the idea in `A null result may arise from poor measurement, low power, or a broken design`.
...
Say: "A null licenses one sentence: this design did not detect it under these conditions."

**Why this sentence matters.** It is the opening question of Lesson 5, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_04_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 3 — The Circularity Trap |
| **Leads to** | Lesson 5 — Making A Condition Fire |

**Transition in.** Lesson 3 established students identify what makes a claim unfalsifiable. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students distinguish a null result from a falsification. Lesson 5 assumes it and builds students check that a condition could actually be triggered.
