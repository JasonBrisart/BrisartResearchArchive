# Lesson 5 — Making A Condition Fire
...
| | |
|---|---|
| **Central question** | Making A Condition Fire: students check that a condition could actually be triggered? |
| **Core concept** | A condition fires only if a producible result would trigger it. |
| **Student outcome** | Students check that a condition could actually be triggered. |
| **Previous lesson** | Lesson 4 — Absence Is Not Disconfirmation |
| **Next lesson** | Lesson 6 — Conditions For Other Claims |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_05_Printout.md` |
| **Homework** | `Homework/Lesson_05_Homework.md` |

## Why this lesson exists

**The conceptual step.** A condition fires only if a producible result would trigger it. Demonstrating the pathway means writing the actual observations that would do so.
...
**What depends on it.** Lesson 6 — Conditions For Other Claims — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A condition fires only if a producible result would trigger it. Demonstrating the pathway means writing the actual observations that would do so.
...
1. A pathway with the triggering numbers written out.
2. A condition revised after the pathway could not be demonstrated.

### One non-example

A condition asserted to be checkable with no pathway shown.
...
That firing pathways can be demonstrated.
...
| Statement | Status |
|---|---|
| A condition fires only if a producible result would trigger it. | Framework-derived, appropriate at this grade |
| That firing pathways can be demonstrated. | What this specific activity can show |
| Whether the condition will fire. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — Absence Is Not Disconfirmation — specifically: students distinguish a null result from a falsification.

**How it was taught.** Through the activity: judge four null results for whether they falsify, given the design described

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: judge four null results for whether they falsify, given the design described, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A pathway with the triggering numbers written out. |
| **Non-example** | A condition asserted to be checkable with no pathway shown. |
...
**Student materials.** One copy of `Printouts/Lesson_05_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 4, kept in the student's folder.
...
**File.** `Printouts/Lesson_05_Printout.md`
...
> "A null licenses one sentence: this design did not detect it under these conditions."
...
**Exact wording.** "Put two conditions side by side, one specific and one vague, and ask which could be checked next month."
...
**Target observation.** That firing pathways can be demonstrated.
...
> "A condition fires only if a producible result would trigger it. You just saw that when put two conditions side by side, one specific and one vague, and ask which could be checked next month.
> Last time we said: A null licenses one sentence: this design did not detect it under these conditions. This is the next part of that.
...
**The example.** A pathway with the triggering numbers written out.
...
**Completed answer.** A pathway with the triggering numbers written out. — which demonstrates that firing pathways can be demonstrated.
...
**Teacher prompt.** "Now one that does not work. A condition asserted to be checkable with no pathway shown. Why is this not an
example?"
...
**Exact student instructions.** Demonstrate a firing pathway for each of their four conditions.
...
- *Licensed conclusion.* That firing pathways can be demonstrated.
...
- *Expected response.* That firing pathways can be demonstrated.
...
1. Any wording carrying the idea in `A condition fires only if a producible result would trigger it`.
...
Say: "A condition that cannot fire is decoration."

**Why this sentence matters.** It is the opening question of Lesson 6, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_05_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 4 — Absence Is Not Disconfirmation |
| **Leads to** | Lesson 6 — Conditions For Other Claims |

**Transition in.** Lesson 4 established students distinguish a null result from a falsification. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students check that a condition could actually be triggered. Lesson 6 assumes it and builds students write falsification conditions for non-TFL claims.
