...
| | |
|---|---|
| **Central question** | The Two Gates: students learn the gate requirements for the year? |
| **Core concept** | The year is gated on two items: a falsification condition naming a possible observation, and a correctly identified invalid application with its boundary named. |
| **Student outcome** | Students learn the gate requirements for the year. |
| **Previous lesson** | None. First lesson of the year. |
| **Next lesson** | Lesson 2 — What Falsification Requires |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_01_Printout.md` |
| **Homework** | `Homework/Lesson_01_Homework.md` |

## Why this lesson exists

**The conceptual step.** The year is gated on two items: a falsification condition naming a possible observation, and a correctly identified invalid application with its boundary named. Both must pass regardless of total score.
...
**What depends on it.** Lesson 2 — What Falsification Requires — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The year is gated on two items: a falsification condition naming a possible observation, and a correctly identified invalid application with its boundary named. Both must pass regardless of total score.
...
1. Gate A recorded verbatim in the lab book.
2. Gate B recorded with the boundary requirement noted.

### One non-example

Gates noted as something to address near the examination.
...
That the gates are announced and unconditional.

### What this activity does not establish

Whether the gates are fair.
...
| Statement | Status |
|---|---|
| The year is gated on two items: a falsification condition naming a possible observation, and a correctly identified invalid application with its boundary named. | Framework-derived, appropriate at this grade |
| That the gates are announced and unconditional. | What this specific activity can show |
| Whether the gates are fair. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The student builds an executable measurement map and states rivals fairly.
...
| **Correct example** | Gate A recorded verbatim in the lab book. |
| **Non-example** | Gates noted as something to address near the examination. |
...
**Student materials.** One copy of `Printouts/Lesson_01_Printout.md` per student.
...
**File.** `Printouts/Lesson_01_Printout.md`
...
This is the first lesson of the year, so there is nothing to retrieve. Instead ask: "What do you think this course is about?" Take three answers and write them where they can be revisited at the end of the year. Do not correct them.

### 2. Hook

**Exact wording.** "Write both gates on the board on day one and leave them up all year."
...
**Target observation.** That the gates are announced and unconditional.
...
> "The year is gated on two items: a falsification condition naming a possible observation, and a correctly identified invalid application with its boundary named. You just saw that when write both gates on the board on day one and leave them up all year.
...
**What students must not infer.** Whether the gates are fair.

### 4. Worked example

**The example.** Gate A recorded verbatim in the lab book.
...
**Completed answer.** Gate A recorded verbatim in the lab book. — which demonstrates that the gates are announced and unconditional.
...
**Conclusions not licensed.** Whether the gates are fair.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Gate B recorded with the boundary requirement noted. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Gates noted as something to address near the examination. Why is this not an
example?"
...
**Exact student instructions.** Record both gates in the front of the lab book and sign underneath.
...
- *Licensed conclusion.* That the gates are announced and unconditional.
- *Not licensed.* Whether the gates are fair.
...
- *Expected response.* That the gates are announced and unconditional.
...
1. Any wording carrying the idea in `The year is gated on two items: a falsification condition naming a possible observation, and a correctly identified invalid application with its boundary named`.
...
Say: "Argue against it as well as you argue for it. That is the year."

**Why this sentence matters.** It is the opening question of Lesson 2, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_01_Homework.md`
...
| | |
|---|---|
| **Follows** | Nothing. First lesson of the year. |
| **Leads to** | Lesson 2 — What Falsification Requires |

**Transition in.** This lesson opens the year.

**Transition out.** This lesson establishes students learn the gate requirements for the year. Lesson 2 assumes it and builds students state the four requirements of a falsification condition.
