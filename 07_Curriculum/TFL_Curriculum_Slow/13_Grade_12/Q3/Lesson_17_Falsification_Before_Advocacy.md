# Lesson 17 — Falsification Before Advocacy
...
| | |
|---|---|
| **Central question** | Falsification Before Advocacy: students order their own argument correctly? |
| **Core concept** | Placing the falsification condition first is what converts advocacy into a testable position. |
| **Student outcome** | Students order their own argument correctly. |
| **Previous lesson** | Lesson 16 — The Scope Review |
| **Next lesson** | Lesson 18 — Choosing The Capstone Claim |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_17_Printout.md` |
| **Homework** | `Homework/Lesson_17_Homework.md` |

## Why this lesson exists

**The conceptual step.** Placing the falsification condition first is what converts advocacy into a testable position. Placed last, it functions as a caveat rather than a commitment.
...
**What depends on it.** Lesson 18 — Choosing The Capstone Claim — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Placing the falsification condition first is what converts advocacy into a testable position. Placed last, it functions as a caveat rather than a commitment.
...
1. An argument opening with the falsification condition.
2. An argument reordered after being returned.

### One non-example

An argument closing with the condition as a caveat.
...
That argument order carries epistemic weight.

### What this activity does not establish

Whether the argument is correct.
...
| Statement | Status |
|---|---|
| Placing the falsification condition first is what converts advocacy into a testable position. | Framework-derived, appropriate at this grade |
| That argument order carries epistemic weight. | What this specific activity can show |
| Whether the argument is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 16 — The Scope Review — specifically: students consolidate scope.

**How it was taught.** Through the activity: review with ten proposals judged and boundaries named

**Quick check.** Ask for the closing sentence of Lesson 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 16: review with ten proposals judged and boundaries named, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An argument opening with the falsification condition. |
| **Non-example** | An argument closing with the condition as a caveat. |
...
**Student materials.** One copy of `Printouts/Lesson_17_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 16, kept in the student's folder.
...
**File.** `Printouts/Lesson_17_Printout.md`
...
> "Next time: falsification comes before advocacy. Always."
...
**Exact wording.** "Put up a strong argument for the framework with no falsification condition and say it is returned unmarked."
...
**Target observation.** That argument order carries epistemic weight.
...
> "Placing the falsification condition first is what converts advocacy into a testable position. You just saw that when put up a strong argument for the framework with no falsification condition and say it is returned unmarked.
> Last time we said: Next time: falsification comes before advocacy. Always. This is the next part of that.
...
**What students must not infer.** Whether the argument is correct.

### 4. Worked example

**The example.** An argument opening with the falsification condition.
...
**Completed answer.** An argument opening with the falsification condition. — which demonstrates that argument order carries epistemic weight.
...
**Conclusions not licensed.** Whether the argument is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An argument reordered after being returned. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An argument closing with the condition as a caveat. Why is this not an
example?"
...
**Exact student instructions.** Reorder three of their own arguments so the condition precedes the advocacy.
...
- *Licensed conclusion.* That argument order carries epistemic weight.
- *Not licensed.* Whether the argument is correct.
...
- *Expected response.* That argument order carries epistemic weight.
...
1. Any wording carrying the idea in `Placing the falsification condition first is what converts advocacy into a testable position`.
...
Say: "State what would kill it before you say why you believe it."

**Why this sentence matters.** It is the opening question of Lesson 18, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_17_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 16 — The Scope Review |
| **Leads to** | Lesson 18 — Choosing The Capstone Claim |

**Transition in.** Lesson 16 established students consolidate scope. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students order their own argument correctly. Lesson 18 assumes it and builds students select one claim narrow enough to be settled.
