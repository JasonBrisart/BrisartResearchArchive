# Lesson 21 — The Inference Ceiling
...
| | |
|---|---|
| **Central question** | The Inference Ceiling: students state the highest claim their design licenses? |
| **Core concept** | The inference ceiling is the highest rung a design licenses. |
| **Student outcome** | Students state the highest claim their design licenses. |
| **Previous lesson** | Lesson 20 — Designing The Capstone |
| **Next lesson** | Lesson 22 — The Reverse Ladder |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_21_Printout.md` |
| **Homework** | `Homework/Lesson_21_Homework.md` |

## Why this lesson exists

**The conceptual step.** The inference ceiling is the highest rung a design licenses. Rung three is the ceiling for a single well-run study; rung four requires converging designs.
...
**What depends on it.** Lesson 22 — The Reverse Ladder — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The inference ceiling is the highest rung a design licenses. Rung three is the ceiling for a single well-run study; rung four requires converging designs.
...
2. A named temptation to claim rung four.

### One non-example

A ceiling placed at rung four from one design.
...
That inference ceilings can be located.

### What this activity does not establish

Whether the result will support the ceiling.
...
| Statement | Status |
|---|---|
| The inference ceiling is the highest rung a design licenses. | Framework-derived, appropriate at this grade |
| That inference ceilings can be located. | What this specific activity can show |
| Whether the result will support the ceiling. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 20 — Designing The Capstone — specifically: students build the design around the condition.

**How it was taught.** Through the activity: draft all seven sections and swap for an executability check

**Quick check.** Ask for the closing sentence of Lesson 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 20: draft all seven sections and swap for an executability check, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A ceiling placed at rung four from one design. |
...
**Student materials.** One copy of `Printouts/Lesson_21_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 20, kept in the student's folder.
...
**File.** `Printouts/Lesson_21_Printout.md`
...
**Exact wording.** "Put five rungs on the board against a hypothetical result and ask where the ceiling is."
...
**Target observation.** That inference ceilings can be located.
...
> "The inference ceiling is the highest rung a design licenses. You just saw that when put five rungs on the board against a hypothetical result and ask where the ceiling is.
...
**What students must not infer.** Whether the result will support the ceiling.
...
**Completed answer.** A ceiling correctly placed at rung three. — which demonstrates that inference ceilings can be located.
...
**Conclusions not licensed.** Whether the result will support the ceiling.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A named temptation to claim rung four. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A ceiling placed at rung four from one design. Why is this not an
example?"
...
- *Licensed conclusion.* That inference ceilings can be located.
- *Not licensed.* Whether the result will support the ceiling.
...
- *Expected response.* That inference ceilings can be located.
...
1. Any wording carrying the idea in `The inference ceiling is the highest rung a design licenses`.
...
**Why this sentence matters.** It is the opening question of Lesson 22, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_21_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 20 — Designing The Capstone |
| **Leads to** | Lesson 22 — The Reverse Ladder |

**Transition in.** Lesson 20 established students build the design around the condition. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state the highest claim their design licenses. Lesson 22 assumes it and builds students state what a null result licenses.
