# Lesson 23 Homework — Confirmatory And Exploratory

**Grade 12** · Falsification and Scope · **Quarter 3**
**Follows:** Lesson 23 — Confirmatory And Exploratory · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 23 ended on, from memory:
...
Mark every planned analysis as confirmatory or exploratory before any data exist.
...
Lesson 24 is **The Capstone Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
