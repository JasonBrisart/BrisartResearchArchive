# Lesson 23 — Confirmatory And Exploratory
...
| **Previous lesson** | Lesson 22 — The Reverse Ladder |
| **Next lesson** | Lesson 24 — The Capstone Review |
...
**The conceptual step.** Exploration is legitimate and must be labelled. The problem is presenting exploration as confirmation, which labelling in advance prevents.
...
**What depends on it.** Lesson 24 — The Capstone Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Exploration is legitimate and must be labelled. The problem is presenting exploration as confirmation, which labelling in advance prevents.
...
2. An analysis marked exploratory and reported as such.

### One non-example

An analysis left unlabelled pending the results.
...
**Prerequisite.** The content of Lesson 22 — The Reverse Ladder — specifically: students state what a null result licenses.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: write the reverse ladder and state whether their condition would fire, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | An analysis left unlabelled pending the results. |
...
**Exact wording.** "Ask whether rigid prespecification prevents discovery."
...
> "Exploration is legitimate and must be labelled. You just saw that when ask whether rigid prespecification prevents discovery.
...
**Teacher prompt.** "Here is a second case. An analysis marked exploratory and reported as such. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An analysis left unlabelled pending the results. Why is this not an
example?"
...
**Exact student instructions.** Mark every planned analysis as confirmatory or exploratory before any data exist.
...
Say: "Prespecify the confirmatory test, label everything else, report both."
...
| | |
|---|---|
| **Follows** | Lesson 22 — The Reverse Ladder |
| **Leads to** | Lesson 24 — The Capstone Review |

**Transition in.** Lesson 22 established students state what a null result licenses. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students separate prespecified tests from exploration. Lesson 24 assumes it and builds students consolidate capstone construction.
