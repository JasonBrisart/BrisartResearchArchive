# Lesson 20 — Designing The Capstone
...
| **Core concept** | The capstone design is built around the falsification condition rather than the other way round. |
| **Student outcome** | Students build the design around the condition. |
| **Previous lesson** | Lesson 19 — The Capstone Falsification Condition |
| **Next lesson** | Lesson 21 — The Inference Ceiling |
| **Materials** | Lab books; printed falsification templates |
| **Preparation** | twenty minutes |
| **Student printout** | `Printouts/Lesson_20_Printout.md` |
| **Homework** | `Homework/Lesson_20_Homework.md` |

## Why this lesson exists

**The conceptual step.** The capstone design is built around the falsification condition rather than the other way round. Executability is checked by handover.
...
**What depends on it.** Lesson 21 — The Inference Ceiling — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The capstone design is built around the falsification condition rather than the other way round. Executability is checked by handover.
...
1. A design whose every line survives the executability check.
2. A design revised after four unrunnable lines were marked.
...
That capstone designs can be audited for executability.

### What this activity does not establish

Whether the design would produce a result.
...
| Statement | Status |
|---|---|
| The capstone design is built around the falsification condition rather than the other way round. | Framework-derived, appropriate at this grade |
| That capstone designs can be audited for executability. | What this specific activity can show |
| Whether the design would produce a result. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — The Capstone Falsification Condition — specifically: students write the condition their capstone could trigger.

**How it was taught.** Through the activity: write the condition and demonstrate a producible result that triggers it

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: write the condition and demonstrate a producible result that triggers it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A design whose every line survives the executability check. |
...
**Student materials.** One copy of `Printouts/Lesson_20_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 19, kept in the student's folder.
...
**File.** `Printouts/Lesson_20_Printout.md`
...
**Exact wording.** "Say: you have the condition. Now build what could produce it."
...
**Target observation.** That capstone designs can be audited for executability.
...
> "The capstone design is built around the falsification condition rather than the other way round. You just saw that when say: you have the condition.
...
**What students must not infer.** Whether the design would produce a result.

### 4. Worked example

**The example.** A design whose every line survives the executability check.
...
**Completed answer.** A design whose every line survives the executability check. — which demonstrates that capstone designs can be audited for executability.
...
**Conclusions not licensed.** Whether the design would produce a result.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A design revised after four unrunnable lines were marked. Work it through with me."
...
- *Licensed conclusion.* That capstone designs can be audited for executability.
- *Not licensed.* Whether the design would produce a result.
...
- *Expected response.* That capstone designs can be audited for executability.
...
1. Any wording carrying the idea in `The capstone design is built around the falsification condition rather than the other way round`.
...
**Why this sentence matters.** It is the opening question of Lesson 21, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_20_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 19 — The Capstone Falsification Condition |
| **Leads to** | Lesson 21 — The Inference Ceiling |

**Transition in.** Lesson 19 established students write the condition their capstone could trigger. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students build the design around the condition. Lesson 21 assumes it and builds students state the highest claim their design licenses.
