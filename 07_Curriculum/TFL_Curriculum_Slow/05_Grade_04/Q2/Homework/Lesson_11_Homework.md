# Lesson 11 Homework — Two Chains At Once

**Grade 4** · Carry Forward · **Quarter 2**
**Follows:** Lesson 11 — Two Chains At Once · **Points:** 5 · **Optional:** yes
...
Two parallel four-row traces with one interaction point marked.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student marks at least one interaction point
...
Lesson 12 is **Chains Across A Week**, which assumes you arrive holding it. Write one thing you expect it to be about:
