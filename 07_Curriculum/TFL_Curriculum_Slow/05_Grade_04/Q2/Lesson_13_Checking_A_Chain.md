...
| | |
|---|---|
| **Central question** | Checking A Chain: students audit somebody else's chain? |
| **Core concept** | Auditing a chain means finding the first break, because everything after it is unreliable anyway. |
| **Student outcome** | Students audit somebody else's chain. |
| **Previous lesson** | Lesson 12 — Chains Across A Week |
| **Next lesson** | Lesson 14 — Repairing A Chain |
...
**The conceptual step.** Auditing a chain means finding the first break, because everything after it is unreliable anyway. Marking every imperfect row wastes the audit.
...
**What depends on it.** Lesson 14 — Repairing A Chain — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Auditing a chain means finding the first break, because everything after it is unreliable anyway. Marking every imperfect row wastes the audit.
...
1. An audit naming row four as the first break.
2. An audit stating what row four should have inherited.

### One non-example

An audit marking five rows as imperfect.
...
That the first break is the decisive one.

### What this activity does not establish

Whether the rows after it are salvageable.
...
| Statement | Status |
|---|---|
| Auditing a chain means finding the first break, because everything after it is unreliable anyway. | Framework-derived, appropriate at this grade |
| That the first break is the decisive one. | What this specific activity can show |
| Whether the rows after it are salvageable. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 12 — Chains Across A Week — specifically: students trace inheritance across a longer interval.

**How it was taught.** Through the activity: a five-point trace across one week with inheritance named at each point

**Quick check.** Ask for the closing sentence of Lesson 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 12: a five-point trace across one week with inheritance named at each point, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit naming row four as the first break. |
| **Non-example** | An audit marking five rows as imperfect. |
...
> "It gets fainter over a week. It does not vanish."
...
**Exact wording.** "Put three traces on the board, one sound and two broken differently."
...
**Target observation.** That the first break is the decisive one.
...
> "Auditing a chain means finding the first break, because everything after it is unreliable anyway. You just saw that when put three traces on the board, one sound and two broken differently.
> Last time we said: It gets fainter over a week. It does not vanish. This is the next part of that.
...
**What students must not infer.** Whether the rows after it are salvageable.

### 4. Worked example

**The example.** An audit naming row four as the first break.
...
**Completed answer.** An audit naming row four as the first break. — which demonstrates that the first break is the decisive one.
...
**Conclusions not licensed.** Whether the rows after it are salvageable.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An audit stating what row four should have inherited. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit marking five rows as imperfect. Why is this not an
example?"
...
**Exact student instructions.** Swap traces; mark the first broken row and what should have been there.
...
- *Licensed conclusion.* That the first break is the decisive one.
- *Not licensed.* Whether the rows after it are salvageable.
...
- *Expected response.* That the first break is the decisive one.
...
1. Any wording carrying the idea in `Auditing a chain means finding the first break, because everything after it is unreliable anyway`.
...
Say: "Read only the inheritance column. Stop at the first break."
...
| | |
|---|---|
| **Follows** | Lesson 12 — Chains Across A Week |
| **Leads to** | Lesson 14 — Repairing A Chain |

**Transition in.** Lesson 12 established students trace inheritance across a longer interval. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit somebody else's chain. Lesson 14 assumes it and builds students repair a broken chain rather than rewriting it.
