...
| | |
|---|---|
| **Central question** | Repairing A Chain: students repair a broken chain rather than rewriting it? |
| **Core concept** | A break has two possible causes: inheritance that was not named, or a moment that was skipped. |
| **Student outcome** | Students repair a broken chain rather than rewriting it. |
| **Previous lesson** | Lesson 13 — Checking A Chain |
| **Next lesson** | Lesson 15 — The Missing Moment |
...
**The conceptual step.** A break has two possible causes: inheritance that was not named, or a moment that was skipped. Classifying the repair is what makes it diagnostic.
...
**What depends on it.** Lesson 15 — The Missing Moment — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A break has two possible causes: inheritance that was not named, or a moment that was skipped. Classifying the repair is what makes it diagnostic.
...
1. A break repaired by naming the missing inheritance.
2. A break repaired by inserting a skipped moment.

### One non-example

A trace rewritten from scratch with the break invisible.
...
That breaks have two distinguishable causes.

### What this activity does not establish

Which cause is more common.
...
| Statement | Status |
|---|---|
| A break has two possible causes: inheritance that was not named, or a moment that was skipped. | Framework-derived, appropriate at this grade |
| That breaks have two distinguishable causes. | What this specific activity can show |
| Which cause is more common. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 13 — Checking A Chain — specifically: students audit somebody else's chain.

**How it was taught.** Through the activity: swap traces; mark the first broken row and what should have been there

**Quick check.** Ask for the closing sentence of Lesson 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 13: swap traces; mark the first broken row and what should have been there, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A break repaired by naming the missing inheritance. |
| **Non-example** | A trace rewritten from scratch with the break invisible. |
...
> "Read only the inheritance column. Stop at the first break."
...
**Exact wording.** "Say: you are not going to rewrite it. You are going to repair it."
...
**Target observation.** That breaks have two distinguishable causes.
...
> "A break has two possible causes: inheritance that was not named, or a moment that was skipped. You just saw that when say: you are not going to rewrite it.
> Last time we said: Read only the inheritance column. Stop at the first break. This is the next part of that.
...
**What students must not infer.** Which cause is more common.

### 4. Worked example

**The example.** A break repaired by naming the missing inheritance.
...
**Completed answer.** A break repaired by naming the missing inheritance. — which demonstrates that breaks have two distinguishable causes.
...
**Conclusions not licensed.** Which cause is more common.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A break repaired by inserting a skipped moment. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A trace rewritten from scratch with the break invisible. Why is this not an
example?"
...
**Exact student instructions.** Repair each break and classify it: missing inheritance or missing moment.
...
- *Licensed conclusion.* That breaks have two distinguishable causes.
- *Not licensed.* Which cause is more common.
...
- *Expected response.* That breaks have two distinguishable causes.
...
1. Any wording carrying the idea in `A break has two possible causes: inheritance that was not named, or a moment that was skipped`.
...
Say: "A break is sometimes a missing moment, not a mistake."
...
| | |
|---|---|
| **Follows** | Lesson 13 — Checking A Chain |
| **Leads to** | Lesson 15 — The Missing Moment |

**Transition in.** Lesson 13 established students audit somebody else's chain. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students repair a broken chain rather than rewriting it. Lesson 15 assumes it and builds students find breaks caused by a skipped moment.
