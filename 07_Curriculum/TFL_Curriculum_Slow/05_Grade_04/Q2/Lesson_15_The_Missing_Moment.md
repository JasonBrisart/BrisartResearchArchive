# Lesson 15 — The Missing Moment

**Grade 4** · Carry Forward · **Quarter 2** · **40 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Missing Moment: students find breaks caused by a skipped moment? |
| **Core concept** | A gap caused by a skipped moment is not an error in the rows that are present. |
| **Student outcome** | Students find breaks caused by a skipped moment. |
| **Previous lesson** | Lesson 14 — Repairing A Chain |
| **Next lesson** | Lesson 16 — The Long Chain Review |
...
**The conceptual step.** A gap caused by a skipped moment is not an error in the rows that are present. Inserting the missing row repairs it without changing anything else.
...
**What depends on it.** Lesson 16 — The Long Chain Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A gap caused by a skipped moment is not an error in the rows that are present. Inserting the missing row repairs it without changing anything else.
...
1. A break repaired entirely by inserting one row.
2. A trace where both rows were correct but non-adjacent.

### One non-example

Classifying a skipped-moment gap as a writing error.
...
That some breaks are absences rather than errors.

### What this activity does not establish

How to tell without attempting the repair.
...
| Statement | Status |
|---|---|
| A gap caused by a skipped moment is not an error in the rows that are present. | Framework-derived, appropriate at this grade |
| That some breaks are absences rather than errors. | What this specific activity can show |
| How to tell without attempting the repair. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Repairing A Chain — specifically: students repair a broken chain rather than rewriting it.

**How it was taught.** Through the activity: repair each break and classify it: missing inheritance or missing moment

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: repair each break and classify it: missing inheritance or missing moment, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A break repaired entirely by inserting one row. |
| **Non-example** | Classifying a skipped-moment gap as a writing error. |
...
> "A break is sometimes a missing moment, not a mistake."
...
**Exact wording.** "Put up a trace where two rows are too far apart to connect."
...
**Target observation.** That some breaks are absences rather than errors.
...
> "A gap caused by a skipped moment is not an error in the rows that are present. You just saw that when put up a trace where two rows are too far apart to connect.
> Last time we said: A break is sometimes a missing moment, not a mistake. This is the next part of that.
...
**What students must not infer.** How to tell without attempting the repair.

### 4. Worked example

**The example.** A break repaired entirely by inserting one row.
...
**Completed answer.** A break repaired entirely by inserting one row. — which demonstrates that some breaks are absences rather than errors.
...
**Conclusions not licensed.** How to tell without attempting the repair.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A trace where both rows were correct but non-adjacent. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Classifying a skipped-moment gap as a writing error. Why is this not an
example?"
...
**Exact student instructions.** Six traces, each classified as missing inheritance or missing moment.
...
- *Licensed conclusion.* That some breaks are absences rather than errors.
- *Not licensed.* How to tell without attempting the repair.
...
- *Expected response.* That some breaks are absences rather than errors.
...
1. Any wording carrying the idea in `A gap caused by a skipped moment is not an error in the rows that are present`.
...
Say: "Sometimes nothing is wrong. Something is absent."
...
| | |
|---|---|
| **Follows** | Lesson 14 — Repairing A Chain |
| **Leads to** | Lesson 16 — The Long Chain Review |

**Transition in.** Lesson 14 established students repair a broken chain rather than rewriting it. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students find breaks caused by a skipped moment. Lesson 16 assumes it and builds students consolidate long-chain work.
