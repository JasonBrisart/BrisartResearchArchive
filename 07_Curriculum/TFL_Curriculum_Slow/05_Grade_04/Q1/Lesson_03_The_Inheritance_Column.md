# Lesson 3 — The Inheritance Column
...
| | |
|---|---|
| **Central question** | The Inheritance Column: students trace one episode across four moments showing inheritance? |
| **Core concept** | The inheritance column is what makes a trace a trace. |
| **Student outcome** | Students trace one episode across four moments showing inheritance. |
| **Previous lesson** | Lesson 2 — The Purple Elephant |
| **Next lesson** | Lesson 4 — The Chain |
...
**The conceptual step.** The inheritance column is what makes a trace a trace. A generic entry such as the last moment names nothing and cannot be checked.
...
**What depends on it.** Lesson 4 — The Chain — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The inheritance column is what makes a trace a trace. A generic entry such as the last moment names nothing and cannot be checked.
...
1. An inheritance entry naming the specific expectation carried over.
2. An inheritance entry naming the unresolved question from the row above.

### One non-example

An inheritance entry reading what happened before.
...
That inheritance can be named specifically.

### What this activity does not establish

Whether the named inheritance is complete.
...
| Statement | Status |
|---|---|
| The inheritance column is what makes a trace a trace. | Framework-derived, appropriate at this grade |
| That inheritance can be named specifically. | What this specific activity can show |
| Whether the named inheritance is complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — The Purple Elephant — specifically: students demonstrate they cannot start a moment fresh.

**How it was taught.** Through the activity: attempt the reset on three self-chosen topics and record what happened

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: attempt the reset on three self-chosen topics and record what happened, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An inheritance entry naming the specific expectation carried over. |
| **Non-example** | An inheritance entry reading what happened before. |
...
> "You cannot start a moment from nothing."
...
**Exact wording.** "Put up a four-row table with a new front column: INHERITED FROM BEFORE."
...
**Target observation.** That inheritance can be named specifically.
...
> "The inheritance column is what makes a trace a trace. You just saw that when put up a four-row table with a new front column: INHERITED FROM BEFORE.
> Last time we said: You cannot start a moment from nothing. This is the next part of that.
...
**What students must not infer.** Whether the named inheritance is complete.

### 4. Worked example

**The example.** An inheritance entry naming the specific expectation carried over.
...
**Completed answer.** An inheritance entry naming the specific expectation carried over. — which demonstrates that inheritance can be named specifically.
...
**Conclusions not licensed.** Whether the named inheritance is complete.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An inheritance entry naming the unresolved question from the row above. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An inheritance entry reading what happened before. Why is this not an
example?"
...
**Exact student instructions.** Trace one real episode across four moments; only the inheritance column is checked.
...
- *Licensed conclusion.* That inheritance can be named specifically.
- *Not licensed.* Whether the named inheritance is complete.
...
- *Expected response.* That inheritance can be named specifically.
...
1. Any wording carrying the idea in `The inheritance column is what makes a trace a trace`.
...
Say: "The inheritance column is the trace."
...
| | |
|---|---|
| **Follows** | Lesson 2 — The Purple Elephant |
| **Leads to** | Lesson 4 — The Chain |

**Transition in.** Lesson 2 established students demonstrate they cannot start a moment fresh. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students trace one episode across four moments showing inheritance. Lesson 4 assumes it and builds students physically demonstrate inheritance and feel its cost.
