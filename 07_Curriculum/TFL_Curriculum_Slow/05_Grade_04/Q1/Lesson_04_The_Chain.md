...
| | |
|---|---|
| **Central question** | The Chain: students physically demonstrate inheritance and feel its cost? |
| **Core concept** | Carrying forward deliberately is effortful, which is why the chain breaks. |
| **Student outcome** | Students physically demonstrate inheritance and feel its cost. |
| **Previous lesson** | Lesson 3 — The Inheritance Column |
| **Next lesson** | Lesson 5 — Inheritance In A Story |
...
**The conceptual step.** Carrying forward deliberately is effortful, which is why the chain breaks. The contrast with the automatic version is the point of the difficulty.
...
**What depends on it.** Lesson 5 — Inheritance In A Story — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Carrying forward deliberately is effortful, which is why the chain breaks. The contrast with the automatic version is the point of the difficulty.
...
1. A chain that breaks at the seventh person.
2. The planted disruption being immediately obvious to the group.

### One non-example

A chain rescued by the teacher before it breaks.
...
That deliberate carrying-forward is effortful.

### What this activity does not establish

That automatic carry-forward works the same way.
...
| Statement | Status |
|---|---|
| Carrying forward deliberately is effortful, which is why the chain breaks. | Framework-derived, appropriate at this grade |
| That deliberate carrying-forward is effortful. | What this specific activity can show |
| That automatic carry-forward works the same way. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 3 — The Inheritance Column — specifically: students trace one episode across four moments showing inheritance.

**How it was taught.** Through the activity: trace one real episode across four moments; only the inheritance column is checked

**Quick check.** Ask for the closing sentence of Lesson 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 3: trace one real episode across four moments; only the inheritance column is checked, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A chain that breaks at the seventh person. |
| **Non-example** | A chain rescued by the teacher before it breaks. |
...
> "The inheritance column is the trace."
...
**Exact wording.** "Circle with one object. Rule: repeat everything you heard, then add one thing."
...
**Target observation.** That deliberate carrying-forward is effortful.
...
> "Carrying forward deliberately is effortful, which is why the chain breaks. You just saw that when circle with one object.
> Last time we said: The inheritance column is the trace. This is the next part of that.
...
**What students must not infer.** That automatic carry-forward works the same way.

### 4. Worked example

**The example.** A chain that breaks at the seventh person.
...
**Completed answer.** A chain that breaks at the seventh person. — which demonstrates that deliberate carrying-forward is effortful.
...
**Conclusions not licensed.** That automatic carry-forward works the same way.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The planted disruption being immediately obvious to the group. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A chain rescued by the teacher before it breaks. Why is this not an
example?"
...
**Exact student instructions.** Two rounds; the second with a student instructed to add something unrelated.
...
- *Licensed conclusion.* That deliberate carrying-forward is effortful.
- *Not licensed.* That automatic carry-forward works the same way.
...
- *Expected response.* That deliberate carrying-forward is effortful.
...
1. Any wording carrying the idea in `Carrying forward deliberately is effortful, which is why the chain breaks`.
...
Say: "Carrying forward is automatic. You noticed it because you did it on purpose."
...
| | |
|---|---|
| **Follows** | Lesson 3 — The Inheritance Column |
| **Leads to** | Lesson 5 — Inheritance In A Story |

**Transition in.** Lesson 3 established students trace one episode across four moments showing inheritance. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students physically demonstrate inheritance and feel its cost. Lesson 5 assumes it and builds students find carry-forward in a narrative text.
