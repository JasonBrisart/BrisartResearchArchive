...
| | |
|---|---|
| **Central question** | Opening The Envelope: students compare their sealed Grade 3 prediction with the answer? |
| **Core concept** | A prediction made a year ago and checked now is the strongest demonstration available that predictions survive as records. |
| **Student outcome** | Students compare their sealed Grade 3 prediction with the answer. |
| **Previous lesson** | None. First lesson of the year. |
| **Next lesson** | Lesson 2 — The Purple Elephant |
...
**The conceptual step.** A prediction made a year ago and checked now is the strongest demonstration available that predictions survive as records. The answer itself opens the year's subject.
...
**What depends on it.** Lesson 2 — The Purple Elephant — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A prediction made a year ago and checked now is the strongest demonstration available that predictions survive as records. The answer itself opens the year's subject.
...
1. A sealed prediction that the moment disappears, now checked.
2. A sealed prediction that some of it stays, now confirmed in part.

### One non-example

Treating a wrong sealed prediction as evidence of poor thinking.
...
That long-interval predictions can be recorded and checked.

### What this activity does not establish

Whether the sealed prediction was correct.
...
| Statement | Status |
|---|---|
| A prediction made a year ago and checked now is the strongest demonstration available that predictions survive as records. | Framework-derived, appropriate at this grade |
| That long-interval predictions can be recorded and checked. | What this specific activity can show |
| Whether the sealed prediction was correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The student builds a supported five-line reconstruction of one moment.
...
| **Correct example** | A sealed prediction that the moment disappears, now checked. |
| **Non-example** | Treating a wrong sealed prediction as evidence of poor thinking. |
...
**Exact wording.** "Hand back the sealed envelopes. Say: read it, do not say it out loud yet."
...
**Target observation.** That long-interval predictions can be recorded and checked.
...
> "A prediction made a year ago and checked now is the strongest demonstration available that predictions survive as records. You just saw that when hand back the sealed envelopes.
...
**What students must not infer.** Whether the sealed prediction was correct.

### 4. Worked example

**The example.** A sealed prediction that the moment disappears, now checked.
...
**Completed answer.** A sealed prediction that the moment disappears, now checked. — which demonstrates that long-interval predictions can be recorded and checked.
...
**Conclusions not licensed.** Whether the sealed prediction was correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A sealed prediction that some of it stays, now confirmed in part. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Treating a wrong sealed prediction as evidence of poor thinking. Why is this not an
example?"
...
**Exact student instructions.** Write one paragraph comparing the sealed answer with the real one.
...
- *Licensed conclusion.* That long-interval predictions can be recorded and checked.
- *Not licensed.* Whether the sealed prediction was correct.
...
- *Expected response.* That long-interval predictions can be recorded and checked.
...
1. Any wording carrying the idea in `A prediction made a year ago and checked now is the strongest demonstration available that predictions survive as records`.
...
Say: "Nothing starts from zero. That sentence is the whole year."
...
| **Leads to** | Lesson 2 — The Purple Elephant |

**Transition in.** This lesson opens the year.

**Transition out.** This lesson establishes students compare their sealed Grade 3 prediction with the answer. Lesson 2 assumes it and builds students demonstrate they cannot start a moment fresh.
