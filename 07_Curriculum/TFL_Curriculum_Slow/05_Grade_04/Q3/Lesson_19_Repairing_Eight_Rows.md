# Lesson 19 — Repairing Eight Rows
...
| | |
|---|---|
| **Central question** | Repairing Eight Rows: students repair a long chain after audit? |
| **Core concept** | Repairing the first break often resolves the rows below it, because those rows were broken by the same missing content. |
| **Student outcome** | Students repair a long chain after audit. |
| **Previous lesson** | Lesson 18 — Auditing Eight Rows |
| **Next lesson** | Lesson 20 — Chains In Other Subjects |
...
**The conceptual step.** Repairing the first break often resolves the rows below it, because those rows were broken by the same missing content. Re-reading after the repair shows this.
...
**What depends on it.** Lesson 20 — Chains In Other Subjects — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Repairing the first break often resolves the rows below it, because those rows were broken by the same missing content. Re-reading after the repair shows this.
...
1. A single repair that resolves three subsequent rows.
2. A repair that requires a second repair further down.

### One non-example

Repairing only the marked row and stopping.
...
That repairs cascade through a chain.

### What this activity does not establish

How many rows a repair typically resolves.
...
| Statement | Status |
|---|---|
| Repairing the first break often resolves the rows below it, because those rows were broken by the same missing content. | Framework-derived, appropriate at this grade |
| That repairs cascade through a chain. | What this specific activity can show |
| How many rows a repair typically resolves. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 18 — Auditing Eight Rows — specifically: students audit a long chain.

**How it was taught.** Through the activity: audit a partner's eight-row trace, marking the first break

**Quick check.** Ask for the closing sentence of Lesson 18. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 18: audit a partner's eight-row trace, marking the first break, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A single repair that resolves three subsequent rows. |
| **Non-example** | Repairing only the marked row and stopping. |
...
> "The first break is where the trace stops being reliable."
...
**Exact wording.** "Say: repair from the first break down."
...
**Target observation.** That repairs cascade through a chain.
...
> "Repairing the first break often resolves the rows below it, because those rows were broken by the same missing content. You just saw that when say: repair from the first break down.
> Last time we said: The first break is where the trace stops being reliable. This is the next part of that.
...
**What students must not infer.** How many rows a repair typically resolves.

### 4. Worked example

**The example.** A single repair that resolves three subsequent rows.
...
**Completed answer.** A single repair that resolves three subsequent rows. — which demonstrates that repairs cascade through a chain.
...
**Conclusions not licensed.** How many rows a repair typically resolves.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A repair that requires a second repair further down. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Repairing only the marked row and stopping. Why is this not an
example?"
...
**Exact student instructions.** Repair the audited trace and record each repair type.
...
- *Licensed conclusion.* That repairs cascade through a chain.
- *Not licensed.* How many rows a repair typically resolves.
...
- *Expected response.* That repairs cascade through a chain.
...
1. Any wording carrying the idea in `Repairing the first break often resolves the rows below it, because those rows were broken by the same missing content`.
...
Say: "Repairs cascade. Fixing the first often fixes the rest."
...
| | |
|---|---|
| **Follows** | Lesson 18 — Auditing Eight Rows |
| **Leads to** | Lesson 20 — Chains In Other Subjects |

**Transition in.** Lesson 18 established students audit a long chain. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students repair a long chain after audit. Lesson 20 assumes it and builds students find carry-forward in non-TFL material.
