...
| | |
|---|---|
| **Central question** | Auditing Eight Rows: students audit a long chain? |
| **Core concept** | Auditing a long chain is the same job as auditing a short one: find the first break. |
| **Student outcome** | Students audit a long chain. |
| **Previous lesson** | Lesson 17 — The Eight Row Trace |
| **Next lesson** | Lesson 19 — Repairing Eight Rows |
...
**The conceptual step.** Auditing a long chain is the same job as auditing a short one: find the first break. Length does not change the method.
...
**What depends on it.** Lesson 19 — Repairing Eight Rows — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Auditing a long chain is the same job as auditing a short one: find the first break. Length does not change the method.
...
1. An audit of eight rows naming row five as the first break.
2. An audit finding no break, which is possible.

### One non-example

An audit listing four separate problems across eight rows.
...
That the audit method scales to long chains.

### What this activity does not establish

Whether the rows after the break are wrong.
...
| Statement | Status |
|---|---|
| Auditing a long chain is the same job as auditing a short one: find the first break. | Framework-derived, appropriate at this grade |
| That the audit method scales to long chains. | What this specific activity can show |
| Whether the rows after the break are wrong. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — The Eight Row Trace — specifically: students produce an eight-row chain.

**How it was taught.** Through the activity: an eight-row trace on one real episode

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: an eight-row trace on one real episode, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit of eight rows naming row five as the first break. |
| **Non-example** | An audit listing four separate problems across eight rows. |
...
> "Eight rows is a long way to carry something honestly."
...
**Exact wording.** "Say: read only the inheritance column, top to bottom."
...
**Target observation.** That the audit method scales to long chains.
...
> "Auditing a long chain is the same job as auditing a short one: find the first break. You just saw that when say: read only the inheritance column, top to bottom.
> Last time we said: Eight rows is a long way to carry something honestly. This is the next part of that.
...
**What students must not infer.** Whether the rows after the break are wrong.

### 4. Worked example

**The example.** An audit of eight rows naming row five as the first break.
...
**Completed answer.** An audit of eight rows naming row five as the first break. — which demonstrates that the audit method scales to long chains.
...
**Conclusions not licensed.** Whether the rows after the break are wrong.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An audit finding no break, which is possible. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit listing four separate problems across eight rows. Why is this not an
example?"
...
**Exact student instructions.** Audit a partner's eight-row trace, marking the first break.
...
- *Licensed conclusion.* That the audit method scales to long chains.
- *Not licensed.* Whether the rows after the break are wrong.
...
- *Expected response.* That the audit method scales to long chains.
...
1. Any wording carrying the idea in `Auditing a long chain is the same job as auditing a short one: find the first break`.
...
Say: "The first break is where the trace stops being reliable."
...
| | |
|---|---|
| **Follows** | Lesson 17 — The Eight Row Trace |
| **Leads to** | Lesson 19 — Repairing Eight Rows |

**Transition in.** Lesson 17 established students produce an eight-row chain. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit a long chain. Lesson 19 assumes it and builds students repair a long chain after audit.
