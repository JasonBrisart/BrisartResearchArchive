# Lesson 21 Homework — The Chain With A Gap

**Grade 4** · Carry Forward · **Quarter 3**
**Follows:** Lesson 21 — The Chain With A Gap · **Points:** 5 · **Optional:** yes
...
A trace spanning an overnight gap, with the gap explicitly handled.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student handles the gap rather than ignoring it
...
Lesson 22 is **Explaining Carry Forward**, which assumes you arrive holding it. Write one thing you expect it to be about:
