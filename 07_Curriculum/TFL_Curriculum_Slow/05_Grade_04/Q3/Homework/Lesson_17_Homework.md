# Lesson 17 Homework — The Eight Row Trace

**Grade 4** · Carry Forward · **Quarter 3**
**Follows:** Lesson 17 — The Eight Row Trace · **Points:** 5 · **Optional:** yes
...
An eight-row trace on one real episode.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has eight rows with inheritance in rows two to eight
...
Lesson 18 is **Auditing Eight Rows**, which assumes you arrive holding it. Write one thing you expect it to be about:
