# Lesson 9 — The Story Stop

**Pre-Kindergarten** · Guessing Games · **Quarter 2** · **15 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Story Stop: children predict what comes next in a familiar story? |
| **Core concept** | Stories make guessing visible because the child knows the story and the next event is already available to them before the page turns. |
| **Student outcome** | Children predict what comes next in a familiar story. |
| **Previous lesson** | Lesson 8 — The Guessing Chart |
| **Next lesson** | Lesson 10 — The Wrong Ending |
...
**The conceptual step.** Stories make guessing visible because the child knows the story and the next event is already available to them before the page turns.
...
**What depends on it.** Lesson 10 — The Wrong Ending — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Stories make guessing visible because the child knows the story and the next event is already available to them before the page turns.
...
1. A child says the wolf blows the house down before the page turns.
2. A child says the bear comes home before it is read.

### One non-example

Reading the page and then repeating it — no guess.
...
That known stories produce guesses ahead of the text.

### What this activity does not establish

That children remember the story perfectly.
...
| Statement | Status |
|---|---|
| Stories make guessing visible because the child knows the story and the next event is already available to them before the page turns. | Framework-derived, appropriate at this grade |
| That known stories produce guesses ahead of the text. | What this specific activity can show |
| That children remember the story perfectly. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Guessing Chart — specifically: children review the quarter and see that guessing happened every session.

**How it was taught.** Through the activity: build a class tally of every guess made this quarter, using the kept drawings

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: build a class tally of every guess made this quarter, using the kept drawings, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child says the wolf blows the house down before the page turns. |
| **Non-example** | Reading the page and then repeating it — no guess. |
...
> "We guessed every single time we met. Next time: what happens when a guess goes wrong."
...
**Exact wording.** "Hold up a well-known picture book and say you will stop and they will say what happens next."
...
**Target observation.** That known stories produce guesses ahead of the text.
...
> "Stories make guessing visible because the child knows the story and the next event is already available to them before the page turns. You just saw that when hold up a well-known picture book and say you will stop and they will say what happens next.
> Last time we said: We guessed every single time we met. Next time: what happens when a guess goes wrong. This is the next part of that.
...
**What students must not infer.** That children remember the story perfectly.

### 4. Worked example

**The example.** A child says the wolf blows the house down before the page turns.
...
**Completed answer.** A child says the wolf blows the house down before the page turns. — which demonstrates that known stories produce guesses ahead of the text.
...
**Conclusions not licensed.** That children remember the story perfectly.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child says the bear comes home before it is read. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reading the page and then repeating it — no guess. Why is this not an
example?"
...
**Exact student instructions.** Read with five stops. At each, one child says the guess aloud before the page turns.
...
- *Licensed conclusion.* That known stories produce guesses ahead of the text.
- *Not licensed.* That children remember the story perfectly.
...
- *Expected response.* That known stories produce guesses ahead of the text.
...
1. Any wording carrying the idea in `Stories make guessing visible because the child knows the story and the next event is already available to them before the page turns`.
...
Say: "Next time I am going to tell it wrong on purpose."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Guessing Chart |
| **Leads to** | Lesson 10 — The Wrong Ending |

**Transition in.** Lesson 8 established children review the quarter and see that guessing happened every session. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children predict what comes next in a familiar story. Lesson 10 assumes it and builds children experience a deliberately broken guess.
