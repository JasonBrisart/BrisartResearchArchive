# Lesson 18 — The Song You Cannot Stop
...
| | |
|---|---|
| **Central question** | The Song You Cannot Stop: children recognise persistence in a familiar everyday form? |
| **Core concept** | Persistence is directly observable in the most ordinary case. |
| **Student outcome** | Children recognise persistence in a familiar everyday form. |
| **Previous lesson** | Lesson 17 — Stuck In Your Head |
| **Next lesson** | Lesson 19 — Why Did That Stick |
...
**The conceptual step.** Persistence is directly observable in the most ordinary case. The song continues with no external source, which is what sticking means.
...
**What depends on it.** Lesson 19 — Why Did That Stick — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Persistence is directly observable in the most ordinary case. The song continues with no external source, which is what sticking means.
...
1. A child reports the song continued after the room went quiet.
2. A child hums it later in the session without being asked.

### One non-example

A child who needs the recording restarted to hear it again.
...
That content continues without external input.

### What this activity does not establish

Any mechanism, which is far beyond this grade.
...
| Statement | Status |
|---|---|
| Persistence is directly observable in the most ordinary case. | Framework-derived, appropriate at this grade |
| That content continues without external input. | What this specific activity can show |
| Any mechanism, which is far beyond this grade. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Stuck In Your Head — specifically: children notice some things stay with them and some do not.

**How it was taught.** Through the activity: fold paper in half. Draw one stuck thing and one forgotten thing

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: fold paper in half. Draw one stuck thing and one forgotten thing, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child reports the song continued after the room went quiet. |
| **Non-example** | A child who needs the recording restarted to hear it again. |
...
> "Some things stick and some go. Both happened to you."
...
**Exact wording.** "Sing four notes of a very familiar song and stop."
...
**Target observation.** That content continues without external input.
...
> "Persistence is directly observable in the most ordinary case. You just saw that when sing four notes of a very familiar song and stop.
> Last time we said: Some things stick and some go. Both happened to you. This is the next part of that.
...
**What students must not infer.** Any mechanism, which is far beyond this grade.

### 4. Worked example

**The example.** A child reports the song continued after the room went quiet.
...
**Completed answer.** A child reports the song continued after the room went quiet. — which demonstrates that content continues without external input.
...
**Conclusions not licensed.** Any mechanism, which is far beyond this grade.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child hums it later in the session without being asked. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who needs the recording restarted to hear it again. Why is this not an
example?"
...
**Exact student instructions.** Children report whether the song kept going in their head, and for how long.
...
- *Licensed conclusion.* That content continues without external input.
- *Not licensed.* Any mechanism, which is far beyond this grade.
...
- *Expected response.* That content continues without external input.
...
1. Any wording carrying the idea in `Persistence is directly observable in the most ordinary case`.
...
Say: "That is sticking. It kept going without you playing it."
...
| | |
|---|---|
| **Follows** | Lesson 17 — Stuck In Your Head |
| **Leads to** | Lesson 19 — Why Did That Stick |

**Transition in.** Lesson 17 established children notice some things stay with them and some do not. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children recognise persistence in a familiar everyday form. Lesson 19 assumes it and builds children begin to say why something stayed with them.
