...
| | |
|---|---|
| **Central question** | The Snack Guess: children guess about a routine event and check it later in the day? |
| **Core concept** | A guess can be made now and checked much later. |
| **Student outcome** | Children guess about a routine event and check it later in the day. |
| **Previous lesson** | Lesson 4 — Guessing the Weather |
| **Next lesson** | Lesson 6 — Guessing By Touch |
...
**The conceptual step.** A guess can be made now and checked much later. The gap between guessing and finding out can be long, and the guess survives the gap.
...
**What depends on it.** Lesson 6 — Guessing By Touch — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A guess can be made now and checked much later. The gap between guessing and finding out can be long, and the guess survives the gap.
...
1. A child draws outdoor play and it happens.
2. A child draws story time and music happens instead.

### One non-example

Drawing what already happened this morning — that is a record, not a guess.
...
That a guess can wait to be checked.

### What this activity does not establish

That children should be able to predict the schedule accurately.
...
| Statement | Status |
|---|---|
| A guess can be made now and checked much later. | Framework-derived, appropriate at this grade |
| That a guess can wait to be checked. | What this specific activity can show |
| That children should be able to predict the schedule accurately. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — Guessing the Weather — specifically: children make a guess about something they can check immediately.

**How it was taught.** Through the activity: three window guesses across the session, each checked immediately

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: three window guesses across the session, each checked immediately, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child draws outdoor play and it happens. |
| **Non-example** | Drawing what already happened this morning — that is a record, not a guess. |
...
> "Guessing first and checking after is how we play."
...
**Exact wording.** "Ask what they think is happening after this part of the day."
...
**Target observation.** That a guess can wait to be checked.
...
> "A guess can be made now and checked much later. You just saw that when ask what they think is happening after this part of the day.
> Last time we said: Guessing first and checking after is how we play. This is the next part of that.
...
**What students must not infer.** That children should be able to predict the schedule accurately.

### 4. Worked example

**The example.** A child draws outdoor play and it happens.
...
**Completed answer.** A child draws outdoor play and it happens. — which demonstrates that a guess can wait to be checked.
...
**Conclusions not licensed.** That children should be able to predict the schedule accurately.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child draws story time and music happens instead. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Drawing what already happened this morning — that is a record, not a guess. Why is this not an
example?"
...
**Exact student instructions.** Each child draws their guess about the next part of the day. Drawings are kept and checked later.
...
- *Licensed conclusion.* That a guess can wait to be checked.
- *Not licensed.* That children should be able to predict the schedule accurately.
...
- *Expected response.* That a guess can wait to be checked.
...
1. Any wording carrying the idea in `A guess can be made now and checked much later`.
...
Say: "We will find out if you were right. Being wrong is fine."
...
| | |
|---|---|
| **Follows** | Lesson 4 — Guessing the Weather |
| **Leads to** | Lesson 6 — Guessing By Touch |

**Transition in.** Lesson 4 established children make a guess about something they can check immediately. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children guess about a routine event and check it later in the day. Lesson 6 assumes it and builds children guess using one sense when another is removed.
