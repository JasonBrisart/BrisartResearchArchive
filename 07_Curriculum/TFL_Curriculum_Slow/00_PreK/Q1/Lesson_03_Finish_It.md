...
| | |
|---|---|
| **Central question** | Finish It: children complete familiar phrases, showing guesses come from before? |
| **Core concept** | Guesses have a source. |
| **Student outcome** | Children complete familiar phrases, showing guesses come from before. |
| **Previous lesson** | Lesson 2 — You Knew Already |
| **Next lesson** | Lesson 4 — Guessing the Weather |
...
**The conceptual step.** Guesses have a source. The child can finish the phrase because the phrase happened to them before. Earlier experience is what makes the next word available.
...
**What depends on it.** Lesson 4 — Guessing the Weather — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Guesses have a source. The child can finish the phrase because the phrase happened to them before. Earlier experience is what makes the next word available.
...
1. The class shouts GO after "ready, set".
2. The class finishes "happy birthday to" without being asked.

### One non-example

A phrase invented on the spot that nobody completes — no prior experience, no guess.
...
That prior experience supplies the guess.

### What this activity does not establish

Which memory system is involved, or how memory works.
...
| Statement | Status |
|---|---|
| Guesses have a source. | Framework-derived, appropriate at this grade |
| That prior experience supplies the guess. | What this specific activity can show |
| Which memory system is involved, or how memory works. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — You Knew Already — specifically: children discover they had a guess without being asked for one.

**How it was taught.** Through the activity: play it four times with different targets: the window, the hallway, the door colour, the ceiling

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: play it four times with different targets: the window, the hallway, the door colour, the ceiling, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The class shouts GO after "ready, set". |
| **Non-example** | A phrase invented on the spot that nobody completes — no prior experience, no guess. |
...
> "Your guesses are already in there, even when nobody asks."
...
**Exact wording.** "Say "ready, set" and stop. They shout GO. Ask how they knew."
...
**Target observation.** That prior experience supplies the guess.
...
> "Guesses have a source. You just saw that when say "ready, set" and stop.
> Last time we said: Your guesses are already in there, even when nobody asks. This is the next part of that.
...
**What students must not infer.** Which memory system is involved, or how memory works.

### 4. Worked example

**The example.** The class shouts GO after "ready, set".
...
**Completed answer.** The class shouts GO after "ready, set". — which demonstrates that prior experience supplies the guess.
...
**Conclusions not licensed.** Which memory system is involved, or how memory works.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The class finishes "happy birthday to" without being asked. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A phrase invented on the spot that nobody completes — no prior experience, no guess. Why is this not an
example?"
...
**Exact student instructions.** Circle game: each child offers a phrase the others finish. Coach the stuck ones.
...
- *Licensed conclusion.* That prior experience supplies the guess.
- *Not licensed.* Which memory system is involved, or how memory works.
...
- *Expected response.* That prior experience supplies the guess.
...
1. Any wording carrying the idea in `Guesses have a source`.
...
Say: "Your guesses come from things that already happened to you."
...
| | |
|---|---|
| **Follows** | Lesson 2 — You Knew Already |
| **Leads to** | Lesson 4 — Guessing the Weather |

**Transition in.** Lesson 2 established children discover they had a guess without being asked for one. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children complete familiar phrases, showing guesses come from before. Lesson 4 assumes it and builds children make a guess about something they can check immediately.
