# Lesson 31 — The Year In Pictures
...
| | |
|---|---|
| **Central question** | The Year In Pictures: children review the whole year using their own work? |
| **Core concept** | The kept work is external memory. |
| **Student outcome** | Children review the whole year using their own work. |
| **Previous lesson** | Lesson 30 — Teaching A Grown-Up |
...
**The conceptual step.** The kept work is external memory. The child does not have to recall session one; they can look at it and reconstruct.
...
The kept work is external memory. The child does not have to recall session one; they can look at it and reconstruct.
...
1. A child orders four drawings correctly.
2. A child recognises their session-one bag drawing.

### One non-example

A child asked to recall session one with no drawings present.
...
Whether the year's work is coherent to the child.

### What this activity does not establish

Unaided long-term recall.
...
| Statement | Status |
|---|---|
| The kept work is external memory. | Framework-derived, appropriate at this grade |
| Whether the year's work is coherent to the child. | What this specific activity can show |
| Unaided long-term recall. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 30 — Teaching A Grown-Up — specifically: children explain the whole cycle to an adult.

**How it was taught.** Through the activity: each child explains the four words and the circle to a visiting adult

**Quick check.** Ask for the closing sentence of Lesson 30. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 30: each child explains the four words and the circle to a visiting adult, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child orders four drawings correctly. |
| **Non-example** | A child asked to recall session one with no drawings present. |
...
**Exact wording.** "Lay out every drawing kept across the year."
...
**Target observation.** Whether the year's work is coherent to the child.
...
> "The kept work is external memory. You just saw that when lay out every drawing kept across the year.
...
**What students must not infer.** Unaided long-term recall.

### 4. Worked example

**The example.** A child orders four drawings correctly.
...
**Completed answer.** A child orders four drawings correctly. — which demonstrates whether the year's work is coherent to the child.
...
**Conclusions not licensed.** Unaided long-term recall.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child recognises their session-one bag drawing. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child asked to recall session one with no drawings present. Why is this not an
example?"
...
**Exact student instructions.** Children arrange their own drawings in order and say what each shows.
...
- *Licensed conclusion.* Whether the year's work is coherent to the child.
- *Not licensed.* Unaided long-term recall.
...
- *Expected response.* Whether the year's work is coherent to the child.
...
1. Any wording carrying the idea in `The kept work is external memory`.
...
Say: "You did all of this. Next time we show what you know."
...
| | |
|---|---|
| **Follows** | Lesson 30 — Teaching A Grown-Up |
| **Leads to** | Lesson 32 — Show What You Know |

**Transition in.** Lesson 30 established children explain the whole cycle to an adult. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children review the whole year using their own work. Lesson 32 assumes it and builds children demonstrate the year's outcomes.
