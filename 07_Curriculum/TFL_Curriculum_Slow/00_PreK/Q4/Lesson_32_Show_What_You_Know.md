...
| | |
|---|---|
| **Central question** | Show What You Know: children demonstrate the year's outcomes? |
| **Core concept** | The four outcomes together are the year. |
| **Student outcome** | Children demonstrate the year's outcomes. |
| **Previous lesson** | Lesson 31 — The Year In Pictures |
...
**The conceptual step.** The four outcomes together are the year. Demonstrating all four in one sitting is what readiness for Kindergarten looks like.
...
The four outcomes together are the year. Demonstrating all four in one sitting is what readiness for Kindergarten looks like.
...
1. A child guesses, reports a surprise, names both columns, walks the circle.
2. A child who needs one prompt but completes all four.

### One non-example

A child who performs two outcomes and stops.
...
How well any single one is performed.
...
| Statement | Status |
|---|---|
| The four outcomes together are the year. | Framework-derived, appropriate at this grade |
| Whether all four exit outcomes are present. | What this specific activity can show |
| How well any single one is performed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 31 — The Year In Pictures — specifically: children review the whole year using their own work.

**How it was taught.** Through the activity: children arrange their own drawings in order and say what each shows

**Quick check.** Ask for the closing sentence of Lesson 31. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 31: children arrange their own drawings in order and say what each shows, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child guesses, reports a surprise, names both columns, walks the circle. |
| **Non-example** | A child who performs two outcomes and stops. |
...
> "You did all of this. Next time we show what you know."
...
**Exact wording.** "Tell them to show you everything they learned and you will just watch."
...
> "The four outcomes together are the year. You just saw that when tell them to show you everything they learned and you will just watch.
> Last time we said: You did all of this. Next time we show what you know. This is the next part of that.
...
**What students must not infer.** How well any single one is performed.

### 4. Worked example

**The example.** A child guesses, reports a surprise, names both columns, walks the circle.
...
**Completed answer.** A child guesses, reports a surprise, names both columns, walks the circle. — which demonstrates whether all four exit outcomes are present.
...
**Conclusions not licensed.** How well any single one is performed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child who needs one prompt but completes all four. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who performs two outcomes and stops. Why is this not an
example?"
...
**Exact student instructions.** The final task: each child guesses, reports a surprise, names a stuck and a gone thing, and shows the circle.
...
- *Not licensed.* How well any single one is performed.
...
1. Any wording carrying the idea in `The four outcomes together are the year`.
...
Say: "You are guessing right now, and you will still be guessing tomorrow."
...
| | |
|---|---|
| **Follows** | Lesson 31 — The Year In Pictures |
| **Leads to** | The final examination. |

**Transition in.** Lesson 31 established children review the whole year using their own work. This lesson uses that as the starting point.
