...
| | |
|---|---|
| **Central question** | The Circle At Home: children find the cycle outside school? |
| **Core concept** | The loop is not a classroom routine. |
| **Student outcome** | Children find the cycle outside school. |
| **Previous lesson** | Lesson 28 — Drawing The Circle |
| **Next lesson** | Lesson 30 — Teaching A Grown-Up |
...
**The conceptual step.** The loop is not a classroom routine. Finding it at home is evidence that it belongs to the child rather than to the lesson.
...
**What depends on it.** Lesson 30 — Teaching A Grown-Up — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The loop is not a classroom routine. Finding it at home is evidence that it belongs to the child rather than to the lesson.
...
1. A child guesses what is for dinner, finds out, guesses dessert.
2. A child guesses who is at the door, finds out, guesses why.

### One non-example

A school example repeated because it is easier.
...
That the loop occurs outside school.

### What this activity does not establish

Any claim about how often it occurs.
...
| Statement | Status |
|---|---|
| The loop is not a classroom routine. | Framework-derived, appropriate at this grade |
| That the loop occurs outside school. | What this specific activity can show |
| Any claim about how often it occurs. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 28 — Drawing The Circle — specifically: children draw the cycle with arrows.

**How it was taught.** Through the activity: each child draws their own circle with arrows going round

**Quick check.** Ask for the closing sentence of Lesson 28. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 28: each child draws their own circle with arrows going round, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child guesses what is for dinner, finds out, guesses dessert. |
| **Non-example** | A school example repeated because it is easier. |
...
> "The arrow goes back to where it started."
...
**Exact wording.** "Ask where else this happens, not here, at home."
...
**Target observation.** That the loop occurs outside school.
...
> "The loop is not a classroom routine. You just saw that when ask where else this happens, not here, at home.
> Last time we said: The arrow goes back to where it started. This is the next part of that.
...
**What students must not infer.** Any claim about how often it occurs.

### 4. Worked example

**The example.** A child guesses what is for dinner, finds out, guesses dessert.
...
**Completed answer.** A child guesses what is for dinner, finds out, guesses dessert. — which demonstrates that the loop occurs outside school.
...
**Conclusions not licensed.** Any claim about how often it occurs.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child guesses who is at the door, finds out, guesses why. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A school example repeated because it is easier. Why is this not an
example?"
...
**Exact student instructions.** Each child names one home example of guess, find out, guess again.
...
- *Licensed conclusion.* That the loop occurs outside school.
- *Not licensed.* Any claim about how often it occurs.
...
- *Expected response.* That the loop occurs outside school.
...
1. Any wording carrying the idea in `The loop is not a classroom routine`.
...
Say: "It is running at home too. It does not stop when you leave."
...
| | |
|---|---|
| **Follows** | Lesson 28 — Drawing The Circle |
| **Leads to** | Lesson 30 — Teaching A Grown-Up |

**Transition in.** Lesson 28 established children draw the cycle with arrows. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children find the cycle outside school. Lesson 30 assumes it and builds children explain the whole cycle to an adult.
