...
| | |
|---|---|
| **Central question** | The Reverse Ladder: students state what a null result licenses? |
| **Core concept** | A null licenses claims only if the condition was prespecified and the controls held. |
| **Student outcome** | Students state what a null result licenses. |
| **Previous session** | Session 5 — The Inference Ladder |
| **Next session** | Session 7 — Confirmatory And Exploratory |
...
**The conceptual step.** A null licenses claims only if the condition was prespecified and the controls held. The reverse ladder is neglected in most methods training.
...
**What depends on it.** Session 7 — Confirmatory And Exploratory — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A null licenses claims only if the condition was prespecified and the controls held. The reverse ladder is neglected in most methods training.
...
1. A reverse ladder stating the null would not fire the condition.
2. A reverse ladder confirming it would, with controls verified.

### One non-example

A claim that a null refutes the framework.
...
That nulls have their own inference ceiling.

### What this activity does not establish

Whether a null will occur.
...
| Statement | Status |
|---|---|
| A null licenses claims only if the condition was prespecified and the controls held. | Framework-derived, appropriate at this grade |
| That nulls have their own inference ceiling. | What this specific activity can show |
| Whether a null will occur. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 5 — The Inference Ladder — specifically: students state the highest rung their design licenses.

**How it was taught.** Through the activity: ladder their own anticipated result and name the rung they will be tempted to claim

**Quick check.** Ask for the closing sentence of Session 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 5: ladder their own anticipated result and name the rung they will be tempted to claim, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A reverse ladder stating the null would not fire the condition. |
| **Non-example** | A claim that a null refutes the framework. |
...
> "Nobody sets out to overclaim. It happens because you have lived with the hypothesis."
...
**Exact wording.** "Ask: you run it and find nothing. What may you say?"
...
**Target observation.** That nulls have their own inference ceiling.
...
> "A null licenses claims only if the condition was prespecified and the controls held. You just saw that when ask: you run it and find nothing.
> Last time we said: Nobody sets out to overclaim. It happens because you have lived with the hypothesis. This is the next part of that.
...
**What students must not infer.** Whether a null will occur.

### 4. Worked example

**The example.** A reverse ladder stating the null would not fire the condition.
...
**Completed answer.** A reverse ladder stating the null would not fire the condition. — which demonstrates that nulls have their own inference ceiling.
...
**Conclusions not licensed.** Whether a null will occur.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A reverse ladder confirming it would, with controls verified. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that a null refutes the framework. Why is this not an
example?"
...
**Exact student instructions.** Write the reverse ladder and state whether their condition would fire.
...
- *Licensed conclusion.* That nulls have their own inference ceiling.
- *Not licensed.* Whether a null will occur.
...
- *Expected response.* That nulls have their own inference ceiling.
...
1. Any wording carrying the idea in `A null licenses claims only if the condition was prespecified and the controls held`.
...
Say: "This half is neglected and it is the more useful one."
...
| | |
|---|---|
| **Follows** | Session 5 — The Inference Ladder |
| **Leads to** | Session 7 — Confirmatory And Exploratory |

**Transition in.** Session 5 established students state the highest rung their design licenses. This session uses that as the starting point.

**Transition out.** This session establishes students state what a null result licenses. Session 7 assumes it and builds students separate prespecified tests from exploration.
