# Session 3 — The Capstone Falsification Condition

**College Year 4** · Independent Critique and Capstone · **Quarter 1** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Capstone Falsification Condition: students write the condition their capstone could trigger? |
| **Core concept** | The capstone condition must be triggerable by a result the design could actually produce. |
| **Student outcome** | Students write the condition their capstone could trigger. |
| **Previous session** | Session 2 — Choosing The Capstone Claim |
| **Next session** | Session 4 — Designing The Capstone |
...
**The conceptual step.** The capstone condition must be triggerable by a result the design could actually produce. Demonstrating the pathway means writing the observations that would trigger it.
...
**What depends on it.** Session 4 — Designing The Capstone — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The capstone condition must be triggerable by a result the design could actually produce. Demonstrating the pathway means writing the observations that would trigger it.
...
1. A condition with the triggering observations written out.
2. A condition revised after the pathway could not be demonstrated.

### One non-example

A condition asserted checkable with no pathway shown.
...
That firing pathways can be demonstrated in advance.

### What this activity does not establish

Whether the condition will fire.
...
| Statement | Status |
|---|---|
| The capstone condition must be triggerable by a result the design could actually produce. | Framework-derived, appropriate at this grade |
| That firing pathways can be demonstrated in advance. | What this specific activity can show |
| Whether the condition will fire. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 2 — Choosing The Capstone Claim — specifically: students select one claim narrow enough to be settled.

**How it was taught.** Through the activity: select a claim, name the rival, and justify the pairing in 300 words

**Quick check.** Ask for the closing sentence of Session 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 2: select a claim, name the rival, and justify the pairing in 300 words, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A condition with the triggering observations written out. |
| **Non-example** | A condition asserted checkable with no pathway shown. |
...
> "Not testing the framework. One claim and the rival it is hardest to separate from."
...
**Exact wording.** "Say: before any design work, write what would make you abandon this claim."
...
**Target observation.** That firing pathways can be demonstrated in advance.
...
> "The capstone condition must be triggerable by a result the design could actually produce. You just saw that when say: before any design work, write what would make you abandon this claim.
> Last time we said: Not testing the framework. One claim and the rival it is hardest to separate from. This is the next part of that.
...
**What students must not infer.** Whether the condition will fire.

### 4. Worked example

**The example.** A condition with the triggering observations written out.
...
**Completed answer.** A condition with the triggering observations written out. — which demonstrates that firing pathways can be demonstrated in advance.
...
**Conclusions not licensed.** Whether the condition will fire.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A condition revised after the pathway could not be demonstrated. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A condition asserted checkable with no pathway shown. Why is this not an
example?"
...
**Exact student instructions.** Write the condition and demonstrate a producible result that triggers it.
...
- *Licensed conclusion.* That firing pathways can be demonstrated in advance.
- *Not licensed.* Whether the condition will fire.
...
- *Expected response.* That firing pathways can be demonstrated in advance.
...
1. Any wording carrying the idea in `The capstone condition must be triggerable by a result the design could actually produce`.
...
Say: "A condition that cannot fire under your own analysis is decorative."
...
| | |
|---|---|
| **Follows** | Session 2 — Choosing The Capstone Claim |
| **Leads to** | Session 4 — Designing The Capstone |

**Transition in.** Session 2 established students select one claim narrow enough to be settled. This session uses that as the starting point.

**Transition out.** This session establishes students write the condition their capstone could trigger. Session 4 assumes it and builds students build the design around the condition.
