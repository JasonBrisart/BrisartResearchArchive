...
| | |
|---|---|
| **Central question** | Revising After The Mock: students revise the capstone against mock feedback? |
| **Core concept** | An unanswered question marks a gap rather than an unfair challenge. |
| **Student outcome** | Students revise the capstone against mock feedback. |
| **Previous session** | Session 20 — The Mock Defence |
| **Next session** | Session 22 — The Capstone Defence |
...
**What depends on it.** Session 22 — The Capstone Defence — opens by assuming this session's closing sentence is already held.
...
1. A revision addressing the measurement challenger's question.
2. A revision narrowing a claim after the inference challenge.

### One non-example

Questions dismissed as outside the project's remit.
...
Whether the revised capstone is sound.
...
| Whether the revised capstone is sound. | Explicitly outside what this activity establishes |
...
**How it was taught.** Through the activity: present for eight minutes, defend for eight, record unanswered questions

**Quick check.** Ask for the closing sentence of Session 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 20: present for eight minutes, defend for eight, record unanswered questions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A revision addressing the measurement challenger's question. |
| **Non-example** | Questions dismissed as outside the project's remit. |
...
**What students must not infer.** Whether the revised capstone is sound.

### 4. Worked example

**The example.** A revision addressing the measurement challenger's question.
...
**Completed answer.** A revision addressing the measurement challenger's question. — which demonstrates that defences improve through revision.
...
**Conclusions not licensed.** Whether the revised capstone is sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A revision narrowing a claim after the inference challenge. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Questions dismissed as outside the project's remit. Why is this not an
example?"
...
**Exact student instructions.** Revise and mark what changed for each unanswered question.
...
- *Not licensed.* Whether the revised capstone is sound.
...
| **Leads to** | Session 22 — The Capstone Defence |
...
**Transition out.** This session establishes students revise the capstone against mock feedback. Session 22 assumes it and builds students defend the capstone against four roles.
