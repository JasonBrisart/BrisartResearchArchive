# Session 15 — Capstone Measurement

**College Year 4** · Independent Critique and Capstone · **Quarter 3** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Capstone Measurement: students build the measurement map for their capstone? |
| **Core concept** | The capstone measurement map is held to the same executability standard as Year 2, verified by fresh external runs rather than by assuming prior competence transfers. |
| **Student outcome** | Students build the measurement map for their capstone. |
| **Previous session** | Session 14 — The Midterm Review |
| **Next session** | Session 16 — Capstone Adjudication |
| **Materials** | Capstone templates; printed inference ladders |
...
**The conceptual step.** The capstone measurement map is held to the same executability standard as Year 2, verified by fresh external runs rather than by assuming prior competence transfers.

**Why students need it now.** This grade owns one idea: the inference ceiling in both directions, and independent critique.
...
that rung three is too conservative. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** A falsification condition is required before any advocacy is accepted. The inference ceiling is declared for both positive and null results.

**What depends on it.** Session 16 — Capstone Adjudication — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The capstone measurement map is held to the same executability standard as Year 2, verified by fresh external runs rather than by assuming prior competence transfers.

### How this is stated at this grade

A falsification condition is required before any advocacy is accepted. The inference ceiling is declared for both positive and null results.

Use only the vocabulary released at or before this grade. Terms not yet available:
Referee-quality manuscript review, governance instruments.

### Why the concept matters

The whole grade rests on the inference ceiling in both directions, and independent critique. If a student leaves this
...
1. A capstone map returning zero questions from one of two runners.
2. A map revised after the first external run found four gaps.

### One non-example

A map assumed adequate because Year 2 maps were.
...
That executability requires fresh verification.

### What this activity does not establish

Whether the map yields valid data.
...
| Statement | Status |
|---|---|
| The capstone measurement map is held to the same executability standard as Year 2, verified by fresh external runs rather than by assuming prior competence transfers. | Framework-derived, appropriate at this grade |
| That executability requires fresh verification. | What this specific activity can show |
| Whether the map yields valid data. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 14 — The Midterm Review — specifically: students consolidate the first half.

**How it was taught.** Through the activity: review covering order, the claim, the ladder, and the critique

**Quick check.** Ask for the closing sentence of Session 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 14: review covering order, the claim, the ladder, and the critique, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | the highest claim a design licenses. |
| **Student wording** | The highest claim a design licenses. |
| **Correct example** | A capstone map returning zero questions from one of two runners. |
| **Non-example** | A map assumed adequate because Year 2 maps were. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for the highest claim a design licenses." |

### reverse ladder

| | |
|---|---|
| **Teacher definition** | what a null result does and does not license. |
| **Student wording** | What a null result does and does not license. |
| **Correct example** | A capstone map returning zero questions from one of two runners. |
| **Non-example** | A map assumed adequate because Year 2 maps were. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for what a null result does and does not license." |

### capstone

| | |
|---|---|
| **Teacher definition** | an independent defended piece of work. |
| **Student wording** | An independent defended piece of work. |
| **Correct example** | A capstone map returning zero questions from one of two runners. |
| **Non-example** | A map assumed adequate because Year 2 maps were. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for an independent defended piece of work." |


Do not introduce terminology from later grades. Referee-quality manuscript review, governance instruments.

## Materials and preparation

**Teacher materials.** Capstone templates; Printed inference ladders; Discipline readings; Whiteboard.
...
> "The midterm covers everything up to here."
...
**Exact wording.** "Say: seven lines, executable. Same standard as Year 2, higher stakes."
...
**Target observation.** That executability requires fresh verification.
...
> "The capstone measurement map is held to the same executability standard as Year 2, verified by fresh external runs rather than by assuming prior competence transfers. You just saw that when say: seven lines, executable.
> Last time we said: The midterm covers everything up to here. This is the next part of that.
> It matters because falsification before advocacy, and a capstone that could fail"
...
**Terminology to introduce here.** inference ceiling, reverse ladder, capstone.

**What students must not infer.** Whether the map yields valid data.

### 4. Worked example

**The example.** A capstone map returning zero questions from one of two runners.
...
**Completed answer.** A capstone map returning zero questions from one of two runners. — which demonstrates that executability requires fresh verification.
...
**Conclusions not licensed.** Whether the map yields valid data.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A map revised after the first external run found four gaps. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A map assumed adequate because Year 2 maps were. Why is this not an
example?"
...
**Exact student instructions.** Build the map and have it externally run by two classmates.
...
- *Licensed conclusion.* That executability requires fresh verification.
- *Not licensed.* Whether the map yields valid data.
...
- *Expected response.* That executability requires fresh verification.
...
3. **Misconception check.** Somebody says: "Rung three is too conservative" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `The capstone measurement map is held to the same executability standard as Year 2, verified by fresh external runs rather than by assuming prior competence transfers`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Overclaiming on a framework's behalf is how frameworks get discredited.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "Executable means runnable by a stranger."
...
### 1. "Rung three is too conservative"

**What the student says or does.** Rung three is too conservative — usually while otherwise engaging well.

**Why it is understandable.** Cumulative reasoning is how fields progress.
...
**Exact correction.** Run the argument both ways.

**Say this.** "Overclaiming on a framework's behalf is how frameworks get discredited."
...
### 2. "A null result refutes the framework"

**What the student says or does.** A null result refutes the framework — usually while otherwise engaging well.

**Why it is understandable.** Symmetry with the positive case.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** The reverse ladder.

**Say this.** "Your condition fires only if prespecified and its controls held."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "Prespecification prevents discovery"

**What the student says or does.** Prespecification prevents discovery — usually while otherwise engaging well.

**Why it is understandable.** Rigidity reads as a constraint on finding things.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Exploration is legitimate and must be labelled.

**Say this.** "The problem is presenting exploration as confirmation."
...
**Visual or physical support.** Provide the inference ladder with rungs one to three worked.
...
Ask for the discussion section a null result would license.
...
Specifically, do not introduce: Referee-quality manuscript review, governance instruments.
...
- Whether the capstone is expected to support or refute the framework
...
| | |
|---|---|
| **Follows** | Session 14 — The Midterm Review |
| **Leads to** | Session 16 — Capstone Adjudication |

**Transition in.** Session 14 established students consolidate the first half. This session uses that as the starting point.

**Transition out.** This session establishes students build the measurement map for their capstone. Session 16 assumes it and builds students state predictions for every account in their capstone.
