...
| | |
|---|---|
| **Central question** | Capstone Confounds: students complete the confound table for the capstone? |
| **Core concept** | Every confound row requires a control and an acknowledged residual risk. |
| **Student outcome** | Students complete the confound table for the capstone. |
| **Previous session** | Session 16 — Capstone Adjudication |
| **Next session** | Session 18 — Capstone Scope Rejection |
...
**The conceptual step.** Every confound row requires a control and an acknowledged residual risk. Dismissal without a written reason is not treatment.
...
**What depends on it.** Session 18 — Capstone Scope Rejection — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Every confound row requires a control and an acknowledged residual risk. Dismissal without a written reason is not treatment.
...
1. A confound controlled with residual risk stated.
2. A confound dismissed with an adequate written reason.

### One non-example

Three confound rows left blank.
...
That confound treatment is auditable.
...
| Statement | Status |
|---|---|
| Every confound row requires a control and an acknowledged residual risk. | Framework-derived, appropriate at this grade |
| That confound treatment is auditable. | What this specific activity can show |
| Whether the controls suffice. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 16 — Capstone Adjudication — specifically: students state predictions for every account in their capstone.

**How it was taught.** Through the activity: complete the five-row prediction table with all rows distinct

**Quick check.** Ask for the closing sentence of Session 16. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 16: complete the five-row prediction table with all rows distinct, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A confound controlled with residual risk stated. |
| **Non-example** | Three confound rows left blank. |
...
> "Identical predictions mean the capstone does not adjudicate."
...
**Exact wording.** "Say: seven rows, controls, and residual risks. No blanks."
...
**Target observation.** That confound treatment is auditable.
...
> "Every confound row requires a control and an acknowledged residual risk. You just saw that when say: seven rows, controls, and residual risks.
> Last time we said: Identical predictions mean the capstone does not adjudicate. This is the next part of that.
...
**The example.** A confound controlled with residual risk stated.
...
**Completed answer.** A confound controlled with residual risk stated. — which demonstrates that confound treatment is auditable.
...
**Teacher prompt.** "Here is a second case. A confound dismissed with an adequate written reason. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Three confound rows left blank. Why is this not an
example?"
...
**Exact student instructions.** Complete the table and have it adversarially audited.
...
- *Licensed conclusion.* That confound treatment is auditable.
...
- *Expected response.* That confound treatment is auditable.
...
1. Any wording carrying the idea in `Every confound row requires a control and an acknowledged residual risk`.
...
Say: "Residual risk acknowledged beats residual risk dismissed."
...
| | |
|---|---|
| **Follows** | Session 16 — Capstone Adjudication |
| **Leads to** | Session 18 — Capstone Scope Rejection |

**Transition in.** Session 16 established students state predictions for every account in their capstone. This session uses that as the starting point.

**Transition out.** This session establishes students complete the confound table for the capstone. Session 18 assumes it and builds students reject an invalid variant of their own capstone.
