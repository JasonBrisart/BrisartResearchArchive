...
| | |
|---|---|
| **Central question** | Practice Final: students rehearse the gated final under conditions? |
| **Core concept** | The practice final is marked gate-first, exactly as the real paper will be. |
| **Student outcome** | Students rehearse the gated final under conditions. |
| **Previous session** | Session 25 — The Degree In Review |
| **Next session** | Session 27 — Final Preparation |
...
**The conceptual step.** The practice final is marked gate-first, exactly as the real paper will be. Knowing whether the gates would pass is its purpose.
...
**What depends on it.** Session 27 — Final Preparation — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The practice final is marked gate-first, exactly as the real paper will be. Knowing whether the gates would pass is its purpose.
...
2. A student discovering Gate A would currently fail.
...
Whether each student would pass the gates.
...
| Whether each student would pass the gates. | What this specific activity can show |
| The final grade. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 25 — The Degree In Review — specifically: students review four years of their own work.

**How it was taught.** Through the activity: compare Year 1 work with Year 4 work and write what changed

**Quick check.** Ask for the closing sentence of Session 25. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 25: compare Year 1 work with Year 4 work and write what changed, in miniature, using one example only. Then ask for the sentence again.
...
> "Look at the distance. You did that."
...
**Target observation.** Whether each student would pass the gates.
...
> Last time we said: Look at the distance. You did that. This is the next part of that.
...
**Completed answer.** A practice paper marked gate-first. — which demonstrates whether each student would pass the gates.
...
**Teacher prompt.** "Here is a second case. A student discovering Gate A would currently fail. Work it through with me."
...
**Exact student instructions.** A full practice final, gates checked first.
...
- *Licensed conclusion.* Whether each student would pass the gates.
...
- *Expected response.* Whether each student would pass the gates.
...
Say: "Now you know whether the gates would pass."
...
| | |
|---|---|
| **Follows** | Session 25 — The Degree In Review |
| **Leads to** | Session 27 — Final Preparation |

**Transition in.** Session 25 established students review four years of their own work. This session uses that as the starting point.

**Transition out.** This session establishes students rehearse the gated final under conditions. Session 27 assumes it and builds students address weaknesses the practice revealed.
