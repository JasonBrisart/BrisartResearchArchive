# Session 12 — The Closure Path

**College Year 4** · Independent Critique and Capstone · **Quarter 2** · **75 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Closure Path: students specify what would resolve the issue raised? |
| **Core concept** | A closure path specifies actionable work and distinguishes theoretical clarification from empirical investigation. |
| **Student outcome** | Students specify what would resolve the issue raised. |
| **Previous session** | Session 11 — Responding Or Conceding |
| **Next session** | Session 13 — Proportionate Assessment |
...
**The conceptual step.** A closure path specifies actionable work and distinguishes theoretical clarification from empirical investigation. Without it a critique is a complaint with citations.
...
**What depends on it.** Session 13 — Proportionate Assessment — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A closure path specifies actionable work and distinguishes theoretical clarification from empirical investigation. Without it a critique is a complaint with citations.
...
1. A path requiring theoretical specification of the threshold.
2. A path requiring an empirical study with a named design.

### One non-example

A path stating that more work is needed in this area.
...
That critiques can specify their own resolution.

### What this activity does not establish

Whether the path would succeed.
...
| Statement | Status |
|---|---|
| A closure path specifies actionable work and distinguishes theoretical clarification from empirical investigation. | Framework-derived, appropriate at this grade |
| That critiques can specify their own resolution. | What this specific activity can show |
| Whether the path would succeed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 11 — Responding Or Conceding — specifically: students answer the defence or narrow the critique.

**How it was taught.** Through the activity: write the response or a reasoned concession that narrows the critique

**Quick check.** Ask for the closing sentence of Session 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 11: write the response or a reasoned concession that narrows the critique, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A path requiring theoretical specification of the threshold. |
| **Non-example** | A path stating that more work is needed in this area. |
...
> "A narrowed surviving critique is worth more than an overreaching one."
...
**Exact wording.** "Ask what would fill the gap they found."
...
**Target observation.** That critiques can specify their own resolution.
...
> "A closure path specifies actionable work and distinguishes theoretical clarification from empirical investigation. You just saw that when ask what would fill the gap they found.
> Last time we said: A narrowed surviving critique is worth more than an overreaching one. This is the next part of that.
...
**What students must not infer.** Whether the path would succeed.

### 4. Worked example

**The example.** A path requiring theoretical specification of the threshold.
...
**Completed answer.** A path requiring theoretical specification of the threshold. — which demonstrates that critiques can specify their own resolution.
...
**Conclusions not licensed.** Whether the path would succeed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A path requiring an empirical study with a named design. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A path stating that more work is needed in this area. Why is this not an
example?"
...
**Exact student instructions.** Write the closure path, distinguishing theoretical from empirical work.
...
- *Licensed conclusion.* That critiques can specify their own resolution.
- *Not licensed.* Whether the path would succeed.
...
- *Expected response.* That critiques can specify their own resolution.
...
1. Any wording carrying the idea in `A closure path specifies actionable work and distinguishes theoretical clarification from empirical investigation`.
...
Say: "Naming the closure path turns a complaint into a contribution."
...
| | |
|---|---|
| **Follows** | Session 11 — Responding Or Conceding |
| **Leads to** | Session 13 — Proportionate Assessment |

**Transition in.** Session 11 established students answer the defence or narrow the critique. This session uses that as the starting point.

**Transition out.** This session establishes students specify what would resolve the issue raised. Session 13 assumes it and builds students match the verdict to the critique's scope.
