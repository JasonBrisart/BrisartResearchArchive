# Lesson 12 — Closure Versus Convenience
...
| | |
|---|---|
| **Central question** | Closure Versus Convenience: students test whether closure is principled or convenient? |
| **Core concept** | Closure is convenient if the excluded variables are precisely those that would threaten the framework's claims. |
| **Student outcome** | Students test whether closure is principled or convenient. |
| **Previous lesson** | Lesson 11 — The Cost Of Adding |
| **Next lesson** | Lesson 13 — Tracing With The Relation |
...
**The conceptual step.** Closure is convenient if the excluded variables are precisely those that would threaten the framework's claims. Testing this requires naming a threatening excluded variable.
...
**What depends on it.** Lesson 13 — Tracing With The Relation — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Closure is convenient if the excluded variables are precisely those that would threaten the framework's claims. Testing this requires naming a threatening excluded variable.
...
1. An excluded variable that would not threaten the gating claim.
2. An excluded variable that would, which supports the challenge.

### One non-example

Accepting that closure is principled without testing it.
...
That the convenience charge can be tested.
...
| Statement | Status |
|---|---|
| Closure is convenient if the excluded variables are precisely those that would threaten the framework's claims. | Framework-derived, appropriate at this grade |
| That the convenience charge can be tested. | What this specific activity can show |
| Whether closure is principled. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 11 — The Cost Of Adding — specifically: students quantify what a sixth variable would cost.

**How it was taught.** Through the activity: for three proposals, name a currently-contradicting result the addition would absorb

**Quick check.** Ask for the closing sentence of Lesson 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 11: for three proposals, name a currently-contradicting result the addition would absorb, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An excluded variable that would not threaten the gating claim. |
| **Non-example** | Accepting that closure is principled without testing it. |
...
> "If it can absorb any result, it can never fail."
...
**Exact wording.** "Say: if closure were convenient, the excluded variables would be the threatening ones."
...
**Target observation.** That the convenience charge can be tested.
...
> "Closure is convenient if the excluded variables are precisely those that would threaten the framework's claims. You just saw that when say: if closure were convenient, the excluded variables would be the threatening ones.
> Last time we said: If it can absorb any result, it can never fail. This is the next part of that.
...
**The example.** An excluded variable that would not threaten the gating claim.
...
**Completed answer.** An excluded variable that would not threaten the gating claim. — which demonstrates that the convenience charge can be tested.
...
**Teacher prompt.** "Here is a second case. An excluded variable that would, which supports the challenge. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Accepting that closure is principled without testing it. Why is this not an
example?"
...
**Exact student instructions.** Test three excluded variables against the convenience challenge.
...
- *Licensed conclusion.* That the convenience charge can be tested.
...
- *Expected response.* That the convenience charge can be tested.
...
1. Any wording carrying the idea in `Closure is convenient if the excluded variables are precisely those that would threaten the framework's claims`.
...
Say: "Check whether the excluded ones are the threatening ones."
...
| | |
|---|---|
| **Follows** | Lesson 11 — The Cost Of Adding |
| **Leads to** | Lesson 13 — Tracing With The Relation |

**Transition in.** Lesson 11 established students quantify what a sixth variable would cost. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students test whether closure is principled or convenient. Lesson 13 assumes it and builds students hand-trace F(t) across multiple cycles.
