...
| | |
|---|---|
| **Central question** | Variable Closure: students state the closure constraint and its cost? |
| **Core concept** | Variable closure restricts inference to the declared set. |
| **Student outcome** | Students state the closure constraint and its cost. |
| **Previous lesson** | Lesson 8 — The Relation Review |
| **Next lesson** | Lesson 10 — The Absorption Exercise |
...
**The conceptual step.** Variable closure restricts inference to the declared set. Adding variables increases explanatory reach and decreases falsifiability, which is the trade being made.
...
**What depends on it.** Lesson 10 — The Absorption Exercise — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Variable closure restricts inference to the declared set. Adding variables increases explanatory reach and decreases falsifiability, which is the trade being made.
...
1. A proposed attention variable, costed in falsifiability.
2. A proposed motivation variable, partly absorbable into E(t).

### One non-example

Closure described as the author being unwilling to improve the model.
...
That closure is a stated trade with a cost.
...
| Statement | Status |
|---|---|
| Variable closure restricts inference to the declared set. | Framework-derived, appropriate at this grade |
| That closure is a stated trade with a cost. | What this specific activity can show |
| Whether the trade is worth making. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Relation Review — specifically: students consolidate the integration function.

**How it was taught.** Through the activity: review with eight statements marked correct or incorrect about the relation

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: review with eight statements marked correct or incorrect about the relation, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A proposed attention variable, costed in falsifiability. |
| **Non-example** | Closure described as the author being unwilling to improve the model. |
...
> "Next time: why the framework refuses to add variables."
...
**Exact wording.** "Ask them to propose a sixth variable that would improve the model. Write every suggestion up."
...
**Target observation.** That closure is a stated trade with a cost.
...
> "Variable closure restricts inference to the declared set. You just saw that when ask them to propose a sixth variable that would improve the model.
> Last time we said: Next time: why the framework refuses to add variables. This is the next part of that.
...
**The example.** A proposed attention variable, costed in falsifiability.
...
**Completed answer.** A proposed attention variable, costed in falsifiability. — which demonstrates that closure is a stated trade with a cost.
...
**Teacher prompt.** "Here is a second case. A proposed motivation variable, partly absorbable into E(t). Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Closure described as the author being unwilling to improve the model. Why is this not an
example?"
...
**Exact student instructions.** Analyse four proposed variables for absorption and cost.
...
- *Licensed conclusion.* That closure is a stated trade with a cost.
...
- *Expected response.* That closure is a stated trade with a cost.
...
1. Any wording carrying the idea in `Variable closure restricts inference to the declared set`.
...
Say: "Closure trades explanatory reach for the ability to be wrong."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Relation Review |
| **Leads to** | Lesson 10 — The Absorption Exercise |

**Transition in.** Lesson 8 established students consolidate the integration function. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state the closure constraint and its cost. Lesson 10 assumes it and builds students test whether a proposed variable can be absorbed.
