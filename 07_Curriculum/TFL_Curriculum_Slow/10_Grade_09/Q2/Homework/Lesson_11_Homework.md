# Lesson 11 Homework — The Cost Of Adding

**Grade 9** · The Formal System · **Quarter 2**
**Follows:** Lesson 11 — The Cost Of Adding · **Points:** 5 · **Optional:** yes
...
For three proposals, name a currently-contradicting result the addition would absorb.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names an absorbed result for at least two proposals
...
Lesson 12 is **Closure Versus Convenience**, which assumes you arrive holding it. Write one thing you expect it to be about:
