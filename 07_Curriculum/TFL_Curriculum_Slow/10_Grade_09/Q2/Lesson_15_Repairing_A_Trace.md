...
| | |
|---|---|
| **Central question** | Repairing A Trace: students repair an architecturally broken trace? |
| **Core concept** | Repair preserves the original and adds what was missing. |
| **Student outcome** | Students repair an architecturally broken trace. |
| **Previous lesson** | Lesson 14 — Breaking A Trace |
| **Next lesson** | Lesson 16 — The Closure Review |
...
**The conceptual step.** Repair preserves the original and adds what was missing. Rewriting hides the diagnosis, which is the part worth keeping.
...
**What depends on it.** Lesson 16 — The Closure Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Repair preserves the original and adds what was missing. Rewriting hides the diagnosis, which is the part worth keeping.
...
1. A repair inserting a missing cycle.
2. A repair naming previously unstated propagation.

### One non-example

A trace rewritten cleanly with the break invisible.
...
That repair preserves the diagnosis.

### What this activity does not establish

Whether the repaired trace is accurate.
...
| Statement | Status |
|---|---|
| Repair preserves the original and adds what was missing. | Framework-derived, appropriate at this grade |
| That repair preserves the diagnosis. | What this specific activity can show |
| Whether the repaired trace is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 14 — Breaking A Trace — specifically: students identify architectural violations in a trace.

**How it was taught.** Through the activity: audit four traces, citing the specific rule each violation breaks

**Quick check.** Ask for the closing sentence of Lesson 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 14: audit four traces, citing the specific rule each violation breaks, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A repair inserting a missing cycle. |
| **Non-example** | A trace rewritten cleanly with the break invisible. |
...
**Exact wording.** "Say: repair it without rewriting it. The original stays visible."
...
**Target observation.** That repair preserves the diagnosis.
...
> "Repair preserves the original and adds what was missing. You just saw that when say: repair it without rewriting it.
> Last time we said: Cite the rule, not the gap. This is the next part of that.
...
**What students must not infer.** Whether the repaired trace is accurate.

### 4. Worked example

**The example.** A repair inserting a missing cycle.
...
**Completed answer.** A repair inserting a missing cycle. — which demonstrates that repair preserves the diagnosis.
...
**Conclusions not licensed.** Whether the repaired trace is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A repair naming previously unstated propagation. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A trace rewritten cleanly with the break invisible. Why is this not an
example?"
...
**Exact student instructions.** Repair four audited traces and classify each repair type.
...
- *Licensed conclusion.* That repair preserves the diagnosis.
- *Not licensed.* Whether the repaired trace is accurate.
...
- *Expected response.* That repair preserves the diagnosis.
...
1. Any wording carrying the idea in `Repair preserves the original and adds what was missing`.
...
Say: "A break is sometimes a missing cycle, not an error."
...
| | |
|---|---|
| **Follows** | Lesson 14 — Breaking A Trace |
| **Leads to** | Lesson 16 — The Closure Review |

**Transition in.** Lesson 14 established students identify architectural violations in a trace. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students repair an architecturally broken trace. Lesson 16 assumes it and builds students consolidate closure and propagation.
