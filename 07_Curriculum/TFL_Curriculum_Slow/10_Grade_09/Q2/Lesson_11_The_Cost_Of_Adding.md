# Lesson 11 — The Cost Of Adding

**Grade 9** · The Formal System · **Quarter 2** · **50 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Cost Of Adding: students quantify what a sixth variable would cost? |
| **Core concept** | The cost of a new variable is measured by naming a specific result that currently contradicts the framework and would no longer do so after the addition. |
| **Student outcome** | Students quantify what a sixth variable would cost. |
| **Previous lesson** | Lesson 10 — The Absorption Exercise |
| **Next lesson** | Lesson 12 — Closure Versus Convenience |
...
**The conceptual step.** The cost of a new variable is measured by naming a specific result that currently contradicts the framework and would no longer do so after the addition.
...
**What depends on it.** Lesson 12 — Closure Versus Convenience — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The cost of a new variable is measured by naming a specific result that currently contradicts the framework and would no longer do so after the addition.
...
1. A contradicting persistence result absorbed by a new variable.
2. A named result that the addition would explain away.

### One non-example

A cost stated as reduced parsimony with no example.
...
That costs can be stated as specific absorbed results.

### What this activity does not establish

Whether the addition would be justified.
...
| Statement | Status |
|---|---|
| The cost of a new variable is measured by naming a specific result that currently contradicts the framework and would no longer do so after the addition. | Framework-derived, appropriate at this grade |
| That costs can be stated as specific absorbed results. | What this specific activity can show |
| Whether the addition would be justified. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 10 — The Absorption Exercise — specifically: students test whether a proposed variable can be absorbed.

**How it was taught.** Through the activity: attempt absorption on four proposals, marking each yes, no, or partly

**Quick check.** Ask for the closing sentence of Lesson 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 10: attempt absorption on four proposals, marking each yes, no, or partly, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A contradicting persistence result absorbed by a new variable. |
| **Non-example** | A cost stated as reduced parsimony with no example. |
...
> "Partly is a real answer. Forcing it either way is not."
...
**Exact wording.** "Say: add your variable. Now name a result the framework could no longer fail."
...
**Target observation.** That costs can be stated as specific absorbed results.
...
> "The cost of a new variable is measured by naming a specific result that currently contradicts the framework and would no longer do so after the addition. You just saw that when say: add your variable.
> Last time we said: Partly is a real answer. Forcing it either way is not. This is the next part of that.
...
**What students must not infer.** Whether the addition would be justified.

### 4. Worked example

**The example.** A contradicting persistence result absorbed by a new variable.
...
**Completed answer.** A contradicting persistence result absorbed by a new variable. — which demonstrates that costs can be stated as specific absorbed results.
...
**Conclusions not licensed.** Whether the addition would be justified.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A named result that the addition would explain away. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A cost stated as reduced parsimony with no example. Why is this not an
example?"
...
**Exact student instructions.** For three proposals, name a currently-contradicting result the addition would absorb.
...
- *Licensed conclusion.* That costs can be stated as specific absorbed results.
- *Not licensed.* Whether the addition would be justified.
...
- *Expected response.* That costs can be stated as specific absorbed results.
...
1. Any wording carrying the idea in `The cost of a new variable is measured by naming a specific result that currently contradicts the framework and would no longer do so after the addition`.
...
Say: "If it can absorb any result, it can never fail."
...
| | |
|---|---|
| **Follows** | Lesson 10 — The Absorption Exercise |
| **Leads to** | Lesson 12 — Closure Versus Convenience |

**Transition in.** Lesson 10 established students test whether a proposed variable can be absorbed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students quantify what a sixth variable would cost. Lesson 12 assumes it and builds students test whether closure is principled or convenient.
