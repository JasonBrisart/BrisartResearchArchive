# Lesson 3 — Weights And Behaviour
...
| | |
|---|---|
| **Central question** | Weights And Behaviour: students predict system behaviour from weight configurations? |
| **Core concept** | Changing a weight changes which term dominates the integrated state. |
| **Student outcome** | Students predict system behaviour from weight configurations. |
| **Previous lesson** | Lesson 2 — Reading The Relation |
| **Next lesson** | Lesson 4 — Weight Cases In Depth |
...
**The conceptual step.** Changing a weight changes which term dominates the integrated state. The resulting descriptions are structural, not descriptions of people.
...
**What depends on it.** Lesson 4 — Weight Cases In Depth — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Changing a weight changes which term dominates the integrated state. The resulting descriptions are structural, not descriptions of people.
...
1. A high-w1 case dominated by incoming input.
2. A high-w3 case dominated by the simulation.

### One non-example

A high-w3 case described as an imaginative personality.
...
That weight configurations produce distinct system behaviours.

### What this activity does not establish

That any person has particular weight values.
...
| Statement | Status |
|---|---|
| Changing a weight changes which term dominates the integrated state. | Framework-derived, appropriate at this grade |
| That weight configurations produce distinct system behaviours. | What this specific activity can show |
| That any person has particular weight values. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — Reading The Relation — specifically: students decode the integration function term by term.

**How it was taught.** Through the activity: write the relation from memory and produce three translations of increasing precision

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: write the relation from memory and produce three translations of increasing precision, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A high-w1 case dominated by incoming input. |
| **Non-example** | A high-w3 case described as an imaginative personality. |
...
> "The integrated state is the weighted combination of input, memory, and simulation."
...
**Exact wording.** "Say: w2 doubles, everything else holds. What changes? Take predictions first."
...
**Target observation.** That weight configurations produce distinct system behaviours.
...
> "Changing a weight changes which term dominates the integrated state. You just saw that when say: w2 doubles, everything else holds.
> Last time we said: The integrated state is the weighted combination of input, memory, and simulation. This is the next part of that.
...
**What students must not infer.** That any person has particular weight values.

### 4. Worked example

**The example.** A high-w1 case dominated by incoming input.
...
**Completed answer.** A high-w1 case dominated by incoming input. — which demonstrates that weight configurations produce distinct system behaviours.
...
**Conclusions not licensed.** That any person has particular weight values.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A high-w3 case dominated by the simulation. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A high-w3 case described as an imaginative personality. Why is this not an
example?"
...
**Exact student instructions.** Complete a six-case table with the dominant term and expected behaviour.
...
- *Licensed conclusion.* That weight configurations produce distinct system behaviours.
- *Not licensed.* That any person has particular weight values.
...
- *Expected response.* That weight configurations produce distinct system behaviours.
...
1. Any wording carrying the idea in `Changing a weight changes which term dominates the integrated state`.
...
Say: "These are parameters of a model, not quantities anybody has."
...
| | |
|---|---|
| **Follows** | Lesson 2 — Reading The Relation |
| **Leads to** | Lesson 4 — Weight Cases In Depth |

**Transition in.** Lesson 2 established students decode the integration function term by term. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students predict system behaviour from weight configurations. Lesson 4 assumes it and builds students reason about extreme and balanced weight configurations.
