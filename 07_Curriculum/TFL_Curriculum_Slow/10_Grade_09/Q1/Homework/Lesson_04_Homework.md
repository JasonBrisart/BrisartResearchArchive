# Lesson 4 Homework — Weight Cases In Depth

**Grade 9** · The Formal System · **Quarter 1**
**Follows:** Lesson 4 — Weight Cases In Depth · **Points:** 5 · **Optional:** yes
...
Four extreme cases analysed, with what each would fail at.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student states a failure mode for each extreme case
...
Lesson 5 is **Conditional Determinism**, which assumes you arrive holding it. Write one thing you expect it to be about:
