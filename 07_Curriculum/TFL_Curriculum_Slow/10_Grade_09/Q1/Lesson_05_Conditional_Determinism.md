# Lesson 5 — Conditional Determinism
...
| **Core concept** | Conditional determinism states that fixed inputs and fixed parameters produce a unique integrated state. |
| **Student outcome** | Students state what the framework guarantees about repeatability. |
| **Previous lesson** | Lesson 4 — Weight Cases In Depth |
| **Next lesson** | Lesson 6 — Where Variability Comes From |
...
**The conceptual step.** Conditional determinism states that fixed inputs and fixed parameters produce a unique integrated state. The condition on parameters is essential and often dropped.
...
**What depends on it.** Lesson 6 — Where Variability Comes From — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Conditional determinism states that fixed inputs and fixed parameters produce a unique integrated state. The condition on parameters is essential and often dropped.
...
1. Same input and same weights producing the same F(t).
2. Same input with different weights producing different F(t).

### One non-example

A claim that the same input always produces the same output.
...
That the guarantee carries a stated condition.

### What this activity does not establish

That human behaviour is deterministic.
...
| Statement | Status |
|---|---|
| Conditional determinism states that fixed inputs and fixed parameters produce a unique integrated state. | Framework-derived, appropriate at this grade |
| That the guarantee carries a stated condition. | What this specific activity can show |
| That human behaviour is deterministic. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 4 — Weight Cases In Depth — specifically: students reason about extreme and balanced weight configurations.

**How it was taught.** Through the activity: four extreme cases analysed, with what each would fail at

**Quick check.** Ask for the closing sentence of Lesson 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 4: four extreme cases analysed, with what each would fail at, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Same input and same weights producing the same F(t). |
| **Non-example** | A claim that the same input always produces the same output. |
...
> "Extremes tell you what each term is doing."
...
**Exact wording.** "Ask: same inputs, same weights. Same F(t)? Take votes."
...
**Target observation.** That the guarantee carries a stated condition.
...
> "Conditional determinism states that fixed inputs and fixed parameters produce a unique integrated state. You just saw that when ask: same inputs, same weights.
> Last time we said: Extremes tell you what each term is doing. This is the next part of that.
...
**What students must not infer.** That human behaviour is deterministic.

### 4. Worked example

**The example.** Same input and same weights producing the same F(t).
...
**Completed answer.** Same input and same weights producing the same F(t). — which demonstrates that the guarantee carries a stated condition.
...
**Conclusions not licensed.** That human behaviour is deterministic.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Same input with different weights producing different F(t). Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that the same input always produces the same output. Why is this not an
example?"
...
- *Licensed conclusion.* That the guarantee carries a stated condition.
- *Not licensed.* That human behaviour is deterministic.
...
- *Expected response.* That the guarantee carries a stated condition.
...
1. Any wording carrying the idea in `Conditional determinism states that fixed inputs and fixed parameters produce a unique integrated state`.
...
| | |
|---|---|
| **Follows** | Lesson 4 — Weight Cases In Depth |
| **Leads to** | Lesson 6 — Where Variability Comes From |

**Transition in.** Lesson 4 established students reason about extreme and balanced weight configurations. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state what the framework guarantees about repeatability. Lesson 6 assumes it and builds students locate the sources of variation across implementations.
