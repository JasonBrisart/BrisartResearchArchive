...
| | |
|---|---|
| **Central question** | Judging Arguments: students evaluate structural arguments by criteria? |
| **Core concept** | Arguments are judged by whether they state costs honestly, name specific consequences, and identify justifying evidence. |
| **Student outcome** | Students evaluate structural arguments by criteria. |
| **Previous lesson** | Lesson 26 — Arguing The Other Side |
| **Next lesson** | Lesson 28 — Defending Under Challenge |
...
**The conceptual step.** Arguments are judged by whether they state costs honestly, name specific consequences, and identify justifying evidence. Agreement with the conclusion is not a criterion.
...
**What depends on it.** Lesson 28 — Defending Under Challenge — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Arguments are judged by whether they state costs honestly, name specific consequences, and identify justifying evidence. Agreement with the conclusion is not a criterion.
...
1. An argument ranked highly for naming its own costs.
2. An argument ranked low for asserting without costing.

### One non-example

An argument ranked highly because its conclusion is appealing.
...
That arguments can be judged on stated criteria.
...
| Statement | Status |
|---|---|
| Arguments are judged by whether they state costs honestly, name specific consequences, and identify justifying evidence. | Framework-derived, appropriate at this grade |
| That arguments can be judged on stated criteria. | What this specific activity can show |
| Which conclusion is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 26 — Arguing The Other Side — specifically: students argue for the modification they argued against.

**How it was taught.** Through the activity: a 250-word argument for the opposite position

**Quick check.** Ask for the closing sentence of Lesson 26. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 26: a 250-word argument for the opposite position, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An argument ranked highly for naming its own costs. |
| **Non-example** | An argument ranked highly because its conclusion is appealing. |
...
> "You should be able to argue both. That is the test."
...
**Exact wording.** "Put two arguments on the board, one stronger, and ask which and why."
...
**Target observation.** That arguments can be judged on stated criteria.
...
> "Arguments are judged by whether they state costs honestly, name specific consequences, and identify justifying evidence. You just saw that when put two arguments on the board, one stronger, and ask which and why.
> Last time we said: You should be able to argue both. That is the test. This is the next part of that.
...
**What students must not infer.** Which conclusion is correct.

### 4. Worked example

**The example.** An argument ranked highly for naming its own costs.
...
**Completed answer.** An argument ranked highly for naming its own costs. — which demonstrates that arguments can be judged on stated criteria.
...
**Conclusions not licensed.** Which conclusion is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An argument ranked low for asserting without costing. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An argument ranked highly because its conclusion is appealing. Why is this not an
example?"
...
**Exact student instructions.** Judge six arguments against three criteria and rank them.
...
- *Licensed conclusion.* That arguments can be judged on stated criteria.
- *Not licensed.* Which conclusion is correct.
...
- *Expected response.* That arguments can be judged on stated criteria.
...
1. Any wording carrying the idea in `Arguments are judged by whether they state costs honestly, name specific consequences, and identify justifying evidence`.
...
Say: "Good arguments cost things honestly. Weak ones assert."
...
| | |
|---|---|
| **Follows** | Lesson 26 — Arguing The Other Side |
| **Leads to** | Lesson 28 — Defending Under Challenge |

**Transition in.** Lesson 26 established students argue for the modification they argued against. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students evaluate structural arguments by criteria. Lesson 28 assumes it and builds students defend a structural argument against classmates.
