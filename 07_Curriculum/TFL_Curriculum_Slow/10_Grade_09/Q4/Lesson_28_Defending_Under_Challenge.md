# Lesson 28 — Defending Under Challenge
...
| | |
|---|---|
| **Central question** | Defending Under Challenge: students defend a structural argument against classmates? |
| **Core concept** | A defence engages the specific challenge. |
| **Student outcome** | Students defend a structural argument against classmates. |
| **Previous lesson** | Lesson 27 — Judging Arguments |
| **Next lesson** | Lesson 29 — The Whole Structure |
...
**The conceptual step.** A defence engages the specific challenge. Restating the original argument more firmly is the commonest evasion and does not constitute a defence.
...
**What depends on it.** Lesson 29 — The Whole Structure — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A defence engages the specific challenge. Restating the original argument more firmly is the commonest evasion and does not constitute a defence.
...
1. A defence answering the cost challenge directly.
2. A defence conceding a point and narrowing the argument.

### One non-example

A defence restating the original position.
...
Whether specific challenges can be engaged.
...
| Statement | Status |
|---|---|
| A defence engages the specific challenge. | Framework-derived, appropriate at this grade |
| Whether specific challenges can be engaged. | What this specific activity can show |
| Whether the argument survives. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — Judging Arguments — specifically: students evaluate structural arguments by criteria.

**How it was taught.** Through the activity: judge six arguments against three criteria and rank them

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: judge six arguments against three criteria and rank them, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence answering the cost challenge directly. |
| **Non-example** | A defence restating the original position. |
...
> "Good arguments cost things honestly. Weak ones assert."
...
**Exact wording.** "Say: swap arguments. Attack the weakest part."
...
**Target observation.** Whether specific challenges can be engaged.
...
> "A defence engages the specific challenge. You just saw that when say: swap arguments.
> Last time we said: Good arguments cost things honestly. Weak ones assert. This is the next part of that.
...
**The example.** A defence answering the cost challenge directly.
...
**Completed answer.** A defence answering the cost challenge directly. — which demonstrates whether specific challenges can be engaged.
...
**Teacher prompt.** "Here is a second case. A defence conceding a point and narrowing the argument. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence restating the original position. Why is this not an
example?"
...
**Exact student instructions.** Each student answers three written challenges to their argument.
...
- *Licensed conclusion.* Whether specific challenges can be engaged.
...
- *Expected response.* Whether specific challenges can be engaged.
...
1. Any wording carrying the idea in `A defence engages the specific challenge`.
...
| | |
|---|---|
| **Follows** | Lesson 27 — Judging Arguments |
| **Leads to** | Lesson 29 — The Whole Structure |

**Transition in.** Lesson 27 established students evaluate structural arguments by criteria. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students defend a structural argument against classmates. Lesson 29 assumes it and builds students present the formal system and defend one claim.
