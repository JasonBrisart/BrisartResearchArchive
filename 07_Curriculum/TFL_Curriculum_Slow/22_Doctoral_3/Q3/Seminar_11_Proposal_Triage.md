...
| | |
|---|---|
| **Central question** | Proposal Triage: participants judge whether a proposal would move the question? |
| **Core concept** | Most proposals produce a result without moving the question. |
| **Student outcome** | Participants judge whether a proposal would move the question. |
| **Previous seminar** | Seminar 10 — The Proposal Architecture |
| **Next seminar** | Seminar 12 — Rebuilding The Proposal |
| **Materials** | Specimen manuscripts; peer proposals |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_11_Printout.md` |
| **Homework** | `Homework/Seminar_11_Homework.md` |

## Why this lesson exists

**The conceptual step.** Most proposals produce a result without moving the question. Naming the failing item makes the verdict actionable.
...
**What depends on it.** Seminar 12 — Rebuilding The Proposal — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Most proposals produce a result without moving the question. Naming the failing item makes the verdict actionable.
...
1. A middle verdict naming item four as the failure.
2. A positive verdict with all eight items satisfied.

### One non-example

A verdict delivered without naming a failing item.
...
That triage verdicts require named failing items.

### What this activity does not establish

Whether the proposals would succeed.
...
| Statement | Status |
|---|---|
| Most proposals produce a result without moving the question. | Framework-derived, appropriate at this grade |
| That triage verdicts require named failing items. | What this specific activity can show |
| Whether the proposals would succeed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 10 — The Proposal Architecture — specifically: participants build the eight-item proposal.

**How it was taught.** Through the activity: draft all eight items with the fairness requirement met

**Quick check.** Ask for the closing sentence of Seminar 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 10: draft all eight items with the fairness requirement met, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A middle verdict naming item four as the failure. |
| **Non-example** | A verdict delivered without naming a failing item. |
...
**Student materials.** One copy of `Printouts/Seminar_11_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 10, kept in the student's folder.
...
**File.** `Printouts/Seminar_11_Printout.md`
...
> "A proposal missing item four does not adjudicate."
...
**Exact wording.** "Five-minute presentations, three verdicts assigned by the room."
...
**Target observation.** That triage verdicts require named failing items.
...
> "Most proposals produce a result without moving the question. You just saw that when five-minute presentations, three verdicts assigned by the room.
> Last time we said: A proposal missing item four does not adjudicate. This is the next part of that.
...
**What students must not infer.** Whether the proposals would succeed.

### 4. Worked example

**The example.** A middle verdict naming item four as the failure.
...
**Completed answer.** A middle verdict naming item four as the failure. — which demonstrates that triage verdicts require named failing items.
...
**Conclusions not licensed.** Whether the proposals would succeed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A positive verdict with all eight items satisfied. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A verdict delivered without naming a failing item. Why is this not an
example?"
...
**Exact student instructions.** Verdicts justified against the architecture, naming the failing item, then revised in session.
...
- *Licensed conclusion.* That triage verdicts require named failing items.
- *Not licensed.* Whether the proposals would succeed.
...
- *Expected response.* That triage verdicts require named failing items.
...
1. Any wording carrying the idea in `Most proposals produce a result without moving the question`.
...
**Why this sentence matters.** It is the opening question of Seminar 12, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_11_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 10 — The Proposal Architecture |
| **Leads to** | Seminar 12 — Rebuilding The Proposal |

**Transition in.** Seminar 10 established participants build the eight-item proposal. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants judge whether a proposal would move the question. Seminar 12 assumes it and builds participants rebuild the failing item.
