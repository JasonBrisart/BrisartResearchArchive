# Seminar 5 — Auditing Measurement As A Referee

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 2** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Auditing Measurement As A Referee: participants judge construct validity and prespecification in others' work? |
| **Core concept** | A claim of prespecification requires evidence in the form of a registration or timestamp. |
| **Student outcome** | Participants judge construct validity and prespecification in others' work. |
| **Previous seminar** | Seminar 4 — The Referee's Problem |
| **Next seminar** | Seminar 6 — Auditing Adjudication And Inference |
...
**The conceptual step.** A claim of prespecification requires evidence in the form of a registration or timestamp. The author's assertion is not evidence.
...
**What depends on it.** Seminar 6 — Auditing Adjudication And Inference — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A claim of prespecification requires evidence in the form of a registration or timestamp. The author's assertion is not evidence.
...
1. A finding that prespecification was claimed without a registration.
2. A located finding about construct validity.

### One non-example

A measurement section reading: measurement is adequate.
...
That prespecification claims require documentary evidence.
...
| Statement | Status |
|---|---|
| A claim of prespecification requires evidence in the form of a registration or timestamp. | Framework-derived, appropriate at this grade |
| That prespecification claims require documentary evidence. | What this specific activity can show |
| Whether the measurement is valid. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 4 — The Referee's Problem — specifically: participants state the two failure directions in reviewing.

**How it was taught.** Through the activity: review one instructor-supplied specimen to the seven-section structure

**Quick check.** Ask for the closing sentence of Seminar 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 4: review one instructor-supplied specimen to the seven-section structure, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A finding that prespecification was claimed without a registration. |
| **Non-example** | A measurement section reading: measurement is adequate. |
...
> "The disclosure section is specific to this literature."
...
**Exact wording.** "Say: the measurement section is where most reports are thin. A verdict is not a finding."
...
**Target observation.** That prespecification claims require documentary evidence.
...
> "A claim of prespecification requires evidence in the form of a registration or timestamp. You just saw that when say: the measurement section is where most reports are thin.
> Last time we said: The disclosure section is specific to this literature. This is the next part of that.
...
**What students must not infer.** Whether the measurement is valid.

### 4. Worked example

**The example.** A finding that prespecification was claimed without a registration.
...
**Completed answer.** A finding that prespecification was claimed without a registration. — which demonstrates that prespecification claims require documentary evidence.
...
**Conclusions not licensed.** Whether the measurement is valid.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A located finding about construct validity. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A measurement section reading: measurement is adequate. Why is this not an
example?"
...
**Exact student instructions.** Audit measurement in two manuscripts with located findings per check.
...
- *Licensed conclusion.* That prespecification claims require documentary evidence.
- *Not licensed.* Whether the measurement is valid.
...
- *Expected response.* That prespecification claims require documentary evidence.
...
1. Any wording carrying the idea in `A claim of prespecification requires evidence in the form of a registration or timestamp`.
...
Say: "An author's assertion of prespecification is not evidence."
...
| | |
|---|---|
| **Follows** | Seminar 4 — The Referee's Problem |
| **Leads to** | Seminar 6 — Auditing Adjudication And Inference |

**Transition in.** Seminar 4 established participants state the two failure directions in reviewing. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants judge construct validity and prespecification in others' work. Seminar 6 assumes it and builds participants judge rival fairness and the inference gap.
