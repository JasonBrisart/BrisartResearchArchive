# Seminar 2 — The Inference Ladder
...
| | |
|---|---|
| **Central question** | The Inference Ladder: participants place the ceiling for a single study? |
| **Core concept** | The inference ceiling for a single well-run study is rung three. |
| **Student outcome** | Participants place the ceiling for a single study. |
| **Previous seminar** | Seminar 1 — Overclaiming Is The Default |
| **Next seminar** | Seminar 3 — The Reverse Ladder |
...
**The conceptual step.** The inference ceiling for a single well-run study is rung three. Rung four requires converging designs, and overclaiming on a framework's behalf discredits it.
...
**What depends on it.** Seminar 3 — The Reverse Ladder — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The inference ceiling for a single well-run study is rung three. Rung four requires converging designs, and overclaiming on a framework's behalf discredits it.
...
1. A ceiling argued at rung three with reasons.
2. An argument that rung four requires converging evidence.

### One non-example

A ceiling placed at rung four by preference.
...
That ceilings are argued rather than asserted.

### What this activity does not establish

Whether the result supports the ceiling.
...
| Statement | Status |
|---|---|
| The inference ceiling for a single well-run study is rung three. | Framework-derived, appropriate at this grade |
| That ceilings are argued rather than asserted. | What this specific activity can show |
| Whether the result supports the ceiling. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 1 — Overclaiming Is The Default — specifically: participants identify the gap between licensed and claimed inference.

**How it was taught.** Through the activity: identify licensed and claimed rungs for three described results

**Quick check.** Ask for the closing sentence of Seminar 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 1: identify licensed and claimed rungs for three described results, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A ceiling argued at rung three with reasons. |
| **Non-example** | A ceiling placed at rung four by preference. |
...
> "The gap between licensed and claimed is where most review work happens."
...
**Exact wording.** "Put five rungs up against a described result."
...
**Target observation.** That ceilings are argued rather than asserted.
...
> "The inference ceiling for a single well-run study is rung three. You just saw that when put five rungs up against a described result.
> Last time we said: The gap between licensed and claimed is where most review work happens. This is the next part of that.
...
**What students must not infer.** Whether the result supports the ceiling.

### 4. Worked example

**The example.** A ceiling argued at rung three with reasons.
...
**Completed answer.** A ceiling argued at rung three with reasons. — which demonstrates that ceilings are argued rather than asserted.
...
**Conclusions not licensed.** Whether the result supports the ceiling.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An argument that rung four requires converging evidence. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A ceiling placed at rung four by preference. Why is this not an
example?"
...
**Exact student instructions.** Argue an assigned ceiling position with reasons.
...
- *Licensed conclusion.* That ceilings are argued rather than asserted.
- *Not licensed.* Whether the result supports the ceiling.
...
- *Expected response.* That ceilings are argued rather than asserted.
...
1. Any wording carrying the idea in `The inference ceiling for a single well-run study is rung three`.
...
Say: "The more conservative position protects the framework from being discredited."
...
| | |
|---|---|
| **Follows** | Seminar 1 — Overclaiming Is The Default |
| **Leads to** | Seminar 3 — The Reverse Ladder |

**Transition in.** Seminar 1 established participants identify the gap between licensed and claimed inference. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants place the ceiling for a single study. Seminar 3 assumes it and builds participants state what a null result licenses.
