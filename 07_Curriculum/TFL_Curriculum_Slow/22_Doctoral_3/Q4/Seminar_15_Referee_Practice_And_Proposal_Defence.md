# Seminar 15 — Referee Practice And Proposal Defence

**Doctoral Year 3** · Inference and Referee Practice · **Quarter 4** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Referee Practice And Proposal Defence: participants deliver reports and defend a proposal? |
| **Core concept** | The proposal defence requires fair operationalisation to be defended with external evidence rather than authorial intent. |
| **Student outcome** | Participants deliver reports and defend a proposal. |
| **Previous seminar** | Seminar 14 — Rehearsing The Defence |
| **Next seminar** | Seminar 16 — The Year In Judgements |
| **Materials** | Specimen manuscripts; peer proposals |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_15_Printout.md` |
| **Homework** | `Homework/Seminar_15_Homework.md` |

## Why this lesson exists

**The conceptual step.** The proposal defence requires fair operationalisation to be defended with external evidence rather than authorial intent.
...
**What depends on it.** Seminar 16 — The Year In Judgements — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The proposal defence requires fair operationalisation to be defended with external evidence rather than authorial intent.
...
1. A defence naming the assigned checker and their recorded verdict.
2. Two referee reports submitted and calibrated.

### One non-example

A defence citing the author's intention to state the rival fairly.
...
Whether proposals and reports meet standard.
...
| Statement | Status |
|---|---|
| The proposal defence requires fair operationalisation to be defended with external evidence rather than authorial intent. | Framework-derived, appropriate at this grade |
| Whether proposals and reports meet standard. | What this specific activity can show |
| Whether the proposal would succeed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 14 — Rehearsing The Defence — specifically: participants rehearse against four challengers.

**How it was taught.** Through the activity: full rehearsal with unanswered questions recorded

**Quick check.** Ask for the closing sentence of Seminar 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 14: full rehearsal with unanswered questions recorded, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence naming the assigned checker and their recorded verdict. |
| **Non-example** | A defence citing the author's intention to state the rival fairly. |
...
**Student materials.** One copy of `Printouts/Seminar_15_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 14, kept in the student's folder.
...
**File.** `Printouts/Seminar_15_Printout.md`
...
> "The unanswered questions are your revision list."
...
**Exact wording.** "Say: reports submitted and calibrated. Proposal defended. Both today."
...
**Target observation.** Whether proposals and reports meet standard.
...
> "The proposal defence requires fair operationalisation to be defended with external evidence rather than authorial intent. You just saw that when say: reports submitted and calibrated.
> Last time we said: The unanswered questions are your revision list. This is the next part of that.
...
**The example.** A defence naming the assigned checker and their recorded verdict.
...
**Completed answer.** A defence naming the assigned checker and their recorded verdict. — which demonstrates whether proposals and reports meet standard.
...
**Teacher prompt.** "Here is a second case. Two referee reports submitted and calibrated. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence citing the author's intention to state the rival fairly. Why is this not an
example?"
...
**Exact student instructions.** Two reports submitted and a sixteen-minute proposal defence.
...
- *Licensed conclusion.* Whether proposals and reports meet standard.
...
- *Expected response.* Whether proposals and reports meet standard.
...
1. Any wording carrying the idea in `The proposal defence requires fair operationalisation to be defended with external evidence rather than authorial intent`.
...
Say: "Next year: the dissertation, defended against people meeting it in an hour."

**Why this sentence matters.** It is the opening question of Seminar 16, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_15_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 14 — Rehearsing The Defence |
| **Leads to** | Seminar 16 — The Year In Judgements |

**Transition in.** Seminar 14 established participants rehearse against four challengers. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants deliver reports and defend a proposal. Seminar 16 assumes it and builds participants review the year's reviewing and proposals.
