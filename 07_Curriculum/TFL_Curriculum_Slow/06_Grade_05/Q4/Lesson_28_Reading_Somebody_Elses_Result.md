# Lesson 28 — Reading Somebody Else's Result
...
| | |
|---|---|
| **Central question** | Reading Somebody Else's Result: students audit a partner's result for overreach? |
| **Core concept** | Overreach is easier to see in somebody else's work than in your own, which is why the audit is done in pairs. |
| **Student outcome** | Students audit a partner's result for overreach. |
| **Previous lesson** | Lesson 27 — The Honest Result |
| **Next lesson** | Lesson 29 — Explaining The Invisible |
...
**The conceptual step.** Overreach is easier to see in somebody else's work than in your own, which is why the audit is done in pairs.
...
**What depends on it.** Lesson 29 — Explaining The Invisible — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Overreach is easier to see in somebody else's work than in your own, which is why the audit is done in pairs.
...
1. An audit marking a claim that went beyond one trial.
2. An audit marking a general claim from a single partner.

### One non-example

An audit returning all three results as appropriately limited.
...
That overreach is findable by another reader.

### What this activity does not establish

Whether the underlying results are sound.
...
| Statement | Status |
|---|---|
| Overreach is easier to see in somebody else's work than in your own, which is why the audit is done in pairs. | Framework-derived, appropriate at this grade |
| That overreach is findable by another reader. | What this specific activity can show |
| Whether the underlying results are sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 27 — The Honest Result — specifically: students write a result with its limits stated.

**How it was taught.** Through the activity: rewrite three of their results with the limits explicitly named

**Quick check.** Ask for the closing sentence of Lesson 27. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 27: rewrite three of their results with the limits explicitly named, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An audit marking a claim that went beyond one trial. |
| **Non-example** | An audit returning all three results as appropriately limited. |
...
> "Saying what you cannot conclude is part of the result."
...
**Exact wording.** "Ask whether they claimed more than their trial showed."
...
**Target observation.** That overreach is findable by another reader.
...
> "Overreach is easier to see in somebody else's work than in your own, which is why the audit is done in pairs. You just saw that when ask whether they claimed more than their trial showed.
> Last time we said: Saying what you cannot conclude is part of the result. This is the next part of that.
...
**What students must not infer.** Whether the underlying results are sound.

### 4. Worked example

**The example.** An audit marking a claim that went beyond one trial.
...
**Completed answer.** An audit marking a claim that went beyond one trial. — which demonstrates that overreach is findable by another reader.
...
**Conclusions not licensed.** Whether the underlying results are sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An audit marking a general claim from a single partner. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit returning all three results as appropriately limited. Why is this not an
example?"
...
**Exact student instructions.** Audit a partner's three results for overreach and mark each.
...
- *Licensed conclusion.* That overreach is findable by another reader.
- *Not licensed.* Whether the underlying results are sound.
...
- *Expected response.* That overreach is findable by another reader.
...
1. Any wording carrying the idea in `Overreach is easier to see in somebody else's work than in your own, which is why the audit is done in pairs`.
...
Say: "Overreach is the commonest mistake, and it is easy to spot in others."
...
| | |
|---|---|
| **Follows** | Lesson 27 — The Honest Result |
| **Leads to** | Lesson 29 — Explaining The Invisible |

**Transition in.** Lesson 27 established students write a result with its limits stated. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students audit a partner's result for overreach. Lesson 29 assumes it and builds students explain invisibility and the break test to somebody else.
