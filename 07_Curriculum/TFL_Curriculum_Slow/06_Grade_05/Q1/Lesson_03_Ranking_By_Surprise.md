...
| | |
|---|---|
| **Central question** | Ranking By Surprise: students rank expectations by how strongly breaking them would surprise? |
| **Core concept** | Expectations differ in strength, and predicted surprise is the available measure of that. |
| **Student outcome** | Students rank expectations by how strongly breaking them would surprise. |
| **Previous lesson** | Lesson 2 — The Break Test |
| **Next lesson** | Lesson 4 — The Invisible Everywhere |
...
**The conceptual step.** Expectations differ in strength, and predicted surprise is the available measure of that. Importance and strength are different orderings.
...
**What depends on it.** Lesson 4 — The Invisible Everywhere — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Expectations differ in strength, and predicted surprise is the available measure of that. Importance and strength are different orderings.
...
1. The floor holding ranked above the bell ringing on time.
2. A student justifying the top rank by imagining the break.

### One non-example

Ranking the timetable highest because school matters.
...
That expectations vary in strength, measurable by predicted surprise.

### What this activity does not establish

Any absolute measure of strength.
...
| Statement | Status |
|---|---|
| Expectations differ in strength, and predicted surprise is the available measure of that. | Framework-derived, appropriate at this grade |
| That expectations vary in strength, measurable by predicted surprise. | What this specific activity can show |
| Any absolute measure of strength. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — The Break Test — specifically: students prove an unnoticed expectation existed.

**How it was taught.** Through the activity: apply the break test to the Lesson 1 list, with the break and the surprise level

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: apply the break test to the Lesson 1 list, with the break and the surprise level, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | The floor holding ranked above the bell ringing on time. |
| **Non-example** | Ranking the timetable highest because school matters. |
...
> "If breaking it would surprise you, it was there."
...
**Exact wording.** "Ask which of these would shock them most if it broke."
...
**Target observation.** That expectations vary in strength, measurable by predicted surprise.
...
> "Expectations differ in strength, and predicted surprise is the available measure of that. You just saw that when ask which of these would shock them most if it broke.
> Last time we said: If breaking it would surprise you, it was there. This is the next part of that.
...
**What students must not infer.** Any absolute measure of strength.

### 4. Worked example

**The example.** The floor holding ranked above the bell ringing on time.
...
**Completed answer.** The floor holding ranked above the bell ringing on time. — which demonstrates that expectations vary in strength, measurable by predicted surprise.
...
**Conclusions not licensed.** Any absolute measure of strength.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student justifying the top rank by imagining the break. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Ranking the timetable highest because school matters. Why is this not an
example?"
...
**Exact student instructions.** Rank ten expectations by predicted surprise and justify the top three.
...
- *Licensed conclusion.* That expectations vary in strength, measurable by predicted surprise.
- *Not licensed.* Any absolute measure of strength.
...
- *Expected response.* That expectations vary in strength, measurable by predicted surprise.
...
1. Any wording carrying the idea in `Expectations differ in strength, and predicted surprise is the available measure of that`.
...
Say: "Stronger expectations produce bigger surprises when broken."
...
| | |
|---|---|
| **Follows** | Lesson 2 — The Break Test |
| **Leads to** | Lesson 4 — The Invisible Everywhere |

**Transition in.** Lesson 2 established students prove an unnoticed expectation existed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students rank expectations by how strongly breaking them would surprise. Lesson 4 assumes it and builds students find unnoticed expectations outside school.
