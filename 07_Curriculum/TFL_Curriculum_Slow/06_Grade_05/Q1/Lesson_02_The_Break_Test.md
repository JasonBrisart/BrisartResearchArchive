# Lesson 2 — The Break Test

**Grade 5** · Invisible and Broken · **Quarter 1** · **40 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Break Test: students prove an unnoticed expectation existed? |
| **Core concept** | The break test is an argument, not an observation: if breaking X would surprise you, you were expecting X. |
| **Student outcome** | Students prove an unnoticed expectation existed. |
| **Previous lesson** | Lesson 1 — The Nothing Moment |
| **Next lesson** | Lesson 3 — Ranking By Surprise |
| **Materials** | Notebooks; index cards in two clear shapes |
...
**The conceptual step.** The break test is an argument, not an observation: if breaking X would surprise you, you were expecting X. It recovers expectations that left no trace.

**Why students need it now.** This grade owns one idea: that contradiction revises rather than deletes, and that alternatives must be stated.
...
that if nothing surprised me, no expectation happened. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Structured written work with a claim, evidence, and a stated alternative. Students say what would have counted against their answer.

**What depends on it.** Lesson 3 — Ranking By Surprise — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The break test is an argument, not an observation: if breaking X would surprise you, you were expecting X. It recovers expectations that left no trace.

### How this is stated at this grade

Structured written work with a claim, evidence, and a stated alternative. Students say what would have counted against their answer.

Use only the vocabulary released at or before this grade. Terms not yet available:
All variable names, persistence threshold, suppression as a technical term.

### Why the concept matters

The whole grade rests on that contradiction revises rather than deletes, and that alternatives must be stated. If a student leaves this
...
1. Imagining the chair collapsing produces a strong surprise, so the expectation was there.
2. Imagining the light not working produces surprise.

### One non-example

Imagining a stranger entering, which would surprise you without a prior specific expectation.
...
That unnoticed expectations can be demonstrated by argument.

### What this activity does not establish

Whether the expectation was consciously held.
...
| Statement | Status |
|---|---|
| The break test is an argument, not an observation: if breaking X would surprise you, you were expecting X. | Framework-derived, appropriate at this grade |
| That unnoticed expectations can be demonstrated by argument. | What this specific activity can show |
| Whether the expectation was consciously held. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 1 — The Nothing Moment — specifically: students recognise routine moments contained many correct expectations.

**How it was taught.** Through the activity: list ten expectations made in the last minute, none of them noticed

**Quick check.** Ask for the closing sentence of Lesson 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 1: list ten expectations made in the last minute, none of them noticed, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | a correct expectation that leaves no trace. |
| **Student wording** | A correct expectation that leaves no trace. |
| **Correct example** | Imagining the chair collapsing produces a strong surprise, so the expectation was there. |
| **Non-example** | Imagining a stranger entering, which would surprise you without a prior specific expectation. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for a correct expectation that leaves no trace." |

### contradiction

| | |
|---|---|
| **Teacher definition** | when what happened does not match what was expected. |
| **Student wording** | When what happened does not match what was expected. |
| **Correct example** | Imagining the chair collapsing produces a strong surprise, so the expectation was there. |
| **Non-example** | Imagining a stranger entering, which would surprise you without a prior specific expectation. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for when what happened does not match what was expected." |

### revise

| | |
|---|---|
| **Teacher definition** | change an expectation a little rather than delete it. |
| **Student wording** | Change an expectation a little rather than delete it. |
| **Correct example** | Imagining the chair collapsing produces a strong surprise, so the expectation was there. |
| **Non-example** | Imagining a stranger entering, which would surprise you without a prior specific expectation. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for change an expectation a little rather than delete it." |


Do not introduce terminology from later grades. All variable names, persistence threshold, suppression as a technical term.

## Materials and preparation

**Teacher materials.** Notebooks; Index cards in two clear shapes; Printed tally sheets; An audio source; A timer.
...
> "When the system works perfectly it is invisible."
...
**Exact wording.** "Ask a student to sit, then ask whether they were surprised and whether that means no expectation."
...
**Target observation.** That unnoticed expectations can be demonstrated by argument.
...
> "The break test is an argument, not an observation: if breaking X would surprise you, you were expecting X. You just saw that when ask a student to sit, then ask whether they were surprised and whether that means no expectation.
> Last time we said: When the system works perfectly it is invisible. This is the next part of that.
> It matters because a correct expectation is invisible. Breaking one is the only way to see it"
...
**Terminology to introduce here.** invisible, contradiction, revise.

**What students must not infer.** Whether the expectation was consciously held.

### 4. Worked example

**The example.** Imagining the chair collapsing produces a strong surprise, so the expectation was there.
...
**Completed answer.** Imagining the chair collapsing produces a strong surprise, so the expectation was there. — which demonstrates that unnoticed expectations can be demonstrated by argument.
...
**Conclusions not licensed.** Whether the expectation was consciously held.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Imagining the light not working produces surprise. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Imagining a stranger entering, which would surprise you without a prior specific expectation. Why is this not an
example?"
...
**Exact student instructions.** Apply the break test to the Lesson 1 list, with the break and the surprise level.
...
- *Licensed conclusion.* That unnoticed expectations can be demonstrated by argument.
- *Not licensed.* Whether the expectation was consciously held.
...
- *Expected response.* That unnoticed expectations can be demonstrated by argument.
...
3. **Misconception check.** Somebody says: "If nothing surprised me, no expectation happened" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `The break test is an argument, not an observation: if breaking X would surprise you, you were expecting X`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: When prediction works you do not notice it.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "If breaking it would surprise you, it was there."
...
### 1. "If nothing surprised me, no expectation happened"

**What the student says or does.** If nothing surprised me, no expectation happened — usually while otherwise engaging well.
...
**Exact correction.** The chair demonstration and the break test.

**Say this.** "When prediction works you do not notice it."
...
### 2. "Being wrong deletes the expectation immediately"

**What the student says or does.** Being wrong deletes the expectation immediately — usually while otherwise engaging well.

**Why it is understandable.** Students assume contradiction acts like an eraser.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** The multi-break trial. The old expectation returns.

**Say this.** "Contradiction changes or pushes aside. It does not erase."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "One trial is enough to know"

**What the student says or does.** One trial is enough to know — usually while otherwise engaging well.

**Why it is understandable.** A single vivid result feels conclusive.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Pool class results and show the spread.

**Say this.** "One trial is a story. Twenty is evidence."
...
**Visual or physical support.** Run trials in pairs with a printed tally sheet.
...
Ask them to design a break that would be hard to recover from.
...
Specifically, do not introduce: All variable names, persistence threshold, suppression as a technical term.
...
| | |
|---|---|
| **Follows** | Lesson 1 — The Nothing Moment |
| **Leads to** | Lesson 3 — Ranking By Surprise |

**Transition in.** Lesson 1 established students recognise routine moments contained many correct expectations. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students prove an unnoticed expectation existed. Lesson 3 assumes it and builds students rank expectations by how strongly breaking them would surprise.
