...
| | |
|---|---|
| **Central question** | The Nothing Moment: students recognise routine moments contained many correct expectations? |
| **Core concept** | A minute in which nothing surprising happened contained many expectations, all met. |
| **Student outcome** | Students recognise routine moments contained many correct expectations. |
| **Previous lesson** | None. First lesson of the year. |
| **Next lesson** | Lesson 2 — The Break Test |
...
**The conceptual step.** A minute in which nothing surprising happened contained many expectations, all met. Their invisibility is caused by their success, not by their absence.
...
**What depends on it.** Lesson 2 — The Break Test — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A minute in which nothing surprising happened contained many expectations, all met. Their invisibility is caused by their success, not by their absence.
...
1. Expecting the floor to hold, unnoticed because it did.
2. Expecting your own voice to sound as it does.

### One non-example

Listing an expectation that was actually noticed at the time.
...
That routine minutes contain many unnoticed expectations.
...
| Statement | Status |
|---|---|
| A minute in which nothing surprising happened contained many expectations, all met. | Framework-derived, appropriate at this grade |
| That routine minutes contain many unnoticed expectations. | What this specific activity can show |
| How many there actually were. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The student produces an audited chain with specific inheritance.
...
| **Correct example** | Expecting the floor to hold, unnoticed because it did. |
| **Non-example** | Listing an expectation that was actually noticed at the time. |
...
**Exact wording.** "Do something routine and ask whether anybody was surprised."
...
**Target observation.** That routine minutes contain many unnoticed expectations.
...
> "A minute in which nothing surprising happened contained many expectations, all met. You just saw that when do something routine and ask whether anybody was surprised.
...
**What students must not infer.** How many there actually were.

### 4. Worked example

**The example.** Expecting the floor to hold, unnoticed because it did.
...
**Completed answer.** Expecting the floor to hold, unnoticed because it did. — which demonstrates that routine minutes contain many unnoticed expectations.
...
**Conclusions not licensed.** How many there actually were.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Expecting your own voice to sound as it does. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Listing an expectation that was actually noticed at the time. Why is this not an
example?"
...
**Exact student instructions.** List ten expectations made in the last minute, none of them noticed.
...
- *Licensed conclusion.* That routine minutes contain many unnoticed expectations.
- *Not licensed.* How many there actually were.
...
- *Expected response.* That routine minutes contain many unnoticed expectations.
...
1. Any wording carrying the idea in `A minute in which nothing surprising happened contained many expectations, all met`.
...
Say: "When the system works perfectly it is invisible."
...
| **Leads to** | Lesson 2 — The Break Test |

**Transition in.** This lesson opens the year.

**Transition out.** This lesson establishes students recognise routine moments contained many correct expectations. Lesson 2 assumes it and builds students prove an unnoticed expectation existed.
