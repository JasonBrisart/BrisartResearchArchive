# Lesson 8 Homework — The Invisible Review

**Grade 5** · Invisible and Broken · **Quarter 1**
**Follows:** Lesson 8 — The Invisible Review · **Points:** 5 · **Optional:** yes
...
Review with six claimed expectations tested by the break test.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the class applies the test correctly to at least four
...
Lesson 9 is **The Pattern Trial**, which assumes you arrive holding it. Write one thing you expect it to be about:
