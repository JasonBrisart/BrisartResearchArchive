...
| | |
|---|---|
| **Central question** | How Many Breaks: students count contradictions needed for durable change? |
| **Core concept** | A counted number is evidence; a predicted one is an opinion. |
| **Student outcome** | Students count contradictions needed for durable change. |
| **Previous lesson** | Lesson 10 — Revise, Not Delete |
| **Next lesson** | Lesson 12 — The Return |
...
**The conceptual step.** A counted number is evidence; a predicted one is an opinion. Comparing the two makes the difference concrete.
...
**What depends on it.** Lesson 12 — The Return — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A counted number is evidence; a predicted one is an opinion. Comparing the two makes the difference concrete.
...
1. A pooled figure of two to three, against a predicted one.
2. A student whose prediction differed from their measurement.

### One non-example

A number reported from the prediction rather than the tally.
...
That the question is answerable by counting.

### What this activity does not establish

Any figure beyond this class.
...
| Statement | Status |
|---|---|
| A counted number is evidence; a predicted one is an opinion. | Framework-derived, appropriate at this grade |
| That the question is answerable by counting. | What this specific activity can show |
| Any figure beyond this class. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 10 — Revise, Not Delete — specifically: students name the three things a contradiction can do.

**How it was taught.** Through the activity: classify eight described cases into the three outcomes

**Quick check.** Ask for the closing sentence of Lesson 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 10: classify eight described cases into the three outcomes, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A pooled figure of two to three, against a predicted one. |
| **Non-example** | A number reported from the prediction rather than the tally. |
...
> "Contradiction revises or pushes aside. It does not erase."
...
**Exact wording.** "Collect written predictions of the number before any trial runs."
...
**Target observation.** That the question is answerable by counting.
...
> "A counted number is evidence; a predicted one is an opinion. You just saw that when collect written predictions of the number before any trial runs.
> Last time we said: Contradiction revises or pushes aside. It does not erase. This is the next part of that.
...
**What students must not infer.** Any figure beyond this class.

### 4. Worked example

**The example.** A pooled figure of two to three, against a predicted one.
...
**Completed answer.** A pooled figure of two to three, against a predicted one. — which demonstrates that the question is answerable by counting.
...
**Conclusions not licensed.** Any figure beyond this class.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student whose prediction differed from their measurement. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A number reported from the prediction rather than the tally. Why is this not an
example?"
...
**Exact student instructions.** A three-break trial in pairs, class numbers pooled.
...
- *Licensed conclusion.* That the question is answerable by counting.
- *Not licensed.* Any figure beyond this class.
...
- *Expected response.* That the question is answerable by counting.
...
1. Any wording carrying the idea in `A counted number is evidence; a predicted one is an opinion`.
...
Say: "We counted instead of arguing."
...
| | |
|---|---|
| **Follows** | Lesson 10 — Revise, Not Delete |
| **Leads to** | Lesson 12 — The Return |

**Transition in.** Lesson 10 established students name the three things a contradiction can do. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students count contradictions needed for durable change. Lesson 12 assumes it and builds students observe a broken expectation reappearing.
