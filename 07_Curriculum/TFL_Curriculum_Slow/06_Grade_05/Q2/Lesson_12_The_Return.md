...
| | |
|---|---|
| **Central question** | The Return: students observe a broken expectation reappearing? |
| **Core concept** | A returned expectation may have persisted throughout or genuinely reappeared. |
| **Student outcome** | Students observe a broken expectation reappearing. |
| **Previous lesson** | Lesson 11 — How Many Breaks |
| **Next lesson** | Lesson 13 — Stronger Contradictions |
...
**The conceptual step.** A returned expectation may have persisted throughout or genuinely reappeared. This data cannot distinguish them, and saying so is the correct answer.
...
**What depends on it.** Lesson 13 — Stronger Contradictions — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A returned expectation may have persisted throughout or genuinely reappeared. This data cannot distinguish them, and saying so is the correct answer.
...
1. Both explanations written with neither selected.
2. A student naming a measurement that would separate them.

### One non-example

Selecting the explanation that seems more likely.
...
That the expectation reappeared.
...
| Statement | Status |
|---|---|
| A returned expectation may have persisted throughout or genuinely reappeared. | Framework-derived, appropriate at this grade |
| That the expectation reappeared. | What this specific activity can show |
| Which of the two explanations is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 11 — How Many Breaks — specifically: students count contradictions needed for durable change.

**How it was taught.** Through the activity: a three-break trial in pairs, class numbers pooled

**Quick check.** Ask for the closing sentence of Lesson 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 11: a three-break trial in pairs, class numbers pooled, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Both explanations written with neither selected. |
| **Non-example** | Selecting the explanation that seems more likely. |
...
**Exact wording.** "Break the pattern, run five unrelated cards, then return."
...
**Target observation.** That the expectation reappeared.
...
> "A returned expectation may have persisted throughout or genuinely reappeared. You just saw that when break the pattern, run five unrelated cards, then return.
> Last time we said: We counted instead of arguing. This is the next part of that.
...
**What students must not infer.** Which of the two explanations is correct.

### 4. Worked example

**The example.** Both explanations written with neither selected.
...
**Completed answer.** Both explanations written with neither selected. — which demonstrates that the expectation reappeared.
...
**Conclusions not licensed.** Which of the two explanations is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student naming a measurement that would separate them. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Selecting the explanation that seems more likely. Why is this not an
example?"
...
**Exact student instructions.** Record the sequence and write both explanations, admitting the question is open.
...
- *Licensed conclusion.* That the expectation reappeared.
- *Not licensed.* Which of the two explanations is correct.
...
- *Expected response.* That the expectation reappeared.
...
1. Any wording carrying the idea in `A returned expectation may have persisted throughout or genuinely reappeared`.
...
Say: "We cannot tell which. That is an honest result."
...
| | |
|---|---|
| **Follows** | Lesson 11 — How Many Breaks |
| **Leads to** | Lesson 13 — Stronger Contradictions |

**Transition in.** Lesson 11 established students count contradictions needed for durable change. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students observe a broken expectation reappearing. Lesson 13 assumes it and builds students test whether a stronger break changes the count.
