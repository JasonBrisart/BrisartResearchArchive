# Lesson 17 Homework — Designing A Break

**Grade 5** · Invisible and Broken · **Quarter 3**
**Follows:** Lesson 17 — Designing A Break · **Points:** 5 · **Optional:** yes
...
Design and run a break on a partner, recording before, during, and after.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student runs a break satisfying all four rules
...
Lesson 18 is **The Failed Break**, which assumes you arrive holding it. Write one thing you expect it to be about:
