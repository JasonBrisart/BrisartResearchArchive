# Lesson 21 Homework — Choosing Between Explanations

**Grade 5** · Invisible and Broken · **Quarter 3**
**Follows:** Lesson 21 — Choosing Between Explanations · **Points:** 5 · **Optional:** yes
...
For each alternative, name one separating observation.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names a separator for at least two of three
...
Lesson 22 is **Alternatives In Other Subjects**, which assumes you arrive holding it. Write one thing you expect it to be about:
