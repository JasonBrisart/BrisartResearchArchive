# Lesson 20 — Stating The Alternative
...
| | |
|---|---|
| **Central question** | Stating The Alternative: students name a different explanation for their own result? |
| **Core concept** | An alternative explanation is another account that would produce the same result. |
| **Student outcome** | Students name a different explanation for their own result. |
| **Previous lesson** | Lesson 19 — Improving A Break |
| **Next lesson** | Lesson 21 — Choosing Between Explanations |
...
**The conceptual step.** An alternative explanation is another account that would produce the same result. A weak alternative is worse than none, because it looks like the work was done.
...
**What depends on it.** Lesson 21 — Choosing Between Explanations — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An alternative explanation is another account that would produce the same result. A weak alternative is worse than none, because it looks like the work was done.
...
1. An alternative that genuinely competes with the first.
2. An alternative a partner judges plausible.
...
That results admit competing explanations.
...
| Statement | Status |
|---|---|
| An alternative explanation is another account that would produce the same result. | Framework-derived, appropriate at this grade |
| That results admit competing explanations. | What this specific activity can show |
| Which explanation is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — Improving A Break — specifically: students revise a break design after it failed.

**How it was taught.** Through the activity: revise and re-run the failed break, comparing both results

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: revise and re-run the failed break, comparing both results, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An alternative that genuinely competes with the first. |
...
> "The second run should work better. If not, the fix missed."
...
**Exact wording.** "Put a student result on the board with its obvious explanation and ask what else."
...
**Target observation.** That results admit competing explanations.
...
> "An alternative explanation is another account that would produce the same result. You just saw that when put a student result on the board with its obvious explanation and ask what else.
> Last time we said: The second run should work better. If not, the fix missed. This is the next part of that.
...
**The example.** An alternative that genuinely competes with the first.
...
**Completed answer.** An alternative that genuinely competes with the first. — which demonstrates that results admit competing explanations.
...
**Teacher prompt.** "Here is a second case. An alternative a partner judges plausible. Work it through with me."
...
**Exact student instructions.** Three of their own results, each with a genuine alternative.
...
- *Licensed conclusion.* That results admit competing explanations.
...
- *Expected response.* That results admit competing explanations.
...
1. Any wording carrying the idea in `An alternative explanation is another account that would produce the same result`.
...
Say: "Your result is not finished without one."
...
| | |
|---|---|
| **Follows** | Lesson 19 — Improving A Break |
| **Leads to** | Lesson 21 — Choosing Between Explanations |

**Transition in.** Lesson 19 established students revise a break design after it failed. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students name a different explanation for their own result. Lesson 21 assumes it and builds students identify evidence that separates two explanations.
