# Lesson 24 — The Mechanism Review
...
| | |
|---|---|
| **Central question** | The Mechanism Review: students consolidate contradiction and scope? |
| **Core concept** | Contradiction outcomes and scope judgements are both stateable rules. |
| **Student outcome** | Students consolidate contradiction and scope. |
| **Previous lesson** | Lesson 23 — Is That What This Is For |
| **Next lesson** | Lesson 25 — The Whole Distinction |
...
**The conceptual step.** Contradiction outcomes and scope judgements are both stateable rules. The review tests whether both survive when applied quickly.
...
**What depends on it.** Lesson 25 — The Whole Distinction — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Contradiction outcomes and scope judgements are both stateable rules. The review tests whether both survive when applied quickly.
...
1. A case correctly classified as suppression.
2. An application correctly judged outside.

### One non-example

A case classified as deletion.
...
Whether both rule sets are secure.
...
| Statement | Status |
|---|---|
| Contradiction outcomes and scope judgements are both stateable rules. | Framework-derived, appropriate at this grade |
| Whether both rule sets are secure. | What this specific activity can show |
| Whether the rules are correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 23 — Is That What This Is For — specifically: students reject applications outside the model's scope.

**How it was taught.** Through the activity: sort ten claims into inside and outside, and justify one rejection

**Quick check.** Ask for the closing sentence of Lesson 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 23: sort ten claims into inside and outside, and justify one rejection, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A case correctly classified as suppression. |
| **Non-example** | A case classified as deletion. |
...
> "A model that claims everything predicts nothing."
...
**Exact wording.** "Ask what contradiction does and what is outside the model."
...
**Target observation.** Whether both rule sets are secure.
...
> "Contradiction outcomes and scope judgements are both stateable rules. You just saw that when ask what contradiction does and what is outside the model.
> Last time we said: A model that claims everything predicts nothing. This is the next part of that.
...
**What students must not infer.** Whether the rules are correct.

### 4. Worked example

**The example.** A case correctly classified as suppression.
...
**Completed answer.** A case correctly classified as suppression. — which demonstrates whether both rule sets are secure.
...
**Conclusions not licensed.** Whether the rules are correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An application correctly judged outside. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A case classified as deletion. Why is this not an
example?"
...
**Exact student instructions.** Review with eight cases classified and four applications judged.
...
- *Licensed conclusion.* Whether both rule sets are secure.
- *Not licensed.* Whether the rules are correct.
...
- *Expected response.* Whether both rule sets are secure.
...
1. Any wording carrying the idea in `Contradiction outcomes and scope judgements are both stateable rules`.
...
Say: "Next time: putting the whole argument together."
...
| | |
|---|---|
| **Follows** | Lesson 23 — Is That What This Is For |
| **Leads to** | Lesson 25 — The Whole Distinction |

**Transition in.** Lesson 23 established students reject applications outside the model's scope. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate contradiction and scope. Lesson 25 assumes it and builds students present a data-backed argument for the central claim.
