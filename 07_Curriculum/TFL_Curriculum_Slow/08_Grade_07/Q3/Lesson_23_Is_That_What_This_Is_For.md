# Lesson 23 — Is That What This Is For
...
| | |
|---|---|
| **Central question** | Is That What This Is For: students reject applications outside the model's scope? |
| **Core concept** | Scope questions are decided by whether a specific Sim(t) can be stated and whether the timescale is short. |
| **Student outcome** | Students reject applications outside the model's scope. |
| **Previous lesson** | Lesson 22 — Presenting Your Data |
| **Next lesson** | Lesson 24 — The Mechanism Review |
...
**The conceptual step.** Scope questions are decided by whether a specific Sim(t) can be stated and whether the timescale is short. Years, identity, groups, and neural mechanism are reliably outside.
...
**What depends on it.** Lesson 24 — The Mechanism Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Scope questions are decided by whether a specific Sim(t) can be stated and whether the timescale is short. Years, identity, groups, and neural mechanism are reliably outside.
...
1. A claim about the next ten seconds, sorted inside.
2. A claim about personality development, sorted outside.

### One non-example

A claim about identity sorted inside because it involves expectation.
...
That scope can be judged by stated criteria.

### What this activity does not establish

Whether the framework is correct about what it does cover.
...
| Statement | Status |
|---|---|
| Scope questions are decided by whether a specific Sim(t) can be stated and whether the timescale is short. | Framework-derived, appropriate at this grade |
| That scope can be judged by stated criteria. | What this specific activity can show |
| Whether the framework is correct about what it does cover. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 22 — Presenting Your Data — specifically: students present their own four-box result to the class.

**How it was taught.** Through the activity: a three-minute presentation with the matrix, the finding, and the disconfirmer

**Quick check.** Ask for the closing sentence of Lesson 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 22: a three-minute presentation with the matrix, the finding, and the disconfirmer, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A claim about the next ten seconds, sorted inside. |
| **Non-example** | A claim about identity sorted inside because it involves expectation. |
...
> "Saying it aloud is different from writing it."
...
**Exact wording.** "Read four claims; students vote inside or outside. Two are traps."
...
**Target observation.** That scope can be judged by stated criteria.
...
> "Scope questions are decided by whether a specific Sim(t) can be stated and whether the timescale is short. You just saw that when read four claims; students vote inside or outside.
> Last time we said: Saying it aloud is different from writing it. This is the next part of that.
...
**What students must not infer.** Whether the framework is correct about what it does cover.

### 4. Worked example

**The example.** A claim about the next ten seconds, sorted inside.
...
**Completed answer.** A claim about the next ten seconds, sorted inside. — which demonstrates that scope can be judged by stated criteria.
...
**Conclusions not licensed.** Whether the framework is correct about what it does cover.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A claim about personality development, sorted outside. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim about identity sorted inside because it involves expectation. Why is this not an
example?"
...
**Exact student instructions.** Sort ten claims into inside and outside, and justify one rejection.
...
- *Licensed conclusion.* That scope can be judged by stated criteria.
- *Not licensed.* Whether the framework is correct about what it does cover.
...
- *Expected response.* That scope can be judged by stated criteria.
...
1. Any wording carrying the idea in `Scope questions are decided by whether a specific Sim(t) can be stated and whether the timescale is short`.
...
Say: "A model that claims everything predicts nothing."
...
| | |
|---|---|
| **Follows** | Lesson 22 — Presenting Your Data |
| **Leads to** | Lesson 24 — The Mechanism Review |

**Transition in.** Lesson 22 established students present their own four-box result to the class. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students reject applications outside the model's scope. Lesson 24 assumes it and builds students consolidate contradiction and scope.
