# Lesson 20 — Persistence Is Mechanical
...
| | |
|---|---|
| **Central question** | Persistence Is Mechanical: students keep persistence low-stakes and non-clinical? |
| **Core concept** | Persistence is a mechanical property of a simulation carrying forward. |
| **Student outcome** | Students keep persistence low-stakes and non-clinical. |
| **Previous lesson** | Lesson 19 — When My Data Disagrees |
| **Next lesson** | Lesson 21 — Closing The Log |
...
**The conceptual step.** Persistence is a mechanical property of a simulation carrying forward. The everyday connotation of intrusive thought is not what the term means, and the framework has nothing to say about distress.
...
**What depends on it.** Lesson 21 — Closing The Log — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Persistence is a mechanical property of a simulation carrying forward. The everyday connotation of intrusive thought is not what the term means, and the framework has nothing to say about distress.
...
1. A persistent expectation about a football result.
2. A persistent expectation about tomorrow's timetable.

### One non-example

A persistent worry about a family situation.
...
That persistence is mechanical and low-stakes.

### What this activity does not establish

Anything about distress or clinical states.
...
| Statement | Status |
|---|---|
| Persistence is a mechanical property of a simulation carrying forward. | Framework-derived, appropriate at this grade |
| That persistence is mechanical and low-stakes. | What this specific activity can show |
| Anything about distress or clinical states. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 19 — When My Data Disagrees — specifically: students report honestly a result that does not fit.

**How it was taught.** Through the activity: identify and describe one poorly fitting entry without explaining it away

**Quick check.** Ask for the closing sentence of Lesson 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 19: identify and describe one poorly fitting entry without explaining it away, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A persistent expectation about a football result. |
| **Non-example** | A persistent worry about a family situation. |
...
> "Reporting the awkward case is the job."
...
**Exact wording.** "Say: persistence sounds like you cannot stop thinking about something. It does not mean that."
...
**Target observation.** That persistence is mechanical and low-stakes.
...
> "Persistence is a mechanical property of a simulation carrying forward. You just saw that when say: persistence sounds like you cannot stop thinking about something.
> Last time we said: Reporting the awkward case is the job. This is the next part of that.
...
**What students must not infer.** Anything about distress or clinical states.

### 4. Worked example

**The example.** A persistent expectation about a football result.
...
**Completed answer.** A persistent expectation about a football result. — which demonstrates that persistence is mechanical and low-stakes.
...
**Conclusions not licensed.** Anything about distress or clinical states.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A persistent expectation about tomorrow's timetable. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A persistent worry about a family situation. Why is this not an
example?"
...
**Exact student instructions.** Rewrite four persistence examples so every one is mechanical and low-stakes.
...
- *Licensed conclusion.* That persistence is mechanical and low-stakes.
- *Not licensed.* Anything about distress or clinical states.
...
- *Expected response.* That persistence is mechanical and low-stakes.
...
1. Any wording carrying the idea in `Persistence is a mechanical property of a simulation carrying forward`.
...
Say: "Persistence just means it carried into the next cycle."
...
| | |
|---|---|
| **Follows** | Lesson 19 — When My Data Disagrees |
| **Leads to** | Lesson 21 — Closing The Log |

**Transition in.** Lesson 19 established students report honestly a result that does not fit. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students keep persistence low-stakes and non-clinical. Lesson 21 assumes it and builds students complete and total their prediction log.
