# Lesson 21 Homework — Closing The Log

**Grade 7** · Persistence Is Not Accuracy · **Quarter 3**
**Follows:** Lesson 21 — Closing The Log · **Points:** 5 · **Optional:** yes
...
Final log audit, totals computed, and the four-box matrix rebuilt on the full set.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student's final matrix uses at least sixteen entries
...
Lesson 22 is **Presenting Your Data**, which assumes you arrive holding it. Write one thing you expect it to be about:
