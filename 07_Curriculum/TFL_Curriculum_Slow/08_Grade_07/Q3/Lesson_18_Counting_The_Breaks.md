# Lesson 18 — Counting The Breaks

**Grade 7** · Persistence Is Not Accuracy · **Quarter 3** · **45 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Counting The Breaks: students measure how many contradictions produce durable change? |
| **Core concept** | Comparing a prediction with a measurement is only possible if the prediction was recorded first. |
| **Student outcome** | Students measure how many contradictions produce durable change. |
| **Previous lesson** | Lesson 17 — Contradiction Mechanics |
| **Next lesson** | Lesson 19 — When My Data Disagrees |
...
**The conceptual step.** Comparing a prediction with a measurement is only possible if the prediction was recorded first. Collecting them in writing is what makes the comparison honest.
...
**What depends on it.** Lesson 19 — When My Data Disagrees — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Comparing a prediction with a measurement is only possible if the prediction was recorded first. Collecting them in writing is what makes the comparison honest.
...
1. A pooled figure compared against a recorded prediction.
2. A student whose prediction was well off the measured figure.

### One non-example

A prediction reported after the measurement was known.
...
That predictions can be tested against measurements.

### What this activity does not establish

Whether the figure generalises.
...
| Statement | Status |
|---|---|
| Comparing a prediction with a measurement is only possible if the prediction was recorded first. | Framework-derived, appropriate at this grade |
| That predictions can be tested against measurements. | What this specific activity can show |
| Whether the figure generalises. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 17 — Contradiction Mechanics — specifically: students record the drop and recovery across a broken pattern.

**How it was taught.** Through the activity: plot the class percentages and write what the recovery shows

**Quick check.** Ask for the closing sentence of Lesson 17. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 17: plot the class percentages and write what the recovery shows, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A pooled figure compared against a recorded prediction. |
| **Non-example** | A prediction reported after the measurement was known. |
...
> "Revision. Suppression. Not deletion."
...
**Exact wording.** "Collect written predictions of the number before any trial."
...
**Target observation.** That predictions can be tested against measurements.
...
> "Comparing a prediction with a measurement is only possible if the prediction was recorded first. You just saw that when collect written predictions of the number before any trial.
> Last time we said: Revision. Suppression. Not deletion. This is the next part of that.
...
**What students must not infer.** Whether the figure generalises.

### 4. Worked example

**The example.** A pooled figure compared against a recorded prediction.
...
**Completed answer.** A pooled figure compared against a recorded prediction. — which demonstrates that predictions can be tested against measurements.
...
**Conclusions not licensed.** Whether the figure generalises.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student whose prediction was well off the measured figure. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A prediction reported after the measurement was known. Why is this not an
example?"
...
**Exact student instructions.** A three-break trial in pairs with class numbers pooled and compared to predictions.
...
- *Licensed conclusion.* That predictions can be tested against measurements.
- *Not licensed.* Whether the figure generalises.
...
- *Expected response.* That predictions can be tested against measurements.
...
1. Any wording carrying the idea in `Comparing a prediction with a measurement is only possible if the prediction was recorded first`.
...
Say: "You tested a claim instead of accepting it."
...
| | |
|---|---|
| **Follows** | Lesson 17 — Contradiction Mechanics |
| **Leads to** | Lesson 19 — When My Data Disagrees |

**Transition in.** Lesson 17 established students record the drop and recovery across a broken pattern. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students measure how many contradictions produce durable change. Lesson 19 assumes it and builds students report honestly a result that does not fit.
