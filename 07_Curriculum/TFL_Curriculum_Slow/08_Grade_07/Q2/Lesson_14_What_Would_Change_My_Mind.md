# Lesson 14 — What Would Have Changed My Mind

**Grade 7** · Persistence Is Not Accuracy · **Quarter 2** · **45 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | What Would Have Changed My Mind: students state in advance what result would count against the claim? |
| **Core concept** | A disconfirming condition names a result that could actually occur in the data and would count against the claim. |
| **Student outcome** | Students state in advance what result would count against the claim. |
| **Previous lesson** | Lesson 13 — Pooling The Class |
| **Next lesson** | Lesson 15 — Intensity Is Not Confidence |
| **Materials** | Printed prediction logs; notebooks |
| **Preparation** | fifteen minutes |
| **Student printout** | `Printouts/Lesson_14_Printout.md` |
| **Homework** | `Homework/Lesson_14_Homework.md` |

## Why this lesson exists

**The conceptual step.** A disconfirming condition names a result that could actually occur in the data and would count against the claim. A condition that could never occur is decorative.
...
**What depends on it.** Lesson 15 — Intensity Is Not Confidence — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A disconfirming condition names a result that could actually occur in the data and would count against the claim. A condition that could never occur is decorative.
...
1. A condition stating one diagonal would have been empty.
2. A condition stating E(t) would not have differed across cells.

### One non-example

A condition stating the data would have been different somehow.
...
That claims can be paired with disconfirming conditions.
...
| Statement | Status |
|---|---|
| A disconfirming condition names a result that could actually occur in the data and would count against the claim. | Framework-derived, appropriate at this grade |
| That claims can be paired with disconfirming conditions. | What this specific activity can show |
| Whether the conditions were met. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 13 — Pooling The Class — specifically: students combine individual matrices into one class dataset.

**How it was taught.** Through the activity: build the pooled class matrix and compute the proportion in each cell

**Quick check.** Ask for the closing sentence of Lesson 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 13: build the pooled class matrix and compute the proportion in each cell, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A condition stating one diagonal would have been empty. |
| **Non-example** | A condition stating the data would have been different somehow. |
...
**Student materials.** One copy of `Printouts/Lesson_14_Printout.md` per student.

**Prior student data required.** Work produced in Lesson 13, kept in the student's folder.
...
**File.** `Printouts/Lesson_14_Printout.md`
...
> "The pooled numbers are harder to argue with than yours alone."
...
**Exact wording.** "Ask what their data would have looked like if the framework were wrong about this."
...
**Target observation.** That claims can be paired with disconfirming conditions.
...
> "A disconfirming condition names a result that could actually occur in the data and would count against the claim. You just saw that when ask what their data would have looked like if the framework were wrong about this.
> Last time we said: The pooled numbers are harder to argue with than yours alone. This is the next part of that.
...
**What students must not infer.** Whether the conditions were met.

### 4. Worked example

**The example.** A condition stating one diagonal would have been empty.
...
**Completed answer.** A condition stating one diagonal would have been empty. — which demonstrates that claims can be paired with disconfirming conditions.
...
**Conclusions not licensed.** Whether the conditions were met.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A condition stating E(t) would not have differed across cells. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A condition stating the data would have been different somehow. Why is this not an
example?"
...
**Exact student instructions.** For three claims, write what result would have counted against each.
...
- *Licensed conclusion.* That claims can be paired with disconfirming conditions.
- *Not licensed.* Whether the conditions were met.
...
- *Expected response.* That claims can be paired with disconfirming conditions.
...
1. Any wording carrying the idea in `A disconfirming condition names a result that could actually occur in the data and would count against the claim`.
...
Say: "Say what would change your mind before you say what you found."

**Why this sentence matters.** It is the opening question of Lesson 15, which assumes students arrive holding it.
...
**File.** `Homework/Lesson_14_Homework.md`
...
| | |
|---|---|
| **Follows** | Lesson 13 — Pooling The Class |
| **Leads to** | Lesson 15 — Intensity Is Not Confidence |

**Transition in.** Lesson 13 established students combine individual matrices into one class dataset. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students state in advance what result would count against the claim. Lesson 15 assumes it and builds students separate how much it mattered from how sure they were.
