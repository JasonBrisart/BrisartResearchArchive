# Lesson 16 — The Distinction Review
...
| | |
|---|---|
| **Central question** | The Distinction Review: students consolidate the central distinction? |
| **Core concept** | The distinction must be stateable cleanly. |
| **Student outcome** | Students consolidate the central distinction. |
| **Previous lesson** | Lesson 15 — Intensity Is Not Confidence |
| **Next lesson** | Lesson 17 — Contradiction Mechanics |
...
**The conceptual step.** The distinction must be stateable cleanly. Hedged statements usually indicate the student is still half-holding the intuition the year exists to correct.
...
**What depends on it.** Lesson 17 — Contradiction Mechanics — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The distinction must be stateable cleanly. Hedged statements usually indicate the student is still half-holding the intuition the year exists to correct.
...
1. How long it lasted says nothing about whether it was right.
2. A claim correctly marked as confusing the two.

### One non-example

A hedged statement about the two being sort of related.
...
Whether the distinction can be stated cleanly.

### What this activity does not establish

Whether the distinction is empirically established.
...
| Statement | Status |
|---|---|
| The distinction must be stateable cleanly. | Framework-derived, appropriate at this grade |
| Whether the distinction can be stated cleanly. | What this specific activity can show |
| Whether the distinction is empirically established. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 15 — Intensity Is Not Confidence — specifically: students separate how much it mattered from how sure they were.

**How it was taught.** Through the activity: re-rate ten log entries on both scales and compare the two columns

**Quick check.** Ask for the closing sentence of Lesson 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 15: re-rate ten log entries on both scales and compare the two columns, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | How long it lasted says nothing about whether it was right. |
| **Non-example** | A hedged statement about the two being sort of related. |
...
> "Two different things. The model uses one of them."
...
**Exact wording.** "Say it in one sentence. No hedging."
...
**Target observation.** Whether the distinction can be stated cleanly.
...
> "The distinction must be stateable cleanly. You just saw that when say it in one sentence.
> Last time we said: Two different things. The model uses one of them. This is the next part of that.
...
**What students must not infer.** Whether the distinction is empirically established.

### 4. Worked example

**The example.** How long it lasted says nothing about whether it was right.
...
**Completed answer.** How long it lasted says nothing about whether it was right. — which demonstrates whether the distinction can be stated cleanly.
...
**Conclusions not licensed.** Whether the distinction is empirically established.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A claim correctly marked as confusing the two. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A hedged statement about the two being sort of related. Why is this not an
example?"
...
**Exact student instructions.** Review with eight claims marked as confusing or respecting the distinction.
...
- *Licensed conclusion.* Whether the distinction can be stated cleanly.
- *Not licensed.* Whether the distinction is empirically established.
...
- *Expected response.* Whether the distinction can be stated cleanly.
...
1. Any wording carrying the idea in `The distinction must be stateable cleanly`.
...
Say: "Next time: what contradiction does to a simulation."
...
| | |
|---|---|
| **Follows** | Lesson 15 — Intensity Is Not Confidence |
| **Leads to** | Lesson 17 — Contradiction Mechanics |

**Transition in.** Lesson 15 established students separate how much it mattered from how sure they were. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students consolidate the central distinction. Lesson 17 assumes it and builds students record the drop and recovery across a broken pattern.
