# Lesson 9 — Two Separate Properties
...
| | |
|---|---|
| **Central question** | Two Separate Properties: students define accuracy and persistence as independent? |
| **Core concept** | Accuracy asks whether the simulation matched the outcome. |
| **Student outcome** | Students define accuracy and persistence as independent. |
| **Previous lesson** | Lesson 8 — The Log Review |
| **Next lesson** | Lesson 10 — The Four Box Study |
...
**The conceptual step.** Accuracy asks whether the simulation matched the outcome. Persistence asks whether it carried forward. If they were the same property, two of the four combinations would be impossible.
...
**What depends on it.** Lesson 10 — The Four Box Study — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Accuracy asks whether the simulation matched the outcome. Persistence asks whether it carried forward. If they were the same property, two of the four combinations would be impossible.
...
1. An accurate prediction that faded immediately.
2. An inaccurate prediction that persisted for days.

### One non-example

A definition treating persistence as long-lasting correctness.
...
That the two properties are logically separable.

### What this activity does not establish

Whether they are empirically independent.
...
| Statement | Status |
|---|---|
| Accuracy asks whether the simulation matched the outcome. | Framework-derived, appropriate at this grade |
| That the two properties are logically separable. | What this specific activity can show |
| Whether they are empirically independent. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 8 — The Log Review — specifically: students consolidate logging practice.

**How it was taught.** Through the activity: full log audit with every failing entry marked and rewritten

**Quick check.** Ask for the closing sentence of Lesson 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 8: full log audit with every failing entry marked and rewritten, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An accurate prediction that faded immediately. |
| **Non-example** | A definition treating persistence as long-lasting correctness. |
...
> "Next time: what accuracy and persistence actually are."
...
**Exact wording.** "Ask for a prediction they were confident about and right, then confident and wrong."
...
**Target observation.** That the two properties are logically separable.
...
> "Accuracy asks whether the simulation matched the outcome. You just saw that when ask for a prediction they were confident about and right, then confident and wrong.
> Last time we said: Next time: what accuracy and persistence actually are. This is the next part of that.
...
**What students must not infer.** Whether they are empirically independent.

### 4. Worked example

**The example.** An accurate prediction that faded immediately.
...
**Completed answer.** An accurate prediction that faded immediately. — which demonstrates that the two properties are logically separable.
...
**Conclusions not licensed.** Whether they are empirically independent.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An inaccurate prediction that persisted for days. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A definition treating persistence as long-lasting correctness. Why is this not an
example?"
...
**Exact student instructions.** Define both in their own words and find one example of each of four combinations.
...
- *Licensed conclusion.* That the two properties are logically separable.
- *Not licensed.* Whether they are empirically independent.
...
- *Expected response.* That the two properties are logically separable.
...
1. Any wording carrying the idea in `Accuracy asks whether the simulation matched the outcome`.
...
Say: "Tomorrow you test this on your own data."
...
| | |
|---|---|
| **Follows** | Lesson 8 — The Log Review |
| **Leads to** | Lesson 10 — The Four Box Study |

**Transition in.** Lesson 8 established students consolidate logging practice. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students define accuracy and persistence as independent. Lesson 10 assumes it and builds students test the independence claim on their own prospective data.
