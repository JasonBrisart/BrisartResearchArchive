# Lesson 6 — Intensity At The Time
...
| | |
|---|---|
| **Central question** | Intensity At The Time: students rate intensity at the moment of prediction, not after? |
| **Core concept** | An intensity rating made after the outcome is contaminated by knowing how things turned out. |
| **Student outcome** | Students rate intensity at the moment of prediction, not after. |
| **Previous lesson** | Lesson 5 — Logging Properly |
| **Next lesson** | Lesson 7 — What Makes A Good Entry |
...
**The conceptual step.** An intensity rating made after the outcome is contaminated by knowing how things turned out. The rating must be made in the same act as the prediction.
...
**What depends on it.** Lesson 7 — What Makes A Good Entry — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An intensity rating made after the outcome is contaminated by knowing how things turned out. The rating must be made in the same act as the prediction.
...
1. An entry with prediction and rating in the same timestamp.
2. A student noticing they had been rating afterwards.

### One non-example

An entry rated once the outcome was known.
...
That contemporaneous rating is different from retrospective rating.

### What this activity does not establish

Whether the ratings are accurate.
...
| Statement | Status |
|---|---|
| An intensity rating made after the outcome is contaminated by knowing how things turned out. | Framework-derived, appropriate at this grade |
| That contemporaneous rating is different from retrospective rating. | What this specific activity can show |
| Whether the ratings are accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 5 — Logging Properly — specifically: students improve their log entries against the four rules.

**How it was taught.** Through the activity: audit and rewrite the first entries; add four more that pass all four rules

**Quick check.** Ask for the closing sentence of Lesson 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 5: audit and rewrite the first entries; add four more that pass all four rules, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An entry with prediction and rating in the same timestamp. |
| **Non-example** | An entry rated once the outcome was known. |
...
> "A log nobody can check is not data."
...
**Exact wording.** "Ask, honestly, when they rated the intensity on entry three."
...
**Target observation.** That contemporaneous rating is different from retrospective rating.
...
> "An intensity rating made after the outcome is contaminated by knowing how things turned out. You just saw that when ask, honestly, when they rated the intensity on entry three.
> Last time we said: A log nobody can check is not data. This is the next part of that.
...
**What students must not infer.** Whether the ratings are accurate.

### 4. Worked example

**The example.** An entry with prediction and rating in the same timestamp.
...
**Completed answer.** An entry with prediction and rating in the same timestamp. — which demonstrates that contemporaneous rating is different from retrospective rating.
...
**Conclusions not licensed.** Whether the ratings are accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student noticing they had been rating afterwards. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An entry rated once the outcome was known. Why is this not an
example?"
...
**Exact student instructions.** Add four entries with intensity rated at writing and timestamped.
...
- *Licensed conclusion.* That contemporaneous rating is different from retrospective rating.
- *Not licensed.* Whether the ratings are accurate.
...
- *Expected response.* That contemporaneous rating is different from retrospective rating.
...
1. Any wording carrying the idea in `An intensity rating made after the outcome is contaminated by knowing how things turned out`.
...
Say: "Rated afterwards, it is contaminated by knowing the outcome."
...
| | |
|---|---|
| **Follows** | Lesson 5 — Logging Properly |
| **Leads to** | Lesson 7 — What Makes A Good Entry |

**Transition in.** Lesson 5 established students improve their log entries against the four rules. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students rate intensity at the moment of prediction, not after. Lesson 7 assumes it and builds students distinguish strong from weak log entries.
