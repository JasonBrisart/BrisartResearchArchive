# Lesson 1 Homework — Starting The Log

**Grade 7** · Persistence Is Not Accuracy · **Quarter 1**
**Follows:** Lesson 1 — Starting The Log · **Points:** 5 · **Optional:** yes
...
Write the sentence Lesson 1 ended on, from memory:
...
Start the log with two entries about the next twenty-four hours, written in class.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has two entries with intensity rated at writing
...
Lesson 2 is **The Persistence Condition**, which assumes you arrive holding it. Write one thing you expect it to be about:
