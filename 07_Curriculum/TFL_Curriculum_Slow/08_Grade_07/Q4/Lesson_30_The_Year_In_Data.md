...
| | |
|---|---|
| **Central question** | The Year In Data: students review the year through their own dataset? |
| **Core concept** | Reviewing a self-collected dataset for surprises is different from summarising it. |
| **Student outcome** | Students review the year through their own dataset. |
| **Previous lesson** | Lesson 29 — Explaining The Distinction |
...
**The conceptual step.** Reviewing a self-collected dataset for surprises is different from summarising it. The surprise must be located to a specific entry.
...
Reviewing a self-collected dataset for surprises is different from summarising it. The surprise must be located to a specific entry.
...
1. A surprise located to entry fourteen.
2. A student finding a pattern they had not noticed while collecting.

### One non-example

A summary with no specific surprise identified.
...
That a self-collected dataset repays examination.
...
| Statement | Status |
|---|---|
| Reviewing a self-collected dataset for surprises is different from summarising it. | Framework-derived, appropriate at this grade |
| That a self-collected dataset repays examination. | What this specific activity can show |
| Whether the dataset supports general claims. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 29 — Explaining The Distinction — specifically: students explain persistence versus accuracy to somebody else.
...
| **Correct example** | A surprise located to entry fourteen. |
| **Non-example** | A summary with no specific surprise identified. |
...
**Exact wording.** "Ask what twenty weeks of data shows that they did not expect."
...
**Target observation.** That a self-collected dataset repays examination.
...
> "Reviewing a self-collected dataset for surprises is different from summarising it. You just saw that when ask what twenty weeks of data shows that they did not expect.
> Last time we said: If they got it, you have it. This is the next part of that.
...
**The example.** A surprise located to entry fourteen.
...
**Completed answer.** A surprise located to entry fourteen. — which demonstrates that a self-collected dataset repays examination.
...
**Teacher prompt.** "Here is a second case. A student finding a pattern they had not noticed while collecting. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A summary with no specific surprise identified. Why is this not an
example?"
...
**Exact student instructions.** Write a summary of the year's dataset including one surprise in it.
...
- *Licensed conclusion.* That a self-collected dataset repays examination.
...
- *Expected response.* That a self-collected dataset repays examination.
...
1. Any wording carrying the idea in `Reviewing a self-collected dataset for surprises is different from summarising it`.
...
Say: "You collected that. Nobody handed it to you."
...
| | |
|---|---|
| **Follows** | Lesson 29 — Explaining The Distinction |
| **Leads to** | Lesson 31 — Practice Final |

**Transition in.** Lesson 29 established students explain persistence versus accuracy to somebody else. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students review the year through their own dataset. Lesson 31 assumes it and builds students rehearse the final under conditions.
