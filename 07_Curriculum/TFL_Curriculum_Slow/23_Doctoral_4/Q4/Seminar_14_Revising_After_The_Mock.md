# Seminar 14 — Revising After The Mock
...
| | |
|---|---|
| **Central question** | Revising After The Mock: participants revise against mock feedback? |
| **Core concept** | An unanswered question marks a gap rather than an unfair challenge. |
| **Student outcome** | Participants revise against mock feedback. |
| **Previous seminar** | Seminar 13 — The Mock Defence |
| **Next seminar** | Seminar 15 — The Defence |
...
**The conceptual step.** An unanswered question marks a gap rather than an unfair challenge. Each produces a logged revision.
...
**What depends on it.** Seminar 15 — The Defence — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An unanswered question marks a gap rather than an unfair challenge. Each produces a logged revision.
...
1. A revision addressing the scope challenger's question.
2. A log with one entry per unanswered question.

### One non-example

Questions dismissed as beyond the dissertation's remit.
...
That mock feedback converts into revisions.

### What this activity does not establish

Whether the revised dissertation is sound.
...
| Statement | Status |
|---|---|
| An unanswered question marks a gap rather than an unfair challenge. | Framework-derived, appropriate at this grade |
| That mock feedback converts into revisions. | What this specific activity can show |
| Whether the revised dissertation is sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 13 — The Mock Defence — specifically: participants face the four adversarial roles in rehearsal.

**How it was taught.** Through the activity: full mock defence with every unanswered question recorded

**Quick check.** Ask for the closing sentence of Seminar 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 13: full mock defence with every unanswered question recorded, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A revision addressing the scope challenger's question. |
| **Non-example** | Questions dismissed as beyond the dissertation's remit. |
...
> "The questions you could not answer are your revision list."
...
**Exact wording.** "Say: every unanswered question becomes a revision."
...
**Target observation.** That mock feedback converts into revisions.
...
> "An unanswered question marks a gap rather than an unfair challenge. You just saw that when say: every unanswered question becomes a revision.
> Last time we said: The questions you could not answer are your revision list. This is the next part of that.
...
**What students must not infer.** Whether the revised dissertation is sound.

### 4. Worked example

**The example.** A revision addressing the scope challenger's question.
...
**Completed answer.** A revision addressing the scope challenger's question. — which demonstrates that mock feedback converts into revisions.
...
**Conclusions not licensed.** Whether the revised dissertation is sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A log with one entry per unanswered question. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Questions dismissed as beyond the dissertation's remit. Why is this not an
example?"
...
**Exact student instructions.** Revise and log each change against its question.
...
- *Licensed conclusion.* That mock feedback converts into revisions.
- *Not licensed.* Whether the revised dissertation is sound.
...
- *Expected response.* That mock feedback converts into revisions.
...
1. Any wording carrying the idea in `An unanswered question marks a gap rather than an unfair challenge`.
...
Say: "A question you could not answer is a gap."
...
| | |
|---|---|
| **Follows** | Seminar 13 — The Mock Defence |
| **Leads to** | Seminar 15 — The Defence |

**Transition in.** Seminar 13 established participants face the four adversarial roles in rehearsal. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants revise against mock feedback. Seminar 15 assumes it and builds participants defend the completed dissertation.
