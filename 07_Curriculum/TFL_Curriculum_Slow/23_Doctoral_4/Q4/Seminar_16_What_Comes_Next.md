...
| | |
|---|---|
| **Central question** | What Comes Next: participants state what they would do with a programme rather than a project? |
| **Core concept** | A programme sketch names a first study and a stop condition. |
| **Student outcome** | Participants state what they would do with a programme rather than a project. |
| **Previous seminar** | Seminar 15 — The Defence |
...
**The conceptual step.** A programme sketch names a first study and a stop condition. Without a stop condition, continuing is not a decision being made.
...
A programme sketch names a first study and a stop condition. Without a stop condition, continuing is not a decision being made.
...
1. A sketch naming a first study and an observation that would end the programme.
2. A stop condition naming a specific result.

### One non-example

A programme sketch with no ending specified.
...
That programme sketches require stop conditions.
...
| Statement | Status |
|---|---|
| A programme sketch names a first study and a stop condition. | Framework-derived, appropriate at this grade |
| That programme sketches require stop conditions. | What this specific activity can show |
| Whether the programme is warranted. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 15 — The Defence — specifically: participants defend the completed dissertation.

**How it was taught.** Through the activity: full defence against four examiners

**Quick check.** Ask for the closing sentence of Seminar 15. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 15: full defence against four examiners, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A sketch naming a first study and an observation that would end the programme. |
| **Non-example** | A programme sketch with no ending specified. |
...
> "A null defended well scores identically to a positive result."
...
**Exact wording.** "Say: one study is done. What would a decade look like?"
...
**Target observation.** That programme sketches require stop conditions.
...
> "A programme sketch names a first study and a stop condition. You just saw that when say: one study is done.
> Last time we said: A null defended well scores identically to a positive result. This is the next part of that.
...
**The example.** A sketch naming a first study and an observation that would end the programme.
...
**Completed answer.** A sketch naming a first study and an observation that would end the programme. — which demonstrates that programme sketches require stop conditions.
...
**Teacher prompt.** "Here is a second case. A stop condition naming a specific result. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A programme sketch with no ending specified. Why is this not an
example?"
...
**Exact student instructions.** Write a one-page programme sketch with a stated first study and a stop condition.
...
- *Licensed conclusion.* That programme sketches require stop conditions.
...
- *Expected response.* That programme sketches require stop conditions.
...
1. Any wording carrying the idea in `A programme sketch names a first study and a stop condition`.
...
Say: "Next year: whether that programme is warranted at all."
...
| | |
|---|---|
| **Follows** | Seminar 15 — The Defence |
| **Leads to** | The final examination. |

**Transition in.** Seminar 15 established participants defend the completed dissertation. This seminar uses that as the starting point.
