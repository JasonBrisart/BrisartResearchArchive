...
| | |
|---|---|
| **Central question** | The Defence: participants defend the completed dissertation? |
| **Core concept** | The dissertation defence requires the inference ceiling to be held under pressure. |
| **Student outcome** | Participants defend the completed dissertation. |
| **Previous seminar** | Seminar 14 — Revising After The Mock |
| **Next seminar** | Seminar 16 — What Comes Next |
...
**The conceptual step.** The dissertation defence requires the inference ceiling to be held under pressure. A null defended well scores identically to a positive result.
...
**What depends on it.** Seminar 16 — What Comes Next — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The dissertation defence requires the inference ceiling to be held under pressure. A null defended well scores identically to a positive result.
...
1. A defence holding the ceiling when pressed to claim more.
2. A null result defended with its contribution stated.

### One non-example

A claim exceeding the declared ceiling under questioning.
...
Whether the dissertation can be defended.
...
| Statement | Status |
|---|---|
| The dissertation defence requires the inference ceiling to be held under pressure. | Framework-derived, appropriate at this grade |
| Whether the dissertation can be defended. | What this specific activity can show |
| Whether the result is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 14 — Revising After The Mock — specifically: participants revise against mock feedback.

**How it was taught.** Through the activity: revise and log each change against its question

**Quick check.** Ask for the closing sentence of Seminar 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 14: revise and log each change against its question, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence holding the ceiling when pressed to claim more. |
| **Non-example** | A claim exceeding the declared ceiling under questioning. |
...
> "A question you could not answer is a gap."
...
**Exact wording.** "Say: the question, the design, the result, both directions, and what you cannot claim."
...
**Target observation.** Whether the dissertation can be defended.
...
> "The dissertation defence requires the inference ceiling to be held under pressure. You just saw that when say: the question, the design, the result, both directions, and what you cannot claim.
> Last time we said: A question you could not answer is a gap. This is the next part of that.
...
**What students must not infer.** Whether the result is correct.

### 4. Worked example

**The example.** A defence holding the ceiling when pressed to claim more.
...
**Completed answer.** A defence holding the ceiling when pressed to claim more. — which demonstrates whether the dissertation can be defended.
...
**Conclusions not licensed.** Whether the result is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A null result defended with its contribution stated. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim exceeding the declared ceiling under questioning. Why is this not an
example?"
...
**Exact student instructions.** Full defence against four examiners.
...
- *Licensed conclusion.* Whether the dissertation can be defended.
- *Not licensed.* Whether the result is correct.
...
- *Expected response.* Whether the dissertation can be defended.
...
1. Any wording carrying the idea in `The dissertation defence requires the inference ceiling to be held under pressure`.
...
Say: "A null defended well scores identically to a positive result."
...
| | |
|---|---|
| **Follows** | Seminar 14 — Revising After The Mock |
| **Leads to** | Seminar 16 — What Comes Next |

**Transition in.** Seminar 14 established participants revise against mock feedback. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants defend the completed dissertation. Seminar 16 assumes it and builds participants state what they would do with a programme rather than a project.
