# Seminar 13 — The Mock Defence

**Doctoral Year 4** · Dissertation and Defence · **Quarter 4** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Mock Defence: participants face the four adversarial roles in rehearsal? |
| **Core concept** | A mock defence harder than the real examination produces a complete list of unanswered questions while there is still time to address them. |
| **Student outcome** | Participants face the four adversarial roles in rehearsal. |
| **Previous seminar** | Seminar 12 — Gate Checking |
| **Next seminar** | Seminar 14 — Revising After The Mock |
| **Materials** | The participant's own proposal and data; dissertation structure templates |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_13_Printout.md` |
| **Homework** | `Homework/Seminar_13_Homework.md` |

## Why this lesson exists

**The conceptual step.** A mock defence harder than the real examination produces a complete list of unanswered questions while there is still time to address them.
...
**What depends on it.** Seminar 14 — Revising After The Mock — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A mock defence harder than the real examination produces a complete list of unanswered questions while there is still time to address them.
...
1. A defence answering the inference challenger specifically.
2. A recorded list of six unanswered questions.

### One non-example

A defence restating the design under challenge.
...
That mock defences identify gaps before examination.

### What this activity does not establish

Whether the defence will succeed.
...
| Statement | Status |
|---|---|
| A mock defence harder than the real examination produces a complete list of unanswered questions while there is still time to address them. | Framework-derived, appropriate at this grade |
| That mock defences identify gaps before examination. | What this specific activity can show |
| Whether the defence will succeed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 12 — Gate Checking — specifically: participants check the dissertation against both gates.

**How it was taught.** Through the activity: peer gate check with failures returned for repair

**Quick check.** Ask for the closing sentence of Seminar 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 12: peer gate check with failures returned for repair, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence answering the inference challenger specifically. |
| **Non-example** | A defence restating the design under challenge. |
...
**Student materials.** One copy of `Printouts/Seminar_13_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 12, kept in the student's folder.
...
**File.** `Printouts/Seminar_13_Printout.md`
...
> "The gate check is the same one the examiners will run."
...
**Exact wording.** "Say: twenty minutes presenting, forty defending. Harder than the real thing, deliberately."
...
**Target observation.** That mock defences identify gaps before examination.
...
> "A mock defence harder than the real examination produces a complete list of unanswered questions while there is still time to address them. You just saw that when say: twenty minutes presenting, forty defending.
> Last time we said: The gate check is the same one the examiners will run. This is the next part of that.
...
**What students must not infer.** Whether the defence will succeed.

### 4. Worked example

**The example.** A defence answering the inference challenger specifically.
...
**Completed answer.** A defence answering the inference challenger specifically. — which demonstrates that mock defences identify gaps before examination.
...
**Conclusions not licensed.** Whether the defence will succeed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A recorded list of six unanswered questions. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence restating the design under challenge. Why is this not an
example?"
...
**Exact student instructions.** Full mock defence with every unanswered question recorded.
...
- *Licensed conclusion.* That mock defences identify gaps before examination.
- *Not licensed.* Whether the defence will succeed.
...
- *Expected response.* That mock defences identify gaps before examination.
...
1. Any wording carrying the idea in `A mock defence harder than the real examination produces a complete list of unanswered questions while there is still time to address them`.
...
Say: "The questions you could not answer are your revision list."

**Why this sentence matters.** It is the opening question of Seminar 14, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_13_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 12 — Gate Checking |
| **Leads to** | Seminar 14 — Revising After The Mock |

**Transition in.** Seminar 12 established participants check the dissertation against both gates. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants face the four adversarial roles in rehearsal. Seminar 14 assumes it and builds participants revise against mock feedback.
