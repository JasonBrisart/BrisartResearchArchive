...
| | |
|---|---|
| **Central question** | Gate Checking: participants check the dissertation against both gates? |
| **Core concept** | The two gates are inference within the declared ceiling and a correct scope rejection. |
| **Student outcome** | Participants check the dissertation against both gates. |
| **Previous seminar** | Seminar 11 — The Scope Section |
| **Next seminar** | Seminar 13 — The Mock Defence |
| **Materials** | The participant's own proposal and data; dissertation structure templates |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_12_Printout.md` |
| **Homework** | `Homework/Seminar_12_Homework.md` |

## Why this lesson exists

**The conceptual step.** The two gates are inference within the declared ceiling and a correct scope rejection. Both are checked before any other reading.
...
**What depends on it.** Seminar 13 — The Mock Defence — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The two gates are inference within the declared ceiling and a correct scope rejection. Both are checked before any other reading.
...
1. A dissertation passing a peer gate check on both items.
2. A dissertation returned after a ceiling breach was found.

### One non-example

A dissertation submitted with the gates assumed to pass.
...
That gate checking precedes examination.

### What this activity does not establish

Whether the dissertation is otherwise sound.
...
| Statement | Status |
|---|---|
| The two gates are inference within the declared ceiling and a correct scope rejection. | Framework-derived, appropriate at this grade |
| That gate checking precedes examination. | What this specific activity can show |
| Whether the dissertation is otherwise sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 11 — The Scope Section — specifically: participants write the formal rejection their dissertation requires.

**How it was taught.** Through the activity: write the rejection with boundary and alternative level

**Quick check.** Ask for the closing sentence of Seminar 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 11: write the rejection with boundary and alternative level, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A dissertation passing a peer gate check on both items. |
| **Non-example** | A dissertation submitted with the gates assumed to pass. |
...
**Student materials.** One copy of `Printouts/Seminar_12_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 11, kept in the student's folder.
...
**File.** `Printouts/Seminar_12_Printout.md`
...
> "The scope gate is checked before anything else is read."
...
**Exact wording.** "Say: inference inside the ceiling, and a correct scope rejection."
...
**Target observation.** That gate checking precedes examination.
...
> "The two gates are inference within the declared ceiling and a correct scope rejection. You just saw that when say: inference inside the ceiling, and a correct scope rejection.
> Last time we said: The scope gate is checked before anything else is read. This is the next part of that.
...
**What students must not infer.** Whether the dissertation is otherwise sound.

### 4. Worked example

**The example.** A dissertation passing a peer gate check on both items.
...
**Completed answer.** A dissertation passing a peer gate check on both items. — which demonstrates that gate checking precedes examination.
...
**Conclusions not licensed.** Whether the dissertation is otherwise sound.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A dissertation returned after a ceiling breach was found. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A dissertation submitted with the gates assumed to pass. Why is this not an
example?"
...
**Exact student instructions.** Peer gate check with failures returned for repair.
...
- *Licensed conclusion.* That gate checking precedes examination.
- *Not licensed.* Whether the dissertation is otherwise sound.
...
- *Expected response.* That gate checking precedes examination.
...
1. Any wording carrying the idea in `The two gates are inference within the declared ceiling and a correct scope rejection`.
...
Say: "The gate check is the same one the examiners will run."

**Why this sentence matters.** It is the opening question of Seminar 13, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_12_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 11 — The Scope Section |
| **Leads to** | Seminar 13 — The Mock Defence |

**Transition in.** Seminar 11 established participants write the formal rejection their dissertation requires. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants check the dissertation against both gates. Seminar 13 assumes it and builds participants face the four adversarial roles in rehearsal.
