# Seminar 7 — Chapter Review By Strangers
...
| | |
|---|---|
| **Central question** | Chapter Review By Strangers: participants have chapters read by people new to the project? |
| **Core concept** | A supervisor fills gaps from knowledge of the project. |
| **Student outcome** | Participants have chapters read by people new to the project. |
| **Previous seminar** | Seminar 6 — Availability And Reproducibility |
| **Next seminar** | Seminar 8 — Revising Against Strangers |
| **Materials** | The participant's own proposal and data; dissertation structure templates |
| **Preparation** | two hours |
| **Student printout** | `Printouts/Seminar_07_Printout.md` |
| **Homework** | `Homework/Seminar_07_Homework.md` |

## Why this lesson exists

**The conceptual step.** A supervisor fills gaps from knowledge of the project. A stranger reader is the honest simulation of an examiner meeting the work for the first time.
...
**What depends on it.** Seminar 8 — Revising Against Strangers — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A supervisor fills gaps from knowledge of the project. A stranger reader is the honest simulation of an examiner meeting the work for the first time.
...
1. A question list from a reader outside the project.
2. Eight questions recorded from a stranger reading.

### One non-example

A chapter reviewed by a collaborator who knows the work.
...
That examiner simulation requires unfamiliar readers.

### What this activity does not establish

Whether the chapter is correct.
...
| Statement | Status |
|---|---|
| A supervisor fills gaps from knowledge of the project. | Framework-derived, appropriate at this grade |
| That examiner simulation requires unfamiliar readers. | What this specific activity can show |
| Whether the chapter is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 6 — Availability And Reproducibility — specifically: participants state what others can obtain.

**How it was taught.** Through the activity: draft the availability statement naming what cannot be shared and why

**Quick check.** Ask for the closing sentence of Seminar 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 6: draft the availability statement naming what cannot be shared and why, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A question list from a reader outside the project. |
| **Non-example** | A chapter reviewed by a collaborator who knows the work. |
...
**Student materials.** One copy of `Printouts/Seminar_07_Printout.md` per student.

**Prior student data required.** Work produced in Seminar 6, kept in the student's folder.
...
**File.** `Printouts/Seminar_07_Printout.md`
...
> "An honest restriction stated beats an unstated one discovered."
...
**Exact wording.** "Say: your supervisor knows what you meant. A stranger does not, and a stranger examines you."
...
**Target observation.** That examiner simulation requires unfamiliar readers.
...
> "A supervisor fills gaps from knowledge of the project. You just saw that when say: your supervisor knows what you meant.
> Last time we said: An honest restriction stated beats an unstated one discovered. This is the next part of that.
...
**What students must not infer.** Whether the chapter is correct.

### 4. Worked example

**The example.** A question list from a reader outside the project.
...
**Completed answer.** A question list from a reader outside the project. — which demonstrates that examiner simulation requires unfamiliar readers.
...
**Conclusions not licensed.** Whether the chapter is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Eight questions recorded from a stranger reading. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A chapter reviewed by a collaborator who knows the work. Why is this not an
example?"
...
**Exact student instructions.** Cross-project reading with every question recorded as a revision.
...
- *Licensed conclusion.* That examiner simulation requires unfamiliar readers.
- *Not licensed.* Whether the chapter is correct.
...
- *Expected response.* That examiner simulation requires unfamiliar readers.
...
1. Any wording carrying the idea in `A supervisor fills gaps from knowledge of the project`.
...
Say: "The stranger reader is the honest simulation of your examiner."

**Why this sentence matters.** It is the opening question of Seminar 8, which assumes students arrive holding it.
...
**File.** `Homework/Seminar_07_Homework.md`
...
| | |
|---|---|
| **Follows** | Seminar 6 — Availability And Reproducibility |
| **Leads to** | Seminar 8 — Revising Against Strangers |

**Transition in.** Seminar 6 established participants state what others can obtain. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants have chapters read by people new to the project. Seminar 8 assumes it and builds participants revise chapters against stranger feedback.
