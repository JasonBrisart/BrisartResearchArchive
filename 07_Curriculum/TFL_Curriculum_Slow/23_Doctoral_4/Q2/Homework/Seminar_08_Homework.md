# Seminar 8 Homework — Revising Against Strangers

**Doctoral Year 4** · Dissertation and Defence · **Quarter 2**
**Follows:** Seminar 8 — Revising Against Strangers · **Points:** 5 · **Optional:** yes
...
Revise and run a second stranger read with both counts reported.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the second read produces fewer questions
...
Seminar 9 is **The Limitations Section**, which assumes you arrive holding it. Write one thing you expect it to be about:
