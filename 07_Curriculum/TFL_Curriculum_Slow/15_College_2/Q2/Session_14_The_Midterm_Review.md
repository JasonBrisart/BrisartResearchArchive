...
| **Core concept** | A midterm review must sample the whole term rather than the recent sessions, which otherwise produces a false sense of readiness. |
| **Student outcome** | Students consolidate the first half. |
| **Previous session** | Session 13 — The External Run |
| **Next session** | Session 15 — Repairing A Protocol |
...
**The conceptual step.** A midterm review must sample the whole term rather than the recent sessions, which otherwise produces a false sense of readiness.
...
**What depends on it.** Session 15 — Repairing A Protocol — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A midterm review must sample the whole term rather than the recent sessions, which otherwise produces a false sense of readiness.
...
1. A review touching Session 3 and Session 12 equally.
2. A cohort identifying construct validity as its weakest area.

### One non-example

A review covering only the last four sessions.
...
| Statement | Status |
|---|---|
| A midterm review must sample the whole term rather than the recent sessions, which otherwise produces a false sense of readiness. | Framework-derived, appropriate at this grade |
| Where the cohort is weakest. | What this specific activity can show |
| What the midterm will contain. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 13 — The External Run — specifically: students test protocols by handing them to somebody else.

**How it was taught.** Through the activity: run a partner's protocol and return a full question list

**Quick check.** Ask for the closing sentence of Session 13. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 13: run a partner's protocol and return a full question list, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A review touching Session 3 and Session 12 equally. |
| **Non-example** | A review covering only the last four sessions. |
...
> "You are not the test. The person who runs it is."
...
> "A midterm review must sample the whole term rather than the recent sessions, which otherwise produces a false sense of readiness. You just saw that when ask what is still unclear about everything so far.
> Last time we said: You are not the test. The person who runs it is. This is the next part of that.
...
**What students must not infer.** What the midterm will contain.

### 4. Worked example

**The example.** A review touching Session 3 and Session 12 equally.
...
**Completed answer.** A review touching Session 3 and Session 12 equally. — which demonstrates where the cohort is weakest.
...
**Conclusions not licensed.** What the midterm will contain.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A cohort identifying construct validity as its weakest area. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A review covering only the last four sessions. Why is this not an
example?"
...
**Exact student instructions.** Review covering the constraint, confabulation, Sim(t), E(t), and validity.
...
- *Not licensed.* What the midterm will contain.
...
1. Any wording carrying the idea in `A midterm review must sample the whole term rather than the recent sessions, which otherwise produces a false sense of readiness`.
...
Say: "The midterm covers everything up to here."
...
| | |
|---|---|
| **Follows** | Session 13 — The External Run |
| **Leads to** | Session 15 — Repairing A Protocol |

**Transition in.** Session 13 established students test protocols by handing them to somebody else. This session uses that as the starting point.

**Transition out.** This session establishes students consolidate the first half. Session 15 assumes it and builds students revise against external-run feedback.
