...
| | |
|---|---|
| **Central question** | Prespecification: students answer the confabulation objection with timing? |
| **Core concept** | Prespecification answers confabulation by timing rather than by cleverness. |
| **Student outcome** | Students answer the confabulation objection with timing. |
| **Previous session** | Session 3 — The Confabulation Objection |
| **Next session** | Session 5 — Capturing Sim(t) |
...
**The conceptual step.** Prespecification answers confabulation by timing rather than by cleverness. Computing the survival rate of one's own old data makes the cost concrete.
...
**What depends on it.** Session 5 — Capturing Sim(t) — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Prespecification answers confabulation by timing rather than by cleverness. Computing the survival rate of one's own old data makes the cost concrete.
...
1. A dataset with a forty percent survival rate under the rules.
2. A student quantifying exactly how much of their data fails.

### One non-example

Prespecification described as good practice with no rate computed.
...
That prespecification is quantifiable and costly.

### What this activity does not establish

Whether the surviving data is accurate.
...
| Statement | Status |
|---|---|
| Prespecification answers confabulation by timing rather than by cleverness. | Framework-derived, appropriate at this grade |
| That prespecification is quantifiable and costly. | What this specific activity can show |
| Whether the surviving data is accurate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 3 — The Confabulation Objection — specifically: students state the objection that threatens all self-report.

**How it was taught.** Through the activity: state the objection in its strongest form and assess what proportion of their data it threatens

**Quick check.** Ask for the closing sentence of Session 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 3: state the objection in its strongest form and assess what proportion of their data it threatens, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A dataset with a forty percent survival rate under the rules. |
| **Non-example** | Prespecification described as good practice with no rate computed. |
...
> "The answer is not clever. It is just timing."
...
**Exact wording.** "Name the student who raised it most sharply and say today is the answer."
...
**Target observation.** That prespecification is quantifiable and costly.
...
> "Prespecification answers confabulation by timing rather than by cleverness. You just saw that when name the student who raised it most sharply and say today is the answer.
> Last time we said: The answer is not clever. It is just timing. This is the next part of that.
...
**What students must not infer.** Whether the surviving data is accurate.

### 4. Worked example

**The example.** A dataset with a forty percent survival rate under the rules.
...
**Completed answer.** A dataset with a forty percent survival rate under the rules. — which demonstrates that prespecification is quantifiable and costly.
...
**Conclusions not licensed.** Whether the surviving data is accurate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A student quantifying exactly how much of their data fails. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Prespecification described as good practice with no rate computed. Why is this not an
example?"
...
**Exact student instructions.** Rebuild one dataset under prespecification rules and compute the survival rate.
...
- *Licensed conclusion.* That prespecification is quantifiable and costly.
- *Not licensed.* Whether the surviving data is accurate.
...
- *Expected response.* That prespecification is quantifiable and costly.
...
1. Any wording carrying the idea in `Prespecification answers confabulation by timing rather than by cleverness`.
...
Say: "Content plus prespecification. Either missing and it is not a framework claim."
...
| | |
|---|---|
| **Follows** | Session 3 — The Confabulation Objection |
| **Leads to** | Session 5 — Capturing Sim(t) |

**Transition in.** Session 3 established students state the objection that threatens all self-report. This session uses that as the starting point.

**Transition out.** This session establishes students answer the confabulation objection with timing. Session 5 assumes it and builds students build a contamination-resistant elicitation protocol.
