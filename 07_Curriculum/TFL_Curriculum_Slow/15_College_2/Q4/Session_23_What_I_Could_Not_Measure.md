# Session 23 — What I Could Not Measure
...
| | |
|---|---|
| **Central question** | What I Could Not Measure: students catalogue what resisted measurement this year? |
| **Core concept** | Cataloguing what resisted measurement is part of the year's result. |
| **Student outcome** | Students catalogue what resisted measurement this year. |
| **Previous session** | Session 22 — Defending The Protocol |
| **Next session** | Session 24 — Measurement In Your Own Field |
...
**The conceptual step.** Cataloguing what resisted measurement is part of the year's result. Claiming everything was measurable indicates the hard cases were avoided rather than attempted.
...
**What depends on it.** Session 24 — Measurement In Your Own Field — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Cataloguing what resisted measurement is part of the year's result. Claiming everything was measurable indicates the hard cases were avoided rather than attempted.
...
1. Within-window content listed as unmeasurable with current means.
2. A requirement naming the resolution that would be needed.

### One non-example

A claim that all five variables were successfully measured.
...
That measurement limits can be catalogued honestly.

### What this activity does not establish

Whether the limits are permanent.
...
| Statement | Status |
|---|---|
| Cataloguing what resisted measurement is part of the year's result. | Framework-derived, appropriate at this grade |
| That measurement limits can be catalogued honestly. | What this specific activity can show |
| Whether the limits are permanent. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 22 — Defending The Protocol — specifically: students defend measurement choices under challenge.

**How it was taught.** Through the activity: a six-minute presentation facing questions on validity, circularity, and runnability

**Quick check.** Ask for the closing sentence of Session 22. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 22: a six-minute presentation facing questions on validity, circularity, and runnability, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Within-window content listed as unmeasurable with current means. |
| **Non-example** | A claim that all five variables were successfully measured. |
...
> "Intent is not validity. What else could it be picking up?"
...
**Exact wording.** "Ask what they wanted to measure and could not."
...
**Target observation.** That measurement limits can be catalogued honestly.
...
> "Cataloguing what resisted measurement is part of the year's result. You just saw that when ask what they wanted to measure and could not.
> Last time we said: Intent is not validity. What else could it be picking up? This is the next part of that.
...
**What students must not infer.** Whether the limits are permanent.

### 4. Worked example

**The example.** Within-window content listed as unmeasurable with current means.
...
**Completed answer.** Within-window content listed as unmeasurable with current means. — which demonstrates that measurement limits can be catalogued honestly.
...
**Conclusions not licensed.** Whether the limits are permanent.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A requirement naming the resolution that would be needed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that all five variables were successfully measured. Why is this not an
example?"
...
**Exact student instructions.** List four things that resisted measurement and what each would require.
...
- *Licensed conclusion.* That measurement limits can be catalogued honestly.
- *Not licensed.* Whether the limits are permanent.
...
- *Expected response.* That measurement limits can be catalogued honestly.
...
1. Any wording carrying the idea in `Cataloguing what resisted measurement is part of the year's result`.
...
Say: "Naming what resisted is part of the result."
...
| | |
|---|---|
| **Follows** | Session 22 — Defending The Protocol |
| **Leads to** | Session 24 — Measurement In Your Own Field |

**Transition in.** Session 22 established students defend measurement choices under challenge. This session uses that as the starting point.

**Transition out.** This session establishes students catalogue what resisted measurement this year. Session 24 assumes it and builds students compare measurement standards with their own discipline.
