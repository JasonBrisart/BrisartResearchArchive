# Session 21 — The Complete Protocol
...
| | |
|---|---|
| **Central question** | The Complete Protocol: students assemble a full measurement package? |
| **Core concept** | A complete measurement package has six components. |
| **Student outcome** | Students assemble a full measurement package. |
| **Previous session** | Session 20 — Complementary Measures |
| **Next session** | Session 22 — Defending The Protocol |
...
**The conceptual step.** A complete measurement package has six components. The resolution declaration is the most frequently omitted and the one that makes results interpretable.
...
**What depends on it.** Session 22 — Defending The Protocol — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A complete measurement package has six components. The resolution declaration is the most frequently omitted and the one that makes results interpretable.
...
1. A package with all six components present.
2. A package audited and the missing declaration found.

### One non-example

A package with five components and no resolution declaration.
...
That measurement packages have stateable completeness.

### What this activity does not establish

Whether the package would work.
...
| Statement | Status |
|---|---|
| A complete measurement package has six components. | Framework-derived, appropriate at this grade |
| That measurement packages have stateable completeness. | What this specific activity can show |
| Whether the package would work. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 20 — Complementary Measures — specifically: students propose a non-report measure and its assumptions.

**How it was taught.** Through the activity: propose two complementary measures and state the assumptions each brings

**Quick check.** Ask for the closing sentence of Session 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 20: propose two complementary measures and state the assumptions each brings, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A package with all six components present. |
| **Non-example** | A package with five components and no resolution declaration. |
...
> "Any measure you add brings its own assumptions."
...
**Exact wording.** "Say: map, Sim(t), E(t), criterion, sampling, resolution. All of it."
...
**Target observation.** That measurement packages have stateable completeness.
...
> "A complete measurement package has six components. You just saw that when say: map, Sim(t), E(t), criterion, sampling, resolution.
> Last time we said: Any measure you add brings its own assumptions. This is the next part of that.
...
**What students must not infer.** Whether the package would work.

### 4. Worked example

**The example.** A package with all six components present.
...
**Completed answer.** A package with all six components present. — which demonstrates that measurement packages have stateable completeness.
...
**Conclusions not licensed.** Whether the package would work.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A package audited and the missing declaration found. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A package with five components and no resolution declaration. Why is this not an
example?"
...
**Exact student instructions.** Assemble the complete package and swap for a full audit.
...
- *Licensed conclusion.* That measurement packages have stateable completeness.
- *Not licensed.* Whether the package would work.
...
- *Expected response.* That measurement packages have stateable completeness.
...
1. Any wording carrying the idea in `A complete measurement package has six components`.
...
Say: "That is a measurement package. Next year it gets adjudicated."
...
| | |
|---|---|
| **Follows** | Session 20 — Complementary Measures |
| **Leads to** | Session 22 — Defending The Protocol |

**Transition in.** Session 20 established students propose a non-report measure and its assumptions. This session uses that as the starting point.

**Transition out.** This session establishes students assemble a full measurement package. Session 22 assumes it and builds students defend measurement choices under challenge.
