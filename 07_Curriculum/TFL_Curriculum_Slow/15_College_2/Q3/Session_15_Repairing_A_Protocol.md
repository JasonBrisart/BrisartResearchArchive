# Session 15 — Repairing A Protocol
...
| | |
|---|---|
| **Central question** | Repairing A Protocol: students revise against external-run feedback? |
| **Core concept** | Repair converts each recorded question into an explicit line. |
| **Student outcome** | Students revise against external-run feedback. |
| **Previous session** | Session 14 — The Midterm Review |
| **Next session** | Session 16 — The Measurement Critique |
...
**The conceptual step.** Repair converts each recorded question into an explicit line. A second run with fewer questions is the evidence the repair worked.
...
**What depends on it.** Session 16 — The Measurement Critique — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Repair converts each recorded question into an explicit line. A second run with fewer questions is the evidence the repair worked.
...
1. A second run producing two questions rather than six.
2. A repair adding explicit timing to the prompt delivery.

### One non-example

A defence that the original wording was sufficiently clear.
...
That repair is measurable by re-running.

### What this activity does not establish

Whether the protocol is now complete.
...
| Statement | Status |
|---|---|
| Repair converts each recorded question into an explicit line. | Framework-derived, appropriate at this grade |
| That repair is measurable by re-running. | What this specific activity can show |
| Whether the protocol is now complete. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 14 — The Midterm Review — specifically: students consolidate the first half.

**How it was taught.** Through the activity: review covering the constraint, confabulation, Sim(t), E(t), and validity

**Quick check.** Ask for the closing sentence of Session 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 14: review covering the constraint, confabulation, Sim(t), E(t), and validity, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A second run producing two questions rather than six. |
| **Non-example** | A defence that the original wording was sufficiently clear. |
...
**Exact wording.** "Say: every question becomes a line in the protocol."
...
**Target observation.** That repair is measurable by re-running.
...
> "Repair converts each recorded question into an explicit line. You just saw that when say: every question becomes a line in the protocol.
...
**What students must not infer.** Whether the protocol is now complete.

### 4. Worked example

**The example.** A second run producing two questions rather than six.
...
**Completed answer.** A second run producing two questions rather than six. — which demonstrates that repair is measurable by re-running.
...
**Conclusions not licensed.** Whether the protocol is now complete.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A repair adding explicit timing to the prompt delivery. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence that the original wording was sufficiently clear. Why is this not an
example?"
...
**Exact student instructions.** Repair the protocol and run a second external test.
...
- *Licensed conclusion.* That repair is measurable by re-running.
- *Not licensed.* Whether the protocol is now complete.
...
- *Expected response.* That repair is measurable by re-running.
...
1. Any wording carrying the idea in `Repair converts each recorded question into an explicit line`.
...
Say: "If the second run matches the first, the repair missed."
...
| **Leads to** | Session 16 — The Measurement Critique |

**Transition in.** Session 14 established students consolidate the first half. This session uses that as the starting point.

**Transition out.** This session establishes students revise against external-run feedback. Session 16 assumes it and builds students critique a measurement claim in writing.
