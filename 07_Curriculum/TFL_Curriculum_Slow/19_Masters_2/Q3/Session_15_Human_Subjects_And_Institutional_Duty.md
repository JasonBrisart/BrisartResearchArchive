# Session 15 — Human Subjects And Institutional Duty
...
| | |
|---|---|
| **Central question** | Human Subjects And Institutional Duty: students state the obligations attached to running studies on people? |
| **Core concept** | Institutional approval is a precondition for any study involving people. |
| **Student outcome** | Students state the obligations attached to running studies on people. |
| **Previous session** | Session 14 — Reviewing Your Own Design |
| **Next session** | Session 16 — Adjudication At Review Standard |
| **Materials** | Specimen manuscripts supplied by the instructor; review protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_15_Printout.md` |
| **Homework** | `Homework/Session_15_Homework.md` |

## Why this lesson exists

**The conceptual step.** Institutional approval is a precondition for any study involving people. Unapproved work is neither publishable nor defensible.
...
**What depends on it.** Session 16 — Adjudication At Review Standard — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Institutional approval is a precondition for any study involving people. Unapproved work is neither publishable nor defensible.
...
1. A design labelled hypothetical with the approval route named.
2. A completed checklist identifying the relevant committee.

### One non-example

A design described as ready to run pending minor formalities.
...
That institutional duty is a precondition.
...
| Statement | Status |
|---|---|
| Institutional approval is a precondition for any study involving people. | Framework-derived, appropriate at this grade |
| That institutional duty is a precondition. | What this specific activity can show |
| Whether approval would be granted. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 14 — Reviewing Your Own Design — specifically: students apply the full protocol to their own work.

**How it was taught.** Through the activity: a full self-review with at least three fatal-or-serious findings

**Quick check.** Ask for the closing sentence of Session 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 14: a full self-review with at least three fatal-or-serious findings, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A design labelled hypothetical with the approval route named. |
| **Non-example** | A design described as ready to run pending minor formalities. |
...
**Student materials.** One copy of `Printouts/Session_15_Printout.md` per student.

**Prior student data required.** Work produced in Session 14, kept in the student's folder.
...
**File.** `Printouts/Session_15_Printout.md`
...
> "Finding them yourself is cheaper than a reviewer finding them."
...
**Exact wording.** "Say: institutional requirements sit above anything specified in this course."
...
**Target observation.** That institutional duty is a precondition.
...
> "Institutional approval is a precondition for any study involving people. You just saw that when say: institutional requirements sit above anything specified in this course.
> Last time we said: Finding them yourself is cheaper than a reviewer finding them. This is the next part of that.
...
**What students must not infer.** Whether approval would be granted.

### 4. Worked example

**The example.** A design labelled hypothetical with the approval route named.
...
**Completed answer.** A design labelled hypothetical with the approval route named. — which demonstrates that institutional duty is a precondition.
...
**Conclusions not licensed.** Whether approval would be granted.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A completed checklist identifying the relevant committee. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A design described as ready to run pending minor formalities. Why is this not an
example?"
...
**Exact student instructions.** Complete the compliance checklist and state the approval route if pursued.
...
- *Licensed conclusion.* That institutional duty is a precondition.
- *Not licensed.* Whether approval would be granted.
...
- *Expected response.* That institutional duty is a precondition.
...
1. Any wording carrying the idea in `Institutional approval is a precondition for any study involving people`.
...
Say: "This is not paperwork. It is the difference between a design and a study."

**Why this sentence matters.** It is the opening question of Session 16, which assumes students arrive holding it.
...
**File.** `Homework/Session_15_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 14 — Reviewing Your Own Design |
| **Leads to** | Session 16 — Adjudication At Review Standard |

**Transition in.** Session 14 established students apply the full protocol to their own work. This session uses that as the starting point.

**Transition out.** This session establishes students state the obligations attached to running studies on people. Session 16 assumes it and builds students judge whether a design would move a question.
