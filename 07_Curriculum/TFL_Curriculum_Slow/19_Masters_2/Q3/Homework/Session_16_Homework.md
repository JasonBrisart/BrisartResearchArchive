# Session 16 Homework — Adjudication At Review Standard

**Master's Year 2** · Design Review and Defence · **Quarter 3**
**Follows:** Session 16 — Adjudication At Review Standard · **Points:** 5 · **Optional:** yes
...
Assign verdicts to six designs, each justified by the failing element.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every verdict names the failing element
...
Session 17 is **Rebuilding After Review**, which assumes you arrive holding it. Write one thing you expect it to be about:
