# Session 18 Homework — The Final Design

**Master's Year 2** · Design Review and Defence · **Quarter 3**
**Follows:** Session 18 — The Final Design · **Points:** 5 · **Optional:** yes
...
Assemble the final design with all eight components.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every design contains all eight components
...
Session 19 is **Gate Checking**, which assumes you arrive holding it. Write one thing you expect it to be about:
