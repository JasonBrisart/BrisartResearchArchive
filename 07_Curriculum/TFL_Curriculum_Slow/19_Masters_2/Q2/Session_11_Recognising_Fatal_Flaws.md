# Session 11 — Recognising Fatal Flaws
...
| | |
|---|---|
| **Central question** | Recognising Fatal Flaws: students distinguish a fatal flaw from a weakness? |
| **Core concept** | A fatal flaw makes every possible result from the design uninterpretable. |
| **Student outcome** | Students distinguish a fatal flaw from a weakness. |
| **Previous session** | Session 10 — The Revised Design |
| **Next session** | Session 12 — The Midterm Review |
...
**The conceptual step.** A fatal flaw makes every possible result from the design uninterpretable. A weakness reduces the strength of the conclusion without destroying it.
...
**What depends on it.** Session 12 — The Midterm Review — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A fatal flaw makes every possible result from the design uninterpretable. A weakness reduces the strength of the conclusion without destroying it.
...
1. A circular measurement classified as fatal.
2. A modest sample classified as weakening rather than fatal.

### One non-example

Every identified defect classified as fatal.
...
That the fatal-weakening distinction is testable.

### What this activity does not establish

Whether the designs should proceed.
...
| Statement | Status |
|---|---|
| A fatal flaw makes every possible result from the design uninterpretable. | Framework-derived, appropriate at this grade |
| That the fatal-weakening distinction is testable. | What this specific activity can show |
| Whether the designs should proceed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 10 — The Revised Design — specifically: students demonstrate improvement against measured criteria.

**How it was taught.** Through the activity: second executability run with both question counts reported

**Quick check.** Ask for the closing sentence of Session 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 10: second executability run with both question counts reported, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A circular measurement classified as fatal. |
| **Non-example** | Every identified defect classified as fatal. |
...
> "Improvement you cannot count is improvement you cannot claim."
...
**Exact wording.** "Say: a fatal flaw makes the result uninterpretable. Not merely weaker."
...
**Target observation.** That the fatal-weakening distinction is testable.
...
> "A fatal flaw makes every possible result from the design uninterpretable. You just saw that when say: a fatal flaw makes the result uninterpretable.
> Last time we said: Improvement you cannot count is improvement you cannot claim. This is the next part of that.
...
**What students must not infer.** Whether the designs should proceed.

### 4. Worked example

**The example.** A circular measurement classified as fatal.
...
**Completed answer.** A circular measurement classified as fatal. — which demonstrates that the fatal-weakening distinction is testable.
...
**Conclusions not licensed.** Whether the designs should proceed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A modest sample classified as weakening rather than fatal. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Every identified defect classified as fatal. Why is this not an
example?"
...
**Exact student instructions.** Classify twelve defects as fatal or weakening with reasons.
...
- *Licensed conclusion.* That the fatal-weakening distinction is testable.
- *Not licensed.* Whether the designs should proceed.
...
- *Expected response.* That the fatal-weakening distinction is testable.
...
1. Any wording carrying the idea in `A fatal flaw makes every possible result from the design uninterpretable`.
...
Say: "Fatal means no result from this design can be interpreted."
...
| | |
|---|---|
| **Follows** | Session 10 — The Revised Design |
| **Leads to** | Session 12 — The Midterm Review |

**Transition in.** Session 10 established students demonstrate improvement against measured criteria. This session uses that as the starting point.

**Transition out.** This session establishes students distinguish a fatal flaw from a weakness. Session 12 assumes it and builds students consolidate the first half.
