...
| | |
|---|---|
| **Central question** | Calibration: students compare their review against others of the same work? |
| **Core concept** | Divergence between reviews is either about a matter of fact or about a standard. |
| **Student outcome** | Students compare their review against others of the same work. |
| **Previous session** | Session 6 — Scope And Recommendation |
| **Next session** | Session 8 — Reviewing The Inference, Not The Framework |
| **Materials** | Specimen manuscripts supplied by the instructor; review protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_07_Printout.md` |
| **Homework** | `Homework/Session_07_Homework.md` |

## Why this lesson exists

**The conceptual step.** Divergence between reviews is either about a matter of fact or about a standard. Divergence traceable to the framework's status rather than the design is a reviewer error.
...
**What depends on it.** Session 8 — Reviewing The Inference, Not The Framework — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Divergence between reviews is either about a matter of fact or about a standard. Divergence traceable to the framework's status rather than the design is a reviewer error.
...
1. A divergence classified as a difference in standard.
2. A divergence traced to a factual disagreement about the design.

### One non-example

A divergence attributed to differing tastes.
...
That divergence has classifiable sources.
...
| Statement | Status |
|---|---|
| Divergence between reviews is either about a matter of fact or about a standard. | Framework-derived, appropriate at this grade |
| That divergence has classifiable sources. | What this specific activity can show |
| Which review is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 6 — Scope And Recommendation — specifically: students complete a review with a defensible verdict.

**How it was taught.** Through the activity: two full six-section reviews with verdicts and ranked revisions

**Quick check.** Ask for the closing sentence of Session 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 6: two full six-section reviews with verdicts and ranked revisions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A divergence classified as a difference in standard. |
| **Non-example** | A divergence attributed to differing tastes. |
...
**Student materials.** One copy of `Printouts/Session_07_Printout.md` per student.

**Prior student data required.** Work produced in Session 6, kept in the student's folder.
...
**File.** `Printouts/Session_07_Printout.md`
...
> "Unranked revisions tell the author nothing about what to fix first."
...
**Exact wording.** "Put up two anonymous reviews of one design: one found a fatal flaw, one was polite."
...
**Target observation.** That divergence has classifiable sources.
...
> "Divergence between reviews is either about a matter of fact or about a standard. You just saw that when put up two anonymous reviews of one design: one found a fatal flaw, one was polite.
> Last time we said: Unranked revisions tell the author nothing about what to fix first. This is the next part of that.
...
**What students must not infer.** Which review is correct.

### 4. Worked example

**The example.** A divergence classified as a difference in standard.
...
**Completed answer.** A divergence classified as a difference in standard. — which demonstrates that divergence has classifiable sources.
...
**Conclusions not licensed.** Which review is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A divergence traced to a factual disagreement about the design. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A divergence attributed to differing tastes. Why is this not an
example?"
...
**Exact student instructions.** Compare their review against the instructor's and two peers', accounting for divergence.
...
- *Licensed conclusion.* That divergence has classifiable sources.
- *Not licensed.* Which review is correct.
...
- *Expected response.* That divergence has classifiable sources.
...
1. Any wording carrying the idea in `Divergence between reviews is either about a matter of fact or about a standard`.
...
Say: "Divergence traceable to reviewing the framework is a reviewer error."

**Why this sentence matters.** It is the opening question of Session 8, which assumes students arrive holding it.
...
**File.** `Homework/Session_07_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 6 — Scope And Recommendation |
| **Leads to** | Session 8 — Reviewing The Inference, Not The Framework |

**Transition in.** Session 6 established students complete a review with a defensible verdict. This session uses that as the starting point.

**Transition out.** This session establishes students compare their review against others of the same work. Session 8 assumes it and builds students avoid the two standard reviewer failures.
