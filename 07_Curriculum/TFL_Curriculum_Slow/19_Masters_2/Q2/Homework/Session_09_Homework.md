# Session 9 Homework — Receiving Review

**Master's Year 2** · Design Review and Defence · **Quarter 2**
**Follows:** Session 9 — Receiving Review · **Points:** 5 · **Optional:** yes
...
Write a full response letter addressing every point.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every point receives a revision or a reasoned refusal
...
Session 10 is **The Revised Design**, which assumes you arrive holding it. Write one thing you expect it to be about:
