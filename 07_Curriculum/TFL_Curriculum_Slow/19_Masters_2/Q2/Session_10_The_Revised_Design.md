...
| | |
|---|---|
| **Central question** | The Revised Design: students demonstrate improvement against measured criteria? |
| **Core concept** | Improvement in executability is measured by comparing question counts across two runs. |
| **Student outcome** | Students demonstrate improvement against measured criteria. |
| **Previous session** | Session 9 — Receiving Review |
| **Next session** | Session 11 — Recognising Fatal Flaws |
| **Materials** | Specimen manuscripts supplied by the instructor; review protocol templates |
| **Preparation** | forty minutes |
| **Student printout** | `Printouts/Session_10_Printout.md` |
| **Homework** | `Homework/Session_10_Homework.md` |

## Why this lesson exists

**The conceptual step.** Improvement in executability is measured by comparing question counts across two runs. Improvement that cannot be counted cannot be claimed.
...
**What depends on it.** Session 11 — Recognising Fatal Flaws — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Improvement in executability is measured by comparing question counts across two runs. Improvement that cannot be counted cannot be claimed.
...
1. Both counts reported with the second lower than the first.
2. A revision producing a drop from nine questions to three.

### One non-example

A claim of substantial improvement with no counts reported.
...
That design improvement is measurable.

### What this activity does not establish

Whether the design is now adequate.
...
| Statement | Status |
|---|---|
| Improvement in executability is measured by comparing question counts across two runs. | Framework-derived, appropriate at this grade |
| That design improvement is measurable. | What this specific activity can show |
| Whether the design is now adequate. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 9 — Receiving Review — specifically: students revise against reviews they disagree with.

**How it was taught.** Through the activity: write a full response letter addressing every point

**Quick check.** Ask for the closing sentence of Session 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 9: write a full response letter addressing every point, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | Both counts reported with the second lower than the first. |
| **Non-example** | A claim of substantial improvement with no counts reported. |
...
**Student materials.** One copy of `Printouts/Session_10_Printout.md` per student.

**Prior student data required.** Work produced in Session 9, kept in the student's folder.
...
**File.** `Printouts/Session_10_Printout.md`
...
> "A reasoned refusal is legitimate. Silence is not."
...
**Exact wording.** "Say: your revised design goes back out. Fewer questions is the measure."
...
**Target observation.** That design improvement is measurable.
...
> "Improvement in executability is measured by comparing question counts across two runs. You just saw that when say: your revised design goes back out.
> Last time we said: A reasoned refusal is legitimate. Silence is not. This is the next part of that.
...
**What students must not infer.** Whether the design is now adequate.

### 4. Worked example

**The example.** Both counts reported with the second lower than the first.
...
**Completed answer.** Both counts reported with the second lower than the first. — which demonstrates that design improvement is measurable.
...
**Conclusions not licensed.** Whether the design is now adequate.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A revision producing a drop from nine questions to three. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim of substantial improvement with no counts reported. Why is this not an
example?"
...
**Exact student instructions.** Second executability run with both question counts reported.
...
- *Licensed conclusion.* That design improvement is measurable.
- *Not licensed.* Whether the design is now adequate.
...
- *Expected response.* That design improvement is measurable.
...
1. Any wording carrying the idea in `Improvement in executability is measured by comparing question counts across two runs`.
...
Say: "Improvement you cannot count is improvement you cannot claim."

**Why this sentence matters.** It is the opening question of Session 11, which assumes students arrive holding it.
...
**File.** `Homework/Session_10_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 9 — Receiving Review |
| **Leads to** | Session 11 — Recognising Fatal Flaws |

**Transition in.** Session 9 established students revise against reviews they disagree with. This session uses that as the starting point.

**Transition out.** This session establishes students demonstrate improvement against measured criteria. Session 11 assumes it and builds students distinguish a fatal flaw from a weakness.
