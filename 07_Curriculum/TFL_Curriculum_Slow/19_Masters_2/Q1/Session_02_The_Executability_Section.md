# Session 2 — The Executability Section

**Master's Year 2** · Design Review and Defence · **Quarter 1** · **100 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Executability Section: students audit whether a design can be run at all? |
| **Core concept** | Executability is checked before any other section because a design that cannot be run makes every later judgement moot. |
| **Student outcome** | Students audit whether a design can be run at all. |
| **Previous session** | Session 1 — What Review Is For |
| **Next session** | Session 3 — The Measurement Section |
...
**The conceptual step.** Executability is checked before any other section because a design that cannot be run makes every later judgement moot. An empty list must be stated rather than implied.
...
**What depends on it.** Session 3 — The Measurement Section — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Executability is checked before any other section because a design that cannot be run makes every later judgement moot. An empty list must be stated rather than implied.
...
1. A clarification list with six located items.
2. An explicitly stated empty list with the check recorded.

### One non-example

A review noting that the design seemed clear.
...
That executability is checked first and evidenced.

### What this activity does not establish

Whether the design would produce results.
...
| Statement | Status |
|---|---|
| Executability is checked before any other section because a design that cannot be run makes every later judgement moot. | Framework-derived, appropriate at this grade |
| That executability is checked first and evidenced. | What this specific activity can show |
| Whether the design would produce results. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 1 — What Review Is For — specifically: students state the purpose and structure of design review.

**How it was taught.** Through the activity: read the six-section protocol and review one specimen design in outline

**Quick check.** Ask for the closing sentence of Session 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 1: read the six-section protocol and review one specimen design in outline, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A clarification list with six located items. |
| **Non-example** | A review noting that the design seemed clear. |
...
> "Politeness that withholds a fatal flaw is not kindness."
...
**Exact wording.** "Say: this is checked before anything else. If it fails, nothing after matters."
...
**Target observation.** That executability is checked first and evidenced.
...
> "Executability is checked before any other section because a design that cannot be run makes every later judgement moot. You just saw that when say: this is checked before anything else.
> Last time we said: Politeness that withholds a fatal flaw is not kindness. This is the next part of that.
...
**What students must not infer.** Whether the design would produce results.

### 4. Worked example

**The example.** A clarification list with six located items.
...
**Completed answer.** A clarification list with six located items. — which demonstrates that executability is checked first and evidenced.
...
**Conclusions not licensed.** Whether the design would produce results.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An explicitly stated empty list with the check recorded. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A review noting that the design seemed clear. Why is this not an
example?"
...
**Exact student instructions.** Executability audits on two designs with complete clarification lists.
...
- *Licensed conclusion.* That executability is checked first and evidenced.
- *Not licensed.* Whether the design would produce results.
...
- *Expected response.* That executability is checked first and evidenced.
...
1. Any wording carrying the idea in `Executability is checked before any other section because a design that cannot be run makes every later judgement moot`.
...
Say: "An empty list must be stated explicitly."
...
| | |
|---|---|
| **Follows** | Session 1 — What Review Is For |
| **Leads to** | Session 3 — The Measurement Section |

**Transition in.** Session 1 established students state the purpose and structure of design review. This session uses that as the starting point.

**Transition out.** This session establishes students audit whether a design can be run at all. Session 3 assumes it and builds students audit construct validity and prespecification.
