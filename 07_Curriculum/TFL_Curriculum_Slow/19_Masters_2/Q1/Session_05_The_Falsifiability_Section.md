# Session 5 — The Falsifiability Section
...
| | |
|---|---|
| **Central question** | The Falsifiability Section: students audit whether the condition could fire? |
| **Core concept** | A falsifiability audit traces the firing pathway independently. |
| **Student outcome** | Students audit whether the condition could fire. |
| **Previous session** | Session 4 — The Adjudication Section |
| **Next session** | Session 6 — Scope And Recommendation |
...
**The conceptual step.** A falsifiability audit traces the firing pathway independently. The author's assertion that the condition could fire is not evidence that it could.
...
**What depends on it.** Session 6 — Scope And Recommendation — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A falsifiability audit traces the firing pathway independently. The author's assertion that the condition could fire is not evidence that it could.
...
1. A traced pathway confirming the condition could fire.
2. A traced pathway showing the condition cannot fire under the plan.

### One non-example

An audit accepting the author's statement that the condition works.
...
That firing claims require independent tracing.

### What this activity does not establish

Whether the condition is well chosen.
...
| Statement | Status |
|---|---|
| A falsifiability audit traces the firing pathway independently. | Framework-derived, appropriate at this grade |
| That firing claims require independent tracing. | What this specific activity can show |
| Whether the condition is well chosen. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 4 — The Adjudication Section — specifically: students audit whether rivals are fairly stated and separated.

**How it was taught.** Through the activity: audit two designs and name which rival best explains the anticipated result

**Quick check.** Ask for the closing sentence of Session 4. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 4: audit two designs and name which rival best explains the anticipated result, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A traced pathway confirming the condition could fire. |
| **Non-example** | An audit accepting the author's statement that the condition works. |
...
> "If you cannot name it, you have not audited adjudication."
...
**Exact wording.** "Put up a condition that cannot fire under its own analysis plan and ask what is wrong."
...
**Target observation.** That firing claims require independent tracing.
...
> "A falsifiability audit traces the firing pathway independently. You just saw that when put up a condition that cannot fire under its own analysis plan and ask what is wrong.
> Last time we said: If you cannot name it, you have not audited adjudication. This is the next part of that.
...
**What students must not infer.** Whether the condition is well chosen.

### 4. Worked example

**The example.** A traced pathway confirming the condition could fire.
...
**Completed answer.** A traced pathway confirming the condition could fire. — which demonstrates that firing claims require independent tracing.
...
**Conclusions not licensed.** Whether the condition is well chosen.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A traced pathway showing the condition cannot fire under the plan. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An audit accepting the author's statement that the condition works. Why is this not an
example?"
...
**Exact student instructions.** Audit two designs, tracing each firing pathway personally.
...
- *Licensed conclusion.* That firing claims require independent tracing.
- *Not licensed.* Whether the condition is well chosen.
...
- *Expected response.* That firing claims require independent tracing.
...
1. Any wording carrying the idea in `A falsifiability audit traces the firing pathway independently`.
...
Say: "The author asserting it fires is not evidence."
...
| | |
|---|---|
| **Follows** | Session 4 — The Adjudication Section |
| **Leads to** | Session 6 — Scope And Recommendation |

**Transition in.** Session 4 established students audit whether rivals are fairly stated and separated. This session uses that as the starting point.

**Transition out.** This session establishes students audit whether the condition could fire. Session 6 assumes it and builds students complete a review with a defensible verdict.
