# Session 24 — The Year In Reviews
...
| | |
|---|---|
| **Central question** | The Year In Reviews: students review the year through their own reviews? |
| **Core concept** | Comparing the first review with the last gives direct evidence of the year's progress in critical judgement. |
| **Student outcome** | Students review the year through their own reviews. |
| **Previous session** | Session 23 — The Calibration Analysis |
| **Next session** | The final examination. |
...
**The conceptual step.** Comparing the first review with the last gives direct evidence of the year's progress in critical judgement.
...
Comparing the first review with the last gives direct evidence of the year's progress in critical judgement.
...
1. A Session 2 review beside a Session 13 one.
2. A student noticing their early reviews produced verdicts, not findings.

### One non-example

Reviewing only the most recent reviews.
...
That review quality improved measurably.
...
| Statement | Status |
|---|---|
| Comparing the first review with the last gives direct evidence of the year's progress in critical judgement. | Framework-derived, appropriate at this grade |
| That review quality improved measurably. | What this specific activity can show |
| Any external quality standard. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 23 — The Calibration Analysis — specifically: students account for their reviewing divergence across the year.

**How it was taught.** Through the activity: a written calibration analysis classifying every divergence

**Quick check.** Ask for the closing sentence of Session 23. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 23: a written calibration analysis classifying every divergence, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A Session 2 review beside a Session 13 one. |
| **Non-example** | Reviewing only the most recent reviews. |
...
> "Editors can see the difference between a standard and a reputation."
...
**Exact wording.** "Lay out every review from the year, in order."
...
**Target observation.** That review quality improved measurably.
...
> "Comparing the first review with the last gives direct evidence of the year's progress in critical judgement. You just saw that when lay out every review from the year, in order.
> Last time we said: Editors can see the difference between a standard and a reputation. This is the next part of that.
...
**The example.** A Session 2 review beside a Session 13 one.
...
**Completed answer.** A Session 2 review beside a Session 13 one. — which demonstrates that review quality improved measurably.
...
**Teacher prompt.** "Here is a second case. A student noticing their early reviews produced verdicts, not findings. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Reviewing only the most recent reviews. Why is this not an
example?"
...
**Exact student instructions.** Compare the first review with the last and write what changed.
...
- *Licensed conclusion.* That review quality improved measurably.
...
- *Expected response.* That review quality improved measurably.
...
1. Any wording carrying the idea in `Comparing the first review with the last gives direct evidence of the year's progress in critical judgement`.
...
Say: "Next year: auditing a specification rather than a design."
...
| | |
|---|---|
| **Follows** | Session 23 — The Calibration Analysis |
| **Leads to** | The final examination. |

**Transition in.** Session 23 established students account for their reviewing divergence across the year. This session uses that as the starting point.
