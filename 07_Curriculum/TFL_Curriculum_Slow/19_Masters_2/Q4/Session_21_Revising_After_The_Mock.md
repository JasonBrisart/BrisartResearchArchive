# Session 21 — Revising After The Mock
...
| | |
|---|---|
| **Central question** | Revising After The Mock: students revise against mock-defence feedback? |
| **Core concept** | An unanswered question marks a gap rather than an unfair challenge. |
| **Student outcome** | Students revise against mock-defence feedback. |
| **Previous session** | Session 20 — The Mock Defence |
| **Next session** | Session 22 — The Design Defence |
...
**The conceptual step.** An unanswered question marks a gap rather than an unfair challenge. Each produces a revision.
...
**What depends on it.** Session 22 — The Design Defence — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An unanswered question marks a gap rather than an unfair challenge. Each produces a revision.
...
1. A revision addressing the arousal challenger's question.
2. A revision narrowing a claim after the scope challenge.

### One non-example

Questions dismissed as outside the design's remit.
...
That defences improve through revision.
...
| That defences improve through revision. | What this specific activity can show |
| Whether the revised design is sound. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 20 — The Mock Defence — specifically: students rehearse against four adversarial roles.

**How it was taught.** Through the activity: full rehearsal with every unanswered question recorded

**Quick check.** Ask for the closing sentence of Session 20. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 20: full rehearsal with every unanswered question recorded, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A revision addressing the arousal challenger's question. |
| **Non-example** | Questions dismissed as outside the design's remit. |
...
**Target observation.** That defences improve through revision.
...
**The example.** A revision addressing the arousal challenger's question.
...
**Completed answer.** A revision addressing the arousal challenger's question. — which demonstrates that defences improve through revision.
...
**Teacher prompt.** "Here is a second case. A revision narrowing a claim after the scope challenge. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Questions dismissed as outside the design's remit. Why is this not an
example?"
...
**Exact student instructions.** Revise and mark what changed for each.
...
- *Licensed conclusion.* That defences improve through revision.
...
- *Expected response.* That defences improve through revision.
...
| | |
|---|---|
| **Follows** | Session 20 — The Mock Defence |
| **Leads to** | Session 22 — The Design Defence |

**Transition in.** Session 20 established students rehearse against four adversarial roles. This session uses that as the starting point.

**Transition out.** This session establishes students revise against mock-defence feedback. Session 22 assumes it and builds students defend a design capable of adjudicating.
