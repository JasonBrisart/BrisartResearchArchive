# Lesson 25 Homework — When The Moment Was Wrong

**Grade 3** · Right Now · **Quarter 4**
**Follows:** Lesson 25 — When The Moment Was Wrong · **Points:** 5 · **Optional:** yes
...
Both moments reconstructed in full; identify which part changed.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student identifies the noticing as the changed part
...
Lesson 26 is **One Part Changes Everything**, which assumes you arrive holding it. Write one thing you expect it to be about:
