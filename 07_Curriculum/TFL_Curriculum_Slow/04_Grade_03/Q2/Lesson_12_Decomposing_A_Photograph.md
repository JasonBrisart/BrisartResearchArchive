# Lesson 12 — Decomposing A Photograph
...
| | |
|---|---|
| **Central question** | Decomposing A Photograph: students decompose a moment from a still image? |
| **Core concept** | A decomposition can be built from visual evidence alone, but every part must be supported by something visible rather than imagined. |
| **Student outcome** | Students decompose a moment from a still image. |
| **Previous lesson** | Lesson 11 — Decomposing A Story |
| **Next lesson** | Lesson 13 — The Wrong Part |
...
**The conceptual step.** A decomposition can be built from visual evidence alone, but every part must be supported by something visible rather than imagined.
...
**What depends on it.** Lesson 13 — The Wrong Part — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A decomposition can be built from visual evidence alone, but every part must be supported by something visible rather than imagined.
...
1. A decomposition where each part points at something in the image.
2. A decomposition that survives the forward check.

### One non-example

A decomposition citing a backstory the image does not show.
...
That decomposition works from visual evidence.

### What this activity does not establish

What the photographed person actually experienced.
...
| Statement | Status |
|---|---|
| A decomposition can be built from visual evidence alone, but every part must be supported by something visible rather than imagined. | Framework-derived, appropriate at this grade |
| That decomposition works from visual evidence. | What this specific activity can show |
| What the photographed person actually experienced. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 11 — Decomposing A Story — specifically: students decompose a character's moment from a text.

**How it was taught.** Through the activity: decompose three character moments from the passage

**Quick check.** Ask for the closing sentence of Lesson 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 11: decompose three character moments from the passage, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A decomposition where each part points at something in the image. |
| **Non-example** | A decomposition citing a backstory the image does not show. |
...
> "It works on people in books too."
...
**Exact wording.** "Show a photograph of somebody mid-reaction."
...
**Target observation.** That decomposition works from visual evidence.
...
> "A decomposition can be built from visual evidence alone, but every part must be supported by something visible rather than imagined. You just saw that when show a photograph of somebody mid-reaction.
> Last time we said: It works on people in books too. This is the next part of that.
...
**What students must not infer.** What the photographed person actually experienced.

### 4. Worked example

**The example.** A decomposition where each part points at something in the image.
...
**Completed answer.** A decomposition where each part points at something in the image. — which demonstrates that decomposition works from visual evidence.
...
**Conclusions not licensed.** What the photographed person actually experienced.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A decomposition that survives the forward check. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A decomposition citing a backstory the image does not show. Why is this not an
example?"
...
**Exact student instructions.** Three decompositions from three images, each checked forwards.
...
- *Licensed conclusion.* That decomposition works from visual evidence.
- *Not licensed.* What the photographed person actually experienced.
...
- *Expected response.* That decomposition works from visual evidence.
...
1. Any wording carrying the idea in `A decomposition can be built from visual evidence alone, but every part must be supported by something visible rather than imagined`.
...
Say: "You can do it with no words at all to go on."
...
| | |
|---|---|
| **Follows** | Lesson 11 — Decomposing A Story |
| **Leads to** | Lesson 13 — The Wrong Part |

**Transition in.** Lesson 11 established students decompose a character's moment from a text. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students decompose a moment from a still image. Lesson 13 assumes it and builds students find the single incorrect part in a decomposition.
