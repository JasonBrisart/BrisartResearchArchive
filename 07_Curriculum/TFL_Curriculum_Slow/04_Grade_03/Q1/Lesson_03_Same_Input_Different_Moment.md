# Lesson 3 — Same Input, Different Moment

**Grade 3** · Right Now · **Quarter 1** · **35 minutes**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Same Input, Different Moment: students explain why identical input yields different moments? |
| **Core concept** | When two people share the same input but have different moments, the difference is located one line above the expectation — in what was remembered. |
| **Student outcome** | Students explain why identical input yields different moments. |
| **Previous lesson** | Lesson 2 — Building Right Now |
| **Next lesson** | Lesson 4 — Right Now Somewhere Else |
| **Materials** | Notebooks; chart paper |
...
**The conceptual step.** When two people share the same input but have different moments, the difference is located one line above the expectation — in what was remembered.

**Why students need it now.** This grade owns one idea: that experience arrives already combined, and can be decomposed afterwards.
...
that right now is just what I am seeing. That belief is corrected here and nowhere else in the
quarter.

**Where it sits in the curve.** Short structured paragraphs. A claim, the evidence, and the cause, in complete sentences. Drawing supports but no longer substitutes.

**What depends on it.** Lesson 4 — Right Now Somewhere Else — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

When two people share the same input but have different moments, the difference is located one line above the expectation — in what was remembered.

### How this is stated at this grade

Short structured paragraphs. A claim, the evidence, and the cause, in complete sentences. Drawing supports but no longer substitutes.

Use only the vocabulary released at or before this grade. Terms not yet available:
Carry forward, integrated state, all notation.

### Why the concept matters

The whole grade rests on that experience arrives already combined, and can be decomposed afterwards. If a student leaves this
...
1. Two templates identical on noticing, different on remembering.
2. The expectation differs because the memory line differs.

### One non-example

Two templates differing on the noticing line, which is a different case.
...
That the difference in moments traces to the remembering line.

### What this activity does not establish

That memory is the only possible source of difference.
...
| Statement | Status |
|---|---|
| When two people share the same input but have different moments, the difference is located one line above the expectation — in what was remembered. | Framework-derived, appropriate at this grade |
| That the difference in moments traces to the remembering line. | What this specific activity can show |
| That memory is the only possible source of difference. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 2 — Building Right Now — specifically: students name the three inputs that fed one moment.

**How it was taught.** Through the activity: reconstruct one moment from today using the five-line template

**Quick check.** Ask for the closing sentence of Lesson 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 2: reconstruct one moment from today using the five-line template, in miniature, using one example only. Then ask for the sentence again.
...
| | |
|---|---|
| **Teacher definition** | everything combined into the moment you are actually having. |
| **Student wording** | Everything combined into the moment you are actually having. |
| **Correct example** | Two templates identical on noticing, different on remembering. |
| **Non-example** | Two templates differing on the noticing line, which is a different case. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for everything combined into the moment you are actually having." |

### combine

| | |
|---|---|
| **Teacher definition** | three things arriving together as one. |
| **Student wording** | Three things arriving together as one. |
| **Correct example** | Two templates identical on noticing, different on remembering. |
| **Non-example** | Two templates differing on the noticing line, which is a different case. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for three things arriving together as one." |

### decompose

| | |
|---|---|
| **Teacher definition** | taking a moment apart to see what built it. |
| **Student wording** | Taking a moment apart to see what built it. |
| **Correct example** | Two templates identical on noticing, different on remembering. |
| **Non-example** | Two templates differing on the noticing line, which is a different case. |
| **Common misuse** | Using it for something outside this grade's release list. |
| **Correction** | "That is close. At this grade we use it only for taking a moment apart to see what built it." |


Do not introduce terminology from later grades. Carry forward, integrated state, all notation.

## Materials and preparation

**Teacher materials.** Notebooks; Chart paper; A partly obscurable object and cloth; Printed five-line templates; A timer.
...
> "Right now is built from three things and arrives as one."
...
**Exact wording.** "Four different written answers to yesterday's covered object, on the board."
...
**Target observation.** That the difference in moments traces to the remembering line.
...
> "When two people share the same input but have different moments, the difference is located one line above the expectation — in what was remembered. You just saw that when four different written answers to yesterday's covered object, on the board.
> Last time we said: Right now is built from three things and arrives as one. This is the next part of that.
> It matters because noticing, remembering, and expecting combine into one moment"
...
**Terminology to introduce here.** right now, combine, decompose.

**What students must not infer.** That memory is the only possible source of difference.

### 4. Worked example

**The example.** Two templates identical on noticing, different on remembering.
...
**Completed answer.** Two templates identical on noticing, different on remembering. — which demonstrates that the difference in moments traces to the remembering line.
...
**Conclusions not licensed.** That memory is the only possible source of difference.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The expectation differs because the memory line differs. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Two templates differing on the noticing line, which is a different case. Why is this not an
example?"
...
**Exact student instructions.** Two students' templates side by side; the class identifies the differing line.
...
- *Licensed conclusion.* That the difference in moments traces to the remembering line.
- *Not licensed.* That memory is the only possible source of difference.
...
- *Expected response.* That the difference in moments traces to the remembering line.
...
3. **Misconception check.** Somebody says: "Right now is just what I am seeing" What would you tell them?

## Teacher-only exit-ticket key

> **Teacher only.** This does not appear on the student printout.

1. Any wording carrying the idea in `When two people share the same input but have different moments, the difference is located one line above the expectation — in what was remembered`.
2. Any case that fits and is not one of the teacher's examples. A reused teacher
   example scores partial credit only.
3. Any correction carrying the sense of: Right now is what you notice, plus what you remember, plus what you expect.

**Not scored:** whether any prediction the student describes turned out correct.

### 10. Carry forward

Say: "The event was shared. The moment was not."
...
### 1. "Right now is just what I am seeing"

**What the student says or does.** Right now is just what I am seeing — usually while otherwise engaging well.

**Why it is understandable.** Perception feels direct and unconstructed.
...
**Exact correction.** Show an ambiguous stimulus and collect differing reports.

**Say this.** "Right now is what you notice, plus what you remember, plus what you expect."
...
### 2. "The combination sentence is a list"

**What the student says or does.** The combination sentence is a list — usually while otherwise engaging well.

**Why it is understandable.** Students rewrite the three parts with commas and call it combined.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Refuse the list and ask what the moment added up to.

**Say this.** "That is three things with commas. Give me the one thing."

**Follow-up that confirms the correction worked.** Ask the student to give a
second example of their own, unprompted. If the second example repeats the
misconception, reteach rather than moving on.

### 3. "Everybody here has the same right now"

**What the student says or does.** Everybody here has the same right now — usually while otherwise engaging well.

**Why it is understandable.** The shared setting implies shared experience.

**How you detect it.** Listen for it during the work step and the discussion. It
surfaces most often when a student explains their reasoning aloud.

**Exact correction.** Put two reconstructions of the same event side by side.

**Say this.** "The event was shared. The moment was not."
...
**Visual or physical support.** Provide the five-line template with the final line pre-started.
...
Ask for a reconstruction from somebody else's point of view.
...
Specifically, do not introduce: Carry forward, integrated state, all notation.
...
| | |
|---|---|
| **Follows** | Lesson 2 — Building Right Now |
| **Leads to** | Lesson 4 — Right Now Somewhere Else |

**Transition in.** Lesson 2 established students name the three inputs that fed one moment. This lesson uses that as the starting point.

**Transition out.** This lesson establishes students explain why identical input yields different moments. Lesson 4 assumes it and builds students build a reconstruction outside the classroom.
