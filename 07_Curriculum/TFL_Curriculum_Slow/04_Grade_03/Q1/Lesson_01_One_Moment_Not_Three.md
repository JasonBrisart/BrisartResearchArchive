# Lesson 1 — One Moment, Not Three Things
...
| | |
|---|---|
| **Central question** | One Moment, Not Three Things: students recognise that experience arrives combined? |
| **Core concept** | Experience does not arrive in three separate pieces that the person assembles. |
| **Student outcome** | Students recognise that experience arrives combined. |
| **Previous lesson** | None. First lesson of the year. |
| **Next lesson** | Lesson 2 — Building Right Now |
...
**The conceptual step.** Experience does not arrive in three separate pieces that the person assembles. It arrives already combined, and the three parts are recovered afterwards by analysis.
...
**What depends on it.** Lesson 2 — Building Right Now — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Experience does not arrive in three separate pieces that the person assembles. It arrives already combined, and the three parts are recovered afterwards by analysis.
...
1. Something felt off when I walked in — one statement covering all three parts.
2. The room seemed wrong today — a combined judgement, not a list.

### One non-example

I noticed the chairs, I remembered assembly, I expected noise — three things joined by commas.
...
That experience is reported as one thing before it is analysed into parts.

### What this activity does not establish

The order in which the parts arrive, which is Grade 6.
...
| Statement | Status |
|---|---|
| Experience does not arrive in three separate pieces that the person assembles. | Framework-derived, appropriate at this grade |
| That experience is reported as one thing before it is analysed into parts. | What this specific activity can show |
| The order in which the parts arrive, which is Grade 6. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The student builds and repairs a four-column comparison table.
...
| **Correct example** | Something felt off when I walked in — one statement covering all three parts. |
| **Non-example** | I noticed the chairs, I remembered assembly, I expected noise — three things joined by commas. |
...
**Exact wording.** "Ask them to describe exactly what happened in the last ten seconds. Read three aloud."
...
**Target observation.** That experience is reported as one thing before it is analysed into parts.
...
> "Experience does not arrive in three separate pieces that the person assembles. You just saw that when ask them to describe exactly what happened in the last ten seconds.
...
**What students must not infer.** The order in which the parts arrive, which is Grade 6.

### 4. Worked example

**The example.** Something felt off when I walked in — one statement covering all three parts.
...
**Completed answer.** Something felt off when I walked in — one statement covering all three parts. — which demonstrates that experience is reported as one thing before it is analysed into parts.
...
**Conclusions not licensed.** The order in which the parts arrive, which is Grade 6.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. The room seemed wrong today — a combined judgement, not a list. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. I noticed the chairs, I remembered assembly, I expected noise — three things joined by commas. Why is this not an
example?"
...
**Exact student instructions.** Rewrite one Grade 2 comparison row as a single sentence describing the whole moment.
...
- *Licensed conclusion.* That experience is reported as one thing before it is analysed into parts.
- *Not licensed.* The order in which the parts arrive, which is Grade 6.
...
- *Expected response.* That experience is reported as one thing before it is analysed into parts.
...
1. Any wording carrying the idea in `Experience does not arrive in three separate pieces that the person assembles`.
...
Say: "You have one moment. We take it apart afterwards."
...
| **Leads to** | Lesson 2 — Building Right Now |

**Transition in.** This lesson opens the year.

**Transition out.** This lesson establishes students recognise that experience arrives combined. Lesson 2 assumes it and builds students name the three inputs that fed one moment.
