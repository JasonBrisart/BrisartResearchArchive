# Lesson 6 Homework — Two People, One Event

**Grade 3** · Right Now · **Quarter 1**
**Follows:** Lesson 6 — Two People, One Event · **Points:** 5 · **Optional:** yes
...
Both reconstruct; compare side by side and name the differing line.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student names at least one differing line
...
Lesson 7 is **The Invisible Right Now**, which assumes you arrive holding it. Write one thing you expect it to be about:
