# Lesson 2 Homework — Building Right Now

**Grade 3** · Right Now · **Quarter 1**
**Follows:** Lesson 2 — Building Right Now · **Points:** 5 · **Optional:** yes
...
Reconstruct one moment from today using the five-line template.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every final line is a single combined statement
...
Lesson 3 is **Same Input, Different Moment**, which assumes you arrive holding it. Write one thing you expect it to be about:
