# Lesson 4 Homework — Right Now Somewhere Else

**Grade 3** · Right Now · **Quarter 1**
**Follows:** Lesson 4 — Right Now Somewhere Else · **Points:** 5 · **Optional:** yes
...
A five-line reconstruction built in the new space, on the spot.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student completes five lines in the new setting
...
Lesson 5 is **Right Now, Just Now**, which assumes you arrive holding it. Write one thing you expect it to be about:
