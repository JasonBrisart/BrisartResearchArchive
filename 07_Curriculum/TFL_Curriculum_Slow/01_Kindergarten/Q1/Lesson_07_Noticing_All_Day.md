...
| | |
|---|---|
| **Central question** | Noticing All Day: children recognise noticing as continuous? |
| **Core concept** | Noticing is continuous rather than occasional. |
| **Student outcome** | Children recognise noticing as continuous. |
| **Previous lesson** | Lesson 6 — Noticing Small Things |
| **Next lesson** | Lesson 8 — The Noticing Review |
...
**The conceptual step.** Noticing is continuous rather than occasional. Counting during an ordinary activity is what makes the rate visible.
...
**What depends on it.** Lesson 8 — The Noticing Review — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Noticing is continuous rather than occasional. Counting during an ordinary activity is what makes the rate visible.
...
1. A two-minute tally reaches twenty items.
2. Children keep finding more after they think they are done.

### One non-example

A tally taken during a noticing exercise, which inflates it artificially.
...
That noticing runs continuously.

### What this activity does not establish

Any actual rate, which is not measurable here.
...
| Statement | Status |
|---|---|
| Noticing is continuous rather than occasional. | Framework-derived, appropriate at this grade |
| That noticing runs continuously. | What this specific activity can show |
| Any actual rate, which is not measurable here. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 6 — Noticing Small Things — specifically: children notice something they usually overlook.

**How it was taught.** Through the activity: the overlooked hunt. Each child finds and draws one never-noticed thing

**Quick check.** Ask for the closing sentence of Lesson 6. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 6: the overlooked hunt. Each child finds and draws one never-noticed thing, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A two-minute tally reaches twenty items. |
| **Non-example** | A tally taken during a noticing exercise, which inflates it artificially. |
...
> "It was always there. You just were not noticing it."
...
**Exact wording.** "Ask how many times they have noticed something today."
...
**Target observation.** That noticing runs continuously.
...
> "Noticing is continuous rather than occasional. You just saw that when ask how many times they have noticed something today.
> Last time we said: It was always there. You just were not noticing it. This is the next part of that.
...
**What students must not infer.** Any actual rate, which is not measurable here.

### 4. Worked example

**The example.** A two-minute tally reaches twenty items.
...
**Completed answer.** A two-minute tally reaches twenty items. — which demonstrates that noticing runs continuously.
...
**Conclusions not licensed.** Any actual rate, which is not measurable here.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Children keep finding more after they think they are done. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A tally taken during a noticing exercise, which inflates it artificially. Why is this not an
example?"
...
**Exact student instructions.** Tally noticing moments across one short activity, counted by the group.
...
- *Licensed conclusion.* That noticing runs continuously.
- *Not licensed.* Any actual rate, which is not measurable here.
...
- *Expected response.* That noticing runs continuously.
...
1. Any wording carrying the idea in `Noticing is continuous rather than occasional`.
...
Say: "You are noticing constantly, not sometimes."
...
| | |
|---|---|
| **Follows** | Lesson 6 — Noticing Small Things |
| **Leads to** | Lesson 8 — The Noticing Review |

**Transition in.** Lesson 6 established children notice something they usually overlook. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children recognise noticing as continuous. Lesson 8 assumes it and builds children consolidate the quarter's noticing work.
