# Lesson 25 — The Sound That Stops
...
| | |
|---|---|
| **Central question** | The Sound That Stops: children report the guess an engineered break revealed? |
| **Core concept** | An engineered break recovers a guess that was never spoken. |
| **Student outcome** | Children report the guess an engineered break revealed. |
| **Previous lesson** | Lesson 24 — The Before Review |
| **Next lesson** | Lesson 26 — What Stuck |
...
**The conceptual step.** An engineered break recovers a guess that was never spoken. The reaction is the evidence and the frame extracts the content.
...
**What depends on it.** Lesson 26 — What Stuck — opens by assuming this lesson's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

An engineered break recovers a guess that was never spoken. The reaction is the evidence and the frame extracts the content.
...
1. A child names the missing next line.
2. A child hums what should have followed.

### One non-example

A child who only reports that it was loud.
...
That breaks make unspoken guesses reportable.

### What this activity does not establish

Precision of the recovered content.
...
| Statement | Status |
|---|---|
| An engineered break recovers a guess that was never spoken. | Framework-derived, appropriate at this grade |
| That breaks make unspoken guesses reportable. | What this specific activity can show |
| Precision of the recovered content. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Lesson 24 — The Before Review — specifically: children consolidate the before rule.

**How it was taught.** Through the activity: whole-group review with three deliberate after-the-fact claims to catch

**Quick check.** Ask for the closing sentence of Lesson 24. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Lesson 24: whole-group review with three deliberate after-the-fact claims to catch, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A child names the missing next line. |
| **Non-example** | A child who only reports that it was loud. |
...
> "Next time we break one on purpose."
...
**Exact wording.** "Play a familiar song, settle the room, then stop it mid-phrase."
...
**Target observation.** That breaks make unspoken guesses reportable.
...
> "An engineered break recovers a guess that was never spoken. You just saw that when play a familiar song, settle the room, then stop it mid-phrase.
> Last time we said: Next time we break one on purpose. This is the next part of that.
...
**What students must not infer.** Precision of the recovered content.

### 4. Worked example

**The example.** A child names the missing next line.
...
**Completed answer.** A child names the missing next line. — which demonstrates that breaks make unspoken guesses reportable.
...
**Conclusions not licensed.** Precision of the recovered content.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A child hums what should have followed. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A child who only reports that it was loud. Why is this not an
example?"
...
**Exact student instructions.** Three more breaks. Each child completes the surprise frame aloud.
...
- *Licensed conclusion.* That breaks make unspoken guesses reportable.
- *Not licensed.* Precision of the recovered content.
...
- *Expected response.* That breaks make unspoken guesses reportable.
...
1. Any wording carrying the idea in `An engineered break recovers a guess that was never spoken`.
...
Say: "Breaking it is how we catch it."
...
| | |
|---|---|
| **Follows** | Lesson 24 — The Before Review |
| **Leads to** | Lesson 26 — What Stuck |

**Transition in.** Lesson 24 established children consolidate the before rule. This lesson uses that as the starting point.

**Transition out.** This lesson establishes children report the guess an engineered break revealed. Lesson 26 assumes it and builds children separate what stayed from what faded.
