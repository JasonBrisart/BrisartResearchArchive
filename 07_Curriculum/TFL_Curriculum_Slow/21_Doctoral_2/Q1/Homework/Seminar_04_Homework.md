# Seminar 4 Homework — The Gating Claim Under Attack

**Doctoral Year 2** · Original Critique · **Quarter 1**
**Follows:** Seminar 4 — The Gating Claim Under Attack · **Points:** 5 · **Optional:** yes
...
Write the deciding design sketch with the distinguishing line.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every participant attempts the distinguishing line
...
Seminar 5 is **Measurement At Publication Standard**, which assumes you arrive holding it. Write one thing you expect it to be about:
