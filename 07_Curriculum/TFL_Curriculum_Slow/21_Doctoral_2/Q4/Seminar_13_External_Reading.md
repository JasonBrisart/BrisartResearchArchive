...
| | |
|---|---|
| **Central question** | External Reading: participants have the paper read by somebody outside the seminar? |
| **Core concept** | A seminar develops shared assumptions that become invisible. |
| **Student outcome** | Participants have the paper read by somebody outside the seminar. |
| **Previous seminar** | Seminar 12 — The Paper Assembled |
...
**The conceptual step.** A seminar develops shared assumptions that become invisible. An external reader detects what the room has stopped noticing.
...
A seminar develops shared assumptions that become invisible. An external reader detects what the room has stopped noticing.
...
1. A paper read by somebody in a different department.
2. Questions recorded from a reader unfamiliar with the seminar.

### One non-example

A paper read by a seminar colleague.
...
That shared assumptions become invisible internally.
...
| Statement | Status |
|---|---|
| A seminar develops shared assumptions that become invisible. | Framework-derived, appropriate at this grade |
| That shared assumptions become invisible internally. | What this specific activity can show |
| Whether the paper is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 12 — The Paper Assembled — specifically: participants assemble the full critique paper.

**How it was taught.** Through the activity: assemble all seven sections and self-audit against the originality test

**Quick check.** Ask for the closing sentence of Seminar 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 12: assemble all seven sections and self-audit against the originality test, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A paper read by somebody in a different department. |
| **Non-example** | A paper read by a seminar colleague. |
...
**Exact wording.** "Say: somebody who has not been in this room for fourteen weeks."
...
**Target observation.** That shared assumptions become invisible internally.
...
> "A seminar develops shared assumptions that become invisible. You just saw that when say: somebody who has not been in this room for fourteen weeks.
> Last time we said: That is a submittable paper. This is the next part of that.
...
**What students must not infer.** Whether the paper is correct.

### 4. Worked example

**The example.** A paper read by somebody in a different department.
...
**Completed answer.** A paper read by somebody in a different department. — which demonstrates that shared assumptions become invisible internally.
...
**Conclusions not licensed.** Whether the paper is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. Questions recorded from a reader unfamiliar with the seminar. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A paper read by a seminar colleague. Why is this not an
example?"
...
**Exact student instructions.** External read with every question recorded and addressed.
...
- *Licensed conclusion.* That shared assumptions become invisible internally.
- *Not licensed.* Whether the paper is correct.
...
- *Expected response.* That shared assumptions become invisible internally.
...
1. Any wording carrying the idea in `A seminar develops shared assumptions that become invisible`.
...
Say: "The outside reader finds what the room has stopped seeing."
...
| | |
|---|---|
| **Follows** | Seminar 12 — The Paper Assembled |
| **Leads to** | Seminar 14 — Rehearsing The Defence |

**Transition in.** Seminar 12 established participants assemble the full critique paper. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants have the paper read by somebody outside the seminar. Seminar 14 assumes it and builds participants rehearse against four challengers.
