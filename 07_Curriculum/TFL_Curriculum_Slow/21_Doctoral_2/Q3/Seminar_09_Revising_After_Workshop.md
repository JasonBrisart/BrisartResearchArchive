# Seminar 9 — Revising After Workshop
...
| | |
|---|---|
| **Central question** | Revising After Workshop: participants revise against workshop findings? |
| **Core concept** | Three readers producing the same misreading is evidence about the paper rather than about the readers. |
| **Student outcome** | Participants revise against workshop findings. |
| **Previous seminar** | Seminar 8 — The Critique Workshop |
| **Next seminar** | Seminar 10 — The Closure Path |
...
**The conceptual step.** Three readers producing the same misreading is evidence about the paper rather than about the readers.
...
**What depends on it.** Seminar 10 — The Closure Path — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Three readers producing the same misreading is evidence about the paper rather than about the readers.
...
1. A revision closing a gap three readers identified.
2. A change logged against a specific reader comment.

### One non-example

A conclusion that the readers misunderstood the argument.
...
That reception gaps indicate paper defects.

### What this activity does not establish

Whether the revised paper succeeds.
...
| Statement | Status |
|---|---|
| Three readers producing the same misreading is evidence about the paper rather than about the readers. | Framework-derived, appropriate at this grade |
| That reception gaps indicate paper defects. | What this specific activity can show |
| Whether the revised paper succeeds. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 8 — The Critique Workshop — specifically: participants develop critiques through structured peer reading.

**How it was taught.** Through the activity: four papers workshopped, then a revision plan comparing intended and received claim

**Quick check.** Ask for the closing sentence of Seminar 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 8: four papers workshopped, then a revision plan comparing intended and received claim, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A revision closing a gap three readers identified. |
| **Non-example** | A conclusion that the readers misunderstood the argument. |
...
> "Explaining during the reading destroys the diagnostic."
...
**Exact wording.** "Say: the gap between what you meant and what they heard. Close it."
...
**Target observation.** That reception gaps indicate paper defects.
...
> "Three readers producing the same misreading is evidence about the paper rather than about the readers. You just saw that when say: the gap between what you meant and what they heard.
> Last time we said: Explaining during the reading destroys the diagnostic. This is the next part of that.
...
**What students must not infer.** Whether the revised paper succeeds.

### 4. Worked example

**The example.** A revision closing a gap three readers identified.
...
**Completed answer.** A revision closing a gap three readers identified. — which demonstrates that reception gaps indicate paper defects.
...
**Conclusions not licensed.** Whether the revised paper succeeds.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A change logged against a specific reader comment. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A conclusion that the readers misunderstood the argument. Why is this not an
example?"
...
**Exact student instructions.** Revise the paper and log every change against a reader comment.
...
- *Licensed conclusion.* That reception gaps indicate paper defects.
- *Not licensed.* Whether the revised paper succeeds.
...
- *Expected response.* That reception gaps indicate paper defects.
...
1. Any wording carrying the idea in `Three readers producing the same misreading is evidence about the paper rather than about the readers`.
...
Say: "The gap is the finding, not the readers' failure."
...
| | |
|---|---|
| **Follows** | Seminar 8 — The Critique Workshop |
| **Leads to** | Seminar 10 — The Closure Path |

**Transition in.** Seminar 8 established participants develop critiques through structured peer reading. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants revise against workshop findings. Seminar 10 assumes it and builds participants specify what would resolve the issue raised.
