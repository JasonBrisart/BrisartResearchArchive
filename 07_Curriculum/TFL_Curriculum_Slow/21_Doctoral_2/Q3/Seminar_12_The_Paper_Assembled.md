# Seminar 12 — The Paper Assembled
...
| | |
|---|---|
| **Central question** | The Paper Assembled: participants assemble the full critique paper? |
| **Core concept** | A critique paper has seven sections. |
| **Student outcome** | Participants assemble the full critique paper. |
| **Previous seminar** | Seminar 11 — Proportionate Assessment |
| **Next seminar** | Seminar 13 — External Reading |
...
**The conceptual step.** A critique paper has seven sections. Omitting the anticipated defence means the strongest counterargument was never engaged.
...
**What depends on it.** Seminar 13 — External Reading — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A critique paper has seven sections. Omitting the anticipated defence means the strongest counterargument was never engaged.
...
1. A paper with all seven sections present.
2. A paper self-audited against the originality test.

### One non-example

A paper with the anticipated defence omitted.
...
That critique papers have stateable completeness.
...
| Statement | Status |
|---|---|
| A critique paper has seven sections. | Framework-derived, appropriate at this grade |
| That critique papers have stateable completeness. | What this specific activity can show |
| Whether the critique succeeds. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 11 — Proportionate Assessment — specifically: participants match the verdict to the critique's scope.

**How it was taught.** Through the activity: write the assessment, checked for proportion in both directions

**Quick check.** Ask for the closing sentence of Seminar 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 11: write the assessment, checked for proportion in both directions, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A paper with all seven sections present. |
| **Non-example** | A paper with the anticipated defence omitted. |
...
**Exact wording.** "Say: seven sections. Target, critique, evidence, defence, response, closure, assessment."
...
**Target observation.** That critique papers have stateable completeness.
...
> "A critique paper has seven sections. You just saw that when say: seven sections.
...
**The example.** A paper with all seven sections present.
...
**Completed answer.** A paper with all seven sections present. — which demonstrates that critique papers have stateable completeness.
...
**Teacher prompt.** "Here is a second case. A paper self-audited against the originality test. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A paper with the anticipated defence omitted. Why is this not an
example?"
...
**Exact student instructions.** Assemble all seven sections and self-audit against the originality test.
...
- *Licensed conclusion.* That critique papers have stateable completeness.
...
- *Expected response.* That critique papers have stateable completeness.
...
1. Any wording carrying the idea in `A critique paper has seven sections`.
...
Say: "That is a submittable paper."
...
| | |
|---|---|
| **Follows** | Seminar 11 — Proportionate Assessment |
| **Leads to** | Seminar 13 — External Reading |

**Transition in.** Seminar 11 established participants match the verdict to the critique's scope. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants assemble the full critique paper. Seminar 13 assumes it and builds participants have the paper read by somebody outside the seminar.
