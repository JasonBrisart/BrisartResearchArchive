# Seminar 12 Homework — The Paper Assembled

**Doctoral Year 2** · Original Critique · **Quarter 3**
**Follows:** Seminar 12 — The Paper Assembled · **Points:** 5 · **Optional:** yes
...
Assemble all seven sections and self-audit against the originality test.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every paper contains all seven sections
...
Seminar 13 is **External Reading**, which assumes you arrive holding it. Write one thing you expect it to be about:
