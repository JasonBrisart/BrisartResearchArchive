# Seminar 6 — The Anticipated Defence
...
| | |
|---|---|
| **Central question** | The Anticipated Defence: participants state the framework's best available response? |
| **Core concept** | Authors construct the defence they can answer. |
| **Student outcome** | Participants state the framework's best available response. |
| **Previous seminar** | Seminar 5 — Measurement At Publication Standard |
| **Next seminar** | Seminar 7 — Responding Or Conceding |
...
**The conceptual step.** Authors construct the defence they can answer. The assigned defender's rewrite is the standard against which the critique is scored.
...
**What depends on it.** Seminar 7 — Responding Or Conceding — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Authors construct the defence they can answer. The assigned defender's rewrite is the standard against which the critique is scored.
...
1. A defence the assigned defender accepted as strongest.
2. A critique scored against the defender's rewrite.
...
That anticipated defences require external construction.
...
| That anticipated defences require external construction. | What this specific activity can show |
| Whether the defence succeeds. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 5 — Measurement At Publication Standard — specifically: participants apply reviewer-level objections to their own work.

**How it was taught.** Through the activity: apply all five objections to their own work with evidence per verdict

**Quick check.** Ask for the closing sentence of Seminar 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 5: apply all five objections to their own work with evidence per verdict, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence the assigned defender accepted as strongest. |
...
> "An answer of no to all five means they were not genuinely applied."
...
**Target observation.** That anticipated defences require external construction.
...
> Last time we said: An answer of no to all five means they were not genuinely applied. This is the next part of that.
...
**The example.** A defence the assigned defender accepted as strongest.
...
**Completed answer.** A defence the assigned defender accepted as strongest. — which demonstrates that anticipated defences require external construction.
...
**Teacher prompt.** "Here is a second case. A critique scored against the defender's rewrite. Work it through with me."
...
**Exact student instructions.** Write the defence, checked by the week's assigned defender.
...
- *Licensed conclusion.* That anticipated defences require external construction.
...
- *Expected response.* That anticipated defences require external construction.
...
Say: "Concession is scored identically to rebuttal."
...
| | |
|---|---|
| **Follows** | Seminar 5 — Measurement At Publication Standard |
| **Leads to** | Seminar 7 — Responding Or Conceding |

**Transition in.** Seminar 5 established participants apply reviewer-level objections to their own work. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants state the framework's best available response. Seminar 7 assumes it and builds participants answer the defence or narrow the critique.
