# Seminar 5 Homework — Measurement At Publication Standard

**Doctoral Year 2** · Original Critique · **Quarter 2**
**Follows:** Seminar 5 — Measurement At Publication Standard · **Points:** 5 · **Optional:** yes
...
Apply all five objections to their own work with evidence per verdict.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** no participant answers no to all five
...
Seminar 6 is **The Anticipated Defence**, which assumes you arrive holding it. Write one thing you expect it to be about:
