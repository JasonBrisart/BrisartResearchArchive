# Seminar 8 — The Critique Workshop

**Doctoral Year 2** · Original Critique · **Quarter 2** · **3 hours**

## Lesson at a glance

| | |
|---|---|
| **Central question** | The Critique Workshop: participants develop critiques through structured peer reading? |
| **Core concept** | The gap between the intended claim and the claim three readers received is the workshop's diagnostic output. |
| **Student outcome** | Participants develop critiques through structured peer reading. |
| **Previous seminar** | Seminar 7 — Responding Or Conceding |
| **Next seminar** | Seminar 9 — Revising After Workshop |
...
**The conceptual step.** The gap between the intended claim and the claim three readers received is the workshop's diagnostic output. An author who explains prevents the diagnostic from forming.
...
**What depends on it.** Seminar 9 — Revising After Workshop — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The gap between the intended claim and the claim three readers received is the workshop's diagnostic output. An author who explains prevents the diagnostic from forming.
...
1. A recorded gap between intended and received claim.
2. An author silent through the full reading round.

### One non-example

An author clarifying their intent during the reading.
...
That reception gaps are measurable.
...
| Statement | Status |
|---|---|
| The gap between the intended claim and the claim three readers received is the workshop's diagnostic output. | Framework-derived, appropriate at this grade |
| That reception gaps are measurable. | What this specific activity can show |
| Whether the critique is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 7 — Responding Or Conceding — specifically: participants answer the defence or narrow the critique.
...
**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 7: write the response or a reasoned concession that narrows the critique, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A recorded gap between intended and received claim. |
| **Non-example** | An author clarifying their intent during the reading. |
...
> "A narrowed surviving critique beats an overreaching one."
...
**Exact wording.** "Author silent for ten minutes while three readers speak, then responds for five."
...
**Target observation.** That reception gaps are measurable.
...
> "The gap between the intended claim and the claim three readers received is the workshop's diagnostic output. You just saw that when author silent for ten minutes while three readers speak, then responds for five.
> Last time we said: A narrowed surviving critique beats an overreaching one. This is the next part of that.
...
**What students must not infer.** Whether the critique is correct.

### 4. Worked example

**The example.** A recorded gap between intended and received claim.
...
**Completed answer.** A recorded gap between intended and received claim. — which demonstrates that reception gaps are measurable.
...
**Conclusions not licensed.** Whether the critique is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An author silent through the full reading round. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An author clarifying their intent during the reading. Why is this not an
example?"
...
**Exact student instructions.** Four papers workshopped, then a revision plan comparing intended and received claim.
...
- *Licensed conclusion.* That reception gaps are measurable.
- *Not licensed.* Whether the critique is correct.
...
- *Expected response.* That reception gaps are measurable.
...
1. Any wording carrying the idea in `The gap between the intended claim and the claim three readers received is the workshop's diagnostic output`.
...
Say: "Explaining during the reading destroys the diagnostic."
...
| | |
|---|---|
| **Follows** | Seminar 7 — Responding Or Conceding |
| **Leads to** | Seminar 9 — Revising After Workshop |

**Transition in.** Seminar 7 established participants answer the defence or narrow the critique. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants develop critiques through structured peer reading. Seminar 9 assumes it and builds participants revise against workshop findings.
