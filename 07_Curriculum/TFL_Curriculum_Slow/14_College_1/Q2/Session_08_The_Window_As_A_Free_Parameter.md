# Session 8 — The Window As A Free Parameter
...
| | |
|---|---|
| **Central question** | The Window As A Free Parameter: students criticise the temporal window specification? |
| **Core concept** | The 100 to 300 millisecond range is a free parameter. |
| **Student outcome** | Students criticise the temporal window specification. |
| **Previous session** | Session 7 — The Status Review |
| **Next session** | Session 9 — The Gating Claim |
...
**The conceptual step.** The 100 to 300 millisecond range is a free parameter. Most framework claims require only that processing is discrete, not that the interval takes any particular value.
...
**What depends on it.** Session 9 — The Gating Claim — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The 100 to 300 millisecond range is a free parameter. Most framework claims require only that processing is discrete, not that the interval takes any particular value.
...
1. A carry-forward claim requiring only discreteness.
2. A window-count claim requiring the actual interval.

### One non-example

A defence of the range citing invented neurophysiological support.
...
That few claims depend on the specific interval.
...
| Statement | Status |
|---|---|
| The 100 to 300 millisecond range is a free parameter. | Framework-derived, appropriate at this grade |
| That few claims depend on the specific interval. | What this specific activity can show |
| Whether the interval is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 7 — The Status Review — specifically: students consolidate status and the declared set.

**How it was taught.** Through the activity: review with six status statements judged for inflation in either direction

**Quick check.** Ask for the closing sentence of Session 7. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 7: review with six status statements judged for inflation in either direction, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A carry-forward claim requiring only discreteness. |
| **Non-example** | A defence of the range citing invented neurophysiological support. |
...
> "Next: the number everybody accepts without checking."
...
**Exact wording.** "Write the range and note that it is a parameter, not a derivation."
...
**Target observation.** That few claims depend on the specific interval.
...
> "The 100 to 300 millisecond range is a free parameter. You just saw that when write the range and note that it is a parameter, not a derivation.
> Last time we said: Next: the number everybody accepts without checking. This is the next part of that.
...
**What students must not infer.** Whether the interval is correct.

### 4. Worked example

**The example.** A carry-forward claim requiring only discreteness.
...
**Completed answer.** A carry-forward claim requiring only discreteness. — which demonstrates that few claims depend on the specific interval.
...
**Conclusions not licensed.** Whether the interval is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A window-count claim requiring the actual interval. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence of the range citing invented neurophysiological support. Why is this not an
example?"
...
**Exact student instructions.** Determine which framework claims depend on the interval and which on discreteness alone.
...
- *Licensed conclusion.* That few claims depend on the specific interval.
- *Not licensed.* Whether the interval is correct.
...
- *Expected response.* That few claims depend on the specific interval.
...
1. Any wording carrying the idea in `The 100 to 300 millisecond range is a free parameter`.
...
Say: "Most claims require only discreteness. Worth discovering yourself."
...
| | |
|---|---|
| **Follows** | Session 7 — The Status Review |
| **Leads to** | Session 9 — The Gating Claim |

**Transition in.** Session 7 established students consolidate status and the declared set. This session uses that as the starting point.

**Transition out.** This session establishes students criticise the temporal window specification. Session 9 assumes it and builds students state and pressure the exclusive gating claim.
