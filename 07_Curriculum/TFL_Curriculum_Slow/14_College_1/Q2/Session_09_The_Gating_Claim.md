...
| | |
|---|---|
| **Central question** | The Gating Claim: students state and pressure the exclusive gating claim? |
| **Core concept** | Exclusive gating is the framework's most exposed claim and its most contested. |
| **Student outcome** | Students state and pressure the exclusive gating claim. |
| **Previous session** | Session 8 — The Window As A Free Parameter |
| **Next session** | Session 10 — Testing It On Your Own Data |
| **Materials** | Index cards for standing objections; the full specification, printed |
| **Preparation** | thirty minutes |
| **Student printout** | `Printouts/Session_09_Printout.md` |
| **Homework** | `Homework/Session_09_Homework.md` |

## Why this lesson exists

**The conceptual step.** Exclusive gating is the framework's most exposed claim and its most contested. The deciding observation is what would settle it, and specifying one is the session's output.
...
**What depends on it.** Session 10 — Testing It On Your Own Data — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Exclusive gating is the framework's most exposed claim and its most contested. The deciding observation is what would settle it, and specifying one is the session's output.
...
1. A deciding observation requiring within-window measurement.
2. A structural argument costing the modification in falsifiability.

### One non-example

An argument concluding the claim is obviously correct.
...
That the claim is contestable and the contest is specifiable.
...
| Statement | Status |
|---|---|
| Exclusive gating is the framework's most exposed claim and its most contested. | Framework-derived, appropriate at this grade |
| That the claim is contestable and the contest is specifiable. | What this specific activity can show |
| Which side is right. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 8 — The Window As A Free Parameter — specifically: students criticise the temporal window specification.

**How it was taught.** Through the activity: determine which framework claims depend on the interval and which on discreteness alone

**Quick check.** Ask for the closing sentence of Session 8. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 8: determine which framework claims depend on the interval and which on discreteness alone, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A deciding observation requiring within-window measurement. |
| **Non-example** | An argument concluding the claim is obviously correct. |
...
**Student materials.** One copy of `Printouts/Session_09_Printout.md` per student.

**Prior student data required.** Work produced in Session 8, kept in the student's folder.
...
**File.** `Printouts/Session_09_Printout.md`
...
> "Most claims require only discreteness. Worth discovering yourself."
...
**Exact wording.** "Assign two positions on exclusivity, then put the deciding question to the room."
...
**Target observation.** That the claim is contestable and the contest is specifiable.
...
> "Exclusive gating is the framework's most exposed claim and its most contested. You just saw that when assign two positions on exclusivity, then put the deciding question to the room.
> Last time we said: Most claims require only discreteness. Worth discovering yourself. This is the next part of that.
...
**What students must not infer.** Which side is right.

### 4. Worked example

**The example.** A deciding observation requiring within-window measurement.
...
**Completed answer.** A deciding observation requiring within-window measurement. — which demonstrates that the claim is contestable and the contest is specifiable.
...
**Conclusions not licensed.** Which side is right.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A structural argument costing the modification in falsifiability. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An argument concluding the claim is obviously correct. Why is this not an
example?"
...
**Exact student instructions.** Write the deciding observation and a 250-word structural argument.
...
- *Licensed conclusion.* That the claim is contestable and the contest is specifiable.
- *Not licensed.* Which side is right.
...
- *Expected response.* That the claim is contestable and the contest is specifiable.
...
1. Any wording carrying the idea in `Exclusive gating is the framework's most exposed claim and its most contested`.
...
Say: "That is a real falsification condition for a specific claim."

**Why this sentence matters.** It is the opening question of Session 10, which assumes students arrive holding it.
...
**File.** `Homework/Session_09_Homework.md`
...
| | |
|---|---|
| **Follows** | Session 8 — The Window As A Free Parameter |
| **Leads to** | Session 10 — Testing It On Your Own Data |

**Transition in.** Session 8 established students criticise the temporal window specification. This session uses that as the starting point.

**Transition out.** This session establishes students state and pressure the exclusive gating claim. Session 10 assumes it and builds students run the four-box study on prospectively collected data.
