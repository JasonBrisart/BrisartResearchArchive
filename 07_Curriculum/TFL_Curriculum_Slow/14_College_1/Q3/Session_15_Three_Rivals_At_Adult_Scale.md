# Session 15 — Three Rivals At Adult Scale
...
| | |
|---|---|
| **Central question** | Three Rivals At Adult Scale: students state the rivals in forms their proponents would accept? |
| **Core concept** | A rival stated by somebody who rejects it will be stated to lose. |
| **Student outcome** | Students state the rivals in forms their proponents would accept. |
| **Previous session** | Session 14 — The Midterm Review |
| **Next session** | Session 16 — Consistency Is Not Evidence |
...
**The conceptual step.** A rival stated by somebody who rejects it will be stated to lose. External checking by somebody who finds it plausible is the only safeguard.
...
**What depends on it.** Session 16 — Consistency Is Not Evidence — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A rival stated by somebody who rejects it will be stated to lose. External checking by somebody who finds it plausible is the only safeguard.
...
1. An uncertainty account a checker accepted as fair.
2. A rival revised after the checker recorded an objection.

### One non-example

A rival statement checked by nobody.
...
That fair statement requires external verification.
...
| Statement | Status |
|---|---|
| A rival stated by somebody who rejects it will be stated to lose. | Framework-derived, appropriate at this grade |
| That fair statement requires external verification. | What this specific activity can show |
| Which rival is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 14 — The Midterm Review — specifically: students consolidate the first half of the course.

**How it was taught.** Through the activity: review covering status, the five variables, the window, gating, and closure

**Quick check.** Ask for the closing sentence of Session 14. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 14: review covering status, the five variables, the window, gating, and closure, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An uncertainty account a checker accepted as fair. |
| **Non-example** | A rival statement checked by nobody. |
...
**Exact wording.** "Present the persistence result and ask them to explain it without the framework."
...
**Target observation.** That fair statement requires external verification.
...
> "A rival stated by somebody who rejects it will be stated to lose. You just saw that when present the persistence result and ask them to explain it without the framework.
...
**What students must not infer.** Which rival is correct.

### 4. Worked example

**The example.** An uncertainty account a checker accepted as fair.
...
**Completed answer.** An uncertainty account a checker accepted as fair. — which demonstrates that fair statement requires external verification.
...
**Conclusions not licensed.** Which rival is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A rival revised after the checker recorded an objection. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rival statement checked by nobody. Why is this not an
example?"
...
**Exact student instructions.** Write each rival and have it checked by a classmate who finds it plausible.
...
- *Licensed conclusion.* That fair statement requires external verification.
- *Not licensed.* Which rival is correct.
...
- *Expected response.* That fair statement requires external verification.
...
1. Any wording carrying the idea in `A rival stated by somebody who rejects it will be stated to lose`.
...
Say: "If you operationalise the rival, you will operationalise it to lose."
...
| **Leads to** | Session 16 — Consistency Is Not Evidence |

**Transition in.** Session 14 established students consolidate the first half of the course. This session uses that as the starting point.

**Transition out.** This session establishes students state the rivals in forms their proponents would accept. Session 16 assumes it and builds students find their own results fit the rivals equally well.
