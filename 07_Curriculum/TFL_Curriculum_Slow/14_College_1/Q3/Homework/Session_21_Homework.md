# Session 21 Homework — Scope And Invalid Application

**College Year 1** · The Framework and Its Status · **Quarter 3**
**Follows:** Session 21 — Scope And Invalid Application · **Points:** 5 · **Optional:** yes
...
Write the sentence Session 21 ended on, from memory:
...
Write three formal rejections with boundary and alternative level.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every rejection names a boundary and points elsewhere
...
Session 22 is **Falsification Conditions**, which assumes you arrive holding it. Write one thing you expect it to be about:
