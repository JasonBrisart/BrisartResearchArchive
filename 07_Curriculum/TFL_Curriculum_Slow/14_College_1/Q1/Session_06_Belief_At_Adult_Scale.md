# Session 6 — Belief At Adult Scale
...
| | |
|---|---|
| **Central question** | Belief At Adult Scale: students state Belief(t)'s different status from the five signals? |
| **Core concept** | Belief(t) is an affectively stabilised structural prior operating across cycles. |
| **Student outcome** | Students state Belief(t)'s different status from the five signals. |
| **Previous session** | Session 5 — The Five Variables At Adult Scale |
| **Next session** | Session 7 — The Status Review |
...
**The conceptual step.** Belief(t) is an affectively stabilised structural prior operating across cycles. It constrains retrieval and simulation content but is not integrated within a window.
...
**What depends on it.** Session 7 — The Status Review — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Belief(t) is an affectively stabilised structural prior operating across cycles. It constrains retrieval and simulation content but is not integrated within a window.
...
1. A belief constraining which memories are retrieved under ambiguity.
2. A belief operating across weeks while simulations operate within seconds.

### One non-example

Belief written into the integration relation as a sixth term.
...
That belief has a different formal status from the five.

### What this activity does not establish

How belief stabilises.
...
| Statement | Status |
|---|---|
| Belief(t) is an affectively stabilised structural prior operating across cycles. | Framework-derived, appropriate at this grade |
| That belief has a different formal status from the five. | What this specific activity can show |
| How belief stabilises. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 5 — The Five Variables At Adult Scale — specifically: students map the declared set with research-grade specificity.

**How it was taught.** Through the activity: map three moments with third-party-checkable Sim(t) and mark any that fail

**Quick check.** Ask for the closing sentence of Session 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 5: map three moments with third-party-checkable Sim(t) and mark any that fail, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A belief constraining which memories are retrieved under ambiguity. |
| **Non-example** | Belief written into the integration relation as a sixth term. |
...
> "Marking one unmappable is the useful result."
...
**Exact wording.** "Say: there is a sixth term. It works differently from the other five."
...
**Target observation.** That belief has a different formal status from the five.
...
> "Belief(t) is an affectively stabilised structural prior operating across cycles. You just saw that when say: there is a sixth term.
> Last time we said: Marking one unmappable is the useful result. This is the next part of that.
...
**What students must not infer.** How belief stabilises.

### 4. Worked example

**The example.** A belief constraining which memories are retrieved under ambiguity.
...
**Completed answer.** A belief constraining which memories are retrieved under ambiguity. — which demonstrates that belief has a different formal status from the five.
...
**Conclusions not licensed.** How belief stabilises.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A belief operating across weeks while simulations operate within seconds. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. Belief written into the integration relation as a sixth term. Why is this not an
example?"
...
**Exact student instructions.** Explain why belief is a structural prior rather than a momentary signal, with an example.
...
- *Licensed conclusion.* That belief has a different formal status from the five.
- *Not licensed.* How belief stabilises.
...
- *Expected response.* That belief has a different formal status from the five.
...
1. Any wording carrying the idea in `Belief(t) is an affectively stabilised structural prior operating across cycles`.
...
Say: "Not a sixth signal. A constraint on how the five behave."
...
| | |
|---|---|
| **Follows** | Session 5 — The Five Variables At Adult Scale |
| **Leads to** | Session 7 — The Status Review |

**Transition in.** Session 5 established students map the declared set with research-grade specificity. This session uses that as the starting point.

**Transition out.** This session establishes students state Belief(t)'s different status from the five signals. Session 7 assumes it and builds students consolidate status and the declared set.
