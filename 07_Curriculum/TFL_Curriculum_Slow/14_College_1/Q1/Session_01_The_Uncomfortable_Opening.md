# Session 1 — The Uncomfortable Opening
...
| | |
|---|---|
| **Central question** | The Uncomfortable Opening: students receive and record the framework's epistemic status? |
| **Core concept** | Epistemic status is content, not a preamble. |
| **Student outcome** | Students receive and record the framework's epistemic status. |
| **Previous session** | None. First session of the year. |
| **Next session** | Session 2 — Stating Status Accurately |
...
**The conceptual step.** Epistemic status is content, not a preamble. TFL is original, formally specified, falsifiable in principle, and not independently validated. Studying something at this stage is unusual and is the reason the course exists.
...
**What depends on it.** Session 2 — Stating Status Accurately — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Epistemic status is content, not a preamble. TFL is original, formally specified, falsifiable in principle, and not independently validated. Studying something at this stage is unusual and is the reason the course exists.
...
1. An objection that the persistence threshold is unspecified.
2. An objection that the gating claim cannot be separated from arousal.

### One non-example

An objection reading: this has not been validated.
...
That status can be stated and objections can be specific.
...
| Statement | Status |
|---|---|
| Epistemic status is content, not a preamble. | Framework-derived, appropriate at this grade |
| That status can be stated and objections can be specific. | What this specific activity can show |
| Whether the framework is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The student states falsification conditions and rejects invalid applications.
...
| **Correct example** | An objection that the persistence threshold is unspecified. |
| **Non-example** | An objection reading: this has not been validated. |
...
**Exact wording.** "Put both relations on the board before they arrive. Deliver the disclosure unsoftened."
...
**Target observation.** That status can be stated and objections can be specific.
...
> "Epistemic status is content, not a preamble. You just saw that when put both relations on the board before they arrive.
...
**The example.** An objection that the persistence threshold is unspecified.
...
**Completed answer.** An objection that the persistence threshold is unspecified. — which demonstrates that status can be stated and objections can be specific.
...
**Teacher prompt.** "Here is a second case. An objection that the gating claim cannot be separated from arousal. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. An objection reading: this has not been validated. Why is this not an
example?"
...
**Exact student instructions.** Each student writes their single strongest objection on a named card, returned at Session 25.
...
- *Licensed conclusion.* That status can be stated and objections can be specific.
...
- *Expected response.* That status can be stated and objections can be specific.
...
1. Any wording carrying the idea in `Epistemic status is content, not a preamble`.
...
Say: "You have never been shown a framework at this stage before it was decided."
...
| **Leads to** | Session 2 — Stating Status Accurately |

**Transition in.** This session opens the year.

**Transition out.** This session establishes students receive and record the framework's epistemic status. Session 2 assumes it and builds students state the status without overclaiming or underclaiming.
