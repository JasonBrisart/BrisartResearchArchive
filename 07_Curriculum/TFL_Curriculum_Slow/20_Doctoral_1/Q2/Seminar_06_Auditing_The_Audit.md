...
| | |
|---|---|
| **Central question** | Auditing The Audit: participants check another audit for unsupported findings? |
| **Core concept** | Auditing an audit means checking every entry against the text. |
| **Student outcome** | Participants check another audit for unsupported findings. |
| **Previous seminar** | Seminar 5 — The Audit Document |
| **Next seminar** | Seminar 7 — Your Field's Rivals |
...
**The conceptual step.** Auditing an audit means checking every entry against the text. Passing a colleague's document without marking anything means the audit was not performed.
...
**What depends on it.** Seminar 7 — Your Field's Rivals — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Auditing an audit means checking every entry against the text. Passing a colleague's document without marking anything means the audit was not performed.
...
1. An entry marked because the cited text does not support it.
2. An entry marked because the location is unverifiable.

### One non-example

A colleague's document passed with no entries marked.
...
That audit findings are externally checkable.

### What this activity does not establish

Whether the original findings are correct.
...
| Statement | Status |
|---|---|
| Auditing an audit means checking every entry against the text. | Framework-derived, appropriate at this grade |
| That audit findings are externally checkable. | What this specific activity can show |
| Whether the original findings are correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 5 — The Audit Document — specifically: participants produce a document another researcher could use.

**How it was taught.** Through the activity: complete the document and peer-audit every entry for textual evidence

**Quick check.** Ask for the closing sentence of Seminar 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 5: complete the document and peer-audit every entry for textual evidence, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | An entry marked because the cited text does not support it. |
| **Non-example** | A colleague's document passed with no entries marked. |
...
> "Without a location, a finding cannot be checked by anybody but you."
...
**Exact wording.** "Say: find the entries that would not survive a check."
...
**Target observation.** That audit findings are externally checkable.
...
> "Auditing an audit means checking every entry against the text. You just saw that when say: find the entries that would not survive a check.
> Last time we said: Without a location, a finding cannot be checked by anybody but you. This is the next part of that.
...
**What students must not infer.** Whether the original findings are correct.

### 4. Worked example

**The example.** An entry marked because the cited text does not support it.
...
**Completed answer.** An entry marked because the cited text does not support it. — which demonstrates that audit findings are externally checkable.
...
**Conclusions not licensed.** Whether the original findings are correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. An entry marked because the location is unverifiable. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A colleague's document passed with no entries marked. Why is this not an
example?"
...
**Exact student instructions.** Audit a colleague's document and mark every unsupported entry.
...
- *Licensed conclusion.* That audit findings are externally checkable.
- *Not licensed.* Whether the original findings are correct.
...
- *Expected response.* That audit findings are externally checkable.
...
1. Any wording carrying the idea in `Auditing an audit means checking every entry against the text`.
...
Say: "An audit that survives this room is worth circulating."
...
| | |
|---|---|
| **Follows** | Seminar 5 — The Audit Document |
| **Leads to** | Seminar 7 — Your Field's Rivals |

**Transition in.** Seminar 5 established participants produce a document another researcher could use. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants check another audit for unsupported findings. Seminar 7 assumes it and builds participants identify the real competing accounts in their literature.
