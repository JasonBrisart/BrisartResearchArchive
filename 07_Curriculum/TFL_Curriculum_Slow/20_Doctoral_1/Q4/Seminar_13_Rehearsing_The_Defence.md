# Seminar 13 — Rehearsing The Defence
...
| | |
|---|---|
| **Central question** | Rehearsing The Defence: participants rehearse the audit defence? |
| **Core concept** | A rehearsal produces a list of unanswered questions. |
| **Student outcome** | Participants rehearse the audit defence. |
| **Previous seminar** | Seminar 12 — The Gaps That Matter |
| **Next seminar** | Seminar 14 — Revising The Audit |
...
**The conceptual step.** A rehearsal produces a list of unanswered questions. Restating the audit rather than engaging the challenge wastes the rehearsal.
...
**What depends on it.** Seminar 14 — Revising The Audit — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A rehearsal produces a list of unanswered questions. Restating the audit rather than engaging the challenge wastes the rehearsal.
...
1. A defence answering the evidence challenger specifically.
2. A recorded list of three unanswered questions.

### One non-example

A defence restating the audit findings when challenged.
...
| Statement | Status |
|---|---|
| A rehearsal produces a list of unanswered questions. | Framework-derived, appropriate at this grade |
| That unanswered questions are identifiable in rehearsal. | What this specific activity can show |
| Whether the audit is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 12 — The Gaps That Matter — specifically: participants select the gap they will develop next year.

**How it was taught.** Through the activity: select and justify one gap, with a preliminary closure path

**Quick check.** Ask for the closing sentence of Seminar 12. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 12: select and justify one gap, with a preliminary closure path, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence answering the evidence challenger specifically. |
| **Non-example** | A defence restating the audit findings when challenged. |
...
> "That is next year's critique paper."
...
**Exact wording.** "Assign three challengers on evidence, ranking, and placement."
...
> "A rehearsal produces a list of unanswered questions. You just saw that when assign three challengers on evidence, ranking, and placement.
> Last time we said: That is next year's critique paper. This is the next part of that.
...
**What students must not infer.** Whether the audit is correct.

### 4. Worked example

**The example.** A defence answering the evidence challenger specifically.
...
**Completed answer.** A defence answering the evidence challenger specifically. — which demonstrates that unanswered questions are identifiable in rehearsal.
...
**Conclusions not licensed.** Whether the audit is correct.
...
**Teacher prompt.** "Now one that does not work. A defence restating the audit findings when challenged. Why is this not an
example?"
...
- *Not licensed.* Whether the audit is correct.
...
1. Any wording carrying the idea in `A rehearsal produces a list of unanswered questions`.
...
| | |
|---|---|
| **Follows** | Seminar 12 — The Gaps That Matter |
| **Leads to** | Seminar 14 — Revising The Audit |

**Transition in.** Seminar 12 established participants select the gap they will develop next year. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants rehearse the audit defence. Seminar 14 assumes it and builds participants revise the audit against rehearsal feedback.
