...
| | |
|---|---|
| **Central question** | Situating The Work: participants place the framework within their field's literature? |
| **Core concept** | Situating is a claim about the relationship between the framework and existing accounts. |
| **Student outcome** | Participants place the framework within their field's literature. |
| **Previous seminar** | Seminar 9 — Both Directions Of Evidence |
| **Next seminar** | Seminar 11 — Defending The Placement |
...
**The conceptual step.** Situating is a claim about the relationship between the framework and existing accounts. It requires evidence in the form of a divergence or a coverage argument.
...
**What depends on it.** Seminar 11 — Defending The Placement — opens by assuming this seminar's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Situating is a claim about the relationship between the framework and existing accounts. It requires evidence in the form of a divergence or a coverage argument.
...
1. A placement supported by a documented divergence.
2. A placement as a special case, with the generalisation named.

### One non-example

A situating statement asserting the framework is novel.
...
That placement claims require evidence.
...
| Statement | Status |
|---|---|
| Situating is a claim about the relationship between the framework and existing accounts. | Framework-derived, appropriate at this grade |
| That placement claims require evidence. | What this specific activity can show |
| Whether the placement is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Seminar 9 — Both Directions Of Evidence — specifically: participants state what would favour the rival.

**How it was taught.** Through the activity: state one observation favouring each account over the others

**Quick check.** Ask for the closing sentence of Seminar 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Seminar 9: state one observation favouring each account over the others, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A placement supported by a documented divergence. |
| **Non-example** | A situating statement asserting the framework is novel. |
...
> "A table that can only favour one is advocacy with extra steps."
...
**Exact wording.** "Say: situating is not a literature review. It is a claim about relationships."
...
**Target observation.** That placement claims require evidence.
...
> "Situating is a claim about the relationship between the framework and existing accounts. You just saw that when say: situating is not a literature review.
> Last time we said: A table that can only favour one is advocacy with extra steps. This is the next part of that.
...
**What students must not infer.** Whether the placement is correct.

### 4. Worked example

**The example.** A placement supported by a documented divergence.
...
**Completed answer.** A placement supported by a documented divergence. — which demonstrates that placement claims require evidence.
...
**Conclusions not licensed.** Whether the placement is correct.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A placement as a special case, with the generalisation named. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A situating statement asserting the framework is novel. Why is this not an
example?"
...
**Exact student instructions.** A 1000-word situating statement with evidence for the placement.
...
- *Licensed conclusion.* That placement claims require evidence.
- *Not licensed.* Whether the placement is correct.
...
- *Expected response.* That placement claims require evidence.
...
1. Any wording carrying the idea in `Situating is a claim about the relationship between the framework and existing accounts`.
...
Say: "Claims about relationships need evidence like any other."
...
| | |
|---|---|
| **Follows** | Seminar 9 — Both Directions Of Evidence |
| **Leads to** | Seminar 11 — Defending The Placement |

**Transition in.** Seminar 9 established participants state what would favour the rival. This seminar uses that as the starting point.

**Transition out.** This seminar establishes participants place the framework within their field's literature. Seminar 11 assumes it and builds participants defend a placement claim under challenge.
