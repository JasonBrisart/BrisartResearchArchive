# Seminar 4 Homework — Ranking By What Rests On Them

**Doctoral Year 1** · Specification Audit · **Quarter 1**
**Follows:** Seminar 4 — Ranking By What Rests On Them · **Points:** 5 · **Optional:** yes
...
Rank the gaps by dependency and justify the top-ranked one.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every ranking is justified with a dependency
...
Seminar 5 is **The Audit Document**, which assumes you arrive holding it. Write one thing you expect it to be about:
