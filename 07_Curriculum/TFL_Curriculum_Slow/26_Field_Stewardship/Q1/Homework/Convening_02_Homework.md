# Convening 2 Homework — Mapping The Functions

**Field Stewardship** · Governing The Examination · **Quarter 1**
**Follows:** Convening 2 — Mapping The Functions · **Points:** 5 · **Optional:** yes
...
Write the sentence Convening 2 ended on, from memory:
...
For each function, state what breaks and the minimum instrument that would fix it.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every function has a named breakage and a minimum instrument
...
Convening 3 is **Version Authority**, which assumes you arrive holding it. Write one thing you expect it to be about:
