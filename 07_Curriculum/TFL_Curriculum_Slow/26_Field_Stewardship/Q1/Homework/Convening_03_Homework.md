# Convening 3 Homework — Version Authority

**Field Stewardship** · Governing The Examination · **Quarter 1**
**Follows:** Convening 3 — Version Authority · **Points:** 5 · **Optional:** yes
...
Write the sentence Convening 3 ended on, from memory:
...
Draft the policy and test it by blind resolution of a manufactured dispute.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** the dispute resolves without the author present
...
Convening 4 is **Preservation And The Citing Literature**, which assumes you arrive holding it. Write one thing you expect it to be about:
