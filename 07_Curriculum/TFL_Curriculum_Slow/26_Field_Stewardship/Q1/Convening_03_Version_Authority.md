# Convening 3 — Version Authority

**Field Stewardship** · Governing The Examination · **Quarter 1** · **Full day**

## Lesson at a glance

| | |
|---|---|
| **Central question** | Version Authority: participants produce a policy resolving which document governs? |
| **Core concept** | A version authority policy resolves which document governs when two disagree. |
| **Student outcome** | Participants produce a policy resolving which document governs. |
| **Previous convening** | Convening 2 — Mapping The Functions |
| **Next convening** | Convening 4 — Preservation And The Citing Literature |
| **Materials** | The full specification and its version history; instrument templates |
| **Preparation** | three hours |
| **Student printout** | `Printouts/Convening_03_Printout.md` |
| **Homework** | `Homework/Convening_03_Homework.md` |

## Why this lesson exists

**The conceptual step.** A version authority policy resolves which document governs when two disagree. It does not confer authority to revise the specification, and supersession does not mean deletion.
...
**What depends on it.** Convening 4 — Preservation And The Citing Literature — opens by assuming this convening's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A version authority policy resolves which document governs when two disagree. It does not confer authority to revise the specification, and supersession does not mean deletion.
...
1. A policy resolving a manufactured citation dispute blind.
2. A policy explicitly stating supersession is not deletion.

### One non-example

A policy claiming the body may issue revised versions.
...
That version authority is separable from editorial authority.

### What this activity does not establish

Whether the policy would be adopted.
...
| Statement | Status |
|---|---|
| A version authority policy resolves which document governs when two disagree. | Framework-derived, appropriate at this grade |
| That version authority is separable from editorial authority. | What this specific activity can show |
| Whether the policy would be adopted. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Convening 2 — Mapping The Functions — specifically: participants determine what breaks if each function stays unowned.

**How it was taught.** Through the activity: for each function, state what breaks and the minimum instrument that would fix it

**Quick check.** Ask for the closing sentence of Convening 2. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Convening 2: for each function, state what breaks and the minimum instrument that would fix it, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A policy resolving a manufactured citation dispute blind. |
| **Non-example** | A policy claiming the body may issue revised versions. |
...
**Student materials.** One copy of `Printouts/Convening_03_Printout.md` per student.

**Prior student data required.** Work produced in Convening 2, kept in the student's folder.
...
**File.** `Printouts/Convening_03_Printout.md`
...
> "The minimum instrument is what you can actually build this year."
...
**Exact wording.** "Say: version drift does not announce itself. By the time you notice, the fix is unavailable."
...
**Target observation.** That version authority is separable from editorial authority.
...
> "A version authority policy resolves which document governs when two disagree. You just saw that when say: version drift does not announce itself.
> Last time we said: The minimum instrument is what you can actually build this year. This is the next part of that.
...
**What students must not infer.** Whether the policy would be adopted.

### 4. Worked example

**The example.** A policy resolving a manufactured citation dispute blind.
...
**Completed answer.** A policy resolving a manufactured citation dispute blind. — which demonstrates that version authority is separable from editorial authority.
...
**Conclusions not licensed.** Whether the policy would be adopted.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A policy explicitly stating supersession is not deletion. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A policy claiming the body may issue revised versions. Why is this not an
example?"
...
**Exact student instructions.** Draft the policy and test it by blind resolution of a manufactured dispute.
...
- *Licensed conclusion.* That version authority is separable from editorial authority.
- *Not licensed.* Whether the policy would be adopted.
...
- *Expected response.* That version authority is separable from editorial authority.
...
1. Any wording carrying the idea in `A version authority policy resolves which document governs when two disagree`.
...
Say: "Supersession is not deletion."

**Why this sentence matters.** It is the opening question of Convening 4, which assumes students arrive holding it.
...
**File.** `Homework/Convening_03_Homework.md`
...
| | |
|---|---|
| **Follows** | Convening 2 — Mapping The Functions |
| **Leads to** | Convening 4 — Preservation And The Citing Literature |

**Transition in.** Convening 2 established participants determine what breaks if each function stays unowned. This convening uses that as the starting point.

**Transition out.** This convening establishes participants produce a policy resolving which document governs. Convening 4 assumes it and builds participants guarantee that superseded versions remain interpretable.
