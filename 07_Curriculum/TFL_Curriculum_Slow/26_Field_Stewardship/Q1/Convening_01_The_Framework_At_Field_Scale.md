# Convening 1 — The Framework At Field Scale
...
| | |
|---|---|
| **Central question** | The Framework At Field Scale: participants identify which field functions have no owner? |
| **Core concept** | Field-level functions such as version authority and null preservation frequently have no owner. |
| **Student outcome** | Participants identify which field functions have no owner. |
| **Previous convening** | None. First convening of the year. |
| **Next convening** | Convening 2 — Mapping The Functions |
| **Materials** | The full specification and its version history; instrument templates |
| **Preparation** | three hours |
| **Student printout** | `Printouts/Convening_01_Printout.md` |
| **Homework** | `Homework/Convening_01_Homework.md` |

## Why this lesson exists

**The conceptual step.** Field-level functions such as version authority and null preservation frequently have no owner. A governing body governs the examination rather than the specification.
...
**What depends on it.** Convening 2 — Mapping The Functions — opens by assuming this convening's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Field-level functions such as version authority and null preservation frequently have no owner. A governing body governs the examination rather than the specification.
...
1. A statement naming five functions with no current owner.
2. A statement explicitly disclaiming authority over the specification.

### One non-example

A statement claiming authority to revise the framework.
...
That unowned field functions can be identified.

### What this activity does not establish

Whether a body should be formed.
...
| Statement | Status |
|---|---|
| Field-level functions such as version authority and null preservation frequently have no owner. | Framework-derived, appropriate at this grade |
| That unowned field functions can be identified. | What this specific activity can show |
| Whether a body should be formed. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The participant produces institutional artifacts that pass blind execution.
...
| **Correct example** | A statement naming five functions with no current owner. |
| **Non-example** | A statement claiming authority to revise the framework. |
...
**Student materials.** One copy of `Printouts/Convening_01_Printout.md` per student.
...
**File.** `Printouts/Convening_01_Printout.md`
...
This is the first convening of the year, so there is nothing to retrieve. Instead ask: "What do you think this course is about?" Take three answers and write them where they can be revisited at the end of the year. Do not correct them.

### 2. Hook

**Exact wording.** "Say: everything below this level assumes somebody is watching. At field scale, frequently nobody is."
...
**Target observation.** That unowned field functions can be identified.
...
> "Field-level functions such as version authority and null preservation frequently have no owner. You just saw that when say: everything below this level assumes somebody is watching.
...
**What students must not infer.** Whether a body should be formed.

### 4. Worked example

**The example.** A statement naming five functions with no current owner.
...
**Completed answer.** A statement naming five functions with no current owner. — which demonstrates that unowned field functions can be identified.
...
**Conclusions not licensed.** Whether a body should be formed.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A statement explicitly disclaiming authority over the specification. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A statement claiming authority to revise the framework. Why is this not an
example?"
...
**Exact student instructions.** Draft the field position statement including what the body does not claim.
...
- *Licensed conclusion.* That unowned field functions can be identified.
- *Not licensed.* Whether a body should be formed.
...
- *Expected response.* That unowned field functions can be identified.
...
1. Any wording carrying the idea in `Field-level functions such as version authority and null preservation frequently have no owner`.
...
Say: "Nobody is the usual answer, and that is the convening's finding."

**Why this sentence matters.** It is the opening question of Convening 2, which assumes students arrive holding it.
...
**File.** `Homework/Convening_01_Homework.md`
...
| | |
|---|---|
| **Follows** | Nothing. First convening of the year. |
| **Leads to** | Convening 2 — Mapping The Functions |

**Transition in.** This convening opens the year.

**Transition out.** This convening establishes participants identify which field functions have no owner. Convening 2 assumes it and builds participants determine what breaks if each function stays unowned.
