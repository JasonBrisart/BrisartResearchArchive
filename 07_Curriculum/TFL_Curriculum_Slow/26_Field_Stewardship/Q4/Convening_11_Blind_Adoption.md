...
| | |
|---|---|
| **Central question** | Blind Adoption: participants test the charter by having another body operate it? |
| **Core concept** | Blind adoption is the assessment. |
| **Student outcome** | Participants test the charter by having another body operate it. |
| **Previous convening** | Convening 10 — The Charter Assembled |
| **Next convening** | Convening 12 — Charter Review |
| **Materials** | The full specification and its version history; instrument templates |
| **Preparation** | three hours |
| **Student printout** | `Printouts/Convening_11_Printout.md` |
| **Homework** | `Homework/Convening_11_Homework.md` |

## Why this lesson exists

**The conceptual step.** Blind adoption is the assessment. The receiving body operates the charter using the document alone, and the failures reported back constitute the score.
...
**What depends on it.** Convening 12 — Charter Review — opens by assuming this convening's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Blind adoption is the assessment. The receiving body operates the charter using the document alone, and the failures reported back constitute the score.
...
1. A charter operated blind through five governance decisions.
2. A charter revised after blind adoption produced inconsistent rulings.

### One non-example

A charter operated with the author clarifying ambiguities.
...
That charters are graded by blind operation.

### What this activity does not establish

Whether the charter is otherwise good.
...
| Statement | Status |
|---|---|
| Blind adoption is the assessment. | Framework-derived, appropriate at this grade |
| That charters are graded by blind operation. | What this specific activity can show |
| Whether the charter is otherwise good. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Convening 10 — The Charter Assembled — specifically: participants assemble all five instruments into one charter.

**How it was taught.** Through the activity: assemble the charter and self-audit against both gates

**Quick check.** Ask for the closing sentence of Convening 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Convening 10: assemble the charter and self-audit against both gates, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A charter operated blind through five governance decisions. |
| **Non-example** | A charter operated with the author clarifying ambiguities. |
...
**Student materials.** One copy of `Printouts/Convening_11_Printout.md` per student.

**Prior student data required.** Work produced in Convening 10, kept in the student's folder.
...
**File.** `Printouts/Convening_11_Printout.md`
...
> "A charter that requires its authors is a committee, not a charter."
...
**Exact wording.** "Say: exchange charters. Five operations, using the received document only."
...
**Target observation.** That charters are graded by blind operation.
...
> "Blind adoption is the assessment. You just saw that when say: exchange charters.
> Last time we said: A charter that requires its authors is a committee, not a charter. This is the next part of that.
...
**What students must not infer.** Whether the charter is otherwise good.

### 4. Worked example

**The example.** A charter operated blind through five governance decisions.
...
**Completed answer.** A charter operated blind through five governance decisions. — which demonstrates that charters are graded by blind operation.
...
**Conclusions not licensed.** Whether the charter is otherwise good.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A charter revised after blind adoption produced inconsistent rulings. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A charter operated with the author clarifying ambiguities. Why is this not an
example?"
...
**Exact student instructions.** Five operations performed blind, with every failure reported back.
...
- *Licensed conclusion.* That charters are graded by blind operation.
- *Not licensed.* Whether the charter is otherwise good.
...
- *Expected response.* That charters are graded by blind operation.
...
1. Any wording carrying the idea in `Blind adoption is the assessment`.
...
Say: "The failures reported back are the adoption score."

**Why this sentence matters.** It is the opening question of Convening 12, which assumes students arrive holding it.
...
**File.** `Homework/Convening_11_Homework.md`
...
| | |
|---|---|
| **Follows** | Convening 10 — The Charter Assembled |
| **Leads to** | Convening 12 — Charter Review |

**Transition in.** Convening 10 established participants assemble all five instruments into one charter. This convening uses that as the starting point.

**Transition out.** This convening establishes participants test the charter by having another body operate it. Convening 12 assumes it and builds participants defend a complete, adoptable governance charter.
