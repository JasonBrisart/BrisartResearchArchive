...
| | |
|---|---|
| **Central question** | Charter Review: participants defend a complete, adoptable governance charter? |
| **Core concept** | The charter defence follows blind adoption. |
| **Student outcome** | Participants defend a complete, adoptable governance charter. |
| **Previous convening** | Convening 11 — Blind Adoption |
| **Next convening** | The final examination. |
| **Materials** | The full specification and its version history; instrument templates |
| **Preparation** | three hours |
| **Student printout** | `Printouts/Convening_12_Printout.md` |
| **Homework** | `Homework/Convening_12_Homework.md` |

## Why this lesson exists

**The conceptual step.** The charter defence follows blind adoption. The body's authority rests on the consent of participating institutions rather than on the expertise of its members.
...
The charter defence follows blind adoption. The body's authority rests on the consent of participating institutions rather than on the expertise of its members.
...
1. A defence grounding authority in institutional consent.
2. A defence answering the archivist on succession.

### One non-example

A defence citing the members' expertise as the basis for authority.
...
Whether field-level capacity has been built.
...
| Statement | Status |
|---|---|
| The charter defence follows blind adoption. | Framework-derived, appropriate at this grade |
| Whether field-level capacity has been built. | What this specific activity can show |
| Whether the framework is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Convening 11 — Blind Adoption — specifically: participants test the charter by having another body operate it.

**How it was taught.** Through the activity: five operations performed blind, with every failure reported back

**Quick check.** Ask for the closing sentence of Convening 11. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Convening 11: five operations performed blind, with every failure reported back, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A defence grounding authority in institutional consent. |
| **Non-example** | A defence citing the members' expertise as the basis for authority. |
...
**Student materials.** One copy of `Printouts/Convening_12_Printout.md` per student.

**Prior student data required.** Work produced in Convening 11, kept in the student's folder.
...
**File.** `Printouts/Convening_12_Printout.md`
...
> "The failures reported back are the adoption score."
...
**Exact wording.** "Say: blind adoption before any defence. Then fifteen minutes each way."
...
**Target observation.** Whether field-level capacity has been built.
...
> "The charter defence follows blind adoption. You just saw that when say: blind adoption before any defence.
> Last time we said: The failures reported back are the adoption score. This is the next part of that.
...
**The example.** A defence grounding authority in institutional consent.
...
**Completed answer.** A defence grounding authority in institutional consent. — which demonstrates whether field-level capacity has been built.
...
**Teacher prompt.** "Here is a second case. A defence answering the archivist on succession. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A defence citing the members' expertise as the basis for authority. Why is this not an
example?"
...
**Exact student instructions.** Defence against four challengers: the author's advocate, the sceptical institution, the funder, the archivist.
...
- *Licensed conclusion.* Whether field-level capacity has been built.
...
- *Expected response.* Whether field-level capacity has been built.
...
1. Any wording carrying the idea in `The charter defence follows blind adoption`.
...
Say: "There is now a path from a child noticing they were already guessing to a body that could settle it honestly."
...
**File.** `Homework/Convening_12_Homework.md`
...
| | |
|---|---|
| **Follows** | Convening 11 — Blind Adoption |
| **Leads to** | The final examination. |

**Transition in.** Convening 11 established participants test the charter by having another body operate it. This convening uses that as the starting point.
