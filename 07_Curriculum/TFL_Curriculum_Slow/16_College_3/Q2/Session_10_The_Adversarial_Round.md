# Session 10 — The Adversarial Round
...
| | |
|---|---|
| **Central question** | The Adversarial Round: students attack a design using an assigned rival? |
| **Core concept** | Adversarial rounds require the designer to listen rather than defend. |
| **Student outcome** | Students attack a design using an assigned rival. |
| **Previous session** | Session 9 — Confounds And Controls |
| **Next session** | Session 11 — Answering The Adversarial Round |
...
**The conceptual step.** Adversarial rounds require the designer to listen rather than defend. A designer who argues in real time stops hearing the attack.
...
**What depends on it.** Session 11 — Answering The Adversarial Round — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Adversarial rounds require the designer to listen rather than defend. A designer who argues in real time stops hearing the attack.
...
1. A design attacked from all three rival positions.
2. A designer recording attacks silently.

### One non-example

A designer rebutting during the first round.
...
That designs can be systematically attacked.
...
| Statement | Status |
|---|---|
| Adversarial rounds require the designer to listen rather than defend. | Framework-derived, appropriate at this grade |
| That designs can be systematically attacked. | What this specific activity can show |
| Whether the design survives. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 9 — Confounds And Controls — specifically: students identify what would invalidate their result.

**How it was taught.** Through the activity: complete the seven-row confound table with controls and residual risks

**Quick check.** Ask for the closing sentence of Session 9. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 9: complete the seven-row confound table with controls and residual risks, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A design attacked from all three rival positions. |
| **Non-example** | A designer rebutting during the first round. |
...
> "Residual risk acknowledged is better work than residual risk dismissed."
...
**Exact wording.** "Assign each student one rival, three rotating rounds."
...
**Target observation.** That designs can be systematically attacked.
...
> "Adversarial rounds require the designer to listen rather than defend. You just saw that when assign each student one rival, three rotating rounds.
> Last time we said: Residual risk acknowledged is better work than residual risk dismissed. This is the next part of that.
...
**What students must not infer.** Whether the design survives.

### 4. Worked example

**The example.** A design attacked from all three rival positions.
...
**Completed answer.** A design attacked from all three rival positions. — which demonstrates that designs can be systematically attacked.
...
**Conclusions not licensed.** Whether the design survives.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A designer recording attacks silently. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A designer rebutting during the first round. Why is this not an
example?"
...
**Exact student instructions.** Deliver a written attack and receive one per rival on their own design.
...
- *Licensed conclusion.* That designs can be systematically attacked.
- *Not licensed.* Whether the design survives.
...
- *Expected response.* That designs can be systematically attacked.
...
1. Any wording carrying the idea in `Adversarial rounds require the designer to listen rather than defend`.
...
Say: "If a design cannot survive this room it will not survive review."
...
| **Leads to** | Session 11 — Answering The Adversarial Round |

**Transition in.** Session 9 established students identify what would invalidate their result. This session uses that as the starting point.

**Transition out.** This session establishes students attack a design using an assigned rival. Session 11 assumes it and builds students revise a design against adversarial feedback.
