...
Complete the seven-row confound table with controls and residual risks.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student addresses all seven rows with reasons
...
Session 10 is **The Adversarial Round**, which assumes you arrive holding it. Write one thing you expect it to be about:
