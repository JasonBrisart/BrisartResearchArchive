# Session 11 — Answering The Adversarial Round
...
| | |
|---|---|
| **Central question** | Answering The Adversarial Round: students revise a design against adversarial feedback? |
| **Core concept** | A design answering all three rival attacks is worth running. |
| **Student outcome** | Students revise a design against adversarial feedback. |
| **Previous session** | Session 10 — The Adversarial Round |
| **Next session** | Session 12 — Both Directions Of Evidence |
...
**The conceptual step.** A design answering all three rival attacks is worth running. Dismissing every attack usually means they were not heard rather than that they failed.
...
**What depends on it.** Session 12 — Both Directions Of Evidence — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A design answering all three rival attacks is worth running. Dismissing every attack usually means they were not heard rather than that they failed.
...
1. A revision adding a control answering the arousal attack.
2. A revision narrowing the claim after the uncertainty attack.

### One non-example

All three attacks dismissed as inapplicable.
...
That designs improve under adversarial revision.

### What this activity does not establish

Whether the revised design works.
...
| Statement | Status |
|---|---|
| A design answering all three rival attacks is worth running. | Framework-derived, appropriate at this grade |
| That designs improve under adversarial revision. | What this specific activity can show |
| Whether the revised design works. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 10 — The Adversarial Round — specifically: students attack a design using an assigned rival.

**How it was taught.** Through the activity: deliver a written attack and receive one per rival on their own design

**Quick check.** Ask for the closing sentence of Session 10. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 10: deliver a written attack and receive one per rival on their own design, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A revision adding a control answering the arousal attack. |
| **Non-example** | All three attacks dismissed as inapplicable. |
...
> "If a design cannot survive this room it will not survive review."
...
**Exact wording.** "Ask which attacks landed and require revision against those."
...
**Target observation.** That designs improve under adversarial revision.
...
> "A design answering all three rival attacks is worth running. You just saw that when ask which attacks landed and require revision against those.
> Last time we said: If a design cannot survive this room it will not survive review. This is the next part of that.
...
**What students must not infer.** Whether the revised design works.

### 4. Worked example

**The example.** A revision adding a control answering the arousal attack.
...
**Completed answer.** A revision adding a control answering the arousal attack. — which demonstrates that designs improve under adversarial revision.
...
**Conclusions not licensed.** Whether the revised design works.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A revision narrowing the claim after the uncertainty attack. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. All three attacks dismissed as inapplicable. Why is this not an
example?"
...
**Exact student instructions.** Revise the design and state what changed for each landing attack.
...
- *Licensed conclusion.* That designs improve under adversarial revision.
- *Not licensed.* Whether the revised design works.
...
- *Expected response.* That designs improve under adversarial revision.
...
1. Any wording carrying the idea in `A design answering all three rival attacks is worth running`.
...
Say: "A design that answers all three is worth running."
...
| | |
|---|---|
| **Follows** | Session 10 — The Adversarial Round |
| **Leads to** | Session 12 — Both Directions Of Evidence |

**Transition in.** Session 10 established students attack a design using an assigned rival. This session uses that as the starting point.

**Transition out.** This session establishes students revise a design against adversarial feedback. Session 12 assumes it and builds students state what would favour the rival.
