# Session 20 — The Redundancy Verdict
...
| | |
|---|---|
| **Central question** | The Redundancy Verdict: students deliver a verdict on whether the framework adds anything? |
| **Core concept** | A verdict on redundancy must rest on a differential prediction. |
| **Student outcome** | Students deliver a verdict on whether the framework adds anything. |
| **Previous session** | Session 19 — The Adjudicating Design |
| **Next session** | Session 21 — Adjudication In Your Own Field |
...
**The conceptual step.** A verdict on redundancy must rest on a differential prediction. Either conclusion is acceptable; an unsupported verdict is not.
...
**What depends on it.** Session 21 — Adjudication In Your Own Field — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

A verdict on redundancy must rest on a differential prediction. Either conclusion is acceptable; an unsupported verdict is not.
...
1. A verdict that the framework diverges, with the prediction.
2. A verdict that it does not diverge, with the failed search documented.

### One non-example

A verdict asserting novelty with no prediction cited.
...
That the charge can be settled by evidence.

### What this activity does not establish

Whether the framework is redundant.
...
| Statement | Status |
|---|---|
| A verdict on redundancy must rest on a differential prediction. | Framework-derived, appropriate at this grade |
| That the charge can be settled by evidence. | What this specific activity can show |
| Whether the framework is redundant. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 19 — The Adjudicating Design — specifically: students present a design distinguishing all accounts.

**How it was taught.** Through the activity: an eight-minute presentation facing one question per rival advocate

**Quick check.** Ask for the closing sentence of Session 19. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 19: an eight-minute presentation facing one question per rival advocate, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A verdict that the framework diverges, with the prediction. |
| **Non-example** | A verdict asserting novelty with no prediction cited. |
...
> "Next year: what would make you abandon this."
...
**Exact wording.** "Say: you have a differential prediction. What does it show?"
...
**Target observation.** That the charge can be settled by evidence.
...
> "A verdict on redundancy must rest on a differential prediction. You just saw that when say: you have a differential prediction.
> Last time we said: Next year: what would make you abandon this. This is the next part of that.
...
**What students must not infer.** Whether the framework is redundant.

### 4. Worked example

**The example.** A verdict that the framework diverges, with the prediction.
...
**Completed answer.** A verdict that the framework diverges, with the prediction. — which demonstrates that the charge can be settled by evidence.
...
**Conclusions not licensed.** Whether the framework is redundant.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A verdict that it does not diverge, with the failed search documented. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A verdict asserting novelty with no prediction cited. Why is this not an
example?"
...
**Exact student instructions.** Write a verdict on the redundancy charge, supported by their own prediction.
...
- *Licensed conclusion.* That the charge can be settled by evidence.
- *Not licensed.* Whether the framework is redundant.
...
- *Expected response.* That the charge can be settled by evidence.
...
1. Any wording carrying the idea in `A verdict on redundancy must rest on a differential prediction`.
...
Say: "Either answer is fine. Assertion is not."
...
| | |
|---|---|
| **Follows** | Session 19 — The Adjudicating Design |
| **Leads to** | Session 21 — Adjudication In Your Own Field |

**Transition in.** Session 19 established students present a design distinguishing all accounts. This session uses that as the starting point.

**Transition out.** This session establishes students deliver a verdict on whether the framework adds anything. Session 21 assumes it and builds students find an adjudication contest in their own discipline.
