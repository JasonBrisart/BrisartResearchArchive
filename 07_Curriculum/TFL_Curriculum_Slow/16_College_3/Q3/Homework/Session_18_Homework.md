# Session 18 Homework — Predictions For Every Account

**College Year 3** · Adjudication · **Quarter 3**
**Follows:** Session 18 — Predictions For Every Account · **Points:** 5 · **Optional:** yes
...
Complete a five-row prediction table with all rows distinct.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student has five distinct prediction rows
...
Session 19 is **The Adjudicating Design**, which assumes you arrive holding it. Write one thing you expect it to be about:
