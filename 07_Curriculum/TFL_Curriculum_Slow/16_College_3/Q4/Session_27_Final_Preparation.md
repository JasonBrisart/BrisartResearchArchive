...
| **Core concept** | Targeted review of diagnosed weaknesses is more useful than general revision. |
...
**The conceptual step.** Targeted review of diagnosed weaknesses is more useful than general revision. The practice paper supplies the targets.
...
Targeted review of diagnosed weaknesses is more useful than general revision. The practice paper supplies the targets.
...
1. A student working specifically on fair operationalisation.
2. A student who revised the discriminating condition after failing it.
...
That review can be targeted by evidence.
...
| Statement | Status |
|---|---|
| Targeted review of diagnosed weaknesses is more useful than general revision. | Framework-derived, appropriate at this grade |
| That review can be targeted by evidence. | What this specific activity can show |
...
| **Correct example** | A student working specifically on fair operationalisation. |
...
**Target observation.** That review can be targeted by evidence.
...
> "Targeted review of diagnosed weaknesses is more useful than general revision. You just saw that when say: your practice paper told you something.
...
**The example.** A student working specifically on fair operationalisation.
...
**Completed answer.** A student working specifically on fair operationalisation. — which demonstrates that review can be targeted by evidence.
...
**Teacher prompt.** "Here is a second case. A student who revised the discriminating condition after failing it. Work it through with me."
...
- *Licensed conclusion.* That review can be targeted by evidence.
...
- *Expected response.* That review can be targeted by evidence.
...
1. Any wording carrying the idea in `Targeted review of diagnosed weaknesses is more useful than general revision`.
...
**Transition out.** This session establishes students address weaknesses the practice revealed. Session 28 assumes it and builds students demonstrate integrated command of adjudication.
