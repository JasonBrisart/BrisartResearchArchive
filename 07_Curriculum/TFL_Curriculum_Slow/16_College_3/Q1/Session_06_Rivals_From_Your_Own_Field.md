# Session 6 — Rivals From Your Own Field
...
| | |
|---|---|
| **Central question** | Rivals From Your Own Field: students identify the real competing accounts in their literature? |
| **Core concept** | Real competition comes from the student's own literature. |
| **Student outcome** | Students identify the real competing accounts in their literature. |
| **Previous session** | Session 5 — The Gating Claim Under Real Pressure |
| **Next session** | Session 7 — The Redundancy Charge |
...
**The conceptual step.** Real competition comes from the student's own literature. If a field account never diverges from TFL, either they are the same theory, one is a special case, or one is underspecified.
...
**What depends on it.** Session 7 — The Redundancy Charge — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Real competition comes from the student's own literature. If a field account never diverges from TFL, either they are the same theory, one is a special case, or one is underspecified.
...
1. A field rival with a stated divergence and a separator.
2. A field account found to make no distinguishable prediction.

### One non-example

A field rival presented with no divergence attempted.
...
That the competition extends beyond the teaching rivals.
...
| Statement | Status |
|---|---|
| Real competition comes from the student's own literature. | Framework-derived, appropriate at this grade |
| That the competition extends beyond the teaching rivals. | What this specific activity can show |
| Which account is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 5 — The Gating Claim Under Real Pressure — specifically: students confront the unfalsifiability charge against exclusive gating.

**How it was taught.** Through the activity: write the deciding design sketch with the distinguishing line completed

**Quick check.** Ask for the closing sentence of Session 5. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 5: write the deciding design sketch with the distinguishing line completed, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A field rival with a stated divergence and a separator. |
| **Non-example** | A field rival presented with no divergence attempted. |
...
> "If the room cannot specify the evidence, the charge stands. Record that."
...
**Exact wording.** "Say: the three are teaching rivals. They are not the competition."
...
**Target observation.** That the competition extends beyond the teaching rivals.
...
> "Real competition comes from the student's own literature. You just saw that when say: the three are teaching rivals.
> Last time we said: If the room cannot specify the evidence, the charge stands. Record that. This is the next part of that.
...
**The example.** A field rival with a stated divergence and a separator.
...
**Completed answer.** A field rival with a stated divergence and a separator. — which demonstrates that the competition extends beyond the teaching rivals.
...
**Teacher prompt.** "Here is a second case. A field account found to make no distinguishable prediction. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A field rival presented with no divergence attempted. Why is this not an
example?"
...
**Exact student instructions.** Present two field rivals with readings, standing, agreement, divergence, and a separator.
...
- *Licensed conclusion.* That the competition extends beyond the teaching rivals.
...
- *Expected response.* That the competition extends beyond the teaching rivals.
...
1. Any wording carrying the idea in `Real competition comes from the student's own literature`.
...
Say: "If your field's account never diverges, one of three things is true."
...
| | |
|---|---|
| **Follows** | Session 5 — The Gating Claim Under Real Pressure |
| **Leads to** | Session 7 — The Redundancy Charge |

**Transition in.** Session 5 established students confront the unfalsifiability charge against exclusive gating. This session uses that as the starting point.

**Transition out.** This session establishes students identify the real competing accounts in their literature. Session 7 assumes it and builds students argue whether the framework adds anything.
