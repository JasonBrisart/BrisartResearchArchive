# Session 7 Homework — The Redundancy Charge

**College Year 3** · Adjudication · **Quarter 1**
**Follows:** Session 7 — The Redundancy Charge · **Points:** 5 · **Optional:** yes
...
Produce one differential prediction between TFL and a field-standard account.

Use material nobody chose for you. Not the example worked through in class.

**Your teacher is looking for:** every student produces a genuine differential prediction
...
Session 8 is **Designing To Adjudicate**, which assumes you arrive holding it. Write one thing you expect it to be about:
