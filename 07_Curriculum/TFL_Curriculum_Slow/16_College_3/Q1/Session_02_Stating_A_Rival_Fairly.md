# Session 2 — Stating A Rival Fairly
...
| | |
|---|---|
| **Central question** | Stating A Rival Fairly: students state rivals as their proponents would? |
| **Core concept** | Fair operationalisation requires external checking by somebody who finds the rival plausible. |
| **Student outcome** | Students state rivals as their proponents would. |
| **Previous session** | Session 1 — Fitting Is Not Supporting |
| **Next session** | Session 3 — The Differential Table |
...
**The conceptual step.** Fair operationalisation requires external checking by somebody who finds the rival plausible. Self-assessment of fairness is unreliable in a predictable direction.
...
**What depends on it.** Session 3 — The Differential Table — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

Fair operationalisation requires external checking by somebody who finds the rival plausible. Self-assessment of fairness is unreliable in a predictable direction.
...
1. A rival statement the assigned defender accepted.
2. A rival revised after the defender recorded an objection.

### One non-example

A rival checked by a classmate who shares the author's view.
...
That fairness requires assigned external checking.
...
| Statement | Status |
|---|---|
| Fair operationalisation requires external checking by somebody who finds the rival plausible. | Framework-derived, appropriate at this grade |
| That fairness requires assigned external checking. | What this specific activity can show |
| Which rival is correct. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 1 — Fitting Is Not Supporting — specifically: students discover their own results fit the rivals equally well.

**How it was taught.** Through the activity: apply the three rivals to three of their own results and count the discriminating ones

**Quick check.** Ask for the closing sentence of Session 1. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 1: apply the three rivals to three of their own results and count the discriminating ones, in miniature, using one example only. Then ask for the sentence again.
...
| **Correct example** | A rival statement the assigned defender accepted. |
| **Non-example** | A rival checked by a classmate who shares the author's view. |
...
> "This is the most useful disappointment of your degree."
...
**Exact wording.** "Put up two statements of the same rival, one by a believer and one by an opponent."
...
**Target observation.** That fairness requires assigned external checking.
...
> "Fair operationalisation requires external checking by somebody who finds the rival plausible. You just saw that when put up two statements of the same rival, one by a believer and one by an opponent.
> Last time we said: This is the most useful disappointment of your degree. This is the next part of that.
...
**The example.** A rival statement the assigned defender accepted.
...
**Completed answer.** A rival statement the assigned defender accepted. — which demonstrates that fairness requires assigned external checking.
...
**Teacher prompt.** "Here is a second case. A rival revised after the defender recorded an objection. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A rival checked by a classmate who shares the author's view. Why is this not an
example?"
...
**Exact student instructions.** Write each rival, checked by a classmate assigned to defend it.
...
- *Licensed conclusion.* That fairness requires assigned external checking.
...
- *Expected response.* That fairness requires assigned external checking.
...
1. Any wording carrying the idea in `Fair operationalisation requires external checking by somebody who finds the rival plausible`.
...
Say: "A rival you wrote to lose has not been adjudicated against."
...
| | |
|---|---|
| **Follows** | Session 1 — Fitting Is Not Supporting |
| **Leads to** | Session 3 — The Differential Table |

**Transition in.** Session 1 established students discover their own results fit the rivals equally well. This session uses that as the starting point.

**Transition out.** This session establishes students state rivals as their proponents would. Session 3 assumes it and builds students build a table in which the accounts differ.
