# Session 4 — The Discriminating Condition
...
| | |
|---|---|
| **Central question** | The Discriminating Condition: students locate the cell where accounts come apart? |
| **Core concept** | The discriminating condition is rare in natural settings. |
| **Student outcome** | Students locate the cell where accounts come apart. |
| **Previous session** | Session 3 — The Differential Table |
| **Next session** | Session 5 — The Gating Claim Under Real Pressure |
...
**The conceptual step.** The discriminating condition is rare in natural settings. Results obtained inside it speak to mechanism rather than typical operation, and the limit must be addressed.
...
**What depends on it.** Session 5 — The Gating Claim Under Real Pressure — opens by assuming this session's closing sentence is already held.

## Teacher concept guide

### Plain-language explanation

The discriminating condition is rare in natural settings. Results obtained inside it speak to mechanism rather than typical operation, and the limit must be addressed.
...
2. A stated generalisation limit acknowledging rarity.

### One non-example

A claim that the condition arises frequently in everyday life.
...
That the condition is rare and the rarity constrains generalisation.
...
| Statement | Status |
|---|---|
| The discriminating condition is rare in natural settings. | Framework-derived, appropriate at this grade |
| That the condition is rare and the rarity constrains generalisation. | What this specific activity can show |
| How rare it actually is. | Explicitly outside what this activity establishes |

## What students should already know

**Prerequisite.** The content of Session 3 — The Differential Table — specifically: students build a table in which the accounts differ.

**How it was taught.** Through the activity: build the table for one scenario and mark any coinciding rows

**Quick check.** Ask for the closing sentence of Session 3. An adequate response carries the idea in any wording.

**If the prerequisite is missing.** **Five-minute recovery.** Re-run the closing move from Session 3: build the table for one scenario and mark any coinciding rows, in miniature, using one example only. Then ask for the sentence again.
...
| **Non-example** | A claim that the condition arises frequently in everyday life. |
...
> "Marking a coincidence is a result, not a failure."
...
**Target observation.** That the condition is rare and the rarity constrains generalisation.
...
> "The discriminating condition is rare in natural settings. You just saw that when ask under what conditions the framework predicts differently from all three.
> Last time we said: Marking a coincidence is a result, not a failure. This is the next part of that.
...
**What students must not infer.** How rare it actually is.
...
**Completed answer.** A condition meeting all four criteria. — which demonstrates that the condition is rare and the rarity constrains generalisation.
...
**Conclusions not licensed.** How rare it actually is.

### 5. Guided practice

#### Guided example one

**Teacher prompt.** "Here is a second case. A stated generalisation limit acknowledging rarity. Work it through with me."
...
**Teacher prompt.** "Now one that does not work. A claim that the condition arises frequently in everyday life. Why is this not an
example?"
...
**Exact student instructions.** Determine whether their design enters the cell and address the generalisation limit.
...
- *Licensed conclusion.* That the condition is rare and the rarity constrains generalisation.
- *Not licensed.* How rare it actually is.
...
- *Expected response.* That the condition is rare and the rarity constrains generalisation.
...
1. Any wording carrying the idea in `The discriminating condition is rare in natural settings`.
...
| | |
|---|---|
| **Follows** | Session 3 — The Differential Table |
| **Leads to** | Session 5 — The Gating Claim Under Real Pressure |

**Transition in.** Session 3 established students build a table in which the accounts differ. This session uses that as the starting point.

**Transition out.** This session establishes students locate the cell where accounts come apart. Session 5 assumes it and builds students confront the unfalsifiability charge against exclusive gating.
